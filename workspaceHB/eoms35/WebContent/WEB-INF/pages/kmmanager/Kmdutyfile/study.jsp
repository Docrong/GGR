<%@ page language="java"
         import="java.util.*,java.lang.*, org.apache.struts.util.*,com.boco.eoms.duty.model.*,com.boco.eoms.common.util.StaticMethod" %>
                ...
                <form id="tawRmDutyfileForm" method="post" action="/eoms/duty/TawRmDutyfile/save.do">
                    <table cellpadding="1" cellspacing="0" border="0" width="100%" class="" formTable>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href='/eoms/duty/upload/2008070922014653.ppt'
                                   target='blank'>${eoms:a2u('EOMS3.5任务工单培训手册.ppt')}</a>
                            </td>
                            <td>
                                <a href='/eoms/duty/upload/2008070922015242.doc'
                                   target='blank'>${eoms:a2u('EOMS-V3.5任务工单用户手册.doc')}</a>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href='/eoms/duty/upload/2008070922020344.doc'
                                   target='blank'>${eoms:a2u('EOMS-V3.5值班管理用户手册.doc')}</a>
                            </td>
                            <td>
                                <a href='/eoms/duty/upload/2008070922021102.ppt'
                                   target='blank'>${eoms:a2u('EOMS-V3.5值班管理培训手册.ppt')}</a>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href='/eoms/duty/upload/2008070922040034.ppt'
                                   target='blank'>${eoms:a2u('EOMS-V3.5培训手册_个人首页.ppt')}</a>
                            </td>
                            <td>
                                <a href='/eoms/duty/upload/2008070922042263.doc'
                                   target='blank'>${eoms:a2u('EOMS-V3.5用户手册_个人首页.doc')}</a>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href='/eoms/duty/upload/2008070922041215.ppt'
                                   target='blank'>${eoms:a2u('EOMS-V3.5培训手册_组织管理.ppt')}</a>
                            </td>
                            <td>
                                <a href='/eoms/duty/upload/2008070922043033.doc'
                                   target='blank'>${eoms:a2u('EOMS-V3.5用户手册_组织管理.doc')}</a>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href='/eoms/duty/upload/2008070922160490.ppt'
                                   target='blank'>${eoms:a2u('EOMS-3.5培训手册_作业计划.ppt')}</a>
                            </td>
                            <td>
                                <a href='/eoms/duty/upload/2008070922161104.doc'
                                   target='blank'>${eoms:a2u('EOMS-V3.5用户手册_作业计划.doc')}</a>
                            </td>
                        </tr>
