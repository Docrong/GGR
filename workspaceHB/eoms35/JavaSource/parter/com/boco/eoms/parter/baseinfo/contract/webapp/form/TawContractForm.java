 ...
 * 
 */
public class TawContractForm extends BaseForm implements java.io.Serializable {
	...
	private FormFile excelInput;

	public FormFile getExcelInput() {
		return excelInput;
	}

	public void setExcelInput(FormFile excelInput) {
