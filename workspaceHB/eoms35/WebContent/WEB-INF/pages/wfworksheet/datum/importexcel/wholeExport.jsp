...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1169 style='border-collapse:
 ...
 <tr height=19 style='height:14.25pt'>
  <td height=19 width=59 style='height:14.25pt;width:44pt'></td>
 ...
 <tr height=19 style='height:14.25pt'>
  ...
  <td class=xl27 colspan=2 style='mso-ignore:colspan'>HLR调整（地市申请编号）</td>
 </tr>
<%for(int i=0;i<size;i++){
  TawBureaudataSHlrForExcel po = (TawBureaudataSHlrForExcel)hlrList.get(i);%>
 <tr height=21 style='height:15.75pt'>
  <td height=21 style='height:15.75pt'><%=i%></td>
