            ...
            <tr>
                ...
                <td class="content">
                    <eoms:dict key="dict-kmmanager" dictId="rolestrFlag" isQuery="false"
                               defaultId="${kmContentsForm.rolestrFlag}"
                               selectId="QueryCond/ROLESTR_FLAG/criteria/value" beanId="selectXML"
                               alt="allowBlank:true"/>
                </td>
                ...
                <td class="content">
                    <eoms:dict key="dict-kmmanager" dictId="levelFlag" isQuery="false"
                               defaultId="${kmContentsForm.levelFlag}" selectId="QueryCond/LEVEL_FLAG/criteria/value"
                               beanId="selectXML"
                               alt="allowBlank:true"/>
                </td>
            </tr>
...
-->
            <tr>
                ...
                <td class="content" colspan="3">
                    <input type="text" name="QueryCond/CONTENT_TITLE/criteria/value" id="contentTitle" value=""
            ...
            <tr>
                ...
                <td class="content" colspan="3">
                    <input type="text" name="QueryCond/CONTENT_KEYS/criteria/value" id="contentKeys" value=""
                           class="text" alt="allowBlank:true"/>
