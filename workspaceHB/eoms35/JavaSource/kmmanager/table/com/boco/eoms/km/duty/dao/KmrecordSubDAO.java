...
public class KmrecordSubDAO extends DAO {

  public KmrecordSubDAO(com.boco.eoms.db.util.ConnectionPool  ds) {
    super(ds);
  }
   ...
   * @throws SQLException
   */
  public void insert(KmrecordSub tawRmRecordSub) throws SQLException {
    String sql;
    sql = "INSERT INTO km_record_sub (id, room_id, workserial, dutyman, starttime, endtime, starttime_defined, endtime_defined, statement, workflag, status, notes) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
   ...
   * @throws SQLException
   */
  public void update(KmrecordSub tawRmRecordSub) throws SQLException {
  	com.boco.eoms.db.util.BocoConnection conn = null;
  	PreparedStatement pstmt = null;
    try {
      conn = ds.getConnection();
      String sql = "UPDATE km_record_sub SET room_id=?, workserial=?, dutyman=?, starttime=?, endtime=?, starttime_defined=?, endtime_defined=?, statement=?, workflag=?, status=?, notes=? WHERE id=?";
      pstmt = conn.prepareStatement(sql);
  ...
  public void delete(int id) throws SQLException {
    ...
    try {
      conn = ds.getConnection();
      String sql = "DELETE FROM km_record_sub WHERE id=?";
      pstmt = conn.prepareStatement(sql);
      pstmt.setInt(1, id);
      pstmt.executeUpdate();
      close(pstmt);
  ...
  public void delete_workserial(int workserial) throws SQLException {
    ...
    try {
      conn = ds.getConnection();
      String sql = "DELETE FROM km_record_sub WHERE workserial=?";
      pstmt = conn.prepareStatement(sql);
   ...
   * @throws SQLException
   */
  public KmrecordSub retrieve(int id) throws SQLException {
    ...
    try {
      conn = ds.getConnection();
      String sql = "SELECT * FROM km_record_sub WHERE id=?";
      pstmt = conn.prepareStatement(sql);
      pstmt.setInt(1, id);
   ...
   * @throws SQLException
   */
  public KmrecordSub retrieve_sub(int workserial,String dutyman) throws SQLException {
     KmrecordSub tawRmRecordSub = null;
     com.boco.eoms.db.util.BocoConnection conn = null;
     PreparedStatement pstmt = null;
     ResultSet rs = null;
     try {
       conn = ds.getConnection();
       String sql = "SELECT * FROM km_record_sub WHERE workserial=? and dutyman = ?";
       pstmt = conn.prepareStatement(sql);
       pstmt.setInt(1, workserial);
    ...
    * @throws SQLException
    */
   public KmrecordSub retrieve_sub1(int workserial,String dutyman) throws SQLException {
      KmrecordSub tawRmRecordSub = null;
      com.boco.eoms.db.util.BocoConnection conn = null;
      PreparedStatement pstmt = null;
      ResultSet rs = null;
  ...
  public List list() throws SQLException {
    ...
    try {
      conn = ds.getConnection();
      String sql = "SELECT room_id, workserial, dutyman, starttime, endtime, starttime_defined, endtime_defined, statement, workflag, status, notes, id FROM km_record_sub";
      pstmt = conn.prepareStatement(sql);
      rs = pstmt.executeQuery();
      while(rs.next()) {
  ...
  /**
   ...
   public int retrieve_sub0(int workserial,String dutyman) throws SQLException {
      ...
      try {
        conn = ds.getConnection();
        String sql = "SELECT typemode FROM km_record_sub WHERE workserial=? and dutyman = ?";
        pstmt = conn.prepareStatement(sql);
        pstmt.setInt(1, workserial);
        pstmt.setString(2,dutyman);
        rs = pstmt.executeQuery();
...
//      int type=1;
      ...
      try {
        conn = ds.getConnection();
        String sql = "SELECT trans,switch,data,system,other, dutySummary,importRecord,importFault,netCut,netKPI,needcorrespond,handoverproceeding  FROM km_record_sub WHERE workserial=? and dutyman = ?";
        pstmt = conn.prepareStatement(sql);
        pstmt.setInt(1, workserial);
        pstmt.setString(2,dutyman);
        rs = pstmt.executeQuery();
