...
<div id="sheetform">
<html:form action="/complaint.do?method=performDealReplyReject" styleId="theform">
 <%@ include file="/common/taglibs.jsp"%>
<%
...
<%@ include file="/WEB-INF/pages/wfworksheet/complaint/baseinputlinkhtmlnew.jsp"%>
     ...
     <tr>
      ...
      <logic:iterate id="toTask" name="acceptList" type="com.boco.eoms.sheet.complaint.task.impl.ComplaintTask">  
        <tr>
          <td>
