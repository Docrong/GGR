...
<html:form action="tawRmTestcards" method="post" styleId="tawRmTestcardForm"> 
	<table class="formTable">
		...
		<tr>
			...
			<td width="500" colspan="3">
				<input type="text" name="openAccountDate" size="30" value="" class="text" onclick="popUpCalendar(this, this,'yyyy-mm-dd',-1,-1,false);" readonly="true">
			</td>
		</tr>
		<tr>
			<td width="100" class="label">
			...
			<td width="500" colspan="3">
				<input type="text" name="logoutDate" size="30" value="" class="text" onclick="popUpCalendar(this, this,'yyyy-mm-dd',-1,-1,false);" readonly="true">
			</td>
		</tr>
		<tr>
			<td width="100" class="label">
			...
			<td width="500" colspan="3">
				<input type="text" name="takeOverDate" size="30" value="" class="text" onclick="popUpCalendar(this, this,'yyyy-mm-dd',-1,-1,false);" readonly="true">
			</td>
		</tr>
		<tr>
			<td width="100" class="label">
