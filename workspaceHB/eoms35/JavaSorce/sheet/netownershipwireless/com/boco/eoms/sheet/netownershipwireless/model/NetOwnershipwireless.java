package com.boco.eoms.sheet.netownershipwireless.model;
 ...
 *
 */
public class NetOwnershipwireless implements Serializable {
	...
	public String getIfgj() {
		return ifgj;
	}

	public void setIfgj(String ifgj) {
		this.ifgj = ifgj;
	}
	...
	public String getIfmz() {
		return ifmz;
	}

	public void setIfmz(String ifmz) {
		this.ifmz = ifmz;
	}
	...
	public String getTtRoleId() {
		return ttRoleId;
	}

	public void setTtRoleId(String ttRoleId) {
		this.ttRoleId = ttRoleId;
	}

	public String getWorkstatprop() {
		return workstatprop;
	}

	public void setWorkstatprop(String workstatprop) {
		this.workstatprop = workstatprop;
	}
