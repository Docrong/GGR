...
<display:table name="taskList" cellspacing="0" cellpadding="0"
	...
	partialList="true"
	decorator="com.boco.eoms.sheet.commonfault.webapp.action.MainListCommonFaultDisplaytagDecoratorHelper">

	<display:column property="sheetId" sortable="true"
		sortName="main.sheetId" headerClass="sortable" title="工单流水号" />
	...
	<display:column property="sendTime" sortable="true"
		sortName="main.sendTime" headerClass="sortable" title="派单时间"
		format="{0,date,yyyy-MM-dd HH:mm:ss}" />
	<display:column property="sheetAcceptLimit" sortable="true"
		sortName="main.sheetAcceptLimit" headerClass="sortable" title="受理时限"
		format="{0,date,yyyy-MM-dd HH:mm:ss}" />

	<display:column property="sheetCompleteLimit" sortable="true"
		sortName="main.sheetCompleteLimit" headerClass="sortable" title="完成时限"
		format="{0,date,yyyy-MM-dd HH:mm:ss}" />

	<display:column sortable="true" headerClass="sortable" title="工单状态"
		sortName="main.status">
