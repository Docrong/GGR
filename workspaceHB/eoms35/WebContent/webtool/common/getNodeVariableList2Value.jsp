...
<head>
    ...
    <script language="javascript">
        ...
        function nametoparent(i) {
            ...
            opener.document.form1.value.value = "[@" + _name + ":" + vname + "]";
            window.close();
        }
    </script>
</head>
...
<form name="dbform" action="">
    <table class="list_table">
        ...
        <tr>
            <th>
                <input type="radio" id="vName<%=i%>" name="vName" value="<%=nameValue %>"
                       onclick="javascript:valuetoparent(<%=i%>)">
            </td>
            <td><%=nameValue%>
            </td>
        </tr>
        <tr id="khdm<%=i%>" style="display:none">
            <td class="nobg"></td>
            <th class="spec">请输入在此集合中字段的名称
