...
<fmt:bundle basename="config/statistic/netdata-config/ApplicationResources-statistic-netdata">
	<display:table name="estList" cellspacing="0" cellpadding="0"
		...
		decorator="com.boco.eoms.commons.statistic.netdata.util.NetdataStatListDisplayHelper">
	...
	<display:column property="sheetid" sortable="true"
		headerClass="sortable" titleKey="list.sheetid" href="${app}/sheet/netdata/netdata.do?method=showDetailPage" paramId="sheetKey" paramProperty="mainid"/>
