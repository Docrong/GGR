...
<form action="${app}/wap/WPSAction.do?method=performDeal" method="post">
  ...
  <input name="taskName" type="hidden" value='<%=(String) request.getAttribute("taskName")%>' />
   	<tr>
  ...
  <tr>
    <td class="list_text_03"><div class="div_all">
      ...
      <tr class="fb_xx_head_tr">
        <td class="tt_head_bg">理由: </td>
        <td class="fb_add_content"><textarea name="transferReason"></textarea></td>
      </tr>
     </table> 
    </div>
    </td>
	...
	<tr>
			    <td class="btn_bg">
			    	 <table>
					  		<tr>
					    	<td><input name="move" type="submit" class="btn_02" value="提交" /></td>  	
							  </tr>
							</table>
