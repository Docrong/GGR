...
<div id="sheetform">
    <html:form action="/businessdredgebroad.do?method=performTransferWorkItem" styleId="theform">
        ...
        <input type="hidden" name="${sheetPageName}beanId" id="${sheetPageName}beanId"
               value="iBusinessDredgebroadMainManager"/>
        <input type="hidden" name="${sheetPageName}mainClassName" id="${sheetPageName}mainClassName"
               value="com.boco.eoms.sheet.businessdredgebroad.model.businessdredgebroadMain"/> <!--main\u00e8\u00a1\u00a8Model\u00e5\u00af\u00b9\u00e8\u00b1\u00a1\u00e7\u00b1\u00bb\u00e5\u0090\u008d-->
        <input type="hidden" name="${sheetPageName}linkClassName" id="${sheetPageName}linkClassName"
               value="com.boco.eoms.sheet.businessdredgebroad.model.businessdredgebroadLink"/> <!--link\u00e8\u00a1\u00a8Model\u00e5\u00af\u00b9\u00e8\u00b1\u00a1\u00e7\u00b1\u00bb\u00e5\u0090\u008d-->
        ...
        <div class="form-btns">
            ...
            <input type="submit" class="submit"
                   onclick="v.passing=true;this.form.action='${app}/sheet/businessdredgebroad/businessdredgebroad.do?method=performSaveInfo'"
