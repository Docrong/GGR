...
from commonfault_link TOORGROLEID VARCHAR2(510) Y
    ACCEPTFLAG NUMBER (10) Y
    ACCEPTTIME TIMESTAMP (6)

select 1
from dual select to_char(null)
from dual

select null
from dual select to_date(null)
from dual
...
--common main
                                      ...
                                      SENDROLEID, SENDCONTACT, STATUS, HOLDSTATISFIED, ENDTIME, ENDUSERID, ENDDEPTID,
                                      ENDROLEID,
...
--bussines main
    , MAINAPPLYSHEETID, MAINIFURGENTFAULT, MAINURGENTFAULTLOG, MAINIFSAFE, MAINIFMUTUALCOMMUNICATION,
                                      MAINFAULTRESPONSELEVEL, MAINALARMNUM, MAINALARMSTATE, MAINALARMSOLVEDATE,
                                      MAINNETSORTONE, MAINEQUIPMENTFACTORY, MAINEQUIPMENTNAME, MAINEQUIPMENTMODEL,
                                      MAINFAULTGENERANTTIME, MAINFAULTGENERANTPRIV, MAINIFAFFECTOPERATION,
                                      MAINAFFECTSTARTTIME, MAINFAULTDISCOVERABLEMODE, MAINSENDMODE, MAINALARMID,
                                      MAINALARMSOURCE, MAINALARMLOGICSORT, MAINALARMLOGICSORTSUB, MAINFAULTSPECIALTY,
                                      MAINEQUIPMENTTYPE, MAINNETNAME, MAINCOMPLETELIMITT1, MAINCOMPLETELIMITT2,
                                      MAINCOMPLETELIMITT3, SENDORGTYPE, MAINFAULTGENERANTCITY, MAINNETSORTTWO,
                                      MAINNETSORTTHREE, MAINREJECTCOUNT, MAINDELAYFLAG, SENDYEAR, SENDMONTH, SENDDAY,
                                      MAINIFRECORD
--bussines link
    , LINKFAULTRESPONSELEVEL, LINKIFMUTUALCOMMUNICATION, LINKIFSAFE, LINKIFEXCUTENETCHANGE, LINKFAULTAVOIDTIME,
                                      ...
                                      LINKIFADDCASEDATABASE, LINKIFDEFERRESOLVE, LINKFAULTDEALINFO, OPERATEYEAR,
                                      OPERATEMONTH, OPERATEDAY
    ) as
    (
--�Ѵ���
        select
...
select *
from est_last_oper create table est_last_oper(
...
values (51, to_date('2007-07-07 00:00:00', 'YYYY-MM-DD HH24:MI:SS'), '���Ϲ���������ɼ�����һ�β�����ʱ��');
