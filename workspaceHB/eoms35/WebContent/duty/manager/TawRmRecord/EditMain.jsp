...
<%@ page
        import="java.util.*,java.lang.*, org.apache.struts.util.*,com.boco.eoms.duty.controller.TawRmRecordForm,com.boco.eoms.duty.model.TawRmDutyfile,com.boco.eoms.duty.model.TawRmRecord" %>
<%
...
<html:form method="post" action="/TawRmRecord/updatemain">
    ...
    <CENTER>
        ...
        <table border="0" width="85%" cellspacing="1" cellpadding="1" class="listTable" align=center>
            ...
            <TR class="tr_show">
                <TD noWrap rowSpan="5" align="center" class="label">&nbsp;<bean:message
                        key="TawRmRecord.baseinfo"/></TD>
            ...
            <TR class="tr_show">
                ...
                <TD colSpan="5">
                    ...
                    <input name="hander" id="hander" type="text" readOnly="" size="58"
            ...
            <TR class="tr_show">
                ...
                <TD colSpan="5">
                    ...
                    <input name="dutyman" id="dutyman" type="text" readOnly="" size="58"
            ...
            <TR class="tr_show">
                ...
                <TD colSpan="5">
                    ...
                    <input name="receiver" id="receiver" type="text" readOnly="" size="58"
            ...
            <TR class="tr_show">
                ...
                <TD>
                    <input name="starttime" type="text" readOnly="" size="18"
                ...
                <TD colSpan="3">
                    ...
                    <c:choose>
                        <c:when test="${requestScope['tawRmRecordForm'].flag == 0}">
                            <input name="flag" id="flag" type="text" class="clstext" readOnly="" size="12"
                                   value='<bean:message key="TawRmRecord.compltetNo" />'/>
                        </c:when>
                        <c:when test="${requestScope['tawRmRecordForm'].flag == 1}">
                            <input name="flag" id="flag" type="text" class="clstext" readOnly="" size="12"
                                   value='<bean:message key="TawRmRecord.compltetYes" />'/>
                        </c:when>
                    </c:choose>
                </TD>
            <TR class="tr_show">
                ...
                <TD><html:hidden property="weather"/><input name="tempStr" id="tempStr" type="text" class="clstext"
                                                            readOnly="" size="20"
                ...
                <TD><html:hidden property="temperature"/><input name="tempStr" id="tempStr" type="text" class="clstext"
                                                                readOnly="" size="5"
                ...
                <TD><html:hidden property="wet"/><input name="tempStr" id="tempStr" type="text" class="clstext"
                                                        readOnly="" size="5"
            ...
            <TR class="tr_show">
                ...
                <TD><html:hidden property="clean"/><input name="tempStr" id="tempStr" type="text" class="clstext"
                                                          readOnly="" size="10"
            ...
            <TR class="tr_show">
                ...
                <TD colSpan="8">
                    <TEXTAREA id=hangQuestion0 name=hangQuestion0 rows=4 cols=70
        ...
        <logic:iterate id="tawRmRecordSub" name="TAWRMRECORD_DUTYMAN" type="com.boco.eoms.duty.model.TawRmRecordSub">
            ...
            <TR class="tr_show">
                ...
                <TD noWrap align=left colSpan=6><TEXTAREA id="dutyrecord" name="dutyrecord" rows=6 cols=64><bean:write
            ...
            <TR class="tr_show">
                ...
                <TD colSpan=6><TEXTAREA id=notes name=notes rows=4 cols=64><bean:write name="tawRmRecordForm"
                                                                                       property="notes"
                    ...
                    <SPAN id=Customvalidator2 style="DISPLAY: none; COLOR: red"
                          ...
                          evaluationfunction="CustomValidatorEvaluateIsValid" display="Dynamic"
                          errormessage="<BR>"
                          controltovalidate="Notes"><BR></SPAN></TD>
            </TR>
            ...
            <TR>
                <TD align="center" height="32">
                    <input type="submit" name=
                        <bean:message key="label.save"/> class="button" value=
                        <bean:message key="label.save"/>>
                    <input type="button" name=
                        <bean:message key="label.back"/> class="button" value=
                               <bean:message key="label.back"/> onclick = "javascript:history.back();">
                </TD>
            </TR>
        </TABLE>
    </CENTER>
