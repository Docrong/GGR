...
<fmt:bundle basename="config/statistic/task-config/ApplicationResources-statistic-task">
	<display:table name="estList" cellspacing="0" cellpadding="0"
		...
		decorator="com.boco.eoms.commons.statistic.netchange.util.NetchangeListDisplayHelper">
<!--  
...
-->
	<display:column property="sheetid" sortable="true"
		headerClass="sortable" titleKey="list.sheetid" href="${app}/sheet/netchange/netchange.do?method=showDetailPage" paramId="sheetKey" paramProperty="mainid"/>
