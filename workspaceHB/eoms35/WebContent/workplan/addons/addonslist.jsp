...
<form name="form1" method="POST">
    <table width="600" class="listTable" id="list">
        ...
        <tr>
            ...
            <td>
                ...
                %>
                <a href='../addons/ntko/showDetail.jsp?path=<%=tawwpAddonsTableVO.getUrl()%>'><bean:message
                        key="addonslist.title.formView"/></a>

                <% } else {
                %> <a
                    href="addonsview.do?action=read&window=self&myid=&model=50&addonsid=<%=tawwpAddonsTableVO.getId()%>&reaction=/tawwpaddons/addonslist.do"><bean:message
                    key="addonslist.title.formView"/></a>
 ...
 --%><input type="button" Class="button" value="<bean:message key="addonslist.title.formAdd" />EXCEL"
            onclick="onAddExcel()">
    <br/>
</form>
<!--
