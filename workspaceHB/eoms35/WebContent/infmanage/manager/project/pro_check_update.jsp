        ...
        <table border="0" width="95%" cellspacing="1" cellpadding="1" class="table_show" align=center>
            ...
            <tr class="tr_show">
                ...
                <td width="75%" height="25">
                    <html:text styleClass="clstext" property="project_exec_time" readonly="false" size="20"
            ...
            <tr class="tr_show">
                ...
                <td width="75%" height="25">
                    <html:text property="project_sign" size="3" name="projectForm" styleClass="clstext"/>%
                </td>
                </td>
            </tr>
            ...
            <tr class="tr_show">
                ...
                <td width="75%" height="25">
                    <html:textarea property="pro_check_content" rows="4" style="width:100%" name="projectForm"
                                   title="问题描述"/>
                </td>
            </tr>
            <tr class="tr_show">
