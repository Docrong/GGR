...
<html:form method="post" action="/TawTestcardManager/save" onsubmit="return check(this);">
    <script type="text/javascript">
        Ext.onReady(function () {
            ...
            new xbox({
                btnId: 'sort1_userName',
                dlgId: 'dlg-audit',
                dlgTitle: '${eoms:a2u('è¯·éæ©äººå')}',
                treeDataUrl: userTreeAction,
                treeRootId: '-1',
                treeRootText: '${eoms:a2u('ææäººå')}',
                treeChkMode: 'single',
                treeChkType: 'user',
                showChkFldId: 'sort1_userName',
                saveChkFldId: 'sort1_userid'
            });
        })
        Ext.onReady(function () {
...
//}
    ...
    <table cellSpacing="0" borderColorDark="#808080" cellPadding="2" width="70%" class="listTable" border="1"
           align="center">
        <tr>
            <td colspan="4" height="25" valign="middle" class="label" align="center"><font
                    size="-1">${eoms:a2u("æµ è¯ å¡ å åº ç®¡ ç")}&nbsp&nbsp&nbsp&nbsp</font></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td width="20%">
                <html:text property="sort1_userName" styleId="sort1_userName"
                           ...
                           alt="allowBlank:false,vtext:'${eoms:a2u('è¯·éæ©åç¨äºº')}'"/>
        ...
        <tr>
            ...
            <td>
                <input type="text" name="leantime" size="30" value="<%=date%>"
            ...
            <td>
                <input type="text" name="belongtime" size="30" value="<%=aftertommorrow%>"
                       onclick="popUpCalendar(this, this,null,null,null,true,-1);" readonly="true"
