        ...
        <logic:present name="sheetMain" scope="request">
            ...
            <table class="formTable">
                <tr>
                    ...
                    <td colspan="3"><bean:write name="sheetMain" property="sheetCompleteLimit"
                                                formatKey="date.formatDateTimeAll" bundle="sheet" scope="request"/></td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="content"><eoms:id2nameDB id="${sheetMain.mainIsSecurity}"
                                                        beanId="ItawSystemDictTypeDao"/></td>
                </tr>
                <tr>
                    <td class="label"><bean:message bundle="softchange" key="softchange.mainAssortSpeciality"/></td>
                    <td colspan="3">
                        <eoms:invert appCode="softchange" sheetKey="${sheetMain.mainAssortSpeciality}"
                                     beanId="CacheBean" scope="page"/>
                    </td>
                </tr>
                <tr>
                    <td class="label"><bean:message bundle="softchange" key="softchange.mainIsConnect"/></td>
                    <td class="content"><eoms:id2nameDB id="${sheetMain.mainIsConnect}"
                                                        beanId="ItawSystemDictTypeDao"/></td>
                    <td class="label"><bean:message bundle="softchange" key="softchange.mainFactory"/></td>
                    <td class="content">
                        <c:forTokens items="${sheetMain.mainFactory}" delims="," var="mainFactory"
                ...
                <tr>
                    ...
                    <td class="content" colspan="3">
                        <pre><bean:write name="sheetMain" property="mainApplyReason" scope="request"/></pre>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="content" colspan="3">
                        <pre><bean:write name="sheetMain" property="mainCellInfo" scope="request"/></pre>
                    </td>
                </tr>

                <tr>
                    <td class="label"><bean:message bundle="softchange" key="softchange.mainSoftCDKey"/></td>
                    <td class="content"><eoms:id2nameDB beanId="ItawSystemDictTypeDao"
                                                        id="${sheetMain.mainSoftCDKey }"/></td>
                ...
                <tr>
                    ...
                    <td class="content" colspan="3">
                        <pre><bean:write name="sheetMain" property="mainSoftDetail" scope="request"/></pre>
                    </td>
                </tr>
                <tr>
                    <td class="label"><bean:message bundle="softchange" key="softchange.mainIsAllow"/></td>
                    <td class="content"><eoms:id2nameDB id="${sheetMain.mainIsAllow}"
                                                        beanId="ItawSystemDictTypeDao"/></td>
                ...
                <tr>
                    ...
                    <td class="content" colspan="3">
                        <pre><bean:write name="sheetMain" property="maincellinfo1" scope="request"/></pre>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="content"><eoms:id2nameDB beanId="ItawSystemDictTypeDao"
                                                        id="${sheetMain.mainsoftcdkey1 }"/></td>
                ...
                <tr>
                    ...
                    <td class="content" colspan="3">
                        <pre><bean:write name="sheetMain" property="mainsoftdetail1" scope="request"/></pre>
                    </td>
                </tr>
                <tr>
                    <td class="label"><bean:message bundle="softchange" key="softchange.mainIsAllow"/>1</td>
                    <td class="content"><eoms:id2nameDB id="${sheetMain.mainisallow1}"
                                                        beanId="ItawSystemDictTypeDao"/></td>
                ...
                <tr>
                    ...
                    <td class="content" colspan="3">
                        <pre><bean:write name="sheetMain" property="maincellinfo2" scope="request"/></pre>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="content"><eoms:id2nameDB beanId="ItawSystemDictTypeDao"
                                                        id="${sheetMain.mainsoftcdkey2 }"/></td>
                ...
                <tr>
                    ...
                    <td class="content" colspan="3">
                        <pre><bean:write name="sheetMain" property="mainsoftdetail2" scope="request"/></pre>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="content"><eoms:id2nameDB id="${sheetMain.mainIsBack}"
                                                        beanId="ItawSystemDictTypeDao"/></td>
                    <td class="label"><bean:message bundle="softchange" key="softchange.mainChangeSource"/></td>
                    <td class="content"><eoms:id2nameDB id="${sheetMain.mainChangeSource}"
                                                        beanId="ItawSystemDictTypeDao"/></td>
                </tr>

                <tr>
                    <td class="label"><bean:message bundle="softchange" key="softchange.mainParentProcessName"/></td>
                    <td class="content"><bean:write name="sheetMain" property="mainParentProcessName"
                                                    scope="request"/></td>
                    <td class="label"><bean:message bundle="softchange" key="softchange.mainIsNeedDesign"/></td>
                    <td class="content"><eoms:id2nameDB id="${sheetMain.mainIsNeedDesign}"
                                                        beanId="ItawSystemDictTypeDao"/></td>
                </tr>
            ...
            <tr>
                ...
                %>
                    ...
                    <select id="dealSelector">
                        ...
                        <option value="${urlShowProjectCreateTaskDealPage}"><bean:message bundle="softchange"
                                                                                          key="operateType.makeScheme"/></option>
                    ...
                    <select id="dealSelector">
                        ...
                        <%if (ifsub.equals("") || ifsub.equals("false")) {%>
                        <%if (ifwaitfor.equals("false")) {%>
                        <option value="${urlShowAuditTaskDealPage}"><bean:message bundle="softchange"
                    ...
                    <select id="dealSelector">
                        ...
                        <%if (ifsub.equals("") || ifsub.equals("false")) {%>
                        <%if (ifwaitfor.equals("false")) {%>
                        <option value="${urlShowPermitTaskDealPage}"><bean:message bundle="softchange"
                                                                                   key="operateType.permit"/></option>
                        <option value="${urlShowTransferAuditPage}"><bean:message bundle="sheet"
                                                                                  key="common.transferAudit"/></option>
                        <option value="${urlShowPhaseReplyPage}"><bean:message bundle="sheet"
                                                                               key="event.reply"/></option>
                    ...
                    <select id="dealSelector">
                        ...
                        <%if (ifsub.equals("") || ifsub.equals("false")) {%>
                        <%if (ifwaitfor.equals("false")) {%>
                        <option value="${urlShowPlanTaskDealPage}"><bean:message bundle="softchange"
                                                                                 key="operateType.make"/></option>
                        <option value="${urlShowTransferkPage}"><bean:message bundle="sheet"
                                                                              key="common.transfer"/></option>
                        <option value="${urlShowPhaseReplyPage}"><bean:message bundle="sheet"
                                                                               key="event.reply"/></option>
                    ...
                    <select id="dealSelector">
                        ...
                        <%if (ifsub.equals("") || ifsub.equals("false")) {%>
                        <%if (ifwaitfor.equals("false")) {%>
                        <option value="${urlShowExecuteTaskDealPage}"><bean:message bundle="softchange"
                    ...
                    <select id="dealSelector">
                        ...
                        <%if (ifsub.equals("") || ifsub.equals("false")) {%>
                        <%if (ifwaitfor.equals("false")) {%>
                        <option value="${urlShowValidateTaskDealPage}"><bean:message bundle="softchange"
                                                                                     key="operateType.checkResult"/></option>
                        <option value="${urlShowTransferkPage}"><bean:message bundle="sheet"
                                                                              key="common.transfer"/></option>
                        <option value="${urlShowPhaseReplyPage}"><bean:message bundle="sheet"
                                                                               key="event.reply"/></option>
                    ...
                    <select id="dealSelector">
                        <option value="${urlShowDraftDeal}"><bean:message bundle="softchange"
                    ...
                    <select id="dealSelector">
                        <option value="${urlShowHoldDealPage}"><bean:message bundle="softchange"
