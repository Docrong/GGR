    ...
    <script type="text/javascript">
        var config = {
            ...
            ctxMenu: [
                {
                    id: 'newnode',
                    text: '<fmt:message key="kmTableGeneral.tree.add"/>',
                    cls: 'new-mi',
                    url: '${app}/kmmanager/kmTableColumns.do?method=add&nodeId=${tableId}'
                },
                {
                    id: 'edtnode',
                    text: '<fmt:message key="kmTableGeneral.tree.update"/>',
                    cls: 'edit-mi',
                    url: '${app}/kmmanager/kmTableColumns.do?method=edit&nodeId='
                },
                {
                    id: 'delnode',
                    isDelete: true,
                    text: '<fmt:message key="kmTableGeneral.tree.delete"/>',
                    cls: 'remove-mi',
                    url: '${app}/kmmanager/kmTableColumns.do?method=remove&nodeId='
                }
            ],//end of ctxMenu
            /************************
