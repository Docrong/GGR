  ...
  <div id="sheetinfo">
	...
	<table class="formTable"> 
	  ...
	  <td class="label"><bean:message bundle="netFault" key="netFault.Specialty"/>*</td>
		<td  colspan="3" class="content"><eoms:id2nameDB id="${sheetMain.specialty}" beanId="ItawSystemDictTypeDao"/></td>
	  </tr>
...
<!--			    <option value="${urlShowRejectBackPage}"><bean:message bundle="sheet" key="common.rejectBack"/></option>-->
		...
		<%}else if(taskName.equals("DraftTask")){%>	
			<select id="dealSelector">
			  <option value="${urlShowDraftDeal}"><bean:message bundle="netFault" key="operateType.draft"/></option>
			</select>
		...
		<%}else if(taskName.equals("HoldTask")){ %>
			<select id="dealSelector">
			  <option value="${urlShowHoldDealPage}"><bean:message bundle="netFault" key="operateType.hold"/></option>
			</select>		
		<%} %>
		</td>
		</tr>
