...
<table class="formTable">
    ...
    <tr>
        ...
        <td>
            <input type="text" class="text" name="approveResult" id="approveResult"
                   alt="allowBlank:false,maxLength:1000,vtext:'请填入 审核结果 信息，最多输入 1000 字符'"
                   value="${sheetLink.approveResult}"/>
        </td>
        ...
        <td>
            <input type="text" class="text" name="approveOpinion" id="approveOpinion"
                   alt="allowBlank:false,maxLength:1000,vtext:'请填入 审核意见 信息，最多输入 1000 字符'"
                   value="${sheetLink.approveOpinion}"/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <input type="text" class="text" name="dataResult" id="dataResult"
                   alt="allowBlank:false,maxLength:1000,vtext:'请填入 数据制作结果 信息，最多输入 1000 字符'"
                   value="${sheetLink.dataResult}"/>
        </td>
        ...
        <td>
            <input type="text" class="text" name="failureInfo" id="failureInfo"
                   alt="allowBlank:false,maxLength:1000,vtext:'请填入 数据制作失败原因 信息，最多输入 1000 字符'"
                   value="${sheetLink.failureInfo}"/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <input type="text" class="text" name="groupNumber" id="groupNumber"
                   alt="allowBlank:false,maxLength:64,vtext:'请填入 集团批复工单号 信息，最多输入 64 字符'"
                   value="${sheetMain.groupNumber}"/>
        </td>
    </tr>
    <%}%>
...
<fieldset>
    ...
    <div class="x-form-item">
        ...
        <eoms:chooser id="AuditHumTask0" type="role" roleId="1862" flowId="616"
...
<fieldset>
    ...
    <div class="x-form-item">
        ...
        <eoms:chooser id="DataHumTask0" type="role" roleId="1860" flowId="616"
                      config="{returnJSON:true,showLeader:true}"
                      category="[{id:'dealPerformer',text:'派发',limit:'none',allowBlank:false,vtext:'请选择派发对象'},{id:'copyPerformer',childType:'user,subrole',limit:'none',text:'抄送'}]"
                      data="${sendUserAndRoles}"/>
