        ...
        <table border="0" width="95%" cellspacing="0">
            ...
            <tr>
                <td width="106%" class="table_title" align="center">
                    <center><%=name%>----新增项目子任务信息(剩余可分配比例<font color="red"><%=rest%>%</font>)</center>
                </td>
            </tr>
        </table>
        <table border="0" width="95%" cellspacing="1" cellpadding="1" class="table_show" align=center>
            ...
            <tr class="tr_show">
                ...
                <td width="75%" height="25">
                    ...
                    不得早于 <font color="red"><%=exec_time.substring(0, 10)%>
                </font></td>
            ...
            <tr class="tr_show">
                ...
                <td width="75%" height="25">
                    <html:text styleClass="clstext" property="task_comp_time" readonly="true" size="20"
                               onfocus="setday(this)"/><font color=crimson>*</font>
                    不得晚于 <font color="red"><%=comp_time.substring(0, 10)%>
                </font></td>
            ...
            <tr class="tr_show">
                ...
                <td width="70%" height="25">
                    <html:text property="task_scale" value="" size="2" styleClass="clstext"/>%
                </td>
            </tr>
            <tr class="tr_show">
                <td width="25%" height="25" class="clsfth">
