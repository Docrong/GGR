...
%>
<%@ include file="/WEB-INF/pages/wfworksheet/commontask/baseinputmainhtmlnew.jsp" %>
<script type="text/javascript">
    ...
    function selectLimit() {
        Ext.Ajax.request({
            method: "get",
            url: "commontask.do?method=newShowLimit&flowName=CommonTaskMainFlowProcess",
            success: function (x) {
...
<input type="hidden" name="${sheetPageName}sheetTemplateName" value="CommonTaskMainFlowProcess"/>
