        ...
        <logic:iterate id="baselink" name="HISTORY" type="com.boco.eoms.sheet.complaintDuban.model.ComplaintDubanLink">
            ...
            <div class="history-item"><!-- add space to hack ie-->&nbsp;
                <div class="history-item-title">
                    ...
                    <eoms:dict key="dict-sheet-complaintDuban" dictId="activeTemplateId"
                    ...
                    <eoms:dict key="dict-sheet-complaintDuban" dictId="mainOperateType" itemId="${baselink.operateType}"
                ...
                <div class="history-item-content hide">
  			      ...
  			      <%} %> -->
                        ...
                        <tr>
                            ...
                            <td class="column-content">
                                <eoms:dict key="dict-sheet-complaintDuban" dictId="mainOperateType"
                        ...
                        <tr>
                            <td class="column-title">
                                <bean:message bundle="complaintDuban" key="complaintDuban.linkAuditResult"/>
                            </td>
                        ...
                        <tr>
                            <td class="column-title">
                                <bean:message bundle="complaintDuban" key="complaintDuban.linkAuditIdea"/>
                            </td>
                            <td class="column-content" colspan="3">
                        ...
                        <tr>
                            <td class="label"><bean:message bundle="complaintDuban"
                                                            key="complaintDuban.linkTaskComplete"/></td>
                            <td class="column-content" colspan="3">
                        ...
                        <tr>
                            <td class="column-title">
                                <bean:message bundle="complaintDuban" key="complaintDuban.fenpairesion"/>
                            </td>
                            <td class="column-content" colspan="3">
                                <pre><bean:write name="baselink" property="linkTaskComplete" scope="page"/></pre>
                            </td>
                        ...
                        <tr>
                            <td class="column-title">
                                <bean:message bundle="complaintDuban" key="complaintDuban.yijiaoresion"/>
                            </td>
                            <td class="column-content" colspan="3">
                                <pre><bean:write name="baselink" property="linkTaskComplete" scope="page"/></pre>
                            </td>
                        ...
                        <tr>
                            <td class="column-title">
                                <bean:message bundle="complaintDuban" key="complaintDuban.advice"/>
                            </td>
                            <td class="column-content" colspan=3>
                                <pre><bean:write name="baselink" property="linkTaskComplete" scope="page"/></pre>
                            </td>
