<%@ page language="java"
         import="com.boco.eoms.base.util.ApplicationContextHolder,com.boco.eoms.extra.supplierkpi.webapp.util.SupplierkpiAttributes" %>
...
<script type="text/javascript">
    var config = {
        ...
        ctxMenu: [
            {
                id: 'NewItem',
                text: '${eoms:a2u('新建评估指标项')}',
                cls: 'new-mi',
                url: '<c:url value="/supplierkpi/editTawSupplierkpiItem.do?dictId=" />'
            },
            {
                id: 'edtnode',
                text: '${eoms:a2u('修改评估指标项')}',
                cls: 'edit-mi',
                url: '<c:url value="/supplierkpi/editTawSupplierkpiItem.do?method=update&dictId=" />'
            },
            {
                id: 'View',
                text: '${eoms:a2u('查看评估指标项')}',
                cls: 'edit-mi',
                url: '<c:url value="/supplierkpi/editTawSupplierkpiItem.do?method=view&dictId=" />'
            },
            {
                id: 'NewItemType',
                text: '${eoms:a2u('新建项目类型')}',
                cls: 'new-mi',
                url: '<c:url value="/supplierkpi/editTawSupplierkpiTemplate.do?method=addItemType&parentDictId=" />'
            },
            {
                id: 'EditItemType',
                text: '${eoms:a2u('修改项目类型')}',
                cls: 'edit-mi',
                url: '<c:url value="/supplierkpi/editTawSupplierkpiItemType.do?parentDictId=" />'
            },
            {
                id: 'delnode',
                isDelete: true,
                text: '${eoms:a2u('删除')}',
                cls: 'remove-mi',
                url: '<c:url value="/supplierkpi/editTawSupplierkpiItem.do?method=delete&id=" />'
            }
        ],//end of ctxMenu
        /************************
