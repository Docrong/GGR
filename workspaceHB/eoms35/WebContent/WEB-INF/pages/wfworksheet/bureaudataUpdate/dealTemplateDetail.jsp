...
<%@ include file="/WEB-INF/pages/wfworksheet/bureaudataUpdate/baseinputlinkhtmlnew.jsp"%>
 <html:form action="/bureaudataUpdate.do" styleId="theform">       
	<br/>
               ...
               <input type="hidden" name="${sheetPageName}mainClassName" value="com.boco.eoms.sheet.bureaudataUpdate.model.bureaudataUpdateMain"/>	
               <input type="hidden" name="${sheetPageName}linkClassName" value="com.boco.eoms.sheet.bureaudataUpdate.model.bureaudataUpdateLink"/> 
			  ...
			  <tr>
	            ...
	            <tr>
  						<td class="label"><bean:message bundle="sheet" key="linkForm.accessories"/></td>
		   				 <td  colspan='3'>
		   				 <eoms:attachment idList="" scope="request" idField="${sheetPageName}nodeAccessories" name="sheetLink" property="nodeAccessories" appCode="bureaudataUpdate" alt="allowBlank:true"/>
		                </td>
		         </tr>  		    	  
         <%}} %>
