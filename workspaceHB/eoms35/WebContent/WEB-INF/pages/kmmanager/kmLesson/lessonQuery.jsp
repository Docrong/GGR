    ...
    <fmt:bundle basename="com/boco/eoms/km/config/applicationResource-kmmanager">
        ...
        <table class="formTable">
            ...
            <tr>
                ...
                <td class="content" colspan="2">
                    <input type="text" id="subjectName" name="subjectName" class="text" maxlength="20" value=""
                           alt="allowBlank:true"/>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="content" colspan="2">
                    <input type="text" name="theme" id="theme" value="" maxlength="20" class="text"
                           alt="allowBlank:true"/>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="content" colspan="2">
                    <input type="text" name="businessType" id="businessType" value="" maxlength="10" class="text"
                           alt="allowBlank:true"/>
                </td>
            </tr>
        ...
        <table>
            <tr>
                <td>
                    <input type="submit" class="btn" value="<fmt:message key="creatlesson.search"/>"
