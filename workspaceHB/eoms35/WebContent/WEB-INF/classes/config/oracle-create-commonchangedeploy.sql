...
values ('xls,txt,doc,jpg,gif', 'commonchangedeploy', '通用变更配置工单流程', 1024, '/sheet/commonchangedeploy', 127,
        '8aa0829921d201ca0121d201ca420000');

--插入菜单


insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('8aa0829921d201ca0121d201ca420001', '120301', '1', '新增工单', '1203', null,
        '/sheet/commonchangedeploy/commonchangedeploy.do?method=newShowNewInputSheetPage', '0', '0', 1);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('8aa0829921d201ca0121d201ca420002', '120303', '0', '待处理工单', '1203', null, null, '0', '0', 3);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('8aa0829921d201ca0121d201ca420003', '12030301', '1', '待办工单', '120303', null,
        '/sheet/commonchangedeploy/commonchangedeploy.do?method=newShowListsendundo', '0', '0', 1);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('8aa0829921d201ca0121d201ca420004', '120307', '1', '工单查询', '1203', null,
        '/sheet/commonchangedeploy/commonchangedeploy.do?method=newShowQueryPage', '0', '0', 7);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('8aa0829921d201ca0121d201ca420005', '120308', '1', '工单处理模板', '1203', null,
        '/sheet/commonchangedeploy/commonchangedeploy.do?method=newGetDealTemplatesByUserId&type=templateManage', '0',
        '0', 8);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('8aa0829921d201ca0121d201ca420006', '120309', '1', '工单模板管理', '1203', null,
        '/sheet/commonchangedeploy/commonchangedeploy.do?method=newGetTemplatesByUserId&type=templateManage', '0', '0',
        9);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('8aa0829921d201ca0121d201ca420007', '120310', '1', '管理者工单', '1203', null,
        '/sheet/commonchangedeploy/commonchangedeploy.do?method=newShowListForAdmin', '0', '0', 10);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('8aa0829921d201ca0121d201ca420008', '1203', '0', '通用变更配置工单', '10', null,
        '/sheet/commonchangedeploy/commonchangedeploy.do?method=newShowDrawing', '0', '0', 20);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('8aa0829921d201ca0121d201ca420009', '120302', '1', '草稿列表', '1203', null,
        '/sheet/commonchangedeploy/commonchangedeploy.do?method=newShowDraftList', '0', '0', 2);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('8aa0829921d201ca0121d201ca42000a', '120304', '0', '已处理工单', '1203', null, null, '0', '0', 4);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('8aa0829921d201ca0121d201ca42000b', '12030402', '1', '建立工单', '120304', null,
        '/sheet/commonchangedeploy/commonchangedeploy.do?method=newShowOwnStarterList', '0', '0', 2);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('8aa0829921d201ca0121d201ca42000c', '12030401', '1', '处理工单', '120304', null,
        '/sheet/commonchangedeploy/commonchangedeploy.do?method=newShowListsenddone', '0', '0', 1);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('8aa0829921d201ca0121d201ca42000d', '120305', '1', '已归档工单', '1203', null,
        '/sheet/commonchangedeploy/commonchangedeploy.do?method=newShowHoldedList', '0', '0', 5);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('8aa0829921d201ca0121d201ca42000e', '120306', '1', '已作废工单', '1203', null,
        '/sheet/commonchangedeploy/commonchangedeploy.do?method=newShowCancelList', '0', '0', 6);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('8aa0829921d201ca0121d201ca42000f', '120311', '1', '超时时间设置', '1203', null,
        '/sheet/overtimetip/overtimetip.do?flowName=EmergencyDrillProcess', '0', '0', 11);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('8aa0829921d201ca0121d201ca420010', '120312', '1', '工单处理时限配置', '1203', null,
        '/sheet/newSheetLimit/sheetLimit.do?method=getLevelLimitList&flowName=EmergencyDrillProcess', '0', '0', 30);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('8aa0829921d201ca0121d201ca420011', '120313', '1', '配置后续处理对象', '1203', null,
        '/sheet/dealtypeconfig/dealtypeconfig.do?flowName=EmergencyDrillProcess', '0', '0', 12);


--插入角色
insert into TAW_SYSTEM_ROLE (ROLE_ID, DELETED, DEPT_ID, LEVEL_ID, LIMIT_COUNT, NOTES, PARENT_ID, ROLE_NAME, ROLETYPE_ID,
                             SINGLE_ID, STRUCTURE_FLAG, TITLE_ID, WORKFLOW_FLAG, LEAF, POSTID, WORKFLOW_FLAG1)
