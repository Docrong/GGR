...
<%
com.boco.eoms.sheet.resourceconfirm.model.ResourceConfirmLink  resourceconfirmLink = (com.boco.eoms.sheet.resourceconfirm.model.ResourceConfirmLink)request.getAttribute("sheetLink");
 java.lang.String taskName = com.boco.eoms.base.util.StaticMethod.nullObject2String(resourceconfirmLink.getActiveTemplateId());
 java.lang.String operateType = java.lang.String.valueOf(com.boco.eoms.base.util.StaticMethod.nullObject2String(resourceconfirmLink.getOperateType()));
 %>
...
function saveDealTemplate(type) { 
   	...
   	form.action = "${app}/sheet/resourceconfirm/resourceconfirm.do?method=saveDealTemplate&type=dealTemplateManage&dealTemplateId=${sheetLink.id}";
   	form.submit();
 }
...
<%@ include file="/WEB-INF/pages/wfworksheet/resourceconfirm/baseinputlinkhtmlnew.jsp"%>
 <html:form action="/resourceconfirm.do" styleId="theform">       
	<br/>
     ...
     <table class="formTable">
     		<caption><bean:message bundle="resourceconfirm" key="resourceconfirm.header"/></caption>
		<tr>
           <td class="label" >
...
<c:if test="${sheetMain.mainspecialtyType==101220102}">
     	       ...
     	       <tr>
     		<!-- 组网方案拓扑图  -->
	     		<td class="label"><bean:message bundle="resourceconfirm" key="resourceconfirm.linkProgramTopology"/>*</td>
	     		<td colspan="3">
	     			<eoms:attachment name="sheetLink" property="linkProgramTopology" 
	              scope="request" idField="${sheetPageName}linkProgramTopology" appCode="resourceconfirm" alt="allowBlank:false"/>
				 </td>
		     </tr>         		    	      
         <%}} %>
