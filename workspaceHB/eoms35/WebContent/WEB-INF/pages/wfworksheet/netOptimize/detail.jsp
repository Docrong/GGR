	    ...
	    <select id="dealSelector" >
			 ...
			 <%} else if(taskStatus.equals(Constants.TASK_STATUS_CLAIMED)){%>
			 	  ...
			 	  <%if(ifsub.equals("") || ifsub.equals("false")){%>
					  ...
					  <option value="${urlShowRequirementAcceptPage}"><bean:message bundle="netOptimize" key="operateType.requirementAccept"/> </option>
			 ...
			 <%}else { %>
			 		...
			 		<!-- 不需要等待回复 -->
			 	  	<% if (ifwaitfor.equals("false")) {%>
			 			<option value="${urlShowDispatchPage}"><bean:message bundle="netOptimize" key="operateType.subTaskReply"/></option>
			 		<%}%>
			 <% } %>
        ...
        <select id="dealSelector" >
			 ...
			 <%} else if(taskStatus.equals(Constants.TASK_STATUS_CLAIMED)){%>
			 	  ...
			 	  <%if(ifsub.equals("") || ifsub.equals("false")){%>
			 	  	...
			 	  	<% if (ifwaitfor.equals("false")) {%>
					  <!-- 流程步骤，移交，阶段回复，分派 -->
					  <option value="${urlShowCommitAuditPage}"><bean:message bundle="netOptimize" key="operateType.audit"/></option>
					  <option value="${urlShowTransferkPage}"><bean:message bundle="sheet" key="common.transfer"/></option>
					  <option value="${urlShowPhaseReplyPage}"><bean:message bundle="sheet" key="event.reply"/></option>
			 		<% }%>
			 <%}else { %>
	     ...
	     <select id="dealSelector" >
			 ...
			 <%} else if(taskStatus.equals(Constants.TASK_STATUS_CLAIMED)){%>
			 	  ...
			 	  <%if(ifsub.equals("") || ifsub.equals("false")){%>
			 	  	...
			 	  	<% if (ifwaitfor.equals("false")) {%>
					  <!-- 流程步骤，移交，阶段回复，分派 -->
					  <option value="${urlShowAuditSchemePage}"><bean:message bundle="netOptimize" key="operateType.auditscheme"/></option>
	  ...
	  <%}}else if(taskName.equals("ExcuteTask")){%>	
	    <select id="dealSelector" >
			 ...
			 <%} else if(taskStatus.equals(Constants.TASK_STATUS_CLAIMED)){%>
			 	  ...
			 	  <%if(ifsub.equals("") || ifsub.equals("false")){%>
			 	  	...
			 	  	<% if (ifwaitfor.equals("false")) {%>
					  <!-- 流程步骤，移交，阶段回复，分派 -->
					    <option value="${urlShowFeedBackPage}"><bean:message bundle="netOptimize" key="operateType.feedback"/></option>
					    <option value="${urlShowTransferkPage}"><bean:message bundle="sheet" key="common.transfer"/></option>
					    <option value="${urlShowPhaseReplyPage}"><bean:message bundle="sheet" key="event.reply"/></option>
			 		<% }%>
			 <%}else { %>
       ...
       <%}}else if(taskName.equals("ResultEvaluateTask")){%>	
          <select id="dealSelector" >
			 ...
			 <%} else if(taskStatus.equals(Constants.TASK_STATUS_CLAIMED)){%>
			 	  ...
			 	  <%if(ifsub.equals("") || ifsub.equals("false")){%>
			 	  	...
			 	  	<% if (ifwaitfor.equals("false")) {%>
					  <!-- 流程步骤，移交，阶段回复，分派 -->
					     <option value="${urlShowCheckPage}"><bean:message bundle="netOptimize" key="operateType.checkFeedback"/></option>
					     <option value="${urlShowTransferkPage}"><bean:message bundle="sheet" key="common.transfer"/></option>
					     <option value="${urlShowPhaseReplyPage}"><bean:message bundle="sheet" key="event.reply"/></option>
			 		<% }%>
			 <%}else { %>
		...
		<%}}else if(taskName.equals("HoldTask")){ %>
	 	<select id="dealSelector" >
		    <option value="${urlShowHoldPage}"><bean:message bundle="netOptimize" key="operateType.hold"/></option>
	    </select>	
	    <%}else if(taskName.equals("rejectTask")){%>	
		<select id="dealSelector">
		  <option value="${urlShowDraftDealPage}"><bean:message bundle="netOptimize" key="operateType.reSend"/></option>
		  <option value="${urlNullityDeal}"><bean:message bundle="netOptimize" key="operateType.nullity"/></option>
		</select>		
	    <%}else if(taskName.equals("draftTask")){ %>
		 <select id="dealSelector" >
	        <option value="${urlDraftDeal}"><bean:message bundle="netOptimize" key="operateType.draft"/></option>
