...
function showPage(){
     var pars = '';
     var url = '';    
      url = '${app}/sheet/securityevaluate/securityevaluate.do?method=showInputRejectPage&piid=${sheetMain.piid}&taskId=${taskId}&taskName=${taskName}';
     if (url!=''){
...
<div id="sheetform">
<html:form action="/securityevaluate.do?method=performDeal" styleId="theform">
