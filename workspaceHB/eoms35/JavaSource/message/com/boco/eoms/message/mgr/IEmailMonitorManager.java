...
public interface IEmailMonitorManager extends Manager {
     ...
     * @param buzId           具体调用消息服务的业务流水号，如：作业计划id（主键），主要为取消消息发送
     * @param orgIds          系统组织（用户，角色，部门）ids,id与typ成对出现，中间以逗号相隔，多条之间以井号出现，如：userId,1#roleId,2
     * @param accessoriesUrls 邮件的附件路径 格式为文件的绝对路径#文件的真实名字，每个附件间用","连接，例如：http://10.32.1.23:8087/eoms/呵呵.txt#呵呵.txt,http://10.32.1.23:8087/eoms/duty/model/new/21/20080617145328.xls#fgsfd.xls
     * @return success, fail（成功与否）
     */
