    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%" align="center" height="100%">
        <tr>
            <td colspan="3" height="28">
                <table width="100%" border="0" cellspacing="0" cellpadding="0"
                       background="../images/shitu/main-top_02.gif" class="p9">
                    <tr>
                        <td width="11"><img src="../images/main-top_01.gif" width="14" height="33"></td>
                        <td valign="middle" nowrap><img width="200" height="0"><br>&nbsp
                            <a href=javascript:self.location="design.do?roomId=<%=roomId%>&nodeId=<%=nodeId%>&Name=<%=nodeName%>&cycle=<%=cycles%>&specility=<%=specility%>"><img
                                    src="../images/reply.gif" align="absmiddle" border="0">返回</a>
                            　　
                        </td>
        ...
        <tr>
            ...
            <td valign="top" width="2000">
                <div id="Layer1" class=mainsheet align=center
                     style="position:relative; left:2px; top:0px; width:expression(document.body.clientWidth-2); height:100%; z-index:1; overflow: auto">
                    <table width=99% border="1" cellspacing="1" cellpadding="1" align="center" style=font-size:9pt
                           bordercolor="#3535FF">
                        <tr bgcolor="#FFFFFF">
                            <td width="10%" class="text-a" align="left">作业名称</td>
                            <td colspan=3 align="left"><%=nodeName%>
                            </td>
                        </tr>
                        <tr bgcolor="#FFFFFF">
                            <td width="10%" class="text-a" align="left">专业</td>
                            <td width="40%" align="left"><%=specility%>
                            </td>
                            <td width="10%" class="text-a" align="left">作业类型</td>
                            <td width="40%" align="left"><%=getCycleName(cycles)%>
                            </td>
                        </tr>
                    </table>
                    <br>
