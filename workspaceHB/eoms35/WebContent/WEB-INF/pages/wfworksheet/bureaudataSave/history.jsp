			  ...
			  <tr>
				  <td colspan="4">
				  	<table class="formTable" >
				          <tr>
				            <td class="label" style="text-align:center">${eoms:a2u('启始号段')}</td>
				            <td class="label" style="text-align:center">${eoms:a2u('终止号段')}</td>
				            <td class="label" style="text-align:center">${eoms:a2u('HLR名称')}</td>
				            <td class="label" style="text-align:center">${eoms:a2u('HLR信令点')}</td>
				            <td class="label" style="text-align:center">${eoms:a2u('HLR编号')}</td>
				          </tr>
				          <%
			   ...
			   <tr>
	  				  <td class="column-title">
	  				     <bean:message bundle="sheet" key="linkForm.auditOpinion"/>
	  				  </td>
	  				  <td class="column-content" colspan=3>
		  ...
		  <%if(baselink.getOperateType()!=null && baselink.getOperateType().intValue() == 18){%>
	                <tr>
  						<td class="label"><bean:message bundle="sheet" key="linkForm.accessories"/></td>
		   				 ...
		   				 idField="${sheetPageName}nodeAccessories" appCode="bureaudataSave" 
		   				 viewFlag="Y"/>
		                </td>
		            </tr>		  		 
			 <%}}%>			 				
