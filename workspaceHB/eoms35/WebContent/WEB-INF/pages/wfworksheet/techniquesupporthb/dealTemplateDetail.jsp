		...
		<%} %>      
         ...
         <%if(taskName.equals("DoneImplTask")){%>
		 	  ...
		 	  <tr>
			    ...
			    <td colspan="3">
			      <textarea class="textarea max"  name="${sheetPageName}linkDealOpinion" id="${sheetPageName}linkDealOpinion" 
         ...
         <%}else if(taskName.equals("ExecuteTask")){ %>
			 ...
			 <tr>
			  ...
			  <td class="content" >
			  	<eoms:comboBox name="${sheetPageName}linkAccountType" id="${sheetPageName}linkAccountType" initDicId="1011501" defaultValue="${sheetLink.linkAccountType}" styleClass="select"/>
			  </td>
			  <td class="label">æ¯å¦å¼éæå</td>
			  <td class="content" >
				<eoms:comboBox name="${sheetPageName}linkIfDredge" id="${sheetPageName}linkIfDredge" initDicId="10301" defaultValue="${sheetLink.linkIfDredge}" styleClass="select"/>
			  </td>
			</tr>			 
		 	  ...
		 	  <tr>
			    ...
			    <td colspan="3" class="content">
			      <textarea class="textarea max"  name="${sheetPageName}linkDredgeDesc" id="${sheetPageName}linkDredgeDesc" 
         ...
         <%}else if(taskName.equals("AcceptReply")){%>
   		    ...
   		    <%if(operateType.equals("201")||operateType.equals("11")){ %>
		           ...
		           <td class="content">
		              <input class="text" onclick="popUpCalendar(this, this)" type="text" 
		                 ...
		                 readonly="readonly" value="${eoms:date2String(sheetLink.nodeAcceptLimit)}" alt="vtype:'lessThen',link:'${sheetPageName}nodeCompleteLimit',vtext:'åçæ¶éä¸è½æäºå¤çæ¶é',allowBlank:false"/>
		           ...
		           <td class="content"> 
		            <input class="text" onclick="popUpCalendar(this, this)" type="text" 
		               name="${sheetPageName}nodeCompleteLimit" readonly="readonly" 
		                  value="${eoms:date2String(sheetLink.nodeCompleteLimit)}" id="${sheetPageName}nodeCompleteLimit" alt="vtype:'moreThen',link:'${sheetPageName}nodeAcceptLimit',vtext:'å¤çæ¶éä¸è½æ©äºåçæ¶é',allowBlank:false"/>
		           </td>
				  </tr>
			 	  ...
			 	  <tr>
				    ...
				    <td colspan="3">
				      <textarea class="textarea max"  name="${sheetPageName}linkTransmitReason" id="${sheetPageName}linkTransmitReason" 
			 ...
			 <tr>
				  ...
				  <td >
				  	<input type="text" class="text" name="${sheetPageName}linkNdeptContact" id="${sheetPageName}linkNdeptContact" value="${sheetLink.linkNdeptContact}"
				  	 alt="allowBlank:true,maxLength:50"/>
				  </td>
			
				  <td class="label">ç½ç»é¨é¨èç³»äººçµè¯</td>
				  <td >
					<input type="text" class="text" name="${sheetPageName}linkNdeptContactPhone" id="${sheetPageName}linkNdeptContactPhone" value="${sheetLink.linkNdeptContactPhone}"
					 alt="allowBlank:true,maxLength:50"/>
				  </td>
				</tr>	
			  ...
			  <td class="content" colspan='3'>
			  	<eoms:comboBox name="${sheetPageName}linkResBuildType" id="${sheetPageName}linkResBuildType" initDicId="1011506" defaultValue="${sheetLink.linkResBuildType}" styleClass="select"/>
			  </td>
			</tr>			 
