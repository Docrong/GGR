  ...
  <div id="sheetinfo">
	...
	<table class="formTable"> 
      ...
      <tr>
		...
		<td class="content" colspan="3"><eoms:id2nameDB id="${sheetMain.mainNetSortThree}" beanId="ItawSystemDictTypeDao"/></td>
	  </tr> 
      <tr>
	   ...
	   <%}else if(taskStatus.equals(Constants.TASK_STATUS_CLAIMED)){ %>
	     <%if(ifsub.equals("") || ifsub.equals("false")){%>
	      <%if(ifwaitfor.equals("false")) {%>
	        <option value="${urlShowMakeTaskDealPage}"><bean:message bundle="greatevent" key="operateType.MakeTask"/> </option>
		 ...
		 <%if(ifsub.equals("") || ifsub.equals("false")){%>
		 <%if(ifwaitfor.equals("false")) {%>
		   <option value="${urlShowAuditTaskDealPage}"><bean:message bundle="greatevent" key="operateType.AuditTask"/> </option>
		...
		<%}else if(taskName.equals("ApprovalTask")){%>	
		 ...
		 <%if(ifsub.equals("") || ifsub.equals("false")){%>
		 <%if(ifwaitfor.equals("false")) {%>
		   <option value="${urlShowApprovalTaskDealPage}"><bean:message bundle="greatevent" key="operateType.ApprovalTask"/> </option>
		   <option value="${urlShowTransferAuditPage}"><bean:message bundle="sheet" key="common.transferAudit"/></option>
		   <option value="${urlShowPhaseReplyPage}"><bean:message bundle="sheet" key="event.reply"/></option>
			<%}%>
		  <%}else{%> 
		...
		<select id="dealSelector">
		 ...
		 <%if(ifsub.equals("") || ifsub.equals("false")){%>
		 <%if(ifwaitfor.equals("false")) {%>
		  <option value="${urlShowPerformTaskDealPage}"><bean:message bundle="greatevent" key="operateType.PerformTask"/></option>	  
		  <option value="${urlShowTransferkPage}"><bean:message bundle="sheet" key="common.transfer"/></option>	
		  <option value="${urlShowPhaseReplyPage}"><bean:message bundle="sheet" key="event.reply"/></option>
		  <%}%>
		  <%}else{%> 
		...
		<%}else if(taskName.equals("AuditEndTask")){%>	
		 ...
		 <%if(ifsub.equals("") || ifsub.equals("false")){%>
		 <%if(ifwaitfor.equals("false")) {%>
		   <option value="${urlShowAuditEndTaskDealPage}"><bean:message bundle="greatevent" key="operateType.AuditEndTask"/> </option>
		   <option value="${urlShowTransferAuditPage}"><bean:message bundle="sheet" key="common.transferAudit"/></option>
		   <option value="${urlShowPhaseReplyPage}"><bean:message bundle="sheet" key="event.reply"/></option>
			<%}%>
		  <%}else{%> 
		...
		<select id="dealSelector">
		 ...
		 <%if(ifsub.equals("") || ifsub.equals("false")){%>
		 <%if(ifwaitfor.equals("false")) {%>
		  <option value="${urlShowAssessmentTaskDealPage}"><bean:message bundle="greatevent" key="operateType.AssessmentTask"/></option>	  
		  <option value="${urlShowTransferkPage}"><bean:message bundle="sheet" key="common.transfer"/></option>	
		  <option value="${urlShowPhaseReplyPage}"><bean:message bundle="sheet" key="event.reply"/></option>
		  <%}%>
		  <%}else{%> 
		...
		<%}else if(taskName.equals("AuditReportTask")){%>	
		 ...
		 <%if(ifsub.equals("") || ifsub.equals("false")){%>
		 <%if(ifwaitfor.equals("false")) {%>
		   <option value="${urlShowAuditReportTaskDealPage}"><bean:message bundle="greatevent" key="operateType.AuditReportTask"/> </option>
		   <option value="${urlShowTransferAuditPage}"><bean:message bundle="sheet" key="common.transferAudit"/></option>
		   <option value="${urlShowPhaseReplyPage}"><bean:message bundle="sheet" key="event.reply"/></option>
			<%}%>
		  <%}else{%> 
		...
		<select id="dealSelector">
		 ...
		 <%if(ifsub.equals("") || ifsub.equals("false")){%>
		 <%if(ifwaitfor.equals("false")) {%>
		  <option value="${urlShowModifyTaskDealPage}"><bean:message bundle="greatevent" key="operateType.ModifyTask"/></option>	  
		  <option value="${urlShowTransferkPage}"><bean:message bundle="sheet" key="common.transfer"/></option>	
		  <option value="${urlShowPhaseReplyPage}"><bean:message bundle="sheet" key="event.reply"/></option>
		  <%}%>
		  <%}else{%> 
		...
		<select id="dealSelector">
		  <option value="${urlShowDraftDeal}"><bean:message bundle="greatevent" key="operateType.DraftTask"/></option>
		</select>
		...
		<select id="dealSelector">
		  <option value="${urlShowHoldDealPage}"><bean:message bundle="greatevent" key="operateType.HoldTask"/></option>
	      <option value="${urlShowRejectBackDealPage}"><bean:message bundle="greatevent" key="operateType.back"/></option>
		</select>	
	<%}%>
	</td>
	</tr>	
