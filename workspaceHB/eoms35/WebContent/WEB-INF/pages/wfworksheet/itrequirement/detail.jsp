        ...
        <logic:present name="sheetMain" scope="request">
            ...
            <table class="formTable">
                ...
                <tr>
                    ...
                    <td class="content"><bean:write name="sheetMain" property="mainBusinessTarget"
                                                    scope="request"/></td>
                </tr>
                ...
                <tr>
                    <td class="label"><bean:message bundle="itrequirement"
                                                    key="itrequirement.mainRequirementDesc"/></td>
                ...
                <tr>
                    <td class="label"><bean:message bundle="itrequirement"
                                                    key="itrequirement.mainRequirementDetail"/></td>
                    <td class="content" colspan='3'>
                        <eoms:attachment name="sheetMain" property="mainRequirementDetail" idList=""
                                         scope="request" idField="${sheetPageName}mainRequirementDetail"
                                         appCode="itrequirementsheet" viewFlag="Y"/>
                    </td>
                </tr>
            </table>
            ...
            <tr>
                ...
                %>
                    ...
                    <select id="dealSelector">
                        ...
                        <option value="${urlShowAuditTaskDealPage}"><bean:message bundle="itrequirement"
                    ...
                    <select id="dealSelector">
                        ...
                        <%if (ifsub.equals("") || ifsub.equals("false")) {%>
                        <%if (ifwaitfor.equals("false")) {%>
                        <option value="${urlShowAnalysisTaskDealPage}"><bean:message bundle="itrequirement"
                                                                                     key="operateType.analysis"/></option>
                    ...
                    <select id="dealSelector">
                        ...
                        <%if (ifsub.equals("") || ifsub.equals("false")) {%>
                        <%if (ifwaitfor.equals("false")) {%>
                        <option value="${urlShowDevAuditTaskDealPage}"><bean:message bundle="itrequirement"
                                                                                     key="operateType.devAudit"/></option>
                        <option value="${urlShowTransferAuditPage}"><bean:message bundle="sheet"
                                                                                  key="common.transferAudit"/></option>
                        <option value="${urlShowPhaseReplyPage}"><bean:message bundle="sheet"
                                                                               key="event.reply"/></option>
                    ...
                    <select id="dealSelector">
                        ...
                        <%if (ifsub.equals("") || ifsub.equals("false")) {%>
                        <%if (ifwaitfor.equals("false")) {%>
                        <option value="${urlShowOperateTaskDealPage}"><bean:message bundle="itrequirement"
                    ...
                    <select id="dealSelector">
                        ...
                        <%if (ifsub.equals("") || ifsub.equals("false")) {%>
                        <%if (ifwaitfor.equals("false")) {%>
                        <option value="${urlShowReplyTaskDealPage}"><bean:message bundle="itrequirement"
                                                                                  key="operateType.reply"/></option>
                        <option value="${urlShowTransferkPage}"><bean:message bundle="sheet"
                                                                              key="common.transfer"/></option>
                        <option value="${urlShowPhaseReplyPage}"><bean:message bundle="sheet"
                                                                               key="event.reply"/></option>
                    ...
                    <select id="dealSelector">
                        <option value="${urlShowAddInfoTaskDealPage}"><bean:message bundle="itrequirement"
                                                                                    key="operateType.addInfo"/></option>
                    </select>
                    <%} else if (taskName.equals("DraftTask")) {%>
                    <select id="dealSelector">
                        <option value="${urlShowDraftDeal}"><bean:message bundle="itrequirement"
                                                                          key="operateType.draft"/></option>
                    </select>

                    <%} else if (taskName.equals("RejectTask")) {%>
                    <select id="dealSelector">
                        <option value="${urlShowBackDeal}"><bean:message bundle="itrequirement"
                                                                         key="operateType.reApplication"/></option>
                    </select>
                    <%} else if (taskName.equals("TempSaveTask")) { %>
                    <select id="dealSelector">
                        <option value="${urlShowTempSaveTaskDealPage}"><bean:message bundle="itrequirement"
                                                                                     key="operateType.tempSave"/></option>
                    </select>
                    <%} else if (taskName.equals("HoldTask")) { %>
                    <select id="dealSelector">
                        <option value="${urlShowHoldDealPage}"><bean:message bundle="itrequirement"
                                                                             key="operateType.hold"/></option>
                        <option value="${urlShowRejectBackDealPage}"><bean:message bundle="itrequirement"
                                                                                   key="operateType.back"/></option>
                    </select>
                    <%} else if (taskName.equals("ConfirmHoldTask")) { %>
                    <select id="dealSelector">
                        <option value="${urlShowConfirmHoldTaskDealPage}"><bean:message bundle="itrequirement"
                                                                                        key="operateType.hold1"/></option>
                        <option value="${urlShowRejectBackTDealPage}"><bean:message bundle="itrequirement"
                                                                                    key="operateType.backoftest"/></option>
                    </select>
                    <%}%>
