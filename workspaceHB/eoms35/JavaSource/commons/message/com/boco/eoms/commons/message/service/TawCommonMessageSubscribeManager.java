...
public interface TawCommonMessageSubscribeManager extends Manager {
    /**
    ...
    /**
     * Gets tawCommonMessageSubscribe's information based on id.
     *
     * @param id the tawCommonMessageSubscribe's id
     ...
     *
     * @param tawCommonMessageSubscribe the object to be saved
     */
