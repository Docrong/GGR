    ...
    <div class="history-item"><!-- add space to hack ie-->&nbsp;
   	 <div class="history-item-title">
         ...
         <bean:message bundle="sheet" key="task.operateName"/>:
  	     <eoms:dict key="dict-sheet-businessdredge" dictId="activeTemplateId" itemId="${baselink.activeTemplateId}" beanId="id2descriptionXML" />
  	     <bean:message bundle="businessdredge" key="businessdredge.operateType"/>:
  	     <eoms:dict key="dict-sheet-businessdredge" dictId="mainOperateType" itemId="${baselink.operateType}" beanId="id2descriptionXML" />
