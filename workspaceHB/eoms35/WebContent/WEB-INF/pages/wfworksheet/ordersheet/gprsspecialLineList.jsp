...
>
    <display:column headerClass="sortable" title="详细信息">
        <a onclick="window.open('${app}/businessupport/product/gprsspeciallines.do?method=showDetail&orderId=<%=orderId%>&sheetType=<%=sheetType%>&isView=1&taskStatus=<%=taskStatus%>&taskName=<%=taskNamePara%>&id=<%=((HashMap)pageContext.getAttribute("list")).get("id")%>');"
