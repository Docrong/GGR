...
<div id="sheetform">
    <html:form action="/circuitcontrol.do?method=performTransferWorkItem" styleId="theform">
        ...
        <input type="hidden" name="mainClassName" id="mainClassName"
               value="com.boco.eoms.sheet.circuitcontrol.model.CircuitControlMain"/>
        <input type="hidden" name="linkClassName" id="linkClassName"
               value="com.boco.eoms.sheet.circuitcontrol.model.CircuitControlLink"/>
        ...
        <div class="form-btns">
            ...
            <input type="submit" class="submit"
                   onclick="v.passing=true;this.form.action='${app}/sheet/circuitcontrol/circuitcontrol.do?method=performSaveInfo'"
