     ...
     <table class="formTable">
         <tr>
		  ...
		  <tr>
			  ...
			  <td>
			  	<input type="text" class="text" name="${sheetPageName}trailId" id="${sheetPageName}trailId" value="${sheetMain.trailId}" alt="allowBlank:false"/>
			  </td>	
			  <td class="label">EOMS投诉工单流水号</td>
			  <td>
			  	<input type="text" class="text" name="${sheetPageName}eomsId" id="${sheetPageName}eomsId" value="${sheetMain.eomsId}" alt="allowBlank:false"/>
			  </td>	
		</tr>  
		  <tr>
			  <td class="label">投诉类别</td>
			  <td>
			  	<input type="text" class="text" name="${sheetPageName}complaintSort" id="${sheetPageName}complaintSort" value="${sheetMain.complaintSort}" alt="allowBlank:false"/>
			  </td>	
			  <td class="label">投诉现象</td>
			  <td>
			  	<input type="text" class="text" name="${sheetPageName}appearance" id="${sheetPageName}appearance" value="${sheetMain.appearance}" alt="allowBlank:false"/>
			  </td>	
		</tr> 
		  <tr>
			  <td class="label">受理号码</td>
			  <td>
			  	<input type="text" class="text" name="${sheetPageName}acceptNum" id="${sheetPageName}acceptNum" value="${sheetMain.acceptNum}" alt="allowBlank:false"/>
			  </td>	
		</tr> 
		  <tr>
		  <td class="label">
