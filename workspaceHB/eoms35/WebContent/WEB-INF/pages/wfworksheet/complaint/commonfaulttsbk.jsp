...
<html:form action="/complaint.do?method=saveAccessories" styleId="theform">
  ...
  <table class="listTable">
  		...
  		<tr>
  				...
  				<td colspan="3">
  					<a href="${app}/accessories/tawCommonsAccessoriesConfigs.do?method=download&id=<%=id%>"><%=accessoriesCnName %></a>
  				</td>
  		</tr>
  		<%
  			}
  		...
  		<tr>
			  ...
			  <td colspan="3">
    			<eoms:attachment name="sheetMain" property="sheetAccessories" scope="request" idField="sheetAccessories" appCode="complaint"/>	
			  </td>
		</tr>	
  </table>       
   <div class="form-btns">
    	<html:submit styleClass="btn" property="method.save" styleId="method.save" onclick="javascript:return test()">
          	保存
       	</html:submit>
   </div>
</html:form>
