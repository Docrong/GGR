    ...
    <tr>
        <td height=26 background="<%=request.getContextPath()%>/images/top/button_tree.gif">
            <table width=189 cellpadding=0 cellspacing=0 border=0>
                <tr>
                    <td style="padding-left:18pt;cursor:hand" width=60
                        onclick="window.location='?infoType=<%=infoType%>&reload=true&openClose=-1'">
                        展开树
                    </td>

                    <td style="padding-left:0pt;cursor:hand"
                        onclick="window.location='?infoType=<%=infoType%>&reload=true&openClose=1'">
                        关闭树
                    </td>

                    <td style="padding-left:0pt;cursor:hand"
                        onclick="window.location='?infoType=<%=infoType%>&reload=true&openClose=<%=request.getParameter("openClose")%>'">
                        刷新
                    </td>
                </tr>
            </table>
    ...
    <tr>
        <td style="border:1px solid #000000">
            <table align=center width=187 cellpadding=0 cellspacing=0 border=0>
                <tr>
                    <td height=7 background="<%=request.getContextPath()%>/images/top/left_line.gif" colspan=2><img
                            src="<%=request.getContextPath()%>/images/top/left_gui.gif"></td>
                </tr>
                <tr>
                    <td width=7 background="<%=request.getContextPath()%>/images/top/top_right_line.gif">
                    </td>
                    <td>
                        <div id="tree" style="width:180;height:473;background:#E6F2FC;overflow-y:scroll">
