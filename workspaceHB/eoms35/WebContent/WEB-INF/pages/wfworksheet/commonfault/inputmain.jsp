...
<table id="sheet" class="formTable">
    <c:if test="${status!=1}">
        ...
        <tr>
            ...
            <td>
                <input type="text" class="text" name="${sheetPageName}mainDetectFaultTime" readonly="readonly"
                       id="${sheetPageName}mainDetectFaultTime"
                       value="${eoms:date2String(sheetMain.mainDetectFaultTime)}"
        ...
        <tr>
            ...
            <td>
                <input type="text" class="text" name="${sheetPageName}mainSendSystem"
                       id="${sheetPageName}mainSendSystem" value="${sheetMain.mainSendSystem}"/>
            </td>
        </tr>
...
<table id="faultPack" class="formTable">
    ...
    <tr>
        <td class="label" colspan="4">
            <iframe id="alarmList" height="480"
...
<script type="text/javascript">
    ...
    if (faultPack == 1030102) {
        //普通故障工单
        v1.disableArea('faultPack', true);
    } else if (faultPack == 1030101) { //打包工单
