...
<%@ include file="/common/header_eoms_ext.jsp"%>
  ...
  var config = {
	...
	onClick:{url:"${app}/duty/TawRmRecord/query.do?typeId=",text:"${eoms:a2u('查询出入机房记录')}"},
	ctxMenu:[
		{id:'Child', text:'${eoms:a2u('查询')}',cls:'new-mi',url:'${app}/duty//TawRmGuestform/query.do?typeId='}
		 ],//end of ctxMenu 
	/************************
