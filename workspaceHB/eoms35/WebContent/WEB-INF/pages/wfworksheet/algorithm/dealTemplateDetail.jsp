...
<%
    com.boco.eoms.sheet.algorithm.model.AlgorithmLink algorithmLink = (com.boco.eoms.sheet.algorithm.model.AlgorithmLink) request.getAttribute("sheetLink");
    java.lang.String taskName = com.boco.eoms.base.util.StaticMethod.nullObject2String(algorithmLink.getActiveTemplateId());
    java.lang.String operateType = java.lang.String.valueOf(com.boco.eoms.base.util.StaticMethod.nullObject2String(algorithmLink.getOperateType()));
%>
<script type="text/javascript">
    ...
    function saveDealTemplate(type) {
        ...
        form.action = "${app}/sheet/algorithm/algorithm.do?method=saveDealTemplate&type=dealTemplateManage&dealTemplateId=${sheetLink.id}";
        form.submit();
    }
...
<html:form action="/algorithm.do" styleId="theform">
    <br/>
    <input type="hidden" name="${sheetPageName}beanId" value="iAlgorithmMainManager"/>
    <input type="hidden" name="${sheetPageName}mainClassName"
           value="com.boco.eoms.sheet.algorithm.model.algorithmMain"/>
    <input type="hidden" name="${sheetPageName}linkClassName"
           value="com.boco.eoms.sheet.algorithm.model.algorithmLink"/>
    <table class="formTable">
        ...
        <tr>
            <td class="label"><bean:message bundle="algorithm" key="algorithm.linkZContact"/>*</td>
            <td class="content">
            ...
            <td class="label"><bean:message bundle="algorithm" key="algorithm.linkZContactTel"/>*</td>
            <td class="content">
        ...
        <tr>
            ...
            <td colspan='3'>
                <eoms:attachment idList="" scope="request" idField="${sheetPageName}nodeAccessories" name="sheetLink"
                                 property="nodeAccessories" appCode="algorithm" alt="allowBlank:true"/>
            </td>
        </tr>
        <%
                }
        ...
        <tr>
            <td class="label"><bean:message bundle="algorithm" key="algorithm.linkOperationDesc"/>*</td>
            <td colspan="3">
        ...
        <tr>
            <td class="label">
                <bean:message bundle="algorithm" key="algorithm.remark"/>*
            </td>
            <td colspan="3">
