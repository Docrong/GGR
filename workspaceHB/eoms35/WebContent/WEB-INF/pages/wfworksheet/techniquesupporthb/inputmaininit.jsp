...
<input type="hidden" name="${sheetPageName}processTemplateName" value="TechniqueSupportHbMainFlowProcess"/>
...
<table class="formTable">
    ...
    <tr>
        <td class="label"><bean:message bundle="techniquesupporthb" key="techniquesupporthb.mainRemark"/>*</td>
        <td colspan="3" class="content">
