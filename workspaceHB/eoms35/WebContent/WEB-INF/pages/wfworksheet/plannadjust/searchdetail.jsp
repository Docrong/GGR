...
<display:table name="taskList" cellspacing="0" cellpadding="0"
    ...
    <display:column sortable="true" headerClass="sortable" title="调整原因属性" paramId="reasonAdjust"
                    paramProperty="reasonAdjust">
    ...
    <display:column sortable="true" headerClass="sortable" title="规划区内投诉情况" paramId="planningAreaComplaint"
                    paramProperty="planningAreaComplaint">
    ...
    <display:column sortable="true" headerClass="sortable" title="审核确认结果" paramId="checkResult"
                    paramProperty="checkResult">
