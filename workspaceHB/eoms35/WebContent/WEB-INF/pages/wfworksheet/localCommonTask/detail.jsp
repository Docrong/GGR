...
<%@page import="com.boco.eoms.sheet.localCommonTask.model.LocalCommonTaskTask" %>
...
<%
    ...
    LocalCommonTaskTask task = new LocalCommonTaskTask();
    String operaterType = "";
    String ifsub = "";
    String ifwaitfor = "";

    if (request.getAttribute("task") != null) {
        task = (LocalCommonTaskTask) request.getAttribute("task");
...
<script type="text/javascript">
    Ext.onReady(function () {
        var tabConfig = {
            items: [{
                ...
                url: 'localCommonTask.do?method=showSheetDealList&orderByDetp=true&sheetKey=${sheetMain.id}&taskName=${taskName}&ifWaitForSubTask=${task.ifWaitForSubTask}'
            }, {
                text: '<bean:message bundle="sheet" key="sheet.filesView"/>',
                url: 'localCommonTask.do?method=showSheetAccessoriesList&id=${sheetMain.id}',
                isIframe: true
            }, {
        ...
        var url2 = "localCommonTask.do?method=newShowCCPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}&operateType=-10&taskStatus=${taskStatus}";
        eoms.util.appendPage("sheet-deal-content", url2);
        <%}%>
        <%if(taskName.equals("reply")){ %>
        var url2 = "localCommonTask.do?method=showRemarkPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}";
        eoms.util.appendPage("sheet-deal-content", url2);
        <%}%>
    ...
    function forceOperation(obj) {
        ...
        if (obj == 1) {
            ...
            var url2 = "localCommonTask.do?method=showForceHoldPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}&operateType=forceHold";
            eoms.util.appendPage("sheet-deal-content", url2);

        } else if (obj == 2) {

            var url2 = "localCommonTask.do?method=showForceHoldPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}&operateType=nullity";
            eoms.util.appendPage("sheet-deal-content", url2);
        } else {

            var url2 = "localCommonTask.do?method=showForceHoldPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}&operateType=forceNullity";
            eoms.util.appendPage("sheet-deal-content", url2);
        }
    }
    ...
    function eventOperation(obj) {
        if (obj == 1) {
            var url2 = "localCommonTask.do?method=showPhaseAdvicePage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&taskName=advice&operateFlag=driveForward&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}";
...
<div id="sheet-detail-page">
    ...
    <div id="sheetinfo">
        <logic:present name="sheetMain" scope="request">
            <%@ include file="/WEB-INF/pages/wfworksheet/localCommonTask/basedetailnew.jsp" %>
            <table class="formTable">
                ...
                <tr>
                    <td class="label"><bean:message bundle="localCommonTask"
                                                    key="localCommonTask.mainTaskDescription"/></td>
                ...
                <!--  			      <tr>
		            <td  class="label"><bean:message bundle="localCommonTask" key="localCommonTask.mainRemark"/></td>
		            <td class="content" colspan="3"> 	
                ...
                <tr>
                    ...
                    <td colspan='3'>
                        <eoms:attachment name="sheetMain" property="sheetAccessories"
                                         scope="request" idField="sheetAccessories" appCode="localCommonTask"
                                         viewFlag="Y"/>
                    </td>
                </tr>
            </table>
...
<!-- 分派 -->
<c:url var="urlShowInputSplit" value="localCommonTask.do">
...
<!-- 会审 -->
<c:url var="urlShowInputSplitAudit" value="localCommonTask.do">
    <c:param name="method" value="showInputSplit"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 分派回复 -->
<c:url var="urlShowDispatchPage" value="localCommonTask.do">
...
<!-- 会审回复 -->
<c:url var="urlShowDispatchAuditPage" value="localCommonTask.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 处理回复通过 -->
<c:url var="urlShowDealReplyAcceptPage" value="localCommonTask.do">
...
<!-- 处理回复不通过 -->
<c:url var="urlShowDealReplyRejectPage" value="localCommonTask.do">
...
<!-- 转审 -->
<c:url var="urlShowTransferAuditPage" value="localCommonTask.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<c:url var="urlShowExamineYesDealPage" value="localCommonTask.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<c:url var="urlShowExamineNoDealPage" value="localCommonTask.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 确认受理 -->
<c:url var="urlShowAcceptDealPage" value="localCommonTask.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 任务创建审批通过 -->
<c:url var="urlShowTransmitDealPage" value="localCommonTask.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 任务创建审批不通过 -->
<c:url var="urlShowTransmit2DealPage" value="localCommonTask.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 分派 -->
<c:url var="urlShowSplitDealPage" value="localCommonTask.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<c:url var="urlShowExamineDealPage" value="localCommonTask.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 处理完成无需审批 -->
<c:url var="urlShowCompleteDealPage" value="localCommonTask.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 执行完成送审 -->
<c:url var="urlShowPassDealPage" value="localCommonTask.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 任务完成审批通过 -->
<c:url var="urlShowTaskCompleteAuditYes" value="localCommonTask.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 任务完成审批不通过 -->
<c:url var="urlShowTaskCompleteAuditNo" value="localCommonTask.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!--处理回复通过 -->
<c:url var="urlShowDealReplyPassPage" value="localCommonTask.do">
...
<c:url var="urlShowDealReplyholtPassPage" value="localCommonTask.do">
    <c:param name="method" value="showDealReplyPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!--处理回复不通过 -->
<c:url var="urlShowDealReplyNoPassPage" value="localCommonTask.do">
    <c:param name="method" value="showDealReplyPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 归档 -->
<c:url var="urlShowHoldDealPage" value="localCommonTask.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 草稿 -->
<c:url var="urlShowCompleteDraftPage" value="localCommonTask.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 驳回 -->
<c:url var="urlShowBackDeal" value="localCommonTask.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 移交 -->
<c:url var="urlShowTransferPage" value="localCommonTask.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 移交 -->
<c:url var="urlShowRejectBackPage" value="localCommonTask.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 阶段回复 -->
<c:url var="urlShowPhaseReplyPage" value="localCommonTask.do">
...
<!-- 重派 -->
<c:url var="urlShowReSendDeal" value="localCommonTask.do">
            ...
            <tr>
                <td width="50%">
                    ...
                    <select id="dealSelector">
                        ...
                        <option value="${urlShowTransmitDealPage}"><bean:message bundle="localCommonTask"
                                                                                 key="localCommonTask.taskpass"/></option>
                        <option value="${urlShowTransmit2DealPage}"><bean:message bundle="localCommonTask"
                                                                                  key="localCommonTask.tasknopass"/></option>
                        <option value="${urlShowExamineDealPage}">${eoms:a2u('延期申请')}</option>
                    ...
                    <select id="dealSelector">
                        ...
                        <option value="${urlShowCompleteDealPage}">${eoms:a2u('回复')}</option>
                        <option value="${urlShowPassDealPage}"><bean:message bundle="localCommonTask"
                                                                             key="localCommonTask.totaskcompsq"/></option>
                        <option value="${urlShowInputSplit}"><bean:message bundle="sheet" key="common.split"/></option>
                        <option value="${urlShowExamineDealPage}">${eoms:a2u('延期申请')}</option>
                        <%} else { %>
                        <!-- 有子任务 -->
                        <% if (ifwaitfor.equals("false")) {%>
                        <option value="${urlShowDispatchPage}">${eoms:a2u('分派回复')}</option>
                        <%} %>
                        <% } %>
                    ...
                    <select id="dealSelector">
                        ...
                        <!--<option value="${urlShowRejectBackPage}"><bean:message bundle="sheet" key="common.rejectBack"/></option>-->
                        <%} else if (taskStatus.equals(Constants.TASK_STATUS_CLAIMED)) { %>
                        <option value="${urlShowTaskCompleteAuditYes}"><bean:message bundle="localCommonTask"
                                                                                     key="localCommonTask.TaskCompleteAuditYes"/></option>
                        <option value="${urlShowTaskCompleteAuditNo}"><bean:message bundle="localCommonTask"
                                                                                    key="localCommonTask.TaskCompleteAuditNo"/></option>
                        <!--<option value="${urlShowPhaseReplyPage}"><bean:message bundle="sheet" key="event.reply"/></option>-->
                        <option value="${urlShowExamineDealPage}">${eoms:a2u('延期申请')}</option>
                        <%} %>
                    </select>
                    ...
                    <select id="dealSelector">
                        <option value="${urlShowDealReplyholtPassPage}">${eoms:a2u('处理回复通过并归档')}</option>
                        <option value="${urlShowDealReplyPassPage}">${eoms:a2u('处理回复通过')}</option>
                        <option value="${urlShowDealReplyNoPassPage}"><bean:message bundle="localCommonTask"
                                                                                    key="localCommonTask.nopassback"/></option>
                        <!--<option value="${urlShowPhaseReplyPage}"><bean:message bundle="sheet" key="event.reply"/></option>-->
                    </select>
                    <%} else if (taskName.equals("ExamineTask")) {%>
                    <select id="dealSelector">
                        ...
                        <% if (ifwaitfor.equals("false")) {%>
                        <!-- 流程步骤 -->
                        <option value="${urlShowExamineYesDealPage}">${eoms:a2u('审批通过')}</option>
                        <option value="${urlShowExamineNoDealPage}">${eoms:a2u('审批驳回')}</option>
                    ...
                    <select id="dealSelector">
                        <option value="${urlShowCompleteDraftPage}"><bean:message bundle="localCommonTask"
                    ...
                    <select id="dealSelector">
                        <option value="${urlShowHoldDealPage}"><bean:message bundle="localCommonTask"
...
<script type="text/javascript">
    Ext.onReady(function () {
        ...
        if (dealTemplateId != null && dealTemplateId != "") {
            url = "localCommonTask.do?method=referenceTemplate&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&taskName=${taskName}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&operateType=${operateType}&taskStatus=${taskStatus}&dealTemplateId=" + dealTemplateId
        }
