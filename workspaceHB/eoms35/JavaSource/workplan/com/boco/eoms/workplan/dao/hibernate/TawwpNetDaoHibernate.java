...
public class TawwpNetDaoHibernate extends BaseDaoHibernate implements
     ...
     * 淇濆瓨缃戝厓
     *
     * @param _tawwpNet TawwpNet 缃戝厓绫� @ 鎿嶄綔寮傚父
     */
     ...
     * 鏌ヨ缃戝厓淇℃伅
     *
     * @param _id String 缃戝厓鏍囪瘑 @ 鎿嶄綔寮傚父
     ...
     * 鏌ヨ鎵�鏈夌綉鍏冧俊鎭�
     *
     * @param _netIdList String 缃戝厓鏍囪瘑瀛楃涓� @ 鎿嶄綔寮傚父
     * @return List 缃戝厓绫诲垪琛�
     */
     ...
     *
     * @param _netTypeId String 缃戝厓鏍囪瘑
     * @param _deptId    String 閮ㄩ棬 @ 鎿嶄綔寮傚父
     * @return List 缃戝厓绫诲垪琛�
     */
     ...
     * 鏌ヨ鎵�鏈夌綉鍏冧俊鎭紝鍒嗛〉
     *
     * @param _pagePra int[] 鍒嗛〉淇℃伅 @ 鎿嶄綔寮傚父
     * @return List 缃戝厓绫诲垪琛�
     */
     ...
     * 鑾峰彇缃戝厓鍚嶇О瀛楃涓�
     *
     * @param _netIdList String 缃戝厓缂栧彿瀛楃涓� @ 鎿嶄綔寮傚父
