...
<%@page import="com.boco.eoms.sheet.softwareLoad.model.SoftwareLoadTask" %>
...
<%
    ...
    SoftwareLoadTask task = new SoftwareLoadTask();
    String operaterType = "";
    String ifsub = "";
    String ifwaitfor = "";
    if (request.getAttribute("task") != null) {
        task = (SoftwareLoadTask) request.getAttribute("task");
...
<script type="text/javascript">
    Ext.onReady(function () {
        var tabConfig = {
            items: [{
                ...
                url: 'softwareLoad.do?method=showSheetDealList&orderByDetp=true&sheetKey=${sheetMain.id}&taskName=${taskName}&ifWaitForSubTask=${task.ifWaitForSubTask}'
            }, {
                text: '<bean:message bundle="sheet" key="sheet.filesView"/>',
                url: 'softwareLoad.do?method=showSheetAccessoriesList&id=${sheetMain.id}',
                isIframe: true
            }]
        };
        ...
        var url2 = "softwareLoad.do?method=newShowCCPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}&operateType=-10&taskStatus=${taskStatus}";
        eoms.util.appendPage("sheet-deal-content", url2);
        <%}%>
        <%if(taskName.equals("reply")){ %>
        var url2 = "softwareLoad.do?method=showRemarkPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}";
        eoms.util.appendPage("sheet-deal-content", url2);
        <%}%>
    ...
    function forceOperation(obj) {
        ...
        if (obj == 1) {
            ...
            var url2 = "softwareLoad.do?method=showForceHoldPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}&operateType=forceHold";
            eoms.util.appendPage("sheet-deal-content", url2);

        } else if (obj == 2) {

            var url2 = "softwareLoad.do?method=showForceHoldPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}&operateType=nullity";
            eoms.util.appendPage("sheet-deal-content", url2);
        } else {

            var url2 = "softwareLoad.do?method=showForceHoldPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}&operateType=forceNullity";
            eoms.util.appendPage("sheet-deal-content", url2);
        }
    }
    ...
    function eventOperation(obj) {
        if (obj == 1) {
            var url2 = "softwareLoad.do?method=showPhaseAdvicePage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&taskName=advice&operateFlag=driveForward&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}";
...
<div id="sheet-detail-page">
    ...
    <div id="sheetinfo">
        <logic:present name="sheetMain" scope="request">
            <%@ include file="/WEB-INF/pages/wfworksheet/softwareLoad/basedetailnew.jsp" %>
            <br/>
            <table class="formTable">
                ...
                <tr>
                    ...
                    <td class="content">
                        <eoms:id2nameDB id="${sheetMain.mainSoftwareType}" beanId="ItawSystemDictTypeDao"/>
                    </td>
                    <td class="label" id="mainSoftwareversionLabel" style="display: "><bean:message
                            bundle="softwareLoad" key="softwareLoad.mainSoftwareversion"/>*
                    </td>
                    <td class="content" id="mainSoftwareversionText" style="display: ">
                            ${sheetMain.mainSoftwareversion }
                    </td>
                    <td class="label" id="mainSoftwareNoLabel" style="display: none;"><bean:message
                            bundle="softwareLoad" key="softwareLoad.mainSoftwareNo"/>*
                    </td>
                    <td class="content" id="mainSoftwareNoText" style="display: none;">
                            ${sheetMain.mainSoftwareNo }
                    </td>
                ...
                <tr>
                    ...
                    <td class="content">
                            ${sheetMain.mainNetwork }
                    </td>
                </tr>
                <tr>
                    <td class="label"><bean:message bundle="softwareLoad" key="softwareLoad.mainFactory"/>*</td>
                    <td class="content" colspan="3">
                        <c:forTokens items="${sheetMain.mainFactory}" delims="," var="mainFactory" varStatus="status">
                            <eoms:id2nameDB id="${mainFactory}" beanId="ItawSystemDictTypeDao"/><c:choose><c:when
                                test="${status.last}"></c:when><c:otherwise>,</c:otherwise></c:choose>
                        </c:forTokens>
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <c:forTokens items="${sheetMain.mainPlans}" delims="," var="mainPlans" varStatus="status">
                            <eoms:id2nameDB id="${mainPlans}" beanId="tawSystemAreaDao"/><c:choose><c:when
                                test="${status.last}"></c:when><c:otherwise>,</c:otherwise></c:choose>
                        </c:forTokens>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="content">
                        <bean:write name="sheetMain" property="mainProgramtime" formatKey="date.formatDateTimeAll"
                ...
                <tr>
                    ...
                    <td class="content">
                            ${sheetMain.maintestunit }
                    </td>
                    <td class="label"><bean:message bundle="softwareLoad" key="softwareLoad.mainUrgency"/>*</td>
                    <td class="content">
                        <eoms:id2nameDB id="${sheetMain.mainUrgency}" beanId="ItawSystemDictTypeDao"/>
                ...
                <tr>
                    ...
                    <td class="content">
                            ${sheetMain.mainPointName }

                    </td>
                    <td class="label"><bean:message bundle="softwareLoad" key="softwareLoad.mainissuing"/>*</td>
                    <td class="content">
                        <eoms:id2nameDB id="${sheetMain.mainissuing}" beanId="ItawSystemDictTypeDao"/>
                    </td>
                </tr>
                <tr>
...
<c:url var="urlShowAssessorDealPage" value="softwareLoad.do">
...
<c:url var="urlShowProgramTaskDealPage" value="softwareLoad.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<c:url var="urlShowLoadingTaskDealPage" value="softwareLoad.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<c:url var="urlShowTestingTaskDealPage" value="softwareLoad.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 草稿派发 -->
<c:url var="urlShowDraftDeal" value="softwareLoad.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 重新派发 -->
<c:url var="urlShowBackDeal" value="softwareLoad.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 归档 -->
<c:url var="urlShowHoldDealPage" value="softwareLoad.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 退回 -->
<c:url var="urlShowRejectBackDealPage" value="softwareLoad.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 转派 -->
<c:url var="urlShowTransferkPage" value="softwareLoad.do">
...
<!-- 转审 -->
<c:url var="urlShowTransferAuditPage" value="softwareLoad.do">
    <c:param name="method" value="showTransferWorkItemPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 阶段回复 -->
<c:url var="urlShowPhaseReplyPage" value="softwareLoad.do">
...
<!-- 驳回 -->
<c:url var="urlShowRejectBackPage" value="softwareLoad.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 确认受理 -->
<c:url var="urlShowAcceptDealPage" value="softwareLoad.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 分派 -->
<c:url var="urlShowInputSplit" value="softwareLoad.do">
...
<!-- 会审 -->
<c:url var="urlShowInputSplitAudit" value="softwareLoad.do">
    <c:param name="method" value="showInputSplit"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 分派回复 -->
<c:url var="urlShowDispatchPage" value="softwareLoad.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
    <c:param name="taskName" value="${taskName}"/>
    <c:param name="subtaskName" value="SoftwareLoadSubTask"/>
    <c:param name="operateRoleId" value="${operateRoleId}"/>
    <c:param name="TKID" value="${TKID}"/>
    <c:param name="taskStatus" value="${taskStatus}"/>
    <c:param name="preLinkId" value="${preLinkId}"/>
...
<!-- 会审回复 -->
<c:url var="urlShowDispatchAuditPage" value="softwareLoad.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 处理回复通过 -->
<c:url var="urlShowDealReplyAcceptPage" value="softwareLoad.do">
...
<!-- 处理回复不通过 -->
<c:url var="urlShowDealReplyRejectPage" value="softwareLoad.do">
            ...
            <tr>
                <td width="50%">
                    ...
                    <select id="dealSelector">
                        ...
                        <option value="${urlShowAssessorDealPage}">提交审核</option>
                        <option value="${urlShowRejectBackPage}"><bean:message bundle="sheet"
                                                                               key="common.rejectBack"/></option>
                    ...
                    <%} else if (taskName.equals("ProgramTask")) {%>
                    <select id="dealSelector">
                        <%if (taskStatus.equals(Constants.TASK_STATUS_READY)) {%>
                        <option value="${urlShowAcceptDealPage}"><bean:message bundle="sheet"
                                                                               key="common.accept"/></option>
                        ...
                        <%if (ifsub.equals("") || ifsub.equals("false")) { %>
                        <% if (ifwaitfor.equals("false")) {%>
                        <option value="${urlShowProgramTaskDealPage}">审核通过</option>
                        <option value="${urlShowRejectBackPage}"><bean:message bundle="sheet"
                                                                               key="common.rejectBack"/></option>
                        <!--	  		    <option value="${urlShowPhaseReplyPage}"><bean:message bundle="sheet" key="event.reply"/></option>-->
                        <!--			     <option value="${urlShowTransferkPage}"><bean:message bundle="sheet" key="common.transfer"/></option>-->
                    ...
                    <%} else if (taskName.equals("LoadingTask")) {%>
                    <select id="dealSelector">
                        <%if (taskStatus.equals(Constants.TASK_STATUS_READY)) {%>
                        <option value="${urlShowAcceptDealPage}"><bean:message bundle="sheet"
                                                                               key="common.accept"/></option>
                        ...
                        <%if (ifsub.equals("") || ifsub.equals("false")) { %>
                        <% if (ifwaitfor.equals("false")) {%>
                        <option value="${urlShowLoadingTaskDealPage}">装载完成</option>
                    ...
                    <%} else if (taskName.equals("TestingTask")) {%>
                    <select id="dealSelector">
                        <%if (taskStatus.equals(Constants.TASK_STATUS_READY)) {%>
                        <option value="${urlShowAcceptDealPage}"><bean:message bundle="sheet"
                                                                               key="common.accept"/></option>
                        ...
                        <%if (ifsub.equals("") || ifsub.equals("false")) { %>
                        <% if (ifwaitfor.equals("false")) {%>
                        <option value="${urlShowTestingTaskDealPage}">反馈结果</option>
                        <!--			    <option value="${urlShowRejectBackPage}"><bean:message bundle="sheet" key="common.rejectBack"/></option>	   -->
                        <!--	  		    <option value="${urlShowPhaseReplyPage}"><bean:message bundle="sheet" key="event.reply"/></option>-->
                        <!--			     <option value="${urlShowTransferkPage}"><bean:message bundle="sheet" key="common.transfer"/></option>-->
                    ...
                    <select id="dealSelector">
                        <option value="${urlShowDraftDeal}"><bean:message bundle="softwareLoad"
                    ...
                    <select id="dealSelector">
                        <option value="${urlShowHoldDealPage}"><bean:message bundle="softwareLoad"
...
<script type="text/javascript">
    Ext.onReady(function () {
        ...
        if (dealTemplateId != null && dealTemplateId != "") {
            url = "softwareLoad.do?method=referenceTemplate&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&taskName=${taskName}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&operateType=${operateType}&taskStatus=${taskStatus}&dealTemplateId=" + dealTemplateId
        }
