...
<div id="tabs">
    ...
    <div id="form" class="tab-content">
        <table cellpadding="0" class="table logList" cellspacing="0">
            ...
            %>
            <tr class="sortable">
                <td width='2%' align='center'><%=++i%>
                </td>
                <td width='8%' align='center'><%=map.get("com_name").toString().trim()%>
                </td>
                <td width='8%' align='center'><%=map.get("xiaozu_name").toString().trim()%>
                </td>
                <td width='10%' align='center'><%=map.get("name").toString().trim()%>
                </td>
                <td width='12%' align='center'><%=map.get("tel").toString().trim()%>
                </td>
                <td width='20%' align='center'><%=map.get("zhize").toString().trim()%>
                </td>
                <td width='20%' align='center'><%=map.get("remark").toString().trim()%>
                </td>
