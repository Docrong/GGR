        ...
        ctxMenu: [
            {
                ...
                text: '新建专题',
                cls: 'new-mi',
                url: '${app}/filemanager/topic/InfoTypeDetailAction.do?actId=4&onlyTopic=1&hdId=',
                rootCanShow: true
            },
            {
                id: 'edtTopic',
                text: '编辑专题',
                cls: 'edit-mi',
                url: '${app}/filemanager/topic/InfoTypeDetailAction.do?actId=0&onlyTopic=1&hdId='
            },
            {
                id: 'delTopic',
                isDelete: true,
                text: '删除专题',
                cls: 'remove-mi',
                url: '${app}/filemanager/topic/InfoTypeDetailAction.do?actId=1&onlyTopic=1&hdId='
            },
            {
                id: 'newScheme',
                text: '新建派发报表',
                cls: 'new-mi',
                url: '${app}/filemanager/scheme/SchemeMgrAction.do?act=add&topicId=',
                rootCanShow: true
            },
            {
                id: 'edtScheme',
                text: '编辑派发报表',
                cls: 'edit-mi',
                url: '${app}/filemanager/scheme/SchemeMgrAction.do?act=edit&schemeId='
            },
            {
                id: 'delScheme',
                isDelete: true,
                text: '删除派发报表',
                cls: 'remove-mi',
                url: '${app}/filemanager/scheme/SchemeMgrAction.do?act=delete&schemeId='
            }
        ],//end of ctxMenu
        /************************
