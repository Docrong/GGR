		...
		<%if(taskName.equals("TaskCreateAuditHumTask")){ %>	 
		    ...
		    <input type="hidden" name="${sheetPageName}operateType" id="${sheetPageName}operateType" value="<%=operateType %>" /> 
		     <%if(operateType.equals("111")){ //启动变更配置工单    %>
		      ...
		      <%}else if(operateType.equals("205")){ //执行回复%>
		          ...
		          <td  class="content"> <input type="text"  class="text" name="${sheetPageName}ndeptContact" value="${sheetLink.ndeptContact}" id="${sheetPageName}ndeptContact"  alt="allowBlank:false,maxLength:25,vtext:'${eoms:a2u('请输入网络部门联系人，最大长度为12个汉字！')}'"/></td>
		           <td  class="label"><bean:message bundle="businesschange" key="businesschange.ndeptContactPhone"/>*</td>
		            <td  class="content"> <input type="text"  class="text" name="${sheetPageName}ndeptContactPhone" value="${sheetLink.ndeptContactPhone}" id="${sheetPageName}ndeptContactPhone"  alt="allowBlank:false,maxLength:50,vtext:'${eoms:a2u('请输入网络部门联系人电话，最大长度为50个字符！')}'"/></td>
		          </tr>
		        <!-- GPRS -->
				...
				<tr>
		            ...
		            <td  class="content" colspan='3'> <input type="text"  class="text" name="${sheetPageName}apnID" id="${sheetPageName}apnID"  value="${sheetLink.apnID}" alt="allowBlank:false,maxLength:32,vtext:'${eoms:a2u('请输入apnID，最大长度为16个汉字！')}'"/></td>
		            </tr>	
                </logic:equal>			        
				...
				<tr>
                 ...
                 <logic:equal value="101100104" property="businesstype1" name="sheetMain">        
     	          <tr >
		            ...
		            <td  class="content" colspan='3'> <input type="text"  class="text" name="${sheetPageName}circuitCode" id="${sheetPageName}circuitCode"  value="${sheetLink.circuitCode}" alt="allowBlank:false,maxLength:200,vtext:'${eoms:a2u('请输入传输专线电路代号，最大长度为100个汉字！')}'"/></td>
		          </tr>
		          
		          <tr>
		            <td  class="label"><bean:message bundle="businesschange" key="businesschange.testReport"/>*</td>
		              <td colspan="3"> 	
    				  <textarea class="textarea max" name="${sheetPageName}testReport" id="${sheetPageName}testReport" alt="width:500,allowBlank:false,maxLength:2000,vtext:'${eoms:a2u('请输入测试报告，最大长度为1000个汉字！')}'">${sheetLink.testReport }</textarea>
                    </td>
		          </tr>
                 </logic:equal>	
		           <tr>
		             ...
		             <td  class="label"><bean:message bundle="businesschange" key="businesschange.dealResult"/>*</td>
            	      ...
            	      initDicId="1011020"  alt="allowBlank:false" defaultValue="${sheetLink.dealResult}" styleClass="select-class"/>
			        </td>	
			       </tr>
			      <tr>
		            <td  class="label"><bean:message bundle="businesschange" key="businesschange.dealDesc"/>*</td>
		              <td colspan="3"> 	
    				  <textarea class="textarea max" name="${sheetPageName}dealDesc" id="${sheetPageName}dealDesc" alt="width:500,allowBlank:false,maxLength:1000,vtext:'${eoms:a2u('请输入处理说明，最大长度为500个汉字！')}'">${sheetLink.dealDesc }</textarea>
                    </td>
		          </tr>
		       <tr>
        	    ...
        	    <%}else if(operateType.equals("206")){ //回复送审%>
        	      ...
        	      <tr>
		           ...
		           <td  class="content"> <input type="text"  class="text" name="${sheetPageName}ndeptContact" value="${sheetLink.ndeptContact}" id="${sheetPageName}ndeptContact"  alt="allowBlank:false,maxLength:25,vtext:'${eoms:a2u('请输入网络部门联系人，最大长度为12个汉字！')}'"/></td>
		           <td  class="label"><bean:message bundle="businesschange" key="businesschange.ndeptContactPhone"/>*</td>
		            <td  class="content"> <input type="text"  class="text" name="${sheetPageName}ndeptContactPhone" id="${sheetPageName}ndeptContactPhone"  value="${sheetLink.ndeptContactPhone}" alt="allowBlank:false,maxLength:50,vtext:'${eoms:a2u('请输入网络部门联系人电话，最大长度为50个字符！')}'"/></td>
		          </tr>
		        <!-- GPRS -->
                <logic:equal value="101100101" property="businesstype1" name="sheetMain">
				<tr>
		            <td  class="label"><bean:message bundle="businesschange" key="businesschange.apnID"/>*</td>
		            <td  class="content" colspan='3'> <input type="text"  class="text" name="${sheetPageName}apnID" id="${sheetPageName}apnID"  value="${sheetLink.apnID}" alt="allowBlank:false,maxLength:200,vtext:'${eoms:a2u('请输入apnID，最大长度为100个汉字！')}'"/></td>
		            </tr>	
                </logic:equal>			        
		         <!-- MMS -->
                <logic:equal value="101100102" property="businesstype1" name="sheetMain">
               ...
               <logic:equal value="101100104" property="businesstype1" name="sheetMain">        
		         ...
		         <tr >
			      ...
			      <tr>
		            <td  class="label"><bean:message bundle="businesschange" key="businesschange.dealDesc"/>*</td>
		              <td colspan="3"> 	
    				  <textarea class="textarea max" name="${sheetPageName}dealDesc" id="${sheetPageName}dealDesc" alt="width:500,allowBlank:false,maxLength:1000,vtext:'${eoms:a2u('请输入处理结果，最大长度为500个汉字！')}'">${sheetLink.dealDesc }</textarea>
                    </td>
		          </tr>
		           <tr>
     			<td class="label"><bean:message bundle="sheet" key="linkForm.nodeAccessories"/></td>
        	    ...
        	    <%}else if(operateType.equals("10")){ //分派%>
        	       ...
        	       <tr>
		            <td  class="label"><bean:message bundle="sheet" key="linkForm.remark"/>*</td>
		              <td colspan="3"> 	
    				  <textarea class="textarea max" name="${sheetPageName}transferReason" id="${sheetPageName}transferReason" alt="width:500,allowBlank:false,maxLength:2000,vtext:'${eoms:a2u('请输入意见，最大长度为1000个汉字！')}'">${sheetLink.transferReason }</textarea>
                    </td>
		          </tr>
         	 ...
         	 <%if(operateType.equals("212")){ %>
         		 <input type="hidden" name="${sheetPageName}phaseId" id="${sheetPageName}phaseId" value="ExcuteHumTask" />   		 
         		  <tr>
		            <td  class="label"><bean:message bundle="businesschange" key="businesschange.dealResult"/></td>
		              <td colspan="3"> 	
    				  <textarea class="textarea max" name="${sheetPageName}dealResult" id="${sheetPageName}dealResult" alt="width:500,allowBlank:true,maxLength:2000,vtext:'${eoms:a2u('请输入处理结果，最大长度为1000个汉字！')}'">${sheetLink.dealResult }</textarea>
                    </td>
		          </tr>            
         ...
         <%}else if( taskName.equals("HoldHumTask")){%>
		  ...
		  <tr>
		    ...
		    <td colspan="3">
		      <textarea name="${sheetPageName}endResult" alt="width:500,allowBlank:false,maxLength:2000,vtext:'${eoms:a2u('请填入信息，最多输入1000字')}'" id="${sheetPageName}endResult"  class="textarea max">${sheetMain.endResult}</textarea>
		    </td>
		  </tr>					       			     	
     	    <%}%>
	       ...
	       <td class="label">
			...
			<td colspan="3">			
			 <input type="hidden" name="${sheetPageName}operateType" id="${sheetPageName}operateType" value="-15" />
		        ...
		        alt="allowBlank:false,maxLength:1000,width:500,vtext:'${eoms:a2u('请填入信息，最多输入1000字')}'" alt="width:'500px'">${sheetLink.remark}</textarea>
		  </td>
		</tr>  
        <%} %> 
