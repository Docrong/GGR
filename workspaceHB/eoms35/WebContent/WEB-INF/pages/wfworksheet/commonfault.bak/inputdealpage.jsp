...
<%if (taskName.equals("cc")) {%>
<fieldset id="link4">
    <eoms:chooser id="commonfaultSendRole"
                  category="[{id:'copyPerformer',childType:'user,subrole',limit:'none',text:'抄送'}]" type="role"
                  roleId="193" flowId="51" config="{returnJSON:true,showLeader:true}"/>
</fieldset>
<%} %>
