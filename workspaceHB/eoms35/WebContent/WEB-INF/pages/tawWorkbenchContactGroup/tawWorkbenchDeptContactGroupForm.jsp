        ...
        <tr>
            ...
            <td>
                <html:text property="groupName" styleId="groupName" styleClass="text medium"
                           alt="allowBlank:false,vtext:'${eoms:a2u('请输入分组名称')}'"/>
            </td>
            <td>
                <html:checkbox styleId="radio" property="allow"><bean:message
                        key="tawWorkbenchDeptContactGroupForm.allow"/></html:checkbox>
            </td>
        </tr>
