   ...
   <tr>
     ...
     <td width="80%">
          ...
          <td>
          	...
          	<input type="text"  name="sendDeptName"  value="" id ="sendDeptName" class="text" readonly="readonly" alt="allowBlank:false">
          	<input type="hidden" name="sendDeptId" >
          
          	<input type="button" value="${eoms:a2u('受理部门')}" id="userTreeBtn1" class="btn" />
          	<input  name="revDeptName"  value="" id ="revDeptName" class="text"  readonly="readonly" alt="allowBlank:false">
