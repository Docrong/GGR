...
function selectLimit(obj){
	...
	<br/>
     <table class="formTable">
					...
					onclick="popUpCalendar(this, this)" alt="vtype:'lessThen',link:'${sheetPageName}sheetCompleteLimit',vtext:'"接收时限不能晚于最终处理时限',allowBlank:false"/> </td>
		            ...
		            <td >  <input type="text" class="text" name="${sheetPageName}sheetCompleteLimit" readonly="readonly" 
					  ...
					  defaultValue="${sheetMain.sheetCompleteLimit}"  alt="vtype:'moreThen',link:'${sheetPageName}sheetAcceptLimit',vtext:'最终处理时限不能早于接收时限',allowBlank:false"/>   </td>
	                </tr>
      <tr>
			    ...
			    <td class="label"><bean:message bundle="securityevaluate" key="securityevaluate.mainCompleteTime"/>*</td>
                  <td class="content">
					   <input type="text" class="text" name="${sheetPageName}mainCompleteTime" readonly="readonly" 
						...
						onclick="popUpCalendar(this, this)"  defaultValue="${sheetMain.mainCompleteTime}" alt="allowBlank:false" />   
					 </td>		
