...
<%@ include file="/WEB-INF/pages/wfworksheet/plannconfirm/baseinputlinkhtmlnew.jsp"%>
 ...
 <%}%>
			...
			<td>
				<input type="text"  class="text" name="percentAgreement" id="percentAgreement"  alt="allowBlank:false,maxLength:1000,vtext:'请填入 同意比例 信息，最多输入 1000 字符'" value="${sheetLink.percentAgreement}"/>
			</td>
		</tr>
			...
			<td>
				<input type="text"  class="text" name="planningAzimuth" id="planningAzimuth"  alt="allowBlank:false,maxLength:1000,vtext:'请填入 规划方位角 信息，最多输入 1000 字符'" value="${sheetLink.planningAzimuth}"/>
			</td>
		</tr>
			...
			<td>
				<input type="text"  class="text" name="electronicAngle" id="electronicAngle"  alt="allowBlank:false,maxLength:1000,vtext:'请填入 规划电子倾角 信息，最多输入 1000 字符'" value="${sheetLink.electronicAngle}"/>
			</td>
			...
			<td>
				<input type="text"  class="text" name="mechanicalAngle" id="mechanicalAngle"  alt="allowBlank:false,maxLength:1000,vtext:'请填入 规划机械倾角 信息，最多输入 1000 字符'" value="${sheetLink.mechanicalAngle}"/>
			</td>
		</tr>
			...
			<td>
				<input type="text"  class="text" name="planningConfiguration" id="planningConfiguration"  alt="allowBlank:false,maxLength:1000,vtext:'请填入 规划配置 信息，最多输入 1000 字符'" value="${sheetLink.planningConfiguration}"/>
			</td>
			...
			<td>
				<input type="text"  class="text" name="particularCase" id="particularCase"  alt="allowBlank:false,maxLength:2000,vtext:'请填入 具体情况 信息，最多输入 2000 字符'" value="${sheetLink.particularCase}"/>
			</td>
			...
			<td>
				<input type="text"  class="text" name="checkPeople" id="checkPeople"  alt="allowBlank:false,maxLength:2000,vtext:'请填入 审核确认人 信息，最多输入 2000 字符'" value="${sheetLink.checkPeople}"/>
			</td>
		</tr>
			...
			<td>
				<input type="text"  class="text" name="contactInformation" id="contactInformation"  alt="allowBlank:false,maxLength:2000,vtext:'请填入 确认人联系方式 信息，最多输入 2000 字符'" value="${sheetLink.contactInformation}"/>
			</td>
		</tr>
 			   		...
 			   		<% if(operateType.equals("102")){ %>
 			   			<fieldset>
							  ...
							  <div class="x-form-item" >
									...
									<eoms:chooser id="ConfirmTask0"  type="role" roleId="1872" flowId="617" config="{returnJSON:true,showLeader:true}"  
