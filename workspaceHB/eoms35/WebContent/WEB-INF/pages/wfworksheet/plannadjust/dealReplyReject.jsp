...
<div id="sheetform">
    <html:form action="/plannadjust.do?method=performDealReplyReject" styleId="theform">
        <%
        ...
        <input type="hidden" name="subtaskName" value="PlannAdjustSubTask"/>
        ...
        <input type="hidden" name="taskNamespace" value="http://PlannAdjust"/>
