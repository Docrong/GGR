...
<link href="<%=request.getContextPath()%>/wap/css/style.css" rel="stylesheet" type="text/css" />
</head>
<body >
  ...
  <tr>
  	<td>
  		<%@ include file="detailButtons.jsp"%> 
  	</td>
  </tr>
  <tr>
    <td class="list_text_03"><div class="div_all"><table  width="100%" border="0" cellpadding="1" cellspacing="1" class="add_table_bg" style="table-layout:fixed;word-break:break-all">
    <%
    ...
    <%
		...
		if (("FirstExcuteHumTask".equalsIgnoreCase((String) request.getAttribute("taskName")) 
			|| !"SecondExcuteHumTask".equalsIgnoreCase((String) request.getAttribute("taskName")) 
			|| !"CheckingHumTask".equalsIgnoreCase((String) request.getAttribute("taskName"))) 
			...
			&& !"ExamineHumTask".equalsIgnoreCase((String) request.getAttribute("taskName"))) {
	%>
	  <tr class="fb_xx_head_tr">
   	 	 <td class="tt_head_bg">驳回意见: </td>
