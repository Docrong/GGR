...
<html:form action="/dutyevent.do?method=save&isSubmit=1"
    ...
    <table border=0 cellspacing="1" cellpadding="1" class="listTable">
        ...
        <tr>
            ...
            <td COLSPAN="10">
                <input type="text" name="beginTime" size="20"
                       ...
                       alt="allowBlank:false,vtext:'请填写开始时间'">
            </td>
            <td COLSPAN="4" class="label">
            ...
            <td COLSPAN="10">
                <input type="text" name="endtime" size="20" onclick="popUpCalendar(this, this,null,null,null,true,-1);"
                       readonly="true" class="text" alt="allowBlank:false,vtext:'请填写结束时间">
            </td>
        </tr>
        ...
        <tr class="tr_show">
            ...
            <td COLSPAN="24">
                <input name="eventtitle" type="text" class="clstext" size="77" value=""
        ...
        <tr>
            ...
            <td COLSPAN="24">
                <eoms:dict key="dict-duty" dictId="complateFlag" beanId="selectXML" isQuery="false"
                           selectId="complateFlag" alt="allowBlank:false"/>
            </td>
        </tr>
        <tr>
            <td COLSPAN="4" class="label">
        ...
        <tr id="time" style="display:none">
            ...
            <td COLSPAN="10">
                <input type="text" name="startTime" size="20"
                       onclick="popUpCalendar(this, this,null,null,null,true,-1);" readonly="true" class="text">
            </td>
            <td COLSPAN="4" class="label">
