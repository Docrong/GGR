    ...
    <fmt:bundle basename="com/boco/eoms/km/config/applicationResource-kmmanager">
        ...
        <table class="formTable">
            ...
            <tr>
                ...
                <td class="content">
                    <html:text property="expertEduSch" styleId="expertEduSch" styleClass="text medium"
            ...
            <tr>
                ...
                <td class="content">
                    <eoms:comboBox name="expertEduEdu" id="expertEduEdu"
                                   initDicId='<%=KmExpertProps.getDictRootId("RootEducation")%>'
            ...
            <tr>
                ...
                <td class="content">
                    <html:text property="expertEduPro" styleId="expertEduPro" styleClass="text medium"
                               alt="allowBlank:false,vtext:''"
            ...
            <tr>
                ...
                <td class="content">
                    <html:text property="expertEduProName" styleId="expertEduProName" styleClass="text medium"
                               alt="allowBlank:false,vtext:''"
            ...
            <tr>
                ...
                <td class="content">
                    <html:text property="expertEduCity" styleId="expertEduCity" styleClass="text medium"
                               alt="allowBlank:false,vtext:''"
            ...
            <tr>
                ...
                <td class="content">
                    <html:textarea property="expertEduDes" styleId="expertEduDes" styleClass="text medium" cols="30"
                                   rows="5" alt="allowBlank:false,vtext:''"
