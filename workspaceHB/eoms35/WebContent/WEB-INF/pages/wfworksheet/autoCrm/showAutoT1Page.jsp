...
<form method="post" id="theform" action="autot1crm.do?method=save">
    ...
    <table class="formTable">
        ...
        <tr>
            ...
            <td width="100%">
                <textarea class="textarea max" ${type == 'open' ? 'disabled="disabled"': ''}
                          name="remark2">${autot1Crm.remark2 }</textarea>
        ...
        Ext.onReady(function () {
            ...
            if (showAreaId != null) {
                ...
                deptetree = new xbox({
                    ...
                    treeChkMode: 'radio',
                    treeChkType: 'area',
                    showChkFldId: 'showArea',
                    saveChkFldId: 'toAreaId'
                });
            }
