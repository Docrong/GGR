              ...
              <td class="label"><bean:message bundle="sheet" key="linkForm.acceptLimit"/>*</td>
			      ...
			      <tr>
		            <td  class="label"><bean:message bundle="softchange" key="softchange.linkCompleteLimitTime"/>*</td>
		   			<td class="content"><input class="text" onclick="popUpCalendar(this, this)" type="text" name="${sheetPageName}linkCompleteLimitTime" 
		   			readonly="readonly" alt="allowBlank:false" value="${eoms:date2String(sheetLink.linkCompleteLimitTime)}" id="${sheetPageName}linkCompleteLimitTime" />
                     </td>
		            <td  class="label"><bean:message bundle="softchange" key="softchange.linkDesignKey"/>*</td>
		             <td class="content"> <input type="text"  class="text" name="${sheetPageName}linkDesignKey" id="${sheetPageName}linkDesignKey" value="${sheetLink.linkDesignKey}" alt="allowBlank:false"/></td>
		          </tr>
			      <tr>
		            <td  class="label"><bean:message bundle="softchange" key="softchange.linkDesignComment"/></td>
		              <td colspan="3" class="content"> 	
    				  <textarea class="textarea max" name="${sheetPageName}linkDesignComment" id="${sheetPageName}linkDesignComment" alt="width:500,allowBlank:true">${sheetLink.linkDesignComment}</textarea>
                    </td>
		          </tr>
			    <tr>
		            <td  class="label"><bean:message bundle="softchange" key="softchange.linkInvolvedProvince"/></td>
		              <td colspan="3"> 	
    				  <textarea class="textarea max" name="${sheetPageName}linkInvolvedProvince" id="${sheetPageName}linkInvolvedProvince" alt="width:500,allowBlank:false">${sheetLink.linkInvolvedProvince}</textarea>
                    </td>
		          </tr>
			      <tr>
		            <td  class="label"><bean:message bundle="softchange" key="softchange.linkInvolvedCity"/></td>
		              <td colspan="3"> 	
    				  <textarea class="textarea max" name="${sheetPageName}linkInvolvedCity" id="${sheetPageName}linkInvolvedCity" alt="width:500,allowBlank:false">${sheetLink.linkInvolvedCity}</textarea>
                    </td>
		          </tr>
			      <tr>
		            <td  class="label"><bean:message bundle="softchange" key="softchange.linkRiskEstimate"/>*</td>
		              <td colspan="3" class="content"> 	
    				  <textarea class="textarea max" name="${sheetPageName}linkRiskEstimate" id="${sheetPageName}linkRiskEstimate" alt="width:500,allowBlank:false">${sheetLink.linkRiskEstimate}</textarea>
                    </td>
		          </tr>
			      <tr>
		            <td  class="label"><bean:message bundle="softchange" key="softchange.linkEffectAnalyse"/>*</td>
		              <td colspan="3" class="content"> 	
    				  <textarea class="textarea max" name="${sheetPageName}linkEffectAnalyse" id="${sheetPageName}linkEffectAnalyse" alt="width:500,allowBlank:false">${sheetLink.linkEffectAnalyse}</textarea>
                    </td>
		          </tr>
	            ...
	            <input type="hidden" name="${sheetPageName}operateType" id="${sheetPageName}operateType" value="111" />	        
			      ...
			      <tr>
		            <td  class="label"><bean:message bundle="softchange" key="softchange.linkCheckComment"/>*</td>
		              <td colspan="3"> 	
    				  <textarea class="textarea max" name="${sheetPageName}linkCheckComment" id="${sheetPageName}linkCheckComment" alt="width:500,allowBlank:false">${sheetLink.linkCheckComment}</textarea>
                    </td>
		          </tr>
	<%}}%>
	    <% if(taskName.equals("PermitTask")){
			      ...
			      <tr>
		            <td  class="label"><bean:message bundle="softchange" key="softchange.linkPermitIdea"/>*</td>
		              <td colspan="3"> 	
    				  <textarea class="textarea max" name="${sheetPageName}linkPermitIdea" id="${sheetPageName}linkPermitIdea" alt="width:500,allowBlank:false">${sheetLink.linkPermitIdea}</textarea>
                    </td>
		          </tr>
	<%}}%>
	    <% if(taskName.equals("PlanTask")){
			      ...
			      <tr>
		            ...
		            <td> <input type="text"  class="text" name="${sheetPageName}linkManager" id="${sheetPageName}linkManager"  value="${sheetLink.linkManager}" alt="allowBlank:false"/></td>		
		            <td  class="label"><bean:message bundle="softchange" key="softchange.linkContact"/>*</td>
		            <td> <input type="text"  class="text" name="${sheetPageName}linkContact" id="${sheetPageName}linkContact"  value="${sheetLink.linkContact}" alt="allowBlank:false"/></td>
		          </tr>
			      <tr>
		            <td  class="label"><bean:message bundle="softchange" key="softchange.linkPlanStartTime"/>*</td>
		                 <td>
		   				 <input class="text" onclick="popUpCalendar(this, this)" type="text" name="${sheetPageName}linkPlanStartTime" readonly="readonly"  alt="allowBlank:true" value="${eoms:date2String(sheetLink.linkPlanStartTime)}" id="${sheetPageName}linkPlanStartTime" />
		                </td>
		            <td  class="label"><bean:message bundle="softchange" key="softchange.linkPlanEndTime"/></td>
		                <td>
		   				 <input class="text" onclick="popUpCalendar(this, this)" type="text" name="${sheetPageName}linkPlanEndTime" readonly="readonly"  alt="allowBlank:true" value="${eoms:date2String(sheetLink.linkPlanEndTime)}" id="${sheetPageName}linkPlanEndTime" />
		                </td>
		          </tr>
			      <tr>
		            <td  class="label"><bean:message bundle="softchange" key="softchange.linkCellInfo"/>*</td>
		              <td colspan="3"> 	
    				  <textarea class="textarea max" name="${sheetPageName}linkCellInfo" id="${sheetPageName}linkCellInfo" alt="width:500,allowBlank:false">${sheetLink.linkCellInfo}</textarea>
                    </td>
		          </tr>
	                <tr>
            	      ...
            	      initDicId="10301"  alt="allowBlank:true" defaultValue="${sheetLink.linkIsEffectBusiness}" styleClass="select-class"/>
			        </td>	                
		            </tr>
			      <tr>
		            <td  class="label"><bean:message bundle="softchange" key="softchange.linkEffectCondition"/></td>
		              <td colspan="3"> 	
    				  <textarea class="textarea max" name="${sheetPageName}linkEffectCondition" id="${sheetPageName}linkEffectCondition" alt="width:500,allowBlank:true">${sheetLink.linkEffectCondition}</textarea>
                    </td>
		          </tr>
			      <tr>
		            <td  class="label"><bean:message bundle="softchange" key="softchange.linkNetManage"/></td>
		              <td colspan="3"> 	
    				  <textarea class="textarea max" name="${sheetPageName}linkNetManage" id="${sheetPageName}linkNetManage" alt="width:500,allowBlank:true ">${sheetLink.linkNetManage}</textarea>
                    </td>
		          </tr>
	                <tr>
	         ...
	         if(operateType.equals("114")){%>
	              ...
	              <input type="hidden" name="${sheetPageName}operateType" id="${sheetPageName}operateType" value="114" />	        
	                ...
	                <tr>
            	      ...
            	      initDicId="1010903"  alt="allowBlank:false" defaultValue="${sheetLink.linkCutResult}" styleClass="select-class"/>
			            </td>	                
			      ...
			      <tr>
		            <td  class="label"><bean:message bundle="softchange" key="softchange.linkCutComment"/>*</td>
		              <td colspan="3"> 	
    				  <textarea class="textarea max" name="${sheetPageName}linkCutComment" id="${sheetPageName}linkCutComment" alt="width:500,allowBlank:false">${sheetLink.linkCutComment}</textarea>
                    </td>
		          </tr>
			      <tr>
		            <td  class="label"><bean:message bundle="softchange" key="softchange.linkBusinessComment"/>*</td>
		              <td colspan="3"> 	
    				  <textarea class="textarea max" name="${sheetPageName}linkBusinessComment" id="${sheetPageName}linkBusinessComment" alt="width:500,allowBlank:false">${sheetLink.linkBusinessComment}</textarea>
                    </td>
		          </tr>
	                <tr>
			      ...
			      <tr>
		            <td  class="label"><bean:message bundle="softchange" key="softchange.linkAlertRecord"/>*</td>
		              <td colspan="3"> 	
    				  <textarea class="textarea max" name="${sheetPageName}linkAlertRecord" id="${sheetPageName}linkAlertRecord" alt="width:500,allowBlank:false">${sheetLink.linkAlertRecord}</textarea>
                    </td>
		          </tr>
			      <tr>
		            <td  class="label"><bean:message bundle="softchange" key="softchange.linkUnnormalComment"/>*</td>
		              <td colspan="3"> 	
    				  <textarea class="textarea max" name="${sheetPageName}linkUnnormalComment" id="${sheetPageName}linkUnnormalComment" alt="width:500,allowBlank:false">${sheetLink.linkUnnormalComment}</textarea>
                    </td>
		          </tr>
	            ...
	            <input type="hidden" name="${sheetPageName}operateType" id="${sheetPageName}operateType" value="115" />	  
			      <tr>
		            <td  class="label"><bean:message bundle="softchange" key="softchange.linkCutAnalyse"/></td>
		              <td colspan="3"> 	
    				  <textarea class="textarea max" name="${sheetPageName}linkCutAnalyse" id="${sheetPageName}linkCutAnalyse" alt="width:500,allowBlank:true">${sheetLink.linkCutAnalyse}</textarea>
                    </td>
		          </tr>
	                <tr>
            	      ...
            	      initDicId="1010909"  alt="allowBlank:false" defaultValue="${sheetLink.linkIsUpdateWork}" styleClass="select-class"/>
			        </td>	                
			      ...
			      <tr>
		            <td  class="label"><bean:message bundle="softchange" key="softchange.linkWorkUpdateAdvice"/></td>
		              <td colspan="3"> 	
    				  <textarea class="textarea max" name="${sheetPageName}linkWorkUpdateAdvice" id="${sheetPageName}linkWorkUpdateAdvice" alt="width:500,allowBlank:true">${sheetLink.linkWorkUpdateAdvice}</textarea>
                    </td>
		          </tr>
			      <tr>
		            <td  class="label"><bean:message bundle="softchange" key="softchange.linkSoftVersionUpdate"/>*</td>
		              <td colspan="3"> 	
    				  <textarea class="textarea max" name="${sheetPageName}linkSoftVersionUpdate" id="${sheetPageName}linkSoftVersionUpdate" alt="width:500,allowBlank:false">${sheetLink.linkSoftVersionUpdate}</textarea>
                    </td>
		          </tr>
			      <tr>
		            <td  class="label"><bean:message bundle="softchange" key="softchange.linkNextPlan"/></td>
		              <td colspan="3"> 	
    				  <textarea class="textarea max" name="${sheetPageName}linkNextPlan" id="${sheetPageName}linkNextPlan" alt="width:500,allowBlank:true">${sheetLink.linkNextPlan}</textarea>
                    </td>
		          </tr>
			      <tr>
		            <td  class="label"><bean:message bundle="softchange" key="softchange.linkProjectComment"/>*</td>
		              <td colspan="3"> 	
    				  <textarea class="textarea max" name="${sheetPageName}linkProjectComment" id="${sheetPageName}linkProjectComment" alt="width:500,allowBlank:false">${sheetLink.linkProjectComment}</textarea>
                    </td>
		          </tr>
	<%}} %>
