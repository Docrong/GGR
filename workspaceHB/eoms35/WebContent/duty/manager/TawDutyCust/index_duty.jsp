...
<form name="form1" method="post">
    ...
    <table cellpadding="0" cellspacing="5" width="98%" border="0" class="clsbkgd" align="center">
        <tr class="top_table_1">
            <td colspan=2>
                <table cellpadding="0" cellspacing="0" class="top_table_1" width="100%" align="center">
                    <tr>
                        <td class="index_1_td"><img src="<%=imgPath%>/hljunicom/mtable_1.gif" width="6" height="27">
                        </td>
                        <td background="<%=imgPath%>/hljunicom/mtable_1_bg.gif">
                            <table cellpadding="1" cellspacing="0" class="maintable">
                                <tr>
                                    <td class="index_1_td_2"><img src="<%=imgPath%>/hljunicom/arrow_7.gif" width="14"
                                                                  height="14"></td>
                                    <td class="letter_2">班次信息_message</td>
                                    <td class="index_1_td_2"><img src="<%=imgPath%>/hljunicom/arrow_1.gif" width="16"
                                                                  height="16" onClick="h('duty')"></td>
                                </tr>
                            </table>
                        </td>
                        <td align="right" class="index_1_td"><img src="<%=imgPath%>/hljunicom/mtable_2.gif" width="6"
                                                                  height="27"></td>
                    </tr>
                    <tr id="duty">
                        <td background="<%=imgPath%>/hljunicom/mtable_2_bg.gif">&nbsp;</td>
                        <td class="index_1_td_1_bg">
                            <table width="100%" border="0">
                                <tr>
                                    <td>
                                        <table cellpadding="1" cellspacing="1" border="0" width="98%" class="table_show"
                                               align="center">
                            ...
                            <table width="100%" align="center">
                                ...
                                <tr width="515">
                                    <td class="index_1_td_1_bg" height="117" valign="top">
                                        <jsp:include page="/infopub/TawInformation/list_inc.do?boardId=2055&infoType=1"
                                                     flush='true'/>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right" class="letter_3"><img src="<%=imgPath%>/hljunicom/more2.gif"
                                                                            onClick="window.location='<%=webapp%>/infopub/TawInformation/viewNew.do?boardId=2055&infoType=1&boardId2=10121&viewFlag=1'"
                                                                            align="absmiddle"></td>
                                </tr>
                            </table>
                        </td>
            ...
            <td valign="top">
                <table cellpadding="0" cellspacing="0" class="top_table_1" border="0" width="100%">
                    <tr>
                        ...
                        <td background="<%=imgPath%>/hljunicom/table_1_bg.gif">
                            <table cellpadding="1" cellspacing="0" class="maintable">
                                <tr>
                                    <td class="index_1_td_2"><img src="<%=imgPath%>/hljunicom/arrow_9.gif" width="16"
                                                                  height="18"></td>
                                    <td class="letter_1">短信</td>
                                    <td class="index_1_td_2"><img src="<%=imgPath%>/hljunicom/arrow_1.gif" width="16"
                                                                  height="16" onclick="h('sms')"></td>
                                </tr>
                            </table>
                        </td>
                        <td align="right" class="index_1_td"><img src="<%=imgPath%>/hljunicom/table_2.gif" width="6"
                                                                  height="27"></td>
                    </tr>
                    <tr id="sms">
                        <td background="<%=imgPath%>/hljunicom/table_2_bg.gif">&nbsp;</td>
                        <td class="index_1_td_1_bg">
                            <table cellpadding="1" cellspacing="1" class="top_table_1">
                                <form action="../template/sm.jsp" method="POST" name="smform">
                                    <tr>
                                        <td width="24%">手机号</td>
                                        <td width="76%"><input name="textfield" type="text" class="table" size="15">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td valign="top">内容</td>
                                        <td><textarea name="textfield2" cols="15" rows="5" class="table"></textarea>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
