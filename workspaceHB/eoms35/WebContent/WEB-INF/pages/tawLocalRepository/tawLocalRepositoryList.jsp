...
<fmt:bundle basename="config/applicationResource-tawlocalrepository">
    ...
    <display:table name="tawLocalRepositoryList" cellspacing="0" cellpadding="0"
        ...
        <display:column property="net" sortable="true"
                        ...
                        href="${app}/repository/tawLocalRepositorys.do?method=edit" paramId="id" paramProperty="id"/>
        ...
        <display:column property="networkTime" sortable="true"
                        headerClass="sortable" titleKey="tawLocalRepository.networkTime" paramId="id"
                        paramProperty="id"/>
        ...
        <display:column titleKey="tawLocalRepository.execute" style="width:60px">
            <a style="vertical-align: middle;"
               href="${app}/repository/tawLocalRepositorys.do?method=edit&id=${tawLocalRepositoryList.id}"
               title="${eoms:a2u('修改')}"><img src="${app }/images/icons/edit.gif"></a>
            |
            <a style="vertical-align: middle;"
               href="${app}/repository/tawLocalRepositoryUps.do?method=add&repositoryId=${tawLocalRepositoryList.id}"
               title="${eoms:a2u('升级')}"><img src="${app }/images/icons/note.gif"></a>
