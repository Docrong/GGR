        ...
        <tr>
            ...
            <td>
                ...
                <input type="text" name="beginTime" id="beginTime"
                       alt="allowBlank:true,vtype:'lessThen',link:'endTime',vtext:'开始时间不能为空或晚于结束时间'" readonly="readonly"
                       onclick="popUpCalendar(this, this,null,null,null,true,-1);" class="text"/>
                到：
                <input type="text" name="endTime" id="endTime"
                       alt="allowBlank:true,vtype:'moreThen',link:'beginTime',vtext:'结束时间不能为空或早于开始时间'"
