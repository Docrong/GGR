...
<form name="tawwpitemedit" method="post"
      action="../tawwpmodel/itemmodify.do?modelplanid=<%=request.getParameter("modelplanid")%>&modelexecuteid=<%=request.getParameter("modelexecuteid")%>"
    ...
    <table class="formTable">
        ...
        <tr>
            ...
            <td width="400">
                <input type="text" name="executedeptlevel" size="40" class="text"
                       value="<%=tawwpModelExecuteVO.getExecutedeptlevel()%>">
            </td>
        </tr>
        <tr>
            <td class="label">
        ...
        <tr>
            ...
            <td>
                <eoms:attachment idList="" idField="accessories" appCode="workplan" scope="request" name="modelexecute"
        ...
        <tr>
            <td colspan='2'>
                <input type="submit" value="<bean:message key="itemedit.tawwpmodel.btnSubmit" />" name="B1"
                       Class="submit">
                <input type="button" value="<bean:message key="itemedit.tawwpmodel.btnBack" />"
