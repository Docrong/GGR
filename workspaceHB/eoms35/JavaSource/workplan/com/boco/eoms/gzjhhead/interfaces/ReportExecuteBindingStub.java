...
public class ReportExecuteBindingStub extends org.apache.axis.client.Stub implements com.boco.eoms.gzjhhead.interfaces.ReportExecutePortType {
    ...
    static {
        ...
        oper.setReturnClass(com.boco.eoms.gzjhhead.interfaces._ReportFormResponse.class);
        ...
        oper.addFault(new org.apache.axis.description.FaultDesc(
                      ...
                      "com.boco.eoms.gzjhhead.interfaces.FaultDetails",
        ...
        oper.addParameter(new javax.xml.namespace.QName("http://eoms.chinaunicom.com.cn/worktaskschedule/ReportExecuteService", "ModifyFormRequest"), new javax.xml.namespace.QName("http://eoms.chinaunicom.com.cn/worktaskschedule/ReportExecuteService", "ModifyFormRequest"), com.boco.eoms.gzjhhead.interfaces._ModifyFormRequest.class, org.apache.axis.description.ParameterDesc.IN, false, false);
        ...
        oper.setReturnClass(com.boco.eoms.gzjhhead.interfaces._ModifyFormResponse.class);
    ...
    public ReportExecuteBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
            ...
            cls = com.boco.eoms.gzjhhead.interfaces._ReportFormRequest.class;
            ...
            cachedSerQNames.add(qName);
            cls = com.boco.eoms.gzjhhead.interfaces.NeNumberType.class;
            cachedSerClasses.add(cls);
            ...
            cachedSerQNames.add(qName);
            cls = com.boco.eoms.gzjhhead.interfaces._ModifyFormRequest.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.boco.eoms.gzjhhead.interfaces.AttachInfoType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.boco.eoms.gzjhhead.interfaces.NeListType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.boco.eoms.gzjhhead.interfaces.ReportTypeType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(simplesf);
            cachedDeserFactories.add(simpledf);
            ...
            cachedSerQNames.add(qName);
            cls = com.boco.eoms.gzjhhead.interfaces.ModifyTypeType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(simplesf);
            cachedDeserFactories.add(simpledf);
            ...
            cachedSerQNames.add(qName);
            cls = com.boco.eoms.gzjhhead.interfaces.AttachInfoListType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.boco.eoms.gzjhhead.interfaces._ModifyFormResponse.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.boco.eoms.gzjhhead.interfaces._ReportFormResponse.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.boco.eoms.gzjhhead.interfaces.NoteType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(simplesf);
            cachedDeserFactories.add(simpledf);
    ...
    public com.boco.eoms.gzjhhead.interfaces._ReportFormResponse reportForm(com.boco.eoms.gzjhhead.interfaces._ReportFormRequest parameters) throws java.rmi.RemoteException, com.boco.eoms.gzjhhead.interfaces.FaultDetails {
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (com.boco.eoms.gzjhhead.interfaces._ReportFormResponse) _resp;
            } catch (java.lang.Exception _exception) {
                return (com.boco.eoms.gzjhhead.interfaces._ReportFormResponse) org.apache.axis.utils.JavaUtils.convert(_resp, com.boco.eoms.gzjhhead.interfaces._ReportFormResponse.class);
            }
        }
    }
    ...
    public com.boco.eoms.gzjhhead.interfaces._ModifyFormResponse modifyForm(com.boco.eoms.gzjhhead.interfaces._ModifyFormRequest parameters) throws java.rmi.RemoteException, com.boco.eoms.gzjhhead.interfaces.FaultDetails {
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (com.boco.eoms.gzjhhead.interfaces._ModifyFormResponse) _resp;
            } catch (java.lang.Exception _exception) {
                return (com.boco.eoms.gzjhhead.interfaces._ModifyFormResponse) org.apache.axis.utils.JavaUtils.convert(_resp, com.boco.eoms.gzjhhead.interfaces._ModifyFormResponse.class);
            }
        }
    }
