...
<table class="formTable">
    ...
    <tr>
        ...
        <td colspan="3">
            <textarea class="textarea max" name="${sheetPageName}linkAnalysisResult"
                      id="${sheetPageName}linkAnalysisResult"
                      alt="width:500,allowBlank:false,maxLength:2000,vtext:'请填入分析结果，最多输入2000字'">${sheetLink.linkAnalysisResult}</textarea>
        </td>
    </tr>
    <tr>
        <td class="label">
        ...
        <td colspan='3'>
            <eoms:attachment name="sheetLink" property="linkAnalysisReport"
                             scope="request" idField="${sheetPageName}linkAnalysisReport" appCode="securityevaluate"
                             alt="allowBlank:true"/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td colspan="3">
            <eoms:comboBox name="${sheetPageName}linkAuditOpinion" id="${sheetPageName}linkAuditOpinion"
                           defaultValue="${sheetLink.linkAuditOpinion}"
                           initDicId="1011301" alt="allowBlank:false" onchange="ifAuditPass(this.value);"
    ...
    <tr>
        ...
        <td colspan="3">
            <textarea name="${sheetPageName}endResult" alt="allowBlank:false,maxLength:255,vtext:'请填入信息，最多输入125字'"
