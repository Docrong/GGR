...
<input type="hidden" name="phaseId" id="phaseId" value="Audit" />
    ...
    <input type="hidden" name="mainClassName" value="com.boco.eoms.sheet.equipmentunsubscribe.model.EquipmentUnsubscribeMain"/>	
    <input type="hidden" name="linkClassName" value="com.boco.eoms.sheet.equipmentunsubscribe.model.EquipmentUnsubscribeLink"/>
    <br>
...
<table id="sheet" class="formTable" >
 ...
 <td class="label">
		...
		<tr><td class="label">
			...
			<td>
				<input type="text"  class="text" name="mainMINIID" id="mainMINIID"  alt="allowBlank:true,maxLength:1000,vtext:'请填入 MINI设备安装ID 信息，最多输入 1000 字符'" value="${sheetMain.mainMINIID}"/>
			</td>
 <td class="label">
				<!-- 详细地址信息 -->
			...
			<td>
				<input type="text"  class="text" name="mainAddress" id="mainAddress"  alt="allowBlank:true,maxLength:1000,vtext:'请填入 详细地址信息 信息，最多输入 1000 字符'" value="${sheetMain.mainAddress}"/>
			</td>
		</tr>
		...
		<tr><td class="label">
			...
			<td colspan="3">
				<eoms:attachment name="sheetMain" property="mainSignPhoto" 
		            scope="request" idField="mainSignPhoto" appCode="equipmentunsubscribe" alt="allowBlank:false"/> 				
			</td>
		</tr>
 		</tbody>
</table>
