...
<%
 ...
 %>
		...
		<input type="hidden" name="linkBeanId" id="linkBeanId" value="iWidenComplaintLinkManager"/>
	  ...
	  <td colspan="3">
	     ...
	     <c:if test="${empty sheetMain.sendRoleId}">       
	        ...
	        <eoms:roleComboBox name="sendRoleId" id="sendRoleId" 
		  	  userId="${sheetMain.sendUserId}" roleId="1740" defaultValue="${sheetMain.sendRoleId}"/>     
	     </c:if>
	     <c:if test="${!empty sheetMain.sendRoleId}">
