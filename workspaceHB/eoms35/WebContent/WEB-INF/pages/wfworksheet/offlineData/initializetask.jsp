...
<html:form action="/offlineData.do?method=newTaskPerformAdd" styleId="theform" target="myname">
    ...
    <table class="formTable">
        <tr>
            <td class="label"><bean:message bundle="offlineData" key="offlineData.linkUrgency"/>*</td>
        ...
        <tr>
            <td class="label"><bean:message bundle="offlineData" key="offlineData.linkReqCompleteTime"/>*</td>
            <td class="content">
            ...
            <td class="label"><bean:message bundle="offlineData" key="offlineData.linkAcceptDept"/>*</td>
            <td class="content">
        ...
        <tr>
            <td class="label"><bean:message bundle="offlineData" key="offlineData.linkSendSheetDesc"/>*</td>
            <td colspan="3">
    ...
    <c:if test="${phaseId=='UserTask'}">
        ...
        <fieldset id="link1">
            <legend>
                <bean:message bundle="offlineData" key="role.toOrgName"/>
