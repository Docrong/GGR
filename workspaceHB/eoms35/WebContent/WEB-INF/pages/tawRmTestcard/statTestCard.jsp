...
<script language="javascript">
    ...
    Ext.onReady(function () {
        ...
        borrowerTree = new xbox({
            btnId: 'borrowerTreeBtn',
            dlgId: 'dlg-huser',
            treeDataUrl: borrowerTreeAction,
            treeRootId: '-1',
            treeRootText: '${eoms:a2u("人员列表")}',
            treeChkMode: 'single',
            treeChkType: 'user',
            showChkFldId: 'borrowerName',
            saveChkFldId: 'borrowerId'
        });
...
<html:form action="tawRmTestcards" method="post" styleId="tawRmTestcardForm">
    <table class="formTable">
        <caption>
            <fmt:message key="statDetail.heading"/>
        </caption>
        <tr>
        ...
        <tr>
            ...
            <td width="500" colspan="3">
                <fmt:message key="tawRmInoutRecordForm.from"/><input type="text" name="borrowStartDate" size="30"
                                                                     value="" class="text"
                                                                     onclick="popUpCalendar(this, this,'yyyy-mm-dd',-1,-1,false);"
                                                                     readonly="true">
                <fmt:message key="tawRmInoutRecordForm.to"/><input type="text" name="borrowEndDate" size="30" value=""
                                                                   class="text"
                                                                   onclick="popUpCalendar(this, this,'yyyy-mm-dd',-1,-1,false);"
                                                                   readonly="true">
            </td>
        ...
        <tr>
            ...
            <td width="500" colspan="3">
                <fmt:message key="tawRmInoutRecordForm.from"/><input type="text" name="intendingReturnStartDate"
                                                                     size="30" value="" class="text"
                                                                     onclick="popUpCalendar(this, this,'yyyy-mm-dd',-1,-1,false);"
                                                                     readonly="true">
                <fmt:message key="tawRmInoutRecordForm.to"/><input type="text" name="intendingReturnEndDate" size="30"
                                                                   value="" class="text"
                                                                   onclick="popUpCalendar(this, this,'yyyy-mm-dd',-1,-1,false);"
                                                                   readonly="true">
            </td>
    ...
    <br>
    <html:submit styleClass="button" property="method.statTestCard" onclick="bCancel=false">
