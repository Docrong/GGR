    ...
    <table class="formTable">
        ...
        <tr>
            ...
            <td width="500" colspan="2">
                <eoms:label styleClass="desc" key="tawRmTestcardForm.allCard"/><html:radio property="cardType" value="2"
		...
		<tr>
			<td width="100" class="label">
				<fmt:message key="tawRmTestcardForm.visitPlace" />
			</td>
			<td width="500" colspan="3">
				<input type="text" name="visitPlace" size="30" value="" class="text">
			</td>
		</tr>-->
        <tr>
            <td width="100" class="label">
                <fmt:message key="tawRmTestcardForm.supplyer"/>
            </td>
            <td width="500" colspan="3">
                <input type="text" name="supplyer" size="30" value="" class="text">
            </td>
        </tr>
        <tr>
            <td width="100" class="label">
                <fmt:message key="tawRmTestcardForm.iccid"/>
            </td>
            <td width="500" colspan="3">
                <input type="text" name="iccid" size="30" value="" class="text">
            </td>
        </tr>
        <tr>
            <td width="100" class="label">
        ...
        <tr>
            <td width="100" class="label">
                <fmt:message key="tawRmTestcardForm.imsi"/>
            </td>
            <td width="500" colspan="3">
                <input type="text" name="imsi" size="30" value="" class="text">
            </td>
        </tr>
        <tr>
            <td width="100" class="label">
                <fmt:message key="tawRmTestcardForm.pin"/>
            </td>
            <td width="500" colspan="3">
                <input type="text" name="pin" size="30" value="" class="text">
            </td>
        </tr>
        <tr>
            <td width="100" class="label">
                <fmt:message key="tawRmTestcardForm.openAccountDate"/>
            </td>
            <td width="500" colspan="3">
                <input type="text" name="openAccountDate" size="30" value="" class="text"
                       onclick="popUpCalendar(this, this,'yyyy-mm-dd',-1,-1,false);" readonly="true">
            </td>
        </tr>
        <tr>
            <td width="100" class="label">
                <fmt:message key="tawRmTestcardForm.logoutDate"/>
            </td>
            <td width="500" colspan="3">
                <input type="text" name="logoutDate" size="30" value="" class="text"
                       onclick="popUpCalendar(this, this,'yyyy-mm-dd',-1,-1,false);" readonly="true">
            </td>
        </tr>
        <tr>
            <td width="100" class="label">
                <fmt:message key="tawRmTestcardForm.takeOverDate"/>
            </td>
            <td width="500" colspan="3">
                <input type="text" name="takeOverDate" size="30" value="" class="text"
                       onclick="popUpCalendar(this, this,'yyyy-mm-dd',-1,-1,false);" readonly="true">
            </td>
        </tr>
        <tr>
            <td width="100" class="label">
                <fmt:message key="tawRmTestcardForm.state"/>
            </td>
            <td width="500" colspan="3">
                <eoms:dict key="dict-plancontent" dictId="useState" beanId="selectXML"
                           isQuery="false" selectId="state" alt="allowBlank:true"/>
            </td>
        </tr>
    </table>
    <br>
