   ...
   if(operateType != null){
      ...
      %>
            ...
            <input type="hidden" name="${sheetPageName}mainClassName"
                   value="com.boco.eoms.sheet.businessplan.model.BusinessPlanMain"/>    <!--mainè¡¨Modelå¯¹è±¡ç±»å-->
            <input type="hidden" name="${sheetPageName}linkClassName"
                   value="com.boco.eoms.sheet.businessplan.model.BusinessPlanLink"/> <!--linkè¡¨Modelå¯¹è±¡ç±»å-->
