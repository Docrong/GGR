...
<%
    com.boco.eoms.sheet.softwareLoad.model.SoftwareLoadLink softwareLoadLink = (com.boco.eoms.sheet.softwareLoad.model.SoftwareLoadLink) request.getAttribute("sheetLink");
    java.lang.String taskName = com.boco.eoms.base.util.StaticMethod.nullObject2String(softwareLoadLink.getActiveTemplateId());
    java.lang.String operateType = java.lang.String.valueOf(com.boco.eoms.base.util.StaticMethod.nullObject2String(softwareLoadLink.getOperateType()));
%>
<script type="text/javascript">
    ...
    function saveDealTemplate(type) {
        ...
        form.action = "${app}/sheet/softwareLoad/softwareLoad.do?method=saveDealTemplate&type=dealTemplateManage&dealTemplateId=${sheetLink.id}";
        form.submit();
    }
...
<%@ include file="/WEB-INF/pages/wfworksheet/softwareLoad/baseinputlinkhtmlnew.jsp" %>
<html:form action="/softwareLoad.do" styleId="theform">
    <br/>
    ...
    <table class="formTable">
        <caption><bean:message bundle="softwareLoad" key="softwareLoad.header"/></caption>
        <tr>
            <td class="label">
        ...
        <tr>
            <td class="label"><bean:message bundle="softwareLoad" key="softwareLoad.linkZContact"/>*</td>
            <td class="content">
            ...
            <td class="label"><bean:message bundle="softwareLoad" key="softwareLoad.linkZContactTel"/>*</td>
            <td class="content">
                <input type="text" class="text" name="${sheetPageName}linkZContactTel"
                       id="${sheetPageName}linkZContactTel"
        ...
        <tr>
            ...
            <td colspan='3'>
                <eoms:attachment idList="" scope="request" idField="${sheetPageName}nodeAccessories" name="sheetLink"
                                 property="nodeAccessories" appCode="softwareLoad" alt="allowBlank:true"/>
            </td>
        </tr>
        <%
                }
        ...
        <tr>
            <td class="label"><bean:message bundle="softwareLoad" key="softwareLoad.linkOperationDesc"/>*</td>
            <td colspan="3">
        ...
        <tr>
            <td class="label">
                <bean:message bundle="softwareLoad" key="softwareLoad.remark"/>*
            </td>
            <td colspan="3">
