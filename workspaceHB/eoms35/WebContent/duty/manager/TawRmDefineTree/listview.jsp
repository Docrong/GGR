    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%" align="center" height="102%">
        <tr>
            <td colspan="3" height="28">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" background="../images/main-top_02.gif"
                       class="p9">
                    <tr>
                        <td width="11"><img src="../images/main-top_01.gif" width="14" height="33"></td>
                        <TD width=""></TD>
                        <TD nowrap onmouseover=mOver_button(this) onmouseout=mOut_button(this)><a
                                href=javascript:self.location="selectroom.do"><IMG border=0 height=19
                                                                                   src="../images/backhome.gif" width=19
                                                                                   align=absmiddle>返回&nbsp;</a></TD>
                        <td nowrap onmouseover=mOver_button(this) onmouseout=mOut_button(this)><a
                                href="javascript:AddDutyTask()" title="新建值班作业"><img src="../images/new.gif"
                                                                                    align="absmiddle" border="0">新建值班作业&nbsp;</a>
                        </td>
                        <td nowrap onmouseover=mOver_button(this) onmouseout=mOut_button(this)><a href="#"
                                                                                                  onclick="deletetask();return false"
                                                                                                  title=删除选中文档><img
                                src="../images/delete.gif" align="absmiddle" border="0">删除&nbsp;</a></td>
                        <td nowrap onmouseover=mOver_button(this) onmouseout=mOut_button(this)><a href="#"
                                                                                                  onclick='self.location="listview.do?roomId=<%=request.getAttribute("roomId")%>"'><img
                                src="../images/icon_refresh.gif" align="absmiddle" border="0" alt=刷新>刷新&nbsp;</a></td>
                        <TD width="100%">&nbsp;</TD>
                ...
                <div id="Layer1" class=mainview id=Layer1>
                    ...
                    <DIV class=cpcontent id=tab3>
                        <DIV id=oDescription
                            ...
                            <table id="table1" border=0 align=center width=98% cellpadding=0 cellspacing=1
                                   style=font-size:9pt>
                                ...
                                <tr id="t1t<%=i+1%>">
                                    ...
                                    <TD align="left" nowrap>
                                        <img src="../images/mod.gif" id=a1a<%=i+1%> border=0
                                             onClick=javascript:showhide('t1t<%=i+1%>');setTableColor(table1,1)
                                             style='CURSOR: hand'>
                                        <%=cyclesNames[i]%>
                                    </td>
                                    <td></td>
                                ...
                                <tr ondblclick=DispDutyTask("<%=tmpVector.elementAt(j*3)%>","<%=tmpVector.elementAt(j*3+1)%>","<%=tmpVector.elementAt(j*3+2)%>","<%=cycles[i]%>","<%=request.getAttribute("roomId")%>")
                                    ...
                                    <td>
                                        <input type="checkbox" class="chkbox" value="<%=tmpVector.elementAt(j*3)%>"
                                               name="L1L<%=i+1%>L<%=j+1%>" onclick="show(this)">
                                    </td>
                                    <td>
                                    </td>
                                    <td><%=tmpVector.elementAt(j * 3 + 2)%>
                                    </td>
                                    <td><%=tmpVector.elementAt(j * 3 + 1)%>
                                    </td>
                                </tr>
                                <%
