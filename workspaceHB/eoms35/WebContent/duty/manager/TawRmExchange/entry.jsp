                        ...
                        <td>
                            <table bgcolor="#f2f2f2" width="500" cellspacing="0" border="0">
                                    ...
                                    <c:otherwise>
                                        ...
                                        <tr>
                                            ...
                                            <td width="76%"><font size="2" face="Tahoma"><bean:write
                                                    name="tawRmExchangeForm" property="roomId"/></font></td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td width="19%"><font color="#022077" size="1"
                                                    ...
                                                    key="TawRmExchange.id"/></b></font></td>
                                            <td width="76%"><font size="2" face="Tahoma"><bean:write
                                                    name="tawRmExchangeForm" property="id"/></font></td>
                                        </tr>
                                ...
                                <tr>
                                    ...
                                    <td width="76%"><font size="2" face="Tahoma"><html:text property="exchangetime"
                                                                                            size="30"/></font></td>
                                </tr>
                                <tr bgcolor="#FFFFFF">
                                    <td width="5%"></td>
