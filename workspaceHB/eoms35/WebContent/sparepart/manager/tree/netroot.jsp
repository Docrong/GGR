...
var s=["s1","s2"];
var opt0 = ['${eoms:a2u("大专业类型")}','${eoms:a2u("小专业类型")}'];
...
<script language="javascript">
function checkdata() {
        if ( document.tawTree.dept.value == '${eoms:a2u("大专业类型")}' ) {
                alert('${eoms:a2u("请选择大专业类型！")}');
                document.tawTree.dept.focus();
                return false;
        }
        if ( document.tawTree.subType.value == '${eoms:a2u("小专业类型")}' ) {
                alert('${eoms:a2u("请选择小专业类型！")}');
                document.tawTree.subType.focus();
                return false;
        }
       return true;
}
