...
public class _EJSRemoteStatelessRoleService_53a09f33_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements Tie {

    private EJSRemoteStatelessRoleService_53a09f33 target = null;
    ...
    public void setTarget(Remote target) {
        this.target = (EJSRemoteStatelessRoleService_53a09f33) target;
    }
    ...
    public OutputStream _invoke(String method, InputStream _in, ResponseHandler reply) throws SystemException {
        try {
            ...
            switch (method.charAt(5)) {
                ...
                case 116:
                    if (method.equals("isVirtualRole")) {
                        return isVirtualRole(in, reply);
                    }
            }
    ...
    private OutputStream isVirtualRole(org.omg.CORBA_2_3.portable.InputStream in, ResponseHandler reply) throws Throwable {
        String arg0 = (String) in.read_value(String.class);
        boolean result = target.isVirtualRole(arg0);
        OutputStream out = reply.createReply();
        out.write_boolean(result);
        return out;
    }
