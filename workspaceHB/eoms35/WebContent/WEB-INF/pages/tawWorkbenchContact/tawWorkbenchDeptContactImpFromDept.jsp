...
<script type="text/javascript">
    Ext.onReady(function () {
        ...
        userTree = new xbox({
            ...
            treeRootId: '-1',
            treeRootText: '<bean:message key="tawWorkbenchContact.deptusertree"/>',
            treeChkMode: '',
    ...
    <table>
        <tr>
            ...
            <td class="label">
                ...
                <input type="button" value="<bean:message key='tawWorkbenchContact.deptusertree'/>" id="userTreeBtn"
                       class="btn"/>
            </td>
        </tr>
    </table>
