        ...
        ctxMenu: [
            {
                ...
                text: '新增考核模板分类',
                cls: 'new-mi',
                url: '${app}/eva/evaTemplateTypes.do?method=newTemplateType&nodeId='
            },
            {
                id: 'editTemplateType',
                text: '修改考核模板分类',
                cls: 'edit-mi',
                url: '${app}/eva/evaTemplateTypes.do?method=editTemplateType&nodeId='
            },
            {
                id: 'newTemplate',
                text: '新增考核模板',
                cls: 'new-mi',
                url: '${app}/eva/evaTemplates.do?method=newTemplate&nodeId='
            },
            {
                id: 'newKpi',
                text: '新增考核指标',
                cls: 'new-mi',
                url: '${app}/eva/evaKpis.do?method=listNextLevelKpi&parentNodeId='
            },
            {
                id: 'editTemplate',
                text: '修改/激活考核模板',
                cls: 'edit-mi',
                url: '${app}/eva/evaTemplates.do?method=editTemplate&nodeId='
            },
            {id: 'editKpi', text: '修改考核指标', cls: 'edit-mi', url: '${app}/eva/evaKpis.do?method=editKpi&parentNodeId='},
            {
                ...
                text: '删除考核模板',
                cls: 'remove-mi',
                url: '${app}/eva/evaTemplates.do?method=removeTemplate&nodeId='
            },
            {
                id: 'delKpi',
                isDelete: true,
                text: '删除考核指标',
                cls: 'remove-mi',
                url: '${app}/eva/evaKpis.do?method=delKpiFromTree&nodeId='
            }
        ],//end of ctxMenu
        /************************
