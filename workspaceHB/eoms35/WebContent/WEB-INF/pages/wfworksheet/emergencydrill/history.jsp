     ...
     <div class="history-item"><!-- add space to hack ie-->&nbsp;
       <div class="history-item-title">
		 ...
		 <bean:write name="baselink" property="operateTime" formatKey="date.formatDateTimeAll" bundle="sheet" scope="page"/>&nbsp; 
  	     ...
  	     <eoms:dict key="dict-sheet-emergencydrill" dictId="activeTemplateId" itemId="${baselink.activeTemplateId}" beanId="id2descriptionXML" />
  	     <bean:message bundle="emergencydrill" key="emergencydrill.operateType"/>:
  	     <eoms:dict key="dict-sheet-emergencydrill" dictId="mainOperateType" itemId="${baselink.operateType}" beanId="id2descriptionXML" />
			 ...
			 <tr>
		  	 ...
		  	 <tr>
  						<td class="label"><bean:message bundle="emergencydrill" key="emergencydrill.linkDrillSummaryReport"/></td>
		   				 ...
		   				 idField="${sheetPageName}linkDrillSummaryReport" appCode="emergencydrill" 
		   				 viewFlag="Y"/>
		                </td>
		            </tr>
			 ...
			 <%if(baselink.getOperateType()!=null && (baselink.getOperateType().intValue() == 96||
		  	 ...
		  	 <tr>
  						<td class="label"><bean:message bundle="emergencydrill" key="emergencydrill.linkEmergencyPreparedness"/></td>
		   				 ...
		   				 idField="${sheetPageName}linkEmergencyPreparedness" appCode="emergencydrill" 
		   				 viewFlag="Y"/>
		                </td>
		            </tr>
