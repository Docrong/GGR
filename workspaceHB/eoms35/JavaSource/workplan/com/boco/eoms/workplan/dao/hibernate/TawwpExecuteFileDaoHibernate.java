...
public class TawwpExecuteFileDaoHibernate extends BaseDaoHibernate implements
     ...
     * 保存执行作业计划附件
     *
     * @param _tawwpExecuteFile TawwpExecuteFile 执行作业计划附件类 @ 操作异常
     */
     ...
     * 查询执行作业计划附件信息
     *
     * @param id String 执行作业计划附件标识 @ 操作异常
     ...
     * 获取与执行执行内容关联的附件对象
     *
     * @param _fileCodeName        String 文件实际存储名
     * @param _tawwpExecuteContent TawwpExecuteContent 执行作业计划执行内容(整体)对象 @ 异常
