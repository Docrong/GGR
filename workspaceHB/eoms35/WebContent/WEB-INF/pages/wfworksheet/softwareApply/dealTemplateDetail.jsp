...
<%
    com.boco.eoms.sheet.softwareApply.model.SoftwareApplyLink softwareApplyLink = (com.boco.eoms.sheet.softwareApply.model.SoftwareApplyLink) request.getAttribute("sheetLink");
    java.lang.String taskName = com.boco.eoms.base.util.StaticMethod.nullObject2String(softwareApplyLink.getActiveTemplateId());
    java.lang.String operateType = java.lang.String.valueOf(com.boco.eoms.base.util.StaticMethod.nullObject2String(softwareApplyLink.getOperateType()));
%>
<script type="text/javascript">
    ...
    function saveDealTemplate(type) {
        ...
        form.action = "${app}/sheet/softwareApply/softwareApply.do?method=saveDealTemplate&type=dealTemplateManage&dealTemplateId=${sheetLink.id}";
        form.submit();
    }
...
<html:form action="/softwareApply.do" styleId="theform">
    <br/>
    ...
    <table class="formTable">
        <caption><bean:message bundle="softwareApply" key="softwareApply.header"/></caption>
        <tr>
            <td class="label">
        ...
        <tr>
            <td class="label"><bean:message bundle="softwareApply" key="softwareApply.linkZContact"/>*</td>
            <td class="content">
            ...
            <td class="label"><bean:message bundle="softwareApply" key="softwareApply.linkZContactTel"/>*</td>
            <td class="content">
        ...
        <tr>
            ...
            <td colspan='3'>
                <eoms:attachment idList="" scope="request" idField="${sheetPageName}nodeAccessories" name="sheetLink"
                                 property="nodeAccessories" appCode="softwareApply" alt="allowBlank:true"/>
            </td>
        </tr>
        <%
                }
        ...
        <tr>
            <td class="label"><bean:message bundle="softwareApply" key="softwareApply.linkOperationDesc"/>*</td>
            <td colspan="3">
        ...
        <tr>
            <td class="label">
                <bean:message bundle="softwareApply" key="softwareApply.remark"/>*
            </td>
            <td colspan="3">
