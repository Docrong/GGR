...
<tr> 
  ...
  <td colspan="3">
	...
	<textarea class="textarea max" readonly="true" name="${sheetPageName}showDept2" style="height:50px" id="${sheetPageName}showDept2"  alt="allowBlank:false,maxLength:50,vtext:'请填入地市，最多输入50字符'"><c:forTokens items="${languagespeciallineForm.businessOpenZone}" delims="," var="businessOpenZone" varStatus="status"><eoms:id2nameDB id="${businessOpenZone}" beanId="tawSystemAreaDao"/><c:choose><c:when test="${status.last}"></c:when><c:otherwise>,</c:otherwise></c:choose></c:forTokens></textarea>              
 ...
 <tbody id='BusinessInfo2' > 
	<tr>
      ...
      <td class="content">
        ...
        <html:text property="userCallNumber" styleId="userCallNumber"  styleClass="text medium" alt="allowBlank:false"/>
      </td>
...
<tr>  
	...
	<tr>
	  <td class="label">中继数*</td>
	    <td colspan='3'>
	  	<html:text property="infoBetweenNumber" styleId="infoBetweenNumber"  styleClass="text medium" alt="allowBlank:false"/></td>
    </tr>
	<tr>
    ...
    <tr>
      ...
      <td class="content">
        ...
        <html:text property="userComputerHoseAdd" styleId="userComputerHoseAdd"  styleClass="text medium" alt="allowBlank:false"/>
      </td>
 ...
 <tr>
     <tr>
      ...
      <td class="content">
	  	<html:errors property="portABDeviceType"/>
	  		  	          <eoms:comboBox name="portABDeviceType" id="portABDeviceType" defaultValue="${languagespeciallineForm.portABDeviceType}" initDicId="1012304" 
		  	       alt="allowBlank:true" styleClass="select-class" />
       </td>
       </tr>
	...
	<tbody id='interfaceInfo' > 
		<%if(taskName.equals("AccessTask")){%>
			<tr>
				  ...
				  <td colspan="3">						  	
				  	<a  style="cursor:hand;color:darkbule" onclick="javascript:popupIrmsPreSurvey('${languagespeciallineForm.portADetailAdd}')">点击进行接入点勘察</a>
				  </td>	
			</tr>
		<%} %>
		<tr>
	...
	<tr>
	  ...
	  <td colspan='3'>
	      	<html:errors property="fiberAroute"/>
	       	<textarea name="fiberAroute" id="fiberAroute" class="textarea max" alt="allowBlank:true">${languagespeciallineForm.fiberAroute}</textarea>			   
	     </td>
      </td>
	</tr>
	</tbody>
	...
	<tbody id='transLineInfo' > 
		<tr>
	      ...
	      <td class="content">
		  	<html:errors property="fiberOwnerA"/>
	       	   <eoms:comboBox name="fiberOwnerA" id="fiberOwnerA" defaultValue="${languagespeciallineForm.fiberOwnerA}" initDicId="1012315" 
		  	       alt="allowBlank:false" styleClass="select-class"/>
	     </td>
      </tr>
      <tr>
      ...
      <td class="content">
        ...
        <eoms:comboBox name="isOkBetweenUserA" id="isOkBetweenUserA" defaultValue="${languagespeciallineForm.isOkBetweenUserA}" initDicId="1012310" 
	  ...
	  <tbody id='YuanYin' style="display:none"> 
	     ...
	     <td colspan='3'>
	      	<html:errors property="noInputResonA"/>
	       	<textarea name="noInputResonA" id="noInputResonA" class="textarea max" alt="allowBlank:true">${languagespeciallineForm.noInputResonA}</textarea>			   
	     </td>
	     </tbody>
     </tr>
     </tbody>
    ...
    <tr>
    	<td class="label">传输容量是否满足开通</td>
     	<td class="content">
	        ...
	        <html:text property="isDeviceAllowOpenA" styleId="isDeviceAllowOpenA"  styleClass="text medium" alt="allowBlank:false"/>
     	</td>
         <td class="label">是否需要添加板卡</td>
          <td class="content">
	  	  <html:errors property="isNeedAddCardA"/>
          <eoms:comboBox name="isNeedAddCardA" id="isNeedAddCardA" defaultValue="${languagespeciallineForm.isNeedAddCardA}" initDicId="1012310" 
   ...
   <%if(taskName.equals("ProjectDealTask")
    ...
    <caption>最后一公里相关信息</caption> 	
	    ...
	    <tr>	      
	      ...
	      <td class="content">
		  	 <eoms:comboBox name="isGetInterfaceA" id="isGetInterfaceA" defaultValue="${languagespeciallineForm.isGetInterfaceA}" initDicId="1012310" 
		  	       alt="allowBlank:true" styleClass="select-class" />
	      </td>
		...
		<tr>
	      <td class="label">A最后一公里处理意见</td>
	       <td  colspan="3">
		  		<textarea name="theLastOpinionA" id="theLastOpinionA" class="textarea max" alt="allowBlank:false">${languagespeciallineForm.theLastOpinionA}</textarea>			   
			</td>
		</tr>
		<tr>
  ...
  <%if(sheetType.equals("businessImplement")&&(
	...
	<tbody id='circuitInfo' >  
     ...
     <td class="content">
        ...
        <html:text property="circuitName" styleId="circuitName"  styleClass="text medium" alt="allowBlank:false"/>
     </td>
      <td class="label">电路编号</td>
     <td class="content">
	  	<html:errors property="circuitSheetId"/>
        <html:text property="circuitSheetId" styleId="circuitSheetId"  styleClass="text medium" alt="allowBlank:false"/>
     </td>
   </tr>
   </tbody>
   </table>
