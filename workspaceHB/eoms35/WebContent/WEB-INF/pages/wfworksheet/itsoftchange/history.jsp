        ...
        <logic:iterate id="baselink" name="HISTORY" type="com.boco.eoms.sheet.itsoftchange.model.ITSoftChangeLink">
            ...
            <div class="history-item"><!-- add space to hack ie-->&nbsp;
                <div class="history-item-title">
                    ...
                    <eoms:dict key="dict-sheet-itsoftchange" dictId="activeTemplateId"
                               itemId="${baselink.activeTemplateId}" beanId="id2descriptionXML"/>
                    <bean:message bundle="itsoftchange" key="itsoftchange.operateType"/>:
                    <eoms:dict key="dict-sheet-itsoftchange" dictId="mainOperateType" itemId="${baselink.operateType}"
                ...
                <div class="history-item-content hide">
                    ...
                    <table class="history-item-table" width="100%" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td class="column-content">
                                <eoms:dict key="dict-sheet-itsoftchange" dictId="mainOperateType"
                        ...
                        <tr>
                            ...
                            <td class="column-content" colspan=3>
                                <pre><bean:write name="baselink" property="linkIfNotifyInterfixSystem"
                                                 scope="page"/></pre>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td class="label"><bean:message bundle="itsoftchange"
                                                            key="itsoftchange.linkTestGuide"/></td>
                            <td colspan='3'>
                        ...
                        <tr>
                            <td class="label"><bean:message bundle="itsoftchange"
                                                            key="itsoftchange.linkTestResult"/></td>
                            <td class="column-content">
                                <eoms:id2nameDB id="${baselink.linkTestResult}" beanId="ItawSystemDictTypeDao"/>

                            </td>
                            <td class="label"><bean:message bundle="itsoftchange"
                                                            key="itsoftchange.linkTestSatisfaction"/></td>
                            <td class="column-content">
                        ...
                        <tr>
                            <td class="column-title"><bean:message bundle="itsoftchange"
                                                                   key="itsoftchange.linkOnlineTime"/></td>
                            <td class="column-content">
                                <bean:write name="baselink" property="linkOnlineTime" formatKey="date.formatDateTimeAll"
                                            bundle="sheet" scope="page"/>
                            </td>
                            <td class="column-title"><bean:message bundle="itsoftchange"
                                                                   key="itsoftchange.linkSoftEdition"/></td>
                            <td class="column-content">
                        ...
                        <tr>
                            <td class="column-title"><bean:message bundle="itsoftchange"
                                                                   key="itsoftchange.linkSoftEditionDCL"/>*
                            </td>
                            <td class="column-content" colspan="3">
                        ...
                        <tr>
                            <td class="column-title"><bean:message bundle="itsoftchange"
                                                                   key="itsoftchange.linkUserNoteChangeDCL"/>*
                            </td>
                            <td class="column-content" colspan="3">
                        ...
                        <tr>
                            <td class="label"><bean:message bundle="itsoftchange"
                                                            key="itsoftchange.linkUserNoteDesc"/></td>
                            <td colspan='3'>
                        ...
                        <tr>
                            <td class="label"><bean:message bundle="itsoftchange"
                                                            key="itsoftchange.linkAuditResult"/></td>
                            <td class="column-content">
