...
<table class="formTable">
    ...
    <tr>
        ...
        <td>
            <input type="text" class="text" name="linkContact" id="linkContact"
                   alt="allowBlank:true,maxLength:1000,vtext:'请填入 联系人 信息，最多输入 1000 字符'"
                   value="${sheetLink.linkContact}"/>
        </td>
        ...
        <td>
            <input type="text" class="text" name="linkContactPhone" id="linkContactPhone"
                   alt="allowBlank:true,maxLength:1000,vtext:'请填入 联系人电话 信息，最多输入 1000 字符'"
                   value="${sheetLink.linkContactPhone}"/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td colspan="3">
            <eoms:comboBox name="linkAutoFind" id="linkAutoFind"
                           initDicId="1013701" alt="allowBlank:false" styleClass="select-class" onchange=""
                           defaultValue="${sheetLink.linkAutoFind}"/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td colspan="3">
				 <textarea name="linkExplain" class="textarea max" id="linkExplain"
                           alt="width:500,maxLength:1600,vtext:'请填入 核查说明 信息，最多输入 1000 字符',allowBlank:false"
                           alt="width:'500px'">${sheetLink.linkExplain}</textarea>
        </td>
        </td>
    </tr>
