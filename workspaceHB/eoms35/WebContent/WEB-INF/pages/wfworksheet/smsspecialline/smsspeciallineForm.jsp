   ...
   <%if(duanXinCaiXinType.equals("CaiXin")){ %>
     <tr>
      ...
      <td class="content">
        ...
        <html:text property="businessSLABook" styleId="businessSLABook"  styleClass="text medium" alt="allowBlank:true"/>
      </td>
	  <td class="label">是否要支持上行彩信流量*</td>
 <td class="content">
          <eoms:comboBox name="isSupportUpCaiXinStream" id="isSupportUpCaiXinStream" defaultValue="${smsspeciallineForm.isSupportUpCaiXinStream}" initDicId="1012310" 
	...
	<tr>
		...
		<td class="content">
		    <eoms:comboBox name="useAccord" id="useAccord" defaultValue="${smsspeciallineForm.useAccord}" initDicId="1013503" 
	  	       alt="allowBlank:true" styleClass="select-class"  />
      </td>
	</tr>
	<tr>
		...
		<td class="content">
		    <eoms:comboBox name="ipAdressType" id="ipAdressType" defaultValue="${smsspeciallineForm.ipAdressType}" initDicId="1012309" 
	...
	<td class="label">
		...
		<td class="content">
		    ...
		    <eoms:comboBox name="cableModem" id="cableModem" defaultValue="${smsspeciallineForm.cableModem}" initDicId="1013504" 
	  	       alt="allowBlank:false" styleClass="select-class"  />
		</td>
		...
		<td class="label">
		 ...
		 <td class="content">
		 		    <eoms:comboBox name="businessLimit" id="businessLimit" defaultValue="${smsspeciallineForm.businessLimit}" initDicId="1013505" 
	  	       alt="allowBlank:true" styleClass="select-class"  />
				  </td>	
	</tr>
	<tr>	
	...
	<td class="label">
		...
		<td class="content">
		   <eoms:comboBox name="ifCable" id="ifCable" defaultValue="${smsspeciallineForm.ifCable}" initDicId="1012310" 
	  	       alt="allowBlank:false" styleClass="select-class"  />
		...
		<td class="label">
		 ...
		 <td class="content">
				  	 ...
				  	 <eoms:comboBox name="billingType" id="billingType" 
				  	       initDicId="1013501" defaultValue="${smsspeciallineForm.billingType}" alt="allowBlank:false" />
				  </td>	
	...
	<td class="label">
		...
		<td class="content">
		   <eoms:comboBox name="nameSheetMethod" id="nameSheetMethod" defaultValue="${smsspeciallineForm.nameSheetMethod}" initDicId="1012310" 
	  	       alt="allowBlank:true" styleClass="select-class"  />
...
<tr>
    ...
    <tr>
      ...
      <td class="content">
        ...
        <html:text property="inputDevNoAndName" styleId="inputDevNoAndName"  styleClass="text medium" alt="allowBlank:true"/>
      </td>
	</tr>   
     <tr>
      ...
      <td class="content">
        ...
        <html:text property="userUseDevPort" styleId="userUseDevPort"  styleClass="text medium" alt="allowBlank:true"/>
      </td>
      <td class="label">接入设备端口状态</td>
      <td class="content">
	  
        <html:text property="inputDevPortStatue" styleId="inputDevPortStatue"  styleClass="text medium" alt="allowBlank:true"/>
      </td>
	</tr>      
	  ...
	  <td class="label">协议*</td>
 		<td>
          <eoms:comboBox name="protocolDuanXin" id="protocolDuanXin" defaultValue="${smsspeciallineForm.protocolDuanXin}" initDicId="1013507" 
	  	       alt="allowBlank:false" styleClass="select-class"  />
         </td>
	  <td class="label">品牌范围*</td>
 		<td>
          <eoms:comboBox name="brandScope" id="brandScope" defaultValue="${smsspeciallineForm.brandScope}" initDicId="1013508" 
	  	       alt="allowBlank:false" styleClass="select-class"  />
         </td>
    ...
    <tr>
		...
		<td class="content">
		   <eoms:comboBox name="isinputDSMP" id="isinputDSMP" defaultValue="${smsspeciallineForm.isinputDSMP}" initDicId="1012310" 
	  	       alt="allowBlank:false" styleClass="select-class"  />
		...
		<td class="content">
		   <eoms:comboBox name="inputMethodDuanXin" id="inputMethodDuanXin" defaultValue="${smsspeciallineForm.inputMethodDuanXin}" initDicId="1013504" 
	  	       alt="allowBlank:false" styleClass="select-class"  />
    ...
    <tr>
      ...
      <td class="content">
        ...
        <html:text property="limitSendAndRecScope" styleId="limitSendAndRecScope"  styleClass="text medium" alt="allowBlank:true"/>
      </td>
    	<td class="label">
			接入等级号
		</td>
		<td class="content">
		   <eoms:comboBox name="inputLevelNumber" id="inputLevelNumber" defaultValue="${smsspeciallineForm.inputLevelNumber}" initDicId="1013509" 
	  	       alt="allowBlank:true" styleClass="select-class"  />
    ...
    <tr>
      ...
      <td class="content">
        ...
        <html:text property="duanxinSing" styleId="duanxinSing"  styleClass="text medium" alt="allowBlank:true"/>
      </td>
		</tr>
     <tr>
      ...
      <td class="content">
        ...
        <html:text property="enterpriseCNName" styleId="enterpriseCNName"  styleClass="text medium" alt="allowBlank:true"/>
      </td>
      <td class="label">企业英文实名</td>
      <td class="content">
	  
        <html:text property="enterpriseENname" styleId="enterpriseENname"  styleClass="text medium" alt="allowBlank:true"/>
      </td>
	</tr> 
     <tr>
      ...
      <td class="content">
        ...
        <html:text property="scopeMakeScope" styleId="scopeMakeScope"  styleClass="text medium" alt="allowBlank:true"/>
      </td>
      <td class="label">时间制作范围</td>
      <td class="content">
	  
        <html:text property="timeMakeScope" styleId="timeMakeScope"  styleClass="text medium" alt="allowBlank:true"/>
      </td>
	</tr> 
	</tr> 
     <tr>
      ...
      <td class="content">
        ...
        <html:text property="computerIpAdd" styleId="computerIpAdd"  styleClass="text medium" alt="allowBlank:true"/>
      </td>
	</tr>
     <tr>
      ...
      <td class="content">
        ...
        <html:text property="inputNetWayBandWidth" styleId="inputNetWayBandWidth"  styleClass="text medium" alt="allowBlank:true"/>
      </td>
      <td class="label">端口速率自适应下调</td>
	   	<td class="content">
		   <eoms:comboBox name="portSpeed" id="portSpeed" defaultValue="${smsspeciallineForm.portSpeed}" initDicId="1012310" 
	  	       alt="allowBlank:true" styleClass="select-class"  />
      </td>
	</tr>
     <tr>
      ...
      <td class="content">
        ...
        <html:text property="lagerDownStream" styleId="lagerDownStream"  styleClass="text medium" alt="allowBlank:true"/>
      </td>
      <td class="label">最大上行流量</td>
      <td class="content">
	  
        <html:text property="lagerUptStream" styleId="lagerUptStream"  styleClass="text medium" alt="allowBlank:true"/>
      </td>
	</tr>
     <tr>
      ...
      <td class="content">
        ...
        <html:text property="rightModule" styleId="rightModule"  styleClass="text medium" alt="allowBlank:true"/>
      </td>
      ...
      <td colspan="3">
        ...
        <html:text property="nameSheetMethod" styleId="nameSheetMethod"  styleClass="text medium" alt="allowBlank:true"/>
      </td>
    ...
    <tr>
      ...
      <td class="content">
	  	<html:errors property="portABDeviceType"/>
	  		  	          <eoms:comboBox name="portABDeviceType" id="portABDeviceType" defaultValue="${smsspeciallineForm.portABDeviceType}" initDicId="1012304" 
		  	       alt="allowBlank:true" styleClass="select-class" />
       </td>
      <td class="label">建设方式</td>
      <td class="content">
	  	<html:errors property="buildMethodA"/>
           <eoms:comboBox name="buildMethodA" id="buildMethodA" defaultValue="${smsspeciallineForm.buildMethodA}" initDicId="1012317" 
		  	       alt="allowBlank:false" styleClass="select-class" />
	...
	<tr>
      ...
      <td class="content">
	  	<html:errors property="userIsHaveDivA"/>
	  	 <eoms:comboBox name="userIsHaveDivA" id="userIsHaveDivA" defaultValue="${smsspeciallineForm.userIsHaveDivA}" initDicId="1012310" 
		  	       alt="allowBlank:false" styleClass="select-class"/>
	  </td>
	  <td class="label">是否需要移动采购</td>
      <td class="content">
      	<html:errors property="isNeedBuyA"/>
          <eoms:comboBox name="isNeedBuyA" id="isNeedBuyA" defaultValue="${smsspeciallineForm.isNeedBuyA}" initDicId="1012310" 
	...
	<tbody id='interfaceInfo' > 
		...
		<tr>
			  ...
			  <td colspan="3">						  	
			  	<a  style="cursor:hand;color:darkbule" onclick="javascript:popupIrmsPreSurvey('${smsspeciallineForm.portADetailAdd}')">点击进行接入点勘察</a>
			  </td>	
		</tr>
		<%} %>
		<tr>
	...
	<tr>
      ...
      <td class="label">A接入点类型</td>
	      ...
	      <eoms:comboBox name="interfacePointTypeA" id="interfacePointTypeA" defaultValue="${smsspeciallineForm.interfacePointTypeA}" initDicId="1012316" 
			  	       alt="allowBlank:true" styleClass="select-class" />
	      </td>	 
	</tr>
	<tr>
	      ...
	      <td colspan="3">
	        ...
	        <textarea name="fiberAroute" id="fiberAroute" class="textarea max" alt="allowBlank:true">${smsspeciallineForm.fiberAroute}</textarea>	
	      </td>
		</tr>
	</tbody>
	...
	<tbody id='transLineInfo' > 
		<tr>
	      ...
	      <td class="content">
		  	<html:errors property="fiberOwnerA"/>
	       	   <eoms:comboBox name="fiberOwnerA" id="fiberOwnerA" defaultValue="${smsspeciallineForm.fiberOwnerA}" initDicId="1012315" 
		  	       alt="allowBlank:false" styleClass="select-class"/>
	     </td>
      </tr>
      <tr>
	      ...
	      <td colspan="3">
	        ...
	        <textarea name="buildTypeA" id="buildTypeA" class="textarea max" alt="allowBlank:true">${smsspeciallineForm.buildTypeA}</textarea>	
	      </td>
      </tr>
      ...
      <tr>
	      ...
	      <td colspan="3">
	        ...
	        <eoms:comboBox name="isOkBetweenUserA" id="isOkBetweenUserA" defaultValue="${smsspeciallineForm.isOkBetweenUserA}" initDicId="1012310" 
	  ...
	  <tbody id='YuanYin' style="display:none"> 
	     ...
	     <td colspan='3'>
	      	<html:errors property="noInputResonA"/>
	       	<textarea name="noInputResonA" id="noInputResonA" class="textarea max" alt="allowBlank:true">${smsspeciallineForm.noInputResonA}</textarea>			   
	     </td>
	     </tbody>
     </tr>
     </tbody>
    ...
    <tr>
    	<td class="label">传输容量是否满足开通</td>
         ...
         <td class="label">是否需要添加板卡</td>
          ...
          <eoms:comboBox name="isNeedAddCardA" id="isNeedAddCardA" defaultValue="${smsspeciallineForm.isNeedAddCardA}" initDicId="1012310" 
	    ...
	    <tr>	      
	      ...
	      <td class="content">
		  	<html:errors property="isGetInterfaceA"/>
		  	 <eoms:comboBox name="isGetInterfaceA" id="isGetInterfaceA" defaultValue="${smsspeciallineForm.isGetInterfaceA}" initDicId="1012310" 
		  	       alt="allowBlank:true" styleClass="select-class" />
	      </td>
		...
		<tr>
	      <td class="label">最后一公里处理意见</td>
	       <td  class="content" colspan="3">
		  		<textarea name="theLastOpinionA" id="theLastOpinionA" class="textarea max" alt="allowBlank:false">${smsspeciallineForm.theLastOpinionA}</textarea>			   
			</td>
		</tr>
		<tr>
...
<tbody id='BusinessInfo2' > 
	<tr>
	 ...
	 <td colspan="3">
	        ...
	        <textarea name="illustrate" id="illustrate" class="textarea max" alt="allowBlank:true">${smsspeciallineForm.illustrate}</textarea>	
	      </td>
