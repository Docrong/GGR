...
<html:form action="forums.do" method="post" styleId="forumsForm">
    ...
    <ul>
        ...
        <li>
            ...
            <input type="text" name="title" id="title" styleClass="text medium"
                   value="<bean:write name='forumsForm' property='title'/>"
                   alt="allowBlank:false,vtext:'<bean:message key='forumsForm.tips.noname'/>'"/>
        </li>
