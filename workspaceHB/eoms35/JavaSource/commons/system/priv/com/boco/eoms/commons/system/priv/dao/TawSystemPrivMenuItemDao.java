...
public interface TawSystemPrivMenuItemDao extends Dao {
     ...
     * found.
     *
     * @param id the tawSystemPrivMenuItem's id
     ...
     *
     * @param tawSystemPrivMenuItem the object to be saved
     */
     ...
     * 获取两个集合的差集
     *
     * @param _objTotals List object 全体集合
     * @param _objExists List object 已存在集合
     ...
     *
     * @param String _strMenuCode
     * @param String _strMenuId
     */
