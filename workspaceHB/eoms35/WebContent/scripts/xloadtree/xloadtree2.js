...
with (document){
  ...
  write ("  .webfx-tree-children {");
  write ("    background-repeat:	repeat-y;");
  write ("    background-image:	url("+xtreePath+"/images/xp/I.png);");
  write ("    background-position-y:	1px !important;	/* IE only */");
  write ("    font:			icon;");
  write ("</style>");
}

webFXTreeConfig.loadingText = "Loading...";
webFXTreeConfig.rootIcon		= xtreePath+"/images/xp/treeroot.gif";
webFXTreeConfig.openRootIcon	= xtreePath+"/images/xp/treeroot.gif";
webFXTreeConfig.folderIcon		= xtreePath+"/images/xp/folder.png";
webFXTreeConfig.openFolderIcon	= xtreePath+"/images/xp/openfolder.png";
webFXTreeConfig.fileIcon		= xtreePath+"/images/xp/file.png";
webFXTreeConfig.lMinusIcon		= xtreePath+"/images/xp/Lminus.png";
webFXTreeConfig.lPlusIcon		= xtreePath+"/images/xp/Lplus.png";
webFXTreeConfig.tMinusIcon		= xtreePath+"/images/xp/Tminus.png";
webFXTreeConfig.tPlusIcon		= xtreePath+"/images/xp/Tplus.png";
webFXTreeConfig.iIcon			= xtreePath+"/images/xp/I.png";
webFXTreeConfig.lIcon			= xtreePath+"/images/xp/L.png";
webFXTreeConfig.tIcon			= xtreePath+"/images/xp/T.png";
webFXTreeConfig.usePersistence  = false;
function headerDisplay(n){
...
/* added by mios >>  add two attibute: type, data*/
WebFXLoadTree._attrs = ["text", "src", "action", "id", "target", "type", "data"];
...
WebFXLoadTree.createItemFromElement = function (oNode) {
	...
	if (jsAttrs.type) {
		jsNode.type = jsAttrs.type;
	}
	if (jsAttrs.data) {
		jsNode.data = jsAttrs.data;
	}
	/* added by mios << */
