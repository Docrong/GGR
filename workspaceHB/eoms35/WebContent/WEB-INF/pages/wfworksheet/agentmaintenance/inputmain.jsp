...
<table class="formTable">
	<tr>
		...
		<td>
			<input type="text" class="text" name="${sheetPageName}sheetAcceptLimit" readonly="readonly" id="${sheetPageName}sheetAcceptLimit" 
				value="${eoms:date2String(sheetMain.sheetAcceptLimit)}" 
				onclick="popUpCalendar(this, this,null,null,null,true,-1)"  alt="vtype:'lessThen',link:'${sheetPageName}sheetCompleteLimit',vtext:'受理时限不能晚于处理时限',allowBlank:false"/>
		</td>
		...
		<td>
			...
			onclick="popUpCalendar(this, this,null,null,null,true,-1)" alt="vtype:'moreThen',link:'${sheetPageName}sheetAcceptLimit',vtext:'完成时限不能早于受理时限',allowBlank:false" />
		</td>
	</tr>
	</table>
	<br>
	...
	<input type="hidden" name="sourceId" id="sourceId" value="${sourceId}">
		...
		<tr><td class="label">
			...
			<td>
				<input type="text"  class="text" name="mainFaultAlarmId" id="mainFaultAlarmId"  alt="allowBlank:false,maxLength:100,vtext:'请填入 网管告警ID 信息，最多输入 100 字符'" 
			...
			<td>
				<input type="text"  class="text" name="mainFaultAlarmNum" id="mainFaultAlarmNum"  
					alt="allowBlank:false,maxLength:100,vtext:'请填入 网管告警流水号 信息，最多输入 100 字符'" value="${commonfaultMain.mainAlarmNum}${sheetMain.mainFaultAlarmNum}"/>
			</td></tr>
			<tr>
			<td class="label">
				<!-- 告警清除时间 -->
			...
			<td>
				<input type="text" class="text" name="mainFaultAlarmSolveDate" readonly="readonly" id="mainFaultAlarmSolveDate" 
					value="${commonfaultMain.mainAlarmSolveDate}${eoms:date2String(sheetMain.mainFaultAlarmSolveDate)}" onclick="popUpCalendar(this, this,null,null,null,true,-1)"  alt="allowBlank:false"/>
			</td>
			<td class="label">
				<!-- 告警来源 -->
			...
			<td>
				<input type="text"  class="text" name="mainFaultAlarmSource" id="mainFaultAlarmSource"  alt="allowBlank:false,maxLength:100,vtext:'请填入 告警来源 信息，最多输入 100 字符'" 
			...
			<td>
				<input type="text"  class="text" name="mainFaultAlarmLevel" id="mainFaultAlarmLevel"  alt="allowBlank:false,maxLength:100,vtext:'请填入 告警级别 信息，最多输入 100 字符'" 
			...
			<td>
				<input type="text"  class="text" name="mainFaultAlarmLogicSort" id="mainFaultAlarmLogicSort" alt="allowBlank:false,maxLength:100,vtext:'请填入 告警逻辑分类 信息，最多输入 100 字符'" 
			...
			<td>
				<input type="text"  class="text" name="mainFaultAlarmLogicSortSub" id="mainFaultAlarmLogicSortSub" alt="allowBlank:false,maxLength:100,vtext:'请填入 告警逻辑子类 信息，最多输入 100 字符'" 
			...
			<td>
				...
				<input type="text"  class="text" name="mainFaultDesc" id="mainFaultDesc"  alt="allowBlank:false,maxLength:100,vtext:'请填入 故障描述 信息，最多输入 100 字符'" 
			...
			<td>
				<eoms:comboBox name="mainFaultDiscoverableMode" id="mainFaultDiscoverableMode" initDicId="1010301" 
					defaultValue="${commonfaultMain.mainFaultDiscoverableMode}${sheetMain.mainFaultDiscoverableMode}" alt="allowBlank:false"/>
			</td>
			<td class="label">
				<!-- 故障处理响应级别 -->
			...
			<td>
				<eoms:comboBox name="mainFaultResponseLevel" id="mainFaultResponseLevel" initDicId="1010304" defaultValue="${commonfaultMain.mainFaultResponseLevel}${sheetMain.mainFaultResponseLevel}" alt="allowBlank:false"/>
			</td>
			</tr>
			<tr><td class="label">
				<!-- 网络分类(一级) -->
			...
			<td>
				<eoms:comboBox name="mainFaultNetSortOne" id="mainFaultNetSortOne" 
					sub="mainFaultNetSortTwo" initDicId="1010104" defaultValue="${commonfaultMain.mainNetSortOne}${sheetMain.mainFaultNetSortOne}" alt="allowBlank:false"/>
			</td>
 <td class="label">
				<!-- 网络分类(二级) -->
			...
			<td>
				<eoms:comboBox name="mainFaultNetSortTwo" id="mainFaultNetSortTwo"  sub="mainFaultNetSortThree" 
					initDicId="${commonfaultMain.mainNetSortOne}${sheetMain.mainFaultNetSortOne}" defaultValue="${commonfaultMain.mainNetSortTwo}${sheetMain.mainFaultNetSortTwo}" alt="allowBlank:false"/>
			</td>
		</tr>
		...
		<tr><td class="label">
			...
			<td>
				<eoms:comboBox name="mainFaultNetSortThree" id="mainFaultNetSortThree"
			  		initDicId="${commonfaultMain.mainNetSortTwo}${sheetMain.mainFaultNetSortTwo}" defaultValue="${commonfaultMain.mainNetSortThree}${sheetMain.mainFaultNetSortThree}" alt="allowBlank:false"/>
			</td>
			<td class="label">
				<!-- 派单方式 -->
			...
			<c:if test="${empty sheetMain.mainFaultSendMode && empty commonfaultMain.mainSendMode}">
          	...
          	<c:if test="${!empty sheetMain.mainFaultSendMode || !empty commonfaultMain.mainSendMode}">
		  		<td>
		   			<eoms:comboBox name="mainFaultSendMode" id="mainFaultSendMode" initDicId="1010305" defaultValue="${commonfaultMain.mainSendMode}${sheetMain.mainFaultSendMode}"/>				
		  		</td>
		  	</c:if>
			</tr>
			<tr>
			...
			<td>
				<eoms:comboBox name="mainFaultEquipmentFactory" id="mainFaultEquipmentFactory" initDicId="1010103" 
					defaultValue="${commonfaultMain.mainEquipmentFactory}${sheetMain.mainFaultEquipmentFactory}" alt="allowBlank:false"/>
			</td>
			<td class="label">
				<!-- 网元名称 -->
			...
			<td>
				<input type="text"  class="text" name="mainFaultNetName" id="mainFaultNetName"  alt="allowBlank:false,maxLength:100,vtext:'请填入 网元名称 信息，最多输入 100 字符'" 
			...
			<td>
				<input type="text"  class="text" name="mainFaultEquipmentModel" id="mainFaultEquipmentModel"  
					alt="allowBlank:false,maxLength:100,vtext:'请填入 故障设备型号 信息，最多输入 100 字符'" value="${commonfaultMain.mainEquipmentModel}${sheetMain.mainFaultEquipmentModel}"/>
			</td>
			<td class="label">
				<!-- 故障发生时间 -->
			...
			<td>
				<input type="text" class="text" name="mainFaultGenerantTime" readonly="readonly" id="mainFaultGenerantTime" 
			...
			<td>
				<input type="text" name="mainFaultGenerantPriv" id="mainFaultGenerantPriv" value="${commonfaultMain.mainFaultGenerantPriv}${sheetMain.mainFaultGenerantPriv}" alt="allowBlank:false"/>
			</td>
			<td class="label">
				<!-- 故障地市 -->
			...
			<td>
				<div id="areaview" class="hide"></div>
               	<input type="text" class="text"  readonly="readonly" name="mainFaultGenerantCity" id="mainFaultGenerantCity" alt="allowBlank:false,vtext:'请选择地域名称'" 
			...
			<td>
				<eoms:comboBox name="mainFaultIfAffectOperation" id="mainFaultIfAffectOperation" initDicId="10301" 
					defaultValue="${commonfaultMain.mainIfAffectOperation}${sheetMain.mainFaultIfAffectOperation}" alt="allowBlank:false"/>
			</td>
			<td class="label">
				<!-- 相关投诉处理工单号 -->
			...
			<td>
				<input type="text"  class="text" name="mainFaultApplySheetId" id="mainFaultApplySheetId"  
					alt="allowBlank:false,maxLength:100,vtext:'请填入 相关投诉处理工单号 信息，最多输入 100 字符'" value="${commonfaultMain.mainApplySheetId}${sheetMain.mainFaultApplySheetId}"/>
			</td>
			</tr>
			<tr>
			<td class="label">
			...
			<td>
				<eoms:comboBox name="mainFaultPretreatment" id="mainFaultPretreatment" initDicId="10301" 
					defaultValue="${commonfaultMain.mainPretreatment}${sheetMain.mainFaultPretreatment}" alt="allowBlank:false" onchange="ifDoT1Deal(this.value)"/>
			</td>
			<td class="label">
			</td>
			</tr>
 	...
 	<input type="hidden" name="sourceId" id="sourceId" value="${sourceId }">
		...
		<tr><td class="label">
			...
			<td>
				<eoms:comboBox name="mainTaskNetSort1" id="mainTaskNetSort1" initDicId="1010104" sub="mainTaskNetSort2" alt="allowBlank:false" 
					defaultValue="${commontaskMain.mainNetSort1}${sheetMain.mainTaskNetSort1}" styleClass="select-class"/>
			</td>
 <td class="label">
				<!-- 网络分类二级类别 -->
			...
			<td>
				<eoms:comboBox name="mainTaskNetSort2" id="mainTaskNetSort2" initDicId="${commontaskMain.mainNetSort1}${sheetMain.mainTaskNetSort1}" sub="mainTaskNetSort3" alt="allowBlank:false" 
					defaultValue="${commontaskMain.mainNetSort2}${sheetMain.mainTaskNetSort2}" styleClass="select-class"/>
			</td>
		</tr>
		...
		<tr><td class="label">
			...
			<td>
				<eoms:comboBox name="mainTaskNetSort3" id="mainTaskNetSort3" initDicId="${commontaskMain.mainNetSort2}${sheetMain.mainTaskNetSort2}"  alt="allowBlank:false" 
					defaultValue="${commontaskMain.mainNetSort3}${sheetMain.mainTaskNetSort3}" styleClass="select-class"/>
			</td>
 <td class="label">
				<!-- 任务类型 -->
			...
			<td>
				<eoms:comboBox name="mainTaskType" id="mainTaskType" initDicId="1010102"  alt="allowBlank:false" 
					defaultValue="${commontaskMain.mainTaskType}${sheetMain.mainTaskType}" styleClass="select-class"/>
			</td>
		</tr>
	...
	<input type="hidden" name="sourceId" id="sourceId" value="${sourceId }">
		...
		<tr><td class="label">
			...
			<td>
				<eoms:comboBox name="mainComurgentDegree" id="mainComurgentDegree" initDicId="1010606" 
					defaultValue="${complaintMain.urgentDegree}${sheetMain.mainComurgentDegree}" alt="allowBlank:ture"/>
			</td>
			<td class="label">
				<!-- 投诉分类一级类别 -->
			...
			<td>
				<eoms:comboBox name="mainComType1" id="mainComType1" sub="mainComType2" initDicId="1010601" styleClass="select-class"
					defaultValue="${complaintMain.complaintType1}${sheetMain.mainComType1}" alt="allowBlank:ture" onchange="selectLimit(this.value);"/>
			</td>
		</tr>
		...
		<tr><td class="label">
			...
			<td>
				<eoms:comboBox name="mainComType2" id="mainComType2" sub="mainComType" initDicId="${complaintMain.complaintType1}${sheetMain.mainComType1}" styleClass="select-class"
					defaultValue="${complaintMain.complaintType2}${sheetMain.mainComType2}" alt="allowBlank:ture" onchange="selectLimit(this.value);"/>
			</td>
 <td class="label">
				<!-- 投诉分类三级类别 -->
			...
			<td>
				<eoms:comboBox name="mainComType" id="mainComType" sub="mainComType4" initDicId="${complaintMain.complaintType2}${sheetMain.mainComType2}" styleClass="select-class"
					defaultValue="${complaintMain.complaintType}${sheetMain.mainComType}" alt="allowBlank:true" onchange="selectLimit(this.value);"/>
			</td>
		</tr>
 		<tr>
 <td class="label">
			...
			<td>
				<eoms:comboBox name="mainComType4" id="mainComType4" sub="mainComType5" initDicId="${complaintMain.complaintType}${sheetMain.mainComType}" styleClass="select-class"
					defaultValue="${complaintMain.complaintType4}${sheetMain.mainComType4}" alt="allowBlank:true" />
			</td>
		<td class="label">
				<!-- 投诉分类五级类别 -->
			...
			<td>
				<eoms:comboBox name="mainComType5" id="mainComType5" sub="mainComType6" initDicId="${complaintMain.complaintType4}${sheetMain.mainComType4}" styleClass="select-class"
					defaultValue="${complaintMain.complaintType5}${sheetMain.mainComType5}" alt="allowBlank:ture"/>
			</td>
			</tr>
		<tr>
 <td class="label">
			...
			<td>
				<eoms:comboBox name="mainComType6" id="mainComType6" sub="mainComType7" initDicId="${complaintMain.complaintType5}${sheetMain.mainComType5}" styleClass="select-class"
					defaultValue="${complaintMain.complaintType6}${sheetMain.mainComType6}" alt="allowBlank:ture"/>
			</td>
	<td class="label">
				<!-- 投诉分类七级类别 -->
			...
			<td>
				<eoms:comboBox name="mainComType7" id="mainComType7" initDicId="${complaintMain.complaintType6}${sheetMain.mainComType6}" styleClass="select-class"
					defaultValue="${complaintMain.complaintType7}${sheetMain.mainComType7}" alt="allowBlank:ture"/>
			</td>
			</tr>
			<tr>
			<td class="label">
			...
			<td>
				<input type="text"  class="text" name="mainCombtype1" id="mainCombtype1"  alt="allowBlank:false,maxLength:100,vtext:'请填入 派发联系人 信息，最多输入 100 字符'" 
			...
			<td>
				<input type="text"  class="text" name="mainCombdeptContact" id="mainCombdeptContact"  alt="allowBlank:false,maxLength:100,vtext:'请填入 派发联系人电话 信息，最多输入 100 字符'" 
			...
			<td>
				<eoms:comboBox name="mainCombdeptContactPhone" id="mainCombdeptContactPhone" initDicId="10301" 
					defaultValue="${complaintMain.bdeptContactPhone}${sheetMain.mainCombdeptContactPhone}" alt="allowBlank:true"/>
			</td>
			<td class="label">
				<!-- 重复投诉次数 -->
			...
			<td>
				<input type="text"  class="text" name="mainrepeatComTimes" id="mainrepeatComTimes"  alt="allowBlank:false,maxLength:100,vtext:'请填入 重复投诉次数 信息，最多输入 100 字符'" 
			...
			<td>
				<input type="text"  class="text" name="mainComcustomerName" id="mainComcustomerName"  alt="allowBlank:false,maxLength:100,vtext:'请填入 客户姓名 信息，最多输入 100 字符'" 
			...
			<td>
				<input type="text"  class="text" name="mainComcustomPhone" id="mainComcustomPhone"  alt="allowBlank:false,maxLength:100,vtext:'请填入 客户电话 信息，最多输入 100 字符'" 
			...
			<td>
				<eoms:comboBox name="mainComcustomBrand" id="mainComcustomBrand" initDicId="1010604" 
					defaultValue="${complaintMain.customBrand}${sheetMain.mainComcustomBrand}" alt="allowBlank:true"/>
			</td>
			<td class="label">
				<!-- 投诉受理省份 -->
...
showChkFldId:'${sheetPageName}showDept1',saveChkFldId:'${sheetPageName}toDeptId',viewer:areaViewer
});
</script>
               	<input type="text" class="text"  readonly="readonly" name="${sheetPageName}showDept1" id="${sheetPageName}showDept1" alt="allowBlank:false,vtext:'请选择地域名称'" 
               		value="<eoms:id2nameDB id='${complaintMain.toDeptId}${sheetMain.toDeptId}' beanId='tawSystemAreaDao'/>"/>
               	<input type="hidden" name="${sheetPageName}toDeptId" id="${sheetPageName}toDeptId" value="${complaintMain.toDeptId}${sheetMain.toDeptId}"/>			  
			</td>
			</tr>	
			<tr><td class="label">
				<!-- 用户归属地 -->
			...
			<td>
				<input type="text"  class="text" name="mainComcustomAttribution" id="mainComcustomAttribution"  alt="allowBlank:false,maxLength:100,vtext:'请填入 用户归属地 信息，最多输入 100 字符'" 
			...
			<td>
				<input type="text" class="text" name="mainComfaultTime" readonly="readonly" id="mainComfaultTime" value="${complaintMain.faultTime}${eoms:date2String(sheetMain.mainComfaultTime)}" 
					onclick="popUpCalendar(this, this)" alt="vtype:'lessThen',link:'mainComTime',vtext:'故障时间不能晚于投诉时间',allowBlank:false"/> 
			</td>
			</tr>
			<tr>
			<td class="label">
			...
			<td>
				<input type="text" class="text" name="mainComTime" readonly="readonly" id="mainComTime" value="${complaintMain.complaintTime}${eoms:date2String(sheetMain.mainComTime)}" 
					onclick="popUpCalendar(this, this)" alt="vtype:'moreThen',link:'mainComfaultTime',vtext:'投诉时间不能早于故障时间',allowBlank:false"/> 
			</td>
			<td class="label">
				<!-- 故障号码 -->
			...
			<td>
				<input type="text"  class="text" name="mainComtNum" id="mainComtNum"  alt="allowBlank:false,maxLength:100,vtext:'请填入 故障号码 信息，最多输入 100 字符'" 
			...
			<td>
				<input type="text"  class="text" name="mainComfaultSite" id="mainComfaultSite"  alt="allowBlank:false,maxLength:100,vtext:'请填入 故障地点 信息，最多输入 100 字符'" 
			...
			<td colspan="3">
				<textarea name="mainComterminalType" id="mainComterminalType" class="textarea max" alt="allowBlank:true,maxLength:2000,vtext:'终端描述，最多输入1000汉字'">
			...
			<td colspan="3">
				<textarea name="mainComDesc" id="mainComDesc" class="textarea max" alt="allowBlank:true,maxLength:2000,vtext:'投诉内容，最多输入1000汉字'">
			...
			<td colspan="3">
				<textarea name="mainCompreDealResult" id="mainCompreDealResult" class="textarea max" alt="allowBlank:true,maxLength:2000,vtext:'预处理情况，最多输入1000汉字'">
...
%>
	...
	<eoms:chooser id="test" config="{returnJSON:true,showLeader:true}"
		...
		panels="[{text:'部门与人员',dataUrl:'/xtree.do?method=userFromDept'}]" data="${sendUserAndRoles}" /></div>
<%}else{
