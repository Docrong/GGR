                ...
                <tr class="tr_show">
                    ...
                    <td>
                        ...
                        <input type="button" name="button" class="button" value=
                            <bean:message key="TawRmChangeduty.withdraw"/> Onclick="window.location.href ='
                        ../TawRmChangeduty/transact_apply.do?transact_id=<%=Integer.parseInt(String.valueOf(getId.elementAt(i)).trim())%>
                        &roomId=<%=roomId %>&transact_flag=3'">
                        <%}%>
                        <%if (Integer.parseInt(String.valueOf(getFlag.elementAt(i)).trim()) == 2) {%>
                        <input type="button" name="button" class="button" value=
                            <bean:message key="TawRmChangeduty.know"/> Onclick="window.location.href ='
                        ../TawRmChangeduty/transact_apply.do?transact_id=<%=Integer.parseInt(String.valueOf(getId.elementAt(i)).trim())%>
                        &roomId=<%=roomId %>&transact_flag=3'">
                        <%}%>
                    </td>
