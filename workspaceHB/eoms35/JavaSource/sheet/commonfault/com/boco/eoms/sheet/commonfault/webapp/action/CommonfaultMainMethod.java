...
public class CommonfaultMainMethod extends BaseSheet {
    ...
    public HashMap getInterfaceObjMap(ActionMapping mapping, ActionForm form,
        ...
        try {
            ...
            String sql = "select * from BUSINESSDREDGE_MAINS_PIID";
            ...
            System.out.println("commonfault_mains sqls:" + sqls.toString());
    ...
    private String saveSql(Connection conn, Map map, Object obj) throws Exception {
        // 将任务表结构信息
