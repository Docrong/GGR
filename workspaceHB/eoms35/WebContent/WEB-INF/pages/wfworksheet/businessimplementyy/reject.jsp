...
function showPage(){
     var pars = '';
     var url = '';    
      url = '${app}/sheet/businessimplementyy/businessimplementyy.do?method=showInputRejectPage&piid=${sheetMain.piid}&taskId=${taskId}&taskName=${taskName}';
     if (url!=''){
...
<div id="sheetform">
<html:form action="/businessimplementyy.do?method=performDeal" styleId="theform">
