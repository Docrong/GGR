    ...
    <table border=0 cellspacing="1" cellpadding="1" class="listTable">
        ...
        <tr>
            <td class="label" COLSPAN="17" align=left>
                <bean:message key="designer.title.labHead"/><%=headElementAmount%><bean:message
                    key="designer.title.labElement"/>
            </td>
        </tr>
        <tr align="center">
            <td>id</td>
        ...
        <tr>
            <td class="label" COLSPAN="17" align=left>
                <bean:message key="designer.title.labBody"/><%=bodyElementAmount%><bean:message
                    key="designer.title.labElement"/>
            </td>
        </tr>
        <tr align="center">
        ...
        <tr>
            <td COLSPAN="17">
                ...
                <input type="button" value="<bean:message key="designer.title.btnBack" />" name="B2" Onclick="GoBack();"
                       class="button">
            </td>
        </tr>
        <!--BODY部分的元素表格：结束-->
