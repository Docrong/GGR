...
<table class="formTable">
    ...
    <tr>
        ...
        <td class="content">
            <input class="text" onclick="popUpCalendar(this, this)" type="text"
                   ...
                   value="${eoms:date2String(sheetMain.sheetAcceptLimit)}" id="${sheetPageName}nodeAcceptLimit"
        ...
        <td class="content">
            <input class="text" onclick="popUpCalendar(this, this)" type="text"
                   ...
                   value="${eoms:date2String(sheetMain.sheetCompleteLimit)}" id="${sheetPageName}nodeCompleteLimit"
    ...
    <tr>
        <td class="label"><!-- 驳回原因 --> <bean:message
                bundle="mofficedata" key="mofficeDataLink.linkRejectRe"/>*
        </td>
    ...
    <tr>
        <td class="label"><!-- 处理结果描述 --> <bean:message
                bundle="mofficedata" key="mofficeDataLink.linkDealDesc"/>*
        </td>
        <td><textarea class="textarea max"
    ...
    <tr>
        <td class="label"><!-- 驳回原因 --> <bean:message
                bundle="mofficedata" key="mofficeDataLink.linkRejectWh"/>*
        </td>
        <td><textarea class="textarea max"
    ...
    <tr>
        <td class="label"><!-- 驳回原因 --> <bean:message
                bundle="mofficedata" key="mofficeDataLink.linkRejectHt"/>*
        </td>
        <td><textarea class="textarea max"
...
<fieldset>
    ...
    <div class="x-form-item">
        <eoms:chooser id="sendObjectMore" type="role" roleId="58705" flowId="587"
    ...
    <div class="x-form-item">
        ...
        <table class="listTable">
            <logic:present name="baseLinks" scope="request">
                ...
                <logic:iterate id="toTask" name="baseLinks"
                               type="com.boco.eoms.sheet.mofficedata.model.MofficeDataLink">
                    <tr>
                        <td>
...
%><!-- 改成局数据核查 alter by weichao 20170331 -->
