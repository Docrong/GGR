...
function intodeleted(){
	 ...
	 deleted = deleted.substring(0,deleted.indexOf("?")+1)+"method=xqueryDeleted&ifReference=${ifReference}";
 	 deleted.action ="nbproductss.do?method=xqueryDeleted&ifReference=${ifReference}";
	 location.href = deleted;
	}	
</script>

<div class="successPage">
	<h1 class="header">${eoms:a2u('删除成功！')}</h1>
	<div class="content">
	   <ul>
