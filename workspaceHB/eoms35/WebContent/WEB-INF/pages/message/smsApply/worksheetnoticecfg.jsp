...
<html:form action="/smsApplys.do?method=updateWorkSheetNotice" method="post" styleId="">
    <table class="formTable" id="table2">
        ...
        <tr>
            ...
            <td>
                <input type="text" size="3" name="sendday<%=(String)subList.get(8)%>"
                       id="sendday<%=(String)subList.get(8)%>" value="<%=(String)subList.get(5)%>"/>天
                <input type="text" size="3" name="sendhour<%=(String)subList.get(8)%>"
                       id="sendhour<%=(String)subList.get(8)%>" value="<%=(String)subList.get(6)%>"/>时
                <input type="text" size="3" name="sendmin<%=(String)subList.get(8)%>"
                       id="sendmin<%=(String)subList.get(8)%>" value="<%=(String)subList.get(7)%>"/>分
            </td>
            <td>
                <input type="button" value="修改" name="<%=(String)subList.get(8)%>" class="btn"
                       onclick="updateva(this)"/>
            </td>
            <td>
                <input type="button" value="删除" name="del<%=(String)subList.get(8)%>" class="btn"
                       onclick="deleva(this)"/>
            </td>
        </tr>
        <%}%>
