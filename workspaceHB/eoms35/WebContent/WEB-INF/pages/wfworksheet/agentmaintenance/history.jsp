...
<div id="history" class="panel">
    ...
    <logic:present name="HISTORY" scope="request">
        <logic:iterate id="baselink" name="HISTORY"
                       type="com.boco.eoms.sheet.agentmaintenance.model.AgentMaintenanceLink">
            <%
                jNum += 1;
            ...
            <div class="history-item"><!-- add space to hack ie-->&nbsp;
                <div class="history-item-title">
                    ...
                    <eoms:dict key="dict-sheet-agentmaintenance" dictId="activeTemplateId"
                    ...
                    <eoms:dict key="dict-sheet-agentmaintenance" dictId="mainOperateType"
  			      ...
  			      <%} %> -->
                        ...
                        <tr>
                            <td class="label"><bean:message bundle="agentmaintenance"
                                                            key="agentmaintenance.linkTaskComplete"/></td>
                            <td class="column-content" colspan="3">
