...
<script language="javascript">
    ...
    Ext.onReady(function () {
        ...
        userTree = new xbox({
            ...
            treeRootId: '-1',
            treeRootText: '<bean:message key="smsService.deptuser"/>',
            treeChkMode: '',
...
<html:form action="/smsServices.do?method=xsave" method="post" styleId="smsServiceForm">
    ...
    <table class="formTable">
        ...
        <tr>
            ...
            <td class="content">
                <input type="text" name="userId" class="text"
                       value="<bean:write scope="session" name="sessionform" property="userid"/>" readonly="readonly"/>
            </td>
        </tr>
        <tr>
            ...
            <td class="label">
                ...
                <input type="button" value="<bean:message key='smsService.modifyuserlist'/>" id="userTreeBtn"
                       class="btn"/>
                <html:checkbox styleId="selStatus" property="selStatus" onchange="modifyTitle(this)">&nbsp;<bean:message
        ...
        <tr>
            ...
            <td class="content">
                <eoms:dict key="dict-msg" dictId="msgType" isQuery="false" defaultId="1" selectId="msgType"
                           beanId="selectXML"/>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="content">
                <html:text property="count" value="1" styleClass="text"
        ...
        <tr>
            ...
            <td class="content">
                <html:text property="interval" value="0" styleClass="text"
                           alt="vtype:'number',vtext:'${eoms:a2u('必须输入数字')}',allowBlank:false"></html:text>
        ...
        <tr>
            <td class="label">
                <html:checkbox styleId="radio" property="isSendNight"><bean:message
                        key='smsService.issendnight'/></html:checkbox>
            </td>
            <td class="content">
                <html:checkbox styleId="radio" property="isSendImediat"><bean:message
        ...
        <tr id="imediat">
            ...
            <td class="content">
                <table class="formtable">
                    <tr>
                        <td>
                            <html:text property="sendDay" value="0" size="3"
                                       alt="vtype:'number',vtext:'${eoms:a2u('必须输入数字')}',allowBlank:false"></html:text>
                        </td>
                        <td>
                        ...
                        <td>
                            <html:text property="sendHour" value="1" size="3"
                                       alt="vtype:'number',vtext:'${eoms:a2u('必须输入数字')}',allowBlank:false"></html:text>
                        </td>
                        <td>
                        ...
                        <td>
                            <html:text property="sendMin" value="30" size="3"
                                       alt="vtype:'number',vtext:'${eoms:a2u('必须输入数字')}',allowBlank:false"></html:text>
                        </td>
                        <td>
                        ...
                        <td class="label">
                            <html:radio property="sendStatus" value="1" onclick="setSendValue()"><bean:message
                                    key='smsService.sendimediat'/></html:radio>
                        </td>
                        <td class="label">
                            <html:radio property="sendStatus" value="2" onclick="setSendValue()"><bean:message
                                    key='smsService.sendforward'/></html:radio>
                        </td>
                        <td class="label">
                            <html:radio property="sendStatus" value="3" onclick="setSendValue()"><bean:message
    ...
    <table class="formTable">
        <tr>
            <td colspan="3">
                <html:checkbox property="isCycleSend" value="0" onclick="displaySend(this)"><bean:message
                        key='smsService.sendcycle'/></html:checkbox>
            </td>
        </tr>
        <tr id="issend" style="display:none">
            <td class="label" colspan="3">
                <table>
                    <tr>
                        <td class="label">
                            <html:radio property="cycleStatus" value="1" onclick="control()">&nbsp;<bean:message
                                    key='smsService.yearcycle'/></html:radio>
                        </td>
                        <td class="label">
                            <html:radio property="cycleStatus" value="2" onclick="control()">&nbsp;<bean:message
                                    key='smsService.monthcycle'/></html:radio>
                        </td>
                        <td class="label">
                            <html:radio property="cycleStatus" value="3" onclick="control()">&nbsp;<bean:message
                                    key='smsService.daycycle'/></html:radio>
                        </td>
                    </tr>
                    <tr>
                        <td class="label">
                            <eoms:dict key="dict-msg" dictId="month" isQuery="false" defaultId="1" selectId="cycleMonth"
                                       beanId="selectXML"/>
                            &nbsp;<bean:message key='smsService.month'/>
                        </td>
                        <td class="label">
                            <eoms:dict key="dict-msg" dictId="day" isQuery="false" defaultId="1" selectId="cycleDay"
                                       beanId="selectXML"/>
                            &nbsp;<bean:message key='smsService.day'/>
                        </td>
                        <td class="label">
                            <eoms:dict key="dict-msg" dictId="hour" isQuery="false" defaultId="1" selectId="cycleHour"
                                       beanId="selectXML"/>
                    ...
                    <tr>
                        <td colspan="3">
                            <html:checkbox styleId="regetData" property="regetData"
                                           onclick="controlSoap(this)">&nbsp;<bean:message key='smsService.regetdata'/></html:checkbox>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="3">
                            <table>
                                <tr>
                                    ...
                                    <td class="label" id="soap" style="display:none">
                                        <eoms:dict key="dict-msg" dictId="soapType" isQuery="false" defaultId="axis"
                                                   selectId="regetProtocol" beanId="selectXML"/>
                                    </td>
                                </tr>
                            </table>
                        </td>
