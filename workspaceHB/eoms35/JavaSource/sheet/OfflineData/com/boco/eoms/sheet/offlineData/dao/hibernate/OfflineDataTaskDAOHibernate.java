...
import com.boco.eoms.sheet.offlineData.dao.IOfflineDataTaskDAO;
import com.boco.eoms.sheet.offlineData.model.OfflineDataTask;
 ...
 */
 ...
 public class OfflineDataTaskDAOHibernate extends TaskDAOImpl implements  IOfflineDataTaskDAO {
	 ...
	 /**
		...
		public HashMap getTaskListBySQL(final String queryStr, 
		   ...
		   HibernateCallback callback = new HibernateCallback() {
	        ...
	        try{
			    Query query = session.createSQLQuery(queryStr).addScalar("title").addEntity(OfflineDataTask.class);
