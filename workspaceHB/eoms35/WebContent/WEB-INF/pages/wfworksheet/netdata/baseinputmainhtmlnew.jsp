...
<input type="hidden" name="${sheetPageName}sendTime" id="${sheetPageName}sendTime"
...
<input type="hidden" name="${sheetPageName}parentPhaseName" id="${sheetPageName}parentPhaseName"
       value="${sheetMain.parentPhaseName}"/>
<table class="formTable">
    <tr>
        <td class="label"><bean:message bundle="sheet" key="mainForm.title"/>*</td>
        <td colspan="3">
            <c:if test="${!empty taskName}">
                <c:if test="${empty fPreTaskName}">
            ...
            <c:if test="${empty taskName}">
                <input type="text" name="${sheetPageName}title" class="text max" id="${sheetPageName}title"
                       value="${sheetMain.title}" alt="allowBlank:false,maxLength:100,vtext:'请输入工单主题，最大长度为100个字符！'"/>
            </c:if>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td colspan="3">
            ...
            <textarea class="textarea max" readonly="true" name="${sheetPageName}showDept" style="height:50px"
                    ...
                    items="${sheetMain.toDeptId}" delims="," var="toDeptId" varStatus="status"><eoms:id2nameDB
                    id="${toDeptId}" beanId="tawSystemAreaDao"/><c:choose><c:when
        ...
        <tr>
            ...
            <td colspan="3">
                <eoms:comboBox name="${sheetPageName}holdStatisfied" id="${sheetPageName}holdStatisfied"
                               initDicId="10303" alt="width:'500px',allowBlank:false" styleClass="select"/>
            </td>
        </tr>
