        ...
        <tr>
            <td align="center" valign="middle">
                <TABLE cellSpacing="0" cellPadding="0" width="95%" borderColorLight="#709FD5" borderColorDark="#ffffff"
                    ...
                    <TR>
                        <TD colSpan="6" class="label">
                            <IFRAME ID=IFrame1 FRAMEBORDER=0 width="100%" height=540 SCROLLING=YES
                                    SRC='editmain.do?id=<bean:write name="tawRmRecordForm" property="id"/>'>
                            </IFRAME>
                        </TD>
                    </TR>
                    ...
                    <c:choose>
                        <c:when test="${requestScope['tawRmRecordForm'].realCount >0 }">
                            <TR>
                                <TD align="center" class="label" colSpan="6"><bean:message
                                        key="TawRmRecord.fineTable"/></TD>
                            </TR>
                            <tr class="tr_show">
                    ...
                    <TR>
                        ...
                        <TD align="center" class="label">
                            <select id='complete_flag' name='complete_flag<%=record_id%>'>
                                <option value='0' <%if (complete_flag==0){%>selected<%}%>><bean:message
                                        key="TawRmRecord.compltetNo"/></option>
                                <option value='1' <%if (complete_flag==1){%>selected<%}%>><bean:message
                                        key="TawRmRecord.compltetYes"/></option>
                            </select>
                        </TD>
                        <TD align="center" class="label">
                            <input type=submit Class="button" name="load" value=
                                <bean:message key="label.edit"/> onclick="javascript:fun_update(<%=record_id%>);">&nbsp;
                            <input type=submit Class="button" name="load" value=
                                <bean:message key="label.remove"/> onclick="javascript:fun_delete(<%=record_id%>);">&nbsp;
                        </TD>
                        <%} else {%>
                ...
                <table border="0" width="95%" cellspacing="1" cellpadding="1" align=center>
                    <TR>
                        <TD align="center" colSpan="6">
                            <input type=submit Class="button" name="load" value='<bean:message key="label.add" />'
