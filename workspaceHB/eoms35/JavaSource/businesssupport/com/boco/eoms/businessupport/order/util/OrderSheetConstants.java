package com.boco.eoms.businessupport.order.util;
 ...
 * 
 */
public class OrderSheetConstants {
	...
	public final static String ORDERSHEET_LIST = "ordersheetList";
...
//		}
	...
	public static String getWhereSql(Map queryMap){
		String hqlDialect = ApplicationContextHolder.getInstance().getHQLDialect().trim();
		String queryStrItem = " and (orderSheet.deleted<>1 or orderSheet.deleted is null) ";
