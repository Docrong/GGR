...
<table class="formTable">
  ...
  <tr>
  	<td>
  	 <textarea class="textarea max" id="show" readonly="readonly" style="height: 300px" alt="width:'500px',maxLength:200,vtext:'最多输入100汉字'"></textarea>
  	</td>
  </tr>
  <tr>
    <td>处理意见</td>
  ...
  <tr>
    <td><textarea class="textarea max" id="showinfo" readonly="readonly"  alt="width:'500px',maxLength:200,vtext:'最多输入100汉字'"></textarea></td>
  </tr>
   <tr>
    <td>处理操作</td>
  </tr>
