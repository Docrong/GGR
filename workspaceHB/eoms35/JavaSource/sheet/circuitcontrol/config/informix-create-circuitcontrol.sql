...
values ('xls,txt,doc,jpg,gif', 'circuitcontrol', '电路调度申请工单流程', 1024, '/sheet/circuitcontrol', 106, '402882e54168ea1b014168ea1b980011');
...
values ('402882e54168ea1b014168ea1b980012', '8601', '1', '新增工单', '86', null, '/sheet/circuitcontrol/circuitcontrol.do?method=showNewSheetPage', '0', '0', 1);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402882e54168ea1b014168ea1b980013', '8603', '0', '待处理工单', '86', null, null, '0', '0', 3);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402882e54168ea1b014168ea1b980014', '860301', '1', '待办工单', '8603', null, '/sheet/circuitcontrol/circuitcontrol.do?method=showListsendundo', '0', '0', 1);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402882e54168ea1b014168ea1b980015', '8607', '1', '工单查询', '86', null, '/sheet/circuitcontrol/circuitcontrol.do?method=showQueryPage', '0', '0', 7);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402882e54168ea1b014168ea1ba80016', '8608', '1', '工单处理模板', '86', null, '/sheet/circuitcontrol/circuitcontrol.do?method=getDealTemplatesByUserId&type=templateManage', '0', '0', 8);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402882e54168ea1b014168ea1ba80017', '8609', '1', '工单模板管理', '86', null, '/sheet/circuitcontrol/circuitcontrol.do?method=getTemplatesByUserId&type=templateManage', '0', '0', 9);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402882e54168ea1b014168ea1ba80018', '8610', '1', '管理者工单', '86', null, '/sheet/circuitcontrol/circuitcontrol.do?method=showListForAdmin', '0', '0', 10);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402882e54168ea1b014168ea1ba80019', '86', '0', '电路调度申请工单流程', '10', null, '/sheet/circuitcontrol/circuitcontrol.do?method=showDrawing', '0', '0', 20);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402882e54168ea1b014168ea1ba8001a', '8602', '1', '草稿列表', '86', null, '/sheet/circuitcontrol/circuitcontrol.do?method=showDraftList', '0', '0', 2);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402882e54168ea1b014168ea1ba8001b', '8604', '0', '已处理工单', '86', null, null, '0', '0', 4);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402882e54168ea1b014168ea1ba8001c','860402','1','建立工单','8604', null, '/sheet/circuitcontrol/circuitcontrol.do?method=showOwnStarterList','0','0',2);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402882e54168ea1b014168ea1ba8001d', '860401', '1', '处理工单', '8604', null, '/sheet/circuitcontrol/circuitcontrol.do?method=showListsenddone', '0', '0', 1);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402882e54168ea1b014168ea1ba8001e', '8605', '1', '已归档工单', '86', null, '/sheet/circuitcontrol/circuitcontrol.do?method=showHoldedList', '0', '0', 5);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402882e54168ea1b014168ea1ba8001f', '8606', '1', '已作废工单', '86', null, '/sheet/circuitcontrol/circuitcontrol.do?method=showCancelList', '0', '0', 6);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402882e54168ea1b014168ea1ba80020', '8611', '1', '超时时间设置', '86', null, '/sheet/overtimetip/overtimetip.do?flowName=CircuitControl', '0', '0', 11);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402882e54168ea1b014168ea1ba80021', '8612', '1', '工单处理时限配置', '86', null, '/sheet/newSheetLimit/sheetLimit.do?method=getLevelLimitList&flowName=CircuitControl', '0', '0', 30);