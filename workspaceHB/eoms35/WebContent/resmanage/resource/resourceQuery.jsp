...
<table width='100%'>
    <tr>
        <td>请选择一个您要查询或统计的类别：</td>
    </tr>
</table>
<table width='100%'>
    <tr>
        <td align=center class="table_title">类别列表</td>
    </tr>
</table>
<table width='100%'>
    <tr>
        <td>
            <table border="0" width='100%' cellspacing="1" cellpadding="1" class="table_show" align=center>
                <form name=resclass method=post>
                    <tr class="tr_show">
                        <td align=center width='20%' class="clsfth"><font size=2>请选择类型：</font></td>
                        <td align=center width='40%'><select name=classtype onchange='ShowSelect()'>
                            <%
                        ...
                        <td align=right><font size=2>选择种类：</font></td>
                        <%
                            for (int i = 0; i < resV.size(); i++) {
                                cls = (resClass) resV.get(i);
