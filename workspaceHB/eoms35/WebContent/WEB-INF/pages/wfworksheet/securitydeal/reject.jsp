...
function showPage(){
     var pars = '';
     var url = '';    
      url = '${app}/sheet/securitydeal/securitydeal.do?method=showInputRejectPage&piid=${sheetMain.piid}&taskId=${taskId}&taskName=${taskName}';
     if (url!=''){
...
<div id="sheetform">
<html:form action="/securitydeal.do?method=performDeal" styleId="theform">
