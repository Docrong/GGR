    ...
    <fmt:bundle basename="com/boco/eoms/km/config/applicationResource-kmmanager">
        ...
        <table class="formTable">
            ...
            <tr>
                ...
                <td class="content">
                    <html:text property="colChname" styleId="colChname" styleClass="text medium"
            ...
            <tr>
                ...
                <td class="content">
                    <input type="text" id="colDictName" name="colDictName" class="text" readonly="readonly"
                           value='<eoms:id2nameDB id="${kmTableColumnForm.colDictId}" beanId="ItawSystemDictTypeDao" />'
            ...
            <tr>
                ...
                <td class="content">
                    <html:text property="colSize" styleId="colSize" styleClass="text medium" alt="vtype:'number'"
                               value="${kmTableColumnForm.colSize}"/>
                ...
                <td class="content">
                    <html:text property="colDefault" styleId="colDefault" styleClass="text medium"
            ...
            <tr>
                ...
                <td class="content">
                    <html:text property="orderBy" styleId="orderBy" styleClass="text medium"
                               alt="allowBlank:false,vtype:'number',vtext:'请填写排序值(数字)'"
                               value="${kmTableColumnForm.orderBy}"/>
                </td>
                <td class="label">
