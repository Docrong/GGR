        ...
        ctxMenu: [
            {
                ...
                text: '${eoms:a2u('新建分组')}',
                cls: 'new-mi',
                url: '<c:url value="/workbench/contact/tawWorkbenchDeptContactGroups.do?method=saveToPage&nodeid=" />',
                rootCanShow: true
            },
            {
                id: 'Edit',
                text: '${eoms:a2u('修改分组')}',
                cls: 'edit-mi',
                url: '<c:url value="/workbench/contact/tawWorkbenchDeptContactGroups.do?method=xget&nodeid=" />'
            },
            {
                id: 'Childs',
                text: '${eoms:a2u('新增人员')}',
                cls: 'new-mi',
                url: '<c:url value="/workbench/contact/tawWorkbenchDeptContacts.do?method=saveToPage&nodeid=" />',
                rootCanShow: true
            },
            {
                id: 'Import',
                text: '${eoms:a2u('部门树导入人员')}',
                cls: 'new-mi',
                url: '<c:url value="/workbench/contact/import.do?nodeid=" />',
                rootCanShow: true
            },
            {
                id: 'Edits',
                text: '${eoms:a2u('修改人员')}',
                cls: 'edit-mi',
                url: '<c:url value="/workbench/contact/tawWorkbenchDeptContacts.do?method=xget&nodeid=" />'
            },
            {
                id: 'Lists',
                text: '${eoms:a2u('人员详细')}',
                cls: 'list-mi',
                url: '<c:url value="/workbench/contact/tawWorkbenchDeptContacts.do?method=xlist&nodeid=" />'
            },
            {
                id: 'Delete',
                isDelete: true,
                text: '${eoms:a2u('删除')}',
                cls: 'remove-mi',
                url: '<c:url value="/workbench/contact/tawWorkbenchDeptContacts.do?method=xdelete&nodeid=" />'
            }
        ],//end of ctxMenu
        /************************
