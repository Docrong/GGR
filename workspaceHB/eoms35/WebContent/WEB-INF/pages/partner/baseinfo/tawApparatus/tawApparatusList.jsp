...
<%@ page language="java"
         import="java.util.*,
                 com.boco.eoms.partner.baseinfo.webapp.form.*;" %>
...
<fmt:bundle basename="config/applicationResources-partner-baseinfo">
    ...
    <display:table name="tawApparatusList" cellspacing="0" cellpadding="0"
                   id="tawApparatusList" pagesize="${pageSize}"
                   decorator="com.boco.eoms.partner.baseinfo.util.PartnerApparatusDecorator"
