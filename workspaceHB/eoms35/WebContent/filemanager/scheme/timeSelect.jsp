...
<center><br>
    <DIV id="dateHidDiv" name="dateHidDiv" width="100%">
        <NOBR>
            <select id="yearSle" name="yearSle" style="width:80px;position:relative"
                    onchange="window.event.cancelBubble=true;showDay();return true;" size=10>
            ...
            <select id="monthSle" name="monthSle" style="width:80px;position:relative"
                    onchange="window.event.cancelBubble=true;showDay();return true;" size=10>
            ...
            <select id="daySle" name="daySle" style="width:80px;position:relative"
                    onclick="window.event.cancelBubble=true;return true;" size=10>
				...
				document.writeln "时间<INPUT id='hourInput' name='hourInput' class='MinuteComponent' inputValue=" & FormatDateTime(Time(),4) & " maskStyle='Normal' style='position:relative;font-size:9pt;width:50px'>"
                        ...
                        <td width="25%" nowrap>
                            <input type="button" value="确&nbsp;&nbsp;定"
                                   style="font-size:9pt;border:1px outset;margin-bottom:0px;padding:0px"
                                   onmouseover="style.cursor='hand';" onclick="javascript:passValue()"/>
                        </td>
                        <td width="25%" nowrap>
                            <input type="button" value="取&nbsp;&nbsp;消"
                                   style="font-size:9pt;border:1px outset;margin-bottom:0px;padding:0px"
                                   onmouseover="style.cursor='hand';" onclick="javascript:window.close();"/>
                        </td>
                    </tr>
            </CENTER>
    </DIV>
