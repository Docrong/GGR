...
<div id="base" class="">
    ...
    <!-- 菜单 (图片) -->
    <div id="u5" class="ax_default image" data-label="菜单">
        <img id="u5_img" class="img " src="images/首页/菜单_u5.png"/>
        <!-- Unnamed () -->
    ...
    <!-- 展开 (图片) -->
    <div id="u13" class="ax_default image ax_default_hidden" data-label="展开" style="display: none; visibility: hidden">
        <img id="u13_img" class="img " src="images/首页/展开_u13.png"/>
        <!-- Unnamed () -->
