...
<form name="tawimport" method="post" enctype="multipart/form-data" action="${app}/sheet/groupcheck/excel.do?method=importSave&wyid=${wyid }" onsubmit="return onsubmitCheck();">
