			...
			<c:choose>
  				<c:when test="${operateType == '54' }">
  					<tr style="height:25%;">
						...
						<td style="height:30%;" colspan="3"><eoms:attachmentDw scope="request"
							idField="sheetAccessories" name="sheetMain"
							property="" appCode="daiweiindexreduction" sheetFlag="renew"
  				...
  				<c:otherwise>
  					<tr style="height:25%;">
						...
						<td style="height:30%;" colspan="3"><eoms:attachmentDw scope="request"
							idField="sheetAccessories" name="sheetMain"
							property="" appCode="daiweiindexreduction" sheetFlag="new"
							alt="allowBlank:true" /></td>
					</tr>
  				</c:otherwise> 
  			</c:choose>
...
<c:if test="${operateType == '54' }">
	<table class="formTable">
		<tr id="importInforList">
			<td colspan="4"><iframe src="daiweiindexreduction.do?method=search&ifShowOther=no&ifSend=no&refSheetId=${sheetMain.mainReserveA }&scrolling="auto" width="100%"
				id="iframepage"></iframe></td>
		</tr>
	</table>
	<br/>
