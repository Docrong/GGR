        ...
        <script type="text/javascript">
            ...
            Ext.onReady(function () {
                ...
                deptTree = new xbox({
                    ...
                    treeChkMode: '',
                    treeChkType: 'dept',
                    showChkFldId: 'acceptDeptName',
                    saveChkFldId: 'acceptDeptId',
                    viewer: deptViewer
                });
            ...
            Ext.onReady(function () {
                ...
                auditUserTree = new xbox({
                    ...
                    treeChkMode: 'single',
                    treeChkType: 'user',
                    showChkFldId: 'auditUserName',
                    saveChkFldId: 'auditUserId',
            ...
            Ext.onReady(function () {
                ...
                reportUserTree = new xbox({
                    ...
                    treeChkMode: 'single',
                    treeChkType: 'user',
                    showChkFldId: 'reportUserName',
                    saveChkFldId: 'reportUserId',
    ...
    <html:form action="/scheme/SchemeMgrAction.do" method="post" enctype="multipart/form-data">
        ...
        <table class="formTable" id="list" width="100%">
            ...
            <tr>
                ...
                <td colspan="3">
                    <html:radio property="cycleType" value="1" onclick="displayAreaCtl(this)" title="临时报表"
                                styleClass="radio">临时报表&nbsp;</html:radio>
                    <html:radio property="cycleType" value="2" onclick="displayAreaCtl(this)" title="以周为周期"
                                styleClass="radio">以周为周期&nbsp;</html:radio>
                    <html:radio property="cycleType" value="3" onclick="displayAreaCtl(this)" title="以月为周期报表"
                                styleClass="radio">以月为周期报表&nbsp;</html:radio>
                    <html:radio property="cycleType" value="4" onclick="displayAreaCtl(this)" title="以季度为周期报表"
                                styleClass="radio">以季度为周期报表&nbsp;</html:radio>
        ...
        <select name="schemeAhead_5" styleClass="select">
            ...
            <tr>
                ...
                <td colspan=3>
                    <html:textarea property="reportDescription" rows="4" styleClass="textarea max" value=""
                                   title="报表描述"/>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td valign="middle" colspan=3>
                    ...
                    <div id="nextFile"></div>
                    <span onmouseover="this.style.border='2 #eeeeee outset';this.style.cursor='hand';width:10"
                          onmouseout="this.style.border='2 #ffffff'" onmousedown="this.style.border='2 #cccccc inset';"
