...
<c:if test="${ifShowOther == 'yes' }">
	...
	<c:choose>
  		<c:when test="${datasList.reserveC=='1030101'}">
  			<select name="reserveC" id="reserveC<%=index1++ %>" onchange="changePhase(this);" style="width:70%" disabled="disabled" alt="allowBlank:false">
				<option value="1030102" <c:if test="${datasList.reserveC=='1030102'}"> selected="selected" </c:if> >否</option>
				<option value="1030101"  <c:if test="${datasList.reserveC=='1030101'}"> selected="selected"  disabled="disabled" </c:if> >是</option>
				
			</select> 	
  		</c:when>
  		<c:otherwise>
  			<select name="reserveC" id="reserveC<%=index1++ %>" onchange="changePhase(this);" style="width:70%" alt="allowBlank:false">
				<option value="1030102" <c:if test="${datasList.reserveC=='1030102'}"> selected="selected" </c:if> >否</option>
