...
<display:table name="taskList" cellspacing="0" cellpadding="0"
               ...
               export="true" requestURI="resourceaffirm.do"
    ...
    <display:column sortable="true" sortName="task.urgentDegree"
                    headerClass="sortable" title="紧急程度">
        <eoms:id2nameDB id="${taskList.urgentDegree}" beanId="ItawSystemDictTypeDao"/>
    </display:column>
