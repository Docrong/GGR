            ...
            items: [
                {
                    id: 'sheet-info',
                    text: '基本资料',
                    url: '${app}/kmmanager/kmExpertBasics.do?method=edit&userId=${userId}',
                    isIframe: true
                },
                {
                    id: 'sheet-edu',
                    text: '教育情况',
                    url: '${app}/kmmanager/kmExpertEdus.do?method=search&userId=${userId}',
                    isIframe: true
                },
                {
                    id: 'sheet-exp',
                    text: '工作情况',
                    url: '${app}/kmmanager/kmExpertExps.do?method=search&userId=${userId}',
                    isIframe: true
                },
                {
                    id: 'sheet-train',
                    text: '培训管理',
                    url: '${app}/kmmanager/kmExpertTrains.do?method=search&userId=${userId}',
                    isIframe: true
                },
                {
                    id: 'sheet-cet',
                    text: '证书管理',
                    url: '${app}/kmmanager/kmExpertCets.do?method=search&userId=${userId}',
                    isIframe: true
                },
                {
                    id: 'sheet-com',
                    text: '技术交流竞赛表彰',
                    url: '${app}/kmmanager/kmExpertComs.do?method=search&userId=${userId}',
                    isIframe: true
                },
                {
                    id: 'sheet-photo',
                    text: '头像照片',
                    url: '${app}/kmmanager/kmExpertPhoto.do?method=uploadPhoto&userId=${userId}',
                    isIframe: true
                }
            ]
        };
