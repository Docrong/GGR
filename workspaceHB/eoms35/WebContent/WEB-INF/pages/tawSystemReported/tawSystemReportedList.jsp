...
<display:table name="tawSystemReportedList" cellspacing="0" cellpadding="0"
    ...
    <display:column sortable="true" headerClass="sortable" titleKey="tawSystemReported.edit"
                    href="${app}/reported/tawSystemReported.do?method=edit" paramId="id"
                    paramProperty="id">${eoms:a2u('编辑')}</display:column>

    <display:column sortable="true" headerClass="sortable" titleKey="tawSystemReported.delete"
                    href="${app}/reported/tawSystemReported.do?method=delete" paramId="id"
                    paramProperty="id">${eoms:a2u('删除')}</display:column>
