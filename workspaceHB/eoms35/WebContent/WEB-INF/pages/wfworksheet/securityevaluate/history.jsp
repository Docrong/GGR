...
<div id="history" class="panel">
    ...
    <logic:present name="HISTORY" scope="request">
        <logic:iterate id="baselink" name="HISTORY"
                       type="com.boco.eoms.sheet.securityevaluate.model.SecurityEvaluateLink">
            <%
                jNum += 1;
            ...
            <div class="history-item"><!-- add space to hack ie-->&nbsp;
                <div class="history-item-title">
                    ...
                    <eoms:dict key="dict-sheet-securityevaluate" dictId="activeTemplateId"
                    ...
                    <eoms:dict key="dict-sheet-securityevaluate" dictId="mainOperateType"
                    ...
                    <table class="history-item-table" width="100%" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td class="label"><bean:message bundle="securityevaluate"
                                                            key="securityevaluate.linkAnalysisResult"/></td>
                            <td colspan="3" 　class="column-content" 　>
                                <pre><bean:write name="baselink" property="linkAnalysisResult" scope="page"/></pre>
                            </td>
                        </tr>
                        <tr>
                            <td class="label"><bean:message bundle="securityevaluate"
                                                            key="securityevaluate.linkAnalysisReport"/></td>
                            <td colspan="3">
                                <eoms:attachment name="baselink" property="linkAnalysisReport"
                                                 scope="page" idField="${sheetPageName}linkAnalysisReport"
                                                 appCode="securityevaluate" viewFlag="Y"/></td>
                        </tr>
                        <%
                                }
                            }
                        ...
                        <tr>
                            <td class="label"><bean:message bundle="securityevaluate"
                                                            key="securityevaluate.linkAuditOpinion"/></td>
                            <td colspan="3"><eoms:id2nameDB id="${baselink.linkAuditOpinion}"
                                                            beanId="ItawSystemDictTypeDao"/></td>
                        </tr>
                        <tr>
                            <td class="label"><bean:message bundle="securityevaluate"
                                                            key="securityevaluate.linkAuditResult"/></td>
                            <td colspan="3" 　class="column-content">
