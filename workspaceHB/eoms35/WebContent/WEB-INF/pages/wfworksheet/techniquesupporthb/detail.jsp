  ...
  <div id="sheetinfo">
	...
	<table class="formTable"> 
      ...
      <tr>
           ...
           <td class="content"><eoms:id2nameDB id="${sheetMain.mainSheetType}" beanId="ItawSystemDictTypeDao"/></td>
      ...
      <tr>
           ...
           <td class="content"><eoms:id2nameDB id="${sheetMain.mainFaultPhoneType}" beanId="ItawSystemDictTypeDao"/></td>
      </tr>
      <%} %>
      <!-- 无线专业技术支持 WXZY -->
      ...
      <tr>
           <td  class="label"><bean:message bundle="techniquesupporthb" key="techniquesupporthb.mainSheetType"/></td>
           <td class="content" colspan='3'><eoms:id2nameDB id="${sheetMain.mainSheetType}" beanId="ItawSystemDictTypeDao"/></td>
           <!--<td  class="label"><bean:message bundle="techniquesupporthb" key="techniquesupporthb.mainFaultType"/></td>
           <td class="content"><eoms:id2nameDB id="${sheetMain.mainFaultType}" beanId="ItawSystemDictTypeDao"/></td>-->
      </tr>
      ...
      <tr>
           ...
           <td class="content" colspan='3'><eoms:id2nameDB id="${sheetMain.mainFaultLevel}" beanId="ItawSystemDictTypeDao"/></td>
      </tr>
       <%} %>
      <tr>
           <td  class="label">子专业</td>
           <td class="content"><eoms:id2nameDB id="${sheetMain.mainProfessional}" beanId="ItawSystemDictTypeDao"/></td>
           <td  class="label">厂商</td>
           <td class="content"><eoms:id2nameDB id="${sheetMain.mainManufacturer}" beanId="ItawSystemDictTypeDao"/></td>
      </tr>
      <!--<tr>
           <td  class="label"><bean:message bundle="techniquesupporthb" key="techniquesupporthb.mainIsMainFault"/></td>
           <td class="content"><eoms:id2nameDB id="${sheetMain.mainIsMainFault}" beanId="ItawSystemDictTypeDao"/></td>
      ...
      <tr>
           ...
           <td class="content"><eoms:id2nameDB id="${sheetMain.mainTrasitionDevType}" beanId="ItawSystemDictTypeDao"/></td>
           <td  class="label"><bean:message bundle="techniquesupporthb" key="techniquesupporthb.mainFaultType"/></td>
           <td class="content"><eoms:id2nameDB id="${sheetMain.mainFaultType}" beanId="ItawSystemDictTypeDao"/></td>
      </tr>
      <tr>
     ...
     <% if("101470105".equals(mainTechSupportType)){ %>        
      ...
      <%} %>
       <tr>
           ...
           <td class="content" colspan='3'><bean:write name="sheetMain" property="mainQuestionDescript" scope="request"/></td>
      </tr>
      <tr>
           <td  class="label">初步处理意见</td>
           <td class="content" colspan='3'><bean:write name="sheetMain" property="mainInitDealOpinition" scope="request"/></td>
      </tr>
...
<div class="sheet-deal">
	<div class='sheet-deal-header'>
		...
		<%}else if(taskName.equals("DraftTask")){%>	
			<select id="dealSelector">
			  <option value="${urlShowCompleteDraftPage}"><bean:message bundle="techniquesupporthb" key="operateType.draft"/></option>
			</select>
		...
		<%}else if(taskName.equals("HoldTask")){ %>
			<select id="dealSelector">
			  <option value="${urlShowHoldDealPage}"><bean:message bundle="techniquesupporthb" key="operateType.hold"/></option>
			</select>		
		<%} %>
		</td>
		</tr>
