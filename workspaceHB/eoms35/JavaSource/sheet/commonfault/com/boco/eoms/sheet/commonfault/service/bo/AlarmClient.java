...
public class AlarmClient {
    ...
    private static void loadSheetStateService(String serSupplier)
        ...
        System.out.println("�澯�����ṩ�� ServiceRooter:" + ServiceRooter);
        ...
        System.out.println("�澯�����ַ getIrmsStr:" + getIrmsStr);
        ...
        if (timeout.length() > 0)
            try {
                ...
                System.out.println("û���ҵ��ӿڳ�ʱ���ã�ʹ��Ĭ��ֵ");
            }
    ...
    public static void main(String args[]) {
        try {
            ...
            buildEmosXML(recordInfo, "���ܸ澯ID", "alarmId", "BOCO_WNMS_762591260_2256541824_1497814915_3274358119");
            buildEmosXML(recordInfo, "EOMS����ID", "sheetNo", "HB-051-140528-11072");
            buildEmosXML(recordInfo, "����״̬", "sheetStatus", "T1");
            buildEmosXML(recordInfo, "״̬ʱ��", "statusTime", (new Date()).toString());
