...
<html:form action="tawRmRenewals" method="post" styleId="tawRmRenewalForm">
    <table class="formTable">
        ...
        <tr>
            ...
            <td width="500" colspan="3">
                <fmt:message key="tawRmInoutRecordForm.from"/><input type="text" name="renewStartDate" size="30"
                                                                     value="" class="text"
                                                                     onclick="popUpCalendar(this, this,'yyyy-mm-dd',-1,-1,false);"
                                                                     readonly="true">
                <fmt:message key="tawRmInoutRecordForm.to"/><input type="text" name="renewEndDate" size="30" value=""
                                                                   class="text"
                                                                   onclick="popUpCalendar(this, this,'yyyy-mm-dd',-1,-1,false);"
                                                                   readonly="true">
            </td>
