        ...
        <option value="7">${eoms:a2u("周日")}</option>
		 ...
		 <tr class="tr_show">
          ...
          <td noWrap width="13%">
    	    ...
    	    <td noWrap width="85%">
                	${eoms:a2u('从')}
	                <input type="text" name="statfromdate" id="statfromdate" value="" readonly="readonly" onclick="popUpCalendar(this, this,null,null,null,true,-1);" class="text"/>
	     	          ${eoms:a2u('到')}
	                <input type="text" name="stattodate" id="stattodate" value=""  readonly="readonly" onclick="popUpCalendar(this, this,null,null,null,true,-1);" class="text"/>
         </td>
    </tr>
