    ...
    <ul>
        ...
        <table class="formTable">
            ...
            <tr>
                ...
                <td width="500" colspan="2">
                    <eoms:dict key="dict-plancontent" dictId="company" beanId="selectXML" isQuery="false"
                               selectId="company" alt="allowBlank:false" defaultId="${tawRmVisitRecordForm.company}"/>
                </td>
            </tr>
