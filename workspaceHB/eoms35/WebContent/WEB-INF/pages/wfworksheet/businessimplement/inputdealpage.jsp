	...
	<c:when test="${task.subTaskFlag == 'true'}">
     ...
     <%if(taskName.equals("ImplementDealTask")&& (operateType.equals("91")||operateType.equals("11"))){ %>
	        ...
	        <tr>
		           ...
		           <td class="content"> 
		           <eoms:comboBox   name="${sheetPageName}linkArugmentlevel" id="${sheetPageName}linkArugmentlevel"  initDicId="1010102" styleClass="select-class" alt="allowBlank:false" defaultValue="${sheetLink.linkArugmentlevel}" />		     	    
		           </td>		           
				   <td class="label">		     
	    		  ...
	    		  <%if(mainSpecifyType.equals("101230102")||mainSpecifyType.equals("101230103")){ %>  
				   ...
				   <tr>    
					<td class="label">		     
				           ...
				           <td colspan="3"> 
				             <eoms:comboBox   name="${sheetPageName}linkDevType" id="${sheetPageName}linkDevType"  initDicId="10301" styleClass="select-class" alt="allowBlank:false" defaultValue="${sheetLink.linkDevType}" onchange="HaveCondition101230102(this.value);"/>	     	
				           </td>
				     </tr>
				     <%} %>
			   ...
			   <tr>
		           ...
		           <td colspan="3"> 
					...
					<td class="label">		     
				           ...
				           <td colspan="3"> 
				             <eoms:comboBox   name="${sheetPageName}linkDevType" id="${sheetPageName}linkDevType"  initDicId="10301" styleClass="select-class" alt="allowBlank:false" defaultValue="${sheetLink.linkDevType}" onchange="HaveCondition(this.value);"/>	     	
				           </td>
				     </tr>
		    ...
		    <input type="hidden" name="${sheetPageName}operateType" id="${sheetPageName}operateType" value="<%=operateType%>" />    
   		    <input type="hidden" name="${sheetPageName}phaseId" id="${sheetPageName}phaseId" value="BusinessTestTask" />
   		     <input type="hidden" name="${sheetPageName}hasNextTaskFlag" id="${sheetPageName}hasNextTaskFlag" value="true" />
		           ...
		           <td  colspan="3"> 
		             <eoms:comboBox   name="${sheetPageName}linkDealResourt" id="${sheetPageName}linkDealResourt"  initDicId="1012306" styleClass="select-class" alt="allowBlank:false" defaultValue="${sheetLink.linkDealResourt}" />
		          </td>
	       </tr> 
	       	       	       	 <tr>
		    ...
		    <input type="hidden" name="${sheetPageName}operateType" id="${sheetPageName}operateType" value="<%=operateType%>" />    
			 ...
			 <tr>
				<td class="label">
		           ...
		           <td class="content" colspan="3"> 
		     	    <eoms:comboBox   name="${sheetPageName}linkDesinResourt" id="${sheetPageName}linkDesinResourt"  initDicId="1012303" styleClass="select-class" alt="allowBlank:false" defaultValue="${sheetLink.linkDesinResourt}" onchange="changeOperate2(this.value);"/>
		           </td>
		             </tr>
		         <tr>   
				   <td class="label">		     
			...
			<input type="hidden" name="${sheetPageName}operateType" id="${sheetPageName}operateType" value="<%=operateType%>" />                   
			 ...
			 <tr>
		         ...
		         <tr>   
		           ...
		           <td colspan="3"> 
		             <eoms:comboBox   name="${sheetPageName}mainNumber" id="${sheetPageName}mainNumber"  initDicId="1010401" styleClass="select-class" alt="allowBlank:false" defaultValue="${sheetMain.mainNumber}" />
		          </td>
	       </tr> 
	       	       <tr>
		           <td class="label">
		           ...
		           <td class="content"> 
		     	     <input type="text"  class="text" name="${sheetPageName}mainInterfaceAConnPerson" id="${sheetPageName}mainInterfaceAConnPerson"  alt="allowBlank:false" value="${sheetMain.mainInterfaceAConnPerson}"/>
		           </td>
				   <td class="label">		     
		            网络部门联系人电话*
		           </td>
		           <td class="content"> 
		             <input type="text"  class="text" name="${sheetPageName}mainAConnPersonPhone" id="${sheetPageName}mainAConnPersonPhone"  alt="allowBlank:false" value="${sheetMain.mainAConnPersonPhone}"/>
		          </td>
	       </tr> 
	       <tr>
		           <td class="label">
		           ...
		           <td class="content"> 
		     	     <input type="text"  class="text" name="${sheetPageName}mainBusinessConnPerson" id="${sheetPageName}mainBusinessConnPerson"  alt="allowBlank:false" value="${sheetMain.mainBusinessConnPerson}"/>
		           </td>
				   <td class="label">		     
		            工程部门联系人电话*
		           </td>
		           <td class="content"> 
		             <input type="text"  class="text" name="${sheetPageName}mainBusinessConnPersonPhone" id="${sheetPageName}mainBusinessConnPersonPhone"  alt="allowBlank:false" value="${sheetMain.mainBusinessConnPersonPhone}"/>
		          </td>
	       </tr> 
	       	       	 <tr>
			  	<td class="label"> <bean:message bundle="businessimplement" key="businessimplement.linkDealDescriptin"/> * </td>
