...
<div id="sheetform">
<html:form action="/securityevaluate.do?method=performDealReplyReject" styleId="theform">
 <%@ include file="/common/taglibs.jsp"%>
<%
 ...
 %>
    ...
    <input type="hidden" name="${sheetPageName}taskNamespace" value="http://SecurityEvaluateProcess"/>  
<%@ include file="/WEB-INF/pages/wfworksheet/securityevaluate/baseinputlinkhtmlnew.jsp"%>
     ...
     <tr>
      ...
      <logic:iterate id="toTask" name="acceptList" type="com.boco.eoms.sheet.securityevaluate.model.SecurityEvaluateTask">  
        <tr>
          <td>
	       ...
	       <td class="label">
			...
			<td colspan="3"> 
		           <textarea name="${sheetPageName}remark" class="textarea max" id="${sheetPageName}remark" 
		              alt="allowBlank:true,maxLength:255,width:500,vtext:'请填入信息，最多输入125字'" >${sheetlink.remark}</textarea>
		  </td>
		</tr>
		</table>
