...
<form name="reportform" method="POST" action="../tawwpexecute/reporteditsave.do?monthplanid=<%=monthPlanId%>">
    ...
    <table class="formTalbe">
        ...
        <tr>
            ...
            <td width="300">
                <textarea name="content" rows="5" cols="45"
                          class="textarea"><%=tawwpExecuteReportVO.getContent()%></textarea>
            </td>
        </tr>
        <tr>
            <td width="100" class="label">
        ...
        <tr>
            ...
            <td width="300">
                <textarea name="advice" rows="5" cols="45"
                          class="textarea"><%=tawwpExecuteReportVO.getAdvice()%></textarea>
            </td>
        </tr>
        <tr>
            <td width="100" class="label">
            ...
            <td width="300">
                <textarea name="remark" rows="5" cols="45"
                          class="textarea"><%=tawwpExecuteReportVO.getRemark()%></textarea>
            </td>
        </tr>
    </table>
    <br>
    ...
    <input type="button" value="<bean:message key="reportedit.title.btnBack" />" name="B2" Onclick="GoBack();"
           class="button">
