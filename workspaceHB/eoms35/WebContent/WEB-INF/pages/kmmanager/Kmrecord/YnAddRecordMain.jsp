...
<html:form method="post" action="/TawRmRecord/ynsavemain">
    ...
    <table border="0" width="95%" cellspacing="1" cellpadding="1" class="listTable" align=center>
        <TR class="tr_show">
            ...
            <TD colspan="1">
                <input name="clean" id="clean" type="text" class="clstext" size="10"
            ...
            <TD>
                <input name="conditioner" id="conditioner" type="text" class="clstext" size="10"
        ...
        <TR class="tr_show">
            ...
            <TD colSpan="3">
                <html:textarea rows="4" cols="60%" style="width:100%" name="tawRmRecordForm" property="netfault"
                               styleClass="clstext" onclick="fun_onExtend(this,1)"
                               onblur="fun_onExtend(this,3)"></html:textarea>
            </TD>
        </TR>
        <TR class="tr_show">
            <TD align="left" class="label">${eoms:a2u('重要社会或灾害事件')}</TD>
            <TD colSpan="3">
                <html:textarea rows="4" cols="60%" style="width:100%" name="tawRmRecordForm" property="importantaffair"
                               styleClass="clstext" onclick="fun_onExtend(this,1)"
                               onblur="fun_onExtend(this,3)"></html:textarea>
            </TD>
        </TR>
        <TR class="tr_show">
            ...
            <TD colSpan="3">
                <html:textarea rows="4" cols="60%" style="width:100%" name="tawRmRecordForm" property="harmony"
                               styleClass="clstext" onclick="fun_onExtend(this,1)"
                               onblur="fun_onExtend(this,3)"></html:textarea>
            </TD>
        </TR>
        <TR class="tr_show">
            ...
            <TD colSpan="3">
                <html:textarea rows="4" cols="60%" style="width:100%" name="tawRmRecordForm" property="otheraffair"
                               styleClass="clstext" onclick="fun_onExtend(this,1)"
                               onblur="fun_onExtend(this,3)"></html:textarea>
            </TD>
        </TR>
    ...
    <table border="0" width="95%" cellspacing="1" cellpadding="1" align=center>
        <TR>
            <TD align="label" colSpan="6">
                ...
                <html:button property="extract" value="${eoms:a2u('提取')}" styleClass="button"
                             onclick="doRequestUsingGET();"></html:button>
            </TD>
        </TR>
    </TABLE>
    <% } else { %>
    <table border="0" width="95%" cellspacing="1" cellpadding="1" class="listTable" align=center>
        <TR class="tr_show">
            ...
            <TD class="label" align="left"><bean:message key="TawRmRecord.clean"/></TD>
            <TD colspan="1">
                <input name="tempStr" id="tempStr" type="text" style="BACKGROUND-COLOR: lightgrey" class="clstext"
                       readOnly="" size="10"
                       value="<bean:write name="tawRmRecordForm" property="clean" scope="request"/>"/>
            </TD>
            <TD class="label"><bean:message key="TawRmRecord.conditioner"/></TD>
        ...
        <TR class="tr_show">
            ...
            <TD align="left" class="label">${eoms:a2u('网络重要故障')}</TD>
            <TD colSpan="3">
                <TEXTAREA name=netfault rows=4 style="width:100%;BACKGROUND-COLOR: lightgrey"
                          readonly="readonly"><bean:write name="tawRmRecordForm" property="netfault"/></TEXTAREA>
            </TD>
        </TR>
        <TR class="tr_show">
            <TD align="left" class="label">${eoms:a2u('重要社会或灾害事件')}</TD>
            <TD colSpan="3">
                <TEXTAREA name=importantaffair rows=4 style="width:100%;BACKGROUND-COLOR: lightgrey"
                          readonly="readonly"><bean:write name="tawRmRecordForm" property="importantaffair"/></TEXTAREA>
            </TD>
        </TR>
        <TR class="tr_show">
            <TD align="left" class="label">${eoms:a2u('需要省公司协调事项')}</TD>
            <TD colSpan="3">
                <TEXTAREA name=harmony rows=4 style="width:100%;BACKGROUND-COLOR: lightgrey"
                          readonly="readonly"><bean:write name="tawRmRecordForm" property="harmony"/></TEXTAREA>
            </TD>
        </TR>
        <TR class="tr_show">
            <TD align="left" class="label">${eoms:a2u('交班事项')}</TD>
            <TD colSpan="3">
                <TEXTAREA name=otheraffair rows=4 style="height:150;width:100%;BACKGROUND-COLOR: lightgrey"
                          readonly="readonly"><bean:write name="tawRmRecordForm" property="otheraffair"/></TEXTAREA>
            </TD>
        </TR>
        <TR class="tr_show" height="80">
            <TD align="left" class="label"><bean:message key="TawRmRecord.accessories"/></TD>
            <TD colSpan="4">
                <IFRAME ID=IFrame1 FRAMEBORDER=0 width="100%" height=80 SCROLLING=YES
                        SRC='../TawRmDutyfile/dutyfile.do?WORKSERIAL=<bean:write name="tawRmRecordForm" property="id"/>'>
                </IFRAME>
            </TD>
        </TR>
