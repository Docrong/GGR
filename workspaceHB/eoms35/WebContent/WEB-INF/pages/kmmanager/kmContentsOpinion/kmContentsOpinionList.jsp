...
<fmt:bundle basename="com/boco/eoms/km/config/applicationResource-kmmanager">
    ...
    <display:table name="kmContentsOpinionList" cellspacing="0" cellpadding="0"
        ...
        <display:column property="contentId" sortable="true"
                        headerClass="sortable" titleKey="kmContentsOpinion.contentId"
                        href="${app}/kmContentsOpinion/kmContentsOpinions.do?method=edit" paramId="id"
                        paramProperty="id"/>

        <display:column property="createUser" sortable="true"
                        headerClass="sortable" titleKey="kmContentsOpinion.createUser"
                        href="${app}/kmContentsOpinion/kmContentsOpinions.do?method=edit" paramId="id"
                        paramProperty="id"/>

        <display:column property="createDept" sortable="true"
                        headerClass="sortable" titleKey="kmContentsOpinion.createDept"
                        href="${app}/kmContentsOpinion/kmContentsOpinions.do?method=edit" paramId="id"
                        paramProperty="id"/>

        <display:column property="createTime" sortable="true"
                        headerClass="sortable" titleKey="kmContentsOpinion.createTime"
                        href="${app}/kmContentsOpinion/kmContentsOpinions.do?method=edit" paramId="id"
                        paramProperty="id"/>

        <display:column property="opinionContent" sortable="true"
                        headerClass="sortable" titleKey="kmContentsOpinion.opinionContent"
                        href="${app}/kmContentsOpinion/kmContentsOpinions.do?method=edit" paramId="id"
                        paramProperty="id"/>

        <display:column property="opinionGrade" sortable="true"
                        headerClass="sortable" titleKey="kmContentsOpinion.opinionGrade"
                        href="${app}/kmContentsOpinion/kmContentsOpinions.do?method=edit" paramId="id"
                        paramProperty="id"/>

        <display:column property="isEdit" sortable="true"
                        headerClass="sortable" titleKey="kmContentsOpinion.isEdit"
                        href="${app}/kmContentsOpinion/kmContentsOpinions.do?method=edit" paramId="id"
                        paramProperty="id"/>

        <display:column property="isRefedit" sortable="true"
                        headerClass="sortable" titleKey="kmContentsOpinion.isRefedit"
                        href="${app}/kmContentsOpinion/kmContentsOpinions.do?method=edit" paramId="id"
                        paramProperty="id"/>

        <display:column property="isDeleted" sortable="true"
                        headerClass="sortable" titleKey="kmContentsOpinion.isDeleted"
                        href="${app}/kmContentsOpinion/kmContentsOpinions.do?method=edit" paramId="id"
                        paramProperty="id"/>
