...
<table class="formTable">
  ...
  <tr>
			...
			<td class="content">
    		  ...
    		  <br/><br/>	
    		     地市:<textarea class="textarea max" readonly="true" name="eomsCity" style="height:50px" id="eomsCity" required ></textarea><br/>
    			 区县:<textarea class="textarea max" readonly="true" name="eomsCounty" style="height:50px" id="eomsCounty" required ></textarea>
...
function callback(jsonData,str){
	...
	areaTree.onBeforeCheck = function(node,checked){
		...
		<tr>
			<td colspan="4" > 
				<input type="button" id="exportTempButton" value="生成模板"  class="button" onclick="javascript:exportTemp();">				
			</td>
		</tr>
</table>
<br>
