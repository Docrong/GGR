    ...
    <c:choose>
        <c:when test="${newFlag == 'newFlag' || sheetMain.newFlag == 'newFlag'}">
            ...
            <tr>
                ...
                <td class="content">
                    <select name="mainAreaId" id="mainAreaId" class="input select"
                        ...
                        <logic:iterate id="cityList" name="cityList">
                            <option value="${cityList.keyId}"
                                    <c:if test="${sheetMain.mainAreaId==cityList.keyId}">selected="selected"</c:if>>${cityList.keyName}</option>
                        </logic:iterate>
                    </select>
                </td>
            </tr>
                ...
                <c:when test="${operateType == '54' }">
                    <tr style="height:35%;">
                        ...
                        <td style="height:25%;" colspan="3"><eoms:attachmentWlf scope="request"
                                                                                idField="sheetAccessories1"
                                                                                name="sheetMain"
                                                                                property=""
                                                                                appCode="branchindexreduction"
                                                                                sheetFlag="renew"
...
<c:if test="${operateType == '54' && sheetMain.newFlag !='newFlag'}">
    <table class="formTable">
        <tr id="importInforList">
            <td colspan="4">
                <iframe src="branchindexreduction.do?method=search&ifShowOther=no&ifSend=no&refSheetId=${sheetMain.mainReserveA }&scrolling="
                        auto
                " width="100%"
