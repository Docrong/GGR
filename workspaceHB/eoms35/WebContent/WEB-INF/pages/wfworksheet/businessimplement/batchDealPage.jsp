	               ...
	               <tr>
		            	...
		            	<td class="content">  
		            		<select id="dealSelector" onchange="checkValue(this)" alt="allowBlank:false,vtext:'请选择处理操作'">
		            			 <option value=""></option>
		            			 <option value="Receive"><bean:message bundle="businessimplement" key="businessimplement.dealrejectpass"/></option>
			 					 <option value="ExcuteHumTask"><bean:message bundle="businessimplement" key="businessimplement.nopassback"/></option>
			 				</select> 
			        	</td>	   
		            	<td class="label"></td>
		                <td class="content">
					         ...
					         <input type="hidden" name="mainClassName" value="com.boco.eoms.sheet.businessimplement.model.BusinessImplementMain"/>	
					         <input type="hidden" name="linkClassName" value="com.boco.eoms.sheet.businessimplement.model.BusinessImplementLink"/>
