...
<div id="head">
    ...
    <div id="note">
        <img src="<%=webapp%>/scripts/flowview/img/icon_history.gif" width="12" height="12" border="0" alt=""
             align="absMiddle"> 已完成步骤
        <img src="<%=webapp%>/scripts/flowview/img/icon_curstep.gif" width="12" height="12" border="0" alt=""
             align="absMiddle"> 当前步骤
        <a href="#" onclick="window.open(window.location.href)">
            <img src="<%=webapp%>/images/icons/expand.gif" width="16" height="16" border="0" alt="" align="absMiddle">
            在新窗口中打开
        </a>
    </div>
</div>
