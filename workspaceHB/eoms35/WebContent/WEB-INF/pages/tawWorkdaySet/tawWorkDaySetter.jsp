...
<link rel="stylesheet" type="text/css"
      href="<%=request.getContextPath() %>/scripts/widgets/test/test-workday-setter.css"></link>
...
<div class="app-border">
    ...
    <div id="wds-tpl">
        <form name="tawWorkdaySetForm" action="${app}/workdayset/TawWorkdaySetAction.do?method=x_save" method="post"
              styleId="tawWorkdaySetForm">
    ...
    <div>
        ...
        <div id="wds-config">
            ...
            <table border="0" cellspacing="0" cellpadding="5">
                <tr>
                    <td colspan="2">${eoms:a2u("将所选日期设置为:")}</td>
                </tr>
                <tr>
