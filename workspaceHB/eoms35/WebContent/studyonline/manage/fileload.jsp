<%@ page contentType="text/html; charset=gb2312" language="java" import="com.boco.eoms.studyonline.bo.*,
                                                                         com.boco.eoms.common.controller.SaveSessionBeanForm,
...
<%
    ...
    try {
        tip2 = studyOnlineBO.importwordWarehouse(fileName, Integer.parseInt(specialtySel), Integer.parseInt(manufacturerSel), Integer.parseInt(equipIdSel), Integer.parseInt(issueType), Integer.parseInt(s_value), userName);
        tip = "提示";
    } catch (Exception ex) {
        ex.printStackTrace();
    ...
    <tr valign="top">
        <td>
            <table width="98%" border="0" cellspacing="0" cellpadding="0" align="center">
                <tr valign=bottom>
                    <td width=40><img src="<%= request.getContextPath()%>/images/studyonline/it.jpg" width="120"
                                      height="85"></td>
                    <td nowrap><B><%=tip %>
                    </B></td>
...
%>
            <table width="98%" border="0" cellspacing="0" cellpadding="0" align="center">
                <tr>
                    ...
                    <td height="2" width="68%">导入数据发生错误，可能是以下原因</td>
                </tr>
                <tr>
                    <td height="2" width="30%">&nbsp;</td>
                    <td height="2" width="68%">1、导入的excel文件模板不正确</td>
                </tr>
                <tr>
                    <td height="2" width="30%">&nbsp;</td>
                    <td height="2" width="68%">2、导入的excel文件数据不正确</td>
                </tr>
                <tr>
                    <td height="2" width="30%">&nbsp;</td>
                    <td height="2" width="68%">3、系统问题</td>
                </tr>
                <tr>
                    <td height="2" width="30%">&nbsp;</td>
                    <td height="2" width="68%">返回的错误信息是：<%= errMsg%>
                    </td>
                </tr>
            </table>
                <%
