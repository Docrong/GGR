...
<div id="sheetform">
<html:form action="/softwareApply.do?method=performBatchDeal" styleId="theform">
...
<div id="sheet-detail-page">
  ...
  <div id="sheetinfo">
	...
	<%@ include file="/WEB-INF/pages/wfworksheet/softwareApply/basedetailnew.jsp"%>
	<br/>
	<table class="formTable"> 
	  <caption></caption>
		  	
	               <tr>
		           		<td class="label"><bean:message bundle="softwareApply" key="softwareApply.mainNetSort1"/></td>
		            	<td class="content">  
		            		<eoms:id2nameDB id="${sheetMain.mainNetSort1}" beanId="ItawSystemDictTypeDao"/>
			        	</td>	   
		            	<td class="label"><bean:message bundle="softwareApply" key="softwareApply.mainNetSort2"/></td>
		                <td class="content">  
	                ...
	                <tr>
		                <td class="label"><bean:message bundle="softwareApply" key="softwareApply.mainNetSort3"/></td>
		                <td class="content">  
		                	<eoms:id2nameDB id="${sheetMain.mainNetSort3}" beanId="ItawSystemDictTypeDao"/>
			        	</td>	 
		                <td  class="label"><bean:message bundle="softwareApply" key="softwareApply.mainTaskType"/></td>
		                <td class="content">  
			      ...
			      <tr>
		            <td class="label"><bean:message bundle="softwareApply" key="softwareApply.mainTaskDescription"/></td>
				...
				<tr>
				    ...
				    <eoms:attachment name="sheetMain" property="sheetAccessories" 
				            scope="request" idField="sheetAccessories" appCode="softwareApply" 
				             viewFlag="Y"/> 
				    </td>
				</tr>
	</table>
	               ...
	               <tr>
		            	...
		            	<td class="content">  
		            		<select id="dealSelector" onchange="checkValue(this)" alt="allowBlank:false,vtext:'请选择处理操作'">
		            			 <option value=""></option>
		            			 <option value="Receive"><bean:message bundle="softwareApply" key="softwareApply.dealrejectpass"/></option>
			 					 <option value="ExcuteHumTask"><bean:message bundle="softwareApply" key="softwareApply.nopassback"/></option>
			 				</select> 
			        	</td>	   
		            	<td class="label"></td>
		                <td class="content">
		                	 ...
		                	 <input type="hidden" name="beanId" value="iSoftwareApplyMainManager"/> 
					         <input type="hidden" name="mainClassName" value="com.boco.eoms.sheet.softwareApply.model.SoftwareApplyMain"/>	
					         <input type="hidden" name="linkClassName" value="com.boco.eoms.sheet.softwareApply.model.SoftwareApplyLink"/>
					         <input type="hidden" name="methodBeanId"  id="methodBeanId" value="${methodBeanId}"/>
					         <input type="hidden" name="piid" value="${piid}"/>  
			        	</td>			        	             
		           </tr>
	               <tr>
			            <td  class="label"><bean:message bundle="softwareApply" key="softwareApply.advice"/>*</td>
			              <td colspan="3"> 	
