...
<fmt:bundle basename="com/boco/eoms/km/config/applicationResource-kmmanager">
    ...
    <display:table name="kmScoreWeightList" cellspacing="0" cellpadding="0"
        ...
        <display:column property="powerName" sortable="true"
                        headerClass="sortable" titleKey="kmScoreWeight.powerName"
                        href="${app}/kmScoreWeight/kmScoreWeights.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="actionName" sortable="true"
                        headerClass="sortable" titleKey="kmScoreWeight.actionName"
                        href="${app}/kmScoreWeight/kmScoreWeights.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="actionWeight" sortable="true"
                        headerClass="sortable" titleKey="kmScoreWeight.actionWeight"
                        href="${app}/kmScoreWeight/kmScoreWeights.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="powerWeight" sortable="true"
                        headerClass="sortable" titleKey="kmScoreWeight.powerWeight"
                        href="${app}/kmScoreWeight/kmScoreWeights.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="isDeleted" sortable="true"
                        headerClass="sortable" titleKey="kmScoreWeight.isDeleted"
                        href="${app}/kmScoreWeight/kmScoreWeights.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="area" sortable="true"
                        headerClass="sortable" titleKey="kmScoreWeight.area"
                        href="${app}/kmScoreWeight/kmScoreWeights.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="remark" sortable="true"
                        headerClass="sortable" titleKey="kmScoreWeight.remark"
                        href="${app}/kmScoreWeight/kmScoreWeights.do?method=edit" paramId="id" paramProperty="id"/>
