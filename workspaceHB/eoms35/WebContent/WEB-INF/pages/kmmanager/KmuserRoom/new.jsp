...
<%@ page language="java"
         import="java.util.*,java.lang.*,org.apache.struts.util.*,com.boco.eoms.common.tree.*,com.boco.eoms.common.util.StaticMethod" %>
...
<%
    ...
    String dept1 = "";
    String wsClass = "-1";
    String sdomIds = StaticMethod.nullObject2String(request
            .getAttribute("SDOMIDS"));
...
<head>
    ...
    <script type="text/javascript" charset="UTF-8" src="<%=request.getContextPath()%>/duty/css/finallytree.js"></script>
    ...
    <SCRIPT LANGUAGE=javascript>
        ...
        function getUsers(json, ids) {
            var specialId = document.getElementById("deptId").value;
            var url = "<c:url value="/kmmanager/kmExpertTree.do?method=getUserListByAjax"/>";
            pars = "&node=" + specialId + "&fieldDictId=1010104/1050103&fieldName=specialty/expertLevel";
            var myAjax = new Ajax.Request(url, {method: 'get', parameters: pars, onComplete: ifQuery});
        }


        function ifQuery(originalRequest) {
            var userList = originalRequest.responseText;
            ...
            if (users) {
                ...
                for (i = 0; i * 2 < k; i++) {
                    var tempoption = new Option(users[i * 2 + 1], users[i * 2]);
        ...
        function sent_room_user() {
            ...
            var sel_sprlen = document.form1.sRoomUserTrue.options.length - 1;
            if (<%=request.getAttribute("UserNum") != null ? "true"
					: "false"%> &&
            (sel_sprlen + 1) % <%=request.getAttribute("UserNum")%> != 0
        )
            {
                ...
                <table cellpadding="0" cellspacing="0" border="0" width="100%" class="listTable">
                    <tr>
                        <td width="100%" align="center" class="label">
                            <b>
                                <%=request.getAttribute("ROOMNAME")%>值班小组用户配置&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <%
                    ...
                    <tr>
                        <td>
                            <table border="0" width="100%" cellspacing="1" cellpadding="1" class="listTable"
                                   align=center>
                                <tr class="tr_show">
                                    ...
                                    <td width="50%" align="center">
                                        ...
                                        <input type="button" id="specialtyTreeBtn" class="btn" value="专家列表"/>
                                        <p>
                                            专家专业<input type="text" id="specialtyName" name="specialtyName" size="20"
                                                       value="" class="text" readonly="readonly">
                                        <p>
                                            ...
                                            <select size=14 name="sDeptUser" style="width:150" multiple>
                                                ...
                                                %>
                                                <option value="<%out.print(DeptUser.elementAt(i*2));%>"><%
                                                    out.print(DeptUser.elementAt(i * 2 + 1));
                                                %></option>
                                                <%
                                                    }
                                                %>
                                    ...
                                    <td width="20%" align="center" valign="center">
                                        <input type=button class="button" name=btnAddItem value=
                                        <bean:message
                                                key="TawUserRoom.btn_add"/>     onclick="javascript:add_RoomTrue();")>
                                        <p>
                                            <input type=button class="button" name=btnDelItem value=
                                            <bean:message
                                                    key="TawUserRoom.btn_del"/>     onclick="javascript:del_RoomTrue();">
                                        <p>
                                            <input type=button class="button" name=btnAddAll value=
                                            <bean:message
                                                    key="TawUserRoom.btn_add_all"/> onclick="javascript:add_all_RoomTrue();">
                                        <p>
                                            <input type=button class="button" name=btnDelAll value=
                                            <bean:message
                                                    key="TawUserRoom.btn_del_all"/> onclick="javascript:del_all_RoomTrue();">
                                    </td>
                                    ...
                                    <td width="30%" align="center">
                                        <table class="formTable">
                                            ...
                                            <tr>
                                                <td align="center" class="label">
                                                    <select size=8 name="sRoomUserTrue" style="width:150">
                                                        ...
                                                        %>
                                                        <option value="<%out.print(RoomUserTrue.elementAt(i*2));%>"><%
                                                            out.print(RoomUserTrue.elementAt(i * 2 + 1));
                                                        %></option>
                                                        <%
                                                            }
                                                        %>
                                                ...
                                                <td>
                                                    <table>
                                                        <tr>
                                                            <td>
                                                                <img src="<%=request.getContextPath()%>/duty/images/bottom/up.gif"
                                                                     onclick="fnSwap(0);">
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <img src="<%=request.getContextPath()%>/duty/images/bottom/down.gif"
                                                                     onclick="fnSwap(1);">
                                                            </td>
                                                        </tr>
                                                    </table>
                                            ...
                                            <tr>
                                                <td align="center">
                                                    <input type="button" class="button" name="btnIn" value="向上"
                                                           onclick=javascript:del_RoomFalse();>
                                                    <input type="button" class="button" name="btnOut" value="向下"
                                                           onclick=javascript:add_RoomFalse();>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td align="center" class="label">
                                                    ...
                                                    <select size=4 name="sRoomUserFalse" style="width:150">
                                                        ...
                                                        %>
                                                        <option value="<%out.print(RoomUserFalse.elementAt(i*2));%>"><%
                                                            out.print(RoomUserFalse.elementAt(i * 2 + 1));
                                                        %></option>
                                                        <%
                                                            }
                                                        %>
                    ...
                    <tr>
                        <td>
                            <table height="30" cellpadding="0" cellspacing="0" border="0" width="100%">
                                <tr>
                                    <td align="right">
                                        <input type=button class="button" name=save value=
                                        <bean:message key="label.save"/> onclick="sent_room_user();">
                                        <input type=button class="button" name=save value=
                                        <bean:message
                                                key="entry.TawRmSysteminfo.btn_new"/> Onclick="window.location.href ='
                                        ../Kmsysteminfo/add.do?roomId=<%=request.getParameter("roomId")%>'">&nbsp;&nbsp;
                                        <input type="hidden" name="user_true" value="">
                                        <input type="hidden" name="user_false" value="">
