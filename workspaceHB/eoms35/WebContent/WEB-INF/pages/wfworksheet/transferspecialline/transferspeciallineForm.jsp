...
<caption><div class="header center">传输专线</div></caption>
<html:form action="transferspeciallines.do?method=xedit" method="post" styleId="transferspeciallineForm" target="myname">
...
<table class="formTable">
    ...
    <tr>
      ...
      <td class="content">
        ...
        <eoms:comboBox name="portAInterfaceType" id="portAInterfaceType" defaultValue="${transferspeciallineForm.portAInterfaceType}" initDicId="1011015" 
	  	       alt="allowBlank:true" styleClass="select-class"/>
     </td>
     <td class="label">Z接口类型及型号</td>
      <td class="content">
	  	<html:errors property="portZInterfaceType"/>
	  	       <eoms:comboBox name="portZInterfaceType" id="portZInterfaceType" defaultValue="${transferspeciallineForm.portZInterfaceType}" initDicId="1011015" 
	  	       alt="allowBlank:true" styleClass="select-class"/>
    ...
    <tr>
      ...
      <td class="content">
        ...
        <html:text property="portZDetailAdd" styleId="portZDetailAdd"  styleClass="text medium" alt="allowBlank:false"/>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td class="content">
        ...
        <html:text property="zpointLocalPerson" styleId="zpointLocalPerson"  styleClass="text medium" alt="allowBlank:false"/>
      </td>
    </tr>
    <tr>
      ...
      <td class="content">
        ...
        <html:text property="portZContactPhone" styleId="portZContactPhone"  styleClass="text medium" alt="allowBlank:false"/>
      </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <html:text property="userSpecifyDevNeed" styleId="userSpecifyDevNeed"  styleClass="text medium" alt="allowBlank:true"/>
     </td>
    </tr>
	</tbody>
</table>
 ...
 <%if(sheetType.equals("businessImplement")||taskName.equals("UserTask") || taskName.equals("AccessTask") || taskName.equals("CityTask")|| taskName.equals("TransfereTask")|| taskName.equals("TransferlTask")|| taskName.equals("MakeTask")|| taskName.equals("AuditTask")|| taskName.equals("HandleTask")|| taskName.equals("HoldTask")){ %>
    ...
    <caption>客户端勘查信息</caption> 
		...
		<eoms:comboBox name="portABDeviceType" id="portABDeviceType" defaultValue="${transferspeciallineForm.portABDeviceType}" initDicId="1012304" 
			  	       alt="allowBlank:true" styleClass="select-class" />
	      ...
	      <td class="content">
		  	<html:errors property="buildMethodA"/>
	           <eoms:comboBox name="buildMethodA" id="buildMethodA" defaultValue="${transferspeciallineForm.buildMethodA}" initDicId="1012308" 
			  	       alt="allowBlank:true" styleClass="select-class" />
		...
		<tr>
	      ...
	      <td class="content">
		  	<html:errors property="userIsHaveDivA"/>
		  	 <eoms:comboBox name="userIsHaveDivA" id="userIsHaveDivA" defaultValue="${transferspeciallineForm.userIsHaveDivA}" initDicId="1012309" 
			  	       alt="allowBlank:true" styleClass="select-class"/>
		  </td>
		  <td class="label">A是否需要移动采购</td>
	      <td class="content">
	      	<html:errors property="isNeedBuyA"/>
	          <eoms:comboBox name="isNeedBuyA" id="isNeedBuyA" defaultValue="${transferspeciallineForm.isNeedBuyA}" initDicId="1012309" 
	    ...
	    <tbody id="NeededA" style="display:none">
	      ...
	      <tr>
	       ...
	       <td  colspan='3'>
	       		<html:text property="userStardAddZ" styleId="userStardAddZ"  styleClass="text medium" alt="allowBlank:true"/>
		   </td>
	    </tr>
		<tr>
	    ...
	    <tr>
	      ...
	      <td class="content">
	        ...
	        <eoms:comboBox name="portZBDeviceType" id="portZBDeviceType" defaultValue="${transferspeciallineForm.portZBDeviceType}" initDicId="1012304" 
			  	       alt="allowBlank:true" styleClass="select-class" />
	      </td>
	      <td class="label">Z建设方式</td>
	      <td class="content">
		  	<html:errors property="buildMethodZ"/>
	           <eoms:comboBox name="buildMethodZ" id="buildMethodZ" defaultValue="${transferspeciallineForm.buildMethodZ}" initDicId="1012308" 
			  	       alt="allowBlank:true" styleClass="select-class" />
		...
		<tr>
	      ...
	      <td class="content">
		  	<html:errors property="userIsHaveDivZ"/>
		  	 <eoms:comboBox name="userIsHaveDivZ" id="userIsHaveDivZ" defaultValue="${transferspeciallineForm.userIsHaveDivZ}" initDicId="1012309" 
			  	       alt="allowBlank:true" styleClass="select-class"/>
		  </td>
		  <td class="label">Z是否需要移动采购</td>
	      <td class="content">
	      	<html:errors property="isNeedBuyZ"/>
	          <eoms:comboBox name="isNeedBuyZ" id="isNeedBuyZ" defaultValue="${transferspeciallineForm.isNeedBuyZ}" initDicId="1012309" 
	    ...
	    <tbody id="NeededZ" style="display:none">
	      ...
	      <td colspan='3'>
	        ...
	        <html:textarea property="theDevNeededZ" styleId="theDevNeededZ"  styleClass="textarea max" alt="allowBlank:true"/>
	      </td>
	      </tr>
		</tbody>
		<tr>
	...
	<tbody id='interfaceInfoA' > 
		...
		<tr>
	      ...
	      <eoms:comboBox name="interfacePointTypeA" id="interfacePointTypeA" defaultValue="${transferspeciallineForm.interfacePointTypeA}" initDicId="1012316" 
			  	       alt="allowBlank:true" styleClass="select-class" />
	      </td>	      
		</tr>
		<tr>
	      ...
	      <td colspan="3">
	        ...
	        <textarea name="fiberAroute" id="fiberAroute" class="textarea max" alt="allowBlank:true">${transferspeciallineForm.fiberAroute}</textarea>	
	      </td>
		</tr>
		<%if(taskName.equals("AccessTask")){%>
			<tr>
				  ...
				  <td colspan="3">						  	
				  	<a  style="cursor:hand;color:darkbule" onclick="javascript:popupIrmsPreSurveyA('${transferspeciallineForm.portADetailAdd}')">点击进行接入点勘察</a>
				  </td>	
			</tr>
		<%} %>
		</tbody>
		...
		<td class="label">Z接入点机房</td>
	      <td class="content">
	        ...
	        <html:text property="zpointComputerHorseName" styleId="zpointComputerHorseName"  styleClass="text medium" alt="allowBlank:true"/>
	      </td>
		<td class="label">Z接入点地址</td>
	      <td class="content">
	      	<html:errors property="interfacePointAddZ"/>
	        <html:text property="interfacePointAddZ" styleId="interfacePointAddZ"  styleClass="text medium" alt="allowBlank:true"/>
	     </td>
	    </tr>
		<tr>
	      ...
	      <td colspan="3">
	        ...
	        <html:text property="interfaceSiteNameZ" styleId="interfaceSiteNameZ"  styleClass="text medium" alt="allowBlank:true"/>
	      </td>
		</tr>
		<tr>
	      ...
	      <td class="content">
	        ...
	        <html:text property="fiberEquipNameZ" styleId="fiberEquipNameZ"  styleClass="text medium" alt="allowBlank:true"/>
	      </td>
	      <td class="label">Z光纤设备编号</td>
	      <td class="content">
		  	<html:errors property="fiberEquipCodeZ"/>
	        <html:text property="fiberEquipCodeZ" styleId="fiberEquipCodeZ"  styleClass="text medium" alt="allowBlank:true"/>
	      </td>
		</tr>
		<tr>
	      ...
	      <td class="content">
	        ...
	        <html:text property="fiberZcount" styleId="fiberZcount"  styleClass="text medium" alt="allowBlank:true"/>
	      </td>
	      <td class="label">Z接入点类型</td>
	      <td class="content">
		  	<html:errors property="interfacePointTypeZ"/>
		  	<eoms:comboBox name="interfacePointTypeZ" id="interfacePointTypeZ" defaultValue="${transferspeciallineForm.interfacePointTypeZ}" initDicId="1012316" 
			  	       alt="allowBlank:true" styleClass="select-class" />
	      </td>	      
		</tr>
		<tr>
	      ...
	      <td colspan="3">
	        ...
	        <textarea name="fiberZroute" id="fiberZroute" class="textarea max" alt="allowBlank:true">${transferspeciallineForm.fiberZroute}</textarea>
	      </td>
		</tr>
		<%if(taskName.equals("AccessTask")){%>
			<tr>
				  ...
				  <td colspan="3">						  	
				  	<a  style="cursor:hand;color:darkbule" onclick="javascript:popupIrmsPreSurveyZ('${transferspeciallineForm.portZDetailAdd}')">点击进行接入点勘察</a>
				  </td>	
			</tr>
		<%} %>
		</tbody>
		...
		<tr>
	      ...
	      <td class="content">
		  	<html:errors property="fiberOwnerA"/>
	       	   <eoms:comboBox name="fiberOwnerA" id="fiberOwnerA" defaultValue="${transferspeciallineForm.fiberOwnerA}" initDicId="1012315" 
		  	       alt="allowBlank:true" styleClass="select-class"/>
	     </td>
	      </tr>
	      <tr>
			<td class="label">敷设方式</td>
		      <td class="content">
		        ...
		        <textarea name="buildTypeA" id="buildTypeA" class="textarea max" alt="allowBlank:true">${transferspeciallineForm.buildTypeA}</textarea>	
		      </td>
	      <td class="label">A客户端到接入点能否通达</td>
	      <td class="content">
		  	<html:errors property="isOkBetweenUserA"/>
	        <eoms:comboBox name="isOkBetweenUserA" id="isOkBetweenUserA" defaultValue="${transferspeciallineForm.isOkBetweenUserA}" initDicId="1012310" 
	     ...
	     <tr>
		     ...
		     <td colspan='3'>
		      	<html:errors property="noInputResonA"/>
		       	<textarea name="noInputResonA" id="noInputResonA" class="textarea max" alt="allowBlank:true">${transferspeciallineForm.noInputResonA}</textarea>			   
		     </td>
	     	</c:if>
	     	</tr>
	     	</tbody>
	     ...
	     <tr>
	      ...
	      <td class="content">
	        ...
	        <html:text property="fiberLengthZ" styleId="fiberLengthZ"  styleClass="text medium" alt="allowBlank:true"/>
	      </td>
	      <td class="label">Z光缆产权</td>
	      <td class="content">
		  	<html:errors property="fiberOwnerZ"/>
	       	   <eoms:comboBox name="fiberOwnerZ" id="fiberOwnerZ" defaultValue="${transferspeciallineForm.fiberOwnerZ}" initDicId="1012315" 
		  	       alt="allowBlank:true" styleClass="select-class"/>
	     </td>
	      </tr>
	      <tr>
			<td class="label">敷设方式</td>
		      <td class="content">
		        ...
		        <textarea name="buildTypeZ" id="buildTypeZ" class="textarea max" alt="allowBlank:true">${transferspeciallineForm.buildTypeZ}</textarea>			   
		      </td>
	      <td class="label">Z客户端到接入点能否通达</td>
	      <td class="content">
		  	<html:errors property="isOkBetweenUserZ"/>
	        <eoms:comboBox name="isOkBetweenUserZ" id="isOkBetweenUserZ" defaultValue="${transferspeciallineForm.isOkBetweenUserZ}" initDicId="1012310" 
	     ...
	     <tr>
		     ...
		     <td colspan='3'>
		      	<html:errors property="noInputResonZ"/>
		       	<textarea name="noInputResonZ" id="noInputResonZ" class="textarea max" alt="allowBlank:true">${transferspeciallineForm.noInputResonZ}</textarea>			   
		     </td>
	     	</c:if>
	     	</tr>
	     </tbody>
	    ...
	    <tr>
	    	<td class="label">A传输容量是否满足开通</td>
	     	<td class="content">
		        ...
		        <html:text property="isDeviceAllowOpenA" styleId="isDeviceAllowOpenA"  styleClass="text medium" alt="allowBlank:true"/>
	     	</td>
	         <td class="label">A是否需要添加板卡</td>
	          <td class="content">
		  	  <html:errors property="isNeedAddCardA"/>
	          <eoms:comboBox name="isNeedAddCardA" id="isNeedAddCardA" defaultValue="${transferspeciallineForm.isNeedAddCardA}" initDicId="1012309" 
    	 ...
    	 <tr>
	    	<td class="label">Z传输容量是否满足开通</td>
	     	<td class="content">
		        ...
		        <html:text property="isDeviceAllowOpenZ" styleId="isDeviceAllowOpenZ"  styleClass="text medium" alt="allowBlank:true"/>
	     	</td>
	         <td class="label">Z是否需要添加板卡</td>
	          <td class="content">
		  	  <html:errors property="isNeedAddCardZ"/>
	          <eoms:comboBox name="isNeedAddCardZ" id="isNeedAddCardZ" defaultValue="${transferspeciallineForm.isNeedAddCardZ}" initDicId="1012309" 
    ...
    <caption>最后一公里相关信息</caption> 	
	    ...
	    <tr>	      
	      ...
	      <td class="content">
		  	...
		  	<eoms:comboBox name="isGetInterfaceA" id="isGetInterfaceA" defaultValue="${transferspeciallineForm.isGetInterfaceA}" initDicId="1012310" 
			  	       alt="allowBlank:true" styleClass="select-class" />
	      </td>
		...
		<tr>
	      <td class="label">A最后一公里处理意见</td>
	       <td  class="content" colspan="3">
		  		<textarea name="theLastOpinionA" id="theLastOpinionA" class="textarea max" alt="allowBlank:true">${transferspeciallineForm.theLastOpinionA}</textarea>			   
			</td>
		</tr>
		<tr>
		 ...
		 <tr>	      
	      ...
	      <td class="content">
		  	...
		  	<eoms:comboBox name="isGetInterfaceZ" id="isGetInterfaceZ" defaultValue="${transferspeciallineForm.isGetInterfaceZ}" initDicId="1012310" 
			  	       alt="allowBlank:true" styleClass="select-class" />
	      </td>
	      <td class="label">Z熔接序号</td>
	      <td colspan="3">
		  	<html:errors property="getInterfaceNoZ"/>
	        <html:text property="getInterfaceNoZ" styleId="getInterfaceNoZ"  styleClass="text medium" alt="allowBlank:true"/>
	      </td>		
		</tr>
		<tr>
	      <td class="label">Z最后一公里处理意见</td>
	       <td  class="content" colspan="3">
		  		<textarea name="theLastOpinionZ" id="theLastOpinionZ" class="textarea max" alt="allowBlank:true">${transferspeciallineForm.theLastOpinionZ}</textarea>			   
			</td>
		</tr>
		<tr>
			<td class="label">工程信息</td>
