                ...
                <td>
                    ...
                    <c:if test="${not empty kmTableThemeForm.id}">
                        <input type="button" class="btn"
                               ...
                               onclick="javascript:if(confirm('<fmt:message
                                       key="kmMessage.delMessage"/>')){var url='${app}/kmmanager/kmTableThemes.do?method=remove&nodeId=${kmTableThemeForm.nodeId}';location.href=url}"/>
                    </c:if>
                </td>
            </tr>
        </table>
