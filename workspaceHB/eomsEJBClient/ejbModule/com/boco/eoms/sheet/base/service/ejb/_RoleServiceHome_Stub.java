...
public class _RoleServiceHome_Stub extends Stub implements RoleServiceHome {

    private static final String[] _type_ids = {
            "RMI:com.boco.eoms.sheet.base.service.ejb.RoleServiceHome:0000000000000000",
    ...
    public RoleService create() throws CreateException, RemoteException {
        while (true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        ...
                        in = (InputStream) _invoke(out);
                        return (RoleService) in.read_Object(RoleService.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create", com.boco.eoms.sheet.base.service.ejb.RoleServiceHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    RoleService result = ((com.boco.eoms.sheet.base.service.ejb.RoleServiceHome) so.servant).create();
                    return (RoleService) Util.copyObject(result, _orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable) Util.copyObject(ex, _orb());
