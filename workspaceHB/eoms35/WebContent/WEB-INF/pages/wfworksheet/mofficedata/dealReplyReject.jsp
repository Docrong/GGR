...
<%@ include file="/WEB-INF/pages/wfworksheet/mofficedata/baseinputlinkhtmlnew.jsp"%>
     ...
     <tr>
      ...
      <logic:iterate id="toTask" name="acceptList" type="com.boco.eoms.sheet.mofficedata.model.MofficeDataTask">  
        <tr>
          <td>
   ...
   <tr>
      ...
      <logic:iterate id="toTask" name="allList" type="com.boco.eoms.sheet.mofficedata.model.MofficeDataTask">  
        <tr>
          <td colspan="2">
              <eoms:id2nameDB id="${toTask.operateRoleId}" beanId="tawSystemSubRoleDao" /><eoms:id2nameDB id="${toTask.operateRoleId}" beanId="tawSystemUserDao" />&nbsp;
              <input type="hidden" name="toid" id="toid" value="${toTask.id}" />
