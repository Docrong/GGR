...
<%}%>
 ...
 <tr class=xl27 height=19 style='height:14.25pt'>
  <td height=19 class=xl24 width=40 style='height:14.25pt;width:30pt'>省份</td>
  <td class=xl24 width=82 style='border-left:none;width:62pt'>原归属城市</td>
  <td class=xl24 width=107 style='border-left:none;width:80pt'>原归属城市区号</td>
  <td class=xl25 width=82 style='border-left:none;width:62pt'>现归属城市</td>
  <td class=xl25 width=113 style='border-left:none;width:85pt'>现归属城市区号</td>
<%Set set = headMap.keySet();
Iterator iter = set.iterator();
while(iter.hasNext()){%>
  <td class=xl25 width=96 style='border-left:none;width:72pt'><%=iter.next()%></td>
<%}%>
  <td class=xl26 width=115 style='border-left:none;width:86pt'>归属HLR名称</td>
  <td class=xl26 width=140 style='border-left:none;width:105pt'>归属HLR信令点</td>
 </tr>
<%for(int i=0;i<size;i++){
  TawBureaudataSHlrForExcel po = (TawBureaudataSHlrForExcel)hlrList.get(i);
  String[] segArr = po.getSegArr();%>
 <tr class=xl27 height=19 style='height:14.25pt'>
  <td height=19 class=xl28 style='height:14.25pt;border-top:none'>湖北</td>
