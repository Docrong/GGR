...
<fmt:bundle basename="com/boco/eoms/km/config/applicationResource-kmmanager">
    ...
    <display:table name="kmTableDictList" cellspacing="0" cellpadding="0"
        ...
        <display:column property="id" sortable="true"
                        headerClass="sortable" titleKey="kmTableDict.id"
                        href="${app}/kmTableDict/kmTableDicts.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="dictName" sortable="true"
                        headerClass="sortable" titleKey="kmTableDict.dictName"
                        href="${app}/kmTableDict/kmTableDicts.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="parentId" sortable="true"
                        headerClass="sortable" titleKey="kmTableDict.parentId"
                        href="${app}/kmTableDict/kmTableDicts.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="isDeleted" sortable="true"
                        headerClass="sortable" titleKey="kmTableDict.isDeleted"
                        href="${app}/kmTableDict/kmTableDicts.do?method=edit" paramId="id" paramProperty="id"/>
