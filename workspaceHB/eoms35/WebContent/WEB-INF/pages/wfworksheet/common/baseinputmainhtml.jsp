        ...
        <td colspan="2">
            <div class="x-form-item"><label><bean:message bundle="sheet" key="mainForm.title"/></label>
                <div class="x-form-element">
                    <input type="text" name="${sheetPageName}title" id="${sheetPageName}title"
                           value="${sheetMain.title}" alt="width:'500px',allowBlank:false"/>
                </div>
            </div>
        </td>
    </tr>
        ...
        <td width="320">
            <div class="x-form-item"><label><bean:message bundle="sheet" key="mainForm.sendUserName"/></label>
                <div class="x-form-element">
                    ...
                    <input type="hidden" name="${sheetPageName}sheetKey" id="${sheetPageName}sheetKey"
                           value="${sheetMain.id}"/>
                    <input type="hidden" name="${sheetPageName}mainId" id="${sheetPageName}mainId"
                           value="${sheetMain.id}"/>
                    <input type="hidden" name="${sheetPageName}sheetId" id="${sheetPageName}sheetId"
                           value="${sheetMain.sheetId}"/>
                    <input type="hidden" name="${sheetPageName}sendUserId" id="${sheetPageName}sendUserId"
                    ...
                    <input type="hidden" name="${sheetPageName}activeTemplateId" id="${sheetPageName}activeTemplateId"
                           value="${taskName}"/>
        ...
        <tr>
            <td>
                <div class="x-form-item"><label><bean:message bundle="sheet" key="mainForm.sendContact"/></label>
                    <div class="x-form-element">
                        <input type="text" name="${sheetPageName}sendContact" id="${sheetPageName}sendContact"
            ...
            <td>
                ...
                <div class="x-form-item"><label><bean:message bundle="sheet" key="mainForm.toDeptId"/></label>
                    <div class="x-form-element">
                        <input type="text" readonly="readonly" name="${sheetPageName}showDept"
            ...
            <td colspan="2">
                <div class="x-form-item"><label><bean:message bundle="sheet" key="mainForm.sendContact"/></label>
                    <div class="x-form-element">
                        <input type="text" name="${sheetPageName}sendContact" id="${sheetPageName}sendContact"
                               value="${sheetMain.sendContact}" alt="allowBlank:false"/>
                        <input type="hidden" name="${sheetPageName}showDept" id="${sheetPageName}showDept"
                               value="<eoms:id2nameDB id="${sheetMain.toDeptId}" beanId="tawSystemDeptDao"/>"/>
                        <input type="hidden" name="${sheetPageName}toDeptId" id="${sheetPageName}toDeptId"
                               value="${sheetMain.toDeptId}"/>
                    </div>
    ...
    <tr>
        <td>
            <div class="x-form-item"><label><bean:message bundle="sheet" key="mainForm.completeLimit"/></label>
                <div class="x-form-element">
                    <input type="text" name="${sheetPageName}sheetCompleteLimit" readonly="readonly"
                           id="${sheetPageName}sheetCompleteLimit"
                           value="${eoms:date2String(sheetMain.sheetCompleteLimit)}" alt="timer:true"/>
                </div>
            </div>
        </td>
    </tr>
