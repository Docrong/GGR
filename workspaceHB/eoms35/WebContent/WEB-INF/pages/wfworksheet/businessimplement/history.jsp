...
<c:if test="${!empty baselink.operateType && (baselink.operateType == '91'||baselink.operateType == '11')}">
                 ...
                 <tr>  				
				  ...
				  <tr>  				
				  				  <td class="column-title">
				  				     <bean:message bundle="businessimplement" key="businessimplement.linkSenderOpinition"/>
				  				  </td>
...
<c:if test="${!empty baselink.operateType && (baselink.operateType == '93'||baselink.operateType == '11')}">
                 <tr>  				
				  ...
				  <tr>  				
				   ...
				   <tr>  				
				  		 <td class="column-title">
				  			<bean:message bundle="businessimplement" key="businessimplement.linkFailureResson"/>  
				  		  </td>
				  		  <td class="column-content" colspan="3">
				  		 ...
				  		 <td class="column-title">
				  		  ...
				  		  <td class="column-content" colspan="3">
				  		    <eoms:id2nameDB id="${baselink.linkDealResourt}" beanId="ItawSystemDictTypeDao"/>
				  				  				   ...
				  				  				   <tr>  				
				  		 <td class="column-title">
				  			<bean:message bundle="businessimplement" key="businessimplement.linkDealDescriptin"/>  
				  		  </td>
				  		  <td class="column-content" colspan="3">
				  ...
				  <tr>  				
	  				  ...
	  				  <td class="column-content" colspan=3>
                         <eoms:attachment name="baselink" property="nodeAccessories" 
				              scope="page" idField="nodeAccessories" appCode="businessimplement" 
				               viewFlag="Y"/>
	                  </td>                  
	  				</tr>
  </c:if>			  					  			
