...
<%@ include file="/WEB-INF/pages/wfworksheet/securityobjaudit/baseinputlinkhtmlnew.jsp"%>
	...
	<table class="formTable">
         ...
         <input type="hidden" name="linkBeanId" value="iSecurityObjAuditLinkManager"/> 
 ...
 <%}%>
			...
			<input type="hidden" name="phaseId" id="phaseId" value="QualityInspection" />	 
 				...
 				<td class="label">
				<!-- 工单驳回描述 -->
				<bean:message bundle="securityobjaudit" key="securityObjAuditLink.linkReject"/>
			</td>
			<td>
			   ...
			   <tr>
			     ...
			     <td colspan="3">				
					     <eoms:attachment name="sheetLink" property="nodeAccessories" 
              				scope="request" idField="nodeAccessories" appCode="securityobjaudit" />		   
			     </td>
		</tr>
	 <%}%>
 			   		...
 			   		<% if(operateType.equals("102")){ %>
 			   			<fieldset>
							  ...
							  <div class="x-form-item" >
									...
									<eoms:chooser id="Audit0"  type="role" roleId="4303" flowId="43" config="{returnJSON:true,showLeader:true}"  
 			   		...
 			   		<% if(operateType.equals("104")){ %>
 			   			<fieldset>
							  ...
							  <div class="x-form-item" >
									...
									<eoms:chooser id="AuditReply0"  type="role" roleId="4304" flowId="43" config="{returnJSON:true,showLeader:true}"  
									   category="[{id:'dealPerformer',text:'派发',limit:'none',allowBlank:false,vtext:'请选择派发对象'},{id:'copyPerformer',childType:'user,subrole',limit:'none',text:'抄送'}]" 
									  data="${sendUserAndRoles}" />
 			   		...
 			   		<% if(operateType.equals("106")){ %>
 			   			<fieldset>
							  ...
							  <div class="x-form-item" >
									...
									<eoms:chooser id="QualityInspection1"  type="role" roleId="4301" flowId="43" config="{returnJSON:true,showLeader:true}"  
									   category="[{id:'dealPerformer',text:'派发',limit:'none',allowBlank:false,vtext:'请选择派发对象'},{id:'copyPerformer',childType:'user,subrole',limit:'none',text:'抄送'}]" 
									  data="${sendUserAndRoles}" />
