        ...
        <logic:present name="sheetMain" scope="request">
            ...
            <table id="sheet" class="formTable">
                ...
                <tr>
                    <td class="label">
                        <!-- 网管告警流水号 -->
                        <bean:message bundle="commonfaultcorrigendum"
                                      key="commonfaultCorrigendumMain.mainCommonfaultSheetId"/>
                    </td>
                    <td>
                    ...
                    <td class="label">
                        <!-- 网元名称 -->
                        <bean:message bundle="commonfaultcorrigendum"
                                      key="commonfaultCorrigendumMain.mainCommonfaultNetName"/>
                    </td>
                    <td>
                ...
                <tr>
                    <td class="label">
                        <!-- 勘误类型一级 -->
                        <bean:message bundle="commonfaultcorrigendum"
                                      key="commonfaultCorrigendumMain.mainCorrigendumTypeOne"/>
                    </td>
                    <td>
                    ...
                    <td class="label">
                        <!-- 勘误类型二级 -->
                        <bean:message bundle="commonfaultcorrigendum"
                                      key="commonfaultCorrigendumMain.mainCorrigendumTypeTwo"/>
                    </td>
                    <td>
                ...
                <tr>
                    <td class="label">
                        <!-- 勘误类型三级 -->
                        <bean:message bundle="commonfaultcorrigendum"
                                      key="commonfaultCorrigendumMain.mainCorrigendumTypeThree"/>
                    </td>
                    <td colspan='3'>
            ...
            <table class="formTable">
                ...
                <tr>
                    ...
                    <td><c:if test="${sheetMain.mainifAutotran=='1'}">是</c:if><c:if
                            test="${sheetMain.mainifAutotran=='0'}">否</c:if></td>
            ...
            <tr>
                <td width="50%">
                    ...
                    <select id="dealSelector">
                        ...
                        <!-- 流程步骤，移交，阶段回复，分派 -->
                        <option value="${urlShowNetCorrigendum102Page}"><bean:message bundle="commonfaultcorrigendum"
                                                                                      key="operateType.NetCorrigendum102"/></option>
                        ...
                        <!-- 不需要等待回复 -->
                        <% if (ifwaitfor.equals("false")) {%>
                        <option value="${urlShowDispatchPage}"><bean:message bundle="commonfaultcorrigendum"
                    ...
                    <select id="dealSelector">
                        ...
                        <% if (ifwaitfor.equals("false")) {%>
                        <!-- 流程步骤，移交，阶段回复，分派 -->
                        <option value="${urlShowHoldTask18Page}"><bean:message bundle="commonfaultcorrigendum"
                    ...
                    <select id="dealSelector">
                        <option value="${urlShowDraftPage}"><bean:message bundle="commonfaultcorrigendum"
