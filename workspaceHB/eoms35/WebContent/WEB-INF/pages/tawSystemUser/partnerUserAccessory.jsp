...
<title>${eoms:a2u('合作伙伴人力信息批量录入')}</title>
<html:form action="tawSystemUsers.do?method=xaccessory"
	method="post" styleId="tawSystemUserForm"
	...
	<table class="formTable small" align="center">
		...
		<tr>
			...
			<td>
			<%
					String url = "/WEB-INF/pages/tawSystemUser/template";
					String fileRealName = "partnerUserTemplate.xls";
					url += "/" + fileRealName;
			%>
				<a
					href="<%=request.getContextPath()%>/sysuser/tawSystemUsers.do?method=xmlOutPut&url=<%=url%>"><%=fileRealName%>
				</a>
			</td>
		</tr>
		<tr>
