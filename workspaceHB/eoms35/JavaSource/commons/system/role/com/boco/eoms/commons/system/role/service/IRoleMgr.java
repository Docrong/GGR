...
public interface IRoleMgr {
     ...
     *
     * @param userId   用户ID
     * @param roleType 子角色类型， RoleConstants.flowRole=流程角色，
     ...
     * 删除子角色
     *
     * @param tawSystemSubRole 待删除的子角色
     * @deprecated 不可用
     */
     ...
     * 复制某用户的所有角色到另一用户
     *
     * @param originUserId 源用户id
     * @param targetUserId 目的用户id
     * @deprecated 不可用
     */
