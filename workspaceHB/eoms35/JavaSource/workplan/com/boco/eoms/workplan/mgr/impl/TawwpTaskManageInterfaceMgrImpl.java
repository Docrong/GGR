...
public class TawwpTaskManageInterfaceMgrImpl implements
    ...
    /**
     * @param tawwpNetMgr the tawwpNetMgr to set
     */
...
//			Document _doc =tawwpIntfaceUtil.getNetInfoDoc();
     ...
     *
     * @param _tawwpExecuteContent TawwpExecuteContent 作业计划执行内容
     * @param _tawwpNet            TawwpNet 网元
     * @param _startDate           String 日期
