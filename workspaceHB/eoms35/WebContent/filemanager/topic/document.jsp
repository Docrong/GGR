    ...
    <html:form method="POST" action="/topic/InfoTypeDetailAction.do" enctype="multipart/form-data">
            ...
            <TABLE id="list" width="100%">
                <TR>
                    <TD>
                        ...
                        <input type="button" value="保存专题信息" <%=request.getAttribute("saveenable")%> name="btnSaveType"
                               onclick='saveRecord()' Class="button">&nbsp;&nbsp
        ...
        <TABLE id="list" class="formTable" width="100%">
            ...
            <TR>
                ...
                <TD><%=request.getAttribute("htmlClassId")%>
                </TD>
            </TR>
            <TR>
                <TD width="30%" class="label"><b>专题路径</b></TD>
                <TD><%=request.getAttribute("htmlTopicPath")%>
                </TD>
            </TR>
            <TR>
