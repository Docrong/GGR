...
function showPage(){
     var pars = '';
     var url = '';    
      url = '${app}/sheet/businessimplementsms/businessimplementsms.do?method=showInputRejectPage&piid=${sheetMain.piid}&taskId=${taskId}&taskName=${taskName}';
     if (url!=''){
...
<div id="sheetform">
<html:form action="/businessimplementsms.do?method=performDeal" styleId="theform">
