...
<fmt:bundle basename="com/boco/eoms/km/config/applicationResource-kmmanager">
    ...
    <display:table name="kmOperateLogList" cellspacing="0" cellpadding="0"
        ...
        <display:column property="themeId" sortable="true"
                        headerClass="sortable" titleKey="kmOperateLog.themeId"
                        href="${app}/kmmanager/kmOperateLogs.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="tableId" sortable="true"
                        headerClass="sortable" titleKey="kmOperateLog.tableId"
                        href="${app}/kmmanager/kmOperateLogs.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="contentId" sortable="true"
                        headerClass="sortable" titleKey="kmOperateLog.contentId"
                        href="${app}/kmmanager/kmOperateLogs.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="operateUser" sortable="true"
                        headerClass="sortable" titleKey="kmOperateLog.operateUser"
                        href="${app}/kmmanager/kmOperateLogs.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="operateDept" sortable="true"
                        headerClass="sortable" titleKey="kmOperateLog.operateDept"
                        href="${app}/kmmanager/kmOperateLogs.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="operateTime" sortable="true"
                        headerClass="sortable" titleKey="kmOperateLog.operateTime"
                        href="${app}/kmmanager/kmOperateLogs.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="score" sortable="true"
                        headerClass="sortable" titleKey="kmOperateLog.score"
                        href="${app}/kmmanager/kmOperateLogs.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="toUser" sortable="true"
                        headerClass="sortable" titleKey="kmOperateLog.toUser"
                        href="${app}/kmmanager/kmOperateLogs.do?method=edit" paramId="id" paramProperty="id"/>
