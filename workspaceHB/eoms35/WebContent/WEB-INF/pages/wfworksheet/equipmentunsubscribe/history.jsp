...
<logic:present name="HISTORY" scope="request">  
      ...
      <logic:iterate id="baselink" name="HISTORY" type="com.boco.eoms.sheet.equipmentunsubscribe.model.EquipmentUnsubscribeLink" >     
       <%         
        jNum += 1;       
      ...
      <div class="history-item">&nbsp;   
	      ...
	      <div class="history-item-title">
			 ...
			 <bean:write name="baselink" property="operateTime" formatKey="date.formatDateTimeAll" bundle="sheet" scope="page"/>&nbsp; 
	  	     ...
	  	     <eoms:dict key="dict-sheet-equipmentunsubscribe" dictId="activeTemplateId" itemId="${baselink.activeTemplateId}" beanId="id2descriptionXML" />
	  	     <bean:message bundle="equipmentunsubscribe" key="equipmentunsubscribe.operateType"/>:
	  	     <eoms:dict key="dict-sheet-equipmentunsubscribe" dictId="mainOperateType" itemId="${baselink.operateType}" beanId="id2descriptionXML" />
	 ...
	 <!-- 流程中的历史页面 -->
		  		...
		  		<%if(baselink.getActiveTemplateId()!=null && baselink.getActiveTemplateId().equals("Dismantle")) {%>
		  				...
		  				<%if(baselink.getOperateType() != null && (baselink.getOperateType().intValue() == 102 || baselink.getOperateType().intValue() == 11)){ %>
		 					...
		 					<td class="label">
								<!-- 安装设备类型 -->
								<bean:message bundle="equipmentunsubscribe" key="equipmentUnsubscribeLink.linkEquipmentType"/>
							</td>
							<td class="content">
							...
							<td class="content">
		 					...
		 					<td class="label">
								<!-- 安装时间 -->
								<bean:message bundle="equipmentunsubscribe" key="equipmentUnsubscribeLink.linkEquipmentTime"/>
							</td>
							<td class="content">
							...
							<td colspan="3">
		 					...
		 					<td class="label">
								<!-- 收费照片 -->
								<bean:message bundle="equipmentunsubscribe" key="equipmentUnsubscribeLink.linkReturnPhoto"/>
							</td>
							<td class="content">
