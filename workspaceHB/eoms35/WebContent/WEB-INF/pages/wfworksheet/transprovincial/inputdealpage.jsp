...
<%@ include file="/WEB-INF/pages/wfworksheet/transprovincial/baseinputlinkhtmlnew.jsp"%>
	...
	<table class="formTable">
		...
		<%} %>      
			...
			<td>
				<input type="text"  class="text" name="assignmentResult" id="assignmentResult"  alt="allowBlank:false,maxLength:1000,vtext:'请填入 分派结果 信息，最多输入 1000 字符'" value="${sheetLink.assignmentResult}"/>
			</td>
		</tr>
 ...
 <%}%>
			...
			<td>
				<input type="text"  class="text" name="desginResult" id="desginResult"  alt="allowBlank:false,maxLength:1000,vtext:'请填入 设计结果 信息，最多输入 1000 字符'" value="${sheetLink.desginResult}"/>
			</td>
		</tr>
 ...
 <%}%>
			...
			<td>
				<textarea class="textarea max" name="examineResult" id="examineResult" alt="allowBlank:false,maxLength:2000,vtext:'请输入审核结果，多输入100汉字'">${sheetLink.examineResult}</textarea>
			</td>
		</tr>
 ...
 <%}%>
			...
			<td>
				<input type="text"  class="text" name="examineResult" id="examineResult"  alt="allowBlank:false,maxLength:1000,vtext:'请填入 审核结果 信息，最多输入 1000 字符'" value="${sheetLink.examineResult}"/>
			</td>
		</tr>
 ...
 <%}%>
			...
			<td>
				<textarea class="textarea max" name="constractCondition" id="constractCondition" alt="allowBlank:false,maxLength:2000,vtext:'请输入审核情况，多输入100汉字'">${sheetLink.constractCondition}</textarea>
			</td>
		</tr>
 ...
 <%}%>
			...
			<td>
				<input type="text"  class="text" name="linkGroupComplete" id="linkGroupComplete"  alt="allowBlank:false,maxLength:1000,vtext:'请填入 回复结果 信息，最多输入 1000 字符'" value="${sheetLink.linkGroupComplete}"/>
			</td>
		</tr>
 ...
 <%}%>
			...
			<td>
				<textarea class="textarea max" name="completeResult" id="completeResult" alt="allowBlank:false,maxLength:2000,vtext:'请输入审核情况，多输入100汉字'">${sheetLink.completeResult}</textarea>
			</td>
		</tr>
 ...
 <%}%>
			...
			<td>
				<input type="text"  class="text" name="acceptanceCondition" id="acceptanceCondition"  alt="allowBlank:false,maxLength:1000,vtext:'请填入 验收情况 信息，最多输入 1000 字符'" value="${sheetLink.acceptanceCondition}"/>
			</td>
		</tr>
 ...
 <%}%>
			...
			<td>
				<textarea class="textarea max" name="acceptanceResult" id="acceptanceResult" alt="allowBlank:false,maxLength:2000,vtext:'请输入审核情况，多输入100汉字'">${sheetLink.acceptanceResult}</textarea>
			</td>
		</tr>
 ...
 <%}%> 
			...
			<td>
				<input type="text"  class="text" name="completionResult" id="completionResult"  alt="allowBlank:false,maxLength:1000,vtext:'请填入 开通结果 信息，最多输入 1000 字符'" value="${sheetLink.completionResult}"/>
			</td>
		</tr>
 ...
 <%}%>
			...
			<td>
				<input type="text"  class="text" name="replyResult" id="replyResult"  alt="allowBlank:false,maxLength:1000,vtext:'请填入 回复结果 信息，最多输入 1000 字符'" value="${sheetLink.replyResult}"/>
			</td>
		</tr>
			   ...
			   <tr>
			     ...
			     <td colspan="3">				
					     <eoms:attachment name="sheetLink" property="nodeAccessories" 
              				scope="request" idField="nodeAccessories" appCode="transprovincial" alt="allowBlank:false" />		   
			     </td>
		</tr>
 			   		...
 			   		<% if(operateType.equals("103")){ %>
 			   			<fieldset>
							  ...
							  <div class="x-form-item" >
									...
									<eoms:chooser id="ProjectDesign0"  type="role" roleId="2023" flowId="994" config="{returnJSON:true,showLeader:true}"  
									   category="[{id:'dealPerformer',text:'派发',limit:'none',allowBlank:false,vtext:'请选择派发对象'},{id:'copyPerformer',childType:'user,subrole',limit:'none',text:'抄送'}]" 
									  data="${sendUserAndRoles}" />
 				...
 				<% } if(taskName.equals("SubmitExamine")){ %>
 			   		...
 			   		<% if(operateType.equals("104")){ %>
 			   			<fieldset>
							  ...
							  <div class="x-form-item" >
									<eoms:chooser id="SubmitExamine0"  type="role" roleId="2021" flowId="994" config="{returnJSON:true,showLeader:true}"  
									   category="[{id:'dealPerformer',text:'派发',limit:'none',allowBlank:false,vtext:'请选择派发对象'},{id:'copyPerformer',childType:'user,subrole',limit:'none',text:'抄送'}]" 
									  data="${sendUserAndRoles}" />							  					   
							    </div>
  						</fieldset>
