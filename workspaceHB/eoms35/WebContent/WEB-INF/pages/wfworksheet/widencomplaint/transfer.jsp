    ...
    <html:form action="/widencomplaint.do?method=performTransferWorkItem" styleId="theform">
            ...
            <div class="x-form-item">
                <c:choose>
                    <c:when test="${taskName=='ExcuteHumTask'}">
                        <eoms:chooser id="sendObject" type="role" roleId="1742" flowId="58"
        ...
        <div class="form-btns">
            ...
            <input type="submit" class="submit"
                   onclick="v.passing=true;this.form.action='${app}/sheet/widencomplaint/widencomplaint.do?method=performSaveInfo'"
