...
<fmt:bundle basename="config/statistic/commonstat-config/ApplicationResources-statistic-commonstat">
	<display:table name="estList" cellspacing="0" cellpadding="0"
		...
		decorator="com.boco.eoms.commons.statistic.securityevaluate.util.SecurityevaluateStatListDisplayHelper">
	...
	<display:column headerClass="sortable" titleKey="list.no"
	 ...
	 <display:column property="sheetid" sortable="true"
		headerClass="sortable" titleKey="list.sheetid" href="${app}/sheet/securityevaluate/securityevaluate.do?method=showDetailPage" paramId="sheetKey" paramProperty="mainid"/>
