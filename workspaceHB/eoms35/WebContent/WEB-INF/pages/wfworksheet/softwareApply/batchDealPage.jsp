            ...
            <div id="sheetinfo">
                <logic:present name="sheetMain" scope="request">
                    ...
                    <table class="formTable">
                        ...
                        <tr>
                            <td class="label"><bean:message bundle="softwareApply"
                                                            key="softwareApply.mainTaskDescription"/></td>
                ...
                <tr>
                    ...
                    <td class="content">
                        <select id="dealSelector" onchange="checkValue(this)" alt="allowBlank:false,vtext:'请选择处理操作'">
                            <option value=""></option>
                            <option value="Receive"><bean:message bundle="softwareApply"
                                                                  key="softwareApply.dealrejectpass"/></option>
                            <option value="ExcuteHumTask"><bean:message bundle="softwareApply"
                                                                        key="softwareApply.nopassback"/></option>
                        </select>
                    </td>
                    <td class="label"></td>
                    <td class="content">
