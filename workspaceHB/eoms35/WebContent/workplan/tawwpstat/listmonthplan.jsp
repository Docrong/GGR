...
<form name="monthplan">
    ...
    <table width="750" class="listTable" id="list-table">
        ...
        %>
        <tr>
            <td width="250"><%=tawwpMonthPlanVO.getName()%>
            </td>
            <td width="100"><%=tawwpMonthPlanVO.getNetName()%>
            </td>
            <td width="100"><%=tawwpMonthPlanVO.getDeptName()%>
            </td>
            <td width="50"><%=tawwpMonthPlanVO.getYearFlag()%>
            </td>
            <td width="50"><%=tawwpMonthPlanVO.getMonthFlag()%>
            </td>
            <td width="75"><%=tawwpMonthPlanVO.getConstituteStateName()%>
            </td>
            <td width="75"><%=tawwpMonthPlanVO.getExecuteStateName()%>
            </td>
            <td width="50">
                <%
    ...
    <br/>
    <input type="button" value="<bean:message key="listmonthplan.title.btnBack" />" onclick="javascript:goBack();"
           class="button">
</form>
