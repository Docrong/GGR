...
<style type='text/css'>
    ...
    .gr_list_l {
        background: url(${app}/images/title_left_bg.png) no-repeat;
        width: 150px;
        color: #fff;
        font-size: 14px;
        text-align: center;
    ...
    .gr_list_r {
        background: url(${app}/images/title_right_bg.png) no-repeat;
        width: 10px;
    }

    .gr_list_c {
        background: url(${app}/images/title_m_bg.png) repeat-x;
    }
</style>
