	...
	<SPAN class="EOMSListbox" id=listboxRoot onchange="jscript: fnEOMSListboxOnChange('listboxRoot');" style="margin:5px;">
      <TABLE cellSpacing=0 cellPadding=0>
        ...
        <TR class=EOMSListboxItem id="tr_parentid_1">
		  ...
		  <IMG id="img_parentid_1" name="img_parentid_1" src="images/false.gif" onclick="load('',1)" style="cursor:hand"></TD>
...
<%	for(int b=0;b<arrSort.length;b++){ %>
	<tr><td>
	<SPAN class="EOMSListbox" id="listboxSort<%=b+1%>" style=" WIDTH: 100%; HEIGHT: expression( (document.body.offsetHeight - 95 - <%=arrSort.length%> * 3) / <%=arrSort.length%>)" onchange="fnEOMSListboxOnChange('listboxSort<%=b+1%>');">
      <TABLE cellSpacing=0 cellPadding=0>
