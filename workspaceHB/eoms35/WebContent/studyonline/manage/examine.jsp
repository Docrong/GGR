...
<html:html>
    ...
    <html:form action="examine.do">
        ...
        <table cellpadding="0" cellspacing="0" width="95%" border="0">
            <tr>
                ...
                <td align="center" class="table_title" width="30%">
                    考试时间:<%=Config.getStartTime().toString().substring(11, 19)%>
                    --<%=Config.getEndTime().toString().substring(11, 19)%>
                </td>
            </tr>
            <tr align="right">
        ...
        <div id="divTable"
             style="position: relative; align: center; top: 5px;width:  100%; height:  85%; z-index: 1; overflow: auto; overflow-x: hidden">
            <table cellpadding="1" cellspacing="1" width="95%" border="0" class="table_show">
                <logic:iterate id="SubjectObj" name="OnlineWarehouse"
                               type="com.boco.eoms.studyonline.model.OnlineWarehouse">
                    <%
                    ...
                    <tr align="center" class="tr_show">
                        <td width="12%" bgcolor="#BEDEF8">                                       <!--标记-->
                            标记此题
                            <input name="<%=SubjectObj.getSubId() + subnum%>" type="checkbox"
                                   alt="tag" <%if(tagsSess.indexOf("("+subnum+")") != -1) out.println("checked");%>>
                        </td>
                        <td width="88%" align="left" bgcolor="#BEDEF8">
                            ...
                            <logic:notEmpty name="SubjectObj" property="image"> <!--图片-->
                                <img src="<%=request.getContextPath()%>/images/bottom/an_xs.gif" border="0"
                                     onclick="view('<%=SubjectObj.getImage()%>')">
                            </logic:notEmpty>
                        </td>
                    </tr>
                    ...
                    <tr align="center" class="tr_show">
                        <td width="12%">
                            <input name="<%=checkName%>"
                                   type="checkbox"  <%if( hadSel.indexOf( checkName ) != -1 ) out.print("checked");%>>
                        </td>
