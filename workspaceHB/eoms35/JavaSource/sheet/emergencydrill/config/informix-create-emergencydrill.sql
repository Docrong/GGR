...
create table emergencydrill_main(
    ...
    mainCompleteTime           DATETIME YEAR TO SECOND DEFAULT 0(32),
...
insert into taw_system_application(app_name,notes,domain_type) values('应�?�预案演练流�?','应�?�预案演练流�?',1);
insert into taw_system_workflow(name,flowid,sheetid,remark,mainservicebeanid) values('EmergencyDrillProcess','061','01','应�?�预案演练流�?','iEmergencyDrillMainManager');
