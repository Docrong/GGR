		...
		throws IOException, ServletException
	{
		...
		if (sessionToken == null)
		{
			...
			if (checkURL && token != null && !token.equals(""))
			{
				...
				if (onLineUser.equals("UNAUTHORIZED_IP_ACCESS") || onLineUser.equals("USER_UNLOGIN") || onLineUser.equals("SYS_ERROR") || onLineUser.equals("SYS_ERROR_DB") || onLineUser.equals("SYS_ERROR_NO_PARAMETER"))
				{
