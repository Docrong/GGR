...
public class ZipEntry implements ZipConstants, Cloneable {
     ...
     * @throws IllegalArgumentException if the specified size is less than 0 or greater than
     *                                  0xFFFFFFFF bytes
     * @see #getSize()
     */
     ...
     * @throws IllegalArgumentException if the length of the specified comment string is greater
     *                                  than 0xFFFF bytes
     * @see #getComment()
     */
