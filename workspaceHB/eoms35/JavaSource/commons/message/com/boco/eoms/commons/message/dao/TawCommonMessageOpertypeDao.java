...
public interface TawCommonMessageOpertypeDao extends Dao {
    ...
    /**
     * Gets tawCommonMessageOpertype's information based on primary key. An
     * ObjectRetrievalFailureException Runtime Exception is thrown if nothing is
     * found.
     *
     * @param id the tawCommonMessageOpertype's id
     ...
     *
     * @param tawCommonMessageOpertype the object to be saved
     */
