...
<table class="formTable">
    ...
    <c:choose>
        ...
        <c:otherwise>
            ...
            <tr id="importInforList" style="display:true">
                ...
                <td colspan="4">
                    <iframe src="branchindexreduction.do?method=search&ifShowOtherok=yesok&ifShowOther=yes&refSheetId=${sheetMain.mainReserveA}"
    ...
    <c:if test="${sheetMain.mainSubtractIndexName == '101410302' }">
        ...
        <tr>
            ...
            <td colspan="3"><input type="button" class="btn" onclick="exportListAll();"
                                   value="导出申请核减的工单列表"/><eoms:attachmentWw scope="request"
                                                                           idField="sheetAccessories1" name="sheetMain"
                                                                           property="" appCode="branchindexreduction"
                                                                           sheetFlag="check"
