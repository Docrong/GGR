...
<table class="formTable">
    ...
    <c:if test="${status!=1}">
        ...
        <tr>
            ...
            <td colspan="3" class="content">
                <textarea class="textarea max" name="${sheetPageName}mainSecurityDealRequire"
                          id="${sheetPageName}mainSecurityDealRequire"
                          alt="allowBlank:false,maxLength:500,vtext:'请输入安全处理要求，最大长度为250个汉字！'">${sheetMain.mainSecurityDealRequire}</textarea>
            </td>
        </tr>
        <tr>
            <td class="label">
        ...
        <tr>
            ...
            <td class="content" colspan="3">
                <eoms:attachment name="sheetMain" property="sheetAccessories"
                                 scope="request" idField="${sheetPageName}sheetAccessories" appCode="securitydeal"
                                 alt="allowBlank:true"/>
            </td>
        </tr>
    </c:if>
