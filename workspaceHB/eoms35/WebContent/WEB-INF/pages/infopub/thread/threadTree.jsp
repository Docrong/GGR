        ...
        ctxMenu: [
            {
                ...
                text: '${eoms:a2u('信息发布')}',
                cls: 'new-mi',
                url: '<html:rewrite page='/thread.do?method=edit&forumsId='/>'
            },
            {
                id: 'ListThreads',
                text: '${eoms:a2u('信息列表')}',
                cls: 'new-mi',
                url: '<html:rewrite page='/thread.do?method=list&forumsId='/>'
            },
            {
                id: 'ListUnreadThreads',
                text: '${eoms:a2u('未读信息')}',
                cls: 'new-mi',
                url: '<html:rewrite page='/thread.do?method=listUnread&forumsId='/>'
            }
        ],//end of ctxMenu
        /************************
