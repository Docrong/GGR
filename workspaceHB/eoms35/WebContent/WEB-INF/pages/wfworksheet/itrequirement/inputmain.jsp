...
<input type="hidden" name="${sheetPageName}linkClassName"
       value="com.boco.eoms.sheet.itrequirement.model.ITRequirementLink"/><br/>
<!-- sheet info -->
<table id=sheet class="formTable">
    <c:if test="${status!=1}">
        ...
        <tr>
            ...
            <td class="content">
                <eoms:comboBox name="${sheetPageName}mainNetSystem" id="${sheetPageName}mainNetSystem"
                               initDicId="1011404" alt="allowBlank:true" styleClass="select-class"
                               defaultValue="${sheetMain.mainNetSystem}"/>
            </td>
            ...
            <td class="content">
                <eoms:comboBox name="${sheetPageName}mainUrgentDegree" id="${sheetPageName}mainUrgentDegree"
                               ...
                               defaultValue="${sheetMain.mainUrgentDegree}"/>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="content"><input type="text" class="text" name="${sheetPageName}mainSheetID"
                                       id="${sheetPageName}mainSheetID" value="${sheetMain.mainSheetID}"
                                       alt="allowBlank:true"/></td>
            <td class="label"><bean:message bundle="itrequirement" key="itrequirement.mainBusinessTarget"/>*</td>
            <td class="content"><input type="text" class="text" name="${sheetPageName}mainBusinessTarget"
                                       id="${sheetPageName}mainBusinessTarget" value="${sheetMain.mainBusinessTarget}"
                                       alt="allowBlank:false,maxLength:50,vtext:'请填入业务目标，最多输入25字'"/></td>
        </tr>
            ...
            <td>
                ...
                <script type="text/javascript">
                    ...
                    deptetree = new xbox({
                        ...
                        saveChkFldId: '${sheetPageName}mainUser',
                        viewer: areaViewer
                    });
                </script>
                <input type="text" class="text" readonly="readonly" name="${sheetPageName}showDept"
                       ...
                       value="<eoms:id2nameDB id='${sheetMain.mainUser}' beanId='tawSystemUserDao'/>"/>
                <input type="hidden" name="${sheetPageName}mainUser" id="${sheetPageName}mainUser"
                       value="${sheetMain.mainUser}"/>
            </td>
        ...
        <tr>
            ...
            <td class="content" colspan="3">
                <textarea class="textarea max" name="${sheetPageName}mainRequirementDesc"
                          id="${sheetPageName}mainRequirementDesc"
                          alt="width:500,allowBlank:false,maxLength:255,vtext:'请填入需求概述，最多输入125字'">${sheetMain.mainRequirementDesc}</textarea>
            </td>
        </tr>
        <tr>
            <td class="label">
