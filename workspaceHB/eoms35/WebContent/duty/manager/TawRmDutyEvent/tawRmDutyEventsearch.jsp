...
<html:form action="/dutyevent.do?method=searchListShow"
    ...
    <table border=0 cellspacing="1" cellpadding="1" class="listTable">
        ...
        <tr>
            ...
            <td COLSPAN="10">
                <eoms:dict key="dict-duty" dictId="complateFlag" beanId="selectXML" isQuery="false"
        ...
        <tr>
            ...
            <td COLSPAN="10">
                <input type="text" name="endtime" size="20" onclick="popUpCalendar(this, this,null,null,null,true,-1);"
...
<html:form action="/dutyevent.do?method=saveSerch" method="post" styleId="tawRmdutyEventForm">
    ...
    <display:table name="TawRmDutyEventList" cellspacing="0" cellpadding="0" id="TawRmDutyEventList"
                   pagesize="${pageSize}" class="table TawRmDutyEventList"
                   requestURI="${app}/duty/dutyevent.do?method=search" sort="list"
                   partialList="true" size="resultSize"
                   decorator="com.boco.eoms.duty.displaytag.support.DutyEventDisplaytagDecorator">
        <display:column property="inputuser" sortable="true" headerClass="sortable" titleKey="tawRmDutyEvent.inputuser"
                        paramId="id" paramProperty="id" href="${app}/duty/dutyevent.do?method=getEvent"/>
        ...
        <display:column property="eventtitle" sortable="true" headerClass="sortable"
                        titleKey="tawRmDutyEvent.eventtitle"/>
        <display:column property="beginTime" sortable="true" headerClass="sortable"
                        titleKey="tawRmDutyEvent.beginTime"/>

        <display:column property="complateFlag" sortable="true" headerClass="sortable"
                        titleKey="tawRmDutyEvent.complateFlag"/>
        <display:column property="pubstatus" sortable="true" headerClass="sortable" title="发布状态"/>
        <display:column sortable="true" headerClass="sortable"
                        url="/duty/dutyevent.do?method=getEvent" paramId="id" paramProperty="id"
                        titleKey="tawRmDutyEvent.read"><bean:message key="tawRmDutyEvent.look"/></display:column>
