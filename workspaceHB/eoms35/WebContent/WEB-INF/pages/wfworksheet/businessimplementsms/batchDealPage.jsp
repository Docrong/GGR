...
<div id="sheetform">
<html:form action="/businessimplementsms.do?method=performBatchDeal" styleId="theform">
  ...
  <div id="sheetinfo">
	...
	<table class="formTable"> 
	  <caption></caption>
	               ...
	               <tr>
		           		<td class="label"><bean:message bundle="businessimplementsms" key="businessimplementsms.mainNetSort1"/></td>
		            	<td class="content">  
		            		<eoms:id2nameDB id="${sheetMain.mainNetSort1}" beanId="ItawSystemDictTypeDao"/>
			        	</td>	   
		            	<td class="label"><bean:message bundle="businessimplementsms" key="businessimplementsms.mainNetSort2"/></td>
		                <td class="content">  
	                ...
	                <tr>
		                <td class="label"><bean:message bundle="businessimplementsms" key="businessimplementsms.mainNetSort3"/></td>
		                <td class="content">  
		                	<eoms:id2nameDB id="${sheetMain.mainNetSort3}" beanId="ItawSystemDictTypeDao"/>
			        	</td>	 
		                <td  class="label"><bean:message bundle="businessimplementsms" key="businessimplementsms.mainTaskType"/></td>
		                <td class="content">  
			      ...
			      <tr>
		            <td class="label"><bean:message bundle="businessimplementsms" key="businessimplementsms.mainTaskDescription"/></td>
				...
				<tr>
				    ...
				    <eoms:attachment name="sheetMain" property="sheetAccessories" 
				            scope="request" idField="sheetAccessories" appCode="businessimplementsms" 
				             viewFlag="Y"/> 
				    </td>
				</tr>
	</table>
	               ...
	               <tr>
		            	...
		            	<td class="content">  
		            		<select id="dealSelector" onchange="checkValue(this)" alt="allowBlank:false,vtext:'请选择处理操作'">
		            			 <option value=""></option>
		            			 <option value="Receive"><bean:message bundle="businessimplementsms" key="businessimplementsms.dealrejectpass"/></option>
			 					 <option value="ExcuteHumTask"><bean:message bundle="businessimplementsms" key="businessimplementsms.nopassback"/></option>
			 				</select> 
			        	</td>	   
		            	<td class="label"></td>
		                <td class="content">
		                	 ...
		                	 <input type="hidden" name="beanId" value="iBusinessImplementSmsMainManager"/> 
					         <input type="hidden" name="mainClassName" value="com.boco.eoms.sheet.businessimplementsms.model.BusinessImplementSmsMain"/>	
					         <input type="hidden" name="linkClassName" value="com.boco.eoms.sheet.businessimplementsms.model.BusinessImplementSmsLink"/>
					         <input type="hidden" name="methodBeanId"  id="methodBeanId" value="${methodBeanId}"/>
					         <input type="hidden" name="piid" value="${piid}"/>  
			        	</td>			        	             
		           </tr>
	               <tr>
			            <td  class="label"><bean:message bundle="businessimplementsms" key="businessimplementsms.advice"/>*</td>
			              <td colspan="3"> 	
