...
------------------------------VIEW----------------------------------------
select *
from v_netchange select distinct *
from v_netchange
...
values (45, to_date('2007-07-07 00:00:00', 'YYYY-MM-DD HH24:MI:SS'), '�����ۺϵ�������������ɼ�����һ�β�����ʱ��');
...
from commonfault_link delete from est_netchange;
select *
from est_netchange;
