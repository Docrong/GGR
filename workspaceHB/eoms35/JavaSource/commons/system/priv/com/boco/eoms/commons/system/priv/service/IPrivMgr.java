...
public interface IPrivMgr {
     ...
     *
     * @param 权限实例 TawSystemPrivAssign
     * @return 保存成功
     * @since 0.1
     */
     ...
     * @param userId                                                                                                       用户id
     * @param deptId                                                                                                       部门id
     * @param roleIds                                                                                                      角色id（可能多个）
     * @param 查询菜单类型,PrivConstants.LIST_OPERATION_TYPE_ALL,PrivConstants,PrivConstants.LIST_OPERATION_TYPE_MOUDLE_FUNCTION
     * @return 获取合并后的最上层菜单
     ...
     * 取某角色、人员、部门菜单方案
     *
     * @param orgId   组织结构id，部门id,角色id，用户id,若为角色id，请使用逗号分隔多个角色id，如：1234,2345,3456
     * @param orgType StaticVariable.PRIV_ASSIGNTYPE_ROLE,
     ...
     * 判断某组织结构是否已分配菜单方案
     *
     * @param orgId   组织结构id，部门id,角色id，用户id；注：角色id以逗号相隔
     * @param orgType StaticVariable.PRIV_ASSIGNTYPE_ROLE,
     *                StaticVariable.PRIV_ASSIGNTYPE_DEPT,
     *                StaticVariable.PRIV_ASSIGNTYPE_USER
     * @param menuId  菜单方案id
     ...
     * @param roleIds    角色列表
     * @param menuId     菜单id
     * @param type       查询菜单类型,PrivConstants.LIST_OPERATION_TYPE_ALL,PrivConstants,PrivConstants.LIST_OPERATION_TYPE_MOUDLE_FUNCTION
