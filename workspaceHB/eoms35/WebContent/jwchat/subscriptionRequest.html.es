...
<html>
    <head>
        <title>JWChat - Petición de subscripción</title>
        <meta http-equiv="content-type" content="text/html; charset=utf-8">
          ...
          function init() {
            ...
            document.title = "Petición de subscripción de "+jid;
          
            var from = "<b><span class=\"link\" onClick=\"return srcW.openUserInfo('"+jid+"');\" title=\""+"mostrar informaci&oacute;n del usuario "+jid+"\">"+jid.substring(0,jid.indexOf('@'))+"</a></b> ";
    ...
    <body style="margin:8px;">
        ...
        <tr>
            <td>
                <span id="requestingUser"></span>
                quiero a&ntilde;adirte a su lista de contactos:
            </td>
        </tr>
        <tr height="100%">
        ...
        <form name="sub">
            ...
            <tr>
                <td align="right">
                    <button onClick="return sendUnsub();">Denegar</button>
                    &nbsp;
                    <button onClick="return sendSub();" tabindex=1
                    >Permitir
                </button>
            </td>
        </tr>
