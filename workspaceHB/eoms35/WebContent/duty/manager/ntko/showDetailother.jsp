...
<FORM id="myForm" METHOD="POST" ENCTYPE="multipart/form-data"
      ACTION="uploadDetail.jsp?filePath=<%=TawwpStaticVariable.wwwDir+request.getParameter("path")%>">
    <input type="hidden" name="id" value="">
    <input type="hidden" name="filePath" value="">
    <TABLE BORDER=0 width=600>
        <tr>
            <td align="left"><input TYPE=hidden id="filename" name="filename" MAXLENGTH=50 size=50
                ...
                <font color="red">${eoms:a2u("如果需要保存你填写的内容，请点击保存按钮")} </font>
            </td>
        </tr>
    </TABLE>
</form>
...
<object id="TANGER_OCX" classid="clsid:C9BC4DFF-4248-4a3c-8A49-63A7D317F404"
        codebase="OfficeControl.ocx#version=3,0,0,7" width="100%" height="100%">
