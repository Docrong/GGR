...
<table border="0" width="95%" cellspacing="1" cellpadding="1" class="table_show" align=center>
    <tr>
        <td colspan="9">
            <div align="center">值班未按时归档工单</div>
        </td>
    </tr>
    <tr>
        ...
        <td align="right" bgcolor="#aec2e8" colspan="9">
            ...
            <SELECT name="jumpPage" onchange="location.href=this.options[this.selectedIndex].value" size="1">
                <% for (int l = 1; l <= intPageCount; l++) {
                    if (l != intPage) {
                %>
                <OPTION value="checklist.do?page=<%=l%>&dutyId=<%=dutyId%>"><%=l%>
                </OPTION>
    ...
    <tr class="tr_show">
        <td width="29%" class="clsfth">
            <div align="center">工单号</div>
        </td>
        <td width="28%" class="clsfth">
            <div align="center">工单主题</div>
        </td>
        <td width="19%" class="clsfth">
            <div align="center">值班班长</div>
        </td>
        <td width="24%" class="clsfth">
            <div align="center">值班日期</div>
        </td>
    ...
    <tr class="tr_show">
        ...
        <td>
            <div align="center"><a
                    href="/EOMS_J2EE/newworksheet<%=new String(obj.get(5).toString().getBytes("819"),"gb2312")%><%=new String(obj.get(0).toString().getBytes("819"),"gb2312")%>"><%=new String(obj.get(1).toString().getBytes("819"), "gb2312")%>
            </a></div>
        </td>
        ...
        <td>
            <div align="center"><%=new String(obj.get(3).toString().getBytes("819"), "gb2312")%>
            </div>
        </td>


        <td>
            <div align="center"><%=new String(obj.get(4).toString().getBytes("819"), "gb2312")%>
            </div>
        </td>
    ...
    %>
    <tr bgcolor="#EEECED">
        <td colspan="4" bgcolor="#aec2e8">
            <div align="center"><a
                    href="checkdetail.do?starttime=<%=starttime%>&endtime=<%=endtime%>&roomId=<%=roomId%>">返回上页</a>
            </div>
        </td>
    </tr>
    <tr bgcolor="#EEECED">
