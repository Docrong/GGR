...
<form name="tawwpitemadd" method="post"
      action="../tawwpmodel/itemsave.do?modelplanid=<%=request.getParameter("modelplanid")%>"
    ...
    <table class="formTable">
        ...
        <tr>
            ...
            <td width="400">
                <eoms:dict key="dict-workplan" dictId="cycle" isQuery="false" defaultId="1" onchange="filter(this);"
