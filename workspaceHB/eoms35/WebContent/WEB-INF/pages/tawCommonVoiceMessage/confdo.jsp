        ...
        <table cellpadding="0" class="table logList" cellspacing="0">
            ...
            <logic:iterate id="tawHieApply" name="TAWCONF" type="com.boco.eoms.commons.voiceMessage.model.TawConfInfo">
                <tr class="tr_show">
                    ...
                    <td width="7%" height="25"><bean:write name="tawHieApply" property="confOrganizer"
                                                           scope="page"/></td>
                    <td width="15%" height="25"><bean:write name="tawHieApply" property="confBeginTime"
                                                            scope="page"/></td>
                    <td width="15%" height="25"><bean:write name="tawHieApply" property="confEndTime"
                                                            scope="page"/></td>
                    ...
                    <td width="5%" height="25"><html:link page="/TawHieApply/listconmem.do" paramId="confNo"
                                                          paramName="tawHieApply" paramProperty="confNo"><img
                            src="<%=request.getContextPath()%>/images/icons/role.gif" border="0"></html:link></td>
                </tr>
            </logic:iterate>
