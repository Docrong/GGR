       ...
       <%if(taskName.equals("MiddleReportAffirmHumTask") || 
		...
		<%if(operateType.equals("913") || operateType.equals("923") || operateType.equals("933")){ %>
			...
			<%if(taskName.equals("MiddleReportAffirmHumTask")){%>
				...
				<input type="hidden" name="${sheetPageName}mainReportLimit" id="${sheetPageName}mainReportLimit" value="<%=mainReportLimit%>" />
			<%} %>
     ...
     <%if(taskName.equals("SolveFaultHumTask")||taskName.equals("subTask3")) {%>
     	...
     	<%if(operateType.equals("93")){%>
			...
			<tr>
			  <td class="label"><bean:message bundle="urgentfault" key="urgentfault.mainIfGreatFault"/></td>
			  <td colspan="3">
			  	<eoms:comboBox name="${sheetPageName}linkIfGreatFault" id="${sheetPageName}linkIfGreatFault" initDicId="10301"  defaultValue="${sheetLink.linkIfGreatFault}"/>
			  </td>
			...
			<tr>
			  ...
			  <td>
			  	<eoms:comboBox name="${sheetPageName}linkFaultReason" id="${sheetPageName}linkFaultReason" 
			  	    initDicId="1010303" sub=""  defaultValue="${sheetLink.linkFaultReason}" alt="allowBlank:true"/>
			  </td>
			...
			<tr>
			  ...
			  <td>
			    <input type="text" class="text" name="${sheetPageName}linkFaultAvoidTime" readonly="readonly" 
					...
					onclick="popUpCalendar(this, this,null,null,null,true,-1)" value="${eoms:date2String(sheetLink.linkFaultAvoidTime)}"/> 	
			  </td>
