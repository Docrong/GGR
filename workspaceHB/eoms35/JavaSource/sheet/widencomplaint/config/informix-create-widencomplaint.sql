...
values ('xls,txt,doc,jpg,gif', 'widencomplaint', '加宽投诉处理工单流程', 1024, '/sheet/widencomplaint', 106, '40287d82529c186f01529c186fe00011');
...
values ('40287d82529c186f01529c186fe00012', '5601', '1', '新增工单', '56', null, '/sheet/widencomplaint/widencomplaint.do?method=showNewSheetPage', '0', '0', 1);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d82529c186f01529c186fe00013', '5603', '0', '待处理工单', '56', null, null, '0', '0', 3);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d82529c186f01529c186fe00014', '560301', '1', '待办工单', '5603', null, '/sheet/widencomplaint/widencomplaint.do?method=showListsendundo', '0', '0', 1);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d82529c186f01529c186fe00015', '5607', '1', '工单查询', '56', null, '/sheet/widencomplaint/widencomplaint.do?method=showQueryPage', '0', '0', 7);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d82529c186f01529c186fe00016', '5608', '1', '工单处理模板', '56', null, '/sheet/widencomplaint/widencomplaint.do?method=getDealTemplatesByUserId&type=templateManage', '0', '0', 8);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d82529c186f01529c186fe00017', '5609', '1', '工单模板管理', '56', null, '/sheet/widencomplaint/widencomplaint.do?method=getTemplatesByUserId&type=templateManage', '0', '0', 9);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d82529c186f01529c186fe00018', '5610', '1', '管理者工单', '56', null, '/sheet/widencomplaint/widencomplaint.do?method=showListForAdmin', '0', '0', 10);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d82529c186f01529c186fe00019', '56', '0', '加宽投诉处理工单流程', '10', null, '/sheet/widencomplaint/widencomplaint.do?method=showDrawing', '0', '0', 20);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d82529c186f01529c186fe0001a', '5602', '1', '草稿列表', '56', null, '/sheet/widencomplaint/widencomplaint.do?method=showDraftList', '0', '0', 2);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d82529c186f01529c186fe0001b', '5604', '0', '已处理工单', '56', null, null, '0', '0', 4);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d82529c186f01529c186fe0001c','560402','1','建立工单','5604', null, '/sheet/widencomplaint/widencomplaint.do?method=showOwnStarterList','0','0',2);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d82529c186f01529c186fe0001d', '560401', '1', '处理工单', '5604', null, '/sheet/widencomplaint/widencomplaint.do?method=showListsenddone', '0', '0', 1);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d82529c186f01529c186fe0001e', '5605', '1', '已归档工单', '56', null, '/sheet/widencomplaint/widencomplaint.do?method=showHoldedList', '0', '0', 5);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d82529c186f01529c186fe0001f', '5606', '1', '已作废工单', '56', null, '/sheet/widencomplaint/widencomplaint.do?method=showCancelList', '0', '0', 6);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d82529c186f01529c186fe00020', '5611', '1', '超时时间设置', '56', null, '/sheet/overtimetip/overtimetip.do?flowName=WidenComplaint', '0', '0', 11);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d82529c186f01529c186fe00021', '5612', '1', '工单处理时限配置', '56', null, '/sheet/newSheetLimit/sheetLimit.do?method=getLevelLimitList&flowName=WidenComplaint', '0', '0', 30);