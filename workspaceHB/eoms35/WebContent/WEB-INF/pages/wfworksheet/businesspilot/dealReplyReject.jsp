...
<div id="sheetform">
<html:form action="/businesspilot.do?method=performDealReplyReject" styleId="theform">
 <%@ include file="/common/taglibs.jsp"%>
<%
 ...
 %>
	...
	<input type="hidden" name="${sheetPageName}mainClassName" value="com.boco.eoms.sheet.businesspilot.model.BusinessPilotMain"/>	
	<input type="hidden" name="${sheetPageName}linkClassName" value="com.boco.eoms.sheet.businesspilot.model.BusinessPilotLink"/>
    <input type="hidden" name="${sheetPageName}taskNamespace" value="http://BusinessPilotProcess"/>  
<%@ include file="/WEB-INF/pages/wfworksheet/businesspilot/baseinputlinkhtmlnew.jsp"%>
     ...
     <tr>
      ...
      <logic:iterate id="toTask" name="acceptList" type="com.boco.eoms.sheet.businesspilot.task.impl.BusinessPilotTask">  
        <tr>
          <td>
