    ...
    <table border="0" width="60%" cellspacing="1" bgcolor="#709ED5" align=center>
        <tr>
            ...
            <td width="70%" height="25" bgcolor="#E5EDF8">
                <% for (int i = 0; i < 4; i++) {
                    if (i < 3) {%>
                <input type="text" name="beginip<%=i%>" <%=readflag%> value='<%=beginiptmp[i]%>' size="5" maxlength="3"
                       onkeyup="checknum(this)"><b>.</b>
                <%} else {%>
                <input type="text" name="beginip<%=i%>" <%=readflag%> value='<%=beginiptmp[i]%>' size="5" maxlength="3"
        ...
        <tr>
            ...
            <td width="70%" height="25" bgcolor="#E5EDF8">
                <% for (int i = 0; i < 4; i++) {
                    if (i < 3) {%>
                <input type="text" name="endip<%=i%>" <%=readflag%> value='<%=endiptmp[i]%>' size="5" maxlength="3"
                       onkeyup="checknum(this)"><b>.</b>
                <%} else {%>
                <input type="text" name="endip<%=i%>"  <%=readflag%> value='<%=endiptmp[i]%>' size="5" maxlength="3"
                       onkeyup="checknum(this)">
        ...
        <tr>
            ...
            <td width="70%" height="25" bgcolor="#E5EDF8">
                ...
                <input type="text" name="mask<%=i%>"  <%=readflag%> value='<%=masktmp[i]%>' size="5" maxlength="3"
                       onkeyup="checknum(this)"><b>.</b>
                <%} else {%>
                <input type="text" name="mask<%=i%>" <%=readflag%> value='<%=masktmp[i]%>' size="5" maxlength="3"
                       onkeyup="checknum(this)">
