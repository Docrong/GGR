            ...
            <tr class="tr_show">
                ...
                <td width="70%" height="25" colspan="2">
                    <input type="text" size="35"
                           value="<bean:write name="storage" property="storagename" scope="request"/>" maxlength="50"
                           name="storagename">
            ...
            <tr class="tr_show">
                ...
                <td width="70%" height="25" colspan="2">
                    <input type="text" name="note" size="35"
                           value="<bean:write name="storage" property="note" scope="request"/>" maxlength="255">
                </td>
            </tr>
        </table>
        <table border="0" width="75%" cellspacing="0">
            <tr class="tr_show">
                ...
                <td width="70%" height="25" colspan="2">
	                ...
	                %>
                        <option value=<%=tawDept.getDeptId()%> selected><%=tawDept.getDeptName()%>
                        </option>
                            <%
	                		} else {
	                %>
                        <option value= <%=tawDept.getDeptId()%>><%=tawDept.getDeptName()%>
                        </option>
                            <%
	                		}
	                	}
