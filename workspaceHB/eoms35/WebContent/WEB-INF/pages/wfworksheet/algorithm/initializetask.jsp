...
<html:form action="/algorithm.do?method=newTaskPerformAdd" styleId="theform" target="myname">
    ...
    <table class="formTable">
        <tr>
            <td class="label"><bean:message bundle="algorithm" key="algorithm.linkUrgency"/>*</td>
        ...
        <tr>
            <td class="label"><bean:message bundle="algorithm" key="algorithm.linkReqCompleteTime"/>*</td>
            <td class="content">
            ...
            <td class="label"><bean:message bundle="algorithm" key="algorithm.linkAcceptDept"/>*</td>
            <td class="content">
        ...
        <tr>
            <td class="label"><bean:message bundle="algorithm" key="algorithm.linkSendSheetDesc"/>*</td>
            <td colspan="3">
