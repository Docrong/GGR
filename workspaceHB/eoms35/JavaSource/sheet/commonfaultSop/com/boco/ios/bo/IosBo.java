...
public class IosBo extends Thread {
    ...
    public IosBo(long neid, AtomicInteger okint, AtomicInteger errorint,
                 List report, AtomicInteger cmdCount, String[] cmdarrs) {
        this.neid = neid;
        this.okint = okint;
        this.errorint = errorint;
        this.report = report;
        this.cmdCount = cmdCount;
        this.cmdarrs = cmdarrs;
    }
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < nelist.size(); i++) {
            ...
            for (int j = 0; j < count; j++) {
                list.add(new IosBo(neid.longValue(), okint, errorint, report, cmdCount, new String[]{"Allip;", "6000", ""}));
            }
        }

        for (int i = 0; i < list.size(); i++) {
            IosBo t = (IosBo) list.get(i);
            t.start();
        }
