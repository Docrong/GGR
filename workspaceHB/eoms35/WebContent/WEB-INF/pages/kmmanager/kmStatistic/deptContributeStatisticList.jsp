...
<fmt:bundle basename="com/boco/eoms/km/config/applicationResource-kmmanager">
    ...
    <display:table name="deptContributeStatisticList" cellspacing="0" cellpadding="0"
        ...
        <display:column property="addCount" sortable="true"
                        headerClass="sortable" titleKey="deptContributeStatistic.addCount" paramId="id"
                        paramProperty="id"/>

        <display:column property="auditOkPercentage" sortable="true"
                        headerClass="sortable" titleKey="deptContributeStatistic.auditOkPercentage" paramId="id"
                        paramProperty="id"/>

        <display:column property="utilizationRate" sortable="true"
                        headerClass="sortable" titleKey="deptContributeStatistic.utilizationRate" paramId="id"
                        paramProperty="id"/>

        <display:column property="useCount" sortable="true"
                        headerClass="sortable" titleKey="deptContributeStatistic.useCount" paramId="id"
                        paramProperty="id"/>

        <display:column property="upCount" sortable="true"
                        headerClass="sortable" titleKey="deptContributeStatistic.upCount" paramId="id"
                        paramProperty="id"/>
