...
<logic:present name="HISTORY" scope="request">  
      ...
      <logic:iterate id="baselink" name="HISTORY" type="com.boco.eoms.sheet.focusresourceerrata.model.FocusResourceErrataLink" >     
       <%         
        jNum += 1;       
      ...
      <div class="history-item">&nbsp;   
	      ...
	      <div class="history-item-title">
			 ...
			 <bean:write name="baselink" property="operateTime" formatKey="date.formatDateTimeAll" bundle="sheet" scope="page"/>&nbsp; 
	  	     ...
	  	     <eoms:dict key="dict-sheet-focusresourceerrata" dictId="activeTemplateId" itemId="${baselink.activeTemplateId}" beanId="id2descriptionXML" />
	  	     <bean:message bundle="focusresourceerrata" key="focusresourceerrata.operateType"/>:
	  	     <eoms:dict key="dict-sheet-focusresourceerrata" dictId="mainOperateType" itemId="${baselink.operateType}" beanId="id2descriptionXML" />
	 ...
	 <!-- 流程中的历史页面 -->
		  		...
		  		<%if(baselink.getActiveTemplateId()!=null && baselink.getActiveTemplateId().equals("MonitoringDepart")) {%>
		  				...
		  				<%if(baselink.getOperateType() != null && (baselink.getOperateType().intValue() == 101 || baselink.getOperateType().intValue() == 11)){ %>
							...
							<td class="content">
								...
								<pre>${baselink.linkCheckState}</pre>
	 						</td>
		  		...
		  		<%if(baselink.getActiveTemplateId()!=null && baselink.getActiveTemplateId().equals("TransmissionNet")) {%>
		  		...
		  		<%if(baselink.getActiveTemplateId()!=null && baselink.getActiveTemplateId().equals("CitieErrata")) {%>
...
<script type="text/javascript">
 ...
 function copy(id){
    ...
    Ext.Ajax.request({
		method:"get",
		url: "focusresourceerrata.do?method=getJsonLink&id="+id+"&beanName=FocusResourceErrata",
		success: function(x){
