...
<caption>角色定制列表</caption>
  ...
  <tr>
    ...
    <td align="center"><input type="button" name="modify" id="modify" value="修改" class="button" onclick="toModify('<%=userMade.getId()%>')">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <input type="button" name="delete" id="delete" value="删除" class="button" onclick="return deleteData('<%=userMade.getId()%>')">
    </td>
  </tr>
  <%} %>
</table><br>
