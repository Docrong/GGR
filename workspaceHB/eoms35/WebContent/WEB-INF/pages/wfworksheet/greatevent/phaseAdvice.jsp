...
<div id="sheetform">
<html:form action="/greatevent.do?method=performProcessEvent" styleId="theform">
 <%@ include file="/common/taglibs.jsp"%>
<%
 ...
 %>
    ...
    <input type="hidden" name="${sheetPageName}mainClassName" value="com.boco.eoms.sheet.greatevent.model.GreatEventMain"/>	<!--main\u8868Model\u5bf9\u8c61\u7c7b\u540d-->	
    <input type="hidden" name="${sheetPageName}linkClassName" value="com.boco.eoms.sheet.greatevent.model.GreatEventLink"/> <!--link\u8868Model\u5bf9\u8c61\u7c7b\u540d--> 
 	<input type="hidden" name="${sheetPageName}processTemplateName" id="${sheetPageName}processTemplateName" value="GreatEventProcess" />
...
<br/>
     <table  class="listTable">
      ...
      <logic:iterate id="toTask" name="toOperaterList" type="com.boco.eoms.sheet.greatevent.model.GreatEventTask">  
        <tr>
          <td>
	       ...
	       <td class="label">
			...
			<td colspan="3"> 
		           <textarea name="${sheetPageName}remark" class="textarea max" id="${sheetPageName}remark" 
		              alt="allowBlank:true,width:500,maxLength:255,vtext:'请填入意见，最多输入125个字符'">${sheetlink.remark}</textarea>
		  </td>
		</tr>
		</table>
