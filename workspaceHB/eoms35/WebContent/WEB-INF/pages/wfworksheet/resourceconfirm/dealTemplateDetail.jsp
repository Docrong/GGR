...
<html:form action="/resourceconfirm.do" styleId="theform">
 ...
 -->
        ...
        <c:if test="${sheetMain.mainspecialtyType==101220101}">
            <tr>
                <td class="label"><bean:message bundle="resourceconfirm" key="resourceconfirm.linkCapabilityAffirm"/>*
                </td>
                <td colspan="3">
        ...
        <c:if test="${sheetMain.mainspecialtyType==101220102}">
            <tr>
                ...
                <td class="label"><bean:message bundle="resourceconfirm" key="resourceconfirm.linkANetContactTel"/>*
                </td>
                <td class="content">
            ...
            <tr>
                <td class="label"><bean:message bundle="resourceconfirm"
                                                key="resourceconfirm.linkBusinessBandwidth"/>*
                </td>
                <td class="content">
                ...
                <td class="label"><bean:message bundle="resourceconfirm" key="resourceconfirm.linkBusinessNumber"/>*
                </td>
                <td class="content">
        ...
        <c:if test="${sheetMain.mainspecialtyType==101220101}">
            <tr>
                <td class="label"><bean:message bundle="resourceconfirm"
                                                key="resourceconfirm.linkCapabilityAffirmN"/>*
                </td>
                <td class="content" colspan="3">
                    <eoms:comboBox name="${sheetPageName}linkCapabilityAffirm" id="${sheetPageName}linkCapabilityAffirm"
            ...
            <tr>
                <td class="label"><bean:message bundle="resourceconfirm" key="resourceconfirm.linkAccessPointName"/>*
                </td>
                <td class="content">
                ...
                <td class="label"><bean:message bundle="resourceconfirm" key="resourceconfirm.linkAccessPDistance"/>*
                </td>
                <td class="content">
        ...
        <c:if test="${sheetMain.mainspecialtyType==101220102}">
            <tr>
                <td class="label"><bean:message bundle="resourceconfirm" key="resourceconfirm.linkGPRSCoreAddress"/>*
                </td>
                <td class="content" colspan="3">
        ...
        <c:if test="${sheetMain.mainspecialtyType==101220101}">
            <tr>
                ...
                <td class="label"><bean:message bundle="resourceconfirm" key="resourceconfirm.linkDealDescription"/>*
                </td>
                <td class="content">
            ...
            <tr>
                <td class="label"><bean:message bundle="resourceconfirm" key="resourceconfirm.linkIfOpenCondition"/>*
                </td>
                <td class="content">
        ...
        <c:if test="${sheetMain.mainspecialtyType==101220102}">
            <tr>
                <td class="label"><bean:message bundle="resourceconfirm" key="resourceconfirm.linkDealDescriptionA"/>*
                </td>
                <td class="content">
            ...
            <tr>
                <td class="label"><bean:message bundle="resourceconfirm" key="resourceconfirm.linkIfOpenConditionA"/>*
                </td>
                <td class="content" colspan="3">
        ...
        <tr>
            ...
            <td colspan="3">
                <eoms:attachment name="sheetLink" property="linkProgramTopology"
                                 scope="request" idField="${sheetPageName}linkProgramTopology" appCode="resourceconfirm"
                                 alt="allowBlank:false"/>
            </td>
        </tr>
        <%
