    ...
    <c:if test="${not empty list}">
        ...
        <c:forEach var="item" items="${list}">
            <tr>
                ...
                <td><input type="button" value="<bean:message key='cacheList.button.flush' />"
                           onclick="flush('${item.cacheName}');"/></td>
                <td><input type="button" value="<bean:message key='cacheList.button.detail' />"
                           onclick="detail('${item.cacheName}');"/></td>
                <td><input type="button" value="<bean:message key='cacheList.button.cleanStat'/>"
                           onclick="clearStat('${item.cacheName}');"/></td>
            </tr>
        </c:forEach>
    </c:if>
