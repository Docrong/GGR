...
<form action="${app}/kmmanager/expertScore.do?method=saveInputScore" name="kmExpertScoreForm" method="post">
    <table class="formTable">
        ...
        <tr>
            ...
            <td><%=kmExpertScore.getBaseScore() %>
            </td>
            <td><%=kmExpertScore.getAnswerNum() %>
            </td>
            <td><%=kmExpertScore.getAnswerSati() %>
            </td>
            <td><%=kmExpertScore.getKnowledgeScore() %>
            </td>
            <td>
                ...
                <input name="inputScore" type="text" size="5"
                       value="<%=StaticMethod.nullObject2String(kmExpertScore.getInputScore()) %>" alt="vtype:'number'">
            </td>
            <%
                }
            %>
