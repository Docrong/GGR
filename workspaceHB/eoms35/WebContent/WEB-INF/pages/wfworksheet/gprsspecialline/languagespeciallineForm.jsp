...
<html:form action="languagespeciallines.do?method=xedit" method="post" styleId="languagespeciallineForm"
    ...
    <table class="formTable">
        ...
        <tr>
            ...
            <td colspan="3">
                ...
                <textarea class="textarea max" readonly="true" name="${sheetPageName}showDept2" style="height:50px"
                          ...
                          alt="allowBlank:false,maxLength:50,vtext:'请填入地市，最多输入50字符'"><c:forTokens
                        items="${languagespeciallineForm.businessOpenZone}" delims="," var="callUserLocalZone"
        ...
        <td colspan="3">
            ...
            <textarea class="textarea max" readonly="true" name="${sheetPageName}showUserLocalZone" style="height:50px"
                      id="${sheetPageName}showUserLocalZone"
                      alt="allowBlank:false,maxLength:250,vtext:'请填入设备厂家，最多输入125个汉字'"><c:forTokens
                    items="${languagespeciallineForm.callUserLocalZone}" delims="," var="callUserOpenBrand"
                    varStatus="status"><eoms:id2nameDB id="${callUserLocalZone}"
                                                       beanId="ItawSystemDictTypeDao"/><c:choose><c:when
                    test="${status.last}"></c:when><c:otherwise>,</c:otherwise></c:choose></c:forTokens></textarea>
            <input type="hidden" name="${sheetPageName}callUserLocalZone" id="${sheetPageName}callUserLocalZone"
        ...
        <tr>
            ...
            <td colspan="3">
                <div id="factoryview" class="hide"></div>
                <textarea class="textarea max" readonly="true" name="${sheetPageName}showUserOpenBrand"
                          style="height:50px" id="${sheetPageName}showUserOpenBrand"
                          alt="allowBlank:false,maxLength:250,vtext:'请填入设备厂家，最多输入125个汉字'"><c:forTokens
                        items="${languagespeciallineForm.callUserOpenBrand}" delims="," var="callUserOpenBrand"
                        varStatus="status"><eoms:id2nameDB id="${callUserOpenBrand}"
                                                           beanId="ItawSystemDictTypeDao"/><c:choose><c:when
    ...
    <table class="formTable">
        ...
        <tr>
            ...
            <td colspan="3">
                ...
                <textarea class="textarea max" readonly="true" name="${sheetPageName}showFactory3" style="height:50px"
                          id="${sheetPageName}showFactory3"
                          alt="allowBlank:false,maxLength:250,vtext:'请填入设备厂家，最多输入125个汉字'"><c:forTokens
                        items="${languagespeciallineForm.applyProductName}" delims="," var="applyProductName"
                        varStatus="status"><eoms:id2nameDB id="${applyProductName}"
                                                           beanId="ItawSystemDictTypeDao"/><c:choose><c:when
                        test="${status.last}"></c:when><c:otherwise>,</c:otherwise></c:choose></c:forTokens></textarea>
                <input type="hidden" name="${sheetPageName}applyProductName" id="${sheetPageName}applyProductName"
                       value="${languagespeciallineForm.applyProductName}"/>
            </td>
        </tr>
    ...
    <eoms:comboBox name="userIsUserNet" id="userIsUserNet" defaultValue="${transferspeciallineForm.userIsUserNet}"
                   initDicId="1012310"
                   alt="allowBlank:true" styleClass="select-class"/>
    </td>
    ...
    <tr>
        ...
        <td class="content">
            ...
            <html:text property="interfaceEquipCodeA" styleId="interfaceEquipCodeA" styleClass="text medium"
                       alt="allowBlank:true"/>
        </td>
    </tr>
    <tr>
...
<script type="text/javascript" id="my5">
    ...
    factoryTree = new xbox({
        ...
        treeChkMode: '',
        treeChkType: 'dict',
        showChkFldId: '${sheetPageName}showFactory3',
        saveChkFldId: '${sheetPageName}applyProductName',
        viewer: factoryViewer3
    });
</script>
<script>
