        ...
        <table border="0" width="75%" cellspacing="1" cellpadding="1" class="table_show" align=center>
            <tr class="tr_show">
                ...
                <td width="70%" height="25" colspan="2">
                    <select name="orderType" size="1" style="FONT-SIZE: 8pt" style="width: 6.8cm;"
                            onchange="changesheetid()">
                        ...
                        %>
                        <option value="<%=strt[0].toString()%>"><%=strt[1].toString()%>
                        </option>
                        <%
                            }
                        %>
            ...
            <tr class="tr_show" style="display:none">
                ...
                <td width="70%" height="25" colspan="2">
                    <input type="text" readonly="readonly" value="<bean:write name="userName" scope="request"/>"
                           size="35" maxlength="50" name="operater">
                    <input type="hidden" readonly="readonly" value="<bean:write name="userId" scope="request"/>"
                           size="35" maxlength="50" name="operaterId">
                    <font color="#FF0000">**</font></td>
            </tr>
            <tr class="tr_show" style="display:none">
            ...
            <tr class="tr_show">
                ...
                <td width="70%" height="25" colspan="2">
                    <input type="text" readonly="readonly" value="<bean:write name="userName" scope="request"/>"
                           size="35" maxlength="50" name="proposer">
                    <input type="hidden" readonly="readonly" value="<bean:write name="userId" scope="request"/>"
                           size="35" maxlength="50" name="proposerId">
                    <font color="#FF0000">**</font></td>
            </tr>
            <tr class="tr_show">
                <td class="clsfth" width="30%" height="25">${eoms:a2u('工单号：')}</td>
                <td width="70%" height="25" colspan="2">
                    <input type="text" name="sheetid" size="35" value="<bean:write name="sheetid" scope="request"/>"
