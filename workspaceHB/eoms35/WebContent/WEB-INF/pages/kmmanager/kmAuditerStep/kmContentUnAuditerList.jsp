...
<fmt:bundle basename="com/boco/eoms/km/config/applicationResource-kmmanager">
    ...
    <display:table name="kmAuditerStepList" cellspacing="0" cellpadding="0"
        ...
        <display:column property="kmId" sortable="true"
                        headerClass="sortable" titleKey="kmAuditerStep.kmId"
                        href="${app}/kmAuditerStep/kmAuditerSteps.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="createTime" sortable="true"
                        headerClass="sortable" titleKey="kmAuditerStep.createTime"
                        href="${app}/kmAuditerStep/kmAuditerSteps.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="operateTime" sortable="true"
                        headerClass="sortable" titleKey="kmAuditerStep.operateTime"
                        href="${app}/kmAuditerStep/kmAuditerSteps.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="operateType" sortable="true"
                        headerClass="sortable" titleKey="kmAuditerStep.operateType"
                        href="${app}/kmAuditerStep/kmAuditerSteps.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="toOrgId" sortable="true"
                        headerClass="sortable" titleKey="kmAuditerStep.toOrgId"
                        href="${app}/kmAuditerStep/kmAuditerSteps.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="toOrgType" sortable="true"
                        headerClass="sortable" titleKey="kmAuditerStep.toOrgType"
                        href="${app}/kmAuditerStep/kmAuditerSteps.do?method=edit" paramId="id" paramProperty="id"/>
    ...
    <display:table name="kmContentsList" cellspacing="0" cellpadding="0"
        ...
        <display:column sortable="true" property="contentTitle" titleKey="kmContents.contentTitle"
                        href="${app}/kmmanager/kmAuditerSteps.do?method=contentAudit" paramId="id" paramProperty="id"
        ...
        <display:column sortable="true" headerClass="contentStatus" title="状态">
            <eoms:dict key="dict-kmmanager" dictId="contentStatus" itemId="${kmContentsList.contentStatus}"
                       beanId="id2nameXML"/>
        </display:column>
