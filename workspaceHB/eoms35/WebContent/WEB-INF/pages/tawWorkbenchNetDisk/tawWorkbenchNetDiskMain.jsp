        ...
        ctxMenu: [
            {
                ...
                text: '${eoms:a2u('新建文件夹')}',
                cls: 'new-mi',
                url: '${app}/workbench/netdisk/tawWorkbenchFolders.do?method=newFolder&folderPath='
            },
            {
                id: 'edtnode',
                text: '${eoms:a2u('重命名')}',
                cls: 'edit-mi',
                url: '${app}/workbench/netdisk/tawWorkbenchFolders.do?method=editFolder&folderPath='
            },
            {
                id: 'sharenode',
                text: '${eoms:a2u('共享')}',
                cls: 'edit-mi',
                url: '${app}/workbench/netdisk/tawWorkbenchFolders.do?method=shareFolder&folderPath='
            },
            {
                id: 'listnode',
                text: '${eoms:a2u('文件列表')}',
                cls: 'list-mi',
                url: '${app}/workbench/netdisk/tawWorkbenchFiles.do?method=listFilesMain&folderPath='
            },
            {
                id: 'delnode',
                isDelete: true,
                text: '${eoms:a2u('删除')}',
                cls: 'remove-mi',
                url: '${app}/workbench/netdisk/tawWorkbenchFolders.do?method=deleteFolder&folderPath='
            }
        ],//end of ctxMenu
        /************************
