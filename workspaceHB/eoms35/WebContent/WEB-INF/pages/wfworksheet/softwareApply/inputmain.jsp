	...
	<tr>
		...
		<script type="text/javascript"> 
	            ...
	            factoryTree = new xbox({
    	          ...
    	          showChkFldId:'${sheetPageName}showFactory',saveChkFldId:'${sheetPageName}mainmanufacturer',viewer:factoryViewer
	            });
               </script> <textarea class="textarea max" readonly="true"
...
<c:if test="${status!=1}">
	<fieldset id="link1"><legend> <bean:message
