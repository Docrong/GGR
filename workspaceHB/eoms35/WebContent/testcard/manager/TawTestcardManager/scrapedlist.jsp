        ...
        <table border="0" width="95%" cellspacing="1" class="formTable">
            ...
            <logic:iterate id="tawTestcardManager" name="tawTestcardManager"
                ...
                <tr bgcolor="#FFFFFF">
                    ...
                    <td class="label" align="center" height="30"><html:link href="../TawTestcardManager/scrapview.do"
                                                                            paramId="id" paramName="tawTestcardManager"
                                                                            paramProperty="id"> ${eoms:a2u("查看")}</html:link></td>
