  ...
  <td>
	<div id="areaview" class="hide"></div>
				...
				var areaViewer = new Ext.JsonView("areaview",
					...
					{ 
						emptyText : '<div>${eoms:a2u("æ²¡æéæ©é¡¹ç®")}</div>'
				}
				);
	            ...
	            deptetree = new xbox({
    	          ...
    	          treeDataUrl:deptTreeAction,treeRootId:'-1',treeRootText:'${eoms:a2u('å°å¸')}',treeChkMode:'single',treeChkType:'area',
    	          showChkFldId:'${sheetPageName}showDept',saveChkFldId:'${sheetPageName}toDeptId',viewer:areaViewer
	            });
               </script>
               <input type="text" class="text"  readonly="readonly" name="${sheetPageName}showDept" id="${sheetPageName}showDept" alt="allowBlank:false,vtext:'${eoms:a2u('è¯·éæ©å°ååç§°')}'" value="<eoms:id2nameDB id='${sheetMain.toDeptId}' beanId='tawSystemAreaDao'/>"/>
