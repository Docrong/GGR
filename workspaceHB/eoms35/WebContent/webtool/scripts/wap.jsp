...
<head>
    ...
    <script type="text/javascript">
        function init() {
            new Ajax.Request("<%=app%>/webtool/configfiles/wap-config.xml", {
                onComplete: loadtree,
        ...
        function loadtree(orqst) {
            ...
            /*
                ...
                var DBConsNode = new WebFXTreeItem(DBConsName,"

            <%=app %>/webtool/wapdbconnection?act=list");
    //alert(tree.target);
	...
	for(i=0;i<arrDBCon.length;i++){
	  ...
	  var node = new WebFXTreeItem(name,"

            <%=app%>/webtool/wapdbconnection?act=view&flag=view&dbId="+dbid);
