...
alter table CIRCUITCONTROL_MAIN
    add constraint CIRCUITCONTROL_MAIN_PK primary key (id) using index;
...
alter table CIRCUITCONTROL_TASK
    add constraint CIRCUITCONTROL_TASK_PK primary key (id) using index;
...
values ('xls,txt,doc,jpg,gif', 'circuitcontrol', '电路调度申请工单流程', 1024, '/sheet/circuitcontrol', 106,
        '402882e54168ea1b014168ea1b980000');
...
values ('402882e54168ea1b014168ea1b980001', '8601', '1', '新增工单', '86', null,
...
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402882e54168ea1b014168ea1b98000b', '860402', '1', '建立工单', '8604', null,
        '/sheet/circuitcontrol/circuitcontrol.do?method=showOwnStarterList', '0', '0', 2);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402882e54168ea1b014168ea1b98000c', '860401', '1', '处理工单', '8604', null,
        '/sheet/circuitcontrol/circuitcontrol.do?method=showListsenddone', '0', '0', 1);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402882e54168ea1b014168ea1b98000d', '8605', '1', '已归档工单', '86', null,
        '/sheet/circuitcontrol/circuitcontrol.do?method=showHoldedList', '0', '0', 5);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402882e54168ea1b014168ea1b98000e', '8606', '1', '已作废工单', '86', null,
        '/sheet/circuitcontrol/circuitcontrol.do?method=showCancelList', '0', '0', 6);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402882e54168ea1b014168ea1b98000f', '8611', '1', '超时时间设置', '86', null,
        '/sheet/overtimetip/overtimetip.do?flowName=CircuitControl', '0', '0', 11);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402882e54168ea1b014168ea1b980010', '8612', '1', '工单处理时限配置', '86', null,
