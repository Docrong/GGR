...
public class GprsSpecialLine {
    ...
    //以下字段为GPRS专线私有字段
    private String longitudeA;                //A点经度
    private String latitudeA;                //A点纬度
    private String detailAddGPRS;            //GPRS核心网详细地址
    private String contactUserGPRS;            //GPRS核心网联系人
    private String contactPhoneGPRS;        //GPRS核心网联系人电话
    private String longitudeGPRS;            //GPRS核心网经度
    private String latitudeGPRS;            //GPRS核心网纬度
    private String businessBandwidth;        //业务带宽
    private String businessAmount;            //业务数量（传输条数）
    private String connectType;                //连接方式
    private String tunnelType;                //隧道方式
    private String groupCustomIP;            //集团用户对端Ip
    private String radiusAddress;            //radius地址
    private String groupCustomIPDetail;        //集团用户IP地址端需求
    private String apnName;                    //APN名称
    private String ipAddressAssign;            //IP地址分配方式
    private String connectPortNameA;        //A点：距离最近的接入点名称
    private String connectPortLengthA;        //A点：与最近的接入点之间的距离
    private String allowConnectA;            //A点：是否具备开通条件
    private String planFinishDaysA;            //A点：预计完成天数
    private String portANetDeptUserA;        //A网络部联系人
    private String portANetDeptPhoneA;        //A网络部门联系人电话
    private String portADealDesc;           //A点处理说明
...
//	板卡类型	
    ...
    public boolean equals(Object o) {
        if (o instanceof GprsSpecialLine) {
            GprsSpecialLine gprsSpecialLine = (GprsSpecialLine) o;
            if (this.id != null || this.id.equals(gprsSpecialLine.getId())) {
                return true;
            } else {
                return false;
            }
