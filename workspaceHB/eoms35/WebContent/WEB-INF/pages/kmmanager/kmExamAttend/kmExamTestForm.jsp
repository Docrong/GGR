        ...
        function checkTest() {
            ...
            for (var i = 0; i < checkQuestions.length; i++) {
                ...
                for (var j = 0; j < obj.length; j++) {
                    if (obj[j].type == "radio" && obj[j].checked == true) {
                        isDo = true;
                    }
                    if (obj[j].type == "checkbox" && obj[j].checked == true) {
                        isDo = true;
                    }
                    if (obj[j].type == "text" && obj[j].value.length > 0) {
                        isDo = true;
                    }
                    if (obj[j].type == "textarea" && obj[j].value.length > 0) {
                        isDo = true;
                    }
                }
                if (!isDo) {
...
<html:form action="/kmExamAttends.do?method=save" styleId="kmExamTestForm" method="post">
    <div id="content" style="text-align:center;position:relative;z-index:0;">
        ...
        <div style="color:#818181;">
            <b>考生姓名：</b>${sessionform.username }&nbsp;&nbsp;&nbsp; |&nbsp;&nbsp;&nbsp;<b>考试时间：</b><font
                color="red">${kmExamTest.testDuration }</font> 分钟&nbsp;&nbsp;&nbsp;<b>考试总分：</b><font
                color="red">${kmExamTest.totalScore }</font> 分&nbsp;&nbsp;&nbsp;<b>离交卷还有：<font color="red"
                                                                                               id="hour">0</font></b>小时<b><font
                color="red" id="minute">0</font></b>分钟<b><font color="red" id="second">0</font></b>秒
        </div>
            ...
            <tr>
                <td align="center">
                    <div style="border:1px #98c0f4 solid;width:90%;height:60px;">
                        <div style="text-align:left;margin:5px auto auto 5px;"><b><font color="red">考试须知</font></b>
                        </div>
        ...
        <div style="width:90%;text-align:right;margin-top:5px;">
            <input type="button" class="btn" style="font-size:15px;margin-right:20px;" value="检查试卷"
                   onclick="checkTest()"/><input type="button" class="btn" style="font-size:15px;margin-right:20px;"
                                                 value="提交试卷" onclick="javascript:doSubmit();"/>
        </div>
                ...
                <div id="part1" style="padding-bottom:20px;">
					...
					-->
                                    ...
                                    <div style="position:relative;width:95%;text-align:left;margin-top:10px;"
                                        ...
                                        <div style="background-image:url(${app }/images/head/edit.PNG);width:45px;height:16px;cursor:pointer;position:absolute;right:0px;top:0px;background-repeat:no-repeat;padding-left:18px;padding-top:2px;"
                                             title="答的不满意，标记一下，方便查看" onclick="marker(this.parentNode)">标记
                                        </div>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <c:forEach items="${choiceList2}" var="item1">
                                <c:if test="${item1.questionsID==item.questionID}">
                                    <tr>
                                        <td colspan="2" align="center">
                                            <div style="width:95%;text-align:left;margin-top:2px;">${item1.orderBy}.&nbsp;<input
                                                    type="checkbox" id="${item.questionID}" name="${item.questionID}"
                                                    value="${item1.orderBy}"/>&nbsp;${item1.content}</div>
                                        </td>
                                    </tr>
                                </c:if>
            ...
            <c:if test="${kmExamTestTypeForm4.description!=null}">
                <div id="part4" style="padding-bottom:20px;">
					...
					-->
                            ...
                            <tr>
                                <td colspan="2" align="center">
                                    <div style="width:95%;text-align:left;margin-top:2px;"><input type="text"
                                                                                                  class="text max"
                                                                                                  id="${item.questionID}"
            ...
            <c:if test="${kmExamTestTypeForm5.description!=null}">
                <div id="part5" style="padding-bottom:20px;">
					...
					-->
                            ...
                            <tr>
                                <td colspan="2" align="center">
                                    <div style="width:95%;text-align:left;margin-top:2px;"><textarea
                                            name="${item.questionID}" id="${item.questionID}"
                                            class="textarea max"></textarea></div>
                                </td>
                            </tr>
                        </c:forEach>
                    </table>
