...
public class DBConnectionPool {
     ...
     * 锟斤拷锟斤拷锟铰碉拷l锟接筹拷
     *
     * @param poolname     l锟接筹拷锟斤拷锟斤拷
     * @param URL          锟斤拷菘锟斤拷JDBC URL
     * @param user         锟斤拷菘锟斤拷屎锟?锟斤拷 null
     * @param password     锟斤拷锟斤拷,锟斤拷 null
     * @param charset      l锟接碉拷锟街凤拷
     * @param maxconn      锟斤拷l锟接筹拷锟斤拷锟?b锟斤拷锟斤拷锟絣锟斤拷锟斤拷
     * @param minconn      锟斤拷l锟接筹拷锟斤拷锟?b锟斤拷锟斤拷小l锟斤拷锟斤拷
     * @param maxusecount  锟斤拷l锟接筹拷锟斤拷锟?b锟斤拷锟斤拷锟絣锟斤拷锟斤拷
     * @param maxidletime  l锟接筹拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟绞憋拷锟?锟斤拷)
     * @param maxalivetime l锟斤拷锟斤拷一锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟绞憋拷锟?
     */
     ...
     *
     * @param timeout 锟皆分计的等达拷时锟斤拷锟斤拷锟斤拷
     */
