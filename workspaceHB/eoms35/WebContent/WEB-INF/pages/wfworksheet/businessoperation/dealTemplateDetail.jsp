...
<html:form action="/businessoperation.do" styleId="theform">
    ...
    <input type="hidden" name="${sheetPageName}mainClassName"
           value="com.boco.eoms.sheet.businessoperation.model.BusinessOperationMain"/> <!--main表Model对象类名-->
    <input type="hidden" name="${sheetPageName}linkClassName"
           value="com.boco.eoms.sheet.businessoperation.model.BusinessOperationLink"/> <!--link表Model对象类名-->
    ...
    <table class="formTable">
        ...
        <tr>
            ...
            <td colspan="3">
                <textarea class="textarea max" name="${sheetPageName}linkBusinessDesc"
                          id="${sheetPageName}linkBusinessDesc"
                          alt="width:500,allowBlank:false">${sheetLink.linkBusinessDesc}</textarea>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <input class="text" onclick="popUpCalendar(this, this)" type="text"
                       name="${sheetPageName}linkOperStartTime" readonly="readonly" alt="allowBlank:false"
            ...
            <td>
                <input class="text" onclick="popUpCalendar(this, this)" type="text"
                       name="${sheetPageName}linkOperEndTime" readonly="readonly" alt="allowBlank:false"
        ...
        <tr>
            ...
            <td>
                <eoms:comboBox name="${sheetPageName}linkNetType" id="${sheetPageName}linkNetType"
                               initDicId="1010508" alt="allowBlank:false" styleClass="select-class"
        ...
        <tr>
            ...
            <td colspan="3">
                <textarea class="textarea max" name="${sheetPageName}linkDataFile" id="${sheetPageName}linkDataFile"
                          alt="width:500,allowBlank:true">${sheetLink.linkDataFile}</textarea>
            </td>
        </tr>
        <tr>
            ...
            <td colspan="3">
                <textarea class="textarea max" name="${sheetPageName}linkVerify" id="${sheetPageName}linkVerify"
                          alt="width:500,allowBlank:true">${sheetLink.linkVerify}</textarea>
            </td>
        </tr>
        <tr>
            ...
            <td colspan="3">
                <textarea class="textarea max" name="${sheetPageName}linkPassMan" id="${sheetPageName}linkPassMan"
                          alt="width:500,allowBlank:true">${sheetLink.linkPassMan}</textarea>
            </td>
        </tr>
        <tr>
            ...
            <td colspan="3">
                <textarea class="textarea max" name="${sheetPageName}linkReport" id="${sheetPageName}linkReport"
                          alt="width:500,allowBlank:true">${sheetLink.linkReport}</textarea>
            </td>
        </tr>
        <tr>
            ...
            <td colspan="3">
                <textarea class="textarea max" name="${sheetPageName}linkWorkplan" id="${sheetPageName}linkWorkplan"
                          alt="width:500,allowBlank:true">${sheetLink.linkWorkplan}</textarea>
            </td>
        </tr>
        <tr>
