        ...
        <logic:iterate id="baselink" name="HISTORY" type="com.boco.eoms.sheet.softwareApply.model.SoftwareApplyLink">
            ...
            <div class="history-item"><!-- add space to hack ie-->&nbsp;
                <div class="history-item-title">
                    ...
                    <eoms:dict key="dict-sheet-softwareApply" dictId="activeTemplateId"
                               itemId="${baselink.activeTemplateId}" beanId="id2descriptionXML"/>
                    <bean:message bundle="softwareApply" key="softwareApply.operateType"/>:
                    <eoms:dict key="dict-sheet-softwareApply" dictId="mainOperateType" itemId="${baselink.operateType}"
                ...
                <div class="history-item-content hide">
  			      ...
  			      <%} %> -->
                        ...
                        <tr>
                            ...
                            <td class="column-content">
                                <eoms:dict key="dict-sheet-softwareApply" dictId="mainOperateType"
                        ...
                        <tr>
                            <td class="label"><bean:message bundle="softwareApply"
                                                            key="softwareApply.linkTaskComplete"/></td>
                            <td class="column-content" colspan="3">
