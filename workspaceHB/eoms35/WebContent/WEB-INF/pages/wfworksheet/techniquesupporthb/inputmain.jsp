...
<table class="formTable">
    ...
    <tr>
        ...
        <td colspan="3"><eoms:comboBox name="${sheetPageName}mainTechSupportType"
                                       id="${sheetPageName}mainTechSupportType" onchange="changeOperate(this.value);"
                                       initDicId="1014701" defaultValue="${sheetMain.mainTechSupportType}"
    ...
    <tr>
        ...
        <td><eoms:comboBox name="${sheetPageName}mainSheetType" id="${sheetPageName}mainSheetType"
                           initDicId="1014702" defaultValue="${sheetMain.mainSheetType}" alt="allowBlank:false"
        ...
        <td><eoms:comboBox name="${sheetPageName}mainCaseType" id="${sheetPageName}mainCaseType"
                           initDicId="1014703" defaultValue="${sheetMain.mainCaseType}" alt="allowBlank:false"
                           styleClass="select-class"/>
        </td>
    ...
    <tr>
        ...
        <td><eoms:comboBox name="${sheetPageName}mainSpecifyType" id="${sheetPageName}mainSpecifyType"
                           initDicId="1014704" defaultValue="${sheetMain.mainSpecifyType}" alt="allowBlank:false"
                           styleClass="select-class"/>
        </td>
        ...
        <td><eoms:comboBox name="${sheetPageName}mainFaultPhoneType" id="${sheetPageName}mainFaultPhoneType"
                           initDicId="1014705" defaultValue="${sheetMain.mainFaultPhoneType}" alt="allowBlank:false"
                           styleClass="select-class"/>
        </td>
    ...
    <tr>
        <td class="label"><bean:message bundle="techniquesupporthb" key="techniquesupporthb.mainSheetType"/>*</td>
        <td><eoms:comboBox name="${sheetPageName}mainSheetType" id="${sheetPageName}mainSheetType"
                           onchange="changeCardNumber(this.value);"
                           initDicId="1014702" defaultValue="${sheetMain.mainSheetType}" alt="allowBlank:false"
                           styleClass="select-class"/>
        </td>
        ...
        <td><eoms:comboBox name="${sheetPageName}mainFaultType" id="${sheetPageName}mainFaultType"
                           initDicId="1014706" defaultValue="${sheetMain.mainFaultType}" alt="allowBlank:false"
                           styleClass="select-class"/>
        </td>
    ...
    <tr>
        ...
        <td><eoms:comboBox name="${sheetPageName}mainIsMainFault" id="${sheetPageName}mainIsMainFault"
                           initDicId="1014707" defaultValue="${sheetMain.mainIsMainFault}" alt="allowBlank:false"
                           styleClass="select-class"/>
        </td>
        <td class="label"><bean:message bundle="techniquesupporthb" key="techniquesupporthb.mainFaultPhoneType"/>*</td>
        <td><eoms:comboBox name="${sheetPageName}mainFaultPhoneType" id="${sheetPageName}mainFaultPhoneType"
    ...
    <tr>
        <td class="label"><bean:message bundle="techniquesupporthb" key="techniquesupporthb.mainSheetType"/>*</td>
        <td colspan='3'><eoms:comboBox name="${sheetPageName}mainSheetType" id="${sheetPageName}mainSheetType"
                                       onchange="changeFaultLevel(this.value);"
                                       initDicId="1014702" defaultValue="${sheetMain.mainSheetType}"
                                       alt="allowBlank:false" styleClass="select-class"/>
        </td>
        <!--<td  class="label"><bean:message bundle="techniquesupporthb" key="techniquesupporthb.mainFaultType"/>*</td>
		         <td ><eoms:comboBox name="${sheetPageName}mainFaultType" id="${sheetPageName}mainFaultType" 
    ...
    <tr>
        ...
        <td><eoms:comboBox name="${sheetPageName}mainProfessional" id="${sheetPageName}mainProfessional"
                           initDicId="1014712" defaultValue="${sheetMain.mainProfessional}" alt="allowBlank:false"
                           styleClass="select-class"/>
        </td>
        <td class="label">厂商*</td>
        <td><eoms:comboBox name="${sheetPageName}mainManufacturer" id="${sheetPageName}mainManufacturer"
                           initDicId="1014713" defaultValue="${sheetMain.mainManufacturer}" alt="allowBlank:false"
                           styleClass="select-class"/>
        </td>
    ...
    <tr>
        ...
        <td colspan='3'><eoms:comboBox name="${sheetPageName}mainFaultLevel" id="${sheetPageName}mainFaultLevel"
                                       initDicId="1014714" defaultValue="${sheetMain.mainFaultLevel}"
                                       alt="allowBlank:false" styleClass="select-class"/>
        </td>
    ...
    <tr>
        ...
        <td colspan='3'>
            <input type="text" class="text" name="${sheetPageName}mainCardNumber" id="${sheetPageName}mainCardNumber"
                   value="${sheetMain.mainCardNumber}" alt="allowBlank:false,maxLength:1000,vtext:'板卡数量，最多输入1000字符'"/>
    ...
    <tr>
        <td class="label"><bean:message bundle="techniquesupporthb" key="techniquesupporthb.mainTrasitionDevType"/>*
        </td>
        <td><eoms:comboBox name="${sheetPageName}mainTrasitionDevType" id="${sheetPageName}mainTrasitionDevType"
                           initDicId="1014709" defaultValue="${sheetMain.mainTrasitionDevType}" alt="allowBlank:false"
                           styleClass="select-class"/>
        </td>
        <td class="label"><bean:message bundle="techniquesupporthb" key="techniquesupporthb.mainFaultType"/>*</td>
        <td><eoms:comboBox name="${sheetPageName}mainFaultType" id="${sheetPageName}mainFaultType"
    ...
    <tr>
        ...
        <td class="label"><bean:message bundle="techniquesupporthb" key="techniquesupporthb.mainFaultPhoneType"/>*</td>
        <td><eoms:comboBox name="${sheetPageName}mainFaultPhoneType" id="${sheetPageName}mainFaultPhoneType"
                           initDicId="1014710" defaultValue="${sheetMain.mainFaultPhoneType}" alt="allowBlank:false"
                           styleClass="select-class"/>
        </td>
    ...
    <tr>
        ...
        <td class="label"><bean:message bundle="techniquesupporthb" key="techniquesupporthb.mainFaultPhoneType"/>*</td>
        <td colspan="3"><eoms:comboBox name="${sheetPageName}mainFaultPhoneType" id="${sheetPageName}mainFaultPhoneType"
                                       initDicId="1014711" defaultValue="${sheetMain.mainFaultPhoneType}"
                                       alt="allowBlank:false" styleClass="select-class"/>
        </td>
    ...
    <tr>
        <td class="label"><bean:message bundle="techniquesupporthb" key="techniquesupporthb.mainQuestionDescript"/>*
        </td>
        <td colspan="3">
		        <textarea name="${sheetPageName}mainQuestionDescript" class="textarea max"
                          id="${sheetPageName}mainQuestionDescript"
                          alt="allowBlank:false,width:200,vtext:'请最多输入100字'"
                          alt="width:'200px'">${sheetMain.mainQuestionDescript}</textarea>
        </td>
    </tr>
    <tr>
        <td class="label">初步处理意见*</td>
        <td colspan="3">
		        <textarea name="${sheetPageName}mainInitDealOpinition" class="textarea max"
                          id="${sheetPageName}mainInitDealOpinition"
                          alt="allowBlank:false,width:200,vtext:'请最多输入100字'"
                          alt="width:'200px'">${sheetMain.mainInitDealOpinition}</textarea>
        </td>
    </tr>
