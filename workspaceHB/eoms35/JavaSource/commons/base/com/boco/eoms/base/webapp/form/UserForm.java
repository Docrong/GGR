...
public class UserForm extends BaseForm implements java.io.Serializable {
	 ...
	 * methods.
	 */
	public com.boco.eoms.base.model.Address getAddress() throws Exception {
		return (com.boco.eoms.base.model.Address) com.boco.eoms.base.util.ConvertUtil
				.convert(this.address);
	}

	public void setAddress(com.boco.eoms.base.model.Address address)
			throws Exception {
		setAddressForm((AddressForm) com.boco.eoms.base.util.ConvertUtil
				.convert(address));
	}
