    ...
    <tr>
        <td width="20%" colspan="34" height="10" align="center">
            ...
            <font color="red"><bean:message
                    key="assessview.title.labExecuteRate"/><%=(executedCount / totalCount) * 100%>%
                &nbsp;&nbsp;<bean:message key="assessview.title.labinTimeRate"/><%=(inTimeCount / executedCount) * 100%>
                %</font>
        </td>
    </tr>
    <tr>
...
<table width="90%" class="listTable">
    ...
    <tr>
        ...
        <td width="10%">
            ...
            %>
            <font color="red"><%=tawwpExecuteReportVO.getReportFlagName()%>
            </font>
            <%
            } else {
            %>
...
<table width="90%" class="listTable">
    ...
    %>
    <tr>
        <td width="15%"><%=tawwpExecuteAssessVO.getCheckUserName()%>
        </td>
        <td width="25%"><%=tawwpExecuteAssessVO.getCrtime()%>
        </td>
        <td width="50%"><%=tawwpExecuteAssessVO.getContent()%>
        </td>
        <td width="10%"><%=tawwpExecuteAssessVO.getStateName()%>
        </td>
    </tr>
    <%
        }
...
<form name="yearcheck" method="post" action="">
    ...
    <table class="listTable" width="100%">
        ...
        <tr align="right">
            <td width="100%" align="right">
                <input type="button" value="<bean:message key="assessview.title.btnPass" />"
                       onclick="javascript:onPass();" class="button">
                <input type="button" value="<bean:message key="assessview.title.btnReject" />"
                       onclick="javascript:onReject();" class="button">
                <input type="button" value="<bean:message key="assessview.title.btnBack" />"
