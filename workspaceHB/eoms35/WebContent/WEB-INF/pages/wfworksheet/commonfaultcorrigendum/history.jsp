...
<div id="history" class="panel">
    ...
    <logic:present name="HISTORY" scope="request">
        ...
        <logic:iterate id="baselink" name="HISTORY"
                       type="com.boco.eoms.sheet.commonfaultcorrigendum.model.CommonfaultCorrigendumLink">
            <%
                jNum += 1;
            ...
            <div class="history-item">&nbsp;
                ...
                <div class="history-item-title">
                    ...
                    <eoms:dict key="dict-sheet-commonfaultcorrigendum" dictId="activeTemplateId"
                    ...
                    <eoms:dict key="dict-sheet-commonfaultcorrigendum" dictId="mainOperateType"
                        ...
                        <tr>
                            ...
                            <td class="label">
                                ...
                                <bean:message bundle="commonfaultcorrigendum"
                                              key="commonfaultCorrigendumLink.linkMeasures"/>
                            </td>
