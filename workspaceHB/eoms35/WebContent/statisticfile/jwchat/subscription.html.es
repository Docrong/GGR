...
<html>
    <head>
        <title>JWChat - A&ntilde;adir usuario</title>
        <meta http-equiv="content-type" content="text/html; charset=utf-8">
          ...
          function init() {
            ...
            document.title = "Enviar subscripción";
            document.title += (jid)?" a " + jid:"";
            if (jid)
    ...
    <body style="margin:8px">
        <form name="sub" style="border:0;padding:0;margin:0;" onSubmit="return sendSub();">
            <table border="0" width="100%" height="100%">
                <tr>
                    <td nowrap>Buscar usuario:</td>
                    <td>
                        <button onClick="return srcW.openSearch();">Abrir búsqueda</button>
                    </td>
                </tr>
                <tr>
                    <td colspan=2
            ...
            <tr>
                <td align="right" nowrap>
                    <label for="to">Enviar subscripci&oacute;n a</label>
                </td>
                <td width="100%">
                    <input type="text" id="to" name="to" size="1" style="width:100%;" tabindex="1">
                </td>
            </tr>
            <tr>
                <td nowrap align="right">
                    <label for="services">Servicio (opcional)</label>
                </td>
                <td width="100%">
                    <select name="services" id="services" onChange="selectService(this);" tabindex="2">
                        <option value="">usuario Jabber local</option>
                    </select>
                </td>
            </tr>
            <tr height="100%">
                <td colspan=2
                >
                <textarea id="msg" wrap="physical" class="msgBox" tabindex="3">Deseo añadirte a mi lista de contactos.
            </textarea>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td colspan="2" align="right">
            <button type="button" onClick="window.close();" tabindex="5">Cancelar</button>
            &nbsp;
