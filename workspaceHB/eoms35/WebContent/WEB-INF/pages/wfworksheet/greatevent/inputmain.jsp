...
<table class="formTable">
    <c:if test="${status!=1}">
        ...
        <tr>
            ...
            <td class="content">
                <input type="text" class="text" name="${sheetPageName}mainEventStartTime" readonly="readonly"
                       ...
                       onclick="popUpCalendar(this, this)"
                       alt="vtype:'lessThen',link:'${sheetPageName}mainEventEndTime',vtext:'事件开始时间不能晚于事件结束时间',allowBlank:false"/>
            </td>
            ...
            <td class="content">
                <input type="text" class="text" name="${sheetPageName}mainEventEndTime" readonly="readonly"
                       ...
                       onclick="popUpCalendar(this, this)"
                       alt="vtype:'moreThen',link:'${sheetPageName}mainEventStartTime',vtext:'事件结束时间不能早于事件开始时间',allowBlank:false"/>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td colspan="3">
                <textarea class="textarea max" name="${sheetPageName}mainEventDesc" id="${sheetPageName}mainEventDesc"
                          value="${sheetMain.mainEventDesc}"
                          alt="allowBlank:true,maxLength:255,vtext:'请重新输入事件描述，最多输入125字'">${sheetMain.mainEventDesc}</textarea>
            </td>
        </tr>
        <tr>
            <td class="label"><bean:message bundle="greatevent" key="greatevent.mainInitDealResult"/>*</td>
            <td colspan="3">
                <textarea class="textarea max" name="${sheetPageName}mainInitDealResult"
                          id="${sheetPageName}mainInitDealResult" value="${sheetMain.mainInitDealResult}"
                          alt="allowBlank:false,maxLength:255,vtext:'请重新输入初步处理结果，最多输入125字'">${sheetMain.mainInitDealResult}</textarea>
            </td>
        </tr>
        <tr>
            <td class="label"><bean:message bundle="greatevent" key="greatevent.mainEventDealAdvice"/>*</td>
            <td colspan="3">
                <textarea class="textarea max" name="${sheetPageName}mainEventDealAdvice"
                          id="${sheetPageName}mainEventDealAdvice" value="${sheetMain.mainEventDealAdvice}"
                          alt="allowBlank:false,maxLength:255,vtext:'请重新输入事件处理建议，最多输入125字'">${sheetMain.mainEventDealAdvice}</textarea>
            </td>
        </tr>
        <tr>
