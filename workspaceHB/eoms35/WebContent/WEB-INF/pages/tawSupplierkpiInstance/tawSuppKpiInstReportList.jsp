...
<fmt:bundle basename="config/ApplicationResources-supplierkpi">
    ...
    <display:table name="tawSuppKpiInstReportOrders" cellspacing="0"
        ...
        <display:column headerClass="sortable" titleKey="button.delete">
            <a href="${app}/supplierkpi/TawSuppKpiInstReportOrder.do?method=delete&id=${tawSuppKpiInstReportOrder.id}&specialType=${tawSuppKpiInstReportOrder.specialType}"
               onclick="confirm('${eoms:a2u("您确实要删除该订制报表吗？")}')">${eoms:a2u('删除')}</a>
        </display:column>
