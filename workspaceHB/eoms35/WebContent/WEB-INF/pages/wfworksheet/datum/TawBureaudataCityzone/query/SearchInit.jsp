    ...
    <center>
        ...
        <center>
            ...
            <table cellSpacing="0" cellPadding="0" width="60%" border="0">
                <TR>
                    <td width="100%" class="table_title">查询地市区号对应
                    ...
                    <TD align="right" width="100%" colspan=2>
                        <div align="center">
                            <table border="0" cellspacing="1" cellpadding="1" width="80%" class="table_show"
                                   align=center>
                                <tr class="tr_show">
                                    <td noWrap width="20%">地市名称(<bean:message key="Worksheet.blurSearch"/><!--模糊查询-->
                                        )
                                    </td>
                                    <td width="70%"><html:text property="cityName" size="30"/></td>
                                </tr>
                                <tr class="tr_show">
                                    <td noWrap width="20%">区号(<bean:message key="Worksheet.blurSearch"/><!--模糊查询--> )
                                    </td>
