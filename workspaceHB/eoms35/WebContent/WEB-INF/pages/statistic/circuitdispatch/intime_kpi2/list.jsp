...
<fmt:bundle basename="config/statistic/circuitdispatch-config/ApplicationResources-statistic-circuitdispatch">
	...
	<display:column headerClass="sortable" titleKey="list.no"
     ...
     <display:column property="sheetid" sortable="true"
		headerClass="sortable" titleKey="list.sheetid" href="${app}/sheet/circuitdispatch/circuitdispatch.do?method=showDetailPage" paramId="sheetKey" paramProperty="mainid"/>

	<display:column property="title" sortable="true"
		headerClass="sortable" titleKey="list.title" />
		
	                          
	<display:column property="mainexecuteenddate" sortable="true"
		headerClass="sortable" titleKey="list.mainExecuteEndDate" />
