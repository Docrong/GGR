...
public class PlannConfirmAction extends SheetAction {
    ...
    public ActionForward searchNumber(ActionMapping mapping, ActionForm form,
        ...
        IPlannConfirmMainManager mainService = (IPlannConfirmMainManager) ApplicationContextHolder.getInstance().getBean("iPlannConfirmMainManager");
