...
import com.boco.eoms.km.duty.dao.KmchangedutyDAO;
...
public class KmchangedutyBO extends BO {
    public KmchangedutyBO(com.boco.eoms.db.util.ConnectionPool ds) {
        super(ds);
    }
    ...
    public String getAppllyString(String User_ID) throws SQLException {
        String AppllyString = "";
        KmchangedutyBO tawRmChangedutyBO = new KmchangedutyBO(ds);
    ...
    public void updateApplly(int transact_id, int transact_flag)
            throws SQLException {
        try {
            KmchangedutyDAO tawRmChangedutyDAO = new KmchangedutyDAO(ds);
            ...
            if (tawRmChangeduty != null) {
                ...
                if (transact_flag == 1) {
					...
					/*if (DutyMgrLocator.getAttributes().getSendSMsgAvailable()
						...
						KmchangedutyBO tawRmChangedutyBO = new KmchangedutyBO(
								ds);
    ...
    /**
     * @param roomId            机房编号
     * @param inputdate         申请日期
     * @param string_radio_from 以,分割班次，交班人，换班原时间
     * @param string_radio_to   以,分割班次，接班人，申请期限（换班目标时间）
     * @param reason            换班原因
     * @throws SQLException
     * @see 插入交换班表
     */
    public void apply(int roomId, String inputdate, String string_radio_from,
        ...
        KmchangedutyBO tawRmChangedutyBO = null;
        KmchangedutyDAO tawRmChangedutyDAO = null;
        ...
        try {
            tawRmChangedutyBO = new KmchangedutyBO(ds);
            tawRmChangedutyDAO = new KmchangedutyDAO(ds);
