...
<form name="tawwpexecuteform" method="POST" action="../tawwpexecute/searchResult.do">
    ...
    <table width="500" border="0" cellspacing="1" cellpadding="1" class="table_show" align=center>
        ...
        <tr class="tr_show">
            ...
            <td>
                <input type="text" name="startDate" size="20" onclick="popUpCalendar(this, this);" readonly="readonly"
                       class="text">
            </td>
        </tr>
        ...
        <tr class="tr_show">
            ...
            <td>
                <input type="text" name="endDate" size="20" onclick="popUpCalendar(this, this);" readonly="readonly"
                       class="text">
            </td>
        </tr>
