                ...
                <div id="configureContent" class="panelContent">
                    <table border='0' cellpadding='0' cellspacing='0'>
                        ...
                        <tr>
                            ...
                            <td class='portlet-table-td-left'>
                                <input type='text' name='userName' class='portlet-form-input-field' size='24'
                        ...
                        <tr>
                            ...
                            <td class='portlet-table-td-left'>
                                <input type='password' name='password' class='portlet-form-input-field' size='24'
                                       value='<c:out value="${requestScope.password}"/>'/>
                            </td>
                        </tr>
                        <tr>
                            <td class='portlet-table-td-right' colspan='2'>
                                <input type='submit' name='action' onClick="document.pressed='login'"
                                       value='<fmt:message key="portlet.button.ok"/>' class='portlet-form-button'/>
                            </td>
                        </tr>
                    </table>
                </div>
                ...
                <div id="addPanel">
                    ...
                    <div id="addContent" class="panelContent">
                        <table border='0' cellpadding='0' cellspacing='0'>
                            ...
                            <tr>
                                <td class='portlet-table-td-right' colspan='2'>
                                    <input type='submit' name='action' onClick="document.pressed='add'"
                                           value='<fmt:message key="portlet.button.add"/>' class='portlet-form-button'/>
                                </td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <div id="editContent" class="panelContent">
                        <table border='0' cellpadding='0' cellspacing='0'>
                            ...
                            <tr>
                                ...
                                <td class='portlet-table-td-left'>
                                    <input type='text' name='url' class='portlet-form-input-field' size='24'
                                           value="<c:out value='${requestScope.url}'/>"/>
                                </td>
                            </tr>
                            <tr>
                                <td class='portlet-table-td-left'>
                                ...
                                <td class='portlet-table-td-left'>
                                    <input type='text' name='name' class='portlet-form-input-field' size='16'
                            ...
                            <tr>
                                ...
                                <td class='portlet-table-td-left'>
                                    <input type='text' name='tag' class='portlet-form-input-field' size='16'
                                           value="<c:out value='${requestScope.tag}'/>"/>
                                </td>
                            </tr>
                            <tr>
                                <td class='portlet-table-td-right' colspan='2'>
                                    <input type='submit' name='action' onClick="document.pressed='save'"
                                           value='<fmt:message key="portlet.button.save"/>'
                                           class='portlet-form-button'/>
                                    <input type='submit' name='action' onClick="document.pressed='cancel'"
