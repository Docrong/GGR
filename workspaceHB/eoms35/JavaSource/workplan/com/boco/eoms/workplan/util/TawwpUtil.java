...
public class TawwpUtil {
     ...
     * @param _request      要处理的request
     * @param _parm         要处理的参数
     * @param _defaultvalue 如果为空，将用该值替代
     * @return 处理后的字符串
     */
    public static String getRequestValue(HttpServletRequest _request,
     ...
     * 增加短信服务功能
     *
     * @param _cruser  String 发送人列表，以逗号分割
     ...
     * 增加短信服务功能
     *
     * @param serverid String 短信订阅服务ID
     * @param _cruser  String 发送人列表，以逗号分割
     * @param _content String 发送内容
     * @param _id      String 所属属性ID 如月计划Id或年计划ID
     */
