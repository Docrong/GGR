        ...
        <logic:iterate id="baselink" name="HISTORY" type="com.boco.eoms.sheet.itrequirement.model.ITRequirementLink">
            ...
            <div class="history-item"><!-- add space to hack ie-->&nbsp;
                <div class="history-item-title">
                    ...
                    <eoms:dict key="dict-sheet-itrequirement" dictId="activeTemplateId"
                               itemId="${baselink.activeTemplateId}" beanId="id2descriptionXML"/>
                    <bean:message bundle="itrequirement" key="itrequirement.operateType"/>:
                    <eoms:dict key="dict-sheet-itrequirement" dictId="mainOperateType" itemId="${baselink.operateType}"
                ...
                <div class="history-item-content hide">
                    ...
                    <table class="history-item-table" width="100%" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td class="column-content">
                                <eoms:dict key="dict-sheet-itrequirement" dictId="mainOperateType"
                        ...
                        <tr>
                            <td class="label"><bean:message bundle="itrequirement"
                                                            key="itrequirement.linkAuditResult"/></td>
                            <td class="column-content" colspan=3>
                        ...
                        <tr>
                            <td class="label"><bean:message bundle="itrequirement"
                                                            key="itrequirement.linkChangeType"/></td>
                            <td class="column-content">
                                <eoms:id2nameDB id="${baselink.linkChangeType}" beanId="ItawSystemDictTypeDao"/>

                            </td>
                            <td class="label"><bean:message bundle="itrequirement"
                                                            key="itrequirement.linkAnalysisResult"/></td>
                            <td class="column-content">
		            ...
		            <td  class="column-content"> <bean:write name="baselink" property="linkAuditPer" scope="page"/></td>
                        ...
                        <tr>
                            <td class="label"><bean:message bundle="itrequirement"
                                                            key="itrequirement.linkAnalysisDesc"/></td>
                            <td colspan="3">
                                <pre><bean:write name="baselink" property="linkAnalysisDesc" scope="page"/></pre>
                            </td>
                        </tr>
                        <tr>
                            <td class="label"><bean:message bundle="itrequirement"
                                                            key="itrequirement.linkHardWareExp"/></td>
                            <td colspan="3">
                        ...
                        <tr>
                            <td class="label"><bean:message bundle="itrequirement"
                                                            key="itrequirement.linkSystemImpact"/></td>
                            <td colspan="3">
                        ...
                        <tr>
                            <td class="label"><bean:message bundle="itrequirement"
                                                            key="itrequirement.linkOtherImpact"/></td>
                            <td colspan="3">
                        ...
                        <tr>
                            <td class="label"><bean:message bundle="itrequirement"
                                                            key="itrequirement.linkTechnicalprogram"/></td>
                            <td colspan='3'>
                                <eoms:attachment name="baselink" property="linkTechnicalprogram" scope="page"
                                                 idField="${sheetPageName}linkTechnicalprogram"
                                                 appCode="itrequirementsheet"
                                                 viewFlag="Y"/>
                            </td>
                        </tr>
                        <%
                        ...
                        <tr>
                            <td class="label"><bean:message bundle="itrequirement"
                                                            key="itrequirement.linkRequirementDesc"/></td>
                            <td colspan="3">
                                <pre><bean:write name="baselink" property="linkRequirementDesc" scope="page"/></pre>
                            </td>
                        </tr>
                        <tr>
                            <td class="label"><bean:message bundle="itrequirement"
                                                            key="itrequirement.linkRequirementDetail"/></td>
                            <td colspan='3'>
                                <eoms:attachment name="baselink" property="linkRequirementDetail" scope="page"
                                                 idField="${sheetPageName}linkRequirementDetail"
                                                 appCode="itrequirementsheet"
                                                 viewFlag="Y"/>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td class="label"><bean:message bundle="itrequirement"
                                                            key="itrequirement.linkCompleteDesc"/></td>
                            <td colspan="3">
		            ...
		            <td  class="label"><bean:message bundle="itrequirement" key="itrequirement.linkTempSaveDesc"/></td>
		              <td colspan="3"><pre><bean:write name="baselink" property="linkTempSaveDesc" scope="page"/></pre></td>
                        ...
                        <tr>
                            <td class="label"><bean:message bundle="itrequirement"
                                                            key="itrequirement.linkReplyDesc"/></td>
                            <td colspan="3">
                                <pre><bean:write name="baselink" property="linkReplyDesc" scope="page"/></pre>
                            </td>
                        </tr>
