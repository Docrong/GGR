...
public class File
{
    ...
    public void saveAs(String destFilePathName, boolean IsCreateFolder)
        throws SmartUploadException, IOException
    {
      saveAs( destFilePathName, 0, IsCreateFolder);
    }

    public void saveAs(String destFilePathName, int optionSaveAs)
        throws SmartUploadException, IOException
    {
      saveAs( destFilePathName, optionSaveAs,true);
    }
    public void saveAs(String destFilePathName, int optionSaveAs,boolean IsCreateFolder)
        throws SmartUploadException, IOException
    {
        String path = new String();
        path = m_parent.getPhysicalPath(destFilePathName, optionSaveAs,IsCreateFolder);
        if(path == null)
