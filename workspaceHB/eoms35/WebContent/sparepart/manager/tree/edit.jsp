        ...
        <table border="0" width="75%" cellspacing="1" cellpadding="1" class="table_show" align=center>
            <tr class="tr_show">
                ...
                <td width="70%" height="25" colspan="2">
                    <input type="text" size="35" value="<bean:write name='tawTree' property='cname' scope='request'/>"
                           maxlength="50" name="cname">
            ...
            <tr class="tr_show">
                ...
                <td width="70%" height="25" colspan="2">
                    <input value="<bean:write name='tawTree' property='note' scope='request'/>" type="text" name="note"
