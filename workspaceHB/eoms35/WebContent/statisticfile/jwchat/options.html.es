...
<html>
    ...
    <body style="margin: 8px;">
        ...
        0 cellspacing=0 height="100%" width="100%">
        <tr>
            <td>
                <div id="tablabels" class="tablabels">
                    <span class="tablabelactive">General</span>
                    <span class='tablabel' id='pw_label'>Change Password</span>
                    <span class="tablabel" id='gw_label'>Transportes</span>
                    <span class="tablabel" id='dir_label'>vJUD</span>
                    <span class="tablabel">Acerca de</span>
                </div>
            </td>
        </tr>
        <tr>
            <td height="100%" class="tabs" valign="top">
                <div id="tabs">
                        ...
                        <form name="options">
                            <fieldset>
                                ...
                                <table border="0">
                                    <tr>
                                        <td>
                                            <input id="usersHidden" type="checkbox"
                                                   onChange="srcW.roster.toggleHide();">
                                        </td>
                                        <td>
                                            <label for="usersHidden">Ocultar usuarios desconectados</label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <input id="autoPopup" type="checkbox"
                                                   onChange="srcW.autoPopup=this.checked;toggleAutoPopupAway(this);">
                                        </td>
                                        <td>
                                            <label for="autoPopup">Abrir mensajes y charlas automáticamente</label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <input id="autoPopupAway" type="checkbox"
                                                   onChange="srcW.autoPopupAway=this.checked">
                                        </td>
                                        <td>
                                            <label for="autoPopupAway">Mostrar ventana incluso si ausente</label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <input id="playSounds" type="checkbox"
                                                   onChange="srcW.playSounds=this.checked;">
                                        </td>
                                        <td>
                                            <label for="playSounds">Reproducir sonidos</label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <input id="focusWindows" type="checkbox"
                                                   onChange="srcW.focusWindows=this.checked;">
                                        </td>
                                        <td>
                                            <label for="focusWindows">Mostrar ventana si se recibe un nuevo mensaje
                                            </label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <input id="timestamps" type="checkbox" onClick="displayTimestamps();">
                                        </td>
                                        <td>
                                            <label for="timestamps">Mostrar horas en la ventana de charla</label>
                                        </td>
                                    </tr>
                                    <tr id='tr_enableLog'>
                                        <td>
                                            <input id="enableLog" type="checkbox"
                                                   onChange="srcW.enableLog=this.checked;">
                                        </td>
                                        <td>
                                            <label for="enableLog">Guardar historial de mensajes</label>
                                        </td>
                                    </tr>
                                        ...
                                        <tr>\
                                            <td colspan="2">\
                                                ...
                                                <select name="timerval"
                                                        onChange="srcW.con.setPollInterval(this.value);srcW.timerval=this.value;">
                                                    \
                    ...
                    <div class="tabinactive" id="password_tab">
                    ...
                    <div class="tabinactive" id="transports_tab">Registrarse en
                        <select id="transports_selector" onchange="service_selected(this);">
                            <option value="">- Escoger Transporte -</option>
                        </select>
                        <div id="transport_pane"></div>
                    </div>
                    <div class="tabinactive" id="directory_tab">Registrarse en
                        <select id="directory_selector" onchange="service_selected(this);">
                            <option value="">- Escoger directorio -</option>
                        </select>
                        <div id="directory_pane"></div>
                    </div>
                    <div class="tabinactive" id="about_tab" align="center">
                        <p>
                            <img src="images/jwchat.jpg" style="border:1px solid black;">
                                <h1 style="margin-bottom: 0px;">JWChat</h1>
                                Version
                                <span id="jwchat_version"></span>
                                <p>
                                    <nobr>&copy 2003-2004 by
                                        <a href="mailto:steve@zeank.in-berlin.de">Stefan Strigler</a>
                                    </nobr>
                                    <p>
                                        <img src="images/jumpto.gif" align="middle">
                                            <a href="http://jwchat.sourceforge.net" target="_new">
