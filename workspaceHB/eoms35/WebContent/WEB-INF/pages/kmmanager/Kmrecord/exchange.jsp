    ...
    <html:hidden property="id" />
      <TABLE cellSpacing="2" cellPadding="1" width="600" >
		...
		<TABLE cellSpacing="0" cellPadding="0" width="600"  borderColorLight="#709FD5"  borderColorDark="#ffffff" align="center" bgColor="#f3f3f3" border="1" class="formTable">
                    <TR>
                      <TD>
                       <IFRAME ID=IFrame1  FRAMEBORDER=0 width="100%" height="130%" SCROLLING=YES SRC='${app}/kmmanager/Kmhangover/show.do?HANGWORKSERIAL=<%=strWorkSerial%>&RECEIVEWORKSERIAL=<%=strNextWorkSerial%>&strHQ=<%=strHQ%>'>
                       </IFRAME>
                      </TD>
                    </TR>
       </TABLE>
