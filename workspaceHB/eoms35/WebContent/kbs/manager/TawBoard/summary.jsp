        ...
        <tr class="tr_show">
            ...
            <td>
                ...
                <html:link page="/TawBoard/edit.do" name="map" scope="page">
                    <img title="<bean:message key="label.edit"/>"
            ...
            <td>
                <%
                    if (tawBoard.getParentId() != 0) {%>
                <a href="../TawBoard/trash.do?boardId=<%=tawBoard.getBoardId()%>&deleted=<%=tawBoard.getDeleted()%>&infoType=<%=infoType%>"
                   onclick='return del_confirm();' title="<bean:message key="label.remove"/>">
...
<table width=100%>
    <tr>
        <td align="right" height="32">
            <input type="button" Class="clsbtn2" value="<bean:message key="label.add"/>"
                   onclick="window.location='add.do?infoType=<%=infoType%>'">
