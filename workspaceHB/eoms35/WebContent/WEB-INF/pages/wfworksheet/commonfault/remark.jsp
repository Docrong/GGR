...
<div id="sheetform">
    <html:form action="/commonfault.do?method=newPerformNonFlow" styleId="theform">
        ...
        %>
        <input type="hidden" name="${sheetPageName}operateType" value="-15"/>
        <%
                }
            }
        %>
        ...
        <input type="hidden" name="${sheetPageName}mainClassName"
               value="com.boco.eoms.sheet.commonfault.model.CommonFaultMain"/> <!--mainè¡¨Modelå¯¹è±¡ç±»å-->
        <input type="hidden" name="${sheetPageName}linkClassName"
               value="com.boco.eoms.sheet.commonfault.model.CommonFaultLink"/> <!--linkè¡¨Modelå¯¹è±¡ç±»å-->
        ...
        <input type="hidden" name="${sheetPageName}preLinkId" value="${baselink.id}"/>
        <input type="hidden" name="${sheetPageName}taskCompleteTime"
               value="${eoms:date2String(baselink.nodeCompleteLimit)}"/>
