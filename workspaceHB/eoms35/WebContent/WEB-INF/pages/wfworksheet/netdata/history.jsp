        ...
        <logic:iterate id="baselink" name="HISTORY" type="com.boco.eoms.sheet.netdata.model.NetDataLink">
            ...
            <div class="history-item"><!-- add space to hack ie-->&nbsp;
                <div class="history-item-title">
                    ...
                    <eoms:dict key="dict-sheet-netdata" dictId="activeTemplateId" itemId="${baselink.activeTemplateId}"
                               beanId="id2descriptionXML"/>
                    <bean:message bundle="netdata" key="netdata.operateType"/>:
                    <eoms:dict key="dict-sheet-netdata" dictId="mainOperateType" itemId="${baselink.operateType}"
                               beanId="id2descriptionXML"/>
                ...
                <div class="history-item-content hide">
  				...
  				-->
                        ...
                        <tr>
                            <td class="label"><bean:message bundle="netdata" key="netdata.linkIfStartOperationTest"/>*
                            </td>
                            <td colspan="3">
                                <eoms:id2nameDB id="${baselink.linkIfStartOperationTest}"
                        ...
                        <c:if test="${baselink.linkIfStartOperationTest=='1030101'}">
                            <tr>
                                ...
                                <td colspan="3">
                                    ...
                                    <c:forTokens items="${baselink.linkTestPerson}" delims="," var="linkTestPerson"
                                                 varStatus="status">
