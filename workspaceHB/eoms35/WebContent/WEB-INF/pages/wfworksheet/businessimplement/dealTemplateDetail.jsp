	...
	<table class="formTable">
     ...
     <%if(taskName.equals("ImplementDealTask")&& (operateType.equals("91")||operateType.equals("11"))){ %>
	        ...
	        <tr>
		           ...
		           <td  > 
		           <eoms:comboBox   name="${sheetPageName}linkArugmentlevel" id="${sheetPageName}linkArugmentlevel"  initDicId="1012302" styleClass="select-class" alt="allowBlank:false" defaultValue="${sheetLink.linkArugmentlevel}" />
		 	  ...
		 	  <tr>
			  	<td class="label"> <bean:message bundle="businessimplement" key="businessimplement.linkSenderOpinition"/>  </td>
			    <td colspan="3">
			      <textarea class="textarea max"  name="${sheetPageName}linkSenderOpinition" id="${sheetPageName}linkSenderOpinition" 
 	 ...
 	 <%}else if(taskName.equals("ProjectDealTask")&&(operateType.equals("93")||operateType.equals("11"))){ %>
	        ...
	        <tr>
				<td class="label">
		           ...
		           <td  > 
		             <eoms:comboBox   name="${sheetPageName}linkDoResourt" id="${sheetPageName}linkDoResourt"  initDicId="1012303" styleClass="select-class" alt="allowBlank:false" defaultValue="${sheetLink.linkArugmentlevel}" />
		           ...
		           <td class="content"> 
		             <input type="text"  class="text" name="${sheetPageName}linkEleNeed" id="${sheetPageName}linkEleNeed"  alt="allowBlank:true" value="${sheetLink.linkEleNeed}"/>
		          </td>
	       </tr> 
	        <tr>
				<td class="label">
		           ...
		           <td  > 
		     	     <input type="text"  class="text" name="${sheetPageName}linkStartA" id="${sheetPageName}linkStartA"  alt="allowBlank:true" value="${sheetLink.linkStartA}"/>
		           </td>
		           ...
		           <td class="content"> 
		             <input type="text"  class="text" name="${sheetPageName}linkACompteHome" id="${sheetPageName}linkACompteHome"  alt="allowBlank:true" value="${sheetLink.linkACompteHome}"/>
		          </td>
	       </tr> 
	       <tr>
				<td class="label">
		           ...
		           <td  > 
		     	     <input type="text"  class="text" name="${sheetPageName}linkABusinessDDF" id="${sheetPageName}linkABusinessDDF"  alt="allowBlank:true" value="${sheetLink.linkABusinessDDF}"/>
		           </td>
		           ...
		           <td class="content"> 
		             <input type="text"  class="text" name="${sheetPageName}linkADevHost" id="${sheetPageName}linkADevHost"  alt="allowBlank:true" value="${sheetLink.linkADevHost}"/>
		          </td>
	       </tr> 
	        <tr>
				<td class="label">
		           ...
		           <td  > 
		     	     <input type="text"  class="text" name="${sheetPageName}linkATrasitionDDF" id="${sheetPageName}llinkATrasitionDDF"  alt="allowBlank:true" value="${sheetLink.linkATrasitionDDF}"/>
		           </td>
		           ...
		           <td class="content"> 
		             <input type="text"  class="text" name="${sheetPageName}linkScopeTrasitionHost" id="${sheetPageName}linkScopeTrasitionHost"  alt="allowBlank:true" value="${sheetLink.linkScopeTrasitionHost}"/>
		          </td>
	       </tr> 
	       <tr>
				<td class="label">
		           ...
		           <td  > 
		     	     <input type="text"  class="text" name="${sheetPageName}linkEndZ" id="${sheetPageName}linkEndZ"  alt="allowBlank:false" value="${sheetLink.linkEndZ}"/>
		           </td>
			...
			<td class="label">		     
		           ...
		           <td class="content"> 
		             <eoms:comboBox   name="${sheetPageName}linkDevType" id="${sheetPageName}linkDevType" sub="${sheetPageName}linkOne" initDicId="1012304" styleClass="select-class" alt="allowBlank:false" defaultValue="${sheetLink.linkDevType}" />	     	
		           </td>
		     </tr>
		        ...
		        <td class="label">		     
		          方式*
		            ...
		            <td class="content" colspan="3"> 
		             <eoms:comboBox   name="${sheetPageName}linkOne" id="${sheetPageName}linkOne" initDicId="${sheetPageName}linkDevType" styleClass="select-class" alt="allowBlank:false" defaultValue="${sheetLink.linkOne}" />	     	
		           </td>
	       </tr> 
	       <tr>
	...
	<%}else if(taskName.equals("CityNetTask")&&(operateType.equals("92")||operateType.equals("11"))){ %>
			 ...
			 <tr>
				<td class="label">
		           ...
		           <td  > 
		     	     <input type="text"  class="text" name="${sheetPageName}linkDesinResourt" id="${sheetPageName}linkDesinResourt"  alt="allowBlank:true" value="${sheetLink.linkDesinResourt}"/>
		           </td>
		           ...
		           <td class="content"> 
		             <input type="text"  class="text" name="${sheetPageName}linkDesinType" id="${sheetPageName}linkDesinType"  alt="allowBlank:true" value="${sheetLink.linkDesinType}"/>
		          </td>
	       </tr> 
	        <tr>
				<td class="label">
		           ...
		           <td  > 
		     	     <input type="text"  class="text" name="${sheetPageName}linkIPAddress" id="${sheetPageName}linkIPAddress"  alt="allowBlank:true" value="${sheetLink.linkIPAddress}"/>
		           </td>
		           ...
		           <td class="content"> 
		             <input type="text"  class="text" name="${sheetPageName}linkSubNetNumber" id="${sheetPageName}linkSubNetNumber"  alt="allowBlank:true" value="${sheetLink.linkSubNetNumber}"/>
		          </td>
	       </tr> 
	       <tr>
				<td class="label">
		           ...
		           <td  > 
		     	     <input type="text"  class="text" name="${sheetPageName}linkGetWay" id="${sheetPageName}linkGetWay"  alt="allowBlank:true" value="${sheetLink.linkGetWay}"/>
		           </td>
		           ...
		           <td class="content"> 
		             <input type="text"  class="text" name="${sheetPageName}linkVLAN" id="${sheetPageName}linkVLAN"  alt="allowBlank:true" value="${sheetLink.linkVLAN}"/>
		          </td>
	       </tr> 
	       	 <tr>
			  	<td class="label"> <bean:message bundle="businessimplement" key="businessimplement.linkFailureResson"/>  </td>
			 ...
			 <tr>
				<td class="label">
		         ...
		         <tr>   
		           ...
		           <td  colspan="3"> 
		             <input type="text"  class="text" name="${sheetPageName}linkGroupUserAddressZone" id="${sheetPageName}linkGroupUserAddressZone"  alt="allowBlank:true" value="${sheetLink.linkGroupUserAddressZone}"/>
		          </td>
	       </tr> 
	       	       	 <tr>
			  	<td class="label"> <bean:message bundle="businessimplement" key="businessimplement.linkFailureResson"/>  </td>
	...
	<%}else if(taskName.equals("BusinessTestTask")&& (operateType.equals("11")|| operateType.equals("94")|| operateType.equals("941"))){ %>		 
			 ...
			 <tr>
		         ...
		         <tr>   
		           ...
		           <td  colspan="3"> 
		             <input type="text"  class="text" name="${sheetPageName}linkDealResourt" id="${sheetPageName}linkDealResourt"  alt="allowBlank:false" value="${sheetLink.linkDealResourt}"/>
		          </td>
	       </tr> 
	       	       	 <tr>
			  	<td class="label"> <bean:message bundle="businessimplement" key="businessimplement.linkDealDescriptin"/> * </td>
			    <td colspan="3">
			      <textarea class="textarea max"  name="${sheetPageName}linkDealDescriptin" id="${sheetPageName}linkDealDescriptin" 
	...
	<%}else if(taskName.equals("TrasitionTask")&& (operateType.equals("11")|| operateType.equals("97"))){ %>		 
			 ...
			 <tr>
				<td class="label">
		           ...
		           <td   > 
		     	     <input type="text"  class="text" name="${sheetPageName}linkEleCallResourt" id="${sheetPageName}linkEleCallResourt"  alt="allowBlank:fasle" value="${sheetLink.linkEleCallResourt}"/>
		           </td>
		             </tr>
		        <td class="label">
		           ...
		           <td  > 
		     	     <input type="text"  class="text" name="${sheetPageName}linkTrasitionEleNumber" id="${sheetPageName}linkTrasitionEleNumber"  alt="allowBlank:fasle" value="${sheetLink.linkTrasitionEleNumber}"/>
		           </td>
		             </tr>
		         <tr>   
				   <td class="label">		     
