...
<head>
<%
String yes=(String)request.getAttribute("msg");
%>
<title>
...
<html:hidden property="type" name="tawOrderForm" />
<%
...
<table border="0" width="75%" cellspacing="1" cellpadding="1" class="table_show" align=center>
    <tr class="tr_show">
                  ...
                  <td width="70%" height="25" colspan="2">
                    <input type="text" value="<bean:write name="userId" scope="request"/>"size="35"  maxlength="50" name="operater">
