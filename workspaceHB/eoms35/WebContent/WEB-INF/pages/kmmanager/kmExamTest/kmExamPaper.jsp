...
<html:form action="/kmExamTests.do?method=isPublic" styleId="kmExamTestForm" method="post">
    <div id="content" style="text-align:center;position:relative;z-index:0;">
        ...
        <div style="color:#818181;">
            <b>考试时间：</b><font color="red">${kmExamTestForm.testDuration }</font> 分钟&nbsp;&nbsp;&nbsp;<b>考试总分：</b><font
                color="red">${kmExamTestForm.totalScore }</font> 分&nbsp;&nbsp;&nbsp;
        </div>
        ...
        <div style="width:90%;text-align:right;margin-top:5px;">
            <c:if test="${kmExamTestForm.isPublic==0}">
                <input type="button" class="btn" style="font-size:15px;margin-right:20px;" value="发布该试卷"
