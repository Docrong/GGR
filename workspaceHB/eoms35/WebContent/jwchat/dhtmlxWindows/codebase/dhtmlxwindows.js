    ...
    if (window.dhtmlXContainer) {
        ...
        if (this[b]) {
            ...
            this.skinParams = {
                ...
                dhx_blue: {
                    header_height: 21, border_left_width: 2, border_right_width: 2,
            ...
            this._autoResizeViewport = function () {
                ...
                if (this.vp != document.body &&
                    this.autoViewport != !1) for (a in this.vp.style.width = (_isIE ? document.body.offsetWidth - 4 : window.innerWidth) + "px", this.vp.style.height = (_isIE ? document.body.offsetHeight - 4 : window.innerHeight) + "px", this.wins) {
                    var c = this.wins[a], b = !1, e = !1;
            ...
            this.createWindow = function (a, b, h, e, g) {
                ...
                this._engineGetWindowHeader(d)[this._isIPad ? "ontouchstart" : "onmousedown"] = function (a) {
                    var a = a || event, b = c.wins[this.idd];
                ...
                d.onmousemove = function (a) {
                    ...
                    if (c.resizingWin == null && c.movingWin == null && !this._isParked) {
                        if (c._isIPad) var f = a.touches[0].clientX,
                            h = a.touches[0].clientY; else f = _isIE || _isOpera ? a.offsetX : a.layerX, h = _isIE || _isOpera ? a.offsetY : a.layerY;
            ...
            this._moveWindow = function (a) {
                ...
                if (this.resizingWin != null && this.resizingWin._allowResize) {
                    ...
                    if (this.resizingDirs == "border_left" || this.resizingDirs == "corner_left" || this.resizingDirs == "corner_up_left") if (this._effects.resize) {
                        var b = c.x + this.resizingWin.resizeOffsetX, e = b > this.resizingWin.x ? -1 : 1;
            ...
            this._bringOnTop = function (a) {
                var c = a.zi, b = this._getTopZIndex(a._isSticked), e;
                for (e in this.wins) if (this.wins[e] != a && (a._isSticked || !a._isSticked && !this.wins[e]._isSticked) && this.wins[e].zi > c) this.wins[e].zi -= this.zIndexStep, this.wins[e].style.zIndex = this.wins[e].zi;
                a.zi = b;
                a.style.zIndex = a.zi
            };
            this._makeActive = function (a, c) {
                for (var b in this.wins) if (this.wins[b] == a) {
                    var e = !1;
            ...
            this._centerWindow = function (a, b) {
                if (a._isMaximized !=
                    ...
                    if (b == !0) var c = _isIE ? document.body.offsetWidth : window.innerWidth,
                        e = _isIE ? document.body.offsetHeight : window.innerHeight; else c = this.vp == document.body ? document.body.offsetWidth : Number(parseInt(this.vp.style.width)) && String(this.vp.style.width).search("%") == -1 ? parseInt(this.vp.style.width) : this.vp.offsetWidth, e = this.vp == document.body ? document.body.offsetHeight : Number(parseInt(this.vp.style.height)) && String(this.vp.style.height).search("%") == -1 ? parseInt(this.vp.style.height) : this.vp.offsetHeight;
                    var g = Math.round(c / 2 - a.w / 2), d = Math.round(e / 2 - a.h / 2);
                    a.x = g;
                    a.y = d;
            ...
            this._parkWindow = function (a, b) {
                if (a._isParkedAllowed || b) if (!this.enableParkEffect || !a.parkBusy) if (a._isParked) this.enableParkEffect && !b ? (a.parkBusy = !0, this._doParkDown(a)) : (a.h = a.lastParkH, this._engineRedrawWindowSize(a), this._engineDoOnWindowParkDown(a), a.updateNestedObjects(), a.btns.park.title = a.btns.park.titleIfNotParked, a._allowResizeGlobal == !0 && (this._enableButton(a, "minmax1"), this._enableButton(a, "minmax2")), a._isParked = !1, b ||
                (a.checkEvent("onParkDown") ? a.callEvent("onParkDown", [a]) : this.callEvent("onParkDown", [a]))); else if (this.enableParkEffect && !b) if (a.lastParkH = String(a.h).search(/\%$/) == -1 ? a.h : a.offsetHeight, a._allowResizeGlobal == !0 && (this._disableButton(a, "minmax1"), this._disableButton(a, "minmax2")), this.enableParkEffect) a.parkBusy = !0, this._doParkUp(a); else {
            ...
            this._getWindowIcon = function (a) {
                return a.iconsPresent ?
                    [a.icons[0], a.icons[1]] : [null, null]
            };
...
dhtmlXWindows.prototype._dhx_Engine = function () {
    ...
    this._engineSkinParams = {
        ...
        dhx_web: {
            hh: 27, lbw: 5, rbw: 5, lch: 5, lcw: 14, rch: 14, rcw: 14, bbh: 5, mnh: 23, tbh: 25,
            sbh: 20, noh_t: 5, noh_h: -10
        }
    };
    this._isIE6 = !1;
    ...
    this._engineCheckHeaderMouseDown = function (b, c) {
        if (this._isIPad) {
            var e = c.touches[0].clientX, a = c.touches[0].clientY, f = c.target || c.srcElement;
    ...
    this._engineAdjustWindowToContent = function (b, c, e) {
        var a = c + b.w - b.vs[b.av].dhxcont.clientWidth, f = e + b.h - b.vs[b.av].dhxcont.clientHeight;
        b.setDimension(a, f)
    };
    ...
    this._engineRedrawWindowTitle = function (b) {
        if (b._noHeader !== !0) {
            var c = b.childNodes[0].childNodes[this._isIE6 ? 1 : 0].offsetWidth,
                e = b.childNodes[0].childNodes[this._isIE6 ? 4 : 3].offsetWidth, a = b.offsetWidth - c - e - 24;
            a < 0 ? a = "100%" : a += "px";
    ...
    dhtmlx.extend_api("dhtmlXWindows", {
        _init: function () {
            ...
            c.createWindow = function (c) {
                ...
                for (var f in c) if (b[f]) a[b[f]](c[f]);
                else f.indexOf("on") == 0 && a.attachEvent(f, c[f]);
                return a
            }
        }, animation: "setEffect", image_path: "setImagePath", skin: "setSkin", viewport: "_viewport", wins: "_wins"
    }, {
        _viewport: function (b) {
            b.object ? (this.enableAutoViewport(!1), this.attachViewportTo(b.object)) : (this.enableAutoViewport(!1), this.setViewport(b.left, b.top, b.width, b.height, b.parent))
        }, _wins: function (b) {
