...
<div align="center">
    <br>
    <form action="../storage/updateclass.do?id=<bean:write name="tawClassMsg" property="id" scope="request"/>"
          method="post" name="TawClassMsgForm">
            ...
            <tr class="tr_show">
                ...
                <td width="70%" height="25" colspan="2">
                    <input type="text" name="cname" size="35"
                           value="<bean:write name="tawClassMsg" property="cname" scope="request"/>" maxlength="50">
                    <font color="#FF0000">**</font></td>
            </tr>
            <tr class="tr_show">
                <td class="clsfth" width="30%" height="25"><bean:message key="class.note"/>：</td>
                <td width="70%" height="25" colspan="2">
                    <input type="text" name="note" size="35"
                           value="<bean:write name="tawClassMsg" property="note" scope="request"/>" maxlength="255">
                </td>
            </tr>
        </table>
        <table border="0" width="75%" cellspacing="0">
