...
<head>
    ...
    <SCRIPT LANGUAGE=JavaScript>
        var s = ["s1", "s2", "s3", "s4"];
        var opt0 = ['${eoms:a2u("备件所属专业")}', '${eoms:a2u("全选")}', '${eoms:a2u("网元类型")}', '${eoms:a2u("备件类型")}'];
...
<div align="center">
    ...
    <form method="post" action="../part/view.do" name="frm" onsubmit="checkdata()">
        <html:hidden property="orderType" name="upLoadsForm"/>
        ...
        <table border="0" width="75%" cellspacing="1" cellpadding="1" class="table_show" align=center>
            ...
            <tr class="tr_show">
                <td class="clsfth" width="30%" height="25">
                    <p style="margin-top: 0; margin-bottom: 0">${eoms:a2u('备件查询')}小专业：</p>
                </td>
                <td width="70%" height="25" colspan="2">
                    <select name="subdept" id="s1" style="width: 6.8cm;"></select>
                </td>
            </tr>
            <tr class="tr_show">
                <td class="clsfth" width="30%" height="25">
                    <p style="margin-top: 0; margin-bottom: 0"><bean:message key="sparepart.necode"/>${eoms:a2u('备件查询')}
                        ：</p>
                </td>
                <td width="70%" height="25" colspan="2">
            ...
            <tr class="tr_show">
                <td class="clsfth" width="30%" height="25">
                    <p style="margin-top: 0; margin-bottom: 0">${eoms:a2u('备件查询')}备件类型：</p>
                </td>
                <td width="70%" height="25" colspan="2">
            ...
            <tr class="tr_show">
                <td class="clsfth" width="30%" height="25">
                    <p style="margin-top: 0; margin-bottom: 0"><bean:message
                            key="sparepart.timein"/>${eoms:a2u('：')}</p>
                </td>
                <td width="70%" height="25" colspan="2">
            ...
            <tr class="tr_show">
                <td class="clsfth" width="30%" height="25">
                    <p style="margin-top: 0; margin-bottom: 0"><bean:message
                            key="sparepart.timeend"/>${eoms:a2u('：')}</p>
                </td>
                <td width="70%" height="25" colspan="2">
