...
%>
            <table bgcolor="#dddddd" width='100%'>
                <tr bgcolor=#eeeeee>
                    ...
                    <td width='50%' align=right colspan=2><input type=button name=go value='增加查询条件'
                                                                 onclick='javascript:addInput()'></td>
                    <td width='50%' align=left colspan=2><input type=submit name=go value='查询'
