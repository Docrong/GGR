    ...
    <table class="formTable">
        ...
        <c:if test="${operateType == '61'}">
            ...
            <input type="submit" class="submit"
                   onclick="this.form.action='${app}/sheet/${module}/${module}.do?method=newPerformClaimTask'"
        ...
        <c:if test="${operateType == '4'}">
            ...
            <tr>
                <td colspan="4">
                    <input type="submit" class="submit"
                           onclick="this.form.action='${app}/sheet/${module}/${module}.do?method=performDealNew'"
