...
<div id="sheetform">
    <html:form action="/netFault.do?method=performBatchDeal" styleId="theform">
            ...
            <div id="sheetinfo">
                <logic:present name="sheetMain" scope="request">
                    ...
                    <table class="formTable">
                        ...
                        <tr>
                            <td class="label"><bean:message bundle="netFault" key="netFault.mainNetSort1"/></td>
                            <td class="content">
                                <eoms:id2nameDB id="${sheetMain.mainNetSort1}" beanId="ItawSystemDictTypeDao"/>
                            </td>
                            <td class="label"><bean:message bundle="netFault" key="netFault.mainNetSort2"/></td>
                            <td class="content">
                        ...
                        <tr>
                            <td class="label"><bean:message bundle="netFault" key="netFault.mainNetSort3"/></td>
                            <td class="content">
                                <eoms:id2nameDB id="${sheetMain.mainNetSort3}" beanId="ItawSystemDictTypeDao"/>
                            </td>
                            <td class="label"><bean:message bundle="netFault" key="netFault.mainTaskType"/></td>
                            <td class="content">
                        ...
                        <tr>
                            <td class="label"><bean:message bundle="netFault" key="netFault.mainTaskDescription"/></td>
                ...
                <tr>
                    ...
                    <td class="content">
                        <select id="dealSelector" onchange="checkValue(this)" alt="allowBlank:false,vtext:'请选择处理操作'">
                            <option value=""></option>
                            <option value="Receive"><bean:message bundle="netFault"
                                                                  key="netFault.dealrejectpass"/></option>
                            <option value="ExcuteHumTask"><bean:message bundle="netFault"
                                                                        key="netFault.nopassback"/></option>
                        </select>
                    </td>
                    <td class="label"></td>
                    <td class="content">
                        ...
                        <input type="hidden" name="beanId" value="iNetFaultMainManager"/>
                        <input type="hidden" name="mainClassName"
                               value="com.boco.eoms.sheet.netFault.model.NetFaultMain"/>
                        <input type="hidden" name="linkClassName"
                               value="com.boco.eoms.sheet.netFault.model.NetFaultLink"/>
                        <input type="hidden" name="methodBeanId" id="methodBeanId" value="${methodBeanId}"/>
                        <input type="hidden" name="piid" value="${piid}"/>
                    </td>
                </tr>
                <tr>
                    <td class="label"><bean:message bundle="netFault" key="netFault.advice"/>*</td>
                    <td colspan="3">
