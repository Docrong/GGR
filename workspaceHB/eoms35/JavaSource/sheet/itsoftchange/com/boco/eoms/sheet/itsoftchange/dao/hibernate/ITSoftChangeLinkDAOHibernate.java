...
import com.boco.eoms.sheet.itsoftchange.dao.IITSoftChangeLinkDAO;
import com.boco.eoms.sheet.itsoftchange.model.ITSoftChangeLink;

public class ITSoftChangeLinkDAOHibernate extends LinkDAO implements IITSoftChangeLinkDAO {
	...
	public BaseLink loadSinglePO(String id) throws HibernateException {
		ITSoftChangeLink link = (ITSoftChangeLink) getHibernateTemplate().get(ITSoftChangeLink.class,id);
		return link;
	}
	...
	public List listAllLinkOfWorkSheet(String id) throws HibernateException {
		String sql = "from "+"ITSoftChangeLink" +" as link where link.mainId ='" + id
	...
	public List loadLinkOfStep(String processId, String stepId)
		...
		String sql = "from "+"ITSoftChangeLink"+" as link where link.piid ='"
