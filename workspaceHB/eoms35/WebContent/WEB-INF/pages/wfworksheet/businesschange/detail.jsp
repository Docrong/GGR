            ...
            <table class="formTable">
                <tr>
                    ...
                    <td class="label"><bean:message bundle="businesschange"
                                                    key="businesschange.sheetCompleteLimit"/></td>
                    <td class="content">
                ...
                <tr>
                    ...
                    <td class="label"><bean:message bundle="businesschange"
                                                    key="businesschange.bdeptContactPhone"/></td>
                ...
                <tr>
                    ...
                    <td class="label"><bean:message bundle="businesschange"
                                                    key="businesschange.customContactPhone"/></td>
                ...
                <tr>
                    ...
                    <td class="label"><bean:message bundle="businesschange"
                                                    key="businesschange.cmanagerContactPhone"/></td>
                ...
                <c:if test="${sheetMain.businesstype1==101100101}">
                    ...
                    <tr>
                        <td class="label"><bean:message bundle="businesschange"
                                                        key="businesschange.AppServerIPAdd"/></td>
                        <td class="content"><bean:write name="sheetMain" property="appServerIPAdd"
                                                        scope="request"/></td>
                    ...
                    <tr>
                        ...
                        <td class="label"><bean:message bundle="businesschange"
                                                        key="businesschange.isRadiusValidate"/></td>
                        <td><eoms:id2nameDB id="${sheetMain.isRadiusValidate}" beanId="ItawSystemDictTypeDao"/></td>

                    </tr>
                    <tr>
                        <td class="label"><bean:message bundle="businesschange"
                                                        key="businesschange.radiusValidateIPAdd"/></td>
                    ...
                    <tr>
                        ...
                        <td class="content" colspan='3'><bean:write name="sheetMain" property="terminalNum"
                                                                    scope="request"/></td>
                    </tr>
                    </tr>
                    <tr>
                        <td class="label"><bean:message bundle="businesschange" key="businesschange.numDetail"/></td>
                        <td class="content" colspan="3"><bean:write name="sheetMain" property="numDetail"
                                                                    scope="request"/></td>
                    </tr>

                    <tr>
                        <td class="label"><bean:message bundle="businesschange"
                                                        key="businesschange.numDetailFile"/></td>
                        <td colspan="3">
                            <eoms:attachment name="sheetMain" property="numDetailFile"
                                             scope="request" idField="${sheetPageName}numDetailFile"
                                             appCode="businesschange" viewFlag="Y"/>
                        </td>
                    </tr>
                    <tr>
                        <td class="label"><bean:message bundle="businesschange"
                                                        key="businesschange.volumeAssessment"/></td>
                ...
                <c:if test="${sheetMain.businesstype1==101100102}">
                    <tr>
                        ...
                        <td class="label"><bean:message bundle="businesschange"
                                                        key="businesschange.siconnectMMSGatewayName"/></td>
                        <td class="content"><bean:write name="sheetMain" property="siconnectMMSGatewayName"
                                                        scope="request"/></td>
                    </tr>
                    <tr>
                        <td class="label"><bean:message bundle="businesschange"
                                                        key="businesschange.SIEnterpriseCode"/></td>
                        <td class="content"><bean:write name="sheetMain" property="siEnterpriseCode"
                                                        scope="request"/></td>
                    ...
                    <tr>
                        <td class="label"><bean:message bundle="businesschange"
                                                        key="businesschange.SIConnectMMSGatewayID"/></td>
                    ...
                    <tr>
                        ...
                        <td class="label"><bean:message bundle="businesschange"
                                                        key="businesschange.isConnectMISC"/></td>
                    ...
                    <tr>
                        ...
                        <td><eoms:id2nameDB id="${sheetMain.factureArea}" beanId="tawSystemAreaDao"/></td>
                        <td class="label"><bean:message bundle="businesschange"
                                                        key="businesschange.nameListSetType"/></td>
                    ...
                    <tr>
                        ...
                        <td class="label"><bean:message bundle="businesschange"
                                                        key="businesschange.connectGatewayBandwidth"/></td>
                        <td class="content"><bean:write name="sheetMain" property="connectGatewayBandwidth"
                                                        scope="request"/></td>
                    </tr>
                    <tr>
                        <td class="label"><bean:message bundle="businesschange"
                                                        key="businesschange.maxConnections"/></td>
                        <td class="content"><bean:write name="sheetMain" property="maxConnections"
                                                        scope="request"/></td>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <eoms:attachment name="sheetMain" property="appProgramme"
                                             ...
                                             appCode="businesschangesheet" viewFlag="Y"/></td>
                    </tr>
                </c:if>
                <c:if test="${sheetMain.businesstype1==101100103}">
                    ...
                    <tr>
                        <td class="label"><bean:message bundle="businesschange"
                                                        key="businesschange.enterpriseCode"/></td>
                        <td class="content"><bean:write name="sheetMain" property="enterpriseCode"
                                                        scope="request"/></td>
                        <td class="label"><bean:message bundle="businesschange" key="businesschange.bCode"/></td>
                        <td class="content"><bean:write name="sheetMain" property="bcode" scope="request"/></td>
                    </tr>
                    ...
                    <tr>
                        <td class="label"><bean:message bundle="businesschange"
                                                        key="businesschange.singleWordsBit"/></td>
                        <td class="content"><bean:write name="sheetMain" property="singleWordsBit"
                                                        scope="request"/></td>
                    ...
                    <tr>
                        <td class="label"><bean:message bundle="businesschange"
                                                        key="businesschange.connectGatewayName"/></td>
                        <td class="content"><bean:write name="sheetMain" property="connectGatewayName"
                                                        scope="request"/></td>
                        <td class="label"><bean:message bundle="businesschange"
                                                        key="businesschange.connectGatewayID"/></td>
                        <td class="content"><bean:write name="sheetMain" property="connectGatewayID"
                                                        scope="request"/></td>
                    </tr>
                    ...
                    <tr>
                        <td class="label"><bean:message bundle="businesschange"
                                                        key="businesschange.authenticationModel"/></td>
                    ...
                    <tr>
                        <td class="label"><bean:message bundle="businesschange"
                                                        key="businesschange.enterpriseType"/></td>
                        <td colspan='3'><eoms:id2nameDB id="${sheetMain.enterpriseType}"
                                                        beanId="ItawSystemDictTypeDao"/></td>
                ...
                <c:if test="${sheetMain.businesstype1==101100104}">
                    ...
                    <tr>
                        ...
                        <td class="label"><bean:message bundle="businesschange"
                                                        key="businesschange.portAInterfaceType"/></td>
                        <td><eoms:id2nameDB id="${sheetMain.portAInterfaceType}" beanId="ItawSystemDictTypeDao"/></td>
                    </tr>
                    <tr>
                        <td class="label"><bean:message bundle="businesschange"
                                                        key="businesschange.portADetailAdd"/></td>
                        <td class="content"><bean:write name="sheetMain" property="portADetailAdd"
                                                        scope="request"/></td>
                        <td class="label"><bean:message bundle="businesschange"
                                                        key="businesschange.portABDeviceName"/></td>
                        <td class="content"><bean:write name="sheetMain" property="portABDeviceName"
                                                        scope="request"/></td>
                    </tr>
                    <tr>
                        <td class="label"><bean:message bundle="businesschange"
                                                        key="businesschange.portABDevicePort"/></td>
                        <td class="content"><bean:write name="sheetMain" property="portABDevicePort"
                                                        scope="request"/></td>

                        <td class="label"><bean:message bundle="businesschange"
                                                        key="businesschange.portAContactPhone"/></td>
                        <td class="content"><bean:write name="sheetMain" property="portAContactPhone"
                                                        scope="request"/></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="label"><bean:message bundle="businesschange"
                                                        key="businesschange.portZInterfaceType"/></td>
                        <td><eoms:id2nameDB id="${sheetMain.portZInterfaceType}" beanId="ItawSystemDictTypeDao"/></td>
                    </tr>
                    <tr>
                        <td class="label"><bean:message bundle="businesschange"
                                                        key="businesschange.portZBDeviceName"/></td>
                        <td class="content"><bean:write name="sheetMain" property="portZBDeviceName"
                                                        scope="request"/></td>
                        <td class="label"><bean:message bundle="businesschange"
                                                        key="businesschange.portZBDevicePort"/></td>
                        <td class="content"><bean:write name="sheetMain" property="portZBDevicePort"
                                                        scope="request"/></td>
                    </tr>
                    ...
                    <tr>
                        <td class="label"><bean:message bundle="businesschange"
                                                        key="businesschange.confCRMTicketNo"/></td>
                        <td class="content"><bean:write name="sheetMain" property="confCRMTicketNo"
                                                        scope="request"/></td>

                        <td class="label"><bean:message bundle="businesschange"
                                                        key="businesschange.transfBusiness"/></td>
                        <td><eoms:id2nameDB id="${sheetMain.transfBusiness}" beanId="ItawSystemDictTypeDao"/></td>
                    </tr>
                    <tr>
                        <td class="label"><bean:message bundle="businesschange"
                                                        key="businesschange.portZContactPhone"/></td>
                        <td class="content" colspan='3'><bean:write name="sheetMain" property="portZContactPhone"
                                                                    scope="request"/></td>
                    </tr>
                </c:if>
                <tr>
            ...
            <tr>
                <td width="50%">
                    ...
                    <select id="dealSelector">
                        ...
                        <option value="${urlShowTransmitDealPage}"><bean:message bundle="businesschange"
                                                                                 key="businesschange.taskpass"/></option>
                        <option value="${urlShowTransmit2DealPage}"><bean:message bundle="businesschange"
                                                                                  key="businesschange.tasknopass"/></option>
                    ...
                    <select id="dealSelector">
                        ...
                        <option value="${urlShowRejectBackPage}"><bean:message bundle="sheet"
                                                                               key="common.rejectBack"/></option>
                        <%} else if (taskStatus.equals(Constants.TASK_STATUS_CLAIMED)) { %>
                        <option value="${urlShowCompleteDealPage}"><bean:message bundle="businesschange"
                                                                                 key="businesschange.dealwcnosp"/></option>
                        <option value="${urlShowPassDealPage}"><bean:message bundle="businesschange"
                                                                             key="businesschange.totaskcompsq"/></option>
                        <option value="${urlShowDispatchDealPage}"><bean:message bundle="sheet"
                                                                                 key="common.dispatchType"/></option>
                        <option value="${urlShowSplitDealPage}"><bean:message bundle="businesschange"
                                                                              key="businesschange.fenpai"/></option>
                        <option value="${urlShowPhaseReplyPage}"><bean:message bundle="sheet"
                                                                               key="event.reply"/></option>
                        <%} %>
                    </select>
                    ...
                    <select id="dealSelector">
                        ...
                        <option value="${urlShowRejectBackPage}"><bean:message bundle="sheet"
                                                                               key="common.rejectBack"/></option>
                        <%} else if (taskStatus.equals(Constants.TASK_STATUS_CLAIMED)) { %>
                        <option value="${urlShowTaskCompleteAuditYes}"><bean:message bundle="businesschange"
                                                                                     key="businesschange.TaskCompleteAuditYes"/></option>
                        <option value="${urlShowTaskCompleteAuditNo}"><bean:message bundle="businesschange"
                                                                                    key="businesschange.TaskCompleteAuditNo"/></option>
                        <option value="${urlShowPhaseReplyPage}"><bean:message bundle="sheet"
                                                                               key="event.reply"/></option>
                        <%} %>
                    </select>
                    ...
                    <select id="dealSelector">
                        <option value="${urlShowDealReplyPassPage}"><bean:message bundle="businesschange"
                                                                                  key="businesschange.dealrejectpass"/></option>
                        <option value="${urlShowDealReplyNoPassPage}"><bean:message bundle="businesschange"
                                                                                    key="businesschange.nopassback"/></option>
                        <option value="${urlShowPhaseReplyPage}"><bean:message bundle="sheet"
                                                                               key="event.reply"/></option>
                    </select>
                    <%} else if (taskName.equals("DraftHumTask")) {%>
                    <select id="dealSelector">
                        <option value="${urlShowCompleteDraftPage}"><bean:message bundle="businesschange"
                                                                                  key="businesschange.draft"/></option>
                    </select>
                    ...
                    <select id="dealSelector">
                        <option value="${urlShowHoldDealPage}"><bean:message bundle="businesschange"
                                                                             key="businesschange.hold"/></option>
                    </select>
                    <%} %>
                </td>
            </tr>
