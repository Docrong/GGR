...
<table>
	<caption class="formTable">
		油机批量录入
	</caption>
</table>
<html:form action="/tawPartnerOils.do?method=xlsSave"
	method="post" styleId="tawPartnerOilForm"
		...
		<tr>
			<td COLSPAN="17">
				<input type="submit"
					...
					class="submit">
					&nbsp;&nbsp;&nbsp;
&nbsp;<input type="button" class="button" name="save" value="下载导入模板" Onclick="window.location.href ='${app }/partner/baseinfo/tawPartnerOils.do?method=outPutModel'" >
