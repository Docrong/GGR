...
<STYLE>
.limitinput{behavior:url(<%=request.getContextPath()%>/css/js/limitInput.htc);}
</STYLE>
...
<html:hidden  name="VO" property="id"/>
   ...
   <tr class="tr_show">
		...
		<td width="200"><input type="text" name="zoneNum" size="40" maxlength="9" class="limitinput" limit="^[0-9]*$" value='<bean:write name="VO" property="zoneNum"/>'/></td>
   </tr>
   <tr class="tr_show">
		<td class="clsfth">对应部门</td>
		<td style="padding-bottom:10px;padding-top:10px;">
        <div id="sort1_text" style="margin-bottom:10px;"><bean:write name="VO" property="deptName"/></div>
        <input type="button" value="选择部门" name="btnSelDept" class="clsbigbtn" onclick="selectTree();">
        <INPUT TYPE="hidden" name="sort1_deptid" id="sort1_deptid" value='<bean:write name="VO" property="deptId"/>'/>
        <html:hidden property="deptId" name="VO"/>
               </td>
   </tr>
   <tr class="tr_show">
		<td width="15%" class="clsfth">负责人员ID号</td>
		<td width="200"><html:text property="userId" size="40" name="VO" maxlength="20"/><html:hidden property="userSysId" name="VO"/></td>
   </tr>
</logic:present>
</table>
