...
<c:set var="buttons">
	...
	<display:table name="tawLocalRepositoryList"  cellspacing="0" cellpadding="0" id="tawLocalRepositoryList" pagesize="${pageSize}" class="table tawLocalRepositoryList"
		export="false" requestURI="" sort="list"  partialList="true" size="resultSize" decorator="com.boco.eoms.repository.webapp.action.SoftRepDisplaytagDecoratorHelper">
	...
	<display:column sortable="true" headerClass="sortable" titleKey="tawLocalRepository.hardwareRepository"  >
		<eoms:id2nameDB id="${tawLocalRepositoryList.hardwareRepository}" beanId="ItawSystemDictTypeDao"/>		
	</display:column>
	<display:column sortable="true"	headerClass="sortable" titleKey="tawLocalRepository.softwareRepository"  >
		<eoms:id2nameDB id="${tawLocalRepositoryList.softwareRepository}" beanId="ItawSystemDictTypeDao"/>		
	</display:column>
	<display:column property="patch" sortable="true" headerClass="sortable" titleKey="tawLocalRepository.patch"  paramId="id" paramProperty="id"/>
	<display:footer>
