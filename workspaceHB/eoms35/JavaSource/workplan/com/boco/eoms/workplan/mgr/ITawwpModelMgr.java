...
public interface ITawwpModelMgr {
     ...
     * @param _fileFlag    =======
     * @param _fileFlag
     * @param fileFlag     >>>>>>> .merge-right.r12161
     *                     >>>>>>> .merge-right.r7971
     *                     =======
     *                     String 创建�?
     * @param _fileFlag    >>>>>>> .merge-right.r5591
     * @param isWeekend
     * @param isHoliday
     * @param userId
     * @throws TawwpException 异常信息
     ...
     * @param executeDay
     * @param monthFlag
     * @throws TawwpException 重写方法。保存模板执行项。添加一个选择周期为月以上的选择的月份monthFlag
     */
    public void addModelExecute(String _name, String _botype, String _executedeptlevel, String _appdesc, String _modelPlanId,
                                String _groupId, String _cycle, String _remark, String accessories, String _formId,
                                String _format, String _cruser, String _isHoliday,
     ...
     * @param _sendDeptId      String 发送部�?
     * @param _sendUser        String 发送人
     * @param _content         String 派发信息
     * @param _modelDispatchId String 父派发信息标�?
     * @throws TawwpException 异常信息
     */
     ...
     * @param _parentModelGroupId String 父作业计划模版组织信息标�?
