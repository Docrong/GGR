            ...
            <div class="history-item"><!-- add space to hack ie-->&nbsp;
                ...
                <div class="history-item-content hide">
  			      ...
  			      <%} %> -->
                        ...
                        <tr>
                            <td class="column-title">
                                <bean:message bundle="arithmeticmodify" key="arithmeticmodify.linkAuditResult"/>
                            </td>
                        ...
                        <tr>
                            <td class="column-title">
                                <bean:message bundle="arithmeticmodify" key="arithmeticmodify.linkAuditIdea"/>
                            </td>
                            <td class="column-content" colspan="3">
                        ...
                        <tr>
                            <td class="label"><bean:message bundle="arithmeticmodify"
                                                            key="arithmeticmodify.linkTaskComplete"/></td>
                            <td class="column-content" colspan="3">
                        ...
                        <tr>
                            <td class="column-title">
                                <bean:message bundle="arithmeticmodify" key="arithmeticmodify.fenpairesion"/>
                            </td>
                            <td class="column-content" colspan="3">
                                <pre><bean:write name="baselink" property="linkTaskComplete" scope="page"/></pre>
                            </td>
                        ...
                        <tr>
                            <td class="column-title">
                                <bean:message bundle="arithmeticmodify" key="arithmeticmodify.yijiaoresion"/>
                            </td>
                            <td class="column-content" colspan="3">
                                <pre><bean:write name="baselink" property="linkTaskComplete" scope="page"/></pre>
                            </td>
                        ...
                        <tr>
                            <td class="column-title">
                                <bean:message bundle="arithmeticmodify" key="arithmeticmodify.advice"/>
                            </td>
                            <td class="column-content" colspan=3>
                                <pre><bean:write name="baselink" property="linkTaskComplete" scope="page"/></pre>
                            </td>
