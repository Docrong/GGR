...
String sheetKey = (String) request.getParameter("sheetKey");
 ...
 %>
     ...
     <input type="hidden" name="${sheetPageName}mainClassName" value="com.boco.eoms.sheet.softwareLoad.model.SoftwareLoadMain"/>	<!--main\u8868Model\u5bf9\u8c61\u7c7b\u540d-->	
     <input type="hidden" name="${sheetPageName}linkClassName" value="com.boco.eoms.sheet.softwareLoad.model.SoftwareLoadLink"/> <!--link\u8868Model\u5bf9\u8c61\u7c7b\u540d--> 
     ...
     <input type="hidden" name="${sheetPageName}TKID" id="${sheetPageName}TKID" value=""/>
...
<%@ include file="/WEB-INF/pages/wfworksheet/softwareLoad/baseinputlinkhtmlnew.jsp"%>
     ...
     <tr>
      ...
      <logic:iterate id="toTask" name="toOperaterList" type="com.boco.eoms.sheet.softwareLoad.model.SoftwareLoadTask">  
        <tr>
          <td>
	       ...
	       <td class="label">
			...
			<td colspan="3"> 
		           <textarea name="${sheetPageName}remark" class="textarea max" id="${sheetPageName}remark" 
		              alt="width:500,allowBlank:false,maxLength:2000,vtext:'${eoms:a2u('请填入意见，最多输入1000字')}'" alt="width:'500px'">${sheetlink.remark}</textarea>
		  </td>
		</tr>
		</table>
