...
<div id="sheetform">
    <html:form action="/groupcomplaint.do?method=performFroceHold" styleId="theform">
   ...
   if(operateType != null){
      ...
      %>
            ...
            <input type="hidden" name="${sheetPageName}linkClassName"
                   value="com.boco.eoms.sheet.groupcomplaint.model.GroupComplaintLink"/> <!--linkè¡¨Modelå¯¹è±¡ç±»å-->
