...
<input type="hidden" name="${sheetPageName}processTemplateName" value="SoftwareLoadMainFlowProcess"/>
...
<table class="formTable">
    ...
    <tr>
        <td class="label"><bean:message bundle="softwareLoad" key="softwareLoad.mainRemark"/>*</td>
        <td colspan="3" class="content">
    ...
    <tr>
        ...
        <td colspan="3">
            ...
            <eoms:attachment name="sheetMain" property="sheetAccessories"
                             scope="request" idField="${sheetPageName}sheetAccessories" appCode="softwareLoad"/>
        </td>
    </tr>
</table>
