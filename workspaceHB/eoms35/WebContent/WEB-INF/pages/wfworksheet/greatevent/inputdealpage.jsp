...
<table class="formTable">
    ...
    <tr>
        ...
        <td colspan="3">
            <textarea class="textarea max" name="${sheetPageName}linkPermisResult" id="${sheetPageName}linkPermisResult"
                      defaultValue="${sheetLink.linkPermisResult}"
    ...
    <tr>
        ...
        <td colspan="3">
            <textarea class="textarea max" name="${sheetPageName}linkSencePerformSummary"
                      id="${sheetPageName}linkSencePerformSummary" defaultValue="${sheetLink.linkSencePerformSummary}"
    ...
    <tr>
        ...
        <td colspan="3">
            <eoms:comboBox name="${sheetPageName}linkIfStartChangeProcess" id="${sheetPageName}linkIfStartChangeProcess"
                           ...
                           defaultValue="${sheetLink.linkIfStartChangeProcess}" onchange="popOtherFlow1(this.value);"/>
            <html:button styleClass="btn" style="display:none" property="method.save" styleId="startCircuit"
