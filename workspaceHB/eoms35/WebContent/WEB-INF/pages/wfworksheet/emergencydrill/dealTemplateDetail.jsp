...
<html:form action="/emergencydrill.do" styleId="theform">
    ...
    <input type="hidden" name="${sheetPageName}mainClassName"
           value="com.boco.eoms.sheet.emergencydrill.model.EmergencyDrillMain"/> <!--main表Model对象类名-->
    <input type="hidden" name="${sheetPageName}linkClassName"
           value="com.boco.eoms.sheet.emergencydrill.model.EmergencyDrillLink"/> <!--link表Model对象类名-->
        ...
        <tr>
            ...
            <td colspan='3'>
                <eoms:attachment idList="" idField="${sheetPageName}linkTechnicalprogram" name="sheetLink"
                                 property="linkTechnicalprogram" appCode="emergencydrillsheet" alt="allowBlank:true"/>
            </td>
        </tr>
        <%
                }
        ...
        <tr>
            ...
            <td colspan='3'>
                <eoms:attachment idList="" idField="${sheetPageName}linkRequirementDetail"
                                 property="linkRequirementDetail" name="sheetLink" appCode="emergencydrillsheet"
