...
<%@ include file="/WEB-INF/pages/wfworksheet/businessbackout/baseinputlinkhtmlnew.jsp"%>
 <html:form action="/businessbackout.do" styleId="theform">       
	<br/>
               ...
               <input type="hidden" name="${sheetPageName}mainClassName" value="com.boco.eoms.sheet.businessbackout.model.businessbackoutMain"/>	<!--main表Model对象类名-->	
               <input type="hidden" name="${sheetPageName}linkClassName" value="com.boco.eoms.sheet.businessbackout.model.businessbackoutLink"/> <!--link表Model对象类名-->
		   ...
		   <%}else if(taskName.equals("ExcuteHumTask")){%>  
		     ...
		     <%}else if(operateType.equals("4")){ //驳回%>
    	        ...
    	        <tr>
			     ...
			     <td colspan="3"><textarea name="${sheetPageName}rejectReason" class="textarea max" id="${sheetPageName}rejectReason" alt="width:'500px'">${sheetLink.rejectReason}</textarea></td>
		      </tr> 
		     <%}else if(operateType.equals("205")){ //回复%>
        	  	...
        	  	<tr>
		           ...
		           <td class="content"><input type="text" class="text" value="${sheetLink.ndeptContact}" name="${sheetPageName}ndeptContact" id="${sheetPageName}ndeptContact" alt="allowBlank:false,vtext:'${eoms:a2u('请输入网络部门联系人电话！')}'"/></td>
		           <td class="label"><bean:message bundle="businessbackout" key="businessbackout.ndeptContactPhone"/>*</td>
		           <td class="content"><input type="text" class="text" value="${sheetLink.ndeptContactPhone}" name="${sheetPageName}ndeptContactPhone" id="${sheetPageName}ndeptContactPhone" alt="allowBlank:false,vtext:'${eoms:a2u('请输入网络部门联系人电话！')}'"/></td>
		          </tr>
		          <tr>
		            <td  class="label"><bean:message bundle="businessbackout" key="businessbackout.dealResult"/>*</td>
		            <td  class="content" colspan="3"><eoms:comboBox defaultValue="${sheetLink.dealResult}" name="${sheetPageName}dealResult" id="${sheetPageName}dealResult" initDicId="1011007"  alt="allowBlank:true" styleClass="select-class" alt="allowBlank:false,vtext:'${eoms:a2u('请选择处理结果！')}'"/></td>
		          </tr>
			      <tr>
		            <td  class="label"><bean:message bundle="businessbackout" key="businessbackout.dealDesc"/></td>
		            <td  colspan="3"><textarea class="textarea max" name="${sheetPageName}dealDesc" id="${sheetPageName}dealDesc" alt="width:500,allowBlank:true">${sheetLink.dealDesc}</textarea></td>
		            </tr>			      
	 		 ...
	 		 <tr>
			    ...
			    <td colspan="3">
			      <eoms:comboBox name="${sheetPageName}holdStatisfied" 
			        id="${sheetPageName}holdStatisfied" defaultValue="${sheetMain.holdStatisfied}" initDicId="10303" styleClass="select" alt="allowBlank:false,vtext:'${eoms:a2u('请选择归档满意度！')}'"/>
			    </td>
			  </tr>
