...
<html:form action="/processchange.do" styleId="theform">
    ...
    <table class="formTable">
        ...
        <tr>
            ...
            <td colspan="3">
                <eoms:comboBox name="${sheetPageName}linkIfInvoke" id="${sheetPageName}linkIfInvoke"
                               ...
                               defaultValue="${sheetLink.linkIfInvoke}"/>
            </td>
        </tr>
        <%} %>
        <tr>
            ...
            <td colspan="3">
                <textarea class="textarea max" name="${sheetPageName}linkReleaseDesc"
                          id="${sheetPageName}linkReleaseDesc"
        ...
        <tr>
            ...
            <td colspan="3">
                <textarea class="textarea max" name="${sheetPageName}linkEvaluateDesc"
                          id="${sheetPageName}linkEvaluateDesc"
