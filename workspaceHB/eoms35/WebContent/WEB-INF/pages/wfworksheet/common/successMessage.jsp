    ...
    <div class="content">
        <ul>
            ...
            <logic:present name="dealOperateListUrl">
                <li><a href="${dealOperateListUrl}"><bean:message bundle="sheet"
                                                                  key="worksheet.success.backDealOperateList"/></a></li>
            </logic:present>

            <logic:present name="dealTemplateListUrl">
                <li><a href="${dealTemplateListUrl}"><bean:message bundle="sheet"
                                                                   key="worksheet.success.backDealTemplateList"/></a>
                </li>
            </logic:present>
        </ul>
    </div>
