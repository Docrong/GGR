...
<table class="formTable"> 
	    ...
	    <tr>
	      ...
	      <tr>
		      ...
		      <td class="content" colspan="3"><pre><bean:write name="sheetMain" property="mainSafetyStatement" scope="request"/></pre></td>
		</tr>
   </table>
...
<div class="sheet-deal">
	...
	<%if(taskName.equals("EvaluateTask")){%>	
		<select id="dealSelector">
		 ...
		 <%if(ifwaitfor.equals("false")) {%>	
		  <option value="${urlShowEvaluateTaskDealPage}"><bean:message bundle="securityevaluate" key="operateType.security"/></option>	  
	...
	<% }else if(taskName.equals("AuditTask")){ %>
		<select id="dealSelector">
		 ...
		 <%if(ifsub.equals("") || ifsub.equals("false")){%>
		 <%if(ifwaitfor.equals("false")) {%>	    
		  <option value="${urlShowAuditTaskDealPage}"><bean:message bundle="securityevaluate" key="operateType.audit"/> </option>
		...
		<%}else if(taskName.equals("DraftTask")){%>	
			<select id="dealSelector">
			  <option value="${urlShowDraftDeal}"><bean:message bundle="securityevaluate" key="operateType.draft"/></option>
			</select>			
	   ...
	   <%}else if(taskName.equals("HoldTask")){ %>
			<select id="dealSelector">
			  <option value="${urlShowHoldDealPage}"><bean:message bundle="securityevaluate" key="operateType.hold"/></option>
			  <option value="${urlShowRejectBackDealPage}"><bean:message bundle="securityevaluate" key="operateType.back"/></option>
			</select>		
		<%} %>
		</td>
		</tr>
