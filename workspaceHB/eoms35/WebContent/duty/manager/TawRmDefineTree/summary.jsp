...
<%@ page language="java"
         import="java.util.*,org.apache.struts.util.*,com.boco.eoms.common.util.StaticMethod,com.boco.eoms.jbzl.model.*" %>
            ...
            <td>
                <table height="30" cellpadding="1" cellspacing="1" border="0" width="100%" class="table_show">
                    ...
                    <tr align="center" class="tr_show">
                        ...
                        <td><a href="RecordSummary.do?month=<%=YearMonth%>&roomId=<%=deptMaproom.get(deptId)%>"
                               target="_blank">
