...
<table class="listTable" width="100%" cellpadding="0" cellspacing="0">
    ...
    <logic:iterate id="plan" name="planList" type="com.boco.eoms.sheet.businessplan.model.BusinessPlanMain">
        <tr>
            <td class="content">
                <a href="${app}/sheet/businessplan/businessplan.do?method=showDetailPage&sheetKey=${plan.id}"
                   target="_blank"><bean:write name="plan" property="sheetId" scope="page"/></a>
            ...
            <td class="content">
                <bean:write name="plan" property="sheetAcceptLimit" formatKey="date.formatDateTimeAll" bundle="sheet"
                            scope="page"/>&nbsp;
            </td>
            <td class="content">
                <bean:write name="plan" property="sheetCompleteLimit" formatKey="date.formatDateTimeAll" bundle="sheet"
                            scope="page"/>&nbsp;
            </td>
            <td class="content">
...
<table class="listTable" width="100%" cellpadding="0" cellspacing="0">
    ...
    <logic:iterate id="pilot" name="pilotList" type="com.boco.eoms.sheet.businesspilot.model.BusinessPilotMain">
        <tr>
            <td class="content">
                <a href="${app}/sheet/business/businesspilot.do?method=showDetailPage&sheetKey=${pilot.id}"
                   target="_blank"><bean:write name="pilot" property="sheetId" scope="page"/></a>
            ...
            <td class="content">
                <bean:write name="pilot" property="sheetAcceptLimit" formatKey="date.formatDateTimeAll" bundle="sheet"
                            scope="page"/>&nbsp;
            </td>
            <td class="content ">
                <bean:write name="pilot" property="sheetCompleteLimit" formatKey="date.formatDateTimeAll" bundle="sheet"
                            scope="page"/>&nbsp;
            </td>
            <td class="content">
...
<table class="listTable" width="100%" cellpadding="0" cellspacing="0">
    ...
    %>
    <logic:iterate id="operate" name="operationList"
                   type="com.boco.eoms.sheet.businessoperation.model.BusinessOperationMain">
        <tr>
            <td class="content">
                <a href="${app}/sheet/businessoperation/businessoperation.do?method=showDetailPage&sheetKey=${operate.id}"
                   target="_blank"><bean:write name="operate" property="sheetId" scope="page"/></a>
            </td>
            <td class="content">
            ...
            <td class="content">
                <bean:write name="operate" property="sheetAcceptLimit" formatKey="date.formatDateTimeAll" bundle="sheet"
                            scope="page"/>&nbsp;
            </td>
            <td class="content ">
                <bean:write name="operate" property="sheetCompleteLimit" formatKey="date.formatDateTimeAll"
