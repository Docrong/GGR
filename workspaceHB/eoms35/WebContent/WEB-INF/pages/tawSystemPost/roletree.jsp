    ...
    <tr>
        <td width="250" align="center" valign="top">
            ...
            <div id="tree" align="left">
                ...
                <bean:define id="posttypeName" name="tawSystemPostForm" property="posttypeName"
                                ...
                                <table align="center" border="0" width="95%" cellspacing="0">
                                    <tr>
                                        <td width="100%" class="table_title" align="center">
                                            <b>&nbsp;&nbsp;<bean:message key="label.view"/>&nbsp;</b>　
                                        </td>
                                    </tr>
                                </table>
                                <table border="0" width="95%" cellspacing="1" cellpadding="1" class="table_show"
                                       align=center>
                                    <tr class="tr_show">
                                        <td width="30%" class="clsfth" height="25">&nbsp;<bean:message
                                                key="OrgPost.postName"/></td>
                                        <td width="70%" height="25"><bean:write name="orgPostForm" property="postName"
                                                                                scope="request"/></td>
                                    </tr>
                                    <tr class="tr_show">
                                        <td width="30%" class="clsfth" height="25">&nbsp;<bean:message
                                                key="OrgPost.posttypeName"/></td>
                                        <td width="70%" height="25"><bean:write name="orgPostForm"
                                    ...
                                    <%}%>
                                    <tr class="tr_show">
                                        <td width="30%" height="25" class="clsfth">&nbsp;<bean:message
                                                key="OrgPost.notes"/>
                                        </td>
                                        <td width="70%" height="25">
                                    ...
                                    <tr class="tr_show">
                                        ...
                                        <td width="70%" height="25">
                                            ...
                                            <div id="sort1_text">
                                                ...
                                                %>
                                                <img src='<%=path%>/assess/configbox/roleListBox/images/user.gif'
                                                     align=absmiddle><span id='tr_userid_<%=userIds[i]%>'
                                                                           style="width: 40%"><%=postNames[i]%></span>
                                                <%
                                                        }
                                                    }
                                                %>
                                    ...
                                    <tr>
                                        <td width="100%" align="right" height="32">
                                            ...
                                            <INPUT id=button type=button value=
                                                <bean:message key="label.roleMembers"/> name=button
                                                   Onclick="selectMembers()" class="clsbtn2">
                                            &nbsp;&nbsp;
                                            <INPUT id=button type=button value=
                                                <bean:message key="label.add"/> name=button
                                                   Onclick="window.location.href ='addFromTree.do?postId=<%=test%>&posttypeId=<%=posttypeId%>&posttypeName=<%=posttypeName%>'"
                                                   class="clsbtn2">
                                            &nbsp;&nbsp;
                                            <INPUT id=button type=button value=
                                                <bean:message key="label.edit"/> name=button
                                                   Onclick="window.location.href ='editFromTree.do?postId=<%=test%>&parentId=<%=parent%>&posttypeId=<%=posttypeId%>&posttypeName=<%=posttypeName%>'"
                                                   class="clsbtn2">
                                            &nbsp;&nbsp;
                                            <INPUT id=button type=button value=
                                                <bean:message key="label.remove"/> name=button Onclick="remove()"
                                                   class="clsbtn2">
                                            &nbsp;&nbsp;
                                        </td>
                                    </tr>
