        ...
        <script type="text/javascript">
            ...
            Ext.onReady(function () {
                ...
                deptTree = new xbox({
                    ...
                    treeChkMode: '',
                    treeChkType: 'dept',
                    showChkFldId: 'sort1_text',
                    saveChkFldId: 'sort1_deptid',
                    viewer: deptViewer
                });
        ...
        <script type="text/javascript">
            ...
            Ext.onReady(function () {
                ...
                deptTree1 = new xbox({
                    ...
                    treeChkMode: '',
                    treeChkType: 'dept',
                    showChkFldId: 'sort2_text',
                    saveChkFldId: 'sort2_deptid',
                    viewer: deptViewer1
                });
            ...
            <TR>
                ...
                <td>
                    <textarea rows="3" cols="68" class="textarea max" name='report' id='report' style="cursor:hand"
                              onclick="showReportTree(this.name,'checkbox','accept',false,true,false);"
                              type="_moz">不选择</textArea>
