...
<div id="sheetform">
    <html:form action="/focusresourceerrata.do?method=performDealReplyReject" styleId="theform">
        <%
        ...
        <input type="hidden" name="subtaskName" value="FocusResourceErrataSubTask"/>
        ...
        <input type="hidden" name="taskNamespace" value="http://FocusResourceErrata"/>
