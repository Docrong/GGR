...
<script type="text/javascript">
    function showPage() {
        var pars = '';
        var url = '';
        url = '${app}/sheet/businessplan/businessplan.do?method=showInputRejectPage&piid=${sheetMain.piid}&taskId=${taskId}&taskName=${taskName}';
        if (url != '') {
...
<div id="sheetform">
    <html:form action="/businessplan.do?method=performDeal" styleId="theform">
