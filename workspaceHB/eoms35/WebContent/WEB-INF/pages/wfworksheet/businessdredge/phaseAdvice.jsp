...
<div id="sheetform">
    <html:form action="/businessdredge.do?method=performProcessEvent" styleId="theform">
        <%@ include file="/common/taglibs.jsp" %>
        <%
        ...
        <input type="hidden" name="${sheetPageName}processTemplateName" id="${sheetPageName}processTemplateName"
               value="BusinessDredgeMainFlowProcess"/>
        ...
        <%@ include file="/WEB-INF/pages/wfworksheet/businessdredge/baseinputlinkhtml.jsp" %>
        <table class="listTable">
            <logic:present name="toOperaterList" scope="request">
                <logic:iterate id="toTask" name="toOperaterList"
                               type="com.boco.eoms.sheet.businessdredge.task.impl.BusinessDredgeTask">
                    <tr>
                        <td>
