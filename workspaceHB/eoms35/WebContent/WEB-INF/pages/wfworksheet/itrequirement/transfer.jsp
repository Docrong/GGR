...
<div id="sheetform">
    <html:form action="/itrequirement.do?method=performTransferWorkItem" styleId="theform">
        ...
        <input type="hidden" name="${sheetPageName}beanId" id="${sheetPageName}beanId"
               value="iITRequirementMainManager"/>
        <input type="hidden" name="${sheetPageName}mainClassName" id="${sheetPageName}mainClassName"
               value="com.boco.eoms.sheet.itrequirement.model.ITRequirementMain"/> <!--mainè¡¨Modelå¯¹è±¡ç±»å-->
        <input type="hidden" name="${sheetPageName}linkClassName" id="${sheetPageName}linkClassName"
               value="com.boco.eoms.sheet.itrequirement.model.ITRequirementLink"/> <!--linkè¡¨Modelå¯¹è±¡ç±»å-->
