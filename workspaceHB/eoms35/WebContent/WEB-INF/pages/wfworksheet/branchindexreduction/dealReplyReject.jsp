...
<div id="sheetform">
    <html:form action="/branchindexreduction.do?method=performDealReplyReject" styleId="theform">
        <%
        ...
        <input type="hidden" name="subtaskName" value="BranchIndexReductionSubTask"/>
        ...
        <input type="hidden" name="taskNamespace" value="http://BranchIndexReduction"/>
