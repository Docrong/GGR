...
<script type="text/javascript">
	var config = {			
		...
		* Tree Configs
		**************/
		test:"tawWorkbenchDeptContactGroups.do?method=getNodes",
		treeGetNodeUrl:"tawWorkbenchDeptContactGroups.do?method=getNodes",
		treeRootId:'-1',
		...
		**************/
		actions:{
			newNode : {
				btnText:"${eoms:a2u('保存')}",
				url:"tawWorkbenchDeptContactGroups.do?method=xsave",
				init:function(){
					AppSimpleTree.setField("parentId","id");
				}
			},
			getNode : {
				url:"tawWorkbenchDeptContactGroups.do?method=xget"
			},
			edtNode : {
				btnText:"${eoms:a2u('保存修改')}",
				url:"tawWorkbenchDeptContactGroups.do?method=xedit"
			},
			delNode : {
				url:"tawWorkbenchDeptContactGroups.do?method=xdelete"
			}
		},
		fieldOptions : {
			width:150
