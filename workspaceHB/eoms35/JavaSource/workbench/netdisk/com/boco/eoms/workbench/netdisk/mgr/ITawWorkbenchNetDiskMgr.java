...
public interface ITawWorkbenchNetDiskMgr {
     ...
     * 保存文件夹共享信息
     *
     * @param tawWorkbenchNetDiskFolderShare 文件夹共享信息类
     */
     ...
     * 获取某用户共享给我的全部文件夹
     *
     * @param fromUserId 共享来源用户ID
     * @param toUserId   共享目标用户ID
     * @return 共享信息列表
     */
     ...
     *
     * @param fromUserId 共享人ID
     * @param folderPath 文件夹路径(hibernate32位Id)
     * @return 文件夹共享信息
     */
    public TawWorkbenchNetDiskFolderShare getTawWorkbenchNetDiskFolderShare(
     ...
     * 删除文件夹
     *
     * @param rootPath        网络U盘根路径
     * @param folderMappingId 文件夹映射ID
     * @param userId          用户ID
     * @return 删除操作结果
     */
     ...
     * 删除某用户某文件夹的所有共享信息
     *
     * @param folderPath 文件夹路径(真实的相对路径,即映射表的Id)
     * @param fromUserId 共享人ID
     */
     ...
     * 保存上传的文件信息到数据库
     *
     * @param tawWorkbenchNetDiskFile 文件类
     */
