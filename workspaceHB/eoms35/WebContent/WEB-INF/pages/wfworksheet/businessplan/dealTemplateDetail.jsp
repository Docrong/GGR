...
<html:form action="/businessplan.do" styleId="theform">
    ...
    <input type="hidden" name="${sheetPageName}mainClassName"
           value="com.boco.eoms.sheet.businessplan.model.BusinessPlanMain"/> <!--main表Model对象类名-->
    <input type="hidden" name="${sheetPageName}linkClassName"
           value="com.boco.eoms.sheet.businessplan.model.BusinessPlanLink"/> <!--link表Model对象类名-->
        ...
        <tr>
            ...
            <td colspan="3">
                <textarea class="textarea max" name="${sheetPageName}linkAnalyse" id="${sheetPageName}linkAnalyse"
                          alt="width:500,allowBlank:true">${sheetLink.linkAnalyse}</textarea>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td colspan="3">
                <eoms:comboBox name="${sheetPageName}linkIsKx" id="${sheetPageName}linkIsKx"
                               initDicId="10306" alt="allowBlank:true" styleClass="select-class"
        ...
        <tr>
            ...
            <td colspan="3">
                <textarea class="textarea max" name="${sheetPageName}linkAuditDesc" id="${sheetPageName}linkAuditDesc"
                          alt="width:500,allowBlank:true">${sheetLink.linkAuditDesc}</textarea>
            </td>
        </tr>
        <%
                }
        ...
        <tr>
            ...
            <td colspan="3">
                <textarea class="textarea max" name="${sheetPageName}linkOpion" id="${sheetPageName}linkOpion"
                          alt="width:500,allowBlank:true">${sheetLink.linkOpion}</textarea>
            </td>
        </tr>
        <tr>
            <td class="label"><bean:message bundle="businessplan" key="businessplan.linkOpionReport"/>*</td>
            <td colspan='3'>
                <eoms:attachment name="sheetLink" property="linkOpionReport" idList=""
                                 idField="${sheetPageName}linkOpionReport"
                                 property="linkOpionReport" scope="request" appCode="businessplan"
                                 alt="allowBlank:false"/>
            </td>
        </tr>
