                    ...
                    <table class="formTable">
                        ...
                        <tr>
                            <td class="label"><bean:message bundle="techniquesupporthb"
                                                            key="techniquesupporthb.mainNetSort1"/></td>
                            <td class="content">
                                <eoms:id2nameDB id="${sheetMain.mainNetSort1}" beanId="ItawSystemDictTypeDao"/>
                            </td>
                            <td class="label"><bean:message bundle="techniquesupporthb"
                                                            key="techniquesupporthb.mainNetSort2"/></td>
                            <td class="content">
                        ...
                        <tr>
                            <td class="label"><bean:message bundle="techniquesupporthb"
                                                            key="techniquesupporthb.mainNetSort3"/></td>
                            <td class="content">
                                <eoms:id2nameDB id="${sheetMain.mainNetSort3}" beanId="ItawSystemDictTypeDao"/>
                            </td>
                            <td class="label"><bean:message bundle="techniquesupporthb"
                                                            key="techniquesupporthb.mainTaskType"/></td>
                            <td class="content">
                        ...
                        <tr>
                            <td class="label"><bean:message bundle="techniquesupporthb"
                                                            key="techniquesupporthb.mainTaskDescription"/></td>
                ...
                <tr>
                    ...
                    <td class="content">
                        <select id="dealSelector" onchange="checkValue(this)" alt="allowBlank:false,vtext:'请选择处理操作'">
                            <option value=""></option>
                            <option value="Receive"><bean:message bundle="techniquesupporthb"
                                                                  key="techniquesupporthb.dealrejectpass"/></option>
                            <option value="ExcuteHumTask"><bean:message bundle="techniquesupporthb"
                                                                        key="techniquesupporthb.nopassback"/></option>
                        </select>
                    </td>
                    <td class="label"></td>
                    <td class="content">
