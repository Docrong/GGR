...
<center>
    <form name="form2" method="post" action="${app}/wapLogin.do?method=wapSaveSession">
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="login_bg">
            ...
            <tr>
                <td align="center"><img src="${app}/wap/images/logo.gif"/></td>
            </tr>
                    ...
                    <table class="login_table">
                        ...
                        <tr>
                            ...
                            <td>
                                <input name="j_username" type="text"
                                       value="<%=WapUtil.getValue4Cookie(WAPConstants.WAP_COOKIE_LOGIN_NAME,request.getCookies()) %>"
                        ...
                        <tr>
                            <td colspan="2" class="table_td">
                                <input name="Submit" type="submit" value='<bean:message key="wap.loginSubmit" />'
                                       class="btn"/> &nbsp
                                <input name="Button" type="button" value='<bean:message key="button.remberPassword" />'
                                       class="btn"
