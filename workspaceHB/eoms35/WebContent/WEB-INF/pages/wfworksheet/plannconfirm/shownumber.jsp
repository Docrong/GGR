...
<div id="sheetform">
	<html:form action="/plannconfirm.do?method=searchNumber" styleId="theform">	
          ...
          <tr>
	            ...
	            <td width="100%">
	                ...
	                <input type="text" class="text" name="sendTimeStartDate" readonly="readonly" 
							...
							onclick="popUpCalendar(this, this, null, null, null, true, -1)" alt="vtype:'lessThen',link:'sendTimeEndDate',vtext:'开始时间不能晚于结束时间',allowBlank:false"/> &nbsp;&nbsp;
					...
					<input type="text" class="text" name="sendTimeEndDate" readonly="readonly" 
							...
							onclick="popUpCalendar(this, this, null, null, null, true, -1)" alt="vtype:'moreThen',link:'sendTimeStartDate',vtext:'结束时间不能早于开始时间',allowBlank:false"/>
	            </td>
          </tr>
          <!-- 统计类型  -->
          <tr>
