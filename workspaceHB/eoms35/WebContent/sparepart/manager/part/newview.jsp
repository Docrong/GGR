    ...
    <form method="post" action="../part/add.do" name="frm" enctype="multipart/form-data">
        ...
        <table border="0" width="80%" cellspacing="1" cellpadding="1" align=center>
            <tr class="tr_show_left">
                <td>
                    ${eoms:a2u('您当前操作的仓库是：')}<font color="red"><bean:write name="storage_dept_name"
                                                                           scope="session"/></font>&nbsp;&nbsp;${eoms:a2u('的')}<b>&nbsp;&nbsp;<font
                        color="blue"><bean:write name="storage" scope="session"/></font></b>
                </td>
            </tr>
        </table>
        <table border="0" width="80%" cellspacing="1" cellpadding="1" class="table_show" align=center>
            ...
            <tr class="tr_show">
                <td class="clsfth" width="30%" height="25">
                    <p style="margin-top: 0; margin-bottom: 0"><bean:message
                            key="sparepart.department"/>${eoms:a2u('：')}</p>
                </td>
            ...
            <tr class="tr_show">
                <td class="clsfth" width="30%" height="25">
                    <p style="margin-top: 0; margin-bottom: 0"><bean:message
                            key="sparepart.necode"/>${eoms:a2u('：')}</p>
                </td>
                <td width="70%" height="25" colspan="2">
            ...
            <tr class="tr_show">
                ...
                <td width="70%" height="25" colspan="2">
                    <input type="text" size="35" maxlength="40"
                           value="<%=StaticMethod.null2String(sparepartForm.getEname())%>" name="ename">
                    <font color="#FF0000">**</font>
                </td>
            </tr>
            ...
            <tr class="tr_show">
                ...
                <td width="70%" height="25" colspan="2">
                    <input type="text" value="<%=StaticMethod.null2String(sparepartForm.getProductcode())%>"
                           name="productcode" size="35" maxlength="40">
                    <font color="#FF0000">**</font>
                </td>
            </tr>
            <tr class="tr_show">
                ...
                <td width="70%" height="25" colspan="2">
                    <input type="text" size="35" value="<%=StaticMethod.null2String(sparepartForm.getManagecode())%>"
                           name="managecode">
            ...
            <tr class="tr_show">
                ...
                <td width="70%" height="25" colspan="2">
                    <input type="text" value="<%=StaticMethod.null2String(sparepartForm.getSerialno())%>"
                           name="serialno" size="35" maxlength="40">
                    <font color="#FF0000">**</font>
                </td>
            </tr>
            <tr class="tr_show">
                ...
                <td width="70%" height="25" colspan="2">
                    <input type="text" size="35" value="<%=StaticMethod.null2String(sparepartForm.getObjtype())%>"
                           name="objtype">
                </td>
            </tr>
            ...
            <tr class="tr_show" style="display:none">
                ...
                <td width="70%" height="25" colspan="2">
                    <input id="radio0" type="radio" value="11" name="state"
                           onclick="changeType(this.value);"/>${eoms:a2u('新件')}
                    <input id="radio1" type="radio" value="12" name="state"
                           onclick="changeType(this.value);"/>${eoms:a2u('故障')}
                    <input id="radio2" type="radio" value="19" name="state"
                           onclick="changeType(this.value);"/>${eoms:a2u('调拨')}
                </td>
            </tr>
            <tr class="tr_show">
                <td class="clsfth" width="30%" height="25">
            ...
            <tr class="tr_show">
                ...
                <td width="70%" height="25" colspan="2">
                    <input type="text" size="35"
                           value="<%=StaticMethod.null2String(sparepartForm.getRepair_endtime())%>"
                           name="repair_endtime">
                </td>
            </tr>
            <tr class="tr_show">
                ...
                <td width="70%" height="25" colspan="2">
                    <input type="text" size="35" value="<%=StaticMethod.null2String(sparepartForm.getRepairtime())%>"
                           name="repairtime">
                </td>
            </tr>
            <tr class="tr_show">
            ...
            <tr class="tr_show">
                ...
                <td width="70%" height="25" colspan="2">
                    <input type="text" size="35" value="<%=StaticMethod.null2String(sparepartForm.getCompany())%>"
                           name="company">
                </td>
            </tr>
            <tr class="tr_show">
                ...
                <td width="70%" height="25" colspan="2">
                    <input type="text" size="35" value="<%=StaticMethod.null2String(sparepartForm.getContract())%>"
                           name="contract" maxlength="40">
                </td>
            </tr>
            <tr class="tr_show">
                <td class="clsfth" width="30%" height="25">
                ...
                <td width="70%" height="25" colspan="2">
                    <input type="text" size="35" value="<%=StaticMethod.null2String(sparepartForm.getMoney())%>"
                           name="money" maxlength="40">
                </td>
            </tr>
            ...
            <tr class="tr_show" id="sheettype">
                ...
                <td width="70%" height="25" colspan="2">
                    ...
                    <input type="text" size="35" value="<%=StaticMethod.null2String(sparepartForm.getSheetid())%>" name="sheetid" readonly="readonly" />
										...
										--%>
                    <input type="text" size="35" value="<%=StaticMethod.null2String(sparepartForm.getSheetid())%>"
                           name="sheetid" maxlength="40"/>
                </td>
            </tr>
            <tr class="tr_show" id="accessorytype">
                ...
                <td width="70%" height="25" colspan="2">
                    <input type="file" size="35" value="<%=StaticMethod.null2String(sparepartForm.getAccessory())%>"
                           name="theFile">
                </td>
            </tr>
            <tr class="tr_show">
                <td class="clsfth" width="30%" height="25">
                    <p style="margin-top: 0; margin-bottom: 0">${eoms:a2u('备件存放位置：')}</p>
                </td>
                <td width="70%" height="25" colspan="2">
                    <input type="text" size="35" value="<%=StaticMethod.null2String(sparepartForm.getPosition())%>"
                           name="position">
                </td>
            </tr>
            ...
            <tr class="tr_show">
                <td class="clsfth" width="30%" height="25">
                    <p style="margin-top: 0; margin-bottom: 0"><bean:message
                            key="sparepart.supplier"/>${eoms:a2u('：')}</p>
                </td>
                <td width="70%" height="25" colspan="2">
                    <select name="supplier" size="1" style="FONT-SIZE: 8pt" style="width: 6.8cm;">
                        ...
                        %>
                        <option value="<%=tawClassMsg.getId()%>" selected="selected"><%=tawClassMsg.getCname()%>
                        </option>
                        <%} else {%>
                        <option value="<%=tawClassMsg.getId()%>"><%=tawClassMsg.getCname()%>
                        </option>
                        <%
                                }
                            }
            ...
            <tr class="tr_show">
                ...
                <td width="70%" height="25" colspan="2">
                    <input type="text" size="35" value="<%=StaticMethod.null2String(sparepartForm.getFixe())%>"
                           name="fixe">
                </td>
            </tr>
            <tr class="tr_show">
            ...
            <tr class="tr_show">
                ...
                <td width="70%" height="25" colspan="2">
                    <input type="text" size="35" value="<%=StaticMethod.null2String(sparepartForm.getNote())%>"
                           maxlength="60" name="note">
            ...
            <tr class="tr_show">
                <td class="clsfth" width="30%" height="25">
                    <p style="margin-top: 0; margin-bottom: 0">${eoms:a2u('入库申请人：')}</p>
                </td>
                <td width="70%" height="25" colspan="2">
                    <input type="text" size="35" value="<%=StaticMethod.null2String(sparepartForm.getProposer())%>"
                           name="proposer">
                </td>
            </tr>
        </table>
        <table border="0" width="80%" cellspacing="0">
            <tr>
                <td height="32" align="right">
                    <input type="submit" value="${eoms:a2u('提交审核')}" name="submit" onclick="return checkdata()"
                           class="clsbtn2">
                    &nbsp;&nbsp;
