...
insert into taw_system_application(app_name,notes,domain_type) values('新业务正式实施流�?','新业务正式实施流�?',1);
insert into taw_system_workflow(name,flowid,sheetid,remark,mainservicebeanid) values('BusinessOperationProcess','023','023','新业务正式实施流�?','iBusinessOperationMainManager');
