  ...
  <div id="sheetinfo">
	...
	<tr>
	  ...
	  <tr>
		...
		<td class="content"  colspan='3'><pre><bean:write name="sheetMain" property="mainDescription" scope="request"/></pre></td>	  
	  </tr>
	  
	  <tr>
  		<td class="label"><bean:message bundle="circuitdispatch" key="circuitdispatch.nodeAccessories"/></td>
...
<div class="sheet-deal">
		 ...
		 <%}else if(taskStatus.equals(Constants.TASK_STATUS_CLAIMED)){ %>
			...
			<%if(ifsub.equals("") || ifsub.equals("false")){%>
				...
				<% if (ifwaitfor.equals("false")) {%>
			  		<option value="${urlShowProjectCreateDealPage}"><bean:message bundle="circuitdispatch" key="operateType.ProjectCreateTask"/> </option>
			...
			<%} else { %>
				...
				<!-- 不需要等待回复 -->
				<% if (ifwaitfor.equals("false")) {%>
					<option value="${urlShowDispatchPage}"><bean:message bundle="circuitdispatch" key="operateType.subTaskReply"/></option>
				<%}%>
			<% } %>
		...
		<select id="dealSelector">
		 ...
		 <%}else if(taskStatus.equals(Constants.TASK_STATUS_CLAIMED)){ %>
			...
			<%if(ifsub.equals("") || ifsub.equals("false")){%>
				<!-- 不需要等待回复 -->
				<% if (ifwaitfor.equals("false")) {%>
			  		<option value="${urlShowPermitDealPage}"><bean:message bundle="circuitdispatch" key="operateType.PermitTask"/> </option>
			  		<option value="${urlShowTransferkPage}"><bean:message bundle="sheet" key="common.transfer"/></option>
			  		<option value="${urlShowPhaseReplyPage}"><bean:message bundle="sheet" key="event.reply"/></option>
			 	<%} %>
			<%} else { %>
		...
		<%if(taskStatus.equals(Constants.TASK_STATUS_READY)){%>
		 ...
		 <%}else if(taskStatus.equals(Constants.TASK_STATUS_CLAIMED)){ %>
			...
			<%if(ifsub.equals("") || ifsub.equals("false")){%>
				<!-- 不需要等待回复 -->
				<% if (ifwaitfor.equals("false")) {%>
			  		<option value="${urlShowPlanDealPage}"><bean:message bundle="circuitdispatch" key="operateType.PlanTask"/> </option>
			  		<option value="${urlShowTransferkPage}"><bean:message bundle="sheet" key="common.transfer"/></option>
			  		<option value="${urlShowPhaseReplyPage}"><bean:message bundle="sheet" key="event.reply"/></option>
			 	<%} %>
			<%} else { %>
		...
		<select id="dealSelector">
		 ...
		 <%}else if(taskStatus.equals(Constants.TASK_STATUS_CLAIMED)){ %>
			...
			<%if(ifsub.equals("") || ifsub.equals("false")){%>
				<!-- 不需要等待回复 -->
				<% if (ifwaitfor.equals("false")) {%>
			  		<option value="${urlShowExecuteDealPage}"><bean:message bundle="circuitdispatch" key="operateType.ExecuteTask"/> </option>
			  		<option value="${urlShowTransferkPage}"><bean:message bundle="sheet" key="common.transfer"/></option>
			  		<option value="${urlShowPhaseReplyPage}"><bean:message bundle="sheet" key="event.reply"/></option>
			 	<%} %>
			<%} else { %>
		...
		<select id="dealSelector">
		 ...
		 <%}else if(taskStatus.equals(Constants.TASK_STATUS_CLAIMED)){ %>
			...
			<%if(ifsub.equals("") || ifsub.equals("false")){%>
				<!-- 不需要等待回复 -->
				<% if (ifwaitfor.equals("false")) {%>
			  		<option value="${urlShowValidateDealPage}"><bean:message bundle="circuitdispatch" key="operateType.ValidateTask"/> </option>
			  		<option value="${urlShowTransferkPage}"><bean:message bundle="sheet" key="common.transfer"/></option>
			  		<option value="${urlShowPhaseReplyPage}"><bean:message bundle="sheet" key="event.reply"/></option>
			 	<%} %>
			<%} else { %>
	...
	<%}}else if(taskName.equals("DraftTask")){%>	
		<select id="dealSelector">
		 <option value="${urlShowDraftDealPage}"><bean:message bundle="circuitdispatch" key="operateType.draft"/></option>
		</select>
	...
	<%}else if(taskName.equals("HoldTask")){ %>
		<select id="dealSelector">
		  <option value="${urlShowHoldDealPage}"><bean:message bundle="circuitdispatch" key="operateType.hold"/></option>
	...
	<%}else if(taskName.equals("circuitSubTask1")){ %>
        ...
        <%if(taskStatus.equals(Constants.TASK_STATUS_READY)){%>
		   ...
		   <option value="${urlShowRejectBackPage}"><bean:message bundle="sheet" key="common.rejectBack"/></option>
		 <%}else if(taskStatus.equals(Constants.TASK_STATUS_CLAIMED)){ %>
		  <option value="${urlShowCompleteDealPage}"><bean:message bundle="circuitdispatch" key="operateType.subTaskReply"/>
		  </option>
		  <%} %>
