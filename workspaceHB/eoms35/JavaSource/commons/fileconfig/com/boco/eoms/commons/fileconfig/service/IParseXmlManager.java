...
public interface IParseXmlManager {
     ...
     *
     * @param cls      类
     * @param key      xml mapping配置文件的key值
     * @param filePath xml配置文件路径,包含文件名
     * @return 返回解析的对象
     ...
     * @param key      xml mapping配置文件的key值
     * @throws ParseXMLException 保存出错抛出异常
     */
     ...
     * @param key       xml mapping配置文件的key值
     * @param filePath  xml配置文件路径,包含文件名
     * @param isMapPath 标识key是mapping配置文件的key值还是mapping文件的路径名，true代表是配置文件key值
     * @return 返回解析的对象
     * @throws ParseXMLException
     */
     ...
     *
     * @param cls 类
     * @param key applicationContext-fileconfig.xml的key
     * @return 返回解析的对象
     * @throws ParseXMLException
     */
