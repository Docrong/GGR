...
<div id="sheetform">
<html:form action="/businessbackout.do?method=performProcessEvent" styleId="theform">
 <%@ include file="/common/taglibs.jsp"%>
<%
 ...
 %>
    ...
    <input type="hidden" name="${sheetPageName}linkClassName" value="com.boco.eoms.sheet.businessbackout.model.BusinessBackoutLink"/> <!--link表Model对象类名--> 
 	<input type="hidden" name="${sheetPageName}processTemplateName" id="${sheetPageName}processTemplateName" value="BusinessBackoutMainFlowProcess" />
...
<%@ include file="/WEB-INF/pages/wfworksheet/businessbackout/baseinputlinkhtmlnew.jsp"%>
     <table  class="listTable">
      ...
      <logic:iterate id="toTask" name="toOperaterList" type="com.boco.eoms.sheet.businessbackout.model.BusinessBackoutTask">  
        <tr>
          <td>
