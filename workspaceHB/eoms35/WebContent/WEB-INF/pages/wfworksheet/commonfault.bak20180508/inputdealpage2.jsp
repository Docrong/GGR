        ...
        <%if(operateType.equals("46") || operateType.equals("11") ){ %>
	          ...
	          <%} %>
				...
				<tr>
                   ...
                   value="${eoms:date2String(sheetLink.faultdealTime)}" id="${sheetPageName}faultdealTime" alt="allowBlank:false"/>
					 </td>
	...
	if(('${sheetMain.mainAlarmSolveDate}'=='' || '${sheetMain.mainAlarmSolveDate}'==null) && '${sheetMain.mainCheckStatus}'!='2'){
		document.getElementById('linkFaultAvoidTime').disabled='true';
				...
				<tr>
				  ...
				  <input type="hidden" name="mainAlarmSolveDate2" id="mainAlarmSolveDate" value="${sheetMain.mainAlarmSolveDate}" />	
				    <input type="text" class="text" name="${sheetPageName}linkFaultAvoidTime" readonly="readonly" 
						id="${sheetPageName}linkFaultAvoidTime"  
						 value="${eoms:date2String(sheetLink.linkFaultAvoidTime)}" alt="vtype:'moreThen',link:'${sheetPageName}mainFaultGenerantTime',vtext:'故障消除时间晚于故障发生时间',allowBlank:false"/> 
