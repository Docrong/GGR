...
<div id="sheetform">
    <html:form action="/businesspilot.do?method=performDealReplyReject" styleId="theform">
        ...
        <input type="hidden" name="${sheetPageName}mainClassName"
               value="com.boco.eoms.sheet.businesspilot.model.BusinessPilotMain"/>
        <input type="hidden" name="${sheetPageName}linkClassName"
               value="com.boco.eoms.sheet.businesspilot.model.BusinessPilotLink"/>
                    ...
                    <table class="listTable">
                        <logic:present name="acceptList" scope="request">
                            ...
                            <logic:iterate id="toTask" name="acceptList"
                                           type="com.boco.eoms.sheet.businesspilot.task.impl.BusinessPilotTask">
                                <tr>
                                    <td>
