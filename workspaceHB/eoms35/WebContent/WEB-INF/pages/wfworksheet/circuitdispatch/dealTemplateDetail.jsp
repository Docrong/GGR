...
<html:form action="/circuitdispatch.do" styleId="theform">
    ...
    <input type="hidden" name="${sheetPageName}mainClassName"
           value="com.boco.eoms.sheet.circuitdispatch.model.CircuitDispatchMain"/> <!--main?Model????-->
    <input type="hidden" name="${sheetPageName}linkClassName"
           value="com.boco.eoms.sheet.circuitdispatch.model.CircuitDispatchLink"/> <!--link?Model????-->
    ...
    <table class="formTable">
        ...
        <tr>
            ...
            <td>
                <eoms:comboBox name="${sheetPageName}linkInvolvedProvince" id="${sheetPageName}linkInvolvedProvince"
                               initDicId="1011608" defaultValue="${sheetLink.linkInvolvedProvince}"
                               alt="allowBlank:false"/>
            </td>
            <!-- ?????? -->
            <td class="label"><bean:message bundle="circuitdispatch" key="circuitdispatch.linkInvolvedCity"/>*</td>
            <td>
                <eoms:comboBox name="${sheetPageName}linkInvolvedCity" id="${sheetPageName}linkInvolvedCity"
                               initDicId="1011608" defaultValue="${sheetLink.linkInvolvedCity}" alt="allowBlank:false"/>
            </td>
        </tr>
        <tr>
            <!-- ?????? -->
        ...
        <tr>
            ...
            <td colspan="3">
                <textarea name="linkRiskEvaluate" id="linkRiskEvaluate" class="textarea max"
                          alt="allowBlank:false">${sheetLink.linkRiskEvaluate}</textarea>
            </td>
        </tr>
        <tr>
            <!-- ?????? -->
            ...
            <td colspan="3">
                <textarea name="linkAffectSituation" id="linkAffectSituation" class="textarea max"
                          alt="allowBlank:false">${sheetLink.linkAffectSituation}</textarea>
            </td>
        </tr>
        <tr>
            <!-- ?????? -->
            ...
            <td colspan="3">
                <textarea name="linkProgrammeExplain" id="linkProgrammeExplain" class="textarea max"
                          alt="allowBlank:false">${sheetLink.linkProgrammeExplain}</textarea>
            </td>
        </tr>
        <tr>
            <!-- ?????? -->
        ...
        <tr>
            ...
            <td colspan="3">
                <eoms:comboBox name="${sheetPageName}linkPermitResult" id="${sheetPageName}linkPermitResult"
                               initDicId="10301" defaultValue="${sheetLink.linkPermitResult}" alt="allowBlank:false"
        ...
        <tr>
            ...
            <td colspan="3">
                <textarea name="linkPermitIdea" id="linkPermitIdea" class="textarea max"
                          alt="allowBlank:false">${sheetLink.linkPermitIdea}</textarea>
            </td>
        </tr>
        <tr>
            <!-- ?? -->
        ...
        <tr>
            ...
            <td>
                <input type="text" class="text" name="${sheetPageName}linkContact" id="${sheetPageName}linkContact"
                       value="${sheetLink.linkContact}" alt="allowBlank:false"/>
            </td>
        </tr>
        <tr>
            <!-- ?????? -->
        ...
        <td>
            <eoms:comboBox name="${sheetPageName}linkIfAffectOperation" id="${sheetPageName}linkIfAffectOperation"
                           initDicId="10301" defaultValue="${sheetLink.linkIfAffectOperation}" alt="allowBlank:false"/>
        </td>
        <!-- ?????? -->
        ...
        <tr>
            ...
            <td colspan="3">
                <eoms:comboBox name="${sheetPageName}linkReferOperateDept" id="${sheetPageName}linkReferOperateDept"
                               initDicId="10301" defaultValue="${sheetLink.linkIfNotify}" alt="allowBlank:false"/>
            </td>
        </tr>
        <tr>
            <!-- ?????? -->
            ...
            <td colspan="3">
                <textarea name="linkNetAffectArea" id="linkNetAffectArea" class="textarea max"
                          alt="allowBlank:false">${sheetLink.linkNetAffectArea}</textarea>
            </td>
        </tr>
        <tr>
            <!-- ?????? -->
        ...
        <tr>
            ...
            <td colspan="3">
                <textarea name="linkAffectNetManage" id="linkAffectNetManage" class="textarea max"
                          alt="allowBlank:false">${sheetLink.linkAffectNetManage}</textarea>
            </td>
        </tr>
        <tr>
            <!-- ???? -->
        ...
        <tr>
            ...
            <td>
                <eoms:comboBox name="${sheetPageName}linkExcuteResult" id="${sheetPageName}linkExcuteResult"
                               initDicId="1011608" defaultValue="${sheetLink.linkExcuteResult}" alt="allowBlank:false"/>
            </td>
            <!-- ???? -->
            ...
            <td>
                <eoms:comboBox name="${sheetPageName}linkTestResult" id="${sheetPageName}linkTestResult"
                               initDicId="1011608" defaultValue="${sheetLink.linkTestResult}" alt="allowBlank:false"/>
            </td>
        </tr>
        <tr>
            <!-- ?????????? -->
            <td class="label"><bean:message bundle="circuitdispatch"
                                            key="circuitdispatch.linkIsAccordanceProgramme"/>*
            </td>
            <td>
                <eoms:comboBox name="${sheetPageName}linkIsAccordanceProgramme"
                               id="${sheetPageName}linkIsAccordanceProgramme" initDicId="1011608"
            ...
            <td>
                <eoms:comboBox name="${sheetPageName}linkFailedReason" id="${sheetPageName}linkFailedReason"
                               initDicId="1011608" defaultValue="${sheetLink.linkFailedReason}" alt="allowBlank:false"/>
            </td>
        </tr>
        <tr>
            <!-- ?????? -->
            ...
            <td colspan="3">
                <textarea name="linkExcuteExplain" id="linkExcuteExplain" class="textarea max"
                          alt="allowBlank:false">${sheetLink.linkExcuteExplain}</textarea>
            </td>
        </tr>
        <tr>
            <!-- ???????? -->
            <td class="label"><bean:message bundle="circuitdispatch"
                                            key="circuitdispatch.linkAffectOperationExplain"/>*
            </td>
            <td colspan="3">
                <textarea name="linkAffectOperationExplain" id="linkAffectOperationExplain" class="textarea max"
                          alt="allowBlank:false">${sheetLink.linkAffectOperationExplain}</textarea>
            </td>
        </tr>
        <tr>
            <!-- ?????? -->
            ...
            <td colspan="3">
                <textarea name="linkAlarmRecord" id="linkAlarmRecord" class="textarea max"
                          alt="allowBlank:false">${sheetLink.linkAlarmRecord}</textarea>
            </td>
        </tr>
        <tr>
            <!-- ???????? -->
            <td class="label"><bean:message bundle="circuitdispatch"
                                            key="circuitdispatch.linkReportAbnormityExplain"/>*
            </td>
            <td colspan="3">
                <textarea name="linkReportAbnormityExplain" id="linkReportAbnormityExplain" class="textarea max"
                          alt="allowBlank:false">${sheetLink.linkReportAbnormityExplain}</textarea>
            </td>
        </tr>
        <tr>
            <!-- ???? -->
        ...
        <tr>
            ...
            <td>
                <eoms:comboBox name="${sheetPageName}linkIfUpdatePlan" id="${sheetPageName}linkIfUpdatePlant"
                               initDicId="1011608" defaultValue="${sheetLink.linkIfUpdatePlan}" alt="allowBlank:false"/>
            </td>
            <!-- ????????? -->
            ...
            <td>
                <eoms:comboBox name="${sheetPageName}linkCircuitUpdate" id="${sheetPageName}linkCircuitUpdate"
                               initDicId="1011608" defaultValue="${sheetLink.linkCircuitUpdate}"
                               alt="allowBlank:false"/>
            </td>
        </tr>
        <tr>
            ...
            <td colspan="3">
                <eoms:comboBox name="${sheetPageName}linkIsToMaintenance" id="${sheetPageName}linkIsToMaintenance"
                               initDicId="1011608" defaultValue="${sheetLink.linkIsToMaintenance}"
                               alt="allowBlank:false"/>
            </td>
        </tr>
        <tr>
            ...
            <td colspan="3">
                <textarea name="linkExcuteConstrue" id="linkExcuteConstrue" class="textarea max"
                          alt="allowBlank:false">${sheetLink.linkExcuteConstrue}</textarea>
            </td>
        </tr>
        <tr>
            <!-- ???????? -->
            ...
            <td colspan="3">
                <textarea name="linkPlanUpdateIdea" id="linkPlanUpdateIdea" class="textarea max"
                          alt="allowBlank:false">${sheetLink.linkPlanUpdateIdea}</textarea>
            </td>
        </tr>
        <tr>
            <!-- ?????? -->
            ...
            <td colspan="3">
                <textarea name="linkWorkPlan" id="linkWorkPlan" class="textarea max"
                          alt="allowBlank:false">${sheetLink.linkWorkPlan}</textarea>
            </td>
        </tr>
        <tr>
            <!-- ???? -->
            ...
            <td colspan="3">
                <textarea name="linkMaintenanceDes" id="linkMaintenanceDes" class="textarea max"
                          alt="allowBlank:false">${sheetLink.linkMaintenanceDes}</textarea>
            </td>
        </tr>
        <tr>
            <!-- ????????? -->
