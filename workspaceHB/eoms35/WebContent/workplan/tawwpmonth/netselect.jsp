...
<form name="form1" id="form1" method="post">
        ...
        <tr>
            <td>
                <table width="390" cellspacing="1" cellpadding="1" border="0">
                    ...
                    <tr height="50px">
                        <td colspan=3>月份: <input type="checkbox" mane="monthsAll" value="" onclick='checkAll()'
                                                 id="monthsAll"/>全选
                    ...
                    <tr>
                        <td width="40%" align="center">
                            ...
                            <select size=15 name="sOper" style="width:150" multiple="true"
                                    ondblclick=javascript:add_RoomTrue();>
                        ...
                        <td width="20%" align="center" valign="top">
                            ...
                            <br>
                            <br>
                            <input type="button" name="btnAddItem" value="<bean:message key="label.add1"/>"
                                   onclick=javascript:add_MoreTrue(); class="button">
                            <p>
                                <input type="button" name="btnDelItem" value="<bean:message key="label.remove1"/>"
                                       onclick=javascript:del_MoreTrue(); class="button">
                            <p>
                                <input type="button" name="btnAddAll" value="<bean:message key="label.alladd"/>"
                                       onclick=javascript:add_all_RoomTrue(); class="button">
                            <p>
                                <input type="button" name="btnDelAll" value="<bean:message key="label.alldel"/>"
                                       onclick=javascript:del_all_RoomTrue(); class="button">
                        </td>
                        <td width="40%" align="center">
                            <b><bean:message key="netselect.tawwpmonth.formAddNet"/></b>
                            <select size=15 name="sOper_O" style="width:150" multiple="true"
                                    ondblclick=javascript:del_RoomTrue();>
    ...
    <input type="button" name="save" value="<bean:message key="label.save"/>" onclick="sent_room_user();"
           class="button">
    <input type="button" value="<bean:message key="netselect.tawwpmonth.btnBack" />" name="B1" class="button"
