...
//处理部门树
	revDeptTree = new xbox({
		...
		showChkFldId:'revDeptName',saveChkFldId:'senddeptid' 
	});
   ...
   <tr>
         ...
         <!-- -->    
          ...
          <td id="selnetsys">
  		 ...
  		 <td id="selrevdept">
        	<input type="button" value="${eoms:a2u('申请单位')}"
					id="deptTreeBtn" class="btn" />
				<input name="revDeptName" value="" id="revDeptName" class="text"
					readonly="readonly" alt="allowBlank:true">
