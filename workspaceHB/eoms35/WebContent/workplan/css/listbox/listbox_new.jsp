        ...
        function fnEOMSListboxMoveRow(elName, operType) {
            if (pageSelected == null)
                ...
                switch (pageSelected.action) {
                    case "add" :
                        fnEOMSListboxAddRow(elName, operType);
                        break;
                    case "del" :
                    ...
                    <TR>
                        <TD valign="top" width="50%">
                            ...
                            <SPAN class="EOMSListbox" id=listboxRoot
                                  ...
                                  style="margin:5px;HEIGHT: expression(document.body.offsetHeight - 95);">
...
%>
				<TR class=EOMSListboxItem id="tr_parentid_<%=toObject%>">
					...
					<IMG id="img_parentid_<%=toObject%>" name="img_parentid_<%=toObject%>" src="images/false.gif"
                         onclick="load('',<%=toObject%>)" style="cursor:hand"></TD>
...
<% for (int b = 0; b < arrSort.length; b++) { %>
	...
	<BOCO:genericButton css="classic" onclick="fnEOMSListboxMoveRow('listboxSort<%=b+1%>',<%=b+1%>);"
...
%>
	...
	<SPAN class="EOMSListbox" id="listboxSort<%=b+1%>"
          style="BORDER: <%=spanColor[b]%> 1px solid; WIDTH: 100%; HEIGHT: expression( (document.body.offsetHeight - 95 - <%=arrSort.length%> * 3) / <%=arrSort.length%>)"
        ...
        <tr>
            <td colspan="2" align="right" class="buttonBanner" height="30">
                ...
                <TABLE cellpadding="5" width="200px">
                    <TR>
                        <TD>
                            <BOCO:genericButton css="classic"
                                                onclick="<%=strOnclick%>window.returnValue=true;window.close();">
