        ...
        <logic:present name="sheetMain" scope="request">
            ...
            <table id="sheet" class="formTable">
                ...
                <tr>
                    ...
                    <td class="content">
                        <c:forTokens items="${sheetMain.mainResourceType}" delims="," var="mainResourceType"
                                     varStatus="status"><eoms:id2nameDB id="${mainResourceType}"
                    ...
                    <td>
                        <c:forTokens items="${sheetMain.mainHLRResource}" delims="," var="mainHLRResource"
                    ...
                    <td class="content">
                        <c:forTokens items="${sheetMain.mainMSCResource}" delims="," var="mainMSCResource"
                ...
                <tr>
                    <td class="label"><bean:message bundle="numberapply"
                                                    key="numberApplyMain.mainContentDescribe"/></td>
                    <td colspan='3' class="content"><bean:write name="sheetMain" property="mainContentDescribe"
            ...
            <tr>
                <td width="50%">
                    ...
                    <select id="dealSelector">
                        ...
                        <% if (ifwaitfor.equals("false")) {%>
                        <!-- 流程步骤，移交，阶段回复，分派 -->
                        <option value="${urlShowAllotResourceTaskPage}"><bean:message bundle="numberapply"
                                                                                      key="operateType.AllotResourceTask"/></option>
                        ...
                        <!-- 不需要等待回复 -->
                        <% if (ifwaitfor.equals("false")) {%>
                        <option value="${urlShowDispatchPage}"><bean:message bundle="numberapply"
                    ...
                    <select id="dealSelector">
                        <option value="${urlShowHoldTaskPage}"><bean:message bundle="numberapply"
                    ...
                    <select id="dealSelector">
                        <option value="${urlShowDraftPage}"><bean:message bundle="numberapply"
