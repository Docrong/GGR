...
<div id="history" class="panel">
    ...
    <logic:present name="HISTORY" scope="request">
        ...
        <logic:iterate id="baselink" name="HISTORY"
                       type="com.boco.eoms.sheet.focusresourceerrata.model.FocusResourceErrataLink">
            <%
                jNum += 1;
            ...
            <div class="history-item">&nbsp;
                ...
                <div class="history-item-title">
                    ...
                    <eoms:dict key="dict-sheet-focusresourceerrata" dictId="activeTemplateId"
                    ...
                    <eoms:dict key="dict-sheet-focusresourceerrata" dictId="mainOperateType"
                ...
                <div class="history-item-content hide">
                    <table class="formTable" width="100%" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td class="label">
                                <!-- 电路核查状态 -->
                                <bean:message bundle="focusresourceerrata"
                                              key="focusResourceErrataLink.linkCheckState"/>
                            </td>
                            <td class="content">
                        ...
                        <tr>
                            ...
                            <td class="label">
                                <!-- 审批意见 -->
                                <bean:message bundle="focusresourceerrata"
                                              key="focusResourceErrataLink.linkApprovalOpinion"/>
                            </td>
                            <td class="content">
