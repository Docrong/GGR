...
<div id="tabs">
    ...
    <div id="form" class="tab-content">
        <table cellpadding="0" class="table logList" cellspacing="0">
            ...
            %>
            <tr class="sortable">
                <td width='2%' align='center'><%=j%>
                </td>

                <td width='8%' align='center'><%=obj.get(1).toString()%>
                </td>
                <td width='10%' align='center'><%=obj.get(2).toString()%>
                </td>
                <td width='12%' align='center'><%=obj.get(5).toString()%>
                </td>
                <td width='20%' align='center'><%=obj.get(4).toString()%>
                </td>
