...
<div align="center">
    <center>
        ...
        <table border="0" width="95%" cellspacing="1" bgcolor="#709ED5"
               style="border-right-style: solid; border-right-color: #d3d3d3; border-bottom-style: solid; border-bottom-color: #d3d3d3">
            ...
            <logic:iterate id="tawTestcard" name="tawTestcard" type="com.boco.eoms.testcard.model.TawTestcard">
                ...
                <tr bgcolor="#FFFFFF">
                    ...
                    <td nowrap bgcolor="#E5EDF8" align="center" height="30"><html:link href="../TawTestcard/view.do"
                                                                                       paramId="iccid"
                                                                                       paramName="tawTestcard"
                                                                                       paramProperty="iccid"><bean:message
                            key="label.view"/></html:link></td>
                    <td nowrap bgcolor="#E5EDF8" align="center" height="30"><html:link href="../TawTestcard/edit.do"
                                                                                       paramId="iccid"
                                                                                       paramName="tawTestcard"
                                                                                       paramProperty="iccid"><bean:message
                            key="label.edit"/></html:link></td>
                    <td nowrap bgcolor="#E5EDF8" align="center" height="30"><html:link href="../TawTestcard/remove.do"
                                                                                       paramId="iccid"
                                                                                       paramName="tawTestcard"
                                                                                       paramProperty="iccid"><bean:message
                            key="label.remove"/></html:link></td>
