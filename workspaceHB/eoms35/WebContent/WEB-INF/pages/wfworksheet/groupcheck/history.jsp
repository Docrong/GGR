...
<logic:present name="HISTORY" scope="request">  
      ...
      <logic:iterate id="baselink" name="HISTORY" type="com.boco.eoms.sheet.groupcheck.model.GroupCheckLink" >     
       <%         
        jNum += 1;       
      ...
      <div class="history-item">&nbsp;   
	      ...
	      <div class="history-item-title">
			 ...
			 <bean:write name="baselink" property="operateTime" formatKey="date.formatDateTimeAll" bundle="sheet" scope="page"/>&nbsp; 
	  	     ...
	  	     <eoms:dict key="dict-sheet-groupcheck" dictId="activeTemplateId" itemId="${baselink.activeTemplateId}" beanId="id2descriptionXML" />
	  	     <bean:message bundle="groupcheck" key="groupcheck.operateType"/>:
	  	     <eoms:dict key="dict-sheet-groupcheck" dictId="mainOperateType" itemId="${baselink.operateType}" beanId="id2descriptionXML" />
	 ...
	 <!-- 流程中的历史页面 -->
		  		...
		  		<%if(baselink.getActiveTemplateId()!=null && baselink.getActiveTemplateId().equals("CityCheck")) {%>
		  				...
		  				<%if(baselink.getOperateType() != null && (baselink.getOperateType().intValue() == 101 || baselink.getOperateType().intValue() == 11)){ %>
							...
							<td class="content">
								...
								<pre><eoms:id2nameDB id="${baselink.linkAutoFind}" beanId="ItawSystemDictTypeDao"/> </pre>
	 						</td>
							...
							<td class="content">
								...
								<pre>${baselink.linkContactPhone}</pre>
	 						</td>
...
<script type="text/javascript">
 ...
 function copy(id){
    ...
    Ext.Ajax.request({
		method:"get",
		url: "groupcheck.do?method=getJsonLink&id="+id+"&beanName=GroupCheck",
		success: function(x){
