...
public interface ITawSystemRoleImportManager extends Manager {
     ...
     *
     * @param id the tawSystemRoleImport's id
     ...
     *
     * @param tawSystemRoleImport the object to be saved
     */
     ...
     * @param curPage  the current page number
     * @param pageSize the size number per page
     * @param whereStr the "where.." conditional statement,must start with "where",
     *                 can be blank
     */
    public Map getTawSystemRoleImports(final Integer curPage,
     ...
     * 导入角色
     *
     * @param excel               mapping的角色列表 (tawSystemRoleImportExcel 与excel mapping的角色对象
     * @param tawSystemRoleImport 角色导入版本控制
     */
