...
function showPage(){
     var pars = '';
     var url = '';    
      url = '${app}/sheet/techniquesupporthb/techniquesupporthb.do?method=showInputRejectPage&piid=${sheetMain.piid}&taskId=${taskId}&taskName=${taskName}';
     if (url!=''){
...
<div id="sheetform">
<html:form action="/techniquesupporthb.do?method=performDeal" styleId="theform">
