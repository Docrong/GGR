...
<div id="sheetform">
    <html:form action="/widencomplaint.do?method=performCreateSubTask" styleId="theform">
   ...
   <c:choose> 
    <c:when test="${taskName=='ExcuteHumTask'}">  
           <eoms:chooser id="test"  config="{{returnJSON:true}"
                ...
                panels="[
                   {text:'可选子角色',dataUrl:'/role/tawSystemSubRoles.do?method=xgetUsersByAppointSubRole&subRoleIds=${splitSubRoleIds}'}
                 ]"
          />
   	</c:when>
    <c:otherwise> 
