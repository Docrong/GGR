			...
			} else
			{
				...
				if (main.getMainInterfaceSheetType() != null && main.getMainInterfaceSheetType().equals("crm"))
				{
					...
					if (sendImmediately.equalsIgnoreCase("true"))
					{
						...
						if (phaseType.equals("") && operateType.equals("9"))
						{
							dealconnotifyWorkSheet(request, info, null);
							infoManager.saveOrUpdateCrmWaitInfo(info);
						} else
						if (!operateType.equals("46") && taskName.equalsIgnoreCase("DeferExamineHumTask") && operateType.equalsIgnoreCase("66") && StaticMethod.nullObject2String(request.getParameter("mainDelayFlag")).equals("1"))
						{
