...
//System.out.println("trans"+trans);
    ...
    <table border="0" width="100%" cellspacing="1" cellpadding="1" class="listTable" align=center>
        ...
        %>
        <TR class="tr_show">
            <TD width="16%" noWrap align="center" rowSpan="2" class="label"><bean:message
                    key="TawRmRecord.circumstance"/></TD>
            <TD class="label"><bean:message key="TawRmRecord.weather"/></TD>

            <TD>
                <eoms:dict key="dict-duty" dictId="weather" beanId="selectXML" defaultId="${tawRmRecordForm.weather}"
                           isQuery="false" selectId="weather"/>
        ...
        <TR class="tr_show">
            ...
            <TD>
                <eoms:dict key="dict-duty" dictId="clean" beanId="selectXML" defaultId="${tawRmRecordForm.clean}"
                           isQuery="false" selectId="clean"/>
            ...
            <TD colSpan="3">
                <eoms:dict key="dict-duty" dictId="conditioner" beanId="selectXML"
                           defaultId="${tawRmRecordForm.conditioner}" isQuery="false" selectId="conditioner"/>
        ...
        <TR class="tr_show">
            ...
            <TD colSpan="3">
                <input name="RoomName" id="RoomName" type="text" style="BACKGROUND-COLOR: lightgrey " readOnly=""
                       maxlength="150" size="20" value="<%=roomName%>" class="clstext"/>
            </TD>
            <TD class="label"><bean:message key="TawRmRecord.receivertime"/></TD>
            <TD colSpan="1">
                <html:hidden property="starttime"/>
                <input name="starttime" id="starttime" type="text" style="BACKGROUND-COLOR: lightgrey" class="clstext"
                       readOnly="" size="20"
        ...
        <TR class="tr_show">
            ...
            <TD colSpan="5">
                <html:hidden property="hander"/>
                <input name="hander" id="hander" type="text" style="BACKGROUND-COLOR: lightgrey" class="clstext"
                       readOnly="" size="58"
        ...
        <TR class="tr_show">
            ...
            <TD colSpan="5">
                    <html:hidden property="dutyman"/>
                <input name="dutyman" id="dutyman" type="text" style="BACKGROUND-COLOR: lightgrey" class="clstext"
                       readOnly="" size="58"
        ...
        <TR class="tr_show">
            ...
            <TD colSpan="5">
                <html:hidden property="receiver"/>
                <input name="receiver" id="receiver" type="text" style="BACKGROUND-COLOR: lightgrey" class="clstext"
                       readOnly="" size="58"
        ...
        <TR class="tr_show">
            ...
            <TD colSpan="8">
                <TEXTAREA id=hangQuestion0 name=hangQuestion0 rows=4 cols=70 style="BACKGROUND-COLOR: lightgrey"
        ...
        <TR class="tr_show">
            ...
            <TD colSpan="6">
                <IFRAME ID=IFrame1 FRAMEBORDER=0 width="100%" height=60 SCROLLING=YES
                        SRC='../TawRmDutyfile/dutyfile.do?WORKSERIAL=<bean:write name="tawRmRecordForm" property="id"/>'>
                </IFRAME>
            </TD>
        </TR>
        <TR class="tr_show">
        ...
        %>
        <TR class="tr_show">
            <TD width="16%" noWrap align="middle" align="center" rowSpan="2" class="clsfth"><bean:message
                    key="TawRmRecord.circumstance"/></TD>
            <TD class="label"><bean:message key="TawRmRecord.weather"/></TD>
            ...
            <TD><html:hidden property="temperature"/><input name="tempStr" id="tempStr" type="text"
                                                            ...
                                                            readOnly="" size="5"
                                                            value="<bean:write name="tawRmRecordForm" property="temperature" scope="request"/>"/>&nbsp;C
            </TD>
        ...
        <TR class="tr_show">
            <TD class="label"><bean:message key="TawRmRecord.clean"/></TD>
            <TD colspan="1"><html:hidden property="clean"/><input name="tempStr" id="tempStr" type="text"
                                                                  style="BACKGROUND-COLOR: lightgrey" class="clstext"
                                                                  readOnly="" size="10"
            ...
            <TD colspan="3"><html:hidden property="conditioner"/><input name="tempStr" id="tempStr" type="text"
                                                                        ...
                                                                        class="clstext" readOnly="" size="10"
    ...
    <table border="0" width="95%" cellspacing="1" cellpadding="1" class="listTable" align=center>
        <TR class="tr_show">
            ...
            <TD>
                ...
                <input name="dutymansub" id="dutymansub" type="text" style="BACKGROUND-COLOR: lightgrey" class="clstext"
                       readOnly="" maxlength="150" size="20" value="<%=saveSessionBeanForm.getUsername()%>"/>
            </TD>
            ...
            <TD>
                ...
                <input name="starttimesub" id="starttimesub" type="text" style="BACKGROUND-COLOR: lightgrey"
                       class="clstext" readOnly="" size="20" value="<%=starttimesub%>"/>
            </TD>
        </TR>
        <TR class="tr_show">
            ...
            <TD>
                ...
                <input name="starttimeDefined" id="starttimeDefined" type="text" style="BACKGROUND-COLOR: lightgrey"
                       class="clstext" readOnly="" size="20" value="<%=Starttime_Defined%>"/>
            </TD>
            ...
            <TD>
                ...
                <input name="endtimeDefined" id="endtimeDefined" type="text" style="BACKGROUND-COLOR: lightgrey"
                       class="clstext" readOnly="" size="20" value="<%=Endtime_Defined%>"/>
            </TD>
        </TR>
        <TR class="tr_show">
            ...
            <TD>
                ...
                %>
                <input name="workflag" id="workflag" type="text" style="BACKGROUND-COLOR: lightgrey" class="clstext"
                       readOnly="" size="20" value="<%=WorkFlagStr%>"/>
            </TD>
            ...
            <TD>
                ...
                %>
                <input name="status" id="status" type="text" style="BACKGROUND-COLOR: lightgrey" class="clstext"
                       readOnly="" size="20" value="<%=StatusStr%>"/>
            </TD>
        </TR>
        <tr class="tr_show">
            <td class="label">
            ...
            <td colspan="3" title='<bean:message key="TawRmRecord.remark2"/>'>
                <%for (int i = 1; i <= StaticDutycheck.dutycheckcount; i++) {%>
                <%=StaticDutycheck.getDutycheckName(StaticDutycheck.getDutycheckId(i))%><input type="checkbox"
                                                                                               name="<%=StaticDutycheck.getDutycheckId(i)%>" <%
                if (dutychecksub.lastIndexOf(StaticDutycheck.getDutycheckId(i)) != -1) out.print("checked");%>/>&nbsp;
                <%}%>
            </td>
        </tr>
        <tr class="tr_show">
            ...
            <td colspan="3" title="TawRmRecord.remark3">
                ...
                <input type="radio" name="typeMode" value="1" checked="checked"
                       onclick="javascript:show(1);"><bean:message key="TawRmRecord.trans"/>
                <%} else {%>
                <input type="radio" name="typeMode" value="1" onclick="javascript:show(1);"><bean:message
                    key="TawRmRecord.trans"/>
                <%}%>
                <%if ("2".equals(typemode)) { %>
                <input type="radio" name="typeMode" value="2" checked="checked"
                       onclick="javascript:show(2);"><bean:message key="TawRmRecord.change"/>
                <%} else {%>
                <input type="radio" name="typeMode" value="2" onclick="javascript:show(2);"><bean:message
                    key="TawRmRecord.change"/>
                <%}%>
                <%if ("3".equals(typemode)) { %>
                <input type="radio" name="typeMode" value="3" checked="checked" onclick="javascript:show(3);">
                <bean:message key="TawRmRecord.date"/>
                <%} else {%>
                <input type="radio" name="typeMode" value="3" onclick="javascript:show(3);"><bean:message
                    key="TawRmRecord.date"/>
                <%}%>
                <%if ("4".equals(typemode)) { %>
                <input type="radio" name="typeMode" value="4" checked="checked"
                       onclick="javascript:show(4);"><bean:message key="TawRmRecord.system"/>
                <%} else {%>
                <input type="radio" name="typeMode" value="4" onclick="javascript:show(4);"><bean:message
                    key="TawRmRecord.system"/>
                <%}%>
                <%if ("5".equals(typemode)) { %>
                <input type="radio" name="typeMode" value="5" checked="checked"
                       onclick="javascript:show(5);"><bean:message key="TawRmRecord.other"/>
                <%} else {%>
                <input type="radio" name="typeMode" value="5" onclick="javascript:show(5);"><bean:message
                    key="TawRmRecord.other"/>
                <%}%>
                <%if ("6".equals(typemode)) { %>
                <input type="radio" name="typeMode" value="6" checked="checked"
                       onclick="javascript:show(6);">${eoms:a2u('值班综述')}
                <%} else {%>
                <input type="radio" name="typeMode" value="6" onclick="javascript:show(6);">${eoms:a2u('值班综述')}
                <%}%>
                <%if ("7".equals(typemode)) { %>
                <input type="radio" name="typeMode" value="7" checked="checked"
                       onclick="javascript:show(7);">${eoms:a2u('重要纪事')}
                <%} else {%>
                <input type="radio" name="typeMode" value="7" onclick="javascript:show(7);">${eoms:a2u('重要纪事')}
                <%}%>
                <%if ("8".equals(typemode)) { %>
                <input type="radio" name="typeMode" value="8" checked="checked"
                       onclick="javascript:show(8);"> ${eoms:a2u('重大故障')}
                <%} else {%>
                <input type="radio" name="typeMode" value="8" onclick="javascript:show(8);">${eoms:a2u('重大故障')}
                <%}%>
                <%if ("9".equals(typemode)) { %>
                <input type="radio" name="typeMode" value="9" checked="checked"
                       onclick="javascript:show(9);">${eoms:a2u('网络割接')}
                <%} else {%>
                <input type="radio" name="typeMode" value="9" onclick="javascript:show(9);">${eoms:a2u('网络割接')}
                <%}%>
                <%if ("0".equals(typemode)) { %>
                <input type="radio" name="typeMode" value="0" checked="checked"
                       onclick="javascript:show(0);">${eoms:a2u('网络KPI')}
                <%} else {%>
        ...
        <TR class="tr_show">
            ...
            <TD colSpan="3"><textarea name="logtype" id="logtype" readonly="" style="BACKGROUND-COLOR: lightgrey"
                                      rows="9" cols="90" Class="clstext" type="_moz">
1.<bean:message key="TawRmRecord.trans"/><bean:message key="label.zhuanye"/>:<%=trans.substring(1, trans.length() - 1)%>
2.<bean:message key="TawRmRecord.change"/><bean:message
                    key="label.zhuanye"/>:<%=swtch.substring(1, swtch.length() - 1)%>
3.<bean:message key="TawRmRecord.date"/><bean:message key="label.zhuanye"/> :<%=data.substring(1, data.length() - 1)%>
4.<bean:message key="TawRmRecord.system"/><bean:message
                    key="label.zhuanye"/> :<%=system.substring(1, system.length() - 1)%>
...
10.${eoms:a2u('网络KPI')}:<%=netKPI.substring(1, netKPI.length() - 1)%>
        ...
        <TR class="tr_show">
            ...
            <%if (StatusInt == 0) {%>
            <TD colSpan="3"><textarea name="statement" id="statement" rows="4" cols="90"
                                      Class="clstext"><%=request.getAttribute("STATEMENT")%></textarea>
                        <%}else{%>
            <TD colSpan="3"><textarea name="statement" id="statement" readonly="" style="BACKGROUND-COLOR: lightgrey"
                                      rows="4" cols="60"
                                      Class="clstext"><%=request.getAttribute("STATEMENT")%></textarea>
                <%}%>
                <span id="Customvalidator2" controltovalidate="Statement" errormessage="<BR> " display="Dynamic"
                      evaluationfunction="CustomValidatorEvaluateIsValid" clientvalidationfunction="CheckStatement"
                      style="color:Red;display:none;"><BR>
             </span></TD>
        </TR>
    ...
    <table border="0" width="95%" cellspacing="1" cellpadding="1" align=center>
        <TR>
            <TD align="label" colSpan="6">
                    ...
                    --%><input type=submit Class="button" name="load" value='<bean:message key="label.rush"/>'
                               onclick="javascript:fun_refresh();">
                <input type=submit Class="button" name="load" value='<bean:message key="label.save"/>'
