...
<caption>
    <div class="header center">GPRS专线</div>
</caption>
    ...
    <table class="formTable">
        ...
        <tr>
            ...
            <td class="content">
                ...
                <eoms:comboBox name="portAInterfaceType" id="portAInterfaceType"
                               defaultValue="${gprsspeciallineForm.portAInterfaceType}" initDicId="1011015"
        ...
        <tr>
            ...
            <td class="content">
                ...
                <html:text property="transferInputMethod" styleId="transferInputMethod" styleClass="text medium"
                           alt="allowBlank:false"/>
            </td>
        ...
        <tr>
            ...
            <td class="content">
                ...
                <eoms:comboBox name="apnType" id="apnType" defaultValue="${gprsspeciallineForm.apnType}"
                               initDicId="1012309"
        ...
        <tr>
            ...
            <td class="content">
                ...
                <html:text property="userInputRouterIP" styleId="userInputRouterIP" styleClass="text medium"
                           alt="allowBlank:true"/>
            </td>
        ...
        <tr>
            ...
            <td colspan="3">
                <textarea name="groupCustomIPDetail" id="groupCustomIPDetail" class="textarea max"
                          alt="allowBlank:true">${gprsspeciallineForm.groupCustomIPDetail}</textarea>
            </td>
        </tr>
        <tr>
            ...
            <td class="content">
                ...
                <html:text property="ipAddressAssign" styleId="ipAddressAssign" styleClass="text medium"
                           alt="allowBlank:false"/>
            </td>
            <td class="label">终端IP地址分配方式*</td>
            <td class="content">
                <html:errors property="endIDDividType"/>
                <eoms:comboBox name="endIDDividType" id="endIDDividType"
                               defaultValue="${gprsspeciallineForm.endIDDividType}" initDicId="1012311"
                               alt="allowBlank:false" styleClass="select-class"/>
            </td>
        </tr>
        <tr>
            ...
            <td colspan='3'>
                ...
                <eoms:comboBox name="isDoubleGGSN" id="isDoubleGGSN" defaultValue="${gprsspeciallineForm.isDoubleGGSN}"
                               initDicId="1011017"
                               alt="allowBlank:false" styleClass="select-class"/>
            </td>
        </tr>
        ...
        <td class="content">
            ...
            <eoms:comboBox name="manYouProperty" id="manYouProperty"
                           defaultValue="${gprsspeciallineForm.manYouProperty}" initDicId="1012312"
                           alt="allowBlank:true" styleClass="select-class"/>
        </td>
        <td class="label">计划开通终端数*</td>
        <td class="content">
            <html:errors property="planExeEndPointNum"/>
            <html:text property="planExeEndPointNum" styleId="planExeEndPointNum" styleClass="text medium"
                       alt="allowBlank:false"/>
        </td>
        </tr>
        <tr>
            ...
            <td class="content">
                ...
                <html:text property="simAdnHlrScope" styleId="simAdnHlrScope" styleClass="text medium"
                           alt="allowBlank:false"/>
            </td>
        </tr>
        <tr>
            ...
            <td colspan="3">
                <textarea name="applyPurpose" id="applyPurpose" class="textarea max"
                          alt="allowBlank:false">${gprsspeciallineForm.applyPurpose}</textarea>
            </td>
        </tr>
        <tr>
            ...
            <td colspan='3'>
                ...
                <textarea name="businessNumAssessment" id="businessNumAssessment" class="textarea max"
                          alt="allowBlank:false">${gprsspeciallineForm.businessNumAssessment}</textarea>
        ...
        <tr>
            ...
            <td class="content">
                ...
                <eoms:comboBox name="userIsUserNet" id="userIsUserNet"
                               defaultValue="${gprsspeciallineForm.userIsUserNet}" initDicId="1012310"
                               alt="allowBlank:true" styleClass="select-class"/>
            </td>
            <td class="label">用户个性化设备需求</td>
            <td colspan='3'>
                <html:errors property="userSpecifyDevNeed"/>
                <textarea name="userSpecifyDevNeed" id="userSpecifyDevNeed" class="textarea max"
                          alt="allowBlank:true">${gprsspeciallineForm.userSpecifyDevNeed}</textarea>
            </td>
        </tr>
        <tr>
            ...
            <td class="content">
                ...
                <eoms:comboBox name="userIsRadiusValid" id="userIsRadiusValid"
                               defaultValue="${gprsspeciallineForm.userIsRadiusValid}" initDicId="1012310"
        ...
        <tr>
            ...
            <td colspan='3'>
                ...
                <html:text property="userRadiusValidateIPAdd" styleId="userRadiusValidateIPAdd" styleClass="text medium"
                           alt="allowBlank:true"/>
            </td>
        </tr>
        </tbody>
        ...
        <tr>
            ...
            <td class="content">
                ...
                <eoms:comboBox name="portABDeviceType" id="portABDeviceType"
                               defaultValue="${gprsspeciallineForm.portABDeviceType}" initDicId="1012304"
                               alt="allowBlank:false" styleClass="select-class"/>
            ...
            <td class="content">
                ...
                <eoms:comboBox name="buildMethodA" id="buildMethodA" defaultValue="${gprsspeciallineForm.buildMethodA}"
                               initDicId="1012317"
                               alt="allowBlank:false" styleClass="select-class"/>
        ...
        <tr>
            ...
            <td class="content">
                ...
                <eoms:comboBox name="userIsHaveDivA" id="userIsHaveDivA"
                               defaultValue="${gprsspeciallineForm.userIsHaveDivA}" initDicId="1012310"
                               alt="allowBlank:false" styleClass="select-class"/>
            </td>
            <td class="label">A是否需要移动采购</td>
            <td class="content">
                <html:errors property="isNeedBuyA"/>
                <eoms:comboBox name="isNeedBuyA" id="isNeedBuyA" defaultValue="${gprsspeciallineForm.isNeedBuyA}"
                               initDicId="1012310"
                               alt="allowBlank:false" styleClass="select-class"
                               onchange="userIsRadiusValidChange(this.value);"/>
            </td>
        </tr>
        </tbody>
        ...
        <tr>
            ...
            <td class="content">
                ...
                <eoms:comboBox name="interfacePointTypeA" id="interfacePointTypeA"
                               defaultValue="${gprsspeciallineForm.interfacePointTypeA}" initDicId="1012316"
                               alt="allowBlank:true" styleClass="select-class"/>
            </td>
        </tr>
        <tr>
            ...
            <td colspan="3">
                ...
                <textarea name="fiberAroute" id="fiberAroute" class="textarea max"
                          alt="allowBlank:true">${gprsspeciallineForm.fiberAroute}</textarea>
            </td>
        </tr>
        </tbody>
        ...
        <tr>
            ...
            <td colspan="3">
                <a style="cursor:hand;color:darkbule"
                   onclick="javascript:popupIrmsPreSurvey('${gprsspeciallineForm.portADetailAdd}')">点击进行接入点勘察</a>
            </td>
        </tr>
        <%} %>
    </table>
    ...
    <table class="formTable">
        ...
        <tr>
            ...
            <td class="content">
                ...
                <eoms:comboBox name="fiberOwnerA" id="fiberOwnerA" defaultValue="${gprsspeciallineForm.fiberOwnerA}"
                               initDicId="1012315"
                               alt="allowBlank:false" styleClass="select-class"/>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="content">
                ...
                <textarea name="buildTypeA" id="buildTypeA" class="textarea max"
                          alt="allowBlank:true">${gprsspeciallineForm.buildTypeA}</textarea>
            </td>
            ...
            <td class="content">
                ...
                <eoms:comboBox name="isOkBetweenUserA" id="isOkBetweenUserA"
                               defaultValue="${gprsspeciallineForm.isOkBetweenUserA}" initDicId="1012310"
        ...
        <td colspan='3'>
            ...
            <textarea name="noInputResonA" id="noInputResonA" class="textarea max"
                      alt="allowBlank:true">${gprsspeciallineForm.noInputResonA}</textarea>
        </td>
        </tbody>
        </tr>
        </tbody>
    ...
    <table class="formTable">
        ...
        <tr>
            ...
            <td class="content">
                ...
                <eoms:comboBox name="isDeviceAllowOpenA" id="isDeviceAllowOpenA"
                               defaultValue="${gprsspeciallineForm.isDeviceAllowOpenA}" initDicId="1012310"
                               alt="allowBlank:false" styleClass="select-class"/>
            </td>
            </td>
            ...
            <td class="content">
                ...
                <eoms:comboBox name="isNeedAddCardA" id="isNeedAddCardA"
                               defaultValue="${gprsspeciallineForm.isNeedAddCardA}" initDicId="1012310"
        ...
        <tr>
            ...
            <td class="content">
                ...
                <eoms:comboBox name="isGetInterfaceA" id="isGetInterfaceA"
                               defaultValue="${gprsspeciallineForm.isGetInterfaceA}" initDicId="1012310"
                               alt="allowBlank:false" styleClass="select-class"/>
            </td>
        ...
        <tr>
            ...
            <td class="content" colspan="3">
                <textarea name="theLastOpinionA" id="theLastOpinionA" class="textarea max"
                          alt="allowBlank:false">${gprsspeciallineForm.theLastOpinionA}</textarea>
            </td>
        </tr>
        <tr>
    ...
    <table class="formTable">
        ...
        <tr>
            ...
            <td class="content">
                ...
                <html:text property="firstApnAddAndNum" styleId="firstApnAddAndNum" styleClass="text medium"
                           alt="allowBlank:false"/>
            </td>
            <td class="label">第二个GGSN的地址池和掩码</td>
            <td class="content">
                <html:errors property="secondApnAddAndNum"/>
                <html:text property="secondApnAddAndNum" styleId="secondApnAddAndNum" styleClass="text medium"
                           alt="allowBlank:true"/>
            </td>
        </tr>
        </tbody>
        ...
        <tr>
            ...
            <td class="content">
                ...
                <html:text property="apnRootMethod" styleId="apnRootMethod" styleClass="text medium"
                           alt="allowBlank:true"/>
            </td>
        </tr>
    </table>
        ...
        <tr>
            ...
            <td colspan="3">
                <textarea name="remark" id="remark" class="textarea max"
                          alt="allowBlank:true">${gprsspeciallineForm.remark}</textarea>
            </td>
        </tr>
    </table>
    <br/>
