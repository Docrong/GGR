...
public class KnowledgeChangesStatisticMgrImpl implements KnowledgeChangesStatisticMgr {
    ...
    public Map getKnowledgeChangesStatistics(final Integer curPage, final Integer pageSize) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            switch (operateId) {
                case 1: {
                    knowledgeChangesStatistic.setAddCount(objs[2] != null ? (Integer) objs[2] : new Integer(0));
                    break;
                }
                case 2: {
                    knowledgeChangesStatistic.setModifyCount(objs[2] != null ? (Integer) objs[2] : new Integer(0));
                    break;
                }
                case 3: {
                    knowledgeChangesStatistic.setOverCount(objs[2] != null ? (Integer) objs[2] : new Integer(0));
                    break;
                }
                case 4: {
                    knowledgeChangesStatistic.setDeleteCount(objs[2] != null ? (Integer) objs[2] : new Integer(0));
                    break;
                }
