...
<div id="sheetform">
    <html:form action="/citycustom.do?method=performTransferWorkItem" styleId="theform">
        ...
        <input type="hidden" name="mainClassName" id="mainClassName"
               value="com.boco.eoms.sheet.citycustom.model.CityCustomMain"/>
        <input type="hidden" name="linkClassName" id="linkClassName"
               value="com.boco.eoms.sheet.citycustom.model.CityCustomLink"/>
        ...
        <div class="form-btns">
            ...
            <input type="submit" class="submit"
                   onclick="v.passing=true;this.form.action='${app}/sheet/citycustom/citycustom.do?method=performSaveInfo'"
