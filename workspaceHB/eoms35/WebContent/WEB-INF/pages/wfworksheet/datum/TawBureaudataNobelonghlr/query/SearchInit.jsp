...
<TR>
<td width="100%" class="table_title">查询地市未确定HLR归属的号段 <bean:message key="Worksheet.selectSearchConditon"/><!--请选择查询条件--></td>
</tr>
<tr>
<TD align="right">
</TD>
...
<table border="0"  cellspacing="1" cellpadding="1" width="80%" class="table_show" align=center>
      ...
      <tr class="tr_show">
      <td noWrap width="20%">起始号段（万号）(<bean:message key="Worksheet.blurSearch"/><!--模糊查询-->)</td>
      <td width="70%"><html:text property="beginSegment" size="30"  /></td>
  </tr>
      <tr class="tr_show">
      <td noWrap width="20%">终止号段（万号）(<bean:message key="Worksheet.blurSearch"/><!--模糊查询-->)</td>
