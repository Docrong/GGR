package com.boco.eoms.sheet.transprovincial.webapp.action;
 ...
 */
 ...
 public class TransprovincialMethod extends BaseSheet  {
        ...
        throws Exception
    {
		...
		if (operateType.equals("4")) {
			...
			ITransprovincialLinkManager service = (ITransprovincialLinkManager)ApplicationContextHolder.getInstance().getBean("iTransprovincialLinkManager");
