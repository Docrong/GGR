...
<form name="tawwpitemadd" method="post"
      action="../tawwpyear/itemsave.do?yearplanid=<%=request.getParameter("yearplanid")%>">
    ...
    <table class="formTable">
        ...
        <tr>
            ...
            <td width="50">
                <select class="select" size='1' name='cycle' value='1'
                        onChange="changecycle(document.tawwpitemadd.cycle.options[document.tawwpitemadd.cycle.selectedIndex].value)">
        ...
        <tr>
            ...
            <td width="400" colspan="2">
                <input type=radio name='isHoliday' value='0' checked>是&nbsp;&nbsp;<input type=radio name='isHoliday'
                                                                                         value='1'>否
            </td>
        </tr>
        <tr>
            ...
            <td width="400" colspan="2">
                <input type=radio name='isWeekend' value='0' checked>是&nbsp;&nbsp;<input type=radio name='isWeekend'
                                                                                         value='1'>否
            </td>
        </tr>
        <tr>
    ...
    <input type="button" value="<bean:message key="itemadd.tawwpyear.btnBack" />"
