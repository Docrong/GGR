...
alter table TRANSPROVINCIAL_MAIN
    add constraint TRANSPROVINCIAL_MAIN_PK primary key (id) using index;
...
alter table TRANSPROVINCIAL_TASK
    add constraint TRANSPROVINCIAL_TASK_PK primary key (id) using index;
...
values ('xls,txt,doc,jpg,gif', 'transprovincial', '跨省集客业务工单流程', 1024, '/sheet/transprovincial', 101,
        '402881043a066d0f013a066d0fe60000');

--插入角色
insert into taw_system_role(role_id, deleted, parent_id, role_name, roletype_id, workflow_flag, leaf)
values ('2020', '0', '0', '建单人', '1', '994', '1');
insert into taw_system_role(role_id, deleted, parent_id, role_name, roletype_id, workflow_flag, leaf)
values ('2021', '0', '0', '网管二级审核人', '1', '994', '1');
insert into taw_system_role(role_id, deleted, parent_id, role_name, roletype_id, workflow_flag, leaf)
values ('2022', '0', '0', '地市工建人', '1', '994', '1');
insert into taw_system_role(role_id, deleted, parent_id, role_name, roletype_id, workflow_flag, leaf)
values ('2023', '0', '0', '地市维护人', '1', '994', '1');

--插入菜单
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402881043a066d0f013a066d0fe60001', '5801', '1', '新增工单', '58', null,
        '/sheet/transprovincial/transprovincial.do?method=showNewSheetPage', '0', '0', 1);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402881043a066d0f013a066d0fe60002', '5803', '0', '待处理工单', '58', null, null, '0', '0', 3);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402881043a066d0f013a066d0fe60003', '580301', '1', '待办工单', '5803', null,
        '/sheet/transprovincial/transprovincial.do?method=showListsendundo', '0', '0', 1);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402881043a066d0f013a066d0fe60004', '5807', '1', '工单查询', '58', null,
        '/sheet/transprovincial/transprovincial.do?method=showQueryPage', '0', '0', 7);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402881043a066d0f013a066d0fe60005', '5808', '1', '工单处理模板', '58', null,
        '/sheet/transprovincial/transprovincial.do?method=getDealTemplatesByUserId&type=templateManage', '0', '0', 8);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402881043a066d0f013a066d0fe60006', '5809', '1', '工单模板管理', '58', null,
        '/sheet/transprovincial/transprovincial.do?method=getTemplatesByUserId&type=templateManage', '0', '0', 9);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402881043a066d0f013a066d0fe60007', '5810', '1', '管理者工单', '58', null,
        '/sheet/transprovincial/transprovincial.do?method=showListForAdmin', '0', '0', 10);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402881043a066d0f013a066d0fe60008', '58', '0', '跨省集客业务工单流程', '10', null,
        '/sheet/transprovincial/transprovincial.do?method=showDrawing', '0', '0', 20);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402881043a066d0f013a066d0fe60009', '5802', '1', '草稿列表', '58', null,
        '/sheet/transprovincial/transprovincial.do?method=showDraftList', '0', '0', 2);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402881043a066d0f013a066d0fe6000a', '5804', '0', '已处理工单', '58', null, null, '0', '0', 4);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402881043a066d0f013a066d0fe6000b', '580402', '1', '建立工单', '5804', null,
        '/sheet/transprovincial/transprovincial.do?method=showOwnStarterList', '0', '0', 2);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402881043a066d0f013a066d0fe6000c', '580401', '1', '处理工单', '5804', null,
        '/sheet/transprovincial/transprovincial.do?method=showListsenddone', '0', '0', 1);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402881043a066d0f013a066d0fe6000d', '5805', '1', '已归档工单', '58', null,
        '/sheet/transprovincial/transprovincial.do?method=showHoldedList', '0', '0', 5);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402881043a066d0f013a066d0fe6000e', '5806', '1', '已作废工单', '58', null,
        '/sheet/transprovincial/transprovincial.do?method=showCancelList', '0', '0', 6);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402881043a066d0f013a066d0fe6000f', '5811', '1', '超时时间设置', '58', null,
        '/sheet/overtimetip/overtimetip.do?flowName=Transprovincial', '0', '0', 11);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402881043a066d0f013a066d0fe60010', '5812', '1', '工单处理时限配置', '58', null,
        '/sheet/newSheetLimit/sheetLimit.do?method=getLevelLimitList&flowName=Transprovincial', '0', '0', 30);