...
<input type="hidden" id="${sheetPageName}operateType" name="${sheetPageName}operateType" value="${sheetPageName}operateType" />	   
     ...
     <table id=sheet class="formTable">
      <c:if test="${status!=1}">
			      ...
			      <tr>
		            ...
		            <td  class="content"> <input type="text"  class="text" name="${sheetPageName}mainITRequirementID" value="${sheetMain.mainIsReferCost}" id="${sheetPageName}mainITRequirementID"  alt="allowBlank:true,maxLength:50,vtext:'请相关IT需求申请工单号，最多输入25字'"/></td>
		            ...
		            <td class="content">  
            	      ...
            	      initDicId="1011405"  alt="allowBlank:false" defaultValue="${sheetMain.mainIsReferCost}" styleClass="select-class"/>
			        </td>	                
		         </tr>
	              ...
	              <tr>
            	         ...
            	         initDicId="1011404"  alt="allowBlank:false" defaultValue="${sheetMain.mainNetSystem}" styleClass="select-class"/>
			             </td>	                
	...
	<div id="areaview" class="hide"></div>
	            ...
	            deptetree = new xbox({
    	          ...
    	          showChkFldId:'${sheetPageName}showDept',saveChkFldId:'${sheetPageName}mainApplyer',viewer:areaViewer
	            });
               </script>
               <input type="text" class="text"  readonly="readonly" name="${sheetPageName}showDept" id="${sheetPageName}showDept" alt="allowBlank:false,vtext:'请选择人员'" value="<eoms:id2nameDB id="${sheetPageName}showDept" beanId='tawSystemUserDao'/>"/>
               <input type="hidden" name="${sheetPageName}mainApplyer" id="${sheetPageName}mainApplyer" value="${sheetMain.mainApplyer}"/>			  
  </td>    
			      ...
			      <tr>
		            <td  class="label"><bean:message bundle="itsoftchange" key="itsoftchange.mainChangeDesc"/>*</td>
		              <td colspan="3"> 	
    				  <textarea class="textarea max" name="${sheetPageName}mainChangeDesc" id="${sheetPageName}mainChangeDesc" alt="width:500,allowBlank:false,maxLength:255,vtext:'请填入变更概述，最多输入125字'">${sheetMain.mainChangeDesc}</textarea>
                    </td>
		          </tr>
		           <tr>
				    <td class="label">
