           ...
           <tr>
			  ...
			  <td>
			  	 <eoms:comboBox name="${sheetPageName}mainNetTypeOne" id="${sheetPageName}mainNetTypeOne" 
			  	      sub="${sheetPageName}mainNetTypeTwo" initDicId="1010104" defaultValue="${sheetMain.mainNetTypeOne}" alt="allowBlank:false" onchange="selectLimit(this.value);"/>
			  </td>				
			  ...
			  <td>
			    <eoms:comboBox name="${sheetPageName}mainNetTypeTwo" id="${sheetPageName}mainNetTypeTwo" 
			  	      sub="${sheetPageName}mainNetTypeThree" initDicId="${sheetMain.mainNetTypeOne}" defaultValue="${sheetMain.mainNetTypeTwo}" onchange="selectLimit(this.value);"/>
			  </td>		  
			</tr>
			...
			<tr>
			  ...
			  <td>
			  	 <eoms:comboBox name="${sheetPageName}mainNetTypeThree" id="${sheetPageName}mainNetTypeThree"
			  	      initDicId="${sheetMain.mainNetTypeTwo}" defaultValue="${sheetMain.mainNetTypeThree}" onchange="selectLimit(this.value);"/>
			  </td>               
		         <td  class="label"><bean:message bundle="softchange" key="softchange.mainIsSecurity"/>*</td>
		          <c:choose>
					<c:when test="${empty sheetMain.mainIsSecurity}">
            	      ...
            	      initDicId="10301"  alt="allowBlank:false"  defaultValue="1030102" styleClass="select-class"/>
			        </td>
					</c:when>
					<c:otherwise>
						<td>  
				        <eoms:comboBox name="${sheetPageName}mainIsSecurity" id="${sheetPageName}mainIsSecurity" 
            	      initDicId="10301"  alt="allowBlank:false"  defaultValue="${sheetMain.mainIsSecurity}" styleClass="select-class"/>
			        </td>
					</c:otherwise>
              ...
              <tr>    	
			              ...
			              <td colspan="3"> 	
	                            ...
	                            <textarea class="textarea max" readonly="true" name="mainAssortSpeciality2" style="height:50px" id="mainAssortSpeciality2"  alt="allowBlank:true"><eoms:invert appCode="softchange" sheetKey="${sheetMain.mainAssortSpeciality}" beanId="CacheBean" scope="page"/></textarea>
	               ...
	               <tr>
            	      ...
            	      initDicId="10301"  alt="allowBlank:false" styleClass="select-class" defaultValue="${sheetMain.mainIsConnect}"/>
			             </td>
			       </tr>
		 <tr> 
      ...
      <input type="hidden" name="${sheetPageName}mainFactory" id="${sheetPageName}mainFactory" value="${sheetMain.mainFactory}"/>			  
			 ...
			 <tr>
		            <td  class="label"><bean:message bundle="softchange" key="softchange.mainApplyReason"/>*</td>
		              <td colspan="3"> 	
    				  <textarea class="textarea max" name="${sheetPageName}mainApplyReason" id="${sheetPageName}mainApplyReason" alt="width:500,allowBlank:false,maxLength:2000,vtext:'请填入申请依据，最多输入2000字'">${sheetMain.mainApplyReason}</textarea>
                    </td>
		    </tr>
            ...
            <td colspan="3"> 
              <script type="text/javascript">
               ...
               <input onclick="resetNet(0)" value="重置" type="button" class="btn">
  			   <textarea class="textarea max" readonly="true" name="${sheetPageName}mainCellInfo" id="${sheetPageName}mainCellInfo" alt="width:500,allowBlank:false,maxLength:2000,vtext:'请填入变更网元，请最多输入2000字'">${sheetMain.mainCellInfo}</textarea>
            </td>
      </tr>      
	  <tr>
            ...
            <td> 
		      ...
		      <textarea class="textarea max" readonly="true" name="${sheetPageName}showSoftCDKey" style="height:50px" id="${sheetPageName}showSoftCDKey"  alt="allowBlank:false,maxLength:250,vtext:'请填入设备厂家，最多输入125个汉字'"><c:forTokens items="${sheetMain.mainSoftCDKey}" delims="," var="mainSoftCDKey" varStatus="status"><eoms:id2nameDB id="${mainSoftCDKey}" beanId="ItawSystemDictTypeDao"/><c:choose><c:when test="${status.last}"></c:when><c:otherwise>,</c:otherwise></c:choose></c:forTokens></textarea>              
		      <input type="hidden" name="${sheetPageName}mainSoftCDKey" id="${sheetPageName}mainSoftCDKey" value="${sheetMain.mainSoftCDKey}"/>			  
            </td>
            <td  class="label"><bean:message bundle="softchange" key="softchange.mainSoftPatchKey"/>*</td>
            <td> <input type="text"  class="text" name="${sheetPageName}mainSoftPatchKey" id="${sheetPageName}mainSoftPatchKey"  value="${sheetMain.mainSoftPatchKey}" alt="allowBlank:false,maxLength:25,vtext:'请填入软件补丁号，最多输入25字'"/></td>
      </tr>
          <tr>
            <td  class="label"><bean:message bundle="softchange" key="softchange.mainIsAllow"/>*</td>
            <td>  
		        <eoms:comboBox name="${sheetPageName}mainIsAllow" id="${sheetPageName}mainIsAllow" initDicId="10301"  alt="allowBlank:false" styleClass="select-class" defaultValue="${sheetMain.mainIsAllow}" />
	        </td>	                
            <td  class="label"><bean:message bundle="softchange" key="softchange.mainAllowKey"/></td>
            <td> <input type="text"  class="text" name="${sheetPageName}mainAllowKey" id="${sheetPageName}mainAllowKey"  value="${sheetMain.mainAllowKey}" alt="allowBlank:true,maxLength:25 ,vtext:'请填入入网许可证号，最多输入25字'"/></td>
        </tr>
	  <tr>
            <td  class="label"><bean:message bundle="softchange" key="softchange.mainSoftDetail"/></td>
            <td colspan="3"> 	
  				  <textarea class="textarea max" name="${sheetPageName}mainSoftDetail" id="${sheetPageName}mainSoftDetail" alt="width:500,allowBlank:true,maxLength:2000,vtext:'请填入软件信息详细描述，最多输入2000字'">${sheetMain.mainSoftDetail}</textarea>
            </td>
       </tr>
	 ...
	 <tr>
            ...
            <td colspan="3">
               ...
               <input onclick="resetNet(1)" value="重置" type="button" class="btn"> 
  			   <textarea class="textarea max" readonly="true" name="${sheetPageName}maincellinfo1" id="${sheetPageName}maincellinfo1">${sheetMain.maincellinfo1}</textarea>
            </td>
      </tr>      
	  <tr>
            ...
            <div id="factoryview" class="hide"></div>
		      ...
		      <textarea class="textarea max" readonly="true" name="${sheetPageName}showSoftCDKey1" style="height:50px" id="${sheetPageName}showSoftCDKey1"   ><c:forTokens items="${sheetMain.mainsoftcdkey1}" delims="," var="mainsoftcdkey1" varStatus="status"><eoms:id2nameDB id="${mainsoftcdkey1}" beanId="ItawSystemDictTypeDao"/><c:choose><c:when test="${status.last}"></c:when><c:otherwise>,</c:otherwise></c:choose></c:forTokens></textarea>              
		      <input type="hidden" name="${sheetPageName}mainsoftcdkey1" id="${sheetPageName}mainsoftcdkey1" value="${sheetMain.mainsoftcdkey1}"/>			  
            </td>
            <td  class="label"><bean:message bundle="softchange" key="softchange.mainSoftPatchKey"/>1</td>
            <td> <input type="text"  class="text" name="${sheetPageName}mainsoftpatchkey1" id="${sheetPageName}mainsoftpatchkey1"  value="${sheetMain.mainsoftpatchkey1}" /></td>
      </tr>
          <tr>
            <td  class="label"><bean:message bundle="softchange" key="softchange.mainIsAllow"/>1</td>
            <td>  
		        <eoms:comboBox name="${sheetPageName}mainisallow1" id="${sheetPageName}mainisallow1" initDicId="10301" defaultValue="${sheetMain.mainisallow1}"  styleClass="select-class"   />
	        </td>	                
            <td  class="label"><bean:message bundle="softchange" key="softchange.mainAllowKey"/>1</td>
            <td> <input type="text"  class="text" name="${sheetPageName}mainallowkey1" id="${sheetPageName}mainallowkey1"  value="${sheetMain.mainallowkey1}" /></td>
        </tr>
	  <tr>
            <td  class="label"><bean:message bundle="softchange" key="softchange.mainSoftDetail"/>1</td>
            <td colspan="3"> 	
  				  <textarea class="textarea max" name="${sheetPageName}mainsoftdetail1" id="${sheetPageName}mainsoftdetail1">${sheetMain.mainsoftdetail1}</textarea>
            </td>
       </tr>
	 ...
	 <tr>
            ...
            <td colspan="3">
                ...
                <input onclick="resetNet(2)" value="重置" type="button" class="btn">  
  			   <textarea class="textarea max" readonly="true" name="${sheetPageName}maincellinfo2" id="${sheetPageName}maincellinfo2"></textarea>
            </td>
      </tr>      
	  <tr>
            ...
            <div id="factoryview" class="hide"></div>
		      ...
		      <textarea class="textarea max" readonly="true" name="${sheetPageName}showSoftCDKey2" style="height:50px" id="${sheetPageName}showSoftCDKey2" ><c:forTokens items="${sheetMain.mainsoftcdkey2}" delims="," var="mainsoftcdkey2" varStatus="status"><eoms:id2nameDB id="${mainsoftcdkey2}" beanId="ItawSystemDictTypeDao"/><c:choose><c:when test="${status.last}"></c:when><c:otherwise>,</c:otherwise></c:choose></c:forTokens></textarea>              
		      <input type="hidden" name="${sheetPageName}mainsoftcdkey2" id="${sheetPageName}mainsoftcdkey2" value="${sheetMain.mainsoftcdkey2}"/>			  
            </td>
            <td  class="label"><bean:message bundle="softchange" key="softchange.mainSoftPatchKey"/>2</td>
            <td> <input type="text" class="text" name="${sheetPageName}mainsoftpatchkey2" id="${sheetPageName}mainsoftpatchkey2"  value="${sheetMain.mainsoftpatchkey2}" /></td>
      </tr>
          <tr>
            <td  class="label"><bean:message bundle="softchange" key="softchange.mainIsAllow"/>2</td>
            <td>  
		        <eoms:comboBox name="${sheetPageName}mainisallow2" id="${sheetPageName}mainisallow2" initDicId="10301"  styleClass="select-class" />
	        </td>	                
            <td  class="label"><bean:message bundle="softchange" key="softchange.mainAllowKey"/>2</td>
            <td> <input type="text"  class="text" name="${sheetPageName}mainallowkey2" id="${sheetPageName}mainallowkey2"  /></td>
        </tr>
	  <tr>
            <td  class="label"><bean:message bundle="softchange" key="softchange.mainSoftDetail"/>2</td>
            <td colspan="3"> 	
  				  <textarea class="textarea max" name="${sheetPageName}mainsoftdetail2" id="${sheetPageName}mainsoftdetail2"></textarea>
            </td>
       </tr>
...
<table class="formTable">
	                <tr>
		             ...
		             <td>  
            	      ...
            	      initDicId="10301"  alt="allowBlank:true" styleClass="select-class" defaultValue="${sheetMain.mainIsBack}"/>
			        </td>	                
            	      ...
            	      initDicId="1010901"  alt="allowBlank:false" styleClass="select-class" defaultValue="${sheetMain.mainChangeSource}" onchange="isHold(this.value);"/>
			        </td>	                
		            </tr>
		        ...
		        <c:if test="${!empty parentSheetId}">
					<input type="text"  class="text" name="${sheetPageName}mainParentProcessName" id="${sheetPageName}mainParentProcessName"  value="${parentSheetId}" alt="allowBlank:true" readonly/>
			  	</c:if>
			  	<c:if test="${empty parentSheetId}">
					<input type="text"  class="text" name="${sheetPageName}mainParentProcessName" id="${sheetPageName}mainParentProcessName"  value="${sheetMain.mainParentProcessName}" alt="allowBlank:true"/>
			  	</c:if>
			  	</td>
            	      ...
            	      initDicId="10301"  alt="allowBlank:true" styleClass="select-class" defaultValue="${sheetMain.mainIsNeedDesign}" onchange="ifDoProjectDeal(this.value)"/>
            	      <input type="hidden" name="${sheetPageName}trueActiveTemplateId" id="${sheetPageName}trueActiveTemplateId" value="${taskName}"/>
			        </td>	                
		            </tr>
	<!--     <tr>
		 ...
		 <tr>
		    ...
		    <eoms:attachment name="sheetMain" property="sheetAccessories" 
				...
				<!-- 是否报备 -->
			<input type="hidden" name="${sheetPageName}mainifrecord" id="${sheetPageName}mainifrecord" value="${sheetMain.mainifrecord}" />
	...
	<table id="sheetProjectCreate" class="formTable" style="display:none">
			      <tr>
		            <td  class="label"><bean:message bundle="softchange" key="softchange.linkCompleteLimitTime"/>*</td>
		   			...
		   			value="${eoms:date2String(sheetMain.linkCompleteLimitTime)}" id="${sheetPageName}linkCompleteLimitTime" />
                    </td>
		            <td  class="label"><bean:message bundle="softchange" key="softchange.linkDesignKey"/>*</td>
		             <td class="content"> <input type="text"  class="text" name="${sheetPageName}linkDesignKey" id="${sheetPageName}linkDesignKey" value="${sheetMain.linkDesignKey}" alt="allowBlank:false,maxLength:25,vtext:'请填入技术方案关键字，最多输入25字'"/></td>
		          </tr>
			      <tr>
		            <td  class="label"><bean:message bundle="softchange" key="softchange.linkDesignComment"/></td>
		              <td colspan="3" class="content"> 	
    				  <textarea class="textarea max" name="${sheetPageName}linkDesignComment" id="${sheetPageName}linkDesignComment" alt="width:500,allowBlank:true,maxLength:2000,vtext:'请填入技术方案说明，最多输入2000字'">${sheetMain.linkDesignComment}</textarea>
                    </td>
		          </tr>
						      <tr>
			      	<!-- 变更涉及省份 -->
		           ...
		           涉及省份及地市*</td>
    				  ...
    				  <br/><br/>	
    				  涉及省份:<textarea class="textarea max" readonly="true" name="linkInvolvedProvince" style="height:50px" id="${sheetPageName}linkInvolvedProvince"  alt="allowBlank:false,maxLength:4000,vtext:'请填入备注信息，最多输入4000字符'">${sheetMain.linkInvolvedProvince }</textarea><br/>
    				  涉及地市:<textarea class="textarea max" readonly="true" name="linkInvolvedCity" style="height:50px" id="${sheetPageName}linkInvolvedCity" alt="allowBlank:true,maxLength:4000,vtext:'请填入备注信息，最多输入4000字符'">${sheetMain.linkInvolvedCity}</textarea>
...
function callback(jsonData,str){
		...
		return true;
			      ...
			      <tr>
		            <td  class="label"><bean:message bundle="softchange" key="softchange.linkRiskEstimate"/>*</td>
		              <td colspan="3" class="content"> 	
    				  <textarea class="textarea max" name="${sheetPageName}linkRiskEstimate" id="${sheetPageName}linkRiskEstimate" alt="width:500,allowBlank:false,maxLength:2000,vtext:'请填入风险评估，最多输入2000字'">${sheetMain.linkRiskEstimate}</textarea>
                    </td>
		          </tr>
			      <tr>
		            <td  class="label"><bean:message bundle="softchange" key="softchange.linkEffectAnalyse"/>*</td>
		              <td colspan="3" class="content"> 	
    				  <textarea class="textarea max" name="${sheetPageName}linkEffectAnalyse" id="${sheetPageName}linkEffectAnalyse" alt="width:500,allowBlank:false,maxLength:2000,vtext:'请填入影响业务分析，最多输入2000字'">${sheetMain.linkEffectAnalyse}</textarea>
                    </td>
		          </tr>
	...
	<fieldset id="link3">
	 <legend>
          ...
          <eoms:chooser id="test33" type="role" roleId="256" flowId="43" config="{returnJSON:true,showLeader:true,mainPanelTitle:'可选择的子角色'}"
