        ...
        <div class="history-item-content">
            <table class="formTable" width="100%" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td class="label" nowrap="nowrap">
                        <bean:message bundle="sheet" key="tawCommonsAccessoriesConfigForm.list.uploadDep"/>
                    </td>
                    <td class="label content" nowrap="nowrap">
                ...
                <logic:present name="sheetAccessories">
                    <logic:iterate id="tawCommonsAccessoriesForm" name="sheetAccessories"
                                   type="com.boco.eoms.commons.accessories.webapp.form.TawCommonsAccessoriesForm"
                                   scope="request">
                        <tr>
                            <td>
                                <input type="checkbox" name="accessoriesIds" id="accessoriesIds"
                                       value="${tawCommonsAccessoriesForm.id}">
                            </td>
                            <td>
                                <eoms:dict key="dict-sheet-safetyproblem" dictId="activeTemplateId"
                                           itemId="${tawCommonsAccessoriesForm.activeTemplateId}"
                            ...
                            <td>
                                <eoms:id2nameDB id="${tawCommonsAccessoriesForm.accessoriesUploader}"
                                                beanId="tawSystemUserDao"/>
                            </td>
                            <td>
                                <eoms:id2nameDB id="${tawCommonsAccessoriesForm.accessoriesDep}"
                                                beanId="tawSystemDeptDao"/>
                            </td>
                            <td>
                                <bean:write name="tawCommonsAccessoriesForm" property="accessoriesUploadDate"
                    ...
                    <table>
                        <tr>
                            <td>
                                <input type="button" name="button" class="button" value="${eoms:a2u('批量导出')}"
                                       onclick="download()">
                            </td>
                        </tr>
                    </table>
