...
<div id="sheetform">
    <c:if test="${operateType=='46'||operateType=='11'}">
        <%
            ...
            {
        %>
        <form id="form1" name="form1" action="http://10.30.174.16:8089/AiNetEmos/testTask/toSaveTestTaskEoms"
            ...
            <input type="hidden" value="${sheetMain.customAttribution}" id="customAttribution"
        ...
        <c:choose>
            ...
            <c:when test="${operateType=='61'}">
                <div class="form-btns" id="btns">
                    <input type="submit" class="submit"
                           onclick="v.passing=true;this.form.action='${app}/sheet/complaint/complaint.do?method=performClaimTask'"
            ...
            <c:when test="${taskName=='DraftHumTask'}">
                <div class="form-btns" id="btns">
                    ...
                    <input type="submit" class="submit"
                           onclick="v.passing=true;this.form.action='${app}/sheet/complaint/complaint.do?method=showDraftList'"
            ...
            <c:otherwise>
                ...
                <div class="form-btns hide" id="btns">
                    ...
                    %>
                    <input type="submit" class="submit" name="method.save" id="method.save"
                           onclick="javascript:ifisCopy();showCount();ifisDuban();"
                           value="<bean:message bundle='sheet' key='button.done'/>">
                    <%
                        }
                        else
