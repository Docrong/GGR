...
String sheetKey = (String) request.getParameter("sheetKey");
 %>
     ...
     <input type="hidden" name="mainClassName" value="com.boco.eoms.sheet.citycustom.model.CityCustomMain"/>	<!--main\u8868Model\u5bf9\u8c61\u7c7b\u540d-->	
     <input type="hidden" name="linkClassName" value="com.boco.eoms.sheet.citycustom.model.CityCustomLink"/> <!--link\u8868Model\u5bf9\u8c61\u7c7b\u540d--> 
...
<%@ include file="/WEB-INF/pages/wfworksheet/citycustom/baseinputlinkhtmlnew.jsp"%>
     ...
     <tr>
      ...
      <logic:iterate id="toTask" name="toOperaterList" type="com.boco.eoms.sheet.citycustom.model.CityCustomTask">  
        <tr>
          <td>
