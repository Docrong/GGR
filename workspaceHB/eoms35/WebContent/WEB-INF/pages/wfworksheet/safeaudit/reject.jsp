...
function showPage(){
     var pars = '';
     var url = '';    
      url = '${app}/sheet/safeaudit/safeaudit.do?method=showInputRejectPage&piid=${sheetMain.piid}&taskId=${taskId}&taskName=${taskName}';
     if (url!=''){
...
<div id="sheetform">
<html:form action="/safeaudit.do?method=performDeal" styleId="theform">
