 ...
 * 
 */
public class KmContentsApply extends BaseObject {
	 ...
	 *
	 */
	private java.lang.String applyCount;
  
	public java.lang.String getApplyCount() {
		return applyCount;
	}

	public void setApplyCount(java.lang.String applyCount) {
		this.applyCount = applyCount;
	}

	public boolean equals(Object o) {
		if( o instanceof KmContentsApply ) {
			KmContentsApply kmContentsApply=(KmContentsApply)o;
			if (this.id != null || this.id.equals(kmContentsApply.getId())) {
				return true;
			} else {
				return false;
			}
