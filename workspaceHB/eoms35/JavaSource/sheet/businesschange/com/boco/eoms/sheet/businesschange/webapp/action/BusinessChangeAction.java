...
import com.boco.eoms.sheet.businesschange.model.BusinessChangeMain;
import com.boco.eoms.sheet.interfaceBase.util.InterfaceConstants;
import com.boco.eoms.sheet.interfaceBase.util.InterfaceUtilProperties;

public class BusinessChangeAction extends SheetAction {
    /**
     * @param mapping
     * @param form
     * @param request
    ...
    public ActionForward performDeal(ActionMapping mapping, ActionForm form,
        ...
        if (sheetKey.equals(""))
            ...
            BusinessChangeMain main = (BusinessChangeMain) baseSheet.getMainService().getSingleMainPO(sheetKey);
            if (main.getIsCustomerFlag() != null && main.getIsCustomerFlag().equals("1")) {    //接口派单
                ...
                if (sendImmediately.equalsIgnoreCase("true")) {
                    ...
                    if (taskName.equals("ExcuteHumTask")
                        ...
                        String opDetail = InterfaceUtilProperties.getInstance().getXmlFromMap(request.getParameterMap(), StaticMethod.getFilePathForUrl("classpath:config/businessChange-crm.xml"), nodeName);
                        CrmLoader.withdrawWorkSheet(InterfaceConstants.SERVIVETYPE_BUSINESSCHANGE, serviceType,
                        ...
                        String opDetail = InterfaceUtilProperties.getInstance().getXmlFromMap(request.getParameterMap(), StaticMethod.getFilePathForUrl("classpath:config/businessChange-crm.xml"), nodeName);
                        CrmLoader.notifyWorkSheet(InterfaceConstants.SERVIVETYPE_BUSINESSCHANGE, serviceType,
                                main.getParentCorrelation(), opDetail, attachRef);
                    } else if (operateType.equals("205")) {// 回复
                        String taskId = StaticMethod.nullObject2String(request.getParameter("TKID"));
                        ITaskService iTaskService = (ITaskService) ApplicationContextHolder.getInstance().getBean("ibusinesschangeTaskManager");
                        ...
                        String opDetail = InterfaceUtilProperties.getInstance().getXmlFromMap(request.getParameterMap(), StaticMethod.getFilePathForUrl("classpath:config/businessChange-crm.xml"), nodeName, chNameList, enNameList, contentList);
                        CrmLoader.replyWorkSheet(InterfaceConstants.SERVIVETYPE_BUSINESSCHANGE, serviceType,
                                main.getParentCorrelation(), opDetail, attachRef);
                    }
                }
            }
            ...
            if (main.getIsCustomerFlag() != null && main.getIsCustomerFlag().equals("1")) {    //接口派单
                ...
                if (sendImmediately.equalsIgnoreCase("true")) {
                    ...
                    if (taskName.equals("ExcuteHumTask") && operateType.equals("61")) {// 受理
                        ...
                        String opDetail = InterfaceUtilProperties.getInstance().getXmlFromMap(request.getParameterMap(), StaticMethod.getFilePathForUrl("classpath:config/businessChange-crm.xml"), nodeName);
                        CrmLoader.confirmWorkSheet(InterfaceConstants.SERVIVETYPE_BUSINESSCHANGE, serviceType,
                                main.getParentCorrelation(), opDetail, attachRef);
                    }
                }
            }
