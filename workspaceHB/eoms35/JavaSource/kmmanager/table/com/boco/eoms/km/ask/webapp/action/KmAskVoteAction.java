...
import com.boco.eoms.km.ask.util.KmAskVoteConstants;
import com.boco.eoms.km.ask.webapp.form.KmAskVoteForm;
...
//			Map map = (Map) kmAskVoteMgr.getKmAskVotes(pageIndex, pageSize, "");
//			List list = (List) map.get("result");
//			KmAskVote kmAskVote = new KmAskVote();
//			
//			//创建ATOM源
...
//				kmAskVote = (KmAskVote) list.get(i);
//				
...
//						+ "/kmAskVote/kmAskVotes.do?method=edit&id="
//						+ kmAskVote.getId() + "' target='_blank'>"
