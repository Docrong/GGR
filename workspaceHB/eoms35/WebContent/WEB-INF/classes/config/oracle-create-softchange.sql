...
insert into taw_system_application(app_name,notes,domain_type) values('软件变更流程','软件变更流程',1);
insert into taw_system_workflow(name,flowid,sheetid,remark,mainservicebeanid) values('SoftChangeProcess','15','01','软件变更流程','iSoftChangeMainManager');
