...
<html:form method="post" action="/TawRmRecord/submit">
    ...
    <TABLE cellSpacing="2" cellPadding="1" width="600">
        <TR>
            <TD align="middle" valign="top">
                ...
                <TABLE cellSpacing="1" cellPadding="1" width="600" align="center"
                    ...
                    <TR class="tr_show">
                        <TD align="center" class="label" colSpan="7" noWrap><bean:message
                                key="TawRmRecord.exchange_per"/></TD>
                    ...
                    <TR class="tr_show">
                        ...
                        <TD noWrap colSpan="1">
                            <input type="text" name="exchangeTime" size="20"
                                   onclick="popUpCalendar(this, this,null,null,null,true,-1);" readonly="true"
                                   class="text">
                        </TD>
                    </TR>
                    <TR class="tr_show">
                        <TD align="center" class="label" rowSpan="2" noWrap><bean:message
                                key="TawRmRecord.alarmnums"/></TD>
                    ...
                    <TR class="tr_show">
                        ...
                        <TD noWrap colSpan="5">
                            <TEXTAREA id=notes name=operationalState rows=2 cols=80 type="_moz"><bean:write
                                    name="tawRmRecordForm" property="operationalState" scope="request"/></TEXTAREA>
                    ...
                    <TR class="tr_show">
                        ...
                        <TD align="center" class="label" colSpan="2" noWrap><bean:message
                                key="TawRmRecord.leavesheetnum"/></TD>
                        <TD align="center" class="label" colSpan="2" noWrap><bean:message
                                key="TawRmRecord.leavesheetnums"/></TD>
                    ...
                    <TR class="tr_show">
                        <TD align="center" class="label" rowSpan="2" noWrap><bean:message
                                key="TawRmRecord.operation"/></TD>
                        <TD align="center" class="label" noWrap><bean:message key="TawRmRecord.purpose"/></TD>
                        <TD noWrap colSpan="5">
                            <TEXTAREA id=notes name=purpose rows=2 cols=80 type="_moz"><bean:write
                                    name="tawRmRecordForm" property="purpose" scope="request"/></TEXTAREA>
                            <SPAN id=Customvalidator2 style="DISPLAY: none; COLOR: red"
                                  clientvalidationfunction="CheckNotes"
                                  evaluationfunction="CustomValidatorEvaluateIsValid"
                                  display="Dynamic" errormessage="<BR>" controltovalidate="Notes"><BR>
                    ...
                    <TR class="tr_show">
                        ...
                        <TD noWrap colSpan="5">
                            <TEXTAREA id=notes name=completeFlag rows=2 cols=80 type="_moz"><bean:write
                                    name="tawRmRecordForm" property="completeFlag" scope="request"/></TEXTAREA>
                            <SPAN id=Customvalidator2 style="DISPLAY: none; COLOR: red"
                                  clientvalidationfunction="CheckNotes"
                                  evaluationfunction="CustomValidatorEvaluateIsValid"
                                  display="Dynamic" errormessage="<BR>" controltovalidate="Notes"><BR>
                    ...
                    <TR class="tr_show">
                        ...
                        <TD noWrap colSpan="6">
                            <TEXTAREA id=notes name=attentive rows=2 cols=80 type="_moz"><bean:write
                                    name="tawRmRecordForm" property="attentive" scope="request"/></TEXTAREA>
                            <SPAN id=Customvalidator2 style="DISPLAY: none; COLOR: red"
                                  clientvalidationfunction="CheckNotes"
                                  evaluationfunction="CustomValidatorEvaluateIsValid"
                                  display="Dynamic" errormessage="<BR>" controltovalidate="Notes"><BR>
                ...
                <TABLE cellSpacing="0" cellPadding="0" width="600" borderColorLight="#709FD5" borderColorDark="#ffffff"
                       align="center" bgColor="#f3f3f3" border="1" class="formTable">
                    <TR>
                        <TD>
                            <IFRAME ID=IFrame1 FRAMEBORDER=0 width="100%" height="130%" SCROLLING=YES
                                    SRC='../TawRmHangover/show.do?HANGWORKSERIAL=<%=strWorkSerial%>&RECEIVEWORKSERIAL=<%=strNextWorkSerial%>&strHQ=<%=strHQ%>'>
                            </IFRAME>
                        </TD>
                    </TR>
                </TABLE>
                ...
                <TABLE cellSpacing="0" cellPadding="0" width="600" borderColorLight="#709FD5" borderColorDark="#ffffff"
                    ...
                    <TR>
                        ...
                        <TD align="center" class="label"><%=typename%>
                        </TD>
                        ...
                        <TD align="center" class="label">
                            ...
                            <%} else {%>
                            [<a href="<%=url%>" target="_blank"><%=Dutyrecord%>
                        </a>]
                            <%}%>
                        </TD>
                ...
                <TABLE cellSpacing="0" cellPadding="0" width="600" borderColorLight="#709FD5" borderColorDark="#ffffff"
                       align="center" bgColor="#f3f3f3" border="1" class="formTable">
                    <TR>
                        <TD class="label" align="middle" valign="center" width="130" Nowrap><bean:message
                                key="TawRmRecord.dutymanname"/></TD>
                        <TD><input name="HanderName" id="HanderName" type="text"
                                   style="WIDTH: 153px; HEIGHT: 22px; BACKGROUND-COLOR: lightgrey" size="19" readonly=""
                                   value="<%=StaticMethod.null2String(String.valueOf(request.getAttribute("DUTYMANNAME")))%>"/>
                            <input name="Hander" id="Hander" type="hidden"
                                   value="<%=StaticMethod.null2String(String.valueOf(request.getAttribute("DUTYMANID")))%>"/>
                        </TD>
                    </TR>
                    <TR>
                        <TD class="label"><bean:message key="TawRmRecord.handerpassword"/></TD>
                        <TD><input name="HanderPwd" id="HanderPwd" type="password" style="WIDTH: 153px; HEIGHT: 24px"
                                   maxlength="25"/></TD>
                    </TR>
                    <TR>
                        ...
                        <TD><input type="radio" name="exFlag" value="0"><bean:message key="TawRmRecord.alread"/>
                            <input type="radio" name="exFlag" checked value="1"><bean:message key="TawRmRecord.noread"/>
                        </TD>
                    </TR>
                    ...
                    <TR>
                        ...
                        <TD><input name="ReceiverName" id="ReceiverName" type="text"
                                   style="WIDTH: 153px; HEIGHT: 22px; BACKGROUND-COLOR: lightgrey" size="18" readonly=""
                                   value="<%=StaticMethod.null2String(String.valueOf(request.getAttribute("RECEIVERMASTERNAME")))%>"/>
                            <input name="Receiver" id="Receiver" type="hidden"
                                   value="<%=StaticMethod.null2String(String.valueOf(request.getAttribute("RECEIVERMASTERID")))%>"/>
                        </TD>
                    </TR>
                    <TR>
                        <TD class="label"><bean:message key="TawRmRecord.receiverpassword"/></TD>
                        <TD><input name="ReceiverPwd" id="ReceiverPwd" type="password"
                                   style="WIDTH: 153px; HEIGHT: 24px" maxlength="25"/></TD>
                    </TR>
                    <%} else {%>
                    <TR>
                ...
                <TABLE cellSpacing="0" cellPadding="0" width="600" borderColorLight="#709FD5" borderColorDark="#ffffff"
                    ...
                    <TR>
                        ...
                        <TD colSpan="3">
                            ...
                            <input name="dutyman" id="dutyman" type="text" style="BACKGROUND-COLOR: lightgrey"
                                   readOnly="" size="58"
                                   value="<bean:write name="tawRmRecordForm" property="dutyman" scope="request"/>"/>
                    </TR>
                    <TR>
                        ...
                        <TD colSpan="3">
                            ...
                            <input name="receiver" id="receiver" type="text" style="BACKGROUND-COLOR: lightgrey"
                                   readOnly="" size="58"
                                   value="<bean:write name="tawRmRecordForm" property="receiver" scope="request"/>"/>
                        </TD>
                    </TR>
