...
<div id="sheetform">
    <html:form action="/businessimplement.do?method=performBatchDeal" styleId="theform">
                    ...
                    <table class="formTable">
                        ...
                        <tr>
                            <td class="label"><bean:message bundle="businessimplement"
                                                            key="businessimplement.mainNetSort1"/></td>
                            <td class="content">
                                <eoms:id2nameDB id="${sheetMain.mainNetSort1}" beanId="ItawSystemDictTypeDao"/>
                            </td>
                            <td class="label"><bean:message bundle="businessimplement"
                                                            key="businessimplement.mainNetSort2"/></td>
                            <td class="content">
                        ...
                        <tr>
                            <td class="label"><bean:message bundle="businessimplement"
                                                            key="businessimplement.mainNetSort3"/></td>
                            <td class="content">
                                <eoms:id2nameDB id="${sheetMain.mainNetSort3}" beanId="ItawSystemDictTypeDao"/>
                            </td>
                            <td class="label"><bean:message bundle="businessimplement"
                                                            key="businessimplement.mainTaskType"/></td>
                            <td class="content">
                        ...
                        <tr>
                            <td class="label"><bean:message bundle="businessimplement"
                                                            key="businessimplement.mainTaskDescription"/></td>
                        ...
                        <tr>
                            ...
                            <td colspan='3'>
                                <eoms:attachment name="sheetMain" property="sheetAccessories"
                                                 scope="request" idField="sheetAccessories" appCode="businessimplement"
                                                 viewFlag="Y"/>
                            </td>
                        </tr>
                    </table>
        ...
        <div id="sheetinfo">
            <table class="formTable">
                ...
                <tr>
                    ...
                    <td class="content">
                        <select id="dealSelector" onchange="checkValue(this)" alt="allowBlank:false,vtext:'请选择处理操作'">
                            <option value=""></option>
                            <option value="Receive"><bean:message bundle="businessimplement"
                                                                  key="businessimplement.dealrejectpass"/></option>
                            <option value="ExcuteHumTask"><bean:message bundle="businessimplement"
                                                                        key="businessimplement.nopassback"/></option>
                        </select>
                    </td>
                    <td class="label"></td>
                    <td class="content">
                        ...
                        <input type="hidden" name="beanId" value="iBusinessImplementMainManager"/>
                ...
                <tr>
                    <td class="label"><bean:message bundle="businessimplement" key="businessimplement.advice"/>*</td>
                    <td colspan="3">
