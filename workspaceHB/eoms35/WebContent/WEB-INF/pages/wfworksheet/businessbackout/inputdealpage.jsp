		...
		<%if(taskName.equals("TaskCreateAuditHumTask")){ %>	      
           ...
           <%if(!operateType.equals("61")&& !operateType.equals("4")){ %>
              <tr>
		            ...
		            <td colspan="3"><textarea class="textarea max" name="${sheetPageName}auditResult" id="${sheetPageName}auditResult" alt="width:500,allowBlank:true">${sheetLink.auditResult}</textarea></td>
		      </tr> 
		    ...
		    <%if(operateType.equals("111")){ 
		     ...
		     <%}else if(operateType.equals("205")){ //回复%>
        	  	...
        	  	<tr>
		           ...
		           <td class="content"><input type="text" class="text" value="${sheetLink.ndeptContact}" name="${sheetPageName}ndeptContact" id="${sheetPageName}ndeptContact" alt="allowBlank:false,maxLength:25,vtext:'${eoms:a2u('请输入网络部门联系人，最大长度为12个汉字！')}'"/></td>
		           <td class="label"><bean:message bundle="businessbackout" key="businessbackout.ndeptContactPhone"/>*</td>
		           <td class="content"><input type="text" class="text" value="${sheetLink.ndeptContactPhone}" name="${sheetPageName}ndeptContactPhone" id="${sheetPageName}ndeptContactPhone" alt="allowBlank:false,maxLength:50,vtext:'${eoms:a2u('请输入网络部门联系人电话，最大长度为25个汉字！')}'"/></td>
		          </tr>
		          <tr>
		            <td  class="label"><bean:message bundle="businessbackout" key="businessbackout.dealResult"/>*</td>
		            <td  class="content" colspan="3"><eoms:comboBox defaultValue="${sheetLink.dealResult}" name="${sheetPageName}dealResult" id="${sheetPageName}dealResult" initDicId="1011051"  alt="allowBlank:false" styleClass="select-class" alt="allowBlank:false,vtext:'${eoms:a2u('请选择处理结果！')}'"/></td>
		          </tr>
			      <tr>
		            <td  class="label"><bean:message bundle="businessbackout" key="businessbackout.dealDesc"/></td>
		            <td  colspan="3"><textarea class="textarea max" name="${sheetPageName}dealDesc" id="${sheetPageName}dealDesc" alt="width:500,allowBlank:false,maxLength:1000,vtext:'${eoms:a2u('请输入处理说明，最大长度为500个汉字！')}'">${sheetLink.dealDesc}</textarea></td>
		          </tr>	
             ...
             <tr>
        	    ...
        	    <%}else if(operateType.equals("10")){ //转派%>
        	       ...
        	       <tr>
		            ...
		            <td colspan="3"><textarea class="textarea max" name="${sheetPageName}transferReason" id="${sheetPageName}transferReason" alt="width:500,allowBlank:true,maxLength:2000,vtext:'${eoms:a2u('请输入转派理由，最大长度为1000个汉字！')}'">${sheetLink.transferReason}</textarea></td>
		          </tr>
        	    <% }else if(operateType.equals("8")){ //移交%>
        	       ...
        	       <tr>
		            ...
		            <td colspan="3"><textarea class="textarea max" name="${sheetPageName}transferReason" id="${sheetPageName}transferReason" alt="width:500,allowBlank:true">${sheetLink.transferReason}</textarea></td>
		          </tr>
                <%}%>
         	 ...
         	 <%if(operateType.equals("7")){ //处理回复不通过%>
         		<input type="hidden" name="${sheetPageName}operateType" id="${sheetPageName}operateType" value="7" />
         		 <input type="hidden" name="${sheetPageName}phaseId" id="${sheetPageName}phaseId" value="ExcuteHumTask" />
         		  <tr>
		            <td class="label"><bean:message bundle="businessbackout" key="businessbackout.dealDesc"/></td>
		            <td colspan="3"><textarea class="textarea max" name="${sheetPageName}dealDesc" id="${sheetPageName}dealDesc" alt="width:500,allowBlank:true,maxLength:2000,vtext:'${eoms:a2u('请输入处理说明，最大长度为1000个汉字！')}'">${sheetLink.dealDesc}</textarea></td>
		          </tr>
         ...
         <%}else if( taskName.equals("DraftHumTask")){%>
          ...
          <%}else if( taskName.equals("HoldHumTask")){%>
	 		 ...
	 		 <tr>
			    ...
			    <td colspan="3">
			      <eoms:comboBox name="${sheetPageName}holdStatisfied" 
			        id="${sheetPageName}holdStatisfied" defaultValue="${sheetMain.holdStatisfied != 0 ? sheetMain.holdStatisfied : 1030301}" initDicId="10303" styleClass="select" alt="allowBlank:false,vtext:'${eoms:a2u('请选择归档满意度！')}'"/>
			    </td>
			  </tr>
			  ...
			  <tr>
			    ...
			    <td colspan="3">
			      <textarea name="${sheetPageName}endResult" id="${sheetPageName}endResult" alt="width:500,allowBlank:false,maxLength:2000,vtext:'${eoms:a2u('请输入归档意见，最大长度为1000个汉字！')}'" class="textarea max">${sheetMain.endResult}</textarea>
			    </td>
			  </tr>	        			          			       			 
              <%}%>
     		...
     		<input type="hidden" name="${sheetPageName}operateType" id="${sheetPageName}operateType" value="-15" />
	 		 ...
	 		 <tr>
			    <td class="label"><bean:message bundle="businessbackout" key="businessbackout.remark" /></td>
			    <td colspan="3"><textarea name="${sheetPageName}remark" class="textarea max" id="${sheetPageName}remark" alt="allowBlank:false,maxLength:1000,width:500,vtext:'${eoms:a2u('请填入意见，最多输入1000字')}'">${sheetLink.remark}</textarea></td>
	 		 </tr>  
    	...
    	<tr>
	       <td class="label">
			...
			<td colspan="3">			
		        ...
		        alt="allowBlank:false,width:500,vtext:'${eoms:a2u('请最多输入200字')}'" alt="width:'500px'">${sheetLink.rejectReason}</textarea>
		  </td>
		</tr>  	
	<%} %>
  </table>
