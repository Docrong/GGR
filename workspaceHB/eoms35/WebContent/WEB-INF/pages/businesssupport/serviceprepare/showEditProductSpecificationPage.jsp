...
<html:form action="/serviceprepare.do?method=editProductSpecification" styleId="theform">
    ...
    <table class="formTable">
        <caption>
            <center>产品规格表信息</center>
        </caption>
        <tr>
            <td class="label">服务规格名称*</td>
            <td class="content">
                <input type="text" class="text" name="name" id="name" value="${productSpecification.name}"
                       alt="allowBlank:false,maxLength:25,vtext:'请填入服务规格名称，最多输入25字'"/>
            </td>
            <td class="label">编码*</td>
            <td class="content">
                <input type="text" class="text" name="code" id="code" value="${productSpecification.code}"
                       alt="allowBlank:false,maxLength:25,vtext:'请填入编码，最多输入25字'"/>
            </td>
        </tr>
        <tr>
            <td class="label">服务规格说明*</td>
            <td class="content" colspan="3">
                <textarea class="textarea max" name="comment" id="comment"
                          alt="width:500,allowBlank:false,maxLength:255,vtext:'请填入服务规格说明，最多输入125字'">${productSpecification.comment}</textarea>
            </td>
        </tr>
    </table>
