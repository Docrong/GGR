...
<table id=sheet class="formTable">
    <c:if test="${status!=1}">
        ...
        <tr>
            ...
            <td class="content"><input type="text" class="text" name="${sheetPageName}mainProductCode" readOnly="true"
                                       id="${sheetPageName}mainProductCode"
                                       alt="allowBlank:false,vtext:'${eoms:a2u('请选择新产品编号')}'"
        ...
        <tr>
            ...
            <td class="content" colspan="3">
                <eoms:comboBox name="${sheetPageName}mainReqType" id="${sheetPageName}mainReqType"
                               initDicId="1010501" alt="allowBlank:false" styleClass="select-class"
                               defaultValue="${sheetMain.mainReqType}"/>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td colspan="3">
                <textarea class="textarea max" name="${sheetPageName}mainTecDesc" id="${sheetPageName}mainTecDesc"
                          alt="allowBlank:false,maxLength:1000,vtext:'${eoms:a2u('请填入技术规范说明，最大长度为1000个汉字！')}'">${sheetMain.mainTecDesc}</textarea>
            </td>
        </tr>
        <!-- <tr>
        <td class="label">
        ...
        <tr>
            ...
            <td colspan="3">
                <eoms:attachment name="sheetMain" property="mainStandard"
                                 scope="request" idField="${sheetPageName}mainStandard" alt="allowBlank:false"
                                 appCode="businessplan"/>
            </td>
        </tr>
    </c:if>
</table>
