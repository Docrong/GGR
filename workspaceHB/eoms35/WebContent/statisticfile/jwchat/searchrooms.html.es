...
<html>
    ...
    <body style="margin:8px;">
        ...
        <table id="search_result_tab" width="100%" height="100%">
            <tr>
                <td>
                    <h2 id="search_result_header"></h2>
                </td>
            </tr>
            <tr>
                <td id="search_result_info"></td>
            </tr>
            <tr>
                <td width="100%" height="100%">
                    <iframe id="search_result_iframe" name="search_result_iframe" src="searchrooms_results_iframe.html"
        ...
        <tr>
            <td align=right>
                <button id="addbookmark_button" onClick="return addBookmark();" disabled>Marcador</button>
                &nbsp;
                <button id="join_room_button" onClick="return joinRoom();">Entrar</button>
                &nbsp;
                <button onClick="return backtosearch();">Atrás</button>
            </td>
        </tr>
    </table>
</body>
