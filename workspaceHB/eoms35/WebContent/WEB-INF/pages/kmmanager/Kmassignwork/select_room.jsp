...
<%@ include file="/common/header_eoms_ext.jsp"%>
  ...
  var config = {
    ...
    treeRootId:'-1',
    treeRootText:"${eoms:a2u('排班管理')}",
	pageFrameId:'formPanel-page',
	onClick:{url:"${app}/kmmanager/Kmassignwork/select_time.do?roomId=",text:"${eoms:a2u('排班管理')}"},
	ctxMenu:[
	          {id:'Child', text:'${eoms:a2u('排班管理')}',cls:'new-mi',url:'${app}/kmmanager/Kmassignwork/select_time.do?roomId='}
		    ],//end of ctxMenu 
	/************************
...
<div id="helpPanel" style="padding:10px;" class="x-layout-inactive-content">
	<dl>
		...
		<dd>${eoms:a2u('列出来的值班小组都是管理员对用户配置的值班小组域，在选择的值班小组上点击右键，选择【排班管理】。或者【直接点击值班小组】')}</dd>
		<dt>${eoms:a2u('排班')}</dt>
