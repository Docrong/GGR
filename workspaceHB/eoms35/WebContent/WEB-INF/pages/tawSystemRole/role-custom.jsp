...
<div id="rolePanel">
    ...
    <div id="rolePanel-users">
        <div style="margin:5px;">${eoms:a2u("人员列表:")}
            <div id="role-user-list" style="padding:10px;width:90%"></div>
        </div>
...
<div id="gridPanel" style="padding:10px;">
    ...
    <div id="subRoleUsers" style="margin:10px 0;padding:10px;background-color:#f1f1f1;border:1px solid #dadada">
        ...
        <div style="margin:5px;">${eoms:a2u("人员列表:")}
            <div id="user-list" style="padding:10px;width:90%"></div>
        </div>
...
<div id="crtSubRolesPanel" style="padding:10px;overflow:auto">
    <form action="/role/tawSystemSubRoles.do?method=jsonSubRoles" id="subRolesForm" name="subRolesForm">
        ...
        <div class="preHelp">
            <div class="preHeader">${eoms:a2u('1. 添加区分度选择器:')}</div>
        ...
        <table width="100%" cellspacing="3" border="1">
            <tr>
                <td class="preHelp">
                    ...
                    <div style="margin-bottom:10px"><label>${eoms:a2u('区分度 4')}</label>
                        <div id="distinction3"></div>
                    </div>

                    <div id="templates" style="display:none">

                        <div id="t1"><label>${eoms:a2u('选择一级专业')}:</label><br/>
                            <eoms:comboBox name="class1m" id="{id}" initDicId="1020101" multiple="multiple" size="4"
                                           styleClass="select-class"/>
                        </div>

                        <div id="t2"><label>${eoms:a2u('选择一级专业')}:</label><br/>
                            <eoms:comboBox name="class1" id="{id}" initDicId="1020101" sub="{sub}"
                                           styleClass="select-class"/>
                        </div>
