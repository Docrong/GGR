...
<div id="sheetform">
    <html:form action="/securityevaluate.do?method=performTransferWorkItem" styleId="theform">
        ...
        <input type="hidden" name="${sheetPageName}beanId" id="${sheetPageName}beanId"
               value="iSecurityEvaluateMainManager"/>
        <input type="hidden" name="${sheetPageName}mainClassName" id="${sheetPageName}mainClassName"
               value="com.boco.eoms.sheet.securityevaluate.model.SecurityEvaluateMain"/> <!--mainè¡¨Modelå¯¹è±¡ç±»å-->
        <input type="hidden" name="${sheetPageName}linkClassName" id="${sheetPageName}linkClassName"
               value="com.boco.eoms.sheet.securityevaluate.model.SecurityEvaluateLink"/> <!--linkè¡¨Modelå¯¹è±¡ç±»å-->
