...
<script language="javascript">
    ...
    function addPara(a, value) {
        ...
        Para.innerHTML = Para.innerHTML + '<span id ="' + idVal + '"><table class="form_table"><tr>'
            ...
            + '<td>参数值<br/><input name="postValue" type="text"  size="15" value="' + "$(" + value + ")" + '" class="smallInput"></td>'
            + '<td class="nobg">'
...
<form name="form1" action="<%=app %>/webtool/tag" onSubmit="return checkInput()">
    ...
    <table class="form_table">
        <tr>
            <th>提交地址：</th>
            <td>
                <input id="hrefCardId" name="hrefCardId" type="text" value="<%=tag.getHrefCardId() %>" size="20"><font
                    color="#FF0000">*</font>
            ...
            %>
			    <span id=<%=idVal%>>
			        <table class="form_table">
			            <tr>
			                <td>参数名称<br/>
						      <input name="postName" type="text" size="15" maxlength="20" value="<%=pfVO.getName()%>"
                                     class="smallInput"><font color="#FF0000">*</font>
					        </td>
			                <td>参数值<br/>
			                    <input name="postValue" type="text" size="15" value="<%=pfVO.getValue()%>"
                                       class="smallInput">
					        </td>
			                <td class="nobg">
			                     <input name="del" type="button" value="删除" onClick="delOpt(<%=idVal%>)" class="submit">
