...
String sheetKey = (String) request.getParameter("sheetKey");
 ...
 %>
     ...
     <input type="hidden" name="${sheetPageName}mainClassName" value="com.boco.eoms.sheet.businessimplementsms.model.BusinessImplementSmsMain"/>	<!--main\u8868Model\u5bf9\u8c61\u7c7b\u540d-->	
     <input type="hidden" name="${sheetPageName}linkClassName" value="com.boco.eoms.sheet.businessimplementsms.model.BusinessImplementSmsLink"/> <!--link\u8868Model\u5bf9\u8c61\u7c7b\u540d--> 
...
<%@ include file="/WEB-INF/pages/wfworksheet/businessimplementsms/baseinputlinkhtmlnew.jsp"%>
     ...
     <tr>
      ...
      <logic:iterate id="toTask" name="toOperaterList" type="com.boco.eoms.sheet.businessimplementsms.model.BusinessImplementSmsTask">  
        <tr>
          <td>
