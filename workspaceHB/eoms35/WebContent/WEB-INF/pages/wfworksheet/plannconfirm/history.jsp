...
<logic:present name="HISTORY" scope="request">  
      ...
      <logic:iterate id="baselink" name="HISTORY" type="com.boco.eoms.sheet.plannconfirm.model.PlannConfirmLink" >     
       <%         
        jNum += 1;       
      ...
      <div class="history-item">&nbsp;   
	      ...
	      <div class="history-item-title">
			 ...
			 <bean:write name="baselink" property="operateTime" formatKey="date.formatDateTimeAll" bundle="sheet" scope="page"/>&nbsp; 
	  	     ...
	  	     <eoms:dict key="dict-sheet-plannconfirm" dictId="activeTemplateId" itemId="${baselink.activeTemplateId}" beanId="id2descriptionXML" />
	  	     <bean:message bundle="plannconfirm" key="plannconfirm.operateType"/>:
	  	     <eoms:dict key="dict-sheet-plannconfirm" dictId="mainOperateType" itemId="${baselink.operateType}" beanId="id2descriptionXML" />
		  		...
		  		<%if(baselink.getActiveTemplateId()!=null && baselink.getActiveTemplateId().equals("AuditTask")) {%>
		  				...
		  				<%if(baselink.getOperateType() != null && (baselink.getOperateType().intValue() == 103 || baselink.getOperateType().intValue() == 11)){ %>
							...
							<td class="content">
						    	...
						    	<pre><eoms:id2nameDB id="${baselink.validationResult}" beanId="ItawSystemDictTypeDao"/></pre>
							...
							<td class="content">
								...
								<pre>${baselink.percentAgreement}</pre>
	 						</td>
							...
							<td class="content">
						    	...
						    	<pre><eoms:id2nameDB id="${baselink.groupDiscussion}" beanId="ItawSystemDictTypeDao"/></pre>
							...
							<td class="content">
								...
								<pre>${baselink.planningAzimuth}</pre>
	 						</td>
							...
							<td class="content">
								...
								<pre>${baselink.electronicAngle}</pre>
	 						</td>
							...
							<td class="content">
								...
								<pre>${baselink.mechanicalAngle}</pre>
	 						</td>
							...
							<td class="content">
								...
								<pre>${baselink.planningConfiguration}</pre>
	 						</td>
							...
							<td class="content">
						    	...
						    	<pre><eoms:id2nameDB id="${baselink.supplementScheme}" beanId="ItawSystemDictTypeDao"/></pre>
							...
							<td class="content">
								...
								<pre>${baselink.particularCase}</pre>
	 						</td>
							...
							<td class="content">
								...
								<pre>${baselink.contactInformation}</pre>
	 						</td>
...
<script type="text/javascript">
 ...
 function copy(id){
    ...
    Ext.Ajax.request({
		method:"get",
		url: "plannconfirm.do?method=getJsonLink&id="+id+"&beanName=PlannConfirm",
		success: function(x){
