...
<div id="sheetform">
    <html:form action="/securityobjaudit.do?method=performDealReplyReject" styleId="theform">
        <%
        ...
        <input type="hidden" name="subtaskName" value="SecurityObjAuditSubTask"/>
        ...
        <input type="hidden" name="mainClassName"
               value="com.boco.eoms.sheet.securityobjaudit.model.SecurityObjAuditMain"/>
        <input type="hidden" name="linkClassName"
               value="com.boco.eoms.sheet.securityobjaudit.model.SecurityObjAuditLink"/>
        <input type="hidden" name="taskNamespace" value="http://SecurityObjAudit"/>
