        ...
        <logic:present name="sheetMain" scope="request">
            ...
            <table class="formTable">
                <tr>
                    ...
                    <td class="content"><bean:write name="sheetMain" property="mainAlarmId" scope="request"/>
                        <INPUT id="btn" type="button" value="sop"
                               onclick="go('<bean:write name='sheetMain' property='mainAlarmId' scope='request'/>')">
                        <br/>
                        <input type="button" class="submit" value="自动预处理结果"
                               onclick="getalarmpreresult('${sheetMain.sheetId}')"/>
                        <c:if test="${!empty sheetMain.mainPretResult}">
                            <input type="button" class="submit" value="指令操作"
                                   onclick="GetAlarmPreOperation('${sheetMain.sheetId}')"/>
                            <input type="button" class="submit" value="综合查询"
                                   onclick="GetAlarmPreSearch('${sheetMain.sheetId}')"/>
                        </c:if>
                    </td>
                ...
                <tr>
                    ...
                    <td class="content" colspan='3'>
                        ...
                        <textarea name="selvalue" id="selvalue" readonly="readonly" value="" cols="100"
                                  rows="6"></textarea>
            ...
            <table class="formTable">
                ...
                <tr>
                    ...
                    <td class="content" colspan='3'>
                        <bean:write name="sheetMain" property="mainAlarmSolveDate" formatKey="date.formatDateTimeAll"
                ...
                <tr>
                    ...
                    <td class="content" colspan='3'>
                        <pre><bean:write name="sheetMain" property="mainAlarmDesc" scope="request"/></pre>
                    </td>
                </tr>
            ...
            <table class="formTable">
                ...
                <tr>
                    ...
                    <td class="content"><eoms:id2nameDB id="${sheetMain.mainFaultResponseLevel}"
                                                        beanId="ItawSystemDictTypeDao"/></td>
                ...
                <tr>
                    ...
                    <td class="content" colspan='3'>
                        <bean:write name="sheetMain" property="mainCompleteLimitT3" formatKey="date.formatDateTimeAll"
                                    bundle="sheet" scope="request"/>
                    </td>
                </tr>
                <tr>
                    <td class="label"><bean:message bundle="commonfault" key="commonfault.mainSendMode"/></td>
                    <td class="content"><eoms:id2nameDB id="${sheetMain.mainSendMode}"
                                                        beanId="ItawSystemDictTypeDao"/></td>
                ...
                <tr>
                    ...
                    <td class="content"><eoms:id2nameDB id="${sheetMain.mainEquipmentFactory}"
                                                        beanId="ItawSystemDictTypeDao"/></td>
                    <td class="label"><bean:message bundle="commonfault" key="commonfault.mainEquipmentModel"/></td>
                    <td class="content"><bean:write name="sheetMain" property="mainEquipmentModel"
                                                    scope="request"/></td>
                </tr>

                <tr>
                    <td class="label"><bean:message bundle="commonfault" key="commonfault.mainFaultGenerantPriv"/></td>
                    <td class="content"><bean:write name="sheetMain" property="mainFaultGenerantPriv"
                                                    scope="request"/></td>
                ...
                <tr>
                    ...
                    <td>${sheetMain.mainReserved1}</td>
                </tr>

                <tr>
                    <td class="label"><bean:message bundle="commonfault" key="commonfault.mainFaultGenerantTime"/></td>
                    <td class="content"><bean:write name="sheetMain" property="mainFaultGenerantTime"
                    ...
                    <td class="content"><eoms:id2nameDB id="${sheetMain.mainFaultDiscoverableMode}"
                                                        beanId="ItawSystemDictTypeDao"/>
                    </td>
                </tr>
                <tr>
                    <td class="label"><bean:message bundle="commonfault" key="commonfault.mainIfAffectOperation"/></td>
                    <td class="content"><eoms:id2nameDB id="${sheetMain.mainIfAffectOperation}"
                                                        beanId="ItawSystemDictTypeDao"/></td>
                    <td class="label">特殊工单说明</td>
                    <td class="content"><eoms:id2nameDB id="${sheetMain.mainPretreatment}"
                                                        beanId="ItawSystemDictTypeDao"/></td>
                ...
                <tr>
                    ...
                    <td class="content"><bean:write name="sheetMain" property="mainDetectFaultTime"
                                                    scope="request"/></td>
                ...
                <tr>
                    ...
                    <td>
                        <div id="selValueAlarmDisplay1" style="display: block;">
                            <bean:write name="sheetMain" property="mainAlarmSolveDate"
                                        formatKey="date.formatDateTimeAll" bundle="sheet" scope="request"/>
                        </div>
                        <div id="selValueAlarmDisplay2" style="display: none;">
                            <input type="text" class="text" name="selValueAlarm" id="selValueAlarm" readonly="readonly"
                                   value=""/>
                        </div>
                    </td>
                    <td class="content" colspan='2'>
                        <input type="button" class="submit" style=" color:red" value="获取告警清除时间"
                               onclick="onFaultAvoidDetail();"/>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="content"><eoms:id2nameDB id="${sheetMain.mainManualPreSolve}"
                                                        beanId="ItawSystemDictTypeDao"/></td>
                </tr>
                <tr>
                    ...
                    <td class="content"><bean:write name="sheetMain" property="mainFaultFirstDealDesc"
                                                    scope="request"/></td>
                </tr>
                <tr>
                    ...
                    <td class="content"><bean:write name="sheetMain" property="mainPretResultThree"
                                                    scope="request"/></td>
                </tr>
                <tr>
                    <td class="label">预处理重现结果第四次</td>
                    <td class="content" colspan='3'><bean:write name="sheetMain" property="mainPretResultFour"
                                                                scope="request"/></td>
                </tr>
                <tr>
                    <td class="label">驳回意见</td>
                    <td class="content" colspan='3'>
                        <pre>${linkUntreadReason}</pre>
                    </td>
                </tr>
                <c:if test="${sheetMain.qcMark==1}">
                    <tr>
                        ...
                        <td class="content" colspan='3'>
                            <pre><bean:write name="sheetMain" property="qcRemark" scope="request"/></pre>
                        </td>
                    </tr>
                </c:if>
	       ...
	       width="100%" src="../commonfault/commonfaultpack.do?method=showOwnStarterList&mainId=${sheetMain.id}&alarmMethod=<%=alarmMethod%>&taskName=<%=taskName%>"></iframe> 
                ...
                <c:if test="${sheetMain.mainCheckStatus== '1'&& isAdmin == 'true'}">
                    ...
                    <tr>
                        ...
                        <td class="content" colspan='3'>
                            <select name="check" id="check" size="1" style="FONT-SIZE: 8pt"
                                    onclick="changeAuditBasis()">
				...
				<textarea name="suggesions" id="suggesions" class="textarea max"
                        ...
                        <td colspan="1">
                            ...
                            <eoms:attachment name="sheetMain" property="rejectAccessories"
                                             scope="request" idField="${sheetPageName}rejectAccessories"
                                             appCode="commonfault"/>
                ...
                <c:if test="${sheetMain.mainCheckStatus== '2'}">
                    <tr>
                        ...
                        <td class="label" nowrap>核查告警清除时间：</td>
                        <td class="content" colspan='3'><bean:write name="sheetMain" property="mainCheckTime"
                                                                    format="yyyy-MM-dd HH:mm:ss" scope="request"/></td>
                    </tr>
                    <tr>
                        <td class="label" nowrap>申请附件</td>
                        <td>
                ...
                <c:if test="${sheetMain.mainCheckStatus== '3'}">
                    <tr>
                        ...
                        <td class="content" colspan='3'><bean:write name="sheetMain" property="mainCheckRejected"
                                                                    scope="request"/></td>
                    </tr>
                    <tr>
                        <td class="label" nowrap>申请附件</td>
...
<c:url var="urlShowCityRejectDealPage" value="commonfault.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
            ...
            <tr>
                ...
                %>
                    ...
                    <select id="dealSelector"
                        ...
                        <c:choose>
                            <c:when test="${sheetMain.mainIsOther == '1'}">
                                <option value="${urlShowCityRejectDealPage}">移交T2</option>
                            </c:when>
                            <c:otherwise>
                        ...
                        <option value="${urlShowCompleteDealPage}" selected="selected"><bean:message
                                bundle="commonfault" key="operateType.dealComplete"/></option>
                        <% } else { %>
                        <!-- 是父任务 -->
                        ...
                        <c:choose>
                            ...
                            <c:otherwise>
                                ...
                                <c:if test="${operateType=='1'||operateType==null||operateType==''}">
                                    <option value="${urlShowTransmitDealPage}" selected="selected"><bean:message
                                            bundle="commonfault" key="operateType.transmit1"/></option>
                                    <option value="${urlShowCompleteDealPage}"><bean:message bundle="commonfault"
                                                                                             key="operateType.dealComplete"/></option>
                                </c:if>
                                <c:if test="${operateType=='2'}">
                                    <option value="${urlShowTransmitDealPage}"><bean:message bundle="commonfault"
                                                                                             key="operateType.transmit1"/></option>
                                    <option value="${urlShowCompleteDealPage}" selected="selected"><bean:message
                                            bundle="commonfault" key="operateType.dealComplete"/></option>
                                </c:if>
                                <option value="${urlShowExamineDealPage}"><bean:message bundle="commonfault"
                                                                                        key="operateType.sendToExamine"/></option>
                                <!--寤舵湡鐢宠-->
                                ...
                                <option value="${urlShowInputSplit}"><bean:message bundle="sheet"
                        ...
                        <!-- 不需要等待回复 -->
                        <% if (ifwaitfor.equals("false")) {%>
                        <option value="${urlShowDispatchPage}"><bean:message bundle="commonfault"
                    ...
                    <select id="dealSelector"
                        ...
                        <c:if test="${centerMonitor == 'true' && sheetMain.mainT2RejectionNum != '4'}">
                        ...
                        <c:if test="${centerMonitor != 'true'}">
                            <option value="${urlShowTransmit2DealPage}"><bean:message bundle="commonfault"
                                                                                      key="operateType.transmit2"/></option>
                        </c:if>
                        <option value="${urlShowExamineDealPage}"><bean:message bundle="commonfault"
                                                                                key="operateType.sendToExamine"/></option>
                        <!--延期申请-->
                        <c:if test="${sheetMain.mainT2RejectionNum != '4'}">
                            <option value="${urlShowRejectBackPage}"><bean:message bundle="sheet"
                                                                                   key="common.rejectBack"/></option>
                        </c:if>
                        <c:choose>
                    ...
                    <select id="dealSelector">
                        <option value="${urlShowDraftPageDealPage}"><bean:message bundle="commonfault"
                                                                                  key="operateType.draft"/></option>
                    </select>
                    <%} else if (taskName.equals("BackHumTask")) {%>
                    <select id="dealSelector">
                        <option value="${urlBackDealPage}"><bean:message bundle="commonfault"
                    ...
                    <select id="dealSelector">
                        ...
                        <% if (ifwaitfor.equals("false")) {%>
                        <!-- 流程步骤 -->
                        <option value="${urlShowExamineYesDealPage}"><bean:message bundle="commonfault"
                                                                                   key="operateType.Examine"/></option>
                        <option value="${urlShowExamineNoDealPage}"><bean:message bundle="commonfault"
                    ...
                    <select id="dealSelector">
                        <option value="${urlShowHoldDealPage}"><bean:message bundle="commonfault"
                                                                             key="operateType.hold"/></option>
                        <option value="${urlShowRejectDealPage}"><bean:message bundle="commonfault"
...
<div id="advice" style="display:block">
    <input type="button" title="执行该操作，工单将进入作废状态，其他人不能在处理工单" value="<bean:message bundle="sheet" key="button.nullity"/>"
