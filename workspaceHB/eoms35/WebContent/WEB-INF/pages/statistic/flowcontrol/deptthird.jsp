...
<%@ page import="java.net.URLEncoder"%>
	  ...
	  StringBuffer xmlBuf = new StringBuffer();
		xmlBuf.append("<graph caption='第三层按各部门柱状图形报表'  decimalPrecision='0' formatNumberScale='0'>");
    xmlBuf.append("<categories>");
     for(int t=0;t<size;t++){
	      Map  map=(Map)statlist.get(t);
	      String s1=StatUtil.id2Name((String)map.get("s1"), "statBaseDeptId2name_v35");
	      xmlBuf.append("<category name='"+s1+"' />");
     }
  xmlBuf.append("</categories>");
...
<table class="listTable">
    <tr class="tr_show" >    
  	<td nowrap align="center" colspan="9" width="100%"><b>工单监控页面(第三层县市)</b></td>		      
  </tr>         

	<tr class="tr_show">
		<td nowrap align="center"  ><b>序号</b></td>	
		<td nowrap align="center" ><b>片 区</b></td>		
