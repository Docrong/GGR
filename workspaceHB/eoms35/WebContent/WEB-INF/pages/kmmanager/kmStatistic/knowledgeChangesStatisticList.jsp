...
<fmt:bundle basename="com/boco/eoms/km/config/applicationResource-kmmanager">
    ...
    <display:table name="knowledgeChangesStatisticList" cellspacing="0" cellpadding="0"
        ...
        <display:column property="baseName" sortable="true"
                        headerClass="sortable" titleKey="knowledgeChangesStatistic.baseName" paramId="id"
                        paramProperty="id"/>

        <display:column property="userName" sortable="true"
                        headerClass="sortable" titleKey="knowledgeChangesStatistic.userName" paramId="id"
                        paramProperty="id"/>

        <display:column property="addCount" sortable="true"
                        headerClass="sortable" titleKey="knowledgeChangesStatistic.addCount" paramId="id"
                        paramProperty="id"/>

        <display:column property="modifyCount" sortable="true"
                        headerClass="sortable" titleKey="knowledgeChangesStatistic.modifyCount" paramId="id"
                        paramProperty="id"/>

        <display:column property="deleteCount" sortable="true"
                        headerClass="sortable" titleKey="knowledgeChangesStatistic.deleteCount" paramId="id"
                        paramProperty="id"/>

        <display:column property="overCount" sortable="true"
                        headerClass="sortable" titleKey="knowledgeChangesStatistic.overCount" paramId="id"
                        paramProperty="id"/>
