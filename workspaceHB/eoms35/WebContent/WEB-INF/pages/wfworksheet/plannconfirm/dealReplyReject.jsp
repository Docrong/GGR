...
<div id="sheetform">
    <html:form action="/plannconfirm.do?method=performDealReplyReject" styleId="theform">
        <%
        ...
        <input type="hidden" name="subtaskName" value="PlannConfirmSubTask"/>
        ...
        <input type="hidden" name="taskNamespace" value="http://PlannConfirm"/>
