...
<html:form action="nbproductss.do?method=xsearch" method="post" styleId="nbproductsForm">
    <table height="35" width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td nowrap>
                <content tag="heading">${eoms:a2u('已删除产品目录库')}</content>
            </td>
            <td nowrap>
                <content tag="heading"><a href="#" onclick="undelete()">${eoms:a2u('进入新业务产品目录库')}</a></content>
            </td>
            <td width="380"></td>
            ...
            <td>
                <input id="btnSearch" type="button" align="right" name="button" onclick="queryDeleted()"
    ...
    <display:table name="nbproductsList" cellspacing="0" cellpadding="0"
                   ...
                   export="true"
                   requestURI="/sheet/nBProducts/nbproductss.do?method=showDeletedDetail&ifReference=${ifReference}"
                   sort="list">
        ...
        <display:column property="procode" sortable="true" headerClass="sortable"
                        url="/sheet/nBProducts/nbproductss.do?method=showDeletedDetail&flag=showDetail&ifReference=${ifReference}"
