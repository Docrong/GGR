...
<div id=page>
    <div class=clearfix id=content>
        <div id=main>
                    ...
                    <div class="x-dlg-tab" title="<bean:message key='rule.table.title.newRule'/>">
                        ...
                        <div class="inner-tab">
                            <form name="ruleform" id="ruleform"
                                  action="<html:rewrite page='/RuleWebToolAction.do?method=addRule'/>" method="post">
                                ...
                                <table class="simple" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td class="msource"><input class="wide"
                                                                   value="com.boco.eoms.commons.rule.service.ExpressionRuleService"
                                                                   name="className"/></td>
                                    </tr>
                                    </tbody>
                                </table>
            ...
            <div style="display:none">
                <table>
                    ...
                    <tr>
                        ...
                        <td class="msource"><input class="wide"
                                                   value="com.boco.eoms.commons.rule.listener.RuleCheckListener"
                                                   name="listenerName" size="20"/></td>
                        ...
                        <td class="mrowbtns">
                            <input name="button2" type=button onClick="removeRow(this);"
                                   value="<bean:message key='rule.table.button.delete'/>"></td>
                    </tr>
                    </tbody>
                    <!-- 监听行模板开始 -->
                </table>
                    ...
                    <table class="member-table" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td rowspan="4" class="mbtns">
                                <input type="button" onclick="removeTable(this);"
                                       value="<bean:message key='rule.table.button.delete'/>"><br/>
                            </td>
                        </tr>
                        <tr class="alt">
                            <td class="micon">&nbsp;</td>
                ...
                <div id="output-template">
                    <table class="member-table" cellspacing="0">
                        ...
                        <tr class="alt">
                            ...
                            <td class="msource">
                                <textarea rows="3" class="wide" name="outputExpression"
                                          id="expression-{ruleItemId}-{t}"></textarea>
                                <input value="<bean:message key='rule.table.button.editExpression'/>" type="button"
                                       onclick="javascript:window.open('<html:rewrite
                                               page='/RuleWebToolAction.do?method=initEditExpression&id={ruleId}&ruleId={ruleItemId}&outName={tempId}'/>','mywin', 'menubar=no,width=600,height=600,resizeable=yes');"/>
                            </td>
                        </tr>
                        </tbody>
                    </table>
            ...
            <table width="80%">
                <tr>
                    <td><strong>${rule.name}</strong><br></td>
                </tr>
                <tr>
                    <td><strong>${rule.xmlPath}</strong></td>
                </tr>
                <tr>
                    <td><input name="newrulebtn" id="newrulebtn" type="button" onClick=""
                               value="<bean:message key='rule.table.button.newRule'/>"></td>
                </tr>
            </table>
            <!-- 正文 -->
            ...
            <c:forEach items="${rules.rules.rule}" var="ruleItem">
                ...
                <input type="hidden" name="qclassName" value="${qclassName }"/>
                <!-- 规则 -->
                <h2><bean:message key="rule.table.title.description"/> | <input type="text"
                                                                                value="${ruleItem.description }"
                                                                                name="ruleDescription" class="wide"
                                                                                size="80"/>
                    <img src="/eoms/images/icons/plus.png" onclick="javascript:togglet('rule-${ruleItem.id}',this);"
                         alt="<bean:message key='rule.table.title.openclose'/>"/>
                </h2>
                <div class="detail-wrap" id="rule-${ruleItem.id}">
                    <div class="mdetail">
                        <strong><bean:message key="rule.table.title.ruleId"/>:</strong><input type="text"
                                                                                              value="${ruleItem.id }"
                                                                                              name="mruleId"
                                                                                              class="wide"
                                                                                              size="80"/><br>
                        <strong>&nbsp;&nbsp;<bean:message key="rule.table.title.class"/>:&nbsp;&nbsp;</strong><input
                            type="text" value="${ruleItem.className}" name="ruleClassName" size="80" class="wide"/>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" onClick=""
                                                                   value="<bean:message key='rule.table.button.submit'/>"><input
                            type="button" value="<bean:message key='rule.table.button.delete'/>"
                            onclick="javascript:delRule('${ruleItem.id}');"/>
                    </div>
                        ...
                        <c:forEach items="${ruleItem.input.parameters}" var="inputItem">
                            <table class="member-table" cellspacing="0" id="rule-${ruleItem.id}-input-table">
                                ...
                                <tr>
                                    <th class="micon">&nbsp;</th>
                                    <th class="mdesc"><bean:message key="rule.table.title.description"/></th>
                                    <th class="msource"><input type="text" value="${inputItem.description }"
                                                               name="inputDescription" size="80" class="wide"/></th>
                                    <td rowspan="4" class="mbtns">
                                        <input type="button" onclick="removeTable(this);"
                                               value="<bean:message key='rule.table.button.delete'/>">
                                    </td>
                                </tr>
                                <tr class="alt">
                                    <td class="micon">&nbsp;</td>
                                    <td class="mdesc"><bean:message key="rule.table.title.parameterName"/></td>
                                    <td class="msource"><input type="text" value="${inputItem.name }" name="inputName"
                                                               size="80" class="wide"/></td>
                                </tr>
                                <tr>
                                    <td class="micon">&nbsp;</td>
                                    <td class="mdesc"><bean:message key="rule.table.title.parameterType"/></td>
                                    <td class="msource"><input type="text" value="${inputItem.type }" name="inputType"
                                                               size="80" class="wide"/></td>
                                </tr>
                                </tbody>
                            </table>
                        </c:forEach>
                        <input type="button" onClick="inputTpl.append('rule-${ruleItem.id}-input')"
                               value="<bean:message key='rule.table.button.addParameter'/>">
                    </div>
                    <div class="tab-content" id="rule-${ruleItem.id}-output">
                        <c:forEach items="${ruleItem.output.parameters}" var="outputItem">
                            <table class="member-table" cellspacing="0">
                                ...
                                <tr>
                                    <th class="micon">&nbsp;</th>
                                    <th class="mdesc"><bean:message key="rule.table.title.description"/></th>
                                    <th class="msource"><input type="text" name="outputDescription"
                                                               value="${outputItem.description }" size="80"
                                                               class="wide"/></th>
                                    <td rowspan="4" class="mbtns">
                                        <input type="button" onclick="removeTable(this);"
                                               value="<bean:message key='rule.table.button.delete'/>">
                                ...
                                <tr class="alt">
                                    <td class="micon">&nbsp;</td>
                                    <td class="mdesc"><bean:message key="rule.table.title.parameterName"/></td>
                                    <td class="msource"><input type="text" name="outputName" value="${outputItem.name }"
                                                               size="80" class="wide"/></td>
                                </tr>
                                <tr>
                                    <td class="micon">&nbsp;</td>
                                    <td class="mdesc"><bean:message key="rule.table.title.parameterType"/></td>
                                    <td class="msource"><input type="text" name="outputType" value="${outputItem.type }"
                                                               size="80" class="wide"/></td>
                                </tr>
                                <tr class="alt">
                                    <td class="micon">&nbsp;</td>
                                    <td class="mdesc"><bean:message key="rule.table.title.expression"/></td>
                                    <td class="msource">
                                        <textarea rows="3" name="outputExpression" class="wide"
                                                  id="expression-${ruleItem.id}-${outputItem.name }"
                                                  type="_moz">${outputItem.expression }</textarea>
                                        <input value="<bean:message key='rule.table.button.editExpression'/>"
                                               type="button" onclick="javascript:window.open('<html:rewrite
                                                page='/RuleWebToolAction.do?method=initEditExpression&id=${rule.id}&ruleId=${ruleItem.id }&outName=${outputItem.name}'/>','mywin', 'menubar=no,width=600,height=600,resizeable=yes');"/>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
                        ...
                        <input type="button"
                               onClick="outputTpl.append('rule-${ruleItem.id}-output',{ruleId:'${rule.id}',ruleItemId:'${ruleItem.id}',tempId:Ext.id()})"
                               value="<bean:message key='rule.table.button.addParameter'/>">
                    </div>
                    <div class="tab-content" id="rule-${ruleItem.id}-listener">
                        <table class="member-table" cellspacing="0" id="rule-${ruleItem.id}-listener-table">
                            ...
                            <c:forEach items="${ruleItem.listeners.listeners}" var="listenerItem">
                                <tr>
                                    <td class="micon">&nbsp;</td>
                                    <td class="mdesc"><bean:message key="rule.table.title.class"/></td>
                                    <td class="msource"><input type="text" name="listenerName"
                                                               value="${listenerItem.name }" size="80" class="wide"/>
                                    </td>
                                    <td class="mdesc"><bean:message key="rule.table.title.description"/></td>
                                    <td class="msource"><input type="text" name="listenerDescription"
                                                               value="${listenerItem.description }" size="80"
                                                               class="wide"/></td>
                                    <td class="mrowbtns">
                                        <input name="button2" type=button onClick="removeRow(this);"
                                               value="<bean:message key='rule.table.button.delete'/>"></td>
                        ...
                        <input type="button" onClick="listenerTpl.append('rule-${ruleItem.id}-listener-table')"
                               value="<bean:message key='rule.table.button.addListener'/>">
                    </div>
...
<table width="600">
	...
	-->
        ...
        <td width="15%"><a href="#" onclick="javascript:page('${currPage-1}');"><bean:message
                key="rule.table.title.lastPage"/></a></td>
        <td width="15%"><a href="#" onclick="javascript:page('${currPage+1}');"><bean:message
                key="rule.table.title.nextPage"/></a></td>
        <td width="15%"><a href="<html:rewrite page='/RuleWebToolAction.do?method=listRule'/>"><bean:message
                key="rule.table.title.return"/></a></td>
    </tr>
    <form name="pageForm" id="pageForm" method="post"
          action="<html:rewrite page='/RuleWebToolAction.do?method=detailRule'/>">
        <input type="hidden" name="id" value="${rule.id }"/>
    ...
    <form name="delRuleForm" id="delRuleForm" method="post"
          action="<html:rewrite page='/RuleWebToolAction.do?method=delRule'/>">
        <input type="hidden" name="id" value="${rule.id }"/>
