                        ...
                        <table bgcolor="#f2f2f2" width="500" cellspacing="0" border="0">
                            ...
                            <logic:present name="tawRmRecordSubForm" scope="request">
                                ...
                                <tr>
                                    ...
                                    <td width="76%"><font size="2" face="Tahoma">
                                        <bean:write name="tawRmRecordSubForm" property="starttimeDefined"
                                                    scope="request"/>
                                ...
                                <tr>
                                    ...
                                    <td width="76%"><font size="2" face="Tahoma">
                                        <bean:write name="tawRmRecordSubForm" property="endtimeDefined"
                                                    scope="request"/>
                            ...
                            <tr align="right" valign="middle">
                                <td><html:form method="POST" action="/TawRmRecordSub/trash">
                                    <input type="hidden" name="id"
                                           value="<bean:write name="tawRmRecordSubForm" property="id" scope="request"/>">
