...
<table id="sheet" class="formTable" > 
	  ...
	  <tr>
		...
		<tr><td class="label">
				<!-- Z端地市 -->
				<c:forTokens items="${sheetMain.ztypearea}" delims="," var="ztypearea" varStatus="status"><eoms:id2nameDB id="${ztypearea}" beanId="ItawSystemDictTypeDao"/><c:choose><c:when test="${status.last}"></c:when><c:otherwise>,</c:otherwise></c:choose></c:forTokens>
			</td>
			<td class="content"> 
		...
		<tr><td class="label">
			...
			<td>
				<eoms:attachment name="sheetMain" property="resourceReport"  scope="request" idField="resourceReport" appCode="citycustom"  viewFlag="Y"/> 
						 ...
						 <td width="50%">  
									...
									<select id="dealSelector">
									 ...
									 <% } else if(taskStatus.equals(Constants.TASK_STATUS_CLAIMED)){ %>
									 	  ...
									 	  <% if (ifwaitfor.equals("false")) {%>
											  <!-- 流程步骤，移交，阶段回复，分派 -->
											  <option value="${urlShowOrderExamine102Page}"><bean:message bundle="citycustom" key="operateType.OrderExamine102"/> </option>
									 ...
									 <%} else { %>
									 		...
									 		<!-- 不需要等待回复 -->
									 	  	<% if (ifwaitfor.equals("false")) {%>
									 			<option value="${urlShowDispatchPage}"><bean:message bundle="citycustom" key="operateType.subTaskReply"/></option>
									 		<% }%>
									 <% } %>
								...
								<% }  if(taskName.equals("NetOrderExamine")){ %>
									<select id="dealSelector">
									 ...
									 <% } else if(taskStatus.equals(Constants.TASK_STATUS_CLAIMED)){ %>
									 	  ...
									 	  <% if (ifwaitfor.equals("false")) {%>
											  <!-- 流程步骤，移交，阶段回复，分派 -->
											  <option value="${urlShowNetOrderExamine103Page}"><bean:message bundle="citycustom" key="operateType.NetOrderExamine103"/> </option>
								...
								<% }  if(taskName.equals("SchemeDesign")){ %>
									<select id="dealSelector">
									 ...
									 <% } else if(taskStatus.equals(Constants.TASK_STATUS_CLAIMED)){ %>
									 	  ...
									 	  <% if (ifwaitfor.equals("false")) {%>
											  <!-- 流程步骤，移交，阶段回复，分派 -->
											  <option value="${urlShowSchemeDesign104Page}"><bean:message bundle="citycustom" key="operateType.SchemeDesign104"/> </option>
								...
								<% }  if(taskName.equals("SubmitExamine")){ %>
									<select id="dealSelector">
									 ...
									 <% } else if(taskStatus.equals(Constants.TASK_STATUS_CLAIMED)){ %>
									 	  ...
									 	  <% if (ifwaitfor.equals("false")) {%>
											  <!-- 流程步骤，移交，阶段回复，分派 -->
											  <option value="${urlShowSubmitExamine105Page}"><bean:message bundle="citycustom" key="operateType.SubmitExamine105"/> </option>
								...
								<% }  if(taskName.equals("ExamineScheme")){ %>
									<select id="dealSelector">
									 ...
									 <% } else if(taskStatus.equals(Constants.TASK_STATUS_CLAIMED)){ %>
									 	  ...
									 	  <% if (ifwaitfor.equals("false")) {%>
											  <!-- 流程步骤，移交，阶段回复，分派 -->
											  <option value="${urlShowExamineScheme106Page}"><bean:message bundle="citycustom" key="operateType.ExamineScheme106"/> </option>
								...
								<% }  if(taskName.equals("Construction")){ %>
									<select id="dealSelector">
									 ...
									 <% } else if(taskStatus.equals(Constants.TASK_STATUS_CLAIMED)){ %>
									 	  ...
									 	  <% if (ifwaitfor.equals("false")) {%>
											  <!-- 流程步骤，移交，阶段回复，分派 -->
											  <option value="${urlShowConstruction107Page}"><bean:message bundle="citycustom" key="operateType.Construction107"/> </option>
								...
								<% }  if(taskName.equals("SubmitCheck")){ %>
									<select id="dealSelector">
									 ...
									 <% } else if(taskStatus.equals(Constants.TASK_STATUS_CLAIMED)){ %>
									 	  ...
									 	  <% if (ifwaitfor.equals("false")) {%>
											  <!-- 流程步骤，移交，阶段回复，分派 -->
											  <option value="${urlShowSubmitCheck108Page}"><bean:message bundle="citycustom" key="operateType.SubmitCheck108"/> </option>
								...
								<% }  if(taskName.equals("AffirmHumTask")){ %>
									<select id="dealSelector">
									 ...
									 <% } else if(taskStatus.equals(Constants.TASK_STATUS_CLAIMED)){ %>
									 	  ...
									 	  <% if (ifwaitfor.equals("false")) {%>
											  <!-- 流程步骤，移交，阶段回复，分派 -->
											  <option value="${urlShowAffirmHumTask111Page}"><bean:message bundle="citycustom" key="operateType.AffirmHumTask111"/> </option>
											  <option value="${urlShowAffirmHumTask112Page}"><bean:message bundle="citycustom" key="operateType.AffirmHumTask112"/> </option>
 							...
 							<!-- 归档 -->
								<% }  if(taskName.equals("HoldTask")){ %>
									<select id="dealSelector">
									 	  ...
									 	  <% if (ifwaitfor.equals("false")) {%>
											  <!-- 流程步骤，移交，阶段回复，分派 -->
											  <option value="${urlShowHoldTask18Page}"><bean:message bundle="citycustom" key="operateType.HoldTask18"/> </option>
							...
							<% }else if(taskName.equals("RejectTask")){%>	
					  		...
					  		<% }else if(taskName.equals("DraftTask")){%>	
								<select id="dealSelector">
								  <option value="${urlShowDraftPage}"><bean:message bundle="citycustom" key="operateType.DraftTask"/></option>
								</select>
					   		<% } %>
					</td>
				</tr>
