...
<html:form action="tawRmInoutRecords" method="post" styleId="tawRmInoutRecordForm">
    <table class="formTable">
        ...
        <tr>
            ...
            <td width="500" colspan="3">
                <fmt:message key="tawRmInoutRecordForm.from"/><input type="text" name="realReturnStartDate" size="30"
                                                                     value="" class="text"
                                                                     onclick="popUpCalendar(this, this,'yyyy-mm-dd',-1,-1,false);"
                                                                     readonly="true">
                <fmt:message key="tawRmInoutRecordForm.to"/><input type="text" name="realReturnEndDate" size="30"
                                                                   value="" class="text"
                                                                   onclick="popUpCalendar(this, this,'yyyy-mm-dd',-1,-1,false);"
                                                                   readonly="true">
            </td>
