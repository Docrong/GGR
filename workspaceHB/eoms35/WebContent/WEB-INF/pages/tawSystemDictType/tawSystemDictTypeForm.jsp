...
<head>
    ...
    <head>
        ...
        <html:form action="saveTawSystemDictType" method="post" styleId="tawSystemDictTypeForm"
...
-->
            <li>
                ...
                <html:text property="parentDictName" styleId="parentDictName"
                           styleClass="text medium required max-length-100"/>
...
-->
                ...
                <html:submit styleClass="button" property="method.delete"
                             onclick="bCancel=true; return confirmDelete('TawSystemDictType')">
