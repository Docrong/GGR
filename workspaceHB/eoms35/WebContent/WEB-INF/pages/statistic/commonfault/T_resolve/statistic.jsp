...
var	roleTree='${app}/xtree.do?method=role&roleTypeId=1&node=51'; //角色树
...
Ext.onReady(function(){
	...
	roleTree = new xbox({
		...
		treeDataUrl:roleTree,treeRootId:'-1',treeRootText:'${eoms:a2u("角色")}',treeChkMode:'',treeChkType:'role',
            ...
            <tr>
			  ...
			  <td>
			  	 <eoms:comboBox name="${sheetPageName}mainNetSortOne" id="${sheetPageName}mainNetSortOne" 
			  	      sub="${sheetPageName}mainNetSortTwo" initDicId="1010104" defaultValue="${sheetMain.mainNetSortOne}" />
			  </td>
			</tr>
         <tr>
			  ...
			  <td>
			  	 <eoms:comboBox name="${sheetPageName}mainNetSortTwo" id="${sheetPageName}mainNetSortTwo" 
			  	      sub="${sheetPageName}mainNetSortThree" initDicId="${sheetPageName}mainNetSortOne" defaultValue="${sheetMain.mainNetSortTwo}" />
			  </td>
			</tr>
			 <tr>
			  ...
			  <td>
			  	 <eoms:comboBox name="${sheetPageName}mainNetSortThree" id="${sheetPageName}mainNetSortThree" 
			  	      sub="" initDicId="${sheetPageName}mainNetSortTwo" defaultValue="${sheetMain.mainNetSortThree}" />
			  </td>
			</tr>      		
