    ...
    <center>
        ...
        <form action="../part/serviceover.do" method="post" name="TawSparepartForm" onsubmit="return handleid();">
            <table border="0" width="95%" cellspacing="1" cellpadding="1" class="table_show" align="center">
                ...
                <%int i = 1;%>
                <logic:iterate id="tawOrderDetail" name="tawOrderDetail"
                               type="com.boco.eoms.sparepart.model.TawOrderDetail">
                    <tr class="tr_show" align="center">
                        ...
                        <td width="10%">
                            <input type="text"
                                   value="<bean:write name="tawOrderDetail" property="serialno" scope="page"/>"
                                   id="<%="a"+i%>_serialno" name="serialno" size="10" maxlength="255">
                        </td>
                        <td width="10%">
                            <input type="text" id="<%="a"+i%>_charge" value="0.00" name="charge" size="10"
                                   maxlength="255">
                        </td>
