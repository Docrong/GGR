...
<div id="sheetform">
    <html:form action="/mofficedata.do?method=newPerformNonFlow" styleId="theform">
        <%
        ...
        <input type="hidden" name="mainClassName"
               value="com.boco.eoms.sheet.mofficedata.model.MofficeDataMain"/> <!--main\u8868Model\u5bf9\u8c61\u7c7b\u540d-->
        <input type="hidden" name="linkClassName"
               value="com.boco.eoms.sheet.mofficedata.model.MofficeDataLink"/> <!--link\u8868Model\u5bf9\u8c61\u7c7b\u540d-->
        <input type="hidden" name="processTemplateName" id="processTemplateName" value="MofficeData"/>
