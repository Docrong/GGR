...
<!-- 处理环节中的按钮 -->
<input type="submit" class="submit" id="method.save" onclick="javascript:isCopy()"
       value="<bean:message bundle='sheet' key='button.done'/>">
<input type="button" class="submit" id="method.save" onclick="v.passing=true;javascript:saveDealInfo();"
       value="<bean:message bundle='sheet' key='button.save'/>">
<input type="submit" class="submit"
       onclick="v.passing=true;this.form.action='${app}/sheet/${module}/${module}.do?method=newPerformSaveInfoAndExit&dealTemplateId=${dealTemplateId}'"
       value="<bean:message bundle='sheet' key='button.saveback'/>"/>
<input type="submit" class="submit"
       onclick="v.passing=true;this.form.action='${app}/sheet/${module}/${module}.do?method=newShowListsendundo'"
