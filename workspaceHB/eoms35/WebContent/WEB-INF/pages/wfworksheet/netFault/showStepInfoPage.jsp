...
<div id="history" class="panel">
    ...
    <logic:present name="HISTORY" scope="request">
        <logic:iterate id="baselink" name="HISTORY" type="com.boco.eoms.sheet.netFault.model.NetFaultLink">
            <%
                jNum += 1;
            ...
            <div class="history-item"><!-- add space to hack ie-->&nbsp;
                <div class="history-item-title">
                    ...
                    <eoms:dict key="dict-sheet-netFault" dictId="activeTemplateId" itemId="${baselink.activeTemplateId}"
                               beanId="id2descriptionXML"/>
                    <bean:message bundle="netFault" key="netFault.operateType"/>:
                    <eoms:dict key="dict-sheet-netFault" dictId="mainOperateType" itemId="${baselink.operateType}"
                               beanId="id2descriptionXML"/>
                ...
                <div class="history-item-content hide">
  			      ...
  			      <%} %> -->
                        ...
                        <tr>
                            ...
                            <td class="column-content">
                                <eoms:dict key="dict-sheet-netFault" dictId="mainOperateType"
                        ...
                        <tr>
                            <td class="column-title">
                                <bean:message bundle="netFault" key="netFault.linkAuditResult"/>
                            </td>
                        ...
                        <tr>
                            <td class="column-title">
                                <bean:message bundle="netFault" key="netFault.linkAuditIdea"/>
                            </td>
                            <td class="column-content" colspan="3">
                        ...
                        <tr>
                            <td class="label"><bean:message bundle="netFault" key="netFault.linkTaskComplete"/></td>
                            <td class="column-content" colspan="3">
                        ...
                        <tr>
                            <td class="column-title">
                                <bean:message bundle="netFault" key="netFault.fenpairesion"/>
                            </td>
                            <td class="column-content" colspan="3">
                                <pre><bean:write name="baselink" property="linkTaskComplete" scope="page"/></pre>
                            </td>
                        ...
                        <tr>
                            <td class="column-title">
                                <bean:message bundle="netFault" key="netFault.yijiaoresion"/>
                            </td>
                            <td class="column-content" colspan="3">
                                <pre><bean:write name="baselink" property="linkTaskComplete" scope="page"/></pre>
                            </td>
                        ...
                        <tr>
                            <td class="column-title">
                                <bean:message bundle="netFault" key="netFault.advice"/>
                            </td>
                            <td class="column-content" colspan=3>
                                <pre><bean:write name="baselink" property="linkTaskComplete" scope="page"/></pre>
                            </td>
...
<script type="text/javascript">
    ...
    function copy(id) {
        ...
        if (ifCheck.checked == true) {
            Ext.Ajax.request({
                method: "get",
                url: "netFault.do?method=getJsonLink&id=" + id + "&beanName=NetFault",
                success: function (x) {
