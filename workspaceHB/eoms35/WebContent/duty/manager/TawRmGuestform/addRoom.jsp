        ...
        ctxMenu: [
            {
                ...
                text: '${eoms:a2u('新增记录')}',
                cls: 'new-mi',
                url: '${app}/duty//TawRmGuestform/add.do?typeId='
            },
            {
                id: 'Edit',
                text: '${eoms:a2u('查询记录')}',
                cls: 'new-mi',
                url: '${app}/duty//TawRmGuestform/query.do?typeId='
            },
            {
                id: 'Childs',
                text: '${eoms:a2u('确认记录')}',
                cls: 'new-mi',
                url: '${app}/duty///TawRmGuestform/okey.do?typeId='
            },
            {
                id: 'Delete',
                text: '${eoms:a2u('删除记录')}',
            ...
            },
            {
                ...
                text: '${eoms:a2u('审核记录')}',
                cls: 'new-mi',
                url: '${app}/duty///TawRmGuestform/okcheck.do?typeId='
            }
        ],
