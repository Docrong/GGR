    ...
    <table class="listTable" id="detailTable">
        ...
        <tr>
            ...
            %>
                ...
                <INPUT type=button value="<bean:message key="viewall.title.btnReport" />" name="button"
                       Onclick="onReport();" class="button">
                <%
                    if (step != null && step.getCheckUserList().size() > 0) {
                %>
                <input type="button" value="<bean:message key="viewall.title.btnToCheck" />" name="B1" class="button"
                       onclick="javascript:onCheck('<%=tawwpMonthPlanVO.getId()%>');">
                <%
                } else {
                %>
                <input type="button" value="<bean:message key="viewall.title.btnToPublic" />" name="B1" class="button"
                       onclick="javascript:onPublic('<%=tawwpMonthPlanVO.getId()%>');">
                <%
                        }
                    }
                %>
                <input type="button" value="<bean:message key="viewall.title.btnBack" />"
