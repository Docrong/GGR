		   ...
		   <%if(operateType.equals("111")){ 
		      ...
		      <%}else if(operateType.equals("205")){ //回复%>
        	  	...
        	  	<tr>
		            ...
		            <td  class="content"> 
						          <input type="text"  class="text" name="${sheetPageName}ndeptContact" id="${sheetPageName}ndeptContact" value="${sheetLink.ndeptContact}" alt="width:500,allowBlank:false,maxLength:25,vtext:'${eoms:a2u('请输入网络部门联系人，最大长度为12个汉字！')}'"/>
						    </td>     
		            <td  class="label"><bean:message bundle="resourceaffirm" key="resourceaffirm.ndeptContactPhone"/>*</td>
		            <td  class="content"> <input type="text"  class="text" name="${sheetPageName}ndeptContactPhone" id="${sheetPageName}ndeptContactPhone" value="${sheetLink.ndeptContactPhone}" alt="width:500,allowBlank:false,maxLength:50,vtext:'${eoms:a2u('请输入网络部门联系人电话，最大长度为50个字符！')}'"/></td>
		          </tr>
		          <tr>
		            <td  class="label"><bean:message bundle="resourceaffirm" key="resourceaffirm.netResCapacity"/>&nbsp;&nbsp;*</td>
		            <td  class="content"> 
		                  <input type="text"  class="text" name="${sheetPageName}netResCapacity" id="${sheetPageName}netResCapacity" value="${sheetLink.netResCapacity}" alt="width:500,allowBlank:false,maxLength:500,vtext:'${eoms:a2u('请输入网络资源能力确认，最大长度为250个汉字！')}'"/>
		            </td>
                <td  class="label"><bean:message bundle="resourceaffirm" key="resourceaffirm.clientPgmCapacity"/>&nbsp;&nbsp;*</td>
		            <td  class="content"> <input type="text"  class="text" name="${sheetPageName}clientPgmCapacity" id="${sheetPageName}clientPgmCapacity" value="${sheetLink.clientPgmCapacity}" alt="width:500,allowBlank:false,maxLength:500,vtext:'${eoms:a2u('请输入客户端工程能力确认，最大长度为250个汉字！')}'"/></td>       
		          </tr>
			        <tr>
		            <td  class="label"><bean:message bundle="resourceaffirm" key="resourceaffirm.investEvaluate"/>*</td>
		            <td  class="content"> <input type="text"  class="text" name="${sheetPageName}investEvaluate" id="${sheetPageName}investEvaluate" value="${sheetLink.investEvaluate}" alt="width:500,allowBlank:false,maxLength:254,vtext:'${eoms:a2u('请输入预计投资，最大长度为127个汉字！')}'"/></td>
		          <td  class="label"><bean:message bundle="resourceaffirm" key="resourceaffirm.expectFinishdays"/>&nbsp;&nbsp;*</td>
		            <td  class="content"> <input type="text"  class="text" name="${sheetPageName}expectFinishdays" id="${sheetPageName}expectFinishdays" value="${sheetLink.expectFinishdays}" alt="width:500,allowBlank:false,maxLength:16,vtext:'${eoms:a2u('请输入预计完成天数，最大长度为8个汉字！')}'"/></td>
		          </tr>			   
		          ...
		          <td  class="label"><bean:message bundle="resourceaffirm" key="resourceaffirm.isOccupied"/>*</td>
            	      ...
            	      initDicId="1011017"  alt="allowBlank:true" defaultValue="${sheetLink.isOccupied}" alt="allowBlank:false" styleClass="select-class"/>
			        </td>
		          </tr>
			  ...
			  <tr>
        	    ...
        	    <%}else if(operateType.equals("206")){ //回复送审%>
        	        ...
        	        <input type="hidden" name="${sheetPageName}phaseId" id="${sheetPageName}phaseId" value="TaskCompleteAuditHumTask" />
		               ...
		               <tr>
		                   <td  class="label"><bean:message bundle="resourceaffirm" key="resourceaffirm.netResCapacity"/>&nbsp;&nbsp;*</td>
		                   <td  class="content"> <input type="text"  class="text" name="${sheetPageName}netResCapacity" id="${sheetPageName}netResCapacity" value="${sheetLink.netResCapacity}" alt="width:500,allowBlank:false,maxLength:500,vtext:'${eoms:a2u('请输入网络资源能力确认，最大长度为250个汉字！')}'"/></td>
                       <td  class="label"><bean:message bundle="resourceaffirm" key="resourceaffirm.clientPgmCapacity"/>&nbsp;&nbsp;*</td>
		                   <td  class="content"> <input type="text"  class="text" name="${sheetPageName}clientPgmCapacity" id="${sheetPageName}clientPgmCapacity" value="${sheetLink.clientPgmCapacity}" alt="width:500,allowBlank:false,maxLength:500,vtext:'${eoms:a2u('请输入客户端工程能力确认，最大长度为250个汉字！')}'"/></td>		          
		               </tr>
			             <tr>
         	 ...
         	 <%if(operateType.equals("7")){ //处理回复不通过%>
         		 ...
         		 <input type="hidden" name="${sheetPageName}phaseId" id="${sheetPageName}phaseId" value="ExcuteHumTask" />
         		  <tr>
		              ...
		              <td colspan="3"> 	
    				         <textarea class="textarea max" name="${sheetPageName}dealResult" id="${sheetPageName}dealResult" alt="width:500,allowBlank:false,maxLength:2000,vtext:'${eoms:a2u('请输入处理结果，最大长度为1000个汉字！')}'">${sheetLink.dealResult }</textarea>				  
                  </td>
		          </tr>
         ...
         <%}else if( taskName.equals("DraftHumTask")){%>
          ...
          <%}else if( taskName.equals("HoldHumTask")){%>
			  ...
			  <tr>
			    ...
			    <td colspan="3">
			      <textarea name="${sheetPageName}endResult" id="${sheetPageName}endResult"  class="textarea max" alt="width:500,allowBlank:false,maxLength:2000,vtext:'${eoms:a2u('请输入归档意见，最大长度为1000个汉字！')}'">${sheetMain.endResult}</textarea>
			    </td>
			  </tr>	        			          			       			 
              <%}%>
           <%} else if(taskName.equals("cc")){%>
			 ...
			 <td colspan="3">			
		           <textarea name="${sheetPageName}remark" class="textarea max" id="${sheetPageName}remark" 
		        alt="width:500,allowBlank:false,maxLength:2000,vtext:'${eoms:a2u('请输入备注，最大长度为1000个汉字！')}'"alt="width:'500px'">${sheetLink.remark}</textarea>
		  </td>
		 </tr>  
		<%} %>
...
<% if(operateType.equals("10")){ //转派%>
   <fieldset>
	 <legend>
		...
		<eoms:chooser id="test" category="[{id:'dealPerformer',childType:'user',limit:'none',text:'${eoms:a2u('派发')}',allowBlank:false,vtext:'${eoms:a2u('请选择任务执行人')}'}]"/>
