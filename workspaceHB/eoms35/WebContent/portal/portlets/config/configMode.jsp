        ...
        <table border='0' cellpadding='0' cellspacing='0' width="95%">
            <tr>
                ...
                <td class='portlet-table-td-left'>
                    <input type='text' name='pcTitle' value='<c:out value="${requestScope.portlet.title}"/>'
            ...
            <tr>
                ...
                <td class='portlet-table-td-left'>
                    <input type='text' name='pcBarBgColor' value='<c:out value="${requestScope.portlet.barBgColor}"/>'
            ...
            <tr>
                ...
                <td class='portlet-table-td-left'>
                    <input type='text' name='pcBarFontColor'
                           value='<c:out value="${requestScope.portlet.barFontColor}"/>'
                           class='portlet-form-input-field' size='10'/>
                </td>
            </tr>
            <tr>
                ...
                <td class='portlet-table-td-left'>
                    <input type='text' name='pcContentBgColor'
                           value='<c:out value="${requestScope.portlet.contentBgColor}"/>'
                           class='portlet-form-input-field' size='10'/>
                </td>
            </tr>
            <tr>
                <td class='cright' colspan='2'>
                    <input name='Submit' type='button' value='<fmt:message key="portlet.button.save"/>'
