...
function showPage(){
     var pars = '';
     var url = '';    
      url = '${app}/sheet/accountpopedomapply/accountpopedomapply.do?method=showInputRejectPage&piid=${sheetMain.piid}&taskId=${taskId}&taskName=${taskName}';
     if (url!=''){
...
<div id="sheetform">
<html:form action="/accountpopedomapply.do?method=performDeal" styleId="theform">
