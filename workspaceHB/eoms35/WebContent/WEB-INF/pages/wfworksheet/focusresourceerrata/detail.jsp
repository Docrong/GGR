						 ...
						 <td width="50%">  
									...
									<select id="dealSelector">
									 ...
									 <% } else if(taskStatus.equals(Constants.TASK_STATUS_CLAIMED)){ %>
									 	  ...
									 	  <% if (ifwaitfor.equals("false")) {%>
											  <!-- 流程步骤，移交，阶段回复，分派 -->
											  <option value="${urlShowMonitoringDepart101Page}"><bean:message bundle="focusresourceerrata" key="operateType.MonitoringDepart101"/> </option>
											  <option value="${urlShowMonitoringDepart102Page}"><bean:message bundle="focusresourceerrata" key="operateType.MonitoringDepart102"/> </option>
											  <option value="${urlShowMonitoringDepart103Page}"><bean:message bundle="focusresourceerrata" key="operateType.MonitoringDepart103"/> </option>
									 ...
									 <%} else { %>
									 		...
									 		<!-- 不需要等待回复 -->
									 	  	<% if (ifwaitfor.equals("false")) {%>
									 			<option value="${urlShowDispatchPage}"><bean:message bundle="focusresourceerrata" key="operateType.subTaskReply"/></option>
									 		<% }%>
									 <% } %>
								...
								<% }  if(taskName.equals("TransmissionNet")){ %>
									<select id="dealSelector">
									 ...
									 <% } else if(taskStatus.equals(Constants.TASK_STATUS_CLAIMED)){ %>
									 	  ...
									 	  <% if (ifwaitfor.equals("false")) {%>
											  <!-- 流程步骤，移交，阶段回复，分派 -->
											  <option value="${urlShowTransmissionNet104Page}"><bean:message bundle="focusresourceerrata" key="operateType.TransmissionNet104"/> </option>
											  <option value="${urlShowTransmissionNet105Page}"><bean:message bundle="focusresourceerrata" key="operateType.TransmissionNet105"/> </option>
								...
								<% }  if(taskName.equals("CitieErrata")){ %>
									<select id="dealSelector">
									 ...
									 <% } else if(taskStatus.equals(Constants.TASK_STATUS_CLAIMED)){ %>
									 	  ...
									 	  <% if (ifwaitfor.equals("false")) {%>
											  <!-- 流程步骤，移交，阶段回复，分派 -->
											  <option value="${urlShowCitieErrata106Page}"><bean:message bundle="focusresourceerrata" key="operateType.CitieErrata106"/> </option>
 							...
 							<!-- 归档 -->
								<% }  if(taskName.equals("HoldTask")){ %>
									<select id="dealSelector">
									 	  ...
									 	  <% if (ifwaitfor.equals("false")) {%>
											  <!-- 流程步骤，移交，阶段回复，分派 -->
											  <option value="${urlShowHoldTask18Page}"><bean:message bundle="focusresourceerrata" key="operateType.HoldTask18"/> </option>
							...
							<% }else if(taskName.equals("RejectTask")){%>	
					  		...
					  		<% }else if(taskName.equals("DraftTask")){%>	
								<select id="dealSelector">
								  <option value="${urlShowDraftPage}"><bean:message bundle="focusresourceerrata" key="operateType.DraftTask"/></option>
								</select>
					   		<% } %>
					</td>
				</tr>
