 ...
 *  
 */
public class ArithmeticModifyMainListDisplaytagDecoratorHelper extends TableDecorator {
	...
	public String getMainYuLiuB() {
		...
		return "<a  href='" + url
				+ "?method=showMainDetailPage&sheetKey=" + StaticMethod.nullObject2String(main.get("id")).trim()
				+ "'>" + StaticMethod.nullObject2String(main.get("mainYuLiuB")).trim() + "</a>";
	}
    ...
    public Date getMainYuLiuC(){
		Map main = (Map) getCurrentRowObject();
    	Date mainYuLiuC =(Date)main.get("mainYuLiuC");    	
    	return mainYuLiuC;
    }
