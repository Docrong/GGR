...
values ('xls,txt,doc,jpg,gif', 'equipmentunsubscribe', '设备退订流程流程', 1024, '/sheet/equipmentunsubscribe', 34, '297e589966577f7d0166577f7e100011');
...
values ('297e589966577f7d0166577f7e100012', '199901', '1', '新增工单', '1999', null, '/sheet/equipmentunsubscribe/equipmentunsubscribe.do?method=showNewSheetPage', '0', '0', 1);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('297e589966577f7d0166577f7e100013', '199903', '0', '待处理工单', '1999', null, null, '0', '0', 3);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('297e589966577f7d0166577f7e100014', '19990301', '1', '待办工单', '199903', null, '/sheet/equipmentunsubscribe/equipmentunsubscribe.do?method=showListsendundo', '0', '0', 1);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('297e589966577f7d0166577f7e100015', '199907', '1', '工单查询', '1999', null, '/sheet/equipmentunsubscribe/equipmentunsubscribe.do?method=showQueryPage', '0', '0', 7);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('297e589966577f7d0166577f7e100016', '199908', '1', '工单处理模板', '1999', null, '/sheet/equipmentunsubscribe/equipmentunsubscribe.do?method=getDealTemplatesByUserId&type=templateManage', '0', '0', 8);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('297e589966577f7d0166577f7e100017', '199909', '1', '工单模板管理', '1999', null, '/sheet/equipmentunsubscribe/equipmentunsubscribe.do?method=getTemplatesByUserId&type=templateManage', '0', '0', 9);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('297e589966577f7d0166577f7e100018', '199910', '1', '管理者工单', '1999', null, '/sheet/equipmentunsubscribe/equipmentunsubscribe.do?method=showListForAdmin', '0', '0', 10);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('297e589966577f7d0166577f7e100019', '1999', '0', '设备退订流程流程', '10', null, '/sheet/equipmentunsubscribe/equipmentunsubscribe.do?method=showDrawing', '0', '0', 20);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('297e589966577f7d0166577f7e10001a', '199902', '1', '草稿列表', '1999', null, '/sheet/equipmentunsubscribe/equipmentunsubscribe.do?method=showDraftList', '0', '0', 2);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('297e589966577f7d0166577f7e10001b', '199904', '0', '已处理工单', '1999', null, null, '0', '0', 4);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('297e589966577f7d0166577f7e10001c','19990402','1','建立工单','199904', null, '/sheet/equipmentunsubscribe/equipmentunsubscribe.do?method=showOwnStarterList','0','0',2);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('297e589966577f7d0166577f7e10001d', '19990401', '1', '处理工单', '199904', null, '/sheet/equipmentunsubscribe/equipmentunsubscribe.do?method=showListsenddone', '0', '0', 1);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('297e589966577f7d0166577f7e10001e', '199905', '1', '已归档工单', '1999', null, '/sheet/equipmentunsubscribe/equipmentunsubscribe.do?method=showHoldedList', '0', '0', 5);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('297e589966577f7d0166577f7e10001f', '199906', '1', '已作废工单', '1999', null, '/sheet/equipmentunsubscribe/equipmentunsubscribe.do?method=showCancelList', '0', '0', 6);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('297e589966577f7d0166577f7e100020', '199911', '1', '超时时间设置', '1999', null, '/sheet/overtimetip/overtimetip.do?flowName=EquipmentUnsubscribe', '0', '0', 11);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('297e589966577f7d0166577f7e100021', '199912', '1', '工单处理时限配置', '1999', null, '/sheet/newSheetLimit/sheetLimit.do?method=getLevelLimitList&flowName=EquipmentUnsubscribe', '0', '0', 30);