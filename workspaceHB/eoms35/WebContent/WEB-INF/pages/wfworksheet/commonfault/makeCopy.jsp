...
<html:form action="/commonfault.do?method=newPerformNonFlow" styleId="theform">
    ...
    <br/>
	      <input type="hidden" name="processTemplateName" id="processTemplateName" value="CommonFaultMainFlowProcess" />
           ...
           <input type="hidden" name="mainClassName" id="mainClassName"  value="com.boco.eoms.sheet.commonfault.model.CommonFaultMain"/>		
           <input type="hidden" name="linkClassName" id="linkClassName" value="com.boco.eoms.sheet.commonfault.model.CommonFaultLink"/> 
