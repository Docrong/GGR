    ...
    <form action="../part/incheckOK.do" method="post" name="tawSparepartForm">
        <table border="0" width="100%" cellspacing="1" cellpadding="1" class="table_show" align=center>
            ...
            <tr class="tr_show">
                ...
                <td class="clsfth" height="25"><input value="<%=StaticMethod.null2String(part.getIntime())%>"
                                                      readonly="readonly"/>
                </td>
        ...
        <table border="0" width="95%" cellspacing="1" cellpadding="1" class="table_show" align=center>
            <tr class="td_label" align="center">
                ...
                <%--<td nowrap="nowrap">备件名称</td>
                <td nowrap="nowrap">备件序列号</td>
                 <td nowrap="nowrap">备件厂商</td>--%>
            </tr>
            <tr class="td_label" align="center">
                <td nowrap="nowrap"><%=order.getProposer()%>
                </td>
                <td nowrap="nowrap"><%=order.getStoragename()%>
                </td>
                <td nowrap="nowrap"><%=order.getStartdate()%>
                </td>
                <td nowrap="nowrap"><%=order.getSheetid()%>
                </td>
                <td nowrap="nowrap"><%=order.getOrderType()%>
                </td>
                <td nowrap="nowrap"><%=order.getOrderState()%>
                </td>
                <td nowrap="nowrap"><%=order.getReason()%>
                </td>
                <%--<td nowrap="nowrap">
                  <%=order.getEname()%>
                </td>
        ...
        <table border="0" width="95%" cellspacing="1" cellpadding="1" class="table_show" align=center>
            <tr class="td_label" align="center">
                ...
                <td height="25">
                    <input type="text" rows="2" name="advices" style="width:100%" value="" title="${eoms:a2u('审核意见')}"/>
                </td>
            </tr>
        </table>
        <table border="0" width="80%" cellspacing="0">
            <tr>
                <td height="32" align="right">
                    <input type="submit" value="${eoms:a2u('提交审批')}" name="submit1" class="clsbtn2">
                </td>
                <td height="32" align="right">
                    <input type="submit" value="${eoms:a2u('审核不通过')}" name="submit2" onclick="return submitform()"
                           class="clsbtn2">
                </td>
            </tr>
        </table>
