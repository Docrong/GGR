...
<table class="formTable">
    ...
    <tr>
        ...
        <td colspan="3">
	    				<textarea class="textarea max" name="${sheetPageName}transferReason"
                                  ...
                                  alt="allowBlank:false,width:500,maxLength:1000,vtext:'${eoms:a2u('最多输入250汉字')}'"
    ...
    <tr>
        ...
        <td colspan="3">
            ...
            <textarea name="${sheetPageName}remark" class="textarea max" id="${sheetPageName}remark"
                      alt="allowBlank:false,width:500,maxLength:2000,vtext:'${eoms:a2u('请最多输入1000汉字')}'"
                      alt="width:'500px'">${sheetLink.remark}</textarea>
        </td>
    </tr>
    <%} %>
