...
<html:form action="/complaintDuban.do?method=newTaskPerformAdd" styleId="theform" target="myname">
<%@ include file="/WEB-INF/pages/wfworksheet/complaintDuban/baseinputlinkhtmlnew.jsp"%>
   ...
   <table class="formTable">
				<tr>
				  <td class="label"><bean:message bundle="complaintDuban" key="complaintDuban.linkUrgency"/>*</td>
				 ...
				 <tr>
	              <td  class="label"><bean:message bundle="complaintDuban" key="complaintDuban.linkReqCompleteTime"/>*</td>				 
				  <td class="content">
	              ...
	              <td  class="label"><bean:message bundle="complaintDuban" key="complaintDuban.linkAcceptDept"/>*</td>
				  <td class="content">
			  ...
			  <tr>
			  	<td class="label"><bean:message bundle="complaintDuban" key="complaintDuban.linkSendSheetDesc"/>*</td>
			    <td colspan="3">
