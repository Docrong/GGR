...
<div id="sheet-detail-page">
    ...
    <div id="sheetinfo">
        <logic:present name="sheetMain" scope="request">
            ...
            <td class="content">
            <bean:write name="sheetMain" property="sheetAcceptLimit" formatKey="date.formatDateTimeAll" bundle="sheet"
                        scope="request"/>
            </td>
            <td class="label">工单处理时限</td>
            <td class="content">
            <bean:write name="sheetMain" property="sheetCompleteLimit" formatKey="date.formatDateTimeAll" bundle="sheet"
                        scope="request"/>
            </td>
            </tr>
            -->
            ...
            <fieldset id="link10">
                ...
                <table class="formTable">
                    ...
                    <tr>
                        ...
                        <td class="content"><bean:write name="orderSheet" property="customContact"
                                                        scope="request"/></td>

                        <td class="label">客户联系人电话</td>
                        <td class="content"><bean:write name="orderSheet" property="customContactPhone"
                                                        bundle="businessimplementyy" scope="request"/></td>

                    </tr>
                    <tr>
                        <td class="label">集团客户联系人邮箱</td>
                        <td class="content"><bean:write name="orderSheet" property="customConnMain"
                                                        bundle="businessimplementyy" scope="request"/></td>
                        <td class="label">集团客户编号*</td>
                        <td class="content"><bean:write name="orderSheet" property="groupCustomNo"
                                                        bundle="businessimplementyy" scope="request"/></td>
                    </tr>
                </table>
            </fieldset>
            <fieldset id="link1">
                ...
                <table class="formTable">
                    ...
                    <tr>
                        ...
                        <td class="content"><bean:write name="orderSheet" property="cmanagerPhone"
                                                        bundle="businessimplementyy" scope="request"/></td>
                        <td class="label">业务所属区域*</td>
                        <td class="content"><bean:write name="orderSheet" property="businesBelongCity"
                                                        bundle="businessimplementyy" scope="request"/></td>
                    </tr>
                    <!-- old end-->
                    <tr>
                        <td class="label">客户经理联系邮箱*</td>
                        <td class="content"><bean:write name="orderSheet" property="customManagerMail"
                                                        bundle="businessimplementyy" scope="request"/></td>
            ...
            <fieldset id="link2">
                ...
                <table class="formTable">
                    ...
                    <tr>
                        ...
                        <td class="content"><bean:write name="orderSheet" property="productSN"
                                                        bundle="businessimplementyy" scope="request"/></td>
            ...
            <fieldset id="link3">
                ...
                <table class="formTable">
                    ...
                    <tr>
                        ...
                        <td class="content"><bean:write name="orderSheet" property="needDesc"
                                                        bundle="businessimplementyy" scope="request"/></td>
                    </tr>
                    <tr>
                        <td colspan="4">
            ...
            <% if (orderSheetId != null && !"".equals(orderSheetId)) { %>
            <iframe id="frame"
                    src="${app}/businessupport/order/ordersheets.do?method=getSpecialLinesByType&orderId=${orderSheetId}&taskStatus=${taskStatus}&specialtyType=yuyin&sheetType=businessImplementyy&taskName=${taskName}"
            ...
            <tr>
                <td width="50%">
                    ...
                    <% if (taskName.equals("HoldTask")) {
                        System.out.println("@@HoldTask"); %>
                    <select id="dealSelector">
                        <option value="${urlShowHoldDealPage}"><bean:message bundle="businessimplementyy"
                    ...
                    <select id="dealSelector">
                        <option value="${urlShowCompleteDraftPage}"><bean:message bundle="businessimplementyy"
