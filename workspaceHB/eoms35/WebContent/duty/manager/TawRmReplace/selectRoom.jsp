...
<%@ include file="/common/header_eoms_ext.jsp"%>
  ...
  var config = {
	...
	onClick:{url:"${app}/duty/tawRmReplace.do?method=apply&roomId=",text:"${eoms:a2u('申请替班')}"},
	ctxMenu:[
		{id:'Child', text:'${eoms:a2u('申请替班')}',cls:'new-mi',url:'${app}/duty/tawRmReplace.do?method=apply&roomId='} 
		 ],//end of ctxMenu 
	/************************
