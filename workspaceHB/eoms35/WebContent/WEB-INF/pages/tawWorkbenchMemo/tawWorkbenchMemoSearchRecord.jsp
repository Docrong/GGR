...
<form name="tawwrokbenchmemo" method="post" 
	action="${app}/workbench/memo/tawWorkbenchMemoNodes.do?method=xSearchRecord&folderPath=<%=str%>">
	...
	<table class="formTable">
		...
		<tr id="view">
			...
			<td width="300" colspan="2">
				<input type="text" name="userid" size="30" readonly="true"
					value="" class="text">
				<input type="button" value=" ${eoms:a2u("创建人")}" name="B1">
			</td>
		</tr>
		<tr>
			<td width="100" class="label">
			...
			<td>
			      <input type="text" name="creatBeginTime" size="20" onclick="popUpCalendar(this, this);" readonly="true"  class="text">
			</td>
