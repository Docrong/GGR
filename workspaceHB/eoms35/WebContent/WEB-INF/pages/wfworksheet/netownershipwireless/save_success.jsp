...
<script type="text/javascript">
    function intoUndo() {
        var undo = document.location.href;
        undo = "/eoms35/sheet/netownershipwireless/netownershipwireless.do?method=showQueryPage&batch=true";
        location.href = undo;
    }

    function intoDone() {
        var done = document.location.href;
        done = done.substring(0, done.indexOf("?") + 1) + "method=showQueryPage";
        location.href = done;
