...
<center>
    ...
    <table border="0" width="95%" cellspacing="1" cellpadding="1" class="table_show" align=center>
        ...
        <logic:iterate id="tawUser" name="tawSystemUserList"
            ...
            <tr class="tr_show">
                ...
                <td width="10%" height="25">
                    <html:link page="/editTawSystemUser.do?method=comebackdel" paramId="id"
                               paramName="tawUser" paramProperty="id"><img
                            src="<%=request.getContextPath()%>/images/pic_5_3.gif"
                            border="0"
                            alt="<bean:message key="button.comebackdel"/><bean:write name="tawUser" property="id" scope="page"/> "></html:link>
                </td>
                <td width="10%" height="25">
                    <html:link page="/editTawSystemUser.do?method=delete" paramId="id"
                               paramName="tawUser" paramProperty="id"><img
                            src="<%=request.getContextPath()%>/images/dept.gif"
                            border="0"
                            alt="<bean:message key="button.comebackdel"/><bean:write name="tawUser" property="id" scope="page"/> "></html:link>
                </td>
                <%} %>
