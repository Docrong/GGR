    ...
    <tr>
        ...
        <td>
            <input type="text" class="text" name="linkEquipmentNum" id="linkEquipmentNum"
                   alt="allowBlank:false,maxLength:1000,vtext:'请填入 设备编号 信息，最多输入 1000 字符'"
    ...
    <tr>
        ...
        <td colspan="3">
            <eoms:attachment name="sheetLink" property="linkEquipmentAgree"
                             scope="request" idField="linkEquipmentAgree" appCode="equipmentinstallation"
    ...
    <tr>
        ...
        <td colspan="3">
            <eoms:attachment name="sheetLink" property="linkUserReceipt"
                             scope="request" idField="linkUserReceipt" appCode="equipmentinstallation"
                             alt="allowBlank:false"/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td colspan="3">
            <eoms:attachment name="sheetLink" property="linkInformation"
                             scope="request" idField="linkInformation" appCode="equipmentinstallation"
                             alt="allowBlank:false"/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td colspan="3">
            <eoms:attachment name="sheetLink" property="linkScenePhoto"
                             scope="request" idField="linkScenePhoto" appCode="equipmentinstallation"
                             alt="allowBlank:false"/>
        </td>
    </tr>
        ...
        <tr>
            ...
            <td colspan="3">
                <eoms:attachment name="sheetLink" property="linkChargePhoto"
                                 scope="request" idField="linkChargePhoto" appCode="equipmentinstallation"
                                 alt="allowBlank:false"/>
            </td>
        </tr>
    </c:if>
