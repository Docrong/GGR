...
values ('xls,txt,doc,jpg,gif', 'securityobjaudit', '安全对象问题审批工单流程', 1024, '/sheet/securityobjaudit', 31, '40287d8c5ba332e8015ba332e8a70011');
...
values ('40287d8c5ba332e8015ba332e8a70012', '4501', '1', '新增工单', '45', null, '/sheet/securityobjaudit/securityobjaudit.do?method=showNewSheetPage', '0', '0', 1);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d8c5ba332e8015ba332e8a70013', '4503', '0', '待处理工单', '45', null, null, '0', '0', 3);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d8c5ba332e8015ba332e8a70014', '450301', '1', '待办工单', '4503', null, '/sheet/securityobjaudit/securityobjaudit.do?method=showListsendundo', '0', '0', 1);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d8c5ba332e8015ba332e8a70015', '4507', '1', '工单查询', '45', null, '/sheet/securityobjaudit/securityobjaudit.do?method=showQueryPage', '0', '0', 7);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d8c5ba332e8015ba332e8a70016', '4508', '1', '工单处理模板', '45', null, '/sheet/securityobjaudit/securityobjaudit.do?method=getDealTemplatesByUserId&type=templateManage', '0', '0', 8);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d8c5ba332e8015ba332e8a70017', '4509', '1', '工单模板管理', '45', null, '/sheet/securityobjaudit/securityobjaudit.do?method=getTemplatesByUserId&type=templateManage', '0', '0', 9);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d8c5ba332e8015ba332e8a70018', '4510', '1', '管理者工单', '45', null, '/sheet/securityobjaudit/securityobjaudit.do?method=showListForAdmin', '0', '0', 10);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d8c5ba332e8015ba332e8a70019', '45', '0', '安全对象问题审批工单流程', '10', null, '/sheet/securityobjaudit/securityobjaudit.do?method=showDrawing', '0', '0', 20);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d8c5ba332e8015ba332e8a7001a', '4502', '1', '草稿列表', '45', null, '/sheet/securityobjaudit/securityobjaudit.do?method=showDraftList', '0', '0', 2);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d8c5ba332e8015ba332e8a7001b', '4504', '0', '已处理工单', '45', null, null, '0', '0', 4);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d8c5ba332e8015ba332e8a8001c','450402','1','建立工单','4504', null, '/sheet/securityobjaudit/securityobjaudit.do?method=showOwnStarterList','0','0',2);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d8c5ba332e8015ba332e8a8001d', '450401', '1', '处理工单', '4504', null, '/sheet/securityobjaudit/securityobjaudit.do?method=showListsenddone', '0', '0', 1);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d8c5ba332e8015ba332e8a8001e', '4505', '1', '已归档工单', '45', null, '/sheet/securityobjaudit/securityobjaudit.do?method=showHoldedList', '0', '0', 5);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d8c5ba332e8015ba332e8a8001f', '4506', '1', '已作废工单', '45', null, '/sheet/securityobjaudit/securityobjaudit.do?method=showCancelList', '0', '0', 6);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d8c5ba332e8015ba332e8a80020', '4511', '1', '超时时间设置', '45', null, '/sheet/overtimetip/overtimetip.do?flowName=SecurityObjAudit', '0', '0', 11);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d8c5ba332e8015ba332e8a80021', '4512', '1', '工单处理时限配置', '45', null, '/sheet/newSheetLimit/sheetLimit.do?method=getLevelLimitList&flowName=SecurityObjAudit', '0', '0', 30);