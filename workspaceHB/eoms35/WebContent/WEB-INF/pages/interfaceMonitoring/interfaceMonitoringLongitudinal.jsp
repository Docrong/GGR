    ...
    <div id="form" class="tab-content">
        ...
        <fmt:bundle basename="config/ApplicationResources-commons-InterfaceMonitoring">
            <display:table name="InterfaceMonitoringList" cellspacing="0" cellpadding="0"
                           ...
                           export="true" requestURI="/interfaceMonitoringLog.do?method=newInterfaceMonitoring"
                           sort="list">
                ...
                <display:column property="view" sortable="true" headerClass="sortable"
                                ...
                                titleKey="interfaceMonitoring.Log" paramId="id" paramProperty="id"
                                href="${app}/interfaceMonitoring/interfaceMonitoringLog.do?method=detail"/>
