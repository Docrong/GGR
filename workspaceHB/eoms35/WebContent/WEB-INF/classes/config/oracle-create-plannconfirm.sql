...
alter table PLANNCONFIRM_MAIN
    add constraint PLANNCONFIRM_MAIN_PK primary key (id) using index;
...
alter table PLANNCONFIRM_TASK
    add constraint PLANNCONFIRM_TASK_PK primary key (id) using index;
...
values ('xls,txt,doc,jpg,gif', 'plannconfirm', '规划站址确认申请流程流程', 1024, '/sheet/plannconfirm', 104,
        '402882e83f18c2fa013f18c2fa9f0000');
...
values ('402882e83f18c2fa013f18c2fa9f0001', '9601', '1', '新增工单', '96', null,
...
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402882e83f18c2fa013f18c2fa9f000b', '960402', '1', '建立工单', '9604', null,
        '/sheet/plannconfirm/plannconfirm.do?method=showOwnStarterList', '0', '0', 2);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402882e83f18c2fa013f18c2fa9f000c', '960401', '1', '处理工单', '9604', null,
        '/sheet/plannconfirm/plannconfirm.do?method=showListsenddone', '0', '0', 1);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402882e83f18c2fa013f18c2fa9f000d', '9605', '1', '已归档工单', '96', null,
        '/sheet/plannconfirm/plannconfirm.do?method=showHoldedList', '0', '0', 5);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402882e83f18c2fa013f18c2fa9f000e', '9606', '1', '已作废工单', '96', null,
        '/sheet/plannconfirm/plannconfirm.do?method=showCancelList', '0', '0', 6);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402882e83f18c2fa013f18c2fa9f000f', '9611', '1', '超时时间设置', '96', null,
        '/sheet/overtimetip/overtimetip.do?flowName=PlannConfirm', '0', '0', 11);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402882e83f18c2fa013f18c2fa9f0010', '9612', '1', '工单处理时限配置', '96', null,
