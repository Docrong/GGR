...
<html>
    <head>
        <title>JWChat - Cambiar estado de conexi&oacute;n</title>
    ...
    <body style="margin:8px">
        <form name="statF">
            ...
            0 cellspacing=0 style="margin-bottom: 8px;">
            <tr>
                <td>
                    <input type=radio name="status" value="available" id="available">
                        <label for="available">
                            <img src="images/available.gif">conectado
                        </label>
                </td>
                <td>
                    <input type=radio name="status" value="xa" id="xa">
                        <label for="xa">
                            <img src="images/xa.gif">no disponible
                        </label>
                </td>
            </tr>
            <tr>
                <td>
                    <input type=radio name="status" value="chat" id="chaty">
                        <label for="chaty">
                            <img src="images/chat.gif">disponible para charlar
                        </label>
                </td>
                <td>
                    <input type=radio name="status" value="dnd" id="dnd">
                        <label for="dnd">
                            <img src="images/dnd.gif">no molestar
                        </label>
                </td>
            </tr>
            <tr>
            ...
            <tr id="offline">
                <td>&nbsp;</td>
                <td>
                    <input type=radio name="status" value="offline" id="offl">
                        <label for="offl">
                            <img src="images/unavailable.gif">desconectado
                        </label>
                </td>
            </tr>
            <tr>
    ...
    <tr height="100%">
        <td colspan=2
        >
        <textarea id="msg" wrap="physical" class="msgBox">
    </textarea>
</td>
</tr>
<tr>
...
<tr>
    <td colspan=2 align="right" id="buttonbox">
        <button onClick="window.close();">Cancelar</button>
        &nbsp;
        <button onClick="return doSubmit();">Aplicar</button>
    </td>
</tr>
</table>
</form>
