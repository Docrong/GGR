    ...
    <fmt:bundle basename="com/boco/eoms/km/config/applicationResource-kmmanager">
        ...
        <table class="formTable">
            ...
            <tr>
                ...
                <td class="content">
                    <input type="text" id="fileName" name="fileName" class="text" maxlength="20"
                           value="${fileForm.fileName}" alt="allowBlank:true"/>
            ...
            <tr>
                ...
                <td class="content">
                    <input type="text" id="userName" name="userName" class="text" readonly="readonly" value=""
                           alt="allowBlank:true"/>
            ...
            <tr>
                ...
                <td class="content">
                    <input type="text" name="keywords" id="keywords" value="${fileForm.keywords}" maxlength="10"
