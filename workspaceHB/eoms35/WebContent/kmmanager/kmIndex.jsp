    ...
    <div id="middlePart">
        ...
        <div class="search">
            ...
            <div id="searchContent">
                搜索：<select name="actionName" id="actionName" class="select"
                           style="font-size:11px;padding-top:0px;border:1px solid #D4D0C8;">
                <option value="search.do">知识案例库</option>
                <option value="sdoc.do">文档案例库</option>
            </select>
                <input type="text" class="text" name="actionValue" id="actionValue"
                       style="height:20px;padding-top:0px;border:1px solid #D4D0C8;"/>
        ...
        <div class="dataDetailList">
            <div class="dataDetailTitle">
                ...
                <div class="dataDetailTitleContent">
                    <span class="span1" style="text-align:center;">所属类别</span>|<span class="span2"
                                                                                     style="text-align:center;">文档主题</span>|<span
                        class="span3">创建时间</span>|<span class="span4">创建人</span>
                </div>
            </div>
    ...
    <div id="rightPart">
        ...
        <div id="loginUser">
            ...
            <div class="userContent">
                ...
                <span>
					<div>${sessionScope.sessionform.username}</div><div id="knowledgeScore"></div><div
                        id="expertScore"></div>
				</span>
            </div>
        </div>
        ...
        <div class="orderList">
            ...
            <div class="orderContent">
                <div style="margin-left:2px;">
                    <span id="tab1" class="orderTabOver" onmouseover="switchTab('${app}','',1);"
                          onmouseout="out(this);">总</span><span id="tab2" class="orderTabDefault"
                                                                onmouseover="switchTab('${app}','',2);"
                                                                onmouseout="out(this);">年</span><span id="tab3"
                                                                                                      class="orderTabDefault"
                                                                                                      onmouseover="switchTab('${app}','',3);"
                                                                                                      onmouseout="out(this);">季</span><span
                        id="tab4" class="orderTabDefault" onmouseover="switchTab('${app}','',4);"
                        onmouseout="out(this);">月</span><span id="tab5" class="orderTabDefault"
                                                              onmouseover="switchTab('${app}','',5);"
                                                              onmouseout="out(this);">周</span></div>
            ...
            <div class="orderContent">
                <div style="margin-left:2px;">
                    <span id="readcountTab1" class="orderTabOver" onmouseover="switchTab('${app}','readcount',1);"
                          onmouseout="out(this);">总</span><span id="readcountTab2" class="orderTabDefault"
                                                                onmouseover="switchTab('${app}','readcount',2);"
                                                                onmouseout="out(this);">年</span><span id="readcountTab3"
                                                                                                      class="orderTabDefault"
                                                                                                      onmouseover="switchTab('${app}','readcount',3);"
                                                                                                      onmouseout="out(this);">季</span><span
                        id="readcountTab4" class="orderTabDefault" onmouseover="switchTab('${app}','readcount',4);"
                        onmouseout="out(this);">月</span><span id="readcountTab5" class="orderTabDefault"
                                                              onmouseover="switchTab('${app}','readcount',5);"
                                                              onmouseout="out(this);">周</span></div>
            ...
            <div class="orderContent">
                <div style="margin-left:2px;">
                    <span id="scoreTab1" class="orderTabOver" onmouseover="switchTab('${app}','score',1);"
                          onmouseout="out(this);">总</span><span id="scoreTab2" class="orderTabDefault"
                                                                onmouseover="switchTab('${app}','score',2);"
                                                                onmouseout="out(this);">年</span><span id="scoreTab3"
                                                                                                      class="orderTabDefault"
                                                                                                      onmouseover="switchTab('${app}','score',3);"
                                                                                                      onmouseout="out(this);">季</span><span
                        id="scoreTab4" class="orderTabDefault" onmouseover="switchTab('${app}','score',4);"
                        onmouseout="out(this);">月</span><span id="scoreTab5" class="orderTabDefault"
                                                              onmouseover="switchTab('${app}','score',5);"
                                                              onmouseout="out(this);">周</span></div>
