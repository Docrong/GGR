    ...
    <div id="sheetinfo">
        <logic:present name="sheetMain" scope="request">
            ...
            <table class="formTable">
                ...
                <tr>
                    <td class="label"><bean:message bundle="safetyproblem"
                                                    key="safetyproblem.mainTaskDescription"/></td>
            ...
            <tr>
                <td width="50%">
                    ...
                    <select id="dealSelector">
                        ...
                        <option value="${urlShowTransmitDealPage}"><bean:message bundle="safetyproblem"
                                                                                 key="safetyproblem.taskpass"/></option>
                        <option value="${urlShowTransmit2DealPage}"><bean:message bundle="safetyproblem"
                                                                                  key="safetyproblem.tasknopass"/></option>
                    ...
                    <select id="dealSelector">
                        ...
                        <%} else if (taskStatus.equals(Constants.TASK_STATUS_CLAIMED)) { %>
                        <option value="${urlShowCompleteDealPage}"><bean:message bundle="safetyproblem"
                                                                                 key="safetyproblem.dealwcnosp"/></option>
                        <option value="${urlShowPassDealPage}"><bean:message bundle="safetyproblem"
                                                                             key="safetyproblem.totaskcompsq"/></option>
                        <!-- <option value="${urlShowTransferPage}"><bean:message bundle="safetyproblem" key="safetyproblem.yijiao"/></option> -->
                        <option value="${urlShowSplitDealPage}"><bean:message bundle="safetyproblem"
                                                                              key="safetyproblem.fenpai"/></option>
                        <!-- <option value="${urlShowPhaseReplyPage}"><bean:message bundle="sheet" key="event.reply"/></option>-->
                        <%} %>
                    </select>
                    ...
                    <select id="dealSelector">
                        ...
                        <!--<option value="${urlShowRejectBackPage}"><bean:message bundle="sheet" key="common.rejectBack"/></option>-->
                        <%} else if (taskStatus.equals(Constants.TASK_STATUS_CLAIMED)) { %>
                        <option value="${urlShowTaskCompleteAuditYes}"><bean:message bundle="safetyproblem"
                                                                                     key="safetyproblem.TaskCompleteAuditYes"/></option>
                        <option value="${urlShowTaskCompleteAuditNo}"><bean:message bundle="safetyproblem"
                                                                                    key="safetyproblem.TaskCompleteAuditNo"/></option>
                        <!--<option value="${urlShowPhaseReplyPage}"><bean:message bundle="sheet" key="event.reply"/></option>-->
                        <%} %>
                    </select>
                    <%} else if (taskName.equals("AffirmHumTask")) {%>
                    <select id="dealSelector">
                        <option value="${urlShowDealReplyPassPage}"><bean:message bundle="safetyproblem"
                                                                                  key="safetyproblem.dealrejectpass"/></option>
                        <option value="${urlShowDealReplyNoPassPage}"><bean:message bundle="safetyproblem"
                                                                                    key="safetyproblem.nopassback"/></option>
                        <!--<option value="${urlShowPhaseReplyPage}"><bean:message bundle="sheet" key="event.reply"/></option>-->
                    </select>
                    <%} else if (taskName.equals("DraftHumTask")) {%>
                    <select id="dealSelector">
                        <option value="${urlShowCompleteDraftPage}"><bean:message bundle="safetyproblem"
                    ...
                    <select id="dealSelector">
                        <option value="${urlShowHoldDealPage}"><bean:message bundle="safetyproblem"
