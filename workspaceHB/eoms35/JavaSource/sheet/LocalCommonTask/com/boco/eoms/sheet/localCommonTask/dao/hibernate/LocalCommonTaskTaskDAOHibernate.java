...
import com.boco.eoms.sheet.localCommonTask.model.LocalCommonTaskTask;
...
public class LocalCommonTaskTaskDAOHibernate extends TaskDAOImpl implements ILocalCommonTaskTaskDAO {
    ...
    public HashMap getTaskListBySQL(final String queryStr,
        ...
        HibernateCallback callback = new HibernateCallback() {
            public Object doInHibernate(Session session) throws HibernateException {
                ...
                try {
                    Query query = session.createSQLQuery(queryStr).addScalar("title").addEntity(LocalCommonTaskTask.class);
