...
<div id="sheetform">
    <html:form action="/commontask.do?method=performProcessEvent" styleId="theform">
        <%@ include file="/common/taglibs.jsp" %>
        <%
        ...
        <input type="hidden" name="${sheetPageName}mainClassName"
               value="com.boco.eoms.sheet.commontask.model.CommonTaskMain"/> <!--main\u8868Model\u5bf9\u8c61\u7c7b\u540d-->
        <input type="hidden" name="${sheetPageName}linkClassName"
               value="com.boco.eoms.sheet.commontask.model.CommonTaskLink"/> <!--link\u8868Model\u5bf9\u8c61\u7c7b\u540d-->
        <input type="hidden" name="${sheetPageName}processTemplateName" id="${sheetPageName}processTemplateName"
               value="CommonTaskMainFlowProcess"/>
        ...
        <table class="listTable">
            <logic:present name="toOperaterList" scope="request">
                <logic:iterate id="toTask" name="toOperaterList"
                               type="com.boco.eoms.sheet.commontask.model.CommonTaskTask">
                    <tr>
                        <td>
