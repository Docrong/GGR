...
<html:form action="/resourceaffirm.do" styleId="theform">
    ...
    <input type="hidden" name="${sheetPageName}mainClassName"
           value="com.boco.eoms.sheet.resourceaffirm.model.resourceaffirmMain"/> <!--main\u8868Model\u5bf9\u8c61\u7c7b\u540d-->
    <input type="hidden" name="${sheetPageName}linkClassName"
           value="com.boco.eoms.sheet.resourceaffirm.model.resourceaffirmLink"/> <!--link\u8868Model\u5bf9\u8c61\u7c7b\u540d-->
