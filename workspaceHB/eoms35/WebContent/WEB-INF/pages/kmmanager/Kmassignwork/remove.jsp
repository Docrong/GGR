                        ...
                        <table bgcolor="#f2f2f2" width="500" cellspacing="0" border="0">
                            ...
                            <logic:present name="tawRmAssignworkForm" scope="request">
                                ...
                                <tr>
                                    ...
                                    <td width="76%"><font size="2" face="Tahoma">
                                        <bean:write name="tawRmAssignworkForm" property="starttimeDefined"
                                                    scope="request"/>
                                ...
                                <tr>
                                    ...
                                    <td width="76%"><font size="2" face="Tahoma">
                                        <bean:write name="tawRmAssignworkForm" property="endtimeDefined"
                                                    scope="request"/>
                            ...
                            <tr align="right" valign="middle">
                                <td><html:form method="POST" action="/TawRmAssignwork/trash">
                                    <input type="hidden" name="id"
                                           value="<bean:write name="tawRmAssignworkForm" property="id" scope="request"/>">
