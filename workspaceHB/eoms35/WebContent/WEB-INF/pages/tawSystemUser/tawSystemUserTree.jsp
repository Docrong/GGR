    ...
    var config = {
        ...
        onLoadFunctions: function () {
            ...
            new xbox({
                ...
                treeChkMode: '',
                treeChkType: 'cptroom',
                showChkFldId: 'cptroomname',
                saveChkFldId: 'cptroomid'
            });
            new xbox({
                btnId: 'deptname',
                dlgId: 'dlg-dept',
                dlgTitle: '${eoms:a2u('请选择该人员所属部门')}',
            ...
            new xbox({
                btnId: 'selMoveTgt',
                dlgId: 'dlg-user',
                dlgTitle: '${eoms:a2u('请选择移交人员')}',
                treeDataUrl: userTree,
                treeRootId: '-1',
                treeRootText: '${eoms:a2u('所有人员')}',
                treeChkMode: '',
                treeChkType: 'user',
                showChkFldId: 'moveToName',
                saveChkFldId: 'userId'
            });
            ...
            new xbox({
                btnId: 'selSubRole',
                dlgId: 'dlg-subrole',
                dlgTitle: '${eoms:a2u('请选子角色')}',
                treeDataUrl: subRoleTree,
                treeRootId: '-1',
                treeRootText: '${eoms:a2u('所有角色')}',
                treeChkMode: '',
                treeChkType: 'subrole',
                showChkFldId: 'subRoles',
                saveChkFldId: 'subRoleId'
            });
        ...
        <div class="x-dlg-tab" title="${eoms:a2u('所属子角色列表')}">
            <div class="inner-tab">
                <form id="adjustSubRole-form" onsubmit="javascript:doAdjustSubRoles(this);return false;">
                    <br/>
                    ${eoms:a2u('需要添加的子角色列表')} :
                    <div id="subRoles" class="viewer-list"></div>
