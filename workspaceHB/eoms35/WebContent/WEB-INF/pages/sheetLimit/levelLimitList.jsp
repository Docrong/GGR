...
<c:set var="buttons">
    <input type="button" style="margin-right: 5px"
           onclick="location.href='<c:url
                   value="/sheet/newSheetLimit/sheetLimit.do?method=editLevelLimit&flowName=${flowName}&type=add"/>'"
...
<display:table name="levelLimitList" cellspacing="0" cellpadding="0"
               ...
               decorator="com.boco.eoms.sheet.limit.webapp.action.SheetLimitListDisplaytagDecoratorHelper">
