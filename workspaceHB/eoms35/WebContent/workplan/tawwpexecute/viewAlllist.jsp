...
<form name="dailyexecuteplan" action="viewAllList.do">
    ...
    <table class="listTable" id="list" width="700">
        <tr>
            ...
            <td width="500">
                <eoms:dict key="dict-workplan" dictId="yearFlag" isQuery="false" defaultId="<%=_yearFlag%>"
                           onchange="changeYear()" selectId="yearFlag" beanId="selectXML"/>
                年<eoms:dict key="dict-workplan" dictId="monthFlag" isQuery="false" defaultId="<%=_monthFlag%>"
                            onchange="changeYear()" selectId="monthFlag" beanId="selectXML"/>
                月
