<%@ page language="java"
         import="java.util.*,com.boco.eoms.base.util.StaticMethod,com.boco.eoms.extra.supplierkpi.model.TawSupplierkpiInstance,com.boco.eoms.base.util.StaticMethod,com.boco.eoms.extra.supplierkpi.model.TawSupplierkpiItem" %>
