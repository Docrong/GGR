       ...
       <%if(operateType.equals("61")){ %>
        ...
        <%if(operateType.equals("46") || operateType.equals("11") ){ %>
	          ...
	          <%} %>
				...
				<tr>
				  <td class="label"><bean:message bundle="commonfault" key="commonfault.linkDealStep"/>1*</td>
				  <td colspan="3">
			  			<select id="selectStep" onchange="changeStep(this.value)" alt="allowBlank:false">
				   <option value="">请选择</option> 
					<%
					System.out.println("请选择"+steplist.size());
					if (steplist.size() > 0 ) {
					...
					>${sheetLink.linkDealStep}</textarea>	
				  </td>
				</tr>
				<tr>
		       <td class="label">
	         ...
	         <%if((taskName.equals("FirstExcuteHumTask") || taskName.equals("SecondExcuteHumTask") ||
				...
				<tr>
				  <td class="label"><bean:message bundle="commonfault" key="commonfault.linkIfExcuteNetChange"/>*12</td>
				  <td >
