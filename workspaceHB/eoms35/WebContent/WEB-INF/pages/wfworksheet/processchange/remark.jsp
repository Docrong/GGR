...
<div id="sheetform">
<html:form action="/processchange.do?method=newPerformNonFlow" styleId="theform">
 ...
 %>
          ...
          <input type="hidden" name="${sheetPageName}mainClassName" value="com.boco.eoms.sheet.processchange.model.ProcessChangeMain"/>	<!--mainè¡¨Modelå¯¹è±¡ç±»å-->	
          <input type="hidden" name="${sheetPageName}linkClassName" value="com.boco.eoms.sheet.processchange.model.linkProcessTypeLink"/> <!--linkè¡¨Modelå¯¹è±¡ç±»å-->
           <input type="hidden" name="${sheetPageName}processTemplateName" value="linkProcessTypeProcess" />
