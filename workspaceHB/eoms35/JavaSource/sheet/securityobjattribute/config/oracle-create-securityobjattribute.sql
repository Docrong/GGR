...
alter table SECURITYOBJATTRIBUTE_MAIN
    add constraint SECURITYOBJATTRIBUTE_MAIN_PK primary key (id) using index;
...
alter table SECURITYOBJATTRIBUTE_TASK
    add constraint SECURITYOBJATTRIBUTE_TASK_PK primary key (id) using index;
...
values ('xls,txt,doc,jpg,gif', 'securityobjattribute', '安全对象属性信息变更审批工单流程', 1024, '/sheet/securityobjattribute', 30,
        '40287d8c5ba33494015ba334944a0000');

--插入角色
insert into taw_system_role(role_id, deleted, parent_id, role_name, roletype_id, workflow_flag, leaf)
values ('4201', '0', '0', '建单人', '1', '42', '1');
insert into taw_system_role(role_id, deleted, parent_id, role_name, roletype_id, workflow_flag, leaf)
values ('4202', '0', '0', '审批人', '1', '42', '1');
insert into taw_system_role(role_id, deleted, parent_id, role_name, roletype_id, workflow_flag, leaf)
values ('4203', '0', '0', '处理人', '1', '42', '1');
insert into taw_system_role(role_id, deleted, parent_id, role_name, roletype_id, workflow_flag, leaf)
values ('4204', '0', '0', '质检员', '1', '42', '1');

--插入菜单
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d8c5ba33494015ba334944a0001', '4401', '1', '新增工单', '44', null,
        '/sheet/securityobjattribute/securityobjattribute.do?method=showNewSheetPage', '0', '0', 1);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d8c5ba33494015ba334944a0002', '4403', '0', '待处理工单', '44', null, null, '0', '0', 3);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d8c5ba33494015ba334944a0003', '440301', '1', '待办工单', '4403', null,
        '/sheet/securityobjattribute/securityobjattribute.do?method=showListsendundo', '0', '0', 1);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d8c5ba33494015ba334944a0004', '4407', '1', '工单查询', '44', null,
        '/sheet/securityobjattribute/securityobjattribute.do?method=showQueryPage', '0', '0', 7);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d8c5ba33494015ba334944a0005', '4408', '1', '工单处理模板', '44', null,
        '/sheet/securityobjattribute/securityobjattribute.do?method=getDealTemplatesByUserId&&type=templateManage', '0',
        '0', 8);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d8c5ba33494015ba334944a0006', '4409', '1', '工单模板管理', '44', null,
        '/sheet/securityobjattribute/securityobjattribute.do?method=getTemplatesByUserId&&type=templateManage', '0',
        '0', 9);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d8c5ba33494015ba334944a0007', '4410', '1', '管理者工单', '44', null,
        '/sheet/securityobjattribute/securityobjattribute.do?method=showListForAdmin', '0', '0', 10);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d8c5ba33494015ba334944a0008', '44', '0', '安全对象属性信息变更审批工单流程', '10', null,
        '/sheet/securityobjattribute/securityobjattribute.do?method=showDrawing', '0', '0', 20);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d8c5ba33494015ba334944a0009', '4402', '1', '草稿列表', '44', null,
        '/sheet/securityobjattribute/securityobjattribute.do?method=showDraftList', '0', '0', 2);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d8c5ba33494015ba334944a000a', '4404', '0', '已处理工单', '44', null, null, '0', '0', 4);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d8c5ba33494015ba334944a000b', '440402', '1', '建立工单', '4404', null,
        '/sheet/securityobjattribute/securityobjattribute.do?method=showOwnStarterList', '0', '0', 2);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d8c5ba33494015ba334944a000c', '440401', '1', '处理工单', '4404', null,
        '/sheet/securityobjattribute/securityobjattribute.do?method=showListsenddone', '0', '0', 1);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d8c5ba33494015ba334944b000d', '4405', '1', '已归档工单', '44', null,
        '/sheet/securityobjattribute/securityobjattribute.do?method=showHoldedList', '0', '0', 5);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d8c5ba33494015ba334944b000e', '4406', '1', '已作废工单', '44', null,
        '/sheet/securityobjattribute/securityobjattribute.do?method=showCancelList', '0', '0', 6);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d8c5ba33494015ba334944b000f', '4411', '1', '超时时间设置', '44', null,
        '/sheet/overtimetip/overtimetip.do?flowName=SecurityObjAttribute', '0', '0', 11);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d8c5ba33494015ba334944b0010', '4412', '1', '工单处理时限配置', '44', null,
        '/sheet/newSheetLimit/sheetLimit.do?method=getLevelLimitList&&flowName=SecurityObjAttribute', '0', '0', 30);