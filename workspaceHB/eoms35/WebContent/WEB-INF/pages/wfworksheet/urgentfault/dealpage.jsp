   ...
   <c:choose> 
     <c:when test="${operateType=='61'}">    
		<div class="form-btns" id="btns">
		  <input type="submit" class="submit" onclick="v.passing=false;this.form.action='${app}/sheet/urgentfault/urgentfault.do?method=performClaimTask'" 
    ...
    <c:when test="${taskName=='DraftHumTask'}">    
		...
		<html:button styleClass="btn" property="method.save" styleId="method.save"
	      ...
	      <input type="submit" class="submit" onclick="v.passing=true;this.form.action='${app}/sheet/urgentfault/urgentfault.do?method=performSaveInfoAndExit&draft=1'" value="<bean:message bundle='sheet' key='button.saveback'/>" />

	       <%-- </c:if>--%>
	      <input type="submit" class="submit" onclick="v.passing=true;this.form.action='${app}/sheet/urgentfault/urgentfault.do?method=showDraftList'" value="<bean:message bundle='sheet' key='button.back'/>" />
    ...
    <c:otherwise>  
	    ...
	    <div class="form-btns hide" id="btns">
	      ...
	      <html:button styleClass="btn" property="method.save" styleId="method.save"
		    onclick="v.passing=true;javascript:saveDealInfo();">
		          	<bean:message bundle='sheet' key='button.save'/>
		    	</html:button><input type="submit" class="submit" onclick="v.passing=true;this.form.action='${app}/sheet/urgentfault/urgentfault.do?method=performSaveInfoAndExit'" value="<bean:message bundle='sheet' key='button.saveback'/>" />
