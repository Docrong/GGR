...
td.column-content{
 ...
 li.history-item {font-size:14px; padding: 0px; margin: 0px 2% 10px 5px;} 
 li.history-item a {
 	border: 1px solid #8cacbb;
 	color:#006699;
 	padding: 0.8ex 0px 0.8ex 8px;font-size:14px;
 	display:block; 
 	position:relative; text-decoration:none;
 	height:auto;
	cursor:text;
 } 
 li.history-item a:hover {background:#e5ecf9;border: 1px solid #8cacbb;color:#006699;}
 li.history-item a span {display:none; }
 li.history-item a span.show {display:block; }
 li.history-item a:hover span {display:block; position:relative; }
...
li>fieldset, form>fieldset { border: 1px solid #C9DEFA }
form fieldset {padding:10px;border: 1px solid #C9DEFA}
...
<%@page import="com.boco.eoms.sheet.complaint.service.*" %>
<%@page import="com.boco.eoms.commons.system.dict.service.ID2NameService" %>
<%@page import="com.boco.eoms.sheet.complaint.model.*" %>
...
<%
ComplaintMain basemain = (ComplaintMain)request.getAttribute("sheetMain");
  ...
  <c:if test="${!empty sheetMain.parentSheetId}">
	...
	<table class="formTable"> 
	  ...
	  <tr>
		...
		<%=id2NameService.id2Name(basemain.getUrgentDegree(),"ItawSystemDictTypeDao")%>
		</td>
	  </tr>		  
      <tr>
	...
	<table class="formTable"> 
      ...
      <tr>
		...
		<td class="content">${sheetMain.btype1}</td>
		<td class="label">联系人电话</td>
		<td class="content">${sheetMain.bdeptContact}</td>
	  </tr> 
				   	  
      <tr>
        <td class="label">故障时间</td>
		<td class="content">
		<%=StaticMethod.date2String(basemain.getFaultTime()) %>
		</td>
		<td class="label">投诉时间</td>
		<td class="content">
		<%=StaticMethod.date2String(basemain.getComplaintTime()) %>
		</td>
	  </tr>  

	<tr>
	  <td class="label">投诉位置</td>
	  <td class="content" colspan="3">${sheetMain.complaintAdd}</td>
	</tr>
	<tr>
	  <td class="label">投诉内容</td>
	  <td class="content" colspan="3">${sheetMain.complaintDesc}</td>
	</tr>		
	  <tr>
	    <td class="label">是否大面积投诉</td>
		<td class="content"><%=id2NameService.id2Name(basemain.getBdeptContactPhone(),"ItawSystemDictTypeDao")%>	
		</td>
		<td class="label">重复投诉次数</td>
		<td class="content">${sheetMain.repeatComplaintTimes}</td>
	  </tr>	
	
	  <tr>
	    <td class="label">用户类型</td>
		<td class="content"><%=id2NameService.id2Name(basemain.getCustomType(),"ItawSystemDictTypeDao")%>	
		</td>
		<td class="label">用户品牌</td>
		<td class="content"><%=id2NameService.id2Name(basemain.getCustomBrand(),"ItawSystemDictTypeDao")%>	
		</td>
	  </tr>	
	  
	  <tr>
	    <td class="label">用户级别</td>
		<td class="content">${sheetMain.customLevel}</td>
		<td class="label">用户归属地</td>
		<td class="content">${sheetMain.customAttribution}</td>
	  </tr>	

	  <tr>
	    <td class="label">投诉分类一级类别</td>
		<td class="content"><%=id2NameService.id2Name(basemain.getComplaintType1(),"ItawSystemDictTypeDao")%>	
		</td>
		<td class="label">投诉分类二级类别</td>
		<td class="content"><%=id2NameService.id2Name(basemain.getComplaintType2(),"ItawSystemDictTypeDao")%>	
		</td>
	  </tr>	

	  <tr>
	    <td class="label">投诉分类三级类别</td>
		<td class="content"><%=id2NameService.id2Name(basemain.getComplaintType(),"ItawSystemDictTypeDao")%>	
		</td>
		<td class="label">投诉分类四级类别</td>
		<td class="content"><%=id2NameService.id2Name(basemain.getComplaintType4(),"ItawSystemDictTypeDao")%>	
		</td>
	  </tr>	
	  
	  <tr>
	    <td class="label">投诉分类五级类别</td>
		<td class="content"><%=id2NameService.id2Name(basemain.getComplaintType5(),"ItawSystemDictTypeDao")%>	
		</td>
		<td class="label">投诉分类六级类别</td>
		<td class="content"><%=id2NameService.id2Name(basemain.getComplaintType6(),"ItawSystemDictTypeDao")%>	
		</td>
	  </tr>		  

	  <tr>
	    <td class="label">投诉分类七级类别</td>
		<td class="content" colspan="3"><%=id2NameService.id2Name(basemain.getComplaintType7(),"ItawSystemDictTypeDao")%>	
		</td>
	  </tr>	
	  <tr>
	    <td class="label">受理地市</td>
		<td class="content" colspan="3"><%=id2NameService.id2Name(basemain.getToDeptId(),"tawSystemAreaDao")%>
		</td>
	  </tr>	

	  <tr>
	    <td class="label">故障行政区</td>
		<td class="content">${sheetMain.faultArea}</td>
		<td class="label">故障路段名</td>
		<td class="content">${sheetMain.faultRoad}</td>
	  </tr>	

	  <tr>
	    <td class="label">故障门牌号</td>
		<td class="content" colspan="3">${sheetMain.faultNo}</td>
	  </tr>

	  <tr>
	    <td class="label">故障交叉路段名1</td>
		<td class="content">${sheetMain.faultRoad1}</td>
		<td class="label">故障交叉路段名2</td>
		<td class="content">${sheetMain.faultRoad2}</td>
	  </tr>	

	  <tr>
	    <td class="label">楼宇名称</td>
		<td class="content">${sheetMain.faultVill}</td>
		<td class="label">是否上门服务</td>
		<td class="content"><%=id2NameService.id2Name(basemain.getIsVisit(),"ItawSystemDictTypeDao")%>	
		</td>
	  </tr>	  

	  <tr>
	    <td class="label">故障现象</td>
		<td class="content" colspan="3">${sheetMain.faultDesc}</td>
	  </tr>	  	  
		...
		<tr>
		    ...
		    <td  colspan='3'>
		    <%
		    	if(basemain.getSheetAccessories()!=null && basemain.getSheetAccessories().length()>0)){
      ...
      <logic:iterate id="baselink" name="HISTORY" type="com.boco.eoms.sheet.complaint.model.ComplaintLink">
		       ...
		       <div class="history-item-title">
				 ...
				 <%=StaticMethod.date2String(baselink.getOperateTime())%>&nbsp; 
				  <%=id2NameService.id2Name(baselink.getOperateUserId(),"tawSystemUserDao")%>
		           操作类型:
		          <%=service.itemId2name("dict-sheet-complaint#mainOperateType", baselink.getOperateType().intValue() + "")%> 
			 ...
			 <%if(baselink.getOperateType()!=null && (baselink.getOperateType().intValue() == 46 || baselink.getOperateType().intValue() == 11) ){%> 
                ...
                <tr>
	  				  ...
	  				  <td class="column-content">
	  				   ${baselink.ndeptContact}
	                  </td>	                 
	  				  <td class="column-title">
	  				     联系人电话
	  				  </td>
	  				  <td class="column-content">
	  				   	${baselink.ndeptContactPhone}
	                  </td>	                  
		  		</tr>	
                ...
                <tr>
	  				  ...
	  				  <td class="column-content">
	  				  <%=id2NameService.id2Name(baselink.getLinkIfInvokeChange(),"ItawSystemDictTypeDao")%>	
	                  </td>	                 
	  				  <td class="column-title">
	  				     变更流程工单编号
	  				  </td>
	  				  <td class="column-content">
	  				  ${baselink.linkChangeSheetId}
	                  </td>	                  
		  		</tr>	
                ...
                <tr>
	  				  ...
	  				  <td class="column-content">
	  				  ${baselink.linkFaultStartTime}
	                  </td>	                 
	  				  <td class="column-title">
	  				     故障结束时间
	  				  </td>
	  				  <td class="column-content">
	  				   	 ${baselink.linkFaultEndTime}
	                  </td>	                  
		  		</tr>		  				  		
                ...
                <tr>
	  				  ...
	  				  <td class="column-content">
	  				  	${baselink.linkFaultGenerantPlace}
	                  </td>	                 
	  				  <td class="column-title">
	  				     具体位置描述
	  				  </td>
	  				  <td class="column-content">
	  				   ${baselink.linkPlaceDesc}
	                  </td>	                  
		  		</tr>		  				  		
                <tr>
	  				  <td class="column-title">
	  				  ...
	  				  <td class="column-content">
	  				  ${baselink.issueEliminatTime}
	                  </td>	                 
	  				  <td class="column-title">
	  				     问题原因
	  				  </td>
	  				  <td class="column-content">
	  				  ${baselink.issueEliminatReason}
	                  </td>	                  
		  		</tr>	  		
		 ...
		 <%if(baselink.getActiveTemplateId()!=null && baselink.getActiveTemplateId().equals("CheckingHumTask") ){%> 
		 	<%if(baselink.getOperateType()!=null && (baselink.getOperateType().intValue() == 56 || baselink.getOperateType().intValue() == 54) ){%>
                <tr>
	  				  ...
	  				  <td class="column-content" colspan=3>
	  				  <%=id2NameService.id2Name(baselink.getLinkCheckResult(),"ItawSystemDictTypeDao")%>	
