...
<div id="sheetform">
<html:form action="/greatevent.do?method=performDealReplyReject" styleId="theform">
 <%@ include file="/common/taglibs.jsp"%>
<%
 ...
 %>
    ...
    <input type="hidden" name="${sheetPageName}subtaskName" value="GreatEventSubTask"/> 
    ...
    <input type="hidden" name="${sheetPageName}taskNamespace" value="http://GreatEventProcess"/>  
<%@ include file="/WEB-INF/pages/wfworksheet/greatevent/baseinputlinkhtmlnew.jsp"%>
 <br/>     
     ...
     <tr>
      ...
      <logic:iterate id="toTask" name="acceptList" type="com.boco.eoms.sheet.greatevent.model.GreatEventTask">  
        <tr>
          <td>
	       ...
	       <td class="label">
			...
			<td colspan="3"> 
		           <textarea name="${sheetPageName}remark" class="textarea max" id="${sheetPageName}remark" 
		              alt="allowBlank:true,maxLength:255,vtext:'请填入信息，最多输入125字'" alt="width:'500px'">${sheetlink.remark}</textarea>
		  </td>
		</tr>
		</table>
