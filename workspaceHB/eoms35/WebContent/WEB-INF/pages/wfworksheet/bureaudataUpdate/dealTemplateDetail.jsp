...
<%
    com.boco.eoms.sheet.bureaudataUpdate.model.BureaudataUpdateLink bureaudataUpdateLink = (com.boco.eoms.sheet.bureaudataUpdate.model.BureaudataUpdateLink) request.getAttribute("sheetLink");
    java.lang.String taskName = com.boco.eoms.base.util.StaticMethod.nullObject2String(bureaudataUpdateLink.getActiveTemplateId());
    java.lang.String operateType = java.lang.String.valueOf(com.boco.eoms.base.util.StaticMethod.nullObject2String(bureaudataUpdateLink.getOperateType()));
%>
<script type="text/javascript">
    ...
    function saveDealTemplate(type) {
        ...
        form.action = "${app}/sheet/bureaudataUpdate/bureaudataUpdate.do?method=saveDealTemplate&type=dealTemplateManage&dealTemplateId=${sheetLink.id}";
        form.submit();
    }
...
<html:form action="/bureaudataUpdate.do" styleId="theform">
    <br/>
    ...
    <table class="formTable">
        <caption><bean:message bundle="bureaudataUpdate" key="bureaudataUpdate.header"/></caption>
        <tr>
            <td class="label">
        ...
        <tr>
            <td class="label"><bean:message bundle="bureaudataUpdate" key="bureaudataUpdate.linkZContact"/>*</td>
            <td class="content">
            ...
            <td class="label"><bean:message bundle="bureaudataUpdate" key="bureaudataUpdate.linkZContactTel"/>*</td>
            <td class="content">
        ...
        <tr>
            ...
            <td colspan='3'>
                <eoms:attachment idList="" scope="request" idField="${sheetPageName}nodeAccessories" name="sheetLink"
                                 property="nodeAccessories" appCode="bureaudataUpdate" alt="allowBlank:true"/>
            </td>
        </tr>
        <%
                }
        ...
        <tr>
            <td class="label"><bean:message bundle="bureaudataUpdate" key="bureaudataUpdate.linkOperationDesc"/>*</td>
            <td colspan="3">
        ...
        <tr>
            <td class="label">
                <bean:message bundle="bureaudataUpdate" key="bureaudataUpdate.remark"/>*
            </td>
            <td colspan="3">
