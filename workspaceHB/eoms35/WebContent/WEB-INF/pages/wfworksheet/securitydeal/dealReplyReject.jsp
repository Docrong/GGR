...
<div id="sheetform">
<html:form action="/securitydeal.do?method=performDealReplyReject" styleId="theform">
 <%@ include file="/common/taglibs.jsp"%>
<%
 ...
 %>
    ...
    <input type="hidden" name="${sheetPageName}subtaskName" value="SecurityDealSubTask"/> 
    ...
    <input type="hidden" name="${sheetPageName}taskNamespace" value="http://SecurityDealProcess"/>  
<%@ include file="/WEB-INF/pages/wfworksheet/securitydeal/baseinputlinkhtmlnew.jsp"%>
    <br/>  
     ...
     <tr>
      ...
      <logic:iterate id="toTask" name="acceptList" type="com.boco.eoms.sheet.securitydeal.model.SecurityDealTask">  
        <tr>
          <td>
