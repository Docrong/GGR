...
<form action="bureaudataHlr.do?method=importexportexcelfile" method="post" onsubmit="return submitCheck();"
      onload="checkType();document.forms[0].exportType.focus();">
    <table class="formTable">
        ...
        <tr class="tr_show">
            <td class="label" width="15%">
                <div align="right"><strong>${eoms:a2u('导出类型')}</strong></div>
            </td>
            <td colspan="3">
        ...
        <tr class="tr_show" id="bureauIdTr" style="display:none;">
            <td class="label">
                <div align="right"><strong>${eoms:a2u('局数据编号*')}</strong></div>
            </td>
            <td><input type="text" name="bureauId" maxlength="50"/></td>
        </tr>
        <tr>
            <td align="right" colspan="4">
                <input type="button" name="btnSubmit" value="${eoms:a2u('导出数据')}" class="btn"
