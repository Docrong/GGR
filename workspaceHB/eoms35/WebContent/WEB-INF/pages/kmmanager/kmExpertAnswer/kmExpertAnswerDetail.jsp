...
<html:form action="/kmExpertAnswer.do?method=saveQuestion" styleId="KmExpertAnswerForm" method="post">
    ...
    <table class="formTable">
        ...
        <tr>
            ...
            <td class="content" colspan="3">
                <eoms:attachment name="kmExpertAnswer" property="questionAtt" scope="request" idField="questionAtt"
        ...
        <tr>
            ...
            <td class="content">
                <eoms:dict key="dict-kmmanager" dictId="questionState" itemId="${kmExpertAnswer.state}"
                           beanId="id2nameXML"/>
            </td>
        </tr>
        <%
        ...
        <tr>
            ...
            <td class="content" colspan="3">
                ...
                <a id='answerUrla' href="${kmExpertAnswer.answerUrl}"
                   target=_blank><%if (kmExpertAnswer.getAnswerUrl() != null && !"".equals(kmExpertAnswer.getAnswerUrl())) {%>
                    相关链接<%}%></a>
            </td>
        ...
        <tr>
            ...
            <td class="content" colspan="3">
                <eoms:attachment name="kmExpertAnswer" property="answerAtt" scope="request" idField="answerAtt"
                                 appCode="kmmanager" viewFlag="Y"/>
        ...
        <tr>
            ...
            <td class="content" colspan="3">
                <eoms:dict key="dict-kmmanager" dictId="answerScore" itemId="${kmExpertAnswer.score}"
                           beanId="id2nameXML"/>
            </td>
        </tr>
        <%
        ...
        <tr>
            ...
            <td class="content" colspan="3">
                <textarea name="answer" id="answer"
                          class="textarea max"><%if (Answer_3) {%>上一次答复：<%}%>${kmExpertAnswer.answer}</textarea>
                <html:hidden property="answerUrl" value="${kmExpertAnswer.answerUrl}"/>
                <a id='answerUrla' href="<%=kmExpertAnswer.getAnswerUrl() %>"
                   target=_blank><%if (kmExpertAnswer.getAnswerUrl() != null && !"".equals(kmExpertAnswer.getAnswerUrl())) {%>
                    相关链接<%}%></a> <input type="button" name="answerUrlt" id="answerUrlt" value="增加(修改)帮助链接" class="btn"
                                         onclick="modifyUrl('<%=StaticMethod.null2String(kmExpertAnswer.getAnswerUrl()) %>');"/>
            </td>
