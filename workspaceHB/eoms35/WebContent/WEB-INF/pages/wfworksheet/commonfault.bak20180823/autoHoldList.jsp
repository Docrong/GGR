...
<jsp:include page="/WEB-INF/pages/wfworksheet/commonfault/autoHoldListFastSearch.jsp"/>
	...
	<display:table name="taskList" cellspacing="0" cellpadding="0"
		...
		sort="list" size="total" partialList="true" decorator="com.boco.eoms.sheet.commonfault.webapp.action.AutoHoldDisplaytagDecoratorHelper">
		...
		<input type="hidden"   name="commonfaultautoids" id="commonfaultautoids"/>
			<tr>
				<td width="200px">
				 ...
				 <input type="button" class="btn" name="export" value="批量导出" onclick="javascript:if(ConfirmExportData()) exportData()" />
				</td>		
			</tr>
	</form>
