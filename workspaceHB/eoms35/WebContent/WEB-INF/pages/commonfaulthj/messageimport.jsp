...
<form name="tawimport" id="tawimport" method="post" enctype="multipart/form-data" action="${app }/commonfaulthj/excelimportnet.do?method=importSave" onsubmit="return onsubmitCheck();">
