        ...
        <logic:present name="sheetMain" scope="request">
            ...
            <table class="formTable">
                ...
                <tr>
                    ...
                    <td class="content"><bean:write name="sheetMain" property="mainITRequirementID"
                                                    scope="request"/></td>
                ...
                <tr>
                    ...
                    <td class="content" colspan='3'>
                        <eoms:attachment name="sheetMain" property="mainChangeDetail" idList=""
                                         scope="request" idField="${sheetPageName}mainChangeDetail"
                                         appCode="itsoftchangesheet" viewFlag="Y"/>
                    </td>
                </tr>
            ...
            <tr>
                ...
                %>
                    ...
                    <select id="dealSelector">
                        ...
                        <option value="${urlShowOperateTaskDealPage}"><bean:message bundle="itsoftchange"
                                                                                    key="operateType.completeDev"/></option>
                    ...
                    <select id="dealSelector">
                        ...
                        <%if (ifsub.equals("") || ifsub.equals("false")) {%>
                        <%if (ifwaitfor.equals("false")) {%>
                        <option value="${urlShowTestTaskDealPage}"><bean:message bundle="itsoftchange"
                                                                                 key="operateType.completeTest"/></option>
                        <option value="${urlShowTransferkPage}"><bean:message bundle="sheet"
                                                                              key="common.transfer"/></option>
                        <option value="${urlShowPhaseReplyPage}"><bean:message bundle="sheet"
                                                                               key="event.reply"/></option>
                    ...
                    <select id="dealSelector">
                        ...
                        <%if (ifsub.equals("") || ifsub.equals("false")) {%>
                        <%if (ifwaitfor.equals("false")) {%>
                        <option value="${urlShowOnlineTaskDealPage}"><bean:message bundle="itsoftchange"
                                                                                   key="operateType.completeOnline"/></option>
                        <option value="${urlShowTransferkPage}"><bean:message bundle="sheet"
                                                                              key="common.transfer"/></option>
                        <option value="${urlShowPhaseReplyPage}"><bean:message bundle="sheet"
                                                                               key="event.reply"/></option>
                    ...
                    <select id="dealSelector">
                        <option value="${urlShowDraftDeal}"><bean:message bundle="itsoftchange"
                    ...
                    <select id="dealSelector">
                        <option value="${urlShowHoldDealPage}"><bean:message bundle="itsoftchange"
                                                                             key="operateType.hold"/></option>
                        <option value="${urlShowRejectBackDealPage}"><bean:message bundle="itsoftchange"
