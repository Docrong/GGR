...
import com.boco.eoms.sheet.businessimplementsms.service.IBusinessImplementSmsFlowManager;


public class BusinessImplementSmsFlowManagerImpl extends BusinessFlowServiceImpl implements IBusinessImplementSmsFlowManager {
	/**
	 * 在流程实例中取得属性值
	 */
