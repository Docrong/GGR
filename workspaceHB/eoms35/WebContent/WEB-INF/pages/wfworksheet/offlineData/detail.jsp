...
<%@page import="com.boco.eoms.sheet.offlineData.model.OfflineDataTask" %>
...
OfflineDataTask task = new OfflineDataTask();
String operaterType = "";
String ifsub = "";
String ifwaitfor="";

if(request.getAttribute("task")!=null){
 task = (OfflineDataTask)request.getAttribute("task");
...
Ext.onReady(function() {
	var tabConfig = {
		items : [{
			...
			url : 'offlineData.do?method=showSheetDealList&orderByDetp=true&sheetKey=${sheetMain.id}&taskName=${taskName}&ifWaitForSubTask=${task.ifWaitForSubTask}'
		}, {
			text : '<bean:message bundle="sheet" key="sheet.filesView"/>',
			url : 'offlineData.do?method=showSheetAccessoriesList&id=${sheetMain.id}',
			isIframe : true
		}, {
	...
	var url2="offlineData.do?method=newShowCCPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}&operateType=-10&taskStatus=${taskStatus}";
	eoms.util.appendPage("sheet-deal-content",url2);	
	<%}%>
	<%if(taskName.equals("reply")){ %>
	var url2="offlineData.do?method=showRemarkPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}";
	eoms.util.appendPage("sheet-deal-content",url2);	
	<%}%>
...
function forceOperation(obj){
	...
	if(obj == 1){
		...
		var url2="offlineData.do?method=showForceHoldPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}&operateType=forceHold";
		eoms.util.appendPage("sheet-deal-content",url2);
		
	}else if(obj == 2){
	     
		var url2="offlineData.do?method=showForceHoldPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}&operateType=nullity";
		eoms.util.appendPage("sheet-deal-content",url2);
	}else{
	    
	    var url2="offlineData.do?method=showForceHoldPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}&operateType=forceNullity";
		eoms.util.appendPage("sheet-deal-content",url2);
    }
   }
    function eventOperation(obj){
	if(obj == 1){
	     var url2="offlineData.do?method=showPhaseAdvicePage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&taskName=advice&operateFlag=driveForward&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}";
...
<div id="sheet-detail-page">
  ...
  <div id="sheetinfo">
  	...
  	<%@ include file="/WEB-INF/pages/wfworksheet/offlineData/basedetailnew.jsp"%>
	<table class="formTable">
		<tr>
		  	<!-- 工单接单时限 -->
			  <td class="label">${eoms:a2u('受理时限')}</td>
			  <td>
			    ${eoms:date2String(sheetMain.sheetAcceptLimit)}
			  </td>
			  <!-- 设计完成时限 -->
			  <td  class="label">${eoms:a2u('处理时限')}</td>
			  <td>
			    ${eoms:date2String(sheetMain.sheetCompleteLimit)}
			  </td>
	  </tr> 
		 <tr>
				  <td class="label">${eoms:a2u('下线类型')}</td>
				  <td>
				    <eoms:id2nameDB id="${sheetMain.offlineType}" beanId="ItawSystemDictTypeDao"/>
				  </td>
				  <td  class="label">${eoms:a2u('工程文号')}</td>
				  <td>${sheetMain.offlineNum}</td>
		  </tr>
		  <tr>
		  		<td  class="label">${eoms:a2u('备注')}</td>
			    <td colspan="3">
 					${sheetMain.mainRemark}
			    </td>
		  </tr>
				<tr>
				    ...
				    <eoms:attachment name="sheetMain" property="sheetAccessories" 
				            scope="request" idField="sheetAccessories" appCode="offlineData" 
				             viewFlag="Y"/> 
				    </td>
				</tr>
...
var frame1 = $('frame2');
	...
	frame1.src = "${app}/sheet/offlineData/offlineData.do?method=showList&sheetKey=${sheetMain.id}&actionForword=infoList&stylepage=detail"; 
</script>
<!-- Sheet Tabs End -->
...
<!-- 分派 -->
<c:url var="urlShowInputSplit" value="offlineData.do">
...
<!-- 会审 -->
<c:url var="urlShowInputSplitAudit" value="offlineData.do">
  <c:param name="method" value="showInputSplit"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 分派回复 -->
<c:url var="urlShowDispatchPage" value="offlineData.do">
...
<!-- 会审回复 -->
<c:url var="urlShowDispatchAuditPage" value="offlineData.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 处理回复通过 -->
<c:url var="urlShowDealReplyAcceptPage" value="offlineData.do">
...
<!-- 处理回复不通过 -->
<c:url var="urlShowDealReplyRejectPage" value="offlineData.do">
...
<!-- 转审 -->
<c:url var="urlShowTransferAuditPage" value="offlineData.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<c:url var="urlShowExamineYesDealPage" value="offlineData.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<c:url var="urlShowExamineNoDealPage" value="offlineData.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 确认受理 -->
<c:url var="urlShowAcceptDealPage" value="offlineData.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 任务创建审批通过 -->
<c:url var="urlShowTransmitDealPage" value="offlineData.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 任务创建审批不通过 -->
<c:url var="urlShowTransmit2DealPage" value="offlineData.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 分派 -->
<c:url var="urlShowSplitDealPage" value="offlineData.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<c:url var="urlShowExamineDealPage" value="offlineData.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 处理完成无需审批 -->
<c:url var="urlShowCompleteDealPage" value="offlineData.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 执行完成送审 -->
<c:url var="urlShowPassDealPage" value="offlineData.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 任务完成审批通过 -->
<c:url var="urlShowTaskCompleteAuditYes" value="offlineData.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 任务完成审批不通过 -->
<c:url var="urlShowTaskCompleteAuditNo" value="offlineData.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!--处理回复通过 -->
<c:url var="urlShowDealReplyPassPage" value="offlineData.do">
...
<!--处理回复不通过 -->
<c:url var="urlShowDealReplyNoPassPage" value="offlineData.do">
  <c:param name="method" value="showDealReplyPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 归档 -->
<c:url var="urlShowHoldDealPage" value="offlineData.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 草稿 -->
<c:url var="urlShowCompleteDraftPage" value="offlineData.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 驳回 -->
<c:url var="urlShowBackDeal" value="offlineData.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 移交 -->
<c:url var="urlShowTransferPage" value="offlineData.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 移交 -->
<c:url var="urlShowRejectBackPage" value="offlineData.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 阶段回复 -->
<c:url var="urlShowPhaseReplyPage" value="offlineData.do">
...
<!-- 重派 -->
<c:url var="urlShowReSendDeal" value="offlineData.do">
	...
	<div class='sheet-deal-header'>
		...
		<%if(taskName.equals("TaskAuditHumTask")){ %>	
			<select id="dealSelector"> 
			 ...
			 <option value="${urlShowTransmitDealPage}"><bean:message bundle="offlineData" key="offlineData.taskpass"/> </option>
			 <option value="${urlShowTransmit2DealPage}"><bean:message bundle="offlineData" key="offlineData.tasknopass"/></option>
<!--			 <option value="${urlShowExamineDealPage}">${eoms:a2u('延期申请')}</option> -->
		...
		<%}else if(taskName.equals("ExcuteHumTask")){%>	
			 ...
			 <%if(ifsub.equals("") || ifsub.equals("false")){ %>
			  <option value="${urlShowCompleteDealPage}">${eoms:a2u('执行下线')}</option>
<!--			  <option value="${urlShowPassDealPage}"><bean:message bundle="offlineData" key="offlineData.totaskcompsq"/></option>-->
...
<!--	  		 <option value="${urlShowExamineDealPage}">${eoms:a2u('延期申请')}</option>-->
	...
	<%}else if(taskName.equals("DraftTask")){%>	
			<select id="dealSelector">
			  <option value="${urlShowCompleteDraftPage}"><bean:message bundle="offlineData" key="operateType.draft"/></option>
			</select>
		...
		<%}else if(taskName.equals("HoldTask")){ %>
			<select id="dealSelector">
			  <option value="${urlShowHoldDealPage}"><bean:message bundle="offlineData" key="operateType.hold"/></option>
			    <option value="${urlShowBackDeal}"><bean:message bundle="sheet" key="common.reSend"/></option>
			</select>		
		<%} %>
		</td>
...
<script type="text/javascript">
	...
	try{
        ...
        if (dealTemplateId != null && dealTemplateId != "") {
   			url = "offlineData.do?method=referenceTemplate&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&taskName=${taskName}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&operateType=${operateType}&taskStatus=${taskStatus}&dealTemplateId="+dealTemplateId
        }
