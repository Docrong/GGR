...
<div id="sheetform">
    <html:form action="/businessoperation.do?method=newPerformNonFlow" styleId="theform">
        ...
        <input type="hidden" name="${sheetPageName}mainClassName"
               value="com.boco.eoms.sheet.businessoperation.model.BusinessOperationMain"/> <!--mainè¡¨Modelå¯¹è±¡ç±»å-->
        <input type="hidden" name="${sheetPageName}linkClassName"
               value="com.boco.eoms.sheet.businessoperation.model.BusinessOperationLink"/> <!--linkè¡¨Modelå¯¹è±¡ç±»å-->
