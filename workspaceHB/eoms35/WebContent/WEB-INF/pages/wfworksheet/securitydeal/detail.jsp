...
<div id="sheet-detail-page">
  ...
  <div id="sheetinfo">
	...
	<table class="formTable"> 
	  ...
	  <td class="content" colspan="3"><bean:write name="sheetMain" property="mainSecurityDealRequire"  scope="request"/></td>
	  </tr>
		<tr>
	   ...
	   <%}else if(taskStatus.equals(Constants.TASK_STATUS_CLAIMED)){ %>
	     <%if(ifsub.equals("") || ifsub.equals("false")){%>
	      <%if(ifwaitfor.equals("false")) {%>
	        <option value="${urlShowMakeDealPage}"><bean:message bundle="securitydeal" key="operateType.MakeTask"/> </option>
		 ...
		 <%if(ifsub.equals("") || ifsub.equals("false")){%>
		 <%if(ifwaitfor.equals("false")) {%>
		   <option value="${urlShowAuditDealPage}"><bean:message bundle="securitydeal" key="operateType.AuditTask"/> </option>
		...
		<select id="dealSelector">
		 ...
		 <%if(ifsub.equals("") || ifsub.equals("false")){%>
		 <%if(ifwaitfor.equals("false")) {%>
		  <option value="${urlShowPerformDealPage}"><bean:message bundle="securitydeal" key="operateType.PerformTask"/></option>	  
		  <option value="${urlShowTransferkPage}"><bean:message bundle="sheet" key="common.transfer"/></option>	
		  <option value="${urlShowPhaseReplyPage}"><bean:message bundle="sheet" key="event.reply"/></option>
		  <%}%>
		  <%}else{%> 
		...
		<select id="dealSelector">
		  <option value="${urlShowDraftDeal}"><bean:message bundle="securitydeal" key="operateType.DraftTask"/></option>
		</select>
		...
		<select id="dealSelector">
		  <option value="${urlShowHoldDealPage}"><bean:message bundle="securitydeal" key="operateType.HoldTask"/></option>
