...
<c:set var="buttons">
    <input type="button" style="margin-right: 5px"
        onclick="location.href='<c:url value="/sheet/dealtypeconfig/dealtypeconfig.do?method=showInputPage&flowName=${flowName}"/>'"
...
<display:table name="configList" cellspacing="0" cellpadding="0"
    ...
    export="false" requestURI="" sort="list" decorator="com.boco.eoms.sheet.dealtypeconfig.webapp.action.DealTypeConfigListDisplaytagDecoratorHelper">
