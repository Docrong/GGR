        ...
        <table cellspacing=0 cellpadding=0 border=1 width="760" bordercolordark="#FFFFFF" bordercolorlight="#66CCFF"
            ...
            <tr>
                ...
                <td width="18%">
                    ...
                    <input type="text" name="vName" size="10" maxlength="200" value="<%="column_"+index%>"
                           onchange="isVariable(this);"><font color="red">**</font>
                </td>
                <td width="15%" nowrap>
                ...
                <td width="18%">
                    <input type="text" name="index" size="10" maxlength="10" value="<%=index%>"><font
                        color="red">**</font>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td width="15%" nowrap>
                    <div align="right"><fmt:message key="autosheet.wzys"/><font size=-2 color=red><b><fmt:message
                            key="autosheet.shuangji"/></b></font></div>
                </td>
                <td width="18%">
            ...
            <tr>
                ...
                <td width="18%">
                    <input type="text" name="formWidth" size="10" maxlength="10" value="20"> <fmt:message
                        key="autosheet.zf"/><font color="red">**</font>
                </td>
                <td width="15%" nowrap>
                    <div align="right" id="str"><fmt:message key="autosheet.maxlength"/></div>
                </td>
                <td width="18%">
                    <input type="text" name="formHeight" size="10" maxlength="10" value="20"> <fmt:message
                        key="autosheet.zf"/><font color="red">**</font>
                </td>
            </tr>
            <tr>
                ...
                <td width="18%">
                    <select name="typeID" disabled>
                        ...
                        <%
                            ...
                            while (codetype.next()) {
                        %>
                        <option value="<%=codetype.getTypeID()%>"><%=codetype.getTypeName()%>
                        </option>
                        <%
                            }
                        %>
...
<table cellspacing=0 cellpadding=0 border=0 width="760">
    <td width="25%" align="right">
        ...
        <input type="button" name="Submit" value="<fmt:message key="autosheet.addname"/>"
               onClick="javascript:addSubmit(0);">
        <input type="button" name="Submit3" value="<fmt:message key="autosheet.zjsrk"/>"
               onClick="javascript:addSubmit(1);">
        <input type="button" name="Submit2" value="<fmt:message key="autosheet.zjwb"/>"
               onClick="javascript:addSubmit(2);">
    </td>
    <!--<td width="14%">
      <div align="left">
