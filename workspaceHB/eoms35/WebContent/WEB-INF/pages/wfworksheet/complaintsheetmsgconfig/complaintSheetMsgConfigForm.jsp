...
<table class="formTable">
		...
		<td class="label">
			故障地市
             ...
             <td class="content" id="commonfaultarea">
              <input type="text" class="text"  readonly="readonly" name="showDept" id="showDept" alt="allowBlank:false,vtext:'请选择地域名称'" 
	...
	<tr>
		...
		<td class="content">
			<eoms:comboBox name="complaintType" id="complaintType" initDicId="10301" 
		       defaultValue="${complaintSheetMsgConfigForm.complaintType}" alt="allowBlank:false,vtext:'请选择投诉分类'"/>
		</td>
	</tr>
	...
	<tr>
		...
		<td class="content" id="chooseUser">		    
		     <input type="text" class="text"  readonly="readonly" name="showUser" id="showUser" alt="allowBlank:false,vtext:'请选择人员'" 
                 value="<eoms:id2nameDB id='${complaintSheetMsgConfigForm.notifyUserIds}' beanId='tawSystemUserDao'/>"/>
             <input type="hidden" name="notifyUserIds" id="notifyUserIds" value="${complaintSheetMsgConfigForm.notifyUserIds}"/>			              
             <eoms:xbox id="userTree" dataUrl="${app}/xtree.do?method=userFromDept" rootId="-1" rootText="用户树" 
               valueField="notifyUserIds" handler="chooseUser" textField="showUser" checktype="user" data="${user}">
             </eoms:xbox>
		</td>
	</tr>
