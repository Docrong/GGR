    ...
    <fmt:bundle basename="com/boco/eoms/km/config/applicationResource-kmmanager">
        ...
        <table class="formTable">
            ...
            <tr>
                ...
                <td class="content">
                    <eoms:dict key="dict-kmmanager" dictId="fileGrade" selectId="fileGrade" beanId="selectXML"
                               alt="allowBlank:false,vtext:'请选择文件等级...'" defaultId="${fileForm.fileGrade}"/>
                </td>
            </tr>
            ...
            <c:if test="${fileForm.fileName != null}">
                <tr>
                    ...
                    <td class="content">
                        <a href="${app}/kmmanager/files.do?method=download&id=${fileForm.id}&nodeId=${fileForm.nodeId}"
                           style="text-decoration:none">${fileForm.fileName}</a>
                    </td>
                </tr>
            </c:if>
            ...
            <tr>
                ...
                <td class="content">
                    <input name="file" type="file"
                           <logic:equal name="fileForm" property="id"
                                        value="">alt="allowBlank:false,vtext:'请选择上传的文件...'"</logic:equal>
                           style="width:50%;height:22;border:1px solid #006699"/>
                </td>
            </tr>
