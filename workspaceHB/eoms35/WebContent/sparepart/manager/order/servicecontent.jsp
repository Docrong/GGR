...
<div align="center">
    <center>
        ...
        <form action="../part/serviceover.do?order=<bean:write name="order" scope="request" filter="false"/>"
              method="post" name="TawSparepartForm" onsubmit="return handleid();">
            <table border="0" width="95%" cellspacing="1" cellpadding="1" class="table_show" align="center">
                ...
                <logic:iterate id="sparepart" name="sparepart" type="com.boco.eoms.sparepart.model.TawPart">
                    <tr class="tr_show" align="center">
                        ...
                        <td>
                            <INPUT TYPE="checkbox" name="primary" id="<%="a"+i%>" label="<%="b"+i%>"
                                   onClick="checkOnly(this);"
                                   value="<bean:write name="sparepart" property="id" scope="page"/>"></td>
                        </td>
                        <td>
                            <INPUT TYPE="checkbox" name="new" id="<%="b"+i%>" label="<%="a"+i%>"
                                   onClick="checkOnly(this);"
                                   value="<bean:write name="sparepart" property="id" scope="page"/>"></td>
                        </td>
                        <td width="10%">
                        ...
                        <td width="10%">
                            <input type="text" id="<bean:write name='sparepart' property='id' scope='page'/>" value=""
                                   name="charge" size="10" maxlength="255">
                            <input type="hidden" id="<bean:write name='sparepart' property='id' scope='page'/>_"
                                   name="hiddencharge" value="">
                        </td>
                    </tr>
                    <%i++;%>
                </logic:iterate>
