...
<table width="600" align="left">
    <tr>
                    ...
                    <td>
                        <table border="0" width="80%" cellspacing="1" cellpadding="1" class="formTable" align=center>
                            ...
                            <tr class="tr_show">
                                ...
                                <td>
                                    <eoms:SelectDate name="time_from_b" formName="tawRmChangedutyForm" flag="1"
                                                     value="<%=str_start%>"/>
                                </td>
                                <td>
                                    <eoms:SelectDate name="time_from_e" formName="tawRmChangedutyForm" flag="1"
                                                     value="<%=str_start%>"/>
                                </td>
                            </tr>
                            ...
                            <tr class="tr_show">
                                ...
                                <td>
                                    <eoms:SelectDate name="time_to_b" formName="tawRmChangedutyForm" flag="1"
                                                     value="<%=str_start%>"/>
                                </td>
                                <td>
                                    <eoms:SelectDate name="time_to_e" formName="tawRmChangedutyForm" flag="1"
                                                     value="<%=str_start%>"/>
                                </td>
                            </tr>
                        </table>
      ...
      --%><input type="submit" name="name" value=
                                    <bean:message key="TawRmChangeduty.apply"/> class="button">
