...
<%
 ...
 %>
    ...
    <input type="hidden" name="${sheetPageName}mainClassName" value="com.boco.eoms.sheet.safeaudit.model.SafeAuditMain"/>	<!--main\u8868Model\u5bf9\u8c61\u7c7b\u540d-->	
    <input type="hidden" name="${sheetPageName}linkClassName" value="com.boco.eoms.sheet.safeaudit.model.SafeAuditLink"/> <!--link\u8868Model\u5bf9\u8c61\u7c7b\u540d--> 
