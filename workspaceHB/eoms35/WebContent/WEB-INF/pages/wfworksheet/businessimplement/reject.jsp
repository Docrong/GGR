...
function showPage(){
     var pars = '';
     var url = '';    
      url = '${app}/sheet/businessimplement/businessimplement.do?method=showInputRejectPage&piid=${sheetMain.piid}&taskId=${taskId}&taskName=${taskName}';
     if (url!=''){
...
<div id="sheetform">
<html:form action="/businessimplement.do?method=performDeal" styleId="theform">
