...
<table class="formTable">
    ...
    <td>
        <eoms:comboBox name="${sheetPageName}compProp" id="${sheetPageName}compProp" initDicId="1011006"
                       defaultValue="${sheetLink.compProp}" alt="allowBlank:ture"/>
    </td>
    ...
    <td>
        <eoms:comboBox name="${sheetPageName}isCorrect" id="${sheetPageName}isCorrect" initDicId="1011050"
                       defaultValue="${sheetLink.isCorrect}" alt="allowBlank:ture"/>
    </td>
    ...
    <td>
        <eoms:comboBox name="${sheetPageName}affectedAreas" id="${sheetPageName}affectedAreas" initDicId="1011003"
                       defaultValue="${sheetLink.affectedAreas}" alt="allowBlank:ture"/>
    </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <eoms:comboBox name="${sheetPageName}dealResult" id="${sheetPageName}dealResult" initDicId="1011007"
                           defaultValue="${sheetLink.dealResult}" alt="allowBlank:ture"/>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td colspan="3">
            <textarea name="dealDesc" id="dealDesc" class="textarea max"
                      alt="allowBlank:true,maxLength:2000,vtext:'最多输入1000汉字'">${sheetLink.dealDesc}</textarea>
        </td>
    </tr>
