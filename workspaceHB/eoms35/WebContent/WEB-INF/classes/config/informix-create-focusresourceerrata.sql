...
values ('xls,txt,doc,jpg,gif', 'focusresourceerrata', '集客资源勘误流程', 1024, '/sheet/focusresourceerrata', 1001, '2c9048ab6347a50d016347a50daf0011');


--插入角色
insert into taw_system_role(role_id,deleted,parent_id,role_name,roletype_id,workflow_flag,leaf) values('1012','0','0','建单人','1','100','1');
insert into taw_system_role(role_id,deleted,parent_id,role_name,roletype_id,workflow_flag,leaf) values('1013','0','0','申请人','1','100','1');
insert into taw_system_role(role_id,deleted,parent_id,role_name,roletype_id,workflow_flag,leaf) values('1003','0','0','传输网部','1','100','1');
insert into taw_system_role(role_id,deleted,parent_id,role_name,roletype_id,workflow_flag,leaf) values('1001','0','0','申请人','1','100','1');
insert into taw_system_role(role_id,deleted,parent_id,role_name,roletype_id,workflow_flag,leaf) values('1004','0','0','地市','1','100','1');
insert into taw_system_role(role_id,deleted,parent_id,role_name,roletype_id,workflow_flag,leaf) values('1002','0','0','监控部','1','100','1');


--插入菜单
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('2c9048ab6347a50d016347a50db00012', '199901', '1', '新增工单', '1999', null, '/sheet/focusresourceerrata/focusresourceerrata.do?method=showNewSheetPage', '0', '0', 1);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('2c9048ab6347a50d016347a50db00013', '199903', '0', '待处理工单', '1999', null, null, '0', '0', 3);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('2c9048ab6347a50d016347a50db00014', '19990301', '1', '待办工单', '199903', null, '/sheet/focusresourceerrata/focusresourceerrata.do?method=showListsendundo', '0', '0', 1);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('2c9048ab6347a50d016347a50db00015', '199907', '1', '工单查询', '1999', null, '/sheet/focusresourceerrata/focusresourceerrata.do?method=showQueryPage', '0', '0', 7);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('2c9048ab6347a50d016347a50db00016', '199908', '1', '工单处理模板', '1999', null, '/sheet/focusresourceerrata/focusresourceerrata.do?method=getDealTemplatesByUserId&type=templateManage', '0', '0', 8);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('2c9048ab6347a50d016347a50db00017', '199909', '1', '工单模板管理', '1999', null, '/sheet/focusresourceerrata/focusresourceerrata.do?method=getTemplatesByUserId&type=templateManage', '0', '0', 9);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('2c9048ab6347a50d016347a50db00018', '199910', '1', '管理者工单', '1999', null, '/sheet/focusresourceerrata/focusresourceerrata.do?method=showListForAdmin', '0', '0', 10);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('2c9048ab6347a50d016347a50db00019', '1999', '0', '集客资源勘误流程', '10', null, '/sheet/focusresourceerrata/focusresourceerrata.do?method=showDrawing', '0', '0', 20);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('2c9048ab6347a50d016347a50db0001a', '199902', '1', '草稿列表', '1999', null, '/sheet/focusresourceerrata/focusresourceerrata.do?method=showDraftList', '0', '0', 2);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('2c9048ab6347a50d016347a50db0001b', '199904', '0', '已处理工单', '1999', null, null, '0', '0', 4);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('2c9048ab6347a50d016347a50db0001c','19990402','1','建立工单','199904', null, '/sheet/focusresourceerrata/focusresourceerrata.do?method=showOwnStarterList','0','0',2);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('2c9048ab6347a50d016347a50db0001d', '19990401', '1', '处理工单', '199904', null, '/sheet/focusresourceerrata/focusresourceerrata.do?method=showListsenddone', '0', '0', 1);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('2c9048ab6347a50d016347a50db0001e', '199905', '1', '已归档工单', '1999', null, '/sheet/focusresourceerrata/focusresourceerrata.do?method=showHoldedList', '0', '0', 5);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('2c9048ab6347a50d016347a50db0001f', '199906', '1', '已作废工单', '1999', null, '/sheet/focusresourceerrata/focusresourceerrata.do?method=showCancelList', '0', '0', 6);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('2c9048ab6347a50d016347a50db00020', '199911', '1', '超时时间设置', '1999', null, '/sheet/overtimetip/overtimetip.do?flowName=FocusResourceErrata', '0', '0', 11);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('2c9048ab6347a50d016347a50db00021', '199912', '1', '工单处理时限配置', '1999', null, '/sheet/newSheetLimit/sheetLimit.do?method=getLevelLimitList&flowName=FocusResourceErrata', '0', '0', 30);