...
<div id="sheetform">
<html:form action="/netFault.do?method=newPerformNonFlow" styleId="theform">
 <%@ include file="/common/taglibs.jsp"%>
<%
...
String sheetKey = (String) request.getParameter("sheetKey");
 ...
 %>
     ...
     <input type="hidden" name="${sheetPageName}mainClassName" value="com.boco.eoms.sheet.netFault.model.NetFaultMain"/>	<!--main\u8868Model\u5bf9\u8c61\u7c7b\u540d-->	
     <input type="hidden" name="${sheetPageName}linkClassName" value="com.boco.eoms.sheet.netFault.model.NetFaultLink"/> <!--link\u8868Model\u5bf9\u8c61\u7c7b\u540d--> 
     <input type="hidden" name="${sheetPageName}processTemplateName" id="${sheetPageName}processTemplateName" value="NetFaultMainFlowProcess" />
...
<%@ include file="/WEB-INF/pages/wfworksheet/netFault/baseinputlinkhtmlnew.jsp"%>
     ...
     <tr>
      ...
      <logic:iterate id="toTask" name="toOperaterList" type="com.boco.eoms.sheet.netFault.model.NetFaultTask">  
        <tr>
          <td>
