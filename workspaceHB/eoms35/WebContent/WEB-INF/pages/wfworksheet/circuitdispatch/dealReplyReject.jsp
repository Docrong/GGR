...
<div id="sheetform">
<html:form action="/circuitdispatch.do?method=performDealReplyReject" styleId="theform">
 <%@ include file="/common/taglibs.jsp"%>
<%
 ...
 %>
    ...
    <input type="hidden" name="${sheetPageName}subtaskName" value="circuitSubTask1"/> 
	...
	<input type="hidden" name="${sheetPageName}processTemplateName" id="${sheetPageName}processTemplateName" value="CircuitDispatchMainProcess" />
	...
	<input type="hidden" name="${sheetPageName}mainClassName" value="com.boco.eoms.sheet.circuitdispatch.model.CircuitDispatchMain"/>	
	<input type="hidden" name="${sheetPageName}linkClassName" value="com.boco.eoms.sheet.circuitdispatch.model.CircuitDispatchLink"/>
    <input type="hidden" name="${sheetPageName}taskNamespace" value="http://CircuitDispatchProcess"/>  
<%@ include file="/WEB-INF/pages/wfworksheet/circuitdispatch/baseinputlinkhtmlnew.jsp"%>
     ...
     <tr>
      ...
      <logic:iterate id="toTask" name="acceptList" type="com.boco.eoms.sheet.circuitdispatch.task.impl.CircuitDispatchTask">  
        <tr>
          <td>
