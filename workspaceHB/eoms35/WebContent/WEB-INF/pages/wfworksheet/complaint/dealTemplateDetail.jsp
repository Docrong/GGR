...
<html:form action="/complaint.do" styleId="theform">
    ...
    <table class="listTable">
        ...
        <tr>
            ...
            <td>
                <eoms:comboBox name="${sheetPageName}linkIfMutualCommunication"
                               id="${sheetPageName}linkIfMutualCommunication" initDicId="1011608"
                               defaultValue="${sheetLink.linkIfMutualCommunication}"/>
            </td>
            <td class="label"><bean:message bundle="complaint" key="complaint.mainIfSafe"/></td>
            <td>
                <eoms:comboBox name="${sheetPageName}linkIfSafe" id="${sheetPageName}linkIfSafe" initDicId="1011608"
        ...
        <tr>
            ...
            <td colspan="3">
                <textarea name="linkFaultFirstDealDesc" id="linkFaultFirstDealDesc"
                          class="textarea max">${sheetLink.linkFaultFirstDealDesc}</textarea>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td colspan="3">
                <textarea name="linkFaultDesc" id="linkFaultDesc"
                          class="textarea max">${sheetLink.linkFaultDesc}</textarea>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td colspan="3">
                <textarea name="linkTransmitReason" id="linkTransmitReason"
                          class="textarea max">${sheetLink.linkTransmitReason}</textarea>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td colspan="3">
                <eoms:comboBox name="${sheetPageName}linkFaultDealResult" id="${sheetPageName}linkFaultDealResult"
                               initDicId="1011612" defaultValue="${sheetLink.linkFaultDealResult}"/>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td colspan="3">
                ...
                <eoms:comboBox name="${sheetPageName}linkFaultReasonSort" id="${sheetPageName}linkFaultReasonSort"
                               initDicId="1011609" defaultValue="${sheetLink.linkFaultReason}"/>
                ...
                <eoms:comboBox name="${sheetPageName}linkFaultReasonSubsection"
                               id="${sheetPageName}linkFaultReasonSubsection" initDicId="1011610"
                               defaultValue="${sheetLink.linkFaultReason}"/>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td colspan="3">
                <textarea name="linkDealStep" id="linkDealStep"
                          class="textarea max">${sheetLink.linkDealStep}</textarea>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td colspan="3">
                <eoms:comboBox name="${sheetPageName}linkIfExcuteNetChange" id="${sheetPageName}linkIfExcuteNetChange"
                               initDicId="1011608" defaultValue="${sheetLink.linkIfExcuteNetChange}"/>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td colspan="3">
                <eoms:comboBox name="${sheetPageName}linkIfFinallySolveProject"
                               id="${sheetPageName}linkIfFinallySolveProject" initDicId="1011608"
                               defaultValue="${sheetLink.linkIfFinallySolveProject}"/>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td colspan="3">
                <eoms:comboBox name="${sheetPageName}linkIfAddCaseDataBase" id="${sheetPageName}linkIfAddCaseDataBase"
                               initDicId="1011608" defaultValue="${sheetLink.linkIfAddCaseDataBase}"/>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td colspan="3">
                <textarea name="linkTransmitContent" id="linkTransmitContent"
                          class="textarea max">${sheetLink.linkTransmitContent}</textarea>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td colspan="3">
                <eoms:comboBox name="${sheetPageName}linkIfDeferResolve" id="${sheetPageName}linkIfDeferResolve"
                               initDicId="1011608" defaultValue="${sheetLink.linkIfDeferResolve}"/>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td colspan="3">
                <textarea name="linkUntreadReason" id="linkUntreadReason"
                          class="textarea max">${sheetLink.linkUntreadReason}</textarea>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <eoms:comboBox name="${sheetPageName}linkFaultResponseLevel" id="${sheetPageName}linkFaultResponseLevel"
                               initDicId="1011603" defaultValue="${sheetLink.linkFaultResponseLevel}"/>
            </td>
        ...
        <tr>
            ...
            <td colspan="3">
                <textarea name="${sheetPageName}endResult" id="${sheetPageName}endResult" alt="allowBlank:false"
