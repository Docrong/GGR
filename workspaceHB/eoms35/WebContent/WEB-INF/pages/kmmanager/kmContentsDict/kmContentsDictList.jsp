...
<fmt:bundle basename="com/boco/eoms/km/config/applicationResource-kmmanager">
    ...
    <display:table name="kmContentsDictList" cellspacing="0" cellpadding="0"
        ...
        <display:column property="contentId" sortable="true"
                        headerClass="sortable" titleKey="kmContentsDict.contentId"
                        href="${app}/kmContentsDict/kmContentsDicts.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="dictId" sortable="true"
                        headerClass="sortable" titleKey="kmContentsDict.dictId"
                        href="${app}/kmContentsDict/kmContentsDicts.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="dictType" sortable="true"
                        headerClass="sortable" titleKey="kmContentsDict.dictType"
                        href="${app}/kmContentsDict/kmContentsDicts.do?method=edit" paramId="id" paramProperty="id"/>
