...
<%
    com.boco.eoms.sheet.circuitoperation.model.CircuitOperationLink circuitoperationLink = (com.boco.eoms.sheet.circuitoperation.model.CircuitOperationLink) request.getAttribute("sheetLink");
    java.lang.String taskName = com.boco.eoms.base.util.StaticMethod.nullObject2String(circuitoperationLink.getActiveTemplateId());
    java.lang.String operateType = java.lang.String.valueOf(com.boco.eoms.base.util.StaticMethod.nullObject2String(circuitoperationLink.getOperateType()));
%>
<script type="text/javascript">
    ...
    function saveDealTemplate(type) {
        ...
        form.action = "${app}/sheet/circuitoperation/circuitoperation.do?method=saveDealTemplate&type=dealTemplateManage&dealTemplateId=${sheetLink.id}";
        form.submit();
    }
...
<html:form action="/circuitoperation.do" styleId="theform">
    <br/>
    ...
    <table class="formTable">
        <caption><bean:message bundle="circuitoperation" key="circuitoperation.header"/></caption>
        <tr>
            <td class="label">
