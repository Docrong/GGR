...
<div id="history" class="panel">
    ...
    <logic:present name="HISTORY" scope="request">
        ...
        <logic:iterate id="baselink" name="HISTORY"
                       type="com.boco.eoms.sheet.securityobjattribute.model.SecurityObjAttributeLink">
            <%
                jNum += 1;
            ...
            <div class="history-item">&nbsp;
                ...
                <div class="history-item-title">
                    ...
                    <eoms:dict key="dict-sheet-securityobjattribute" dictId="activeTemplateId"
                               itemId="${baselink.activeTemplateId}" beanId="id2descriptionXML"/>
                    <bean:message bundle="securityobjattribute" key="securityobjattribute.operateType"/>:
                    <eoms:dict key="dict-sheet-securityobjattribute" dictId="mainOperateType"
                ...
                <div class="history-item-content hide">
                    <table class="formTable" width="100%" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td class="label">
                                <!-- 审核结果 -->
                                <bean:message bundle="securityobjattribute"
                                              key="securityObjAttributeLink.linkAuditResult"/>
                            </td>
                            <td class="content">
                            ...
                            <td class="label">
                                <!-- 审核意见 -->
                                <bean:message bundle="securityobjattribute"
                                              key="securityObjAttributeLink.linkAuditOpinion"/>
                            </td>
                            <td class="content">
                        ...
                        <tr>
                            ...
                            <td class="label">
                                <!-- 回复对象 -->
                                <bean:message bundle="securityobjattribute"
                                              key="securityObjAttributeLink.linkReplyObj"/>
                            </td>
                            <td class="content">
                            ...
                            <td class="label">
                                <!-- 回复说明 -->
                                <bean:message bundle="securityobjattribute"
                                              key="securityObjAttributeLink.linkReplyExp"/>
                            </td>
                            <td class="content">
                        ...
                        <tr>
                            ...
                            <td class="label">
                                <!-- 质检结果 -->
                                <bean:message bundle="securityobjattribute"
                                              key="securityObjAttributeLink.linkQualityResult"/>
                            </td>
                            <td class="content">
                            ...
                            <td class="label">
                                <!-- 质检概述 -->
                                <bean:message bundle="securityobjattribute"
                                              key="securityObjAttributeLink.linkQualityView"/>
                            </td>
                            <td class="content">
...
<script type="text/javascript">
    ...
    function copy(id) {
        ...
        if (ifCheck.checked == true) {
            Ext.Ajax.request({
                method: "get",
                url: "securityobjattribute.do?method=getJsonLink&id=" + id + "&beanName=SecurityObjAttribute",
                success: function (x) {
