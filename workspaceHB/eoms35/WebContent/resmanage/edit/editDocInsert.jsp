...
<form method="post" name="editPic" enctype="multipart/form-data" action="editDocSave.jsp">
    ...
    <table class='table_show' border=0 cellspacing=1 width='100%'>
        <tr class=td_label>
            ...
            <td align=center><font size=2 color=#000000 face='Verdana, Arial, Helvetica, sans-serif'><input type=file
                                                                                                            name=fname1>　　文件名必须为英文名</font>
            </td>
        </tr>
        <tr class=td_label>
            <td align=center><font size=2 color=#000000 face='Verdana, Arial, Helvetica, sans-serif'>上传文档</font>
        ...
        <tr class=td_label>
            ...
            <td align=center><font size=2 color=#000000 face='Verdana, Arial, Helvetica, sans-serif'><input type=file
                                                                                                            name=fname4>　　文件名必须为英文名</font>
            </td>
        </tr>
        <tr bgcolor=#eaeaea>
            <td align=center><font size=2 color=#000000 face='Verdana, Arial, Helvetica,sans-serif'>文档说明</font>
            </td>
            <td align=center><font size=2 color=#000000 face='Verdana, Arial, Helvetica, sans-serif'><input type=text
                                                                                                            name=cc_dis
                                                                                                            maxlength=128>
                必填</font>
            </td>
        ...
        <tr bgcolor=#eaeaea>
            ...
            <td align=center><font size=2 color=#000000 face='Verdana, Arial, Helvetica, sans-serif'><input type=text
                                                                                                            name=cc_data
                                                                                                            maxlength=8></font>(YYYY-MM)
            </td>
        </tr>
        <tr bgcolor=#eaeaea>
            <td align=center><font size=2 color=#000000 face='Verdana, Arial, Helvetica,sans-serif'>所属城市</font>
            </td>
            <td align=center><font size=2 color=#000000 face='Verdana, Arial, Helvetica, sans-serif'><select
                    name=fi_city>
                <%
