...
<c:if test="${findForward != null && findForward == 'list'}">
	<jsp:include page="/WEB-INF/pages/wfworksheet/${module}/listsendUndoJS.jsp"/>
</c:if>
<%} %>
...
<bean:define id="url" value="localCommonTask.do"/>
	<display:table name="taskList" cellspacing="0" cellpadding="0"
		...
		export="true" requestURI="localCommonTask.do"
		sort="external" size="total" partialList="true"
		decorator="com.boco.eoms.sheet.localCommonTask.webapp.action.ProcessListCommonDisplaytagDecoratorHelper">
