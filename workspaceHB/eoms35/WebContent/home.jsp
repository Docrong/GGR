...
<head>
    ...
    <style type="text/css">
        td.left {
            width: 207px;
            background: transparent url(${app}/images/home-shadow.gif) repeat-y scroll 100% 0;
        }
        ...
        div.footer {
            ...
            height: 40px;
            clear: both;
            background: transparent url(${app}/images/home-footbg.gif) repeat-x;
        ...
        div.tools {
            margin-top: 10px;
            background: url(${app}/images/portal-tools.gif) no-repeat;
        }

        div.forum {
            background: url(${app}/images/home-forum.gif) no-repeat;
        }

        div.links {
            background: url(${app}/images/home-links.gif) no-repeat;
        }

        div.myfocus {
            margin-top: 10px;
            background: url(${app}/images/home-myfocus.gif) no-repeat;
        }

        div.msg {
            background: url(${app}/images/home-msg.gif) no-repeat;
        }
        ...
        div.line {
            height: 5px;
            background: url(${app}/images/home-line.gif) repeat-x;
        }
        ...
        td.middle td.dot {
            width: 20px;
            background: url(${app}/images/home-dot.gif) no-repeat;
        }
    </style>
</head>
<body>
