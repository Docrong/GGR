   ...
   --%>
    ...
    <logic:equal value="101100109" property="businesstype1" name="sheetMain">
        <tr>
            ...
            <input type="hidden" name="${sheetPageName}apnID" id="${sheetPageName}apnID"
                   value="${sheetMain.radiusValidateIPAdd}"/>
        ...
        <tr>
            ...
            <td colspan='3'><input type="text" class="text" name="${sheetPageName}rejectReason"
                                   id="${sheetPageName}rejectReason" value="${sheetLink.rejectReason}"
                                   alt="allowBlank:true,maxLength:1000,vtext:'${eoms:a2u('请输入装机地址，最大长度为500个汉字！')}'"/>
            </td>
        </tr>
        <tr>
            <td class="label">${eoms:a2u('施工人员姓名/工号')}</td>
            <td>
                <input type="text" class="text" name="${sheetPageName}auditResult" id="${sheetPageName}auditResult"
                       value="${sheetLink.auditResult}"
        ...
        <tr>
            ...
            <td colspan='3'>
                <input type="text" class="text" name="${sheetPageName}loginUserPassWord"
        ...
        <tr>
            ...
            <td>
                <eoms:comboBox name="${sheetPageName}clientPgmCapacity" id="${sheetPageName}clientPgmCapacity"
                               defaultValue="${sheetLink.clientPgmCapacity}"
        ...
        <tr>
            ...
            <td colspan='3'>
				<textarea class="textarea max" name="${sheetPageName}remark" id="${sheetPageName}remark"
                          alt="allowBlank:true,width:500,maxLength:2000,vtext:'${eoms:a2u('请最多输入1000字')}'"
                          alt="width:'500px'">${sheetLink.remark}</textarea>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <input type="text" class="text" name="${sheetPageName}testReport" id="${sheetPageName}testReport"
                       value="${sheetLink.testReport}"
                       alt="allowBlank:true,maxLength:20,vtext:'${eoms:a2u('请输入满意度，最大长度为10个汉字！')}'"/>
            </td>
            <td class="label">${eoms:a2u('客户意见')}</td><!-- dealResult -->
            <td>
                <input type="text" class="text" name="${sheetPageName}transferReason"
                       id="${sheetPageName}transferReason" value="${sheetLink.transferReason}"
    ...
    <logic:equal value="101100102" property="businesstype1" name="sheetMain">
        <tr>
            ...
            <td class="label"><bean:message bundle="businessdredgebroad"
                                            key="businessdredgebroad.loginUserPassWord"/>*
            </td>
        ...
        <tr>
            ...
            <td class="content">
                <input type="text" class="text" name="${sheetPageName}tempBusinessCode"
                       id="${sheetPageName}tempBusinessCode" value=""/>
            </td>
            <td class="label">${eoms:a2u('MAS ID')}</td>
            <td class="content">
                <input type="text" class="text" name="${sheetPageName}tempMasId" id="${sheetPageName}tempMasId"
                       value=""/>
            </td>
        </tr>
        <tr>
            ...
            <td class="content" colspan='3'>
                <input type="text" class="text" name="${sheetPageName}tempPassword" id="${sheetPageName}tempPassword"
                       value=""/>
            </td>
        </tr>
        <!-- end by yangna -->
    ...
    <logic:equal value="101100104" property="businesstype1" name="sheetMain">
        <tr>
            <td class="label"><bean:message bundle="businessdredgebroad" key="businessdredgebroad.expectFinishdays"/>*
            </td>
        ...
        <tr>
            <td class="label"><bean:message bundle="businessdredgebroad" key="businessdredgebroad.netResCapacity"/>*
            </td>
            ...
            <td class="label"><bean:message bundle="businessdredgebroad"
                                            key="businessdredgebroad.clientPgmCapacity"/>*
            </td>
    ...
    <logic:equal value="101100102" property="businesstype1" name="sheetMain">
        <tr>
            <td class="label"><bean:message bundle="businessdredgebroad" key="businessdredgebroad.SIEnterpriseCode"/>*
            </td>
            <td class="content"><input type="text" class="text" name="${sheetPageName}siEnterpriseCode"
                                       id="${sheetPageName}siEnterpriseCode" value="${sheetMain.siEnterpriseCode}"
                                       alt="allowBlank:false,maxLength:200,vtext:'${eoms:a2u('请输入EC/SI企业代码，最大长度为100个汉字！')}'"/>
            </td>
            <td class="label"><bean:message bundle="businessdredgebroad" key="businessdredgebroad.SIServerCode"/>*</td>
            <td class="content"><input type="text" class="text" name="${sheetPageName}siServerCode"
                                       id="${sheetPageName}siServerCode" value="${sheetMain.siServerCode}"
                                       alt="allowBlank:false,maxLength:200,vtext:'${eoms:a2u('请输入EC/SI名称，最大长度为100个汉字！')}'"/>
            </td>
        </tr>
        <tr>
            <td class="label">${eoms:a2u('厂商编码')}*</td>
            <td class="content"><input type="text" class="text" name="${sheetPageName}mainFactoryCode"
                                       id="${sheetPageName}mainFactoryCode" value="${sheetMain.mainFactoryCode}"
                                       alt="allowBlank:false,maxLength:100,vtext:'${eoms:a2u('请输入厂商编码，最大长度为100个字符！')}'"/>
            </td>
            <td class="label">${eoms:a2u('业务类型')}*</td>
            <td class="content">
                <eoms:comboBox name="${sheetPageName}mainBusinessType" id="${sheetPageName}mainBusinessType"
                               initDicId="1011053" alt="allowBlank:false" defaultValue="${sheetMain.mainBusinessType}"
    ...
    <logic:equal value="101100103" property="businesstype1" name="sheetMain">
        <tr>
            <td class="label"><bean:message bundle="businessdredgebroad" key="businessdredgebroad.enterpriseCode"/>*
            </td>
            <td class="content"><input type="text" class="text" name="${sheetPageName}enterpriseCode"
            ...
            <td class="content"><input type="text" class="text" name="${sheetPageName}serverCode"
                                       id="${sheetPageName}serverCode" value="${sheetMain.serverCode}"
                                       alt="allowBlank:false,maxLength:200,vtext:'${eoms:a2u('请输入服务代码，最大长度为100个汉字！')}'"/>
            </td>
        </tr>
        <tr>
            <td class="label">${eoms:a2u('厂商编码')}*</td>
...
<fieldset>
    <legend>
        <bean:message bundle="businessdredgebroad" key="businessdredgebroad.toOrgName"/>
        <span id="roleName">:<bean:message bundle="businessdredgebroad"
                                           key="businessdredgebroad.TaskCompleteAudit"/> </span>
    </legend>
    <eoms:chooser id="test"
