...
<div id="sheetform">
<html:form action="/bureaudataUpdate.do?method=performBatchDeal" styleId="theform">
  ...
  <div id="sheetinfo">
	...
	<table class="formTable"> 
	  <caption></caption>
	               ...
	               <tr>
		           		<td class="label"><bean:message bundle="bureaudataUpdate" key="bureaudataUpdate.mainNetSort1"/></td>
		            	<td class="content">  
		            		<eoms:id2nameDB id="${sheetMain.mainNetSort1}" beanId="ItawSystemDictTypeDao"/>
			        	</td>	   
		            	<td class="label"><bean:message bundle="bureaudataUpdate" key="bureaudataUpdate.mainNetSort2"/></td>
		                <td class="content">  
	                ...
	                <tr>
		                <td class="label"><bean:message bundle="bureaudataUpdate" key="bureaudataUpdate.mainNetSort3"/></td>
		                <td class="content">  
		                	<eoms:id2nameDB id="${sheetMain.mainNetSort3}" beanId="ItawSystemDictTypeDao"/>
			        	</td>	 
		                <td  class="label"><bean:message bundle="bureaudataUpdate" key="bureaudataUpdate.mainTaskType"/></td>
		                <td class="content">  
			      ...
			      <tr>
		            <td class="label"><bean:message bundle="bureaudataUpdate" key="bureaudataUpdate.mainTaskDescription"/></td>
				...
				<tr>
				    ...
				    <eoms:attachment name="sheetMain" property="sheetAccessories" 
				            scope="request" idField="sheetAccessories" appCode="bureaudataUpdate" 
				             viewFlag="Y"/> 
				    </td>
				</tr>
	</table>
	               ...
	               <tr>
		            	...
		            	<td class="content">  
		            		<select id="dealSelector" onchange="checkValue(this)" alt="allowBlank:false,vtext:'请选择处理操作'">
		            			 <option value=""></option>
		            			 <option value="Receive"><bean:message bundle="bureaudataUpdate" key="bureaudataUpdate.dealrejectpass"/></option>
			 					 <option value="ExcuteHumTask"><bean:message bundle="bureaudataUpdate" key="bureaudataUpdate.nopassback"/></option>
			 				</select> 
			        	</td>	   
		            	<td class="label"></td>
		                <td class="content">
		                	 ...
		                	 <input type="hidden" name="beanId" value="iBureaudataUpdateMainManager"/> 
					         <input type="hidden" name="mainClassName" value="com.boco.eoms.sheet.bureaudataUpdate.model.BureaudataUpdateMain"/>	
					         <input type="hidden" name="linkClassName" value="com.boco.eoms.sheet.bureaudataUpdate.model.BureaudataUpdateLink"/>
					         <input type="hidden" name="methodBeanId"  id="methodBeanId" value="${methodBeanId}"/>
					         <input type="hidden" name="piid" value="${piid}"/>  
			        	</td>			        	             
		           </tr>
	               <tr>
			            <td  class="label"><bean:message bundle="bureaudataUpdate" key="bureaudataUpdate.advice"/>*</td>
			              <td colspan="3"> 	
