        ...
        <logic:iterate id="baselink" name="HISTORY" type="com.boco.eoms.sheet.circuitcontrol.model.CircuitControlLink">
            ...
            <div class="history-item">&nbsp;
                ...
                <div class="history-item-title">
                    ...
                    <eoms:dict key="dict-sheet-circuitcontrol" dictId="activeTemplateId"
                    ...
                    <eoms:dict key="dict-sheet-circuitcontrol" dictId="mainOperateType" itemId="${baselink.operateType}"
