...
<fmt:bundle basename="com/boco/eoms/km/config/applicationResource-kmmanager">
    ...
    <display:table name="kmOperateScoreList" cellspacing="0" cellpadding="0"
        ...
        <display:column property="operateName" sortable="true"
                        headerClass="sortable" titleKey="kmOperateScore.operateName"
                        href="${app}/kmOperateScore/kmOperateScores.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="score" sortable="true"
                        headerClass="sortable" titleKey="kmOperateScore.score"
                        href="${app}/kmOperateScore/kmOperateScores.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="operateId" sortable="true"
                        headerClass="sortable" titleKey="kmOperateScore.operateId"
                        href="${app}/kmOperateScore/kmOperateScores.do?method=edit" paramId="id" paramProperty="id"/>
