...
<table width="100%" cellspacing="1" border="0" cellpadding="1" class="formTable">
    ...
    <tr class="tr_show">
        ...
        <td align="center"><html:link href="view.do" paramId="id" paramName="tawRmGuestform" paramProperty="id"><img
                src="<%=request.getContextPath()%>/images/bottom/an_xs.gif" border="0"></html:link>
        </td>
    </tr>
