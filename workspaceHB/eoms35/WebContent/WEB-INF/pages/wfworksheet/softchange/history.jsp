            ...
            <logic:iterate id="baselink" name="HISTORY" type="com.boco.eoms.sheet.softchange.model.SoftChangeLink">
                ...
                <div class="history-item"><!-- add space to hack ie-->&nbsp;
                    <div class="history-item-title">
                        ...
                        <%} %>
                        <%=jNum%>.
                        <bean:write name="baselink" property="operateTime" formatKey="date.formatDateTimeAll"
                                    bundle="sheet" scope="page"/>&nbsp;
                        <eoms:id2nameDB id="${baselink.operateUserId}" beanId="tawSystemUserDao"/>
                        <bean:message bundle="sheet" key="task.operateName"/>:
                        <eoms:dict key="dict-sheet-softchange" dictId="activeTemplateId"
                                   itemId="${baselink.activeTemplateId}" beanId="id2descriptionXML"/>
                        <bean:message bundle="softchange" key="softchange.operateType"/>:
                        <eoms:dict key="dict-sheet-softchange" dictId="mainOperateType" itemId="${baselink.operateType}"
                    ...
                    <div class="history-item-content hide">
                        ...
                        <table class="history-item-table" width="100%" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td class="column-content">
                                    <eoms:dict key="dict-sheet-softchange" dictId="mainOperateType"
                            ...
                            <tr>
                                ...
                                <td class="column-content">
                                    <bean:write name="baselink" property="nodeCompleteLimit"
                            ...
                            <tr>
                                <td class="label"><bean:message bundle="softchange"
                                                                key="softchange.linkCompleteLimitTime"/></td>
                                <td class="column-content">
                                    <bean:write name="baselink" property="linkCompleteLimitTime"
                                                format="yyyy-MM-dd HH:mm:ss" scope="page"/>
                                </td>
                                <td class="label"><bean:message bundle="softchange"
                                                                key="softchange.linkDesignKey"/></td>
                                <td class="column-content">
                            ...
                            <tr>
                                <td class="label"><bean:message bundle="softchange"
                                                                key="softchange.linkDesignComment"/></td>
                                <td class="column-content" colspan="3">
                            ...
                            <tr>
                                <td class="label"><bean:message bundle="softchange"
                                                                key="softchange.linkInvolvedProvince"/></td>
                                <td class="column-content">
                                    <pre><bean:write name="baselink" property="linkInvolvedProvince"
                                                     scope="page"/></pre>
                                </td>
                                <td class="label"><bean:message bundle="softchange"
                                                                key="softchange.linkInvolvedCity"/></td>
                                <td class="column-content">
                            ...
                            <tr>
                                <td class="label"><bean:message bundle="softchange"
                                                                key="softchange.linkRiskEstimate"/></td>
                                <td class="column-content" colspan="3">
                            ...
                            <tr>
                                <td class="label"><bean:message bundle="softchange"
                                                                key="softchange.linkEffectAnalyse"/></td>
                                <td class="column-content" colspan="3">
                            ...
                            <tr>
                                <td class="label"><bean:message bundle="softchange"
                                                                key="softchange.linkCheckComment"/></td>
                                <td class="column-content" colspan=3>
                            ...
                            <tr>
                                <td class="label"><bean:message bundle="softchange"
                                                                key="softchange.linkPermitResult"/></td>
                                <td class="column-content" colspan=3>
                            ...
                            <tr>
                                <td class="label"><bean:message bundle="softchange"
                                                                key="softchange.linkPermitIdea"/></td>
                                <td class="column-content" colspan=3>
                            ...
                            <tr>
                                <td class="label"><bean:message bundle="softchange"
                                                                key="softchange.linkPlanStartTime"/></td>
                                <td class="column-content">
                                    <bean:write name="baselink" property="linkPlanStartTime"
                                                format="yyyy-MM-dd HH:mm:ss" scope="page"/>
                                </td>
                                <td class="label"><bean:message bundle="softchange"
                                                                key="softchange.linkPlanEndTime"/></td>
                                <td class="column-content">
                                    <bean:write name="baselink" property="linkPlanEndTime" format="yyyy-MM-dd HH:mm:ss"
                                                scope="page"/>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td class="label"><bean:message bundle="softchange"
                                                                key="softchange.linkIsEffectBusiness"/></td>
                                <td class="column-content" colspan=3>
                                    <eoms:id2nameDB id="${baselink.linkIsEffectBusiness}"
                                                    beanId="ItawSystemDictTypeDao"/>
                                </td>
                            </tr>
                            <tr>
                                <td class="label"><bean:message bundle="softchange"
                                                                key="softchange.linkEffectCondition"/></td>
                                <td class="column-content" colspan=3>
                            ...
                            <tr>
                                <td class="label"><bean:message bundle="softchange"
                                                                key="softchange.linkNetManage"/></td>
                                <td class="column-content" colspan=3>
                            ...
                            <tr>
                                <td class="label"><bean:message bundle="softchange"
                                                                key="softchange.linkCutResult"/></td>
                                <td class="column-content">
                            ...
                            <tr>
                                <td class="label"><bean:message bundle="softchange"
                                                                key="softchange.linkCutComment"/></td>
                                <td class="column-content" colspan="3">
                            ...
                            <tr>
                                <td class="label"><bean:message bundle="softchange"
                                                                key="softchange.linkBusinessComment"/></td>
                                <td class="column-content" colspan="3">
                            ...
                            <tr>
                                <td class="label"><bean:message bundle="softchange"
                                                                key="softchange.linkAlertRecord"/></td>
                                <td class="column-content" colspan="3">
                            ...
                            <tr>
                                <td class="label"><bean:message bundle="softchange"
                                                                key="softchange.linkUnnormalComment"/></td>
                                <td class="column-content" colspan="3">
                            ...
                            <tr>
                                <td class="label"><bean:message bundle="softchange"
                                                                key="softchange.linkCutAnalyse"/></td>
                                <td class="column-content" colspan=3>
                            ...
                            <tr>
                                <td class="label"><bean:message bundle="softchange"
                                                                key="softchange.linkWorkUpdateAdvice"/></td>
                                <td class="column-content" colspan=3>
                                    <pre><bean:write name="baselink" property="linkWorkUpdateAdvice"
                                                     scope="page"/></pre>
                                </td>
                            </tr>
                            <tr>
                                <td class="label"><bean:message bundle="softchange"
                                                                key="softchange.linkSoftVersionUpdate"/></td>
                                <td class="column-content" colspan=3>
                                    <pre><bean:write name="baselink" property="linkSoftVersionUpdate"
                                                     scope="page"/></pre>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td class="label"><bean:message bundle="softchange"
                                                                key="softchange.linkProjectComment"/></td>
                                <td class="column-content" colspan=3>
                            ...
                            <tr>
                                ...
                                <td colspan='3'>
                                    <eoms:id2nameDB id="${sheetMain.mainIfDemonstrateCase}"
                                                    beanId="ItawSystemDictTypeDao"/>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td colspan='3'>
                                    <pre><bean:write name="sheetMain" property="mainCaseKeywords"
                                                     scope="request"/></pre>
                                </td>
                            </tr>
                            <%} %>
