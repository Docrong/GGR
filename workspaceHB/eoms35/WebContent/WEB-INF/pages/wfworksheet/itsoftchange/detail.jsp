...
<%@page import="com.boco.eoms.sheet.itsoftchange.model.ITSoftChangeTask" %>
...
ITSoftChangeTask task = new ITSoftChangeTask();
String operaterType = "";
String ifsub = "";
String ifwaitfor="";
if(request.getAttribute("task")!=null){
 task = (ITSoftChangeTask)request.getAttribute("task");
...
Ext.onReady(function() {
	var tabConfig = {
		items : [{
			...
			url : 'itsoftchange.do?method=showSheetDealList&sheetKey=${sheetMain.id}&taskName=${taskName}&ifWaitForSubTask=${task.ifWaitForSubTask}'
		}, {
			...
			//url : 'itsoftchange.do?method=showWorkFlow&sheetKey=${sheetMain.id}',
			  url : 'itsoftchange.do?method=showWorkFlow&linkServiceName=iITSoftChangeLinkManager&dictSheetName=dict-sheet-itsoftchange&description=mainOperateType&sheetKey=${sheetMain.id}',
			isIframe : true
		},{
			text : '<bean:message bundle="sheet" key="sheet.filesView"/>',
			url : 'itsoftchange.do?method=showSheetAccessoriesList&id=${sheetMain.id}',
			isIframe : true
		}, {
	...
	var url2="itsoftchange.do?method=newShowCCPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}&operateType=-10&taskStatus=${taskStatus}";
	eoms.util.appendPage("sheet-deal-content",url2);	
	<%}%>
	<%if(taskName.equals("reply")){ %>
	var url2="itsoftchange.do?method=showRemarkPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}";
	eoms.util.appendPage("sheet-deal-content",url2);	
	<%}%>
...
function forceOperation(obj){
	...
	if(obj == 1){
	    // window.location.href='itsoftchange.do?method=showForceHoldPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}&operateType=forceHold';
	   var url2="itsoftchange.do?method=showForceHoldPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}&operateType=forceHold";
	   eoms.util.appendPage("sheet-deal-content",url2);	  
	}else if(obj == 2){
	    // window.location.href='itsoftchange.do?method=showForceHoldPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}&operateType=nullity';
	   var url2="itsoftchange.do?method=showForceHoldPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}&operateType=nullity";
	   eoms.util.appendPage("sheet-deal-content",url2);	 
	}else{
	   //  window.location.href='itsoftchange.do?method=showForceHoldPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}&operateType=forceNullity';
        var url2="itsoftchange.do?method=showForceHoldPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}&operateType=forceNullity";
	    eoms.util.appendPage("sheet-deal-content",url2);
    }
   }
    function eventOperation(obj){
	if(obj == 1){
	     var url2="itsoftchange.do?method=showPhaseAdvicePage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&taskName=advice&operateFlag=driveForward&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}";
			  ...
			  <td class="content">
			    <bean:write  name="sheetMain"  property="sheetCompleteLimit" formatKey="date.formatDateTimeAll" bundle="sheet" scope="request"/>  
			      ...
			      <tr>
		            ...
		            <td  class="content"> <bean:write  name="sheetMain"  property="mainITRequirementID"  scope="request"/></td>
		             <td  class="label"><bean:message bundle="itsoftchange" key="itsoftchange.mainIsReferCost"/></td>
		                <td class="content">  
				       <eoms:id2nameDB id="${sheetMain.mainIsReferCost}" beanId="ItawSystemDictTypeDao"/> 
			        </td>	                
		          </tr>	
	               <tr>
			      ...
			      <tr>
		            <td  class="label"><bean:message bundle="itsoftchange" key="itsoftchange.mainApplyer"/></td>
    				  ...
    				  <pre><eoms:id2nameDB id="${sheetMain.mainApplyer}" beanId="tawSystemUserDao"/></pre>
                    </td>
		          </tr>		            
			      ...
			      <tr>
		            <td  class="label"><bean:message bundle="itsoftchange" key="itsoftchange.mainChangeDesc"/></td>
		              <td class="content" colspan="3"> 	
    				  <pre><bean:write  name="sheetMain"  property="mainChangeDesc"  scope="request"/></pre>
                    </td>
		          </tr>	
	              <tr>
  						<td class="label"><bean:message bundle="itsoftchange" key="itsoftchange.mainChangeDetail"/></td>
		   				 <td  class="content" colspan='3'>
		   				 <eoms:attachment name="sheetMain" property="mainChangeDetail" idList=""
            			  scope="request" idField="${sheetPageName}mainChangeDetail" appCode="itsoftchangesheet" viewFlag="Y"/> 
		                </td>
		            </tr>	          		            
...
<c:url var="urlShowOperateTaskDealPage" value="itsoftchange.do">
...
<c:url var="urlShowTestTaskDealPage" value="itsoftchange.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<c:url var="urlShowOnlineTaskDealPage" value="itsoftchange.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 草稿派发 -->
<c:url var="urlShowDraftDeal" value="itsoftchange.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 重新派发 -->
<c:url var="urlShowBackDeal" value="itsoftchange.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 归档 -->
<c:url var="urlShowHoldDealPage" value="itsoftchange.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 退回 -->
<c:url var="urlShowRejectBackDealPage" value="itsoftchange.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 转派 -->
<c:url var="urlShowTransferkPage" value="itsoftchange.do">
...
<!-- 转审 -->
<c:url var="urlShowTransferAuditPage" value="itsoftchange.do">
  <c:param name="method" value="showTransferWorkItemPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 阶段回复 -->
<c:url var="urlShowPhaseReplyPage" value="itsoftchange.do">
...
<!-- 驳回 -->
<c:url var="urlShowRejectBackPage" value="itsoftchange.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 确认受理 -->
<c:url var="urlShowAcceptDealPage" value="itsoftchange.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 分派 -->
<c:url var="urlShowInputSplit" value="itsoftchange.do">
...
<!-- 会审 -->
<c:url var="urlShowInputSplitAudit" value="itsoftchange.do">
  <c:param name="method" value="showInputSplit"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 分派回复 -->
<c:url var="urlShowDispatchPage" value="itsoftchange.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 会审回复 -->
<c:url var="urlShowDispatchAuditPage" value="itsoftchange.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 处理回复通过 -->
<c:url var="urlShowDealReplyAcceptPage" value="itsoftchange.do">
...
<!-- 处理回复不通过 -->
<c:url var="urlShowDealReplyRejectPage" value="itsoftchange.do">
...
<div class="sheet-deal">
	...
	<%if(taskName.equals("OperateTask")){ %>
		<select id="dealSelector">
		 ...
		 <%if(ifwaitfor.equals("false")) {%>	
		  <option value="${urlShowOperateTaskDealPage}"><bean:message bundle="itsoftchange" key="operateType.completeDev"/></option>	  
	...
	<%}else if(taskName.equals("TestTask")){%>	
		<select id="dealSelector">
		 ...
		 <%if(ifsub.equals("") || ifsub.equals("false")){%>
		 <%if(ifwaitfor.equals("false")) {%>	
		  <option value="${urlShowTestTaskDealPage}"><bean:message bundle="itsoftchange" key="operateType.completeTest"/></option>	  
		  <option value="${urlShowTransferkPage}"><bean:message bundle="sheet" key="common.transfer"/></option>	
		  <option value="${urlShowPhaseReplyPage}"><bean:message bundle="sheet" key="event.reply"/></option>
		  <%}%>
		  <%}else{%> 
		...
		<%}else if(taskName.equals("OnlineTask")){%>	
		<select id="dealSelector">
		<%if(taskStatus.equals(Constants.TASK_STATUS_READY)){%>
		   <option value="${urlShowAcceptDealPage}"><bean:message bundle="sheet" key="common.accept"/> </option>
		   <option value="${urlShowRejectBackPage}"><bean:message bundle="sheet" key="common.rejectBack"/></option>
		 ...
		 <%if(ifsub.equals("") || ifsub.equals("false")){%>
		 <%if(ifwaitfor.equals("false")) {%>
		  <option value="${urlShowOnlineTaskDealPage}"><bean:message bundle="itsoftchange" key="operateType.completeOnline"/></option>		  
		  <option value="${urlShowTransferkPage}"><bean:message bundle="sheet" key="common.transfer"/></option>
		  <option value="${urlShowPhaseReplyPage}"><bean:message bundle="sheet" key="event.reply"/></option>
		  <%}%>
		  <%}else{%> 
	...
	<%}else if(taskName.equals("DraftTask")){%>	
		<select id="dealSelector">
		  <option value="${urlShowDraftDeal}"><bean:message bundle="itsoftchange" key="operateType.draft"/></option>
		</select>
   ...
   <%}else if(taskName.equals("HoldTask")){ %>
		<select id="dealSelector">
		  <option value="${urlShowHoldDealPage}"><bean:message bundle="itsoftchange" key="operateType.hold"/></option>
		  <option value="${urlShowRejectBackDealPage}"><bean:message bundle="itsoftchange" key="operateType.back"/></option>
		</select>					
	<%}%>			
...
<script type="text/javascript">
	...
	try{
        ...
        if (dealTemplateId != null && dealTemplateId != "") {
   			url = "itsoftchange.do?method=referenceTemplate&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&taskName=${taskName}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&operateType=${operateType}&taskStatus=${taskStatus}&dealTemplateId="+dealTemplateId
        }
