...
function showPage(){
     var pars = '';
     var url = '';    
      url = '${app}/sheet/algorithm/algorithm.do?method=showInputRejectPage&piid=${sheetMain.piid}&taskId=${taskId}&taskName=${taskName}';
     if (url!=''){
...
<div id="sheetform">
<html:form action="/algorithm.do?method=performDeal" styleId="theform">
