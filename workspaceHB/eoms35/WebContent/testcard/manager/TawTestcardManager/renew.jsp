...
<html:form method="post" action="/TawTestcardManager/renewupdate">
    <div align="center">
        <table border="0" width="70%" cellspacing="1" class="formTable">
            <tr>
                <td colspan="4" valign="middle" bgcolor="#E5EDF8" align="center">${eoms:a2u("测 试 卡 续 借")}</td>
            </tr>
            <logic:present name="tawTestcardManagerForm" scope="request">
                ...
                <tr>
                    ...
                    <td colspan="3" nowrap>
                        <html:text size="70" property="reason" name="tawTestcardManagerForm"
                                   styleClass="clstext"></html:text>&nbsp
                        <INPUT TYPE="hidden" name="idlist" id="idlist" value="<%=idlist%>">
                    </td>
                </tr>
            </logic:present>
            <tr>
                <td colspan=4 nowrap bgcolor="#E5EDF8" align="center"><html:submit
                        styleClass="clsbtn2">${eoms:a2u("保存")}</html:submit></td>
            </tr>
        </table>
    </div>
</html:form>
