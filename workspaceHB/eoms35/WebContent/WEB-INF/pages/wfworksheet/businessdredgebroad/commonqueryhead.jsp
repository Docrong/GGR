...
<script type="text/javascript">
    Ext.onReady(function () {
        eoms.form.disableArea("ProcessingObjects", true);
    })

    function changeOperate2(operatetype) {
        if (operatetype == 205) {
            eoms.form.enableArea('ProcessingObjects');
            document.getElementById('showDealRole').style.display = 'none';
            document.getElementById('showDealDpt').style.display = 'none';
            document.getElementById('showDealUser').style.display = 'none';
            //eoms.form.disableArea('showDealRolel',true);
            //eoms.form.disableArea('showDealDpt',true);
            //eoms.form.disableArea('showDealUser',true);
        } else {
            eoms.form.disableArea('ProcessingObjects', true);
        }
    }
...
<table class="formTable">
    ...
    <!-- 是否归档 -->
    <tr>
        <td class="label">是否已经回复</td>
        <td>
            <select name="operatetype" id="operatetype" onchange="changeOperate2(this.value);">
                <option value=""></option>
                <option value="205">已回复</option>
            </select>
        </td>
    </tr>
