...
<html:form action="/localCommonTask.do?method=batchPerformDeal" styleId="theform">
<%@ include file="/WEB-INF/pages/wfworksheet/localCommonTask/baseinputlinkhtmlnew.jsp"%>
     ...
     <input type="hidden" name="${sheetPageName}processTemplateName" id="${sheetPageName}processTemplateName" value="LocalCommonTaskMainFlowProcess" />
