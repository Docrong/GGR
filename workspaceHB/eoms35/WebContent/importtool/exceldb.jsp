...
<%@ page
        import="com.boco.RW_Excel.Checkin.CheckIn_Informix,com.boco.RW_Excel.DBInfo.DB_Informix_Info,com.boco.RW_Excel.XMLToDB.ValueInsDB,com.boco.RW_Excel.DBAccess.DBAccess" %>
...
<table border="0" width="95%" cellspacing="1" bgcolor="#709ED5"
    ...
    <tr bgcolor="#E5EDF8">
        ...
        <td height="27">
            <div align="center"><font color="#FF0000">EXCEL �������ڵ������Ժ�</font><font
