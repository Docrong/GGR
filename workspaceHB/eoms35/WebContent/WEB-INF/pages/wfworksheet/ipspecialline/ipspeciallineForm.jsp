...
<caption><div class="header center">IP数据专线</div></caption>
...
<table class="formTable">
    ...
    <tr>
      ...
      <td colspan="3">
        ...
        <eoms:comboBox name="portAInterfaceType" id="portAInterfaceType" defaultValue="${ipspeciallineForm.portAInterfaceType}" initDicId="1011015" 
	...
	<tr>
      ...
      <td class="content">
        ...
        <html:text property="businessAmount" styleId="businessAmount"  styleClass="text medium" alt="allowBlank:false"/>
      </td>
    </tr>
    <tr>
      ...
      <td class="content">
        ...
        <html:text property="ipServerNeedNum" styleId="ipServerNeedNum"  styleClass="text medium" alt="allowBlank:false"/>
      </td>
   ...
   <tr>
      ...
      <td  colspan="3">
	  		<textarea name="businessRequireDesc" id="businessRequireDesc" class="textarea max" alt="allowBlank:false">${ipspeciallineForm.businessRequireDesc}</textarea>			   
	  </td>
   </tr>
   <tr>
    <td class="label">用户个性化设备需求</td>
     ...
     <td class="content">
	  	<html:errors property="userIsUserNet"/>
	  	          <eoms:comboBox name="userIsUserNet" id="userIsUserNet" defaultValue="${ipspeciallineForm.userIsUserNet}" initDicId="1012310" 
		  	       alt="allowBlank:true" styleClass="select-class" />
     </td>
  </tr>
   ...
   <tr>
      ...
      <td  colspan="3">
	  		<textarea name="requirmentArea" id="requirmentArea" class="textarea max" alt="allowBlank:true">${ipspeciallineForm.requirmentArea}</textarea>			   
	  </td>
   </tr>
  </tbody>
  </table>
    ...
    <tr>
      ...
      <td class="content">
	  	<html:errors property="portABDeviceType"/>
	  		  	          <eoms:comboBox name="portABDeviceType" id="portABDeviceType" defaultValue="${ipspeciallineForm.portABDeviceType}" initDicId="1012304" 
		  	       alt="allowBlank:true" styleClass="select-class" />
       </td>
      <td class="label">建设方式</td>
      <td class="content">
	  	<html:errors property="buildMethodA"/>
           <eoms:comboBox name="buildMethodA" id="buildMethodA" defaultValue="${ipspeciallineForm.buildMethodA}" initDicId="1012317" 
	...
	<tr>
      ...
      <td class="content">
	  	<html:errors property="userIsHaveDivA"/>
	  	 <eoms:comboBox name="userIsHaveDivA" id="userIsHaveDivA" defaultValue="${ipspeciallineForm.userIsHaveDivA}" initDicId="1012310" 
		  	       alt="allowBlank:false" styleClass="select-class"/>
	  </td>
	  <td class="label">是否需要移动采购</td>
      <td class="content">
      	<html:errors property="isNeedBuyA"/>
          <eoms:comboBox name="isNeedBuyA" id="isNeedBuyA" defaultValue="${ipspeciallineForm.isNeedBuyA}" initDicId="1012310" 
	...
	<tr>
		  ...
		  <td colspan="3">						  	
		  	<a  style="cursor:hand;color:darkbule" onclick="javascript:popupIrmsPreSurvey('${ipspeciallineForm.portADetailAdd}')">点击进行接入点勘察</a>
		  </td>	
	</tr>
	<%} %>
		<tr>
	...
	<tr>
      ...
      <td class="label">A接入点类型</td>
	      ...
	      <eoms:comboBox name="interfacePointTypeA" id="interfacePointTypeA" defaultValue="${ipspeciallineForm.interfacePointTypeA}" initDicId="1012316" 
			  	       alt="allowBlank:true" styleClass="select-class" />
	      </td>	 
	</tr>
	<tr>
	      ...
	      <td colspan="3">
	        ...
	        <textarea name="fiberAroute" id="fiberAroute" class="textarea max" alt="allowBlank:true">${ipspeciallineForm.fiberAroute}</textarea>	
	      </td>
		</tr>
	</tbody>
	...
	<tbody id='transLineInfo' > 
		<tr>
	      ...
	      <td class="content">
		  	<html:errors property="fiberOwnerA"/>
	       	   <eoms:comboBox name="fiberOwnerA" id="fiberOwnerA" defaultValue="${ipspeciallineForm.fiberOwnerA}" initDicId="1012315" 
		  	       alt="allowBlank:false" styleClass="select-class"/>
	     </td>
      </tr>
      <tr>
	      ...
	      <td colspan="3">
	        ...
	        <textarea name="buildTypeA" id="buildTypeA" class="textarea max" alt="allowBlank:true">${ipspeciallineForm.buildTypeA}</textarea>	
	      </td>
      </tr>
      ...
      <tr>
	      ...
	      <td colspan="3">
	        ...
	        <eoms:comboBox name="isOkBetweenUserA" id="isOkBetweenUserA" defaultValue="${ipspeciallineForm.isOkBetweenUserA}" initDicId="1012310" 
	  ...
	  <tbody id='YuanYin' style="display:none"> 
	     ...
	     <td colspan='3'>
	      	<html:errors property="noInputResonA"/>
	       	<textarea name="noInputResonA" id="noInputResonA" class="textarea max" alt="allowBlank:true">${ipspeciallineForm.noInputResonA}</textarea>			   
	     </td>
	     </tbody>
     </tr>
     </tbody>
    ...
    <tr>
    	<td class="label">传输容量是否满足开通</td>
         ...
         <td class="label">是否需要添加板卡</td>
          ...
          <eoms:comboBox name="isNeedAddCardA" id="isNeedAddCardA" defaultValue="${ipspeciallineForm.isNeedAddCardA}" initDicId="1012310" 
	    ...
	    <tr>	      
	      ...
	      <td class="content">
		  	<html:errors property="isGetInterfaceA"/>
		  	 <eoms:comboBox name="isGetInterfaceA" id="isGetInterfaceA" defaultValue="${ipspeciallineForm.isGetInterfaceA}" initDicId="1012310" 
		  	       alt="allowBlank:true" styleClass="select-class" />
	      </td>
		...
		<tr>
	      <td class="label">最后一公里处理意见</td>
	       <td  class="content" colspan="3">
		  		<textarea name="theLastOpinionA" id="theLastOpinionA" class="textarea max" alt="allowBlank:false">${ipspeciallineForm.theLastOpinionA}</textarea>			   
			</td>
		</tr>
		<tr>
   ...
   <table class="formTable">    
    <tr>
      <td class="label">备注</td>
        <td  colspan="3">
	  		<textarea name="remark" id="remark" class="textarea max" alt="allowBlank:true">${ipspeciallineForm.remark}</textarea>			   
		  </td>
   </tr>
 </table>
 <br/>
