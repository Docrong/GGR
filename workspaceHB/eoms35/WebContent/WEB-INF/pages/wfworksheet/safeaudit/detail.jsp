        ...
        <logic:present name="sheetMain" scope="request">
            ...
            <table class="formTable">
                ...
                <tr>
                    ...
                    <td class="content" colspan="3"><bean:write name="sheetMain" property="mainSafeAuditRequest"
                                                                scope="request"/></td>
                </tr>
                <tr>
            ...
            <tr>
                ...
                %>
                    ...
                    <select id="dealSelector">
                        ...
                        <option value="${urlShowMakeDealPage}"><bean:message bundle="safeaudit"
                                                                             key="operateType.EvaluateMaterialHumTask"/></option>
                    ...
                    <select id="dealSelector">
                        ...
                        <%if (ifsub.equals("") || ifsub.equals("false")) {%>
                        <%if (ifwaitfor.equals("false")) {%>
                        <option value="${urlShowAuditDealPage}"><bean:message bundle="safeaudit"
                                                                              key="operateType.EditReportHumTask"/></option>
                        <option value="${urlShowTransferkPage}"><bean:message bundle="sheet"
                                                                              key="common.transfer"/></option>
                        <option value="${urlShowPhaseReplyPage}"><bean:message bundle="sheet"
                                                                               key="event.reply"/></option>
                    ...
                    <select id="dealSelector">
                        ...
                        <%if (ifsub.equals("") || ifsub.equals("false")) {%>
                        <%if (ifwaitfor.equals("false")) {%>
                        <option value="${urlShowPerformDealPage}"><bean:message bundle="safeaudit"
                                                                                key="operateType.ApprovingHumTask"/></option>
                    ...
                    <select id="dealSelector">
                        <option value="${urlShowDraftDeal}"><bean:message bundle="safeaudit"
                                                                          key="operateType.DraftHumTask"/></option>
                    </select>
                    ...
                    <select id="dealSelector">
                        <option value="${urlShowHoldDealPage}"><bean:message bundle="safeaudit"
                                                                             key="operateType.HoldHumTask"/></option>
