            ...
            <logic:notEmpty name="LIST">
                <logic:iterate id="sparepart" name="LIST" type="com.boco.eoms.sparepart.model.EarlyWarning">
                    <tr class="tr_show" align="center">
                        ...
                        <td>
                            <a href="<%=request.getContextPath()%>/sparepart/query/earlywarninglist.do?type=1&id=<%=id%>">
                                <bean:write name="sparepart" property="item1" scope="page"/></a></td>
                        <td>
                            <a href="<%=request.getContextPath()%>/sparepart/query/earlywarninglist.do?type=2&id=<%=id%>">
                                <bean:write name="sparepart" property="item2" scope="page"/></a></td>
                        <td>
                            <a href="<%=request.getContextPath()%>/sparepart/query/earlywarninglist.do?type=5&id=<%=id%>">
                                <bean:write name="sparepart" property="item5" scope="page"/></a></td>
                        <td>
                            <a href="<%=request.getContextPath()%>/sparepart/query/earlywarninglist.do?type=3&id=<%=id%>">
                                <bean:write name="sparepart" property="item3" scope="page"/></a></td>
                        <td>
                            <a href="<%=request.getContextPath()%>/sparepart/query/earlywarninglist.do?type=4&id=<%=id%>">
