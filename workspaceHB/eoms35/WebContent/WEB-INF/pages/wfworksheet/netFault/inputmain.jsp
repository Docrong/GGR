...
<table class="formTable">
    ...
    <tr>
        ...
        <td colspan="3">
            <eoms:comboBox name="${sheetPageName}specialty" id="${sheetPageName}specialty" initDicId="1011501"
                           defaultValue="${sheetMain.specialty}" alt="allowBlank:ture"/>
        </td>
    </tr>
    <tr>
        <td class="label">
    ...
    <fieldset id="link1">
        ...
        <div class="x-form-item">
            <div id="test">
                ...
                <input type="hidden" name="testTotalJSON" id="ext-gen20"
                       value="[{id:'101',nodeType:'dept',categoryId:'dealPerformer'}]">
                <input type="hidden" name="dealPerformer" alt="allowBlank:false,vtext:'请选择派发对象'" id="ext-gen135"
                       value="1223">
                ...
                <input type="hidden" name="dealPerformerJSON" id="ext-gen138"
                       value="[{id:'1223',nodeType:'dept',categoryId:'dealPerformer'}]">
