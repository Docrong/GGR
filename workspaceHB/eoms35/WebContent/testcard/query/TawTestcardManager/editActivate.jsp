...
<%@ page
        import="com.boco.eoms.testcard.controller.TawTestcardForm,com.boco.eoms.commons.system.session.form.TawSystemSessionForm" %>
...
<html:form method="post" action="/TawTestcard/save" onsubmit="return check(this);">
    ...
    <%
        ...
        String lasttesttime = StaticMethod.getLocalString();
    ...
    <html:hidden property="isAlive" value="1"/>
    <SCRIPT LANGUAGE=javascript>
    ...
    <script language="JavaScript">
        ...
        function check() {
            if (document.forms[0].msisdn.value == "") {
                alert("msisdn不得为空")
                return false;
            } else {
                return true;
    ...
    <table border="0" width="95%" cellspacing="1" class="formTable" align="center">
        ...
        <tr>
            <td align="right" width="100%" bgColor="#f5f5f5">
                <div align="center">
                    <table cellSpacing="0" borderColorDark="#ffffff" cellPadding="4" width="100%"
                           borderColorLight="#808080" border="1" align="center">
                        <tr>
                            <td noWrap width="80" class="label"> ${eoms:a2u("卡类型")}</td>
                            <td colspan=3 width="80%" align="left">
                                <input type="radio" id="cardType1" name="cardType" value="1"
                                       onclick="changeCardType(this.value);" <%=temp1%>/> ${eoms:a2u("国际来访卡")}&nbsp;
                                <input type="radio" id="cardType0" name="cardType" value="0"
                                       onclick="changeCardType(this.value);" <%=temp0%>/> ${eoms:a2u("国际出访卡")}&nbsp;
                                <input type="radio" id="cardType2" name="cardType" value="2"
                                       onclick="changeCardType(this.value);" <%=temp2%>/> ${eoms:a2u("省际来访卡")}&nbsp;
                                <input type="radio" id="cardType3" name="cardType" value="3"
                                       onclick="changeCardType(this.value);" <%=temp3%>/> ${eoms:a2u("省际出访卡")}&nbsp;
                                <input type="radio" id="cardType5" name="cardType" value="5"
                                       onclick="changeCardType(this.value);" <%=temp5%>/> ${eoms:a2u("省内来访卡")}&nbsp;
                                <input type="radio" id="cardType6" name="cardType" value="6"
                                       onclick="changeCardType(this.value);" <%=temp6%>/> ${eoms:a2u("省内出访卡")}&nbsp;
                                <input type="radio" id="cardType4" name="cardType" value="4"
                                       onclick="changeCardType(this.value);" <%=temp4%>/> ${eoms:a2u("本地测试卡")}&nbsp;
                            </td>
                        </tr>
                        <tr>
                            <td noWrap width="80" class="label"> ${eoms:a2u("归属地")}</td>
                            <td width="100%" height="25" colspan="3" nowrap="nowrap">
                                    ${eoms:a2u("国家")}<select name="fromCountry" id="s1" style="width: 3cm;"></select>
                                &nbsp&nbsp
                        ...
                        <tr id="visitField">
                            ...
                            <td width="100%" height="25" colspan="3" nowrap="nowrap">
                                ...
                                &nbsp&nbsp
                                    ${eoms:a2u("运营商")}
                                <html:text styleClass="clstext" property="toOpe"/>
                            </td>
                        </tr>
                        <tr id="visitField2">
                            ...
                            <td width="380">
                                <eoms:comboBox name="leave" id="a1" sub="a2" initDicId="10401"
                                               defaultValue="${tawTestcardForm.leave}"/>

                            </td>
                            <td class="clsfth"> ${eoms:a2u("套餐类型")}
                            </td>
                            <td>
                                <html:select property="cardpackage" style="width: 4.0cm;"
                        ...
                        <tr>
                            ...
                            <td width="380"><html:text styleClass="clstext" property="iccid" size="20"/></td>
                        ...
                        <%
                            try {
                                if (!(taw_testcard.getCardpackage() == "双模") && !(taw_testcard.getCardpackage().trim().equals("双模"))) {
                        %>
                        <tr>
            ...
            <td width="380" colspan="3" >
            	<html:text property="oldNo" styleClass="clstext" />
                        ...
                        <tr id="visitField3">
                            ...
                            <td class="clsfth"> ${eoms:a2u("电话号码")}
                            </td>
                            <td>
                                <html:text styleClass="clstext" property="phoneNumber" readonly="true" size="20"/>
                            </td>
                        </tr>
                        <tr>
                            <td width="80" class="label">
