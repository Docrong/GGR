...
<div id="sheetform">
    <html:form action="/groupcheck.do?method=performTransferWorkItem" styleId="theform">
        ...
        <input type="hidden" name="mainClassName" id="mainClassName"
               value="com.boco.eoms.sheet.groupcheck.model.GroupCheckMain"/>
        <input type="hidden" name="linkClassName" id="linkClassName"
               value="com.boco.eoms.sheet.groupcheck.model.GroupCheckLink"/>
        ...
        <div class="form-btns">
            ...
            <input type="submit" class="submit"
                   onclick="v.passing=true;this.form.action='${app}/sheet/groupcheck/groupcheck.do?method=performSaveInfo'"
