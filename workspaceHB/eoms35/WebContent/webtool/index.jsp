...
<table width="100%" height="100%" cellspacing="1" cellpadding="0" id="index_container">
    ...
    <tr>
        <td width="205" height="100%" align="center" id="index_left">
            <iframe id="leftFrame" name="leftFrame" frameborder=0 src="<%=temp1%>" scrolling="no"></iframe>
        </td>
        <td width="100%" height="100%" id="index_right">
            <iframe id="rightFrame" name="rightFrame" frameborder=0 src="<%=temp2%>" scrolling="auto"></iframe>
        </td>
    </tr>
</table>
</body>
