  ...
  <div id="sheetinfo">
	...
	<table class="formTable"> 
      ...
      <tr>
		...
		<td class="content"><eoms:id2nameDB id="${sheetMain.bservType}" beanId="ItawSystemDictTypeDao"/></td>
	  </tr> 
		   <tr>
	...
	<tr>
	  ...
	  <tr>
		...
		<td class="content" colspan="3"><eoms:id2nameDB id="${sheetMain.affectedAreas}" beanId="ItawSystemDictTypeDao"/></td>
	  </tr>	
   ...
   <tr>
	  ...
	  <tr>
		...
		<td class="content"><eoms:id2nameDB id="${sheetMain.connectType}" beanId="ItawSystemDictTypeDao"/></td>
	  </tr>	
		...
		<select id="dealSelector" onchange="javascript:eoms.util.appendPage('sheet-deal-content',this.value,true);">
		 ...
		 <%}else if(taskStatus.equals(Constants.TASK_STATUS_CLAIMED)){ %>
			 	  ...
			 	  <%if(ifsub.equals("") || ifsub.equals("false")){%>
			 		...
			 		<%}else{%>
			 			<option value="${urlShowInputSplit}"><bean:message bundle="sheet" key="common.split"/>	
			 		<%} %>
