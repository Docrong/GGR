...
function showPage(){
     var pars = '';
     var url = '';    
      url = '${app}/sheet/circuitoperation/circuitoperation.do?method=showInputRejectPage&piid=${sheetMain.piid}&taskId=${taskId}&taskName=${taskName}';
     if (url!=''){
...
<div id="sheetform">
<html:form action="/circuitoperation.do?method=performDeal" styleId="theform">
