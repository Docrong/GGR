...
<html:form action="/serviceprepare.do?method=addServiceConfiguration" styleId="theform">
	<table class="formTable" id="table"> 
		  <caption><center>服务详细信息</center></caption>
		  <tr>
	  		<td class="label">服务名称*</td>
			<td class="content"> 			
				<select name="processId" id="processId" onChange="selectFlowId(this.value)" alt="allowBlank:false">
				<option value="">请选择</option> 				
				<logic:iterate id="toProcessTypeList" name="ProcessTypeList" type="com.boco.eoms.businessupport.serviceprepare.model.ProcessType">						
          ...
          <tr>
			...
			<td class="content" colspan="3">		 			
				...
				<option value="">请选择</option>	
				<logic:iterate id="toProductSpecificationList" name="productSpecificationList" type="com.boco.eoms.businessupport.serviceprepare.model.ProductSpecification">						
          ...
          <tr>
			...
			<td class="content" colspan="3">		 			
                 <textarea class="textarea max" name="remark" id="remark" alt="allowBlank:true,maxLength:255,vtext:'请填写备注，最大长度为255字符'" ></textarea>																	
			</td>          
          </tr>                         
	</table>
