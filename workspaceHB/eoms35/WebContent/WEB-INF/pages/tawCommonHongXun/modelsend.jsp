...
<div id="tabs">
        ...
        <form action="${app}/hongxun/TawCommonHongXunAction/sendgaojin.do" method="post"
            ...
            <table border="0" width="95%" cellspacing="1">
                ...
                <tr class="tr_show">
                    ...
                    <td width="11%">
                        <div align="center">
                            <input type=button class="clsbtn2" name="AddUserAll" value='${eoms:a2u('全加')}'
                                   onclick="javascript:add_all_user();">
                        </div>
                        <div align="center">
                            <input type=button Class="clsbtn2" name="AddUser" value='${eoms:a2u('增加')}'
                                   onclick="javascript:add_user();">
                        </div>

                        <div align="center">
                            <input type=button Class="clsbtn2" name="DelUser" value='${eoms:a2u('删除')}'
                                   onclick="javascript:del_user();">
                        </div>
                        <div align="center">
                            <input type=button Class="clsbtn2" name="DelUserAll" value='${eoms:a2u('全删')}'
                                   onclick="javascript:del_all_user();">
                        </div>
    ...
    function checkForm() {
        var objOptions = document.TawCommonHongXunForm.seluser.options;
        var i;
        var sValue;
        var sValuestr;
        var bFirst = true;
        ...
        document.TawCommonHongXunForm.selvalue.value =
            sValue;
        callerWindowObj.document.forms[0].accompanyName.value = sValuestr;
        callerWindowObj.document.forms[0].accompany.value = sValue;
        window.close();
    }
