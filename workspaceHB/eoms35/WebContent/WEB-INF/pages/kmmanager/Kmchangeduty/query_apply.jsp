                ...
                <tr class="tr_show">
                    ...
                    <td>
                        ...
                        <input type="button" name="button" class="button"
                               value=
                                   <bean:message key="TawRmChangeduty.withdraw"/>
                                       Onclick="window.location.href ='${app}
                        /kmmanager/Kmchangeduty/transact_apply.do?transact_id=<%=Integer.parseInt(String.valueOf(
                        ...
                        <input type="button" name="button" class="button"
                               value=
                                   <bean:message key="TawRmChangeduty.know"/>
                                       Onclick="window.location.href ='${app}
                        /kmmanager/Kmchangeduty/transact_apply.do?transact_id=<%=Integer.parseInt(String.valueOf(
                            getId.elementAt(i)).trim())%>&roomId=<%=roomId%>&transact_flag=3'">
                        <%
            ...
            <table border="0" width="100%" cellspacing="1" cellpadding="1"
                ...
                <tr class="tr_show">
                    ...
                    <td>
                        ...
                        <input type="button" name="button" class="button"
                               value=
                                   <bean:message key="TawRmChangeduty.agree"/>
                                       Onclick="window.location.href ='${app}
                        /kmmanager/Kmchangeduty/transact_apply.do?transact_id=<%=Integer.parseInt(String.valueOf(
                        ...
                        <input type="button" name="button" class="button"
                               value=
                                   <bean:message key="TawRmChangeduty.disagree"/>
                                       Onclick="window.location.href ='${app}
                        /kmmanager/Kmchangeduty/transact_apply.do?transact_id=<%=Integer.parseInt(String.valueOf(
