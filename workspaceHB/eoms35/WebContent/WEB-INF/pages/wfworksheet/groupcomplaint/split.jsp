...
<div id="sheetform">
    <html:form action="/groupcomplaint.do?method=performCreateSubTask" styleId="theform">
      ...
      <table class="formTable">
         ...
         <input type="hidden" name="${sheetPageName}taskNamespace" value="http://GroupComplaintProcess"/>       
         <input type="hidden" name="${sheetPageName}operateType" id="${sheetPageName}operateType" value="${operateType}" />
		 <tr>	
		  <td class="label">            
             <bean:message bundle="group" key="groupcomplaint.linkTransmitReason1"/>*
          </td>
          <td colspan="3">
		    <textarea name="${sheetPageName}remark" id="${sheetPageName}remark" 
			    class="textarea max" alt="allowBlank:false">${sheetLink.remark}</textarea>
		  </td>	
	   </tr>
	    <tr>	
		  <td class="label">            
          ...
          <td colspan="3">
		    <eoms:attachment idList="" idField="${sheetPageName}nodeAccessories" appCode="groupcomplaint"/>
		  </td>	
	   </tr>  
     </table>
