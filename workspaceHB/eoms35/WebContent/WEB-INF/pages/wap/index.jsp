<%@page import="java.util.List,com.boco.eoms.commons.system.priv.model.TawSystemPrivOperation,com.boco.eoms.wap.util.*,org.apache.abdera.model.Entry,com.boco.eoms.commons.system.session.form.TawSystemSessionForm"
        pageEncoding="UTF-8" %>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table_width">
                ...
                <tr class="nav_text">
                    ...
                    <td>
                        ...
                        %><a href="<%=realUrl%>" accesskey="<%=i+1%>"><img src="${app}/wap/images/ico0<%=i+1%>.gif"/>
                    </a><br/>
                        <!-- 按照4个截位。-->
                        <a href="<%=realUrl%>" accesskey="<%=i+1%>"><%=AtomUtil.substring(privOper.getName(), 0, 4)%>
                        </a>
                        <%} else {%>
                        <a href="#help<%=i%>" accesskey="<%=i+1%>"><img
                                src="${app}/wap/images/ico0<%=i+1%>.gif"/></a><br/>
                        <a href="#help<%=i%>" accesskey="<%=i+1%>"><%=AtomUtil.substring(privOper.getName(), 0, 4)%>
                        </a>
                        <%}%>
                    </td>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="sub_table_bg">
    ...
    %>
    <tr>
        <td class="title_bg_0<%if(0==i){%>1<%}else{%>2<%}%>" align="left"><img
                src="${app}/wap/images/s_ico_0<%=i+1%>.gif">
        ...
        <td align="right" class="title_bg_0<%if(0==i){%>1<%}else{%>2<%}%>"><a href="${app}<%=privOper.getUrl()%>"><img
                src="${app}/wap/images/ico_more_1.gif"></a></td>
    </tr>
        ...
        <td>
            <div class="content_text_01">
                <ul>
                    ...
                    <li><a class="a1"
                           href="<%=((Entry)EntryList.get(k)).getContent()%>"><%=((Entry) EntryList.get(k)).getTitle()%>
                    </a></li>
