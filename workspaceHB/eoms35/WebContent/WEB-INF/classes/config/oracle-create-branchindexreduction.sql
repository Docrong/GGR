...
alter table BRANCHINDEXREDUCTION_MAIN
    add constraint BRANCHINDEXREDUCTION_MAIN_PK primary key (id) using index;
...
alter table BRANCHINDEXREDUCTION_TASK
    add constraint BRANCHINDEXREDUCTION_TASK_PK primary key (id) using index;
...
values ('xls,txt,doc,jpg,gif', 'branchindexreduction', '分公司指标核减流程流程', 1024, '/sheet/branchindexreduction', 9221,
        '4028811e5d8829ff015d882a00230000');

--插入角色
insert into taw_system_role(role_id, deleted, parent_id, role_name, roletype_id, workflow_flag, leaf)
values ('99501', '0', '0', '地市人员', '1', '995', '1');
insert into taw_system_role(role_id, deleted, parent_id, role_name, roletype_id, workflow_flag, leaf)
values ('99502', '0', '0', '初审人', '1', '995', '1');

--插入菜单
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('4028811e5d8829ff015d882a00230001', '99999191401', '1', '新增工单', '999991914', null,
        '/sheet/branchindexreduction/branchindexreduction.do?method=showNewSheetPage', '0', '0', 1);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('4028811e5d8829ff015d882a00230002', '99999191403', '0', '待处理工单', '999991914', null, null, '0', '0', 3);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('4028811e5d8829ff015d882a00230003', '9999919140301', '1', '待办工单', '99999191403', null,
        '/sheet/branchindexreduction/branchindexreduction.do?method=showListsendundo', '0', '0', 1);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('4028811e5d8829ff015d882a00230004', '99999191407', '1', '工单查询', '999991914', null,
        '/sheet/branchindexreduction/branchindexreduction.do?method=showQueryPage', '0', '0', 7);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('4028811e5d8829ff015d882a00230005', '99999191408', '1', '工单处理模板', '999991914', null,
        '/sheet/branchindexreduction/branchindexreduction.do?method=getDealTemplatesByUserId&type=templateManage', '0',
        '0', 8);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('4028811e5d8829ff015d882a00230006', '99999191409', '1', '工单模板管理', '999991914', null,
        '/sheet/branchindexreduction/branchindexreduction.do?method=getTemplatesByUserId&type=templateManage', '0', '0',
        9);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('4028811e5d8829ff015d882a00230007', '99999191410', '1', '管理者工单', '999991914', null,
        '/sheet/branchindexreduction/branchindexreduction.do?method=showListForAdmin', '0', '0', 10);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('4028811e5d8829ff015d882a00230008', '999991914', '0', '分公司指标核减流程流程', '10', null,
        '/sheet/branchindexreduction/branchindexreduction.do?method=showDrawing', '0', '0', 20);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('4028811e5d8829ff015d882a00230009', '99999191402', '1', '草稿列表', '999991914', null,
        '/sheet/branchindexreduction/branchindexreduction.do?method=showDraftList', '0', '0', 2);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('4028811e5d8829ff015d882a0023000a', '99999191404', '0', '已处理工单', '999991914', null, null, '0', '0', 4);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('4028811e5d8829ff015d882a0023000b', '9999919140402', '1', '建立工单', '99999191404', null,
        '/sheet/branchindexreduction/branchindexreduction.do?method=showOwnStarterList', '0', '0', 2);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('4028811e5d8829ff015d882a0023000c', '9999919140401', '1', '处理工单', '99999191404', null,
        '/sheet/branchindexreduction/branchindexreduction.do?method=showListsenddone', '0', '0', 1);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('4028811e5d8829ff015d882a0023000d', '99999191405', '1', '已归档工单', '999991914', null,
        '/sheet/branchindexreduction/branchindexreduction.do?method=showHoldedList', '0', '0', 5);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('4028811e5d8829ff015d882a0023000e', '99999191406', '1', '已作废工单', '999991914', null,
        '/sheet/branchindexreduction/branchindexreduction.do?method=showCancelList', '0', '0', 6);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('4028811e5d8829ff015d882a0023000f', '99999191411', '1', '超时时间设置', '999991914', null,
        '/sheet/overtimetip/overtimetip.do?flowName=BranchIndexReduction', '0', '0', 11);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('4028811e5d8829ff015d882a00230010', '99999191412', '1', '工单处理时限配置', '999991914', null,
        '/sheet/newSheetLimit/sheetLimit.do?method=getLevelLimitList&flowName=BranchIndexReduction', '0', '0', 30);