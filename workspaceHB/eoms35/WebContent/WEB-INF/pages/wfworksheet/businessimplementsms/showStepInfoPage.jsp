            ...
            <div class="history-item"><!-- add space to hack ie-->&nbsp;
                ...
                <div class="history-item-content hide">
  			      ...
  			      <%} %> -->
                        ...
                        <tr>
                            <td class="column-title">
                                <bean:message bundle="businessimplementsms" key="businessimplementsms.linkAuditResult"/>
                            </td>
                        ...
                        <tr>
                            <td class="column-title">
                                <bean:message bundle="businessimplementsms" key="businessimplementsms.linkAuditIdea"/>
                            </td>
                            <td class="column-content" colspan="3">
                        ...
                        <tr>
                            <td class="label"><bean:message bundle="businessimplementsms"
                                                            key="businessimplementsms.linkTaskComplete"/></td>
                            <td class="column-content" colspan="3">
                        ...
                        <tr>
                            <td class="column-title">
                                <bean:message bundle="businessimplementsms" key="businessimplementsms.advice"/>
                            </td>
                            <td class="column-content" colspan=3>
                                <pre><bean:write name="baselink" property="linkTaskComplete" scope="page"/></pre>
                            </td>
...
<script type="text/javascript">
    ...
    function copy(id) {
        ...
        if (ifCheck.checked == true) {
            Ext.Ajax.request({
                method: "get",
                url: "businessimplementsms.do?method=getJsonLink&id=" + id + "&beanName=BusinessImplementSms",
                success: function (x) {
