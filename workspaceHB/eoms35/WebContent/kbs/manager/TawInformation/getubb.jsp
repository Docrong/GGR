...
<br>
<img onclick=Cbold() src="../images/ubb/bold.gif" width="22" height="22" alt="粗体" border="0">
...
<img onclick=Ccenter() src="../images/ubb/center.gif" width="22" height="22" alt="居中" border="0">
<img onclick=Curl() src="../images/ubb/url1.gif" width="22" height="22" alt="超级连接" border="0">
<img onclick=Cemail() src="../images/ubb/email1.gif" width="23" height="22" alt="Email连接" border="0">
<!--
<img onclick=Cimage() src="../images/ubb/image.gif" width="23" height="22" alt="图片" border="0">
<img onclick=Cswf() src="../images/ubb/swf.gif" width="23" height="22" alt="Flash图片" border="0">
<img onclick=Cdir() src="../images/ubb/shockwave.gif" width="23" height="22" alt="Shockwave文件" border="0">
<img onclick=Crm() src="../images/ubb/rm.gif" width="23" height="22" alt="realplay视频文件" border="0">
<img onclick=Cwmv() src="../images/ubb/mp.gif" width="23" height="22" alt="Media Player视频文件" border="0">
<img onclick=Cmov() src="../images/ubb/qt.gif" width="23" height="22" alt="QuickTime视频文件" border="0">

<img onclick=Cquote() src="../images/ubb/quote1.gif" width="23" height="22" alt="引用" border="0">
-->
<IMG onclick=Cfly() height=22 alt=飞行字 src="../images/ubb/fly.gif" width=23 border=0>
<IMG onclick=Cmarquee() height=22 alt=移动字 src="../images/ubb/move.gif" width=23 border=0>
<IMG onclick=Cguang() height=22 alt=发光字 src="../images/ubb/glow.gif" width=23 border=0>
<IMG onclick=Cying() height=22 alt=阴影字 src="../images/ubb/shadow.gif" width=23 border=0>
<IMG onclick=openScript('../inc/smiles.jsp',400,300) src="../images/ubb/ubb_smilie.gif" border=0 alt=查看更多的心情图标>
<!--
<img onclick=Csound() src="../images/ubb/csound.gif" width="23" height="22" alt="背景音乐" border="0">
-->
