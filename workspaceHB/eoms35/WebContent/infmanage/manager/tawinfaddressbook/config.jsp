                            ...
                            <table width="390" cellspacing="1" cellpadding="1" border="0" class="table_show">
                                ...
                                <tr class="tr_show">
                                    <td width="40%" align="center">
                                        ...
                                        <select size=25 name="sOper" style="width:250" multiple="true"
                                    ...
                                    <td width="20%" align="center" valign="top">
                                        ...
                                        <input type="button" name="btnAddItem" value="<bean:message key="label.add1"/>"
                                               onclick=javascript:add_MoreTrue(); class="clsbtn2">
                                        <p>
                                            <input type="button" name="btnDelItem"
                                                   value="<bean:message key="label.remove1"/>"
                                                   onclick=javascript:del_MoreTrue(); class="clsbtn2">
                                        <p>
                                            <input type="button" name="btnAddAll"
                                                   value="<bean:message key="label.alladd"/>"
                                                   onclick=javascript:add_all_RoomTrue(); class="clsbtn2">
                                        <p>
                                            <input type="button" name="btnDelAll"
                                                   value="<bean:message key="label.alldel"/>"
                                                   onclick=javascript:del_all_RoomTrue(); class="clsbtn2">
                                    </td>
                                    ...
                                    <td width="40%" align="center">
                                        ...
                                        <select size=25 name="sOper_O" style="width:250" multiple="true"
                        ...
                        <td>
                            <table height="30" cellpadding="0" cellspacing="0" border="0" width="100%">
                                <tr align="right" height="32">
                                    <td>
                                        <input type="button" name="save" value="<bean:message key="label.rigor"/>"
                                               onclick="toQuery()" class="clsbtn2">
                                        <input type="button" name="save" value="<bean:message key="label.sent"/>"
                                               onclick="sent_room_user();" class="clsbtn2">
