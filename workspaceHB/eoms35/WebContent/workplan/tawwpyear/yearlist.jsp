...
<form name="yearplanform">
    ...
    <table width="100%" class="listTable" id="list">
        <caption><bean:message key="yearlist.title.formTitle"/>
            <eoms:dict key="dict-workplan" dictId="yearFlag" isQuery="false" defaultId="<%=yearFlag%>"
    ...
    <input type="button" Class="button" value="<bean:message key="yearlist.title.addFromDept" />"
           onclick="onAddNoModel();">
</form>
