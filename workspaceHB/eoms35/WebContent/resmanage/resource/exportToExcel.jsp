...
//out.println("disVec.size()::"+disVec.size());
    ...
    <%
        ...
        //int everypagenum=2;
        //rs.setPageCapacity(everypagenum);						//ÿҳ��ʾ��¼���ݸ���
        rs.setRS(strSql);
    ...
    <table bgcolor=#dddddd width='100%' border=0 cellspacing=1 id="resultRs">
        <tr>
            <%
                out.println("<td align=center class=ttTable><b><font size=2 color=#000000 face='Verdana, Arial, Helvetica, sans-serif'>" + StaticMethod.dbNull2String("���") + "</font></b></td>");
                ...
                out.println("<td align=center class=ttTable><b><font size=2 color=#000000 face='Verdana, Arial, Helvetica, sans-serif'>" + StaticMethod.dbNull2String("���ڵ���") + "</font></b></td>");
                out.println("<td align=center class=ttTable><b><font size=2 color=#000000 face='Verdana, Arial, Helvetica, sans-serif'>" + StaticMethod.dbNull2String("�豸����") + "</font></b></td>");
        ...
        <%
            ...
            out.println("<tr><td align=center class=td><font size=2 color=#000000 face='Verdana, Arial, Helvetica, sans-serif'>" + StaticMethod.dbNull2String("�ϼƣ�") + rs.getRowCount() + "</font></td></tr>");
        %>
