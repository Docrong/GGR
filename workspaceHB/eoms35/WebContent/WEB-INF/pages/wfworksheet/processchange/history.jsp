        ...
        <logic:iterate id="baselink" name="HISTORY" type="com.boco.eoms.sheet.processchange.model.ProcessChangeLink">
            ...
            <div class="history-item"><!-- add space to hack ie-->&nbsp;
                <div class="history-item-title">
                    ...
                    <eoms:dict key="dict-sheet-processchange" dictId="activeTemplateId"
                               itemId="${baselink.activeTemplateId}" beanId="id2descriptionXML"/>
                    <bean:message bundle="processchange" key="processchange.operateType"/>:
                    <eoms:dict key="dict-sheet-processchange" dictId="mainOperateType" itemId="${baselink.operateType}"
                ...
                <div class="history-item-content hide">
                    ...
                    <table class="history-item-table" width="100%" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td class="column-content">
                                <eoms:dict key="dict-sheet-processchange" dictId="mainOperateType"
                        ...
                        <tr>
                            <td class="label"><bean:message bundle="processchange"
                                                            key="processchange.linkProcessType"/></td>
                            <td class="column-content"><eoms:id2nameDB id="${baselink.linkProcessType}"
                                                                       beanId="ItawSystemDictTypeDao"/></td>
                            <td class="label"><bean:message bundle="processchange"
                                                            key="processchange.linkProcess"/></td>
                            <td class="column-content"><eoms:id2nameDB id="${baselink.linkProcess}"
                                                                       beanId="ItawSystemDictTypeDao"/></td>
                        </tr>
                        <tr>
                            <td class="column-title"><bean:message bundle="processchange"
                                                                   key="processchange.linkFrameDesc"/></td>
                            <td class="column-content" colspan=3>
                                <pre><bean:write name="baselink" property="linkFrameDesc" scope="page"/></pre>
                            </td>
                        </tr>
                        <tr>
                            <td class="label"><bean:message bundle="processchange"
                                                            key="processchange.linkSchemeFrame"/></td>
                            <td colspan='3'>
                        ...
                        <tr>
                            <td class="column-title"><bean:message bundle="processchange"
                                                                   key="processchange.linkSchemeDesc"/></td>
                            <td class="column-content" colspan=3>
                                <pre><bean:write name="baselink" property="linkSchemeDesc" scope="page"/></pre>
                            </td>
                        </tr>
                        <tr>
                            <td class="label"><bean:message bundle="processchange"
                                                            key="processchange.linkChangeScheme"/></td>
                            <td colspan='3'>
                        ...
                        <tr>
                            <td class="label"><bean:message bundle="processchange"
                                                            key="processchange.linkITChangeScheme"/></td>
                            <td colspan='3'>
                        ...
                        <tr>
                            <td class="label"><bean:message bundle="processchange"
                                                            key="processchange.linkAuditResult"/></td>
                            <td class="column-content" colspan="3"><eoms:id2nameDB id="${baselink.linkAuditResult}"
                                                                                   beanId="ItawSystemDictTypeDao"/></td>
                        </tr>
                        <tr>
                            <td class="column-title"><bean:message bundle="processchange"
                                                                   key="processchange.linkAuditDesc"/></td>
                            <td class="column-content" colspan=3>
                        ...
                        <tr>
                            <td class="column-title"><bean:message bundle="processchange"
                                                                   key="processchange.linkIfInvoke"/></td>
                            <td class="column-content" colspan=3><eoms:id2nameDB id="${baselink.linkIfInvoke}"
                                                                                 beanId="ItawSystemDictTypeDao"/></pre></td>
                        </tr>
                        <%} %>
                        <tr>
                            <td class="column-title"><bean:message bundle="processchange"
                                                                   key="processchange.linkReleaseDesc"/></td>
                            <td class="column-content" colspan=3>
                                <pre><bean:write name="baselink" property="linkReleaseDesc" scope="page"/></pre>
                            </td>
                        </tr>
                        <%
                                }
                        ...
                        <tr>
                            <td class="label"><bean:message bundle="processchange"
                                                            key="processchange.linkOptimizeImpact"/></td>
                            <td class="column-content" colspan="3"><eoms:id2nameDB id="${baselink.linkOptimizeImpact}"
                                                                                   beanId="ItawSystemDictTypeDao"/></td>
                        </tr>
                        <tr>
                            <td class="column-title"><bean:message bundle="processchange"
                                                                   key="processchange.linkEvaluateDesc"/></td>
                            <td class="column-content" colspan=3>
                                <pre><bean:write name="baselink" property="linkEvaluateDesc" scope="page"/></pre>
                            </td>
                        </tr>
                        <tr>
                            <td class="label"><bean:message bundle="processchange"
                                                            key="processchange.linkEvaluateAttach"/></td>
                            <td colspan='3'>
