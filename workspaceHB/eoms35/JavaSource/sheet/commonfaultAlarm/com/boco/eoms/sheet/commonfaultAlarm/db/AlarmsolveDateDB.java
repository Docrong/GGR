package com.boco.eoms.sheet.commonfaultAlarm.db;
...
public class AlarmsolveDateDB {
    ...
    public static Connection getConnection() {
        ...
        try {
            PropertyFile properties = PropertyFile.getInstance("/config/AlarmsolveDateDBConfig.properties");
            if (properties != null) {
