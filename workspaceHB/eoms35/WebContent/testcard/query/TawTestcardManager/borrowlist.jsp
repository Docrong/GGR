        ...
        <table border="0" width="95%" cellspacing="1" class="formTable">
            ...
            <logic:iterate id="tawTestcardManager" name="tawTestcardManager"
                ...
                <tr bgcolor="#FFFFFF">
                    ...
                    <td nowrap align="center"><html:link href="../TawTestcardManager/returnborrownote.do" paramId="id"
                                                         paramName="tawTestcardManager"
                                                         paramProperty="id">    ${eoms:a2u("显示")}</html:link></td>
