      ...
      <c:if test="${status!=1}">
				  ...
				  <td class="content">
	                ...
	                <tr>
            	      ...
            	      initDicId="1010701" sub="${sheetPageName}mainProcess" defaultValue="${sheetMain.mainProcessType}" alt="allowBlank:false" styleClass="select-class"/>
			        </td>	                
            	      ...
            	      initDicId="${sheetMain.mainProcessType}"  defaultValue="${sheetMain.mainProcess}" alt="allowBlank:false" styleClass="select-class"/>
			        </td>	                
		            </tr>
			      ...
			      <tr>
		            <td  class="label"><bean:message bundle="processchange" key="processchange.mainEditReason"/>*</td>
		              <td colspan="3"> 	
    				  <textarea class="textarea max" name="${sheetPageName}mainEditReason" id="${sheetPageName}mainEditReason" alt="width:500,allowBlank:false,maxLength:255,vtext:'请填入流程修订原因，最多输入125字'">${sheetMain.mainEditReason}</textarea>
                    </td>
		          </tr>
			      ...
			      <tr>
		            <td  class="label"><bean:message bundle="processchange" key="processchange.mainEditAdvice"/>*</td>
		              <td colspan="3"> 	
    				  <textarea class="textarea max" name="${sheetPageName}mainEditAdvice" id="${sheetPageName}mainEditAdvice" alt="width:500,allowBlank:false,maxLength:255,vtext:'请填入流程修订建议，最多输入125字'">${sheetMain.mainEditAdvice}</textarea>
                    </td>
		          </tr>
     </c:if>
	</table>
