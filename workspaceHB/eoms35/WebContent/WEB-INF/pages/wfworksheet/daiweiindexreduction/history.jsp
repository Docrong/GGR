...
<logic:present name="HISTORY" scope="request">  
      ...
      <logic:iterate id="baselink" name="HISTORY" type="com.boco.eoms.sheet.daiweiindexreduction.model.DaiWeiIndexReductionLink" >     
       <%         
        jNum += 1;       
      ...
      <div class="history-item">&nbsp;   
	      ...
	      <div class="history-item-title">
			 ...
			 <bean:write name="baselink" property="operateTime" formatKey="date.formatDateTimeAll" bundle="sheet" scope="page"/>&nbsp; 
	  	     ...
	  	     <eoms:dict key="dict-sheet-daiweiindexreduction" dictId="activeTemplateId" itemId="${baselink.activeTemplateId}" beanId="id2descriptionXML" />
	  	     <bean:message bundle="daiweiindexreduction" key="daiweiindexreduction.operateType"/>:
	  	     <eoms:dict key="dict-sheet-daiweiindexreduction" dictId="mainOperateType" itemId="${baselink.operateType}" beanId="id2descriptionXML" />
	 ...
	 <!-- 流程中的历史页面 -->
		  		...
		  		<%if(baselink.getActiveTemplateId()!=null && baselink.getActiveTemplateId().equals("TrialTask")) {%>
		  				...
		  				<%if(baselink.getOperateType() != null && (baselink.getOperateType().intValue() == 101 || baselink.getOperateType().intValue() == 11)){ %>
		 					...
		 					<td class="label">
								<!-- 联系人 -->
								<bean:message bundle="daiweiindexreduction" key="daiWeiIndexReductionLink.linkMan"/>
							</td>
							<td class="content">
		 					
								<pre>${baselink.linkMan}</pre>
	 						</td>
		 					...
		 					<td class="label">
								<!-- 联系人电话 -->
								<bean:message bundle="daiweiindexreduction" key="daiWeiIndexReductionLink.linkManTelephone"/>
							</td>
							<td class="content">
		 					
								<pre>${baselink.linkManTelephone}</pre>
	 						</td>
		 					...
		 					<td class="label">
								<!-- 初审说明 -->
								<bean:message bundle="daiweiindexreduction" key="daiWeiIndexReductionLink.linkTrialIllustrate"/>
							</td>
							<td colspan="3">
		 					
								<pre>${baselink.linkTrialIllustrate}</pre>
	 						</td>
...
<script type="text/javascript">
 ...
 function copy(id){
    ...
    Ext.Ajax.request({
		method:"get",
		url: "daiweiindexreduction.do?method=getJsonLink&id="+id+"&beanName=DaiWeiIndexReduction",
		success: function(x){
