...
<div id="sheetform">
    <html:form action="/commontask.do?method=performBatchDeal" styleId="theform">
                    ...
                    <table class="formTable">
                        ...
                        <tr>
                            <td class="label"><bean:message bundle="commontask"
                                                            key="commontask.mainTaskDescription"/></td>
                ...
                <tr>
                    ...
                    <td class="content">
                        <select id="dealSelector" onchange="checkValue(this)" alt="allowBlank:false,vtext:'请选择处理操作'">
                            <option value=""></option>
                            <option value="Receive"><bean:message bundle="commontask"
                                                                  key="commontask.dealrejectpass"/></option>
                            <option value="ExcuteHumTask"><bean:message bundle="commontask"
                    ...
                    <td class="content">
                        ...
                        <input type="hidden" name="beanId" value="iCommonTaskMainManager"/>
