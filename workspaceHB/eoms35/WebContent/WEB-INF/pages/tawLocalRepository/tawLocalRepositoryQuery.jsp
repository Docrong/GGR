	...
	<tr>
		...
		<td class="content">
			<eoms:comboBox name="${sheetPageName}netType" id="${sheetPageName}netType" 
			  	      sub="${sheetPageName}driverTpye" initDicId="1011701" defaultValue="${tawLocalRepositoryForm.netType}"  onchange="selectLimit(this.value);"/>
	...
	<tr>
		...
		<td class="content">
			<eoms:comboBox name="${sheetPageName}driverTpye" id="${sheetPageName}driverTpye" 
			  	      sub="${sheetPageName}company" initDicId="${tawLocalRepositoryForm.netType}" defaultValue="${tawLocalRepositoryForm.driverTpye}"  onchange="selectLimit(this.value);"/>
		</td>
		<td class="label">
