 ...
 <o:DocumentProperties>
  ...
  <o:Version>11.9999</o:Version>
    ...
    <body link= blue vlink= purple>
        ...
        <table x:str border=0 cellpadding=0 cellspacing=0 width=1058
        style='border-collapse:collapse;table-layout:fixed;width:796pt'>
        ...
        <td height=17 class=xl24 width=38 style='height:12.75pt;width:29pt'>省份
    </td>
    <td class= xl25 width=44 style='width:33pt'>城市
</td>
    <td class= xl25 width=
62 style='width:47pt'>城市区号</td>
<%
    iter = headMap.keySet().iterator();
    while (iter.hasNext()) {
%>
    <td class= xl26 width=
80 style='width:60pt'><%=iter.next()%></td>
<%}%>
    <td class= xl35 width=
106 style='width:80pt'>原归属HLR名称</td>
    <td class= xl36 width=
106 style='width:80pt'>原归属HLR信令点</td>
    <td class= xl37 width=
122 style='width:92pt'>申请归属HLR名称</td>
    <td class= xl38 width=
129 style='width:97pt'>申请归属HLR信令点</td>
    <td class= xl27 width=
204 style='width:153pt'>申请编号</td>
</tr>
<%
...
%>
    <tr height=
17 style='height:12.75pt'>
    <td height=
17 class=xl28 style='height:12.75pt'>湖北</td>
...
0 style='display:none'>
    <td width=
38 style='width:29pt'></td>
    <td width=
44 style='width:33pt'></td>
    <td width=
62 style='width:47pt'></td>
    <td width=
80 style='width:60pt'></td>
    <td width=
83 style='width:62pt'></td>
    <td width=
84 style='width:63pt'></td>
    <td width=
122 style='width:92pt'></td>
    <td width=
129 style='width:97pt'></td>
    <td width=
106 style='width:80pt'></td>
    <td width=
106 style='width:80pt'></td>
    <td width=
204 style='width:153pt'></td>
</tr>
    <
![endif]>
</table>
