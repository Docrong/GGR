    ...
    <html:form action="/kmLesson.do?method=save" styleId="kmLessonForm" method="post">
        <table class="formTable">
            ...
            <tr>
                ...
                <td class="content" colspan=3>
                    <textarea name="lessonContents" id="lessonContents" cols="50" class="textarea max"
                              alt="allowBlank:false,vtext:'请填写课题内容...'">${kmLessonForm.lessonContents}</textarea>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="content" colspan=3>
                    <eoms:attachment name="kmLessonForm" property="attachment" scope="request" idField="attachment"
                                     appCode="kmmanager"/>
                </td>
            </tr>
        </table>
