...
<form method="post" action="../TawTestcardManager/uselist.do"
	onsubmit="true">
	...
	<center>
		...
		<table class="formTable">
			...
			<tr>
				...
				<td width="100" align="left">
					<html:select property="cardType" style="width: 3.0cm;" value="7">
						...
						<!--                             <html:option value="0">国内出访卡</html:option>
                              <html:option value="3">省际出访卡</html:option>
                              <html:option value="6">省内出访卡</html:option>-->
			...
			<tr valign="middle">
				<td colspan="2">
					<INPUT type="submit" class="button" value="${eoms:a2u('查询')}"
						name="submit">
					&nbsp;&nbsp;
