...
<table id="sheet" class="formTable" >
 ...
 <td class="label">
			...
			<td>
				<input type="text"  class="text" name="administrativeArea" id="administrativeArea"  alt="allowBlank:false,maxLength:2000,vtext:'请填入 行政区域 信息，最多输入 2000 字符'" value="${sheetMain.administrativeArea}"/>
			</td>
		</tr>
 ...
 <td class="label">
		...
		<tr><td class="label">
			...
			<td>
				<input type="text"  class="text" name="planningScheme" id="planningScheme"  alt="allowBlank:false,maxLength:2000,vtext:'请填入 所属规划方案 信息，最多输入 2000 字符'" value="${sheetMain.planningScheme}"/>
			</td>
 <td class="label">
				<!-- 规划站经度 -->
			...
			<td>
				<input type="text"  class="text" name="longitude" id="longitude"  alt="allowBlank:false,maxLength:1000,vtext:'请填入 规划站经度 信息，最多输入 1000 字符'" value="${sheetMain.longitude}"/>
			</td>
		</tr>
		...
		<tr><td class="label">
			...
			<td>
				<input type="text"  class="text" name="latitude" id="latitude"  alt="allowBlank:false,maxLength:1000,vtext:'请填入 规划站纬度 信息，最多输入 1000 字符'" value="${sheetMain.latitude}"/>
			</td>
 <td class="label">
				<!-- 网元 -->
 ...
 <td class="label">
		...
		<tr><td class="label">
			...
			<td>
				<input type="text"  class="text" name="illustrate" id="illustrate"  alt="maxLength:2000,vtext:'请填入 调整原因属性说明 信息，最多输入 2000 字符'" value="${sheetMain.illustrate}"/>
			</td><td class="label">
				<!-- 规划起始时间 -->
 ...
 <td class="label">
			...
			<td>
				<input type="text"  class="text" name="briefDescription" id="briefDescription"  alt="allowBlank:false,maxLength:2000,vtext:'请填入 调整申请简要说明 信息，最多输入 2000 字符'" value="${sheetMain.briefDescription}"/>
			</td>
		</tr>
 ...
 <td class="label">
		...
		<tr><td>
			...
			<td>
				<input type="text"  class="text" name="gsmSignalLevel" id="gsmSignalLevel"  alt="allowBlank:false,maxLength:200,vtext:'请填入 GSM信号电平值 信息，最多输入 200 字符'" value="${sheetMain.gsmSignalLevel}"/>
			</td>
			<td>
				<input type="text"  class="text" name="gsmStationLocation" id="gsmStationLocation"  alt="allowBlank:false,maxLength:200,vtext:'请填入 GSM基站位置 信息，最多输入 200 字符'" value="${sheetMain.gsmStationLocation}"/>
			</td>
			<td>
				<input type="text"  class="text" name="gsmPlanningArea" id="gsmPlanningArea"  alt="allowBlank:false,maxLength:200,vtext:'请填入 GSM距离规划区(米) 信息，最多输入 200 字符'" value="${sheetMain.gsmPlanningArea}"/>
			</td>
		</tr>
		...
		<tr><td>
			...
			<td>
				<input type="text"  class="text" name="wcdmaSignalLevel" id="wcdmaSignalLevel"  alt="allowBlank:false,maxLength:200,vtext:'请填入 WCDMA信号电平值 信息，最多输入 200 字符'" value="${sheetMain.wcdmaSignalLevel}"/>
			</td>
			<td>
				<input type="text"  class="text" name="wcdmaStationLocation" id="wcdmaStationLocation"  alt="allowBlank:false,maxLength:200,vtext:'请填入 WCDMA基站位置 信息，最多输入 200 字符'" value="${sheetMain.wcdmaStationLocation}"/>
			</td>
			<td>
				<input type="text"  class="text" name="wcdmaPlanningArea" id="wcdmaPlanningArea"  alt="allowBlank:false,maxLength:200,vtext:'请填入 WCDMA距离规划区(米) 信息，最多输入 200 字符'" value="${sheetMain.wcdmaPlanningArea}"/>
			</td>
		</tr>
		...
		<tr><td>
			...
			<td>
				<input type="text"  class="text" name="cdmaSignalLevel" id="cdmaSignalLevel"  alt="allowBlank:false,maxLength:200,vtext:'请填入 CDMA信号电平值 信息，最多输入 200 字符'" value="${sheetMain.cdmaSignalLevel}"/>
			</td>
			<td>
				<input type="text"  class="text" name="cdmaStationLocation" id="cdmaStationLocation"  alt="allowBlank:false,maxLength:200,vtext:'请填入 CDMA基站位置 信息，最多输入 200 字符'" value="${sheetMain.cdmaStationLocation}"/>
			</td>
			<td>
				<input type="text"  class="text" name="cdmaPlanningArea" id="cdmaPlanningArea"  alt="allowBlank:false,maxLength:200,vtext:'请填入 CDMA距离规划区(米) 信息，最多输入 200 字符'" value="${sheetMain.cdmaPlanningArea}"/>
			</td>
		</tr>
