    ...
    <div id="sheetinfo">
        <logic:present name="sheetMain" scope="request">
            ...
            <table id="sheet" class="formTable">
                ...
                <tr>
                    <td class="label"><bean:message bundle="widencomplaint"
                                                    key="widenComplaintMain.mainCompleteLimitT1"/></td>
                    <td class="content">
                        <bean:write name="sheetMain" property="mainCompleteLimitT1" formatKey="date.formatDateTimeAll"
                                    bundle="sheet" scope="request"/>
                    </td>
                    <td class="label"><bean:message bundle="widencomplaint"
                                                    key="widenComplaintMain.mainCompleteLimitT2"/></td>
                    <td class="content">
                ...
                <tr>
                    <td class="label"><bean:message bundle="widencomplaint"
                                                    key="widenComplaintMain.complaintType1"/></td>
                    <td class="content"><eoms:id2nameDB id="${sheetMain.complaintType1}"
                                                        beanId="ItawSystemDictTypeDao"/></td>
                    <td class="label"><bean:message bundle="widencomplaint"
                                                    key="widenComplaintMain.complaintType2"/></td>
                ...
                <tr>
                    <td class="label"><bean:message bundle="widencomplaint"
                                                    key="widenComplaintMain.complaintType"/></td>
                    <td class="content"><eoms:id2nameDB id="${sheetMain.complaintType}"
                                                        beanId="ItawSystemDictTypeDao"/></td>
                    <td class="label"><bean:message bundle="widencomplaint"
                                                    key="widenComplaintMain.complaintType4"/></td>
                ...
                <tr>
                    <td class="label"><bean:message bundle="widencomplaint"
                                                    key="widenComplaintMain.complaintType5"/></td>
                    <td class="content"><eoms:id2nameDB id="${sheetMain.complaintType5}"
                                                        beanId="ItawSystemDictTypeDao"/></td>
                    <td class="label"><bean:message bundle="widencomplaint"
                                                    key="widenComplaintMain.complaintType6"/></td>
                ...
                <tr>
                    <td class="label"><bean:message bundle="widencomplaint"
                                                    key="widenComplaintMain.complaintType7"/></td>
            ...
            <table class="formTable">
                ...
                <tr>
                    <td class="label"><bean:message bundle="widencomplaint"
                                                    key="widenComplaintMain.bdeptContactPhone"/></td>
                    <td class="content"><eoms:id2nameDB id="${sheetMain.bdeptContactPhone}"
                                                        beanId="ItawSystemDictTypeDao"/></td>
                    <td class="label"><bean:message bundle="widencomplaint"
                                                    key="widenComplaintMain.repeatComplaintTimes"/></td>
                ...
                <tr>
                    ...
                    <c:choose>
                        <c:when test="${sheetMain.mainIfrepeat=='是' }">
                            <td class="content"><font color="red"
                                                      style="font-weight: bold">${sheetMain.mainIfrepeat}</font></td>
                        </c:when>
                        <c:otherwise>
                ...
                <tr>
                    <td class="label"><bean:message bundle="widencomplaint"
                                                    key="widenComplaintMain.preDealResult"/></td>
                    <td class="content" colspan="3">
            ...
            <tr>
                <td width="50%">
                    ...
                    <select id="dealSelector">
                        ...
                        <!-- 流程步骤，移交，阶段回复，分派 -->
                        <option value="${urlShowExcuteHumTask102Page}"><bean:message bundle="widencomplaint"
                                                                                     key="operateType.ExcuteHumTask102"/></option>
                        ...
                        <!-- 不需要等待回复 -->
                        <% if (ifwaitfor.equals("false")) {%>
                        <option value="${urlShowDispatchPage}"><bean:message bundle="widencomplaint"
                    ...
                    <select id="dealSelector">
                        ...
                        <% if (ifwaitfor.equals("false")) {%>
                        <!-- 流程步骤，移交，阶段回复，分派 -->
                        <option value="${urlShowHoldTask18Page}"><bean:message bundle="widencomplaint"
                    ...
                    <select id="dealSelector">
                        <option value="${urlShowDraftPage}"><bean:message bundle="widencomplaint"
