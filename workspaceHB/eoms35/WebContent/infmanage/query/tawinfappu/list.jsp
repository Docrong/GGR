...
<html:html>
    ...
    <form name="form1">
        ...
        <table border="0" width="100%" cellspacing="1" cellpadding="1" class="table_show" align=center>
            ...
            <tr class="tr_show">
                <td width="20%" height="25" class="clsfth" align="center"><bean:message
                        key="TawInfAppu.InfSortName"/></td>
            ...
            <logic:iterate id="tawInfInfo" name="TAW_INF_INFO_LIST" type="com.boco.eoms.infmanage.model.TawInfInfo">
                <tr class="tr_show">
                    <td width="20%" height="25" class="clsfth" align="center">
                        <input type="checkbox" name="chk_sel_id" id="<%=tawInfInfo.getId()%>"
                               value="<bean:write name="tawInfInfo" property="id" scope="page"/>">
                        <bean:write name="tawInfInfo" property="infSortName" scope="page"/></td>

                    <td width="5%" height="25" class="clsfth" align="center"><bean:write name="tawInfInfo"
                                                                                         property="infInfoId"
                                                                                         scope="page"/></td>

                    <td width="15%" height="25" class="clsfth" align="center"><bean:write name="tawInfInfo"
                                                                                          property="infInfoName"
                                                                                          scope="page"/></td>
                    ...
                    <td width="5%" height="25" align="center"><font color="#cc0000"><html:link
                            page="/TawInfAppu/view.do" name="map" scope="page"><img
                            src="<%=request.getContextPath()%>/images/bottom/an_xs.gif" border="0" alt="显示"></html:link>&nbsp;</font>
                    </td>

                    <td width="5%" height="25" align="center"><font color="#cc0000"><html:link
                            page="/TawInfAppu/update.do" name="map" scope="page"><img
                            src="<%=request.getContextPath()%>/images/bottom/an_bj.gif" border="0" alt="编辑"></html:link>&nbsp;</font>
                    </td>

                    <td width="5%" height="25" align="center"><font color="#cc0000"><html:link page="/TawInfAppu/del.do"
                                                                                               name="map"
                                                                                               scope="page"><img
