...
<table id=sheet class="formTable">
    <c:if test="${status!=1}">
        <tr>
            ...
            <td class="label"><bean:message bundle="businessoperation" key="businessoperation.sheetCompleteLimit"/>*
            </td>
            <td class="content">
        ...
        <tr>
            ...
            <td class="content">
                <eoms:comboBox name="${sheetPageName}mainProductType" id="${sheetPageName}mainProductType"
                               initDicId="1010515" sub="${sheetPageName}mainProductTypeTwo" alt="allowBlank:false"
                               styleClass="select-class" defaultValue="${sheetMain.mainProductType}"/>
            </td>
            <td class="label"><bean:message bundle="businessoperation" key="businessoperation.mainProductTypeTwo"/>*
            </td>
            <td class="content">
                <eoms:comboBox name="${sheetPageName}mainProductTypeTwo" id="${sheetPageName}mainProductTypeTwo"
                               initDicId="${sheetMain.mainProductType}" defaultValue="${sheetMain.mainProductTypeTwo}"
        ...
        <tr>
            ...
            <td class="content"><input type="text" class="text" name="${sheetPageName}mainProductCode"
                                       value="${sheetMain.mainProductCode}" id="${sheetPageName}mainProductCode"
                                       readOnly="true" alt="allowBlank:false,vtext:'${eoms:a2u('请选择新产品编号')}'"/>
                <input type="button" class="btn" value="${eoms:a2u('引用')}"
                       onclick="window.open('${app}/sheet/nBProducts/nbproductss.do?method=xquery&ifReference=true',null,'left=300,top=150,height=400,width=500,scrollbars=yes,resizable=yes')"/>
            </td>
            <td class="label"><bean:message bundle="businessoperation" key="businessoperation.mainProductName"/>*</td>
            <td class="content">
                <input type="text" class="text" name="${sheetPageName}mainProductName"
                       id="${sheetPageName}mainProductName" readOnly="true" alt="allowBlank:false"
                       value="${sheetMain.mainProductName}"/>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="content" colspan="3">
                <eoms:comboBox name="${sheetPageName}mainTask" id="${sheetPageName}mainTask"
                               initDicId="1010512" alt="allowBlank:false" styleClass="select-class"
                               defaultValue="${sheetMain.mainTask}"/>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="content">
                <eoms:comboBox name="${sheetPageName}mainIsGF" id="${sheetPageName}mainIsGF"
                               initDicId="1010505" alt="allowBlank:false" styleClass="select-class"
                               defaultValue="${sheetMain.mainIsGF}"/>
            </td>
            ...
            <td class="content">
                <eoms:comboBox name="${sheetPageName}mainIsGC" id="${sheetPageName}mainIsGC"
                               initDicId="1010506" alt="allowBlank:false" styleClass="select-class"
                               defaultValue="${sheetMain.mainIsGC}"/>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="content">
                <input type="text" class="text" name="${sheetPageName}mainDesignSheetId"
                       id="${sheetPageName}mainDesignSheetId" value="${sheetMain.mainDesignSheetId}"
                       alt="allowBlank:true,maxLength:20,vtext:'${eoms:a2u('请填入新业务分类相关设计配合工单号，最多输入20字!')}'"/></td>
            <td class="label"><bean:message bundle="businessoperation" key="businessoperation.mainSheetId"/></td>
            <td class="content">
                <input type="text" class="text" name="${sheetPageName}mainSheetId" id="${sheetPageName}mainSheetId"
                       value="${sheetMain.mainSheetId}"
                       alt="allowBlank:true,maxLength:20,vtext:'${eoms:a2u('请填入新业务分类相关试点工单号，最多输入20字!')}'"/></td>
        </tr>

        <tr>
            <td class="label"><bean:message bundle="businessoperation" key="businessoperation.mainSummarize"/>*</td>
            <td class="content" colspan="3">
                <textarea class="textarea max" name="${sheetPageName}mainSummarize" id="${sheetPageName}mainSummarize"
                          alt="allowBlank:false,maxLength:1000,vtext:'${eoms:a2u('请填入推广概述，最多输入1000字!')}'">${sheetMain.mainSummarize}</textarea>
            </td>
        </tr>
        <!-- <tr>
        <td class="label">
        ...
        <tr>
            ...
            <td colspan='3'>
                <eoms:attachment idList="" name="sheetMain" scope="request" property="mainExtendAcc"
                                 idField="${sheetPageName}mainExtendAcc" appCode="businessoperation"
                                 alt="allowBlank:false"/>
            </td>
            </td>
        </tr>
