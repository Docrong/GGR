				...
				<tr>
				  ...
				  <td> 
				    <input type="text" class="text" name="${sheetPageName}linkFaultAvoidTime" readonly="readonly" 
						...
						onclick="getlinkFaultAvoidTime()"  value="${eoms:date2String(sheetLink.linkFaultAvoidTime)}" alt="vtype:'moreThen',link:'${sheetPageName}mainFaultGenerantTime',vtext:'故障消除时间晚于故障发生时间',allowBlank:false"/> 
...
function success(x) {
  ...
  function getlinkFaultAvoidTime(){
    var mainAlarmSolveDate = document.getElementById("mainAlarmSolveDate");
    var mainCheckTime = document.getElementById("mainCheckTime");
    if(mainAlarmSolveDate.value==null||mainAlarmSolveDate.value==''){
       document.getElementById("linkFaultAvoidTime") = mainCheckTime.value;
       alert("获取核查告警清除时间");
    }else{
      document.getElementById("linkFaultAvoidTime") = mainAlarmSolveDate.value;
       alert("获取故障清除时间");
    }
    }
