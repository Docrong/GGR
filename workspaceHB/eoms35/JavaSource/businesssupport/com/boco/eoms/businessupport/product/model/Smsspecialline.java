 ...
 * 
 */
public class Smsspecialline extends BaseObject {
...
//	黑白名单设置方式  
	...
	public boolean equals(Object o) {
		if( o instanceof Smsspecialline ) {
			Smsspecialline smsspecialline=(Smsspecialline)o;
			if (this.id != null || this.id.equals(smsspecialline.getId())) {
				return true;
			} else {
				return false;
			}
