        ...
        <tr>
            ...
            <td class="label">
                <input type="text" name="startTime" class="text"
                       value="<bean:write format='yyyy-MM-dd hh:mm:ss' name='smsApplyForm' property='startTime'/>"
                    ...
                    <tr>
                        <td class="label">
                            <eoms:dict key="dict-msg" dictId="month" isQuery="false"
                                       defaultId="${smsApplyForm.cycleMonth}" selectId="cycleMonth" beanId="selectXML"/>
                            &nbsp;<bean:message key='smsService.month'/>
                        </td>
                        <td class="label">
                            <eoms:dict key="dict-msg" dictId="day" isQuery="false" defaultId="${smsApplyForm.cycleDay}"
                                       selectId="cycleDay" beanId="selectXML"/>
                            &nbsp;<bean:message key='smsService.day'/>
                        </td>
                        <td class="label">
                            <eoms:dict key="dict-msg" dictId="hour" isQuery="false"
                                       defaultId="${smsApplyForm.cycleHour}" selectId="cycleHour" beanId="selectXML"/>
                    ...
                    <tr>
                        <td colspan="3">
                            <html:checkbox styleId="regetData" property="regetData"
                                           onclick="controlSoap()">&nbsp;<bean:message
