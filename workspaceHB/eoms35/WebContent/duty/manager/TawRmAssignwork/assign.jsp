...
<%@ page language="java"
         import="java.util.*,java.lang.*, org.apache.struts.util.*,com.boco.eoms.common.util.StaticMethod,java.util.GregorianCalendar;" %>
...
//first col in a day
                                ...
                                <tr class="tr_show">
                                    <td rowspan="<%=team_num%>"><%=cal_start.get(cal_start.YEAR)%>-<%=cal_start.get(cal_start.MONTH)+1%>-<%=cal_start.get(cal_start.DATE)%>
                                        <input type="hidden" name="<%="date_name"+String.valueOf(date_name)%>"
                                               value="<%=cal_start.get(cal_start.YEAR)%>-<%=cal_start.get(cal_start.MONTH)+1%>-<%=cal_start.get(cal_start.DATE)%>">
                                        <br>
                                    <td>
                                        <%
                                    ...
                                    <td>
                                        <input type="checkbox" name="check_user"
                                               value="<%="roomuser_name"+String.valueOf(roomuser_name)%>"/>
                                        <select id="<%="roomuser_name"+String.valueOf(roomuser_name)%>"
                                                name="<%="roomuser_name"+String.valueOf(roomuser_name)%>"
                                                style="width:100"
                                                onchange="changeUser(this,<%=String.valueOf(roomuser_name)%>)">
                                            <%
                                                for (int room_user_i = 0; room_user_i * 2 < vector_room_user.size(); room_user_i++) {
                                    ...
                                    <td>
                                        <select id="<%="expert_name"+String.valueOf(expert_name)%>"
                                                name="<%="expert_name"+String.valueOf(expert_name)%>" style="width:100">
                                            <%
                                                for (int room_expert_i = 0; room_expert_i * 2 < expert.size(); room_expert_i++) {
                                            %>
                                            <option value="<%out.print(expert.elementAt(room_expert_i*2));%>"><%
                                                out.print(expert.elementAt(room_expert_i * 2 + 1));%></option>
                                            <%
                                                }
                                                expert_name++;
                                            %></select><br></td>
...
//first col in a day
                                ...
                                <tr class="tr_show">
                                    ...
                                    <td>
                                        <input type="checkbox" name="check_user"
                                               value="<%="roomuser_name"+String.valueOf(roomuser_name)%>"/><select
                                            id="<%="roomuser_name"+String.valueOf(roomuser_name)%>"
                                            name="<%="roomuser_name"+String.valueOf(roomuser_name)%>" style="width:100"
                                            onchange="changeUser(this,<%=String.valueOf(roomuser_name)%>)">
                                        <%
                                            for (int room_user_i = 0; room_user_i * 2 < vector_room_user.size(); room_user_i++) {
                                                if (user_num_current == room_user_i) {
...
%>
                                    ...
                                    <td>
                                        ...
                                        %>
                                        <option value="<%out.print(vector_room_user.elementAt(room_user_i*2));%>" <%if (StaticMethod.null2String(String.valueOf(vector_room_user.elementAt(room_user_i * 2))).trim().equals(String.valueOf(vecDutyman.elementAt(user_num_i)).trim())) {%>
                                                selected <%}%>><%
                                            out.print(vector_room_user.elementAt(room_user_i * 2 + 1));%></option>
                                        <%
                                            }
                                        ...
                                        <%
                                            if (intAssignAuto >= 0) {
                                                for (int room_user_i = 0; room_user_i * 2 < vector_room_user.size(); room_user_i++) {
                                                    ...
                                                    if (vecDutyman.size() > user_num_i) {
                                        %>
                                        <option value="<%out.print(vector_room_user.elementAt(room_user_i*2));%>" <%if (StaticMethod.null2String(String.valueOf(vector_room_user.elementAt(room_user_i * 2))).equals(String.valueOf(vecDutyman.elementAt(user_num_i)))) {%>
                                                selected <%}%>><%
                                            out.print(vector_room_user.elementAt(room_user_i * 2 + 1));%></option>
                                        <%
                                            }
...
//get how many user in the room
                                ...
                                <tr class="tr_show">
                                    <%//first col in a day%>
                                    <td rowspan="<%=team_num%>"><%=cal_start.get(cal_start.YEAR)%>
                                        -<%=cal_start.get(cal_start.MONTH) + 1%>-<%=cal_start.get(cal_start.DATE)%>
                                        <input type="hidden" name="<%="date_name"+String.valueOf(date_name)%>"
                                               value="<%=cal_start.get(cal_start.YEAR)%>-<%=cal_start.get(cal_start.MONTH)+1%>-<%=cal_start.get(cal_start.DATE)%>">
                                        <br></td>
                                    <td>
                                ...
                                <tr class="tr_show">
                                    <td>
                                        <%=cal_start.get(cal_start.YEAR)%>-<%=cal_start.get(cal_start.MONTH) + 1%>
                                ...
                                <tr>
                                    <td align="left">
                                        ...
                                        <%}%>
                                            ...
                                            --%><input type="submit" name="sub1" class="button" value=
                                        <bean:message key="label.save"/>>
                                        &nbsp;&nbsp;&nbsp;
                                        <input type="button" class="button" name="save" value="保存并设置为周期模板"
                                               onclick="javascript:model_set();">
