...
<table width="500" class="formTable">
  <caption>回复归档信息</caption>
   <tr>
    ...
    <td>
		 <eoms:comboBox name="faultDealResult" id="faultDealResult" initDicId="1010306" defaultValue="${object.faultDealResult}"   />
...
<tr>
	...
	<eoms:comboBox name="ifCarryNetChange" id="ifCarryNetChange" initDicId="10301" defaultValue="${object.ifCarryNetChange}"   />
...
<tr>
	...
	<eoms:comboBox name="ifAddCaseDataBase" id="ifAddCaseDataBase" initDicId="10301" defaultValue="${object.ifAddCaseDataBase}"   />
