        ...
        <html:form action="/failureRecord.do?method=saveFailureRecord">
            <table border="0" width="100%" cellspacing="1" class="formTable">
                ...
                <tr class="tr_show">
                    ...
                    <td>
                        <html:text property="faultstarttime" styleId="faultstarttime" readonly="true"
                    ...
                    <td>
                        <html:text property="faultendtime" styleId="faultendtime" readonly="true"
                                   onclick="popUpCalendar(this, this);"/>
                    </td>
                </tr>
                ...
                <tr class="tr_show">
                    ...
                    <td>
                        <eoms:comboBox name="${failureRecordForm.faulttype1}holdStatisfied"
                                       id="${failureRecordForm.faulttype1}holdStatisfied" initDicId="120"/>
                ...
                <tr class="tr_show">
                    ...
                    <td colspan="3">
                        ...
                        <textarea rows="1" cols="50" wrap="hard"
                                  name="faultdetail">${failureRecordForm.faultdetail}</textarea>
