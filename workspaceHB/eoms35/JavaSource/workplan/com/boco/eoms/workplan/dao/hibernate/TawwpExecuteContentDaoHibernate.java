...
public class TawwpExecuteContentDaoHibernate extends BaseDaoHibernate implements
     ...
     * 保存执行作业计划执行内容
     *
     * @param _tawwpExecuteContent TawwpExecuteContent 执行作业计划执行内容类
     * @throws Exception 操作异常
     */
     ...
     * @param _startDate String 开始时间
     * @param _endDate   String 结束时间
     * @param _deptIdStr String 部门集合字符串 用“，”分隔
     * @param _state     int 状态
     * @return List 获取部门在一个执行周期中某个状态的完成数量列表（结构：deptId,cycle,count）
     * @throws Exception 操作异常
     */
     ...
     *
     * @param _year  String 年度
     * @param _month String 月度
     * @param day    String 天
     * @return List 查询信息集合
     * @throws Exception 异常
     */
...
//				+ "and tawwpexecutecontent.executeFlag = '0' ";
     ...
     * @param _deptId      String 部门
     * @param _orgPostStr  String 岗位
     * @param _roomId      String 机房
     * @param _currentDate String 当前日期
     * @param _dutyFlag    String 值班标志
