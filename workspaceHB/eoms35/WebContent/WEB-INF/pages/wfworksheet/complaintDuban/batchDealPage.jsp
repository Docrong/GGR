            ...
            <div id="sheetinfo">
                <logic:present name="sheetMain" scope="request">
                    ...
                    <table class="formTable">
                        ...
                        <tr>
                            <td class="label"><bean:message bundle="complaintDuban"
                                                            key="complaintDuban.mainNetSort1"/></td>
                            <td class="content">
                                <eoms:id2nameDB id="${sheetMain.mainNetSort1}" beanId="ItawSystemDictTypeDao"/>
                            </td>
                            <td class="label"><bean:message bundle="complaintDuban"
                                                            key="complaintDuban.mainNetSort2"/></td>
                            <td class="content">
                        ...
                        <tr>
                            <td class="label"><bean:message bundle="complaintDuban"
                                                            key="complaintDuban.mainTaskDescription"/></td>
                ...
                <tr>
                    ...
                    <td class="content">
                        <select id="dealSelector" onchange="checkValue(this)" alt="allowBlank:false,vtext:'请选择处理操作'">
                            <option value=""></option>
                            <option value="Receive"><bean:message bundle="complaintDuban"
                                                                  key="complaintDuban.dealrejectpass"/></option>
                            <option value="ExcuteHumTask"><bean:message bundle="complaintDuban"
                                                                        key="complaintDuban.nopassback"/></option>
                        </select>
                    </td>
                    <td class="label"></td>
                    <td class="content">
