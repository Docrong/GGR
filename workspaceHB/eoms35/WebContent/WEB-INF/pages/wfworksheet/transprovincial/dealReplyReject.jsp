...
<div id="sheetform">
    <html:form action="/transprovincial.do?method=performDealReplyReject" styleId="theform">
        <%
        ...
        <input type="hidden" name="subtaskName" value="TransprovincialSubTask"/>
        ...
        <input type="hidden" name="taskNamespace" value="http://Transprovincial"/>
