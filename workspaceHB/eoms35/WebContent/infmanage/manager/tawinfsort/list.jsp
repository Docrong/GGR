...
<html:html>
    ...
    <html:form action="/TawInfSort/add" method="post">
        ...
        <table border="0" width="50%" cellspacing="1" cellpadding="1" class="table_show" align=center>
            ...
            <tr class="tr_show">
                <td width="30%" height="25" class="clsfth" align="center"><bean:message
                        key="TawInfSort.inf_sort_name"/></td>
            ...
            <logic:iterate id="tawInfSort" name="TAW_INF_SORT_LIST" type="com.boco.eoms.infmanage.model.TawInfSort">
                <tr class="tr_show">
                    <td width="30%" height="25" class="clsfth" align="center"><bean:write name="tawInfSort"
                                                                                          property="infSortName"
                                                                                          scope="page"/></td>
                    <%
                    ...
                    <td width="10%" height="25" align="center"><font color="#cc0000"><html:link
                            page="/TawInfSort/update.do" name="map" scope="page"><img
                            src="<%=request.getContextPath()%>/images/bottom/an_bj.gif" border="0" alt="编辑"></html:link>&nbsp;</font>
                    </td>

                    <td width="10%" height="25" align="center"><font color="#cc0000"><html:link
                            page="/TawInfSort/del.do" name="map" scope="page"><img
