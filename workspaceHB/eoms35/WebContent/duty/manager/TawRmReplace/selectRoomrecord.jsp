...
<%@ include file="/common/header_eoms_ext.jsp"%>
  ...
  var config = {
	...
	onClick:{url:"${app}/duty/tawRmReplace.do?method=xgetshow&roomId=",text:"${eoms:a2u('替班记录')}"},
	ctxMenu:[
		{id:'Child', text:'${eoms:a2u('替班记录')}',cls:'new-mi',url:'${app}/duty/tawRmReplace.do?method=xgetshow&roomId='} 
		 ],//end of ctxMenu 
	/************************
