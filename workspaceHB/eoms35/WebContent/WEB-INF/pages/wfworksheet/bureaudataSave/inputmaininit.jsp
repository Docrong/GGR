...
<input type="hidden" name="${sheetPageName}processTemplateName" value="BureaudataSaveMainFlowProcess"/>
...
<table class="formTable">
    ...
    <tr>
        <td class="label"><bean:message bundle="bureaudataSave" key="bureaudataSave.mainRemark"/>*</td>
        <td colspan="3" class="content">
    ...
    <tr>
        ...
        <td colspan="3">
            ...
            <eoms:attachment name="sheetMain" property="sheetAccessories"
                             scope="request" idField="${sheetPageName}sheetAccessories" appCode="bureaudataSave"/>
        </td>
    </tr>
</table>
