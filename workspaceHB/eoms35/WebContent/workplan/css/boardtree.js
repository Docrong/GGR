...
/*
����˵����
��Ϣ������ҵ����̳ģ�飬����������ʾ���ڵ��м���ê���ӣ�������ʾ��
http://localhost:8080/eoms_j2ee/infopub/TawInformation/list.do?boardId=8&infoType=2
��function������com.boco.eoms.common.tree.BoardTree.java���е�strWKTree()��������ʹ��
���磺
...
function createTree(arrName, startNode, openNode) {
    ...
    if (nodes.length > 0) {
        ...
        if (startNode != 0) {
            ...
            document.write("<a href=\"../infopub/TawInformation/list.do?boardId=" + nodeValues[0] + "&infoType=" + nodeValues[3] + "\" target=rightFrame onmouseover=\"window.status='" + nodeValues[2] + "';return true;\" onmouseout=\"window.status=' ';return true;\"><img src=\"../images/img/folderopen.gif\" align=\"absbottom\" alt=\"\" />" + nodeValues[2] + "</a><br />");
...
function addNode(parentNode, recursedNodes) {
    for (var i = 0; i < nodes.length; i++) {
        ...
        if (nodeValues[1] == parentNode) {
            ...
            // Start link
            document.write("<a href=\"../infopub/TawInformation/list.do?boardId=" + nodeValues[0] + "&infoType=" + nodeValues[3] + "\" target = rightFrame onmouseover=\"window.status='" + nodeValues[2] + "';return true;\" onmouseout=\"window.status=' ';return true;\">");
