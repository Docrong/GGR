 ...
 * 
 */
public class KmScoreWeight extends BaseObject {
	...
	public boolean equals(Object o) {
		if( o instanceof KmScoreWeight ) {
			KmScoreWeight kmScoreWeight=(KmScoreWeight)o;
			if (this.id != null || this.id.equals(kmScoreWeight.getId())) {
				return true;
			} else {
				return false;
			}
