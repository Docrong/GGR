...
<display:table name="tawRmTestcardList" cellspacing="0" cellpadding="0"
    ...
    requestURI="${app}/testcard/tawRmInoutRecords.do?method=inEdit" 
...
<br>
<html:submit styleClass="button" property="method.toInStorage" onclick="return ConfirmCheckBox()">
	<fmt:message key="button.inStorage" />
</html:submit>
</html:form>
