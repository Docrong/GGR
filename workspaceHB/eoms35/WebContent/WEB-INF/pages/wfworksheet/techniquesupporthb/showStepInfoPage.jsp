...
<div id="history" class="panel">
    ...
    <logic:present name="HISTORY" scope="request">
        <logic:iterate id="baselink" name="HISTORY"
                       type="com.boco.eoms.sheet.techniquesupporthb.model.TechniqueSupportHbLink">
            <%
                jNum += 1;
            ...
            <div class="history-item"><!-- add space to hack ie-->&nbsp;
                <div class="history-item-title">
                    ...
                    <eoms:dict key="dict-sheet-techniquesupporthb" dictId="mainOperateType"
                ...
                <div class="history-item-content hide">
  			      ...
  			      <%} %> -->
                        ...
                        <tr>
                            <td class="column-title">
                                <bean:message bundle="techniquesupporthb" key="techniquesupporthb.linkAuditResult"/>
                            </td>
                        ...
                        <tr>
                            <td class="column-title">
                                <bean:message bundle="techniquesupporthb" key="techniquesupporthb.linkAuditIdea"/>
                            </td>
                            <td class="column-content" colspan="3">
                        ...
                        <tr>
                            <td class="label"><bean:message bundle="techniquesupporthb"
                                                            key="techniquesupporthb.linkTaskComplete"/></td>
                            <td class="column-content" colspan="3">
                        ...
                        <tr>
                            <td class="column-title">
                                <bean:message bundle="techniquesupporthb" key="techniquesupporthb.advice"/>
                            </td>
                            <td class="column-content" colspan=3>
                                <pre><bean:write name="baselink" property="linkTaskComplete" scope="page"/></pre>
                            </td>
