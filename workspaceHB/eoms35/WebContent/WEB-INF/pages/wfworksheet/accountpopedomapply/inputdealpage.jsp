...
<table class="formTable">
    ...
    <tr>
        <td class="label"><bean:message bundle="accountpopedomapply" key="accountpopedomapply.link.applyAttitude"/>*
        </td>
        <td colspan='3'>
    ...
    <tr>
        ...
        <td colspan='3'>
            <textarea class="textarea max" name="${sheetPageName}applyResult" id="${sheetPageName}applyResult"
                      alt="width:500,allowBlank:false">${sheetLink.applyResult}</textarea>
        </td>
    </tr>
    <%
    ...
    <tr>
        ...
        <td colspan='3'>
            <textarea class="textarea max" name="${sheetPageName}deResult" id="${sheetPageName}deResult"
                      alt="width:500,allowBlank:false">${sheetLink.deResult}</textarea>
        </td>
    </tr>
    <%
