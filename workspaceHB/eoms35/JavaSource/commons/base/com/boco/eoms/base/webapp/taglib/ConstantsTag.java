 ...
 *          tei-class="com.boco.eoms.base.webapp.taglib.ConstantsTei"
 */
...
//	private final Log log = LogFactory.getLog(ConstantsTag.class);
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			BocoLog.error(this,"ClassNotFound - maybe a typo?");
		...
		try {
			...
			if (var == null) {
				...
				try {
					...
					BocoLog.error(this,nsf.getMessage());
					throw new JspException(nsf);
				}
			}
		} catch (IllegalAccessException iae) {
			BocoLog.error(this,"Illegal Access Exception - maybe a classloader issue?");
