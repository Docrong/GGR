...
<input type="hidden" name="${sheetPageName}processTemplateName" value="BusinessImplementSmsMainFlowProcess"/>
...
<table class="formTable">
    ...
    <tr>
        <td class="label"><bean:message bundle="businessimplementsms"
                                        key="businessimplementsms.mainTaskDescription"/>*
        </td>
    ...
    <tr>
        <td class="label"><bean:message bundle="businessimplementsms" key="businessimplementsms.mainRemark"/>*</td>
        <td colspan="3" class="content">
    ...
    <tr>
        ...
        <td colspan="3">
            ...
            <eoms:attachment name="sheetMain" property="sheetAccessories"
                             scope="request" idField="${sheetPageName}sheetAccessories" appCode="businessimplementsms"/>
        </td>
    </tr>
</table>
