...
<div id="sheetform">
    <html:form action="/equipmentinstallation.do?method=performDealReplyReject" styleId="theform">
        <%
        ...
        <input type="hidden" name="subtaskName" value="EquipmentInstallationSubTask"/>
        ...
        <input type="hidden" name="processTemplateName" id="processTemplateName" value="EquipmentInstallation"/>
        ...
        <input type="hidden" name="taskNamespace" value="http://EquipmentInstallation"/>
                    ...
                    <table class="formTable">
                        <logic:present name="acceptList" scope="request">
                            ...
                            <logic:iterate id="toTask" name="acceptList"
                                           type="com.boco.eoms.sheet.equipmentinstallation.model.EquipmentInstallationTask">
                                <tr>
                                    <td>
