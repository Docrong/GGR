    ...
    <html:form action="/urgentfault.do?method=performTransferWorkItem" styleId="theform">
        ...
        <fieldset>
            ...
            <div class="x-form-item">
                <eoms:chooser id="test" type="role" roleId="${bigRoleId}" flowId="53"
        ...
        <div class="form-btns">
            ...
            <input type="submit" class="submit"
                   onclick="v.passing=true;this.form.action='${app}/sheet/urgentfault/urgentfault.do?method=performSaveInfo'"
