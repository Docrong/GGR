...
<%
    com.boco.eoms.sheet.netFault.model.NetFaultLink netFaultLink = (com.boco.eoms.sheet.netFault.model.NetFaultLink) request.getAttribute("sheetLink");
    java.lang.String taskName = com.boco.eoms.base.util.StaticMethod.nullObject2String(netFaultLink.getActiveTemplateId());
    java.lang.String operateType = java.lang.String.valueOf(com.boco.eoms.base.util.StaticMethod.nullObject2String(netFaultLink.getOperateType()));
%>
<script type="text/javascript">
    ...
    function saveDealTemplate(type) {
        ...
        form.action = "${app}/sheet/netFault/netFault.do?method=saveDealTemplate&type=dealTemplateManage&dealTemplateId=${sheetLink.id}";
        form.submit();
    }
...
<html:form action="/netFault.do" styleId="theform">
    <br/>
    ...
    <table class="formTable">
        <caption><bean:message bundle="netFault" key="netFault.header"/></caption>
        <tr>
            <td class="label">
        ...
        <tr>
            <td class="label"><bean:message bundle="netFault" key="netFault.linkZContact"/>*</td>
            <td class="content">
            ...
            <td class="label"><bean:message bundle="netFault" key="netFault.linkZContactTel"/>*</td>
            <td class="content">
        ...
        <tr>
            ...
            <td colspan='3'>
                <eoms:attachment idList="" scope="request" idField="${sheetPageName}nodeAccessories" name="sheetLink"
                                 property="nodeAccessories" appCode="netFault" alt="allowBlank:true"/>
            </td>
        </tr>
        <%
                }
        ...
        <tr>
            <td class="label"><bean:message bundle="netFault" key="netFault.linkOperationDesc"/>*</td>
            <td colspan="3">
        ...
        <tr>
            <td class="label">
                <bean:message bundle="netFault" key="netFault.remark"/>*
            </td>
            <td colspan="3">
