...
<form name="tawgznetform" method="post" action="netsave.do" onsubmit='return SubmitCheck()'>
        ...
        <tr>
            ...
            <td width="400">
                <select size=1 name="systype" class="select"
                        onChange="changelocation(document.forms[0].systype.options[document.forms[0].systype.selectedIndex].value)">
        ...
        <tr>
            ...
            <td width="400">
                <select size="1" name="nettype" class="select"
                        onChange="mychangelocation(document.forms[0].nettype.options[document.forms[0].nettype.selectedIndex].value)">
    ...
    <input type="button" value="<bean:message key="netadd.title.formBack" />"
