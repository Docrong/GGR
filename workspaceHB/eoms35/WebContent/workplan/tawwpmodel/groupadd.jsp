...
<%
    ...
    if (modelPlanId == null) {
%>
<form name="tawwpgroupadd" method="post" action="../tawwpmodel/groupsave.do?modelgroupid=<%=modelGroupId%>"
      onsubmit='return SubmitCheck()'>
        <%
}
else if(modelGroupId == null){
%>
    <form name="tawwpgroupadd" method="post" action="../tawwpmodel/groupsave.do?modelplanid=<%=modelPlanId%>"
          onsubmit='return SubmitCheck()'>
            <%
}
else{
%>
        <form name="tawwpgroupadd" method="post"
              action="../tawwpmodel/groupsave.do?fathergroupid=<%=modelGroupId%>&modelplanid=<%=modelPlanId%>"
              onsubmit='return SubmitCheck()'>
            <%
                }
            %>
