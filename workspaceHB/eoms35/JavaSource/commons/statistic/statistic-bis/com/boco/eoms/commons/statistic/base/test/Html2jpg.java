...
//	    editorPane.read(new FileInputStream(url), new HTMLEditorKit());
	    ...
	    BufferedImage image1 = resize(image, 300, 200); 
...
//	    new Html2jpg("d://8aa081a61eb3b52d011eb3c0bf2b003520090108090000.html", new File("d:/file.jpg")); 
		new Html2jpg("http://127.0.0.1:8085/zy/statisticfile/customstatisticfile/monthfile/MyHtml.html", new File("d:/file.png"));
