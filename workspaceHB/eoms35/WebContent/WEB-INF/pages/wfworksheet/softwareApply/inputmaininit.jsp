...
<c:if test="${status==-1}">
	...
	<input type="hidden" name="${sheetPageName}processTemplateName" value="SoftwareApplyMainFlowProcess" />
	...
	<!-- sheet info --> 
     <table class="formTable">
			      ...
			      <tr>
		            <td  class="label"><bean:message bundle="softwareApply" key="softwareApply.mainRemark"/>*</td>
		              <td colspan="3" class="content"> 	
	 ...
	 <tr>
		   ...
		   <tr>
		    ...
		    <eoms:attachment name="sheetMain" property="sheetAccessories" 
		            scope="request" idField="${sheetPageName}sheetAccessories" appCode="softwareApply" /> 				
		    </td>
		  </tr>		
	</table>
