...
<div id="sheetform">
    <html:form action="/localCommonTask.do?method=performBatchDeal" styleId="theform">
                    ...
                    <table class="formTable">
                        ...
                        <tr>
                            <td class="label"><bean:message bundle="localCommonTask"
                                                            key="localCommonTask.mainNetSort1"/></td>
                            <td class="content">
                                <eoms:id2nameDB id="${sheetMain.mainNetSort1}" beanId="ItawSystemDictTypeDao"/>
                            </td>
                            <td class="label"><bean:message bundle="localCommonTask"
                                                            key="localCommonTask.mainNetSort2"/></td>
                            <td class="content">
                        ...
                        <tr>
                            <td class="label"><bean:message bundle="localCommonTask"
                                                            key="localCommonTask.mainNetSort3"/></td>
                            <td class="content">
                                <eoms:id2nameDB id="${sheetMain.mainNetSort3}" beanId="ItawSystemDictTypeDao"/>
                            </td>
                            <td class="label"><bean:message bundle="localCommonTask"
                                                            key="localCommonTask.mainTaskType"/></td>
                            <td class="content">
                ...
                <tr>
                    ...
                    <td class="content">
                        <select id="dealSelector" onchange="checkValue(this)" alt="allowBlank:false,vtext:'请选择处理操作'">
                            <option value=""></option>
                            <option value="Receive"><bean:message bundle="localCommonTask"
                                                                  key="localCommonTask.dealrejectpass"/></option>
                            <option value="ExcuteHumTask"><bean:message bundle="localCommonTask"
                    ...
                    <td class="content">
                        ...
                        <input type="hidden" name="beanId" value="iLocalCommonTaskMainManager"/>
