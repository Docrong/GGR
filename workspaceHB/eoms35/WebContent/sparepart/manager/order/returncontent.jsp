...
<div align="center">
    <center>
        ...
        <br>
        <form action="../part/returnover.do?order=<bean:write name="order" scope="request" filter="false"/>"
              method="post" name="TawSparepartForm">
            ...
            <table border="0" width="95%" cellspacing="1" cellpadding="1" class="table_show" align="center">
                ...
                <logic:iterate id="sparepart" name="sparepart" type="com.boco.eoms.sparepart.model.TawPart">
                    <tr class="tr_show" align="center">
                        ...
                        <td>
                            <INPUT TYPE="hidden" name="newserialno"
                                   value="<bean:write name="sparepart" property="serialno" scope="page"/>">
                            <INPUT TYPE="checkbox" name="return" id="<%="a"+i%>" label="<%="b"+i%>"
                                   onClick="checkOnly(this);"
                                   value="<bean:write name="sparepart" property="id" scope="page"/>">
                        </td>
                        <td>
                            <INPUT TYPE="checkbox" name="mangle" id="<%="b"+i%>" label="<%="a"+i%>"
                                   onClick="checkOnly(this);"
                                   value="<bean:write name="sparepart" property="id" scope="page"/>">
                        </td>
                    </tr>
