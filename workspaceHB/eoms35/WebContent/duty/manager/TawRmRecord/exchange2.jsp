...
<html:form method="post" action="/TawRmRecord/submit2">
    ...
    <TABLE cellSpacing="1" cellPadding="1" width="600" align="center"
        ...
        <TR class="tr_show">
            ...
            <TD noWrap colSpan="5">
                <TEXTAREA id=notes name=operationalState rows=2 cols=80 type="_moz"><bean:write name="tawRmRecordForm"
        ...
        <TR class="tr_show">
            ...
            <TD noWrap colSpan="5">
                <TEXTAREA id=notes name=purpose rows=2 cols=80 type="_moz"><bean:write name="tawRmRecordForm"
                                                                                       property="purpose"
                                                                                       scope="request"/></TEXTAREA>
                <SPAN id=Customvalidator2 style="DISPLAY: none; COLOR: red"
                      clientvalidationfunction="CheckNotes"
        ...
        <TR class="tr_show">
            ...
            <TD noWrap colSpan="5">
                <TEXTAREA id=notes name=completeFlag rows=2 cols=80 type="_moz"><bean:write name="tawRmRecordForm"
                                                                                            property="completeFlag"
                                                                                            scope="request"/></TEXTAREA>
                <SPAN id=Customvalidator2 style="DISPLAY: none; COLOR: red"
                      clientvalidationfunction="CheckNotes"
                      evaluationfunction="CustomValidatorEvaluateIsValid"
        ...
        <TR class="tr_show">
            ...
            <TD noWrap colSpan="6">
                <TEXTAREA id=notes name=attentive rows=2 cols=80 type="_moz"><bean:write name="tawRmRecordForm"
                                                                                         property="attentive"
                                                                                         scope="request"/></TEXTAREA>
                <SPAN id=Customvalidator2 style="DISPLAY: none; COLOR: red"
                      clientvalidationfunction="CheckNotes"
        ...
        <TR class="tr_show">
            ...
            <TD>
                ...
                <select name="Hander">
                    ...
                    %>
                    <option value='<%=vecDutyManId.get(i).toString()%>'><%=vecDutyManName.get(i).toString()%>
                    </option>
                    <%}%>
                </select>
            </TD>
        ...
        <TR class="tr_show">
            ...
            <TD>
                ...
                <select name="Receiver">
                    ...
                    %>
                    <option value='<%=vecReceiverId.get(i).toString()%>'><%=vecReceiverName.get(i).toString()%>
                    </option>
                    <%}%>
                </select>
            </TD>
