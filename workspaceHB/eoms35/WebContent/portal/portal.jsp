...
<head>
    ...
    <script language="JavaScript"
            src="<%= request.getContextPath() %>/portal/light/scripts/lightPortletChat.js"></script>
    <script language="JavaScript"
            src="<%= request.getContextPath() %>/portal/light/scripts/locale/lightResourceBundle<%= (session.getAttribute("currentLocale") != null) ? "_"+(String)session.getAttribute("currentLocale") : "" %>.js"></script>
    <LINK href="<%= request.getContextPath() %>/portal/light/<%= (session.getAttribute("theme") != null) ? (String)session.getAttribute("theme") : "theme/master.css"%>"
