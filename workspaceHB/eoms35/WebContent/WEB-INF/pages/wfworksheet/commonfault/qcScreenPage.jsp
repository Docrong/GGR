...
<table class="formTable">
	...
	<tr>
	  ...
	  <td class="content">
	      <input type="text" class="text" name="ratio" id="ratio" maxlength="3" onblur="checkData(this.value)" value="0"><font size="2" color="red">（提示：请输入0-100的数字）</font>
	  </td>		  
	   <td class="label">区域</td>
	   <td class="content">
             <input type="text" class="text max"  readonly="readonly" name="showArea" id="showArea" beanId="tawSystemAreaDao"/>
