            ...
            <tr>
                <td width="50%">
                    ...
                    <select id="dealSelector">
                        ...
                        <!-- 流程步骤，移交，阶段回复，分派 -->
                        <option value="${urlShowFirstApproval101Page}"><bean:message bundle="circuitcontrol"
                                                                                     key="operateType.FirstApproval101"/></option>
                        ...
                        <!-- 不需要等待回复 -->
                        <% if (ifwaitfor.equals("false")) {%>
                        <option value="${urlShowDispatchPage}"><bean:message bundle="circuitcontrol"
                    ...
                    <select id="dealSelector">
                        ...
                        <% if (ifwaitfor.equals("false")) {%>
                        <!-- 流程步骤，移交，阶段回复，分派 -->
                        <option value="${urlShowSecondApproval102Page}"><bean:message bundle="circuitcontrol"
                                                                                      key="operateType.SecondApproval102"/></option>
                        <option value="${urlShowSecondApproval103Page}"><bean:message bundle="circuitcontrol"
                                                                                      key="operateType.SecondApproval103"/></option>
                    ...
                    <select id="dealSelector">
                        ...
                        <% if (ifwaitfor.equals("false")) {%>
                        <!-- 流程步骤，移交，阶段回复，分派 -->
                        <option value="${urlShowHoldTask18Page}"><bean:message bundle="circuitcontrol"
                    ...
                    <select id="dealSelector">
                        <option value="${urlShowDraftPage}"><bean:message bundle="circuitcontrol"
