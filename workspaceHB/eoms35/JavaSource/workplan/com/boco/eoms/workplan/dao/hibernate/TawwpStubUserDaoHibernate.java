...
public class TawwpStubUserDaoHibernate extends BaseDaoHibernate implements
     ...
     * 保存代理
     *
     * @param _tawwpStubUser TawwpStubUser 代理类 @ 操作异常
     */
     ...
     * @param _currentDate String 当前时间 @ 操作异常
     * @return List 代理列表
     */
     ...
     * 查询代理的审批人
     *
     * @param _checkuser String 审批人 @ 操作异常
     * @return List 代理列表
     */
