...
<%@ include file="/WEB-INF/pages/wfworksheet/equipmentsecurityresponse/baseinputlinkhtmlnew.jsp"%>
	...
	<%} %> 
			...
			<td>
				<input type="text"  class="text" name="linkAuditResult" id="linkAuditResult"  alt="allowBlank:true,maxLength:1000,vtext:'请填入 审核结果 信息，最多输入 1000 字符'" value="${sheetLink.linkAuditResult}"/>
			</td>
			...
			<td>
				<input type="text"  class="text" name="linkAuditOpinion" id="linkAuditOpinion"  alt="allowBlank:true,maxLength:1000,vtext:'请填入 审核意见 信息，最多输入 1000 字符'" value="${sheetLink.linkAuditOpinion}"/>
			</td>
		</tr>
			...
			<td>
				<input type="text"  class="text" name="linkUpStuts" id="linkUpStuts"  alt="allowBlank:true,maxLength:1000,vtext:'请填入 挂起状态 信息，最多输入 1000 字符'" value="${sheetLink.linkUpStuts}"/>
			</td>
			...
			<td>
				<input type="text"  class="text" name="linkUpReason" id="linkUpReason"  alt="allowBlank:true,maxLength:1000,vtext:'请填入 挂起原因 信息，最多输入 1000 字符'" value="${sheetLink.linkUpReason}"/>
			</td>
		</tr>
			...
			<td>
				<input type="text"  class="text" name="linkOperation" id="linkOperation"  alt="allowBlank:true,maxLength:1000,vtext:'请填入 操作描述 信息，最多输入 1000 字符'" value="${sheetLink.linkOperation}"/>
			</td>
			...
			<td>
				<input type="text"  class="text" name="linkAuditResult" id="linkAuditResult"  alt="allowBlank:true,maxLength:1000,vtext:'请填入 审批结果 信息，最多输入 1000 字符'" value="${sheetLink.linkAuditResult}"/>
			</td>
		</tr>
			...
			<td>
				<input type="text"  class="text" name="linkRelieveState" id="linkRelieveState"  alt="allowBlank:true,maxLength:1000,vtext:'请填入 解除说明 信息，最多输入 1000 字符'" value="${sheetLink.linkRelieveState}"/>
			</td>
		</tr>
			...
			<td>
				<input type="text"  class="text" name="linkExtend1" id="linkExtend1"  alt="allowBlank:true,maxLength:2000,vtext:'请填入 预留字段1 信息，最多输入 2000 字符'" value="${sheetLink.linkExtend1}"/>
			</td>
			...
			<td>
				<input type="text"  class="text" name="linkExtend2" id="linkExtend2"  alt="allowBlank:true,maxLength:2000,vtext:'请填入 预留字段1 信息，最多输入 2000 字符'" value="${sheetLink.linkExtend2}"/>
			</td>
		</tr>
			...
			<td>
				<input type="text"  class="text" name="linkExtend3" id="linkExtend3"  alt="allowBlank:true,maxLength:2000,vtext:'请填入 预留字段1 信息，最多输入 2000 字符'" value="${sheetLink.linkExtend3}"/>
			</td>
			...
			<td>
				<input type="text"  class="text" name="linkExtend4" id="linkExtend4"  alt="allowBlank:true,maxLength:2000,vtext:'请填入 预留字段1 信息，最多输入 2000 字符'" value="${sheetLink.linkExtend4}"/>
			</td>
		</tr>
			...
			<td>
				<input type="text"  class="text" name="linkExtend5" id="linkExtend5"  alt="allowBlank:true,maxLength:2000,vtext:'请填入 预留字段1 信息，最多输入 2000 字符'" value="${sheetLink.linkExtend5}"/>
			</td>
		</tr>
 ...
 <%}%>
			...
			<td>
				<input type="text"  class="text" name="linkReplyObj" id="linkReplyObj"  alt="allowBlank:true,maxLength:1000,vtext:'请填入 回复对象 信息，最多输入 1000 字符'" value="${sheetLink.linkReplyObj}"/>
			</td>
			...
			<td>
				<input type="text"  class="text" name="linkReplyExp" id="linkReplyExp"  alt="allowBlank:true,maxLength:1000,vtext:'请填入 回复说明 信息，最多输入 1000 字符'" value="${sheetLink.linkReplyExp}"/>
			</td>
		</tr>
			...
			<td>
				<input type="text"  class="text" name="linkFaultCause" id="linkFaultCause"  alt="allowBlank:true,maxLength:1000,vtext:'请填入 故障原因 信息，最多输入 1000 字符'" value="${sheetLink.linkFaultCause}"/>
			</td>
			...
			<td>
				<input type="text"  class="text" name="linkDealMeasures" id="linkDealMeasures"  alt="allowBlank:true,maxLength:1000,vtext:'请填入 处理措施 信息，最多输入 1000 字符'" value="${sheetLink.linkDealMeasures}"/>
			</td>
		</tr>
			...
			<td>
				<input type="text"  class="text" name="linkIfSolution" id="linkIfSolution"  alt="allowBlank:true,maxLength:1000,vtext:'请填入 是否为最终解决方案 信息，最多输入 1000 字符'" value="${sheetLink.linkIfSolution}"/>
			</td>
			...
			<td>
				<input type="text"  class="text" name="linkRemark" id="linkRemark"  alt="allowBlank:true,maxLength:1000,vtext:'请填入 备注 信息，最多输入 1000 字符'" value="${sheetLink.linkRemark}"/>
			</td>
		</tr>
 ...
 <%}%>
			...
			<td>
				<textarea class="textarea max" name="linkQualityResult" 
								id="linkQualityResult" alt="allowBlank:true,maxLength:1000,vtext:'请填入 质检结果 信息，最多输入 1000 字符'">${sheetLink.linkQualityResult}</textarea>
			...
			<td>
				<textarea class="textarea max" name="linkQualityView" 
								id="linkQualityView" alt="allowBlank:true,maxLength:1000,vtext:'请填入 质检概述 信息，最多输入 1000 字符'">${sheetLink.linkQualityView}</textarea>
 ...
 <%}%>
			...
			<td>
				<textarea class="textarea max" name="linkReject" 
								id="linkReject" alt="allowBlank:true,maxLength:1000,vtext:'请填入 工单驳回描述 信息，最多输入 1000 字符'">${sheetLink.linkReject}</textarea>
 			   		...
 			   		<% if(operateType.equals("106")){ %>
 			   			<fieldset>
							  ...
							  <div class="x-form-item" >
									...
									<eoms:chooser id="QualityInspection1"  type="role" roleId="4401" flowId="44" config="{returnJSON:true,showLeader:true}"  
									   category="[{id:'dealPerformer',text:'派发',limit:'none',allowBlank:false,vtext:'请选择派发对象'},{id:'copyPerformer',childType:'user,subrole',limit:'none',text:'抄送'}]" 
									  data="${sendUserAndRoles}" />
