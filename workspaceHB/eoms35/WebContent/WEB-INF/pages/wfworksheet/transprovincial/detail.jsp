...
<table id="sheet" class="formTable" > 
	  ...
	  <tr>
		...
		<tr><td class="label">
			...
			<td class="content"> 
				<c:forTokens items="${sheetMain.atypearea}" delims="," var="atypearea" varStatus="status"><eoms:id2nameDB id="${atypearea}" beanId="ItawSystemDictTypeDao"/><c:choose><c:when test="${status.last}"></c:when><c:otherwise>,</c:otherwise></c:choose></c:forTokens>
			</td>
		</tr>
		<tr><td class="label">
				<!-- 资源确认汇总表 -->
			...
			<td>
				<eoms:attachment name="sheetMain" property="resourceReport"  scope="request" idField="resourceReport" appCode="transprovincial"  viewFlag="Y"/> 
						 ...
						 <td width="50%">  
									...
									<select id="dealSelector">
									 ...
									 <% } else if(taskStatus.equals(Constants.TASK_STATUS_CLAIMED)){ %>
									 	  ...
									 	  <% if (ifwaitfor.equals("false")) {%>
											  <!-- 流程步骤，移交，阶段回复，分派 -->
											  <option value="${urlShowAssignment102Page}"><bean:message bundle="transprovincial" key="operateType.Assignment102"/> </option>
									 ...
									 <%} else { %>
									 		...
									 		<!-- 不需要等待回复 -->
									 	  	<% if (ifwaitfor.equals("false")) {%>
									 			<option value="${urlShowDispatchPage}"><bean:message bundle="transprovincial" key="operateType.subTaskReply"/></option>
									 		<% }%>
									 <% } %>
								...
								<% }  if(taskName.equals("ProjectDesign")){ %>
									<select id="dealSelector">
									 ...
									 <% } else if(taskStatus.equals(Constants.TASK_STATUS_CLAIMED)){ %>
									 	  ...
									 	  <% if (ifwaitfor.equals("false")) {%>
											  <!-- 流程步骤，移交，阶段回复，分派 -->
											  <option value="${urlShowProjectDesign103Page}"><bean:message bundle="transprovincial" key="operateType.ProjectDesign103"/> </option>
								...
								<% }  if(taskName.equals("SubmitExamine")){ %>
									<select id="dealSelector">
									 ...
									 <% } else if(taskStatus.equals(Constants.TASK_STATUS_CLAIMED)){ %>
									 	  ...
									 	  <% if (ifwaitfor.equals("false")) {%>
											  <!-- 流程步骤，移交，阶段回复，分派 -->
											  <option value="${urlShowSubmitExamine104Page}"><bean:message bundle="transprovincial" key="operateType.SubmitExamine104"/> </option>
								...
								<% }  if(taskName.equals("ProjectExamine")){ %>
									<select id="dealSelector">
									 ...
									 <% } else if(taskStatus.equals(Constants.TASK_STATUS_CLAIMED)){ %>
									 	  ...
									 	  <% if (ifwaitfor.equals("false")) {%>
											  <!-- 流程步骤，移交，阶段回复，分派 -->
											  <option value="${urlShowProjectExamine105Page}"><bean:message bundle="transprovincial" key="operateType.ProjectExamine105"/> </option>
								...
								<% }  if(taskName.equals("ProjectConstract")){ %>
									<select id="dealSelector">
									 ...
									 <% } else if(taskStatus.equals(Constants.TASK_STATUS_CLAIMED)){ %>
									 	  ...
									 	  <% if (ifwaitfor.equals("false")) {%>
											  <!-- 流程步骤，移交，阶段回复，分派 -->
											  <option value="${urlShowProjectConstract106Page}"><bean:message bundle="transprovincial" key="operateType.ProjectConstract106"/> </option>
								...
								<% }  if(taskName.equals("SubmibAcceptance")){ %>
									<select id="dealSelector">
									 ...
									 <% } else if(taskStatus.equals(Constants.TASK_STATUS_CLAIMED)){ %>
									 	  ...
									 	  <% if (ifwaitfor.equals("false")) {%>
											  <!-- 流程步骤，移交，阶段回复，分派 -->
											  <option value="${urlShowSubmibAcceptance107Page}"><bean:message bundle="transprovincial" key="operateType.SubmibAcceptance107"/> </option>
								...
								<% }  if(taskName.equals("AcceptanceExamine")){ %>
									<select id="dealSelector">
									 ...
									 <% } else if(taskStatus.equals(Constants.TASK_STATUS_CLAIMED)){ %>
									 	  ...
									 	  <% if (ifwaitfor.equals("false")) {%>
											  <!-- 流程步骤，移交，阶段回复，分派 -->
											  <option value="${urlShowAcceptanceExamine108Page}"><bean:message bundle="transprovincial" key="operateType.AcceptanceExamine108"/> </option>
								...
								<% }  if(taskName.equals("AffirmHumTask")){ %>
									<select id="dealSelector">
									 ...
									 <% } else if(taskStatus.equals(Constants.TASK_STATUS_CLAIMED)){ %>
									 	  ...
									 	  <% if (ifwaitfor.equals("false")) {%>
											  <!-- 流程步骤，移交，阶段回复，分派 -->
											  <option value="${urlShowAffirmHumTask110Page}"><bean:message bundle="transprovincial" key="operateType.AffirmHumTask110"/> </option>
											  <option value="${urlShowAffirmHumTask111Page}"><bean:message bundle="transprovincial" key="operateType.AffirmHumTask111"/> </option>
 							...
 							<!-- 归档 -->
								<% }  if(taskName.equals("HoldTask")){ %>
									<select id="dealSelector">
									 	  ...
									 	  <% if (ifwaitfor.equals("false")) {%>
											  <!-- 流程步骤，移交，阶段回复，分派 -->
											  <option value="${urlShowHoldTask18Page}"><bean:message bundle="transprovincial" key="operateType.HoldTask18"/> </option>
							...
							<% }else if(taskName.equals("RejectTask")){%>	
					  		...
					  		<% }else if(taskName.equals("DraftTask")){%>	
								<select id="dealSelector">
								  <option value="${urlShowDraftPage}"><bean:message bundle="transprovincial" key="operateType.DraftTask"/></option>
								</select>
					   		<% } %>
					</td>
				</tr>
