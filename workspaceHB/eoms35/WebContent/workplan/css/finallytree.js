...
����˵����
temp��checkbox��idֵ;
temp3�������checkbox��valueֵ;
tempId�����checkbox�����ر���idֵ��textfield����
tempName�����checkbox����ʾ��ѡ�ڵ�ֵ��textfield����
*/
...
/*
����˵����
��checkBox���������ʾ��������ʾ��ѡ�ڵ����ѡ�ڵ㣬����ڵ㶼�ǲ���ѡ�ģ�
...
checkedid����ѡ�Ľڵ㣬��","�ָ���ַ�����
checkedno������ѡ�Ľڵ㣬��","�ָ���ַ�����
name�����ͽṹ��checkbox���nameֵ,���磺window.tawApparatusroomForm.cid;
*/
...
/*
����˵����
��checkBox���������ʾ��������ʾ�ѱ�ѡ�нڵ㡢����ѡ�ڵ�Ϳ�ѡ�ڵ�ֵ��
�ڸ����͵���ͼ�У����checkbox����������ΪjsName��function����function��Ҫ��ҳ����ʵ�֡�
...
openNode���Ӹýڵ㿪ʼ��չ�������е��ӽڵ㡣����Ϊһ��С��0��ֵ�����ʾ�����ͽṹȫ��չ����
path��webӦ�õ����ƣ�
checkedid���ѱ�ѡ�еĽڵ㣬��","�ָ���ַ�����
checkedno������ѡ�Ľڵ㣬��","�ָ���ַ�����
name��  ���ͽṹ��checkbox���nameֵ,���磺window.tawApparatusroomForm.cid;
jsName��������ͽṹ��checkbox�󣬴�����js����;
*/
...
* checkedid���ѱ�ѡ�еĽڵ㣻checkedno������ѡ�Ľڵ㣻path��·��
* name��checkbox������
* ���ܣ�ʵ�ָ�ѡ��ͼ�����ҿ�����ͬһ��ҳ���ж����ͼ
*/
