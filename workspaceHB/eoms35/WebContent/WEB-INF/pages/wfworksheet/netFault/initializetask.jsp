...
<html:form action="/netFault.do?method=newTaskPerformAdd" styleId="theform" target="myname">
    ...
    <table class="formTable">
        <tr>
            <td class="label"><bean:message bundle="netFault" key="netFault.linkUrgency"/>*</td>
        ...
        <tr>
            <td class="label"><bean:message bundle="netFault" key="netFault.linkReqCompleteTime"/>*</td>
            <td class="content">
            ...
            <td class="label"><bean:message bundle="netFault" key="netFault.linkAcceptDept"/>*</td>
            <td class="content">
        ...
        <tr>
            <td class="label"><bean:message bundle="netFault" key="netFault.linkSendSheetDesc"/>*</td>
            <td colspan="3">
    ...
    <c:if test="${phaseId=='UserTask'}">
        ...
        <fieldset id="link1">
            <legend>
                <bean:message bundle="netFault" key="role.toOrgName"/>
