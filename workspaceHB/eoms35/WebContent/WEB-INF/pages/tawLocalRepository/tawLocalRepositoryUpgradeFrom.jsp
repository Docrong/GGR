...
<table class="formTable">
	<caption>
		<div class="header center"><fmt:message key="tawLocalRepositoryUp.form.heading"/><font color="red">${saveFlag }</font></div>
	</caption>
...
<html:hidden property="oper" value="${oper}"/>
	<tr>
		...
		<td class="content">
			<input type="hidden" name="beforeHardwareRepository" id="beforeHardwareRepository" value="${tawLocalRepositoryUpForm.beforeHardwareRepository}">
			<eoms:id2nameDB id="${tawLocalRepositoryUpForm.beforeHardwareRepository}" beanId="ItawSystemDictTypeDao"/>
		</td>
	</tr>
	...
	<tr>
		...
		<td class="content">
			<input type="hidden" name="beforeSoftwareRepository" id="beforeSoftwareRepository" value="${tawLocalRepositoryUpForm.beforeSoftwareRepository}">
			<eoms:id2nameDB id="${tawLocalRepositoryUpForm.beforeSoftwareRepository}" beanId="ItawSystemDictTypeDao"/>
		</td>
	</tr>
	...
	<tr>
		...
		<td class="content">${tawLocalRepositoryUpForm.beforePatch}
			<input type="hidden" name="beforePatch" id="beforePatch" value="${tawLocalRepositoryUpForm.beforePatch}">
		</td>
	</tr>
...
<table>
	<tr>
		...
		<input type="button" class="btn" value="<fmt:message key="button.back"/>" onclick="window.location = '${app}/repository/tawLocalRepositorys.do?method=queryHistory';"/>
		</td>
	</tr>
</table>
