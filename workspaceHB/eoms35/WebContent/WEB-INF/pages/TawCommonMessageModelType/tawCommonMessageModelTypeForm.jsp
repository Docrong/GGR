...
<html:form action="saveTawCommonMessageModelType" method="post" styleId="tawCommonMessageModelTypeForm"
    ...
    <ul>
        ...
        <li class="buttonBar bottom">
            ...
            <html:submit styleClass="button" property="method.delete"
                         onclick="bCancel=true; return confirmDelete('TawCommonMessageModelType')">
