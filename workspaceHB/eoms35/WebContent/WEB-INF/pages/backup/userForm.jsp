...
<html:form action="saveUser" styleId="userForm" onsubmit="return validateUserForm(this)">
    ...
    <ul>
        ...
        <li>
            <eoms:label styleClass="desc" key="userForm.username"/>
        ...
        <c:if test="${cookieLogin != 'true'}">
            <li>
                <div>
                    <div class="left">
                        <eoms:label styleClass="desc" key="userForm.password"/>
                        <html:errors property="password"/>
                        <html:password styleClass="text medium" property="password" onchange="passwordChanged(this)"
                                       styleId="password" redisplay="true"/>
                    </div>
                    <div>
                        <eoms:label styleClass="desc" key="userForm.confirmPassword"/>
                        <html:errors property="confirmPassword"/>
                        <html:password styleClass="text medium" property="confirmPassword" styleId="confirmPassword"
                                       redisplay="true"/>
                    </div>
                </div>
            </li>
        ...
        <li>
            <eoms:label styleClass="desc" key="userForm.passwordHint"/>
        ...
        <li>
            <div>
                <div class="left">
                    <eoms:label styleClass="desc" key="userForm.firstName"/>
                    <html:errors property="firstName"/>
                    <html:text styleClass="text medium" property="firstName" styleId="firstName" maxlength="50"/>
                </div>
                <div>
                    <eoms:label styleClass="desc" key="userForm.lastName"/>
        ...
        <li>
            <div>
                <div class="left">
                    <eoms:label styleClass="desc" key="userForm.email"/>
                    <html:errors property="email"/>
                    <html:text styleClass="text medium" property="email" styleId="email"/>
                </div>
                <div>
                    <eoms:label styleClass="desc" key="userForm.phoneNumber"/>
        ...
        <li>
            <eoms:label styleClass="desc" key="userForm.website"/>
        ...
        <li>
            ...
            <div class="group">
                ...
                <div>
                    ...
                    <p><eoms:label key="userForm.addressForm.province"/></p>
                </div>
                <div class="left">
                    ...
                    <p><eoms:label key="userForm.addressForm.postalCode"/></p>
                </div>
                <div>
                    <eoms:country name="countries" toScope="page"/>
                    ...
                    <p><eoms:label key="userForm.addressForm.country"/></p>
                </div>
            </div>
        </li>
        <c:choose>
            <c:when test="${param.from == 'list' or param.method == 'Add'}">
                <li>
                    <fieldset>
                        ...
                        <label for="credentialsExpired" class="choice"><fmt:message
                                key="userForm.credentialsExpired"/></label>
                    </fieldset>
                </li>
                <li>
                    <fieldset>
