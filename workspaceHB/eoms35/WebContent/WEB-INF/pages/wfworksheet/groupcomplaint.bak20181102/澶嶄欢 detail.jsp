    ...
    Ext.onReady(function () {
        var tabConfig = {
            items: [{
                ...
                url: 'groupcomplaint.do?method=showSheetDealList&sheetKey=${sheetMain.id}'
            }, {
		...
		<td class="content">
            ...
            <table class="formTable">
                ...
                <tr>
                    ...
                    <td class="content"><eoms:id2nameDB id="${sheetMain.btype1}" beanId="ItawSystemDictTypeDao"/></td>
                    <td class="label"><bean:message bundle="group" key="groupcomplaint.bservType"/></td>
                    <td class="content"><eoms:id2nameDB id="${sheetMain.bservType}"
                                                        beanId="ItawSystemDictTypeDao"/></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="content" colspan="3"><eoms:id2nameDB id="${sheetMain.affectedAreas}"
                                                                    beanId="ItawSystemDictTypeDao"/></td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="content"><eoms:id2nameDB id="${sheetMain.ecsiType}" beanId="ItawSystemDictTypeDao"/></td>
                    <td class="label"><bean:message bundle="group" key="groupcomplaint.connectType"/></td>
                    <td class="content"><eoms:id2nameDB id="${sheetMain.connectType}"
                                                        beanId="ItawSystemDictTypeDao"/></td>
                </tr>

                <tr>
                    <td class="label"><bean:message bundle="group" key="groupcomplaint.termType"/></td>
                    <td class="content" colspan="3"><bean:write name="sheetMain" property="termType"
                                                                scope="request"/></td>
                </tr>
            ...
            <tr>
                ...
                %>
                    ...
                    <select id="dealSelector"
                        ...
                        <!-- 流程步骤，移交，阶段回复，分派 -->
                        <option value="${urlShowTransmitDealPage}"><bean:message bundle="group"
                                                                                 key="operateType.transmit1"/></option>
                        <option value="${urlShowCompleteDealPage}"><bean:message bundle="group"
                                                                                 key="operateType.dealComplete"/></option>
                        <option value="${urlShowTransferPage}"><bean:message bundle="sheet"
                                                                             key="common.transfer"/></option>
                        <option value="${urlShowSendExaminePage}"><bean:message bundle="group"
                        ...
                        <option value="${urlShowInputSplit}">
                            ...
                            <!-- 不需要等待回复 -->
                                <% if (ifwaitfor.equals("false")) {%>
                        <option value="${urlShowDispatchPage}"><bean:message bundle="group"
                    ...
                    <select id="dealSelector">
                        ...
                        <option value="${urlShowRejectBackPage}"><bean:message bundle="sheet"
                                                                               key="common.rejectBack"/></option>
                        <%} else if (taskStatus.equals(Constants.TASK_STATUS_CLAIMED)) { %>
                        <option value="${urlShowCheckYesDealPage}"><bean:message bundle="group"
                                                                                 key="operateType.checkYes"/></option>
                        <option value="${urlShowCheckNoDealPage}"><bean:message bundle="group"
                    ...
                    <select id="dealSelector">
                        <option value="${urlShowDraftDealPage}"><bean:message bundle="group"
                                                                              key="operateType.reSend"/></option>
                    </select>
                    <%} else if (taskName.equals("ExamineHumTask")) {%>
                    <select id="dealSelector">
                        <option value="${urlShowExamineYesDealPage}"><bean:message bundle="group"
                                                                                   key="operateType.Examine"/></option>
                        <option value="${urlShowExamineNoDealPage}"><bean:message bundle="group"
                    ...
                    <select id="dealSelector">
                        <option value="${urlShowHoldDealPage}"><bean:message bundle="group"
                                                                             key="operateType.hold"/></option>
                        <option value="${urlShowRejectDealPage}"><bean:message bundle="group"
