            ...
            <div id="plan-info" class="tabContent">
                ...
                <table class="formTable">
                    ...
                    <tr>
                        ...
                        <td class="content" colspan="3">
                            <textarea cols="50" class="textarea max"
                                      readonly="readonly">${trainPlanForm.trainContent}</textarea>
                        </td>
                    </tr>
                    <tr>
                        <td class="label">
            ...
            <div id="enter-info" class="tabContent">
                ...
                >
                    ...
                    <display:column property="trainEnterTel" sortable="false"
                                    headerClass="sortable" titleKey="trainEnter.trainEnterTel" paramId="id"
                                    paramProperty="id"/>

                    <display:column property="trainEnterTime" sortable="false" format="{0,date,yyyy-MM-dd HH:mm:ss}"
                                    headerClass="sortable" titleKey="trainEnter.trainEnterTime" paramId="id"
                                    paramProperty="id"/>
            ...
            <div id="feedback-info" class="tabContent">
                ...
                >
                    ...
                    <display:column property="trainFeedbackTel" sortable="false"
                                    headerClass="sortable" titleKey="trainFeedback.trainFeedbackTel" paramId="id"
                                    paramProperty="id"/>

                    <display:column property="trainFeedbackTime" sortable="false" format="{0,date,yyyy-MM-dd HH:mm:ss}"
                                    headerClass="sortable" titleKey="trainFeedback.trainFeedbackTime" paramId="id"
                                    paramProperty="id"/>
