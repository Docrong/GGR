                            ...
                            <table border="0" width="95%" cellspacing="1" cellpadding="1" class="table_show"
                                ...
                                <tr class="tr_show">
                                    <td width="30%" class="clsfth" height="25">&nbsp;<bean:message
                                            key="class.name"/></td>
                                    <td width="70%" height="25"><bean:write name="tawClassMsg" property="cname"
                                                                            scope="request"/></td>
                                </tr>
                                <tr class="tr_show">
                                    <td width="30%" class="clsfth" height="25">&nbsp;<bean:message
                                            key="class.note"/></td>
                                    <td width="70%" height="25"><bean:write name="tawClassMsg" property="note"
                                                                            scope="request"/></td>
                                </tr>
                            </table>
                            <table align="center" border="0" width="95%" cellspacing="0">
                                <tr>
                                    <td width="100%" align="right" height="32">
                                        &nbsp;&nbsp;
                                        <INPUT class="clsbtn2" id=button type=button value=
                                            <bean:message key="label.add"/> name=button
                                               Onclick="window.location.href ='../storage/addclass.do?id=<bean:write
                                                       name='tawClassMsg' property='id' scope='request'/>&deleted=
                                                   <bean:write name='tawClassMsg' property='deleted'
                                                               scope='request'/>'">
                                        &nbsp;&nbsp;
                                        <INPUT class="clsbtn2" id=button type=button value=
                                            <bean:message key="label.edit"/> name=button
                                               Onclick="window.location.href ='../storage/editclass.do?id=<bean:write
                                                       name='tawClassMsg' property='id' scope='request'/>'">
                                        &nbsp;&nbsp;
                                        <INPUT class="clsbtn2" id=button type=button value=
                                            <bean:message key="label.remove"/> name=button
                                               Onclick="onPublic(<bean:write name='tawClassMsg' property='id'
                                                                             scope='request'/>);">
                                        &nbsp;&nbsp;
                                    </td>
                                </tr>
