	    ...
	    <tr>
			  ...
			  <td class="content"><bean:write name="sheetMain" property="mainCompleteTime" scope="request"/></td>               
	              ...
	              <tr>
            			  ...
            			  scope="request" idField="${sheetPageName}mainEmergencyPlan" appCode="emergencydrill" viewFlag="Y"/> 
		                </td>
		            </tr>
   </table>
...
<div class="sheet-deal">
	...
	<%if(taskName.equals("MakeProgramTask")){ %>
		<select id="dealSelector">
		 ...
		 <%if(ifwaitfor.equals("false")) {%>	    
		  <option value="${urlShowMakeProgramTaskDealPage}"><bean:message bundle="emergencydrill" key="operateType.MakeProgram"/> </option>
	...
	<%}else if(taskName.equals("AuditProgramTask")){%>	
		<select id="dealSelector">
		 ...
		 <%if(ifsub.equals("") || ifsub.equals("false")){%>
		 <%if(ifwaitfor.equals("false")) {%>	
		  <option value="${urlShowAuditProgramTaskDealPage}"><bean:message bundle="emergencydrill" key="operateType.AuditProgram"/></option>
	...
	<%}else if(taskName.equals("ImplementProgramTask")){%>	
		<select id="dealSelector">
		 ...
		 <%if(ifsub.equals("") || ifsub.equals("false")){%>
		 <%if(ifwaitfor.equals("false")) {%>	    
		  <option value="${urlShowImplementProgramTaskDealPage}"><bean:message bundle="emergencydrill" key="operateType.ImplementProgram"/> </option>
		 <option value="${urlShowTransferkPage}"><bean:message bundle="sheet" key="common.transfer"/></option>
		  <option value="${urlShowPhaseReplyPage}"><bean:message bundle="sheet" key="event.reply"/></option>
		  <%}%>
		  <%}else{%> 
		...
		<%if(taskStatus.equals(Constants.TASK_STATUS_READY)){%>
		 ...
		 <%if(ifsub.equals("") || ifsub.equals("false")){%>
		 <%if(ifwaitfor.equals("false")) {%>
		  <option value="${urlShowSubmitSummaryTaskDealPage}"><bean:message bundle="emergencydrill" key="operateType.SubmitSummary"/></option>		  
		  <option value="${urlShowTransferkPage}"><bean:message bundle="sheet" key="common.transfer"/></option>
		  <option value="${urlShowPhaseReplyPage}"><bean:message bundle="sheet" key="event.reply"/></option>
		  <%}%>
		  <%}else{%> 
		...
		<%if(taskStatus.equals(Constants.TASK_STATUS_READY)){%>
		 ...
		 <%if(ifsub.equals("") || ifsub.equals("false")){%>
		 <%if(ifwaitfor.equals("false")) {%>	
		  <option value="${urlShowAuditSummaryTaskDealPage}"><bean:message bundle="emergencydrill" key="operateType.AuditSummary"/></option>
		   <option value="${urlShowTransferAuditPage}"><bean:message bundle="sheet" key="common.transferAudit"/></option>	  		 	
		  <option value="${urlShowPhaseReplyPage}"><bean:message bundle="sheet" key="event.reply"/></option>
		  <%}%>
		  <%}else{%> 
		...
		<%if(taskStatus.equals(Constants.TASK_STATUS_READY)){%>
		 ...
		 <%if(ifsub.equals("") || ifsub.equals("false")){%>
		 <%if(ifwaitfor.equals("false")) {%>
		  <option value="${urlShowAmendmentProgramTaskDealPage}"><bean:message bundle="emergencydrill" key="operateType.AmendmentProgram"/></option>		  
		  <option value="${urlShowTransferkPage}"><bean:message bundle="sheet" key="common.transfer"/></option>
		  <option value="${urlShowPhaseReplyPage}"><bean:message bundle="sheet" key="event.reply"/></option>
		  <%}%>
		  <%}else{%> 
	...
	<%}else if(taskName.equals("DraftTask")){%>	
		<select id="dealSelector">
		  <option value="${urlShowDraftDeal}"><bean:message bundle="emergencydrill" key="operateType.draft"/></option>
		</select>
	...
	<%}else if(taskName.equals("HoldTask")){ %>
		<select id="dealSelector">
		  <option value="${urlShowHoldDealPage}"><bean:message bundle="emergencydrill" key="operateType.hold"/></option>
		  <option value="${urlShowRejectBackTDealPage}"><bean:message bundle="emergencydrill" key="operateType.back"/></option>
		</select>						
	<%}%>			
