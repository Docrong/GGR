...
<div id="sheetform">
    <html:form action="/equipmentsecurityresponse.do?method=performDealReplyReject" styleId="theform">
        <%
        ...
        <input type="hidden" name="subtaskName" value="EquipmentSecurityResponseSubTask"/>
        ...
        <input type="hidden" name="taskNamespace" value="http://EquipmentSecurityResponse"/>
