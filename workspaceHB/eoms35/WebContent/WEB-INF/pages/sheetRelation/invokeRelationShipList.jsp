...
<bean:message bundle="sheet" key="sheet.sheetRelation.mySend" /> 
 <table class="listTable" width="100%" cellpadding="0" cellspacing="0">
	<tr>
		...
		<td class="label" width="35%"><bean:message bundle="sheet"key="sheet.sheetRelation.sheetTitle" /></td>		
		<td class="label" width="25%"><bean:message bundle="sheet"key="sheet.sheetRelation.sendTime" /></td>
		<td class="label" width="25%"><bean:message bundle="sheet"key="sheet.sheetRelation.invokeNode" /></td>		
	</tr>

	<logic:present name="FROMRELATIONLIST" scope="request">
		<logic:iterate id="tawSheetRelation" name="FROMRELATIONLIST" type="com.boco.eoms.sheet.tool.relation.webapp.form.TawSheetRelationForm">
			<tr>
				<td class="label">
				  <c:choose>
				...
				<td class="label">
				  <a onclick=openSheet('<bean:write name="tawSheetRelation" property="currentFlowName" scope="page" />','<bean:write name="tawSheetRelation" property="currentId" scope="page" />','<bean:write name="tawSheetRelation" property="taskName"  scope="page" />')>
				    <bean:write name="tawSheetRelation" property="currentSheetId" scope="page" />
				  </a>
				</td>
				<td class="label"><bean:write name="tawSheetRelation" property="currentTitle" scope="page" /></td>				
				<td class="label"><bean:write name="tawSheetRelation" property="invokeTime"  scope="page" /></td>
			    <td class="label"><bean:write name="tawSheetRelation" property="taskCnName"  scope="page" /></td>
			    </tr>
		</logic:iterate>
	</logic:present>
</table>
...
<bean:message bundle="sheet" key="sheet.sheetRelation.sendToMe" />
 <table class="listTable" width="100%" cellpadding="0" cellspacing="0">
	...
	<logic:present name="TORELATIONLIST" scope="request">
		<logic:iterate id="tawSheetRelation" name="TORELATIONLIST" type="com.boco.eoms.sheet.tool.relation.webapp.form.TawSheetRelationForm">
			<tr>
				<td class="label">
				  <bean:write name="tawSheetRelation" property="parentFlowCnName" scope="page" /></td>
				<td class="label">
				  <a onclick=openSheet('<bean:write name="tawSheetRelation" property="parentFlowName" scope="page" />','<bean:write name="tawSheetRelation" property="parentId" scope="page" />')>
				    <bean:write name="tawSheetRelation" property="parentSheetId" scope="page" />
				  </a>
				</td>
				<td class="label"><bean:write name="tawSheetRelation" property="parentTitle" scope="page" /></td>				
				<td class="label"><bean:write name="tawSheetRelation" property="invokeTime"  scope="page" /></td>
			    <td class="label"><bean:write name="tawSheetRelation" property="taskCnName" scope="page" /></td>
			    </tr>
		</logic:iterate>
