    ...
    <table width="100%">
        <tr>
            ...
            <td>
                ...
                <input type="hidden" id="completeTimeLimitStartDateExpression"
                       name="completeTimeLimitStartDateExpression" value=">="/>
                <input type="text" name="completeTimeLimitStartDate"
                ...
                to
                <input type="hidden" id="completeTimeLimitEndDateExpression" name="completeTimeLimitEndDateExpression"
                       value="<=">
                <input type="text" name="completeTimeLimitEndDate" id="completeTimeLimitEndDate"
        ...
        <tr>
            ...
            <td colspan="3">
                ...
                <eoms:comboBox name="mainNetSortOneChoiceExpression" id="mainSafeAuditType1" sub="mainSafeAuditType2"
                               initDicId="1010104"/>
                <input type="hidden" name="main.mainSafeAuditType2"/>
                <eoms:comboBox name="mainNetSortTwoChoiceExpression" id="mainSafeAuditType2" sub="mainSafeAuditType3"/>
                <input type="hidden" name="main.mainSafeAuditType3"/>
                <eoms:comboBox name="mainNetSortThreeChoiceExpression" id="mainSafeAuditType3"/>
