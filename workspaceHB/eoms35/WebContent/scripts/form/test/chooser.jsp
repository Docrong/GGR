...
<form id="frm">
    ...
    ></eoms:xbox>
    --%>
    <eoms:xbox id="dictTree" dataUrl="${app}/xtree.do?method=dict" rootId="1010104" rootText="专业树" valueField="saved2"
               handler="usert"
    ...
    <eoms:chooser id="test0"
                  category="[{id:'send1',text:'派发1',childType:'user,dept',limit:3,allowBlank:false},{id:'copy2',text:'copy2'}]"/>
    ...
    <input type="button" value="setDataUrl"
           onclick="javascript:chooser_test.setDataUrl('/xtree.do?method=userFromDept',1)">
    ...
    <input type="button" value="0limitto2"
           onclick="javascript:chooser_test.category[0].attr('limit',2);chooser_test.reset();">
    <br/><br/>
