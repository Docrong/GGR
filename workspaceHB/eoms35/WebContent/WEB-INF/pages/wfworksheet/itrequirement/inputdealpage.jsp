...
<%@ include file="/WEB-INF/pages/wfworksheet/itrequirement/baseinputlinkhtmlnew.jsp"%>
    ...
    <input type="hidden" name="${sheetPageName}linkClassName" value="com.boco.eoms.sheet.itrequirement.model.ITRequirementLink"/>
	            ...
	            <input type="hidden" name="${sheetPageName}operateType" id="${sheetPageName}operateType" value="<%=operateType %>" />
			      ...
			      <tr>
		             <td  class="label"><bean:message bundle="itrequirement" key="itrequirement.linkAuditDesc"/>*</td>
		              <td colspan="3"> 	
    				 <textarea class="textarea max" name="${sheetPageName}linkAuditDesc" id="${sheetPageName}linkAuditDesc" alt="width:500,allowBlank:false,maxLength:255,vtext:'请填入审批意见，最多输入125字'">${sheetLink.linkAuditDesc}</textarea>
                    </td>
		          </tr>
		          <%}} %>
			 ...
			 <!--       <tr>
			      ...
			      <tr>
		            <td  class="label"><bean:message bundle="itrequirement" key="itrequirement.linkAnalysisDesc"/>*</td>
		              <td colspan="3"> 	
    				  <textarea class="textarea max" name="${sheetPageName}linkAnalysisDesc" id="${sheetPageName}linkAnalysisDesc" alt="width:500,allowBlank:false,maxLength:255,vtext:'请填入需求分析概述，最多输入125字'">${sheetLink.linkAnalysisDesc}</textarea>
                    </td>
		          </tr>
		     	<tr>
		            <td  class="label"><bean:message bundle="itrequirement" key="itrequirement.linkHardWareExp"/>*</td>
		              <td colspan="3"> 	
    				  <textarea class="textarea max" name="${sheetPageName}linkHardWareExp" id="${sheetPageName}linkHardWareExp" alt="width:500,allowBlank:false,maxLength:255,vtext:'请填入硬件扩容需求，最多输入125字'">${sheetLink.linkHardWareExp}</textarea>
                    </td>
		          </tr>
			      <tr>
		            <td  class="label"><bean:message bundle="itrequirement" key="itrequirement.linkSystemImpact"/>*</td>
		              <td colspan="3"> 	
    				  <textarea class="textarea max" name="${sheetPageName}linkSystemImpact" id="${sheetPageName}linkSystemImpact" alt="width:500,allowBlank:false,maxLength:255,vtext:'请填入系统性能影响，最多输入125字'">${sheetLink.linkSystemImpact}</textarea>
                    </td>
		          </tr>
			      <tr>
		            <td  class="label"><bean:message bundle="itrequirement" key="itrequirement.linkOtherImpact"/>*</td>
		              <td colspan="3"> 	
    				  <textarea class="textarea max" name="${sheetPageName}linkOtherImpact" id="${sheetPageName}linkOtherImpact" alt="width:500,allowBlank:false,maxLength:255,vtext:'请填入其他影响，最多输入125字'">${sheetLink.linkOtherImpact}</textarea>
                    </td>
		          </tr>     
		             <tr>
					    <td class="label">
	                ...
	                <tr>
  						<td class="label"><bean:message bundle="itrequirement" key="itrequirement.linkTechnicalprogram"/></td>
		   				 <td  colspan='3'>
		   				 <eoms:attachment idList="" scope="request" idField="${sheetPageName}linkTechnicalprogram" name="sheetLink" property="linkTechnicalprogram" appCode="itrequirementsheet" alt="allowBlank:true"/>
		                </td>
		            </tr>
		            <%}}%>
               ...
               if(operateType.equals("93")){%>
				   ...
				   <tr>
		            <td  class="label"><bean:message bundle="itrequirement" key="itrequirement.linkRequirementDesc"/>*</td>
		              <td colspan="3"> 	
    				  <textarea class="textarea max" name="${sheetPageName}linkRequirementDesc" id="${sheetPageName}linkRequirementDesc" alt="width:500,allowBlank:false,maxLength:255,vtext:'请填入需求概述，最多输入125字'">${sheetLink.linkRequirementDesc}</textarea>
                    </td>
		          </tr>
		             <tr>
					    <td class="label">
	                ...
	                <tr>
  						<td class="label"><bean:message bundle="itrequirement" key="itrequirement.linkRequirementDetail"/>*</td>
		   				 <td  colspan='3'>
		   				 <eoms:attachment scope="request" idList="" idField="${sheetPageName}linkRequirementDetail" property="linkRequirementDetail" name="sheetLink" appCode="itrequirementsheet" alt="allowBlank:false"/>
		                </td>
		            </tr>
		    <%}} %>
	            ...
	            <input type="hidden" name="${sheetPageName}operateType" id="${sheetPageName}operateType" value="<%=operateType %>" />	        
			      ...
			      <tr>
		            <td  class="label"><bean:message bundle="itrequirement" key="itrequirement.linkCompleteDesc"/>*</td>
		              <td colspan="3"> 	
    				  <textarea class="textarea max" name="${sheetPageName}linkCompleteDesc" id="${sheetPageName}linkCompleteDesc" alt="width:500,allowBlank:false,maxLength:255,vtext:'请填入完成情况概述，最多输入125字'">${sheetLink.linkCompleteDesc}</textarea>
                    </td>
		          </tr>
		            <%}} %>
	          ...
	          if(operateType.equals("97")|| operateType.equals("11")){%>
		           ...
		           <td class="content"> 
		            <input class="text" onclick="popUpCalendar(this, this)" type="text" 
			  	   ...
			  	   <tr><td class="label">调用IT需求开发流程*</td>
			      ...
			      <tr>
		            <td  class="label"><bean:message bundle="itrequirement" key="itrequirement.linkReplyDesc"/>*</td>
		              <td colspan="3"> 	
    				  <textarea class="textarea max" name="${sheetPageName}linkReplyDesc" id="${sheetPageName}linkReplyDesc" alt="width:500,allowBlank:false,maxLength:255,vtext:'请填入回复内容，最多输入125字'">${sheetLink.linkReplyDesc}</textarea>
                    </td>
		          </tr>
			      <tr>
		        <%}}%>			       
	        ...
	        <input type="hidden" name="${sheetPageName}operateType" id="${sheetPageName}operateType" value="<%=operateType %>" />	
		      <tr>
                <td  class="label"><bean:message bundle="itrequirement" key="itrequirement.linkTestDesc"/>*</td>
                 <td colspan="3"> 	
  				  <textarea class="textarea max" name="${sheetPageName}linkTestDesc" id="${sheetPageName}linkTestDesc" alt="allowBlank:false,maxLength:255,vtext:'请填入测试说明，请最多输入125字'">${sheetLink.linkTestDesc}</textarea>
                  </td>
          </tr>    	    
