					...
					-->
                            ...
                            <c:forEach items="${choiceList1}" var="item1">
                                <c:if test="${item1.questionsID==item.questionID}">
                                    <tr>
                                        <td colspan="2">
                                            <input type="radio" id="${item.questionID}" name="${item.questionID}"
                                                   value="${item1.orderBy}"/>${item1.orderBy},${item1.content}
                                        </td>
                                    </tr>
                                </c:if>
                            </c:forEach>
					...
					-->
                            ...
                            <c:forEach items="${choiceList2}" var="item1">
                                <c:if test="${item1.questionsID==item.questionID}">
                                    <tr>
                                        <td colspan="2">
                                            <input type="checkbox" id="${item.questionID}" name="${item.questionID}"
                                                   value="${item1.orderBy}"/>${item1.orderBy},${item1.content}
            ...
            <tr id="typeTable4">
                ...
                <td colspan="2">
					...
					-->
                            ...
                            <tr>
                                <td colspan="2">
                                    <input type="text" class="text max" id="${item.questionID}"
                                           name="${item.questionID}" value=""/>
                                </td>
                            </tr>
                        </c:forEach>
                    </table>
            ...
            <tr id="typeTable5">
                ...
                <td colspan="2">
					...
					-->
                            ...
                            <tr>
                                <td colspan="2">
                                    <textarea name="${item.questionID}" id="${item.questionID}"
