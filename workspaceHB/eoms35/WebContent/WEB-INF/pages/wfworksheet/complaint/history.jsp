        ...
        <logic:iterate id="baselink" name="HISTORY" type="com.boco.eoms.sheet.complaint.model.ComplaintLink">
            ...
            <div class="history-item"><!-- add space to hack ie-->&nbsp;
                <div class="history-item-title">
                    ...
                    <eoms:dict key="dict-sheet-complaint" dictId="activeTemplateId"
                               itemId="${baselink.activeTemplateId}" beanId="id2descriptionXML"/>
                    <bean:message bundle="complaint" key="complaint.operateType"/>:
                    <eoms:dict key="dict-sheet-complaint" dictId="mainOperateType" itemId="${baselink.operateType}"
                ...
                <div class="history-item-content hide">
                    ...
                    <table class="history-item-table" width="100%" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td class="column-content">
                                <eoms:dict key="dict-sheet-complaint" dictId="mainOperateType"
                        ...
                        <tr>
                            ...
                            <td class="column-content">
                                <bean:write name="baselink" property="linkFaultStartTime" format="yyyy-MM-dd HH:mm:ss"
                                            scope="page"/>
                            </td>
                            <td class="column-title">
                            ...
                            <td class="column-content">
                                <bean:write name="baselink" property="linkFaultEndTime" format="yyyy-MM-dd HH:mm:ss"
                                            scope="page"/>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="column-content">
                                <bean:write name="baselink" property="issueEliminatTime" format="yyyy-MM-dd HH:mm:ss"
                                            scope="page"/>
                            </td>
                            <td class="column-title">
                        ...
                        <c:if test="${baselink.linkIsComplaintSolve == '1030101'}">
                            <tr>
                                ...
                                <td class="column-content" colspan="3">
                                    <bean:write name="baselink" property="linkComplaintSolveDate" scope="page"
                                                formatKey="date.formatDateTimeAll"/>
                                </td>
                            </tr>
                        </c:if>
                        <c:if test="${baselink.linkIsComplaintSolve == '1030102'}">
                            <tr>
                                ...
                                <td class="column-content">
                                    <eoms:id2nameDB id="${baselink.linkPlanSolveTypeparent}"
                                                    beanId="ItawSystemDictTypeDao"/>-<eoms:id2nameDB
                                        id="${baselink.linkPlanSolveType}" beanId="ItawSystemDictTypeDao"/>
                                </td>
                                <c:if test="${baselink.linkPlanSolveTypeparent == '101061601'}">
                                    ...
                                    <td class="column-content">
                                        <bean:write name="baselink" property="linkPlanSolveDate" scope="page"
                                                    formatKey="date.formatDateTimeAll"/>
                                    </td>
                                </c:if>
                            </tr>
                        ...
                        <tr>
                            ...
                            <td class="column-content" colspan="3">
                                ...
                                <c:if test="${baselink.linkIsUserConfirm == '1030102'}">
                                    <br>原因 :
                                    <pre><bean:write name="baselink" property="linkNoConfirmReason" scope="page"/></pre>
                                </c:if>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="column-content">
                                ...
                                <c:if test="${baselink.linkIsRepeatComplaint == '1030101'}">
                                    <br>重复投诉原因 : <eoms:id2nameDB id="${baselink.linkRepeatComplaintType}"
                            ...
                            <td class="column-content">
                                ...
                                <c:if test="${baselink.linkIsReciveFaultId == '101061503'}">
                                    <br>不满意原因 :
                                    <pre><bean:write name="baselink" property="linkUserNoStatisfied"
                                                     scope="page"/></pre>
                                </c:if>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="column-content" colspan="3">
                                ...
                                <c:if test="${baselink.linkIsContactUser == '1030101'}">
                                    <br>联系时间 : <bean:write name="baselink" property="linkContactDate" scope="page"
                                                           formatKey="date.formatDateTimeAll"/>
                                    <br>联系方式 : <eoms:id2nameDB id="${baselink.linkContactship}"
                                                               beanId="ItawSystemDictTypeDao"/>
                                ...
                                <c:if test="${baselink.linkIsContactUser == '1030102'}">
                                    <br>未与用户联系原因 : <eoms:id2nameDB id="${baselink.linkNoContactReason}"
                                                                   beanId="ItawSystemDictTypeDao"/>
                                </c:if>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="column-content" colspan="3">
                                ...
                                <c:if test="${baselink.linkIsAlarm == '1030101'}">
                                    ...
                                    <br>故障工单号 : <bean:write name="baselink" property="linkCommonfaultNumber"
                                                            scope="page"/>
                                </c:if>
                            </td>
                        </tr>
