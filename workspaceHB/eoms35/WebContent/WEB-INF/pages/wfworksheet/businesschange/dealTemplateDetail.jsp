...
<%@ include file="/WEB-INF/pages/wfworksheet/businesschange/baseinputlinkhtmlnew.jsp"%>
 <html:form action="/businesschange.do" styleId="theform">       
	<br/>
               ...
               <input type="hidden" name="${sheetPageName}mainClassName" value="com.boco.eoms.sheet.businesschange.model.businesschangeMain"/>	<!--main\u8868Model\u5bf9\u8c61\u7c7b\u540d-->	
               <input type="hidden" name="${sheetPageName}linkClassName" value="com.boco.eoms.sheet.businesschange.model.businesschangeLink"/> <!--link\u8868Model\u5bf9\u8c61\u7c7b\u540d-->
		...
		<%if(taskName.equals("TaskCreateAuditHumTask")){ %>	 
		    ...
		    <input type="hidden" name="${sheetPageName}operateType" id="${sheetPageName}operateType" value="<%=operateType %>" /> 		     
		      <%if(operateType.equals("205")){ //执行回复%>
        	  	...
        	  	<tr>
		            ...
		            <td  class="content"> 
		             <eoms:comboBox name="${sheetPageName}ndeptContact" id="${sheetPageName}ndeptContact" 
            	        initDicId="1010509"  alt="allowBlank:false" defaultValue="${sheetPageName}ndeptContact" styleClass="select-class"/>
		           <td  class="label"><bean:message bundle="businesschange" key="businesschange.ndeptContactPhone"/>*</td>
		            <td  class="content"> <input type="text"  class="text" name="${sheetPageName}ndeptContactPhone" value="${sheetLink.ndeptContactPhone}" id="${sheetPageName}ndeptContactPhone"  alt="allowBlank:false"/></td>
		          </tr>
		        <!-- GPRS -->
				...
				<tr>
		            ...
		            <td  class="content" colspan='3'> <input type="text"  class="text" name="${sheetPageName}apnID" id="${sheetPageName}apnID"  value="${sheetLink.apnID}" alt="allowBlank:false"/></td>
		            </tr>	
                </logic:equal>			        
				...
				<tr>
		            ...
		            <td  class="content"> <input type="text"  class="text" name="${sheetPageName}loginUserNam" id="${sheetPageName}loginUserNam"  value="${sheetLink.loginUserNam}" alt="allowBlank:false"/></td>
		            <td  class="label"><bean:message bundle="businesschange" key="businesschange.loginUserPassWord"/>*</td>
		            <td class="content"> <input type="text"  class="text" name="${sheetPageName}loginUserPas" id="${sheetPageName}loginUserPas"  value="${sheetLink.loginUserPassWord}" alt="allowBlank:false"/></td>
		          </tr>	
                </logic:equal>		          
		          <!-- SMS -->
				...
				<tr>
		            ...
		            <td  class="label"><bean:message bundle="businesschange" key="businesschange.loginUserPassWord"/>*</td>
		            <td class="content"> <input type="text"  class="text" name="${sheetPageName}loginUserPas" id="${sheetPageName}loginUserPas" value="${sheetLink.loginUserPas}" alt="allowBlank:false"/></td>
		          </tr>	
                 </logic:equal>	
		          <!-- chuanshu -->
                 <logic:equal value="101100104" property="businesstype1" name="sheetMain">        
     	          <tr >
		            ...
		            <td  class="content"> <input type="text"  class="text" name="${sheetPageName}expectFinish" id="${sheetPageName}expectFinish"  value="${sheetLink.expectFinish}" alt="allowBlank:true"/></td>
		            <td  class="label"><bean:message bundle="businesschange" key="businesschange.circuitCode"/></td>
		            <td  class="content"> <input type="text"  class="text" name="${sheetPageName}circuitCode" id="${sheetPageName}circuitCode"  value="${sheetLink.circuitCode}" alt="allowBlank:true"/></td>
		          </tr>
		          
		          <tr>
		            <td  class="label"><bean:message bundle="businesschange" key="businesschange.netResCapacity"/></td>
		            <td  class="content"> <input type="text"  class="text" name="${sheetPageName}netResCapaci" id="${sheetPageName}netResCapaci"  value="${sheetLink.netResCapaci}" alt="allowBlank:true"/></td>
                    <td  class="label"><bean:message bundle="businesschange" key="businesschange.clientPgmCapacity"/></td>
		            <td  class="content"> <input type="text"  class="text" name="${sheetPageName}clientPgmCap" id="${sheetPageName}clientPgmCap"  value="${sheetLink.clientPgmCap}" alt="allowBlank:true"/></td>
		           ...
		           <tr>
		             ...
		             <td  class="label"><bean:message bundle="businesschange" key="businesschange.dealResult"/>*</td>
            	      ...
            	      initDicId="1010509"  alt="allowBlank:false" defaultValue="${sheetLink.dealResult}" styleClass="select-class"/>
			        </td>	
			       </tr>
			      <tr>
        	    ...
        	    <%}else if(operateType.equals("206")){ //回复送审%>
        	      ...
        	      <tr>
		            ...
		            <td  class="content"> 
		             <eoms:comboBox name="${sheetPageName}ndeptContact" id="${sheetPageName}ndeptContact" 
            	        initDicId="1010509"  alt="allowBlank:false" defaultValue="${sheetLink.ndeptContact}" styleClass="select-class"/>
		           <td  class="label"><bean:message bundle="businesschange" key="businesschange.ndeptContactPhone"/>*</td>
        	    ...
        	    <%}else if(operateType.equals("10")){ //分派%>
        	       ...
        	       <tr>
		            <td  class="label"><bean:message bundle="businesschange" key="businesschange.transmitReason"/></td>
		              <td colspan="3"> 	
    				  <textarea class="textarea max" name="${sheetPageName}transmitReason" id="${sheetPageName}transmitReason" alt="width:500,allowBlank:true">${sheetLink.transmitReason }</textarea>
                    </td>
		          </tr>
         	 ...
         	 <%if(operateType.equals("212")){ %>
         		 <input type="hidden" name="${sheetPageName}phaseId" id="${sheetPageName}phaseId" value="ExcuteHumTask" />   		 
         		  <tr>
		            <td  class="label"><bean:message bundle="businesschange" key="businesschange.dealResult"/></td>
		              <td colspan="3"> 	
    				  <textarea class="textarea max" name="${sheetPageName}dealResult" id="${sheetPageName}dealResult" alt="width:500,allowBlank:true">${sheetLink.dealResult }</textarea>
                    </td>
		          </tr>            
         ...
         <%}else if( taskName.equals("HoldHumTask")){%>
		  ...
		  <tr>
		    ...
		    <td colspan="3">
		      <textarea name="${sheetPageName}endResult" alt="allowBlank:false,maxLength:1000,vtext:'${eoms:a2u('请填入信息，最多输入1000字')}'" id="${sheetPageName}endResult"  class="textarea max">${sheetMain.endResult}</textarea>
		    </td>
		  </tr>					       			     	
     	    <%}%>
