            ...
            <table class="formTable">
                <tr>
                    ...
                    <td class="content"><bean:write name="sheetMain" property="sheetAcceptLimit"
                                                    ...
                                                    scope="request"/></td>
                    <td class="label"><bean:message bundle="businessdredge"
                                                    key="businessdredge.sheetcompletelimit"/></td>
                ...
                <tr>
                    ...
                    <td class="label"><bean:message bundle="businessdredge"
                                                    key="businessdredge.bdeptContactPhone"/></td>
                ...
                <tr>
                    ...
                    <td class="label"><bean:message bundle="businessdredge"
                                                    key="businessdredge.customContactPhone"/></td>
                ...
                <tr>
                    ...
                    <td class="label"><bean:message bundle="businessdredge"
                                                    key="businessdredge.cmanagerContactPhone"/></td>
                ...
                <tr>
                    ...
                    <td class="content"><eoms:id2nameDB id="${sheetMain.factureArea}"
                                                        beanId="ItawSystemDictTypeDao"/></td>
                ...
                <tr>
                    ...
                    <td class="label"><bean:message bundle="businessdredge"
                                                    key="businessdredge.radiusValidateIPAdd"/></td>
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <eoms:attachment name="sheetMain" property="numDetailFile"
                                         ...
                                         appCode="businessdredge" viewFlag="Y"/>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="label"><bean:message bundle="businessdredge"
                                                    key="businessdredge.siconnectMMSGatewayName"/></td>
                ...
                <tr>
                    ...
                    <td class="label"><bean:message bundle="businessdredge"
                                                    key="businessdredge.SIConnectMMSGatewayID"/></td>
                ...
                <tr>
                    ...
                    <td class="content"><eoms:id2nameDB id="${sheetMain.comProtocol}"
                                                        beanId="ItawSystemDictTypeDao"/></td>
                    <td class="label"><bean:message bundle="businessdredge"
                                                    key="businessdredge.connectGatewayBandwidth"/></td>
                ...
                <tr>
                    ...
                    <td class="label"><bean:message bundle="businessdredge"
                                                    key="businessdredge.flowControlPriority"/></td>
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <eoms:attachment name="sheetMain" property="appProgramme"
                                         scope="request" idField="${sheetPageName}appProgramme" appCode="businessdredge"
                                         viewFlag="Y"/></td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="label"><bean:message bundle="businessdredge"
                                                    key="businessdredge.connectGatewayName"/></td>
                ...
                <tr>
                    <td class="label"><bean:message bundle="businessdredge"
                                                    key="businessdredge.authenticationModel"/></td>
                ...
                <tr>
                    ...
                    <td class="content"><eoms:id2nameDB id="${sheetMain.betweenNetwork}"
                                                        beanId="ItawSystemDictTypeDao"/></td>
                </tr>
                ...
                <tr>
                    <td class="label"><bean:message bundle="businessdredge"
                                                    key="businessdredge.portAInterfaceType"/></td>
                ...
                <tr>
                    <td class="label"><bean:message bundle="businessdredge"
                                                    key="businessdredge.portZInterfaceType"/></td>
                ...
                <tr>
                    ...
                    <td class="label"><bean:message bundle="businessdredge"
                                                    key="businessdredge.portZContactPhone"/></td>
                ...
                <tr>
                    <td class="label"><bean:message bundle="businessdredge"
                                                    key="businessdredge.portAContactPhone"/></td>
            ...
            <tr>
                <td width="50%">
                    ...
                    <select id="dealSelector">
                        ...
                        <option value="${urlShowNewAuditPassPage}"><bean:message bundle="businessdredge"
                                                                                 key="businessdredge.taskpass"/></option>
                        <option value="${urlShowNewAuditUnpassPage}"><bean:message bundle="businessdredge"
                                                                                   key="businessdredge.tasknopass"/></option>
                        <%} %>
                    </select>
                    ...
                    <select id="dealSelector">
                        ...
                        <option value="${urlShowRejectBackPage}"><bean:message bundle="sheet"
                                                                               key="common.rejectBack"/></option>
                        <%} else if (taskStatus.equals(Constants.TASK_STATUS_CLAIMED)) { %>
                        <option value="${urlShowTaskCompleteAuditYes}"><bean:message bundle="businessdredge"
                                                                                     key="businessdredge.TaskCompleteAuditYes"/></option>
                        <option value="${urlShowTaskCompleteAuditNo}"><bean:message bundle="businessdredge"
                                                                                    key="businessdredge.TaskCompleteAuditNo"/></option>
                        <%} %>
                    </select>
                    ...
                    <select id="dealSelector">
                        ...
                        <option value="${urlShowRejectBackPage}"><bean:message bundle="sheet"
                                                                               key="common.rejectBack"/></option>
                        <%} else if (taskStatus.equals(Constants.TASK_STATUS_CLAIMED)) { %>
                        <option value="${urlShowCompleteDealPage}"><bean:message bundle="businessdredge"
                                                                                 key="businessdredge.dealwcnosp"/></option>
                        ...
                        <option value="${urlShowPassDealPage}"><bean:message bundle="businessdredge"
                                                                             key="businessdredge.totaskcompsq"/></option>
                    ...
                    <select id="dealSelector">
                        <option value="${urlShowExamineNODealPage}"><bean:message bundle="businessdredge"
                                                                                  key="businessdredge.dealrejectpass"/></option>
                        <option value="${urlShowExamineDealPage}"><bean:message bundle="businessdredge"
                                                                                key="businessdredge.nopassback"/></option>
                    </select>
                    <%} else if (taskName.equals("DraftHumTask")) {%>
                    <select id="dealSelector">
                        <option value="${urlShowCompleteDraftPage}"><bean:message bundle="businessdredge"
                                                                                  key="businessdredge.draft"/></option>
                    </select>
                    <%} else if (taskName.equals("HoldHumTask")) { %>
                    <select id="dealSelector">
                        <option value="${urlShowHoldDealPage}"><bean:message bundle="businessdredge"
                                                                             key="businessdredge.Hold"/></option>
                    </select>
