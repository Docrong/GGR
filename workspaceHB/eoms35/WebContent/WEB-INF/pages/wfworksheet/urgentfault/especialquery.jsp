...
<table class="formTable">
    ...
    <tr>
        <td class="label">
            <bean:message bundle="urgentfault" key="urgentfault.mainNetSortOne"/>
        </td>
        <td>
    ...
    <tr>
        <td class="label">
            <bean:message bundle="urgentfault" key="urgentfault.mainNetSortTwo"/>
        </td>
        <td>
    ...
    <tr>
        <td class="label">
            <bean:message bundle="urgentfault" key="urgentfault.mainNetSortThree"/>
        </td>
        <td>
