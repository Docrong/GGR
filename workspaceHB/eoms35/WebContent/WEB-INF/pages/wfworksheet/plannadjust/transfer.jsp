...
<div id="sheetform">
    <html:form action="/plannadjust.do?method=performTransferWorkItem" styleId="theform">
        ...
        <input type="hidden" name="mainClassName" id="mainClassName"
               value="com.boco.eoms.sheet.plannadjust.model.PlannAdjustMain"/>
        <input type="hidden" name="linkClassName" id="linkClassName"
               value="com.boco.eoms.sheet.plannadjust.model.PlannAdjustLink"/>
        ...
        <div class="form-btns">
            ...
            <input type="submit" class="submit"
                   onclick="v.passing=true;this.form.action='${app}/sheet/plannadjust/plannadjust.do?method=performSaveInfo'"
