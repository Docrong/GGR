...
<html>
<head><title>颜色选择器</title></head>
<body align=center>
<form>
    <P align=center><font size=-1 color=red>单击颜色，再单击关闭按钮<br>或直接双击选中颜色</font></p>
    <table>
        <tr>
            <td colspan=4 bgcolor=balck onclick='window.returnValue="black";'
                ondblclick='window.returnValue="black";self.close();' align=center>默认颜色
            </td>
        </tr>
        <%
            String colors[] = {
        ...
        <tr>
            <td colspan=4 align=center>
                <input type='button' value='关闭'
                       onclick='if(window.returnValue==null){window.returnValue="black";}self.close();'>
            </td>
        </tr>
