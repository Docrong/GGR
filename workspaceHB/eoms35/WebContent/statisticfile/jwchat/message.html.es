    ...
    <body style="margin:8px;">
        ...
        <tr height="100%">
            <td style="padding-top: 4px;">
                <iframe src="chat_iframe.html" id="msgbox" name="msgbox" scrolling="auto"
        ...
        <tr id="reply_buttons">
            <td align="right">
                <button onClick="return reply(true);">Citar</button>
                &nbsp;
                <button onClick="return reply();">Responder</button>
                &nbsp;
                <button onClick="return openChat();">Iniciar charla</button>
            </td>
        </tr>

        <tr>
            <td align="right" style="padding-top: 4px;">
                <button onClick="return prev();" id="prevButton">anterior</button>
                &nbsp;
                <button onClick="return next();" id="nextButton">siguiente</button>
                &nbsp;
