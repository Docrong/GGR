    ...
    <table border="0" width="95%" cellspacing="1" class="formTable">
        ...
        <logic:iterate id="tawTestcardManager" name="tawTestcardManager"
            ...
            <tr bgcolor="#FFFFFF">
                ...
                <td nowrap align="center"><bean:write name="tawTestcardManager" property="belongtime"
                                                      scope="page"/></td>
                ...
                <td nowrap align="center"><INPUT TYPE="checkbox" name="id"
                                                 value="<bean:write name="tawTestcardManager" property="id" scope="page"/>">
                </td>
