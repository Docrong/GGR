...
<table id="sheet" class="formTable">
    ...
    <tr>
        ...
        <td>
            <input type="text" class="text" name="mainGroupSheetId" id="mainGroupSheetId"
                   alt="allowBlank:true,maxLength:1000,vtext:'请填入 集团投诉工单号 信息，最多输入 1000 字符'"
                   value="${sheetMain.mainGroupSheetId}"/>
        </td>
        <td class="label">
            <!-- 产品实例标识 -->
        ...
        <td>
            <input type="text" class="text" name="mainProductIns" id="mainProductIns"
                   alt="allowBlank:true,maxLength:1000,vtext:'请填入 产品实例标识 信息，最多输入 1000 字符'"
                   value="${sheetMain.mainProductIns}"/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <input type="text" class="text" name="mainUserAffilia" id="mainUserAffilia"
                   alt="allowBlank:true,maxLength:1000,vtext:'请填入 用户归属地 信息，最多输入 1000 字符'"
                   value="${sheetMain.mainUserAffilia}"/>
        </td>
    </tr>
