    <%@ include file="/portal/common/taglibs-portal.jsp" %>
        ...
        /portal/light/scripts/lightPortal.js"></script>
        <script language="JavaScript" src="<%= request.getContextPath() %>
        /portal/light/scripts/lightPortlet.js"></script>
        <script language="JavaScript" src="<%= request.getContextPath() %>
        /portal/light/scripts/locale/lightResourceBundle<%= (session.getAttribute("currentLocale") != null) ? "_"+(String)session.getAttribute("currentLocale") : "" %>
        .js"></script>
        <LINK href="<%= request.getContextPath() %>
        /portal/light/<%= (session.getAttribute("theme") != null) ? (String)session.getAttribute("theme") : "theme/master.css"%>
        ...
        <img src="<%= request.getContextPath() %>/portal/light/images/spacer.gif" style="border: 0px" width="100"
        height="20" />
