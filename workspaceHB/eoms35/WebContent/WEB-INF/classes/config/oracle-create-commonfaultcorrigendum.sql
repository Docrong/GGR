...
alter table COMMONFAULTCORRIGENDUM_MAIN
    add constraint COMMONFAULTCORRIGENDUM_MAIN_PK primary key (id) using index;
...
alter table COMMONFAULTCORRIGENDUM_TASK
    add constraint COMMONFAULTCORRIGENDUM_TASK_PK primary key (id) using index;
...
values ('xls,txt,doc,jpg,gif', 'commonfaultcorrigendum', '故障工单勘误流程流程', 1024, '/sheet/commonfaultcorrigendum', 105,
        '402881be48bf6ff00148bf6ff1590000');

--插入菜单
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402881be48bf6ff00148bf6ff1590001', '9701', '1', '新增工单', '97', null,
        '/sheet/commonfaultcorrigendum/commonfaultcorrigendum.do?method=showNewSheetPage', '0', '0', 1);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402881be48bf6ff00148bf6ff1590002', '9703', '0', '待处理工单', '97', null, null, '0', '0', 3);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402881be48bf6ff00148bf6ff1590003', '970301', '1', '待办工单', '9703', null,
        '/sheet/commonfaultcorrigendum/commonfaultcorrigendum.do?method=showListsendundo', '0', '0', 1);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402881be48bf6ff00148bf6ff1590004', '9707', '1', '工单查询', '97', null,
        '/sheet/commonfaultcorrigendum/commonfaultcorrigendum.do?method=showQueryPage', '0', '0', 7);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402881be48bf6ff00148bf6ff1590005', '9708', '1', '工单处理模板', '97', null,
        '/sheet/commonfaultcorrigendum/commonfaultcorrigendum.do?method=getDealTemplatesByUserId&type=templateManage',
        '0', '0', 8);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402881be48bf6ff00148bf6ff1590006', '9709', '1', '工单模板管理', '97', null,
        '/sheet/commonfaultcorrigendum/commonfaultcorrigendum.do?method=getTemplatesByUserId&type=templateManage', '0',
        '0', 9);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402881be48bf6ff00148bf6ff1590007', '9710', '1', '管理者工单', '97', null,
        '/sheet/commonfaultcorrigendum/commonfaultcorrigendum.do?method=showListForAdmin', '0', '0', 10);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402881be48bf6ff00148bf6ff1590008', '97', '0', '故障工单勘误流程流程', '10', null,
        '/sheet/commonfaultcorrigendum/commonfaultcorrigendum.do?method=showDrawing', '0', '0', 20);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402881be48bf6ff00148bf6ff1590009', '9702', '1', '草稿列表', '97', null,
        '/sheet/commonfaultcorrigendum/commonfaultcorrigendum.do?method=showDraftList', '0', '0', 2);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402881be48bf6ff00148bf6ff159000a', '9704', '0', '已处理工单', '97', null, null, '0', '0', 4);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402881be48bf6ff00148bf6ff159000b', '970402', '1', '建立工单', '9704', null,
        '/sheet/commonfaultcorrigendum/commonfaultcorrigendum.do?method=showOwnStarterList', '0', '0', 2);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402881be48bf6ff00148bf6ff159000c', '970401', '1', '处理工单', '9704', null,
        '/sheet/commonfaultcorrigendum/commonfaultcorrigendum.do?method=showListsenddone', '0', '0', 1);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402881be48bf6ff00148bf6ff159000d', '9705', '1', '已归档工单', '97', null,
        '/sheet/commonfaultcorrigendum/commonfaultcorrigendum.do?method=showHoldedList', '0', '0', 5);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402881be48bf6ff00148bf6ff159000e', '9706', '1', '已作废工单', '97', null,
        '/sheet/commonfaultcorrigendum/commonfaultcorrigendum.do?method=showCancelList', '0', '0', 6);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402881be48bf6ff00148bf6ff159000f', '9711', '1', '超时时间设置', '97', null,
        '/sheet/overtimetip/overtimetip.do?flowName=CommonfaultCorrigendum', '0', '0', 11);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402881be48bf6ff00148bf6ff1590010', '9712', '1', '工单处理时限配置', '97', null,
        '/sheet/newSheetLimit/sheetLimit.do?method=getLevelLimitList&flowName=CommonfaultCorrigendum', '0', '0', 30);