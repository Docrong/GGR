...
insert into taw_system_application(app_name,notes,domain_type) values('资源确认流程','资源确认流程',1);
insert into taw_system_workflow(name,flowid,sheetid,remark,mainservicebeanid) values('ResourceAffirmProcess','031','01','资源确认流程','iResourceAffirmMainManager');
