...
<fmt:bundle basename="com/boco/eoms/km/config/applicationResource-kmmanager">
    ...
    <display:table name="kmAskQuestionList" cellspacing="0" cellpadding="0"
        ...
        <display:column property="name" sortable="true"
                        ...
                        href="${app}/kmmanager/kmAskQuestions.do?method=attend" paramId="id" paramProperty="id"/>
        ...
        <display:column sortable="false" headerClass="sortable" titleKey="kmAskQuestion.questionStatus">
            <eoms:dict key="dict-kmmanager" dictId="questionStatus" itemId="${kmAskQuestionList.questionStatus}"
                       beanId="id2nameXML"/>
        </display:column>
