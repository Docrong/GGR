...
public class TransferSpecialLineForm extends BaseForm implements java.io.Serializable {

    protected String id;
    protected String orderSheet_Id;
    protected String cityA;
    protected String cityZ;
    protected String bandwidth;
    protected String amount;
    protected String portA;
    protected String portAInterfaceType;
    protected String portADetailAdd;
    protected String portABDeviceName;
    protected String portABDevicePort;
    protected String portAContactPhone;
    protected String portZ;
    protected String portZInterfaceType;
    protected String portZDetailAdd;
    protected String portZBDeviceName;
    protected String portZBDevicePort;
    protected String portZContactPhone;
    protected String isBeforehandOccupy;
    protected String specialtyType;
    protected String circuitCode;
    protected String circuitName;
    protected String circuitRate;
