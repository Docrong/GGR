...
<%@ include file="/WEB-INF/pages/wfworksheet/itsoftchange/baseinputlinkhtmlnew.jsp"%>
 <html:form action="/itsoftchange.do" styleId="theform">       
	<br/>
               ...
               <input type="hidden" name="${sheetPageName}mainClassName" value="com.boco.eoms.sheet.itsoftchange.model.ITSoftChangeMain"/>	<!--main表Model对象类名-->	
               <input type="hidden" name="${sheetPageName}linkClassName" value="com.boco.eoms.sheet.itsoftchange.model.ITSoftChangeLink"/> <!--link表Model对象类名-->
			  ...
			  <%if(taskName.equals("OperateTask")){ 
	            ...
	            <input type="hidden" name="${sheetPageName}operateType" id="${sheetPageName}operateType" value="<%=operateType %>" />
     		      ...
     		      <tr>
		            ...
		            <td  colspan="3"> <input type="text"  class="text" name="${sheetPageName}linkDevContacter" id="${sheetPageName}linkDevContacter"  alt="allowBlank:false,,maxLength:50,vtext:'请填入开发人员及联系方式，最多输入25字'"/></td>
		          </tr>
			      <tr>
		            <td  class="label"><bean:message bundle="itsoftchange" key="itsoftchange.linkCompleteDesc"/>*</td>
		              <td colspan="3"> 	
    				  <textarea class="textarea max" name="${sheetPageName}linkCompleteDesc" id="${sheetPageName}linkCompleteDesc" alt="width:500,allowBlank:false,maxLength:500,vtext:'请填入完成说明，最多输入250字'">${sheetLink.linkCompleteDesc}</textarea>
                    </td>
		          </tr>
		             <tr>
					    <td class="label">
	            ...
	            <input type="hidden" name="${sheetPageName}operateType" id="${sheetPageName}operateType" value="<%=operateType %>" />
		           ...
		           <td class="content"> 
		            ...
		            <td  class="label"><bean:message bundle="itsoftchange" key="itsoftchange.linkTestDesc"/>*</td>
		              <td colspan="3"> 	
    				  <textarea class="textarea max" name="${sheetPageName}linkTestDesc" id="${sheetPageName}linkTestDesc" alt="width:500,allowBlank:false,maxLength:500,vtext:'请填入测试说明，最多输入250字'">${sheetLink.linkTestDesc}</textarea>
                    </td>
		          </tr>       
		             <tr>
					    <td class="label">
	            ...
	            <input type="hidden" name="${sheetPageName}operateType" id="${sheetPageName}operateType" value="<%=operateType %>" />
				  ...
				  <tr>
		            ...
		            <td  class="label"><bean:message bundle="itsoftchange" key="itsoftchange.linkOnlineDesc"/>*</td>
		              <td colspan="3"> 	
    				  <textarea class="textarea max" name="${sheetPageName}linkOnlineDesc" id="${sheetPageName}linkOnlineDesc" alt="width:500,allowBlank:false,maxLength:500,vtext:'请填入上线说明，最多输入250字'">${sheetLink.linkOnlineDesc}</textarea>
                    </td>
		          </tr> 				       
		             <tr>
					    <td class="label">
	                ...
	                <tr>
  						<td class="label"><bean:message bundle="itsoftchange" key="itsoftchange.linkUserNoteDesc"/>*</td>
		   				 <td  colspan='3'>
		   				 <eoms:attachment idList="" scope="request" idField="${sheetPageName}linkUserNoteDesc" name="sheetLink" property="linkUserNoteDesc" appCode="itsoftchangesheet" alt="allowBlank:false"/>
		                </td>
		            </tr>		            				  
		            <%}}%>		                 
    	...
    	<tr>
	       <td class="label">
			...
			<td colspan="3">			
		        ...
		        alt="allowBlank:false,maxLength:500,width:500,vtext:'请填入信息，最多输入250字'" alt="width:'500px'">${sheetLink.remark}</textarea>
		  </td>
		</tr>  	
		...
		<%} %>
         ...
         <%if(taskName.equals("HoldTask")) {%>  	
		   ...
		   <tr>
		           ...
		           <td> <input type="text"  class="text" name="${sheetPageName}linkAnalysisCount" id="${sheetPageName}linkAnalysisCount"  alt="allowBlank:false,,maxLength:50,vtext:'请填入需求分析工作量，最多输入25字'"/></td>
		      </tr>
		      <tr>
		           <td  class="label"><bean:message bundle="itsoftchange" key="itsoftchange.linkTestCount"/>*</td>
		           <td > <input type="text"  class="text" name="${sheetPageName}linkTestCount" id="${sheetPageName}linkTestCount"  alt="allowBlank:false,,maxLength:50,vtext:'请填入现场实施与测试工作量，最多输入25字'"/></td>
		           <td  class="label"><bean:message bundle="itsoftchange" key="itsoftchange.linkDevCount"/>*</td>
		           <td> <input type="text"  class="text" name="${sheetPageName}linkDevCount" id="${sheetPageName}linkDevCount"  alt="allowBlank:false,,maxLength:50,vtext:'请填入研发工作量，最多输入25字'"/></td>
		         </tr>			
			 <tr>
	       ...
	       <td class="label">
			...
			<td colspan="3">			
			 <input type="hidden" name="${sheetPageName}operateType" id="${sheetPageName}operateType" value="-15" />
		           <textarea name="${sheetPageName}remark" class="textarea max" id="${sheetPageName}remark" 
		        alt="allowBlank:false,maxLength:500,vtext:'请填入信息，最多输入250字'" alt="width:'500px'">${sheetLink.remark}</textarea>
		  </td>
		</tr>  
          <%} %>     
