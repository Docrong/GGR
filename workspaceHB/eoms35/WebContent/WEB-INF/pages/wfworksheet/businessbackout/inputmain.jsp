...
<table class="formTable">
    <tr>
        ...
        <td>
            <eoms:comboBox name="${sheetPageName}btype1" id="${sheetPageName}btype1" defaultValue="${sheetMain.btype1}"
                           initDicId="1011001" alt="allowBlank:false,vtext:'${eoms:a2u('请选择集团客户业务分类！')}'"
                           styleClass="select-class" onchange="changeOperate(this);"/>
        </td>
        ...
        <td><eoms:comboBox name="${sheetPageName}urgentDegree" id="${sheetPageName}urgentDegree"
                           initDicId="1010102" defaultValue="${sheetMain.urgentDegree}"
                           alt="allowBlank:false,vtext:'${eoms:a2u('请选择紧急程度！')}'" styleClass="select-class"/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            ...
            --%>
            <input type="text" class="text" value="${sheetMain.bdeptContact}" name="${sheetPageName}bdeptContact"
        ...
        <td><input type="text" class="text" value="${sheetMain.bdeptContactPhone}"
                   name="${sheetPageName}bdeptContactPhone" id="${sheetPageName}bdeptContactPhone"
    ...
    <tr>
        ...
        <td><input type="text" class="text" value="${sheetMain.customNo}" name="${sheetPageName}customNo"
                   id="${sheetPageName}customNo"
                   alt="allowBlank:false,maxLength:200,vtext:'${eoms:a2u('请选择集团客户编号，最大长度为100个汉字！')}'"/></td>
        <td class="label"><bean:message bundle="businessbackout" key="businessbackout.customName"/></td>
        <td><input type="text" class="text" value="${sheetMain.customName}" name="${sheetPageName}customName"
                   id="${sheetPageName}customName"
    ...
    <tr>
        ...
        <td><input type="text" class="text" value="${sheetMain.customContact}" name="${sheetPageName}customContact"
                   id="${sheetPageName}customContact"
        ...
        <td><input type="text" class="text" value="${sheetMain.customContactPhone}"
                   name="${sheetPageName}customContactPhone" id="${sheetPageName}customContactPhone"
    ...
    <tr>
        ...
        <td colspan='3'><input type="text" class="text" value="${sheetMain.apnName}" name="${sheetPageName}apnName"
                               id="${sheetPageName}apnName"
    ...
    <tr>
        ...
        <td colspan="3">
            <textarea class="textarea max" name="${sheetPageName}backoutCause" id="${sheetPageName}backoutCause"
                      alt="width:500,allowBlank:false,maxLength:255,vtext:'${eoms:a2u('请输入拆除原因，最大长度为125个汉字！')}'">${sheetMain.backoutCause}</textarea>
        </td>
    </tr>
    </tbody>
    ...
    <tr>
        ...
        <td><input type="text" class="text" value="${sheetMain.bcode}" name="${sheetPageName}bcode"
                   id="${sheetPageName}bcode"
        ...
        <td><input type="text" class="text" value="${sheetMain.enterpriseCode}" name="${sheetPageName}enterpriseCode"
                   id="${sheetPageName}enterpriseCode"
    ...
    <tr>
        ...
        <td><input type="text" class="text" value="${sheetMain.siName}" name="${sheetPageName}siName"
                   id="${sheetPageName}siName"
                   alt="allowBlank:true,maxLength:200,vtext:'${eoms:a2u('请输入EC/SI名称，最大长度为100个汉字！')}'"/></td>
        <td class="label"><bean:message bundle="businessbackout" key="businessbackout.SIEnterpriseCode"/></td>
        <td><input type="text" class="text" value="${sheetMain.siEnterpriseCode}"
                   name="${sheetPageName}siEnterpriseCode" id="${sheetPageName}siEnterpriseCode"
                   alt="allowBlank:true,maxLength:200,vtext:'${eoms:a2u('请输入EC/SI企业代码，最大长度为100个汉字！')}'"/></td>
    </tr>
    <tr>
        <td class="label"><bean:message bundle="businessbackout" key="businessbackout.SIServerCode"/></td>
        <td colspan='3'><input type="text" class="text" value="${sheetMain.siServerCode}"
                               name="${sheetPageName}siServerCode" id="${sheetPageName}siServerCode"
                               alt="allowBlank:true,maxLength:200,vtext:'${eoms:a2u('请输入EC/SI服务代码，最大长度为100个汉字！')}'"/>
        </td>
    ...
    <tr>
        ...
        <td colspan='3'><eoms:comboBox name="${sheetPageName}urgentDegree" id="${sheetPageName}urgentDegree"
                                       initDicId="1010102" defaultValue="${sheetMain.urgentDegree}"
                                       alt="allowBlank:false,vtext:'${eoms:a2u('请选择紧急程度！')}'"
    ...
    <tr>
        ...
        <td><input type="text" class="text" value="${sheetMain.serverCode}" name="${sheetPageName}serverCode"
                   id="${sheetPageName}serverCode"
                   alt="allowBlank:true,maxLength:200,vtext:'${eoms:a2u('请输入服务代码，最大长度为100个汉字！')}'"/></td>
    </tr>
    </tbody>
    ...
    <tr>
        ...
        <td colspan='3'><input type="text" class="text" value="${sheetMain.circuitCode}"
                               name="${sheetPageName}circuitCode" id="${sheetPageName}circuitCode"
