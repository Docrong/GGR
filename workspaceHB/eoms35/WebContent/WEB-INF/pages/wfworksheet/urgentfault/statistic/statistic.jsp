...
<html:form action="/businessdesign.do?method=performStatistic" styleId="theform">
    ...
    <table border="0" cellspacing="1" cellpadding="1" width="60%" align="center" class="table_show">
        ...
        <tr class="tr_show">
            <td noWrap width="20%">${eoms:a2u("选择kpi")}
            </td>
            <td width="80%" colspan=2>

                <select name="kpiDefineName">
                    <option value="jiekourenkpi_role_user">${eoms:a2u("接口人角色kpi考核")}</option>
