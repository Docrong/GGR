...
<div id="sheetform">
<html:form action="/netOptimize.do?method=performDealReplyReject" styleId="theform">
 <%@ include file="/common/taglibs.jsp"%>
<%
 ...
 %>
    ...
    <input type="hidden" name="${sheetPageName}taskNamespace" value="http://NetOptimizeProcess"/>  
<%@ include file="/WEB-INF/pages/wfworksheet/netOptimize/baseinputlinkhtmlnew.jsp"%>
     ...
     <tr>
      ...
      <logic:iterate id="toTask" name="acceptList" type="com.boco.eoms.sheet.netoptimize.task.impl.NetOptimizeTask">  
        <tr>
          <td>
