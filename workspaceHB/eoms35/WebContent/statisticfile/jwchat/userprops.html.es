...
<html>
    <head>
        <title>JWChat - Propiedades de usuario</title>
        <meta http-equiv="content-type" content="text/html; charset=utf-8">
          ...
          function init() {
            ...
            getArgs();
            jid = passedArgs['jid'];
            document.title = "Editar propiedades para "+jid;
            ...
            for (var i=0; i<srcW.roster.groups.length; i++) {
              if (srcW.roster.groups[i].name != "Vac&iacute;o") {
    ...
    <body style="margin: 8px;">
        <form name="userprops">
            <fieldset>
                <legend>Editar apodo para
                    <span id="nickjid"></span>
                </legend>
        ...
        <br>
            <fieldset>
                <legend>Editar grupos para
                    <span id="groupjid"></span>
                </legend>
                <table>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td colspan=2 width="100%;">
                            <select size="9" name="allgrps" style="width:100%"
                                    onChange="setNewGrp(this.selectedIndex);"></select>
                        </td>
                    </tr>
                </table>
            </fieldset>
...
<hr noshade size="1" size="100%">
    <div align="right" id="buttonbox">
        ...
        &nbsp;
        <button onClick="return submitClicked();">Aceptar</button>
    </div>
</form>
</body>
</html>
