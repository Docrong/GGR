...
import com.boco.eoms.sheet.numberapply.dao.INumberApplyMainDAO;
 ...
 */
 ...
 public class NumberApplyMainManagerImpl extends MainService implements INumberApplyMainManager {
	 /**
	  * 
	  */
	public HashMap getListByHqlBy(final Integer curPage,final  Integer pageSize, final String hql,final String condictions, final String modelname) throws Exception {
		return ((INumberApplyMainDAO)this.getMainDAO()).getListByHqlBy(curPage, pageSize, hql, condictions, modelname);
	}
	/**
	...
	public void updateDynamicModel(String modelname, String condiction, String condictionValue, String id) throws Exception {
		((INumberApplyMainDAO)this.getMainDAO()).updateDynamicModel(modelname, condiction, condictionValue, id);
	...
	public void updateResourceClear(String modelname, String sheetKey, String contidion, String condictionValue) throws Exception {
		((INumberApplyMainDAO)this.getMainDAO()).updateResourceClear(modelname, sheetKey, contidion, condictionValue);
	}
	/**
	...
	public void updateResourceOccupied(String modelname, String sheetKey, String id) throws Exception {
		((INumberApplyMainDAO)this.getMainDAO()).updateResourceOccupied(modelname, sheetKey, id);
	}
	/**
	...
	public HashMap getListByCondiction(final Integer curPage, final Integer pageSize,Map condiction, String modelname) throws Exception {
		...
		//获得查询的记录
		Map map = new HashMap();
		map = ((INumberApplyMainDAO)this.getMainDAO()).getListByHqlBy(curPage, pageSize, hqls, condictions, modelname);
		return (HashMap)map;
	}
	/**
	 * 根据拼写的hql去更新
	...
	public void updateModelByHql(String hql) throws Exception {
		((INumberApplyMainDAO)this.getMainDAO()).updateModelByHql(hql);
	}
