...
<table class="formTable">
    ...
    <tr>
        ...
        <td colspan='3'>
            <input type="text" class="text" name="${sheetPageName}linkBusiInputNet"
                   id="${sheetPageName}linkBusiInputNet" alt="allowBlank:true" value="${sheetLink.linkBusiInputNet}"/>
        </td>
    ...
    <tr>
        ...
        <td class="content">
            <input type="text" class="text" name="${sheetPageName}linkPointNumber" id="${sheetPageName}linkPointNumber"
                   alt="allowBlank:false" value="${sheetLink.linkPointNumber}"/>
        </td>
