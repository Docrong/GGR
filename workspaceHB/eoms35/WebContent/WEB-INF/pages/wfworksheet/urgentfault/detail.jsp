...
<div id="sheetinfo"><logic:present name="sheetMain"
	...
	<table class="formTable">
		...
		<tr>
			...
			<eoms:dict key="dict-sheet-urgentfault" dictId="subOperateType" itemId="${sheetMain.mainSendContentType}" beanId="id2nameXML" />
			</td>
		</tr>		
		<tr>
		...
		<tr>
			...
			<td class="content" colspan='3'><pre><bean:write
				name="sheetMain" property="mainFaultDesc" scope="request" /></pre></td>
		</tr>
      ...
      <%} %>
		...
		<tr>
			...
			<td class="content" colspan='3'><pre><bean:write
				name="sheetMain" property="mainAffectOperationDesc" scope="request" /></pre></td>
		</tr>
	...
	<tr>
		...
		<select id="dealSelector">
		 <%if(taskStatus.equals(Constants.TASK_STATUS_READY)){%>
		   ...
		   <option value="${urlShowRejectDealPage}"><bean:message bundle="urgentfault" key="operate.reject" /></option>
		 <%}else if(taskStatus.equals(Constants.TASK_STATUS_CLAIMED)){ %>
			<option value="${urlShowMiddleReportAffirmDealPage}"><bean:message bundle="urgentfault" key="operate.MiddleReportAffirm" /></option>
        ...
        <%}else if(taskName.equals("BackReportAffirmHumTask")){%> 
		 ...
		 <%if(taskStatus.equals(Constants.TASK_STATUS_READY)){%>
		   ...
		   <option value="${urlShowRejectDealPage}"><bean:message bundle="urgentfault" key="operate.reject" /></option>
		 <%}else if(taskStatus.equals(Constants.TASK_STATUS_CLAIMED)){ %>
			<option value="${urlShowBackReportAffirmDealPage}"><bean:message bundle="urgentfault" key="operate.BackReportAffirm" /></option>
		...
		<select id="dealSelector">
		 ...
		 <%}else if(taskStatus.equals(Constants.TASK_STATUS_CLAIMED)){ %>
			<option value="${urlShowSolveFaultDealPage}"><bean:message bundle="urgentfault" key="operate.SolveFault" /></option>
			<option value="${urlShowTransferPage}"><bean:message bundle="sheet" key="common.transfer" /></option>
			<option value="${urlShowPhaseReplyPage}"><bean:message bundle="sheet" key="event.reply" /></option>
            <%}%>
		...
		<select id="dealSelector">
		   ...
		   <option value="${urlShowRejectDealPage}"><bean:message bundle="urgentfault" key="operate.reject" /></option>
		 <%}else if(taskStatus.equals(Constants.TASK_STATUS_CLAIMED)){ %>
			<option value="${urlShowSolveFaultAffirmDealPage}"><bean:message bundle="urgentfault" key="operate.SolveFaultAffirm" /></option>
		...
		<select id="dealSelector">
		   ...
		   <option value="${urlShowRejectDealPage}"><bean:message bundle="urgentfault" key="operate.reject" /></option>
		 <%}else if(taskStatus.equals(Constants.TASK_STATUS_CLAIMED)){ %>
						<option value="${urlShowReportDealPage}"><bean:message bundle="urgentfault" key="operate.Report" /></option>
			<option value="${urlShowTransferPage}"><bean:message bundle="sheet" key="common.transfer" /></option>
			<option value="${urlShowPhaseReplyPage}"><bean:message bundle="sheet" key="event.reply" /></option>
            <%}%>
			<!--  <option value="${urlShowInputSplit1}"><bean:message bundle="sheet" key="common.split"/></option>-->
		...
		<select id="dealSelector">
			<%if(taskStatus.equals(Constants.TASK_STATUS_READY)){%>
		     ...
		     <option value="${urlShowRejectDealPage}"><bean:message bundle="urgentfault" key="operate.reject" /></option>
		   <%}else if(taskStatus.equals(Constants.TASK_STATUS_CLAIMED)){ %>
			<option value="${urlShowSumUpDealPage}"><bean:message bundle="urgentfault" key="operate.SumUp" /></option>
			<option value="${urlShowTransferPage}"><bean:message bundle="sheet" key="common.transfer" /></option>
			<option value="${urlShowPhaseReplyPage}"><bean:message bundle="sheet" key="event.reply" /></option>
            <%}%>
		  </select> 
		  ...
		  <select id="dealSelector">
			   <option value="${urlShowHoldDealPage}"><bean:message bundle="urgentfault" key="operate.Draft" /></option>
		   </select>
		  <%}else if(taskName.equals("BackHumTask")){%> 
		  <select id="dealSelector">
			   <option value="${urlBackDealPage}"><bean:message bundle="urgentfault" key="operate.reSend" /></option>
		   </select>  
		   <%}else if(taskName.equals("HoldHumTask")){ %> 
		<select id="dealSelector">
			<option value="${urlShowHoldDealPage}"><bean:message bundle="urgentfault" key="operate.Hold" /></option>
		</select> <%} else if(taskName.equals("MiddleReportAffirmSubTask")||taskName.equals("BackReportAffirmSubTask")||
...
<c:if test="${sheetMain.status==0}">
	...
	<div id="buttonDisplay" style="display:block"><input type="button"
		...
		value="<bean:message bundle="sheet" key="button.forceHold"/>"
		 onclick="$('buttonDisplay').style.display='none';forceOperation(1);"> <input type="button"
	...
	<div id="advice" style="display:block"><input type="button"
		...
		onclick="$('advice').style.display='none';forceOperation(2);"> <input type="button"
		value="<bean:message bundle="sheet" key="event.advice"/>"
