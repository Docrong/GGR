...
<%@ include file="/common/header_eoms_ext.jsp"%>
  ...
  var config = {
	...
	onClick:{url:"${app}/duty/TawRmAssignwork/select_time.do?roomId=",text:"${eoms:a2u('排班管理')}"},
	ctxMenu:[
		{id:'Child', text:'${eoms:a2u('排班管理')}',cls:'new-mi',url:'${app}/duty/TawRmAssignwork/select_time.do?roomId='}
		 ],//end of ctxMenu 
	/************************
