...
<%
 ...
 %>
	...
	<input type="hidden" name="mainClassName" value="com.boco.eoms.sheet.branchindexreduction.model.BranchIndexReductionMain"/>	
	<input type="hidden" name="linkClassName" value="com.boco.eoms.sheet.branchindexreduction.model.BranchIndexReductionLink"/>
...
<%@ include file="/WEB-INF/pages/wfworksheet/branchindexreduction/baseinputlinkhtmlnew.jsp"%>
     ...
     <tr>
      ...
      <logic:iterate id="toTask" name="acceptList" type="com.boco.eoms.sheet.branchindexreduction.model.BranchIndexReductionTask">  
        <tr>
          <td>
