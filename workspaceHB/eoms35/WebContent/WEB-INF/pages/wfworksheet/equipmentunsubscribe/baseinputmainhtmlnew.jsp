...
<%
 ...
 %>
		...
		<input type="hidden" name="linkBeanId" id="linkBeanId" value="iEquipmentUnsubscribeLinkManager"/>
	  ...
	  <td colspan="3">
	     ...
	     <c:if test="${empty sheetMain.sendRoleId}">       
	        ...
	        <eoms:roleComboBox name="sendRoleId" id="sendRoleId" 
		  	  userId="${sheetMain.sendUserId}" roleId="149" defaultValue="${sheetMain.sendRoleId}"/>     
	     </c:if>
	     <c:if test="${!empty sheetMain.sendRoleId}">
