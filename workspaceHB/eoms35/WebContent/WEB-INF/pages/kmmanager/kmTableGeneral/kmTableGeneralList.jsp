...
<fmt:bundle basename="com/boco/eoms/km/config/applicationResource-kmmanager">
    ...
    <html:form action="/kmTableGenerals.do?method=searchX" styleId="kmTableGeneralForm" method="post">
        ...
        <table align="center">
            <tr>
                ...
                <td>
                    <input type="text" id="tableChname" name="tableChname" class="text"
                           value="${kmTableGeneralForm.tableChname}">
                </td>
                <td>
    ...
    <display:table name="kmTableGeneralList" cellspacing="0"
        ...
        <display:column sortable="true" headerClass="sortable" titleKey="kmTableGeneral.isCreated">
            <eoms:dict key="dict-kmmanager" dictId="isOrNot" itemId="${kmTableGeneralList.isCreated}"
                       beanId="id2nameXML"/>
        </display:column>
