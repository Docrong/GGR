...
<div id="sheetform">
    <html:form action="/securitydeal.do?method=performCreateSubTask" styleId="theform">
      	...
      	<tr>        
	       <td class="label">
			...
			<td colspan="3">			
		        ...
		        alt="allowBlank:false,maxLength:500,vtext:'请填写意见，最多输入250字符'">${sheetLink.remark}</textarea>
