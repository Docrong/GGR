...
<table class="formTable">
            ...
            <tr>	  
				  <td class="label">
				  		<bean:message bundle="emergencydrill" key="emergencydrill.mainNetSortOne"/>
				  </td>
				  <td>
			...
			<tr>			
				  <td class="label">
				  		<bean:message bundle="emergencydrill" key="emergencydrill.mainNetSortTwo"/>
				  </td>
				  <td>
            ...
            <tr>
                <td  class="label">
                		<bean:message bundle="emergencydrill" key="emergencydrill.mainNetSortThree"/>
                </td>
                <td>
