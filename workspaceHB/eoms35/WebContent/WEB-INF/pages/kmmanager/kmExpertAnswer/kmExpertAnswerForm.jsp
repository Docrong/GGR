        ...
        <table class="formTable">
            ...
            <tr>
                ...
                <td class="content">
                    <eoms:comboBox name="type" id="type"
                                   initDicId="1010104" defaultValue="101010401" alt="allowBlank:false,vtext:''"
                                   styleClass="select-class" onchange=""/>
            ...
            <tr>
                ...
                <td class="content" colspan="3">
                    ...
                    <eoms:xbox id="answerUsert" dataUrl="${app}/kmmanager/kmExpertAnswer.do?method=getNodes" rootId="-1"
                               single='true' rootText="请选择专家" valueField="answerUserId" handler="answerUsert"
