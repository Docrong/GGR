...
<html:form action="/smsContentTemplates.do?method=forward2New" method="post" styleId="smsContentTemplateForm">
    <table class="formTable">
        ...
        <logic:iterate id="contentList" name="contentList">
            <tr>
                <td>
                    <a href="${app}/msg/smsContentTemplates.do?method=xeditInit&id=<bean:write name="contentList" property="id" />"><bean:write
                            name="contentList" property="name"/></a>
                </td>
                ...
                <td>
                    <a href="${app}/msg/smsContentTemplates.do?method=xdelete&id=<bean:write name="contentList" property="id" />"><bean:message
