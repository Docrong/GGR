...
<fmt:bundle basename="com/boco/eoms/km/config/applicationResource-kmmanager">
    ...
    <display:table name="personalContributeStatisticList" cellspacing="0" cellpadding="0"
                   id="personalContributeStatisticList" pagesize="${pageSize}"
                   class="table personalContributeStatisticList"
                   export="false"
        ...
        <display:column property="addCount" sortable="true"
                        headerClass="sortable" titleKey="personalContributeStatistic.addCount" paramId="id"
                        paramProperty="id"/>

        <display:column property="modifyCount" sortable="true"
                        headerClass="sortable" titleKey="personalContributeStatistic.modifyCount" paramId="id"
                        paramProperty="id"/>

        <display:column property="overCount" sortable="true"
                        headerClass="sortable" titleKey="personalContributeStatistic.overCount" paramId="id"
                        paramProperty="id"/>

        <display:column property="deleteCount" sortable="true"
                        headerClass="sortable" titleKey="personalContributeStatistic.deleteCount" paramId="id"
                        paramProperty="id"/>

        <display:column property="upCount" sortable="true"
                        headerClass="sortable" titleKey="personalContributeStatistic.upCount" paramId="id"
                        paramProperty="id"/>
