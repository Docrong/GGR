...
<%@ include file="/WEB-INF/pages/wfworksheet/itsoftchange/baseinputlinkhtmlnew.jsp"%>
    ...
    <input type="hidden" name="${sheetPageName}mainClassName" value="com.boco.eoms.sheet.itsoftchange.model.ITSoftChangeMain"/>	
    <input type="hidden" name="${sheetPageName}linkClassName" value="com.boco.eoms.sheet.itsoftchange.model.ITSoftChangeLink"/>
			  ...
			  <%if(taskName.equals("OperateTask")){ 
	            ...
	            <input type="hidden" name="${sheetPageName}operateType" id="${sheetPageName}operateType" value="<%=operateType %>" />
     		      ...
     		      <tr>
		            ...
		            <td  colspan="3"> <input type="text"  class="text" name="${sheetPageName}linkDevContacter" id="${sheetPageName}linkDevContacter"  	
                                            value="${sheetLink.linkDevContacter}" alt="allowBlank:false,,maxLength:50,vtext:'请填入开发人员及联系方式，最多输入25字'"/></td>
		          </tr>
		          <tr>
		            <td  class="label"><bean:message bundle="itsoftchange" key="itsoftchange.linkMakerTestResult"/>*</td>
		              <td colspan="3"> 	
    				  <textarea class="textarea max" name="${sheetPageName}linkMakerTestResult" id="${sheetPageName}linkMakerTestResult" alt="width:500,allowBlank:false,maxLength:255,vtext:'请填入厂家测试结果，最多输入125字'">${sheetLink.linkMakerTestResult}</textarea>
                    </td>
		          </tr><tr>
		            <td  class="label"><bean:message bundle="itsoftchange" key="itsoftchange.linkImpactElseDCL"/>*</td>
		              <td colspan="3"> 	
    				  <textarea class="textarea max" name="${sheetPageName}linkImpactElseDCL" id="${sheetPageName}linkImpactElseDCL" alt="width:500,allowBlank:false,maxLength:255,vtext:'请填入影响其他系统或模块说明，最多输入125字'">${sheetLink.linkImpactElseDCL}</textarea>
                    </td>
		          </tr><tr>
		            <td  class="label"><bean:message bundle="itsoftchange" key="itsoftchange.linkIfNotifyInterfixSystem"/>*</td>
		              <td colspan="3"> 	
    				  <textarea class="textarea max" name="${sheetPageName}linkIfNotifyInterfixSystem" id="${sheetPageName}linkIfNotifyInterfixSystem" alt="width:500,allowBlank:false,maxLength:255,vtext:'请填入是否通知相关系统及沟通情况，最多输入125字'">${sheetLink.linkIfNotifyInterfixSystem}</textarea>
                    </td>
		          </tr>
			      <tr>
		            <td  class="label"><bean:message bundle="itsoftchange" key="itsoftchange.linkCompleteDesc"/>*</td>
		              <td colspan="3"> 	
    				  <textarea class="textarea max" name="${sheetPageName}linkCompleteDesc" id="${sheetPageName}linkCompleteDesc" alt="width:500,allowBlank:false,maxLength:255,vtext:'请填入完成说明，最多输入125字'">${sheetLink.linkCompleteDesc}</textarea>
                    </td>
		          </tr>
		             <tr>
					    <td class="label">
	                ...
	                <tr>
  						<td class="label"><bean:message bundle="itsoftchange" key="itsoftchange.linkTestGuide"/>*</td>
		   				 <td  colspan='3'>
		   				 <eoms:attachment idList="" scope="request" idField="${sheetPageName}linkTestGuide" name="sheetLink" property="linkTestGuide" appCode="itsoftchangesheet" alt="allowBlank:false"/>
		                </td>
		            </tr>		            	             
		          <%}} %>
	            ...
	            <input type="hidden" name="${sheetPageName}operateType" id="${sheetPageName}operateType" value="<%=operateType %>" />
		           ...
		           <td class="content"> 
	                ...
	                <tr>
            	      ...
            	      initDicId="1011406"  alt="allowBlank:false" styleClass="select-class" onchange="ifTestPass(this.value);" defaultValue="${sheetLink.linkTestResult }"/>
			        </td>	                
		             <td  class="label"><bean:message bundle="itsoftchange" key="itsoftchange.linkTestSatisfaction"/>*</td>
            	      ...
            	      initDicId="10303"  alt="allowBlank:false" styleClass="select-class" defaultValue="${sheetLink.linkTestSatisfaction }"/>
			        </td>	                
		            </tr>
		    		<tr>
		            <td  class="label"><bean:message bundle="itsoftchange" key="itsoftchange.linkTestDesc"/>*</td>
		              <td colspan="3"> 	
    				  <textarea class="textarea max" name="${sheetPageName}linkTestDesc" id="${sheetPageName}linkTestDesc" alt="width:500,allowBlank:false,maxLength:255,vtext:'请填入测试说明，最多输入125字'">${sheetLink.linkTestDesc}</textarea>
                    </td>
		          </tr>       
		             <tr>
					    <td class="label">
	                ...
	                <tr>
  						<td class="label"><bean:message bundle="itsoftchange" key="itsoftchange.linkTestNote"/>*</td>
		   				 <td  colspan='3'>
		   				 <eoms:attachment idList="" scope="request" idField="${sheetPageName}linkTestNote" name="sheetLink" property="linkTestNote" appCode="itsoftchangesheet" alt="allowBlank:false"/>
		                </td>
		            </tr>		            				  
		            <%}}%>
				  ...
				  <tr>
		                ...
		                <td class="content">
		                    <input type="text"  class="text" name="${sheetPageName}linkSoftEdition" id="${sheetPageName}linkSoftEdition"  
		                       value="${sheetLink.linkSoftEdition}"    alt="allowBlank:false,,maxLength:100,vtext:'请填入软件版本，最多输入50字'"/></td>
				  </tr>
				  <tr>
		            <td  class="label"><bean:message bundle="itsoftchange" key="itsoftchange.linkSoftEditionDCL"/>*</td>
		              <td colspan="3"> 	
    				  <textarea class="textarea max" name="${sheetPageName}linkSoftEditionDCL" id="${sheetPageName}linkSoftEditionDCL" alt="width:500,allowBlank:false,maxLength:255,vtext:'请填入软件版本说明，最多输入125字'">${sheetLink.linkSoftEditionDCL}</textarea>
                    </td>
		          </tr> 
		    		<tr>
		            <td  class="label"><bean:message bundle="itsoftchange" key="itsoftchange.linkOnlineDesc"/>*</td>
		              <td colspan="3"> 	
    				  <textarea class="textarea max" name="${sheetPageName}linkOnlineDesc" id="${sheetPageName}linkOnlineDesc" alt="width:500,allowBlank:false,maxLength:255,vtext:'请填入上线说明，最多输入125字'">${sheetLink.linkOnlineDesc}</textarea>
                    </td>
		          </tr> 
		           <tr>
		            <td  class="label"><bean:message bundle="itsoftchange" key="itsoftchange.linkUserNoteChangeDCL"/>*</td>
		              <td colspan="3"> 	
    				  <textarea class="textarea max" name="${sheetPageName}linkUserNoteChangeDCL" id="${sheetPageName}linkUserNoteChangeDCL" alt="width:500,allowBlank:false,maxLength:255,vtext:'请填入用户手册变更说明，最多输入125字'">${sheetLink.linkUserNoteChangeDCL}</textarea>
                    </td>
		          </tr> 				       
		             <tr>
					    <td class="label">
	                ...
	                <tr>
  						<td class="label"><bean:message bundle="itsoftchange" key="itsoftchange.linkUserNoteDesc"/></td>
		   				 <td  colspan='3'>
		   				 <eoms:attachment idList="" scope="request" idField="${sheetPageName}linkUserNoteDesc" name="sheetLink" property="linkUserNoteDesc" appCode="itsoftchangesheet" alt="allowBlank:true"/>
		                </td>
		            </tr>		            				  
		            <%}}%>		                 
         ...
         <%if(taskName.equals("HoldTask")) {%>  	
		   ...
		   <tr>
			        ...
			        <eoms:comboBox name="${sheetPageName}linkAuditResult" id="${sheetPageName}linkAuditResult" 
		         	      initDicId="1011407"  alt="allowBlank:false" styleClass="select-class" defaultValue="${sheetLink.linkAuditResult}"/>
		        </td>	                

		           <td  class="label"><bean:message bundle="itsoftchange" key="itsoftchange.linkAnalysisCount"/>*</td>
		           <td> <input type="text"  class="text" name="${sheetPageName}linkAnalysisCount" id="${sheetPageName}linkAnalysisCount" value="${sheetLink.linkAnalysisCount}"  alt="allowBlank:false,maxLength:50,vtext:'请填入需求分析工作量，最多输入25字'"/></td>
		      </tr>
		      <tr>
		           <td  class="label"><bean:message bundle="itsoftchange" key="itsoftchange.linkTestCount"/>*</td>
		           <td > <input type="text"  class="text" name="${sheetPageName}linkTestCount" id="${sheetPageName}linkTestCount" value="${sheetLink.linkTestCount}"  alt="allowBlank:false,maxLength:50,vtext:'请填入现场实施与测试工作量，最多输入25字'"/></td>
		           <td  class="label"><bean:message bundle="itsoftchange" key="itsoftchange.linkDevCount"/>*</td>
		           <td> <input type="text"  class="text" name="${sheetPageName}linkDevCount" id="${sheetPageName}linkDevCount" value="${sheetLink.linkDevCount}" alt="allowBlank:false,maxLength:50,vtext:'请填入研发工作量，最多输入25字'"/></td>
		         </tr>			
			 <tr>
	       ...
	       <td class="label">
			...
			<td colspan="3">			
			 <input type="hidden" name="${sheetPageName}operateType" id="${sheetPageName}operateType" value="-15" />
		           <textarea name="${sheetPageName}remark" class="textarea max" id="${sheetPageName}remark" 
		        alt="allowBlank:false,maxLength:255,vtext:'请填入信息，最多输入125字'" alt="width:'500px'">${sheetLink.remark}</textarea>
		  </td>
		</tr>  
          <%} %>     
