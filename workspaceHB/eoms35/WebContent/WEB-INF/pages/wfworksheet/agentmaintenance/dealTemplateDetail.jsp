...
<%
    com.boco.eoms.sheet.agentmaintenance.model.AgentMaintenanceLink agentmaintenanceLink = (com.boco.eoms.sheet.agentmaintenance.model.AgentMaintenanceLink) request.getAttribute("sheetLink");
    java.lang.String taskName = com.boco.eoms.base.util.StaticMethod.nullObject2String(agentmaintenanceLink.getActiveTemplateId());
    java.lang.String operateType = java.lang.String.valueOf(com.boco.eoms.base.util.StaticMethod.nullObject2String(agentmaintenanceLink.getOperateType()));
%>
<script type="text/javascript">
    ...
    function saveDealTemplate(type) {
        ...
        form.action = "${app}/sheet/agentmaintenance/agentmaintenance.do?method=saveDealTemplate&type=dealTemplateManage&dealTemplateId=${sheetLink.id}";
        form.submit();
    }
...
<html:form action="/agentmaintenance.do" styleId="theform">
    <br/>
    ...
    <table class="formTable">
        <caption><bean:message bundle="agentmaintenance" key="agentmaintenance.header"/></caption>
        <tr>
            <td class="label">
