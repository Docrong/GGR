...
<script type="text/javascript">
    ...
    Ext.onReady(function () {
        ...
        roleTree = new xbox({
            ...
            treeRootId: '-1',
            treeRootText: '<bean:message bundle="sheet" key="sheet.selectRole"/>',
            treeChkMode: '',
            treeChkType: 'subrole',
            showChkFldId: 'showd',
            saveChkFldId: 'operateRoleId'
        });
    ...
    <table class="formTable">
        ...
        <tr>
            ...
            <td width="80%">
                ...
                <select name="reportName">
                    ...
                    %>
                    <option value="<%=sheet.getSheetName() %>"><%=sheet.getSheetName()%>
                    </option>
        ...
        <tr>
            ...
            <td width="80%">
                ...
                <input type="text" name="beginTime" id="beginTime" readonly="readonly"
                       onclick="popUpCalendar(this, this);" class="text"/>
                <bean:message bundle="statistic" key="statistic.end"/>
                <input type="text" name="endTime" id="endTime"
                       alt="allowBlank:false,vtext:'${eoms:a2u("处理时限不能早于回复时限")}'" readonly="readonly"
                       onclick="popUpCalendar(this, this);" class="text"/>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td nowrap>
                <input type="button" class="btn" name="trees" id="trees"
                       value="<bean:message bundle="statistic" key="button.select"/>">
