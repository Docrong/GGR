...
<br/>
     ...
     <tr>
      ...
      <logic:iterate id="toTask" name="toOperaterList" type="com.boco.eoms.sheet.securitydeal.model.SecurityDealTask">  
        <tr>
          <td>
	       ...
	       <td class="label">
			...
			<td colspan="3"> 
		           <textarea name="${sheetPageName}remark" class="textarea max" id="${sheetPageName}remark" 
		              alt="allowBlank:false,maxLength:500,vtext:'请输入意见，最大长度为250个汉字！'">${sheetlink.remark}</textarea>
		  </td>
		</tr>
		</table>
