...
<%@ include file="/WEB-INF/pages/wfworksheet/itrequirement/baseinputlinkhtmlnew.jsp"%>
 <html:form action="/itrequirement.do" styleId="theform">       
	<br/>
               ...
               <input type="hidden" name="${sheetPageName}mainClassName" value="com.boco.eoms.sheet.itrequirement.model.ITRequirementMain"/>	<!--main表Model对象类名-->	
               <input type="hidden" name="${sheetPageName}linkClassName" value="com.boco.eoms.sheet.itrequirement.model.ITRequirementLink"/> <!--link表Model对象类名-->
			      ...
			      <tr>
	                ...
	                <tr>
  						<td class="label"><bean:message bundle="itrequirement" key="itrequirement.linkTechnicalprogram"/></td>
		   				 <td  colspan='3'>
		   				 <eoms:attachment idList=""  idField="${sheetPageName}linkTechnicalprogram" name="sheetLink" property="linkTechnicalprogram" appCode="itrequirementsheet" alt="allowBlank:true"/>
		                </td>
		            </tr>
		            <%}}%>
				   ...
				   <tr>
	                ...
	                <tr>
  						<td class="label"><bean:message bundle="itrequirement" key="itrequirement.linkRequirementDetail"/>*</td>
		   				 <td  colspan='3'>
		   				 <eoms:attachment idList="" idField="${sheetPageName}linkRequirementDetail" property="linkRequirementDetail" name="sheetLink" appCode="itrequirementsheet" alt="allowBlank:false"/>
		                </td>
		            </tr>
		    <%}} %>
