...
<div align="center">
    <center>
        ...
        <table border="0" width="95%" cellspacing="1" bgcolor="#709ED5"
            ...
            <logic:iterate id="tawTestcardManager" name="tawTestcardManager"
                           type="com.boco.eoms.testcard.model.TawTestcardManager">
                <tr bgcolor="#FFFFFF">
                    ...
                    <td nowrap bgcolor="#E5EDF8" align="center" height="30"><html:link
                            href="../TawTestcardManager/useview.do" paramId="id" paramName="tawTestcardManager"
                            paramProperty="id"><bean:message key="label.view"/></html:link></td>
