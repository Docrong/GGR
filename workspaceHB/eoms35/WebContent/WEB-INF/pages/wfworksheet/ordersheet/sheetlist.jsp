...
<table class="listTable" width="100%" cellpadding="0" cellspacing="0">
    ...
    <logic:iterate id="resourceconfirm" name="resourceconfirmList"
                   type="com.boco.eoms.sheet.resourceconfirm.model.ResourceConfirmMain">
        <tr>
            <td class="content">
                <a href="${app}/sheet/resourceconfirm/resourceconfirm.do?method=showDetailPage&sheetKey=${resourceconfirm.id}"
                   target="_blank"><bean:write name="resourceconfirm" property="sheetId" scope="page"/></a>
...
<table class="listTable" width="100%" cellpadding="0" cellspacing="0">
    ...
    <logic:iterate id="businessimplement" name="businessimplementList"
                   type="com.boco.eoms.sheet.businessimplement.model.BusinessImplementMain">
        <tr>
            <td class="content">
                <a href="${app}/sheet/businessimplement/businessimplement.do?method=showDetailPage&sheetKey=${businessimplement.id}"
                   target="_blank"><bean:write name="businessimplement" property="sheetId" scope="page"/></a>
...
<table class="listTable" width="100%" cellpadding="0" cellspacing="0">
    ...
    <logic:iterate id="operationchange" name="operationchangeList"
                   type="com.boco.eoms.sheet.operationchange.model.OperationChangeMain">
        <tr>
            <td class="content">
                <a href="${app}/sheet/operationchange/operationchange.do?method=showDetailPage&sheetKey=${operationchange.id}"
                   target="_blank"><bean:write name="operationchange" property="sheetId" scope="page"/></a>
...
<table class="listTable" width="100%" cellpadding="0" cellspacing="0">
    ...
    <logic:iterate id="operationbackout" name="operationbackoutList"
                   type="com.boco.eoms.sheet.operationbackout.model.OperationBackOutMain">
        <tr>
            <td class="content">
                <a href="${app}/sheet/operationbackout/operationbackout.do?method=showDetailPage&sheetKey=${operationbackout.id}"
                   target="_blank"><bean:write name="operationbackout" property="sheetId" scope="page"/></a>
