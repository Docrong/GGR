...
<c:set var="buttons">
    <input type="button" style="margin-right: 5px"
        onclick="location.href='<c:url value="/sheet/overtimetip/overtimetip.do?method=showInputPage&flowName=${flowName}"/>'"
...
<display:table name="timeList" cellspacing="0" cellpadding="0"
    ...
    export="true" requestURI="" sort="list" decorator="com.boco.eoms.sheet.overtimetip.webapp.action.OvertimeTipListDisplaytagDecoratorHelper">
