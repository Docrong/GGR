...
<input type="hidden" name="${sheetPageName}processTemplateName" id="${sheetPageName}processTemplateName"
       value="CircuitDispatchMainFlowProcess"/>
...
<input type="hidden" name="${sheetPageName}mainClassName"
       value="com.boco.eoms.sheet.circuitdispatch.model.CircuitDispatchMain"/> <!--main表Model对象类名-->
<input type="hidden" name="${sheetPageName}linkClassName"
       value="com.boco.eoms.sheet.circuitdispatch.model.CircuitDispatchLink"/> <!--link表Model对象类名-->
...
<table class="formTable">
    ...
    <tr>
        ...
        <td colspan="3">
            <input type="text" class="text" name="${sheetPageName}linkExecuteEndDate" readonly="readonly"
                   ...
                   alt="vtype:'lessThen',link:'tmpCompleteLimit',vtext:'实施完成时限不能晚于工单完成时限',allowBlank:false"/>
        </td>
    </tr>
    <tr>
        <!-- 变更涉及省份  -->
        ...
        <td>
            ...
            <input type="text" class="text" readonly="readonly" name="${sheetPageName}showDept"
                   ...
                   value="<eoms:id2nameDB id='${sheetLink.linkInvolvedCity}' beanId='tawSystemAreaDao'/>"/>
            <input type="hidden" name="${sheetPageName}linkInvolvedCity" id="${sheetPageName}linkInvolvedCity"
                   value="${sheetLink.linkInvolvedCity}"/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td class="content">
            <a onclick="javascript:getUrl('design')"><bean:message bundle='circuitdispatch'
                                                                   key='button.projectCreate'/></a>
        ...
        <td>
            <input type="text" class="text" readonly="readonly" name="${sheetPageName}mainResourceNo"
                   id="${sheetPageName}mainResourceNo" value="${sheetMain.mainResourceNo}" alt="allowBlank:true"/>
        </td>
    </tr>
    <tr>
        <!-- 技术方案关键字 -->
        ...
        <td colspan="3">
            <input type="text" class="text" name="${sheetPageName}linkProgrammeKey"
                   id="${sheetPageName}linkProgrammeKey" value="${sheetLink.linkProgrammeKey}"
    ...
    <tr>
        ...
        <td colspan="3">
            <textarea name="linkProgrammeExplain" id="linkProgrammeExplain" class="textarea max"
                      alt="allowBlank:true,maxLength:2000,vtext:'请填入技术方案说明，最多输入2000个字符'">${sheetLink.linkProgrammeExplain}</textarea>
        </td>
    </tr>
    <tr>
        <!-- 风险评估 -->
        ...
        <td colspan="3">
            <textarea name="linkRiskEvaluate" id="linkRiskEvaluate" class="textarea max"
                      alt="allowBlank:false,maxLength:2000,vtext:'请填入风险评估，最多输入2000个字符'">${sheetLink.linkRiskEvaluate}</textarea>
        </td>
    </tr>
    <tr>
        <!-- 影响业务分析 -->
        ...
        <td colspan="3">
            <textarea name="linkOperationConstrue" id="linkOperationConstrue" class="textarea max"
                      alt="allowBlank:false,maxLength:2000,vtext:'请填入影响业务分析，最多输入2000个字符'">${sheetLink.linkOperationConstrue}</textarea>
        </td>
    </tr>
            ...
            <c:when test="${empty sheetLink.nodeAcceptLimit }">
                <td class="content">
                    <input class="text" onclick="popUpCalendar(this, this)" type="text"
                           ...
                           readonly="readonly" value="<%=acceptLimit %>"
            ...
            <c:when test="${empty sheetLink.nodeCompleteLimit }">
                <td class="content">
                    <input class="text" onclick="popUpCalendar(this, this)" type="text"
                           ...
                           value="<%=completeLimit %>" id="${sheetPageName}nodeCompleteLimit"
    ...
    <tr>
        ...
        <td colspan="3">
            <eoms:comboBox name="${sheetPageName}linkPermitResult" id="${sheetPageName}linkPermitResult"
                           ...
                           onchange="ifPermitPass(this.value);"/>
        </td>
    </tr>
    <tr>
        <!-- 审批意见 -->
        ...
        <td colspan="3">
            <textarea name="linkPermitIdea" id="linkPermitIdea" class="textarea max"
                      alt="allowBlank:false,maxLength:2000,vtext:'请填入审批意见，最多输入2000个字符'">${sheetLink.linkPermitIdea}</textarea>
        </td>
    </tr>
    <tr>
        <td class="label">
    ...
    <tr>
        ...
        <td class="content">
            <input type="text" class="text" name="${sheetPageName}linkExcutePrincipal"
                   id="${sheetPageName}linkExcutePrincipal" value="${sheetLink.linkExcutePrincipal}"
                   alt="allowBlank:false,maxLength:40,vtext:'请填入实施负责人，最多输入40个字符'"/>
        </td>
        <!-- 联系方式 -->
        <td class="label"><bean:message bundle="circuitdispatch" key="circuitdispatch.linkContact"/>*</td>
        <td>
            <input type="text" class="text" name="${sheetPageName}linkContact" id="${sheetPageName}linkContact"
                   value="${sheetLink.linkContact}" alt="allowBlank:false,maxLength:40,vtext:'请填入联系方式，最多输入40个字符'"/>
        </td>
    </tr>
    <tr>
        <!-- 排程看板 -->
        ...
        <td colspan="3">
            <a href="#" onclick="popModifyTime()"><bean:message bundle="circuitdispatch"
                                                                key="circuitdispatch.lookPlanSheet"/></a>
        </td>
    </tr>
    <tr>
        <!-- 计划开始时间 -->
        ...
        <td>
            <input type="text" class="text" name="${sheetPageName}linkPlanStartDate" readonly="readonly"
                   id="${sheetPageName}linkPlanStartDate" onclick="popUpCalendar(this, this)"
                   alt="vtype:'lessThen',link:'${sheetPageName}linkPlanEndDate',vtext:'计划开始时间不能晚于计划结束时间',allowBlank:false"/>
        </td>
        <!-- 计划结束时间 -->
        ...
        <td>
            <input type="text" class="text" name="${sheetPageName}linkPlanEndDate" readonly="readonly"
                   id="${sheetPageName}linkPlanEndDate" onclick="popUpCalendar(this, this)"
                   alt="vtype:'moreThen',link:'${sheetPageName}linkPlanStartDate',vtext:'计划结束时间不能早于计划开始时间',allowBlank:false"/>
        </td>
    </tr>
    <tr>
        <!-- 查看设计结果 -->
    ...
    <tr>
        ...
        <td colspan="3">
            <eoms:comboBox name="${sheetPageName}linkIfAffectOperation" id="${sheetPageName}linkIfAffectOperation"
                           initDicId="10301" defaultValue="${sheetLink.linkIfAffectOperation}" alt="allowBlank:true"/>
        </td>
    </tr>
    <tr>
        <!-- 影响业务情况 -->
        ...
        <td colspan="3">
            <textarea name="${sheetPageName}linkAffectSituation" id="${sheetPageName}linkAffectSituation"
                      class="textarea max"
                      alt="allowBlank:true,maxLength:2000,vtext:'请填入影响业务情况，最多输入2000个字符'">${sheetLink.linkAffectSituation}</textarea>
        </td>
    </tr>
    <tr>
        <!-- 涉及业务部门 -->
        ...
        <td colspan="3">
            <eoms:comboBox name="${sheetPageName}linkReferOperateDept" id="${sheetPageName}linkReferOperateDept"
                           initDicId="1010902" defaultValue="${sheetLink.linkReferOperateDept}" alt="allowBlank:true"/>
        </td>
    </tr>
    <tr>
        <!-- 影响网元范围 -->
        ...
        <td colspan="3">
            <textarea name="linkNetAffectArea" id="linkNetAffectArea" class="textarea max"
                      alt="allowBlank:false,maxLength:2000,vtext:'请填入影响网元范围，最多输入2000个字符'">${sheetLink.linkNetAffectArea}</textarea>
        </td>
    </tr>
    <tr>
        <!-- 影响网管情况 -->
        ...
        <td colspan="3">
            <textarea name="linkAffectNetManage" id="linkAffectNetManage" class="textarea max"
                      alt="allowBlank:true,maxLength:2000,vtext:'请填入影响网管情况，最多输入2000个字符'">${sheetLink.linkAffectNetManage}</textarea>
        </td>
    </tr>
    <tr>
        <!-- 是否通知客服 -->
        ...
        <td colspan="3">
            <eoms:comboBox name="${sheetPageName}linkIfNotify" id="${sheetPageName}linkIfNotify" initDicId="10301"
                           defaultValue="${sheetLink.linkIfNotify}" alt="allowBlank:false"/>
        </td>
    </tr>
    <tr>
        <td class="label">
        ...
        <c:choose>
            <c:when test="${empty sheetLink.nodeAcceptLimit }">
                <td class="content">
                    <input class="text" onclick="popUpCalendar(this, this)" type="text"
                           name="${sheetPageName}nodeAcceptLimit" id="${sheetPageName}nodeAcceptLimit"
                           readonly="readonly" value="<%=eAcceptLimit %>"
                           alt="vtype:'lessThen',link:'${sheetPageName}nodeCompleteLimit',vtext:'受理时限不能晚于处理时限',allowBlank:false"/>
                </td>
            </c:when>
            <c:otherwise>
        ...
        <c:choose>
            <c:when test="${empty sheetLink.nodeCompleteLimit }">
                <td class="content">
                    <input class="text" onclick="popUpCalendar(this, this)" type="text"
                           name="${sheetPageName}nodeCompleteLimit" readonly="readonly"
                           value="<%=eCompleteLimit %>" id="${sheetPageName}nodeCompleteLimit"
                           alt="vtype:'moreThen',link:'${sheetPageName}nodeAcceptLimit',vtext:'处理时限不能早于受理时限',allowBlank:false"/>
                </td>
            </c:when>
            <c:otherwise>
    ...
    <tr>
        ...
        <td>
            <eoms:comboBox name="${sheetPageName}linkFailedReason" id="${sheetPageName}linkFailedReason"
                           initDicId="1010905" defaultValue="${sheetLink.linkFailedReason}" alt="allowBlank:true"/>
        </td>
    </tr>
    <tr>
        <!-- 是否完全按照方案实施 -->
        ...
        <td colspan="3">
            <eoms:comboBox name="${sheetPageName}linkIsAccordanceProgramme"
                           id="${sheetPageName}linkIsAccordanceProgramme" initDicId="10301"
                           defaultValue="${sheetLink.linkIsAccordanceProgramme}" alt="allowBlank:false"/>
        </td>
        <!-- 测试结果
    ...
    <tr>
        ...
        <td colspan="3">
            <textarea name="linkExcuteExplain" id="linkExcuteExplain" class="textarea max"
                      alt="allowBlank:false,maxLength:2000,vtext:'请填入实施情况说明，最多输入2000个字符'">${sheetLink.linkExcuteExplain}</textarea>
        </td>
    </tr>
    <tr>
        <!-- 影响业务情况说明 -->
        <td class="label"><bean:message bundle="circuitdispatch" key="circuitdispatch.linkAffectOperationExplain"/>*
        </td>
        <td colspan="3">
            <textarea name="linkAffectOperationExplain" id="linkAffectOperationExplain" class="textarea max"
                      alt="allowBlank:false,maxLength:2000,vtext:'请填入影响业务情况说明，最多输入2000个字符'">${sheetLink.linkAffectOperationExplain}</textarea>
        </td>
    </tr>
    <tr>
        <!-- 告警情况记录 -->
        ...
        <td colspan="3">
            <textarea name="linkAlarmRecord" id="linkAlarmRecord" class="textarea max"
                      alt="allowBlank:false,maxLength:2000,vtext:'请填入告警情况记录，最多输入2000个字符'">${sheetLink.linkAlarmRecord}</textarea>
        </td>
    </tr>
    <!--  统计报告异常说明  	<tr>
    ...
    <tr>
        ...
        <td colspan="3">
            <textarea name="linkExcuteConstrue" id="linkExcuteConstrue" class="textarea max"
                      alt="allowBlank:true,maxLength:2000,vtext:'请填入执行情况分析，最多输入2000个字符'">${sheetLink.linkExcuteConstrue}</textarea>
        </td>
    </tr>
    <tr>
        <!-- 是否需要更新作业计划
        ...
        <td>
            <eoms:comboBox name="${sheetPageName}linkCircuitUpdate" id="${sheetPageName}linkCircuitUpdate"
                           initDicId="1010906" defaultValue="${sheetLink.linkCircuitUpdate}" alt="allowBlank:false"/>
        </td>
    </tr>
    <!--	<tr>
     		 作业计划更新建议 
    ...
    <tr>
        ...
        <td colspan="3">
            <textarea name="linkWorkPlan" id="linkWorkPlan" class="textarea max"
                      alt="allowBlank:true,maxLength:2000,vtext:'请填入后续工作安排，最多输入2000个字符'">${sheetLink.linkWorkPlan}</textarea>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td colspan="3">
            <textarea name="linkMaintenanceDes" id="linkMaintenanceDes" class="textarea max"
                      alt="allowBlank:false,maxLength:2000,vtext:'请填入交维描述，最多输入2000个字符'">${sheetLink.linkMaintenanceDes}</textarea>
        </td>
    </tr>
    <tr>
        <td class="label">
    ...
    <tr>
        ...
        <td colspan="3">
            <eoms:comboBox name="${sheetPageName}mainIfDemonstrateCase" id="${sheetPageName}mainIfDemonstrateCase"
                           initDicId="1010912" alt="allowBlank:false" styleClass="select-class"
                           defaultValue="${sheetMain.mainIfDemonstrateCase}" onchange="ifCase(this.value);"/>
        </td>
    </tr>
    ...
    <tr id="ifDcase">
        ...
        <td colspan="3">
            <textarea name="${sheetPageName}mainCaseKeywords"
                      alt="allowBlank:false,maxLength:100,vtext:'请填入案例关键字，最多输入100字符'"
                      id="${sheetPageName}mainCaseKeywords"
                      class="textarea max">${sheetMain.mainCaseKeywords}</textarea>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td colspan="3">
            <eoms:comboBox name="${sheetPageName}linkRejectReason" id="${sheetPageName}linkRejectReason"
                           initDicId="1010911" defaultValue="${sheetLink.linkRejectReason}" alt="allowBlank:false"/>
        </td>
    </tr>
    <%} else { %>
...
<fieldset id="link4">
    ...
    <eoms:chooser id="circuitdispatchSendRole" type="role" roleId="269" flowId="042"
...
<input type="hidden" name="${sheetPageName}mainRejectTimes" id="${sheetPageName}mainRejectTimes"
       value="${sheetMain.mainResourceNo}"/>
<fieldset id="link4">
    <legend>
        <bean:message bundle="sheet" key="mainForm.toOperateRoleName"/>:
        <span id="roleName"></span>
    </legend>
    <eoms:chooser id="circuitdispatchSendRole" type="role" roleId="270" flowId="042"
                  config="{returnJSON:true,showLeader:true}"
...
<fieldset id="link4">
    ...
    <input type="hidden" name="${sheetPageName}dealPerformer" id="${sheetPageName}dealPerformer"
           value="${ProjectCreateTaskOperateroleid}"/>
    <input type="hidden" name="${sheetPageName}dealPerformerLeader" id="${sheetPageName}dealPerformerLeader"
           value="${ProjectCreateTaskTaskOwner}"/>
    <input type="hidden" name="${sheetPageName}dealPerformerType" id="${sheetPageName}dealPerformerType"
           value="${ProjectCreateTaskOperateroleidType}"/>
</fieldset>
<%} %>
