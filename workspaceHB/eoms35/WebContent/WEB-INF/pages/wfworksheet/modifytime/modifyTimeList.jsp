...
<c:set var="buttons">
    <input type="button" style="margin-right: 5px"
        onclick="location.href='<c:url value="/sheet/modifyTime/editModifyTime.do?isAdd=${isAdd}&isEdit=${isEdit}&isDelete=${isDelete}"/>'"
...
<display:table name="modifytimeList" cellspacing="0" cellpadding="0"
    ...
    <display:column property="beginTime" sortable="true" headerClass="sortable"
        url="/sheet/modifyTime/editModifyTime.do?method=xedit&isAdd=${isAdd}&isEdit=${isEdit}&isDelete=${isDelete}" paramId="id" paramProperty="id"
