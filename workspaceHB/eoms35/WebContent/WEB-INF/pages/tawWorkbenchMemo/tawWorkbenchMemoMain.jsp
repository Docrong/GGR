        ...
        ctxMenu: [
            {
                ...
                text: '${eoms:a2u('新增便签')}',
                cls: 'new-mi',
                url: '${app}/workbench/memo/editTawWorkbenchMemo.do?folderPath='
            },
            {
                id: 'Edit',
                text: '${eoms:a2u('便签列表')}',
                cls: 'list-mi',
                url: '${app}/workbench/memo/tawWorkbenchMemo.do?method=search&folderPath='
            },
            {
                id: 'Delete',
                text: '${eoms:a2u('新增发送')}',
            ...
            },
            {
                ...
                text: '${eoms:a2u('查询')}',
                cls: 'list-mi',
                url: '${app}/workbench/memo/tawWorkbenchMemoNodes.do?method=xSearch&folderPath='
            }
