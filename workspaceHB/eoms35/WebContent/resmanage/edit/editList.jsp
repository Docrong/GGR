        ...
        <table width=100%>
            <tr>
                ...
                <td height=20 align=center width=60>
                    <input type="button" name="bt_001" value="增加" alt="增加一个该类型的实体" onclick="javascript:inputclick()"
                           class="clsbtn2">
                </td>
                <td height=20 align=center width=60>
                    <input type="button" name="bt_001" value="修改" alt="修改选中的实体" onclick="javascript:edit(entity)"
                           class="clsbtn2">
                </td>
                <td height=20 align=center width=60>
                    <input type="button" name="bt_001" value="删除" alt="删除选中的实体" onclick="javascript:Del(entity)"
                           class="clsbtn2"></td>

                <td height=20 align=center width=60>
                    <input type="button" name="bt_001" value="导出摸板" alt="导出摸板" onclick="javascript:download()"
                           class="clsbtn2"></td>
                <td height=20 align=center width=60>
                    <input type="button" name="bt_001" value="增量导入" alt="增量导入" onclick="javascript:upload('1')"
                           class="clsbtn2"></td>
                <td height=20 align=center width=60>
                    <input type="button" name="bt_001" value="重新导入" alt="重新导入" onclick="javascript:upload('2')"
                           class="clsbtn2"></td>
                <td height=20 align=center width=60>
...
<script language="javascript">
    ...
    function download() {
        entity.action = "editDown.jsp?sId="+<%=sId%>+
        "&cityId=" +<%=cityId%>;
        entity.submit();
    }

    function upload(importtype) {
        var linkUrl = "editUp.jsp?sId="+<%=sId%>+
        "&cityId="+<%=cityId%>+
