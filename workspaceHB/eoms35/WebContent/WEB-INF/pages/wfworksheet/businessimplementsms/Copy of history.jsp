...
<div id="history" class="panel">
    ...
    <logic:present name="HISTORY" scope="request">
        <logic:iterate id="baselink" name="HISTORY"
                       type="com.boco.eoms.sheet.businessimplementsms.model.BusinessImplementSmsLink">
            <%
                jNum += 1;
            ...
            <div class="history-item"><!-- add space to hack ie-->&nbsp;
                <div class="history-item-title">
                    ...
                    <eoms:dict key="dict-sheet-businessimplementsms" dictId="activeTemplateId"
                    ...
                    <eoms:dict key="dict-sheet-businessimplementsms" dictId="mainOperateType"
  			      ...
  			      <%} %> -->
                        ...
                        <c:if test="${!empty baselink.activeTemplateId && baselink.activeTemplateId == 'ImplementDealTask'}">
                            <c:if test="${!empty baselink.operateType && (baselink.operateType == '91'||baselink.operateType == '11')}">
                                ...
                                <tr>
                                    <td class="column-title">
                                        <bean:message bundle="businessimplementsms"
                                                      key="businessimplementsms.linkArugmentlevel"/>
                                    </td>
                                    <td class="column-content">
                                    ...
                                    <td class="column-title">
                                        <bean:message bundle="businessimplementsms"
                                                      key="businessimplementsms.linkNeedFinishTime"/>
                                    </td>
                                    <td class="column-content">
                                ...
                                <tr>
                                    <td class="column-title">
                                        <bean:message bundle="businessimplementsms"
                                                      key="businessimplementsms.linkSenderOpinition"/>
                                    </td>
                        ...
                        <c:if test="${!empty baselink.activeTemplateId && baselink.activeTemplateId == 'ProjectDealTask'}">
                            <c:if test="${!empty baselink.operateType && (baselink.operateType == '93'||baselink.operateType == '11')}">
                                <tr>
                                    <td class="column-title">
                                        <bean:message bundle="businessimplementsms"
                                                      key="businessimplementsms.linkDoResourt"/>
                                    </td>
                                    <td class="column-content">
                                    ...
                                    <td class="column-title">
                                        <bean:message bundle="businessimplementsms"
                                                      key="businessimplementsms.linkEleNeed"/>
                                    </td>
                                    <td class="column-content">
                                ...
                                <tr>
                                    <td class="column-title">
                                        <bean:message bundle="businessimplementsms"
                                                      key="businessimplementsms.linkStartA"/>
                                    </td>
                                    <td class="column-content">
                                    ...
                                    <td class="column-title">
                                        <bean:message bundle="businessimplementsms"
                                                      key="businessimplementsms.linkACompteHome"/>
                                    </td>
                                    <td class="column-content">
                                ...
                                <tr>
                                    <td class="column-title">
                                        <bean:message bundle="businessimplementsms"
                                                      key="businessimplementsms.linkABusinessDDF"/>
                                    </td>
                                    <td class="column-content">
                                    ...
                                    <td class="column-title">
                                        <bean:message bundle="businessimplementsms"
                                                      key="businessimplementsms.linkADevHost"/>
                                    </td>
                                    <td class="column-content">
                                ...
                                <tr>
                                    <td class="column-title">
                                        <bean:message bundle="businessimplementsms"
                                                      key="businessimplementsms.linkATrasitionDDF"/>
                                    </td>
                                    <td class="column-content">
                                    ...
                                    <td class="column-title">
                                        <bean:message bundle="businessimplementsms"
                                                      key="businessimplementsms.linkScopeTrasitionHost"/>
                                    </td>
                                    <td class="column-content">
                                ...
                                <tr>
                                    <td class="column-title">
                                        <bean:message bundle="businessimplementsms"
                                                      key="businessimplementsms.linkEndZ"/>
                                    </td>
                                    <td class="column-content">
                                    ...
                                    <td class="column-title">
                                        <bean:message bundle="businessimplementsms"
                                                      key="businessimplementsms.linkDevType"/>
                                    </td>
                                    <td class="column-content">
                                ...
                                <tr>
                                    <td class="column-title">
                                        <bean:message bundle="businessimplementsms"
                                                      key="businessimplementsms.linkFailureResson"/>
                                    </td>
                                    <td class="column-content" colspan="3">
                        ...
                        <c:if test="${!empty baselink.activeTemplateId && baselink.activeTemplateId == 'CityNetTask'}">
                            <c:if test="${!empty baselink.operateType && (baselink.operateType == '741'||baselink.operateType == '11')}">
                                <tr>
                                    <td class="column-title">
                                        <bean:message bundle="businessimplementsms"
                                                      key="businessimplementsms.linkDesinResourt"/>
                                    </td>
                                    <td class="column-content">
                                    ...
                                    <td class="column-title">
                                        <bean:message bundle="businessimplementsms"
                                                      key="businessimplementsms.linkDesinType"/>
                                    </td>
                                    <td class="column-content">
                                ...
                                <tr>
                                    <td class="column-title">
                                        <bean:message bundle="businessimplementsms"
                                                      key="businessimplementsms.linkIPAddress"/>
                                    </td>
                                    <td class="column-content">
                                    ...
                                    <td class="column-title">
                                        <bean:message bundle="businessimplementsms"
                                                      key="businessimplementsms.linkSubNetNumber"/>
                                    </td>
                                    <td class="column-content">
                                ...
                                <tr>
                                    <td class="column-title">
                                        <bean:message bundle="businessimplementsms"
                                                      key="businessimplementsms.linkGetWay"/>
                                    </td>
                                    <td class="column-content">
                                    ...
                                    <td class="column-title">
                                        <bean:message bundle="businessimplementsms"
                                                      key="businessimplementsms.linkVLAN"/>
                                    </td>
                                    <td class="column-content">
                        ...
                        <c:if test="${!empty baselink.activeTemplateId && baselink.activeTemplateId == 'TrasitionTask'}">
                            <c:if test="${!empty baselink.operateType && (baselink.operateType == '743'||baselink.operateType == '11')}">
                                ...
                                <tr>
                                    <td class="label">
                                        <bean:message bundle="businessimplementsms"
                                                      key="businessimplementsms.linkEleCallResourt"/>*
                                    </td>
                                    <td colspan="3">
                                ...
                                <tr>
                                    <td class="label">
                                        <bean:message bundle="businessimplementsms"
                                                      key="businessimplementsms.linkTrasitionEleNumber"/>*
                                    </td>
                                    <td>
                                    ...
                                    <td class="label">
                                        <bean:message bundle="businessimplementsms"
                                                      key="businessimplementsms.linkGroupUserAddressZone"/>*
                                    </td>
                                    <td>
                        ...
                        <c:if test="${!empty baselink.activeTemplateId && baselink.activeTemplateId == 'BusinessTestTask'}">
                            <c:if test="${!empty baselink.operateType && (baselink.operateType == '75'||baselink.operateType == '11')}">
                                ...
                                <tr>
                                    <td class="column-title">
                                        <bean:message bundle="businessimplementsms"
                                                      key="businessimplementsms.linkDealResourt"/>
                                    </td>
                                    <td class="column-content" colspan="3">
                                ...
                                <tr>
                                    <td class="column-title">
                                        <bean:message bundle="businessimplementsms"
                                                      key="businessimplementsms.linkDealDescriptin"/>
                                    </td>
                                    <td class="column-content" colspan="3">
                        ...
                        <c:if test="${!empty baselink.operateType && baselink.operateType == '8'}">
                            <tr>
                                <td class="column-title">
                                    <bean:message bundle="businessimplementsms"
                                                  key="businessimplementsms.yijiaoresion"/>
                                </td>
                                <td class="column-content" colspan="3">
                        ...
                        <c:if test="${!empty baselink.operateType && baselink.operateType == '10'}">
                            ...
                            <tr>
                                <td class="column-title">
                                    <bean:message bundle="businessimplementsms"
                                                  key="businessimplementsms.fenpairesion"/>
                                </td>
                                <td class="column-content" colspan="3">
                                    <pre><bean:write name="baselink" property="remark" scope="page"/></pre>
                                </td>
