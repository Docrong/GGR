...
function showPage(){
     var pars = '';
     var url = '';    
      url = '${app}/sheet/greatevent/greatevent.do?method=showInputRejectPage&piid=${sheetMain.piid}&taskId=${taskId}&taskName=${taskName}';
     if (url!=''){
...
<div id="sheetform">
<html:form action="/greatevent.do?method=performDeal" styleId="theform">
