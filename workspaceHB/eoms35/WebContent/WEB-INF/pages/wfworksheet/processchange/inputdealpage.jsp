				 ...
				 <%if(!operateType.equals("11")) {%>
				  <tr>
		             ...
		             <td colspan="3">  
            	      ...
            	      initDicId="1010703"  alt="allowBlank:false" styleClass="select-class"  onchange="popOtherFlow(this.value);" defaultValue="${sheetLink.linkIfInvoke}" />
			           <html:button styleClass="btn" style="display:none" property="method.save" styleId="startITRequirement" onclick="openwin()">IT需求申请工单</html:button>
			        </td>	                                                                          
		            </tr>
		            <%} %>
			      <tr>
