...
<div id="history" class="panel">
    ...
    <logic:present name="HISTORY" scope="request">
        <logic:iterate id="baselink" name="HISTORY"
                       type="com.boco.eoms.sheet.circuitoperation.model.CircuitOperationLink">
            <%
                jNum += 1;
            ...
            <div class="history-item"><!-- add space to hack ie-->&nbsp;
                <div class="history-item-title">
                    ...
                    <eoms:dict key="dict-sheet-circuitoperation" dictId="activeTemplateId"
                               itemId="${baselink.activeTemplateId}" beanId="id2descriptionXML"/>
                    <bean:message bundle="circuitoperation" key="circuitoperation.operateType"/>:
                    <eoms:dict key="dict-sheet-circuitoperation" dictId="mainOperateType"
                ...
                <div class="history-item-content hide">
                    ...
                    <table class="history-item-table" width="100%" cellpadding="0" cellspacing="0">
                        ...
                        <%} %>
                        <%if (baselink.getActiveTemplateId() != null && baselink.getActiveTemplateId().equals("MakeZTask")) {%>
                        ...
                        <tr>
                            <td class="label"><bean:message bundle="circuitoperation"
                                                            key="circuitoperation.linkZContact"/></td>
                            <td class="content">
                                <bean:write name="baselink" property="linkZContact" scope="page"/>
                            </td>
                            <td class="label"><bean:message bundle="circuitoperation"
                                                            key="circuitoperation.linkZContactTel"/></td>
                            <td class="content">
                                <bean:write name="baselink" property="linkZContactTel" scope="page"/>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td colspan='3'>
                                <eoms:attachment name="baselink" property="nodeAccessories" scope="page"
                                                 idField="${sheetPageName}nodeAccessories" appCode="circuitoperation"
                                                 viewFlag="Y"/>
                            </td>
                        </tr>
                        <%
                        ...
                        %>
                        <%if (baselink.getActiveTemplateId() != null && baselink.getActiveTemplateId().equals("MakeTTask")) {%>
                        <%if (baselink.getOperateType() != null && (baselink.getOperateType().intValue() == 201 || baselink.getOperateType().intValue() == 11)) {%>

                        <tr>
                            <td class="label"><bean:message bundle="circuitoperation"
                                                            key="circuitoperation.linkOperationDesc"/></td>
                            <td class="content" colspan="3">
                                <bean:write name="baselink" property="linkOperationDesc" scope="page"/>
                            </td>
                        </tr>
                        <tr>
                            <td class="label"><bean:message bundle="sheet" key="linkForm.accessories"/></td>
                        ...
                        %>
                        <%if (baselink.getActiveTemplateId() != null && baselink.getActiveTemplateId().equals("BackTask")) {%>
                        ...
                        %>
                        <%if (baselink.getActiveTemplateId() != null && baselink.getActiveTemplateId().equals("DateATask")) {%>
                        ...
                        %>
                        <%if (baselink.getActiveTemplateId() != null && baselink.getActiveTemplateId().equals("DateZTask")) {%>
...
<script type="text/javascript">
    ...
    function copy(id) {
        ...
        if (ifCheck.checked == true) {
            Ext.Ajax.request({
                method: "get",
                url: "circuitoperation.do?method=getJsonLink&id=" + id + "&beanName=CircuitOperation",
                success: function (x) {
