...
<table class="formTable">
    ...
    <tr>
        ...
        <td>
            <eoms:comboBox name="${sheetPageName}urgentDegree" id="${sheetPageName}urgentDegree"
                           initDicId="1010102" alt="allowBlank:false" defaultValue="${sheetMain.urgentDegree}"
                           styleClass="select-class"/>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><input type="text" class="text" name="${sheetPageName}numDetail" id="${sheetPageName}numDetail"
                   ...
                   alt="allowBlank:false,maxLength:200,vtext:'${eoms:a2u('请输入号码明细，最大长度为100个汉字！')}'"/></td>
    </tr>
    ...
    <tr>
        ...
        <td colspan="3">
            <textarea name="${sheetPageName}volumeAssessment" id="${sheetPageName}volumeAssessment" class="textarea max"
                      alt="allowBlank:false,maxLength:255,vtext:'${eoms:a2u('请输入业务量评估，最大长度为125个汉字！')}'">${sheetMain.volumeAssessment}</textarea>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td><eoms:comboBox name="${sheetPageName}nameListSetType" id="${sheetPageName}nameListSetType"
                           initDicId="1011027" alt="allowBlank:true" defaultValue="${sheetMain.nameListSetType}"
    ...
    <tr>
        ...
        <td><eoms:comboBox name="${sheetPageName}comProtocol" id="${sheetPageName}comProtocol"
                           initDicId="1011052" alt="allowBlank:false" defaultValue="${sheetMain.comProtocol}"
                           styleClass="select-class"/></td>
    </tr>
    ...
    <tr>
        <td class="label"><bean:message bundle="businesschange" key="businesschange.nameListSetType"/>*</td>
        <td><eoms:comboBox name="${sheetPageName}nameListSetType" id="${sheetPageName}nameListSetType"
                           initDicId="1011027" alt="allowBlank:false" defaultValue="${sheetMain.nameListSetType}"
                           styleClass="select-class"/></td>
    ...
    <tr>
        ...
        <td><input type="text" class="text" name="${sheetPageName}connectGatewayName"
                   ...
                   alt="allowBlank:true,maxLength:200,vtext:'${eoms:a2u('请输入EC/SI接入短信网关名称，最大长度为100个汉字！')}'"/></td>
    </tr>
    ...
    <tr>
        ...
        <td><input type="text" class="text" name="${sheetPageName}connectGatewayID"
                   ...
                   alt="allowBlank:true,maxLength:200,vtext:'${eoms:a2u('请输入EC/SI接入短信网关ID，最大长度为100个汉字！')}'"/></td>
        <td class="label"><bean:message bundle="businesschange" key="businesschange.factureArea"/>*</td>
        <td>
    ...
    <tr>
        ...
        <td>
            <eoms:comboBox name="${sheetPageName}authenticationModel" id="${sheetPageName}authenticationModel"
                           defaultValue="${sheetMain.authenticationModel}" initDicId="1011021" alt="allowBlank:false"
                           styleClass="select-class"/>
        </td>
