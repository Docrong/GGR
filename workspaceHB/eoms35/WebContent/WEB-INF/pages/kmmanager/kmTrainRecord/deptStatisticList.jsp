...
<fmt:bundle basename="com/boco/eoms/km/config/applicationResource-kmmanager">
    ...
    <tr align='center'>
        <td>
            ...
            部门(可选)：<input type="text" id="trainDeptName" name="trainDeptName" class="text" readonly="readonly"
                          value='<eoms:id2nameDB id="${trainDept}" beanId="tawSystemDeptDao" />'/>
    ...
    <display:table name="trainRecordList" cellspacing="0" cellpadding="0"
        ...
        <display:column property="trainCount" sortable="true"
                        headerClass="sortable" titleKey="trainDeptStatistic.trainCount" paramId="id"
                        paramProperty="id"/>
