...
<html>
    <head>
        <title>JWChat - Enviar mensaje</title>
        <meta http-equiv="content-type" content="text/html; charset=utf-8">
          ...
          function init() {
            ...
            document.title = "Enviar mensaje a "+srcW.roster.getUserByJID(jid).name;
          }
        ...
        <form name="msg" style="border:0;padding:0;margin:0;" onSubmit="return sendMSG();">
            <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" style="margin-bottom: 8px;">
                <tr width="100%">
                    <td>Asunto:&nbsp;</td>
                    <td width="100%">
                        <input type="text" name="subject" size="20" style="width:100%;" tabindex="1">
                    </td>
                </tr>
                <tr height="100%">
                    <td colspan="2" style="padding-top: 4px;">
                        <textarea id="msgbox" wrap="physical" class="msgBox" tabindex="2"></textarea>
                    </td>
                </tr>
                ...
                <tr>
                    <td colspan="2" id="buttonbox" align="right">
                        <button type="button" onClick="window.close();" tabindex="4">Cancelar</button>
                        &nbsp;
