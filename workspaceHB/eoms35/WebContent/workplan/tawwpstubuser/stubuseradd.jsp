...
<form name="reportform" method="POST">
    ...
    <table border="0" width="400" class="formTable">
        ...
        <tr>
            ...
            <td width="300">
                <input type="text" name="startdate" size="20" readonly="true" onclick="popUpCalendar(this, this);"
                       class="text">
            </td>
        </tr>
        <tr>
            ...
            <td width="300">
                <input type="text" name="enddate" size="20" readonly="true" onclick="popUpCalendar(this, this);"
                       class="text">
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td colSpan="2">
                <input type="submit" value="<bean:message key="stubuseradd.title.btnSubmit" />" name="B1"
                       Onclick="return onSubmit();" class="submit">
                <input type="button" value="<bean:message key="stubuseradd.title.btnBack" />" name="B2"
