...
<div id="sheet-detail-page">
  ...
  <div id="sheetinfo">
	...
	<td>
		...
		<tr>
			<td class="label"><bean:message bundle="agentmaintenance" key="agentMaintenanceMain.mainFaultAlarmId"/></td>
			<td class="content">  
				${sheetMain.mainFaultAlarmId}
			</td>	   
			<td class="label"><bean:message bundle="agentmaintenance" key="agentMaintenanceMain.mainFaultAlarmNum"/></td>
			<td class="content">  
		     		${sheetMain.mainFaultAlarmNum}
			</td>			        	             
		</tr>
		<tr>
			<td class="label"><bean:message bundle="agentmaintenance" key="agentMaintenanceMain.mainFaultAlarmSolveDate"/></td>
			<td class="content">  
				${sheetMain.mainFaultAlarmSolveDate}
			</td>	 
			<td  class="label"><bean:message bundle="agentmaintenance" key="agentMaintenanceMain.mainFaultAlarmSource"/></td>
			<td class="content">  
				${sheetMain.mainFaultAlarmSource}
			</td>			        	               
		</tr>
		<tr>
			<td class="label"><bean:message bundle="agentmaintenance" key="agentMaintenanceMain.mainFaultAlarmLevel"/></td>
			<td class="content" > 	
			...
			<td>
				<eoms:id2nameDB id="${sheetMain.mainFaultResponseLevel}" beanId="ItawSystemDictTypeDao"/>
			</td>
			</tr>
			<tr><td class="label">
				<!-- 网络分类(一级) -->
			...
			<td>
				<eoms:id2nameDB id="${sheetMain.mainFaultNetSortOne}" beanId="ItawSystemDictTypeDao"/>
			</td>
 <td class="label">
				<!-- 网络分类(二级) -->
			...
			<td>
				<eoms:id2nameDB id="${sheetMain.mainFaultNetSortTwo}" beanId="ItawSystemDictTypeDao"/>
			</td>
		</tr>
		...
		<tr><td class="label">
			...
			<td>
				<eoms:id2nameDB id="${sheetMain.mainFaultNetSortThree}" beanId="ItawSystemDictTypeDao"/>
			</td>
			<td class="label">
				<!-- 派单方式 -->
	  		...
	  		<td>
	   			<eoms:id2nameDB id="${sheetMain.mainFaultSendMode}" beanId="ItawSystemDictTypeDao"/>		
	  		</td>
			</tr>
			<tr>
			<td class="label">
			...
			<td>
				<eoms:id2nameDB id="${sheetMain.mainFaultEquipmentFactory}" beanId="ItawSystemDictTypeDao"/>
			</td>
			<td class="label">
				<!-- 网元名称 -->
			...
			<td><eoms:id2nameDB id="${sheetMain.mainFaultIfAffectOperation}" beanId="ItawSystemDictTypeDao"/>
			</td>
			<td class="label">
				<!-- 相关投诉处理工单号 -->
			...
			<td><eoms:id2nameDB id="${sheetMain.mainFaultPretreatment}" beanId="ItawSystemDictTypeDao"/>
			</td>
			<td class="label">
			</td>
			<td>
		...
		<tr>
			...
			<td colspan='3'>
				<eoms:attachment name="sheetMain" property="sheetAccessories" scope="request" idField="sheetAccessories" appCode="agentmaintenance" viewFlag="Y"/> 
			</td>
		</tr>
	</table>
	</td>
	...
	<td>
		...
		<tr><td class="label">
			...
			<td><eoms:id2nameDB id="${sheetMain.mainTaskNetSort1}" beanId="ItawSystemDictTypeDao"/>
			</td>
 <td class="label">
				<!-- 网络分类二级类别 -->
				<bean:message bundle="agentmaintenance" key="agentMaintenanceMain.mainTaskNetSort2"/>*
			</td>
			<td><eoms:id2nameDB id="${sheetMain.mainTaskNetSort2}" beanId="ItawSystemDictTypeDao"/>
			</td>
		</tr>
		...
		<tr><td class="label">
			...
			<td><eoms:id2nameDB id="${sheetMain.mainTaskNetSort3}" beanId="ItawSystemDictTypeDao"/>
			</td>
 <td class="label">
				<!-- 任务类型 -->
	...
	<table class="formTable">
		<tr><td class="label">
			...
			<td class="content"><eoms:id2nameDB id="${sheetMain.mainComurgentDegree}" beanId="ItawSystemDictTypeDao"/>
			</td>
			<td class="label">
				<!-- 投诉分类一级类别 -->
				<bean:message bundle="agentmaintenance" key="agentMaintenanceMain.mainComType1"/>*
			</td>
			<td class="content"><eoms:id2nameDB id="${sheetMain.mainComType1}" beanId="ItawSystemDictTypeDao"/>
			</td>
		</tr>
		...
		<tr><td class="label">
			...
			<td class="content"><eoms:id2nameDB id="${sheetMain.mainComType2}" beanId="ItawSystemDictTypeDao"/>
			</td>
 <td class="label">
				<!-- 投诉分类三级类别 -->
				<bean:message bundle="agentmaintenance" key="agentMaintenanceMain.mainComType"/>*
			</td>
			<td class="content"><eoms:id2nameDB id="${sheetMain.mainComType}" beanId="ItawSystemDictTypeDao"/>
			</td>
		</tr>
 		<tr>
 <td class="label">
			...
			<td class="content"><eoms:id2nameDB id="${sheetMain.mainComType4}" beanId="ItawSystemDictTypeDao"/>
			</td>
		<td class="label">
				<!-- 投诉分类五级类别 -->
				<bean:message bundle="agentmaintenance" key="agentMaintenanceMain.mainComType5"/>*
			</td>
			<td class="content"><eoms:id2nameDB id="${sheetMain.mainComType5}" beanId="ItawSystemDictTypeDao"/>
			</td>
			</tr>
		<tr>
 <td class="label">
			...
			<td class="content"><eoms:id2nameDB id="${sheetMain.mainComType6}" beanId="ItawSystemDictTypeDao"/>
			</td>
	<td class="label">
				<!-- 投诉分类七级类别 -->
				<bean:message bundle="agentmaintenance" key="agentMaintenanceMain.mainComType7"/>*
			</td>
			<td class="content"><eoms:id2nameDB id="${sheetMain.mainComType7}" beanId="ItawSystemDictTypeDao"/>
			</td>
			</tr>
			<tr>
			<td class="label">
			...
			<td class="content"><eoms:id2nameDB id="${sheetMain.mainCombdeptContactPhone}" beanId="ItawSystemDictTypeDao"/>
			</td>
			<td class="label">
				<!-- 重复投诉次数 -->
			...
			<td class="content"><eoms:id2nameDB id="${sheetMain.mainComcustomBrand}" beanId="ItawSystemDictTypeDao"/>
			</td>
			<td class="label">
				<!-- 投诉受理省份 -->
	...
	<div class='sheet-deal-header'>
		...
		<%if(taskName.equals("TaskCreateAuditHumTask")){ %>	
			<select id="dealSelector"> 
			 ...
			 <option value="${urlShowTransmitDealPage}"><bean:message bundle="agentmaintenance" key="agentmaintenance.taskpass"/> </option>
			 <option value="${urlShowTransmit2DealPage}"><bean:message bundle="agentmaintenance" key="agentmaintenance.tasknopass"/></option>
             <%}%>
           </select>	
		<%}else if(taskName.equals("ExcuteHumTask")){%>	
			  ...
			  <option value="${urlShowCompleteDealPage}"><bean:message bundle="agentmaintenance" key="agentmaintenance.dealwcnosp"/></option>
			  <!-- <option value="${urlShowTransferPage}"><bean:message bundle="agentmaintenance" key="agentmaintenance.yijiao"/></option> -->
			  <option value="${urlShowSplitDealPage}"><bean:message bundle="agentmaintenance" key="agentmaintenance.fenpai"/></option> 		   
	  		     <%} %>
			</select>
		<%}else if(taskName.equals("TaskCompleteAuditHumTask")){%>	
			...
			<%if(taskStatus.equals(Constants.TASK_STATUS_READY)){%>
			    ...
			    <option value="${urlShowRejectBackPage}"><bean:message bundle="sheet" key="common.rejectBack"/></option>
			 <%}else if(taskStatus.equals(Constants.TASK_STATUS_CLAIMED)){ %>
			  <option value="${urlShowTaskCompleteAuditYes}"><bean:message bundle="agentmaintenance" key="agentmaintenance.TaskCompleteAuditYes"/></option>
			  <option value="${urlShowTaskCompleteAuditNo}"><bean:message bundle="agentmaintenance" key="agentmaintenance.TaskCompleteAuditNo"/></option>
			<%} %>
			</select>
		<%}else if(taskName.equals("AffirmHumTask")){%>	
			<select id="dealSelector">
			  <option value="${urlShowDealReplyPassPage}"><bean:message bundle="agentmaintenance" key="agentmaintenance.dealrejectpass"/></option>
			  <option value="${urlShowDealReplyNoPassPage}"><bean:message bundle="agentmaintenance" key="agentmaintenance.nopassback"/></option>
			</select>
		<%}else if(taskName.equals("DraftHumTask")){%>	
			<select id="dealSelector">
			  <option value="${urlShowCompleteDraftPage}"><bean:message bundle="agentmaintenance" key="operateType.draft"/></option>
			</select>
		...
		<%}else if(taskName.equals("HoldHumTask")){ %>
			<select id="dealSelector">
			  <option value="${urlShowHoldDealPage}"><bean:message bundle="agentmaintenance" key="operateType.hold"/></option>
			</select>		
		<%} %>
		</td>
		</tr>
