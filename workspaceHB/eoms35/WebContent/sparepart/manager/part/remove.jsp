...
<%@ page
        import="java.util.List,java.util.ArrayList,com.boco.eoms.sparepart.model.*,com.boco.eoms.sparepart.model.TawStorage,com.boco.eoms.common.util.StaticMethod" %>
...
<form action="../part/remove.do" method="post" name="tawSparepartForm">
    <table border="0" width="95%" cellspacing="1" cellpadding="1" align=center>
        <tr class="tr_show_left">
            <td>
                ${eoms:a2u('您当前操作的仓库是：')}<font color="red"><bean:write name="storage_dept_name" scope="session"/></font>&nbsp;&nbsp;${eoms:a2u('的')}<b>&nbsp;&nbsp;<font
    ...
    <table border="0" width="95%" cellspacing="1" cellpadding="1" class="table_show" align="center">
        ...
        <logic:iterate id="sparepart" name="sparepart" type="com.boco.eoms.sparepart.model.TawPart">
            <tr class="tr_show" align="center">
                <td>
                    <INPUT TYPE="checkbox" name="id" value="<bean:write name="sparepart" property="id" scope="page"/>">
                </td>
...
<logic:present name="choosed">
        ...
        <tr class="tr_show_left">
            <td>
                ...
                <logic:iterate id="storage" name="storage" type="com.boco.eoms.sparepart.model.TawStorage">
                    <option value="<bean:write name="storage" property="id" scope="page"/>"><bean:write name="storage"
    ...
    <form action="../part/removeover.do" method="post" name="TawSparepartForm">
        ...
        <table border="0" width="95%" cellspacing="0">
            <tr>
                <td height="32" align="right">
                    <input type="button" value="<bean:message key="label.submit"/>" name="pp"
                           onclick="if(checkdata()) document.forms[1].submit();" class="clsbtn2">
                    &nbsp;&nbsp;
                </td>
            </tr>
        </table>
