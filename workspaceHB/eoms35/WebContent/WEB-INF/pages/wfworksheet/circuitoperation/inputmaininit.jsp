...
<input type="hidden" name="${sheetPageName}processTemplateName" value="CircuitOperationMainFlowProcess"/>
...
<table class="formTable">
    ...
    <tr>
        <td class="label"><bean:message bundle="circuitoperation" key="circuitoperation.mainRemark"/>*</td>
        <td colspan="3" class="content">
