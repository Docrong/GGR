...
<%
    com.boco.eoms.sheet.localCommonTask.model.LocalCommonTaskLink localCommonTaskLink = (com.boco.eoms.sheet.localCommonTask.model.LocalCommonTaskLink) request.getAttribute("sheetLink");
    java.lang.String taskName = com.boco.eoms.base.util.StaticMethod.nullObject2String(localCommonTaskLink.getActiveTemplateId());
    java.lang.String operateType = java.lang.String.valueOf(com.boco.eoms.base.util.StaticMethod.nullObject2String(localCommonTaskLink.getOperateType()));
%>
<script type="text/javascript">
    ...
    function saveDealTemplate(type) {
        ...
        form.action = "${app}/sheet/localCommonTask/localCommonTask.do?method=saveDealTemplate&type=dealTemplateManage&dealTemplateId=${sheetLink.id}";
        form.submit();
    }
...
<html:form action="/localCommonTask.do" styleId="theform">
    <br/>
    ...
    <table class="formTable">
        <caption><bean:message bundle="localCommonTask" key="localCommonTask.header"/></caption>
        <tr>
            <td class="label">
        ...
        <tr>
            <td class="label"><bean:message bundle="localCommonTask" key="localCommonTask.linkZContact"/>*</td>
            <td class="content">
            ...
            <td class="label"><bean:message bundle="localCommonTask" key="localCommonTask.linkZContactTel"/>*</td>
            <td class="content">
        ...
        <tr>
            ...
            <td colspan='3'>
                <eoms:attachment idList="" scope="request" idField="${sheetPageName}nodeAccessories" name="sheetLink"
                                 property="nodeAccessories" appCode="localCommonTask" alt="allowBlank:true"/>
            </td>
        </tr>
        <%
                }
        ...
        <tr>
            <td class="label"><bean:message bundle="localCommonTask" key="localCommonTask.linkOperationDesc"/>*</td>
            <td colspan="3">
        ...
        <tr>
            <td class="label">
                <bean:message bundle="localCommonTask" key="localCommonTask.remark"/>*
            </td>
            <td colspan="3">
