...
<html:form action="/dutyevent.do?method=edit"
    ...
    <table border=0 cellspacing="1" cellpadding="1" class="listTable">
        ...
        <tr>
            ...
            <td COLSPAN="10">
                <eoms:dict key="dict-duty" dictId="faultType" beanId="selectXML"
                           defaultId="${tawRmDutyEventForm.faultType}" isQuery="false" selectId="faultType"
            ...
            <td COLSPAN="10">
                <eoms:dict key="dict-duty" dictId="faultflag" beanId="selectXML" defaultId="${tawRmDutyEventForm.flag}"
                           isQuery="false" selectId="flag" alt="allowBlank:false"/>
                    <%--
        ...
        <tr>
            ...
            <td COLSPAN="10">
                ...
                <html:text property="beginTime" styleId="beginTime"
                           ...
                           readonly="true" alt="allowBlank:false,vtext:'请填写开始时间'"/>
            ...
            <td COLSPAN="10">
                <html:text property="endtime" styleId="endtime"
                           styleClass="text medium" onclick="popUpCalendar(this, this,null,null,null,true,-1);"
                           readonly="true" alt="allowBlank:false,vtext:'请填写结束时间'"/>
        ...
        <tr class="tr_show">
            ...
            <td COLSPAN="24">
                <input name="eventtitle" type="text" class="clstext" size="70" value="${tawRmDutyEventForm.eventtitle}"
                       alt="allowBlank:false,vtext:'请填写标题时间'"/>
        </tr>
        <TR>
            <td COLSPAN="4" class="label">
            ...
            <td COLSPAN="24">
                    <eoms:dict key="dict-duty" dictId="complateFlag" beanId="selectXML" isQuery="false"
                               defaultId="${tawRmDutyEventForm.complateFlag}" selectId="complateFlag"
                               alt="allowBlank:false"/>
        ...
        <tr>
            <td COLSPAN="28">
                ...
                <input type="button" value="<bean:message key="tawRmDutyEvent.removeEvent" />"
                       Onclick="javascript:removeEvent('${tawRmDutyEventForm.id}');" class="button">
            </td>
        </tr>
        <%} %>
    </table>
    ...
    <table border=0 cellspacing="1" cellpadding="1" class="listTable">
        ...
        <tr>
            ...
            <td COLSPAN="10">
                ...
                <input type="text" name="happentime" size="20"
        ...
        <tr>
            <td COLSPAN="28">
                <input type="button" value=
                    <bean:message key="tawRmDutyEventSub.addEventSub"/> onClick="javascript:onsubSave(0);"
                       class="button">
                <input type="button" value=
                    <bean:message key="tawRmDutyEventSub.addEventSubandClose"/>  onClick="javascript:onsubSave(1);"
                       class="button">
            </td>
        </tr>
    </table>
