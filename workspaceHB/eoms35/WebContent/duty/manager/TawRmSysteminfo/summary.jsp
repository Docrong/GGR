                ...
                <tr>
                    <td>
                        <table bgcolor="#f2f2f2" width="500" cellspacing="0" border="0">
                            ...
                            <logic:iterate id="tawRmSysteminfo" name="TAWRMSYSTEMINFOS"
                                           type="com.boco.eoms.duty.model.TawRmSysteminfo">
                                ...
                                <tr bgcolor="#FFFFFF">
                                    ...
                                    <td style="border-left-width: 1; border-right-width: 1; border-top-width: 1; border-bottom-style: solid; border-bottom-width: 1; padding-left: 6; padding-right: 6; padding-top: 3; padding-bottom: 3">
                                        <font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="#022077"><b>
                                            <html:link href="TawRmSysteminfo/edit.do" paramId="roomId"
                                                       paramName="tawRmSysteminfo" paramProperty="roomId"><bean:message
                                                    key="label.edit"/></html:link>&nbsp;
                                            <html:link href="TawRmSysteminfo/view.do" paramId="roomId"
                                                       paramName="tawRmSysteminfo" paramProperty="roomId"><bean:message
                                                    key="label.view"/></html:link>&nbsp;
                                            <html:link href="TawRmSysteminfo/remove.do" paramId="roomId"
                                                       paramName="tawRmSysteminfo" paramProperty="roomId"><bean:message
