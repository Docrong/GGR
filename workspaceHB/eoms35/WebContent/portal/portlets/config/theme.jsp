...
<fmt:bundle basename="resourceBundle">
    ...
    <form name="form_<%= responseId %>">
        <table border='0' cellpadding='0' cellspacing='0'>
            ...
            <tr>
                <td class='portlet-table-td-center'><img src='light/images/theme1.gif' height='200'
                                                         style='border: 1px solid #999' width='150' alt=''/></td>
                <td class='portlet-table-td-center'><img src='light/images/theme3.gif' height='200'
                                                         style='border: 1px solid #999' width='150' alt=''/></td>
            </tr>
        </table>
...
<a href="javascript:void(0);" onclick="javascript:showMoreBgImage(event,'<%= responseId %>');"><fmt:message
        key="portlet.theme.description.moreimage"/></a>
    ...
    <input type='radio' name='ptBg' value='more' checked='true'/>
        ...
        <table border='0' cellpadding='0' cellspacing='0'>
            ...
            <tr>
                ...
                <td class='portlet-table-td-left'>
<span height='20' width='100' style=''>
<a href="javascript:void(0);" onclick="javascript:showMoreHeaderImage(event,'<%= responseId %>');"><fmt:message
        key="portlet.theme.description.moreimage"/></a>
        ...
        <table border='0' cellpadding='0' cellspacing='0'>
                ...
                <td class='portlet-table-td-left'>
                    <select name='ptHeaderHeight' size='1' class='portlet-form-select'>
                        <c:if test='${sessionScope.portal.headerHeight == -40}'>
                            <option selected='selected' value='-40'><fmt:message
                                    key="portlet.theme.description.defalut"/>-40
                            </option>
                        </c:if>
                        <c:if test='${sessionScope.portal.headerHeight != -40}'>
                        ...
                        <c:if test='${sessionScope.portal.headerHeight == -30}'>
                            <option selected='selected' value='-30'><fmt:message
                                    key="portlet.theme.description.defalut"/>-30
                            </option>
                        </c:if>
                        <c:if test='${sessionScope.portal.headerHeight != -30}'>
                        ...
                        <c:if test='${sessionScope.portal.headerHeight == -20}'>
                            <option selected='selected' value='-20'><fmt:message
                                    key="portlet.theme.description.defalut"/>-20
                            </option>
                        </c:if>
                        <c:if test='${sessionScope.portal.headerHeight != -20}'>
                        ...
                        <c:if test='${sessionScope.portal.headerHeight == -10}'>
                            <option selected='selected' value='-10'><fmt:message
                                    key="portlet.theme.description.defalut"/>-10
                            </option>
                        </c:if>
                        <c:if test='${sessionScope.portal.headerHeight != -10}'>
                        ...
                        <c:if test='${sessionScope.portal.headerHeight == 0}'>
                            <option selected='selected' value='0'><fmt:message
                                    key="portlet.theme.description.defalut"/></option>
                        </c:if>
                        <c:if test='${sessionScope.portal.headerHeight != 0}'>
                ...
                <td class='portlet-table-td-left'>
                    <select name='ptFontSize' size='1' class='portlet-form-select'>
                        <c:if test='${sessionScope.portal.fontSize == -4}'>
                            <option selected='selected' value='-4'><fmt:message
                                    key="portlet.theme.description.defalut"/>-4
                            </option>
                        </c:if>
                        <c:if test='${sessionScope.portal.fontSize != -4}'>
                        ...
                        <c:if test='${sessionScope.portal.fontSize == -3}'>
                            <option selected='selected' value='-3'><fmt:message
                                    key="portlet.theme.description.defalut"/>-3
                            </option>
                        </c:if>
                        <c:if test='${sessionScope.portal.fontSize != -3}'>
                        ...
                        <c:if test='${sessionScope.portal.fontSize == -2}'>
                            <option selected='selected' value='-2'><fmt:message
                                    key="portlet.theme.description.defalut"/>-2
                            </option>
                        </c:if>
                        <c:if test='${sessionScope.portal.fontSize != -2}'>
                        ...
                        <c:if test='${sessionScope.portal.fontSize == -1}'>
                            <option selected='selected' value='-1'><fmt:message
                                    key="portlet.theme.description.defalut"/>-1
                            </option>
                        </c:if>
                        <c:if test='${sessionScope.portal.fontSize != -1}'>
            ...
            <tr>
                <td class='portlet-table-td-right' colspan='2'>
                    <input name='Apply' type='button' value='<fmt:message key="portlet.theme.description.apply"/>'
