...
public class AttachInfoListType  implements java.io.Serializable {
    private com.boco.eoms.gzjhhead.interfaces.AttachInfoType[] attachInfo;

    public AttachInfoListType() {
    }

    public com.boco.eoms.gzjhhead.interfaces.AttachInfoType[] getAttachInfo() {
        return attachInfo;
    }

    public void setAttachInfo(com.boco.eoms.gzjhhead.interfaces.AttachInfoType[] attachInfo) {
        this.attachInfo = attachInfo;
    }

    public com.boco.eoms.gzjhhead.interfaces.AttachInfoType getAttachInfo(int i) {
        return attachInfo[i];
    }

    public void setAttachInfo(int i, com.boco.eoms.gzjhhead.interfaces.AttachInfoType value) {
