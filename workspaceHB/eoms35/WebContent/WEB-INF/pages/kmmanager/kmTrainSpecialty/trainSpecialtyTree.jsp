    ...
    <script type="text/javascript">
        var config = {
            ...
            ctxMenu: [
                {
                    id: 'newnode',
                    text: '<fmt:message key="trainSpecialty.tree.add"/>',
                    cls: 'new-mi',
                    url: '${app}/kmmanager/trainSpecialtys.do?method=add&nodeId='
                },
                {
                    id: 'edtnode',
                    text: '<fmt:message key="trainSpecialty.tree.edit"/>',
                    cls: 'edit-mi',
                    url: '${app}/kmmanager/trainSpecialtys.do?method=edit&nodeId='
                },
                {
                    id: 'delnode',
                    isDelete: true,
                    text: '<fmt:message key="trainSpecialty.tree.delete"/>',
                    cls: 'remove-mi',
                    url: '${app}/kmmanager/trainSpecialtys.do?method=remove&nodeId='
                }
            ],//end of ctxMenu
            /************************
