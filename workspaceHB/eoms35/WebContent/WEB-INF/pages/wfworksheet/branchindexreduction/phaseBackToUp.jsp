...
<div id="sheetform">
    <html:form action="/branchindexreduction.do?method=newPerformNonFlow" styleId="theform">
        <%
        ...
        %>
        <input type="hidden" name="linkBeanId" value="iBranchIndexReductionLinkManager"/>
        <input type="hidden" name="beanId" value="iBranchIndexReductionMainManager"/>
        <input type="hidden" name="mainClassName"
               value="com.boco.eoms.sheet.branchindexreduction.model.BranchIndexReductionMain"/> <!--main\u8868Model\u5bf9\u8c61\u7c7b\u540d-->
        <input type="hidden" name="linkClassName"
               value="com.boco.eoms.sheet.branchindexreduction.model.BranchIndexReductionLink"/> <!--link\u8868Model\u5bf9\u8c61\u7c7b\u540d-->
        <input type="hidden" name="processTemplateName" id="processTemplateName" value="BranchIndexReduction"/>
        ...
        <%@ include file="/WEB-INF/pages/wfworksheet/branchindexreduction/baseinputlinkhtmlnew.jsp" %>
        <table class="formTable">
            <tr>
                <td class="label"><bean:message bundle="sheet" key="phase.pleaseSelect"/></br>
                    <input type="checkbox" name="checkall" id="checkall" value="${toTask.operateRoleId}"
                           onclick="selfcheckall();eoms.util.checkAll(this, 'deal')">
                    全选</br>
                    <input type="checkbox" name="checkbackall" id="checkbackall" value="${toTask.operateRoleId}"
                           onclick="selfcheckbackall();selfx()">
                    反选
                    ...
                    <table class="listTable">
                        <logic:present name="toOperaterList" scope="request">
                            ...
                            <logic:iterate id="toTask" name="toOperaterList"
                                           type="com.boco.eoms.sheet.branchindexreduction.model.BranchIndexReductionTask">
                                <tr>
                                    <td>
                                        <input type="checkbox" name="deal" id="deal" value="${toTask.operateRoleId}"
                                               onclick="check()">
                                        ...
                                        <input type="hidden" name="performerType" id="performerType"
                                               value="${toTask.operateType}"/>
                                        <input type="hidden" name="performerLeader" id="performerLeader"
            ...
            <tr>
                ...
                <td colspan="3">
		           <textarea name="remark" class="textarea max" id="remark"
                             alt="width:500,allowBlank:false,maxLength:2000,vtext:'请填入意见，最多输入1000字'"
