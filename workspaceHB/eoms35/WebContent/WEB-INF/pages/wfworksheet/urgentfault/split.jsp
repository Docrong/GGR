...
<div id="sheetform">
    <html:form action="/urgentfault.do?method=performCreateSubTask" styleId="theform">
      ...
      <table class="formTable">
        ...
        <input type="hidden" name="${sheetPageName}taskNamespace" value="http://UrgentFaultProcess"/>     
        <input type="hidden" name="${sheetPageName}operateType" id="${sheetPageName}operateType" value="${operateType}" />
		<tr>	
		  <td class="label">            
             <bean:message bundle="urgentfault" key="urgentfault.linkTransmitReason1"/>*
          </td>
          <td colspan="3">
