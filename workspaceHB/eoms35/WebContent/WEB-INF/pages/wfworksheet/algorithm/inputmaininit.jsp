...
<input type="hidden" name="${sheetPageName}processTemplateName" value="AlgorithmMainFlowProcess"/>
...
<table class="formTable">
    ...
    <tr>
        <td class="label"><bean:message bundle="algorithm" key="algorithm.mainRemark"/>*</td>
        <td colspan="3" class="content">
