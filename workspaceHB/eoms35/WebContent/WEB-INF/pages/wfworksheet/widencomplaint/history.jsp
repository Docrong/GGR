        ...
        <logic:iterate id="baselink" name="HISTORY" type="com.boco.eoms.sheet.widencomplaint.model.WidenComplaintLink">
            ...
            <div class="history-item">&nbsp;
                ...
                <div class="history-item-title">
                    ...
                    <eoms:dict key="dict-sheet-widencomplaint" dictId="activeTemplateId"
                    ...
                    <eoms:dict key="dict-sheet-widencomplaint" dictId="mainOperateType" itemId="${baselink.operateType}"
                ...
                <div class="history-item-content hide">
                    <table class="formTable" width="100%" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td class="column-content">
                                <bean:write name="baselink" property="linkFirstContactUesrTime"
                            ...
                            <td class="column-content">
                                <bean:write name="baselink" property="linkReservationTime" format="yyyy-MM-dd HH:mm:ss"
                                            scope="page"/>
                            </td>
