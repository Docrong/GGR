...
public interface ITawwpNetMgr {
     ...
     *
     * @param pagePra int[] 鍒嗛〉淇℃伅
     * @return List 缃戝厓鍒楄〃
     * @throws TawwpException 寮傚父淇℃伅
     */
     ...
     *
     * @param _name      String 缃戝厓鍚嶇О
     * @param _deptId    String 鎵�灞為儴闂�
     * @param _roomId    String 鎵�鍦ㄦ満鎴�
     * @param _sysTypeId String 绯荤粺绫诲埆
     * @param _netTypeId String 缃戝厓绫诲瀷
     * @param _serialNo  String 搴忓垪鍙�
     * @param _vendor    String 鍘傚晢
     * @param vendorSel
     * @throws TawwpException 寮傚父淇℃伅
     */
     ...
     *
     * @param _netTypeId String 缃戝厓绫诲瀷鏍囪瘑
     ...
     * @param _netTypeId String 缃戝厓绫诲瀷鏍囪瘑
     * @param _deptId    String 閮ㄩ棬
     * @param flag       鏄惁鏀惧紑鏈堝害浣滀笟璁″垝鍒跺畾鍚庝慨鏀圭綉鍏冪殑鍔熻兘
     * @return List 缃戝厓鍒楄〃
     * @throws TawwpException 寮傚父淇℃伅
     */
