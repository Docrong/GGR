...
<html>
    ...
    <body class="roster">
        <div id="ie5menu" class="skin0" onMouseover="highlightie5(event)" onMouseout="lowlightie5(event)"
            ...
            <nobr>
                <div class="menuitems" func="roster.openChat">Iniciar charla</div>
            </nobr>
            <nobr>
                <div class="menuitems" func="roster.openMessage">Enviar mensaje</div>
            </nobr>
            <nobr>
                <div class="menuitems" func="openCustomPresence">Presencia</div>
            </nobr>
            <nobr>
                <div class="menuitems" func="openUserProps">Editar usuario</div>
            </nobr>
            <nobr>
                <div class="menuitems" func="openUserInfo">Mostrar informaci&oacute;n</div>
            </nobr>
            <nobr>
                <div class="menuitems" func="openUserHistory" id='hist_menuitem'>Historial</div>
            </nobr>
            <nobr>
                <div class="menuitems" func="openUserNote">Editar anotación</div>
            </nobr>
            <div class="menuitems" func="openSubscription">Resubscribirse</div>
            <div class="menuitems" func="removeUser">Borrar</div>
        </div>
        <div id="gwMenu" class="skin0" onMouseover="highlightie5(event)" onMouseout="lowlightie5(event)"
             onClick="jumptoie5(event)" display:none>
            <nobr>
                <div class="menuitems" func="openCustomPresence">Presencia</div>
            </nobr>
            <nobr>
                <div class="menuitems" func="openUserProps">Editar</div>
            </nobr>
            <nobr>
                <div class="menuitems" func="openUserInfo">Mostrar informaci&oacute;n</div>
            </nobr>
        </div>
        <div id="gChatMenu" class="skin0" onMouseover="highlightie5(event)" onMouseout="lowlightie5(event)"
             onClick="jumptoie5(event)" display:none>
            <nobr>
                <div class="menuitems" func="openGroupchat">Mostrar</div>
            </nobr>
            <nobr>
                <div class="menuitems" func="openCustomPresence">Presencia</div>
            </nobr>
