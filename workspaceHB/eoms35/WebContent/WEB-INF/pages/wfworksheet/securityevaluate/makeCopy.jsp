...
<div id="sheetform">
<html:form action="/securityevaluate.do?method=newPerformNonFlow" styleId="theform">
       <%@ include file="/WEB-INF/pages/wfworksheet/securityevaluate/baseinputlinkhtmlnew.jsp"%>
    <br/>
	      <input type="hidden" name="${sheetPageName}processTemplateName" id="${sheetPageName}processTemplateName" value="SecurityEvaluateProcess" />
          <input type="hidden" name="${sheetPageName}operateName" id="${sheetPageName}operateName" value="nonFlowOperate" />
           <input type="hidden" name="${sheetPageName}beanId"   id="${sheetPageName}beanId"  value="iSecurityEvaluateMainManager"/>
           <input type="hidden" name="${sheetPageName}mainClassName" id="${sheetPageName}mainClassName"  value="com.boco.eoms.sheet.securityevaluate.model.SecurityEvaluateMain"/>	<!--mainè¡¨Modelå¯¹è±¡ç±»å-->	
           <input type="hidden" name="${sheetPageName}linkClassName" id="${sheetPageName}linkClassName" value="com.boco.eoms.sheet.securityevaluate.model.SecurityEvaluateLink"/> <!--linkè¡¨Modelå¯¹è±¡ç±»å-->
