...
<div id="sheetform">
    <html:form action="/safetyproblem.do?method=performBatchDeal" styleId="theform">
                ...
                <tr>
                    ...
                    <td class="content">
                        <select id="dealSelector" onchange="checkValue(this)" alt="allowBlank:false,vtext:'请选择处理操作'">
                            <option value=""></option>
                            <option value="Receive"><bean:message bundle="safetyproblem"
                                                                  key="safetyproblem.dealrejectpass"/></option>
                            <option value="ExcuteHumTask"><bean:message bundle="safetyproblem"
                    ...
                    <td class="content">
                        ...
                        <input type="hidden" name="beanId" value="iSafetyProblemMainManager"/>
                        <input type="hidden" name="mainClassName"
                               value="com.boco.eoms.sheet.safetyproblem.model.SafetyProblemMain"/>
                        <input type="hidden" name="linkClassName"
                               value="com.boco.eoms.sheet.safetyproblem.model.SafetyProblemLink"/>
