            ...
            <tr>
                ...
                <td class="content">
                    <input class="text" onclick="popUpCalendar(this, this)" type="text"
                           ...
                           alt="vtype:'lessThen',link:'nodeCompleteLimit',vtext:'受理时限不能晚于处理时限',allowBlank:false"/>
                ...
                <td class="content">
                    <input class="text" onclick="popUpCalendar(this, this)" type="text"
                           ...
                           value="${eoms:date2String(sheetLink.nodeCompleteLimit)}" id="nodeCompleteLimit"
                           alt="vtype:'moreThen',link:'nodeAcceptLimit',vtext:'完成时限不能早于受理时限',allowBlank:false"/>
                </td>
            </tr>
            <tr>
                <td class="label">
                ...
                <td colspan="3">
                    <textarea class="textarea max" name="transferReason" id="transferReason"
                              alt="allowBlank:false,maxLength:4000,vtext:'请填入备注信息，最多输入4000字符'">${sheetLink.transferReason}</textarea>
                </td>
            </tr>
