...
<%@ include file="/WEB-INF/pages/wfworksheet/urgentfault/baseinputmainhtmlnew.jsp"%>
	...
	<table class="formTable">	
		...
		<tr>
		  ...
		  <td><input type="text" class="text" name="${sheetPageName}mainFaultSheetId" id="${sheetPageName}mainFaultSheetId" value="${sheetMain.mainFaultSheetId}" alt="allowBlank:true"/></td>
		  <td class="label"></td>
		  <td></td>
		</tr>
		...
		<tr>
		  ...
		  <td>
			<eoms:comboBox name="${sheetPageName}mainNetSortOne" id="${sheetPageName}mainNetSortOne" 
			   initDicId="1010104" sub="${sheetPageName}mainNetSortTwo" defaultValue="${sheetMain.mainNetSortOne}" alt="allowBlank:false" onchange="selectLimit(this.value);"/>
		  </td>
		  ...
		  <td>
		  	<eoms:comboBox name="${sheetPageName}mainNetSortTwo" id="${sheetPageName}mainNetSortTwo"
		  	   initDicId="${sheetMain.mainNetSortOne}" sub="${sheetPageName}mainNetSortThree" defaultValue="${sheetMain.mainNetSortTwo}" 
		...
		<tr>
		  ...
		  <td colspan="3">
	  		<textarea name="mainFaultDesc" id="mainFaultDesc" class="textarea max" alt="allowBlank:false">${sheetMain.mainFaultDesc}</textarea>			   
		  </td> 
		</tr>	
		...
		<tr id="shihou1" style="display:none">
		  ...
		  <td>
		  	<eoms:comboBox name="${sheetPageName}mainFaultReason" id="${sheetPageName}mainFaultReason" 
		  	   initDicId="1010303" sub="${sheetPageName}mainFaultSubReason" defaultValue="${sheetMain.mainFaultReason}" alt="allowBlank:false"/>
		  </td>
		  ...
		  <td>
		  	<eoms:comboBox name="${sheetPageName}mainFaultSubReason" id="${sheetPageName}mainFaultSubReason"
		  	    initDicId="${sheetMain.mainFaultReason}" defaultValue="${sheetMain.mainFaultSubReason}" alt="allowBlank:false"/>
		  </td>		  
		</tr>  
      ...
      <!--shi hou  end-->
		<tr>
		  ...
		  <td>
		  	<input type="text" class="text" name="${sheetPageName}mainTrafficLoss" id="${sheetPageName}mainTrafficLoss" value="${sheetMain.mainTrafficLoss}" alt="allowBlank:true"/>
		  </td>
		  <td class="label"><bean:message bundle="urgentfault" key="urgentfault.mainTriggerUserComplaint"/></td>
		  <td>
		  	<input type="text" class="text" name="${sheetPageName}mainTriggerUserComplaint" id="${sheetPageName}mainTriggerUserComplaint" value="${sheetMain.mainTriggerUserComplaint}" alt="allowBlank:true"/>
		  </td>
		</tr>
		...
		<tr>
		  ...
		  <td>
		  	<input type="text" class="text" name="${sheetPageName}mainImpactUserNum" id="${sheetPageName}mainImpactUserNum" value="${sheetMain.mainImpactUserNum}" alt="allowBlank:true"/>
		  </td>
		</tr>		
		...
		<tr>
		  ...
		  <td colspan="3">
	  		<textarea name="${sheetPageName}mainAffectOperationDesc" id="${sheetPageName}mainAffectOperationDesc" class="textarea max">${sheetMain.mainAffectOperationDesc}</textarea>			   
		  </td>
		</tr>	
	...
	<!--shi hou start -->	
		...
		<tr id="shihou4" style="display:none">
		  ...
		  <td>
		  	<input type="text" class="text" name="${sheetPageName}mainAffectTimeLength" id="${sheetPageName}mainAffectTimeLength" value="${sheetMain.mainAffectTimeLength}" alt="allowBlank:false"/>
		  </td>
		</tr>	
   ...
   <c:if test="${status!=1}">	
      <c:if test="${!empty sheetMain.mainSendContentType}">  
		...
		<eoms:chooser id="testSendRole" type="role" roleId="196" flowId="53" config="{returnJSON:true,showLeader:true}"
