...
<script language='javascript'>
    function period() {
        ...
        location.href = '${app}/kmmanager/personalAuditStatistics.do?method=search&startDate=' + startDate + '&endDate=' + endDate;
    }
</script>
...
<fmt:bundle basename="com/boco/eoms/km/config/applicationResource-kmmanager">
    ...
    <content tag="heading">
        <b><fmt:message key="personalAuditStatistic.list.personalHeading"/></b>
    </content>
    ...
    <display:table name="personalAuditStatisticList" cellspacing="0" cellpadding="0"
        ...
        <display:column sortable="true" headerClass="sortable" titleKey="personalAuditStatistic.userName">
            <eoms:id2nameDB id="${personalAuditStatisticList.userName}" beanId="tawSystemUserDao"/>
        </display:column>
        ...
        <display:column property="auditCount" sortable="true"
                        headerClass="sortable" titleKey="personalAuditStatistic.auditCount" paramId="id"
                        paramProperty="id"/>

        <display:column property="auditOkCount" sortable="true"
                        headerClass="sortable" titleKey="personalAuditStatistic.auditOkCount" paramId="id"
                        paramProperty="id"/>

        <display:column property="auditBackCount" sortable="true"
                        headerClass="sortable" titleKey="personalAuditStatistic.auditBackCount" paramId="id"
                        paramProperty="id"/>

        <display:column property="auditOkRatio" sortable="true"
                        headerClass="sortable" titleKey="personalAuditStatistic.auditOkRatio" paramId="id"
                        paramProperty="id"/>
