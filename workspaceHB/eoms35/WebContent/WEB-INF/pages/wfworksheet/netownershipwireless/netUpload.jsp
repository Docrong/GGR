...
<html:form action="/netownershipwireless.do?method=exportExcel&appId=netownershipwireless" method="post"
           styleId="theform">
    <table class="formTable">
        ...
        <tr>
            <td colspan="4">
                <input type="submit" id="exportTempButton" value="生成模板" class="button"
