...
<form name="tawwpexecuteform" method="POST" action="../tawwpexecute/BakdataResult.do">
    ...
    <table width="500" border="0" cellspacing="1" cellpadding="1" class="table_show" align=center>
        ...
        <tr class="tr_show">
            ...
            <td align="left">
                <input type="text" name="startDate" size="15" onclick="popUpCalendar(this, this);" readonly="readonly"
                       class="text">
            </td>
            <td width="20%" class="td_label8">
                结束时间：
            ...
            <td align="left">
                <input type="text" name="endDate" size="15" onclick="popUpCalendar(this, this);" readonly="readonly"
                       class="text">
            </td>
        </tr>
        <tr class="tr_show">
