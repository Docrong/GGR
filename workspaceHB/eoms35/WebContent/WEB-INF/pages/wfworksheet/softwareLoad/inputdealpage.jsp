...
<%
    ...
    IBaseSheet baseSheet = (IBaseSheet) ApplicationContextHolder.getInstance().getBean("SoftwareLoad");
    if (bl != null) {
...
<table class="formTable">
    ...
    <input type="hidden" name="${sheetPageName}phaseId" id="${sheetPageName}phaseId" value="ProgramTask"/>
    <tr>
        <td class="label">
    ...
    <input type="hidden" name="${sheetPageName}operateType" id="${sheetPageName}operateType" value="<%=operateType%>"/>
    <input type="hidden" name="${sheetPageName}phaseId" id="${sheetPageName}phaseId" value="LoadingTask"/>
    <tr>
        <td class="label">
            <bean:message bundle="sheet" key="linkForm.acceptLimit"/>*
        </td>
    ...
    <input type="hidden" name="${sheetPageName}operateType" id="${sheetPageName}operateType" value="<%=operateType%>"/>
    <input type="hidden" name="${sheetPageName}phaseId" id="${sheetPageName}phaseId" value="TestingTask"/>
    <tr>
        <td class="label">
            <bean:message bundle="sheet" key="linkForm.acceptLimit"/>*
        </td>
    ...
    <tr>
        <td class="label">
            <bean:message bundle="softwareLoad" key="softwareLoad.linkLoadtime"/>*
        </td>
        <td class="content">
            <input class="text" onclick="popUpCalendar(this, this)" type="text"
                   name="${sheetPageName}linkLoadtime" readonly="readonly"
                   value="${eoms:date2String(sheetLink.linkLoadtime)}" id="${sheetPageName}linkLoadtime"
                   alt="vtype:'moreThen',link:'${sheetPageName}nodeAcceptLimit',vtext:'处理时限不能早于受理时限',allowBlank:false"/>

        </td>
        <td class="label">
            <bean:message bundle="softwareLoad" key="softwareLoad.linkPointName"/>*
        </td>
        <td class="content">
            <input type="text" class="text" name="${sheetPageName}linkPointName" value="${sheetLink.linkPointName }"
    ...
    <tr>
        <td class="label">
            <bean:message bundle="softwareLoad" key="softwareLoad.linkTestTime"/>*
        </td>
        <td class="content">
            <input class="text" onclick="popUpCalendar(this, this)" type="text"
                   name="${sheetPageName}linkTestsites" readonly="readonly"
                   value="${eoms:date2String(sheetLink.linkTestsites)}" id="${sheetPageName}linkTestsites"
                   alt="vtype:'moreThen',link:'${sheetPageName}nodeAcceptLimit',vtext:'处理时限不能早于受理时限',allowBlank:false"/>

        </td>
        <td class="label">
            <bean:message bundle="softwareLoad" key="softwareLoad.linkTestsites"/>*
        </td>
        <td class="content">
            <input type="text" class="text" name="${sheetPageName}linkTestsites" value="${sheetLink.linkTestsites }"
                   alt="allowBlank:false"/>
        </td>
    </tr>
    <tr>
...
<%if (taskName.equals("DevelopTask") && operateType.equals("200")) { %>
...
<%} %>
<%if (taskName.equals("ProgramTask") && operateType.equals("201")) { %>
...
<%} %>
<%if (taskName.equals("LoadingTask") && operateType.equals("202")) { %>
