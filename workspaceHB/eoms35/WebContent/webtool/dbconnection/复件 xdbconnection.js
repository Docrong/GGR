    ...
    init: function () {
        ...
        editer.add(
            new Ext.form.TextField({
                fieldLabel: '数据源名称', id: 'dbName', name: 'dbName', width: 175, allowBlank: false
            }),
            new Ext.form.TextField({
                fieldLabel: 'URL', id: 'dbConnectionUrl', name: 'dbConnectionUrl', width: 175, allowBlank: false
            }),
            new Ext.form.TextField({
                fieldLabel: '用户名', id: 'userName', name: 'userName', width: 175, allowBlank: false
            }),
            new Ext.form.TextField({
                fieldLabel: '口令', id: 'password', name: 'password', value: 'ajax', width: 175, allowBlank: false
            }),
            new Ext.form.TextField({
                fieldLabel: '字符集', id: 'dbCharset', name: 'dbCharset', value: 'GBK', width: 175, allowBlank: false
            }),
            new Ext.form.TextField({
                fieldLabel: '描述', id: 'description', name: 'description', width: 175, allowBlank: false
            }),
            new Ext.form.TextField({
                fieldLabel: '数据库类型', id: 'dbType', name: 'dbType', width: 175, allowBlank: false
            })
        );
