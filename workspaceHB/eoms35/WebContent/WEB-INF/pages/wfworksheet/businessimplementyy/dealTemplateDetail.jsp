...
<html:form action="/businessimplementyy.do" styleId="theform">
    ...
    <table class="formTable">
        ...
        <input type="hidden" name="${sheetPageName}mainClassName"
               value="com.boco.eoms.sheet.businessimplementyy.model.BusinessImplementYYMain"/>
        <input type="hidden" name="${sheetPageName}linkClassName"
               value="com.boco.eoms.sheet.businessimplementyy.model.BusinessImplementYYLink"/>
        ...
        <tr>
            ...
            <td colspan="3">
                <eoms:comboBox name="${sheetPageName}linkIsAppled" id="${sheetPageName}linkIsAppled" initDicId="1013301"
                               styleClass="select-class" alt="allowBlank:false" defaultValue="${sheetLink.linkIsAppled}"
                               onchange="onchangeAppled(this.value);"/>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td colspan="3">
			      <textarea class="textarea max" name="${sheetPageName}linkNoAppledOpinition"
                            id="${sheetPageName}linkNoAppledOpinition"
        ...
        <tr>
            ...
            <td class="content">
                <input type="text" class="text" name="${sheetPageName}linkGoupeProductCode"
                       id="${sheetPageName}linkGoupeProductCode" alt="allowBlank:true"
                       value="${sheetLink.linkGoupeProductCode}"/>
            </td>
            <td class="label">处理方式*</td>
            <td class="content">
                <eoms:comboBox name="${sheetPageName}linkDealMethod" id="${sheetPageName}linkDealMethod"
                               initDicId="1013302" styleClass="select-class" alt="allowBlank:false"
                               defaultValue="${sheetLink.linkDealMethod}"/>
            </td>
        </tr>
        <tr>
            <td class="label">处理意见</td>
            <td colspan="3">
			      <textarea class="textarea max" name="${sheetPageName}linkDealOpinition"
                            id="${sheetPageName}linkDealOpinition"
        ...
        <tr>
            ...
            <td colspan="3"
            ">
            <eoms:comboBox name="${sheetPageName}linkInfoMethod" id="${sheetPageName}linkInfoMethod" initDicId="1013303"
                           styleClass="select-class" alt="allowBlank:false" defaultValue="${sheetLink.linkInfoMethod}"
                           onchange="onchangelinkInfoMethod(this.value);"/>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="content">
                <eoms:comboBox name="${sheetPageName}linkInfoProtocol" id="${sheetPageName}linkInfoProtocol"
                               initDicId="1013304" styleClass="select-class" alt="allowBlank:true"
                               defaultValue="${sheetLink.linkInfoProtocol}"/>
            </td>
            <td class="label">集团产品编码*</td>
            <td class="content">
                <input type="text" class="text" name="${sheetPageName}linkGoupeProductCode"
        ...
        <tr>
            ...
            <td class="content">
                <input type="text" class="text" name="${sheetPageName}linkCircuitCode"
                       id="${sheetPageName}linkCircuitCode" alt="allowBlank:true" value="${sheetLink.linkCircuitCode}"/>
            </td>
            <td class="label">处理方式*</td>
            <td class="content">
                <eoms:comboBox name="${sheetPageName}linkDealMethod" id="${sheetPageName}linkDealMethod"
        ...
        <tr>
            ...
            <td colspan='3'>
                <input type="text" class="text" name="${sheetPageName}linkBusiInputNet"
                       id="${sheetPageName}linkBusiInputNet" alt="allowBlank:true"
                       value="${sheetLink.linkBusiInputNet}"/>
            </td>
        ...
        <tr>
            ...
            <td class="content">
                <input type="text" class="text" name="${sheetPageName}linkPointNumber"
                       id="${sheetPageName}linkPointNumber" alt="allowBlank:false"
                       value="${sheetLink.linkPointNumber}"/>
            </td>
            <td class="label">信令端口数量*</td>
            <td class="content">
                <input type="text" class="text" name="${sheetPageName}linkInfoPointNumber"
                       id="${sheetPageName}linkInfoPointNumber" alt="allowBlank:false"
                       value="${sheetLink.linkInfoPointNumber}"/>
            </td>
        </tr>
        <!--
		       <tr>
        ...
        <tr>
            ...
            <td class="content" colspan='3'>
                <!-- add by liufuyuan -->
                <eoms:comboBox name="${sheetPageName}linkIsAppled" id="${sheetPageName}linkIsAppled" initDicId="1013301"
                               defaultValue="${sheetLink.linkIsAppled}" styleClass="select" alt="allowBlank:false"
        ...
        <tr>
            ...
            <td class="content">
                <eoms:comboBox name="${sheetPageName}linkIsDataOk" id="${sheetPageName}linkIsDataOk" initDicId="1013306"
                               styleClass="select-class" alt="allowBlank:false" defaultValue="${sheetLink.linkIsDataOk}"
                               onchange="onchangelinkIsDataOk(this.value);"/>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td colspan='3'>
                <eoms:comboBox name="${sheetPageName}linkIsDataOk" id="${sheetPageName}linkIsDataOk" initDicId="1013301"
                               styleClass="select-class" alt="allowBlank:false"
                               defaultValue="${sheetLink.linkIsDataOk}"/>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td colspan='3'>
			           <textarea class="textarea max" name="${sheetPageName}linkDateMakeResult"
                                 id="${sheetPageName}linkDateMakeResult"
        ...
        <tr>
            ...
            <td class="content">
                <eoms:comboBox name="${sheetPageName}linkDealMethod" id="${sheetPageName}linkDealMethod"
                               initDicId="1013307" styleClass="select-class" alt="allowBlank:false"
                               defaultValue="${sheetLink.linkDealMethod}"/>
            </td>
        </tr>
        <tbody id="NoApplied" style="display:none">
        ...
        <tr>
            ...
            <td class="content">
                <eoms:comboBox name="${sheetPageName}linkIsOk" id="${sheetPageName}linkIsOk" initDicId="1013308"
                               styleClass="select-class" alt="allowBlank:false" defaultValue="${sheetLink.linkIsOk}"/>
            </td>
            <td class="label">是否满足需求*</td>
            <td class="content">
                <eoms:comboBox name="${sheetPageName}linkIsOkNeed" id="${sheetPageName}linkIsOkNeed" initDicId="1013301"
                               styleClass="select-class" alt="allowBlank:false" defaultValue="${sheetLink.linkIsOkNeed}"
        ...
        <tr>
            ...
            <td colspan="3">
			      <textarea class="textarea max" name="${sheetPageName}linkNoOkResson"
                            id="${sheetPageName}linkNoOkResson"
