...
<script language="javascript">
    Ext.onReady(function () {
        ...
        handoverTree = new xbox({
            btnId: 'handoverTreeBtn',
            dlgId: 'dlg-huser',
            treeDataUrl: handoverTreeAction,
            treeRootId: '-1',
            treeRootText: '${eoms:a2u("交班人列表")}',
            treeChkMode: 'single',
            treeChkType: 'user',
            showChkFldId: 'handoverName',
            saveChkFldId: 'tmpHandoverId'
        });
        successorTree = new xbox({
            btnId: 'successorTreeBtn',
            dlgId: 'dlg-suser',
            treeDataUrl: successorTreeAction,
            treeRootId: '-1',
            treeRootText: '${eoms:a2u("接班人列表")}',
            treeChkMode: 'single',
            treeChkType: 'user',
            showChkFldId: 'successorName',
            saveChkFldId: 'tmpSuccessorId'
        });
    })
</script>
