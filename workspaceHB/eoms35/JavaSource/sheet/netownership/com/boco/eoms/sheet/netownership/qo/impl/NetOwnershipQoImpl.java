package com.boco.eoms.sheet.netownership.qo.impl;
...
public class NetOwnershipQoImpl implements INetOwnershipQo {
...
//		}
    ...
    public void stringExpression(Map properties, String columnName, StringBuffer where, String name, String nameValue) {
        ...
        if (expressionValue != null && expressionValue.equals("=")) {
            where.append(NetOwnershipQOhelper.addEqualClause(name, nameValue));
        } else if (expressionValue != null && expressionValue.equals("in")) {
            where.append(NetOwnershipQOhelper.addInClause(name, nameValue));
        } else {
            if (nameValue.contains(",")) {
                where.append(NetOwnershipQOhelper.addInClause(name, nameValue));
            } else {
                where.append(NetOwnershipQOhelper.addLikeClause(name, nameValue));
            }
        }
    }
    ...
    public void dateExpression(Map properties, String columnName, StringBuffer where, String name, DataBaseTypeAdapterQO dataBaseTypeAdapterQO) {
        ...
        if (startDateValue != null && !startDateValue.equals("")) {
            dateWhere.append(" and (").append(NetOwnershipQOhelper.addGreatOrEqualDateClause(name, (String) startDateExpressionValue, (String) startDateValue, dataBaseTypeAdapterQO));
        }
        if (endDateValue != null && !endDateValue.equals("")) {
            ...
            dateWhere.append(NetOwnershipQOhelper.addGreatOrEqualDateClause(name, (String) endDateExpressionValue, (String) endDateValue, dataBaseTypeAdapterQO));
            dateWhere.append(")");
    ...
    public void numberExpression(Map properties, String columnName, StringBuffer where, String name) {
        ...
        if (startNumberValue != null && !String.valueOf(startNumberValue).equals("")) {
            numberWhere.append(" and (").append(NetOwnershipQOhelper.addGreatOrEqualNumberClause(name, (String) startNumberExpressionValue, String.valueOf(startNumberValue)));
        }
        if (EndNumberValue != null && !String.valueOf(EndNumberValue).equals("")) {
            ...
            numberWhere.append(NetOwnershipQOhelper.addGreatOrEqualNumberClause(name, (String) EndNumberExpressionValue, String.valueOf(EndNumberValue)));
            numberWhere.append(")");
    ...
    public void choiceExpression(Map properties, String columnName, StringBuffer where, String name) {
        ...
        if (choiceExpressionValue != null && choiceExpressionValue.getClass().isArray()) {
            ...
            where.append(NetOwnershipQOhelper.addEqualClause(name, (String) choiceExpressionValue));
        }
    }
    ...
    public void orderExpression(Map properties, String columnName, StringBuffer orderWhere, String name) {
        ...
        if (orderWhere.toString().equals("")) {
            orderWhere.append(NetOwnershipQOhelper.addOrderClause(name, (String) orderExpressionValue));
        } else {
            orderWhere.append("," + NetOwnershipQOhelper.addOrderClause(name, (String) orderExpressionValue));
        }
