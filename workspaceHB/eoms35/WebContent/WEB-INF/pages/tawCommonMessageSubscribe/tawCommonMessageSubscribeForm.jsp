...
<html:form action="saveTawCommonMessageSubscribe" method="post" styleId="tawCommonMessageSubscribeForm">
    <ul>
        ...
        <li>
            ...
            <eoms:comboBox name="receivertype" id="receivertype" sub="revecer" initDicId="1020201"
                           ds="/message/tawCommonMessageSubscribes.do?method=xsearch&type="/>
       ...
       <input type="button" value="<fmt:message key="label.selectTree"/>" onclick="$('checkboxtree').toggle();"/>-->
        ...
        <li class="buttonBar bottom">
            ...
            <html:submit styleClass="button" property="method.delete"
                         onclick="bCancel=true; return confirmDelete('TawCommonMessageSubscribe')">
