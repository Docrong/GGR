     ...
     <div class="history-item"><!-- add space to hack ie-->&nbsp;
       <div class="history-item-title">
		 ...
		 <bean:write name="baselink" property="operateTime" formatKey="date.formatDateTimeAll" bundle="sheet" scope="page"/>&nbsp; 
  	     ...
  	     <eoms:dict key="dict-sheet-netchange" dictId="activeTemplateId" itemId="${baselink.activeTemplateId}" beanId="id2descriptionXML" />
  	     <bean:message bundle="netchange" key="netchange.operateType"/>:
  	     <eoms:dict key="dict-sheet-netchange" dictId="mainOperateType" itemId="${baselink.operateType}" beanId="id2descriptionXML" />
       ...
       <div class="history-item-content hide">
        ...
        <tr>
		 ...
		 <%if(baselink.getActiveTemplateId()!=null && baselink.getActiveTemplateId().equals("ExecuteTask")){
     		...
     		<tr>
			  ...
			  <td>
			  	 <eoms:id2nameDB id="${baselink.linkIfStartCircuit}" beanId="ItawSystemDictTypeDao" />
			  </td>
			  <td class="label"><bean:message bundle="netchange" key="netchange.linkIfStartData"/></td>
			  <td>
			  	<eoms:id2nameDB id="${baselink.linkIfStartData}" beanId="ItawSystemDictTypeDao" />
			  </td>
			</tr>
			<tr>
			  <td class="label"><bean:message bundle="netchange" key="netchange.linkIfStartSoft"/></td>
			  <td colspan="3">
			  	<eoms:id2nameDB id="${baselink.linkIfStartSoft}" beanId="ItawSystemDictTypeDao" />
			  </td>
			</tr>
		 	</c:if>
			</c:if>
		...
		<tr>
			  ...
			  <td colspan="3">
			  	 <eoms:id2nameDB id="${baselink.linkIfAccordingProject}" beanId="ItawSystemDictTypeDao" />
			  </td>
		</tr>
        <tr>
     		<td class="label"><bean:message bundle="netchange" key="netchange.linkColligateExcuteResult"/></td>
     		<td colspan="3">
     			<pre><bean:write name="baselink" property="linkColligateExcuteResult" scope="page"/></pre>
			  </td>
		</tr>
     	...
     	<tr>
     		...
     		<td colspan="3">
     			<eoms:attachment name="baselink" property="nodeAccessories" 
              scope="page" idField="${sheetPageName}nodeAccessories" appCode="netchange" viewFlag="Y"/>
			  </td>
		</tr>
	  	 <%}%>
	  	 </c:if>
