            ...
            <table class="formTable">
                <tr>
                    ...
                    <td class="content"><bean:write name="sheetMain" property="sheetAcceptLimit"
                                                    ...
                                                    scope="request"/></td>
                    <td class="label"><bean:message bundle="resourceaffirm"
                                                    key="resourceaffirm.sheetcompletelimit"/></td>
                    <td><bean:write name="sheetMain" property="sheetCompleteLimit" formatKey="date.formatDateTimeAll"
                ...
                <tr>
                    ...
                    <td class="label"><bean:message bundle="resourceaffirm"
                                                    key="resourceaffirm.bdeptContactPhone"/></td>
                ...
                <tr>
                    ...
                    <td class="label"><bean:message bundle="resourceaffirm"
                                                    key="resourceaffirm.customContactPhone"/></td>
                ...
                <tr>
                    ...
                    <td class="label"><bean:message bundle="resourceaffirm"
                                                    key="resourceaffirm.cmanagerContactPhone"/></td>
                ...
                <tr>
                    ...
                    <td class="label"><bean:message bundle="resourceaffirm"
                                                    key="resourceaffirm.isBeforehandOccupy"/></td>
                    <td>
            ...
            <tr>
                <td width="50%">
                    ...
                    <select id="dealSelector">
                        ...
                        <option value="${urlShowNewAuditPassPage}"><bean:message bundle="resourceaffirm"
                                                                                 key="resourceaffirm.taskpass"/></option>
                        <option value="${urlShowNewAuditUnpassPage}"><bean:message bundle="resourceaffirm"
                                                                                   key="resourceaffirm.tasknopass"/></option>
                        <%} %>
                    </select>
                    ...
                    <select id="dealSelector">
                        ...
                        <option value="${urlShowRejectBackPage}"><bean:message bundle="sheet"
                                                                               key="common.rejectBack"/></option>
                        <%} else if (taskStatus.equals(Constants.TASK_STATUS_CLAIMED)) { %>
                        <option value="${urlShowTaskCompleteAuditYes}"><bean:message bundle="resourceaffirm"
                                                                                     key="resourceaffirm.TaskCompleteAuditYes"/></option>
                        <option value="${urlShowTaskCompleteAuditNo}"><bean:message bundle="resourceaffirm"
                                                                                    key="resourceaffirm.TaskCompleteAuditNo"/></option>
                        <%} %>
                    </select>
                    ...
                    <select id="dealSelector">
                        ...
                        <option value="${urlShowCompleteDealPage}"><bean:message bundle="resourceaffirm"
                                                                                 key="resourceaffirm.dealwcnosp"/></option>
                        <option value="${urlShowPassDealPage}"><bean:message bundle="resourceaffirm"
                                                                             key="resourceaffirm.totaskcompsq"/></option>
			    ...
			    <option value="${urlShowTransferkPage}"><bean:message bundle="sheet" key="common.transfer"/></option>	
	  		   <option value="${urlShowInputSplit1}"><bean:message bundle="sheet" key="common.split"/></option>-->
                    ...
                    <select id="dealSelector">
                        <option value="${urlShowExamineNODealPage}"><bean:message bundle="resourceaffirm"
                                                                                  key="resourceaffirm.dealrejectpass"/></option>
                        <option value="${urlShowExamineDealPage}"><bean:message bundle="resourceaffirm"
                                                                                key="resourceaffirm.nopassback"/></option>
                    </select>
                    <%} else if (taskName.equals("DraftHumTask")) {%>
                    <select id="dealSelector">
                        <option value="${urlShowCompleteDraftPage}"><bean:message bundle="resourceaffirm"
                                                                                  key="operateType.draft"/></option>
                    </select>
                    <%} else if (taskName.equals("HoldHumTask")) { %>
                    <select id="dealSelector">
                        <option value="${urlShowHoldDealPage}"><bean:message bundle="resourceaffirm"
