...
<form name="tawwpmodeladd" method="post" enctype="multipart/form-data"
      action="modelimport.do?reaction=/tawwpmodel/modellist.do" onsubmit='return SubmitCheck()'>
    ...
    <table class="formTable">
        ...
        <tr>
            ...
            <td width="400">
                <select size=1 name="systype" class="select"
                        onChange="changelocation(document.tawwpmodeladd.systype.options[document.tawwpmodeladd.systype.selectedIndex].value)">
        ...
        <tr>
            ...
            <td>
                <eoms:dict key="dict-workplan" dictId="typeIndex" isQuery="false" defaultId="" selectId="typeIndex"
                           beanId="selectXML"/>
    ...
    <input type="button" value="<bean:message key="modelimport.title.btnBack" />"
