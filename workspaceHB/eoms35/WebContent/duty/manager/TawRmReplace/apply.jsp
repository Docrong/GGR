...
<script type="text/javascript">
    Ext.onReady(function () {
        ...
        new xbox({
            ...
            treeChkMode: 'single',
            treeChkType: 'user',
            showChkFldId: 'receiverName',
            saveChkFldId: 'receiver'
        });
    })
    Ext.onReady(function () {
    ...
    <tr>
        <td>
            ...
            <table cellpadding="0" cellspacing="0" border="0" width="600">
                <tr>
                    <td>
                        <table border="0" width="80%" cellspacing="1" cellpadding="1" class="listTable" align=left
                               width="600">
                            <tr class="tr_show">
                                <td class="label">
                                        ${eoms:a2u('选择替班人')}
                                ...
                                <td>
                                    ...
                                    <html:text property="receiverName" styleId="receiverName"
                                               ...
                                               alt="allowBlank:false,vtext:'${eoms:a2u('请输入替班人')}'"/>
                            ...
                            <tr>
                                ...
                                <td>
                                    <eoms:SelectDate name="time_from" formName="tawRmReplaceForm" flag="1"
                                                     value="<%=str_start%>"/>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <eoms:SelectDate name="time_to" formName="tawRmReplaceForm" flag="1"
                                                     value="<%=str_start%>"/>
                                </td>
                            </tr>
                            <tr class="tr_show">
