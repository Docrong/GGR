...
values ('4028811e5d8829ff015d882a002a0012', '99999191401', '1', '新增工单', '999991914', null,
...
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('4028811e5d8829ff015d882a002b001c', '9999919140402', '1', '建立工单', '99999191404', null,
        '/sheet/branchindexreduction/branchindexreduction.do?method=showOwnStarterList', '0', '0', 2);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('4028811e5d8829ff015d882a002b001d', '9999919140401', '1', '处理工单', '99999191404', null,
        '/sheet/branchindexreduction/branchindexreduction.do?method=showListsenddone', '0', '0', 1);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('4028811e5d8829ff015d882a002b001e', '99999191405', '1', '已归档工单', '999991914', null,
        '/sheet/branchindexreduction/branchindexreduction.do?method=showHoldedList', '0', '0', 5);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('4028811e5d8829ff015d882a002b001f', '99999191406', '1', '已作废工单', '999991914', null,
        '/sheet/branchindexreduction/branchindexreduction.do?method=showCancelList', '0', '0', 6);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('4028811e5d8829ff015d882a002b0020', '99999191411', '1', '超时时间设置', '999991914', null,
        '/sheet/overtimetip/overtimetip.do?flowName=BranchIndexReduction', '0', '0', 11);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('4028811e5d8829ff015d882a002b0021', '99999191412', '1', '工单处理时限配置', '999991914', null,
