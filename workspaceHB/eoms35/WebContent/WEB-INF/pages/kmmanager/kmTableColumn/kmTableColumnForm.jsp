...
<html:form action="/kmTableColumns.do?method=save" styleId="kmTableColumnForm" method="post">
            ...
            <tr>
                ...
                <td class="content">
                    <html:text property="colChname" styleId="colChname"
                               ...
                               alt="allowBlank:false,vtext:'请填写字段名称'" value="${kmTableColumnForm.colChname}"/>
                ...
                <td class="content">
                    <eoms:dict key="dict-kmmanager" dictId="colDictType" isQuery="false"
                               alt="allowBlank:false,vtext:'请选择绑定类型'"
                               defaultId="${kmTableColumnForm.colDictType}" selectId="colDictType" beanId="selectXML"
                               onchange="changeTree()"/>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="content">
                    <!--html:text property="colDictId" styleId="colDictId" styleClass="text medium"
						alt="allowBlank:false,vtext:'请填写绑定类型编号'" value="${kmTableColumnForm.colDictId}" />  -->
                    <input type="text" id="colDictName" name="colDictName" class="text" readonly="readonly"
                           value='<eoms:id2nameDB id="${kmTableColumnForm.colDictId}" beanId="kmTableThemeDao" />'
                ...
                <td class="content">
                    <eoms:dict key="dict-kmmanager" dictId="colType" isQuery="false"
                               alt="allowBlank:false,vtext:'请选择字段类型'"
                               defaultId="${kmTableColumnForm.colType}" selectId="colType" beanId="selectXML"
                               onchange="display()"/>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="content">
                    <html:text property="colSize" styleId="colSize"
                               styleClass="text medium"
                               alt="vtype:'number'" value="${kmTableColumnForm.colSize}"/>
                ...
                <td class="content">
                    <html:text property="colDefault" styleId="colDefault"
                               styleClass="text medium"
                               alt="allowBlank:true,vtext:'请填写字段默认值'" value="${kmTableColumnForm.colDefault}"/>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="content">
                    <html:text property="orderBy" styleId="orderBy"
                               styleClass="text medium"
                               alt="allowBlank:true,vtext:''" value="${kmTableColumnForm.orderBy}"/>
                </td>
                <td class="label">
                ...
                <td class="content">
                    <eoms:dict key="dict-kmmanager" dictId="isOrNot" isQuery="false"
                               alt="allowBlank:false,vtext:'请选择是否为空'"
                               defaultId="${kmTableColumnForm.isNullable}" selectId="isNullable" beanId="selectXML"/>
                </td>
            </tr>
            <tr>
                <td class="label">
                    <fmt:message key="kmTableColumn.subNode"/>1111
                </td>
	...
	<tr>
		<td class="label">
			<fmt:message key="kmTableColumn.isOpen" />
		</td>
		<td class="content">
		<eoms:dict key="dict-kmmanager" dictId="isOrNot" isQuery="false" alt="allowBlank:false,vtext:'请选择是否开放'"
				defaultId="${kmTableColumnForm.isOpen}" selectId="isOpen" beanId="selectXML" />	
		
		</td>
		<td class="label">
			<fmt:message key="kmTableColumn.isVisibl" />
		</td>
		<td class="content">
		<eoms:dict key="dict-kmmanager" dictId="isOrNot" isQuery="false" alt="allowBlank:false,vtext:'请选择是否可显'"
				defaultId="${kmTableColumnForm.isVisibl}" selectId="isVisibl" beanId="selectXML" onchange="onIsVisiblChg(this)"/>
		</td>
	</tr>
-->
	...
	<tr>
	    <td class="label">
			<fmt:message key="kmTableColumn.isUnique" />
		</td>
		<td class="content">
		<eoms:dict key="dict-kmmanager" dictId="isOrNot" isQuery="false" alt="allowBlank:false,vtext:'请选择是否唯一'"
				defaultId="${kmTableColumnForm.isUnique}" selectId="isUnique" beanId="selectXML" />	
		
		</td>	
		<td class="label">
			<fmt:message key="kmTableColumn.isIndex" />
		</td>
		<td class="content">
		<eoms:dict key="dict-kmmanager" dictId="isOrNot" isQuery="false"
				defaultId="${kmTableColumnForm.isIndex}" selectId="isIndex" beanId="selectXML" />			
		</td>		
	</tr>  
-->
	...
	<tr>
		<td class="label">
			<fmt:message key="kmTableColumn.isDeleted" />
		</td>
		<td class="content">		
				<eoms:dict key="dict-kmmanager" dictId="isOrNot" itemId="${kmTableColumnForm.isDeleted}" beanId="id2nameXML" />	
		</td>
	</tr>
-->
