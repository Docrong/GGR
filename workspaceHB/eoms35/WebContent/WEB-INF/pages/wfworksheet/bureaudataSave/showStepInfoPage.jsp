        ...
        <logic:iterate id="baselink" name="HISTORY" type="com.boco.eoms.sheet.bureaudataSave.model.BureaudataSaveLink">
            ...
            <div class="history-item"><!-- add space to hack ie-->&nbsp;
                <div class="history-item-title">
                    ...
                    <eoms:dict key="dict-sheet-bureaudataSave" dictId="activeTemplateId"
                    ...
                    <eoms:dict key="dict-sheet-bureaudataSave" dictId="mainOperateType" itemId="${baselink.operateType}"
                ...
                <div class="history-item-content hide">
  			      ...
  			      <%} %> -->
                        ...
                        <tr>
                            ...
                            <td class="column-content">
                                <eoms:dict key="dict-sheet-bureaudataSave" dictId="mainOperateType"
                        ...
                        <tr>
                            <td class="label"><bean:message bundle="bureaudataSave"
                                                            key="bureaudataSave.linkTaskComplete"/></td>
                            <td class="column-content" colspan="3">
