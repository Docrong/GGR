...
<html:html>
    ...
    <form name="form1">
        ...
        <table border="0" width="100%" cellspacing="1" cellpadding="1" class="table_show" align=center>
            <tr class="tr_show">
                <td width="100%" colspan="11" height="25" align="center"><bean:write name="pagerHeader" scope="request"
                ...
                <tr class="tr_show">
                    <td width="20%" height="25" class="clsfth" align="center">
                        ...
                        <html:link page="/project/tasklist.do" name="map" scope="page">
                            <center><font color="red"><bean:write name="project" property="project_name"
                                                                  scope="page"/></font></center>
                        </html:link></td>
                    ...
                    <%} else {%>
                    <td width="15%" height="25" class="clsfth" align="center">
                        <center><font color="red">已全部分配</font></center>
                    </td>
