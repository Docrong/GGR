...
<div id="sheetform">
    <html:form action="/commonfaultcorrigendum.do?method=performDealReplyReject" styleId="theform">
        <%
        ...
        <input type="hidden" name="subtaskName" value="CommonfaultCorrigendumSubTask"/>
        ...
        <input type="hidden" name="taskNamespace" value="http://CommonfaultCorrigendum"/>
