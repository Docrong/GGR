     ...
     <div class="history-item" width="100%" ><!-- add space to hack ie-->&nbsp;
  	...
  	<logic:iterate id="tawCommonsAccessoriesForm" name="sheetAccessories" type="com.boco.eoms.commons.accessories.webapp.form.TawCommonsAccessoriesForm" scope="request">
  				<tr>
  				  ...
  				  <td>
				       <eoms:dict key="dict-sheet-safetyproblem" dictId="activeTemplateId" itemId="${tawCommonsAccessoriesForm.activeTemplateId}" beanId="id2descriptionXML" />  
  				  </td>
  				  <td>
  				  ...
  				  <td>
  				     <eoms:id2nameDB id="${tawCommonsAccessoriesForm.accessoriesDep}" beanId="tawSystemDeptDao"/>
  				  </td>
  				  <td>
	  		...
	  		<table>
	  			<tr>
	  				<td>
	  					<input type="button" name="button" class="button" value="${eoms:a2u('批量导出')}" onclick="download()" >
	  				</td>
	  			</tr>
	  		</table>	
	 </logic:present> 
