...
<div id="sheetform">
    <html:form action="/mofficedata.do?method=performCreateSubTask" styleId="theform">
       <%@ include file="/WEB-INF/pages/wfworksheet/mofficedata/baseinputlinkhtmlnew.jsp"%>		
       <br/>		
      <table class="formTable">
      			<tr>
			<td class="label">是否地市拨测*</td>
			<td>
				<eoms:comboBox name="linkIsNeedTest" id="linkIsNeedTest" initDicId="1014007"
				   defaultValue="${sheetLink.linkIsNeedTest}" alt="allowBlank:false"/>
			</td>
		</tr>
      	<tr>        
	       <td class="label">
			...
			<td colspan="3">			
               ...
               <input type="hidden" name="taskNamespace" value="http://MofficeData"/>  
  ...
  <legend>
   请选择派发对象   
     ...
     <eoms:chooser id="test" type="role"
		roleId="58704" flowId="587" config="{returnJSON:true}"
