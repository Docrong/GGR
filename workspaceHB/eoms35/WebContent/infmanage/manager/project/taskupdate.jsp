...
<html:form method="post" action="/project/taskupdatedone">
    ...
    <center>
        ...
        <table border="0" width="95%" cellspacing="0">
            ...
            <bean:define id="task_executor_name" name="projectForm" property="task_executor_name"
            ...
            <tr>
                <td width="106%" class="table_title" align="center">
                    <center><%=project_name%>项目----修改<%=task_name%>子任务信息(剩余可分配比例<font color="red"><%=rest%>%</font>)
                    </center>
                </td>
            </tr>
        </table>
        <table border="0" width="95%" cellspacing="1" cellpadding="1" class="table_show" align=center>
            ...
            <tr class="tr_show">
                ...
                <td width="75%" height="25">
                    <html:text styleClass="clstext" property="task_exec_time" readonly="true" size="20"
                               onfocus="setday(this)"/><font color=crimson>*</font>
                    不得早于 <font color="red"><%=pro_exec_time.substring(0, 10)%>
                </font></td>
            ...
            <tr class="tr_show">
                ...
                <td width="75%" height="25">
                    <html:text styleClass="clstext" property="task_comp_time" readonly="true" size="20"
                               onfocus="setday(this)"/><font color=crimson>*</font>
                    不得晚于 <font color="red"><%=pro_comp_time.substring(0, 10)%>
                </font></td>
            ...
            <tr class="tr_show">
                ...
                <td width="70%" height="25">
                    <select size=1 name="task_executor" style="width:220;z-index:-1">
                        <option value="<%=task_executor%>"><%=task_executor_name%>
                        </option>
            ...
            <tr class="tr_show">
                ...
                <%if (rest == 0) {%>
                <td width="70%" height="25">
                    <html:text property="task_scale" size="2" styleClass="clstext"/>%(修改不要超过<%=task_scale%>%)
                </td>

                <%} else {%>
                <td width="70%" height="25">
                    <html:text property="task_scale" size="2"
                               styleClass="clstext"/>%(修改不要超过<%=Integer.parseInt(task_scale.toString()) + rest%>%)
                </td>
                <%}%>
            </tr>
            <tr class="tr_show">
