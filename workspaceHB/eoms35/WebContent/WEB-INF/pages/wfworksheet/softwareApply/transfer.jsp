...
<html:form action="/softwareApply.do?method=performTransferWorkItem" styleId="theform">
    ...
    <br/>
           <input type="hidden" name="${sheetPageName}beanId"   id="${sheetPageName}beanId"  value="iSoftwareApplyMainManager"/>
           <input type="hidden" name="${sheetPageName}mainClassName" id="${sheetPageName}mainClassName"  value="com.boco.eoms.sheet.softwareApply.model.SoftwareApplyMain"/>		
           <input type="hidden" name="${sheetPageName}linkClassName" id="${sheetPageName}linkClassName" value="com.boco.eoms.sheet.softwareApply.model.SoftwareApplyLink"/> 
   ...
   <div class="form-btns">
        ...
        <input type="submit" class="submit" onclick="v.passing=true;this.form.action='${app}/sheet/softwareApply/softwareApply.do?method=performSaveInfo'" value="<bean:message bundle='sheet' key='button.save'/>" />
