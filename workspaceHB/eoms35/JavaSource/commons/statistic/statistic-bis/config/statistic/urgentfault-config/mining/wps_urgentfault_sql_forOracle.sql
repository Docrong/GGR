...
from urgentfault_main

select *
from urgentfault_link select *
from urgentfault_task
...
----est_stat---
    ...
    case when task.operatetype=
     'subrole' then orole.roleid else to_number(null) end operate_bigrole_id,
    sd.linkid send_dept_level,
    od.linkid operate_dept_level,
--common main
...
--common link
    ...
    case when to_date(to_char(task.ACCEPTTIMELIMIT,
     'YYYY-MM-DD HH24:MI:SS'),
     'YYYY-MM-DD HH24:MI:SS')> sysdate then 1 else 2 end ACCEPTFLAG,
    case when to_date(to_char(task.COMPLETETIMELIMIT,
     'YYYY-MM-DD HH24:MI:SS'),
     'YYYY-MM-DD HH24:MI:SS')> sysdate then 1 else 2 end COMPLETEFLAG,
    task.PRELINKID,
...
------------------------------VIEW----------------------------------------
select *
from v_urgentfault select distinct *
from v_urgentfault
...
--common task
                                     ...
                                     taskoperatetype
--bussines main
    , MAINSENDCONTENTTYPE, MAINIFGREATFAULT, MAINGREATFAULTID, MAINFAULTSHEETID, MAINFAULTGENERANTTIME,
                                     MAINFAULTGENERANTPLACE, MAINEQUIPMENTFACTORY, MAINFAULTREASON, MAINTRAFFICLOSS,
                                     MAINIMPACTUSERNUM, MAINIFAFFECTOPERATION, MAINAFFECTAREA, MAINAFFECTSTARTTIME,
                                     MAINAFFECTOPERATIONLEVEL, MAINAFFECTOPERATIONSORT, MAINTRIGGERUSERCOMPLAINT,
                                     MAINIFREPORT, MAINIFACHIEVEPROJECTSTARTUP, MAINURGENTLEVE, MAINFAULTSPECIALITY,
                                     MAINEQUIPINTEGRATOR, MAINFAULTAVOIDTIME, MAINAFFECTTIMELENGTH, MAINNETSORTONE,
                                     MAINNETSORTTWO, MAINNETSORTTHREE, MAINFAULTSUBREASON, MAINFAULTLOCATION,
                                     MAINREPORTLIMIT, SENDYEAR, SENDMONTH, SENDDAY, MAINIFRECORD
--bussines link
    , LINKIFGREATFAULT, LINKFAULTGENERANTPLACE, LINKFAULTAVOIDTIME, LINKAFFECTTIMELENGTH, LINKGREATFAULTID,
                                     LINKIFAFFIRM, LINKFAULTREASON, LINKFAULTSUBREASON, OPERATEYEAR, OPERATEMONTH,
                                     OPERATEDAY
    ) as
    (
--�Ѵ���
...
values (53, to_date('2007-07-07 00:00:00', 'YYYY-MM-DD HH24:MI:SS'), '����Ϲ������ɼ�����һ�β����ʱ��');

drop table est_last_oper
delete
from est_last_oper
select *
from est_last_oper SELECT *
FROM est_last_oper
WHERE
    id =51
...
from commonfault_link delete from est_urgentfault;
select *
from est_urgentfault;
