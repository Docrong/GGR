...
<script type="text/javascript">
    ...
    Ext.onReady(function () {
        ...
        subroleFromDept = new xbox({
            btnId: 'roleTreeBtn',
            dlgId: 'dlg-subroleFromDept',
            treeDataUrl: subroleFromDept,
            treeRootId: '-1',
            treeRootText: '${eoms:a2u("部门角色")}',
            treeChkMode: '',
            treeChkType: 'subrole',
            showChkFldId: 'revRoleName',
            saveChkFldId: 'revRoleid'
        });
        ...
        userByDeptTree = new xbox({
            ...
            treeChkMode: '',
            treeChkType: 'user',
            showChkFldId: 'revUserName',
            saveChkFldId: 'revUserid'
        });
    ...
    <table class="formTable">
        ...
        <tr id="trSelectdept">
            ...
            <td id="selrevrole">
                ...
                <input type="text" name="revRoleName" value="" id="revRoleName" class="text" readonly="readonly"
                       alt="allowBlank:true">

            </td>
            <td id="selrevperson">
                <input type="button" value="${eoms:a2u('受理人')}" id="userTreeBtn" class="btn"/>
                <input type="text" name="revUserName" value="" id="revUserName" class="text" readonly="readonly"
                       alt="allowBlank:true">
            </td>
        </tr>
        <tr>
