	...
	<SPAN class="EOMSListbox" id=listboxRoot onchange="jscript: fnEOMSListboxOnChange('listboxRoot');"
      ...
      <TABLE cellSpacing=0 cellPadding=0>
        ...
        <TR class=EOMSListboxItem id="tr_parentid_1">
		  ...
		  <IMG id="img_parentid_1" name="img_parentid_1" src="<%=webapp%>/kbs/configbox/listbox/images/false.gif"
               onclick="loadDeptPost('',1)" style="cursor:hand"></TD>
...
<% for (int b = 0; b < arrSort.length; b++) { %>
	...
	<BOCO:genericButton css="classic" onclick="fnEOMSListboxMoveRow('listboxSort<%=b+1%>');"
                        image="<%=webapp%>/css/listbox/images/btnarrow.gif">
	 <%=arrSort[b]%>
	</BOCO:genericButton>
	</td></tr>
<% } %>
