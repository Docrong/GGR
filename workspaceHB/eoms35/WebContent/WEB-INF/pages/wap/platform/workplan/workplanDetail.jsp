                ...
                <div class="div_all">
                    <table width="100%" border="0" cellpadding="1" cellspacing="1" class="add_table_bg">
                        ...
                        <tr class="fb_xx_head_tr">
                            <td class="tt_head_bg">
                                <nobr><%=tawwpExecuteContentVO.getName()%>
                                </nobr>
                                ...
                                <input type="hidden" name="userid<%=i%>"
                            ...
                            <input type="hidden" name="writeDate<%=i%>" size="20"
                                   value="<%=StaticMethod.getCurrentDateTime()%>">
                            <td class="fb_add_content">
                                <textarea name="content<%=i%>" rows=2
                        ...
                        <tr class="fb_xx_head_tr">
                            ...
                            %>
                            <td><a href='${app}/workplan<%=tempArray1%>'><%=tempArray[0]%>
                            </a>
                            </td>
                            <%
                                }
