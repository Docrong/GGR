     ...
     <div class="history-item"><!-- add space to hack ie-->&nbsp;
       <div class="history-item-title">
		 ...
		 <bean:write name="baselink" property="operateTime" formatKey="date.formatDateTimeAll" bundle="sheet" scope="page"/>&nbsp; 
  	     ...
  	     <eoms:dict key="dict-sheet-commonfault" dictId="activeTemplateId" itemId="${baselink.activeTemplateId}" beanId="id2nameXML" />
  	     <bean:message bundle="commonfault" key="commonfault.operateType"/>:
  	     <eoms:dict key="dict-sheet-commonfault" dictId="mainOperateType" itemId="${baselink.operateType}" beanId="id2descriptionXML" />
			 ...
			 <%//移交T2
			  if(baselink.getOperateType()!=null && baselink.getOperateType().intValue() == 1){%> 
  				...
  				<tr>
	  				  ...
	  				  <td class="column-content">
	  				      <eoms:id2nameDB id="${baselink.linkIfMutualCommunication}" beanId="ItawSystemDictTypeDao" />
	  			      </td>
	  				  <td class="column-title">
          ...
          <tr>
		     ...
		     <tr>
		  		...
		  		<tr>
	  				  ...
	  				  <td class="column-content">
	  				   	<eoms:id2nameDB id="${baselink.linkFaultReasonSubsection}" beanId="ItawSystemDictTypeDao"/>
	                  </td>	                  
		  		</tr>
		  			<tr>
		  			 <td class="column-title">
	  				  ...
	  				  <td colspan="3">
	  				  	<eoms:id2nameDB id="${baselink.linkFaultReasonSubsectionTwo}" beanId="ItawSystemDictTypeDao"/>
	                  </td>	                 
		       ...
		       <td class="label">
                ...
                <tr>
	  				  ...
	  				  <td class="column-content" colspan=3>
	  				   	<eoms:id2nameDB id="${baselink.linkIfFinallySolveProject}" beanId="ItawSystemDictTypeDao"/>
	                  </td>
		  		</tr>
	           ...
	           <td class="column-title">
		  		...
		  		<tr>
	  				  ...
	  				  <td class="column-content">
	  				  	 <bean:write name="baselink" property="linkOperRenewTime" format="yyyy-MM-dd HH:mm:ss" scope="page"/>
	                  </td>                  
  				</tr>
