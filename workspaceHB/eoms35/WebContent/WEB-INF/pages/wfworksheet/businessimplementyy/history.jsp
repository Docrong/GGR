                        ...
                        <c:if test="${!empty baselink.activeTemplateId && (baselink.activeTemplateId == 'CodeDispthTask')}">
                            <c:if test="${!empty baselink.operateType && (baselink.operateType == '72'||baselink.operateType == '11' ||baselink.operateType == '111')}">
                                ...
                                <tr>
                                    ...
                                    <td class="content">
                                        <eoms:id2nameDB id="${baselink.linkInfoProtocol}"
                                ...
                                <td colspan="3"">
                                <eoms:comboBox name="${sheetPageName}linkBackResonType"
                                               id="${sheetPageName}linkBackResonType" initDicId="1013305"
                                               styleClass="select-class" alt="allowBlank:false"
                                               defaultValue="${sheetLink.linkBackResonType}"/>
                                </td>
                                </tr> -->
                                <tr>
                                    <td class="label">处理意见</td>
