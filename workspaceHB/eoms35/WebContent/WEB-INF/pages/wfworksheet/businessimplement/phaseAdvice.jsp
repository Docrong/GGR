...
<%
 ...
 %>
    ...
    <input type="hidden" name="${sheetPageName}linkClassName" value="com.boco.eoms.sheet.businessimplement.model.BusinessImplementLink"/> <!--link\u8868Model\u5bf9\u8c61\u7c7b\u540d--> 
 	<input type="hidden" name="${sheetPageName}processTemplateName" id="${sheetPageName}processTemplateName" value="BusinessImplementMainFlowProcess" />
...
<%@ include file="/WEB-INF/pages/wfworksheet/businessimplement/baseinputlinkhtmlnew.jsp"%>
     <table  class="listTable">
      ...
      <logic:iterate id="toTask" name="toOperaterList" type="com.boco.eoms.sheet.businessimplement.model.BusinessImplementTask">  
        <tr>
          <td>
