...
<body bgcolor="#ffffff" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onload="init()"
      oncontextmenu="return true;" ondragstart="return false" onselectstart="return false" onbeforecopy="return false">
<div id='hiddenPic'
     style='position:absolute; left:433px; top:258px; width:77px; height:91px; z-index:1; visibility: hidden;'>
    <img id='images2' name='images2' src='${app}/images/equipmentsecurityresponse.gif' border='0'>
</div>
<div id='block1' onmouseout="javascript:drag=0;" onmouseover='javascript:dragObj=block1; drag=1;'
    ...
    <dd><img id='images1' name='images1' src='${app}/images/equipmentsecurityresponse.gif' border='0'></dd>
</div>
