...
<table class="formTable">
    ...
    <tr>
        ...
        <td colspan="3">
            <eoms:comboBox name="${sheetPageName}linkIfProvidedNeeds" id="${sheetPageName}linkIfProvidedNeeds"
                           initDicId="1010106" defaultValue="${sheetLink.linkIfProvidedNeeds}" alt="allowBlank:false"
                           onchange="IfTestPass(this.value)"/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td colspan="3">
            <textarea name="${sheetPageName}linkArgument" alt="allowBlank:false,maxLength:255,vtext:'请填入处理意见，最多输入255字符'"
                      id="${sheetPageName}linkArgument" class="textarea max">${sheetLink.linkArgument}</textarea>
        </td>
    </tr>
    <%
            }
    ...
    <tr>
        ...
        <td colspan="3">
            <input class="text" onclick="popUpCalendar(this, this)" type="text"
                   ...
                   readonly="readonly" value="${eoms:date2String(sheetLink.linkinputGetUserDate)}"
                   alt="allowBlank:true"/>
    ...
    <tr>
        ...
        <td colspan="3">
            <eoms:comboBox name="${sheetPageName}linkCircuitResult" id="${sheetPageName}linkCircuitResult"
                           initDicId="1013306" styleClass="select-class" alt="allowBlank:false"
                           defaultValue="${sheetLink.linkCircuitResult}" onchange="onchangelinkIsDataOk(this.value);"/>
        </td>
    </tr>
    </tbody>
    ...
    <tr>
        ...
        <td colspan='3'>
			           <textarea class="textarea max" name="${sheetPageName}linkUnsuccessDesc"
                                 id="${sheetPageName}linkUnsuccessDesc"
    ...
    <tr>
        ...
        <td colspan="3">
			      <textarea class="textarea max" name="${sheetPageName}linkStartSheetDesc"
                            id="${sheetPageName}linkStartSheetDesc"
    ...
    <input type="hidden" name="${sheetPageName}toMorePhaseId" id="${sheetPageName}toMorePhaseId"
           value="NetMakeTask,SupportMakeTask"/>
    <tr>
        <td class="label">企业代码*</td>
        <td class="content">
            <input type="text" class="text" name="${sheetPageName}linkEnterpriseNum"
                   id="${sheetPageName}linkEnterpriseNum" value="${sheetLink.linkEnterpriseNum}"
                   alt="allowBlank:false,maxLength:50,vtext:'请填入企业代码，六位数字'"/>
        </td>
        <td class="label">服务代码*</td>
        <td class="content">
            <input type="text" class="text" name="${sheetPageName}linkServiceNum" id="${sheetPageName}linkServiceNum"
                   value="${sheetLink.linkServiceNum}"
                   alt="allowBlank:false,maxLength:50,vtext:'请填入服务代码，以106开头的7位-20位，以10086、1258、12114、9开头的20位以内。'"/>
        </td>
    </tr>
    <tr>
        <td class="label">接入号码*</td>
        <td class="content">
            <input type="text" class="text" name="${sheetPageName}linkPointNum" id="${sheetPageName}linkPointNum"
                   value="${sheetLink.linkPointNum}" alt="allowBlank:false,maxLength:50,vtext:'请填入接入号码'"/>
        </td>
        <td class="label">黑名单*</td>
        <td class="content">
            <input type="text" class="text" name="${sheetPageName}linkBlackName" id="${sheetPageName}linkBlackName"
                   value="${sheetLink.linkBlackName}" alt="allowBlank:true"/>
        </td>
    </tr>
    <tr>
        <td class="label">白名单*</td>
        <td class="content" colspan=3>
            <input type="text" class="text" name="${sheetPageName}linkWhiteName" id="${sheetPageName}linkWhiteName"
                   value="${sheetLink.linkWhiteName}" alt="allowBlank:true"/>
        </td>
    </tr>
    <%
            }
    ...
    <tr>
        ...
        <td class="content">
            <input type="text" class="text" name="${sheetPageName}linkGatewayAddress"
                   id="${sheetPageName}linkGatewayAddress" value="${sheetLink.linkGatewayAddress}"
                   alt="allowBlank:false,maxLength:50,vtext:'请填入服务代码，以106开头的7位-20位，以10086、1258、12114、9开头的20位以内。'"/>
        </td>
    </tr>
    <tr>
        ...
        <td class="content">
            <input type="text" class="text" name="${sheetPageName}linkSmsGatewayAddress"
                   id="${sheetPageName}linkSmsGatewayAddress" value="${sheetLink.linkSmsGatewayAddress}"
                   alt="allowBlank:false,maxLength:50,vtext:'请填入企业代码，六位数字'"/>
        </td>
        <td class="label">业务流向限制*</td>
        <td class="content">
            <input type="text" class="text" name="${sheetPageName}linkBusinessLimit"
                   id="${sheetPageName}linkBusinessLimit" value="${sheetLink.linkBusinessLimit}"
                   alt="allowBlank:false,maxLength:50,vtext:'请填入企业代码，六位数字'"/>
        </td>
    ...
    <tr>
        ...
        <td class="content">
            <input type="text" class="text" name="${sheetPageName}linkLoginName" id="${sheetPageName}linkLoginName"
                   value="${sheetLink.linkLoginName}"
                   alt="allowBlank:false,maxLength:50,vtext:'请填入服务代码，以106开头的7位-20位，以10086、1258、12114、9开头的20位以内。'"/>
        </td>
        <td class="label">登录网关的密码*</td>
        <td class="content">
            <input type="text" class="text" name="${sheetPageName}linkLoginPassword"
                   id="${sheetPageName}linkLoginPassword" value="${sheetLink.linkLoginPassword}"
                   alt="allowBlank:false,maxLength:50,vtext:'请填入企业代码，六位数字'"/>
        </td>
    ...
    <tr>
        ...
        <td class="content">
            <input type="text" class="text" name="${sheetPageName}linkCompanyBusy" id="${sheetPageName}linkCompanyBusy"
                   value="${sheetLink.linkCompanyBusy}"
                   alt="allowBlank:false,maxLength:50,vtext:'请填入服务代码，以106开头的7位-20位，以10086、1258、12114、9开头的20位以内。'"/>
        </td>
        <td class="label">企业流控闲时*</td>
        <td class="content">
            <input type="text" class="text" name="${sheetPageName}linkCompanyFree" id="${sheetPageName}linkCompanyFree"
                   value="${sheetLink.linkCompanyFree}"
                   alt="allowBlank:false,maxLength:50,vtext:'请填入服务代码，以106开头的7位-20位，以10086、1258、12114、9开头的20位以内。'"/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td class="content">
            <input type="text" class="text" name="${sheetPageName}linkSmsUrl" id="${sheetPageName}linkSmsUrl"
                   value="${sheetLink.linkSmsUrl}" alt="allowBlank:false,maxLength:50,vtext:'请填入企业代码，六位数字'"/>
        </td>
        <td class="label">ProvisionURL*</td>
        <td class="content">
            <input type="text" class="text" name="${sheetPageName}linkProvisionURL"
                   id="${sheetPageName}linkProvisionURL" value="${sheetLink.linkProvisionURL}"
                   alt="allowBlank:false,maxLength:50,vtext:'请填入服务代码，以106开头的7位-20位，以10086、1258、12114、9开头的20位以内。'"/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td class="content">
            <input type="text" class="text" name="${sheetPageName}linknetWayIpAdd" id="${sheetPageName}linknetWayIpAdd"
                   value="${sheetLink.linknetWayIpAdd}"/>
        </td>
    ...
    <tr>
        <td class="label">回复意见*</td>
        <td>
				   <textarea name="${sheetPageName}linkDealResult" id="${sheetPageName}linkDealResult"
                             class="textarea max"
    ...
    <tr>
        ...
        <td colspan="3">
            <input type="text" class="text" name="${sheetPageName}linkMasServerNum"
                   id="${sheetPageName}linkMasServerNum" value="${sheetLink.linkMasServerNum}"
                   alt="allowBlank:false,maxLength:50,vtext:'请填入MAS服务器电路编号'"/>
        </td>
    </tr>
    <tr>
        <td class="label">回复意见*</td>
    ...
    <tr>
        ...
        <td colspan="3">
				   <textarea name="${sheetPageName}linkUnSatisfiedReason" id="${sheetPageName}linkUnSatisfiedReason"
                             class="textarea max"
