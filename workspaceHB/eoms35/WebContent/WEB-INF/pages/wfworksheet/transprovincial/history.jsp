...
<div id="history" class="panel">
    ...
    <logic:present name="HISTORY" scope="request">
        ...
        <logic:iterate id="baselink" name="HISTORY"
                       type="com.boco.eoms.sheet.transprovincial.model.TransprovincialLink">
            <%
                jNum += 1;
            ...
            <div class="history-item">&nbsp;
                ...
                <div class="history-item-title">
                    ...
                    <eoms:dict key="dict-sheet-transprovincial" dictId="activeTemplateId"
                    ...
                    <eoms:dict key="dict-sheet-transprovincial" dictId="mainOperateType"
