...
public class HandheldOperationLoader {
	...
	public static String createOpDetailXml(List chNameList,List enNameList,List contentList,List analysisList){
		...
		for(int i=0;i<chNameList.size();i++){
			HandheldOperationLoader.addContentXML(recordInfo,StaticMethod.nullObject2String(chNameList.get(i)),StaticMethod.nullObject2String(enNameList.get(i)),contentList.get(i),analysisList);
		}
