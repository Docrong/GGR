...
import com.boco.eoms.sheet.safetyproblem.model.SafetyProblemTask;

public class SafetyProblemTaskDAOHibernate extends TaskDAOImpl implements ISafetyProblemTaskDAO {
    ...
    public HashMap getTaskListBySQL(final String queryStr,
        ...
        HibernateCallback callback = new HibernateCallback() {
            public Object doInHibernate(Session session) throws HibernateException {
                ...
                try {
                    Query query = session.createSQLQuery(queryStr).addScalar("title").addScalar("revert").addEntity(SafetyProblemTask.class);
