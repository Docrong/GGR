...
<head>
<title>
<bean:message key="sparepart.servicein"/>
</title>
...
<table border="0" width="95%" cellspacing="0">
    <tr>
      <td class="table_title" align="center">
         <b><bean:message key="sparepart.servicein"/></b>
      </td>
    </tr>
</table>
<%
...
<table border="0" width="95%" cellspacing="1" cellpadding="1" class="table_show" align="center">
    ...
    <logic:iterate id="taworder" name="taworder" type="com.boco.eoms.sparepart.model.TawOrder">
        <tr class="tr_show">
                      ...
                      <td><p align="center"><html:link page="/part/servicecontent.do" paramId="id" paramName="taworder" paramProperty="id"><bean:message key="sparepart.msg"/></html:link></td>
        </tr>
      </logic:iterate>
</table>
</center>
