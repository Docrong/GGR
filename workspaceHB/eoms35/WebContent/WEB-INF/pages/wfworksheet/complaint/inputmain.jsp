	...
	<table id="sheet" class="formTable">	
		<c:if test="${status!=1}">
			...
			<tr>
			  ...
			  <td colspan="3">
		  		<eoms:comboBox name="${sheetPageName}urgentDegree" id="${sheetPageName}urgentDegree" initDicId="1010606" defaultValue="${sheetMain.urgentDegree}" alt="allowBlank:ture"/>
			  </td>			 					  
			</tr>		
			<tr>
			 ...
			 <tr>
			  ...
			  <td>
			  	 <eoms:comboBox name="${sheetPageName}complaintType1" id="${sheetPageName}complaintType1" 
			  	      sub="${sheetPageName}complaintType2" initDicId="1010601" defaultValue="${sheetMain.complaintType1}" alt="allowBlank:ture" onchange="selectLimit(this.value);"/>
			  </td>				
			  ...
			  <td>
			    <eoms:comboBox name="${sheetPageName}complaintType2" id="${sheetPageName}complaintType2" 
			  	      sub="${sheetPageName}complaintType" initDicId="${sheetMain.complaintType1}" defaultValue="${sheetMain.complaintType2}" alt="allowBlank:ture" onchange="selectLimit(this.value);"/>
			  </td>		  
			</tr>					
            <tr>
		   ...
		   <tr>
            ...
            <tr>
			 ...
			 <tr>
			  ...
			  <td>
			  	<input type="text" class="text" name="${sheetPageName}customPhone" id="${sheetPageName}customPhone" value="${sheetMain.customPhone}" alt="allowBlank:true"/>
			  </td>		  
			</tr>
			<tr>
            ...
            <tr>
			  ...
			  <td colspan="3">
		  		<textarea name="${sheetPageName}complaintDesc" id="${sheetPageName}complaintDesc" class="textarea max" alt="allowBlank:true,maxLength:2000,vtext:'投诉内容，最多输入1000汉字'">${sheetMain.complaintDesc}</textarea>	
			  </td>			 					  
			</tr>
            <tr>
