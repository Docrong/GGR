...
<input type="hidden" name="${sheetPageName}processTemplateName" value="NetFaultMainFlowProcess"/>
...
<table class="formTable">
    ...
    <tr>
        <td class="label"><bean:message bundle="netFault" key="netFault.mainRemark"/>*</td>
        <td colspan="3" class="content">
