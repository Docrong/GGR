...
<%@ include file="/WEB-INF/pages/wfworksheet/focusresourceerrata/baseinputlinkhtmlnew.jsp"%>
	...
	<table class="formTable">
		...
		<%} %>
			...
			<td>
				<input type="text"  class="text" name="linkCheckState" id="linkCheckState"  alt="allowBlank:true,maxLength:1000,vtext:'请填入 电路核查状态 信息，最多输入 1000 字符'" value="${sheetLink.linkCheckState}"/>
			</td>
		</tr>
 ...
 <%}%>
			...
			<td>
				<input type="text"  class="text" name="linkIsMysel" id="linkIsMysel"  alt="allowBlank:true,maxLength:1000,vtext:'请填入 自动归档 信息，最多输入 1000 字符'" value="${sheetLink.linkIsMysel}"/>
			</td>
		</tr>
 ...
 <%}%>
			...
			<td>
				<textarea class="textarea max" name="linkApprovalOpinion" 
								id="linkApprovalOpinion" alt="allowBlank:true,maxLength:1000,vtext:'请填入 审批意见 信息，最多输入 1000 字符'">${sheetLink.linkApprovalOpinion}</textarea>
 ...
 <%}%>
			...
			<td colspan="3">
				<input type="text"  class="text" name="linkResult" id="linkResult"  alt="allowBlank:true,maxLength:1000,vtext:'请填入 执行结果 信息，最多输入 1000 字符'" value="${sheetLink.linkResult}"/>
			</td>
 		...
 		<tr>
			...
			<td colspan="3">
				<textarea class="textarea max" name="linkRemark" 
								id="linkRemark" alt="allowBlank:true,maxLength:1000,vtext:'请填入 备注 信息，最多输入 1000 字符'">${sheetLink.linkRemark}</textarea>
 				 ...
 				 <% if(taskName.equals("MonitoringDepart")){ %> 
 			   		...
 			   		<% if(operateType.equals("101")){ %>
 			   			<fieldset>
							  ...
							  <div class="x-form-item" >
									...
									<eoms:chooser id="MonitoringDepart0"  type="role" roleId="1003" flowId="100" config="{returnJSON:true,showLeader:true}"  
 			   		...
 			   		<% if(operateType.equals("102")){ %>
 			   			<fieldset>
							  ...
							  <div class="x-form-item" >
									...
									<eoms:chooser id="MonitoringDepart1"  type="role" roleId="1001" flowId="100" config="{returnJSON:true,showLeader:true}"  
									   category="[{id:'dealPerformer',text:'派发',limit:'none',allowBlank:false,vtext:'请选择派发对象'},{id:'copyPerformer',childType:'user,subrole',limit:'none',text:'抄送'}]" 
									  data="${sendUserAndRoles}" />
 			   		...
 			   		<% if(operateType.equals("103")){ %>
 			   			<fieldset>
							  ...
							  <div class="x-form-item" >
							  		<eoms:chooser id="MonitoringDepart3"  type="role" roleId="1003" flowId="100" config="{returnJSON:true,showLeader:true}"  
									   category="[{id:'dealPerformer',text:'派发',limit:'none',allowBlank:false,vtext:'请选择派发对象'},{id:'copyPerformer',childType:'user,subrole',limit:'none',text:'抄送'}]" 
									  data="${sendUserAndRoles}" />			   
							    </div>
  						</fieldset>
 			   		...
 			   		<% if(operateType.equals("104")){ %>
 			   			<fieldset>
							  ...
							  <div class="x-form-item" >
									...
									<eoms:chooser id="TransmissionNet0"  type="role" roleId="1004" flowId="100" config="{returnJSON:true,showLeader:true}"  
									   category="[{id:'dealPerformer',text:'派发',limit:'none',allowBlank:false,vtext:'请选择派发对象'},{id:'copyPerformer',childType:'user,subrole',limit:'none',text:'抄送'}]" 
									  data="${sendUserAndRoles}" />
 			   		...
 			   		<% if(operateType.equals("105")){ %>
 			   			<fieldset>
							  ...
							  <div class="x-form-item" >
									...
									<eoms:chooser id="TransmissionNet1"  type="role" roleId="1002" flowId="100" config="{returnJSON:true,showLeader:true}"  
									   category="[{id:'dealPerformer',text:'派发',limit:'none',allowBlank:false,vtext:'请选择派发对象'},{id:'copyPerformer',childType:'user,subrole',limit:'none',text:'抄送'}]" 
									  data="${sendUserAndRoles}" />
 				...
 				<% } if(taskName.equals("CitieErrata")){ %>
 			   		...
 			   		<% if(operateType.equals("106")){ %>
 			   			<fieldset>
							  ...
							  <div class="x-form-item" >
							  		<eoms:chooser id="CitieErrata0"  type="role" roleId="1002" flowId="100" config="{returnJSON:true,showLeader:true}"  
									   category="[{id:'dealPerformer',text:'派发',limit:'none',allowBlank:false,vtext:'请选择派发对象'},{id:'copyPerformer',childType:'user,subrole',limit:'none',text:'抄送'}]" 
									  data="${sendUserAndRoles}" />			   
							    </div>
  						</fieldset>
