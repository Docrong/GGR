...
<logic:present name="HISTORY" scope="request">  
      ...
      <logic:iterate id="baselink" name="HISTORY" type="com.boco.eoms.sheet.branchindexreduction.model.BranchIndexReductionLink" >     
       <%         
        jNum += 1;       
      ...
      <div class="history-item">&nbsp;   
	      ...
	      <div class="history-item-title">
			 ...
			 <bean:write name="baselink" property="operateTime" formatKey="date.formatDateTimeAll" bundle="sheet" scope="page"/>&nbsp; 
	  	     ...
	  	     <eoms:dict key="dict-sheet-branchindexreduction" dictId="activeTemplateId" itemId="${baselink.activeTemplateId}" beanId="id2descriptionXML" />
	  	     <bean:message bundle="branchindexreduction" key="branchindexreduction.operateType"/>:
	  	     <eoms:dict key="dict-sheet-branchindexreduction" dictId="mainOperateType" itemId="${baselink.operateType}" beanId="id2descriptionXML" />
	 ...
	 <!-- 流程中的历史页面 -->
		  		...
		  		<%if(baselink.getActiveTemplateId()!=null && baselink.getActiveTemplateId().equals("TrialTask")) {%>
		  				...
		  				<%if(baselink.getOperateType() != null && (baselink.getOperateType().intValue() == 101 || baselink.getOperateType().intValue() == 11)){ %>
		 					...
		 					<td class="label">
								<!-- 联系人 -->
								<bean:message bundle="branchindexreduction" key="branchIndexReductionLink.linkMan"/>
							</td>
							<td class="content">
		 					...
		 					<td class="label">
								<!-- 联系人电话 -->
								<bean:message bundle="branchindexreduction" key="branchIndexReductionLink.linkManTelephone"/>
							</td>
							<td class="content">
		 					...
		 					<td class="label">
								<!-- 初审说明 -->
								<bean:message bundle="branchindexreduction" key="branchIndexReductionLink.linkTrialIllustrate"/>
							</td>
...
<script type="text/javascript">
 ...
 function copy(id){
    ...
    Ext.Ajax.request({
		method:"get",
		url: "branchindexreduction.do?method=getJsonLink&id="+id+"&beanName=BranchIndexReduction",
		success: function(x){
