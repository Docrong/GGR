...
<html:form action="saveTawSystemPost" method="post" styleId="tawSystemPostForm">
    ...
    <center>
        ...
        <table border="1" width="95%" cellspacing="1" cellpadding="1"
            ...
            <tr class="tr_show">
                <td width="30%" height="25" class="clsfth"><eoms:label styleClass="desc"
                                                                       key="tawSystemPostForm.postName"/>
                </td>
            ...
            <tr class="tr_show">
                <td width="30%" height="25" class="clsfth"><eoms:label styleClass="desc"
                                                                       key="tawSystemPostForm.parentPostName"/>
                </td>
                <td width="70%" height="25">
            ...
            <tr>
                ...
                <td width="70%" height="25">
                    ...
                    <input type="button" value="<fmt:message key="label.deptTree"/>"
                           onclick="$('checkboxtree').toggle();"/>
                </td>
            </tr>
            <tr>
                <td width="30%" height="25" class="clsfth">
            ...
            <tr class="tr_show">
                <td width="30%" height="25" class="clsfth"><eoms:label styleClass="desc"
                                                                       key="tawSystemPostForm.postRemark"/>
                </td>
                <td width="70%" height="25">
        ...
        <table border="0" width="95%" cellspacing="0">
            <tr>
                <td width="100%" height="32" align="right">
                    ...
                    <input type="button" class="clsbtn2" value="<bean:message key="button.cancel"/>" name="button"
                           onclick="goto();">
                    &nbsp;&nbsp;
                </td>
            </tr>
