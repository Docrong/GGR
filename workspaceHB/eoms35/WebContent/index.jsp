...
function loginIM() {
  ...
  var jid = '<bean:write name='sessionform' property='userid'/>';
  	var URL1 = './jwchat/jwchat.html?server=10.30.227.11&btype=binding&base=/jwchat/JHB/&pass=<bean:write name='sessionform' property='originPassword'/>&jid=<bean:write name='sessionform' property='userid'/>';
	
//	var URL1 = './jwchat/jwchat.html?server=10.30.227.11&btype=binding&base=/JHB/&pass=Boco1234&jid=yinyong&prio=medium';
//	var URL1 = 'http://10.30.227.11:8080/jwchat/jwchat.html?server=10.30.227.11&btype=binding&base=/jwchat/JHB/&pass=<bean:write name='sessionform' property='originPassword'/>&jid=<bean:write name='sessionform' property='userid'/>@10.30.227.11/jwchat';
 // jwchats[jid]= window.open('http://10.30.227.11:8080/jwchat/jwchat.html?server=10.30.227.11&btype=binding&base=/jwchat/JHB/&pass=<bean:write name='sessionform' property='originPassword'/>&jid=<bean:write name='sessionform' property='userid'/>@10.30.227.11/jwchat','<bean:write name='sessionform' property='username'/>','width=180,height=390,resizable=yes');
...
<a style="text-decoration: none;" href="#" onclick="javascript:loginIM();"><img width="18" height="18" alt="登录运维通" src="${app}/images/spark.png">登录运维通</a> |   
