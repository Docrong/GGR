...
<%@ page
        import="com.boco.eoms.workplan.util.TawwpUtil,com.boco.eoms.commons.system.session.form.TawSystemSessionForm" %>
    ...
    <table class="formTable" width="600">
        ...
        <tr>
            <td colspan="6">
                ...
                <select id="sysselect" style="display:none" size=1 name="systype" class="select"
                        onChange="changelocation(document.form1.systype.options[document.form1.systype.selectedIndex].value)">
                ...
                <input type="text" name="netnamelist" size="30" readonly="true" value="" class="text" id="netnameselect"
                       style="display:none">
                ...
                <input type="button" value="<bean:message key="querymonthplan.title.formSelectNet"/>" name="B1"
                       class="button" Onclick="javascript:onNet();" id="netbuttonselect" style="display:none">
                ...
                <select name="monthflag" class="select">
                    ...
                    <%
                        for (int i = 1; i <= 12; i++) {
                            ...
                            if (month.equals(i + "")) {
                    %>
                    <option value="<%=_mm%>" selected><%=_mm%>
                    </option>
                    <%} else {%>
                    <option value=" <%=_mm%>"><%=_mm%>
                    </option>
                    <%
                            }
                        }
