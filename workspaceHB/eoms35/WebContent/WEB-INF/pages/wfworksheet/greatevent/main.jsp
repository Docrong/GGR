...
<html:form action="/greatevent.do?method=newPerformAdd" styleId="theform">
    ...
    <logic:notPresent name="templateManage">
        ...
        <html:submit styleClass="btn" property="method.saveDraft" onclick="javascript:changeType2()"
        ...
        <html:button styleClass="btn" property="method.save" styleId="method.save"
                     onclick="window.open('./greatevent.do?method=getTemplatesByUserId',null,'left=300,top=150,height=400,width=500,scrollbars=yes')">
