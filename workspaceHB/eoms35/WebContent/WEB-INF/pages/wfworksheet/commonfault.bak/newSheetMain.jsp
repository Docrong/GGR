		...
		<c:if test="${status!=1}">
		   <tr>
			...
			<tr style="display:none">
			  ...
			  <td colspan="3">
			  	<c:choose> 
				  	...
				  	<eoms:comboBox name="${sheetPageName}mainSendMode" id="${sheetPageName}mainSendMode" initDicId="1010305" defaultValue="101030502"/>
					</c:when>
					<c:otherwise>
			...
			<tr>
			  ...
			  <td>
			  	<input type="text" class="text" name="${sheetPageName}mainEquipmentType" id="${sheetPageName}mainEquipmentType" value="${sheetMain.mainEquipmentType}" alt="allowBlank:false"/>
			  </td>
