...
<c:if test="${findForward != null && findForward == 'list'}">
	<jsp:include page="/WEB-INF/pages/wfworksheet/techniquesupporthb/listsendUndoJS.jsp"/>
</c:if>
<%} %>
...
<bean:define id="url" value="techniquesupporthb.do"/>
	<display:table name="taskList" cellspacing="0" cellpadding="0"
		...
		export="true" requestURI="techniquesupporthb.do"
		sort="list" size="total" partialList="true"
		decorator="com.boco.eoms.sheet.techniquesupporthb.webapp.action.ProcessListCommonDisplaytagDecoratorHelper">
		...
		<display:column  sortable="true" headerClass="sortable" title="工单类型" sortName="main.mainSheetType"> 
			 <eoms:id2nameDB id="${taskList.mainSheetType}" beanId="ItawSystemDictTypeDao"/></td>
		</display:column>
		<display:column  sortable="true" headerClass="sortable" title="子专业" sortName="main.mainProfessional"> 
			 <eoms:id2nameDB id="${taskList.mainProfessional}" beanId="ItawSystemDictTypeDao"/></td>
		</display:column>
