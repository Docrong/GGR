...
<table width="100%" class="formTable" align="center">
    ...
    <tr>
        ...
        <td>
            ...
            <input type="checkbox" id="checkBeginNumberPartOne" name="checkBeginNumberPartOne"
                   onClick="javascript:clickCheckBox(1);"/>
        </td>
        <td>
            <input type="text" id="beginNumberPartTow" name="beginNumberPartTow" size="4" title="号码第二部分" MaxLength="4"/>
            <input type="checkbox" id="checkBeginNumberPartTow" name="checkBeginNumberPartTow"
                   onClick="javascript:clickCheckBox(2);"/>
        </td>
        <td>
            <input type="text" id="beginNumberPartThree" name="beginNumberPartThree" size="4" title="号码第三部分"
                   MaxLength="4"/>
            <input type="checkbox" id="checkBeginNumberPartThree" name="checkBeginNumberPartThree"
                   onClick="javascript:clickCheckBox(3);"/>
        </td>
    </tr>
    <tr>
        <td noWrap width="80" class="label">
        ...
        <td>
            ...
            <input type="checkbox" id="checkEndNumberPartOne" name="checkEndNumberPartOne"
                   onClick="javascript:clickCheckBox(4);"/>
        </td>
        <td>
            <input type="text" id="endNumberPartTow" name="endNumberPartTow" size="4" title="号码第二部分" MaxLength="4"/>
            <input type="checkbox" id="checkEndNumberPartTow" name="checkEndNumberPartTow"
                   onClick="javascript:clickCheckBox(5);"/>
        </td>
        <td>
            <input type="text" id="endNumberPartThree" name="endNumberPartThree" size="4" title="号码第三部分" MaxLength="4"/>
            <input type="checkbox" id="checkEndNumberPartThree" name="checkEndNumberPartThree"
                   onClick="javascript:clickCheckBox(6);"/>
        </td>
    </tr>
    <tr>
        <td class="label">
