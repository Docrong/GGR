...
insert into taw_system_application(app_name,notes,domain_type) values('新业务设计流�?','新业务设计流�?',1);
insert into taw_system_workflow(name,flowid,sheetid,remark,mainservicebeanid) values('BusinessPlanProcess','021','021','新业务设计流�?','iBusinessPlanMainManager');
