...
<html>
    <head>
        ...
        <script>
            ...
            var row = modifylistF.document.createElement("TR");
            var header = new Array("Apodo","JID","Razón");
            var cell;
            ...
            if (!iq || iq.getType() == 'error') {
            document.getElementById('hint').innerHTML = "Ha ocurrido un error";
            if (iq)
            srcW.Debug.log(iq.getDoc().xml,1);
            return;
        }
            ...
            document.getElementById('hint').innerHTML = "No se encuentran objetos";
        }
            ...
            document.getElementById('title').innerHTML = "Modificar "+args[2];
        ...
        <table width="100%" height="100%">
            ...
            <tr>
                <td width="100%" height="100%">
                    <iframe src="groupchat_modifylist_iframe.html" id="modifylistF" name="modifylistF" scrolling="auto"
                    ...
                    <form name="add_item">
                        <table>
                            <tr>
                                <th>Nick</th>
                                <td>
                                    <input type="text" name="nick" onkeydown="activateAddButton();">
                                </td>
                            </tr>
                            <tr>
                                <th>JID</th>
                                <td>
                                    <input type="text" name="jid" style="width: 100%;" onkeydown="activateAddButton();">
                                </td>
                            </tr>
                            <tr>
                                <th>Reason</th>
            ...
            <tr>
                <td align="right">
                    <button id="add_button" onClick="return addItem();">Añadir</button>
                    &nbsp;
                    <button id="delete_button" onClick="return deleteItem();">Borrar</button>
                    &nbsp;
                    <button type="submit" id="save_button" onClick="return doSub();">Guardar</button>
                </td>
            </tr>
        </table>
    </body>
