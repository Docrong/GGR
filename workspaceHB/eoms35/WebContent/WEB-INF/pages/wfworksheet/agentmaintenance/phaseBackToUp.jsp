...
String sheetKey = (String) request.getParameter("sheetKey");
 ...
 %>
     ...
     <input type="hidden" name="${sheetPageName}mainClassName" value="com.boco.eoms.sheet.agentmaintenance.model.AgentMaintenanceMain"/>	<!--main\u8868Model\u5bf9\u8c61\u7c7b\u540d-->	
     <input type="hidden" name="${sheetPageName}linkClassName" value="com.boco.eoms.sheet.agentmaintenance.model.AgentMaintenanceLink"/> <!--link\u8868Model\u5bf9\u8c61\u7c7b\u540d--> 
     <input type="hidden" name="${sheetPageName}processTemplateName" id="${sheetPageName}processTemplateName" value="AgentMaintenanceMainFlowProcess" />
...
<%@ include file="/WEB-INF/pages/wfworksheet/agentmaintenance/baseinputlinkhtmlnew.jsp"%>
     ...
     <tr>
      ...
      <logic:iterate id="toTask" name="toOperaterList" type="com.boco.eoms.sheet.agentmaintenance.model.AgentMaintenanceTask">  
        <tr>
          <td>
