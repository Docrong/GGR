...
<div id="sheetform">
    <html:form action="/businessimplementsms.do?method=performTransferWorkItem" styleId="theform">
        ...
        <input type="hidden" name="${sheetPageName}beanId" id="${sheetPageName}beanId"
               value="iBusinessImplementSmsMainManager"/>
        ...
        <div class="form-btns">
            ...
            <input type="submit" class="submit"
                   onclick="v.passing=true;this.form.action='${app}/sheet/businessimplementsms/businessimplementsms.do?method=performSaveInfo'"
