...
<html:form action="/thread.do" method="post" styleId="threadForm">
    ...
    <display:table name="threadList" cellspacing="0" cellpadding="0"
                   ...
                   export="true"
                   requestURI="${app}/workbench/infopub/thread.do?method=list4forumId&forumsId=${forumsId }" sort="list"
        ...
        <display:column property="title" sortable="true" headerClass="sortable"
                        titleKey="infopub.threadForm.title" paramId="id" paramProperty="id"
                        href="${app}/workbench/infopub/thread.do?method=detail"/>

        <display:column property="status" sortable="true" headerClass="sortable"
                        titleKey="infopub.threadForm.status"
                        href="${app}/workbench/infopub/threadAuditHistory.do?method=edit" paramId="threadId"
                        paramProperty="id"/>

        <display:column property="threadCount" sortable="true" headerClass="sortable"
                        titleKey="infopub.threadForm.num" href="${app}/workbench/infopub/threadHistory.do?method=search"
