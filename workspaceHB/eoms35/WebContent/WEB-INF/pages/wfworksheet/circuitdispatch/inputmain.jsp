    ...
    <c:if test="${status!=1}">
        ...
        <tr>
            ...
            <td colspan="3">
                ...
                <textarea class="textarea max" readonly="true" name="mainAssortSpeciality2" style="height:50px"
                          id="mainAssortSpeciality2" alt="allowBlank:true"><eoms:invert appCode="circuitdispatch"
        ...
        <tr>
            ...
            <td class="label"><bean:message bundle="circuitdispatch"
                                            key="circuitdispatch.mainIfMutualCommunication"/>*
            </td>
            <td>
        ...
        <tr>
            ...
            <td>
                <eoms:comboBox name="${sheetPageName}mainIfChangeProject" id="${sheetPageName}mainIfChangeProject"
                               initDicId="10301" defaultValue="${sheetMain.mainIfChangeProject}"
        ...
        <tr>
            ...
            <td>
                ...
                <input type="text" class="text" name="${sheetPageName}mainTakeBusiness"
                       id="${sheetPageName}mainTakeBusiness" value="${sheetMain.mainTakeBusiness}"
                       alt="allowBlank:false,maxLength:255,vtext:'请填入承载业务，最多输入255个字符'"/>
        ...
        <tr>
            ...
            <td colspan="3">
                <textarea name="${sheetPageName}mainApplyGist" id="${sheetPageName}mainApplyGist" class="textarea max"
                          alt="allowBlank:false,maxLength:2000,vtext:'请填入申请依据，最多输入2000个字符'">${sheetMain.mainApplyGist}</textarea>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td colspan="3">
                <textarea name="${sheetPageName}mainDescription" id="${sheetPageName}mainDescription"
                          class="textarea max"
                          alt="allowBlank:false,maxLength:2000,vtext:'请填入详细描述，最多输入2000个字符'">${sheetMain.mainDescription}</textarea>
            </td>
        </tr>
    </c:if>
