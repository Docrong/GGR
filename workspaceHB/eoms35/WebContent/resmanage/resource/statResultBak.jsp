...
if(flag == 0)
{
	...
	<tr><td align=center><font size=2><B>Í³¼ÆÁÐ±í</B></font></td>
	</table>
<%
}
if(flag == 1)
...
if(Integer.parseInt(tab) == 1)
{
	...
	for(int i = 0; i < tnn.size(); i ++)
	{
		...
		out.println("<td align=center class=td><font size=2>"+pc.getName()+"</font></td>");
		resStr.setId(0);
	...
	out.println("<tr bgcolor=#eeeeee><td align=center class=td><font size=2><B>×Ü¼Æ</B></font></td>");
...
dataString = sr.getAppletString(strV,tmpa.size(),colSize);
%>
</table>
<br>
<%
...
<p align=center>ËµÃ÷£º²é¿´±ý×´Í¼ÇëÔÚÖù×´Í¼ÉÏµ¥»÷Êó±êÓÒ¼ü(Êó±ê±ØÐëµãÔÚÊý¾ÝÖùÉÏ)</p>
</div>
<table>
<tr><td align=center><a href="javascript:exportToFile()">µ¼³öExcel</a></td></tr>
</table>
