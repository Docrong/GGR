    ...
    <tr>
        ...
        <td class="content">
            <eoms:comboBox name="${sheetPageName}mainTargetLevel" id="${sheetPageName}mainTargetLevel"
                           initDicId="1017002" defaultValue="${sheetMain.mainTargetLevel}" styleClass="select-class"
                           alt="allowBlank:false"/>
        </td>
        <td class="label">指标分类*</td>
        <td class="content">
            <eoms:comboBox name="${sheetPageName}mainTargetType" id="${sheetPageName}mainTargetType"
                           initDicId="1017003" defaultValue="${sheetMain.mainTargetType}" styleClass="select-class"
                           alt="allowBlank:false" onchange="getType(this.value);"/>
        </td>
    </tr>
    <tr>
