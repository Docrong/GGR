...
function sent_room_user()
{
    ...
    if(<%=request.getAttribute("UserNum") != null ? "true"
					: "false"%> && (sel_sprlen+1)%<%=request.getAttribute("UserNum")%>!=0)
   {
            ...
            <table border="0" width="100%" cellspacing="1" cellpadding="1" class="listTable" align=center>
              <tr class="tr_show">
                ...
                <td width="50%" align="center" >
                 ...
                 <input type="button" id="specialtyTreeBtn" class="btn" value="专家列表"  /><p>
                   专家专业<input type="text" id ="specialtyName" name="specialtyName" size="20" value="" class="text" readonly="readonly"><p>
                ...
                <td width="20%" align="center" valign = "center">
                  <input type=button class="button" name=btnAddItem value=<bean:message key="TawUserRoom.btn_add"/>     onclick="javascript:add_RoomTrue();")><p>
                  <input type=button class="button" name=btnDelItem value=<bean:message key="TawUserRoom.btn_del"/>     onclick="javascript:del_RoomTrue();"><p>
                  <input type=button class="button" name=btnAddAll  value=<bean:message key="TawUserRoom.btn_add_all"/> onclick="javascript:add_all_RoomTrue();"><p>
                    ...
                    <tr>
                      ...
                      <td>
                        <table>
                          <tr>
                            <td>
                              <img src="<%=request.getContextPath()%>/duty/images/bottom/up.gif" onclick="fnSwap(0);">
                            </td>
                          </tr>
                          <tr>
                            <td>
                              <img src="<%=request.getContextPath()%>/duty/images/bottom/down.gif" onclick="fnSwap(1);">
                            </td>
                          </tr>
                        </table>
                      </td>
      ...
      <table height="30" cellpadding="0" cellspacing="0" border="0" width="100%" >
        <tr>
          <td align="right">
            ...
            <input type=button class="button" name=save value=<bean:message key="entry.TawRmSysteminfo.btn_new"/> Onclick="window.location.href ='../Kmsysteminfo/add.do?roomId=<%=request.getParameter("roomId")%>'">&nbsp;&nbsp;
