...
<table class="list_table">
    ...
    <tr>
        <th class="<%=thClass%>">
            <%=wapNodeVO.getName() %></td>
        <td class="<%=tdClass%>"><%=wapNodeVO.getDescription() %>
        </td>
        <td class="<%=tdClass%>"><a
                href="<%=app %>/webtool/wapnode?act=view&flag=modify&wapNodeId=<%=wapNodeVO.getNodeId()%>">修改</a></td>
        <td class="<%=tdClass%>"><a
                href="<%=app %>/webtool/wapnode?act=view&flag=view&wapNodeId=<%=wapNodeVO.getNodeId()%>">查看</a></td>
        <td class="<%=tdClass%>"><a
                href="<%=app %>/webtool/wapnode?act=remove&wapNodeId=<%=wapNodeVO.getNodeId()%>">删除</a></td>
    </tr>
    <%
            rowCount = !rowCount;
        } %>
