...
<table id="sheet" class="formTable" >
		...
		<tr><td class="label">
			...
			<td>
				<input type="text"  class="text" name="mainType" id="mainType"  alt="allowBlank:false,maxLength:2000,vtext:'请填入 种类 信息，最多输入 2000 字符'" value="${sheetMain.mainType}"/>
			</td>
 <td class="label">
				<!-- 序号 -->
			...
			<td>
				<input type="text"  class="text" name="mainSerialNumber" id="mainSerialNumber"  alt="allowBlank:false,maxLength:2000,vtext:'请填入 序号 信息，最多输入 2000 字符'" value="${sheetMain.mainSerialNumber}"/>
			</td>
		</tr>
		...
		<tr><td class="label">
			...
			<td>
				<input type="text"  class="text" name="mainDeviceName" id="mainDeviceName"  alt="allowBlank:false,maxLength:2000,vtext:'请填入 设备名称 信息，最多输入 2000 字符'" value="${sheetMain.mainDeviceName}"/>
			</td>
 <td class="label">
				<!-- 设备厂家 -->
			...
			<td>
				<input type="text"  class="text" name="mainManufacturers" id="mainManufacturers"  alt="allowBlank:false,maxLength:2000,vtext:'请填入 设备厂家 信息，最多输入 2000 字符'" value="${sheetMain.mainManufacturers}"/>
			</td>
		</tr>
		...
		<tr><td class="label">
			...
			<td>
				<input type="text"  class="text" name="mainSystemName" id="mainSystemName"  alt="allowBlank:false,maxLength:2000,vtext:'请填入 系统名称 信息，最多输入 2000 字符'" value="${sheetMain.mainSystemName}"/>
			</td>
 <td class="label">
				<!-- 设备型号 -->
			...
			<td>
				<input type="text"  class="text" name="mainEquipmentType" id="mainEquipmentType"  alt="allowBlank:false,maxLength:2000,vtext:'请填入 设备型号 信息，最多输入 2000 字符'" value="${sheetMain.mainEquipmentType}"/>
			</td>
		</tr>
		...
		<tr><td class="label">
			...
			<td>
				<input type="text"  class="text" name="mainDeviceNumber" id="mainDeviceNumber"  alt="allowBlank:false,maxLength:2000,vtext:'请填入 设备序列号 信息，最多输入 2000 字符'" value="${sheetMain.mainDeviceNumber}"/>
			</td>
 <td class="label">
				<!-- 入网时间 -->
			...
			<td>
				<input type="text"  class="text" name="mainAccessTime" id="mainAccessTime"  alt="allowBlank:false,maxLength:2000,vtext:'请填入 入网时间 信息，最多输入 2000 字符'" value="${sheetMain.mainAccessTime}"/>
			</td>
		</tr>
		...
		<tr><td class="label">
			...
			<td>
				<input type="text"  class="text" name="mainOutDate" id="mainOutDate"  alt="allowBlank:false,maxLength:2000,vtext:'请填入 出保日期 信息，最多输入 2000 字符'" value="${sheetMain.mainOutDate}"/>
			</td>
 <td class="label">
				<!-- 接口类型及数量 -->
			...
			<td>
				<input type="text"  class="text" name="mainInterfaceType" id="mainInterfaceType"  alt="allowBlank:false,maxLength:2000,vtext:'请填入 接口类型及数量 信息，最多输入 2000 字符'" value="${sheetMain.mainInterfaceType}"/>
			</td>
		</tr>
		...
		<tr><td class="label">
			...
			<td>
				<input type="text"  class="text" name="mainSoftware" id="mainSoftware"  alt="allowBlank:false,maxLength:2000,vtext:'请填入 是否配置双机热备软件和其它随机软件 信息，最多输入 2000 字符'" value="${sheetMain.mainSoftware}"/>
			</td>
 <td class="label">
				<!-- 操作系统名称及版本 -->
				<bean:message bundle="maintenanceservice" key="maintenanceServiceMain.mainSystemName"/>*
			...
			<td>
				<input type="text"  class="text" name="mainSystemName" id="mainSystemName"  alt="allowBlank:false,maxLength:2000,vtext:'请填入 操作系统名称及版本 信息，最多输入 2000 字符'" value="${sheetMain.mainSystemName}"/>
			</td>
		</tr>
		...
		<tr><td class="label">
			...
			<td>
				<input type="text"  class="text" name="mainIntegratorName" id="mainIntegratorName"  alt="allowBlank:false,maxLength:2000,vtext:'请填入 系统集成商名称 信息，最多输入 2000 字符'" value="${sheetMain.mainIntegratorName}"/>
			</td>
 <td class="label">
				<!-- 拟购买的服务级别 -->
			...
			<td>
				<input type="text"  class="text" name="mainLevelService" id="mainLevelService"  alt="allowBlank:false,maxLength:2000,vtext:'请填入 拟购买的服务级别 信息，最多输入 2000 字符'" value="${sheetMain.mainLevelService}"/>
			</td>
		</tr>
		...
		<tr><td class="label">
			...
			<td>
				<input type="text"  class="text" name="mainPhysicalLocation" id="mainPhysicalLocation"  alt="allowBlank:false,maxLength:2000,vtext:'请填入 设备物理位置 信息，最多输入 2000 字符'" value="${sheetMain.mainPhysicalLocation}"/>
			</td>
 <td class="label">
				<!-- 备注 -->
			...
			<td>
				<input type="text"  class="text" name="mainRemarks" id="mainRemarks"  alt="allowBlank:false,maxLength:2000,vtext:'请填入 备注 信息，最多输入 2000 字符'" value="${sheetMain.mainRemarks}"/>
			</td>
		</tr>
		...
		<tr><td class="label">
			...
			<td>
				<input type="text"  class="text" name="mainContacts" id="mainContacts"  alt="allowBlank:false,maxLength:2000,vtext:'请填入 联系人 信息，最多输入 2000 字符'" value="${sheetMain.mainContacts}"/>
			</td>
 <td class="label">
				<!-- 联系方式 -->
			...
			<td>
				<input type="text"  class="text" name="mainContactInformation" id="mainContactInformation"  alt="allowBlank:false,maxLength:2000,vtext:'请填入 联系方式 信息，最多输入 2000 字符'" value="${sheetMain.mainContactInformation}"/>
			</td>
		</tr>
		...
		<tr><td class="label">
			...
			<td>
				<input type="text"  class="text" name="mainCompany" id="mainCompany"  alt="allowBlank:false,maxLength:2000,vtext:'请填入 单位 信息，最多输入 2000 字符'" value="${sheetMain.mainCompany}"/>
			</td>
		</tr>
...
<table id="sheet" class="formTable">
	    ...
	    <tr>
		    ...
		    <eoms:attachment name="sheetMain" property="sheetAccessories" 
		            scope="request" idField="sheetAccessories" appCode="maintenanceservice" alt="allowBlank:true"/> 				
		    </td>
	   </tr>			  
</table>
	 ...
	 <c:choose>
		 <c:when test="${auto=='true'}">
		    ...
		    <div class="x-form-item" >
					<eoms:chooser id="Fill0"  type="role" roleId="1761" flowId="60" config="{returnJSON:true,showLeader:true}"  
