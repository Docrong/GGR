...
<div id="sheetform">
<html:form action="/securityevaluate.do?method=performTransferWorkItem" styleId="theform">
           ...
           <td class="label">
             ...
             <td colspan="3">
		           <textarea name="${sheetPageName}transferReason" class="textarea max" id="${sheetPageName}transferReason" 
		            alt="allowBlank:false,maxLength:255,width:500,vtext:'请填入信息，最多输入125字'" ></textarea>	
			</td>	
	   </tr>
