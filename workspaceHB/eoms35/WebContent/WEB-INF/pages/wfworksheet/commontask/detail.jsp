...
<input id="addMainWorkFlow" type="button" value="<bean:message bundle="sheet" key="button.creatnew"/>"
       onclick="addMainWorkflow();">
            ...
            <tr>
                <td width="50%">
                    ...
                    <select id="dealSelector">
                        ...
                        <option value="${urlShowTransmitDealPage}"><bean:message bundle="commontask"
                                                                                 key="commontask.taskpass"/></option>
                        <option value="${urlShowTransmit2DealPage}"><bean:message bundle="commontask"
                                                                                  key="commontask.tasknopass"/></option>
                    ...
                    <select id="dealSelector">
                        ...
                        <%} else if (taskStatus.equals(Constants.TASK_STATUS_CLAIMED)) { %>
                        <option value="${urlShowCompleteDealPage}"><bean:message bundle="commontask"
                                                                                 key="commontask.dealwcnosp"/></option>
                        <option value="${urlShowPassDealPage}"><bean:message bundle="commontask"
                                                                             key="commontask.totaskcompsq"/></option>
                        <!-- <option value="${urlShowTransferPage}"><bean:message bundle="commontask" key="commontask.yijiao"/></option> -->
                        <option value="${urlShowSplitDealPage}"><bean:message bundle="commontask"
                                                                              key="commontask.fenpai"/></option>
                        <!-- <option value="${urlShowPhaseReplyPage}"><bean:message bundle="sheet" key="event.reply"/></option>-->
                        <%} %>
                    </select>
                    ...
                    <select id="dealSelector">
                        ...
                        <!--<option value="${urlShowRejectBackPage}"><bean:message bundle="sheet" key="common.rejectBack"/></option>-->
                        <%} else if (taskStatus.equals(Constants.TASK_STATUS_CLAIMED)) { %>
                        <option value="${urlShowTaskCompleteAuditYes}"><bean:message bundle="commontask"
                                                                                     key="commontask.TaskCompleteAuditYes"/></option>
                        <option value="${urlShowTaskCompleteAuditNo}"><bean:message bundle="commontask"
                                                                                    key="commontask.TaskCompleteAuditNo"/></option>
                        <!--<option value="${urlShowPhaseReplyPage}"><bean:message bundle="sheet" key="event.reply"/></option>-->
                        <%} %>
                    </select>
                    <%} else if (taskName.equals("AffirmHumTask")) {%>
                    <select id="dealSelector">
                        <option value="${urlShowDealReplyPassPage}"><bean:message bundle="commontask"
                                                                                  key="commontask.dealrejectpass"/></option>
                        <option value="${urlShowDealReplyNoPassPage}"><bean:message bundle="commontask"
                                                                                    key="commontask.nopassback"/></option>
                        <!--<option value="${urlShowPhaseReplyPage}"><bean:message bundle="sheet" key="event.reply"/></option>-->
                    </select>
                    <%} else if (taskName.equals("DraftHumTask")) {%>
                    <select id="dealSelector">
                        <option value="${urlShowCompleteDraftPage}"><bean:message bundle="commontask"
                    ...
                    <select id="dealSelector">
                        <option value="${urlShowHoldDealPage}"><bean:message bundle="commontask"
