	...
	<table class="formTable">
		...
		<%} %>      
			...
			<input type="hidden" name="phaseId" id="phaseId" value="CheckingHumTask" />	 
			 ...
			 <tr> 
	  				...
	  				<td>
	  					...
	  					<input type="text" class="text" name="linkFirstContactUesrTime" readonly="readonly" id="linkFirstContactUesrTime" value="${eoms:date2String(sheetLink.linkFirstContactUesrTime)}" onclick="popUpCalendar(this, this,null,null,null,true,-1)" 
	  				...
	  				<td>
	  					...
	  					<input type="text" class="text" name="linkReservationTime" readonly="readonly" id="linkReservationTime" value="${eoms:date2String(sheetLink.linkReservationTime)}" onclick="popUpCalendar(this, this,null,null,null,true,-1)" 
			...
			<tr>
				...
				<td class="content" colspan="3">
				  <eoms:comboBox name="issueReasonTypeOne" id="issueReasonTypeOne" sub="issueReasonTypeTwo" initDicId="1010626" onchange="selectTypeOne();" alt="allowBlank:false" />
					<eoms:comboBox name="issueReasonTypeTwo" id="issueReasonTypeTwo" sub="issueReasonTypeThree" styleClass="border" onchange="selectTypeTwo();" alt="allowBlank:false" />					
					<eoms:comboBox name="issueReasonTypeThree" id="issueReasonTypeThree" sub="issueReasonTypeFour" styleClass="border" onchange="selectTypeThree();" alt="allowBlank:false" />	
					<eoms:comboBox name="issueReasonTypeFour" id="issueReasonTypeFour" onchange="selectTypeFour();" alt="allowBlank:false" />
 			   		...
 			   		<% if(operateType.equals("102")){ %>
 			   			<fieldset>
							  ...
							  <div class="x-form-item" >
								...
								<eoms:chooser id="ExcuteHumTask0"  type="role" roleId="1743" flowId="58" config="{returnJSON:true,showLeader:true}"  
