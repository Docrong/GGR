...
<html:form method="post" action="/TawTestcardManager/usesave" onsubmit="return check(this);">
    ...
    <table cellSpacing="0" borderColorDark="#808080" cellPadding="2" width="70%" class="formTable" border="1"
           align="center">
        <tr>
            <td colspan="4" height="25" valign="middle" bgcolor="#e9e9e9" align="center"><font size="-1"><b>
        ...
        <tr>
            ...
            <td width="380">
                <input type="text" name="testtime" size="30" onclick="popUpCalendar(this, this,null,null,null,true,-1);"
                       readonly="true"
                       class="text">
            </td>
        </tr>
        ...
        <tr>
            ...
            --%>
                <eoms:attachment idList="" idField="accessories" appCode="testcard" scope="request"
