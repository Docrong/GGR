...
<fmt:bundle basename="config.ApplicationResources-workbench-netdisk">
    <display:table name="netDiskFiles" cellspacing="0" cellpadding="0"
        ...
        <display:column property="fileName" sortable="true" headerClass="sortable"
                        titleKey="tawWorkbenchNetDisk.fileName"/>
        <display:column property="uploadUserName" sortable="true" headerClass="sortable"
                        titleKey="tawWorkbenchNetDisk.uploadUserName"/>
        <display:column property="uploadTime" sortable="true" headerClass="sortable"
                        titleKey="tawWorkbenchNetDisk.uploadTime"/>
        <display:column property="fileSize" sortable="true" headerClass="sortable"
                        titleKey="tawWorkbenchNetDisk.fileSize"/>
        <display:column property="scanTimes" sortable="true" headerClass="sortable"
                        titleKey="tawWorkbenchNetDisk.scanTimes"/>
        <display:column property="fileOperation" sortable="false" headerClass="sortable"
                        titleKey="tawWorkbenchNetDisk.fileOperation"/>
