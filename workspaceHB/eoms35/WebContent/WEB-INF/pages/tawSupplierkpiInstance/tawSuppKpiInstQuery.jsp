            ...
            <tr height="50">
                ...
                <td>
                    <supplierkpi:comboBox name="serviceType" id="serviceType"
                                          ...
                                          sub="specialType"
                                          ds="/supplierkpi/tawSupplierkpiDicts.do?method=xsearch&dictId="
            ...
            <tr height="50">
                ...
                <td>
                    <select name="manufacturerName">
                        ...
                        %>
                        <option value="<%=tawSupplierkpiInfo.getSupplierName() %>"><%=tawSupplierkpiInfo.getSupplierName() %>
                        </option>
                        <%
                            }
                        %>
                ...
                <td>
                    <input type="radio" name="fillFlag" value="1"/>&nbsp;&nbsp;&nbsp;&nbsp;<bean:message
                        key="tawSupplierkpiInstanceList.filled"/>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="radio" name="fillFlag" value="0"/>&nbsp;&nbsp;&nbsp;&nbsp;<bean:message
                        key="tawSupplierkpiInstanceList.nofill"/>
                </td>
                ...
                <td colspan="3">
                    ...
                    <select name="month" id="slt2" onchange="optionDisabled(this);">
                        <option value="-1">====<bean:message
                                key="tawSupplierkpiInstanceList.dark"/>====
                        </option>
