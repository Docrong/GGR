...
<body>
<html:form method="post" action="/TawRmGuestform/dodelete" >
<html:hidden property="id" />
<br>
<center>
<TABLE cellSpacing="0" cellPadding="0" width="95%" align="center" border="0">
<tr>
<td width="100%" align="center" valign="middle" class="clsscd" colspan="4">
...
<tr>
 <TD align="right" height="32">
        ...
        <input type = "submit" name = <bean:message key="label.remove"/> class="clsbtn2" value = <bean:message key="label.remove"/> >
        <input type = "button" name = <bean:message key="label.back"/> class="clsbtn2" value = <bean:message key="label.back"/> onclick = "javascript:history.back();">
</td>
</tr>
</table>
</html:form>
