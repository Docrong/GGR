<table class="formTable">
       ...
       <tr>
		...
		<tr>
			...
			<td>
			<c:forTokens items="${sheetMain.toDeptId}" delims="," var="toDeptId" varStatus="status">
               <eoms:id2nameDB id="${toDeptId}" beanId="tawSystemAreaDao"/><c:choose><c:when test="${status.last}"></c:when><c:otherwise>,</c:otherwise></c:choose> 	                  
             </c:forTokens>
			</td>
	   </tr>
     ...
     <tr>		
        <td class="label">
          <bean:message bundle="netdata" key="netdata.mainIfDemonstrateCase"/>
        </td>
		<td colspan='3'>
     ...
     <tr>		
        <td class="label">
          <bean:message bundle="netdata" key="netdata.mainCaseKeywords"/>
        </td>
		<td colspan='3'>
