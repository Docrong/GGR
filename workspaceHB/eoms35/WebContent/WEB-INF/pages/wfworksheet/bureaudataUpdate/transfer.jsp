...
<div id="sheetform">
<html:form action="/bureaudataUpdate.do?method=performTransferWorkItem" styleId="theform">
       <%@ include file="/WEB-INF/pages/wfworksheet/bureaudataUpdate/baseinputlinkhtmlnew.jsp"%>
    <br/>
           <input type="hidden" name="${sheetPageName}beanId"   id="${sheetPageName}beanId"  value="iBureaudataUpdateMainManager"/>
           <input type="hidden" name="${sheetPageName}mainClassName" id="${sheetPageName}mainClassName"  value="com.boco.eoms.sheet.bureaudataUpdate.model.BureaudataUpdateMain"/>		
           <input type="hidden" name="${sheetPageName}linkClassName" id="${sheetPageName}linkClassName" value="com.boco.eoms.sheet.bureaudataUpdate.model.BureaudataUpdateLink"/> 
   ...
   <div class="form-btns">
        ...
        <input type="submit" class="submit" onclick="v.passing=true;this.form.action='${app}/sheet/bureaudataUpdate/bureaudataUpdate.do?method=performSaveInfo'" value="<bean:message bundle='sheet' key='button.save'/>" />
