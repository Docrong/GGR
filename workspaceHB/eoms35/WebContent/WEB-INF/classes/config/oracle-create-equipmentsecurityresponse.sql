...
alter table EQUIPMENTSECURITYRESPONSE_MAIN
    add constraint EQUIPMENTSECURITYRESPONSE_MAIN_PK primary key (id) using index;
...
alter table EQUIPMENTSECURITYRESPONSE_TASK
    add constraint EQUIPMENTSECURITYRESPONSE_TASK_PK primary key (id) using index;
...
values ('xls,txt,doc,jpg,gif', 'equipmentsecurityresponse', '设备互联核查安全告警响应工单流程', 1024,
        '/sheet/equipmentsecurityresponse', 32, '40287d8c5ba336af015ba336af820000');
...
values ('40287d8c5ba336af015ba336af820001', '4601', '1', '新增工单', '46', null,
...
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d8c5ba336af015ba336af82000b', '460402', '1', '建立工单', '4604', null,
        '/sheet/equipmentsecurityresponse/equipmentsecurityresponse.do?method=showOwnStarterList', '0', '0', 2);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d8c5ba336af015ba336af82000c', '460401', '1', '处理工单', '4604', null,
        '/sheet/equipmentsecurityresponse/equipmentsecurityresponse.do?method=showListsenddone', '0', '0', 1);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d8c5ba336af015ba336af82000d', '4605', '1', '已归档工单', '46', null,
        '/sheet/equipmentsecurityresponse/equipmentsecurityresponse.do?method=showHoldedList', '0', '0', 5);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d8c5ba336af015ba336af82000e', '4606', '1', '已作废工单', '46', null,
        '/sheet/equipmentsecurityresponse/equipmentsecurityresponse.do?method=showCancelList', '0', '0', 6);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d8c5ba336af015ba336af82000f', '4611', '1', '超时时间设置', '46', null,
        '/sheet/overtimetip/overtimetip.do?flowName=EquipmentSecurityResponse', '0', '0', 11);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d8c5ba336af015ba336af830010', '4612', '1', '工单处理时限配置', '46', null,
        '/sheet/newSheetLimit/sheetLimit.do?method=getLevelLimitList&&flowName=EquipmentSecurityResponse', '0', '0',
        30);