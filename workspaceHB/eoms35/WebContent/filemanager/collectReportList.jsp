            ...
            <td>
                <table class="formTable" id="list-table" width="100%">
                    ...
                    <%
                        int i = 0;
                    %>
                    <logic:iterate id="reportList" name="ReportList"
                                   type="com.boco.eoms.filemanager.form.ReportMgrBean">
                        <tr bgcolor="<%if(i%2==0) out.print("#f5fafa"); else out.print("#ffffff");%>">
                            ...
                            %>
                            <td nowrap height="30">
                                <html:link href="ReportMgrAction.do?act=allFileView" name="map" title="">
