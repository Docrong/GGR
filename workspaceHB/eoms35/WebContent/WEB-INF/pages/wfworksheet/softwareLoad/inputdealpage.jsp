		     ...
		     <input type="hidden" name="${sheetPageName}operateType" id="${sheetPageName}operateType" value="<%=operateType%>" />   
			  ...
			  <tr>
			  	<td class="label">
		           ...
		           <td class="content">
					 <input type="text" class="text" name="${sheetPageName}linkPointName" value="${sheetLink.linkPointName }" alt="allowBlank:false" /> 	          		          
		           </td>
			  </tr>
			<tr>
			<td class="label">
		     ...
		     <input type="hidden" name="${sheetPageName}operateType" id="${sheetPageName}operateType" value="<%=operateType%>" />   
			  ...
			  <tr>
			  	<td class="label">
		           ...
		           <td class="content">
					 <input type="text" class="text" name="${sheetPageName}linkTestsites" value="${sheetLink.linkTestsites }" alt="allowBlank:false" /> 	          		          
		           </td>
			  </tr>
			  <tr>
			<td class="label">
