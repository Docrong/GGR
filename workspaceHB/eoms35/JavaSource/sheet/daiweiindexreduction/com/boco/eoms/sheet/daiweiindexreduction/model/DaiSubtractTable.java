 ...
 * 2017-8-4
 */
public class DaiSubtractTable extends BaseObject {
     ...
     * 预留字段E
     */
    private java.lang.String reserveE;  // 核减状态   2：核减中   3：核减完成： 4：未通过
    ...
    public java.lang.String getHjstatus() {
        return hjstatus;
    }

    public void setHjstatus(java.lang.String hjstatus) {
        this.hjstatus = hjstatus;
    }

    public boolean equals(Object o) {
        if (o instanceof DaiSubtractTable) {
            DaiSubtractTable daiweiindexreduction = (DaiSubtractTable) o;
            if (this.id != null || this.id.equals(daiweiindexreduction.getId())) {
                return true;
            } else {
                return false;
            }
