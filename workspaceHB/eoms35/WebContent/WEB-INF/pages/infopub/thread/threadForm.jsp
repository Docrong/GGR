...
<html:form action="/thread.do?method=save" method="post" styleId="threadForm">
	...
	<ul>
		...
		<li>
			...
			<html:text property="title" styleId="title" styleClass="text medium" alt="allowBlank:false" style="width:300"/>
		</li>
		...
		<li>
			...
			<html:checkbox property="isIncludeSubDept" styleId="isIncludeSubDept" value="1">${eoms:a2u("包括子部门")}</html:checkbox>
		...
		<li>
			...
			<input type="button" id="clkAudit" name="clkAudit" value="<bean:message key='threadForm.button.audit'/>" disabled="true" />
		...
		<li class="buttonBar bottom">
			<input type="button" value="<fmt:message key="button.save" />" onClick="javascript:onSave(0);" class="button">
			<input type="button" value="<bean:message key='threadForm.button.published'/>" onClick="javascript:onSave(1);" class="button">
			<input type="button" value="<bean:message key='threadForm.button.submitAudit'/>" onClick="javascript:onSave(2);" class="button">
			<input type="button" value="<fmt:message key="button.back" />" onclick="javascript:window.location='<html:rewrite page='/thread.do?method=list&forumsId=${threadForm.forumsId}'/>'" class="button" />
