...
<div id="sheetform">
    <html:form action="/securityevaluate.do?method=performProcessEvent" styleId="theform">
        <%@ include file="/common/taglibs.jsp" %>
        <%
        ...
        <%@ include file="/WEB-INF/pages/wfworksheet/securityevaluate/baseinputlinkhtml.jsp" %>
        <table class="listTable">
            <logic:present name="toOperaterList" scope="request">
                <logic:iterate id="toTask" name="toOperaterList"
                               type="com.boco.eoms.sheet.securityevaluate.task.impl.SecurityEvaluateTaskImpl">
                    <tr>
                        <td>
