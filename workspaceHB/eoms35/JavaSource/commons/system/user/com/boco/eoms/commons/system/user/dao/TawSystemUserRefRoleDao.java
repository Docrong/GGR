...
public interface TawSystemUserRefRoleDao extends Dao {
     ...
     * found.
     *
     * @param id the tawSystemUserRefRole's id
     ...
     *
     * @param tawSystemUserRefRole the object to be saved
     */
     ...
     * @param delFlag  删除标记位,Constants.DELETED_FLAG=删除,Constants.NOT_DELETED_FLAG=未删除
     * @return 某人员对应类型子角色集合
     */
