        ...
        <logic:present name="sheetMain" scope="request">
            ...
            <table class="formTable">
                ...
                <tr>
                    ...
                    <td class="content">
                        <bean:write name="sheetMain" property="dealTime1" formatKey="date.formatDateTimeAll"
                                    bundle="sheet" scope="request"/>
                    </td>
                    <td class="label"><bean:message bundle="group" key="groupcomplaint.dealTime2"/></td>
                    <td class="content">
                        <bean:write name="sheetMain" property="dealTime2" formatKey="date.formatDateTimeAll"
                                    bundle="sheet" scope="request"/>
                    </td>
                </tr>
                ...
                <tr>
                    <c:choose>
                        ...
                        <c:otherwise>
                            <td class="label"><bean:message bundle="group"
                                                            key="groupcomplaint.mainCompleteLimitT1"/></td>
                        </c:otherwise>
                    </c:choose>
                    <td class="content">
            ...
            <table class="formTable">
                ...
                <tr>
                    ...
                    <td class="content" colspan="3"><eoms:id2nameDB id="${sheetMain.bservType}"
                                                                    beanId="ItawSystemDictTypeDao"/></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="content" colspan="3"><bean:write name="sheetMain" property="productName"
                                                                scope="request"/></td>
                </tr>
                <tr>
                    <td class="label"><bean:message bundle="group" key="groupcomplaint.affectedAreas"/></td>
                    <td class="content"><eoms:id2nameDB id="${sheetMain.affectedAreas}"
                                                        beanId="ItawSystemDictTypeDao"/></td>
