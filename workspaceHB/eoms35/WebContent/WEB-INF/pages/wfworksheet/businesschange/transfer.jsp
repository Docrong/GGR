...
<html:form action="/businesschange.do?method=performTransferWorkItem" styleId="theform">
    ...
    <br/>
           <input type="hidden" name="${sheetPageName}beanId"   id="${sheetPageName}beanId"  value="iBusinessChangeMainManager"/>
           <input type="hidden" name="${sheetPageName}mainClassName" id="${sheetPageName}mainClassName"  value="com.boco.eoms.sheet.businesschange.model.BusinessChangeMain"/>	<!--mainè¡¨Modelå¯¹è±¡ç±»å-->	
           <input type="hidden" name="${sheetPageName}linkClassName" id="${sheetPageName}linkClassName" value="com.boco.eoms.sheet.businesschange.model.BusinessChangeLink"/> <!--linkè¡¨Modelå¯¹è±¡ç±»å-->
