...
<div id="sheetform">
<html:form action="/safeaudit.do?method=performDealReplyReject" styleId="theform">
 <%@ include file="/common/taglibs.jsp"%>
<%
 ...
 %>
    ...
    <input type="hidden" name="${sheetPageName}taskNamespace" value="http://SafeAuditProcess"/>  
<%@ include file="/WEB-INF/pages/wfworksheet/safeaudit/baseinputlinkhtmlnew.jsp"%>
    <br/>  
     ...
     <tr>
      ...
      <logic:iterate id="toTask" name="acceptList" type="com.boco.eoms.sheet.safeaudit.model.SafeAuditTask">  
        <tr>
          <td>
	       ...
	       <td class="label">
			...
			<td colspan="3"> 
		           <textarea name="${sheetPageName}remark" class="textarea max" id="${sheetPageName}remark" 
		               alt="width:500,allowBlank:false,maxLength:500,vtext:'请填入操作描述，最多输入250字'">${sheetlink.remark}</textarea>
		  </td>
		</tr>
		</table>
