...
<html>
    <head>
        <title>JWChat - Editar Marcadores</title>
        <meta http-equiv="content-type" content="text/html; charset=utf-8">
          ...
          function saveBookmark() {
            ...
            if (document.forms[0].save_bookmark_as.value == '') {
              alert("Por favor, introduzca un nombre para este marcador.");
              return false;
            }
            ...
            if (document.forms[0].group.value == '') {
              alert("Por favor, indica la sala a la que deseas entrar");
              return false;
            }
        ...
        <form name="sub" onsubmit="return doSub();">
            <table border="0" width="100%">
                <tr>
                    <td>Marcador</td>
                    <td>
                        <select id="bookmark_selector" onChange="return bookmark_selected(this);">
                            <option value=''>- Elegir Marcador -</option>
                        </select>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>Nombre</td>
                    <td>
                        <input type="text" name="save_bookmark_as" size="32" style="width: 100%;">
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                ...
                <tr>
                    <td nowrap>Apodo</td>
                    <td width="100%">
                        <input type="text" name="nick" size="32" style="width:100%;">
                    </td>
                </tr>
                <tr>
                    <td nowrap>Sala</td>
                    <td width="100%">
                        <input type="text" name="group" size="32" style="width:100%;">
                    </td>
                </tr>
                <tr>
                    <td nowrap>Servidor</td>
                    <td width="100%">
                        <input type="text" name="server" size="32" style="width:100%;">
                    </td>
                </tr>
                <tr>
                    <td nowrap>Contrase&ntilde;a</td>
                    <td width="100%">
                        <input type="text" name="pass" size="32" style="width:100%;">
                    </td>
                </tr>
                <tr>
                    <td nowrap>Auto unirse</td>
                    <td>
            ...
            <div align="right" id="buttonbox">
                <button onClick="return saveBookmark();">Add/Update</button>
                &nbsp;
                <button onClick="return deleteBookmark();">Delete</button>
            </div>
