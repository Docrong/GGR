...
<FORM method="post" name="userlist_form">
    ...
    <table width="100%">
        <tr class="tr_show">
            <td>在线人员[<font color="#ff0000"><%= num %>
            </font>]
            </td>
        </tr>
        <tr>
            <td><a href="#" onClick=PerformSubmit("所有人")>所有人</a></td>
        </tr>
            <%
		...
		String User = null;
		     ...
		     deptname=(String)itr.next();
                 ...
                 %>
        <tr>
            <td style="word-break:keep-all;word-wrap:normal">[<%out.print(deptname);%>]</td>
        </tr>
            <%
			...
			%>
        <tr>
            <td style="word-break:keep-all;word-wrap:normal"><a href="#" class="l1" onClick=PerformSubmit("<%= User%>")>&nbsp&nbsp<%
                out.print(User);
            %></a></td>
        </tr>
            <%
