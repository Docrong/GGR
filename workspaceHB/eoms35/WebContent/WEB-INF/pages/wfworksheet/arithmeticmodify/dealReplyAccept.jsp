...
<div id="sheetform">
    <html:form action="/arithmeticmodify.do?method=performDealReplyAccept" styleId="theform">
        <%@ include file="/common/taglibs.jsp" %>
        <%
                        ...
                        <logic:present name="acceptList" scope="request">
                            ...
                            <logic:iterate id="toTask" name="acceptList"
                                ...
                                <tr>
                                    ...
                                    <td><eoms:id2nameDB id="${toTask.taskOwner}"
                                                        beanId="tawSystemSubRoleDao"/><eoms:id2nameDB
                                            id="${toTask.taskOwner}" beanId="tawSystemUserDao"/>&nbsp;
                                    </td>
                                    <td><bean:write name="toTask" property="taskDisplayName" scope="page"/></td>
                                </tr>
                            </logic:iterate>
                        </logic:present>
                    </table>
