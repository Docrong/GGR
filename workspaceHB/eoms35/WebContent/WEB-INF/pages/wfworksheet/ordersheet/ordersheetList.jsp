...
<caption><div class="header center">定单目录库</div></caption>
 <%int jNum=0;%>
...
<display:table name="ordersheetList" cellspacing="0" cellpadding="0"
    ...
    <display:column  sortable="true" headerClass="orderType" title="定单类型" url="/businessupport/order/ordersheets.do?method=showDetail&flag=showDetail" paramId="id" paramProperty="id">   
...
<tr class="buttonBar bottom">
   <input type="button"  styleClass="button"
            onclick="location.href='<c:url value="/businessupport/order/ordersheets.do?method=xedit&type=add&ifReference=${ifReference}"/>'" 
            value="添加"/>
