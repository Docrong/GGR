...
<table class="formTable">
    ...
    <tr>
     ...
     <td class="content">
        ...
        <eoms:comboBox name="orderType" id="orderType" defaultValue="${ordersheetForm.orderType}" initDicId="10401" 
     ...
     <td class="content">
        ...
        <eoms:comboBox name="urgentDegree" id="urgentDegree" defaultValue="${ordersheetForm.urgentDegree}" initDicId="1010102" 
	  	       alt="allowBlank:false" styleClass="select-class"/>
     </td>
     </tr>
     <tr>
     ...
     <td class="content">
        ...
        <eoms:comboBox name="orderBuisnessType" id="orderBuisnessType" defaultValue="${ordersheetForm.orderBuisnessType}" initDicId="1012301" 
	  	       alt="allowBlank:false" styleClass="select-class"/>
     </td>
     <td class="label">是否竣工</td>
     <td class="content">
        <html:errors property="isCompleted"/>
        <eoms:comboBox name="isCompleted" id="isCompleted" defaultValue="${ordersheetForm.isCompleted}" initDicId="10407" 
    ...
    <tr>
     ...
     <td class="content">
        ...
        <html:text property="orderNumber" styleId="orderNumber"  styleClass="text medium" alt="allowBlank:false"/>
     </td>
     <td class="label">主产品实例编码</td>
     <td class="content">
	  	<html:errors property="mainProductInstanceCode"/>
        <html:text property="mainProductInstanceCode" styleId="mainProductInstanceCode"  styleClass="text medium" alt="allowBlank:true"/>
     </td>
   </tr>
   <tr>
 ...
 <table class="formTable">
   <tr>
     ...
     <td class="content">
        ...
        <html:text property="customName" styleId="customName"  styleClass="text medium" alt="allowBlank:false"/>
     </td>
   </tr>
   <tr>
     ...
     <td class="content">
        ...
        <eoms:comboBox name="customLevel" id="customLevel" defaultValue="${ordersheetForm.customLevel}" initDicId="10405" 
	  	       alt="allowBlank:false" styleClass="select-class"/>
     </td>
     <td class="label">所属省份*</td>
     <td class="content">
	  	<html:errors property="provinceName"/>
        <html:text property="provinceName" styleId="provinceName"  styleClass="text medium" alt="allowBlank:false"/>
     </td>
   </tr>
   <tr>
     ...
     <td class="content">
        ...
        <html:text property="countyName" styleId="countyName"  styleClass="text medium" alt="allowBlank:false"/>
     </td>
   </tr>
 </table>
 </fieldset>
...
<legend>申请业务信息</legend>
 <table class="formTable">  
 <tr><td class="label">产品名称*</td>
     <td class="content">
	  	<html:errors property="productName"/>
        <html:text property="productName" styleId="productName"  styleClass="text medium" alt="allowBlank:false"/>
     </td>
     <td class="label">产品类别*</td>
     <td class="content">
	  	<html:errors property="productKind"/>
        <eoms:comboBox name="productKind" id="productKind" defaultValue="${ordersheetForm.productKind}" initDicId="10404" 
	  	       alt="allowBlank:false" styleClass="select-class"/>
     </td>
     </tr>
     <tr>
     ...
     <td class="content">
        ...
        <html:text property="productID" styleId="productID"  styleClass="text medium" alt="allowBlank:false"/>
     </td>
     <td class="label">产品序列号*</td>
     <td class="content">
	  	<html:errors property="productSN"/>
        <html:text property="productSN" styleId="productSN"  styleClass="text medium" alt="allowBlank:false"/>
     </td>
   </tr>
   <tr>
     ...
     <td class="content">
        ...
        <eoms:comboBox name="isNonLocal" id="isNonLocal" defaultValue="${ordersheetForm.isNonLocal}" initDicId="10406" 
	  	       alt="allowBlank:false" styleClass="select-class"/>
     </td>
     <td class="label">传输承载的业务*</td>
     <td class="content">
	  	<html:errors property="transfBusiness"/>
        <html:text property="transfBusiness" styleId="transfBusiness"  styleClass="text medium" alt="allowBlank:false"/>
     </td>
   </tr>
   <tr>
      <td class="label">业务需求描述</td>
     <td class="content" colspan="3">
	  		<textarea name="brequirementDesc" id="brequirementDesc" class="textarea max" alt="allowBlank:true">${ordersheetForm.brequirementDesc}</textarea>			   
		  </td>
   </tr>
   </table>
</fieldset>
...
<legend>相关联系人信息</legend>
 <table class="formTable"> 
   <tr>
     ...
     <td class="content">
        ...
        <html:text property="cmanagerPhone" styleId="cmanagerPhone"  styleClass="text medium" alt="allowBlank:false"/>
     </td>
     <td class="label">客户经理联系电话*</td>
     <td class="content">
	  	<html:errors property="cmanagerContactPhone"/>
        <html:text property="cmanagerContactPhone" styleId="cmanagerContactPhone"  styleClass="text medium" alt="allowBlank:false"/>
     </td>
     </tr>
     <tr>
     ...
     <td class="content">
        ...
        <html:text property="customContact" styleId="customContact"  styleClass="text medium" alt="allowBlank:false"/>
     </td>
     <td class="label">集团客户联系电话*</td>
     <td class="content">
	  	<html:errors property="customContactPhone"/>
        <html:text property="customContactPhone" styleId="customContactPhone"  styleClass="text medium" alt="allowBlank:false"/>
     </td>
   </tr> 
   <tr>
     ...
     <td class="content">
        ...
        <html:text property="bdeptContact" styleId="bdeptContact"  styleClass="text medium" alt="allowBlank:false"/>
     </td>
     <td class="label">集客部联系人联系电话*</td>
     <td class="content">
	  	<html:errors property="bdeptContactPhone"/>
        <html:text property="bdeptContactPhone" styleId="bdeptContactPhone"  styleClass="text medium" alt="allowBlank:false"/>
     </td>
   </tr>  
   <tr>
     ...
     <td class="content">
        ...
        <html:text property="groupDealContact" styleId="groupDealContact"  styleClass="text medium" alt="allowBlank:false"/>
     </td>
     <td class="label">集团业务联系人电话*</td>
     <td class="content">
	  	<html:errors property="groupDealContactPhone"/>
        <html:text property="groupDealContactPhone" styleId="groupDealContactPhone"  styleClass="text medium" alt="allowBlank:false"/>
     </td>
   </tr>
   <tr>
     ...
     <td class="content">
        ...
        <html:text property="groupTechContact" styleId="groupTechContact"  styleClass="text medium" alt="allowBlank:true"/>
     </td>
     <td class="label">集团技术联系人电话</td>
     <td class="content">
	  	<html:errors property="groupTechContactPhone"/>
        <html:text property="groupTechContactPhone" styleId="groupTechContactPhone"  styleClass="text medium" alt="allowBlank:true"/>
     </td>
   </tr>     
 </table>
 </fieldset>
 <br/>    	
     <input type="submit"  styleClass="submit" property="method.xsave"
            onclick="return;location.href='<c:url value="/businessupport/order/ordersheets.do?method=xquery&ifReference=${ifReference}"/>'" value="保存"/>
     <input type="button"  styleClass="button"
            onclick="location.href='<c:url value="/businessupport/order/ordersheets.do?method=xquery&ifReference=${ifReference}"/>'" 
            value="返回"/>
</html:form>
