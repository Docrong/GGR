...
<table id="sheet" class="formTable">
    ...
    <tr>
        ...
        <td>
            <input type="text" class="text" name="taskDescription" id="taskDescription"
                   alt="allowBlank:false,maxLength:2000,vtext:'请填入 任务描述 信息，最多输入 2000 字符'"
                   value="${sheetMain.taskDescription}"/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <input type="text" class="text" name="stationSite" id="stationSite"
                   alt="allowBlank:false,maxLength:1000,vtext:'请填入 基站站址 信息，最多输入 1000 字符'"
                   value="${sheetMain.stationSite}"/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <input type="text" class="text" name="sceneType" id="sceneType"
                   alt="allowBlank:false,maxLength:1000,vtext:'请填入 场景类型 信息，最多输入 1000 字符'"
                   value="${sheetMain.sceneType}"/>
        </td>
        <td class="label">
            <!-- 经度 -->
        ...
        <td>
            <input type="text" class="text" name="longitude" id="longitude"
                   alt="allowBlank:false,maxLength:1000,vtext:'请填入 经度 信息，最多输入 1000 字符'" value="${sheetMain.longitude}"/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <input type="text" class="text" name="latitude" id="latitude"
                   alt="allowBlank:false,maxLength:1000,vtext:'请填入 纬度 信息，最多输入 1000 字符'" value="${sheetMain.latitude}"/>
        </td>
        <td class="label">
            <!-- 楼宇类型 -->
        ...
        <td>
            <input type="text" class="text" name="buildingType" id="buildingType"
                   alt="allowBlank:false,maxLength:1000,vtext:'请填入 楼宇类型 信息，最多输入 1000 字符'"
                   value="${sheetMain.buildingType}"/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <input type="text" class="text" name="buildingNumber" id="buildingNumber"
                   alt="allowBlank:false,maxLength:1000,vtext:'请填入 楼宇层数 信息，最多输入 1000 字符'"
                   value="${sheetMain.buildingNumber}"/>
        </td>
        <td class="label">
            <!-- 天线挂高 -->
        ...
        <td>
            <input type="text" class="text" name="antennaHeight" id="antennaHeight"
                   alt="allowBlank:false,maxLength:1000,vtext:'请填入 天线挂高 信息，最多输入 1000 字符'"
                   value="${sheetMain.antennaHeight}"/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <input type="text" class="text" name="platformType" id="platformType"
                   alt="allowBlank:false,maxLength:1000,vtext:'请填入 平台类型 信息，最多输入 1000 字符'"
                   value="${sheetMain.platformType}"/>
        </td>
        <td class="label">
            <!-- 天线类型 -->
    ...
    <tr>
        ...
        <td>
            <input type="text" class="text" name="antennaModel" id="antennaModel"
                   alt="maxLength:1000,vtext:'请填入 天线型号 信息，最多输入 1000 字符'" value="${sheetMain.antennaModel}"/>
        </td>
        <td class="label">
            <!-- 经纬度符合要求 -->
    ...
    <tr>
        ...
        <td>
            <input type="text" class="text" name="otherCircumstance" id="otherCircumstance"
                   alt="maxLength:2000,vtext:'请填入 其他情况 信息，最多输入 2000 字符'" value="${sheetMain.otherCircumstance}"/>
        </td>
    </tr>
