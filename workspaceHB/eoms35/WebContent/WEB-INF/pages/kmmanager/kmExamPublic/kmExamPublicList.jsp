...
<fmt:bundle basename="config/applicationResource-kmexampublic">
    ...
    <display:table name="kmExamPublicList" cellspacing="0" cellpadding="0"
        ...
        <display:column property="testId" sortable="true"
                        headerClass="sortable" titleKey="kmExamPublic.testId"
                        href="${app}/kmExamPublic/kmExamPublics.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="createUser" sortable="true"
                        headerClass="sortable" titleKey="kmExamPublic.createUser"
                        href="${app}/kmExamPublic/kmExamPublics.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="createDept" sortable="true"
                        headerClass="sortable" titleKey="kmExamPublic.createDept"
                        href="${app}/kmExamPublic/kmExamPublics.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="createTime" sortable="true"
                        headerClass="sortable" titleKey="kmExamPublic.createTime"
                        href="${app}/kmExamPublic/kmExamPublics.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="description" sortable="true"
                        headerClass="sortable" titleKey="kmExamPublic.description"
                        href="${app}/kmExamPublic/kmExamPublics.do?method=edit" paramId="id" paramProperty="id"/>
