       ...
       <input type="hidden" name="${sheetPageName}toOrgRoleId" value="${preLink.operateRoleId}"/>
		           ...
		           <td class="content"> 
	                ...
	                <tr>
  						<td class="label"><bean:message bundle="businessoperation" key="businessoperation.linkOperStartTime"/>*</td>
		   				 <td >
		   				 <input class="text" onclick="popUpCalendar(this, this)" type="text" name="${sheetPageName}linkOperStartTime" readonly="readonly" 
  						...
  						<td class="label"><bean:message bundle="businessoperation" key="businessoperation.linkOperEndTime"/>*</td>
		   				 <td>
		   				 <input class="text" onclick="popUpCalendar(this, this)" type="text" name="${sheetPageName}linkOperEndTime" readonly="readonly"  
			     ...
			     <tr>                
		          ...
		          <tr>
		            <td  class="label"><bean:message bundle="businessoperation" key="businessoperation.linkBusinessDesc"/>*</td>
		              <td colspan="3"> 	
    				  <textarea class="textarea max" name="${sheetPageName}linkBusinessDesc" id="${sheetPageName}linkBusinessDesc" alt="width:500,allowBlank:false,maxLength:1000,vtext:'${eoms:a2u('请填入业务试点说明，最多输入2000字')}'">${sheetLink.linkBusinessDesc}</textarea>
                    </td>
		          </tr>
		             <tr>
					    <td class="label">
	            ...
	            <input type="hidden" name="${sheetPageName}operateType" id="${sheetPageName}operateType" value="<%=operateType %>" />	        
			      ...
			      <tr>
		            <td  class="label"><bean:message bundle="businessoperation" key="businessoperation.linkDataFile"/></td>
		              <td colspan="3"> 	
    				  <textarea class="textarea max" name="${sheetPageName}linkDataFile" id="${sheetPageName}linkDataFile" alt="width:500,allowBlank:true,maxLength:1000,vtext:'${eoms:a2u('请填入局数据资料，最多输入1000字')}'">${sheetLink.linkDataFile}</textarea>
                    </td>
		          </tr>
			      <tr>
		            <td  class="label"><bean:message bundle="businessoperation" key="businessoperation.linkVerify"/></td>
		              <td colspan="3"> 	
    				  <textarea class="textarea max" name="${sheetPageName}linkVerify" id="${sheetPageName}linkVerify" alt="width:500,allowBlank:true,maxLength:1000,vtext:'${eoms:a2u('请填入设备功能验证，最多输入1000字')}'">${sheetLink.linkVerify}</textarea>
                    </td>
		          </tr>
			      <tr>
		            <td  class="label"><bean:message bundle="businessoperation" key="businessoperation.linkPassMan"/></td>
		              <td colspan="3"> 	
    				  <textarea class="textarea max" name="${sheetPageName}linkPassMan" id="${sheetPageName}linkPassMan" alt="width:500,allowBlank:true,maxLength:1000,vtext:'${eoms:a2u('请填入口令管理的移交，最多输入1000字')}'">${sheetLink.linkPassMan}</textarea>
                    </td>
		          </tr>
			      <tr>
		            <td  class="label"><bean:message bundle="businessoperation" key="businessoperation.linkReport"/></td>
		              <td colspan="3"> 	
    				  <textarea class="textarea max" name="${sheetPageName}linkReport" id="${sheetPageName}linkReport" alt="width:500,allowBlank:true,maxLength:1000,vtext:'${eoms:a2u('请填入初验报告，最多输入1000字')}'">${sheetLink.linkReport}</textarea>
                    </td>
		          </tr>
			      <tr>
		            <td  class="label"><bean:message bundle="businessoperation" key="businessoperation.linkWorkplan"/></td>
		              <td colspan="3"> 	
    				  <textarea class="textarea max" name="${sheetPageName}linkWorkplan" id="${sheetPageName}linkWorkplan" alt="width:500,allowBlank:true,maxLength:1000,vtext:'${eoms:a2u('请填入作业计划制定情况，最多输入1000字')}'">${sheetLink.linkWorkplan}</textarea>
                    </td>
		          </tr>
		            <!-- <tr>
					    <td class="label">
	                ...
	                <tr>
  						<td class="label"><bean:message bundle="businessoperation" key="businessoperation.linkMeetingAcc"/>*</td>
		   				 <td  colspan='3'>
		   				 <eoms:attachment idList="" name="sheetLink" scope="request" property="linkMeetingAcc" idField="${sheetPageName}linkMeetingAcc" appCode="businessoperation" alt="allowBlank:false"/>
		                </td>
		            </tr>
		            <%}} %>
		 <%if(taskName.equals("report")){ 
	          if(operateType.equals("94")|| operateType.equals("11")){%>
	            ...
	            <input type="hidden" name="${sheetPageName}operateType" id="${sheetPageName}operateType" value="<%=operateType %>" />	
	             <input type="hidden" name="${sheetPageName}mainIsSuccess" id="${sheetPageName}mainIsSuccess" value="${sheetPageName}mainIsSuccess" />              
		          <tr>
				   <td class="label">
				     <bean:message bundle="sheet" key="linkForm.acceptLimit"/>*           
		           </td>
		           ...
		           <td class="content"> 
	                ...
	                <tr>
  						<td class="label"><bean:message bundle="businessoperation" key="businessoperation.linkTGReportAcc"/>*</td>
		   				 <td  colspan='3'>
		   				 <eoms:attachment idList="" name="sheetLink" scope="request" property="linkTGReportAcc" idField="${sheetPageName}linkTGReportAcc" appCode="businessoperation" alt="allowBlank:false"/>
		                </td>
		            </tr>
		            <%}} %>
		...
		<%} %>
         ...
         <%if(taskName.equals("hold")) {%>  	
		  ...
		  <tr>
		    ...
		    <td colspan="3">
		      <textarea name="${sheetPageName}endResult" alt="allowBlank:false,vtext:'${eoms:a2u('请最多输入1000字')}'" id="${sheetPageName}endResult"  class="textarea max">${sheetMain.endResult}</textarea>
		    </td>
		  </tr>					       			     	
     	    <%} }%>
