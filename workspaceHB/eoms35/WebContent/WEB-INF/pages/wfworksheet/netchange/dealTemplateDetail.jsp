...
<html:form action="/netchange.do" styleId="theform">
    ...
    <input type="hidden" name="${sheetPageName}mainClassName"
           value="com.boco.eoms.sheet.netchange.model.NetChangeMain"/> <!--main?Model????-->
    <input type="hidden" name="${sheetPageName}linkClassName"
           value="com.boco.eoms.sheet.netchange.model.NetChangeLink"/> <!--link?Model????-->
    ...
    <table class="formTable">
        ...
        <tr>
            ...
            <td colspan="3">
                <input type="text" class="text" name="${sheetPageName}linkProjectKey"
                       id="${sheetPageName}linkProjectKey" value="${sheetLink.linkProjectKey}" alt="allowBlank:false"/>
            </td>
        </tr>
        <tr>
            <!-- 风险评估 -->
            ...
            <td colspan="3">
                <textarea name="${sheetPageName}linkRiskEvaluate" id="${sheetPageName}linkRiskEvaluate"
                          class="textarea max" alt="allowBlank:false">${sheetLink.linkRiskEvaluate}</textarea>
            </td>
        </tr>
        <tr>
            <!-- 影响业务分析 -->
            ...
            <td colspan="3">
                <textarea name="${sheetPageName}linkOperationConstrue" id="${sheetPageName}linkOperationConstrue"
                          class="textarea max" alt="allowBlank:false">${sheetLink.linkOperationConstrue}</textarea>
            </td>
        </tr>
        <tr>
            <!-- 总技术方案说明 -->
            ...
            <td colspan="3">
                <textarea name="${sheetPageName}linkProjectExplain" id="${sheetPageName}linkProjectExplain"
                          class="textarea max" alt="allowBlank:true">${sheetLink.linkProjectExplain}</textarea>
            </td>
        </tr>
        <tr>
            <!-- 总技术方案附件 -->
        ...
        <tr>
            ...
            <td colspan="3">
                <eoms:comboBox name="${sheetPageName}linkAuditingResult" id="${sheetPageName}linkAuditingResult"
                               initDicId="1011608" defaultValue="${sheetLink.linkAuditingResult}"
        ...
        <tr>
            ...
            <td colspan="3">
                <textarea name="linkAuditingIdea" id="linkAuditingIdea" class="textarea max"
                          alt="allowBlank:false">${sheetLink.linkAuditingIdea}</textarea>
            </td>
        </tr>
        <tr>
            <!-- 附件 -->
        ...
        <tr>
            ...
            <td colspan="3">
                <eoms:comboBox name="${sheetPageName}linkPermitResult" id="${sheetPageName}linkPermitResult"
                               initDicId="1011608" defaultValue="${sheetLink.linkPermitResult}"
                               onchange="ifAuditPass(this.value);" alt="allowBlank:false"/>
            </td>
        </tr>
        <tr>
            <!-- 审批意见 -->
        ...
        <tr>
            ...
            <td>
                <input type="hidden" name="${sheetPageName}linkIfStartCircuit" id="${sheetPageName}linkIfStartCircuit"
                       value=""/>
                <a href="/WEB-INF/pages/wfworksheet/circuitdispatch/inputmain.jsp"><bean:message bundle="netchange"
                                                                                                 key="netchange.linkIfStartCircuit"/></a>
            </td>
            <!-- 是否启动软件变更工单 -->
            <td class="label"><bean:message bundle="netchange" key="netchange.linkIfStartData"/>*</td>
            <td>
                <input type="hidden" name="${sheetPageName}linkIfStartData" id="${sheetPageName}linkIfStartData"
                       value=""/>
                <eoms:comboBox name="${sheetPageName}linkIfNotify" id="${sheetPageName}linkIfNotify"
                               initDicId="${sheetLink.linkIfNotify}" defaultValue="${sheetLink.linkIfNotify}"
                               alt="allowBlank:false"/>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td colspan="3">
                <textarea name="linkColligateExcuteResult" id="linkColligateExcuteResult" class="textarea max"
                          alt="allowBlank:false">${sheetLink.linkColligateExcuteResult}</textarea>
            </td>
        </tr>
        <tr>
            <!-- 综合实施报告 -->
        ...
        <tr>
            ...
            <td>
                <eoms:comboBox name="${sheetPageName}linkIfAccordingProject" id="${sheetPageName}linkIfAccordingProject"
                               initDicId="1011608" defaultValue="${sheetLink.linkIfAccordingProject}"
                               alt="allowBlank:false"/>
            </td>
        </tr>
        <tr>
            ...
            <td colspan="3">
                <eoms:comboBox name="${sheetPageName}linkIfExcuteSuccess" id="${sheetPageName}linkIfExcuteSuccess"
                               initDicId="1011608" defaultValue="${sheetLink.linkIfExcuteSuccess}"
                               alt="allowBlank:false"/>
            </td>
        </tr>
        <tr>
            ...
            <td colspan="3">
                <textarea name="${sheetPageName}linkTestSummarize" id="${sheetPageName}linkTestSummarize"
                          class="textarea max" alt="allowBlank:false">${sheetLink.linkTestSummarize}</textarea>
            </td>
        </tr>
        <tr>
            <!-- 后续工作安排 -->
        ...
        <tr>
            ...
            <td colspan="3">
                <textarea name="${sheetPageName}linkMaintenanceDes" id="${sheetPageName}linkMaintenanceDes"
                          class="textarea max" alt="allowBlank:false">${sheetLink.linkMaintenanceDes}</textarea>
            </td>
        </tr>
        <tr>
            <!-- 综合测试报告 -->
