...
<%
    ...
    if (TabNum != 0) {
        for (int Col = 0; Col < TabNum; Col++) {
            ...
            cc_operateid = SysTabIndex.getCc_operateid();
            cc_location = SysTabIndex.getCc_location();
        }
    }
%>
    ...
    <form name=editsysform action="" method="post">
        <table bgcolor=#dddddd width='100%' cellspacing="1" cellpadding="0" border="0">
            <tr bgcolor=#eeeeee>
                ...
                <td align=left><font size=2 color=#000000><input name='cc_name' maxlength=32 value=<%=cc_name%>></input></font>*
                </td>
            </tr>
            <tr bgcolor=#eeeeee>
                <td align=center><font size=2 color=#000000>数据表代号：</font></td>
                <td align=left><font size=2 color=#000000></font><input name='cc_code' maxlength=32
                                                                        value=<%=cc_code%>></input></td>
            </tr>
            <tr bgcolor=#eeeeee>
                <td align=center><font size=2 color=#000000>数据表类型：</font></td>
                <td align=left><font size=2 color=#000000></font><input name='fi_type' value=<%=fi_type%>></input></td>
            </tr>
            <tr bgcolor=#eeeeee>
                <td align=center><font size=2 color=#000000>创建数据表的SQL：</font></td>
                <td align=left><font size=2 color=#000000></font><textarea name='ct_sql' value=<%=ct_sql%>></textarea>
                </td>
            </tr>
            <tr bgcolor=#eeeeee>
            ...
            <tr bgcolor=#eeeeee>
                <td align=center><font size=2 color=#000000>操作id:</font></td>
                <td align=left><font size=2 color=#000000></font><input name='cc_operateid' value=<%=ci_icon%>></input>
                </td>
            </tr>
            <tr bgcolor=#eeeeee>
                <td align=center><font size=2 color=#000000>位置：</font></td>
                <td align=left><font size=2 color=#000000></font><input name='cc_location' value=<%=ci_icon%>></input>
                </td>
            </tr>
        </table>
        <br>
                    ...
                    <table>
                        <tr>
                            ...
                            <td width=60 align=center><a href="javascript:clearinput()"><img
                                    src="../images/button_cancel.gif" border=0></a></td>
                        </tr>
                    </table>
                </td>
            </tr>
