    ...
    <form name="form1">
        ...
        <table border="0" width="100%" cellspacing="1" cellpadding="1" class="table_show" align=center>
            ...
            <logic:iterate id="project" name="Project_LIST" type="com.boco.eoms.infmanage.model.Project">
                ...
                <bean:define id="project_send_user" name="project" property="project_send_user"
                ...
                <tr class="tr_show">
                    ...
                    <td width="5%" height="25" class="clsfth" align="center">
                        <center><bean:write name="project" property="project_level" scope="page"/></center>
                    </td>
                    <td width="5%" height="25" class="clsfth" align="center">
                        <center><bean:write name="project" property="project_state" scope="page"/></center>
                    </td>
                    <td width="5%" height="25" class="clsfth" align="center">
                        <center><bean:write name="project" property="project_instancy" scope="page"/></center>
                    </td>
                    <td width="15%" height="25" class="clsfth" align="center">
                    ...
                    <td width="15%" height="25" class="clsfth" align="center">
                        <center><%=Integer.parseInt(sign.toString())%>%</center>
                    </td>
                    <%} else {%>
                    <td width="15%" height="25" class="clsfth" align="center">
                    ...
                    <%}%>
                    <td width="5%" height="25" align="center"><font color="#cc0000"><html:link page="/project/view.do"
                                                                                               name="map"
                                                                                               scope="page"><img
                    ...
                    <td width="5%" height="25" align="center">
                        ...
                        <font color="#cc0000"><html:link page="/project/update.do" name="map" scope="page"><img
                                src="<%=request.getContextPath()%>/images/bottom/an_bj.gif" border="0"
                                alt="编辑"></html:link>&nbsp;</font>
                        <%}%></td>

                    <td width="5%" height="25" align="center">
                        <%if (userName.equals(project_send_user)) {%>
                        <font color="#cc0000"><html:link page="/project/del.do" name="map" scope="page"><img
                                src="<%=request.getContextPath()%>/images/bottom/an_sc.gif" border="0"
                                alt="删除"></html:link>&nbsp;</font>
                        <%}%></td>
                </tr>
            </logic:iterate>
            　
