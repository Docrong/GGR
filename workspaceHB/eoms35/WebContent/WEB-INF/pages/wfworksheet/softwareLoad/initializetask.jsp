...
<html:form action="/softwareLoad.do?method=newTaskPerformAdd" styleId="theform" target="myname">
    ...
    <table class="formTable">
        <tr>
            <td class="label"><bean:message bundle="softwareLoad" key="softwareLoad.linkUrgency"/>*</td>
        ...
        <tr>
            <td class="label"><bean:message bundle="softwareLoad" key="softwareLoad.linkReqCompleteTime"/>*</td>
            <td class="content">
            ...
            <td class="label"><bean:message bundle="softwareLoad" key="softwareLoad.linkAcceptDept"/>*</td>
            <td class="content">
        ...
        <tr>
            <td class="label"><bean:message bundle="softwareLoad" key="softwareLoad.linkSendSheetDesc"/>*</td>
            <td colspan="3">
    ...
    <c:if test="${phaseId=='UserTask'}">
        ...
        <fieldset id="link1">
            <legend>
                <bean:message bundle="softwareLoad" key="role.toOrgName"/>
