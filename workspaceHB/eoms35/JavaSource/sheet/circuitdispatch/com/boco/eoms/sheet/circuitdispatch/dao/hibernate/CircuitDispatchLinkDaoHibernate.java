...
import com.boco.eoms.sheet.circuitdispatch.dao.ICircuitDispatchLinkDAO;
 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class CircuitDispatchLinkDaoHibernate extends LinkDAO implements
        ICircuitDispatchLinkDAO {
	...
	public BaseLink loadSinglePO(String id, Object linkObject) throws HibernateException {
		CircuitDispatchLink link = (CircuitDispatchLink) getHibernateTemplate().get(CircuitDispatchLink.class,id);
		return link;
	}
	...
	public List listAllLinkOfWorkSheet(String id, Object linkObject) throws HibernateException {
		String sql = "from CircuitDispatchLink as link where link.mainId ='" + id
	...
	public List loadLinkOfStep(String processId, String stepId, Object linkObject)
		...
		String sql = "from CircuitDispatchLink as link where link.piid ='"
