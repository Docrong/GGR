...
<c:if test="${findForward != null && findForward == 'list'}">
	<jsp:include page="/WEB-INF/pages/wfworksheet/businessimplementyy/listsendUndoJS.jsp"/>
</c:if>
<%} %>
...
<bean:define id="url" value="businessimplementyy.do"/>
	<display:table name="taskList" cellspacing="0" cellpadding="0"
		...
		export="true" requestURI="businessimplementyy.do"
		sort="list" size="total" partialList="true"
		decorator="com.boco.eoms.sheet.businessimplementyy.webapp.action.ProcessListCommonDisplaytagDecoratorHelper">
