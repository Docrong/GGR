...
<script type="text/javascript">
    Ext.onReady(function () {
        ...
        new xbox({
            ...
            treeChkMode: 'single',
            treeChkType: 'user',
            showChkFldId: 'auditName',
            saveChkFldId: 'auditer'
        });
        new xbox({
            btnId: 'reportPersonName',
            dlgId: 'dlg-audit',
            dlgTitle: '请选择人员',
            treeDataUrl: userTreeAction,
            treeRootId: '-1',
            ...
            treeChkMode: 'single',
            treeChkType: 'user',
            showChkFldId: 'reportPersonName',
            saveChkFldId: 'reportPerson'
        });
    })
</script>
<!--根据给定的实例名生成标题 -->
...
<html:form action="tawWorkbenchReports" method="post" styleId="tawWorkbenchReportForm">
    <ul>
        ...
        <li>
            ...
            <html:text property="reportTime" styleId="reportTime" readonly="true" styleClass="text medium"
        ...
        <li>
            ...
            <html:text property="auditTime" styleId="auditTime" styleClass="text medium"
                       onclick="popUpCalendar(this, this,null,null,null,false,-1);"/>
        </li>
        <li>
            ...
            <eoms:dict key="dict-workbench-report" dictId="auditStatus" selectId="auditStatus" beanId="selectXML"
                       alt="allowBlank:false" defaultId="${tawWorkbenchReportForm.auditStatus }"/>
        </li>
