        ...
        <center>
            ...
            <table border="0" width="95%" cellspacing="1" cellpadding="1"
                ...
                <tr class="tr_show">
                    ...
                    <td width="75%" height="25" colspan="3">
                        <html:text styleClass="clstext" property="sheetid" value="<%=sheetid%>" size="30"
                                   readonly="true"/>
                        <font color="#FF0000">**</font>
                    </td>
                </tr>
                <%//}%>
                <tr class="tr_show">
                    <td width="25%" height="25" class="clsfth">&nbsp;工单主题</td>
                    <td width="75%" height="25" colspan="3">
                ...
                <tr class="tr_show">
                    <td width="25%" class="clsfth">&nbsp;工单派发人</td>
                    <td width="75%" colspan="3"><%=authorDeptName%> <%=authorName%>
                    </td>
                </tr>
                <tr class="tr_show">
                    <td width="25%" class="clsfth">&nbsp;工单入库人</td>
                    <td width="75%" height="25" colspan="3">
                        <html:text styleClass="clstext" property="zuozhe"
                                   value="<%=StaticMethod.getGBString(StaticMethod.null2String(zuozhe,""))%>"
                                   size="30"/>
                    </td>
                </tr>
                <!--tr class="tr_show">
      ...
      <eoms:SelectDictRel jsDealTimeLimit="true" name="specialtyType" typeName="CustType" formName="kbsBaseForm" relProperty="faultType" relTypeName="FaultType" value="15" />
		...
		<html:select property="custType" style="width: 3.6cm;">
                ...
                <tr class="tr_show">
                    ...
                    <td width="75%" height="25" colspan="3">
                        <html:textarea rows="6" style="width:10.8cm;" property="description" styleClass="clstext"
                                       value="<%=description%>"/>
                    </td>
                </tr>
                <!--tr class="tr_show" >
        ...
        <html:textarea  rows="6" style="width:10.8cm;"  styleClass="clstext" property="cause" value="<%=cause%>"/>
                ...
                <tr class="tr_show">
                    ...
                    <td width="75%" height="50" colspan="3">
                        <html:textarea property="deal" rows="6" style="width:10.8cm;" value="<%=deal%>"
                                       styleClass="clstext"/>
                    </td>
                </tr>
                <tr class="tr_show">
