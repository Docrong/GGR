...
<div align="center">
    <center>
        ...
        <form action="../part/backover.do?order=<bean:write name="order" scope="request" filter="false"/>" method="post"
              name="TawSparepartForm" onsubmit="return handleid();">
            ...
            <table border="0" width="95%" cellspacing="1" cellpadding="1" class="table_show" align="center">
                ...
                <logic:iterate id="sparepart" name="sparepart" type="com.boco.eoms.sparepart.model.TawPart">
                    <tr class="tr_show" align="center">
                        ...
                        <td>
                            <INPUT TYPE="checkbox" name="back" id="<%="a"+i%>" label="<%="b"+i%>"
