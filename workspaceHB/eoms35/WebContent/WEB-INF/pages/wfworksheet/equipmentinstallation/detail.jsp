						 ...
						 <td width="50%">  
									...
									<select id="dealSelector">
									 ...
									 <% } else if(taskStatus.equals(Constants.TASK_STATUS_CLAIMED)){ %>
									 	  ...
									 	  <% if (ifwaitfor.equals("false")) {%>
											  <!-- 流程步骤，移交，阶段回复，分派 -->
											  <option value="${urlShowAudit101Page}"><bean:message bundle="equipmentinstallation" key="operateType.Audit101"/> </option>
									 ...
									 <%} else { %>
									 		...
									 		<!-- 不需要等待回复 -->
									 	  	<% if (ifwaitfor.equals("false")) {%>
									 			<option value="${urlShowDispatchPage}"><bean:message bundle="equipmentinstallation" key="operateType.subTaskReply"/></option>
									 		<% }%>
									 <% } %>
								...
								<% }  if(taskName.equals("Install")){ %>
									<select id="dealSelector">
									 ...
									 <% } else if(taskStatus.equals(Constants.TASK_STATUS_CLAIMED)){ %>
									 	  ...
									 	  <% if (ifwaitfor.equals("false")) {%>
											  <!-- 流程步骤，移交，阶段回复，分派 -->
											  <option value="${urlShowInstall102Page}"><bean:message bundle="equipmentinstallation" key="operateType.Install102"/> </option>
 							...
 							<!-- 归档 -->
								<% }  if(taskName.equals("HoldTask")){ %>
									<select id="dealSelector">
									 	  ...
									 	  <% if (ifwaitfor.equals("false")) {%>
											  <!-- 流程步骤，移交，阶段回复，分派 -->
											  <option value="${urlShowHoldTask18Page}"><bean:message bundle="equipmentinstallation" key="operateType.HoldTask18"/> </option>
							...
							<% }else if(taskName.equals("RejectTask")){%>	
					  		...
					  		<% }else if(taskName.equals("DraftTask")){%>	
								<select id="dealSelector">
								  <option value="${urlShowDraftPage}"><bean:message bundle="equipmentinstallation" key="operateType.DraftTask"/></option>
								</select>
					   		<% } %>
					</td>
				</tr>
