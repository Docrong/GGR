        ...
        <html:form action="/Faultrecord/save">
            ...
            <table border="0" width="500" cellspacing="1" cellpadding="1" class="formTable" align=center>
                ...
                <tr class="tr_show">
                    ...
                    <td colspan=3>
                        <eoms:dict key="dict-plancontent" dictId="devVendor" beanId="selectXML" isQuery="false"
                                   selectId="devVendor" alt="allowBlank:false"/>
                    </td>
                </tr>
                ...
                <tr class="tr_show">
                    ...
                    <td colspan=3>
                        <eoms:dict key="dict-plancontent" dictId="devicetype" beanId="selectXML" isQuery="false"
                                   selectId="devicetype" alt="allowBlank:false"/>
                    </td>
                </tr>
                ...
                <tr class="tr_show">
                    ...
                    <td colspan=3>
                        <eoms:dict key="dict-plancontent" dictId="faultLevel" beanId="selectXML" isQuery="false"
                                   selectId="faultLevel" alt="allowBlank:false"/>
                    </td>
                </tr>
                ...
                <tr class="tr_show">
                    ...
                    <td colspan=3>
                        <html:textarea property="faultContent" rows="4" style="width:100%" value=""
                                       title="${eoms:a2u('故障内容')}" styleClass="textarea medium"/>
                    </td>
                </tr>
                ...
                <tr class="tr_show">
                    ...
                    <td colspan=3>
                        <html:textarea property="faultResult" rows="4" style="width:100%" value=""
                                       title="${eoms:a2u('故障处理情况')}" styleClass="textarea medium"/>
                    </td>
                </tr>
                ...
                <tr class="tr_show">
                    ...
                    <td colspan=3>
                        <input type="text" name="declareTime" size="30" value="" class="text"
                               onclick="popUpCalendar(this, this,null,null,null,true,-1);" readonly="true">
                    </td>
                </tr>
                ...
                <tr class="tr_show">
                    ...
                    <td colspan=3>
                        <input type="text" name="dealTime" size="30" value="" class="text"
                               onclick="popUpCalendar(this, this,null,null,null,true,-1);" readonly="true">
                    </td>
                </tr>
                ...
                <tr class="tr_show">
                    ...
                    <td colspan=3>
                        <html:textarea property="remark" rows="4" style="width:100%" value="" title="${eoms:a2u('备注')}"
