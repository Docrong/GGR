...
public interface ITawwpYearPlanMgr {
     ...
     *
     * @param _yearCheckIdStr   String 年度作业计划审批标识字符�?
     * @param _content          String 审批内容
     ...
     *
     * @param _sysType  String 系统类型
     * @param _netType  String 网元类型
     * @param _content  String 作业计划内容
     * @param _cruser   String 创建�?
     * @param _deptId   String 部门ID
     * @param _name     String 年度作业计划名称
     * @param _netList  String 对应的网元信�?
     ...
     * @param _cruser      String 创建�?
     * @param _deptId      String 部门ID
     * @param _modelPlanId String 作业计划模版ID
     * @param _netList     String 对应的网元信�?
     * @param _remark      String 备注
     * @param _yearFlag    String 年度�?
     * @return TawwpYearPlan 年度作业计划对象
     ...
     *
     * @param _command    String 命令标识(智能巡检接口)
     * @param _cruser     String 创建�?
     * @param _cycle      String 周期
     * @param _executeId  String 执行内容ID
     * @param _format     String 填写格式
     * @param _formId     String 执行表格标识
     * @param _groupId    String 组织信息表示标识
     * @param _monthFlag  String 周期为月以上的周期，制定执行在第几个月执�?
     * @param _name       String 年度作业计划执行内容名称
     * @param _netTypeId  String 网元类型
     * @param _remark     String 备注
     * @param _yearPlanId String 年度作业计划标识
     * @param _isHoliday  String 是否假日排班 0 �?1 �?
     * @param _isWeekend  String 是否周末排班 0 �?1 �?
     * @param
     * @throws Exception 异常信息
     */
     ...
     * @param _command   String 命令标识(智能巡检接口)
     * @param _cycle     String 周期
     * @param _executeId String 执行内容标识
     * @param _formId    String 执行表格标识
     * @param _format    String 填写格式
     * @param _monthFlag String 周期为月以上的周期，制定执行在第几个月执�?
     * @param _name      String 年度作业计划执行内容名称
     ...
     * 业务逻辑：通过审批(PASS-YEAR-PLAN-AUDITING-001)
     *
     * @param _yearCheckId      String 年度作业计划审批标识
