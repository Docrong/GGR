...
<form name="form1" action="">
    ...
    <TABLE cellpadding="10">
        ...
        <TR>
            <TD>表单用提交按钮：<BR>
                名字：<INPUT TYPE="text" NAME="name" value=""> <BOCO:genericButton
                        text="">俺叫<%=request.getParameter("name")%>
                </BOCO:genericButton><BR>
        ...
        <TR>
            <TD>超长按钮文字：<BR><BOCO:genericButton css="classic" text=""> 超长按钮文字测试，哈哈，13413 ASDLFKJAF
                DF </BOCO:genericButton>
            </TD>
        </TR>
        <TR>
            <TD>图片按钮：<BR>
