...
<div id="sheetform">
    <html:form action="/maintenanceservice.do?method=performDealReplyReject" styleId="theform">
        <%
        ...
        <input type="hidden" name="subtaskName" value="MaintenanceServiceSubTask"/>
        ...
        <input type="hidden" name="taskNamespace" value="http://MaintenanceService"/>
                    ...
                    <table class="formTable">
                        <logic:present name="acceptList" scope="request">
                            ...
                            <logic:iterate id="toTask" name="acceptList"
                                           type="com.boco.eoms.sheet.maintenanceservice.model.MaintenanceServiceTask">
                                <tr>
                                    <td>
