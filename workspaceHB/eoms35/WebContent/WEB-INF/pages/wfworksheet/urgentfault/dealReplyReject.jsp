...
<div id="sheetform">
<html:form action="/urgentfault.do?method=performDealReplyReject" styleId="theform">
 <%@ include file="/common/taglibs.jsp"%>
<%
...
<%@ include file="/WEB-INF/pages/wfworksheet/urgentfault/baseinputlinkhtmlnew.jsp"%>
     ...
     <tr>
      ...
      <logic:iterate id="toTask" name="acceptList" type="com.boco.eoms.sheet.urgentfault.task.impl.UrgentFaultTask">  
        <tr>
          <td>
