...
<div id='hiddenPic'
    ...
    <img id='images2' name='images2' src='${app}/images/techniquesupporthb.gif' border='0'>
</div>
<div id='block1' onmouseout="javascript:drag=0;" onmouseover='javascript:dragObj=block1; drag=1;'
    ...
    <dd><img id='images1' name='images1' src='${app}/images/techniquesupporthb.gif' border='0'></dd>
</div>
