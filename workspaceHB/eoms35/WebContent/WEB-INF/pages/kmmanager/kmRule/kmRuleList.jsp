...
<fmt:bundle basename="com/boco/eoms/km/config/applicationResource-kmmanager">
    ...
    <display:table name="kmRuleList" cellspacing="0" cellpadding="0"
        ...
        <display:column property="ruleName" sortable="true"
                        headerClass="sortable" titleKey="kmRule.ruleName" href="${app}/kmmanager/kmRules.do?method=edit"
        ...
        <display:column property="createTime" sortable="true"
                        headerClass="sortable" titleKey="kmRule.createTime"
                        href="${app}/kmmanager/kmRules.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="ruleScript" sortable="true"
                        headerClass="sortable" titleKey="kmRule.ruleScript"
                        href="${app}/kmmanager/kmRules.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="ruleParameter" sortable="true"
                        headerClass="sortable" titleKey="kmRule.ruleParameter"
                        href="${app}/kmmanager/kmRules.do?method=edit" paramId="id" paramProperty="id"/>
        ...
        <display:column property="id" sortable="true"
                        headerClass="sortable" titleKey="kmRule.id" href="${app}/kmmanager/kmRules.do?method=edit"
                        paramId="id" paramProperty="id"/>

        <display:column property="remark" sortable="true"
                        headerClass="sortable" titleKey="kmRule.remark" href="${app}/kmmanager/kmRules.do?method=edit"
                        paramId="id" paramProperty="id"/>
