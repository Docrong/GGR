        ...
        <fmt:bundle basename="com/boco/eoms/km/config/applicationResource-kmmanager">
			...
			<textarea name="applyContent" id="applyContent"
                    ...
                    <c:if test="${kmContentsApplyForm.fileName!=null}">
                        <tr>
                            ...
                            <td class="content" colspan="3">
                                <eoms:attachment name="kmContentsApplyForm" property="fileName" scope="request"
                                                 idField="fileName" appCode="kmmanager" viewFlag="Y"/>
                            </td>
                        </tr>
                    </c:if>
            ...
            <div id="content-info" class="tabContent">
                <display:table name="kmContentsList" cellspacing="0" cellpadding="0"
                    ...
                    <display:column sortable="false" property="createTime" titleKey="kmContents.createTime"
