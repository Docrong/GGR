...
<table class="formTable">
    ...
    <tr>
        ...
        <td>
            <eoms:comboBox name="${sheetPageName}urgentDegree" id="${sheetPageName}urgentDegree"
                           initDicId="1010102" alt="allowBlank:true" defaultValue="${sheetMain.urgentDegree}"
        ...
        <td>
            <eoms:comboBox name="${sheetPageName}btype1" id="${sheetPageName}btype1"
                           initDicId="1011201" alt="allowBlank:true" defaultValue="${sheetMain.btype1}"
                           alt="allowBlank:false" styleClass="select-class"/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <input type="text" class="text" name="${sheetPageName}bdeptContact" id="${sheetPageName}bdeptContact"
                   ...
                   alt="allowBlank:false,maxLength:200,vtext:'${eoms:a2u('请输入业务部门联系人，最大长度为100个汉字！')}'"
                   defaultValue="${sheetMain.bdeptContactPhone}"/>
        </td>
        <td class="label"><bean:message bundle="resourceaffirm" key="resourceaffirm.bdeptContactPhone"/>&nbsp;&nbsp;*
        </td>
        <td><input type="text" class="text" name="${sheetPageName}bdeptContactPhone"
                   ...
                   alt="allowBlank:false,maxLength:200,vtext:'${eoms:a2u('请输入业务部门联系人电话，最大长度为100个汉字！')}'"
                   defaultValue="${sheetMain.bdeptContactPhone}"/></td>
    </tr>
    ...
    <tr>
        ...
        <td><input type="text" class="text" name="${sheetPageName}customNo" id="${sheetPageName}customNo"
                   ...
                   alt="allowBlank:false,maxLength:200,vtext:'${eoms:a2u('请输入集团客户编号，最大长度为100个汉字！')}'"
                   defaultValue="${sheetMain.customNo}"/></td>
        ...
        <td><input type="text" class="text" name="${sheetPageName}customName"
                   id="${sheetPageName}customName" value="${sheetMain.customName}"
                   alt="allowBlank:true,maxLength:200,vtext:'${eoms:a2u('请输入集团客户名称，最大长度为100个汉字！')}'"
                   value="${sheetMain.customName}" defaultValue="${sheetMain.customName}"/></td>
    </tr>
    ...
    <tr>
        ...
        <td><input type="text" class="text" name="${sheetPageName}customContact" id="${sheetPageName}customContact"
                   ...
                   alt="allowBlank:true,maxLength:200,vtext:'${eoms:a2u('请输入集团客户联系人，最大长度为100个汉字！')}'"
                   defaultValue="${sheetMain.customContact}"/></td>
        ...
        <td><input type="text" class="text" name="${sheetPageName}customContactPhone"
                   ...
                   alt="allowBlank:true,maxLength:200,vtext:'${eoms:a2u('请输入集团客户联系人电话，最大长度为100个汉字！')}'"
                   defaultValue="${sheetMain.customContactPhone}"/></td>
    </tr>
    ...
    <tr>
        ...
        <td><input type="text" class="text" name="${sheetPageName}bandwidth" id="${sheetPageName}bandwidth"
                   defaultValue="${sheetMain.bandwidth}" value="${sheetMain.bandwidth}"
        ...
        <td><input type="text" class="text" name="${sheetPageName}numbere" id="${sheetPageName}numbere"
                   defaultValue="${sheetMain.numbere}" value="${sheetMain.numbere}"
    ...
    <tr>
        ...
        <td><input type="text" class="text" name="${sheetPageName}cityA" id="${sheetPageName}cityA"
                   defaultValue="${sheetMain.cityA}" value="${sheetMain.cityA}"
        ...
        <td><input type="text" class="text" name="${sheetPageName}cityZ" id="${sheetPageName}cityZ"
                   defaultValue="${sheetMain.cityZ}" value="${sheetMain.cityZ}"
    ...
    <tr>
        ...
        <td><input type="text" class="text" name="${sheetPageName}portA" id="${sheetPageName}portA"
                   defaultValue="${sheetMain.portA}" value="${sheetMain.portA}"
        ...
        <td>
            <eoms:comboBox name="${sheetPageName}transfBusiness" id="${sheetPageName}transfBusiness"
                           initDicId="1011049" alt="allowBlank:true" defaultValue="${sheetMain.transfBusiness}"
                           alt="allowBlank:false" styleClass="select-class"/>
        </td>
    </tr>
    <tr>
        ...
        <td colspan='3'>
            <eoms:comboBox name="${sheetPageName}isBeforehandOccupy" id="${sheetPageName}isBeforehandOccupy"
                           initDicId="1011017" alt="allowBlank:true" defaultValue="${sheetMain.isBeforehandOccupy}"
                           alt="allowBlank:false" styleClass="select-class"/><bean:message bundle="resourceaffirm"
                                                                                           key="resourceaffirm.prompt"/>
        </td>

    </tr>

    <tr>
        <td class="label"><bean:message bundle="resourceaffirm" key="resourceaffirm.portAInterfaceType"/>&nbsp;&nbsp;*
        </td>
        <td>
            <eoms:comboBox name="${sheetPageName}portAInterfaceType" id="${sheetPageName}portAInterfaceType"
                           initDicId="1011016" alt="allowBlank:false" defaultValue="${sheetMain.portAInterfaceType}"
                           styleClass="select-class"/>
        </td>
        <td class="label"><bean:message bundle="resourceaffirm" key="resourceaffirm.portAContactPhone"/>&nbsp;&nbsp;*
        </td>
        <td><input type="text" class="text" name="${sheetPageName}portAContactPhone"
                   id="${sheetPageName}portAContactPhone" defaultValue="${sheetMain.portAContactPhone}"
                   value="${sheetMain.portAContactPhone}"
                   alt="allowBlank:false,maxLength:200,vtext:'${eoms:a2u('请输入端口A联系人及电话，最大长度为100个汉字！')}'"/></td>
    </tr>
    <tr>
        <td class="label"><bean:message bundle="resourceaffirm" key="resourceaffirm.portABDeviceName"/>&nbsp;&nbsp;*
        </td>
        <td><input type="text" class="text" name="${sheetPageName}portABDeviceName"
                   id="${sheetPageName}portABDeviceName" defaultValue="${sheetMain.portABDeviceName}"
                   value="${sheetMain.portABDeviceName}"
                   alt="allowBlank:false,maxLength:200,vtext:'${eoms:a2u('请输入端点A业务设备名称，最大长度为100个汉字！')}'"/></td>
        <td class="label"><bean:message bundle="resourceaffirm" key="resourceaffirm.portABDevicePort"/>&nbsp;&nbsp;*
        </td>
        <td><input type="text" class="text" name="${sheetPageName}portABDevicePort"
                   id="${sheetPageName}portABDevicePort" defaultValue="${sheetMain.portABDevicePort}"
                   value="${sheetMain.portABDevicePort}"
    ...
    <tr>
        ...
        <td><input type="text" class="text" name="${sheetPageName}portADetailAdd" id="${sheetPageName}portADetailAdd"
                   defaultValue="${sheetMain.portADetailAdd}" value="${sheetMain.portADetailAdd}"
        ...
        <td>
            <input type="text" class="text" name="${sheetPageName}portZ" id="${sheetPageName}portZ"
                   defaultValue="${sheetMain.portZ}" value="${sheetMain.portZ}"
                   alt="allowBlank:false,maxLength:200,vtext:'${eoms:a2u('请输入端点Z，最大长度为100个汉字！')}'"/>
        </td>
    </tr>
    <tr>
        <td class="label"><bean:message bundle="resourceaffirm" key="resourceaffirm.portZInterfaceType"/>&nbsp;&nbsp;*
        </td>
        <td>
            <eoms:comboBox name="${sheetPageName}portZInterfaceType" id="${sheetPageName}portZInterfaceType"
                           initDicId="1011016" alt="allowBlank:false" defaultValue="${sheetMain.portZInterfaceType}"
                           styleClass="select-class"/>
        </td>
        <td class="label"><bean:message bundle="resourceaffirm" key="resourceaffirm.portZContactPhone"/>&nbsp;&nbsp;*
        </td>
        <td><input type="text" class="text" name="${sheetPageName}portZContactPhone"
                   id="${sheetPageName}portZContactPhone" defaultValue="${sheetMain.portZContactPhone}"
                   value="${sheetMain.portZContactPhone}"
                   alt="allowBlank:false,maxLength:200,vtext:'${eoms:a2u('请输入端点Z联系人及电话，最大长度为100个汉字！')}'"/></td>
    </tr>
    <tr>
        <td class="label"><bean:message bundle="resourceaffirm" key="resourceaffirm.portZBDevicePort"/>&nbsp;&nbsp;*
        </td>
        <td><input type="text" class="text" name="${sheetPageName}portZBDevicePort"
                   id="${sheetPageName}portZBDevicePort" defaultValue="${sheetMain.portZBDevicePort}"
                   value="${sheetMain.portZBDevicePort}"
                   alt="allowBlank:false,maxLength:200,vtext:'${eoms:a2u('请输入端点Z业务设备端口，最大长度为100个汉字！')}'"/></td>
        <td class="label"><bean:message bundle="resourceaffirm" key="resourceaffirm.portZBDeviceName"/>&nbsp;&nbsp;*
        </td>
        <td><input type="text" class="text" name="${sheetPageName}portZBDeviceName"
                   id="${sheetPageName}portZBDeviceName" defaultValue="${sheetMain.portZBDeviceName}"
                   value="${sheetMain.portZBDeviceName}"
    ...
    <tr>
        ...
        <td colspan="3">
            <textarea class="textarea max" name="${sheetPageName}brequirementDesc" id="${sheetPageName}brequirementDesc"
                      ...
                      alt="width:500,allowBlank:false,maxLength:255,vtext:'${eoms:a2u('请输入业务需求描述，最大长度为125个汉字！')}'">${sheetMain.brequirementDesc}</textarea>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td colspan="3">
            <textarea class="textarea max" name="${sheetPageName}applyInfo" id="${sheetPageName}applyInfo"
                      alt="width:500,allowBlank:false,maxLength:255,vtext:'${eoms:a2u('请输入业务需求描述，最大长度为125个汉字！')}'">${sheetMain.applyInfo}</textarea>
        </td>
    </tr>
    <tr>
        <td class="label">
