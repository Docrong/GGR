<%@ page import="java.sql.Connection, java.sql.DriverManager,java.sql.ResultSet,java.sql.SQLException,java.sql.Statement,org.acegisecurity.providers.encoding.Md5PasswordEncoder" %> 
