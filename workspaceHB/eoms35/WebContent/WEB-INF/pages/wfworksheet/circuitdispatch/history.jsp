...
<div id="history" class="panel">
    ...
    <logic:present name="HISTORY" scope="request">
        <logic:iterate id="baselink" name="HISTORY"
                       type="com.boco.eoms.sheet.circuitdispatch.model.CircuitDispatchLink">
            <%
                jNum += 1;
            ...
            <div class="history-item"><!-- add space to hack ie-->&nbsp;
                <div class="history-item-title">
                    ...
                    <eoms:dict key="dict-sheet-circuitdispatch" dictId="activeTemplateId"
                    ...
                    <eoms:dict key="dict-sheet-circuitdispatch" dictId="mainOperateType"
                ...
                <div class="history-item-content hide">
                    ...
                    <table class="history-item-table" width="100%" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td class="column-content" colspan=3>
                                <bean:write name="baselink" property="linkExecuteEndDate" format="yyyy-MM-dd HH:mm:ss"
                                            scope="page"/>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="label"><bean:message bundle="circuitdispatch"
                                                            key="circuitdispatch.linkProjectKey"/>*
                            </td>
                            <td>
                                <bean:write name="baselink" property="linkProgrammeKey" scope="page"/>
                            </td>
                            <td class="label"><bean:message bundle="circuitdispatch"
                                                            key="circuitdispatch.mainResProjectNo"/></td>
                            <td>
                        ...
                        <tr>
                            <!-- 风险评估 -->
                            <td class="label"><bean:message bundle="circuitdispatch"
                                                            key="circuitdispatch.linkRiskEvaluate"/>*
                            </td>
                            <td>
                            ...
                            <!-- 影响业务分析 -->
                            <td class="label"><bean:message bundle="circuitdispatch"
                                                            key="circuitdispatch.linkOperationConstrue"/>*
                            </td>
                            <td>
                        ...
                        <tr>
                            <!-- 技术方案说明 -->
                            <td class="label"><bean:message bundle="circuitdispatch"
                                                            key="circuitdispatch.linkProjectExplain"/>*
                            </td>
                            <td colspan="3">
                        ...
                        <tr>
                            <!-- 技术方案附件 -->
                            <td class="label"><bean:message bundle="circuitdispatch"
                                                            key="circuitdispatch.linkProjectAcc"/></td>
                            <td colspan="3">
                        ...
                        <tr>
                            <!-- 审批结果 -->
                            <td class="label"><bean:message bundle="circuitdispatch"
                                                            key="circuitdispatch.linkPermitResult"/>*
                            </td>
                            <td colspan="3">
                        ...
                        <tr>
                            <!-- 审批意见 -->
                            <td class="label"><bean:message bundle="circuitdispatch"
                                                            key="circuitdispatch.linkPermitIdea"/>*
                            </td>
                            <td colspan="3">
                        ...
                        <tr>
                            <!-- 实施负责人 -->
                            <td class="label"><bean:message bundle="circuitdispatch"
                                                            key="circuitdispatch.linkExcutePrincipal"/>*
                            </td>
                            <td>
                        ...
                        <tr>
                            <!-- 计划开始时间 -->
                            <td class="label"><bean:message bundle="circuitdispatch"
                                                            key="circuitdispatch.linkPlanStartDate"/>*
                            </td>
                            <td>
                                <bean:write name="baselink" property="linkPlanStartDate" format="yyyy-MM-dd HH:mm:ss"
                                            scope="page"/>
                            </td>
                            <!-- 计划结束时间 -->
                            <td class="label"><bean:message bundle="circuitdispatch"
                                                            key="circuitdispatch.linkPlanEndDate"/>*
                            </td>
                            <td>
                                <bean:write name="baselink" property="linkPlanEndDate" format="yyyy-MM-dd HH:mm:ss"
                                            scope="page"/>
                            </td>
                        </tr>
                        <!-- 是否影响业务 -->
                        <td class="label"><bean:message bundle="circuitdispatch"
                                                        key="circuitdispatch.linkIfAffectOperation"/>*
                        </td>
                        <td>
                            <eoms:id2nameDB id="${baselink.linkIfAffectOperation}" beanId="ItawSystemDictTypeDao"/>
                        </td>
                        <!-- 是否通知客服 -->
                        <td class="label"><bean:message bundle="circuitdispatch" key="circuitdispatch.linkIfNotify"/>*
                        </td>
                        <td>
                        ...
                        <tr>
                            <!-- 涉及业务部门 -->
                            <td class="label"><bean:message bundle="circuitdispatch"
                                                            key="circuitdispatch.linkReferOperateDept"/>*
                            </td>
                            <td colspan="3">
                        ...
                        <tr>
                            <!-- 影响网元范围 -->
                            <td class="label"><bean:message bundle="circuitdispatch"
                                                            key="circuitdispatch.linkNetAffectArea"/>*
                            </td>
                            <td colspan="3">
                        ...
                        <tr>
                            <!-- 影响业务情况 -->
                            <td class="label"><bean:message bundle="circuitdispatch"
                                                            key="circuitdispatch.linkAffectSituation"/>*
                            </td>
                            <td colspan="3">
                        ...
                        <tr>
                            <!-- 影响网管情况 -->
                            <td class="label"><bean:message bundle="circuitdispatch"
                                                            key="circuitdispatch.linkAffectNetManage"/>*
                            </td>
                            <td colspan="3">
                        ...
                        <tr>
                            <!-- 实施方案 -->
                            <td class="label"><bean:message bundle="circuitdispatch"
                                                            key="circuitdispatch.linkExecuteAcc"/>*
                            </td>
                            <td colspan="3">
                                <eoms:attachment name="baselink" property="nodeAccessories"
                                                 scope="page" idField="${sheetPageName}nodeAccessories"
                                                 appCode="circuitdispatch" viewFlag="Y"/>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <!-- 实施结果 -->
                            <td class="label"><bean:message bundle="circuitdispatch"
                                                            key="circuitdispatch.linkExcuteResult"/>*
                            </td>
                            <td colspan="3">
			  ...
			  <td>
			  	<eoms:id2nameDB id="${baselink.linkTestResult}" beanId="ItawSystemDictTypeDao" />
                        ...
                        <tr>
                            ...
                            <td>
                                <eoms:id2nameDB id="${baselink.linkIsAccordanceProgramme}"
                                                beanId="ItawSystemDictTypeDao"/>
                            </td>
                            <!-- 失败原因 -->
                            <td class="label"><bean:message bundle="circuitdispatch"
                                                            key="circuitdispatch.linkFailedReason"/>*
                            </td>
                            <td>
                        ...
                        <tr>
                            <!-- 实施情况说明 -->
                            <td class="label"><bean:message bundle="circuitdispatch"
                                                            key="circuitdispatch.linkExcuteExplain"/>*
                            </td>
                            <td colspan="3">
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <pre><bean:write name="baselink" property="linkAffectOperationExplain"
                                                 scope="page"/></pre>
                            </td>
                        </tr>
                        <tr>
                            <!-- 告警情况记录 -->
                            <td class="label"><bean:message bundle="circuitdispatch"
                                                            key="circuitdispatch.linkAlarmRecord"/>*
                            </td>
                            <td colspan="3">
     		...
     		<td colspan="3">
     			<pre><bean:write name="baselink" property="linkReportAbnormityExplain" scope="page"/></pre>
                        ...
                        <tr>
                            <!-- 测试报告 -->
                            <td class="label"><bean:message bundle="circuitdispatch"
                                                            key="circuitdispatch.linkTestReport"/>*
                            </td>
                            <td colspan="3">
                                <eoms:attachment name="baselink" property="nodeAccessories"
                                                 scope="page" idField="${sheetPageName}nodeAccessories"
                        ...
                        <tr>
                            <!-- 是否需要更新作业计划 -->
                            <td class="label"><bean:message bundle="circuitdispatch"
                                                            key="circuitdispatch.linkIfUpdatePlan"/>*
                            </td>
                            <td>
                            ...
                            <!-- 资源库电路数据更新 -->
                            <td class="label"><bean:message bundle="circuitdispatch"
                                                            key="circuitdispatch.linkCircuitUpdate"/>*
                            </td>
                            <td>
                        ...
                        <tr>
                            <!-- 是否涉及工程交维 -->
                            <td class="label"><bean:message bundle="circuitdispatch"
                                                            key="circuitdispatch.linkIsToMaintenance"/>*
                            </td>
                            <td colspan="3">
                        ...
                        <tr>
                            <!-- 执行情况分析 -->
                            <td class="label"><bean:message bundle="circuitdispatch"
                                                            key="circuitdispatch.linkExcuteConstrue"/>*
                            </td>
                            <td colspan="3">
                        ...
                        <tr>
                            <!-- 作业计划更新建议 -->
                            <td class="label"><bean:message bundle="circuitdispatch"
                                                            key="circuitdispatch.linkPlanUpdateIdea"/>*
                            </td>
                            <td colspan="3">
                        ...
                        <tr>
                            <!-- 后续工作安排 -->
                            <td class="label"><bean:message bundle="circuitdispatch"
                                                            key="circuitdispatch.linkWorkPlan"/>*
                            </td>
                            <td colspan="3">
                        ...
                        <tr>
                            <!-- 交维描述 -->
                            <td class="label"><bean:message bundle="circuitdispatch"
                                                            key="circuitdispatch.linkMaintenanceDes"/>*
                            </td>
                            <td colspan="3">
                        ...
                        <tr>
                            <!-- 业务侧资源数据反馈 -->
                            <td class="label"><bean:message bundle="circuitdispatch"
                                                            key="circuitdispatch.linkServiceResData"/>*
                            </td>
                            <td colspan="3">
                                <eoms:attachment name="baselink" property="nodeAccessories"
                                                 scope="page" idField="${sheetPageName}nodeAccessories"
