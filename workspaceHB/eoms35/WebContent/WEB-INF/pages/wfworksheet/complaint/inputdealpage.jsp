...
<table class="formTable">
    ...
    <tr>
        ...
        <td colspan="3">
			        <textarea name="${sheetPageName}linkTransmitReason" class="textarea max"
                              ...
                              alt="width:500,maxLength:1600,vtext:'最多输入800汉字'"
    ...
    <tr>
        ...
        <td class="content" colspan="3">
            ...
            <eoms:comboBox name="issueReasonTypeOne" id="issueReasonTypeOne" sub="issueReasonTypeTwo"
                           initDicId="1010615" onchange="selectTypeOne();" alt="allowBlank:true"/>

            <eoms:comboBox name="issueReasonTypeTwo" id="issueReasonTypeTwo" sub="issueReasonTypeThree"
                           styleClass="border" onchange="selectTypeTwo();" alt="allowBlank:true"/>
            <eoms:comboBox name="issueReasonTypeThree" id="issueReasonTypeThree" sub="issueReasonTypeFour"
                           styleClass="border" onchange="selectTypeThree();" alt="allowBlank:true"/>
    ...
    <tr>
        ...
        <td class="label"><bean:message bundle="complaint" key="complaint.dealDesc"/></td>
        <td colspan="3">
            <textarea name="${sheetPageName}dealDesc" id="${sheetPageName}dealDesc" class="textarea max"
    ...
    <tr>
        ...
        <td colspan="3">
            <select id="selectAiNetReason" name="selectAiNetReason" onchange="selectAiNet();"
    ...
    <input type="hidden" name="${sheetPageName}copyPerformer" id="${sheetPageName}copyPerformer"
           value="${ccsubroleid}"/>
    <input type="hidden" name="${sheetPageName}copyPerformerLeader" id="${sheetPageName}copyPerformerLeader"
           value="${ccsubroleid}"/>
    <input type="hidden" name="${sheetPageName}copyPerformerType" id="${sheetPageName}copyPerformerType"
           value="subrole"/>
    <% } %>
...
<fieldset id="link4">
    ...
    <eoms:chooser id="commonfaultSendRole" type="role" roleId="215" flowId="052"
...
<fieldset id="link4">
    ...
    <eoms:chooser id="commonfaultSendRole" type="role" roleId="214" flowId="052"
                  config="{returnJSON:true,showLeader:true}"
...
<fieldset id="link4">
    ...
    <eoms:chooser id="commonfaultSendRole" type="role" roleId="217" flowId="052"
                  data="[{id:'${zjSubroleid}',nodeType:'subrole',categoryId:'dealPerformer'}]"
                  config="{returnJSON:true,showLeader:true}"
