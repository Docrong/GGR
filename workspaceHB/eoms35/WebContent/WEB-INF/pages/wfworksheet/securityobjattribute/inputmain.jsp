...
<table id="sheet" class="formTable">
    ...
    <tr>
        ...
        <td>
            <input type="text" class="text" name="mainProcessType" id="mainProcessType"
                   alt="allowBlank:true,maxLength:2000,vtext:'请填入 流程类型 信息，最多输入 2000 字符'"
                   value="${sheetMain.mainProcessType}"/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <input type="text" class="text" name="mainOperateId" id="mainOperateId"
                   alt="allowBlank:true,maxLength:2000,vtext:'请填入 操作者账号 信息，最多输入 2000 字符'"
                   value="${sheetMain.mainOperateId}"/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <input type="text" class="text" name="mainObjectId" id="mainObjectId"
                   alt="allowBlank:true,maxLength:2000,vtext:'请填入 变更对象ID 信息，最多输入 2000 字符'"
                   value="${sheetMain.mainObjectId}"/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <input type="text" class="text" name="mainObjectName" id="mainObjectName"
                   alt="allowBlank:true,maxLength:2000,vtext:'请填入 变更对象名称 信息，最多输入 2000 字符'"
                   value="${sheetMain.mainObjectName}"/>
        </td>
        <td class="label">
            <!-- 变更属性中文名称 -->
        ...
        <td>
            <input type="text" class="text" name="mainAttrName" id="mainAttrName"
                   alt="allowBlank:true,maxLength:2000,vtext:'请填入 变更属性中文名称 信息，最多输入 2000 字符'"
                   value="${sheetMain.mainAttrName}"/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <input type="text" class="text" name="mainAttrId" id="mainAttrId"
                   alt="allowBlank:true,maxLength:2000,vtext:'请填入 变更属性字段名称 信息，最多输入 2000 字符'"
                   value="${sheetMain.mainAttrId}"/>
        </td>
        <td class="label">
            <!-- 变更属性之前值 -->
        ...
        <td>
            <input type="text" class="text" name="mainAttrBefore" id="mainAttrBefore"
                   alt="allowBlank:true,maxLength:2000,vtext:'请填入 变更属性之前值 信息，最多输入 2000 字符'"
                   value="${sheetMain.mainAttrBefore}"/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <input type="text" class="text" name="mainAttrAfter" id="mainAttrAfter"
                   alt="allowBlank:true,maxLength:2000,vtext:'请填入 变更属性之后值 信息，最多输入 2000 字符'"
                   value="${sheetMain.mainAttrAfter}"/>
        </td>
        <td class="label">
            <!-- 预留字段1 -->
