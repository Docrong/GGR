...
<div id="sheetform">
    <html:form action="/businessimplementyy.do?method=performCreateSubTask" styleId="theform">
        ...
        <table class="formTable">
            <tr>
		        ...
		        <textarea name="${sheetPageName}remark" class="textarea max" id="${sheetPageName}remark"
                    ...
                    <input type="hidden" name="${sheetPageName}taskNamespace"
                           value="http://BusinessImplementYYProcess"/>
