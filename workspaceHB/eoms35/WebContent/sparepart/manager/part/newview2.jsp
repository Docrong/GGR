    ...
    <form method="post" action="../part/add.do" name="frm" enctype="multipart/form-data">
        ...
        <table border="0" width="80%" cellspacing="1" cellpadding="1" class="table_show" align=center>
            ...
            <tr class="tr_show">
                ...
                <td width="70%" height="25" colspan="2">
                    <input type="text" value="<%=StaticMethod.null2String(sparepartForm.getVersion())%>" name="version"
                ...
                <td width="70%" height="25" colspan="2">
                    ...
                    <select name="company" size="1" style="width: 6.8cm;">
                        ...
                        <logic:iterate id="company" name="company" type="com.boco.eoms.sparepart.model.TawClassMsg">
                            <option value="<bean:write name="company" property="id" scope="page"/>"><bean:write
                                    name="company" property="cname" scope="page"/></option>
                        </logic:iterate>
                    </select>
                </td>
            </tr>
            ...
            <tr class="tr_show">
                ...
                <td width="70%" height="25" colspan="2">
                    <input type="text" size="35" value="<%=StaticMethod.null2String(sparepartForm.getUnits())%>"
                           name="units" maxlength="40">
                </td>
            </tr>
                ...
                <td width="70%" height="25" colspan="2">
                    ...
                    <select name="fixe" size="1" style="width: 6.8cm;">
                        ...
                        <logic:iterate id="fixe" name="fixe" type="com.boco.eoms.sparepart.model.TawClassMsg">
                            <option value="<bean:write name="fixe" property="id" scope="page"/>"><bean:write name="fixe"
                                                                                                             property="cname"
                                                                                                             scope="page"/></option>
                        </logic:iterate>
                    </select>
