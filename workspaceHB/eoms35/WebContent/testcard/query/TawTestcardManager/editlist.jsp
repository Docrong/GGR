        ...
        <logic:iterate id="tawTestcard" name="tawTestcard" type="com.boco.eoms.testcard.model.TawTestcard">
            ...
            <tr bgcolor="#FFFFFF">
                <td nowrap align="center" height="25">
                    <INPUT TYPE="checkbox" name="iccid"
                           value="<bean:write name="tawTestcard" property="iccid" scope="page"/>"></td>
                </td>
                ...
                <td nowrap align="center" height="30"><html:link href="../TawTestcardManager/toedit.do" paramId="iccid"
                                                                 paramName="tawTestcard"
                                                                 paramProperty="iccid"> ${eoms:a2u("修改")}</html:link></td>
                <td nowrap align="center" height="30"><html:link href="../TawTestcard/edittrash.do" paramId="iccid"
                                                                 paramName="tawTestcard"
                                                                 paramProperty="iccid"> ${eoms:a2u("删除")}</html:link></td>
            </tr>
        </logic:iterate>
        <tr>
