    ...
    <form name="listForm">
        ...
        <table border="0" width="100%" cellspacing="1" cellpadding="1" class="table_show" align=center>
            ...
            <logic:iterate id="tawInfCmd" name="TAW_INF_CMD_LIST" type="com.boco.eoms.infmanage.model.TawInfCmd">
                <tr class="tr_show">
                    <td width="20%" height="25" class="clsfth" align="center"><bean:write name="tawInfCmd"
                                                                                          property="cmdSwich"
                                                                                          scope="page"/></td>

                    <td width="10%" height="25" class="clsfth" align="center"><bean:write name="tawInfCmd"
                                                                                          property="cmdId"
                                                                                          scope="page"/></td>

                    <td width="15%" height="25" class="clsfth" align="center"><bean:write name="tawInfCmd"
                                                                                          property="cmdName"
                                                                                          scope="page"/></td>
                    ...
                    <td width="10%" height="25" align="center"><font color="#cc0000"><html:link
                            page="/TawInfCmd/view.do" name="map" scope="page"><img
                            src="<%=request.getContextPath()%>/images/bottom/an_xs.gif" border="0" alt="显示"></html:link>&nbsp;</font>
                    </td>

                    <td width="10%" height="25" align="center"><font color="#cc0000"><html:link
                            page="/TawInfCmd/update.do" name="map" scope="page"><img
                            src="<%=request.getContextPath()%>/images/bottom/an_bj.gif" border="0" alt="编辑"></html:link>&nbsp;</font>
                    </td>

                    <td width="10%" height="25" align="center"><font color="#cc0000"><html:link page="/TawInfCmd/del.do"
                                                                                                name="map" scope="page"><img
