...
public class FMImportExcelFileManagerImpl extends FMImportFileManagerAdpter {
     ...
     * 导入操作,由excel为源读入
     *
     * @param xmlPath  导入所需的xml配置文件,如FMImportSample.xml文件
     * @param filePath excel(pdf,word)文件的路径
     ...
     *
     * @param cls    class
     * @param obj    class实例化对象
     * @param header xml mapping对象( <header/>标签)的对象
     * @param cell   单元格
     ...
     *
     * @param className 类名
     * @param headerIt  xml中配置的header标签的Iterator，其中含每列对应配置
     * @param i         行数
