...
<!--    <td nowrap bgcolor="#E5EDF8" align="center" >
    ...
    <td nowrap bgcolor="#E5EDF8" align="center" height="30"> <html:link href="../TawTestcardManager/view.do" paramId="id" paramName="tawTestcardManager" paramProperty="id"><bean:message key="label.view"/></html:link></td>
