...
<div align="center">
    ...
    <form method="post" action="../part/remove.do" name="frm" onsubmit="checkdata()">
        <html:hidden property="orderType" value="5"/>
        ...
        <table border="0" width="75%" cellspacing="1" cellpadding="1" class="table_show" align=center>
            ...
            <tr class="tr_show">
                ...
                <td width="70%" height="25" colspan="2">
                    <select name="state" size="1" style="width: 4.4cm;">
                        ...
                        <option value="19">${eoms:a2u('调拨')}</option>

                        <option value="16">${eoms:a2u('扩容')}</option>

                        <option value="11">${eoms:a2u('库中可用')}</option>

                        <option value="12">${eoms:a2u('库中待修')}</option>

                        <option value="13">${eoms:a2u('维修出库')}</option>

                        <option value="15">${eoms:a2u('报废')}</option>

                        <option value="14">${eoms:a2u('借出')}</option>
                    </select>
                </td>
            </tr>
            ...
            <tr class="tr_show">
                <td class="clsfth" width="30%" height="25">
                    <p style="margin-top: 0; margin-bottom: 0"><bean:message
                            key="sparepart.serialno"/>${eoms:a2u('：')}</p>
                </td>
                <td width="70%" height="25" colspan="2">
