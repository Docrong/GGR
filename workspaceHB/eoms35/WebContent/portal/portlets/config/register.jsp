    ...
    <form name="form_<%= responseId %>">
        <table border='0' cellpadding='0' cellspacing='0'>
            ...
            <tr>
                ...
                <td class='portlet-table-td-left'>
                    <input type='password' name='plConfirmPassword' value='' class='portlet-form-input-field'
                           size='18'/>
                </td>
            </tr>
            <tr>
        ...
        <table border='0' cellpadding='0' cellspacing='0' width='95%'>
            ...
            <c:forEach var="channel" items="${requestScope.channels}">
                ...
                <td class='portlet-table-td-left'>
                    <input TYPE='checkbox' name='plChannels' checked="yes"
                           value='<c:out value="${channel.value}"/>'><c:out value="${channel.name}"/></input>
                </td>
        ...
        <table border='0' cellpadding='0' cellspacing='0' width='80%'>
            <tr>
                <td class='portlet-table-td-right'>
                    <input name='signup' type='button' value='<fmt:message key="portlet.button.signUp"/>'
                           class='portlet-form-button'
                           onclick="javascript:signUpPortal('<%= responseId %>');"/>
                </td>
                <td class='portlet-table-td-right'>
                    <input name='cancel' type='button' value='<fmt:message key="portlet.button.cancel"/>'
                           class='portlet-form-button'
