	     ...
	     <input type="hidden" name="${sheetPageName}operateType" id="${sheetPageName}operateType" value="<%=operateType %>" />
			      <tr>
		            <td  class="label"><bean:message bundle="businessplan" key="businessplan.linkAnalyse"/>*</td>
		              <td colspan="3"> 	
    				  <textarea class="textarea max" name="${sheetPageName}linkAnalyse" id="${sheetPageName}linkAnalyse" alt="width:500,allowBlank:false,maxLength:1000,vtext:'${eoms:a2u('请填入可行性分析概述，最多输入1000字')}'">${sheetLink.linkAnalyse}</textarea>
                    </td>
		          </tr>
		             <tr>
					    <td class="label">
	                ...
	                <tr>
            	      ...
            	      initDicId="1010502"  alt="allowBlank:false" styleClass="select-class" defaultValue="${sheetLink.linkIsKx}"/>
			        </td>	                
		            </tr>
		  <%}} %>
	          ...
	          if(operateType.equals("92")|| operateType.equals("55")){%>
	            ...
	            <input type="hidden" name="${sheetPageName}operateType" id="${sheetPageName}operateType" value="<%=operateType %>" />
	                <tr>
            	      ...
            	      initDicId="1010503"  alt="allowBlank:false" styleClass="select-class" onchange="ifAuditPass(this.value);" defaultValue="${sheetLink.linkAuditResult}" />
			        </td>	                
		            </tr>
			      <tr>
		            <td  class="label"><bean:message bundle="businessplan" key="businessplan.linkAuditDesc"/>*</td>
		              <td colspan="3"> 	
    				  <textarea class="textarea max" name="${sheetPageName}linkAuditDesc" id="${sheetPageName}linkAuditDesc" alt="width:500,allowBlank:false,maxLength:1000,vtext:'${eoms:a2u('请填入审批意见，最多输入1000字')}'">${sheetLink.linkAuditDesc}</textarea>
                    </td>
		          </tr>
		          <%}} %>
	          ...
	          if(operateType.equals("94")|| operateType.equals("55")){%>
	            ...
	            <input type="hidden" name="${sheetPageName}operateType" id="${sheetPageName}operateType" value="<%=operateType %>" />
	                <tr>
		                ...
		                <td colspan="3">  
				        <eoms:comboBox name="${sheetPageName}linkAuditResult" id="${sheetPageName}linkAuditResult" 
            	      initDicId="1010503"  alt="allowBlank:false" styleClass="select-class" onchange="ifAuditPass1(this.value);" defaultValue="${sheetLink.linkAuditResult}" />
			        </td>	                
		            </tr>
			      <tr>
		            <td  class="label"><bean:message bundle="businessplan" key="businessplan.linkAuditDesc"/>*</td>
	            ...
	            <input type="hidden" name="${sheetPageName}operateType" id="${sheetPageName}operateType" value="<%=operateType %>" />      
			      <tr>
		            <td  class="label"><bean:message bundle="businessplan" key="businessplan.linkOpion"/>*</td>
		              <td colspan="3"> 	
    				  <textarea class="textarea max" name="${sheetPageName}linkOpion" id="${sheetPageName}linkOpion" alt="width:500,allowBlank:false,maxLength:1000,vtext:'${eoms:a2u('请填入技术规范评审意见，最多输入1000字')}'">${sheetLink.linkOpion}</textarea>
                    </td>
		          </tr>
		             <tr>
					    <td class="label">
	                ...
	                <tr>
  						<td class="label"><bean:message bundle="businessplan" key="businessplan.linkOpionReport"/>*</td>
		   				 ...
		   				 <eoms:attachment name="sheetLink"   idList="" property="linkOpionReport"   scope="request"  idField="${sheetPageName}linkOpionReport" appCode="businessplan" alt="allowBlank:false"/>
		                </td>
		            </tr>
		...
		<%} %>
         ...
         <%if(taskName.equals("hold")) {%>  
		  ...
		  <tr>
		    ...
		    <td colspan="3">
		      <textarea name="${sheetPageName}endResult" alt="allowBlank:true,maxLength:1000,vtext:'${eoms:a2u('归档意见最多输入1000字')}'" id="${sheetPageName}endResult"  class="textarea max">${sheetMain.endResult}</textarea>
		    </td>
		  </tr>					       			     	
     	    <%} }%>
