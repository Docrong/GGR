...
<div id="sheetform">
<html:form action="/localCommonTask.do?method=performDealReplyReject" styleId="theform">
 <%@ include file="/common/taglibs.jsp"%>
<%
 ...
 %>
    ...
    <input type="hidden" name="${sheetPageName}linkClassName" value="com.boco.eoms.sheet.localCommonTask.model.LocalCommonTaskLink"/> <!--link表Model对象类名--> 
 	<input type="hidden" name="${sheetPageName}processTemplateName" id="${sheetPageName}processTemplateName" value="LocalCommonTaskProcess" />
    <input type="hidden" name="${sheetPageName}subtaskName" value="${subtaskName}"/> 
    <input type="hidden" name="${sheetPageName}taskNamespace" value="http://LocalCommonTaskProcess"/> 
...
<%@ include file="/WEB-INF/pages/wfworksheet/localCommonTask/baseinputlinkhtmlnew.jsp"%>
     ...
     <tr>
      ...
      <logic:iterate id="toTask" name="acceptList" type="com.boco.eoms.sheet.localCommonTask.model.LocalCommonTaskTask">  
        <tr>
          <td>
