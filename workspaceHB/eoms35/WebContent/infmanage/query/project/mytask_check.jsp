    ...
    <form name="form1">
        ...
        <table border="0" width="100%" cellspacing="1" cellpadding="1" class="table_show" align=center>
            ...
            <tr class="tr_show">
                ...
                <td width="15%" height="25" class="clsfth" align="center">
                    <center><font color="#cc0000">相应操作</font></center>
                </td>
            ...
            <logic:iterate id="project" name="Project_TaskList" type="com.boco.eoms.infmanage.model.Project">
                ...
                <bean:define id="task_executor_name" name="project" property="task_executor_name"
                ...
                <bean:define id="project_send_user" name="project" property="project_send_user"
                             type="java.lang.String"/>
                <bean:define id="check_project_group" name="project" property="check_project_group"
                             type="java.lang.String"/>
