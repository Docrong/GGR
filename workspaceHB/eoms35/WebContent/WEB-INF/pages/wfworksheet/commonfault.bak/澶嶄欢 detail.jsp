        ...
        <logic:present name="sheetMain" scope="request">
            ...
            <table class="formTable">
                ...
                <tr>
                    ...
                    <td class="content"><bean:write name="sheetMain" property="mainEquipmentType" scope="request"/></td>
            ...
            <tr>
                ...
                %>
                    ...
                    <select id="dealSelector"
                        ...
                        <c:if test="${sheetMain.mainFaultResponseLevel == '101030401'}">
                            <%if (ifInvokeUrgentFault.equals("no")) { %>
                            <option value="${urlShowInvokeUrgentFaultDealPage}"><bean:message bundle="commonfault"
                                                                                              key="operateType.InvokeUrgentFault"/></option>
                            <%} %>
                        </c:if>
                        <option value="${urlShowInputSplit}">
                            <bean:message bundle="sheet" key="common.split"/>
                                <% }else{%>
                        <option value="${urlShowInputSplit}">
                            <bean:message bundle="sheet" key="common.split"/>
                                <%} %>
...
<c:if test="${sheetMain.status==1 && sheetMain.mainIfCheck =='0' }">
    ...
    <div id="advice" style="display:block">
        <input type="button" value="${eoms:a2u('质检')}" onclick="$('advice').style.display='none';eventOperation(2);">
    </div>
</c:if>
