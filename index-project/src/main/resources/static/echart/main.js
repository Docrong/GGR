...
//        },
        ...
        series: [{
            name: '树图',
            type: 'tree',
            orient: 'horizontal', //树形图方向 vertical horizontal
...
function adjustTreeView(data) {
	...
	var treeWidth = (meterBoxNum - 1) * treeNodePadding + meterBoxNum * meterBoxSymbolSize; //假设上一层每个节点都有子节点，否则这样算会有问题，总之能计算树的总宽度就ok
