            ...
            <td>
                <table width='100%' id='inputinfo' border=0 cellspacing=1 cellpadding=0>
                    <TR bgcolor=#eeeeee align=center>
                        <TD align=center colspan=6><font size=2>实体表中文名称：</font><input type=text name=tablename
                                                                                      value='表名称'><font
                                color=red>*</font></TD>
                        <TD align=center colspan=6><font size=2>实体表英文名称：</font><input type=text name=tablecode><font
                                color=red>*</font></TD>
                    </TR>
                    <TR bgcolor=#eeeeee align=center>
                        ...
                        <TD><select name='cc_null' disabled>
                            <option value=1 selected>不为空</option>
                        </select></TD>
                        <TD><select name='cc_dis' disabled>
                            <option value=1 selected>显示列</option>
                            <option value=1>不显示列</option></TD>
