...
<fmt:bundle basename="config/applicationResource-businessupport">
    ...
    <display:table name="businessupportList" cellspacing="0" cellpadding="0"
        ...
        <display:column property="orderSheetId" sortable="true"
                        headerClass="sortable" titleKey="businessupport.orderSheetId"
                        href="${app}/businessupport/businessupports.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="portEngineRoomName" sortable="true"
                        headerClass="sortable" titleKey="businessupport.portEngineRoomName"
                        href="${app}/businessupport/businessupports.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="portInterfaceType" sortable="true"
                        headerClass="sortable" titleKey="businessupport.portInterfaceType"
                        href="${app}/businessupport/businessupports.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="portDeviceName" sortable="true"
                        headerClass="sortable" titleKey="businessupport.portDeviceName"
                        href="${app}/businessupport/businessupports.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="portCustAidPerson" sortable="true"
                        headerClass="sortable" titleKey="businessupport.portCustAidPerson"
                        href="${app}/businessupport/businessupports.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="portACustAidPhone" sortable="true"
                        headerClass="sortable" titleKey="businessupport.portACustAidPhone"
                        href="${app}/businessupport/businessupports.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="portDetailAdd" sortable="true"
                        headerClass="sortable" titleKey="businessupport.portDetailAdd"
                        href="${app}/businessupport/businessupports.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="sevPointContact" sortable="true"
                        headerClass="sortable" titleKey="businessupport.sevPointContact"
                        href="${app}/businessupport/businessupports.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="sevPointContactPhone" sortable="true"
                        headerClass="sortable" titleKey="businessupport.sevPointContactPhone"
                        href="${app}/businessupport/businessupports.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="sevPointContactEmail" sortable="true"
                        headerClass="sortable" titleKey="businessupport.sevPointContactEmail"
                        href="${app}/businessupport/businessupports.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="sevPointContactAdd" sortable="true"
                        headerClass="sortable" titleKey="businessupport.sevPointContactAdd"
                        href="${app}/businessupport/businessupports.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="fiberEquipName" sortable="true"
                        headerClass="sortable" titleKey="businessupport.fiberEquipName"
                        href="${app}/businessupport/businessupports.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="fiberEquipCode" sortable="true"
                        headerClass="sortable" titleKey="businessupport.fiberEquipCode"
                        href="${app}/businessupport/businessupports.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="siteEquipCode" sortable="true"
                        headerClass="sortable" titleKey="businessupport.siteEquipCode"
                        href="${app}/businessupport/businessupports.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="siteName" sortable="true"
                        headerClass="sortable" titleKey="businessupport.siteName"
                        href="${app}/businessupport/businessupports.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="accessSiteIden" sortable="true"
                        headerClass="sortable" titleKey="businessupport.accessSiteIden"
                        href="${app}/businessupport/businessupports.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="remark" sortable="true"
                        headerClass="sortable" titleKey="businessupport.remark"
                        href="${app}/businessupport/businessupports.do?method=edit" paramId="id" paramProperty="id"/>
