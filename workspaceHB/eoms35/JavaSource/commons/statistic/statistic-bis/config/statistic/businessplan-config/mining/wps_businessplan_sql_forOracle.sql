...
--common task
                                      ...
                                      PARENTTASKID,
                                      taskstatus,
                                      taskoperatetype, MAINPRODUCTTYPE, MAINPRODUCTNAME, MAINPRODUCTCODE, MAINREQTYPE,
                                      MAINSTANDARD, mainifrecord, SENDYEAR, SENDMONTH, SENDDAY
--link 
    , LINKAUDITPER, LINKREPORT, LINKISKX, LINKAUDITRESULT, LINKOPIONREPORT, operateyear, operatemonth, operateday
    ) as
    (
--已处理
        select
...
values (21, to_date('2007-07-07 00:00:00', 'YYYY-MM-DD HH24:MI:SS'), '新业务设计工单基础表采集的上一次操作的时间');
...
delete
from est_businessplan
select *
from est_businessplan drop table est_businessplan
--中间表
