    ...
    <head>
        ...
        <meta http-equiv="content-type" content="text/html; charset=utf-8">
            ...
            <script type="text/javascript">
                ...
                * Copyright (C) 2003-2008 Stefan Strigler
                <steve
                @zeank.in-berlin.de>
                *
                ...
                */
                ...
                case '401':
                alert("Autorizaci&oacute; fallida");
                if (!con.connected())
                window.close();
                break;
                case '409':
...
// 		changeStatus(onlstat,onlmsg);
    ...
    <body>
        Tu navegador debe soportar frames y JavaScript para usar esta aplicaci&oacute;n. Por favor revise nuestro
        <a href="help.html">manual en l&iacute;nea</a>
        para una lista de navegadores soportados.
    </body>
</html>
