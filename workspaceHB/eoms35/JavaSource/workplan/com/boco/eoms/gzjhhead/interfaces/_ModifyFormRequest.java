...
public class _ModifyFormRequest  implements java.io.Serializable {
    ...
    private com.boco.eoms.gzjhhead.interfaces.NeListType relatedNEList;
    private com.boco.eoms.gzjhhead.interfaces.ModifyTypeType modifyType;
    private com.boco.eoms.gzjhhead.interfaces.NoteType noteModifyForm;
    ...
    public com.boco.eoms.gzjhhead.interfaces.NeListType getRelatedNEList() {
        return relatedNEList;
    }

    public void setRelatedNEList(com.boco.eoms.gzjhhead.interfaces.NeListType relatedNEList) {
        this.relatedNEList = relatedNEList;
    }

    public com.boco.eoms.gzjhhead.interfaces.ModifyTypeType getModifyType() {
        return modifyType;
    }

    public void setModifyType(com.boco.eoms.gzjhhead.interfaces.ModifyTypeType modifyType) {
        this.modifyType = modifyType;
    }

    public com.boco.eoms.gzjhhead.interfaces.NoteType getNoteModifyForm() {
        return noteModifyForm;
    }

    public void setNoteModifyForm(com.boco.eoms.gzjhhead.interfaces.NoteType noteModifyForm) {
