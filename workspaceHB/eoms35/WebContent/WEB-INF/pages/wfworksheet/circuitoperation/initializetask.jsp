...
<html:form action="/circuitoperation.do?method=newTaskPerformAdd" styleId="theform" target="myname">
    ...
    <table class="formTable">
        <tr>
            <td class="label"><bean:message bundle="circuitoperation" key="circuitoperation.linkUrgency"/>*</td>
        ...
        <tr>
            <td class="label"><bean:message bundle="circuitoperation" key="circuitoperation.linkReqCompleteTime"/>*</td>
            <td class="content">
            ...
            <td class="label"><bean:message bundle="circuitoperation" key="circuitoperation.linkAcceptDept"/>*</td>
            <td class="content">
        ...
        <tr>
            <td class="label"><bean:message bundle="circuitoperation" key="circuitoperation.linkSendSheetDesc"/>*</td>
            <td colspan="3">
