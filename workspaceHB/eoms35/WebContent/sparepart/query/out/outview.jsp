    ...
    <center>
        ...
        <table border="0" width="95%" cellspacing="1" cellpadding="1" class="table_show" align="center">
            ...
            <tr class="td_label" align="center">
                ...
                <td><bean:message key="sparepart.out"/></td>
                <td><bean:message key="sparepart.outpercent"/></td>
            </tr>
            <logic:iterate id="sparepart" name="sparepart" type="com.boco.eoms.sparepart.model.TawPart">
                <tr class="tr_show" align="center">
                    ...
                    <td><bean:write name="sparepart" property="outSum" scope="page"/></td>
                    <td><bean:write name="sparepart" property="outPercent" scope="page"/></td>
                </tr>
            </logic:iterate>
        </table>
        <br>
