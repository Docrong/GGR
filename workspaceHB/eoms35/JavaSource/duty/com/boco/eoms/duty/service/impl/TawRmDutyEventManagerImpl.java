    ...
    public TawRmDutyEventRegion getEventRegionData(String jksWorkserial, String workserial, String region, String roomid) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            switch (Integer.parseInt(o[0].toString())) {
                case 1:
                    tawRmDutyEventRegion.setStar1(Integer.parseInt(o[1].toString()));
                    break;
                case 2:
                    tawRmDutyEventRegion.setStar2(Integer.parseInt(o[1].toString()));
                    break;
                case 3:
                    tawRmDutyEventRegion.setStar3(Integer.parseInt(o[1].toString()));
                    break;
                case 4:
                    tawRmDutyEventRegion.setStar4(Integer.parseInt(o[1].toString()));
                    break;
            }
        }
    ...
    public TawRmDutyEventRegion parseEventList(List list) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            switch (StaticMethod.nullObject2int(event.getFlag())) {
                case 1:
                    tawRmDutyEventRegion.setStar1(tawRmDutyEventRegion.getStar1() + 1);
                    break;
                case 2:
                    tawRmDutyEventRegion.setStar2(tawRmDutyEventRegion.getStar2() + 1);
                    break;
                case 3:
                    tawRmDutyEventRegion.setStar3(tawRmDutyEventRegion.getStar3() + 1);
                    break;
                case 4:
                    tawRmDutyEventRegion.setStar4(tawRmDutyEventRegion.getStar4() + 1);
                    break;
            }
