        ...
        <logic:iterate id="baselink" name="HISTORY" type="com.boco.eoms.sheet.softwareLoad.model.SoftwareLoadLink">
            ...
            <div class="history-item"><!-- add space to hack ie-->&nbsp;
                <div class="history-item-title">
                    ...
                    <eoms:dict key="dict-sheet-softwareLoad" dictId="mainOperateType" itemId="${baselink.operateType}"
                ...
                <div class="history-item-content hide">
  			      ...
  			      <%} %> -->
                        ...
                        <tr>
                            ...
                            <td class="column-content">
                                <eoms:dict key="dict-sheet-softwareLoad" dictId="mainOperateType"
                        ...
                        <tr>
                            <td class="label"><bean:message bundle="softwareLoad"
                                                            key="softwareLoad.linkTaskComplete"/></td>
                            <td class="column-content" colspan="3">
