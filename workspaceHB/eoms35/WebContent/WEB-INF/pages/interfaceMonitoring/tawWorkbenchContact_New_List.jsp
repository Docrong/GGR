        ...
        ctxMenu: [
            {
                ...
                text: '${eoms:a2u('新建接口组')}',
                cls: 'new-mi',
                url: '<c:url value="/interfaceMonitoring/interfaceMonitoringLog.do?method=saveToPage&nodeid=" />',
                rootCanShow: true
            },
            {
                id: 'Edit',
                text: '${eoms:a2u('修改分组')}',
                cls: 'edit-mi',
                url: '<c:url value="/interfaceMonitoring/interfaceMonitoringLog.do?method=xgetInterfaceConfigurationGroup&nodeid=" />'
            },
            {
                id: 'Childs',
                text: '${eoms:a2u('新增接口')}',
                cls: 'new-mi',
                url: '<c:url value="/interfaceMonitoring/interfaceMonitoringLog.do?method=savePage&nodeid=" />',
                rootCanShow: true
            },
            {
                id: 'Edits',
                text: '${eoms:a2u('修改接口')}',
                cls: 'edit-mi',
                url: '<c:url value="/interfaceMonitoring/interfaceMonitoringLog.do?method=xget&nodeid=" />'
            },
            {
                id: 'Lists',
                text: '${eoms:a2u('接口详细')}',
                cls: 'list-mi',
                url: '<c:url value="/interfaceMonitoring/interfaceMonitoringLog.do?method=xlist&nodeid=" />'
            },
            {
                id: 'Delete',
                isDelete: true,
                text: '${eoms:a2u('删除')}',
                cls: 'remove-mi',
                url: '<c:url value="/interfaceMonitoring/interfaceMonitoringLog.do?method=xdelete&nodeid=" />'
            }
        ],//end of ctxMenu
        /************************
