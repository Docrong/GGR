...
--NetData-START--
drop table netdata_main;
create table netdata_main(
    id                   VARCHAR(32),
    sheetid              VARCHAR(50) ,
	title                VARCHAR(100) ,
...
drop table netdata_link;
create table netdata_link(
    id                   VARCHAR(32),
    mainid               VARCHAR(50) ,
    ...
    linkPlanStartTime           DATE(32),

    linkPlanEndTime           DATE(32),
...
insert into taw_system_application(app_name,notes,domain_type) values('网络数据管理流程','网络数据管理流程',1);
insert into taw_system_workflow(name,flowid,sheetid,remark,mainservicebeanid) values('NetDataProcess','16','01','网络数据管理流程','iNetDataMainManager');
