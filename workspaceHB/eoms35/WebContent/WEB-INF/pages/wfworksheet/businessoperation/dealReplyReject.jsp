...
<div id="sheetform">
<html:form action="/businessoperation.do?method=performDealReplyReject" styleId="theform">
 <%@ include file="/common/taglibs.jsp"%>
<%
 ...
 %>
    ...
    <input type="hidden" name="${sheetPageName}taskNamespace" value="http://BusinessOperationProcess"/>  
<%@ include file="/WEB-INF/pages/wfworksheet/businessoperation/baseinputlinkhtmlnew.jsp"%>
     ...
     <tr>
      ...
      <logic:iterate id="toTask" name="acceptList" type="com.boco.eoms.sheet.businessoperation.model.BusinessOperationTask">  
        <tr>
          <td>
	       ...
	       <td class="label">
			...
			<td colspan="3"> 
		           <textarea name="${sheetPageName}remark" class="textarea max" id="${sheetPageName}remark" 
		              alt="allowBlank:true,width:500,vtext:'${eoms:a2u('请填入信息，最多输入1000字')}'" alt="width:'500px'">${sheetlink.remark}</textarea>
		  </td>
		</tr>
		</table>
