...
<table class="formTable">
	...
	<tr>
		...
		<td class="content">
			<input type="text"  class="text" name="netName" id="netName"  alt="allowBlank:falsevtext:'请填入 网元名称 '" value="${numberApplyMscid.netName}"/>
		</td>
	</tr>
	<tr>
		<td class="label">网元代号*</td>
		<td class="content">
			<input type="text"  class="text" name="netId" id="netId"  alt="allowBlank:false,vtext:'请填入 网元代号'" value="${numberApplyMscid.netId}"/>
		</td>
		<td class="label">网元属性*</td>
		<td class="content">
			<input type="text"  class="text" name="netProp" id="netProp"  alt="allowBlank:false,vtext:'请填入 网元属性'" value="${numberApplyMscid.netProp}"/>
		</td>
	</tr>
	<tr>
		...
		<td class="content">
			<input type="text"  class="text" name="buildAddress" id="buildAddress"  alt="allowBlank:false,vtext:'请填入 建设地点'" value="${numberApplyMscid.buildAddress}"/>
		</td>
	</tr>
	<tr>
		...
		<td class="content">
			<input type="text"  class="text" name="equipmentArc" id="equipmentArc"   value="${numberApplyMscid.equipmentArc}"/>
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="content">
			<input type="text"  class="text" name="hardwareFlatRoof" id="hardwareFlatRoof"   value="${numberApplyMscid.hardwareFlatRoof}"/>
		</td>
	</tr>
	<tr>
		<td class="label">软件版本</td>
		<td class="content">
			<input type="text"  class="text" name="softwareVersion" id="softwareVersion"  value="${numberApplyMscid.softwareVersion}"/>
		</td>
		<td class="label">容量（万）</td>
		<td class="content">
			<input type="text"  class="text" name="capability" id="capability"   value="${numberApplyMscid.capability}"/>
		</td>
	</tr>
	<tr>
		<td class="label">信令链路数（2MB）</td>
		<td class="content">
			<input type="text"  class="text" name="commondLink" id="commondLink"  value="${numberApplyMscid.commondLink}"/>
		</td>
	...
	<tr>
		...
		<td class="content">
			<input type="text"  class="text" name="iptotalNum" id="iptotalNum"  value="${numberApplyMscid.iptotalNum}"/>
		</td>
	...
	<tr>
		...
		<td class="content">
			<input type="text"  class="text" name="maxSourceNum" id="maxSourceNum"  value="${numberApplyMscid.maxSourceNum}"/>
		</td>
		<td class="label">最大目的信令点数量</td>
		<td class="content">
			<input type="text"  class="text" name="maxTargetNum" id="maxTargetNum"   value="${numberApplyMscid.maxTargetNum}"/>
		</td>
	</tr>
	<tr>
		...
		<td class="content">
			<input type="text"  class="text" name="areaNumber" id="areaNumber"   value="${numberApplyMscid.areaNumber}"/>
		</td>
	</tr>
	<tr>
		...
		<td class="content">
			<input type="text"  class="text" name="coverAreaRange" id="coverAreaRange"   value="${numberApplyMscid.coverAreaRange}"/>
		</td>
	</tr>
	<tr>
		...
		<td class="content">
			<input type="text"  class="text" name="deviceName" id="deviceName"   value="${numberApplyMscid.deviceName}"/>
		</td>
	</tr>
	<tr>
		<td class="label">归属区域</td>
		<td class="content">
			<input type="text"  class="text" name="attachArea" id="attachArea"   value="${numberApplyMscid.attachArea}"/>
		</td>
		<td class="label">批复文件号</td>
		<td class="content">
			<input type="text"  class="text" name="fileNumber" id="fileNumber"  value="${numberApplyMscid.fileNumber}"/>
		</td>
	</tr>
</table>
<script type="text/javascript">
