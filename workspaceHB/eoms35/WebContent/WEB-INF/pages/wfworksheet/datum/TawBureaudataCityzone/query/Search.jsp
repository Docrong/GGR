...
<div align="center">
    <table border="0" width="95%" cellspacing="0" style="margin-bottom:10px;">
        <tr>
            <td width="100%" class="table_title" align="center"><b>&nbsp;&nbsp;地市区号对应<bean:message
                    key="label.list"/></b></td>
        </tr>
    </table>
    <table border="0" width="80%" cellspacing="1" cellpadding="1" class="table_show" align=center>
        ...
        <logic:iterate id="VO" name="AllCityzone" type="com.boco.eoms.datum.vo.impl.TawBureaudataCityzoneVO">
            <tr class="tr_show">
                ...
                %>
                <td align="center"><html:link page="/TawBureaudataCityzone/view.do" name="map" scope="page"><img
                        src="<%=request.getContextPath()%>/images/bottom/an_xs.gif" border="0"
                        alt="<bean:message key="label.view"/>"></html:link></td>
                <td align="center"><html:link page="/TawBureaudataCityzone/edit.do" name="map" scope="page"><img
