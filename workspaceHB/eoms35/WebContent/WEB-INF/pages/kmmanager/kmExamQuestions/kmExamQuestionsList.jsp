...
<fmt:bundle basename="com/boco/eoms/km/config/applicationResource-kmmanager">
    ...
    <html:form action="/kmExamQuestionss.do?method=searchX" styleId="kmExamQuestionsForm" method="post">
        ...
        <td>
        <input type="text" id="specialtyName" name="specialtyName" class="text" readonly="readonly" value='<eoms:id2nameDB
            id="${kmExamQuestionsForm.specialtyID}" beanId="kmExamSpecialtyDao"/>' alt="allowBlank:false'"/>
        ...
        <td>
        <input type="text" id="deptName" name="deptName" class="text" readonly="readonly" value='<eoms:id2nameDB
            id="${kmExamQuestionsForm.deptId}" beanId="tawSystemDeptDao"/>' alt="allowBlank:false'"/>
    ...
    <display:table name="kmExamQuestionsList1" cellspacing="0" cellpadding="0"
        ...
        <display:column sortable="true" headerClass="sortable" titleKey="kmExamQuestions.difficulty">
            <eoms:dict key="dict-kmmanager" dictId="difficulty" itemId="${kmExamQuestionsList1.difficulty}"
                       beanId="id2nameXML"/>
        </display:column>
    ...
    <display:table name="kmExamQuestionsList2" cellspacing="0" cellpadding="0"
        ...
        <display:column sortable="true" headerClass="sortable" titleKey="kmExamQuestions.difficulty">
            <eoms:dict key="dict-kmmanager" dictId="difficulty" itemId="${kmExamQuestionsList2.difficulty}"
                       beanId="id2nameXML"/>
        </display:column>
    ...
    <display:table name="kmExamQuestionsList3" cellspacing="0" cellpadding="0"
        ...
        <display:column sortable="true" headerClass="sortable" titleKey="kmExamQuestions.difficulty">
            <eoms:dict key="dict-kmmanager" dictId="difficulty" itemId="${kmExamQuestionsList3.difficulty}"
                       beanId="id2nameXML"/>
        </display:column>
    ...
    <display:table name="kmExamQuestionsList4" cellspacing="0" cellpadding="0"
        ...
        <display:column sortable="true" headerClass="sortable" titleKey="kmExamQuestions.difficulty">
            <eoms:dict key="dict-kmmanager" dictId="difficulty" itemId="${kmExamQuestionsList4.difficulty}"
                       beanId="id2nameXML"/>
        </display:column>
    ...
    <display:table name="kmExamQuestionsList5" cellspacing="0" cellpadding="0"
        ...
        <display:column sortable="true" headerClass="sortable" titleKey="kmExamQuestions.difficulty">
            <eoms:dict key="dict-kmmanager" dictId="difficulty" itemId="${kmExamQuestionsList5.difficulty}"
                       beanId="id2nameXML"/>
        </display:column>
