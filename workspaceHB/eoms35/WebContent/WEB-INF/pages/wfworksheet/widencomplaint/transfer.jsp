...
<div id="sheetform">
<html:form action="/widencomplaint.do?method=performTransferWorkItem" styleId="theform">
    ...
    <br/>
           ...
           <input type="hidden" name="mainClassName" id="mainClassName"  value="com.boco.eoms.sheet.widencomplaint.model.WidenComplaintMain"/>		
           <input type="hidden" name="linkClassName" id="linkClassName" value="com.boco.eoms.sheet.widencomplaint.model.WidenComplaintLink"/> 
   ...
   <div class="form-btns">
        ...
        <input type="submit" class="submit" onclick="v.passing=true;this.form.action='${app}/sheet/widencomplaint/widencomplaint.do?method=performSaveInfo'" value="<bean:message bundle='sheet' key='button.save'/>" />
