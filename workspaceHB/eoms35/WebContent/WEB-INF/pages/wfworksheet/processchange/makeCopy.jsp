...
<html:form action="/processchange.do?method=newPerformNonFlow" styleId="theform">
    ...
    <br/>
	      <input type="hidden" name="${sheetPageName}processTemplateName" id="${sheetPageName}processTemplateName" value="ProcessChangeProcess" />
           ...
           <input type="hidden" name="${sheetPageName}mainClassName" id="${sheetPageName}mainClassName"  value="com.boco.eoms.sheet.processchange.model.ProcessChangeMain"/>		
           <input type="hidden" name="${sheetPageName}linkClassName" id="${sheetPageName}linkClassName" value="com.boco.eoms.sheet.processchange.model.ProcessChangeLink"/> 
