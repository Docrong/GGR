...
<html:form action="/smsContentTemplates.do?method=forward2New" method="post" styleId="smsContentTemplateForm"> 
	<table class="formTable">
		...
		<logic:iterate id="contentList" name="contentList">
			<tr ondblclick="setFormValue('<bean:write name="contentList" property="content"/>#<bean:write name="contentList" property="remark" />');"  title="双击鼠标即可选择" onMouseOver="this.className='tr-over'" onMouseOut="this.className=''">
				<td>
