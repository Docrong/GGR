...
<table id="sheet" class="formTable" >
		...
		<tr><td class="label">
			...
			<td>
				<input type="text"  class="text" name="applyNum" id="applyNum"  alt="allowBlank:false,maxLength:1000,vtext:'请填入 申请单号 信息，最多输入 1000 字符'" value="${sheetMain.applyNum}"/>
			</td>
 <td class="label">
				<!-- 业务类型 -->
		...
		<tr><td>
				<input type="text"  class="text" name="proportionCircuitName"  alt="allowBlank:false,maxLength:4000,vtext:'请填入 电路名称 信息，最多输入 4000 字符'" />
			</td>
			<td>
				<input type="text"  class="text" name="proportionStartName"  alt="allowBlank:false,maxLength:4000,vtext:'请填入 起点站名 信息，最多输入 4000 字符'" />
			</td>
			<td>
				<input type="text"  class="text" name="proportionEndName"  alt="allowBlank:false,maxLength:4000,vtext:'请填入 终点站名 信息，最多输入 4000 字符'" />
			</td>
			<td>
				<input type="text"  class="text" name="proportionRemarkRate"  alt="allowBlank:false,maxLength:4000,vtext:'请填入 备注(速率) 信息，最多输入 4000 字符'" />
			</td>
		</tr>
		...
		<tr><td class="label">
			...
			<td colspan="3">
				<textarea name="remark" id="remark" class="textarea max"  alt="allowBlank:false,width:500,maxLength:1000,vtext:'最多输入4000汉字'" alt="width:'500px'">${sheetMain.remark}</textarea>
			</td>
		</tr>
