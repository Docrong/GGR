...
<table class="formTable">
    ...
    <input type="hidden" name="mainClassName"
           value="com.boco.eoms.sheet.maintenanceservice.model.MaintenanceServiceMain"/>
    <input type="hidden" name="linkClassName"
           value="com.boco.eoms.sheet.maintenanceservice.model.MaintenanceServiceLink"/>
    ...
    <tr>
        ...
        <td>
            <input type="text" class="text" name="linkExplain" id="linkExplain"
                   alt="allowBlank:false,maxLength:2000,vtext:'请填入 说明 信息，最多输入 2000 字符'"
                   value="${sheetLink.linkExplain}"/>
        </td>
        ...
        <td>
            <input type="text" class="text" name="linkDescribe" id="linkDescribe"
                   alt="allowBlank:false,maxLength:2000,vtext:'请填入 描述 信息，最多输入 2000 字符'"
                   value="${sheetLink.linkDescribe}"/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <input type="text" class="text" name="linkFilingReason" id="linkFilingReason"
                   alt="allowBlank:false,maxLength:2000,vtext:'请填入 强制归档原因 信息，最多输入 2000 字符'"
                   value="${sheetLink.linkFilingReason}"/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <input type="text" class="text" name="linkType" id="linkType"
                   alt="allowBlank:false,maxLength:2000,vtext:'请填入 种类 信息，最多输入 2000 字符'" value="${sheetLink.linkType}"/>
        </td>
        ...
        <td>
            <input type="text" class="text" name="linkSerialNumber" id="linkSerialNumber"
                   alt="allowBlank:false,maxLength:2000,vtext:'请填入 序号 信息，最多输入 2000 字符'"
                   value="${sheetLink.linkSerialNumber}"/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <input type="text" class="text" name="linkDeviceName" id="linkDeviceName"
                   alt="allowBlank:false,maxLength:2000,vtext:'请填入 设备名称 信息，最多输入 2000 字符'"
                   value="${sheetLink.linkDeviceName}"/>
        </td>
        ...
        <td>
            <input type="text" class="text" name="linkManufacturers" id="linkManufacturers"
                   alt="allowBlank:false,maxLength:2000,vtext:'请填入 设备厂家 信息，最多输入 2000 字符'"
                   value="${sheetLink.linkManufacturers}"/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <input type="text" class="text" name="linkSystemName" id="linkSystemName"
                   alt="allowBlank:false,maxLength:2000,vtext:'请填入 系统名称 信息，最多输入 2000 字符'"
                   value="${sheetLink.linkSystemName}"/>
        </td>
    ...
    <tr>
        ...
        <td>
            <input type="text" class="text" name="linkDeviceNumber" id="linkDeviceNumber"
                   alt="allowBlank:false,maxLength:2000,vtext:'请填入 设备序列号 信息，最多输入 2000 字符'"
                   value="${sheetLink.linkDeviceNumber}"/>
        </td>
        ...
        <td>
            <input type="text" class="text" name="linkAccessTime" id="linkAccessTime"
                   alt="allowBlank:false,maxLength:2000,vtext:'请填入 入网时间 信息，最多输入 2000 字符'"
                   value="${sheetLink.linkAccessTime}"/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <input type="text" class="text" name="linkOutDate" id="linkOutDate"
                   alt="allowBlank:false,maxLength:2000,vtext:'请填入 出保日期 信息，最多输入 2000 字符'"
                   value="${sheetLink.linkOutDate}"/>
        </td>
        ...
        <td>
            <input type="text" class="text" name="linkInterfaceType" id="linkInterfaceType"
                   alt="allowBlank:false,maxLength:2000,vtext:'请填入 接口类型及数量 信息，最多输入 2000 字符'"
                   value="${sheetLink.linkInterfaceType}"/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <input type="text" class="text" name="linkSoftware" id="linkSoftware"
                   alt="allowBlank:false,maxLength:2000,vtext:'请填入 是否配置双机热备软件和其它随机软件 信息，最多输入 2000 字符'"
                   value="${sheetLink.linkSoftware}"/>
        </td>
    ...
    <tr>
        ...
        <td>
            <input type="text" class="text" name="linkIntegratorName" id="linkIntegratorName"
                   alt="allowBlank:false,maxLength:2000,vtext:'请填入 系统集成商名称 信息，最多输入 2000 字符'"
                   value="${sheetLink.linkIntegratorName}"/>
        </td>
        ...
        <td>
            <input type="text" class="text" name="linkLevelService" id="linkLevelService"
                   alt="allowBlank:false,maxLength:2000,vtext:'请填入 拟购买的服务级别 信息，最多输入 2000 字符'"
                   value="${sheetLink.linkLevelService}"/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <input type="text" class="text" name="linkPhysicalLocation" id="linkPhysicalLocation"
                   alt="allowBlank:false,maxLength:2000,vtext:'请填入 设备物理位置 信息，最多输入 2000 字符'"
                   value="${sheetLink.linkPhysicalLocation}"/>
        </td>
        ...
        <td>
            <input type="text" class="text" name="linkRemarks" id="linkRemarks"
                   alt="allowBlank:false,maxLength:2000,vtext:'请填入 备注 信息，最多输入 2000 字符'"
                   value="${sheetLink.linkRemarks}"/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <input type="text" class="text" name="linkContacts" id="linkContacts"
                   alt="allowBlank:false,maxLength:2000,vtext:'请填入 联系人 信息，最多输入 2000 字符'"
                   value="${sheetLink.linkContacts}"/>
        </td>
        ...
        <td>
            <input type="text" class="text" name="linkContactInformation" id="linkContactInformation"
                   alt="allowBlank:false,maxLength:2000,vtext:'请填入 联系方式 信息，最多输入 2000 字符'"
                   value="${sheetLink.linkContactInformation}"/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <input type="text" class="text" name="linkCompany" id="linkCompany"
                   alt="allowBlank:false,maxLength:2000,vtext:'请填入 单位 信息，最多输入 2000 字符'"
                   value="${sheetLink.linkCompany}"/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <input type="text" class="text" name="linkReasonRejection" id="linkReasonRejection"
                   alt="allowBlank:false,maxLength:2000,vtext:'请填入 驳回原因 信息，最多输入 2000 字符'"
                   value="${sheetLink.linkReasonRejection}"/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <input type="text" class="text" name="linkResult" id="linkResult"
                   alt="allowBlank:false,maxLength:2000,vtext:'请填入 审批结果 信息，最多输入 2000 字符'"
        ...
        <td>
            <input type="text" class="text" name="linkApprovalOpinion" id="linkApprovalOpinion"
                   alt="allowBlank:false,maxLength:2000,vtext:'请填入 审批意见 信息，最多输入 2000 字符'"
                   value="${sheetLink.linkApprovalOpinion}"/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <input type="text" class="text" name="linkServiceContent" id="linkServiceContent"
                   alt="allowBlank:false,maxLength:2000,vtext:'请填入 服务内容是否满意 信息，最多输入 2000 字符'"
                   value="${sheetLink.linkServiceContent}"/>
        </td>
        ...
        <td>
            <input type="text" class="text" name="linkScore" id="linkScore"
                   alt="allowBlank:false,maxLength:2000,vtext:'请填入 评分 信息，最多输入 2000 字符'" value="${sheetLink.linkScore}"/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <input type="text" class="text" name="linkTimelyProcessing" id="linkTimelyProcessing"
                   alt="allowBlank:false,maxLength:2000,vtext:'请填入 处理是否及时 信息，最多输入 2000 字符'"
                   value="${sheetLink.linkTimelyProcessing}"/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <input type="text" class="text" name="linkServiceContent" id="linkServiceContent"
                   alt="allowBlank:false,maxLength:2000,vtext:'请填入 服务内容 信息，最多输入 2000 字符'"
                   value="${sheetLink.linkServiceContent}"/>
        </td>
        ...
        <td>
            <input type="text" class="text" name="linkMaintenanceStartTime" id="linkMaintenanceStartTime"
                   alt="allowBlank:false,maxLength:2000,vtext:'请填入 维护开始时间 信息，最多输入 2000 字符'"
                   value="${sheetLink.linkMaintenanceStartTime}"/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <input type="text" class="text" name="linkMaintenanceEndTime" id="linkMaintenanceEndTime"
                   alt="allowBlank:false,maxLength:2000,vtext:'请填入 维护结束时间 信息，最多输入 2000 字符'"
                   value="${sheetLink.linkMaintenanceEndTime}"/>
        </td>
...
<fieldset>
    ...
    <div class="x-form-item">
        ...
        <eoms:chooser id="Confirmation0" type="role" roleId="1762" flowId="60"
...
<fieldset>
    ...
    <div class="x-form-item">
        ...
        <eoms:chooser id="Confirmation1" type="role" roleId="1760" flowId="60"
                      config="{returnJSON:true,showLeader:true}"
                      category="[{id:'dealPerformer',text:'派发',limit:'none',allowBlank:false,vtext:'请选择派发对象'},{id:'copyPerformer',childType:'user,subrole',limit:'none',text:'抄送'}]"
                      data="${sendUserAndRoles}"/>
