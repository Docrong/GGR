            ...
            <div id="sheetinfo">
                <logic:present name="sheetMain" scope="request">
                    ...
                    <table class="formTable">
                        ...
                        <tr>
                            <td class="label"><bean:message bundle="bureaudataUpdate"
                                                            key="bureaudataUpdate.mainNetSort1"/></td>
                            <td class="content">
                                <eoms:id2nameDB id="${sheetMain.mainNetSort1}" beanId="ItawSystemDictTypeDao"/>
                            </td>
                            <td class="label"><bean:message bundle="bureaudataUpdate"
                                                            key="bureaudataUpdate.mainNetSort2"/></td>
                            <td class="content">
                        ...
                        <tr>
                            <td class="label"><bean:message bundle="bureaudataUpdate"
                                                            key="bureaudataUpdate.mainNetSort3"/></td>
                            <td class="content">
                                <eoms:id2nameDB id="${sheetMain.mainNetSort3}" beanId="ItawSystemDictTypeDao"/>
                            </td>
                            <td class="label"><bean:message bundle="bureaudataUpdate"
                                                            key="bureaudataUpdate.mainTaskType"/></td>
                            <td class="content">
                        ...
                        <tr>
                            <td class="label"><bean:message bundle="bureaudataUpdate"
                                                            key="bureaudataUpdate.mainTaskDescription"/></td>
                ...
                <tr>
                    ...
                    <td class="content">
                        <select id="dealSelector" onchange="checkValue(this)" alt="allowBlank:false,vtext:'请选择处理操作'">
                            <option value=""></option>
                            <option value="Receive"><bean:message bundle="bureaudataUpdate"
                                                                  key="bureaudataUpdate.dealrejectpass"/></option>
                            <option value="ExcuteHumTask"><bean:message bundle="bureaudataUpdate"
                                                                        key="bureaudataUpdate.nopassback"/></option>
                        </select>
                    </td>
                    <td class="label"></td>
                    <td class="content">
