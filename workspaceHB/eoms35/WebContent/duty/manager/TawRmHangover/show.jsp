...
<td align="center" width = "70%">
        <TEXTAREA id=hangQuestion0 name=hangQuestion0 rows=2 cols=45 style="BACKGROUND-COLOR: lightgrey" readOnly=""><bean:write name="tawRmHangoverForm" property="hangQuestion0" scope="request"/></TEXTAREA>
</td>
</tr>
<tr class="tr_show">
<td align="center" class="clsfth"><bean:message key="TawRmHangover.thishangquestion"/></td>
<td align="center">
        <TEXTAREA id=hangQuestion name=hangQuestion rows=2 cols=45 ><bean:write name="tawRmHangoverForm" property="hangQuestion" scope="request"/></TEXTAREA>
</td>
</tr>
</table>
<TABLE cellSpacing="1" cellPadding="1" width="450" align="center" border="0">
