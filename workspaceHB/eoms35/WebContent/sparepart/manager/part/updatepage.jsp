    ...
    <tr class="tr_show">
	 ...
	 -->
            ...
            <tr class="tr_show">
                ...
                <td width="70%" height="25" colspan="2">
                    <select name="proform" size="1" value="<%=part.getProformFlag()%>" style="FONT-SIZE: 8pt"
                            style="width: 6.8cm;">
            ...
            <tr class="tr_show">
                ...
                <td width="70%" height="25" colspan="2">
                    <select name="warrantyFlag" size="1" value="<%=part.getWarrantyFlag()%>" style="FONT-SIZE: 8pt"
                            style="width: 6.8cm;">
            ...
            <tr class="tr_show">
                ...
                <td width="70%" height="25" colspan="2">
                    <select name="stopproductFlag" size="1" value="<%=part.getStopproductFlag()%>"
                            style="FONT-SIZE: 8pt" style="width: 6.8cm;">
            ...
            <tr class="tr_show">
                ...
                <td width="70%" height="25" colspan="2">
                    <select name="supplier" size="1" value="<%=part.getSupplierid()%>" style="FONT-SIZE: 8pt"
                            style="width: 6.8cm;">

                        <option value="<%=part.getSupplierid()%>"><%=part.getSupplier()%>
                        </option>
            ...
            <tr class="tr_show">
                ...
                <td width="70%" height="25" colspan="2">
                    ...
                    <select name="fixe" size="1" style="width: 6.8cm;">
                        <option value="<%=part.getFixeid()%>"><%=part.getFixe()%>
                        </option>
