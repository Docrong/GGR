package com.boco.eoms.extra.supplierkpi.taglibs;
    ...
    public int doEndTag() {
        ...
        try {
            ...
            if (initDicId != null) {
                ...
                ITawSupplierkpiDictManager _objDictManager = (ITawSupplierkpiDictManager) ApplicationContextHolder
                        .getInstance().getBean("ItawSupplierkpiDictManager");
                ...
                if (list.size() > 0) {
                    ...
                    for (Iterator it = list.iterator(); it.hasNext(); ) {
                        TawSupplierkpiDict item = (TawSupplierkpiDict) it.next();
