...
<form name="reportform" method="POST" action="../tawwpstubuser/stubusermodify.do">
    ...
    <table width="400" class="formTable">
        ...
        <tr id="dateselect">
            ...
            <td width="300">
                <input type="text" name="startdate" size="20" onfocus="setday(this)" readonly="true"
                       onclick="popUpCalendar(this, this);" value="<%=tawwpStubUserVO.getStartDate()%>">
            </td>
        </tr>
        <tr id="dateselect">
            <td width="100" class="label">
            ...
            <td width="300">
                <input type="text" name="enddate" size="20" onfocus="setday(this)" readonly="true"
                       onclick="popUpCalendar(this, this);" value="<%=tawwpStubUserVO.getEndDate()%>">
            </td>
        </tr>
        <tr>
            <td width="100" class="label">
        ...
        <tr>
            <td colSpan="2">
                ...
                <input type="submit" value="<bean:message key="stubuseredit.title.btnSubmit" />" name="B1"
                       class="submit">
                <input type="button" value="<bean:message key="stubuseredit.title.btnRemove" />" name="B3"
                       class="button" onclick="onDelete();">
                <input type="button" value="<bean:message key="stubuseredit.title.btnBack" />" name="B2"
