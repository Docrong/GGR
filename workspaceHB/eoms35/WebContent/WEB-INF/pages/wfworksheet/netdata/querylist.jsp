...
<logic:notPresent name="recordTotal">
    ...
    <display:table name="taskList" cellspacing="0" cellpadding="0"
                   ...
                   export="true" requestURI="netdata.do"
...
<logic:present name="recordTotal">
    <center>
        <table>
            <tr>
                <td><font size="4"><bean:message bundle="sheet" key="worksheet.query.total"/> ${recordTotal}
                    <bean:message bundle="sheet" key="worksheet.query.totalNumber"/></font></td>
            </tr>
        </table>
    </center>
</logic:present>
