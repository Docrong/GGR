...
/**
 * @hibernate.class table="TAW_WP_YEAREXECUTE"
 */
...
public class TawwpYearExecute
    ...
    /**
     * @hibernate.property column="SERIALNO"
     * length="20"
     * not-null="false"
     * update="true"
     */
    ...
    /**
     * @hibernate.property column="CYCLES"
     * length="3"
     * not-null="true"
     * update="true"
     */
    ...
    /**
     * @hibernate.property column="COMMAND"
     * length="100"
     * not-null="false"
     * update="true"
     */
    ...
    /**
     * @hibernate.property column="XLSX"
     * length="3"
     * not-null="false"
     * update="true"
     */
    ...
    /**
     * @hibernate.property column="XLSY"
     * length="3"
     * not-null="false"
     * update="true"
     */
    ...
    /**
     * @hibernate.property column="VALIDATES"
     * length="30"
     * not-null="false"
     * update="true"
     */
    ...
    /**
     * @hibernate.many-to-one column="MODEL_GROUP_ID"
     * cascade="none"
     * not-null="false"
     */
    ...
    /**
     * @hibernate.many-to-one column="MODEL_EXECUTE_ID"
     * cascade="none"
     * not-null="false"
     */
     ...
     * lazy="true"
     * cascade="save-update"
     * @hibernate.collection-key column="YEAR_EXECUTE_ID"
