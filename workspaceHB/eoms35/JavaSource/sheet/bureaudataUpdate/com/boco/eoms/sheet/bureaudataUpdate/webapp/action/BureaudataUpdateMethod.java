...
public class BureaudataUpdateMethod extends BaseSheet {
	...
	public void showInputDealPage(ActionMapping mapping, ActionForm form,
		...
		// IMainService parentMainService = (IMainService)
		// ApplicationContextHolder
		// .getInstance().getBean(parentSheetName);
		// BaseMain
		// parentMain=parentMainService.getSingleMainPO(parentSheetKey);
	...
	public String getProcessTemplateName() {
		// TODO Auto-generated method stub
		return "BureaudataUpdateProcess";
	}

	public String getSheetAttachCode() {
		// TODO Auto-generated method stub
		return "bureaudataUpdate";
	}
	...
	public void dealFlowEngineMap(ActionMapping mapping, ActionForm form,
		...
		if(mainMap.get("title")!=null&&"".equals(mainMap.get("title"))){
			...
			String title = tbr.getTawSystemApplyID(sessionform.getUserid(), "变更");
...
//		==============================
	...
	public void showDetailPage(ActionMapping mapping, ActionForm form,
		...
		.getSession().getAttribute("sessionform");
//		 获取该用户可访问号段信息
		List hlrlists = hlrmgr.getBelongSegment(session.getUserid());
		request.setAttribute("BureaudataBasicAll", hlrlists);
	}
