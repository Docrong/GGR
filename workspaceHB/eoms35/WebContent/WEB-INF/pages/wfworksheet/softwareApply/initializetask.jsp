...
<html:form action="/softwareApply.do?method=newTaskPerformAdd" styleId="theform" target="myname">
<%@ include file="/WEB-INF/pages/wfworksheet/softwareApply/baseinputlinkhtmlnew.jsp"%>
	<input type="hidden" name="${sheetPageName}processTemplateName" value="SoftwareApplyProcess" />
   ...
   <table class="formTable">
				<tr>
				  <td class="label"><bean:message bundle="softwareApply" key="softwareApply.linkUrgency"/>*</td>
				 ...
				 <tr>
	              <td  class="label"><bean:message bundle="softwareApply" key="softwareApply.linkReqCompleteTime"/>*</td>				 
				  <td class="content">
	              ...
	              <td  class="label"><bean:message bundle="softwareApply" key="softwareApply.linkAcceptDept"/>*</td>
				  <td class="content">
			  ...
			  <tr>
			  	<td class="label"><bean:message bundle="softwareApply" key="softwareApply.linkSendSheetDesc"/>*</td>
			    <td colspan="3">
...
<c:if test="${phaseId=='UserTask'}">
    <input type="hidden" id="${sheetPageName}operateType" name="${sheetPageName}operateType" value="2011" />
		<fieldset id ="link1">
			 <legend>
			     	 <bean:message bundle="softwareApply" key="role.toOrgName"/>
