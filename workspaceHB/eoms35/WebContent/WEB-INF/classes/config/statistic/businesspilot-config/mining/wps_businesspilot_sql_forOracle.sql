...
from businesspilot_main

select *
from businesspilot_link select *
from businesspilot_task
...
------------------------------VIEW----------------------------------------
select *
from v_businesspilot select distinct *
from v_businesspilot
...
--bussines main
    , MAINSTARTTIME, MAINENDTIME, MAINBUSDEPT, MAINPRODUCTTYPE, MAINPRODUCTNAME, MAINPRODUCTCODE, MAINISBUS,
                                       MAINBUSSHEETID, MAINISPROJECT, MAINISSUCCESS, mainifrecord, SENDYEAR, SENDMONTH,
                                       SENDDAY
--bussines link                                                                
    , LINKOPERSTARTTIME, LINKOPERENDTIME, LINKTESTRESULT, LINKNETTYPE, LINKTGPOLICYACC, LINKDEVICEVERIFY, LINKISUPDATE,
                                       LINKISSUCCESS, LINKSDENDTIME, LINKISFINISH, LINKISCHANGE, operateyear,
...
values (22, to_date('2007-7-7 00:00:00', 'YYYY-MM-DD HH24:MI:SS'), '新业务试点工单基础表采集的上一次操作的时间');
