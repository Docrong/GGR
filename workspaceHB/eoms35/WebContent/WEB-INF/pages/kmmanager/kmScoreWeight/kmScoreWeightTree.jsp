    ...
    <script type="text/javascript">
        var config = {
            ...
            ctxMenu: [
                {
                    id: 'newnode',
                    text: '<fmt:message key="kmScoreWeight.tree.add"/>',
                    cls: 'new-mi',
                    url: '${app}/kmmanager/kmScoreWeights.do?method=add&nodeId='
                },
                {
                    id: 'edtnode',
                    text: '<fmt:message key="kmScoreWeight.tree.edit"/>',
                    cls: 'edit-mi',
                    url: '${app}/kmmanager/kmScoreWeights.do?method=edit&nodeId='
                },
                {
                    id: 'delnode',
                    isDelete: true,
                    text: '<fmt:message key="kmScoreWeight.tree.delete"/>',
                    cls: 'remove-mi',
                    url: '${app}/kmmanager/kmScoreWeights.do?method=remove&nodeId='
                }
            ],//end of ctxMenu
            /************************
