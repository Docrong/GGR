...
-->
            ...
            <tr>
                ...
                <td class="content" colspan="3">
                    <textarea name="remark" cols="50" id="remark" class="textarea max" alt="allowBlank:false"
                              onkeyup="this.value=this.value.slice(0, 180)">${kmTableGeneralForm.remark}</textarea>
                </td>
            </tr>
