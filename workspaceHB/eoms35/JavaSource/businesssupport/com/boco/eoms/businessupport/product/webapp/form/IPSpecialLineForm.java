...
public class IPSpecialLineForm extends BaseForm implements java.io.Serializable{
	
	    protected String id;
	    protected String orderSheet_Id;
        protected String RCAPDetailAddress;	
    	protected String allowConnect;		
    	protected String connectPortLength;	
    	protected String dealResult;		
    	protected String dealDesc;		
    	protected String ipAddressCount;		
    	protected String businessBandwidth;	
    	protected String businessAmount;		  
    	protected String portANetDeptUser;		  
    	protected String portANetDeptPhone;		 
	    protected String engineeringUserA;		 
	    protected String engineeringPhoneA;		  
	    protected String testReport;				
	    protected String ip1;						
	    protected String ip2;						
	    protected String cnetCode;				
	    protected String gateway;					
	    protected String businessRequireDesc;     
	    protected String userEquipmentName;      
	    protected String userEquipmentPort;       
    	protected String netResourceAbilityAffirm;  
        protected String guestProjectAbilityAffirm; 
    	protected String intendInvest;             
	    protected String isAlreadyCampON;         
	    protected String buildingScheme;  
