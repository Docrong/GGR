...
<div align="center">
    ...
    <form action="../query/repairview.do" method="post" name="frm" onsubmit="checkdata()">
        <table border="0" width="75%" cellspacing="1" cellpadding="1" class="table_show" align=center>
            <tr class="tr_show">
                <td class="clsfth" width="30%" height="25">
                    <p style="margin-top: 0; margin-bottom: 0">${eoms:a2u('物资所属大专业：')}</p>
                </td>
            ...
            <tr class="tr_show">
                <td class="clsfth" width="30%" height="25">
                    <p style="margin-top: 0; margin-bottom: 0">${eoms:a2u('物资所属小专业：')}</p>
                </td>
                <td width="70%" height="25" colspan="2">
            ...
            <tr class="tr_show">
                ...
                <td width="70%" height="25" colspan="2">
                    <app:SelectDate name="timein" formName="frm" day="-90" value="<%=StaticMethod.getLocalString() %>"/>
                </td>
            </tr>
            <tr class="tr_show">
                <td class="clsfth" width="30%" height="25">
