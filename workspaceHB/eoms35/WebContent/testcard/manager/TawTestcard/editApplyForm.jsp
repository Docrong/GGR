...
<script language="javascript">
    ...
    function onSearchCard() {
        window.location.href = '<%=request.getContextPath()%>/testcard/TawTestcardApply/searchcard.do?formId='+<%=ApplyForm.getId()%>+
        '&leaveid=' +<%=leaveid%>;
    }
                ...
                <td align="right" width="100%" bgColor="#f5f5f5">
                    <div align="center">
                        ...
                        <table border="0" width="95%" cellspacing="1" class="listTable">
                            ...
                            <logic:iterate id="tawTestcard" name="tawTestcard"
                                           type="com.boco.eoms.testcard.model.TawTestcard">
                                <tr bgcolor="#FFFFFF">
