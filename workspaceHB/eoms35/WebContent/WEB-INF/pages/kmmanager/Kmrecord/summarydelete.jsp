...
<br>
<table cellpadding="0" cellspacing="0" border="0" width="95%" class="listTable">
	<tr>
			...
			<table border="0" width="95%" cellspacing="1" cellpadding="1"
				...
				<logic:iterate id="tawRmRecord" name="TAWRMRECORDS"
					...
					<tr class="tr_show">
						...
						<td align="center">
							<html:link href="viewdelete.do" paramId="id"
								paramName="tawRmRecord" paramProperty="id">
								<img src="<%=request.getContextPath()%>/duty/images/an_sc.gif"
									border="0">
							</html:link>
							&nbsp;
						</td>
