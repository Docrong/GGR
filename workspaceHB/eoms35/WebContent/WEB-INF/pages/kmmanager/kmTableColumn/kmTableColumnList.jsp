...
<fmt:bundle basename="com/boco/eoms/km/config/applicationResource-kmmanager">
    ...
    <display:table name="kmTableColumnList" cellspacing="0" cellpadding="0"
        ...
        <display:column property="tableId" sortable="true"
                        headerClass="sortable" titleKey="kmTableColumn.tableId"
                        href="${app}/kmTableColumn/kmTableColumns.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="id" sortable="true"
                        headerClass="sortable" titleKey="kmTableColumn.id"
                        href="${app}/kmTableColumn/kmTableColumns.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="createUser" sortable="true"
                        headerClass="sortable" titleKey="kmTableColumn.createUser"
                        href="${app}/kmTableColumn/kmTableColumns.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="createDept" sortable="true"
                        headerClass="sortable" titleKey="kmTableColumn.createDept"
                        href="${app}/kmTableColumn/kmTableColumns.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="createTime" sortable="true"
                        headerClass="sortable" titleKey="kmTableColumn.createTime"
                        href="${app}/kmTableColumn/kmTableColumns.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="colName" sortable="true"
                        headerClass="sortable" titleKey="kmTableColumn.colName"
                        href="${app}/kmTableColumn/kmTableColumns.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="colChname" sortable="true"
                        headerClass="sortable" titleKey="kmTableColumn.colChname"
                        href="${app}/kmTableColumn/kmTableColumns.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="colType" sortable="true"
                        headerClass="sortable" titleKey="kmTableColumn.colType"
                        href="${app}/kmTableColumn/kmTableColumns.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="colDictType" sortable="true"
                        headerClass="sortable" titleKey="kmTableColumn.colDictType"
                        href="${app}/kmTableColumn/kmTableColumns.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="colDictId" sortable="true"
                        headerClass="sortable" titleKey="kmTableColumn.colDictId"
                        href="${app}/kmTableColumn/kmTableColumns.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="colDefault" sortable="true"
                        headerClass="sortable" titleKey="kmTableColumn.colDefault"
                        href="${app}/kmTableColumn/kmTableColumns.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="colSize" sortable="true"
                        headerClass="sortable" titleKey="kmTableColumn.colSize"
                        href="${app}/kmTableColumn/kmTableColumns.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="isNullable" sortable="true"
                        headerClass="sortable" titleKey="kmTableColumn.isNullable"
                        href="${app}/kmTableColumn/kmTableColumns.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="isOpen" sortable="true"
                        headerClass="sortable" titleKey="kmTableColumn.isOpen"
                        href="${app}/kmTableColumn/kmTableColumns.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="isVisibl" sortable="true"
                        headerClass="sortable" titleKey="kmTableColumn.isVisibl"
                        href="${app}/kmTableColumn/kmTableColumns.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="isUnique" sortable="true"
                        headerClass="sortable" titleKey="kmTableColumn.isUnique"
                        href="${app}/kmTableColumn/kmTableColumns.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="isIndex" sortable="true"
                        headerClass="sortable" titleKey="kmTableColumn.isIndex"
                        href="${app}/kmTableColumn/kmTableColumns.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="isDeleted" sortable="true"
                        headerClass="sortable" titleKey="kmTableColumn.isDeleted"
                        href="${app}/kmTableColumn/kmTableColumns.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="orderBy" sortable="true"
                        headerClass="sortable" titleKey="kmTableColumn.orderBy"
                        href="${app}/kmTableColumn/kmTableColumns.do?method=edit" paramId="id" paramProperty="id"/>
