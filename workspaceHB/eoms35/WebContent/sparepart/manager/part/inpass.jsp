...
<center>
    ...
    <table border="0" width="95%" cellspacing="0">
        <tr>
            <td width="106%" class="table_title" align="center">${eoms:a2u('备件出入库申请待审批')}<bean:message
                    key="label.list"/></td>
        </tr>
    </table>
    <table border="0" width="95%" cellspacing="1" cellpadding="1" class="table_show" align=center>
        ...
        <logic:iterate id="order" name="orderlist" type="com.boco.eoms.sparepart.model.TawOrder">
            ...
            <a href="../part/inpassdetail.do?id=<bean:write name="order" property="id" scope="page"/>&sparepart_id=<bean:write name="order" property="sparepart_id" scope="page"/>&orderpart_id=<bean:write name="order" property="orderpart_id" scope="page"/>">
