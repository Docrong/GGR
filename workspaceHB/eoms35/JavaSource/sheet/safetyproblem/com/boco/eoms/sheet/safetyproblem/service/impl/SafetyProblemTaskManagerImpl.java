...
// Source File Name:   SafetyProblemTaskManagerImpl.java
...
import com.boco.eoms.sheet.safetyproblem.dao.*;
import com.boco.eoms.sheet.safetyproblem.service.*;

public class SafetyProblemTaskManagerImpl extends TaskServiceImpl
        implements ISafetyProblemTaskManager {

    public SafetyProblemTaskManagerImpl() {
    }
    ...
    public HashMap getSplitAndReplyTask(Map condition, String userId, String deptId, String flowName, Integer startIndex, Integer length)
        ...
        try {
            ISafetyProblemTaskDAO iSafetyProblemTaskDAO = (ISafetyProblemTaskDAO) getTaskDAO();
            taskMap = iSafetyProblemTaskDAO.getSplitAndReplyList(condition, userId, deptId, flowName, startIndex, length);
        } catch (Exception e) {
    ...
    public HashMap getSplitNotReplyTask(Map condition, String userId, String deptId, String flowName, Integer startIndex, Integer length)
        ...
        try {
            ISafetyProblemTaskDAO iSafetyProblemTaskDAO = (ISafetyProblemTaskDAO) getTaskDAO();
            taskMap = iSafetyProblemTaskDAO.getSplitNotReplyList(condition, userId, deptId, flowName, startIndex, length);
        } catch (Exception e) {
            throw new SheetException(e);
        }
        return taskMap;
