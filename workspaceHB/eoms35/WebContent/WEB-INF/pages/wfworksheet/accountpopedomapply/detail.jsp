...
<%@page import="com.boco.eoms.sheet.accountpopedomapply.model.AccountPopedomApplyTask" %>
...
<%
    ...
    AccountPopedomApplyTask task = new AccountPopedomApplyTask();
    String operaterType = "";
    String ifsub = "";
    String ifwaitfor = "";
    if (request.getAttribute("task") != null) {
        task = (AccountPopedomApplyTask) request.getAttribute("task");
...
<script type="text/javascript">
    Ext.onReady(function () {
        var tabConfig = {
            items: [{
                ...
                url: 'accountpopedomapply.do?method=showSheetDealList&sheetKey=${sheetMain.id}&taskName=${taskName}&ifWaitForSubTask=${task.ifWaitForSubTask}'
            }, {
                text: '<bean:message bundle="sheet" key="sheet.flowchar"/>',
                //url : '/ProcessMonitor/runtime/html/index.jsp?appName=accountpopedomapplyProcessApp&templateName=accountpopedomapplyMainFlowProcess&piid=${sheetMain.piid}&listType=myProcesses&curPage=0',
                //url : 'accountpopedomapply.do?method=showWorkFlow&linkServiceName=iaccountpopedomapplyLinkManager&dictSheetName=dict-sheet-accountpopedomapply&description=mainOperateType&sheetKey=${sheetMain.id}',
                url: 'accountpopedomapply.do?method=showWorkFlow&sheetKey=${sheetMain.id}',
                isIframe: true
            }, {
                text: '<bean:message bundle="sheet" key="sheet.filesView"/>',
                url: 'accountpopedomapply.do?method=showSheetAccessoriesList&id=${sheetMain.id}',
                isIframe: true
            }, {
        ...
        var url2 = "accountpopedomapply.do?method=newShowCCPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}&operateType=-10&taskStatus=${taskStatus}";
        eoms.util.appendPage("sheet-deal-content", url2);
        <%}%>
        <%if(taskName.equals("reply")){ %>
        var url2 = "accountpopedomapply.do?method=showRemarkPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}";
        eoms.util.appendPage("sheet-deal-content", url2);
        <%}%>
    ...
    function forceOperation(obj) {
        ...
        if (obj == 1) {
            var url2 = 'accountpopedomapply.do?method=showForceHoldPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}&operateType=forceHold';
            eoms.util.appendPage("sheet-deal-content", url2);
        } else if (obj == 2) {
            var url2 = 'accountpopedomapply.do?method=showForceHoldPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}&operateType=nullity';
            eoms.util.appendPage("sheet-deal-content", url2);
        } else {
            var url2 = 'accountpopedomapply.do?method=showForceHoldPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}&operateType=forceNullity';
            eoms.util.appendPage("sheet-deal-content", url2);
        }
    }
    ...
    function eventOperation(obj) {
        if (obj == 1) {
            var url2 = "accountpopedomapply.do?method=showPhaseAdvicePage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&taskName=advice&operateFlag=driveForward&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}";
...
<div id="sheet-detail-page">
    ...
    <div id="sheetinfo">
        <logic:present name="sheetMain" scope="request">
            <%@ include file="/WEB-INF/pages/wfworksheet/accountpopedomapply/basedetailnew.jsp" %>
            <br/>

            <table class="formTable">
                <caption></caption>
                <tr>
                    <td class="label"><bean:message bundle="accountpopedomapply"
                                                    key="accountpopedomapply.netType1"/></td>
                    <td class="content"><eoms:id2nameDB id="${sheetMain.netType1}" beanId="ItawSystemDictTypeDao"/></td>
                    <td class="label"><bean:message bundle="accountpopedomapply"
                                                    key="accountpopedomapply.netType2"/></td>
                    <td class="content"><eoms:id2nameDB id="${sheetMain.netType2}" beanId="ItawSystemDictTypeDao"/></td>
                </tr>
                <tr>
                    <td class="label"><bean:message bundle="accountpopedomapply"
                                                    key="accountpopedomapply.netType3"/></td>
                    <td class="content" colspan="3"><eoms:id2nameDB id="${sheetMain.netType3}"
                                                                    beanId="ItawSystemDictTypeDao"/></td>
                </tr>
                <tr>
                    <td class="label"><bean:message bundle="accountpopedomapply"
                                                    key="accountpopedomapply.becomeTime"/></td>
                    <td class="content"><bean:write name="sheetMain" property="becomeTime"
                                                    formatKey="date.formatDateTimeAll" bundle="sheet"
                                                    scope="request"/></td>
                    <td class="label"><bean:message bundle="accountpopedomapply"
                                                    key="accountpopedomapply.abateTime"/></td>
                    <td class="content"><bean:write name="sheetMain" property="abateTime"
                                                    formatKey="date.formatDateTimeAll" bundle="sheet"
                                                    scope="request"/></td>
                </tr>
                <tr>
                    <td class="label"><bean:message bundle="accountpopedomapply" key="accountpopedomapply.system"/></td>
                    <td class="content" colspan='3'><bean:write name="sheetMain" property="system" bundle="sheet"
                                                                scope="request"/></td>
                </tr>
                <tr>
                    <td class="label"><bean:message bundle="accountpopedomapply"
                                                    key="accountpopedomapply.applyExplain"/></td>
                    <td class="content" colspan='3'><bean:write name="sheetMain" property="applyExplain" bundle="sheet"
                                                                scope="request"/></td>
                </tr>
                <tr>
                    ...
                    <td colspan='3'>
                        <eoms:attachment name="sheetMain" property="sheetAccessories"
                                         scope="request" idField="sheetAccessories" appCode="accountpopedomapply"
                                         viewFlag="Y"/>
                    </td>
                </tr>
            </table>
...
<!--审核申请-->
<c:url var="urlShowAuditApplyPage" value="accountpopedomapply.do">
...
<!--审核通过-->
<c:url var="urlShowAuditAcceptPage" value="accountpopedomapply.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!--审核不通过 -->
<c:url var="urlShowAuditReplyPage" value="accountpopedomapply.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!--会审-->
<c:url var="urlTogetherAudit" value="accountpopedomapply.do">
...
<!--转审-->
<c:url var="urlTransmitAudit" value="accountpopedomapply.do">
...
<!--处理完成-->
<c:url var="urlShowPerformDealPage" value="accountpopedomapply.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 归档页面 -->
<c:url var="urlShowHoldDealPage" value="accountpopedomapply.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 草稿节点 -->
<c:url var="urlShowDraftDeal" value="accountpopedomapply.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 草稿节点-显示草稿派发 -->
<c:url var="urlShowDraftPageDealPage" value="accountpopedomapply.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 被驳回，显示草稿修改页面 -->
<c:url var="urlBackDealPage" value="accountpopedomapply.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 确认受理 -->
<c:url var="urlShowAcceptDealPage" value="accountpopedomapply.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 环节内（组内）移交 -->
<c:url var="urlShowTransferkPage" value="accountpopedomapply.do">
    <c:param name="method" value="showTransferWorkItemPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 阶段回复 -->
<c:url var="urlShowPhaseReplyPage" value="accountpopedomapply.do">
...
<!--处理回复通过 -->
<c:url var="urlShowDealReplyAcceptPage" value="accountpopedomapply.do">
...
<!-- 处理回复不通过 -->
<c:url var="urlShowDealReplyRejectPage" value="accountpopedomapply.do">
...
<!-- 驳回上一级 -->
<c:url var="urlShowRejectBackPage" value="accountpopedomapply.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!--分派-->
<c:url var="urlShowInputSplit" value="accountpopedomapply.do">
    <c:param name="method" value="showInputSplit"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 分派回复 -->
<c:url var="urlShowDispatchPage" value="accountpopedomapply.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
            ...
            <tr>
                ...
                %>
                    ...
                    <select id="dealSelector">
                        ...
                        <option value="${urlShowAuditApplyPage}">审核申请</option>
                        <option value="${urlTransmitAudit}">转审</option>
                        <option value="${urlTogetherAudit}">会审</option>
                        <option value="${urlShowPhaseReplyPage}"><bean:message bundle="sheet"
                                                                               key="event.reply"/></option>
                        <%}%>
                        <%} else {%>
                        <% if (ifwaitfor.equals("false")) {%>
                        <option value="${urlShowAuditReplyPage}">会审回复</option>
                        <%}%>
                        <%}%>
                    ...
                    <%} else if (taskName.equals("ActualizeHumTask")) {%>
                    <select id="dealSelector">
                        <%if (taskStatus.equals(Constants.TASK_STATUS_READY)) {%>
                        <option value="${urlShowAcceptDealPage}"><bean:message bundle="sheet"
                                                                               key="common.accept"/></option>
                        ...
                        <%if (ifsub.equals("") || ifsub.equals("false")) {%>
                        <%if (ifwaitfor.equals("false")) {%>
                        <option value="${urlShowPerformDealPage}">处理完成</option>
                    ...
                    <select id="dealSelector">
                        <option value="${urlShowDraftDeal}">草稿</option>
                    </select>
                    ...
                    <select id="dealSelector">
                        <option value="${urlShowHoldDealPage}">归档</option>
...
<script type="text/javascript">
    Ext.onReady(function () {
        ...
        if (dealTemplateId != null && dealTemplateId != "") {
            url = "accountpopedomapply.do?method=referenceTemplate&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&taskName=${taskName}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&operateType=${operateType}&taskStatus=${taskStatus}&dealTemplateId=" + dealTemplateId
        }
