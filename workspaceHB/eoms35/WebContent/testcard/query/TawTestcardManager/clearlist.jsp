        ...
        <table border="0" width="95%" cellspacing="1" class="formTable">
            ...
            <logic:iterate id="tawTestcard" name="tawTestcard" type="com.boco.eoms.testcard.model.TawTestcard">
                ...
                <tr bgcolor="#FFFFFF">
                    ...
                    <td align="center"><html:link href="../TawTestcard/view.do" paramId="iccid" paramName="tawTestcard"
                                                  paramProperty="iccid">${eoms:a2u("显示")}</html:link></td>
                    ...
                    <td align="center" height="25">
                        <INPUT TYPE="checkbox" name="iccid"
                               value="<bean:write name="tawTestcard" property="state" scope="page"/>,<bean:write name="tawTestcard" property="iccid" scope="page"/>,<bean:write name="tawTestcard" property="msisdn" scope="page"/>">
                    </td>
                </tr>
            </logic:iterate>
            <tr>
                <td width="100%" colspan="10" bgcolor="#E5EDF8" align="right" height="25">
                    <select name="newstate" style="width: 4.0cm;">
                        <option value="0" selected="selected">${eoms:a2u("正常")}</option>
                        <option value="1">${eoms:a2u("停机")}</option>
                        <option value="2">${eoms:a2u("遗失")}</option>
                        <option value="6">${eoms:a2u("SIM卡注册失败")}</option>
                    </select>
