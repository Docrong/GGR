...
public class TawRmExchangePer {
    private String id;
    private String workSerial;
    private String exchangeTime;
    private int prAlarmNums;
    private int sendSheetNum;
    private int alAlarmNum;
    private int noAlarmNum;
    private String operationalState;
    private String yeLinetype;
    private int leaveSheetNum;
    private int leaveSheetNums;
    private int chiefSheetNum;
    private String purpose;
    private String completeFlag;
    private String difLinetype;
    private String toLinetype;
