...
<logic:present name="HISTORY" scope="request">  
      <logic:iterate id="baselink" name="HISTORY" type="com.boco.eoms.sheet.businessoperation.model.BusinessOperationLink">  
       <%         
        jNum += 1;       
     ...
     <div class="history-item"><!-- add space to hack ie-->&nbsp;
       <div class="history-item-title">
		 ...
		 <bean:write name="baselink" property="operateTime" formatKey="date.formatDateTimeAll" bundle="sheet" scope="page"/>&nbsp; 
  	     ...
  	     <eoms:dict key="dict-sheet-businessoperation" dictId="activeTemplateId" itemId="${baselink.activeTemplateId}" beanId="id2descriptionXML" />
  	     <bean:message bundle="businessoperation" key="businessoperation.operateType"/>:
  	     <eoms:dict key="dict-sheet-businessoperation" dictId="mainOperateType" itemId="${baselink.operateType}" beanId="id2descriptionXML" />
			 ...
			 <c:if test="${baselink.operateType!=11 }">
			  ...
			  <tr>
		            <td  class="label"><bean:message bundle="businessoperation" key="businessoperation.linkBusinessDesc"/></td>
	  				  <td class="column-content" colspan=3>
	  				      	<pre><bean:write name="baselink" property="linkBusinessDesc" scope="page"/></pre>
	  			      </td>
		          </tr>
                       <tr>
                         ...
                         <eoms:attachment name="baselink" property="linkOperateScheme" 
				              scope="page" idField="${sheetPageName}linkOperateScheme" appCode="businessoperation" 
				               viewFlag="Y"/>
	                    </td>  
		            </tr>
			 </c:if>
			 ...
			 <c:if test="${!empty baselink.linkTestResult}">
	                ...
	                <tr>
                         ...
                         <eoms:attachment name="baselink" property="linkAlterationAcc" 
				              scope="page" idField="${sheetPageName}linkAlterationAcc" appCode="businessoperation" 
				               viewFlag="Y"/>
	                    </td>  
		            </tr>
			   </c:if>
			 ...
			 <%if(baselink.getOperateType()!=null && (baselink.getOperateType().intValue() == 92||baselink.getOperateType().intValue() == 11)){%> 
			     ...
			     <tr>
                         ...
                         <eoms:attachment name="baselink" property="linkTGPolicyAcc" 
				              scope="page" idField="${sheetPageName}linkTGPolicyAcc" appCode="businessoperation" 
				               viewFlag="Y"/>
	                    </td>  
		            </tr>	 
			 <%} }%>	
			      ...
			      <tr>
	                ...
	                <tr>
                         ...
                         <eoms:attachment name="baselink" property="linkMeetingAcc" 
				              scope="page" idField="${sheetPageName}linkMeetingAcc" appCode="businessoperation" 
				               viewFlag="Y"/>
	                    </td>  
		            </tr>
			 <%} }%>	
			   ...
			   <tr>
	                ...
	                <tr>
                         ...
                         <eoms:attachment name="baselink" property="linkTGReportAcc" 
				              scope="page" idField="${sheetPageName}linkTGReportAcc" appCode="businessoperation" 
				               viewFlag="Y"/>
	                    </td>  
		            </tr>
		            </tr>
