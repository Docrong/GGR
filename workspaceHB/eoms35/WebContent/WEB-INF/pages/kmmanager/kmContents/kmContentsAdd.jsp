        ...
        <table class="formTable">
            ...
            <tr>
                ...
                <td class="content">
                    <html:select property="TableInfo/TABLE_ID" styleId="TABLE_ID"
                                 ...
                                 alt="allowBlank:false,vtext:'请选择知识库...'" value="${TABLE_ID}"
                                 onchange="onTableChg(this)">
                        <html:optionsCollection name="KmTableGeneralList" value="id"
                ...
                <td class="content">
                    <input type="text" id="themeName" name="themeName" class="text" readonly="readonly" value=""
            ...
            <tr>
                ...
                <td class="content" colspan="3">
                    <input type="text" name="TableInfo/CONTENT_TITLE" id="CONTENT_TITLE" value="" maxLength="100"
                           class="text max" alt="allowBlank:false,vtext:'请输入知识标题...'"/>
                </td>
            </tr>
                                ...
                                <c:choose>
                                    <c:when test="${item.colType == 1}">
                                        ...
                                        <input type="text" name="TableInfo/${item.colName}" id="${item.colName}"
                                               value="${item.colDefault}" maxLength="${item.colSize}"
                                               class="text medium"
                                    ...
                                    <c:when test="${item.colType == 7}">
                                        <!-- 不绑定_附件上传 -->
                                        <eoms:attachment name="" property="" scope="request"
            ...
            <tr>
                ...
                <td class="content" colspan="3">
                    <input type="text" name="TableInfo/CONTENT_KEYS" id="CONTENT_KEYS" value="" maxLength="100"
                           class="text max" alt="allowBlank:false,vtext:'请输入知识关键字...'"/>
                </td>
            </tr>
        </table>
