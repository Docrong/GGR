    ...
    <tr>
        <td width="20%" colspan="34" height="10">
            ...
            <font color="red"><bean:message
                    key="querymonthplanresult.title.labCurrentRate"/><%=String.valueOf((executedCount / totalCount) * 100)%>
                % &nbsp;&nbsp;<bean:message
                        key="querymonthplanresult.title.labIntimeRate"/><%=String.valueOf((inTimeCount / executedCount) * 100)%>
                %</font>
        </td>
    </tr>
    <tr>
...
<div>
    <input type="button" value="<bean:message key="querymonthplanresult.title.btnBack" />"
...
<table class="listTable" id="fileList">
    ...
    <tr>
        <td colspan="4">
            <input type="button" name="b1" value="<bean:message key="querymonthplanresult.title.btnCheckContent" />"
                   onclick="javascript:onAssessAdd();" Class="button">
        </td>
    </tr>
</table>
