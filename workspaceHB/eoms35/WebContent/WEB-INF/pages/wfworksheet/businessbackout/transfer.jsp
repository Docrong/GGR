...
<html:form action="/businessbackout.do?method=performTransferWorkItem" styleId="theform">
    ...
    <br/>
           <input type="hidden" name="${sheetPageName}beanId"   id="${sheetPageName}beanId"  value="ibusinessbackoutMainManager"/>
           <input type="hidden" name="${sheetPageName}mainClassName" id="${sheetPageName}mainClassName"  value="com.boco.eoms.sheet.businessbackout.model.businessbackoutMain"/>	<!--mainè\u00a1¨Model\u00e5\u00af\u00b9è±\u00a1\u00e7±\u00bb\u00e5\u0090\u008d-->	
           <input type="hidden" name="${sheetPageName}linkClassName" id="${sheetPageName}linkClassName" value="com.boco.eoms.sheet.businessbackout.model.businessbackoutLink"/> <!--linkè\u00a1¨Model\u00e5\u00af\u00b9è±\u00a1\u00e7±\u00bb\u00e5\u0090\u008d-->
   ...
   <div class="form-btns">
        ...
        <input type="submit" class="submit" onclick="v.passing=true;this.form.action='${app}/sheet/businessbackout/businessbackout.do?method=performSaveInfo'" value="<bean:message bundle='sheet' key='button.save'/>" />
