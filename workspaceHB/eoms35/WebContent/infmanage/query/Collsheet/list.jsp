        ...
        <table border="0" width="100%" cellspacing="1" cellpadding="1" class="table_show" align=center>
            ...
            <logic:iterate id="collsheet" name="Collsheet_LIST" type="com.boco.eoms.infmanage.model.Collsheet">
                <tr class="tr_show">
                    ...
                    <td width="5%" height="25" class="clsfth" align="center"><bean:write name="collsheet"
                                                                                         property="achieve_person"
                                                                                         scope="page"/></td>

                    <td width="15%" height="25" class="clsfth" align="center"><bean:write name="collsheet"
                                                                                          property="achieve_time"
                                                                                          scope="page"/></td>
                    ...
                    <td width="5%" height="25" align="center"><font color="#cc0000"><html:link page="/Collsheet/view.do"
                                                                                               name="map"
                                                                                               scope="page"><img
                    ...
                    <td width="5%" height="25" align="center"><font color="#cc0000"><html:link
                            page="/Collsheet/update.do" name="map" scope="page"><img
                            src="<%=request.getContextPath()%>/images/bottom/an_bj.gif" border="0" alt="编辑"></html:link>&nbsp;</font>
                    </td>

                    <td width="5%" height="25" align="center"><font color="#cc0000"><html:link page="/Collsheet/del.do"
                                                                                               name="map"
                                                                                               scope="page"><img
