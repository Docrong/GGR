...
public class TawwpMonthExecuteUserDaoHibernate extends BaseDaoHibernate
     ...
     * 保存月度作业计划执行内容执行人
     *
     * @param _tawwpMonthExecuteUser TawwpMonthExecuteUser 月度作业计划执行内容执行人类 @ 操作异常
     */
     ...
     * 查询月度作业计划执行内容执行人信息
     *
     * @param id String 月度作业计划执行内容执行人标识 @ 操作异常
     ...
     * @param _orgPostStr String 岗位编号字符串 @ 操作异常
     ...
     * @param _monthFlag String 执行月度 @ 操作异常
     * @return List 执行作业计划执行内容(个人)类列表
     */
