    ...
    <html:form action="/commonfault.do?method=performDeal" styleId="theform">
        ...
        <c:choose>
            ...
            <c:otherwise>
                ...
                <logic:empty name="batch">
                    <div class="form-btns hide" id="btns">
                        <c:choose>
                            <c:when test="${taskName=='cc'}">
                                <input type="submit" class="submit" name="method.save" id="method.save"
                                       onclick="javascript:ifisCopy();showCount();return setStep();" value="已阅">
                            </c:when>
                            <c:otherwise>
                                <input type="submit" class="submit" name="method.save" id="method.save"
                                       onclick="javascript:return checkAlarmSolveTime();ifisCopy();showCount();return setStep();"
                                       value="<bean:message bundle='sheet' key='button.done'/>">
                                <html:button styleClass="btn" property="method.save" styleId="method.save"
                                             onclick="v.passing=true;javascript:saveDealInfo();">
                                    <bean:message bundle='sheet' key='button.save'/>
                ...
                <logic:notEmpty name="batch">
                    <div class="form-btns hide" id="btns">
                        <input type="submit" class="submit" name="method.save" id="method.save"
                               onclick="javascript:batchSubmit();return setStep();"
                               value="<bean:message bundle='sheet' key='button.done'/>">
                    </div>
                </logic:notEmpty>
        ...
        <script type="text/javascript">
            ...
            function checkAlarmSolveTime() {
                ...
                //alert("nodeAccessories="+nodeAccessories);
                //alert("mainAlarmSolveDate="+mainAlarmSolveDate);
                //alert("mainCheckTime="+mainCheckTime);
