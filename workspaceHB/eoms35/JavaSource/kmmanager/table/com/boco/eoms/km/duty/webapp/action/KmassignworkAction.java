...
import com.boco.eoms.km.configInfo.dao.KmexchangeDAO;
...
import com.boco.eoms.km.duty.webapp.form.KmassignworkForm;

public class KmassignworkAction extends Action {
    ...
    private ActionForward xlslCopy(ActionMapping mapping, ActionForm form,
        ...
        KmassignworkForm tawRmModelCopyForm = (KmassignworkForm) form;
    ...
    private ActionForward performSaveassign(ActionMapping mapping,
        ...
        try {
            ...
            AssignType = request.getParameter("assign_type").trim();
            IKmassignworkManager mgr = (IKmassignworkManager) ApplicationContextHolder
                    .getInstance().getBean("IKmassignworkManager");
    ...
    private ActionForward performView(ActionMapping mapping,
        ...
        KmassignworkForm form = (KmassignworkForm) actionForm;
        try {
    ...
    private ActionForward performSave(ActionMapping mapping,
        ...
        try {
            ...
            if (strutsAction == KmassignworkForm.ADD) {
            ...
            } else if (strutsAction == KmassignworkForm.EDIT) {
    ...
    private ActionForward performEdit(ActionMapping mapping,
        ...
        KmassignworkForm form = (KmassignworkForm) actionForm;
        form.setStrutsAction(KmassignworkForm.EDIT);
        try {
    ...
    private ActionForward performAdd(ActionMapping mapping,
                                     ...
                                     HttpServletResponse response) {
        KmassignworkForm form = (KmassignworkForm) actionForm;
        form.setStrutsAction(KmassignworkForm.ADD);
        return mapping.findForward("success");
    }
