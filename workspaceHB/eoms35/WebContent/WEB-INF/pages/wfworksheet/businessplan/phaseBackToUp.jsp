    ...
    <html:form action="/businessplan.do?method=newPerformNonFlow" styleId="theform">
                    ...
                    <table class="listTable">
                        <logic:present name="toOperaterList" scope="request">
                            ...
                            <logic:iterate id="toTask" name="toOperaterList"
                                           type="com.boco.eoms.sheet.businessplan.model.BusinessPlanTask">
                                <tr>
                                    <td>
            ...
            <tr>
                ...
                <td colspan="3">
		           ...
		           <textarea name="${sheetPageName}remark" class="textarea max" id="${sheetPageName}remark"
                             alt="allowBlank:false,maxLength:200,vtext:'${eoms:a2u('请填入操作描述，最大长度为100个汉字！')}'">${sheetlink.remark}</textarea>
                </td>
            </tr>
        </table>
        ...
        <tr>
            ...
            <td colspan="3">
		           ...
		           <textarea name="${sheetPageName}remark" class="textarea max" id="${sheetPageName}remark"
                             alt="allowBlank:false,maxLength:200,vtext:'${eoms:a2u('请填入操作描述，最大长度为100个汉字！')}'"
                   >${sheetlink.remark}</textarea>
            </td>
        </tr>
        </table>
        <%} %>
