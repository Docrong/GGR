...
<script type="text/javascript">
    function showPage() {
        var pars = '';
        var url = '';
        url = '${app}/sheet/resourceconfirm/resourceconfirm.do?method=showInputRejectPage&piid=${sheetMain.piid}&taskId=${taskId}&taskName=${taskName}';
        if (url != '') {
...
<div id="sheetform">
    <html:form action="/resourceconfirm.do?method=performDeal" styleId="theform">
