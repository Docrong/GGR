...
<table class="formTable">
    <input type="hidden" id="tmpCompleteLimit" value=""
           alt="vtype:'moreThen',link:'${sheetPageName}nodeCompleteLimit',vtext:'${eoms:a2u("å¤çæ¶éä¸è½æäºå·¥åå®ææ¶é")}'"/>
    ...
    <c:if test="${sheetMain.type=='commonfault'}">
        ...
        <tr>
            ...
            <td>
                <eoms:comboBox name="linkFaultReasonSort" id="linkFaultReasonSort" initDicId="1010303"
                               defaultValue="${dwpreLink.linkFaultReasonSort}" sub="linkFaultReasonSubsection"
                               alt="allowBlank:false"/>
            </td>
            <td class="label">故障原因细分*</td>
            <td>
                <eoms:comboBox name="linkFaultReasonSubsection" id="linkFaultReasonSubsection"
                               initDicId="${dwpreLink.linkFaultReasonSort}"
        ...
        <tr>
            ...
            <td>
                <c:if test="${!empty dwpreLink.linkFaultIfFinallySolveProject}">
                    <eoms:comboBox name="linkFaultIfFinallySolveProject" id="linkFaultIfFinallySolveProject"
                                   initDicId="10301"
        ...
        <tr>
            ...
            <td>
                <input type="text" class="text" name="linkFaultAffectTimeLength" id="linkFaultAffectTimeLength"
                       alt="allowBlank:true"
        ...
        <tr>
            ...
            <td>
                <input type="text" class="text" name="linkFaultOperRenewTime" readonly="readonly"
                       id="linkFaultOperRenewTime"
        ...
        <tr>
            ...
            <td>
                <input class="text" onclick="popUpCalendar(this, this,null,null,null,true,-1)" type="text"
                       ...
                       value="${eoms:date2String(sheetLink.commonFaultdealTime)}"
                       id="${sheetPageName}commonFaultdealTime" alt="allowBlank:false"/>
            </td>
            <td class="label">故障处理人*</td>
            <td>
                <input type="text" class="text" name="${sheetPageName}commonFaultTreatment"
                       id="${sheetPageName}commonFaultTreatment" value="${sheetLink.commonFaultTreatment}"
                       alt="allowBlank:false"/>
            </td>
        </tr>
        <tr>
            ...
            <td colspan="3">
					  <textarea name="${sheetPageName}commonFaultdealdesc" id="${sheetPageName}commonFaultdealdesc"
                                class="textarea max"
                                alt="allowBlank:false,width:500,maxLength:1000,vtext:'最多输入500汉字'"
                                alt="width:'500px'">${sheetLink.commonFaultdealdesc}</textarea>
            </td>
        ...
        <tr>
            ...
            <td colspan="3">
                <select name="selectStep" onchange="isifdeal(this.value)" alt="allowBlank:false">
                    ...
                    %>
                    <option value="<%=commonFaultDesc%>"><%=commonFaultDesc%>
                    </option>
                    <%
                        }
                    } else {
        ...
        <tr id="isIfDeal" style="display:none">
            ...
            <td colspan="3">
                <textarea name="${sheetPageName}commonLinkDealdesc" id="${sheetPageName}commonLinkDealdesc"
                          class="textarea max" alt="allowBlank:true,width:500,maxLength:1000,vtext:'最多输入500汉字'"
                          alt="width:'500px'">${sheetLink.commonLinkDealdesc}</textarea>
    ...
    <c:if test="${sheetMain.type=='complaint'}">
        <tr>
            ...
            <td>
                <input type="text" class="text" name="linkComContactUser" id="linkComContactUser"
                       value="${dwpreLink.linkComContactUser}"/>
            </td>
            <td class="label">联系人电话*</td>
            <td>
                <input type="text" class="text" name="linkComContactPhone" id="linkComContactPhone"
                       value="${dwpreLink.linkComContactPhone}"/>
            </td>
        </tr>
        <tr>
            <td class="label">投诉性质*</td>
            <td>
                <eoms:comboBox name="linkComcompProp" id="linkComcompProp" initDicId="1010610"
                               defaultValue="${dwpreLink.linkComcompProp}"/>
            </td>
            <td class="label">是否已答复客户*</td>
            <td>
                <c:if test="${!empty dwpreLink.linkComIsContactUser}">
                    <eoms:comboBox name="linkComIsContactUser" id="linkComIsContactUser" initDicId="10301"
                                   defaultValue="${dwpreLink.linkComIsContactUser}"/>
                </c:if>
                <c:if test="${empty dwpreLink.linkComIsContactUser}">
                    <eoms:comboBox name="linkComIsContactUser" id="linkComIsContactUser" initDicId="10301"
                                   defaultValue="1030102"/>
        ...
        <tr>
            ...
            <td>
                <eoms:comboBox name="linkComdealResult" id="linkComdealResult" initDicId="1010611"
                               defaultValue="${dwpreLink.linkComdealResult}"/>
            </td>
        </tr>
        <tr>
    ...
    <tr>
        ...
        <td colspan="3">
    				  <textarea class="textarea max" name="${sheetPageName}linkComUntreadReason"
                                id="${sheetPageName}linkComUntreadReason"
    ...
    <tr>
        ...
        <td colspan="3">
            ...
            <textarea name="${sheetPageName}remark" class="textarea max" id="${sheetPageName}remark"
                      alt="allowBlank:false,width:500,maxLength:2000,vtext:'${eoms:a2u('è¯·æå¤è¾å¥1000æ±å­')}'"
    ...
    <tr>
        ...
        <td colspan="3">
		        <textarea name="${sheetPageName}remark" class="textarea max" id="${sheetPageName}remark"
                          alt="allowBlank:false,width:500,vtext:'${eoms:a2u('è¯·æå¤è¾å¥1000å­')}'"
                          alt="width:'500px'">${sheetLink.remark}</textarea>
        </td>
    </tr>
