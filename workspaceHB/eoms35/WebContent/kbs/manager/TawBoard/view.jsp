                    ...
                    <td>
                        ...
                        <table border="0" width="500" cellspacing="1" cellpadding="1" class="table_show" align=center>
                            <logic:present name="tawBoardForm" scope="request">
                                <tr class="tr_show">
                                    <td width="5%"></td>
                                    <td width="19%" class="clsfth"><bean:message key="TawBoard.boardId"/></td>
                                    <td width="76%">
                                ...
                                <tr class="tr_show">
                                    <td width="5%"></td>
                                    <td width="19%" class="clsfth"><bean:message key="TawBoard.parentId"/></td>
                                    <td width="76%">
                                ...
                                <tr class="tr_show">
                                    <td width="5%"></td>
                                    <td width="19%" class="clsfth">\u4E3B\u9898\u7F16\u7801</td>
                                    <td width="76%">
                                ...
                                <tr class="tr_show">
                                    <td width="5%"></td>
                                    <td width="19%" class="clsfth"><bean:message key="TawBoard.boardName"/></td>
                                    <td width="76%">
                                ...
                                <tr class="tr_show">
                                    <td width="5%"></td>
                                    <td width="19%" class="clsfth"><bean:message key="TawBoard.boardAdmin"/></td>
                                    <td width="76%">
                                ...
                                <tr class="tr_show">
                                    <td width="5%"></td>
                                    <td width="19%" class="clsfth"><bean:message key="TawBoard.deptId"/></td>
                                    <td width="76%">
                                ...
                                <tr class="tr_show">
                                    <td width="5%"></td>
                                    <td width="19%" class="clsfth"><bean:message key="TawBoard.operSendNo"/></td>
                                    <td width="76%">
                                ...
                                <tr class="tr_show">
                                    <td width="5%"></td>
                                    <td width="19%" class="clsfth"><bean:message key="TawBoard.operCheckNo"/></td>
                                    <td width="76%">
                                ...
                                <tr class="tr_show">
                                    <td width="5%"></td>
                                    <td width="19%" class="clsfth"><bean:message key="TawBoard.operReadNo"/></td>
                                    <td width="76%">
                                ...
                                <tr class="tr_show">
                                    <td width="5%"></td>
                                    <td width="19%" class="clsfth"><bean:message key="TawBoard.editSelfNo"/></td>
                                    <td width="76%">
                                ...
                                <tr class="tr_show">
                                    <td width="5%"></td>
                                    <td width="19%" class="clsfth"><bean:message key="TawBoard.editNo"/></td>
                                    <td width="76%">
                                ...
                                <tr class="tr_show">
                                    <td width="5%"></td>
                                    <td width="19%" class="clsfth"><bean:message key="TawBoard.delNo"/></td>
                                    <td width="76%">
                                ...
                                <tr class="tr_show">
                                    <td width="5%"></td>
                                    <td width="19%" class="clsfth"><bean:message key="TawBoard.createTime"/></td>
                                    <td width="76%">
                                ...
                                <tr class="tr_show">
                                    <td width="5%"></td>
                                    <td width="19%" class="clsfth"><bean:message key="TawBoard.modiTime"/></td>
                                    <td width="76%">
                                ...
                                <tr class="tr_show">
                                    <td width="5%"></td>
                                    <td width="19%" class="clsfth"><bean:message key="TawBoard.childNum"/></td>
                                    <td width="76%">
                                ...
                                <tr class="tr_show">
                                    <td width="5%"></td>
                                    <td width="19%" class="clsfth"><bean:message key="TawBoard.articleNum"/></td>
                                    <td width="76%">
                                ...
                                <tr class="tr_show">
                                    <td width="5%"></td>
                                    <td width="19%" class="clsfth"><bean:message key="TawBoard.infoType"/></td>
                                    <td width="76%">
                                ...
                                <tr class="tr_show">
                                    <td width="5%"></td>
                                    <td width="19%" class="clsfth"><bean:message key="TawBoard.comments"/></td>
                                    <td width="76%">
                                ...
                                <tr class="tr_show">
                                    <td width="5%"></td>
                                    <td width="19%" class="clsfth"><bean:message key="TawBoard.operType"/></td>
                                    <td width="76%">
                                ...
                                <tr class="tr_show">
                                    <td width="5%"></td>
                                    <td width="19%" class="clsfth"><bean:message key="TawBoard.deleted"/></td>
                                    <td width="76%">
