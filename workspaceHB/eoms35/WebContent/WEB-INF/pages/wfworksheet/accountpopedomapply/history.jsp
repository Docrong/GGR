...
<div id="history" class="panel">
    ...
    <logic:present name="HISTORY" scope="request">
        <logic:iterate id="baselink" name="HISTORY"
                       type="com.boco.eoms.sheet.accountpopedomapply.model.AccountPopedomApplyLink">
            <%
                jNum += 1;
            ...
            <div class="history-item"><!-- add space to hack ie-->&nbsp;
                <div class="history-item-title">
                    ...
                    <eoms:dict key="dict-sheet-accountpopedomapply" dictId="activeTemplateId"
                               itemId="${baselink.activeTemplateId}" beanId="id2descriptionXML"/>
                    <bean:message bundle="sheet" key="sheet.deal"/>:
                    <eoms:dict key="dict-sheet-accountpopedomapply" dictId="mainOperateType"
                    ...
                    <table class="history-item-table" width="100%" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td class="label"><bean:message bundle="accountpopedomapply"
                                                            key="accountpopedomapply.link.applyAttitude"/></td>
                        ...
                        <tr>
                            <td class="label"><bean:message bundle="accountpopedomapply"
                                                            key="accountpopedomapply.link.applyResult"/></td>
                            <td class="column-content" colspan="3">
                        ...
                        <tr>
                            <td class="label"><bean:message bundle="accountpopedomapply"
                                                            key="accountpopedomapply.link.deResult"/></td>
                            <td colspan="3">
