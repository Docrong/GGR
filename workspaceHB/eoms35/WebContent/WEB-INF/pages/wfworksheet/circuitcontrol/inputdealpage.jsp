 			   		...
 			   		<% if(operateType.equals("101")){ %>
 			   			<fieldset>
							  ...
							  <div class="x-form-item" >
									...
									<eoms:chooser id="FirstApproval0"  type="role" roleId="1942" flowId="619" config="{returnJSON:true,showLeader:true}"  
 			   		...
 			   		<% if(operateType.equals("102")){ %>
 			   			<fieldset>
							  ...
							  <div class="x-form-item" >
									...
									<eoms:chooser id="SecondApproval0"  type="role" roleId="1940" flowId="619" config="{returnJSON:true,showLeader:true}"  
									   category="[{id:'dealPerformer',text:'派发',limit:'none',allowBlank:false,vtext:'请选择派发对象'},{id:'copyPerformer',childType:'user,subrole',limit:'none',text:'抄送'}]" 
									  data="${sendUserAndRoles}" />
