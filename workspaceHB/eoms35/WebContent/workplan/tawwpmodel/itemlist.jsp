...
<form name="modelexecutelist">
    ...
    <table width="100%" class="listTable" id="list-table">
        ...
        %>
        <tr>
            <td><%=tawwpModelExecuteVO.getName()%>
            </td>
            <td><%=tawwpModelExecuteVO.getCycleName()%>
            </td>
            <td><%=tawwpModelExecuteVO.getFormat()%>
            </td>
            <td>
                <a target="_blank"
                   href="../tawwpaddons/addonsread.do?action=read&window=new&myid=&model=50&addonsid=<%=tawwpModelExecuteVO.getFormId()%>&reaction=/tawwpaddons/addonslist.do">
    ...
    <input type="button" Class="button" value="<bean:message key="itemlist.tawwpmodel.btnAdd" />"
           onclick="javascript:onModelPlanAdd();">
    <input type="button" Class="button" value="<bean:message key="itemlist.tawwpmodel.btnBack" />"
