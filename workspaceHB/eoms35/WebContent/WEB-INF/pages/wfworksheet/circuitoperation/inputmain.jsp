...
<table class="formTable">
    ...
    <tr>
        ...
        <td class="content">
            <input type="text" class="text" name="${sheetPageName}mainAContact" id="${sheetPageName}mainAContact"
                   alt="allowBlank:false,maxLength:25,vtext:'请填入A施工联系人，最多输入25字'" value="${sheetMain.mainAContact}"/>
        </td>
        <td class="label"><bean:message bundle="circuitoperation" key="circuitoperation.mainAContactTel"/>*</td>
        <td class="content">
            <input type="text" class="text" name="${sheetPageName}mainAContactTel" id="${sheetPageName}mainAContactTel"
                   alt="allowBlank:false,maxLength:25,vtext:'请填入A施工业务联系电话，最多输入25字'"
                   value="${sheetMain.mainAContactTel}"/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td colspan="3">
            <textarea name="${sheetPageName}mainRequireUse" id="${sheetPageName}mainRequireUse" class="textarea max"
                      alt="allowBlank:false,maxLength:255,vtext:'请填入需求用途，最多输入255个字符'">${sheetMain.mainRequireUse}</textarea>
        </td>
    </tr>
    <tr>
        <td class="label"><bean:message bundle="circuitoperation" key="circuitoperation.mainRequireDesc"/>*</td>
        <td colspan="3">
            <textarea name="${sheetPageName}mainRequireDesc" id="${sheetPageName}mainRequireDesc" class="textarea max"
                      alt="allowBlank:false,maxLength:255,vtext:'请填入需求描述，最多输入255个字符'">${sheetMain.mainRequireDesc}</textarea>
        </td>
    </tr>
    <tr>
        <td class="label">
