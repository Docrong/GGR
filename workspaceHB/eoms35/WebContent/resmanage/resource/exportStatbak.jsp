    ...
    <tr>
        <td align=center>
            <form name=file style='display:none'>
                <INPUT TYPE="button" value="Êý¾Ýµ¼³öµ½Excel" name=bo onclick="showExcel(arRS,'Í³¼Æ½á¹û');"></form>
        </td>
    </tr>
</table>
<script language=javascript>
...
<div id="showExceldiv" style="display:none" align="center">
    <object classid="clsid:0002E510-0000-0000-C000-000000000046" id="Spreadsheet1" codebase="" width="100%"
            height="1400">
    </object>
</div>
</body>
