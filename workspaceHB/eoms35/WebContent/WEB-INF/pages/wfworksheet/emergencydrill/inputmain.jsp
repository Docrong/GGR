...
<input type="hidden" name="${sheetPageName}linkClassName"
       value="com.boco.eoms.sheet.emergencydrill.model.EmergencyDrillLink"/><br/>
<!-- sheet info -->
    ...
    <c:if test="${status!=1}">
        ...
        <tr>
            ...
            <td class="content">
                <eoms:comboBox name="${sheetPageName}mainEmergencySortOne" id="${sheetPageName}mainEmergencySortOne"
                               sub="${sheetPageName}mainEmergencySortTwo" initDicId="1010801"
                               defaultValue="${sheetMain.mainEmergencySortOne}" alt="allowBlank:false"/>
            </td>
            ...
            <td class="content">
                <eoms:comboBox name="${sheetPageName}mainEmergencySortTwo" id="${sheetPageName}mainEmergencySortTwo"
                               initDicId="${sheetMain.mainEmergencySortOne}"
                               defaultValue="${sheetMain.mainEmergencySortTwo}" alt="allowBlank:false"/>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="content" colspan="3">
                <textarea class="textarea max" name="${sheetPageName}mainRemarks" id="${sheetPageName}mainRemarks"
                          alt="width:500,allowBlank:true,maxLength:255,vtext:'请填入备注，最多输入125字'">${sheetMain.mainRemarks}</textarea>
            </td>
        </tr>
        <tr>
            <td class="label">
