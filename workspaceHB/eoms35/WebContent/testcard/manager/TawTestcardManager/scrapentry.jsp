...
<html:form method="post" action="/TawTestcardManager/scrapsave" onsubmit="return check(this);">
    ...
    <table cellSpacing="0" class="formTable" cellPadding="2" width="35%" border="1" align="center">
        <tr>
            <td colspan="4" height="25" valign="middle" align="center"><font size="-1"><b>
        ...
        <tr>
            ...
            <td width="380">
                ...
                <input type="text" name="leantime" size="30" onclick="popUpCalendar(this, this,null,null,null,true,-1);"
                       readonly="true"
                       class="text">
            </td>
        </tr>
