...
<div align="center">
    <center>
        ...
        <table class="listTable" border="0" width="95%" cellspacing="1" cellpadding="1" class="table_show"
               align="center">
            <tr class="td_label">
            ...
            <logic:iterate id="taworder" name="taworder" type="com.boco.eoms.sparepart.model.TawOrder">
                <tr class="tr_show">
                    ...
                    <td><p align="center"><html:link page="/part/backcontent.do" paramId="id" paramName="taworder"
                                                     paramProperty="id">
