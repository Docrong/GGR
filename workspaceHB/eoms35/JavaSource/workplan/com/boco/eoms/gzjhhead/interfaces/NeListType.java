...
public class NeListType  implements java.io.Serializable {
    ...
    public com.boco.eoms.gzjhhead.interfaces.NeNumberType[] getNeNumber() {
        return neNumber;
    }

    public void setNeNumber(com.boco.eoms.gzjhhead.interfaces.NeNumberType[] neNumber) {
        this.neNumber = neNumber;
    }

    public com.boco.eoms.gzjhhead.interfaces.NeNumberType getNeNumber(int i) {
        return neNumber[i];
    }

    public void setNeNumber(int i, com.boco.eoms.gzjhhead.interfaces.NeNumberType value) {
