...
<div class="list">
    <html:form action="/saveTawSuppKpiInstReportOrder.do?method=save" method="post"
        ...
        <table>
            ...
            <tr height="50">
                ...
                <td colspan="3">
                    <input type="text" class="text" name="reportName" value="${requestScope.reportName}"
                           style="width:88%"/>
                </td>
            </tr>
            ...
            <tr height="50">
                ...
                <td>
                    <input type="text" name="reportStartTime" id="reportStartTime" class="text"
                           ...
                           value="${requestScope.reportStartTime}"/>
                </td>
                ...
                <td>
                    <input type="text" name="reportEndTime" id="fillEndTime" class="text"
                           ...
                           onclick="popUpCalendar(this, this,null,null,null,true,-1);"
                           value="${requestScope.reportEndTime}"/>
                </td>
            ...
            <tr align="right" height="40">
                <td colspan="4">
                    <input type="submit" class="btn" property="method.save" styleId="method.save"
