...
<%
 ...
 %>
		...
		<input type="hidden" name="linkBeanId" id="linkBeanId" value="iPlannConfirmLinkManager"/>
	  ...
	  <td colspan="3">
	     ...
	     <c:if test="${empty sheetMain.sendRoleId}">       
	        ...
	        <eoms:roleComboBox name="sendRoleId" id="sendRoleId" 
		  	  userId="${sheetMain.sendUserId}" roleId="1870" defaultValue="${sheetMain.sendRoleId}"/>     
	     </c:if>
	     <c:if test="${!empty sheetMain.sendRoleId}">
	...
	<tr>
	   ...
	   <td >
	    <input type="text" class="text" name="sendTime" readonly="readonly" 
						...
						onclick="popUpCalendar(this, this)" alt="allowBlank:false" disabled="disabled"/> 	
	   </td>
	 </tr>
