...
<form name="workflowForm" method="post">
    <table class="listTable">
        ...
        %>            故障处理工单<a href="${app}<%=url%>"
                               target="blank"><%=tawwpWorkflow.getFlowId() + tawwpWorkflow.getFlowType()%>
    </a><br>

        <%
        } else {
            url = "#";
        %>          网优工单<a href='<%=url%>' target="blank"><%=tawwpWorkflow.getFlowId() + tawwpWorkflow.getFlowType()%>
    </a><br>
