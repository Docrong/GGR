    ...
    <form method="post" action="../part/add.do" name="frm" onsubmit="return checkdata()">
        ...
        <table border="0" width="80%" cellspacing="1" cellpadding="1" class="table_show" align=center>
            ...
            <tr class="tr_show">
                <td class="clsfth" width="30%" height="25">
                    <p style="margin-top: 0; margin-bottom: 0"><bean:message
                            key="sparepart.objectname"/>${eoms:a2u('：')}</p>
                </td>
                <td width="70%" height="25" colspan="2">
                    <input type="text" size="35" value="<bean:write name='ename' scope='request' filter='false'/>"
                           maxlength="50" name="ename">
                </td>
            </tr>
            <tr class="tr_show">
                <td class="clsfth" width="30%" height="25">
                ...
                <td width="70%" height="25" colspan="2">
                    <select name="supplier" size="1" style="width: 6.8cm;">
                        ...
                        <logic:iterate id="supplier" name="supplier" type="com.boco.eoms.sparepart.model.TawClassMsg">
                            <option value="<bean:write name="supplier" property="id" scope="page"/>"><bean:write
                                    name="supplier" property="cname" scope="page"/></option>
                        </logic:iterate>
                    </select>
                </td>
            </tr>
            <tr class="tr_show">
                <td class="clsfth" width="30%" height="25"><bean:message
                        key="sparepart.productcode"/>${eoms:a2u('：')}</td>
                <td width="70%" height="25" colspan="2">
                    <input value="<bean:write name='productcode' scope='request' filter='false'/>" type="text"
                           name="productcode" size="35" maxlength="255">
            ...
            <tr class="tr_show">
                ...
                <td width="70%" height="25" colspan="2">
                    <input type="text" size="35" value="<bean:write name='managecode' scope='request' filter='false'/>"
                           maxlength="50" name="managecode">
                    <font color="#FF0000">**</font></td>
            </tr>
            <tr class="tr_show">
                <td class="clsfth" width="30%" height="25"><bean:message key="sparepart.serialno"/>${eoms:a2u('：')}</td>
                <td width="70%" height="25" colspan="2">
                    <input type="text" value="<bean:write name='serialno' scope='request' filter='false'/>"
                           name="serialno" size="35" maxlength="255">
                    <font color="#FF0000">**</font>
                </td>
            </tr>
            <tr class="tr_show">
                ...
                <td width="70%" height="25" colspan="2">
                    <input type="text" value="<bean:write name='operator' scope='request' filter='false'/>"
                           name="operator" size="35" maxlength="255">
                </td>
            </tr>
            <tr class="tr_show">
                <td class="clsfth" width="30%" height="25">
            ...
            <tr class="tr_show">
                ...
                <td width="70%" height="25" colspan="2">
                    <input type="text" size="35" value="<bean:write name='note' scope='request' filter='false'/>"
        ...
        <table border="0" width="80%" cellspacing="0">
            <tr>
                <td height="32" align="right">
                    ...
                    &nbsp;&nbsp;
                    <input type="submit" value="<bean:message key="label.resubmit"/>" name="reset"
                           onclick="frm.differ.value=2" class="clsbtn2">
                    &nbsp;&nbsp;
                </td>
            </tr>
        </table>
