/*******************************************************************************
		网页表格控件程序 由BOCO设计于2003年12月-2004年1月，保留所有权利！
*********************************************************************************/
...
try{
	...
	if(!document.getElementById){throw new Error(999,"Your browser dosen't support TableControl function,IE5.0+ is recommended.");}
	...
	var load_js=function (src)
	{
		...
		for(var i=0;i<script.length;i++)
		{
			...
			if(s.indexOf("TableControl.js")!=-1){jsPath=s.replace("TableControl.js","")}
		}
	...
	with(tc.col[i])
	{
		...
		onmousemove=function(){this.style.cursor="hand"}
	}}
