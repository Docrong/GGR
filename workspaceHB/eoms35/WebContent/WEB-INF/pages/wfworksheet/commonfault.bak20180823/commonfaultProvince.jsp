...
<br/>
  ...
  <table class="formTable"> 
	  ...
	  <tr>
		...
		<td class="content"><%=id2NameService.id2Name(basemain.getMainNetSortOne(),"ItawSystemDictTypeDao")%></td>
		<td class="label">网络分类(二级)</td>
		<td class="content"><%=id2NameService.id2Name(basemain.getMainNetSortTwo(),"ItawSystemDictTypeDao")%></td>
	  </tr>
      <tr>
		<td class="label">网络分类(三级)</td>
		<td class="content"><%=id2NameService.id2Name(basemain.getMainNetSortThree(),"ItawSystemDictTypeDao")%></td>
		
		<td class="label">故障处理响应级别</td>
		<td class="content"><%=id2NameService.id2Name(basemain.getMainFaultResponseLevel(),"ItawSystemDictTypeDao")%></td>
      ...
      <tr>    
		...
		<td class="content"><%=id2NameService.id2Name(basemain.getMainSendMode(),"ItawSystemDictTypeDao")%></td> 
      ...
      <tr>
		...
		<td class="content"><%=id2NameService.id2Name(basemain.getMainEquipmentFactory(),"ItawSystemDictTypeDao")%></td>      
      ...
      <tr>
		...
		<td class="content"><%=id2NameService.id2Name(basemain.getToDeptId(),"tawSystemAreaDao")%></td>
	  </tr>

      <tr>
      <td class="label">故障发生时间</td>
		<td class="content"><%=StaticMethod.date2String(basemain.getMainFaultGenerantTime())%></td>
      <td class="label">故障发现方式</td>
	   ...
	   <tr>
		 ...
		 <td class="content"><%=id2NameService.id2Name(basemain.getMainIfAffectOperation(),"ItawSystemDictTypeDao")%></td>
	      <td class="label">是否预处理</td>
		<td class="content"><%=id2NameService.id2Name(basemain.getMainPretreatment(),"ItawSystemDictTypeDao")%></td>
