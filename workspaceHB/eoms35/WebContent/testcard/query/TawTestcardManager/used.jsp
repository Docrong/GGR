        ...
        <caption>
            ...
            <caption>
                ...
                <tr>
                    ...
                    <td width="200">
                        <input name="fromtime" id="fromtime" onclick="popUpCalendar(this, this,null,null,null,true,-1);"
                               readonly="readonly"
                ...
                <tr>
                    ...
                    <td width="200">
                        <input name="totime" id="totime" style="clstext"
                               onclick="popUpCalendar(this, this,null,null,null,true,-1);"
                               readonly="readonly"
                               alt="vtype:'moreThen',link:'fromtime',vtext:'${eoms:a2u("不得早于开始时间")}'"/>
                    </td>
                </tr>
                <tr>
                    <td colspan=2>
