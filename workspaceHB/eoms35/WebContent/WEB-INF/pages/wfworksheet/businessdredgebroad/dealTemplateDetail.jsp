    ...
    <table class="formTable">
        ...
        <tr>
            ...
            <td class="label"><bean:message bundle="businessdredgebroad"
                                            key="businessdredgebroad.ndeptContactPhone"/>*
            </td>
        ...
        <logic:equal value="101100102" property="businesstype1" name="sheetMain">
            <tr>
                <td class="label"><bean:message bundle="businessdredgebroad"
                                                key="businessdredgebroad.loginUserName"/>*
                </td>
        ...
        <logic:equal value="101100104" property="businesstype1" name="sheetMain">
            <tr>
                <td class="label"><bean:message bundle="businessdredgebroad"
                                                key="businessdredgebroad.expectFinishdays"/>*
                </td>
                <td class="content"><input type="text" class="text" name="${sheetPageName}expectFinishdays"
                                           ...
                                           alt="allowBlank:false"/></td>
                <td class="label"><bean:message bundle="businessdredgebroad" key="businessdredgebroad.circuitCode"/>*
                </td>
            ...
            <tr>
                <td class="label"><bean:message bundle="businessdredgebroad"
                                                key="businessdredgebroad.netResCapacity"/>*
                </td>
        ...
        <tr>
            <td class="label"><bean:message bundle="businessdredgebroad" key="businessdredgebroad.holdStatisfied"/>*
            </td>
            <td colspan="3">
