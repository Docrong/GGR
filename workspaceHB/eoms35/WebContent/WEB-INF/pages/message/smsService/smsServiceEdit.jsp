...
<script language="javascript">
    ...
    Ext.onReady(function () {
        ...
        userTree = new xbox({
            ...
            treeRootId: '-1',
            treeRootText: '<bean:message key="smsService.servicename"/>',
            treeChkMode: '',
            treeChkType: 'user,dept',
            viewer: userViewer,
            saveChkFldId: 'usersId',
            returnJSON: true
        });
    })
</script>
    ...
    <table class="formTable">
        <tr>
            ...
            <td class="content">
                <html:text property="name" styleClass="text"
                           alt="allowBlank:false,vtext:'${eoms:a2u('请输入服务名称')}'"></html:text>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="label">
                ...
                <input type="button" value="<bean:message key='smsService.modifyuserlist'/>" id="userTreeBtn"
                       class="btn"/>
                <html:checkbox styleId="selStatus" property="selStatus" onclick="modifyTitle()">&nbsp;<bean:message
                        key='smsService.selstatus'/></html:checkbox>
            </td>
        </tr>
        <tr>
            <td class="label">
            ...
            <td class="content">
                <eoms:dict key="dict-msg" dictId="msgType" isQuery="false" defaultId="${smsServiceForm.msgType}"
                           selectId="msgType" beanId="selectXML"/>
        ...
        <tr>
            ...
            <td class="content">
                <html:text property="count" styleClass="text"
                           alt="vtype:'number',vtext:'${eoms:a2u('必须输入数字')}',allowBlank:false"></html:text>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="content">
                <html:text property="interval" styleClass="text"
                           alt="vtype:'number',vtext:'${eoms:a2u('必须输入数字')}',allowBlank:false"></html:text>
        ...
        <tr>
            <td class="label">
                <html:checkbox styleId="isSendNight" property="isSendNight" onclick="setValue(this)"><bean:message
                        key='smsService.issendnight'/></html:checkbox>
            </td>
            <td class="content">
                <html:checkbox styleId="isSendImediat" property="isSendImediat" onclick="setValue(this)"><bean:message
                        key='smsService.issendimediat'/></html:checkbox>
            </td>
        </tr>
        <tr>
            <td class="label">
        ...
        <tr>
            ...
            <td class="content">
                <input type="text" name="startTime" class="text"
                       value="<bean:write format='yyyy-MM-dd hh:mm:ss' name='smsServiceForm' property='startTime'/>"
        ...
        <tr>
            ...
            <td class="content">
                <input type="text" name="endTime" class="text"
                       value="<bean:write format='yyyy-MM-dd hh:mm:ss' name='smsServiceForm' property='endTime'/>"
                       onclick="popUpCalendar(this, this);" readonly="true"/>
        ...
        <tr>
            ...
            <td class="content">
                <table class="formtable">
                    <tr>
                        <td>
                            <html:text property="sendDay" size="3"
                                       alt="vtype:'number',vtext:'${eoms:a2u('必须输入数字')}',allowBlank:false"></html:text>
                        </td>
                        <td>
                        ...
                        <td>
                            <html:text property="sendHour" size="3"
                                       alt="vtype:'number',vtext:'${eoms:a2u('必须输入数字')}',allowBlank:false"></html:text>
                        </td>
                        <td>
                        ...
                        <td>
                            <html:text property="sendMin" size="3"
                                       alt="vtype:'number',vtext:'${eoms:a2u('必须输入数字')}',allowBlank:false"></html:text>
                        </td>
                        <td>
                        ...
                        <td class="label">
                            <html:radio property="sendStatus" value="1" onclick="setSendValue(this)"><bean:message
                                    key='smsService.sendimediat'/></html:radio>
                        </td>
                        <td class="label">
                            <html:radio property="sendStatus" value="2" onclick="setSendValue(this)"><bean:message
                                    key='smsService.sendforward'/></html:radio>
                        </td>
                        <td class="label">
                            <html:radio property="sendStatus" value="3" onclick="setSendValue(this)"><bean:message
                                    key='smsService.senddelay'/></html:radio>
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr id="issend" style="display:none">
            <td class="label" colspan="3">
                <table>
                    <tr>
                        <td class="label">
                            <html:radio property="cycleStatus" value="1" onclick="control(this)">&nbsp;<bean:message
                                    key='smsService.yearcycle'/></html:radio>
                        </td>
                        <td class="label">
                            <html:radio property="cycleStatus" value="2" onclick="control(this)">&nbsp;<bean:message
                                    key='smsService.monthcycle'/></html:radio>
                        </td>
                        <td class="label">
                            <html:radio property="cycleStatus" value="3" onclick="control(this)">&nbsp;<bean:message
                                    key='smsService.daycycle'/></html:radio>
                        </td>
                    </tr>
                    <tr>
                        <td class="label">
                            <eoms:dict key="dict-msg" dictId="month" isQuery="false"
                                       defaultId="${smsServiceForm.cycleMonth}" selectId="cycleMonth"
                                       beanId="selectXML"/>
                            &nbsp;<bean:message key='smsService.month'/>
                        </td>
                        <td class="label">
                            <eoms:dict key="dict-msg" dictId="day" isQuery="false"
                                       defaultId="${smsServiceForm.cycleDay}" selectId="cycleDay" beanId="selectXML"/>
                            &nbsp;<bean:message key='smsService.day'/>
                        </td>
                        <td class="label">
                            <eoms:dict key="dict-msg" dictId="hour" isQuery="false"
                                       defaultId="${smsServiceForm.cycleHour}" selectId="cycleHour" beanId="selectXML"/>
                            &nbsp;<bean:message key='smsService.hour'/>
                        </td>
                    </tr>
                    <tr colspan="3">
                        <td>
                            <html:checkbox styleId="regetData" property="regetData" value="0" onclick="controlSoap()">&nbsp;<bean:message
                                    key='smsService.regetdata'/></html:checkbox>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="3">
                            <table>
                                <tr>
                                    ...
                                    <td class="label" id="soap" style="display:none">
                                        <eoms:dict key="dict-msg" dictId="soapType" isQuery="false"
                                                   defaultId="${smsServiceForm.regetProtocol}" selectId="regetProtocol"
                                                   beanId="selectXML"/>
                                    </td>
                                </tr>
                            </table>
