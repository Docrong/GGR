...
values ('xls,txt,doc,jpg,gif', 'securityobjattribute', '安全对象属性信息变更审批工单流程', 1024, '/sheet/securityobjattribute', 30,
        '40287d8c5ba33494015ba33494530011');
...
values ('40287d8c5ba33494015ba33494540012', '4401', '1', '新增工单', '44', null,
...
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d8c5ba33494015ba33494540014', '440301', '1', '待办工单', '4403', null,
        '/sheet/securityobjattribute/securityobjattribute.do?method=showListsendundo', '0', '0', 1);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d8c5ba33494015ba33494540015', '4407', '1', '工单查询', '44', null,
        '/sheet/securityobjattribute/securityobjattribute.do?method=showQueryPage', '0', '0', 7);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d8c5ba33494015ba33494540016', '4408', '1', '工单处理模板', '44', null,
        '/sheet/securityobjattribute/securityobjattribute.do?method=getDealTemplatesByUserId&type=templateManage', '0',
        '0', 8);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d8c5ba33494015ba33494540017', '4409', '1', '工单模板管理', '44', null,
        '/sheet/securityobjattribute/securityobjattribute.do?method=getTemplatesByUserId&type=templateManage', '0', '0',
        9);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d8c5ba33494015ba33494540018', '4410', '1', '管理者工单', '44', null,
        '/sheet/securityobjattribute/securityobjattribute.do?method=showListForAdmin', '0', '0', 10);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d8c5ba33494015ba33494540019', '44', '0', '安全对象属性信息变更审批工单流程', '10', null,
        '/sheet/securityobjattribute/securityobjattribute.do?method=showDrawing', '0', '0', 20);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d8c5ba33494015ba3349454001a', '4402', '1', '草稿列表', '44', null,
