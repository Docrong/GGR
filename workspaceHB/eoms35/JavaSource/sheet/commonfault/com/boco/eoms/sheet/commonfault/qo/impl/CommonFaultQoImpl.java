    ...
    public String getClauseSql(Map properties) {
        ...
        while (names.hasNext()) {
            ...
            if (name != null && !name.equals("") && name.indexOf("Expression") == -1 && name.indexOf(".") > -1) {
                ...
                } else if (!StaticMethod.nullObject2String(properties.get(columnName + "StartDateExpression")).equals(""))
                    dateExpression(properties, columnName, where, name, dataBaseTypeAdapterQO);
                else if (!StaticMethod.nullObject2String(properties.get(columnName + "StartNumberExpression")).equals(""))
                    numberExpression(properties, columnName, where, name);
                else if (!StaticMethod.nullObject2String(properties.get(columnName + "OrderExpression")).equals(""))
                    orderExpression(properties, columnName, orderWhere, name);
                else if (!StaticMethod.nullObject2String(properties.get(columnName + "ChoiceExpression")).equals(""))
