...
<div id="sheetform">
    <html:form action="/softwareLoad.do?method=performBatchDeal" styleId="theform">
            ...
            <div id="sheetinfo">
                <logic:present name="sheetMain" scope="request">
                    ...
                    <table class="formTable">
                        ...
                        <tr>
                            <td class="label"><bean:message bundle="softwareLoad" key="softwareLoad.mainNetSort1"/></td>
                            <td class="content">
                                <eoms:id2nameDB id="${sheetMain.mainNetSort1}" beanId="ItawSystemDictTypeDao"/>
                            </td>
                            <td class="label"><bean:message bundle="softwareLoad" key="softwareLoad.mainNetSort2"/></td>
                            <td class="content">
                        ...
                        <tr>
                            <td class="label"><bean:message bundle="softwareLoad" key="softwareLoad.mainNetSort3"/></td>
                            <td class="content">
                                <eoms:id2nameDB id="${sheetMain.mainNetSort3}" beanId="ItawSystemDictTypeDao"/>
                            </td>
                            <td class="label"><bean:message bundle="softwareLoad" key="softwareLoad.mainTaskType"/></td>
                            <td class="content">
                        ...
                        <tr>
                            <td class="label"><bean:message bundle="softwareLoad"
                                                            key="softwareLoad.mainTaskDescription"/></td>
                        ...
                        <tr>
                            ...
                            <td colspan='3'>
                                <eoms:attachment name="sheetMain" property="sheetAccessories"
                                                 scope="request" idField="sheetAccessories" appCode="softwareLoad"
                                                 viewFlag="Y"/>
                            </td>
                        </tr>
                    </table>
            ...
            <logic:present name="tasks" scope="request">
                ...
                <table class="listTable" width="100%" cellpadding="0" cellspacing="0">
                    ...
                    <logic:iterate name="tasks" id="task">
                        <tr>
                            <td><input type="checkbox" name="ids" value="${task.id}"
                                       toOrgRoleId="${task.id}|${task.preDealUserId}"
                                       toSelfRoleId="${task.id}|${task.operateRoleId}"></td>
                            <td>
        ...
        <div id="sheetinfo">
            <table class="formTable">
                ...
                <tr>
                    ...
                    <td class="content">
                        <select id="dealSelector" onchange="checkValue(this)" alt="allowBlank:false,vtext:'请选择处理操作'">
                            <option value=""></option>
                            <option value="Receive"><bean:message bundle="softwareLoad"
                                                                  key="softwareLoad.dealrejectpass"/></option>
                            <option value="ExcuteHumTask"><bean:message bundle="softwareLoad"
                                                                        key="softwareLoad.nopassback"/></option>
                        </select>
                    </td>
                    <td class="label"></td>
                    <td class="content">
                        ...
                        <input type="hidden" name="beanId" value="iSoftwareLoadMainManager"/>
                ...
                <tr>
                    <td class="label"><bean:message bundle="softwareLoad" key="softwareLoad.advice"/>*</td>
                    <td colspan="3">
                        <textarea class="textarea max" name="linkTaskComplete" id="linkTaskComplete"
                                  alt="allowBlank:false,width:500,maxLength:1000,vtext:'请填入备注，最多输入1000个字符'"></textarea>
                    </td>
                </tr>
            </table>
            <br/>
