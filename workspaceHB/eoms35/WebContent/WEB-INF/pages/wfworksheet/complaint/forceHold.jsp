...
<div id="sheetform">
    <html:form action="/complaint.do?method=performFroceHold" styleId="theform">
   ...
   if(operateType != null){
      ...
      %>
            ...
            <input type="hidden" name="${sheetPageName}mainClassName"
                   value="com.boco.eoms.sheet.complaint.model.ComplaintMain"/>    <!--mainè¡¨Modelå¯¹è±¡ç±»å-->
            <input type="hidden" name="${sheetPageName}linkClassName"
                   value="com.boco.eoms.sheet.complaint.model.ComplaintLink"/> <!--linkè¡¨Modelå¯¹è±¡ç±»å-->
