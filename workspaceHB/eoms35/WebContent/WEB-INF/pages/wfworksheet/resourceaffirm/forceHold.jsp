...
<html:form action="/resourceaffirm.do?method=performFroceHold" styleId="theform">
 ...
 %>
         <input type="hidden" name="${sheetPageName}beanId" value="iResourceAffirmMainManager"/> 
          <input type="hidden" name="${sheetPageName}mainClassName" value="com.boco.eoms.sheet.resourceaffirm.model.ResourceAffirmMain"/>	<!--main\u00e8\u00a1\u00a8Model\u00e5\u00af\u00b9\u00e8\u00b1\u00a1\u00e7\u00b1\u00bb\u00e5\u0090\u008d-->	
          <input type="hidden" name="${sheetPageName}linkClassName" value="com.boco.eoms.sheet.resourceaffirm.model.ResourceAffirmLink"/> <!--link\u00e8\u00a1\u00a8Model\u00e5\u00af\u00b9\u00e8\u00b1\u00a1\u00e7\u00b1\u00bb\u00e5\u0090\u008d-->
