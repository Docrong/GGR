...
<input type="hidden" name="${sheetPageName}mainClassName"
       value="com.boco.eoms.sheet.softwareLoad.model.SoftwareLoadMain"/>
<input type="hidden" name="${sheetPageName}linkClassName"
       value="com.boco.eoms.sheet.softwareLoad.model.SoftwareLoadLink"/>
<br>
<!-- sheet info -->
<table class="formTable">
    ...
    <tr>
        ...
        <td class="content">
            <eoms:comboBox name="${sheetPageName}mainSoftwareType" id="${sheetPageName}mainSoftwareType"
                           initDicId="1011503" alt="allowBlank:false" defaultValue="101150301" styleClass="select-class"
                           onchange="onTdChange(this)"/>
        </td>
        <td class="label" id="mainSoftwareversionLabel" style="display: "><bean:message bundle="softwareLoad"
                                                                                        key="softwareLoad.mainSoftwareversion"/>*
        </td>
        <td class="content" id="mainSoftwareversionText" style="display: ">
            <input type="text" class="text" value="${sheetMain.mainSoftwareversion }"
                   name="${sheetPageName}mainSoftwareversion"/>

        </td>
        <td class="label" id="mainSoftwareNoLabel" style="display: none;"><bean:message bundle="softwareLoad"
                                                                                        key="softwareLoad.mainSoftwareNo"/>*
        </td>
    ...
    <tr>
        ...
        <td class="content">
            <input type="text" class="text" name="${sheetPageName}mainNetwork" value="${sheetMain.mainNetwork }"
        ...
        <td colspan="3">
            ...
            <script type="text/javascript">
                ...
                deptetree = new xbox({
                    ...
                    saveChkFldId: '${sheetPageName}mainPlans',
                    viewer: areaViewer
                });
            </script>
            ...
            <textarea class="textarea max" readonly="true" name="${sheetPageName}showDept" style="height:50px"
                    ...
                    items="${sheetMain.mainPlans}" delims="," var="mainPlans" varStatus="status"><eoms:id2nameDB
                    id="${mainPlans}" beanId="tawSystemAreaDao"/><c:choose><c:when
                    test="${status.last}"></c:when><c:otherwise>,</c:otherwise></c:choose></c:forTokens></textarea>
            <input type="hidden" name="${sheetPageName}mainPlans" id="${sheetPageName}mainPlans"
                   value="${sheetMain.mainPlans}"/>
        </td>
    </tr>
    <tr>
        ...
        <td class="content">
            <input type="text" class="text" name="${sheetPageName}mainProgramtime" readonly="readonly"
                   ...
                   onclick="popUpCalendar(this, this)"
                   alt="vtype:'moreThen',link:'${sheetPageName}sheetAcceptLimit',vtext:'计划装载时间不能早于受理时限',allowBlank:false"/>
    ...
    <tr>
        ...
        <td class="content">
            <input type="text" class="text" name="${sheetPageName}maintestunit" value="${sheetMain.maintestunit }"
                   alt="allowBlank:false"/>
        ...
        <td class="content">
            <eoms:comboBox name="${sheetPageName}mainUrgency" id="${sheetPageName}mainUrgency"
                           initDicId="1010102" alt="allowBlank:false" defaultValue="101010202"
    ...
    <tr>
        ...
        <td class="content">
            <input type="text" class="text" value="${sheetMain.mainPointName }" name="${sheetPageName}mainPointName"
                   alt="allowBlank:false"/>
        ...
        <td class="content">
            <eoms:comboBox name="${sheetPageName}mainissuing" id="${sheetPageName}mainissuing"
                           initDicId="1011504" alt="allowBlank:false" defaultValue="101150401"
                           styleClass="select-class"/>
    ...
    <tr>
        ...
        <td class="content">
            <input type="text" class="text" value="${sheetMain.mainpointweights }"
                   name="${sheetPageName}mainpointweights" alt="allowBlank:false"/>

        </td>
        <td class="label"><bean:message bundle="softwareLoad" key="softwareLoad.mainApplication"/>*</td>
        <td class="content">
            <input type="text" class="text" name="${sheetPageName}mainApplication" value="${sheetMain.mainApplication }"
                   alt="allowBlank:false"/>
    ...
    <tr>
        ...
        <td class="content" colspan="3">
            <textarea class="textarea max" name="${sheetPageName}mainKeyword" id="${sheetPageName}mainKeyword"
                      alt="width:500,allowBlank:false,maxLength:2000,vtext:'请填入影响业务分析，最多输入2000字'">${sheetMain.mainKeyword}</textarea>
        </td>
    </tr>
    <tr>
        <td class="label"><bean:message bundle="softwareLoad" key="softwareLoad.mainFunction"/>*</td>
        <td class="content" colspan="3">
            <textarea class="textarea max" name="${sheetPageName}mainFunction" id="${sheetPageName}mainFunction"
                      alt="width:500,allowBlank:false,maxLength:2000,vtext:'请填入影响业务分析，最多输入2000字'">${sheetMain.mainFunction}</textarea>
    ...
    <tr>
        ...
        <td class="content" colspan="3">
            <textarea class="textarea max" name="${sheetPageName}mainNotes" id="${sheetPageName}mainNotes"
                      alt="width:500,allowBlank:false,maxLength:2000,vtext:'请填入影响业务分析，最多输入2000字'">${sheetMain.mainNotes}</textarea>
