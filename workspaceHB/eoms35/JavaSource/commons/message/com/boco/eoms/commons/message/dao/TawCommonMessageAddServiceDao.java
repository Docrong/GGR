...
public interface TawCommonMessageAddServiceDao extends Dao {
    ...
    /**
     * Gets tawCommonMessageAddService's information based on primary key. An
     * ObjectRetrievalFailureException Runtime Exception is thrown if nothing is
     * found.
     *
     * @param id the tawCommonMessageAddService's id
     ...
     *
     * @param tawCommonMessageAddService the object to be saved
     */
