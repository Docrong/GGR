...
<div class="content">
            ...
            <table border="0" width="50%" cellspacing="1">
                ...
                <tr class="tr_show">
                    <td>
                        ...
                        <input type="text" name="taskname" id="taskname" style="width:400px" styleClass="text"
                ...
                <tr class="tr_show">
                    <td>
                        <textarea rows="4" cols="30" name="taskremarks" style="width:400px" class="textarea"
                                  alt="allowBlank:false,vtext:'${eoms:a2u('请输入任务概要')}'"></textarea>
                    </td>
                </tr>
                <tr>
    ...
    <c:forEach items="${networkcalendarList}" var="list" varStatus="status">
        ...
        <h4><A href="networkcalendarmain.do?method=xdelete&id=${list.id}"><bean:message key='delete'/></A> <A
                href="networkcalendarmain.do?method=detail&id=${list.id}"><bean:message key='edit'/></A></h4>
