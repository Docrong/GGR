...
<%@ page
        import="java.util.*,java.lang.*, org.apache.struts.util.*,com.boco.eoms.commons.system.session.form.TawSystemSessionForm,com.boco.eoms.duty.model.*" %>
<HTML>
<%
...
<FORM>
    ...
    <table>
        <tr>
            ...
            %>
            <td>
                <input type="button" class="clsbtn2" value="返回"
                       onclick="window.location='summary.do?deptId=<%=deptId%>&YearMonth=<%=month%>&deptName=<%=deptName%>';">
            </td>
            <%}%>
        </tr>
    </table>
...
//String month=(String)request.getAttribute("month");
        ...
        <tr>
            <td>
                <center><%=tawRmDefineTree.getName()%>
                </center>
            </td>
            <td>
                <center><%=tawRmDefineTree.getSpecility()%>
                </center>
            </td>
            <td>
                <center>
