...
<%@ page
        import="java.util.*,java.lang.*, org.apache.struts.util.*,com.boco.eoms.common.util.StaticMethod,com.boco.eoms.duty.model.TawRmAssignwork" %>
<%!
...
<html:form method="post" action="/TawRmRecordPer/showresult.do">
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="400" align="center">
        <tr>
            <td align="center" valign="middle" class="table_title" colspan="2"><bean:message
                    key="TawRmRecordPer.dutystat"/></td>
        </tr>
    </table>
        ...
        <tr class="tr_show">
            ...
            <td>
                <select name="typename">
                    ...
                    <option value="<bean:message key="TawRmRecordPer.gongdan"/>"><bean:message
                            key="TawRmRecordPer.gongdan"/></option>
                    <option value="<bean:message key="TawRmRecordPer.duty"/>"><bean:message
                            key="TawRmRecordPer.duty"/></option>
                    <option value="<bean:message key="TawRmRecordPer.workplan"/>"><bean:message
                            key="TawRmRecordPer.workplan"/></option>
                    <option value="<bean:message key="TawRmRecordPer.guzhanggongdan"/>"><bean:message
                            key="TawRmRecordPer.guzhanggongdan"/></option>
                    <option value="<bean:message key="TawRmRecordPer.workdutygd"/>"><bean:message
                            key="TawRmRecordPer.workdutygd"/></option>
                    <option value="<bean:message key="TawRmRecordPer.jushujugd"/>"><bean:message
                            key="TawRmRecordPer.jushujugd"/></option>
                    <option value="<bean:message key="TawRmRecordPer.shengaonggd"/>"><bean:message
                            key="TawRmRecordPer.shengaonggd"/></option>
                    <option value="<bean:message key="TawRmRecordPer.dlsqddgd"/>"><bean:message
                            key="TawRmRecordPer.dlsqddgd"/></option>
                    <option value="<bean:message key="TawRmRecordPer.txfhydsqgd"/>"><bean:message
                            key="TawRmRecordPer.txfhydsqgd"/></option>
                    <option value="<bean:message key="TawRmRecordPer.wyzxgd"/>"><bean:message
                            key="TawRmRecordPer.wyzxgd"/></option>
                    <option value="<bean:message key="TawRmRecordPer.ywzxgd"/>"><bean:message
                            key="TawRmRecordPer.ywzxgd"/></option>
                    <option value="<bean:message key="TawRmRecordPer.yhsqspgd"/>"><bean:message
                            key="TawRmRecordPer.yhsqspgd"/></option>
                    <option value="<bean:message key="TawRmRecordPer.xlgjgd"/>"><bean:message
                            key="TawRmRecordPer.xlgjgd"/></option>
                    <option value="<bean:message key="TawRmRecordPer.qggd"/>"><bean:message
                            key="TawRmRecordPer.qggd"/></option>
                </select>
            </td>
        </tr>
        <tr class="tr_show">
        ...
        <tr class="tr_show">
            ...
            <td>
                <select name="userId">
                    ...
                    %>
                    <option value='<%=RoomUser.elementAt(i).toString()%>'><%=RoomUser.elementAt(i + 1).toString()%>
                    </option>
                    <%}%>
                </select>
            </td>
        ...
        <tr align="left">
            <td height="32" align="left">
                ...
                <input type="submit" name="name" value=
                    <bean:message key="TawRmSysteminfo.stat"/> class="button">
            </td>
        </tr>
    </table>
    <%
        ...
        if (vecPerRecords != null) {
            ...
            String typename = "";
    %>
    <TABLE cellSpacing="0" cellPadding="0" width="95%" borderColorLight="#709FD5" borderColorDark="#ffffff"
        ...
        <TR>
            ...
            <TD align="center" class="label"><%if (complete_flag == 0) {%><bean:message
                    key="TawRmRecordPer.nofinish"/><%} else {%><bean:message key="TawRmRecordPer.finished"/><%}%></TD>
        </TR>
        <%
                vecPerRecord = null;
            }
    ...
    <TABLE align="center">
        <TR>
            <TD align="middle" colSpan="6" class="clsfth">
                <input type=button Class="button" name="load" value="<bean:message key="TawRmRecordPer.print"/>"
