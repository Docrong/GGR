	...
	<table id="sheet" class="formTable">	
		<c:if test="${status!=1}">
		   ...
		   <tr>
			  ...
			  <td>
			  	<input type="text" class="text" name="${sheetPageName}btype1" id="${sheetPageName}btype1" value="${sheetMain.btype1}" alt="allowBlank:true,maxLength:40,vtext:'联系人，最多输入20汉字'"/>
			  </td>				
			  <td class="label"><bean:message bundle="complaint" key="complaint.bdeptContact"/></td>
			  <td>
			  	<input type="text" class="text" name="${sheetPageName}bdeptContact" id="${sheetPageName}bdeptContact" value="${sheetMain.bdeptContact}" alt="allowBlank:true,maxLength:20,vtext:'联系人电话，最多输入20字符'"/>
			  </td>		  
			</tr>
		   ...
		   <tr>
			  ...
			  <td colspan="3">
			  	<input type="text" class="text" name="${sheetPageName}complaintAdd" id="${sheetPageName}complaintAdd" value="${sheetMain.complaintAdd}" alt="allowBlank:true,maxLength:240,vtext:'投诉位置，最多输入120汉字'"/>
			  </td>					  
			</tr>						
		   ...
		   <tr>
			  ...
			  <td>
			  	<eoms:comboBox name="${sheetPageName}bdeptContactPhone" id="${sheetPageName}bdeptContactPhone" initDicId="10301" defaultValue="${sheetMain.bdeptContactPhone}" alt="allowBlank:true"/>
			  </td>				
			  <td class="label"><bean:message bundle="complaint" key="complaint.repeatComplaintTimes"/></td>
			  <td>
			  	<input type="text" class="text" name="${sheetPageName}repeatComplaintTimes" id="${sheetPageName}repeatComplaintTimes" value="${sheetMain.repeatComplaintTimes}" alt="allowBlank:true"/>
			  </td>		  
			</tr>
		   ...
		   <tr>
			  ...
			  <td>
			  	...
			  	value="${sheetMain.customAttribution}" alt="allowBlank:true,maxLength:200,vtext:'用户归属地，最多输入100汉字'"/>
			  </td>		  
			</tr>							
		   ...
		   <tr>
			  ...
			  <td>
			  	 <eoms:comboBox name="${sheetPageName}complaintReason1" id="${sheetPageName}complaintReason1" 
			  	      sub="${sheetPageName}complaintReason2" initDicId="1010605" defaultValue="${sheetMain.complaintReason1}" alt="allowBlank:true"/>
			  </td>				
			  ...
			  <td>
			    <eoms:comboBox name="${sheetPageName}complaintReason2" id="${sheetPageName}complaintReason2" 
			  	      sub="${sheetPageName}complaintReason" initDicId="${sheetMain.complaintReason1}" defaultValue="${sheetMain.complaintReason2}" alt="allowBlank:true"/>
			  </td>		  
			</tr>
 -->											
            <tr>
		   ...
		   <tr>
            ...
            <tr>
			  ...
			  <td>
				<eoms:comboBox name="${sheetPageName}isVisit" id="${sheetPageName}isVisit" initDicId="10301" defaultValue="${sheetLink.isVisit}"/>
			  </td>		  
			</tr>	
