...
<html:form action="/smsMobilesTemplates.do?method=forward2New" method="post" styleId="smsMobilesTemplateForm">
    <table class="formTable">
        ...
        <logic:iterate id="mobilesList" name="mobilesList">
            <tr>
                <td>
                    <a href="${app}/msg/smsMobilesTemplates.do?method=xeditInit&id=<bean:write name="mobilesList" property="id" />"><bean:write
                            name="mobilesList" property="name"/></a>
                </td>
                ...
                <td>
                    <a href="${app}/msg/smsMobilesTemplates.do?method=xdelete&id=<bean:write name="mobilesList" property="id" />"><bean:message
                            key='smsButton.delete'/></a>
                </td>
            </tr>
        </logic:iterate>
        <tr>
