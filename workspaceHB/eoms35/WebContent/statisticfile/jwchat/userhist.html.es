...
<html>
    <head>
        <title>JWChat - Historial del Charla</title>
        <meta http-equiv="content-type" content="text/html; charset=utf-8">
          ...
          function init() {
              ...
              var dtitle = "Historial de mensajes para "+user.name;
    ...
    <body style="margin:8px;">
        ...
        <td align="right">
            <button onClick="deleteHistory();">Borrar</button>
            <button onClick="reloadHistory();">Refrescar
        </td>
    </tr>
    <tr height="100%">
        <td>
            <iframe id="collections" name="collections" src="userhist_collections_iframe.html"
                    style="width:240px;height:100%;" scrolling="auto"></iframe>
        </td>
        <td width="100%">
            <iframe id="selected_collection" name="selected_collection" src="chat_iframe.html"
