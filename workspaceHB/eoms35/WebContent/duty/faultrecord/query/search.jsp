...
<html:html>
    ...
    <center>
        ...
        <!---正文开始------------------------------------------------------------------------------------------>
        <html:form action="/Faultrecord/searchdo.do">
            ...
            <table border="0" width="500" cellspacing="1" cellpadding="1" class="formTable" align=center>
                ...
                <tr class="tr_show">
                    ...
                    <td>
                        ...
                        <input type="text" name="insertTimeFrom" size="30" value="<%=yesterdayTime%>" class="text"
                               onclick="popUpCalendar(this, this,null,null,null,true,-1);" readonly="true">
                        &nbsp;&nbsp;
                        <bean:message key="label.to"/><!--到-->
                        <input type="text" name="insertTimeTo" size="30" value="<%=currenTime%>" class="text"
                               onclick="popUpCalendar(this, this,null,null,null,true,-1);" readonly="true">
                    </td>
                </tr>
