        ...
        <logic:iterate id="baselink" name="HISTORY" type="com.boco.eoms.sheet.groupcheck.model.GroupCheckLink">
            ...
            <div class="history-item">&nbsp;
                ...
                <div class="history-item-title">
                    ...
                    <eoms:dict key="dict-sheet-groupcheck" dictId="activeTemplateId"
                               itemId="${baselink.activeTemplateId}" beanId="id2descriptionXML"/>
                    <bean:message bundle="groupcheck" key="groupcheck.operateType"/>:
                    <eoms:dict key="dict-sheet-groupcheck" dictId="mainOperateType" itemId="${baselink.operateType}"
                    ...
                    <table class="formTable" width="100%" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td class="content">
                                ...
                                <pre><eoms:id2nameDB id="${baselink.linkAutoFind}"
