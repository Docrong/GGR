...
<table class="formTable">
    ...
    <tr>
        ...
        <td colspan="3">
            <eoms:comboBox name="${sheetPageName}linkPermitResult" id="${sheetPageName}linkPermitResult"
                           initDicId="1011601" defaultValue="${sheetLink.linkPermitResult}" styleClass="select-class"
                           alt="allowBlank:false" onchange="permitResult(this.value);"/>
        </td>
    </tr>
    <tr>
        <td class="label">审批意见*</td>
        <td colspan="3">
					      <textarea name="${sheetPageName}linkPermitOpinion" id="${sheetPageName}linkPermitOpinion"
                                    class="textarea max"
    ...
    <tr>
        ...
        <td colspan="3">
					      <textarea name="${sheetPageName}linkRequireConfirm" id="${sheetPageName}linkRequireConfirm"
                                    class="textarea max"
    ...
    <tr>
        ...
        <td colspan="3">
					      <textarea name="${sheetPageName}linkTestResult" id="${sheetPageName}linkTestResult"
                                    class="textarea max"
    ...
    <tr>
        ...
        <td colspan="3">
					      <textarea name="${sheetPageName}linkYZReportResult" id="${sheetPageName}linkYZReportResult"
                                    class="textarea max"
    ...
    <tr>
        ...
        <td colspan="3">
					      <textarea name="${sheetPageName}linkJCReportResult" id="${sheetPageName}linkJCReportResult"
                                    class="textarea max"
    ...
    <tr>
        ...
        <td colspan="3">
					      <textarea name="${sheetPageName}linkTargetCheckResult"
                                    id="${sheetPageName}linkTargetCheckResult" class="textarea max"
    ...
    <tr>
        ...
        <td colspan="3">
				  		<textarea name="${sheetPageName}linkSheetNumber" id="${sheetPageName}linkSheetNumber"
                                  class="textarea max"
    ...
    <tr>
        ...
        <td colspan="3">
					      <textarea name="${sheetPageName}linkBSResultReport" id="${sheetPageName}linkBSResultReport"
                                    class="textarea max"
