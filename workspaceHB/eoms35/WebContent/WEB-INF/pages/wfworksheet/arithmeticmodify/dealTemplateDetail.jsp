		     ...
		     <input type="hidden" name="${sheetPageName}operateType" id="${sheetPageName}operateType" value="<%=operateType%>" />    
   		    <%if(operateType.equals("90")||operateType.equals("11")){ %>
   		        ...
   		        <tr>
		             ...
		             <td colspan="3"> 	
    				       <textarea class="textarea max" name="${sheetPageName}linkArithmeticModifyProcess" id="${sheetPageName}linkArithmeticModifyProcess" alt="width:500,allowBlank:false,maxLength:500,vtext:'请填入后续处理过程，最多输入500字符'">${sheetLink.linkArithmeticModifyProcess}</textarea>
                     </td>
		       </tr>
		       <tr>
	             	...
	             	<td colspan="3">
	             		 <eoms:attachment name="sheetLink" property="linkTestReport" 
			            	scope="request" idField="${sheetPageName}linkTestReport" appCode="arithmeticmodify" alt="allowBlank:false"/>
	             	</td>
	             </tr>		                       
		       </tr>	
		     <%} %>
