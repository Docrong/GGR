       ...
       <table class="formTable">
        ...
        <tr>
           <td class="label">
             ...
             <td colspan="3">
    				<textarea class="textarea max" name="${sheetPageName}transferReason" id="${sheetPageName}transferReason" alt="allowBlank:false,maxLength:4000,vtext:'${eoms:a2u('请填入备注信息，最多输入4000字符')}'">${sheetLink.transferReason}</textarea>
			</td>		
	   </tr>
