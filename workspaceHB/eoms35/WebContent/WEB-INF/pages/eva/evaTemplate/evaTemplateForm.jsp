      	  ...
      	  <dt class="warn">${requestScope.failInfo}</dt>
                ...
                <c:if test="${not empty evaTemplateForm.id}">
                    ...
                    <tr>
                        ...
                        <td class="content" colspan="3">
                            <eoms:dict key="dict-eva" dictId="activated" itemId="${evaTemplateForm.activated}"
                                       beanId="id2nameXML"/>
                        </td>
                    </tr>
                </c:if>
                    ...
                    <tr>
                        ...
                        <c:if test="${empty requestScope.templateTypeId}">
                            <td class="content" colspan="3">
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                模板分类：
                                <select name="templateTypeId" id="templateTypeId" disabled="disabled"
                        ...
                        <c:if test="${not empty requestScope.templateTypeId}">
                            <td class="content" colspan="3">
                                ...
                                <select name="templateTypeId" id="templateTypeId"
                                        onchange="selectChange(this.options[this.options.selectedIndex].value)">
                                    <option value=""><eoms:id2nameDB id="${requestScope.templateTypeId}"
                                                                     beanId="evaTreeDao"/></option>
                                    <logic:iterate id="ttList" name="ttList">
                                        <option value="${ttList.nodeId}">
                                            <eoms:id2nameDB id="${ttList.nodeId}" beanId="evaTreeDao"/>
                                        </option>
