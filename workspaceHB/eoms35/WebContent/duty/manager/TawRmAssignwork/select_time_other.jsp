                                ...
                                <tr class="tr_show">
                                    ...
                                    <td width="40%" colspan="2">
                                        <input id="assign_auto" type="radio" name="assign_type" value="assign_auto"
                                               onclick="javascript:click_assign_auto();">自动排班
                                    </td>
                                    <td width="40%">
                                        <input id="assign_manu" type="radio" name="assign_type" value="assign_manu"
                                               onclick="javascript:click_assign_manu();">手动排班调整
                                    </td>
                                </tr>
                                <tr class="tr_show">
                                    ...
                                    <td width="40%" colspan="2">
                                        <input id="auto_cover" type="radio" name="assign_type" value="auto_cover"
                                               checked="checked" onclick="javascript:click_auto_cover();">自动排班并覆盖已有排班
                                    </td>
                                    <td width="40%">
                        ...
                        <td>
                            <table height="32" cellpadding="0" cellspacing="0" border="0" width="100%">
                                <tr align="right" valign="middle">
                                    <td>
                                        <input type="submit" class="clsbtn2" name="save" value=
                                        <bean:message key="TawRmAssignwork.assign"/>>
                                        &nbsp;&nbsp;&nbsp;
                                        <input type="button" class="clsbtn2" name="save"
                                               value='补排班' <%="1".equals(request.getAttribute("haveAssign"))?"disabled":""%>
                                               onclick="javascript:click_assign_modify();">
                                    </td>
                                </tr>
                            </table>
                        </td>
