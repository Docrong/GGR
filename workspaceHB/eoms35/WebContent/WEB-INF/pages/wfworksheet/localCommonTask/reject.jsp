...
<script type="text/javascript">
    function showPage() {
        var pars = '';
        var url = '';
        url = '${app}/sheet/localCommonTask/localCommonTask.do?method=showInputRejectPage&piid=${sheetMain.piid}&taskId=${taskId}&taskName=${taskName}';
        if (url != '') {
...
<div id="sheetform">
    <html:form action="/localCommonTask.do?method=performDeal" styleId="theform">
