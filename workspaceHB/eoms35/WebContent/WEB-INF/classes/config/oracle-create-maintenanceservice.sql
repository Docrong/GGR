...
alter table MAINTENANCESERVICE_MAIN add constraint MAINTENANCESERVICE_MAIN_PK primary key (id)  using index; 
...
alter table MAINTENANCESERVICE_TASK add constraint MAINTENANCESERVICE_TASK_PK primary key (id)  using index; 
...
values ('xls,txt,doc,jpg,gif', 'maintenanceservice', '维保服务审批流程', 1024, '/sheet/maintenanceservice', 109, '2c9ba3865ad6167d015ad6167dec0000');

--插入角色
insert into taw_system_role(role_id,deleted,parent_id,role_name,roletype_id,workflow_flag,leaf) values('1760','0','0','建单人','1','60','1');
insert into taw_system_role(role_id,deleted,parent_id,role_name,roletype_id,workflow_flag,leaf) values('1761','0','0','设备维护人','1','60','1');
insert into taw_system_role(role_id,deleted,parent_id,role_name,roletype_id,workflow_flag,leaf) values('1762','0','0','厂家','1','60','1');
insert into taw_system_role(role_id,deleted,parent_id,role_name,roletype_id,workflow_flag,leaf) values('1763','0','0','报修人','1','60','1');
insert into taw_system_role(role_id,deleted,parent_id,role_name,roletype_id,workflow_flag,leaf) values('1764','0','0','主管领导','1','60','1');

--插入菜单
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('2c9ba3865ad6167d015ad6167dec0001', '6001', '1', '新增工单', '60', null, '/sheet/maintenanceservice/maintenanceservice.do?method=showNewSheetPage', '0', '0', 1);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('2c9ba3865ad6167d015ad6167dec0002', '6003', '0', '待处理工单', '60', null, null, '0', '0', 3);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('2c9ba3865ad6167d015ad6167dec0003', '600301', '1', '待办工单', '6003', null, '/sheet/maintenanceservice/maintenanceservice.do?method=showListsendundo', '0', '0', 1);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('2c9ba3865ad6167d015ad6167dec0004', '6007', '1', '工单查询', '60', null, '/sheet/maintenanceservice/maintenanceservice.do?method=showQueryPage', '0', '0', 7);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('2c9ba3865ad6167d015ad6167dec0005', '6008', '1', '工单处理模板', '60', null, '/sheet/maintenanceservice/maintenanceservice.do?method=getDealTemplatesByUserId&type=templateManage', '0', '0', 8);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('2c9ba3865ad6167d015ad6167dec0006', '6009', '1', '工单模板管理', '60', null, '/sheet/maintenanceservice/maintenanceservice.do?method=getTemplatesByUserId&type=templateManage', '0', '0', 9);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('2c9ba3865ad6167d015ad6167dec0007', '6010', '1', '管理者工单', '60', null, '/sheet/maintenanceservice/maintenanceservice.do?method=showListForAdmin', '0', '0', 10);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('2c9ba3865ad6167d015ad6167dec0008', '60', '0', '维保服务审批流程', '10', null, '/sheet/maintenanceservice/maintenanceservice.do?method=showDrawing', '0', '0', 20);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('2c9ba3865ad6167d015ad6167dec0009', '6002', '1', '草稿列表', '60', null, '/sheet/maintenanceservice/maintenanceservice.do?method=showDraftList', '0', '0', 2);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('2c9ba3865ad6167d015ad6167dec000a', '6004', '0', '已处理工单', '60', null, null, '0', '0', 4);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('2c9ba3865ad6167d015ad6167dec000b','600402','1','建立工单','6004', null, '/sheet/maintenanceservice/maintenanceservice.do?method=showOwnStarterList','0','0',2);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('2c9ba3865ad6167d015ad6167dec000c', '600401', '1', '处理工单', '6004', null, '/sheet/maintenanceservice/maintenanceservice.do?method=showListsenddone', '0', '0', 1);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('2c9ba3865ad6167d015ad6167dec000d', '6005', '1', '已归档工单', '60', null, '/sheet/maintenanceservice/maintenanceservice.do?method=showHoldedList', '0', '0', 5);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('2c9ba3865ad6167d015ad6167dec000e', '6006', '1', '已作废工单', '60', null, '/sheet/maintenanceservice/maintenanceservice.do?method=showCancelList', '0', '0', 6);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('2c9ba3865ad6167d015ad6167dec000f', '6011', '1', '超时时间设置', '60', null, '/sheet/overtimetip/overtimetip.do?flowName=MaintenanceService', '0', '0', 11);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('2c9ba3865ad6167d015ad6167dec0010', '6012', '1', '工单处理时限配置', '60', null, '/sheet/newSheetLimit/sheetLimit.do?method=getLevelLimitList&flowName=MaintenanceService', '0', '0', 30);