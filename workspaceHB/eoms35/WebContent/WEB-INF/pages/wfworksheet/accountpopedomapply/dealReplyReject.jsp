...
<div id="sheetform">
<html:form action="/accountpopedomapply.do?method=performDealReplyReject" styleId="theform">
 <%@ include file="/common/taglibs.jsp"%>
<%
 ...
 %>
	...
	<input type="hidden" name="${sheetPageName}processTemplateName" id="${sheetPageName}processTemplateName" value="AccountPopedomApplyProcess" />
    ...
    <input type="hidden" name="${sheetPageName}taskNamespace" value="http://AccountPopedomApplyProcess"/>  
<%@ include file="/WEB-INF/pages/wfworksheet/accountpopedomapply/baseinputlinkhtmlnew.jsp"%>
    <br/>  
     ...
     <tr>
      ...
      <logic:iterate id="toTask" name="acceptList" type="com.boco.eoms.sheet.accountpopedomapply.model.AccountPopedomApplyTask">  
        <tr>
          <td>
