    ...
    <script type="text/javascript">
        var config = {
            ...
            ctxMenu: [
                {
                    id: 'newnode',
                    text: '<fmt:message key="kmScoreSettree.tree.add"/>',
                    cls: 'new-mi',
                    url: '${app}/kmmanager/kmScoreSets.do?method=add&nodeId='
                },
                {
                    id: 'edtnode',
                    text: '<fmt:message key="kmScoreSettree.tree.edit"/>',
                    cls: 'edit-mi',
                    url: '${app}/kmmanager/kmScoreSets.do?method=edit&nodeId='
                },
                {
                    id: 'delnode',
                    isDelete: true,
                    text: '<fmt:message key="kmScoreSettree.tree.delete"/>',
                    cls: 'remove-mi',
                    url: '${app}/kmmanager/kmScoreSets.do?method=remove&nodeId='
                }
            ],//end of ctxMenu
            /************************
