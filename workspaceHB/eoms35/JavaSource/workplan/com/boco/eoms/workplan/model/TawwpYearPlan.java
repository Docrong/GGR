...
/**
 * @hibernate.class table="TAW_WP_YEARPLAN"
 */
...
public class TawwpYearPlan
    ...
    /**
     * @hibernate.property column="NETLIST"
     * length="200"
     * not-null="false"
     * update="true"
     */
     ...
     * lazy="true"
     * cascade="all"
     * @hibernate.collection-key column="YEAR_PLAN_ID"
     * @hibernate.collection-one-to-many class="com.boco.eoms.workplan.model.TawwpYearCheck"
     */
     ...
     * cascade="all"
     * @hibernate.collection-key column="YEAR_PLAN_ID"
     * @hibernate.collection-one-to-many class="com.boco.eoms.workplan.model.TawwpYearExecute"
     */
     ...
     * cascade="save-update"
     * @hibernate.collection-key column="YEAR_PLAN_ID"
     * @hibernate.collection-one-to-many class="com.boco.eoms.workplan.model.TawwpMonthPlan"
     */
