...
function showPage(){
     var pars = '';
     var url = '';    
      url = '${app}/sheet/widencomplaint/widencomplaint.do?method=showInputRejectPage&piid=${sheetMain.piid}&taskId=${taskId}&taskName=${taskName}';
     if (url!=''){
...
<div id="sheetform">
<html:form action="/widencomplaint.do?method=performDeal" styleId="theform">
