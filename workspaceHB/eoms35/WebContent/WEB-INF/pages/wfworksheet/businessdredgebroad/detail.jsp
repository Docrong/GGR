...
<table class="formTable">
     <tr>
	  ...
	  <tr>     
		  ...
		  <td  class="content" colspan='3'><bean:write name="sheetMain" property="parentCorrelation" scope="request"/></td>
	  </tr>
	  <!-- end by yangna -->
		 ...
		 <tr>     
		  ...
		  <td colspan="3" >
                   <eoms:attachment name="sheetMain" property="numDetailFile" 
        			  scope="request" idField="${sheetPageName}numDetailFile" appCode="businessdredgebroad" viewFlag="Y"/> 
          </td>
        </tr>			     
			      <tr>
       ...
       <!-- MMS -->	 <% if("101100102".equals(businesstype1)){ %>
			      ...
			      <tr>
                   ...
                   <tr>
                    ...
                    <td class="content"> <eoms:id2nameDB id="${sheetMain.mainBusinessType}" beanId="ItawSystemDictTypeDao"/></td> 
                   </tr>
                    <!-- end by yangna -->
		           <tr>
		    		 ...
		    		 <tr>
					  <td class="label"><bean:message bundle="businessdredgebroad" key="businessdredgebroad.AppProgramme"/></td>
						 ...
						 <eoms:attachment name="sheetMain" property="appProgramme" 
			              scope="request" idField="${sheetPageName}appProgramme" appCode="businessdredgebroad" viewFlag="Y"/> </td>
			         </tr>        
		         ...
		         <tr>
		            ...
		            <tr>
		            <td  class="label"><bean:message bundle="businessdredgebroad" key="businessdredgebroad.flowControlPriority"/></td>
		               <td  class="content"  colspan="3"><bean:write name="sheetMain" property="flowControlPriority" scope="request"/></td>
		            </tr>
		          ...
		          <tr>
		            ...
		            <td class="content"><eoms:id2nameDB id="${sheetMain.terminalNum}" beanId="ItawSystemDictTypeDao"/></td>
		          </tr>  
		          <tr>
		          ...
		          <tr>
		            ...
		            <td class="content"><eoms:id2nameDB id="${sheetMain.siconnectMMSGatewayName}" beanId="ItawSystemDictTypeDao"/></td>
		            <td  class="label">${eoms:a2u('带宽')}</td>
		            <td class="content"><eoms:id2nameDB id="${sheetMain.siEnterpriseCode}" beanId="ItawSystemDictTypeDao"/></td>
		          </tr> 
		          <tr>
	        ...
	        <tr>
	         ...
	         <tr>
		           ...
		           <td  class="content">
		           <a href="businessdredgebroad.do?method=showMainPrintInfoPage&sheetKey=${sheetMain.id}" target=_blank>${eoms:a2u('施工单查看')}</a>
		           </td>
		     </tr>   
	...
	<div class='sheet-deal-header'>
		...
		<%if(taskName.equals("TaskCreateAuditHumTask")){ %>	
			<select id="dealSelector"> 
			 ...
			 <option value="${urlShowNewAuditPassPage}"><bean:message bundle="businessdredgebroad" key="businessdredgebroad.taskpass"/> </option>
			 <option value="${urlShowNewAuditUnpassPage}"><bean:message bundle="businessdredgebroad" key="businessdredgebroad.tasknopass"/></option>
             <%} %>
           </select>
		<%}else if(taskName.equals("TaskCompleteAuditHumTask")){ %>	
			<select id="dealSelector">
			  <%if(taskStatus.equals(Constants.TASK_STATUS_READY)){%>
			    ...
			    <option value="${urlShowRejectBackPage}"><bean:message bundle="sheet" key="common.rejectBack"/></option>
			 <%}else if(taskStatus.equals(Constants.TASK_STATUS_CLAIMED)){ %>
			  <option value="${urlShowTaskCompleteAuditYes}"><bean:message bundle="businessdredgebroad" key="businessdredgebroad.TaskCompleteAuditYes"/></option>
			  <option value="${urlShowTaskCompleteAuditNo}"><bean:message bundle="businessdredgebroad" key="businessdredgebroad.TaskCompleteAuditNo"/></option>
			 <%} %>
			</select>			
		<%}else if(taskName.equals("ExcuteHumTask")){ %>	
		    ...
		    %>
			 ...
			 %>
			  ...
			  <option value="${urlShowCompleteDealPage}"><bean:message bundle="businessdredgebroad" key="businessdredgebroad.dealwcnosp"/></option>
			  <option value="${urlShowPassDealPage}"><bean:message bundle="businessdredgebroad" key="businessdredgebroad.totaskcompsq"/></option>
		...
		<%}else if(taskName.equals("AffirmHumTask")){%>	
			<select id="dealSelector">
			  <option value="${urlShowExamineNODealPage}"><bean:message bundle="businessdredgebroad" key="businessdredgebroad.dealrejectpass"/></option>
			  <option value="${urlShowExamineDealPage}"><bean:message bundle="businessdredgebroad" key="businessdredgebroad.nopassback"/></option>
			</select>
		<%}else if(taskName.equals("DraftHumTask")){%>	
			<select id="dealSelector">
			  <option value="${urlShowCompleteDraftPage}"><bean:message bundle="businessdredgebroad" key="businessdredgebroad.draft"/></option>
			</select>
		<%}else if(taskName.equals("HoldHumTask")){ %>
			<select id="dealSelector">
			  <option value="${urlShowHoldDealPage}"><bean:message bundle="businessdredgebroad" key="businessdredgebroad.Hold"/></option>
			</select>	
