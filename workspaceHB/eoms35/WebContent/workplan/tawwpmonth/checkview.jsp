...
<table width="100%" class="listTable">
    ...
    <tr>
        ...
        <td colspan="<%=tawwpMonthExecuteVO.getDayCount()%>">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;<bean:message
                key="checkview.title.executeFmCycle"/><%=tawwpMonthExecuteVO.getCycleName()%>
            &nbsp;&nbsp;&nbsp;&nbsp;<bean:message key="checkview.title.executeFmForm"/><a target="_blank"
...
<table width="100%" class="listTable">
    ...
    %>
    <tr>
        <td width="100"><%=tawwpMonthCheckVO.getCheckUserName()%>
        </td>
        <td width="150"><%=tawwpMonthCheckVO.getChecktime()%>
        </td>
        <td width="400"><%=tawwpMonthCheckVO.getContent()%>
        </td>
        <td width="50"><%=tawwpMonthCheckVO.getState()%>
        </td>
    </tr>
    <%
        }
...
<form name="yearcheck" method="post" action="">
    ...
    <table width="100%">
        ...
        <tr align="right">
            <td width="100%" align="right">
                <input type="button" value="<bean:message key="checkview.title.btnPass" />"
                       onclick="javascript:onPass();" class="button">
                <input type="button" value="<bean:message key="checkview.title.btnReject" />"
                       onclick="javascript:onReject();" class="button">
                <input type="button" value="<bean:message key="checkview.title.btnBack" />"
