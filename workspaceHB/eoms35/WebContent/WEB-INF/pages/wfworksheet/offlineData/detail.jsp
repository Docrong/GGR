    ...
    <div id="sheetinfo">
        <logic:present name="sheetMain" scope="request">
            ...
            <table class="formTable">
                ...
                <tr>
                    <td colspan="4">
                        <iframe id="frame2" name="frame2" src="" width="100%" height="300px"
            ...
            <tr>
                <td width="50%">
                    ...
                    <select id="dealSelector">
                        ...
                        <option value="${urlShowTransmitDealPage}"><bean:message bundle="offlineData"
                                                                                 key="offlineData.taskpass"/></option>
                        <option value="${urlShowTransmit2DealPage}"><bean:message bundle="offlineData"
                                                                                  key="offlineData.tasknopass"/></option>
                    ...
                    <select id="dealSelector">
                        <option value="${urlShowCompleteDraftPage}"><bean:message bundle="offlineData"
                    ...
                    <select id="dealSelector">
                        <option value="${urlShowHoldDealPage}"><bean:message bundle="offlineData"
