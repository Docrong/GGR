...
<div class="content">
    ...
    <div id="sscontent">
        <html:form action="/networkcalendarmain.do?method=saveNetworkcalendar&date=${param.date}"
                   styleId="networkcalendarForm">
            <input type="hidden" name="tasktime" value="<%=date%>">
            <html:hidden property="id" styleId="id"/>
            <table border="0" width="50%" cellspacing="1">
                <tr class="tr_show">
                    <td class="clsfth"><bean:message key='name'/>:</td>
                </tr>
                <tr class="tr_show">
                    <td>
                        <html:text property="taskname" styleId="taskname" style="width:400px" styleClass="text"
                                   alt="allowBlank:false,vtext:'${eoms:a2u('请输入标题')}'"/>
                    </td>
                </tr>
                <tr class="tr_show">
                ...
                <tr class="tr_show">
                    <td>
                        ...
                        <select name="taskhours" size="1" value="<%=hours%>">
                            ...
                            <%}%>
                            <option value='<%=taskminutes%>'><%=taskminutes%>
                            </option>
                            <%}%>
                ...
                <tr class="tr_show">
                    <td>
                        <textarea rows="4" cols="30" name="taskremarks" style="width:400px" class="textarea"
                                  alt="allowBlank:false,vtext:'${eoms:a2u('请输入任务概要')}'"
                                  type="_moz">${networkcalendarForm.taskremarks}</textarea>
                    </td>
                </tr>
                <tr>
    ...
    <h4><bean:message key='time'/>:${list.tasktime}
        ...
        <h4><A href="networkcalendarmain.do?method=xdelete&id=${list.id}"><bean:message key='delete'/></A> <A
                href="networkcalendarmain.do?method=xdelete&id=${list.id}"><bean:message key='edit'/></A></h4>
