...
<table id="sheet" class="formTable">
    ...
    <tr>
        ...
        <td>
            <input type="text" class="text" name="mainCommonfaultSheetId" id="mainCommonfaultSheetId"
                   alt="allowBlank:false,maxLength:2000,vtext:'请填入 网管告警流水号 信息，最多输入 2000 字符'"
                   value="${sheetMain.mainCommonfaultSheetId}"/>
        </td>
        <td class="label">
            <!-- 网元名称 -->
        ...
        <td>
            <input type="text" class="text" name="mainCommonfaultNetName" id="mainCommonfaultNetName"
                   alt="allowBlank:false,maxLength:2000,vtext:'请填入 网元名称 信息，最多输入 2000 字符'"
                   value="${sheetMain.mainCommonfaultNetName}"/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <input type="text" class="text" name="mainCorrigendumTypeOne" id="mainCorrigendumTypeOne"
                   alt="allowBlank:false,maxLength:2000,vtext:'请填入 勘误类型一级 信息，最多输入 2000 字符'"
                   value="${sheetMain.mainCorrigendumTypeOne}"/>
        </td>
        <td class="label">
            <!-- 勘误类型二级 -->
        ...
        <td>
            <input type="text" class="text" name="mainCorrigendumTypeTwo" id="mainCorrigendumTypeTwo"
                   alt="allowBlank:false,maxLength:2000,vtext:'请填入 勘误类型二级 信息，最多输入 2000 字符'"
                   value="${sheetMain.mainCorrigendumTypeTwo}"/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <input type="text" class="text" name="mainCorrigendumTypeThree" id="mainCorrigendumTypeThree"
                   alt="allowBlank:false,maxLength:2000,vtext:'请填入 勘误类型三级 信息，最多输入 2000 字符'"
                   value="${sheetMain.mainCorrigendumTypeThree}"/>
        </td>
        <td class="label">
            <!-- 网元类型 -->
        ...
        <td>
            <input type="text" class="text" name="mainNetType" id="mainNetType"
                   alt="allowBlank:false,maxLength:2000,vtext:'请填入 网元类型 信息，最多输入 2000 字符'"
                   value="${sheetMain.mainNetType}"/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <input type="text" class="text" name="mainCity" id="mainCity"
                   alt="allowBlank:false,maxLength:2000,vtext:'请填入 地市 信息，最多输入 2000 字符'" value="${sheetMain.mainCity}"/>
        </td>
        <td class="label">
            <!-- 区县 -->
        ...
        <td>
            <input type="text" class="text" name="mainCounty" id="mainCounty"
                   alt="allowBlank:false,maxLength:2000,vtext:'请填入 区县 信息，最多输入 2000 字符'"
                   value="${sheetMain.mainCounty}"/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <input type="text" class="text" name="mainCreateUserId" id="mainCreateUserId"
                   alt="allowBlank:false,maxLength:2000,vtext:'请填入 创建人 信息，最多输入 2000 字符'"
                   value="${sheetMain.mainCreateUserId}"/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <input type="text" class="text" name="mainCreateDeptId" id="mainCreateDeptId"
                   alt="allowBlank:false,maxLength:2000,vtext:'请填入 创建人所属部门 信息，最多输入 2000 字符'"
                   value="${sheetMain.mainCreateDeptId}"/>
        </td>
        <td class="label">
            <!-- 是否自动移交 -->
        ...
        <td>
            <input type="text" class="text" name="mainifAutotran" id="mainifAutotran"
                   alt="allowBlank:false,maxLength:2000,vtext:'请填入 是否自动移交 信息，最多输入 2000 字符'"
                   value="${sheetMain.mainifAutotran}"/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <input type="text" class="text" name="mainTeamRoleId" id="mainTeamRoleId"
                   alt="allowBlank:false,maxLength:2000,vtext:'请填入 维护班组 信息，最多输入 2000 字符'"
                   value="${sheetMain.mainTeamRoleId}"/>
        </td>
        <td class="label">
            <!-- 抄送对象 -->
        ...
        <td>
            <input type="text" class="text" name="mainccObject" id="mainccObject"
                   alt="allowBlank:false,maxLength:2000,vtext:'请填入 抄送对象 信息，最多输入 2000 字符'"
                   value="${sheetMain.mainccObject}"/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <input type="text" class="text" name="mainnewTeamRoleId" id="mainnewTeamRoleId"
                   alt="allowBlank:false,maxLength:2000,vtext:'请填入 更新维护班组 信息，最多输入 2000 字符'"
                   value="${sheetMain.mainnewTeamRoleId}"/>
        </td>
        <td class="label">
            <!-- 更新抄送对象 -->
        ...
        <td>
            <input type="text" class="text" name="mainnewccObject" id="mainnewccObject"
                   alt="allowBlank:false,maxLength:2000,vtext:'请填入 更新抄送对象 信息，最多输入 2000 字符'"
                   value="${sheetMain.mainnewccObject}"/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td colspan="3">
            <eoms:attachment name="sheetMain" property="sheetAccessories"
                             scope="request" idField="sheetAccessories" appCode="commonfaultcorrigendum"
                             alt="allowBlank:true"/>
        </td>
    </tr>
</table>
...
<fieldset>
    ...
    <div class="x-form-item">
        <eoms:chooser id="sendObject" type="role" roleId="8005106" flowId="620"
