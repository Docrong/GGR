...
<%@ page
        import="java.util.List,java.util.ArrayList,com.boco.eoms.sparepart.model.TawClassMsg,com.boco.eoms.sparepart.model.TawOrderDetail,com.boco.eoms.common.util.StaticMethod" %>
<%
    ...
    <center>
        ...
        <table border="0" width="95%" cellspacing="1" cellpadding="1" class="table_show" align="center">
            ...
            <tr class="tr_show" align="center">
                ...
                <td><a href="/EOMS_J2EE/sparepart/part/amplyview.do?id=<%=TO.getSparepartId()%>"
                       target="_blank">${eoms:a2u('查看详细')}</a></td>
            </tr>
            <%}%>
        </table>
        <br>
