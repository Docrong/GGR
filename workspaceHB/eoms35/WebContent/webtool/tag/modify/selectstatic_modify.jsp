        ...
        <tr>
            ...
            <td>
                <select name="multiple">
                    <option value="false" <%if (tag.getMultiple().equals("false")) out.println("selected"); %>>单选
                    </option>
            ...
            %>
			    <span id=<%=idVal%>>
			        <table class="form_table">
			            <tr>
			                <td>值<br/>
						      <input name="value" type="text" size="15" maxlength="20" value="<%=value1%>"><font
                                        color="#FF0000">*</font>
					        </td>
			                <td>文本<br/>
			                    <input name="text" type="text" size="15" value="<%=text1%>"><font
                                        color="#FF0000">*</font>
					        </td>
    			            <td>提交地址<br/>
    			                <input type="onpick" value="<%=address1%>" size="10" maxlength="50" id="onpick<%=j %>"
                                       name="onpick" class="smallInput">
                                <!--
