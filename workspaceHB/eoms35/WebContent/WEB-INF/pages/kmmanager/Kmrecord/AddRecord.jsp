...
<html:form method="post" action="/Kmrecord/record">
    ...
    <table class="formTable">
        ...
        <TR>
            ...
            <TD align="center">
                <input type="submit" class="btn" name="load" value='<bean:message key="label.editas" />'
                       onclick="javascript:fun_update(<%=record_id%>);">&nbsp;
                <input type="submit" class="btn" name="load" value='<bean:message key="label.delete" />'
    ...
    <table class="formTable">
        <TR>
            <TD align="center" colSpan="6">
                ...
                <input type="submit" class="btn" name="load" value='<bean:message key="label.add" />'
                       onclick="javascript:fun_save();">&nbsp;&nbsp;
                <input type="submit" class="btn" name="load" value='<bean:message key="label.rush" />'
