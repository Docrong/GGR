        ...
        <display:table name="tawNetTransferlist" cellspacing="0"
            ...
            <logic:present name="tawNetTransferlist" property="id">
                ...
                <display:column headerClass="sortable"
                    ...
                    <eoms:dict key="dict-duty" dictId="speciality" itemId="${tawNetTransferlist.speciality }"
                               beanId="id2nameXML"/>
                </display:column>
                <display:column headerClass="sortable"
                                titleKey="TawNetTransfer.state">
                    <eoms:dict key="dict-duty" dictId="netState" itemId="${tawNetTransferlist.state }"
                               beanId="id2nameXML"/>
                </display:column>
                <c:choose>
                    <c:when
