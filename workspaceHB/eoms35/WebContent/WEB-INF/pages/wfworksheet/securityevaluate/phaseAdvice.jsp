operateNameoperateName<%@ include file="/common/taglibs.jsp"%>
<style type="text/css">
...
<%@ include file="/WEB-INF/pages/wfworksheet/securityevaluate/baseinputlinkhtml.jsp"%>
     <table  class="listTable">
      ...
      <logic:iterate id="toTask" name="toOperaterList" type="com.boco.eoms.sheet.securityevaluate.task.impl.SecurityEvaluateTaskImpl">  
        <tr>
          <td>
