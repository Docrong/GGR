<table class="formTable">
    ...
    <tr>
        ...
        <td colspan='3'><input type="text" class="text max" name="${sheetPageName}title" id="${sheetPageName}title"
    ...
    <tr>
        ...
        <td colspan="3"><bean:write name="sheetMain" property="sendTime" formatKey="date.formatDateTimeAll"
