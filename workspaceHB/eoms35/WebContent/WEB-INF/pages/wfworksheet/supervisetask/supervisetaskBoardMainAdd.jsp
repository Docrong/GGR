...
<input type="hidden" id="saveflag" name="saveflag" value="${saveflag}">
	...
	--><tr>
		...
		<td class="content">
			<input type="hidden" style="border:none" readonly="readonly" id="workflowType" name="workflowType" value="${workflowType }">
			<c:choose>
	...
	<tr>
		...
		<td class="content">
		<input type="text" style="border:none" readonly="readonly" id="sheetId" name="sheetId" value="${object.sheetId }">
		</td>
		<td class="label">创建时间</td>
		<td class="content"><input type="text" style="border:none" readonly="readonly" id="createtime" name="createtime" value="${createtime }"></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="content">
			<input type="hidden" style="border:none" readonly="readonly" id="workflowStatus" name="workflowStatus" value="${object.status }">
	...
	<tr>
		...
		<td class="content">
			<input type="hidden" style="border:none" readonly="readonly" id="deptid" name="deptid" value="${deptid }"><eoms:id2nameDB id="${deptid }" beanId="tawSystemDeptDao" />
		</td>
		<td class="label">问题派发人</td>
		<td class="content">
			<input type="hidden" style="border:none" readonly="readonly" id="sendUserid" name="sendUserid" value="${userid }">
