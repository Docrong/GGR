        ...
        >
            <table border="0" width="95%" cellspacing="1">
                ...
                <tr class="tr_show">
                    ...
                    <td colspan=3>
                        <html:text property="confName" styleId="confName" styleClass="text medium"
                ...
                <tr class="tr_show">
                    ...
                    <td colspan=3>
                        <html:text property="confBeginTime" styleId="confBeginTime" styleClass="text medium"
                                   alt="allowBlank:false" readonly="true" onclick="popUpCalendar(this, this);"/>
                ...
                <tr class="tr_show">
                    ...
                    <td colspan=3>
                        <html:text property="confEndTime" styleId="confEndTime" styleClass="text medium"
                                   alt="allowBlank:false" readonly="true" onclick="popUpCalendar(this, this);"/>
                    </td>
                </tr>
