...
<html:form action="/TawFileUpload/add.do" name="tawFileUploadForm" type="com.boco.eoms.kbs.controller.TawFileUploadForm"
    ...
    <table align="center" width="70%">
        <tr>
            ...
            <td align="right" VALIGN="top" rowspan="2">
                <input type="button" Class="clsbtn2" VALUE=">><bean:message key="taw.attach"/>>>"
                       onclick="return addattach(1);">
                <input type="button" Class="clsbtn2" VALUE="<<<bean:message key="label.remove"/><<"
                       onclick='return removeattach();'>
