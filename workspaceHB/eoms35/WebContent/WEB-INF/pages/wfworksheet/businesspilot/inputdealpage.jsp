...
<%@ include file="/WEB-INF/pages/wfworksheet/businesspilot/baseinputlinkhtmlnew.jsp"%>    
	<br/>     
	<input type="hidden" name="${sheetPageName}processTemplateName" id="${sheetPageName}processTemplateName" value="BusinessPilotProcess" />
			...
			<input type="hidden" name="${sheetPageName}phaseId" id="${sheetPageName}phaseId" value="callProcess" />
		       ...
		       <tr>
  				  ...
  				  <td class="content">
				     ...
				     onclick="popUpCalendar(this, this)" alt="vtype:'lessThen',link:'${sheetPageName}linkOperEndTime',vtext:'${eoms:a2u("试点开始时间不能晚于试点结束时间")}',allowBlank:false" value="${eoms:date2String(sheetLink.linkOperStartTime)}"/> 
  			      </td>
  				  <td class="label">
  				  ...
  				  <td class="content">
				     ...
				     onclick="popUpCalendar(this, this)"  alt="vtype:'moreThen',link:'${sheetPageName}linkOperStartTime',vtext:'${eoms:a2u("试点结束时间不能早于试点开始时间")}',allowBlank:false"  value="${eoms:date2String(sheetLink.linkOperEndTime)}"/> 
  			      </td>
               </tr>
               ...
               <tr>
  				  ...
  				  <td class="content" colspan=3>
  				   	<textarea name="linkBusDesc" id="linkBusDesc" class="textarea max" alt="allowBlank:false,maxLength:1000,vtext:'${eoms:a2u('请输入业务试点说明，最大长度为1000个汉字')}'">${sheetLink.linkBusDesc}</textarea>	  
                  </td>
	  		  </tr>	
		  	<tr>
			    <td class="label">
	  		 ...
	  		 <tr>  				
  				  ...
  				  <eoms:attachment name="sheetLink" property="linkPilotScheme" 
			              scope="request" idField="${sheetPageName}linkPilotScheme" alt="allowBlank:false" appCode="businesspilot"/>
			...
			<%if(operateType.equals("1")){ %>
  		    <tr>
		       ...
		       <tr id="test" style="display:none">
  				  ...
  				  <td class="content max" colspan=3>
  				  	<eoms:comboBox name="${sheetPageName}linkTestResult" id="${sheetPageName}linkTestResult" alt="allowBlank:false" initDicId="1010507" onchange="ifTestPass(this.value);" defaultValue="${sheetLink.linkTestResult}"/>
                  </td>	
               </tr>
		  		...
		  		<tr id="testfile" style="display:none"> 				
  				  ...
  				  <td class="content  max" colspan="3">
  				    <eoms:attachment name="sheetLink" property="linkOperateDesc" 
			              scope="request" idField="${sheetPageName}linkOperateDesc"  alt="allowBlank:false" appCode="businesspilot"/>
                  </td>                  
			...
			<input type="hidden" name="${sheetPageName}phaseId" id="${sheetPageName}phaseId" value="prepare" />
                ...
                <tr>
				  <td class="label">
		 		  ...
		 		  <td colspan=3>
				     <textarea name="linkIlluminate" id="linkIlluminate" class="textarea max" alt="allowBlank:false,maxLength:1000,vtext:'${eoms:a2u('请输入说明，最大长度为1000个汉字！')}'">${sheetLink.linkIlluminate}</textarea>	  
                </td>
  		       </tr>	
  		      	 <tr>
  		       ...
  		       <tr>  				
 				  ...
 				  <td colspan=3>
  				    <eoms:attachment name="sheetLink" property="linkTGPolicyAcc" 
			              scope="request" idField="${sheetPageName}linkTGPolicyAcc" alt="allowBlank:false" appCode="businesspilot"/>
			      </td>  
 			   </tr>	
	      <%} %>		
		     ...
		     <%if(operateType.equals("66") || operateType.equals("11")){ %>
			   ...
			   <input type="hidden" name="${sheetPageName}phaseId" id="${sheetPageName}phaseId" value="run" />
               	...
               	<tr>
	  				  ...
	  				  <td colspan=3>
	  				   	<eoms:comboBox name="${sheetPageName}linkDeviceVerify" id="${sheetPageName}linkDeviceVerify" initDicId="1010514" defaultValue="${sheetLink.linkDeviceVerify}"/>
	            ...
	            <tr>
	  				  ...
	  				  <td  colspan=3>
 	                       ...
 	                       id="linkDataFile" class="textarea max" alt="allowBlank:true,maxLength:1000,vtext:'${eoms:a2u('您输入的局数据资料超出最大长度限制，最多支持1000个汉字！')}'" >${sheetLink.linkDataFile}</textarea>
		              </td>
		  		</tr>	
                ...
                <tr>
	  				  ...
	  				  <td colspan=3>
 	                       ...
 	                       id="linkPassMan" class="textarea max" alt="allowBlank:true,maxLength:1000,vtext:'${eoms:a2u('您输入的口令管理的移交信息超出最大长度限制，最多支持1000个汉字！')}'">${sheetLink.linkPassMan}</textarea>
		              </td>
		  		</tr>					  		 
                ...
                <tr>
	  				  ...
	  				  <td colspan=3>
 	                       ...
 	                       id="linkReport" class="textarea max" alt="allowBlank:true,maxLength:1000,vtext:'${eoms:a2u('您输入的初验报告信息超出最大长度限制，最多支持1000个汉字！')}'"  >${sheetLink.linkReport}</textarea>
		              </td>
		  		</tr>
                ...
                <tr>
	  				  ...
	  				  <td colspan=3>
 	                       ...
 	                       id="linkWorkplan" class="textarea max" alt="allowBlank:true,maxLength:1000,vtext:'${eoms:a2u('您输入的作业计划制定情况超出最大长度限制，最多支持1000个汉字！')}'">${sheetLink.linkWorkplan}</textarea>
		              </td>
		  		</tr>
		  		 <tr>
			    <!-- <td class="label">
                ...
                <tr>  				
  				  ...
  				  <td colspan=3>
  				    <eoms:attachment name="sheetLink" property="linkMeetingAcc" 
			              scope="request" idField="${sheetPageName}linkMeetingAcc"  alt="allowBlank:false" appCode="businesspilot"/>
			      </td>  
  			   </tr>	
		  ...
		  <%if(operateType.equals("46") || operateType.equals("11")){ %>
			...
			<input type="hidden" name="${sheetPageName}phaseId" id="${sheetPageName}phaseId" value="check" />
		          ...
		          <tr>
 	                   ...
 	                   id="linkRunFeedBack" class="textarea max" alt="allowBlank:false,maxLength:1000,vtext:'${eoms:a2u('请输入试运行反馈，最大长度为1000个汉字！')}'">${sheetLink.linkRunFeedBack}</textarea>
	                  </td>
		  		 </tr>
		  		  <tr>
		    <!-- <td class="label">
		  ...
		  <%if(operateType.equals("64") || operateType.equals("11")){ %>
			...
			<input type="hidden" name="${sheetPageName}phaseId" id="${sheetPageName}phaseId" value="report" />
		        <tr>
	  				  ...
	  				  <td colspan=3>
	  				   	<eoms:comboBox name="${sheetPageName}linkIsUpdate" id="${sheetPageName}linkIsUpdate" alt="allowBlank:false" initDicId="1010509" defaultValue="${sheetLink.linkIsUpdate}"/>
                     </td>
		  		</tr>	
                ...
                <tr>
	  				  ...
	  				  <td colspan=3>
		  				   <textarea name="linkUpdateAdvice" id="linkUpdateAdvice" class="textarea max" alt="allowBlank:false,maxLength:1000,vtext:'${eoms:a2u('请输入技术规范修订建议，最大长度为1000个汉字！')}'">${sheetLink.linkUpdateAdvice}</textarea>
		              </td>
		  		</tr>	
		 <%}if(operateType.equals("4")){ %>
			<input type="hidden" name="${sheetPageName}dealPerformer" id="${sheetPageName}dealPerformer" value="${fOperateroleid}" />
		  ...
		  <%if(operateType.equals("62") || operateType.equals("11")){ %>
			...
			<input type="hidden" name="${sheetPageName}phaseId" id="${sheetPageName}phaseId" value="note" />
		          ...
		          <tr>
	  				  ...
	  				  <td colspan=3>
	  				   	<eoms:comboBox name="${sheetPageName}linkIsSuccess" id="${sheetPageName}linkIsSuccess" alt="allowBlank:false" onchange="ifSuccess(this.value);" initDicId="1010510" defaultValue="${sheetLink.linkIsSuccess}"/>
	                  </td>
		  		 </tr>	
		  		  <tr>
		     <td class="label">
		    ...
		    <eoms:attachment name="tawSheetAccess" property="accesss" 
		       ...
		       <tr>
	  				  ...
	  				  <td colspan=3>
		  				   <textarea name="linkConsult" id="linkConsult" class="textarea max" alt="allowBlank:false,maxLength:1000,vtext:'${eoms:a2u('请输入试点总结概述，最大长度为1000个汉字！')}'">${sheetLink.linkConsult}</textarea>
		              </td>
		  		</tr>	
		  		 ...
		  		 <tr>  				
  				  ...
  				  <eoms:attachment name="sheetLink" property="linkSummarizeAcc" 
			              scope="request" idField="${sheetPageName}linkSummarizeAcc" alt="allowBlank:false" appCode="businesspilot"/>
			  ...
			  <tr>
			    ...
			    <td colspan="3">
			      <eoms:comboBox name="${sheetPageName}linkIsFinish" 
			        id="${sheetPageName}linkIsFinish" defaultValue="${sheetLink.linkIsFinish}" initDicId="1010511" onchange="isFinish(this.value);" styleClass="select" alt="allowBlank:false"/>
			    </td>
			  </tr>
			 ...
			 <tr id="isChange" style="display:none">
			    ...
			    <td colspan="3">
			      <eoms:comboBox name="${sheetPageName}linkIsChange" 
			        id="${sheetPageName}linkIsChange" defaultValue="${sheetLink.linkIsChange}" initDicId="10301" styleClass="select" onchange="holdInvokeAgin(this.value);" alt="allowBlank:false"/>
			    </td>
			  </tr>
  		      ...
  		      <tr id="invokeAgin1" style="display:none">                
  				  <td class="label">
  				   ...
  				   <td class="content max" colspan=3>
  				     <input type="hidden" name="${sheetPageName}linkNetType" id="${sheetPageName}linkNetType" value="" />
  				     <input type="button" class="btn" value="<eoms:id2nameDB id='101050801' beanId='ItawSystemDictTypeDao'/>" onclick="javascript:openybwin('101050801')"> 
                     <input type="button" class="btn" value="<eoms:id2nameDB id='101050802' beanId='ItawSystemDictTypeDao'/>" onclick="javascript:openybwin('101050802')"> 
                     <input type="button" class="btn" value="<eoms:id2nameDB id='101050803' beanId='ItawSystemDictTypeDao'/>" onclick="javascript:openybwin('101050803')"> 
                     <input type="button" class="btn" value="<eoms:id2nameDB id='101050804' beanId='ItawSystemDictTypeDao'/>" onclick="javascript:openybwin('101050804')"> 
