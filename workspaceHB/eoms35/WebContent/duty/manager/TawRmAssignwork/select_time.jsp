                            ...
                            <table border="0" width="100%" cellspacing="1" cellpadding="1" class="listTable"
                                ...
                                <tr class="tr_show">
                                    ...
                                    <td width="40%" colspan="2" class="label">
                                        <input id="assign_auto" type="radio" name="assign_type" value="assign_auto"
                                               onclick="javascript:click_assign_auto();"><bean:message
                                            key="entry.TawRmExchange.dutyzidong"/>
                                    </td>
                                    <td width="40%" class="label">
                                        <input id="assign_manu" type="radio" name="assign_type" value="assign_manu"
                                               onclick="javascript:click_assign_manu();"><bean:message
                                            key="entry.TawRmExchange.dutyshoudong"/>
                                    </td>
                                </tr>
                                ...
                                <tr class="tr_show">
                                    ...
                                    <td width="40%" colspan="2" class="label">
                                        <input id="auto_cover" type="radio" name="assign_type" value="auto_cover"
                                               checked="checked" onclick="javascript:click_auto_cover();"><bean:message
                                            key="entry.TawRmExchange.dutyFree"/>
                                    </td>
                                    <td width="40%" class="label">
                                        <input id="auto_cover" type="radio" name="assign_type"
                                               value="auto_daily"><bean:message key="entry.TawRmExchange.dutyCord"/>
                                    </td>
                                </tr>
                                <tr class="tr_show">

                                    <td width="40%" colspan="3" class="label">
                                        <input id="auto_cover" type="radio" name="assign_type" value="auto_new"
                                               checked="checked" onclick="javascript:click_auto_new();"><bean:message
                                            key="entry.TawRmExchange.dutyquick"/>
                                ...
                                <tr class="tr_show">
                                    ...
                                    <td width="25%" class="label">
                                        ...
                                        <select name="sTeamNum" disabled="disabled">
                                            ...
                                            %>
                                            <option value="<%out.print(vTeamNum.elementAt(i));%>" selected><%
                                                out.print(vTeamNum.elementAt(i));%></option>
                                            <%
                                            } else {
                                            %>
                                            <option value="<%out.print(vTeamNum.elementAt(i));%>"><%
                                                out.print(vTeamNum.elementAt(i));%></option>
                                            <%
                                                    }
                                                }
                                    ...
                                    <td width="25%" class="label">
                                        ...
                                        <select name="sUserNum" disabled="disabled">
                                            ...
                                            %>
                                            <option value="<%out.print(vUserNum.elementAt(i));%>" selected><%
                                                out.print(vUserNum.elementAt(i));%></option>
                                            <%
                                            } else {
                                            %>
                                            <option value="<%out.print(vUserNum.elementAt(i));%>"><%
                                                out.print(vUserNum.elementAt(i));%></option>
                                            <%
                                                    }
                                                }
                                        ...
                                        <select name="sRoomUser" style="width:100">
                                            <%
                                                ...
                                                for (int i = 0; i * 2 < RoomUser.size(); i++) {
                                                    k = i;
                                            %>
                                            <option value="<%out.print(RoomUser.elementAt(i*2));%>"><%
                                                out.print(RoomUser.elementAt(i * 2 + 1));%></option>
                                            <%
                                                }
                                            %>
                                        </select>
                                ...
                                <tr class="tr_show">
                                    ...
                                    <td align="center" colspan="4" class="label">
                                        ...
                                        <eoms:SelectDate name="start_" formName="form1" flag="1"
                                                         value="<%=str_start%>"/>
                                ...
                                <tr>
                                    ...
                                    <td width="40%" colspan="2" class="label">
                                        <input type="radio" name="workSelect" value="1"><bean:message
                                            key="entry.TawRmExchange.yes"/>

                                        <input type="radio" name="workSelect" value="0" checked="checked"><bean:message
                                            key="entry.TawRmExchange.no"/>
                                    </td>
                                    <td class="label">
                        ...
                        <td>
                            <table height="32" cellpadding="0" cellspacing="0" border="0" width="100%">
                                <tr align="right" valign="middle">
                                    <td>
                                        <input type="button" class="button" name="save" value="使用模板排班"
                                               onclick="xls_input()" ;>
                                        &nbsp;&nbsp;&nbsp;
                                        <input type="button" class="button" name="save" value="重复上一周期"
                                               onclick="model_copy()" ;>
                                        &nbsp;&nbsp;&nbsp;
                                        ...
                                        <bean:message
                                                key="entry.TawRmExchange.dutyBucong"/>  <%="1".equals(request.getAttribute("haveAssign"))?"disabled":""%>  onclick="javascript:click_assign_modify();">
                                    </td>
                                </tr>
                            </table>
                        </td>
