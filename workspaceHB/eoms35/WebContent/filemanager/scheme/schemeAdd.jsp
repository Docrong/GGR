...
<table id="listTitle">
	<tr>
	<td><font size="2"><b>&nbsp;&nbsp;派发报表设置</b></font></TD>
	</tr>
</table>
<br/>
<%--enctype="multipart/form-data"--%>
<html:form action="/scheme/SchemeMgrAction.do" method="post"  enctype="multipart/form-data" >


<table class="formTable" id="list" width="100%">
<tr class="label">
	<td align="right" colspan="4" class="label"><font color="#FF0000">*为必填项</font></td></tr>
...
<html:hidden property="cycleDescription"/>
     ...
     <tr>
		...
		<td width="400">
		<html:text property="sendContact" size="20" title="联系方式" styleClass="text"/>
		</td>
	</tr>
	<tr>
  ...
  <tr>
		<td class="label"><b>周期选择</b></td>
		<td colspan="3">
         <html:radio property="cycleType" value="1" onclick="displayAreaCtl(this)" title="临时报表" styleClass="radio">临时报表&nbsp;</html:radio>
         <html:radio property="cycleType" value="2" onclick="displayAreaCtl(this)" title="以周为周期" styleClass="radio">以周为周期&nbsp;</html:radio>
         <html:radio property="cycleType" value="3" onclick="displayAreaCtl(this)" title="以月为周期报表" styleClass="radio">以月为周期报表&nbsp;</html:radio>
         <html:radio property="cycleType" value="4" onclick="displayAreaCtl(this)" title="以季度为周期报表" styleClass="radio">以季度为周期报表&nbsp;</html:radio>
         <%--<html:radio property="cycleType" value="5" onclick="displayAreaCtl(this)" title="其他复杂周期报表" styleClass="radio">其他复杂周期报表&nbsp;</html:radio>
        --%></td>
  </tr>
  <tr>
		<td class="label"><b>通知时间</b></td>
		<td colspan="3">
		<span id="cycleArea_1">
		<eoms:SelectTime name="schemeTime_1"  formName="SchemeMgrForm" min="5"/>
         <br/>
         <b>报表汇总时间（时限）</b>
		<select name="schemeAhead_1" styleClass="select">
	        <option value="1">一天以后</option>
	        <option value="2">二天以后</option>
	        <option value="3">三天以后</option>
	        <option value="4">四天以后</option>
	        <option value="5">五天以后</option>
	        <option value="6">六天以后</option>
	        <option value="7">七天以后</option>
	    </select>
		</span>
		
		<span id="cycleArea_2"  style="display:none">
		<select name="schemeTime_2" styleClass="select">
    	...
    	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      	<b>报表汇总时间（时限）</b>
        <select name="schemeAhead_2" styleClass="select">
	        <option value="1">一天以后</option>
	        <option value="2">二天以后</option>
	        <option value="3">三天以后</option>
	        <option value="4">四天以后</option>
		...
		<span id="cycleArea_3"  style="display:none">
		<select name="schemeTime_3" styleClass="select">
	        <option value="1">每月第一天</option>
	        <option value="2">每月第二天</option>
	        <option value="3">每月第三天</option>
	        <option value="4">每月第四天</option>
	        <option value="5">每月第五天</option>
	        <option value="6">每月第六天</option>
	        <option value="7">每月第七天</option>
	        <option value="8">每月第八天</option>
	        <option value="9">每月第九天</option>
	        <option value="10">每月第十天</option>
	        <option value="11">每月第十一天</option>
	        <option value="12">每月第十二天</option>
	        <option value="13">每月第十三天</option>
	        <option value="14">每月第十四天</option>
	        <option value="15">每月第十五天</option>
	        <option value="25">每月第二十五天</option>
    	</select>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      	<b>报表汇总时间（时限）</b>
        <select name="schemeAhead_3" styleClass="select">
	        <option value="1">一天以后</option>
	        <option value="2">二天以后</option>
	        <option value="3">三天以后</option>
	        <option value="4">四天以后</option>
		...
		<span id="cycleArea_4"  style="display:none">
		<select name="schemeTime_4" styleClass="select">
	        <option value="1">每季第一天</option>
	        <option value="2">每季第二天</option>
	        <option value="3">每季第三天</option>
	        <option value="4">每季第四天</option>
	        <option value="5">每季第五天</option>
	        <option value="6">每季第六天</option>
	        <option value="7">每季第七天</option>
	        <option value="8">每季第八天</option>
	        <option value="9">每季第九天</option>
	        <option value="10">每季第十天</option>
	        <option value="11">每季第十一天</option>
	        <option value="12">每季第十二天</option>
	        <option value="13">每季第十三天</option>
	        <option value="14">每季第十四天</option>
	        <option value="15">每季第十五天</option>
	        <option value="25">每月第二十五天</option>
    	</select>
    	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
     	<b>报表汇总时间（时限）</b>
        <select name="schemeAhead_4" styleClass="select">
	        <option value="1">一天以后</option>
	        <option value="2">二天以后</option>
	        <option value="3">三天以后</option>
	        <option value="4">四天以后</option>
		...
		<span id="cycleArea_5" style="display:none">
		<b>报表派发周期</b>
        <input type="text" name="schemeTime_5" id="schemeTime_5" styleClass="text">
      	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      	<b>报表汇总时间（时限）</b>
  ...
  <tr>
		...
		<td colspan=3>
		<html:text property="title" style="width:100%" title="报表名称" styleClass="text"/>
		</td>
 </tr>
   <tr>
		<td class="label"><b>合并类型</b></td>
		<td colspan=3>
				<html:select property="combinType" value="0" styleClass="select">
                <html:options collection="combinType" property="value" labelProperty="label"/>
                </html:select>
	 ...
	 <tr>
		...
		<td colspan=3>
		<html:select property="faultClass" value="2" styleClass="select">
                <html:options collection="faultClass" property="value" labelProperty="label"/>
                </html:select>
		</td>
 </tr>
	 ...
	 <tr>
		...
		<td colspan = 3>
      	<html:textarea property="reportDescription" rows="4" styleClass="textarea max" value="" title="报表描述"/>
		</td>
 </tr>
 <tr>
    ...
    <td colspan=3>
		...
		<input type="text"  readonly id ="acceptDeptName" name="acceptDeptName" styleClass="text"/>
		<input type="hidden" id="acceptDeptId" name="acceptDeptId"/>
			<input type="button" id="clkOrg" name="clkOrg" value="选择任务填写部门" class="button"/>
 ...
 <tr>
    ...
    <td colspan=3>
		<input type="text"  readonly id ="auditUserName" name="auditUserName" styleClass="text"/>
		<input type="hidden" id="auditUserId" name="auditUserId"/>
			<input type="button" id="auditUser" name="auditUser" value="选择审核人" class="button" disabled="true"/>
			<INPUT type="checkbox" id="isAudit" name="isAudit" onclick="javascript:changeAudit(this)" />是否需要审核
 ...
 <tr>
    ...
    <td colspan=3>
		...
		<input type="text"  readonly id ="reportUserName" name="reportUserName" styleClass="text"/>
		<input type="hidden" id="reportUserId" name="reportUserId"/>
			<input type="button" id="reportUser" name="reportUser" value="选择接收人" class="button"/>
 ...
 <tr>
    ...
    <td  valign="middle" colspan=3>
            ...
            <div id="nextFile"></div>
            <span onmouseover="this.style.border='2 #eeeeee outset';this.style.cursor='hand';width:10" onmouseout="this.style.border='2 #ffffff'" onmousedown="this.style.border='2 #cccccc inset';" onclick="addNextFile()"  valign="center"><img border=0 src="<%=request.getContextPath()%>/images/add1.gif"><font color="darkblue">增加上传文件</font></span>
     </td>
 </tr>
...
<TR>
	<TD>
    <input type="button" class="button" name="cancel" value="取消" onclick="javascript:window.history.back();"/>
    &nbsp;
    <input type="button" class="button" name="confirm" onclick=" prepareSubmit();" value="保存"/>
</TR>
</TABLE>
