...
<html:form action="/bureaudataUpdate.do?method=newTaskPerformAdd" styleId="theform" target="myname">
<%@ include file="/WEB-INF/pages/wfworksheet/bureaudataUpdate/baseinputlinkhtmlnew.jsp"%>
   ...
   <table class="formTable">
				<tr>
				  <td class="label"><bean:message bundle="bureaudataUpdate" key="bureaudataUpdate.linkUrgency"/>*</td>
				 ...
				 <tr>
	              <td  class="label"><bean:message bundle="bureaudataUpdate" key="bureaudataUpdate.linkReqCompleteTime"/>*</td>				 
				  <td class="content">
	              ...
	              <td  class="label"><bean:message bundle="bureaudataUpdate" key="bureaudataUpdate.linkAcceptDept"/>*</td>
				  <td class="content">
			  ...
			  <tr>
			  	<td class="label"><bean:message bundle="bureaudataUpdate" key="bureaudataUpdate.linkSendSheetDesc"/>*</td>
			    <td colspan="3">
