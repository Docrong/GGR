...
//弹出派发树窗口
function selectTree(){
	dWinOrnaments = "status:no;scroll:no;resizable:yes;dialogHeight:450px;dialogWidth:520px;";
	dWin = showModalDialog('<%=request.getContextPath()%>/css/listbox/listbox_zyjh.jsp?user=no&post=no', window, dWinOrnaments);
...
<TR>
    <td>取得数据的显示区域：<BR>
		...
		<INPUT TYPE="hidden" name="sort1_postid" id="sort1_postid" value="">
		<BR>
		...
		<INPUT TYPE="hidden" name="sort1_postid" id="sort2_postid" value="">
		<BR>
		...
		<INPUT TYPE="hidden" name="sort1_postid" id="sort3_postid" value="">
		<BR><BR>
