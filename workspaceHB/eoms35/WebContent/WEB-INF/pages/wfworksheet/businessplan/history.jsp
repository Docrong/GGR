...
<div id="history" class="panel">
    ...
    <logic:present name="HISTORY" scope="request">
        <logic:iterate id="baselink" name="HISTORY" type="com.boco.eoms.sheet.businessplan.model.BusinessPlanLink">
            <%
                jNum += 1;
            ...
            <div class="history-item"><!-- add space to hack ie-->&nbsp;
                <div class="history-item-title">
                    ...
                    <eoms:dict key="dict-sheet-businessplan" dictId="activeTemplateId"
                               itemId="${baselink.activeTemplateId}" beanId="id2descriptionXML"/>
                    <bean:message bundle="businessplan" key="businessplan.operateType"/>:
                    <eoms:dict key="dict-sheet-businessplan" dictId="mainOperateType" itemId="${baselink.operateType}"
                ...
                <div class="history-item-content hide">
                    ...
                    <table class="history-item-table" width="100%" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td class="column-content">
                                <eoms:dict key="dict-sheet-businessplan" dictId="mainOperateType"
                        ...
                        <%if (baselink.getActiveTemplateId() != null && baselink.getActiveTemplateId().equals("analyse")) {%>

                        <%if (baselink.getOperateType() != null && (baselink.getOperateType().intValue() == 91 || baselink.getOperateType().intValue() == 11)) {%>

                        <tr>
                            <td class="column-title">
                                <bean:message bundle="businessplan" key="businessplan.linkAnalyse"/>
                            </td>
                            <td class="column-content" colspan=3>
                                <pre><bean:write name="baselink" property="linkAnalyse" scope="page"/></pre>
                            </td>
                        </tr>
                        <tr>
                            <td class="column-title">
                                <pre><bean:message bundle="businessplan" key="businessplan.linkreport"/></pre>
                            </td>
                            <td class="column-content" colspan=3>
                                <eoms:attachment name="baselink" property="linkreport"
                                                 scope="page" idField="nodeAccessories" appCode="businessplan"
                                                 viewFlag="Y"/>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td class="column-title">
                                <bean:message bundle="businessplan" key="businessplan.linkIsKx"/>
                            </td>
                            <td class="column-content" colspan=3>
                                <eoms:id2nameDB id="${baselink.linkIsKx}" beanId="ItawSystemDictTypeDao"/>
                            </td>
                        </tr>
                        ...
                        <%
                            if ((baselink.getActiveTemplateId() != null && baselink.getActiveTemplateId().equals("audit")) ||
                                    (baselink.getActiveTemplateId() != null && baselink.getActiveTemplateId().equals("standard"))) {
                        %>

                        <%
                            if ((baselink.getOperateType() != null && (baselink.getOperateType().intValue() == 92 || baselink.getOperateType().intValue() == 55)) ||
                                    (baselink.getOperateType() != null && (baselink.getOperateType().intValue() == 94 || baselink.getOperateType().intValue() == 55))) {
                        %>
                        <tr>
                            <td class="label"><bean:message bundle="businessplan"
                                                            key="businessplan.linkAuditResult"/></td>
                            <td class="column-content" colspan=3>
                        ...
                        <tr>
                            <td class="column-title">
                                <bean:message bundle="businessplan" key="businessplan.linkAuditDesc"/>
                            </td>
                            <td class="column-content" colspan=3>
                        ...
                        <%if (baselink.getActiveTemplateId() != null && baselink.getActiveTemplateId().equals("appraisal")) {%>
                        ...
                        <tr>
                            <td class="column-title">
                                <bean:message bundle="businessplan" key="businessplan.linkOpion"/>
                            </td>
                            <td class="column-content" colspan=3>
                                <pre><bean:write name="baselink" property="linkOpion" scope="page"/></pre>
                            </td>
                        </tr>

                        <tr>
                            <td class="column-title">
                                <bean:message bundle="businessplan" key="businessplan.linkOpionReport"/>
                            </td>

                            <td class="column-content" colspan=3>
                                <eoms:attachment name="baselink" property="linkOpionReport"
                                                 scope="page" idField="nodeAccessories" appCode="businessplan"
                                                 viewFlag="Y"/>
                            </td>
                        </tr>
...
<script type="text/javascript">
    ...
    function copy(id) {
        ...
        if (ifCheck.checked == true) {
            Ext.Ajax.request({
                method: "get",
                url: "businessplan.do?method=getJsonLink&id=" + id + "&beanName=BusinessPlan",
                success: function (x) {
