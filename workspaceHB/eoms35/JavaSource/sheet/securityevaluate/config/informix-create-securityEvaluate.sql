...
insert into taw_system_application(app_name,notes,domain_type) values('安全评估流程','安全评估流程',1);
insert into taw_system_workflow(name,flowid,sheetid,remark,mainservicebeanid) values('SecurityEvaluateProcess','071','01','安全评估流程','iSecurityEvaluateMainManager');
