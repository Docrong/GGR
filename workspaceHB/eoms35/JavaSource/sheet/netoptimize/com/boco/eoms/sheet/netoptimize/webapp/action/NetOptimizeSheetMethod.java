 ...
 */
package com.boco.eoms.sheet.netoptimize.webapp.action;
 ...
 */
public class NetOptimizeSheetMethod extends BaseSheet {
	...
	public void showInputDealPage(ActionMapping mapping, ActionForm form,
		...
		if (taskName.equals("AcceptTask")||taskName.equals("ProjectCreateTask")
				|| taskName.equals("AuditTask")
				|| taskName.equals("ExcuteTask")|| taskName.equals("ResultEvaluateTask")) {
	...
	public Map getAttachmentAttributeOfOjbect() {
		...
		mainAttachmentAttributes.add("mainOptmizeScheme");
		
		List linkAttachmentAttributes = new ArrayList();
		linkAttachmentAttributes.add("nodeAccessories");
		linkAttachmentAttributes.add("linkProjectAcc");
		linkAttachmentAttributes.add("linkOperationAcc");
	...
	public void performPreCommit(ActionMapping mapping, ActionForm form,
		...
		if(taskName.equals("ExcuteTask")&&operateType.equals("111")){
			//查询工单互调表
		    	ITawSheetRelationManager rmgr = (ITawSheetRelationManager) ApplicationContextHolder
					.getInstance().getBean("ITawSheetRelationManager");
	...
	public boolean performIsInvokeProcess(ActionMapping mapping, ActionForm form,
		...
		if(task != null){
			...
			if(relationAllList != null && relationAllList.size()>0 && !operateType.equals("62")){
				return true;
			}else{
			    return false;
			}
