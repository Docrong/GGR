...
<script type="text/javascript">
    var config = {
        ...
        ctxMenu: [
            {
                id: 'newnode',
                text: '${eoms:a2u('新建服务类型')}',
                cls: 'new-mi',
                url: '<c:url value="/supplierkpi/editTawSupplierkpiTemplate.do?dictIdNew=" />'
            },
            {
                id: 'NewSpecial',
                text: '${eoms:a2u('新建专业模型')}',
                cls: 'new-mi',
                url: '<c:url value="/supplierkpi/editTawSupplierkpiTemplate.do?dictIdNew=" />'
            },
            {
                ...
                text: '${eoms:a2u('修改专业')}',
                cls: 'edit-mi',
                url: '<c:url value="/supplierkpi/editTawSupplierkpiTemplate.do?dictIdEdit=" />'
            },
            {
                id: 'ViewSpecial',
                text: '${eoms:a2u('查看/送审')}',
                cls: 'edit-mi',
                url: '<c:url value="/supplierkpi/viewTawSupplierkpiTemplate.do?method=view&specialType=" />'
            },
            {
                id: 'delnode',
                isDelete: true,
                text: '${eoms:a2u('删除专业')}',
                cls: 'remove-mi',
                url: '<c:url value="/supplierkpi/editTawSupplierkpiTemplate.do?method=delete&dictId=" />'
            }
        ],//end of ctxMenu
        /************************
