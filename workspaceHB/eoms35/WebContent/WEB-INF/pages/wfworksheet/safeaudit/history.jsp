        ...
        <logic:iterate id="baselink" name="HISTORY" type="com.boco.eoms.sheet.safeaudit.model.SafeAuditLink">
            ...
            <div class="history-item"><!-- add space to hack ie-->&nbsp;
                <div class="history-item-title">
                    ...
                    <eoms:dict key="dict-sheet-safeaudit" dictId="activeTemplateId"
                               itemId="${baselink.activeTemplateId}" beanId="id2descriptionXML"/>
                    <bean:message bundle="safeaudit" key="safeaudit.operateType"/>:
                    <eoms:dict key="dict-sheet-safeaudit" dictId="mainOperateType" itemId="${baselink.operateType}"
                    ...
                    <table class="history-item-table" width="100%" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td class="label"><bean:message bundle="safeaudit"
                                                            key="safeaudit.linkPresentDescribe"/></td>
                            <td colspan="3">
