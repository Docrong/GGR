...
<html:form action="ordersheets.do?method=xsave" method="post" styleId="detail">
   ...
   <tr>
    <td class="label">生成时间</td>
      <td class="content">      
         <bean:write name="ordersheetForm" property="creatTime" formatKey="date.formatDateTimeAll" bundle="ordersheet" scope="request"/>
       </td>   
      <td class="label">竣工时间</td>
      <td class="content">
        <bean:write name="ordersheetForm" property="endTime" formatKey="date.formatDateTimeAll" bundle="ordersheet" scope="request"/>
        </td>
   </tr>
   <tr>
    <td class="label">完成期限</td>
       <td class="content">
         <bean:write name="ordersheetForm" property="completeLimit" formatKey="date.formatDateTimeAll" bundle="ordersheet" scope="request"/>
       </td>  
    <td class="label">变更时间</td>
       <td class="content">
         <bean:write name="ordersheetForm" property="changeTime" formatKey="date.formatDateTimeAll" bundle="ordersheet" scope="request"/>
       </td>
    
   <tr>
     <td class="label">撤销时间</td>
       <td class="content" colspan="3">
         <bean:write name="ordersheetForm" property="cancelTime" formatKey="date.formatDateTimeAll" bundle="ordersheet" scope="request"/>
       </td>
   </tr>
 </table>
 <br>
 <table class="formTable">
   <tr><td class="label" colspan="4"><div class="header center">客户相关信息</div></td></tr>
   <tr>
...
<br>      
<table class="formTable">
<tr><td class="label" colspan="4"><div class="header center">申请业务信息</div></td></tr>
  <tr>
   ...
   <tr>
     ...
     <td class="content"><eoms:id2nameDB id="${ordersheetForm.transfBusiness}" beanId="ItawSystemDictTypeDao"/></td>   
   </tr>  
   <tr>
...
<br>     
<table class="formTable">
<tr><td class="label" colspan="4"><div class="header center">相关联系人信息</div></td></tr>
   <tr>
