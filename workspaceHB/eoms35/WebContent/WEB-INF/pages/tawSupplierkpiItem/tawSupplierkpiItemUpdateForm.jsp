<%@ page language="java"
         import="java.util.*, com.boco.eoms.commons.system.role.model.TawSystemSubRole, com.boco.eoms.base.util.StaticMethod" %>
    ...
    <div class="list">
        <table cellspacing="0" cellpadding="0" border="0" id="list-table">
            ...
            <tr height="40">
                ...
                <td width="30%">
                    <bean:define id="source" name="tawSupplierkpiItemForm" property="dataSource"
            ...
            <tr height="40">
                ...
                <td>
                    <bean:define id="impersonality" name="tawSupplierkpiItemForm" property="isImpersonality"
                                 type="java.lang.String"/>
            ...
            <tr height="40">
                ...
                <td>
                    <bean:define id="moment" name="tawSupplierkpiItemForm" property="assessMoment"
                                 type="java.lang.String"/>
                    <eoms:dict key="dict-supplierkpi" dictId="assessMoment" isQuery="false"
                               defaultId="<%=moment%>" selectId="assessMoment" beanId="selectXML"
                               onchange="setCycle()"/>
                </td>
                ...
                <td>
                    <logic:match name="tawSupplierkpiItemForm" property="assessMoment" value="106010603">
                        <bean:define id="cycle" name="tawSupplierkpiItemForm" property="statictsCycle"
                                     type="java.lang.String"/>
            ...
            <tr height="40">
                ...
                <td colspan="3">
                    ...
                    <html:select name="tawSupplierkpiItemForm" property="preActor" value="<%=actor%>">
                        ...
                        %>
                        <html:option value="<%=subRole.getId() %>"><%=subRole.getSubRoleName() %>
                        </html:option>
                        <%}%>
                    </html:select>
                </td>
            ...
            <tr height="40">
                ...
                <td colspan="3">
                    <html:textarea property="assessContent" styleId="assessContent" styleClass="textarea small"
                                   style="width:88%"/>
                </td>
            </tr>
            <tr height="40">
                ...
                <td colspan="3">
                    <html:textarea property="assessNote" styleId="assessNote" styleClass="textarea small"
                                   style="width:88%"/>
                </td>
            </tr>
            <tr align="left" height="15">
                <td colspan="4">
                    ...
                    <input type="button" class="btn" value="${eoms:a2u('返回')}"
                           onclick="window.location.replace('${app}/supplierkpi/viewTawSupplierkpiTemplate.do?method=view&specialType=<%=specialType %>');"/>
                    <%} %>
                </td>
            </tr>
            <script type="text/javascript">
