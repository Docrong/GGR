	...
	<fieldset id="link1">
	 <legend>
	      ...
	      <table class="formTable" id="segTab">
			<tr >
			<td  >启始号段</td>
			<td ><input type="text" size="11" maxlength="10" class="limitinput" limit="^[0-9]*$" name="beginsegment"/></td>
			<td  >终止号段</td>
			...
			<td ><span class="prettyShow">
	         ...
	         <td>&nbsp;&nbsp;<input type="button" value="增加行" class="btn" onclick="splitSegment(this.parentNode.parentNode)"/>
	         	&nbsp;&nbsp;<input type="button" value="删除行" class="btn" onclick="deleteSegment(this.parentNode.parentNode)"/>
	         </td>
			</tr>
		</table>
			<%} %>
