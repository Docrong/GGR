...
<div id="history" class="panel">
    ...
    <logic:present name="HISTORY" scope="request">
        ...
        <logic:iterate id="baselink" name="HISTORY"
                       type="com.boco.eoms.sheet.branchindexreduction.model.BranchIndexReductionLink">
            <%
                jNum += 1;
            ...
            <div class="history-item">&nbsp;
                ...
                <div class="history-item-title">
                    ...
                    <eoms:dict key="dict-sheet-branchindexreduction" dictId="activeTemplateId"
                    ...
                    <eoms:dict key="dict-sheet-branchindexreduction" dictId="mainOperateType"
                    ...
                    <table class="formTable" width="100%" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td class="label">
                                ...
                                <bean:message bundle="branchindexreduction"
                                              key="branchIndexReductionLink.linkManTelephone"/>
                            </td>
                            <td class="content">
                        ...
                        <tr>
                            ...
                            <td class="label">
                                <!-- 初审说明 -->
                                <bean:message bundle="branchindexreduction"
                                              key="branchIndexReductionLink.linkTrialIllustrate"/>
                            </td>
