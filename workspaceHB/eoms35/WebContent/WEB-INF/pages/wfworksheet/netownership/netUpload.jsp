...
<script type="text/javascript">
    Ext.onReady(function () {
        Ext.Ajax.request({
            url: 'netownership.do?method=showNetType',
            method: 'POST',
    ...
    function importTemp() {
        ...
        if (template.length <= 24 && template.length != 0) {
            ...
            if (tempType == 'xls') {
                ...
                Ext.Ajax.request({
                    method: "post",
                    url: "netownership.do?method=importExcel&accessoriesname=" + template,
                    success: function (x) {
...
<html:form action="/netownership.do?method=exportExcel&appId=netownership" method="post" styleId="theform">
    <table class="formTable">
        ...
        <tr>
            ...
            <td class="content">
                ...
                <br/><br/>
                地市:<textarea class="textarea max" readonly="true" name="eomsCity" style="height:50px" id="eomsCity"
                             required></textarea><br/>
                区县:<textarea class="textarea max" readonly="true" name="eomsCounty" style="height:50px" id="eomsCounty"
                             required></textarea>
        ...
        <tr>
            <td colspan="4">
                <input type="button" id="exportTempButton" value="生成模板" class="button"
                       onclick="javascript:exportTemp();">
            </td>
        </tr>
    </table>
    <br>
        ...
        <tr>
            ...
            <td class="content" colspan="3">
                <eoms:attachment name="sheetLink" property="mainImportTemplate" scope="request"
                                 idField="mainImportTemplate" appCode="netownership"/>
            </td>
        </tr>
        <tr>
            <td colspan="4">
                <input type="button" id="importTempButton" value="提交" class="button"
                       onclick="javascript:importTemp();"/>
            </td>
        </tr>
    </table>
</html:form>
<script type="text/javascript">
    function exportTemp() {
        ...
        var eomsCity = thisform.eomsCity.value;
        var eomsCounty = thisform.eomsCounty.value;
        if (eomsCity != '' || eomsCounty != '') {
            thisform.action = "http://10.25.119.42:8080/netownership/NetOwnershipAction?method=exportExcel&appId=netownership";
            thisform.submit();
