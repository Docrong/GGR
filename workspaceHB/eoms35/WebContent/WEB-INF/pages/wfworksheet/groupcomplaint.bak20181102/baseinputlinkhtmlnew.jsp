...
<input type="hidden" name="linkBeanId" value="iGroupComplaintLinkManager"/>
<table class="formTable">
    ...
    <tr>
        ...
        <td class="content">
            ...
            <input class="text" onclick="popUpCalendar(this, this)" type="text"
                   name="${sheetPageName}nodeCompleteLimit" id="${sheetPageName}nodeCompleteLimit" readonly="readonly"
            ...
            <input class="text" type="text"
                   name="${sheetPageName}nodeCompleteLimit" readonly="readonly" onclick="popUpCalendar(this, this)"
                   value="${eoms:date2String(sheetMain.sheetCompleteLimit)}" id="${sheetPageName}nodeCompleteLimit"
                   alt="vtype:'moreThen',link:'${sheetPageName}nodeAcceptLimit',vtext:'完成时限不能早于受理时限',allowBlank:false"
            />
            <%} %>
    ...
    <%} else { %>
    <input type="hidden" name="${sheetPageName}nodeAcceptLimit" readonly="readonly"
           value="${eoms:date2String(task.acceptTimeLimit)}" id="${sheetPageName}nodeAcceptLimit"/>
    <input type="hidden" name="${sheetPageName}nodeCompleteLimit" readonly="readonly"
           value="${eoms:date2String(task.completeTimeLimit)}" id="${sheetPageName}nodeCompleteLimit"/>
    <%} %>
</table>
