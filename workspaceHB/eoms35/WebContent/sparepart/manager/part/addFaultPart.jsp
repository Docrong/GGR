...
<div align="center">
    <br>
    <form method="post" action="<%=request.getContextPath()%>/sparepart/part/addFaultPartSubmit.do" name="frm"
        ...
        <table border="0" width="80%" cellspacing="1" cellpadding="1" class="table_show" align=center>
            ...
            <tr class="tr_show">
                ...
                <td width="70%" height="25" colspan="2">
                    <input type="text" size="35" value="<%=StaticMethod.null2String(sparepartForm.getEname())%>"
                           name="ename">
                </td>
            </tr>
            ...
            <tr class="tr_show">
                <td class="clsfth" width="30%" height="25">
                    <p style="margin-top: 0; margin-bottom: 0"><bean:message
                            key="sparepart.managecode"/>${eoms:a2u('：')}</p>
                </td>
                <td width="70%" height="25" colspan="2">
            ...
            <tr class="tr_show">
                ...
                <td width="70%" height="25" colspan="2">
                    <input size="35" readonly="readonly"
                           value="<%=StaticMethod.null2String(sparepartForm.getOperator())%>" name="operator"/>
                </td>
            </tr>
            <%--
            入库状态：故障
            ...
            <tr class="tr_show" id="sheettype">
                ...
                <td width="70%" height="25" colspan="2">
                    <input type="text" size="35" value="<%=StaticMethod.null2String(sparepartForm.getSheetid())%>"
                           name="sheetid" readonly="readonly">
                    <input type="submit" name="toquery" value="${eoms:a2u('查询工单号')}"
                           onclick=document.frm.action="../../newworksheet/part/accessory.do"/>
                </td>
            </tr>
        ...
        <table border="0" width="80%" cellspacing="0">
            <tr>
                <td height="32" align="right">
                    <input type="submit" value="<bean:message key="label.submit"/>" name="submit"
                           onclick="frm.differ.value=1" class="clsbtn2">
                </td>
            </tr>
        </table>
