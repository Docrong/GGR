        ...
        <tr>
            ...
            <td>
                ...
                <html:text property="allNum" styleId="allNum"
                           styleClass="text medium"
                           alt="allowBlank:false,vtype:'number',vtext:'${eoms:a2u('请输入物品数量')}'"
        ...
        <tr>
            ...
            <td>
                ...
                <html:textarea property="describe" styleId="describe"
                               ...
                               alt="allowBlank:false,vtext:'${eoms:a2u('请输入物品描述')}',maxlenth:512"
                               readonly="true"></html:textarea>
            </td>
        </tr>
        <tr>
            <td align="center" colspan="2">
                <html:button property="button.back" styleClass="button"
                             onclick="javascript:window.self.close();">${eoms:a2u('关闭')}</html:button>
            </td>
        </tr>
    </table>
</html:form>
