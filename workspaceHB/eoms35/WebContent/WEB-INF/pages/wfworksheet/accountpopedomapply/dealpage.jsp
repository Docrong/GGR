  ...
  <html:form action="/accountpopedomapply.do?method=newPerformDeal" styleId="theform">
   ...
   <c:choose> 
    <c:when test="${operateType=='61'}">    
		  ...
		  <input type="submit" class="submit" onclick="v.passing=true;this.form.action='${app}/sheet/accountpopedomapply/accountpopedomapply.do?method=performClaimTask'" 
     ...
     <c:when test="${taskName=='DraftHumTask'}">   
		   <div class="form-btns hide" id="btns">
	          ...
	          <input type="submit" class="submit" onclick="v.passing=true;this.form.action='${app}/sheet/accountpopedomapply/accountpopedomapply.do?method=performSaveInfoAndExit&draft=1'" value="<bean:message bundle='sheet' key='button.saveback'/>" />
	          <input type="submit" class="submit" onclick="v.passing=true;this.form.action='${app}/sheet/accountpopedomapply/accountpopedomapply.do?method=showDraftList'" value="<bean:message bundle='sheet' key='button.back'/>" />
		  </div>  
   	</c:when>
   	<c:when test="${taskName=='ByRejectHumTask'}">    
		<div class="form-btns" id="btns">
