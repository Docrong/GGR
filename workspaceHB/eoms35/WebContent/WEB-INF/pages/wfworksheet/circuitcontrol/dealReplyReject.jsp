...
<div id="sheetform">
    <html:form action="/circuitcontrol.do?method=performDealReplyReject" styleId="theform">
        <%
        ...
        <input type="hidden" name="subtaskName" value="CircuitControlSubTask"/>
        ...
        <input type="hidden" name="taskNamespace" value="http://CircuitControl"/>
