...
<html:form action="/tawApparatuss.do?method=xlsSave"
	method="post" styleId="tawApparatusForm"
		...
		<tr>
			<td COLSPAN="17">
				<input type="submit"
					...
					class="submit">
					&nbsp;&nbsp;&nbsp;
&nbsp; <input type="button" class="button" name="save" value="下载导入模板" Onclick="window.location.href ='${app }/partner/baseinfo/tawApparatuss.do?method=outPutModel'" >
&nbsp;
