...
<html:form action="/safetyproblem.do?method=newPerformNonFlow" styleId="theform">
    ...
    <br/>
	      <input type="hidden" name="${sheetPageName}processTemplateName" id="${sheetPageName}processTemplateName" value="SafetyProblemMainFlowProcess" />
           ...
           <input type="hidden" name="${sheetPageName}mainClassName" id="${sheetPageName}mainClassName"  value="com.boco.eoms.sheet.safetyproblem.model.SafetyProblemMain"/>		
           <input type="hidden" name="${sheetPageName}linkClassName" id="${sheetPageName}linkClassName" value="com.boco.eoms.sheet.safetyproblem.model.SafetyProblemLink"/> 
