...
<table class="formTable">
	...
	<c:if test="${!empty columnMap}">
		...
		<tr>
			...
			<td>
        		<html:text property="overtimeLimit" styleId="overtimeLimit"	styleClass="text medium" alt="allowBlank:false,maxLength:9,vtext:'请填入预超时提醒时间，最多输入9个字符'" value="${overtimetip.overtimeLimit}"/>
			</td>
		</tr>
</table>
