    ...
    <table class="formTable">
        ...
        <tr class="tr_show">
            ...
            <td width="70%" height="25" colspan="2">
                <html:text styleClass="clstext" property="beginTime"
                           onclick="popUpCalendar(this, this,null,null,null,true,-1);" readonly="readonly" size="21"
                           value="<%=StaticMethod.getLocalString()%>"/>
            </td>
        </tr>
        <tr class="tr_show">
            <td class="clsfth">
            ...
            <td width="70%" height="25" colspan="2">
                <html:text styleClass="clstext" property="endTime"
                           onclick="popUpCalendar(this, this,null,null,null,true,-1);" readonly="readonly" size="21"
                           value="<%=StaticMethod.getLocalString()%>"/>
            </td>
        </tr>
