...
<%@page import="com.boco.eoms.sheet.processchange.model.ProcessChangeTask" %>
...
ProcessChangeTask task = new ProcessChangeTask();
String operaterType = "";
String ifsub = "";
String ifwaitfor="";
if(request.getAttribute("task")!=null){
 task = (ProcessChangeTask)request.getAttribute("task");
...
Ext.onReady(function() {
	var tabConfig = {
		items : [{
			...
			url : 'processchange.do?method=showSheetDealList&sheetKey=${sheetMain.id}&taskName=${taskName}&ifWaitForSubTask=${task.ifWaitForSubTask}'
		}, {
			text : '<bean:message bundle="sheet" key="sheet.flowchar"/>',
			//url : '/ProcessMonitor/runtime/html/index.jsp?appName=ProcessChangeProcessApp&templateName=processchangeMainFlowProcess&piid=${sheetMain.piid}&listType=myProcesses&curPage=0',
			//url : 'processchange.do?method=showWorkFlow&sheetKey=${sheetMain.id}',
			  url : 'processchange.do?method=showWorkFlow&linkServiceName=iProcessChangeLinkManager&dictSheetName=dict-sheet-processchange&description=mainOperateType&sheetKey=${sheetMain.id}',
			isIframe : true
		},{
			text : '<bean:message bundle="sheet" key="sheet.filesView"/>',
			url : 'processchange.do?method=showSheetAccessoriesList&id=${sheetMain.id}',
			isIframe : true
		}, {
	...
	var url2="processchange.do?method=newShowCCPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}&operateType=-10&taskStatus=${taskStatus}";
	eoms.util.appendPage("sheet-deal-content",url2);	
	<%}%>
	<%if(taskName.equals("reply")){ %>
	var url2="processchange.do?method=showRemarkPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}";
	eoms.util.appendPage("sheet-deal-content",url2);	
	<%}%>
...
function forceOperation(obj){
	...
	if(obj == 1){
	    // window.location.href='processchange.do?method=showForceHoldPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}&operateType=forceHold';
	   var url2="processchange.do?method=showForceHoldPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}&operateType=forceHold";
	   eoms.util.appendPage("sheet-deal-content",url2);	  
	}else if(obj == 2){
	    // window.location.href='processchange.do?method=showForceHoldPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}&operateType=nullity';
	   var url2="processchange.do?method=showForceHoldPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}&operateType=nullity";
	   eoms.util.appendPage("sheet-deal-content",url2);	 
	}else{
	   //  window.location.href='processchange.do?method=showForceHoldPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}&operateType=forceNullity';
        var url2="processchange.do?method=showForceHoldPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}&operateType=forceNullity";
	    eoms.util.appendPage("sheet-deal-content",url2);
    }
   }
    function eventOperation(obj){
	if(obj == 1){
	     var url2="processchange.do?method=showPhaseAdvicePage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&taskName=advice&operateFlag=driveForward&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}";
...
<div id="sheet-detail-page">
  ...
  <div id="sheetinfo">
	...
	<%@ include file="/WEB-INF/pages/wfworksheet/processchange/basedetailnew.jsp"%>
	<br/>
			  ...
			  <td class="content">
               ...
               <tr>
	             <td  class="label"><bean:message bundle="processchange" key="processchange.mainProcessType"/></td>
	                <td class="content"> 
	                 <eoms:id2nameDB id="${sheetMain.mainProcessType}" beanId="ItawSystemDictTypeDao"/> 
		        </td>	 
	             <td  class="label"><bean:message bundle="processchange" key="processchange.mainProcess"/></td>
	                <td class="content"> 
	                 <eoms:id2nameDB id="${sheetMain.mainProcess}" beanId="ItawSystemDictTypeDao"/> 
		        </td>	
		       </tr>         	            
			      <tr>
		            <td  class="label"><bean:message bundle="processchange" key="processchange.mainEditReason"/></td>
		              <td class="content" colspan="3"> 	
    				  <pre><bean:write  name="sheetMain"  property="mainEditReason"  scope="request"/></pre>
                    </td>
		          </tr>	  
			      <tr>
		            <td  class="label"><bean:message bundle="processchange" key="processchange.mainEditAdvice"/></td>
		              <td class="content" colspan="3"> 	
    				  <pre><bean:write  name="sheetMain"  property="mainEditAdvice"  scope="request"/></pre>
                    </td>
		          </tr>	
	              <tr>	              
...
<c:url var="urlShowEvaluateTaskDealPage" value="processchange.do">
...
<c:url var="urlShowMakeTaskDealPage" value="processchange.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<c:url var="urlShowAuditTaskDealPage" value="processchange.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<c:url var="urlShowReleaseTaskDealPage" value="processchange.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<c:url var="urlShowOperateTaskDealPage" value="processchange.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 草稿派发 -->
<c:url var="urlShowDraftDeal" value="processchange.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 重新派发 -->
<c:url var="urlShowBackDeal" value="processchange.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 归档 -->
<c:url var="urlShowHoldDealPage" value="processchange.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 退回 -->
<c:url var="urlShowRejectBackDealPage" value="processchange.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 转派 -->
<c:url var="urlShowTransferkPage" value="processchange.do">
...
<!-- 转审 -->
<c:url var="urlShowTransferAuditPage" value="processchange.do">
  <c:param name="method" value="showTransferWorkItemPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 阶段回复 -->
<c:url var="urlShowPhaseReplyPage" value="processchange.do">
...
<!-- 驳回 -->
<c:url var="urlShowRejectBackPage" value="processchange.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 确认受理 -->
<c:url var="urlShowAcceptDealPage" value="processchange.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 分派 -->
<c:url var="urlShowInputSplit" value="processchange.do">
...
<!-- 会审 -->
<c:url var="urlShowInputSplitAudit" value="processchange.do">
  <c:param name="method" value="showInputSplit"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 分派回复 -->
<c:url var="urlShowDispatchPage" value="processchange.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 会审回复 -->
<c:url var="urlShowDispatchAuditPage" value="processchange.do">
  <c:param name="method" value="showDealPage"/>
  <c:param name="sheetKey" value="${sheetMain.id}"/>
  <c:param name="piid" value="${sheetMain.piid}"/>
  <c:param name="taskId" value="${taskId}"/>
...
<!-- 处理回复通过 -->
<c:url var="urlShowDealReplyAcceptPage" value="processchange.do">
...
<!-- 处理回复不通过 -->
<c:url var="urlShowDealReplyRejectPage" value="processchange.do">
...
<div class="sheet-deal">
	...
	<%if(taskName.equals("EvaluateTask")){ %>
		<select id="dealSelector">
		 ...
		 <%if(ifwaitfor.equals("false")) {%>	
		  <option value="${urlShowEvaluateTaskDealPage}"><bean:message bundle="processchange" key="operateType.submitScheme"/></option>	  
	...
	<%}else if(taskName.equals("MakeTask")){%>	
		<select id="dealSelector">
		 ...
		 <%if(ifsub.equals("") || ifsub.equals("false")){%>
		 <%if(ifwaitfor.equals("false")) {%>	
		  <option value="${urlShowMakeTaskDealPage}"><bean:message bundle="processchange" key="operateType.completeScheme"/></option>	  
		  <option value="${urlShowTransferkPage}"><bean:message bundle="sheet" key="common.transfer"/></option>	
		  <option value="${urlShowPhaseReplyPage}"><bean:message bundle="sheet" key="event.reply"/></option>
		  <%}%>
		  <%}else{%> 
	...
	<%}else if(taskName.equals("AuditTask")){ %>
		<select id="dealSelector">
		 ...
		 <%if(ifsub.equals("") || ifsub.equals("false")){%>
		 <%if(ifwaitfor.equals("false")) {%>	    
		  <option value="${urlShowAuditTaskDealPage}"><bean:message bundle="processchange" key="operateType.auditScheme"/> </option>
		...
		<%if(taskStatus.equals(Constants.TASK_STATUS_READY)){%>
		 ...
		 <%if(ifsub.equals("") || ifsub.equals("false")){%>
		 <%if(ifwaitfor.equals("false")) {%>
		  <option value="${urlShowReleaseTaskDealPage}"><bean:message bundle="processchange" key="operateType.releaseProcess"/></option>		  
		  <option value="${urlShowTransferkPage}"><bean:message bundle="sheet" key="common.transfer"/></option>
		  <option value="${urlShowPhaseReplyPage}"><bean:message bundle="sheet" key="event.reply"/></option>
		  <%}%>
		  <%}else{%> 
		...
		<%if(taskStatus.equals(Constants.TASK_STATUS_READY)){%>
		 ...
		 <%if(ifsub.equals("") || ifsub.equals("false")){%>
		 <%if(ifwaitfor.equals("false")) {%>
		  <option value="${urlShowOperateTaskDealPage}"><bean:message bundle="processchange" key="operateType.operate"/></option>		  
		  <option value="${urlShowTransferkPage}"><bean:message bundle="sheet" key="common.transfer"/></option>
		  <option value="${urlShowPhaseReplyPage}"><bean:message bundle="sheet" key="event.reply"/></option>
		  <%}%>
		  <%}else{%> 
	...
	<%}else if(taskName.equals("DraftTask")){%>	
		<select id="dealSelector">
		  <option value="${urlShowDraftDeal}"><bean:message bundle="processchange" key="operateType.draft"/></option>
		</select>
   ...
   <%}else if(taskName.equals("HoldTask")){ %>
		<select id="dealSelector">
		  <option value="${urlShowHoldDealPage}"><bean:message bundle="processchange" key="operateType.hold"/></option>
		  <option value="${urlShowRejectBackDealPage}"><bean:message bundle="processchange" key="operateType.back"/></option>
		</select>					
	<%}%>			
...
<script type="text/javascript">
	...
	try{
        ...
        if (dealTemplateId != null && dealTemplateId != "") {
   			url = "processchange.do?method=referenceTemplate&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&taskName=${taskName}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&operateType=${operateType}&taskStatus=${taskStatus}&dealTemplateId="+dealTemplateId
        }
