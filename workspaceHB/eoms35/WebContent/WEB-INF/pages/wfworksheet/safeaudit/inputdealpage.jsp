...
<table class="formTable">
    ...
    <tr>
        ...
        <td colspan='3'>
            <textarea class="textarea max" name="${sheetPageName}linkCheckResult" id="${sheetPageName}linkCheckResult"
    ...
    <tr>
        ...
        <td colspan="3">
            <eoms:comboBox name="${sheetPageName}LinkIfStartSecurityDeal" id="${sheetPageName}LinkIfStartSecurityDeal"
                           ...
                           defaultValue="${baseLink.LinkIfStartSecurityDeal}" onchange="popOtherFlow1(this.value);"/>
