...
<div class="list">
    <html:form action="/tawSuppKpiInstReOrderQuery.do?method=vertical" method="post" styleId="theform"
        ...
        <table width="80%">
            ...
            <tr height="50">
                ...
                <td>
                    <select name="reportName" onchange="changeLatitude();">
                        ...
                        %>
                        <option value="<%=reportName.getId()%>@<%=reportName.getLatitude()%>"><%=reportName.getReportName() %>
                        </option>
                        <%
                            }
                        %>
                ...
                <td>
                    <select name="manufacturerName">
                        ...
                        %>
                        <option value="<%=tawSupplierkpiInfo.getId()%>"><%=tawSupplierkpiInfo.getSupplierName()%>
                        </option>
                        <%
                            }
                        %>
            ...
            <tr align="right" height="40">
                <td colspan="4">
                    <input type="submit" styleClass="btn" property="method.save" styleId="method.save"
                           value="<bean:message key="button.querys" />"/>
                </td>
