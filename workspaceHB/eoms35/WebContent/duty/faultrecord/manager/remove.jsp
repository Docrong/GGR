...
<center>
    ...
    <BR>
    <html:form method="POST" action="/Faultrecord/deldo">
        <TABLE cellSpacing="0" cellPadding="0" width="95%" border="0" align=center>
            <TR>
                <TD align="right">
                    <input type="hidden" name="id"
                           value="<bean:write name="BASEINFOVO" property="id" scope="request"/>">
                    <html:submit styleClass="button"><bean:message key="label.remove"/></html:submit>&nbsp;
