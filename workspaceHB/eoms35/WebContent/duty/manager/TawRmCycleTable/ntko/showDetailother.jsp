...
<FORM id="myForm" METHOD="POST" ENCTYPE="multipart/form-data"
    ...
    <TABLE BORDER=0 width=600>
        <tr>
            <td align="center"><input TYPE=hidden id="filename" name="filename" MAXLENGTH=50 size=50
                                      value="<%=request.getParameter("path")%>">
                <INPUT type=BUTTON
                       VALUE=${eoms:a2u("保存")}  onclick="TANGER_OCX_SaveEditToServer('<%=request.getParameter("path")%>');">
            </td>
