...
function showPage(){
     var pars = '';
     var url = '';    
      url = '${app}/sheet/offlineData/offlineData.do?method=showInputRejectPage&piid=${sheetMain.piid}&taskId=${taskId}&taskName=${taskName}';
     if (url!=''){
...
<div id="sheetform">
<html:form action="/offlineData.do?method=performDeal" styleId="theform">
