 ...
 * @version 1.0
 */
public class KmExpertScore extends BaseObject {
    ...
    public boolean equals(Object o) {
        if (o instanceof KmExpertScore) {
            KmExpertScore kmExpertScore = (KmExpertScore) o;
            if (this.id != null || this.id.equals(kmExpertScore.getId())) {
                return true;
            } else {
                return false;
            }
