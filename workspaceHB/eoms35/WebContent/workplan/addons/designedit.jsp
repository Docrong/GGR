...
<form method="post" name="tawRmCycleTableForm" action="addonsexcelsave.do" onSubmit="return checkForm()"
    ...
    <table border=0 cellspacing="1" cellpadding="1" class="listTable">
        ...
        <tr>
            ...
            <td COLSPAN="14">
                <textarea cols="50" name="remark" value=""
                          class="textarea max"><%=tawwpAddonsTableVO.getText()%></textarea>
            </td>
        </tr>
