...
<logic:present name="HISTORY" scope="request">  
      ...
      <logic:iterate id="baselink" name="HISTORY" type="com.boco.eoms.sheet.transprovincial.model.TransprovincialLink" >     
       <%         
        jNum += 1;       
      ...
      <div class="history-item">&nbsp;   
	      ...
	      <div class="history-item-title">
			 ...
			 <bean:write name="baselink" property="operateTime" formatKey="date.formatDateTimeAll" bundle="sheet" scope="page"/>&nbsp; 
	  	     ...
	  	     <eoms:dict key="dict-sheet-transprovincial" dictId="activeTemplateId" itemId="${baselink.activeTemplateId}" beanId="id2descriptionXML" />
	  	     <bean:message bundle="transprovincial" key="transprovincial.operateType"/>:
	  	     <eoms:dict key="dict-sheet-transprovincial" dictId="mainOperateType" itemId="${baselink.operateType}" beanId="id2descriptionXML" />
	 ...
	 <!-- 流程中的历史页面 -->
		  		...
		  		<%if(baselink.getActiveTemplateId()!=null && baselink.getActiveTemplateId().equals("Assignment")) {%>
		  				...
		  				<%if(true){ %>
							...
							<td class="content">
								...
								<pre>${baselink.assignmentResult}</pre>
	 						</td>
		  		...
		  		<%if(baselink.getActiveTemplateId()!=null && baselink.getActiveTemplateId().equals("ProjectDesign")) {%>
		  		...
		  		<%if(baselink.getActiveTemplateId()!=null && baselink.getActiveTemplateId().equals("SubmitExamine")) {%>
		  				...
		  				<%if(baselink.getOperateType() != null && (baselink.getOperateType().intValue() == 104 || baselink.getOperateType().intValue() == 11)){ %>
							...
							<td class="content">
								...
								<pre>${baselink.examineResult}</pre>
	 						</td>
		  		...
		  		<%if(baselink.getActiveTemplateId()!=null && baselink.getActiveTemplateId().equals("ProjectExamine")) {%>
		  				...
		  				<%if(baselink.getOperateType() != null && (baselink.getOperateType().intValue() == 105 || baselink.getOperateType().intValue() == 11)){ %>
							...
							<td class="content">
								...
								<pre>${baselink.constractCondition}</pre>
	 						</td>
		  		...
		  		<%if(baselink.getActiveTemplateId()!=null && baselink.getActiveTemplateId().equals("ProjectConstract")) {%>
		  				...
		  				<%if(baselink.getOperateType() != null && (baselink.getOperateType().intValue() == 106 || baselink.getOperateType().intValue() == 11)){ %>
							...
							<td class="content">
								...
								<pre>${baselink.completeResult}</pre>
	 						</td>
		  		...
		  		<%if(baselink.getActiveTemplateId()!=null && baselink.getActiveTemplateId().equals("SubmibAcceptance")) {%>
		  				...
		  				<%if(baselink.getOperateType() != null && (baselink.getOperateType().intValue() == 107 || baselink.getOperateType().intValue() == 11)){ %>
							...
							<td class="content">
								...
								<pre>${baselink.acceptanceCondition}</pre>
	 						</td>
		  		...
		  		<%if(baselink.getActiveTemplateId()!=null && baselink.getActiveTemplateId().equals("AcceptanceExamine")) {%>
		  				...
		  				<%if(baselink.getOperateType() != null && (baselink.getOperateType().intValue() == 108 || baselink.getOperateType().intValue() == 11)){ %>
							...
							<td class="content">
								...
								<pre>${baselink.acceptanceResult}</pre>
	 						</td>
		  		...
		  		<%if(baselink.getActiveTemplateId()!=null && baselink.getActiveTemplateId().equals("CompletionTask")) {%>
		  				...
		  				<%if(baselink.getOperateType() != null && (baselink.getOperateType().intValue() == 109 || baselink.getOperateType().intValue() == 11)){ %>
							...
							<td class="content">
								...
								<pre>${baselink.completionResult}</pre>
	 						</td>
...
<script type="text/javascript">
 ...
 function copy(id){
    ...
    Ext.Ajax.request({
		method:"get",
		url: "transprovincial.do?method=getJsonLink&id="+id+"&beanName=Transprovincial",
		success: function(x){
