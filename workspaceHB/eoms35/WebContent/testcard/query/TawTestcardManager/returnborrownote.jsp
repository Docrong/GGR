...
<table cellSpacing="0" cellPadding="0" width="95%" border="0">
       <tr>
        ...
        <tr>
                <td noWrap width="100" class= "label">${eoms:a2u("卡号(iccid)")}</td>
                <td width="380">
                      <bean:write name="tawTestcardManagerForm" property="cardid"/>&nbsp
                </td>
                <td noWrap width="100" class= "label">msisdn</td>
                <td width="380" >
                      <bean:write name="tawTestcardManagerForm" property="msisdn"/>&nbsp
                </td>
                <td noWrap width="100" class= "label">${eoms:a2u("借用部门")}</td>
                <td width="380" >
                      <bean:write name="tawTestcardManagerForm" property="lenddept"/>&nbsp
                </td>
        </tr>
        <tr>                
                <td noWrap width="100" class= "label">${eoms:a2u("借用人")}</td>
                <td  width="380" >
                 <bean:write name="tawTestcardManagerForm" property="lender"/>&nbsp
                </td>
                <td noWrap width="100"  class= "label">${eoms:a2u("借出人")}</td>
                <td width="380">
                      <bean:write name="tawTestcardManagerForm" property="dealer"/>&nbsp
                </td>
                <td noWrap width="100"  class= "label">${eoms:a2u("借用时间")}</td>
              <td width="380">
                      <bean:write name="tawTestcardManagerForm" property="leantime"/>&nbsp
              </td>              
       </tr>
       <tr>
         <td noWrap width="100"  class= "label">${eoms:a2u("归还人")}</td>
                <td width="380">
                  <bean:write name="tawTestcardManagerForm" property="returner"/>&nbsp
                      &nbsp
                </td>
         <td noWrap width="100"  class= "label">${eoms:a2u("批准人")}</td>
              <td width="380">
                     <bean:write name="tawTestcardManagerForm" property="checker"/>&nbsp
              </td>
              <td noWrap width="100"  class= "label">${eoms:a2u("归还时间")}</td>
              <td width="380">              
	...
	<tr bgcolor="#FFFFFF">
          <td nowrap class="label" align="center" height="25">
        	...
        	<td nowrap class="label" align="center" height="25">
        	   	...
        	   	<logic:iterate id="tawTestcardManagerNote" name="tawTestcardManagerNote" type="com.boco.eoms.testcard.model.TawTestcardManagerNote">
		<tr bgcolor="#FFFFFF">
     			<td nowrap bgcolor="#E5EDF8" align="center">
     			   <% if(!(tawTestcardManagerNote.getRenewer()==null)&&!(tawTestcardManagerNote.getRenewer().equals(""))){ %>     
     			       <bean:write name="tawTestcardManagerNote" property="renewer" scope="page"/>
     			   <% }else{ %>   
                    		<bean:write name="tawTestcardManagerNote" property="lender" scope="page"/>
                   <% } %>
    			</td>
    			<td nowrap bgcolor="#E5EDF8" align="center" >
                    		<% if(!(tawTestcardManagerNote.getRenewer()==null)&&!(tawTestcardManagerNote.getRenewer().equals(""))){ %>     
     			       <bean:write name="tawTestcardManagerNote" property="relenddept" scope="page"/>
     			   <% }else{ %>   
                    		<bean:write name="tawTestcardManagerNote" property="lenddept" scope="page"/>
                   <% } %>
    			</td>
    			
                <td nowrap bgcolor="#E5EDF8" align="center" >
                    <% if(tawTestcardManagerNote.getDeleted()==1){ %>
                      ${eoms:a2u("归还")}
                    <% }else if(!(tawTestcardManagerNote.getRenewer()==null)&&!(tawTestcardManagerNote.getRenewer().equals(""))){ %>
                       ${eoms:a2u("续借")}
                       <% }else if(!(tawTestcardManagerNote.getRenewer()==null)&&!(tawTestcardManagerNote.getState()=="待接受")){ 
                       System.out.println("**"+tawTestcardManagerNote.getState());%>
                          ${eoms:a2u("接收")}
                          <% }else if(!(tawTestcardManagerNote.getRenewer()==null)&&!(tawTestcardManagerNote.getState()=="借出")){ %>
                          ${eoms:a2u("借出")}
                          <%} %>
                    
                </td>
    			<td nowrap bgcolor="#E5EDF8" align="center">
                    		<bean:write name="tawTestcardManagerNote" property="leantime" scope="page"/>
    			</td>
    			<td nowrap bgcolor="#E5EDF8" align="center" >
                    		<bean:write name="tawTestcardManagerNote" property="reason" scope="page"/>
    			</td>
        </tr>
    	</logic:iterate>
      </table>
