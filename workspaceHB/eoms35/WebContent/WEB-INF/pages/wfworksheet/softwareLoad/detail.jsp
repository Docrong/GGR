	  ...
	  <tr>
		  ...
		  <tr>
				  ...
				  <c:forTokens items="${sheetMain.mainFactory}" delims="," var="mainFactory" varStatus="status">
               		 <eoms:id2nameDB id="${mainFactory}" beanId="ItawSystemDictTypeDao"/><c:choose><c:when test="${status.last}"></c:when><c:otherwise>,</c:otherwise></c:choose> 	                  
             	  </c:forTokens> 
		  ...
		  <td colspan="3">
		   <c:forTokens items="${sheetMain.mainPlans}" delims="," var="mainPlans" varStatus="status">
               <eoms:id2nameDB id="${mainPlans}" beanId="tawSystemAreaDao"/><c:choose><c:when test="${status.last}"></c:when><c:otherwise>,</c:otherwise></c:choose> 	                  
             </c:forTokens>  
		  </td>
  		  </tr>
		  <tr>
		  ...
		  <td class="content">
		  <bean:write name="sheetMain" property="mainProgramtime" formatKey="date.formatDateTimeAll" bundle="sheet" scope="request"/>
...
<!--			     <option value="${urlShowTransferkPage}"><bean:message bundle="sheet" key="common.transfer"/></option>-->
		...
		<%}else if(taskName.equals("DraftTask")){%>	
			<select id="dealSelector">
			  <option value="${urlShowDraftDeal}"><bean:message bundle="softwareLoad" key="operateType.draft"/></option>
			</select>
		...
		<%}else if(taskName.equals("HoldTask")){ %>
			<select id="dealSelector">
			  <option value="${urlShowHoldDealPage}"><bean:message bundle="softwareLoad" key="operateType.hold"/></option>
			</select>		
		<%} %>
		</td>
		</tr>
