<%@ page language="java"
         import="java.util.*,com.boco.eoms.commons.mms.base.config.*,com.boco.eoms.commons.mms.mmsreporttemplate.model.*,com.boco.eoms.base.util.StaticMethod"
         pageEncoding="UTF-8" %>
	...
	<tr class="tr_show">
     ...
     -->
            ...
            <tr class="tr_show">
                ...
                <td width="500" colspan="5">
                    <input type="text" name="receiveTime" size="20"
