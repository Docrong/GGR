...
<br>
<html:form method="post" action="/TawRmChangeduty/apply">
    ...
    <tr>
        <td>
            ...
            <table cellpadding="0" cellspacing="0" border="0" width="400">
                <tr>
                    <td>
                        <table border="0" width="80%" cellspacing="1" cellpadding="1" class="listTable" align=center>
                            ...
                            <tr class="tr_show">
                                ...
                                <td>
                                    <eoms:SelectDate name="time_from" formName="tawRmChangedutyForm" flag="1"
                                                     value="<%=str_start%>"/>
                                </td>
                            </tr>
                            ...
                            <tr class="tr_show">
                                ...
                                <td>
                                    <eoms:SelectDate name="time_to" formName="tawRmChangedutyForm" flag="1"
                                                     value="<%=str_start%>"/>
                                </td>
                            </tr>
                        </table>
