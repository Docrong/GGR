...
<div class="list">
    <html:form action="/saveAppendTawSuppKpiInstOrder.do?method=append" method="post"
               styleId="tawSuppKpiInstReportOrderForm" onsubmit="return validate();">
        <table>
            ...
            <tr height="50">
                ...
                <td colspan="3">
                    <input type="text" name="reportName"
                           value="<%=String.valueOf(request.getAttribute("reportName")) %>"/>
                </td>
            </tr>
            <tr height="50">
                <td>
            ...
            <tr height="50">
                ...
                <td>
                    <input type="text" name="reportStartTime" id="reportStartTime" alt="timer:true"
                           value="<%=String.valueOf(request.getAttribute("reportStartTime"))%>"/>
                </td>
                ...
                <td>
                    <input type="text" name="reportEndTime" id="reportEndTime" alt="timer:true"
                           value="<%=String.valueOf(request.getAttribute("reportEndTime")) %>"/>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr height="50">
                ...
                <td colspan="3" id="slt1">
                    <input type="checkbox" name="quarter_1" value="one"
                           onClick="getAllQuarterName(this);"><label>${eoms:a2u('第一季度')}</label></input>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="checkbox" name="quarter_1" value="two"
                           onClick="getAllQuarterName(this);"><label>${eoms:a2u('第二季度')}</label></input>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="checkbox" name="quarter_1" value="three"
                           onClick="getAllQuarterName(this);"><label>${eoms:a2u('第三季度')}</label></input>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="checkbox" name="quarter_1" value="four"
                           onClick="getAllQuarterName(this);"><label>${eoms:a2u('第四季度')}</label></input>
                </td>
            ...
            <tr height="50">
                ...
                <td colspan="3" id="slt2">
                    <input type="checkbox" name="month_1" value="01"
                           onClick="getAllMonthName(this);"><label>${eoms:a2u('一月')}</label></input>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="checkbox" name="month_1" value="02"
                           onClick="getAllMonthName(this);"><label>${eoms:a2u('二月')}</label></input>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="checkbox" name="month_1" value="03"
                           onClick="getAllMonthName(this);"><label>${eoms:a2u('三月')}</label></input>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="checkbox" name="month_1" value="04"
                           onClick="getAllMonthName(this);"><label>${eoms:a2u('四月')}</label></input>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="checkbox" name="month_1" value="05"
                           onClick="getAllMonthName(this);"><label>${eoms:a2u('五月')}</label></input>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="checkbox" name="month_1" value="06"
                           onClick="getAllMonthName(this);"><label>${eoms:a2u('六月')}</label></input>
                    <br>
                    <input type="checkbox" name="month_1" value="07"
                           onClick="getAllMonthName(this);"><label>${eoms:a2u('七月')}</label></input>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="checkbox" name="month_1" value="08"
                           onClick="getAllMonthName(this);"><label>${eoms:a2u('八月')}</label></input>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="checkbox" name="month_1" value="09"
                           onClick="getAllMonthName(this);"><label>${eoms:a2u('九月')}</label></input>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="checkbox" name="month_1" value="10"
                           onClick="getAllMonthName(this);"><label>${eoms:a2u('十月')}</label></input>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="checkbox" name="month_1" value="11"
                           onClick="getAllMonthName(this);"><label>${eoms:a2u('十一月')}</label></input>
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="checkbox" name="month_1" value="12"
                           onClick="getAllMonthName(this);"><label>${eoms:a2u('十二月')}</label></input>
                </td>
                <input type="hidden" id="month_id" name="month"/>
            </tr>
            <tr align="right" height="40">
                <td colspan="4">
                    <input type="submit" styleClass="btn" property="method.append" styleId="method.append"
