	...
	<table class="listTable"> 
	  <caption></caption>	 
	       ...
	       <tr>
			  ...
			  <td class="content"><eoms:id2nameDB id="${sheetMain.mainBusDept}" beanId="ItawSystemDictTypeDao"/></td>				
		   ...
		   <tr>
			  ...
			  <td class="content"><eoms:id2nameDB id="${sheetMain.mainProductTypeTwo}" beanId="ItawSystemDictTypeDao"/></td>	  
		  </tr>	
			 <tr>
			  <td class="label"><bean:message bundle="businesspilot" key="businesspilot.mainIsBus"/>*</td>
			  <td class="content"><eoms:id2nameDB id="${sheetMain.mainIsBus}" beanId="ItawSystemDictTypeDao"/></td>					
			  <td class="label"><bean:message bundle="businesspilot" key="businesspilot.mainIsProject"/>*</td>
			  <td class="content"><eoms:id2nameDB id="${sheetMain.mainIsProject}" beanId="ItawSystemDictTypeDao"/></td>		  
			</tr>	
		  <tr>
			...
			<tr>
			 ...
			 <td class="content">
			  <bean:write name="sheetMain" property="mainStartTime" formatKey="date.formatDateTimeAll" bundle="sheet" scope="request"/>	
			  </td>
			  <td class="label"><bean:message bundle="businesspilot" key="businesspilot.mainEndTime"/>*</td>
			  <td class="content">
			  <bean:write name="sheetMain" property="mainEndTime" formatKey="date.formatDateTimeAll" bundle="sheet" scope="request"/>	
			  </td>	  
			</tr>
	    ...
	    <select id="dealSelector" >
			 ...
			 <%} else if(taskStatus.equals(Constants.TASK_STATUS_CLAIMED)){%>
			 	  ...
			 	  <%if(ifsub.equals("") || ifsub.equals("false")){%>
					  ...
					  <!-- 流程步骤，移交，阶段回复，分派 -->
					  <option value="${urlShowPilotDealPage1}"><bean:message bundle="businesspilot" key="operateType.testPass"/> </option>
			 ...
			 <%}else { %>
			 		...
			 		<!-- 不需要等待回复 -->
			 	  	<% if (ifwaitfor.equals("false")) {%>
			 			<option value="${urlShowDispatchPage}"><bean:message bundle="businesspilot" key="operateType.subTaskReply"/></option>
			 		<%}%>
			 <% } %>
        ...
        <select id="dealSelector" >
			 ...
			 <%} else if(taskStatus.equals(Constants.TASK_STATUS_CLAIMED)){%>
			 	  ...
			 	  <%if(ifsub.equals("") || ifsub.equals("false")){%>
			 	  	...
			 	  	<% if (ifwaitfor.equals("false")) {%>
					  <!-- 流程步骤，移交，阶段回复，分派 -->
					  <option value="${urlShowStrategyDealPage}"><bean:message bundle="businesspilot" key="operateType.strategyDeal"/></option>
					  <option value="${urlShowTransferkPage}"><bean:message bundle="sheet" key="common.transfer"/></option>
					  <option value="${urlShowPhaseReplyPage}"><bean:message bundle="sheet" key="event.reply"/></option>
			 		<% }%>
			 <%}else { %>
			 		...
			 		<%}%>
			 <% } %>
			  <option value="${urlShowInputSplit}"><bean:message bundle="sheet" key="common.split"/></option>${needDealReply}
			  <c:if test="${needDealReply == 'true'}">
			       <option value="${urlShowDealReplyAcceptPage}"><bean:message bundle="sheet" key="common.dealReplyAccept"/></option>
			       <option value="${urlShowDealReplyRejectPage}"><bean:message bundle="sheet" key="common.dealReplyReject"/></option>  
			  </c:if>
	     ...
	     <select id="dealSelector" >
			 ...
			 <%} else if(taskStatus.equals(Constants.TASK_STATUS_CLAIMED)){%>
			 	  ...
			 	  <%if(ifsub.equals("") || ifsub.equals("false")){%>
			 	  	...
			 	  	<% if (ifwaitfor.equals("false")) {%>
					  <!-- 流程步骤，移交，阶段回复，分派 -->
					  <option value="${urlShowPrepareDealPage}"><bean:message bundle="businesspilot" key="operateType.prepareDeal"/></option>
				      <option value="${urlShowTransferkPage}"><bean:message bundle="sheet" key="common.transfer"/></option>
				      <option value="${urlShowPhaseReplyPage}"><bean:message bundle="sheet" key="event.reply"/></option>
			 		<% }%>
			 <%}else { %>
	    ...
	    <select id="dealSelector" >
			 ...
			 <%} else if(taskStatus.equals(Constants.TASK_STATUS_CLAIMED)){%>
			 	  ...
			 	  <%if(ifsub.equals("") || ifsub.equals("false")){%>
			 	  	...
			 	  	<% if (ifwaitfor.equals("false")) {%>
					  <!-- 流程步骤，移交，阶段回复，分派 -->
					    <option value="${urlShowRunDealPage}"><bean:message bundle="businesspilot" key="operateType.runDeal"/></option>
					    <option value="${urlShowTransferkPage}"><bean:message bundle="sheet" key="common.transfer"/></option>
					    <option value="${urlShowPhaseReplyPage}"><bean:message bundle="sheet" key="event.reply"/></option>
			 		<% }%>
			 <%}else { %>
       ...
       <%}}else if(taskName.equals("report")){%>	
          <select id="dealSelector" >
			 ...
			 <%} else if(taskStatus.equals(Constants.TASK_STATUS_CLAIMED)){%>
			 	  ...
			 	  <%if(ifsub.equals("") || ifsub.equals("false")){%>
			 	  	...
			 	  	<% if (ifwaitfor.equals("false")) {%>
					  <!-- 流程步骤，移交，阶段回复，分派 -->
					     <option value="${urlShowReportDealPage}"><bean:message bundle="businesspilot" key="operateType.reportDeal"/></option>
					     <option value="${urlShowTransferkPage}"><bean:message bundle="sheet" key="common.transfer"/></option>
					     <option value="${urlShowPhaseReplyPage}"><bean:message bundle="sheet" key="event.reply"/></option>
			 		<% }%>
			 <%}else { %>
		...
		<%}}else if(taskName.equals("check")){%>	
		 <select id="dealSelector" >
			 ...
			 <%} else if(taskStatus.equals(Constants.TASK_STATUS_CLAIMED)){%>
			 	  ...
			 	  <%if(ifsub.equals("") || ifsub.equals("false")){%>
			 	  	...
			 	  	<% if (ifwaitfor.equals("false")) {%>
					  <!-- 流程步骤，移交，阶段回复，分派 -->
					     <option value="${urlShowCheckDealPage}"><bean:message bundle="businesspilot" key="operateType.checkDeal"/></option>
					     <option value="${urlShowTransferkPage}"><bean:message bundle="sheet" key="common.transfer"/></option>
					     <option value="${urlShowPhaseReplyPage}"><bean:message bundle="sheet" key="event.reply"/></option>
			 		<% }%>
			 <%}else { %>
		 ...
		 <select id="dealSelector" >
			 ...
			 <%} else if(taskStatus.equals(Constants.TASK_STATUS_CLAIMED)){%>
			 	 <option value="${urlShowHoldPage}"><bean:message bundle="businesspilot" key="operateType.hold"/></option>
			     <option value="${urlShowNoteYqDealPage}"><bean:message bundle="businesspilot" key="operateType.noteYqDeal"/></option>
			     <!--  <option value="${urlShowTransferkPage}"><bean:message bundle="sheet" key="common.transfer"/></option>
			     <option value="${urlShowPhaseReplyPage}"><bean:message bundle="sheet" key="event.reply"/></option>-->
	 	 </select> 
		...
		<select id="dealSelector">
		  <option value="${urlShowDraftDealPage}"><bean:message bundle="businesspilot" key="operateType.draft"/></option>
		</select>	
	    <%}else if(taskName.equals("draft")){ %>
		 <select id="dealSelector" >
	        <option value="${urlDraftDeal}"><bean:message bundle="businesspilot" key="operateType.draft"/></option>
	     </select>	
	  <%} %>
	 </td>
	</tr></table>
