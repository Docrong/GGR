...
<input type="hidden" name="${sheetPageName}processTemplateName" value="ComplaintDubanMainFlowProcess"/>
...
<table class="formTable">
    ...
    <tr>
        <td class="label"><bean:message bundle="complaintDuban" key="complaintDuban.mainRemark"/>*</td>
        <td colspan="3" class="content">
    ...
    <tr>
        ...
        <td colspan="3">
            ...
            <eoms:attachment name="sheetMain" property="sheetAccessories"
                             scope="request" idField="${sheetPageName}sheetAccessories" appCode="complaintDuban"/>
        </td>
    </tr>
</table>
