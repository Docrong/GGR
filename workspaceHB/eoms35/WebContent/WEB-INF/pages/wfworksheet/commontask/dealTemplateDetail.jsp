...
<%
    com.boco.eoms.sheet.commontask.model.CommonTaskLink commontaskLink = (com.boco.eoms.sheet.commontask.model.CommonTaskLink) request.getAttribute("sheetLink");
    java.lang.String taskName = com.boco.eoms.base.util.StaticMethod.nullObject2String(commontaskLink.getActiveTemplateId());
    java.lang.String operateType = java.lang.String.valueOf(com.boco.eoms.base.util.StaticMethod.nullObject2String(commontaskLink.getOperateType()));
%>
<script type="text/javascript">
    ...
    function saveDealTemplate(type) {
        ...
        form.action = "${app}/sheet/commontask/commontask.do?method=saveDealTemplate&type=dealTemplateManage&dealTemplateId=${sheetLink.id}";
        form.submit();
    }
...
<html:form action="/commontask.do" styleId="theform">
    <br/>
    <input type="hidden" name="${sheetPageName}beanId" value="iCommonTaskMainManager"/>
    <input type="hidden" name="${sheetPageName}mainClassName"
           value="com.boco.eoms.sheet.commontask.model.commontaskMain"/>
    <input type="hidden" name="${sheetPageName}linkClassName"
           value="com.boco.eoms.sheet.commontask.model.commontaskLink"/>
    <table class="formTable">
        <caption><bean:message bundle="commontask" key="commontask.header"/></caption>
        <tr>
            <td class="label">
        ...
        <input type="hidden" name="${sheetPageName}linkAuditResult" id="${sheetPageName}linkAuditResult"
               value="101040101"/>
        <tr>
        ...
        <tr>
            ...
            <td colspan="3">
                ...
                <textarea name="${sheetPageName}remark" class="textarea max" id="${sheetPageName}remark"
                          alt="allowBlank:true,width:500,maxLength:2000,vtext:'${eoms:a2u('请最多输入1000汉字')}'"
