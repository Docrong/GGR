 ...
 * 
 */
public class TrancePoint extends BaseObject {
	...
	public boolean equals(Object o) {
		if( o instanceof TrancePoint ) {
			TrancePoint businessupport=(TrancePoint)o;
			if (this.id != null || this.id.equals(businessupport.getId())) {
				return true;
			} else {
				return false;
			}
