...
<table id="sheet" class="formTable" >
 ...
 <td class="label">
			...
			<td>
				<input type="text"  class="text" name="mainTaskName" id="mainTaskName"  alt="allowBlank:true,maxLength:2000,vtext:'请填入 任务名称 信息，最多输入 2000 字符'" value="${sheetMain.mainTaskName}"/>
			</td>
		</tr>
		...
		<tr><td class="label">
			...
			<td>
				<input type="text"  class="text" name="mainTaskId" id="mainTaskId"  alt="allowBlank:true,maxLength:2000,vtext:'请填入 任务编号 信息，最多输入 2000 字符'" value="${sheetMain.mainTaskId}"/>
			</td>
 <td class="label">
				<!-- 安全作业计划编号 -->
			...
			<td>
				<input type="text"  class="text" name="mainWorkId" id="mainWorkId"  alt="allowBlank:true,maxLength:2000,vtext:'请填入 安全作业计划编号 信息，最多输入 2000 字符'" value="${sheetMain.mainWorkId}"/>
			</td>
		</tr>
		...
		<tr><td class="label">
			...
			<td>
				<input type="text"  class="text" name="mainWorkName" id="mainWorkName"  alt="allowBlank:true,maxLength:2000,vtext:'请填入 安全作业计划的名称 信息，最多输入 2000 字符'" value="${sheetMain.mainWorkName}"/>
			</td>
 <td class="label">
				<!-- 检查时间 -->
		...
		<tr><td class="label">
			...
			<td>
				<input type="text"  class="text" name="mainProDes" id="mainProDes"  alt="allowBlank:true,maxLength:2000,vtext:'请填入 问题描述 信息，最多输入 2000 字符'" value="${sheetMain.mainProDes}"/>
			</td>
 <td class="label">
				<!-- 安全对象IP -->
			...
			<td>
				<input type="text"  class="text" name="mainSecurityIP" id="mainSecurityIP"  alt="allowBlank:true,maxLength:2000,vtext:'请填入 安全对象IP 信息，最多输入 2000 字符'" value="${sheetMain.mainSecurityIP}"/>
			</td>
		</tr>
		...
		<tr><td class="label">
			...
			<td>
				<input type="text"  class="text" name="mainSecurityName" id="mainSecurityName"  alt="allowBlank:true,maxLength:2000,vtext:'请填入 安全对象名称 信息，最多输入 2000 字符'" value="${sheetMain.mainSecurityName}"/>
			</td>
 <td class="label">
				<!-- 安全对象ID -->
			...
			<td>
				<input type="text"  class="text" name="mainSecurityID" id="mainSecurityID"  alt="allowBlank:true,maxLength:2000,vtext:'请填入 安全对象ID 信息，最多输入 2000 字符'" value="${sheetMain.mainSecurityID}"/>
			</td>
		</tr>
...
<table id="sheet" class="formTable">
	    ...
	    <tr>
		    ...
		    <eoms:attachment name="sheetMain" property="sheetAccessories" 
		            scope="request" idField="sheetAccessories" appCode="securityobjaudit" alt="allowBlank:true"/> 				
		    </td>
	   </tr>			  
</table>
