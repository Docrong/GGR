...
<div id="sheetform">
    <html:form action="/mofficedata.do?method=performDealReplyReject" styleId="theform">
        <%
        ...
        <input type="hidden" name="subtaskName" value="mofficedataSubTask"/>
        ...
        <input type="hidden" name="processTemplateName" id="processTemplateName" value="MofficeDataMainProcess"/>
        ...
        <input type="hidden" name="taskNamespace" value="http://MofficeDataProcess"/>
        ...
        <table class="formTable">
                    ...
                    <table class="formTable">
                        <logic:present name="acceptList" scope="request">
                            ...
                            <logic:iterate id="toTask" name="acceptList"
                                           type="com.boco.eoms.sheet.mofficedata.model.MofficeDataTask">
                                <tr>
                                    <td>
            ...
            <tr>
                <td class="label">回复情况</br>
                <td colspan="3">
                    <table class="formTable">
                        <logic:present name="allList" scope="request">
                            <tr>
                            ...
                            <logic:iterate id="toTask" name="allList"
                                           type="com.boco.eoms.sheet.mofficedata.model.MofficeDataTask">
                                <tr>
                                    <td colspan="2">
                                        <eoms:id2nameDB id="${toTask.operateRoleId}"
