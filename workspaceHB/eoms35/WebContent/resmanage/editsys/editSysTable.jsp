...
<tr bgcolor=#eeeeee>
	...
	<td align=left><font size=2 color=#000000></font><input name='cc_code' maxlength=32 value=<%=cc_code%> ></input></td>
</tr>
<tr bgcolor=#eeeeee>
...
<tr bgcolor=#eeeeee>
	...
	<td align=left><font size=2 color=#000000></font><input name='cc_operateid'  value=<%=ci_icon%>></input></td>
</tr>
<tr bgcolor=#eeeeee>
	<td align=center><font size=2 color=#000000>位置：</font></td>
	<td align=left><font size=2 color=#000000></font><input name='cc_location'  value=<%=ci_icon%>></input></td>
</tr>
</table>
<br>
<table width='100%'>
