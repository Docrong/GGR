        ...
        ctxMenu: [
            {
                ...
                text: '${eoms:a2u('新增')}',
                cls: 'new-mi',
                url: '<c:url value="/supplierkpi/editTawSupplierkpiInfo.do?name=" />'
            },
            {
                id: 'edtnode',
                text: '${eoms:a2u('修改')}',
                cls: 'edit-mi',
                url: '<c:url value="/supplierkpi/editTawSupplierkpiInfo.do?id=" />'
            },
            {
                id: 'view',
                text: '${eoms:a2u('查看')}',
                cls: 'edit-mi',
                url: '<c:url value="/supplierkpi/viewTawSupplierkpiInfo.do?method=view&id=" />'
            },
            {
                id: 'delnode',
                isDelete: true,
                text: '${eoms:a2u('删除')}',
                cls: 'remove-mi',
                url: '<c:url value="/supplierkpi/editTawSupplierkpiInfo.do?method=delete&id=" />'
            },
            {
                id: 'kpi',
                text: '${eoms:a2u('已定制评估指标')}',
                cls: 'edit-mi',
                url: '<c:url value="/supplierkpi/editTawSupplierkpiInfo.do?method=supplierkpiList&id=" />'
            }
        ],//end of ctxMenu
        /************************
