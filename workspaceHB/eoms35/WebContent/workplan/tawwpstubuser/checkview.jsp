...
<form name="reportform" method="POST" action="../tawwpstubuser/stubusersave.do" onsubmit="onSubmit();">
    ...
    <input type="button" value="<bean:message key="checkview.title.btnPass" />" name="B2" Onclick="onPass();"
           class="button">
    <input type="button" value="<bean:message key="checkview.title.btnReject" />" name="B2" Onclick="onReject();"
           class="button">
    <input type="button" value="<bean:message key="checkview.title.btnBack" />" name="B2" Onclick="GoBack();"
           class="button">
