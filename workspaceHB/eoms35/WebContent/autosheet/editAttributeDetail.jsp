...
<div align="center">
    ...
    <form name="addEForm" method="post" action="<%=request.getContextPath()%>/sheetattrservlet"
          onsubmit="javascript: return checkInput();">
        <table cellspacing=0 cellpadding=0 border=1 width="779" bordercolordark="#FFFFFF" bordercolorlight="#66CCFF"
               bgcolor=#F3F3F3 align="center">
            <tr>
                <td width="12%" nowrap align="right">输入框名称</td>
                <td width="13%" nowrap>
                    <input type="text" name="attrName" size="10" maxlength="200"
                           value="<%out.print(shAttribute.getAttrName(attr_id));%>"><font color="red">**</font>
             ...
             out.println("<option value=\"2\" >表尾</option>");*/
                ...
                <td width="13%" nowrap>
                    <input type="text" name="index" size="10" maxlength="10"
                           value="<%=(shAttribute.getIndex(attr_id))%>"><font color="red">**</font>
                </td>
            ...
            <tr>
                ...
                <td width="13%" nowrap>
                    <input type="text" name="colspan" size="10" maxlength="10"
                           value="<%=shAttribute.getColspan(attr_id)%>"><font color="red">**</font>
                </td>
                <td width="12%" nowrap align="right">跨行宽</td>
                <td width="13%" nowrap>
                    <input type="text" name="rowspan" size="10" maxlength="10"
                           value="<%=shAttribute.getRowspan(attr_id)%>"><font color="red">**</font>
                </td>
            </tr>
            <tr>
                ...
                <td width="13%" nowrap>
                    <input type="text" name="height" size="10" maxlength="10"
                           value="<%=shAttribute.getHeight(attr_id)%>"> 象素
                </td>
                ...
                <td width="13%">
                    <input type="text" name="color" size="10" maxlength="10" value="<%=shAttribute.getColor(attr_id)%>"
                           ondblclick="openColorWin()">
                </td>
