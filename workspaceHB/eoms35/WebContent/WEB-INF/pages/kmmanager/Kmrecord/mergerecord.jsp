...
<%@ page
        import="java.util.*,
                ...
                com.boco.eoms.km.duty.webapp.form.KmrecordForm,
                com.boco.eoms.common.util.StaticMethod,
                com.boco.eoms.km.duty.model.*,
                com.boco.eoms.duty.util.StaticDutycheck" %>
<%
...
<html:form method="post" action="/Kmrecord/exchange">
    ...
    <TABLE cellSpacing="1" cellPadding="1" width="600" align="center"
        ...
        <TR class="tr_show">
            ...
            <TD colSpan=6>
                <TEXTAREA id=notes name=notes rows=4 cols=80 type="_moz"><bean:write name="kmrecordForm"
                                                                                     property="notes"
