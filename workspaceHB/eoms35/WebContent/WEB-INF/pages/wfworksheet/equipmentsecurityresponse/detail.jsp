						 ...
						 <td width="50%">  
									...
									<select id="dealSelector">
									 ...
									 <% } else if(taskStatus.equals(Constants.TASK_STATUS_CLAIMED)){ %>
									 	  ...
									 	  <% if (ifwaitfor.equals("false")) {%>
											  <!-- 流程步骤，移交，阶段回复，分派 -->
											  <option value="${urlShowAudit102Page}"><bean:message bundle="equipmentsecurityresponse" key="operateType.Audit102"/> </option>
									 ...
									 <%} else { %>
									 		...
									 		<!-- 不需要等待回复 -->
									 	  	<% if (ifwaitfor.equals("false")) {%>
									 			<option value="${urlShowDispatchPage}"><bean:message bundle="equipmentsecurityresponse" key="operateType.subTaskReply"/></option>
									 		<% }%>
									 <% } %>
								...
								<% }  if(taskName.equals("AuditReply")){ %>
									<select id="dealSelector">
									 ...
									 <% } else if(taskStatus.equals(Constants.TASK_STATUS_CLAIMED)){ %>
									 	  ...
									 	  <% if (ifwaitfor.equals("false")) {%>
											  <!-- 流程步骤，移交，阶段回复，分派 -->
											  <option value="${urlShowAuditReply104Page}"><bean:message bundle="equipmentsecurityresponse" key="operateType.AuditReply104"/> </option>
								...
								<% }  if(taskName.equals("QualityInspection")){ %>
									<select id="dealSelector">
									 ...
									 <% } else if(taskStatus.equals(Constants.TASK_STATUS_CLAIMED)){ %>
									 	  ...
									 	  <% if (ifwaitfor.equals("false")) {%>
											  <!-- 流程步骤，移交，阶段回复，分派 -->
											  <option value="${urlShowQualityInspection105Page}"><bean:message bundle="equipmentsecurityresponse" key="operateType.QualityInspection105"/> </option>
											  <option value="${urlShowQualityInspection106Page}"><bean:message bundle="equipmentsecurityresponse" key="operateType.QualityInspection106"/> </option>
 							...
 							<!-- 归档 -->
								<% }  if(taskName.equals("HoldTask")){ %>
									<select id="dealSelector">
									 	  ...
									 	  <% if (ifwaitfor.equals("false")) {%>
											  <!-- 流程步骤，移交，阶段回复，分派 -->
											  <option value="${urlShowHoldTask18Page}"><bean:message bundle="equipmentsecurityresponse" key="operateType.HoldTask18"/> </option>
											  <option value="${urlShowHoldTask107Page}"><bean:message bundle="equipmentsecurityresponse" key="operateType.HoldTask107"/> </option>
							...
							<% }else if(taskName.equals("RejectTask")){%>	
					  		...
					  		<% }else if(taskName.equals("DraftTask")){%>	
								<select id="dealSelector">
								  <option value="${urlShowDraftPage}"><bean:message bundle="equipmentsecurityresponse" key="operateType.DraftTask"/></option>
								</select>
					   		<% } %>
					</td>
				</tr>
