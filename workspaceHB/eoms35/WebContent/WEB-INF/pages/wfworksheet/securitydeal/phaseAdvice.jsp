...
<div id="sheetform">
    <html:form action="/securitydeal.do?method=performProcessEvent" styleId="theform">
        <%@ include file="/common/taglibs.jsp" %>
        <%
        ...
        <input type="hidden" name="${sheetPageName}processTemplateName" id="${sheetPageName}processTemplateName"
               value="SecurityDealMainFlowProcess"/>
        ...
        <%@ include file="/WEB-INF/pages/wfworksheet/securitydeal/baseinputlinkhtml.jsp" %>
        <table class="listTable">
            <logic:present name="toOperaterList" scope="request">
                <logic:iterate id="toTask" name="toOperaterList"
                               type="com.boco.eoms.sheet.securitydeal.model.SecurityDealTask">
                    <tr>
                        <td>
