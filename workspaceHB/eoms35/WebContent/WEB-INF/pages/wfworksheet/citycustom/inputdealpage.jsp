...
<%@ include file="/WEB-INF/pages/wfworksheet/citycustom/baseinputlinkhtmlnew.jsp"%>
	...
	<table class="formTable">
		...
		<%} %>      
			...
			<td>
				<textarea class="textarea max" name="linkGroupComplete" id="linkGroupComplete" alt="allowBlank:false,maxLength:2000,vtext:'请输入审核情况，多输入100汉字'">${sheetLink.linkGroupComplete}</textarea>
			</td>
		</tr>
 ...
 <%}%>
			...
			<td>
				<input type="text"  class="text" name="linkGroupComplete" id="linkGroupComplete"  alt="allowBlank:false,maxLength:1000,vtext:'请填入 完成情况 信息，最多输入 1000 字符'" value="${sheetLink.linkGroupComplete}"/>
			</td>
		</tr>
 			   		...
 			   		<% if(operateType.equals("102")){ %>
 			   			<fieldset>
							  ...
							  <div class="x-form-item" >
									...
									<eoms:chooser id="OrderExamine0"  type="role" roleId="1922" flowId="614" config="{returnJSON:true,showLeader:true}"  
 			   		...
 			   		<% if(operateType.equals("103")){ %>
 			   			<fieldset>
							  ...
							  <div class="x-form-item" >
									...
									<eoms:chooser id="NetOrderExamine0"  type="role" roleId="1923" flowId="614" config="{returnJSON:true,showLeader:true}"  
									   category="[{id:'dealPerformer',text:'派发',limit:'none',allowBlank:false,vtext:'请选择派发对象'},{id:'copyPerformer',childType:'user,subrole',limit:'none',text:'抄送'}]" 
									  data="${sendUserAndRoles}" />
 			   		...
 			   		<% if(operateType.equals("104")){ %>
 			   			<fieldset>
							  ...
							  <div class="x-form-item" >
									...
									<eoms:chooser id="SchemeDesign0"  type="role" roleId="1924" flowId="614" config="{returnJSON:true,showLeader:true}"  
									   category="[{id:'dealPerformer',text:'派发',limit:'none',allowBlank:false,vtext:'请选择派发对象'},{id:'copyPerformer',childType:'user,subrole',limit:'none',text:'抄送'}]" 
									  data="${sendUserAndRoles}" />
 			   		...
 			   		<% if(operateType.equals("105")){ %>
 			   			<fieldset>
							  ...
							  <div class="x-form-item" >
									...
									<eoms:chooser id="SubmitExamine0"  type="role" roleId="1925" flowId="614" config="{returnJSON:true,showLeader:true}"  
									   category="[{id:'dealPerformer',text:'派发',limit:'none',allowBlank:false,vtext:'请选择派发对象'},{id:'copyPerformer',childType:'user,subrole',limit:'none',text:'抄送'}]" 
									  data="${sendUserAndRoles}" />
