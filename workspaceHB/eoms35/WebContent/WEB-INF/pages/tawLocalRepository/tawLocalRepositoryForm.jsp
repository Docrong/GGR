...
<table class="formTable">
	...
	<tr>
		...
		<td class="content">
			<eoms:comboBox name="${sheetPageName}city" id="${sheetPageName}city"    initDicId="1010107" defaultValue="${tawLocalRepositoryForm.city}" alt="allowBlank:false" />
		</td>
	</tr>
	...
	<tr>
		...
		<td class="content">
			<eoms:comboBox name="${sheetPageName}netType" id="${sheetPageName}netType" 
			  	      sub="${sheetPageName}driverTpye" initDicId="1011701" defaultValue="${tawLocalRepositoryForm.netType}" alt="allowBlank:false" onchange="selectLimit(this.value);"/>
		</td>
	</tr>
	<tr>
		<td class="label">
		...
		<td class="content">
			<eoms:comboBox name="${sheetPageName}driverTpye" id="${sheetPageName}driverTpye" 
			  	      sub="${sheetPageName}company" initDicId="${tawLocalRepositoryForm.netType}" defaultValue="${tawLocalRepositoryForm.driverTpye}" alt="allowBlank:false" onchange="selectLimit(this.value);"/>
		</td>
		<td class="label">
		...
		<td class="content">
			<eoms:comboBox name="${sheetPageName}company" id="${sheetPageName}company" 
			  	      sub="${sheetPageName}netModale" initDicId="${tawLocalRepositoryForm.driverTpye}" defaultValue="${tawLocalRepositoryForm.company}" onchange="selectLimit(this.value);"/>
		</td>
	</tr>
	<tr>
		<td class="label">
		...
		<td class="content">
				<eoms:comboBox name="${sheetPageName}netModale" id="${sheetPageName}netModale" 
			  	      sub="${sheetPageName}hardwareRepository" initDicId="${tawLocalRepositoryForm.company}" defaultValue="${tawLocalRepositoryForm.netModale}" onchange="selectLimit(this.value);"/>
		</td>
		...
		<td class="content">
				<eoms:comboBox name="${sheetPageName}hardwareRepository" id="${sheetPageName}hardwareRepository" 
			  	      sub="${sheetPageName}softwareRepository" initDicId="${tawLocalRepositoryForm.netModale}" defaultValue="${tawLocalRepositoryForm.hardwareRepository}" onchange="selectLimit(this.value);"/>
		</td>
	</tr>
	...
	<tr>
		...
		<td class="content">
			<eoms:comboBox name="${sheetPageName}softwareRepository" id="${sheetPageName}softwareRepository" 
			  	      sub="${sheetPageName}mainNetTypeThree" initDicId="${tawLocalRepositoryForm.hardwareRepository}" defaultValue="${tawLocalRepositoryForm.softwareRepository}" onchange="selectLimit(this.value);"/>
		</td>
	</tr>
