...
<table id="sheet" class="formTable">
    ...
    <tr>
        ...
        <td>
            <input type="text" class="text" name="mainALarmTitle" id="mainALarmTitle"
                   alt="allowBlank:true,maxLength:2000,vtext:'请填入 告警标题 信息，最多输入 2000 字符'"
                   value="${sheetMain.mainALarmTitle}"/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <input type="text" class="text" name="mainALarmType" id="mainALarmType"
                   alt="allowBlank:true,maxLength:2000,vtext:'请填入 告警类型 信息，最多输入 2000 字符'"
                   value="${sheetMain.mainALarmType}"/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <input type="text" class="text" name="mainALarmName" id="mainALarmName"
                   alt="allowBlank:true,maxLength:2000,vtext:'请填入 告警级别名称 信息，最多输入 2000 字符'"
                   value="${sheetMain.mainALarmName}"/>
        </td>
        <td class="label">
            <!-- 告警ID -->
        ...
        <td>
            <input type="text" class="text" name="mainALarmID" id="mainALarmID"
                   alt="allowBlank:true,maxLength:2000,vtext:'请填入 告警ID 信息，最多输入 2000 字符'"
                   value="${sheetMain.mainALarmID}"/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <input type="text" class="text" name="mainOrigSourceID" id="mainOrigSourceID"
                   alt="allowBlank:true,maxLength:2000,vtext:'请填入 原来源资产ID 信息，最多输入 2000 字符'"
                   value="${sheetMain.mainOrigSourceID}"/>
        </td>
        <td class="label">
            <!-- 原来目的资产ID -->
        ...
        <td>
            <input type="text" class="text" name="mainOrigPurposeID" id="mainOrigPurposeID"
                   alt="allowBlank:true,maxLength:2000,vtext:'请填入 原来目的资产ID 信息，最多输入 2000 字符'"
                   value="${sheetMain.mainOrigPurposeID}"/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <input type="text" class="text" name="mainNowSourceID" id="mainNowSourceID"
                   alt="allowBlank:true,maxLength:2000,vtext:'请填入 现在源资产ID 信息，最多输入 2000 字符'"
                   value="${sheetMain.mainNowSourceID}"/>
        </td>
        <td class="label">
            <!-- 现在目的资产ID -->
        ...
        <td>
            <input type="text" class="text" name="mainNowPurposeID" id="mainNowPurposeID"
                   alt="allowBlank:true,maxLength:2000,vtext:'请填入 现在目的资产ID 信息，最多输入 2000 字符'"
                   value="${sheetMain.mainNowPurposeID}"/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <input type="text" class="text" name="mainALarmContent" id="mainALarmContent"
                   alt="allowBlank:true,maxLength:2000,vtext:'请填入 告警内容 信息，最多输入 2000 字符'"
                   value="${sheetMain.mainALarmContent}"/>
        </td>
        <td class="label">
            <!-- 预留字段1 -->
