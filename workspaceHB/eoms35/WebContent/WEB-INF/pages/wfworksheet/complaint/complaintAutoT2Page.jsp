...
<table class="formTable">
        	...
        	<tr>
				  	...
				  	<td>
				  	 <eoms:comboBox name="complaintType1" id="complaintType1" sub="complaintType2" initDicId="1010601"  alt="allowBlank:true" defaultValue="${complaintAutoT2.complaintType1}"/>
				  	</td> 
			</tr>
			...
			<tr>				
				  	...
				  	<td>
				    	<eoms:comboBox name="complaintType2" id="complaintType2" sub="complaintType3" initDicId="${complaintAutoT2.complaintType1}" defaultValue="${complaintAutoT2.complaintType2}"/>
				  	</td>
			</tr>
            ...
            <tr>
			  		...
			  		<td >
			  	 		<eoms:comboBox name="complaintType3" id="complaintType3" sub="complaintType4" initDicId="${complaintAutoT2.complaintType2}" defaultValue="${complaintAutoT2.complaintType3}"/>
			  		</td>
		    </tr>
			...
			<tr> 	 
			  		...
			  		<td >
			  	 		<eoms:comboBox name="complaintType4" id="complaintType4" sub="complaintType5" initDicId="${complaintAutoT2.complaintType3}" defaultValue="${complaintAutoT2.complaintType4}"/>
			  		</td>			   
		 	</tr>
		    ...
		    <tr>
			  		...
			  		<td>
			  	 		<eoms:comboBox name="complaintType5" id="complaintType5" sub="complaintType6" initDicId="${complaintAutoT2.complaintType4}" defaultValue="${complaintAutoT2.complaintType5}"/>
			  		</td>
		  	</tr>
		    ...
		    <tr>				
			  		...
			  		<td>
			    		<eoms:comboBox name="complaintType6" id="complaintType6" sub="complaintType7" initDicId="${complaintAutoT2.complaintType5}" defaultValue="${complaintAutoT2.complaintType6}"/>
			  		</td>		  
		  	</tr>
		  	...
		  	<tr>
			  		...
			  		<td>
			  	 		<eoms:comboBox name="complaintType7" id="complaintType7" initDicId="${complaintAutoT2.complaintType6}" defaultValue="${complaintAutoT2.complaintType7}"/>
			  		</td>					  
		   	</tr>
			...
			<tr>
	            ...
	            <td  class="content">
	               ...
	               <input type="hidden" name="autoAcceptRoleT1" id="toSendRoleId" value="${complaintAutoT2.autoAcceptRoleT1}"/>
