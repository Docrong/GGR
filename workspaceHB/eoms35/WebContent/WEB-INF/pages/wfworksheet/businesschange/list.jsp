...
<bean:define id="url" value="businesschange.do"/>
	<display:table name="taskList" cellspacing="0" cellpadding="0"
		id="taskList" pagesize="${pageSize}" class="listTable resourceAssessTable"
		export="true" requestURI="businesschange.do"
        ...
        <display:column  sortable="true"
			headerClass="sortable" title="任务所有者" sortName="task.taskOwner">
