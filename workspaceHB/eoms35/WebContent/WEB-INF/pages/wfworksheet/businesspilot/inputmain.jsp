...
<table id="sheet" class="formTable">
    <c:if test="${status!=1}">
        ...
        <tr>
            ...
            <td><input type="text" class="text" name="${sheetPageName}mainProductCode"
                       id="${sheetPageName}mainProductCode" readonly="true" alt="allowBlank:false"
                       value="${sheetMain.mainProductCode}"/>
        ...
        <tr>
            ...
            <td colspan="3">
                <input type="text" name="${sheetPageName}mainBusSheetId" class="text"
                       id="${sheetPageName}mainBusSheetId"
                       value="${sheetMain.mainBusSheetId}"
                       alt="maxLength:100,vtext:'${eoms:a2u('相关业务设计配合工单号，最大长度为100个汉字！')}"/>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <input type="text" class="text" name="${sheetPageName}mainStartTime" readonly="readonly"
                       ...
                       onclick="popUpCalendar(this, this)"
                       alt="vtype:'lessThen',link:'${sheetPageName}mainEndTime',vtext:'${eoms:a2u("试点开始时间不能晚于试点结束时间")}',allowBlank:false"/>
            </td>
            ...
            <td>
                <input type="text" class="text" name="${sheetPageName}mainEndTime" readonly="readonly"
                       ...
                       onclick="popUpCalendar(this, this)"
                       alt="vtype:'moreThen',link:'${sheetPageName}mainStartTime',vtext:'${eoms:a2u("试点结束时间不能早于试点开始理时间")}',allowBlank:false"/>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td colspan="3">
                <textarea name="mainReqDesc" id="mainReqDesc" class="textarea max"
                          alt="allowBlank:false,maxLength:1000,vtext:'${eoms:a2u('请输入试点需求简述，最大长度为1000个汉字！')}">${sheetMain.mainReqDesc}</textarea>
            </td>
        </tr>
        <!-- <tr>
        <td class="label">
        ...
        <tr>
            ...
            <td colspan="3">
                ...
                <eoms:attachment name="sheetMain" property="mainAcc"
                                 scope="request" idField="${sheetPageName}mainAcc" alt="allowBlank:false"
