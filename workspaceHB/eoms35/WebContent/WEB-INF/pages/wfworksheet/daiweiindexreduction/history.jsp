...
<div id="history" class="panel">
    ...
    <logic:present name="HISTORY" scope="request">
        ...
        <logic:iterate id="baselink" name="HISTORY"
                       type="com.boco.eoms.sheet.daiweiindexreduction.model.DaiWeiIndexReductionLink">
            <%
                jNum += 1;
            ...
            <div class="history-item">&nbsp;
                ...
                <div class="history-item-title">
                    ...
                    <eoms:dict key="dict-sheet-daiweiindexreduction" dictId="activeTemplateId"
                    ...
                    <eoms:dict key="dict-sheet-daiweiindexreduction" dictId="mainOperateType"
                ...
                <div class="history-item-content hide">
                    <table class="formTable" width="100%" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td class="label">
                                <!-- 联系人电话 -->
                                <bean:message bundle="daiweiindexreduction"
                                              key="daiWeiIndexReductionLink.linkManTelephone"/>
                            </td>
                            <td class="content">
                        ...
                        <tr>
                            ...
                            <td class="label">
                                <!-- 初审说明 -->
                                <bean:message bundle="daiweiindexreduction"
                                              key="daiWeiIndexReductionLink.linkTrialIllustrate"/>
                            </td>
                            <td colspan="3">
