...
<html:form action="/securityevaluate.do" styleId="theform">
    ...
    <input type="hidden" name="${sheetPageName}mainClassName"
           value="com.boco.eoms.sheet.securityevaluate.model.securityevaluateMain"/> <!--main\u8868Model\u5bf9\u8c61\u7c7b\u540d-->
    <input type="hidden" name="${sheetPageName}linkClassName"
           value="com.boco.eoms.sheet.securityevaluate.model.securityevaluateLink"/> <!--link\u8868Model\u5bf9\u8c61\u7c7b\u540d-->
    <table class="listTable">
        <tr>
            <td class="label"><bean:message bundle="securityevaluate" key="securityevaluate.ndeptContact"/></td>
            <td colspan="3"><input type="text" class="text" name="${sheetPageName}ndeptContact"
                                   id="${sheetPageName}ndeptContact" value="${sheetLink.ndeptContact}"/></td>
        </tr>
        <tr>
            <td class="label"><bean:message bundle="securityevaluate" key="securityevaluate.ndeptContactPhone"/></td>
            <td colspan="3"><input type="text" class="text" name="${sheetPageName}ndeptContactPhone"
                                   id="${sheetPageName}ndeptContactPhone" value="${sheetLink.ndeptContactPhone}"/></td>
        </tr>
        <tr>
            <td class="label"><bean:message bundle="securityevaluate" key="securityevaluate.dealResult"/></td>
            <td colspan="3"><input type="text" class="text" name="${sheetPageName}dealResult"
                                   id="${sheetPageName}dealResult" value="${sheetLink.dealResult}"/></td>
        </tr>
        <tr>
            <td class="label"><bean:message bundle="securityevaluate" key="securityevaluate.dealDesc"/></td>
            <td colspan="3"><input type="text" class="text" name="${sheetPageName}dealDesc"
                                   id="${sheetPageName}dealDesc" value="${sheetLink.dealDesc}"/></td>
        </tr>
        <tr>
            <td class="label"><bean:message bundle="securityevaluate" key="securityevaluate.netResCapacity"/></td>
            <td colspan="3"><input type="text" class="text" name="${sheetPageName}netResCapacity"
                                   id="${sheetPageName}netResCapacity" value="${sheetLink.netResCapacity}"/></td>
        </tr>
        <tr>
            <td class="label"><bean:message bundle="securityevaluate" key="securityevaluate.expectFinishdays"/></td>
            <td colspan="3"><input type="text" class="text" name="${sheetPageName}expectFinishdays"
                                   id="${sheetPageName}expectFinishdays" value="${sheetLink.expectFinishdays}"/></td>
        </tr>
        <tr>
            <td class="label"><bean:message bundle="securityevaluate" key="securityevaluate.circuitCode"/></td>
            <td colspan="3"><input type="text" class="text" name="${sheetPageName}circuitCode"
                                   id="${sheetPageName}circuitCode" value="${sheetLink.circuitCode}"/></td>
        </tr>
        <tr>
            <td class="label"><bean:message bundle="securityevaluate" key="securityevaluate.clientPgmCapacity"/></td>
            <td colspan="3"><input type="text" class="text" name="${sheetPageName}clientPgmCapacity"
                                   id="${sheetPageName}clientPgmCapacity" value="${sheetLink.clientPgmCapacity}"/></td>
        </tr>
    </table>
    </table>
</html:form>
