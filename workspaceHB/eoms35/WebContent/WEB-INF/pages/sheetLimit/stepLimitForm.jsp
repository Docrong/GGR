...
<html:form action="sheetLimit.do" method="post" styleId="stepLimitForm">
    <table class="formTable">
        ...
        <tr>
            ...
            <td>
                <eoms:comboBox name="taskName" id="taskName" initDicId="10121" defaultValue="${sheetLimitForm.stepId}"
                               styleClass="select-class"/>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <html:text property="limit" styleId="limit" styleClass="text medium"
                           alt="allowBlank:false,maxLength:9,vtext:'请填入预超时提醒时间，最多输入9个字符'" value="${stepLimit.limit}"/>
            </td>
        </tr>
    </table>
