        ...
        <table class="formTable">
            ...
            <tr>
                ...
                <td class="content">
                    ...
                    <input type="text" style="width:0px;height:0px;" id="time" name="time" value=""
                           onpropertychange="appendTimeBack();"/>
            ...
            <tr>
                <td class="content">
                    知识难易程度：<eoms:dict key="dict-kmmanager" dictId="levelFlag" isQuery="false" defaultId=""
                                      selectId="levelFlag"
                                      beanId="selectXML" alt="allowBlank:true" onchange="appendDict(this)"/>&nbsp;&nbsp;
                    知识等级：<eoms:dict key="dict-kmmanager" dictId="rolestrFlag" isQuery="false" defaultId=""
                                    selectId="rolestrFlag"
                                    beanId="selectXML" alt="allowBlank:true" onchange="appendDict(this)"/>&nbsp;&nbsp;
                    知识状态：<eoms:dict key="dict-kmmanager" dictId="contentStatus" isQuery="false" defaultId=""
                                    selectId="contentStatus"
                                    beanId="selectXML" alt="allowBlank:true" onchange="appendDict(this)"/>&nbsp;&nbsp;
            ...
            <tr>
                <td class="content">
                    <textarea name="ruleEditArea" id="ruleEditArea" class="textarea max" alt="allowBlank:false'"
                              cols="70" rows="24" attributesText="id='ruleEditArea'"></textarea>
                </td>
            </tr>
