...
<table border="0" width="100%">
    <tr>
        <td width="100%">
            ...
            <a class='blue' href="javascript:expandChildren('<%=tawwpModelGroupVO.getId()%>');">
                <img Id='id_img2_<%=tawwpModelGroupVO.getId()%>' src='../images/icon-group2.gif' align=TEXTTOP
                     border='0'>
            </a>
            <a id='id_groupHref_<%=tawwpModelGroupVO.getId()%>' class='blue'
               href="grouplist.do?modelplanid=<%=request.getParameter("modelplanid")%>&modelgroupid=<%=tawwpModelGroupVO.getId()%>">
