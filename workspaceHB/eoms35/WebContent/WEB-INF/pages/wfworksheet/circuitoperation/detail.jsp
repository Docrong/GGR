...
<div class="sheet-deal">
	<div class='sheet-deal-header'>
		...
		<%}else if(taskName.equals("DraftTask")){%>	
			<select id="dealSelector">
			  <option value="${urlShowDraftDeal}"><bean:message bundle="circuitoperation" key="operateType.draft"/></option>
			</select>
		...
		<%}else if(taskName.equals("HoldTask")){ %>
			<select id="dealSelector">
			  <option value="${urlShowHoldDealPage}"><bean:message bundle="circuitoperation" key="operateType.hold"/></option>
			</select>		
		<%} %>
		</td>
		</tr>
