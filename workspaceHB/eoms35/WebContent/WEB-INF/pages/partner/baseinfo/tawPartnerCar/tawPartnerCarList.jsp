...
<html:form action="tawPartnerCars.do?method=xquery" method="post"
	...
	<display:column property="car_number" sortable="true"
			headerClass="sortable" titleKey="tawPartnerCar.car_number" href="${app}/partner/baseinfo/tawPartnerCars.do?method=edit" paramId="id" paramProperty="id"/>

	<display:column property="dept_id" sortable="true"
			headerClass="sortable" titleKey="tawPartnerCar.dept_id" href="${app}/partner/baseinfo/tawPartnerCars.do?method=edit" paramId="id" paramProperty="id"/>

	<display:column property="area_id" sortable="true"
			headerClass="sortable" titleKey="tawPartnerCar.area_id" href="${app}/partner/baseinfo/tawPartnerCars.do?method=edit" paramId="id" paramProperty="id"/>

	<display:column property="start_time" sortable="true" format="{0,date,yyyy-mm-dd HH:MM:SS}"
			headerClass="sortable" titleKey="tawPartnerCar.start_time" href="${app}/partner/baseinfo/tawPartnerCars.do?method=edit" paramId="id" paramProperty="id"/>

	<display:column  sortable="true" property="piece" href="${app}/partner/baseinfo/tawPartnerCars.do?method=edit" paramId="id" paramProperty="id"
			headerClass="sortable" titleKey="tawPartnerCar.piece" />

	<display:column property="remark" sortable="true"
			headerClass="sortable" titleKey="tawPartnerCar.remark" href="${app}/partner/baseinfo/tawPartnerCars.do?method=edit" paramId="id" paramProperty="id"/>
