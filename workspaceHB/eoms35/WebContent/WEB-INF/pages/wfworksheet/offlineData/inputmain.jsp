	...
	<!-- sheet info --> 
     <table class="formTable">
		...
		<tr>
			  ...
			  <td>
			    <eoms:comboBox name="offlineType" id="offlineType" initDicId="1011901" defaultValue="${sheetMain.offlineType}" alt="allowBlank:false"/>
			  </td>
	  ...
	  <tr>
		    ...
		    <td colspan="3">
		    	<textarea class="textarea max" name="mainRemark" id="mainRemark" alt="allowBlank:false,maxLength:255,vtext:'请填入备注 信息，最多输入 255 字符'">${sheetMain.mainRemark}</textarea>
		    </td>
	  </tr>
