...
<script type="text/javascript">
   ...
   Ext.onReady(function(){
	...
	if ('${templateId}'!= null && '${templateId}' != "") {
		mgr.update("${app}/sheet/commonfault/commonfault.do?method=showTemplateInputSheetPage&templateId=${templateId}");
	} else {
		mgr.update("${app}/sheet/commonfault/commonfault.do?method=showNewInputSheetPage&processname=CommonFaultMainFlowProcess");
	}
...
<html:form action="/commonfault.do?method=performAdd" styleId="theform">
	...
	<logic:notPresent name="templateManage">
		...
		<html:button styleClass="btn" property="method.save" styleId="method.save" onclick="window.open('./commonfault.do?method=getTemplatesByUserId',null,'left=300,top=150,height=400,width=500,scrollbars=yes,resizable=yes')">
