...
<center>
    ...
    <table border="0" width="95%" cellspacing="1" cellpadding="1" class="table_show" align=center>
        ...
        <logic:iterate id="tawDept" name="tawSystemDeptList"
                       type="com.boco.eoms.commons.system.dept.model.TawSystemDept">
            <tr class="tr_show">
                ...
                <td width="10%" height="25">
                    <html:link page="/editTawSystemDept.do?method=comebackdel" paramId="id"
                               paramName="tawDept" paramProperty="id"><img
                            src="<%=request.getContextPath()%>/images/pic_5_3.gif"
                            border="0"
                            alt="<bean:message key="button.comebackdel"/><bean:write name="tawDept" property="id" scope="page"/> "></html:link>
                </td>
                <%} %>
            </tr>
        </logic:iterate>
