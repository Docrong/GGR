...
<script language='javascript'>
    function period() {
        ...
        location.href = '${app}/kmmanager/personalStatistics.do?method=deptSearch&startDate=' + startDate + '&endDate=' + endDate;
    }
</script>
...
<fmt:bundle basename="com/boco/eoms/km/config/applicationResource-kmmanager">
    ...
    <content tag="heading">
        <b><fmt:message key="personalStatistic.list.deptHeading"/></b>
    </content>
    ...
    <display:table name="personalStatisticList" cellspacing="0" cellpadding="0"
        ...
        <display:column property="modifyCount" sortable="true"
                        headerClass="sortable" titleKey="personalStatistic.modifyCount" paramId="id"
                        paramProperty="id"/>
        ...
        <display:column property="deleteCount" sortable="true"
                        headerClass="sortable" titleKey="personalStatistic.deleteCount" paramId="id"
                        paramProperty="id"/>
