...
PortletWindow.prototype.selfRefresh = function () {
    ...
    if (this.allowJS) {
        ...
        ajaxEngine.sendRequestAndUpdate(this.request, Light._PC_PREFIX + this.tIndex + "_" + this.position + "_" + this.index, {
            evalScripts: true,
            parameters: pars
        });
    } else {
...
PortletWindow.prototype.createPortletHeader = function (portlet) {
    ...
    if (Light.portal.tabs[this.tIndex].tabIsMoveable) {
        ...
        vHeader.onmousemove = function (e) {
            portlet.move(e);
        }
        vHeader.onmouseup = function () {
            portlet.moveEnd();
        }
        vHeader.onmouseout = function () {
            portlet.moveEnd();
        }
