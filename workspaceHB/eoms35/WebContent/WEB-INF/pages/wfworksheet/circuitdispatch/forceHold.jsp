...
<div id="sheetform">
    <html:form action="/circuitdispatch.do?method=performFroceHold" styleId="theform">
   ...
   if(operateType != null){
      ...
      %>
            ...
            <tr>
                ...
                <td colspan="3">
                    ...
                    <eoms:comboBox name="${sheetPageName}holdStatisfied" id="${sheetPageName}holdStatisfied"
                                   alt="allowBlank:false" initDicId="10303" styleClass="select"/>
            ...
            <input type="hidden" name="${sheetPageName}mainClassName"
                   value="com.boco.eoms.sheet.circuitdispatch.model.CircuitDispatchMain"/>
            <!--mainè¡¨Modelå¯¹è±¡ç±»å-->
            <input type="hidden" name="${sheetPageName}linkClassName"
                   value="com.boco.eoms.sheet.circuitdispatch.model.CircuitDispatchLink"/>
            <!--linkè¡¨Modelå¯¹è±¡ç±»å-->
            ...
            <input type="hidden" name="${sheetPageName}invokePiid" id="${sheetPageName}invokePiid"
                   value="${parentMain.piid}"/>
            ...
            <tr>
                ...
                <td colspan="3">
                    ...
                    <textarea class="textarea max" name="${sheetPageName}cancelReason" id="${sheetPageName}cancelReason"
