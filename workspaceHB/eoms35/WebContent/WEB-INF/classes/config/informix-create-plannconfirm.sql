...
values ('xls,txt,doc,jpg,gif', 'plannconfirm', '规划站址确认申请流程流程', 1024, '/sheet/plannconfirm', 104, '402882e83f18c2fa013f18c2fa9f0011');
...
values ('402882e83f18c2fa013f18c2fa9f0012', '9601', '1', '新增工单', '96', null, '/sheet/plannconfirm/plannconfirm.do?method=showNewSheetPage', '0', '0', 1);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402882e83f18c2fa013f18c2fa9f0013', '9603', '0', '待处理工单', '96', null, null, '0', '0', 3);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402882e83f18c2fa013f18c2fa9f0014', '960301', '1', '待办工单', '9603', null, '/sheet/plannconfirm/plannconfirm.do?method=showListsendundo', '0', '0', 1);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402882e83f18c2fa013f18c2fa9f0015', '9607', '1', '工单查询', '96', null, '/sheet/plannconfirm/plannconfirm.do?method=showQueryPage', '0', '0', 7);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402882e83f18c2fa013f18c2fa9f0016', '9608', '1', '工单处理模板', '96', null, '/sheet/plannconfirm/plannconfirm.do?method=getDealTemplatesByUserId&type=templateManage', '0', '0', 8);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402882e83f18c2fa013f18c2fa9f0017', '9609', '1', '工单模板管理', '96', null, '/sheet/plannconfirm/plannconfirm.do?method=getTemplatesByUserId&type=templateManage', '0', '0', 9);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402882e83f18c2fa013f18c2fa9f0018', '9610', '1', '管理者工单', '96', null, '/sheet/plannconfirm/plannconfirm.do?method=showListForAdmin', '0', '0', 10);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402882e83f18c2fa013f18c2fa9f0019', '96', '0', '规划站址确认申请流程流程', '10', null, '/sheet/plannconfirm/plannconfirm.do?method=showDrawing', '0', '0', 20);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402882e83f18c2fa013f18c2fa9f001a', '9602', '1', '草稿列表', '96', null, '/sheet/plannconfirm/plannconfirm.do?method=showDraftList', '0', '0', 2);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402882e83f18c2fa013f18c2fa9f001b', '9604', '0', '已处理工单', '96', null, null, '0', '0', 4);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402882e83f18c2fa013f18c2fa9f001c','960402','1','建立工单','9604', null, '/sheet/plannconfirm/plannconfirm.do?method=showOwnStarterList','0','0',2);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402882e83f18c2fa013f18c2fa9f001d', '960401', '1', '处理工单', '9604', null, '/sheet/plannconfirm/plannconfirm.do?method=showListsenddone', '0', '0', 1);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402882e83f18c2fa013f18c2fa9f001e', '9605', '1', '已归档工单', '96', null, '/sheet/plannconfirm/plannconfirm.do?method=showHoldedList', '0', '0', 5);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402882e83f18c2fa013f18c2fa9f001f', '9606', '1', '已作废工单', '96', null, '/sheet/plannconfirm/plannconfirm.do?method=showCancelList', '0', '0', 6);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402882e83f18c2fa013f18c2fa9f0020', '9611', '1', '超时时间设置', '96', null, '/sheet/overtimetip/overtimetip.do?flowName=PlannConfirm', '0', '0', 11);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402882e83f18c2fa013f18c2fa9f0021', '9612', '1', '工单处理时限配置', '96', null, '/sheet/newSheetLimit/sheetLimit.do?method=getLevelLimitList&flowName=PlannConfirm', '0', '0', 30);