...
<%
    com.boco.eoms.sheet.offlineData.model.OfflineDataLink offlineDataLink = (com.boco.eoms.sheet.offlineData.model.OfflineDataLink) request.getAttribute("sheetLink");
    java.lang.String taskName = com.boco.eoms.base.util.StaticMethod.nullObject2String(offlineDataLink.getActiveTemplateId());
    java.lang.String operateType = java.lang.String.valueOf(com.boco.eoms.base.util.StaticMethod.nullObject2String(offlineDataLink.getOperateType()));
%>
<script type="text/javascript">
    ...
    function saveDealTemplate(type) {
        ...
        form.action = "${app}/sheet/offlineData/offlineData.do?method=saveDealTemplate&type=dealTemplateManage&dealTemplateId=${sheetLink.id}";
        form.submit();
    }
...
<html:form action="/offlineData.do" styleId="theform">
    <br/>
    ...
    <table class="formTable">
        <caption><bean:message bundle="offlineData" key="offlineData.header"/></caption>
        <tr>
            <td class="label">
        ...
        <tr>
            <td class="label"><bean:message bundle="offlineData" key="offlineData.linkZContact"/>*</td>
            <td class="content">
            ...
            <td class="label"><bean:message bundle="offlineData" key="offlineData.linkZContactTel"/>*</td>
            <td class="content">
        ...
        <tr>
            ...
            <td colspan='3'>
                <eoms:attachment idList="" scope="request" idField="${sheetPageName}nodeAccessories" name="sheetLink"
                                 property="nodeAccessories" appCode="offlineData" alt="allowBlank:true"/>
            </td>
        </tr>
        <%
                }
        ...
        <tr>
            <td class="label"><bean:message bundle="offlineData" key="offlineData.linkOperationDesc"/>*</td>
            <td colspan="3">
        ...
        <tr>
            <td class="label">
                <bean:message bundle="offlineData" key="offlineData.remark"/>*
            </td>
            <td colspan="3">
