...
<div id="sheetform">
    <html:form action="/daiweiindexreduction.do?method=performDealReplyReject" styleId="theform">
        <%
        ...
        <input type="hidden" name="subtaskName" value="DaiWeiIndexReductionSubTask"/>
        ...
        <input type="hidden" name="taskNamespace" value="http://DaiWeiIndexReduction"/>
