...
public class _SaveDataServiceHome_Stub extends Stub implements SaveDataServiceHome {
    
    private static final String[] _type_ids = {
        "RMI:com.boco.eoms.sheet.base.service.ejb.SaveDataServiceHome:0000000000000000", 
    ...
    public SaveDataService create() throws CreateException, RemoteException {
        while(true) {
            if (!Util.isLocal(this)) {
                InputStream in = null;
                try {
                    try {
                        ...
                        in = (InputStream)_invoke(out);
                        return (SaveDataService) in.read_Object(SaveDataService.class);
                    } catch (ApplicationException ex) {
                        in = (InputStream) ex.getInputStream();
                        String id = in.read_string();
                ...
                ServantObject so = _servant_preinvoke("create",com.boco.eoms.sheet.base.service.ejb.SaveDataServiceHome.class);
                if (so == null) {
                    continue;
                }
                try {
                    SaveDataService result = ((com.boco.eoms.sheet.base.service.ejb.SaveDataServiceHome)so.servant).create();
                    return (SaveDataService)Util.copyObject(result,_orb());
                } catch (Throwable ex) {
                    Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
