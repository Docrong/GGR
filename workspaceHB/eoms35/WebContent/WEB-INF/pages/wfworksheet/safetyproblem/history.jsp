                ...
                <div class="history-item hide">
                    <c:forEach items="${deptIdMap[deptId]}" var="baselink">
                        ...
                        <div class="history-item-title">
                                ${numberMap[baselink.id]}. <bean:write name="baselink" property="operateTime"
                            ...
                            <eoms:dict key="dict-sheet-safetyproblem" dictId="activeTemplateId"
                                       itemId="${baselink.activeTemplateId}" beanId="id2descriptionXML"/>
                            <bean:message bundle="safetyproblem" key="safetyproblem.operateType"/>:
                            <eoms:dict key="dict-sheet-safetyproblem" dictId="mainOperateType"
                            ...
                            <table class="history-item-table" width="100%" cellpadding="0" cellspacing="0">
                                ...
                                <c:if test="${!empty baselink.nodeAcceptLimit && !empty baselink.nodeCompleteLimit}">
                                    ...
                                    <tr>
                                        ...
                                        <td class="column-content">
                                            <bean:write name="baselink" property="nodeAcceptLimit"
                                ...
                                <c:if test="${!empty baselink.activeTemplateId && (baselink.activeTemplateId == 'TaskCreateAuditHumTask' || baselink.activeTemplateId == 'TaskCompleteAuditHumTask') }">
                                    <c:if test="${!empty baselink.operateType && (baselink.operateType == '201' || baselink.operateType == '202' || baselink.operateType == '208' || baselink.operateType == '209')}">
                                        ...
                                        <tr>
                                            <td class="column-title">
                                                <bean:message bundle="safetyproblem"
                                                              key="safetyproblem.linkAuditResult"/>
                                            </td>
                                            <td class="column-content" colspan="3">
                                                <eoms:id2nameDB id="${baselink.linkAuditResult}"
                                                                beanId="ItawSystemDictTypeDao"/>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="column-title">
                                                <bean:message bundle="safetyproblem" key="safetyproblem.linkAuditIdea"/>
                                            </td>
                                            <td class="column-content" colspan="3">
                                                <pre> <bean:write name="baselink" property="linkAuditIdea"
                                                                  scope="page"/></pre>
                                            </td>
                                        </tr>
                                    </c:if>
                                ...
                                <c:if test="${!empty baselink.activeTemplateId && baselink.activeTemplateId == 'ExcuteHumTask'}">
                                    <c:if test="${!empty baselink.operateType && (baselink.operateType == '205' || baselink.operateType == '206')}">
                                        <tr>
                                            <td class="label"><bean:message bundle="safetyproblem"
                                                                            key="safetyproblem.linkTaskComplete"/></td>
                                            <td class="column-content" colspan="3">
                                                <pre> <bean:write name="baselink" property="linkTaskComplete"
                                                                  scope="page"/></pre>
                                            </td>
                                        </tr>
                                    ...
                                    <c:if test="${!empty baselink.operateType && baselink.operateType == '10'}">
                                        <tr>
                                            <td class="column-title">
                                                <bean:message bundle="safetyproblem" key="safetyproblem.fenpairesion"/>
                                            </td>
                                            <td class="column-content" colspan="3">
                                                <pre><bean:write name="baselink" property="linkTaskComplete"
                                                                 scope="page"/></pre>
                                    ...
                                    <c:if test="${!empty baselink.operateType && baselink.operateType == '8'}">
                                        <tr>
                                            <td class="column-title">
                                                <bean:message bundle="safetyproblem" key="safetyproblem.yijiaoresion"/>
                                            </td>
                                            <td class="column-content" colspan="3">
                                                <pre><bean:write name="baselink" property="linkTaskComplete"
                                                                 scope="page"/></pre>
                                ...
                                <c:if test="${!empty baselink.activeTemplateId && baselink.activeTemplateId == 'AffirmHumTask'}">
                                    <c:if test="${!empty baselink.operateType && (baselink.operateType == '211' || baselink.operateType == '212')}">

                                        <tr>
                                            <td class="column-title">
                                                <bean:message bundle="safetyproblem" key="safetyproblem.advice"/>
                                            </td>
                                            <td class="column-content" colspan=3>
                                                <pre><bean:write name="baselink" property="linkTaskComplete"
                                                                 scope="page"/></pre>
...
<script type="text/javascript">
    ...
    function copy(id) {
        ...
        if (ifCheck.checked == true) {
            Ext.Ajax.request({
                method: "get",
                url: "safetyproblem.do?method=getJsonLink&id=" + id + "&beanName=SafetyProblem",
                success: function (x) {
