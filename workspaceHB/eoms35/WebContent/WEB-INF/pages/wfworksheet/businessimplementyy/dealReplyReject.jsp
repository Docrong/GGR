...
<div id="sheetform">
<html:form action="/businessimplementyy.do?method=performDealReplyReject" styleId="theform">
 <%@ include file="/common/taglibs.jsp"%>
<%
 ...
 %>
    ...
    <input type="hidden" name="${sheetPageName}linkClassName" value="com.boco.eoms.sheet.businessimplementyy.model.BusinessImplementYYLink"/> <!--link表Model对象类名--> 
 	<input type="hidden" name="${sheetPageName}processTemplateName" id="${sheetPageName}processTemplateName" value="BusinessImplementYYProcess" />
    <input type="hidden" name="${sheetPageName}subtaskName" value="${subtaskName}"/> 
    <input type="hidden" name="${sheetPageName}taskNamespace" value="http://BusinessImplementYYProcess"/> 
...
<%@ include file="/WEB-INF/pages/wfworksheet/businessimplementyy/baseinputlinkhtmlnew.jsp"%>
     ...
     <tr>
      ...
      <logic:iterate id="toTask" name="acceptList" type="com.boco.eoms.sheet.businessimplementyy.model.BusinessImplementYYTask">  
        <tr>
          <td>
