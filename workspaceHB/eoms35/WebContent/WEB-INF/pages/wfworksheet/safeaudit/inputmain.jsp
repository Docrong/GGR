...
<table class="formTable">
    <tr>
        <td class="label"><bean:message bundle="safeaudit"
                                        key="safeaudit.sheetAcceptLimit"/>*
        </td>
        ...
        <td class="label"><bean:message bundle="safeaudit"
                                        key="safeaudit.sheetCompleteLimit"/>*
        </td>
        <td class="content"><input type="text" class="text"
    ...
    <c:if test="${status!=1}">
        <tr>
            <td class="label"><bean:message bundle="safeaudit"
                                            key="safeaudit.mainSafeAuditType1"/>*
            </td>
            ...
            <td class="label"><bean:message bundle="safeaudit"
                                            key="safeaudit.mainSafeAuditType2"/>*
            </td>
        ...
        <tr>
            <td class="label"><bean:message bundle="safeaudit"
                                            key="safeaudit.mainSafeAuditType3"/>*
            </td>
        ...
        <tr>
            <td class="label"><bean:message bundle="safeaudit"
                                            key="safeaudit.mainSafeAuditRequest"/>*
            </td>
