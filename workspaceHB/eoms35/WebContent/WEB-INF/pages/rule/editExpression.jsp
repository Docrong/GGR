...
<table class="member-table" cellspacing="0">
    ...
    <tr>
        <td><input type="button" value="<bean:message key='rule.table.button.checkExpression'/>"
    ...
    <tr>
        <td><select name="input"/>
            <option value=""><bean:message key='rule.table.title.select'/></option>
            <input type="button" value="<bean:message key='rule.table.button.insertIputParameter'/>"
                   onclick="insertInput();"/>
        </td>
    ...
    <tr>
        <td><select name="output"/>
            ...
            <input type="button" value="<bean:message key='rule.table.button.insertOutputParameter'/>"
    ...
    <tr>
        <td>
            ...
            <bean:message key='rule.table.title.isString'/><input type="checkbox" checked="true" id="isStr"><input
                type="button" value="<bean:message key='rule.table.button.insertDictionary'/>" onclick="insertDict();"/>
        </td>
    </tr>


    <tr>
        <td align="right"><input type="button" value="&nbsp;<bean:message key='rule.table.button.return'/>&nbsp;"
