...
function checkAlarm(){
 ...
 function getlinkFaultAvoidTime(){
    ...
    if(attachment ==null ||attachment==''){
     	...
     	var url ="${app}/sheet/commonfault/commonfault.do?method=getMainAlarmIdIsTure&mainAlarmId=${sheetMain.mainAlarmId}";
     	Ext.Ajax.request({
			url :url ,
			method: 'POST',
			success: function (res) {
   ...
   function seleBanz(){
   		//var result= window.showModalDialog("${app}/sheet/commonfault/commonfault.do?method=seleBanz&operateRoleId=${operateRoleId}",'','dialogWidth=900px;dialogHeight=600px;center:yes;resizable:yes');
   		//if(result != null || result != ''){
   		//	var subRoleId = result.split("#")[0];
   		//	var subRoleName = result.split("#")[1];
		//    document.getElementById("dealPerformer1").value = subRoleId;
		//	document.getElementById("subRoleName").innerHTML = subRoleName;
			//没有申请跨地市选择班组，将标准位置为空
		//	document.getElementById("mainIsOther").value ="";
		//	document.getElementById("mainOtherSubrole").value ="";
		//	document.getElementById("mainThisSubrole").value ="";
   		//}
   		
   		window.open('${app}/sheet/commonfault/commonfault.do?method=seleBanz&operateRoleId=${operateRoleId}','','width=900,height=600,menubar=yes, scrollbars=yes, resizable=yes');
   }
   
   function sendotherbanz(){
   	   alert("请电话联系省监控部");
	   ...
	   var operateRoleId = '${operateRoleId}';
	   var dealPerformer = document.getElementById("mainOtherSubrole").value;
   	   window.open('${app}/sheet/commonfault/commonfault.do?method=sendotherbanz&linkSendRes='+linkSendRes+'&linkSendOtherName='+linkSendOtherName+'&linkSendOtherTel='+linkSendOtherTel+'&dealPerformer='+dealPerformer+'&operateRoleId='+operateRoleId,'','width=900,height=600');
   	   
   }
   
   function changeDiv(obj){
   		if(obj.value == '101011202'){//不同意
   			eoms.form.enableArea('changeee');
   			document.getElementById("dealPerformer").value = '${sheetMain.mainThisSubrole}';
   			document.getElementById("dealPerformerLeader").value = '${sheetMain.mainThisSubrole}';
   		}else{
   			eoms.form.disableArea('changeee',true);
   			document.getElementById("dealPerformer").value = '${sheetMain.mainOtherSubrole}';
   			document.getElementById("dealPerformerLeader").value = '${sheetMain.mainOtherSubrole}';
   		}
   }
...
<%}%>
     	...
     	<input type="button" class="submit" value="故障工单调用代维流程"
  			...
  			&nbsp;&nbsp;&nbsp;&nbsp;
  			 <%if("WL-001-00-800003".equals(mainAlarmId)){%>
  			 	<input type="button" class="submit" value="代维回复内容" onclick="searchContent1('${sheetMain.id}');" onmouseout="search1();"/>
  			 	<%}else{%>
  			<input type="button" class="submit" value="代维回复内容" onclick="searchContent('${sheetMain.id}');" onmouseout="search1();"/>
  		  	<%}%>
    ...
    <tr>
      <td class="label"><bean:message bundle="commonfault" key="commonfault.linkIfGreatFault"/>*</td>
		  <td class="content">
		  	<eoms:comboBox name="${sheetPageName}linkIfGreatFault" id="${sheetPageName}linkIfGreatFault" initDicId="10301" defaultValue="1030102"/>
		  </td>		
    </tr>
...
<!-- lizhi -->
		<tr><td class="label">
			...
			<td colspan="3">
			<br>无线侧选项：<br>
				<input type="checkbox" id="_wireless1" name="_wireless" value="基站退服" onclick="changeFaultFirstDealDesc(this)" style="vertical-align: middle;">基站退服
				<input type="checkbox" id="_wireless2" name="_wireless" value="小区退服" onclick="changeFaultFirstDealDesc(this)" style="vertical-align: middle;">小区退服
				<input type="checkbox" id="_wireless3" name="_wireless" value="正常" onclick="changeFaultFirstDealDesc(this)" style="vertical-align: middle;">正常
				<input type="checkbox" id="_wireless4" name="_wireless" value="设备掉电" onclick="changeFaultFirstDealDesc(this)" style="vertical-align: middle;">设备掉电
				<input type="checkbox" id="_wireless5" name="_wireless" value="时钟参考源异常" onclick="changeFaultFirstDealDesc(this)" style="vertical-align: middle;">时钟参考源异常
				<input type="checkbox" id="_wireless6" name="_wireless" value="单板通讯链路断" onclick="changeFaultFirstDealDesc(this)" style="vertical-align: middle;">单板通讯链路断
				<input type="checkbox" id="_wireless7" name="_wireless" value="被汇聚射频单元链路异常" onclick="changeFaultFirstDealDesc(this)" style="vertical-align: middle;">被汇聚射频单元链路异常
				<input type="checkbox" id="_wireless8" name="_wireless" value="光电上行链路中断" onclick="changeFaultFirstDealDesc(this)" style="vertical-align: middle;">光电上行链路中断
				<br>射频单元：
				<input type="checkbox" id="_wireless9" name="_wireless" value="射频单元维护链路异常" onclick="changeFaultFirstDealDesc(this)" style="vertical-align: middle;">维护链路异常
				<input type="checkbox" id="_wireless10" name="_wireless" value="射频单元光模块收发异常" onclick="changeFaultFirstDealDesc(this)" style="vertical-align: middle;">光模块收发异常
				<input type="checkbox" id="_wireless11" name="_wireless" value="射频单元配置但不可用" onclick="changeFaultFirstDealDesc(this)" style="vertical-align: middle;">配置但不可用
				<input type="checkbox" id="_wireless12" name="_wireless" value="射频单元光接口性能恶化" onclick="changeFaultFirstDealDesc(this)" style="vertical-align: middle;">光接口性能恶化
				<input type="checkbox" id="_wireless13" name="_wireless" value="射频单元驻波告警" onclick="changeFaultFirstDealDesc(this)" style="vertical-align: middle;">驻波告警
				<br>BBU：
				<input type="checkbox" id="_wireless14" name="_wireless" value="BBU CPRI接口异常" onclick="changeFaultFirstDealDesc(this)" style="vertical-align: middle;">CPRI接口异常
				<input type="checkbox" id="_wireless15" name="_wireless" value="BBU IR光模块收发异常" onclick="changeFaultFirstDealDesc(this)" style="vertical-align: middle;">IR光模块收发异常
				<input type="checkbox" id="_wireless16" name="_wireless" value="BBU光模块收发异常" onclick="changeFaultFirstDealDesc(this)" style="vertical-align: middle;">光模块收发异常
				<input type="checkbox" id="_wireless17" name="_wireless" value="BBU与RRU通讯链路断" onclick="changeFaultFirstDealDesc(this)" style="vertical-align: middle;">与RRU通讯链路断
				
				<br><br>动环侧选项：<br>
				<input type="checkbox" id="_dynring1" name="_dynring" value="市电无,直流电压低" onclick="changeFaultFirstDealDesc(this)" style="vertical-align: middle;">市电无,直流电压低
				<input type="checkbox" id="_dynring2" name="_dynring" value="监控中断,无法查询相关信息" onclick="changeFaultFirstDealDesc(this)" style="vertical-align: middle;">监控中断,无法查询相关信息
				<input type="checkbox" id="_dynring3" name="_dynring" value="正常" onclick="changeFaultFirstDealDesc(this)" style="vertical-align: middle;">正常
				<input type="checkbox" id="_dynring4" name="_dynring" value="市电正常,直流电压低" onclick="changeFaultFirstDealDesc(this)" style="vertical-align: middle;">市电正常,直流电压低
				<input type="checkbox" id="_dynring5" name="_dynring" value="门开告警" onclick="changeFaultFirstDealDesc(this)" style="vertical-align: middle;">门开告警
				<input type="checkbox" id="_dynring6" name="_dynring" value="高温告警" onclick="changeFaultFirstDealDesc(this)" style="vertical-align: middle;">高温告警
				<input type="checkbox" id="_dynring7" name="_dynring" value="烟雾告警" onclick="changeFaultFirstDealDesc(this)" style="vertical-align: middle;">烟雾告警
				<br><input type="checkbox" id="_dynring8" name="_dynring" value="室分站点无相关信息,请实地核实故障原因" onclick="changeFaultFirstDealDesc(this)" style="vertical-align: middle;">室分站点无相关信息,请实地核实故障原因
				<input type="checkbox" id="_dynring9" name="_dynring" value="4G站点无对应网元信息,请实地核实故障原因" onclick="changeFaultFirstDealDesc(this)" style="vertical-align: middle;">4G站点无对应网元信息,请实地核实故障原因
				
				<br><br>传输侧选项：<br>
				<input type="checkbox" id="_transmission1" name="_transmission" value="E1/T1信号丢失告警" onclick="changeFaultFirstDealDesc(this)" style="vertical-align: middle;">E1/T1信号丢失告警
				<input type="checkbox" id="_transmission2" name="_transmission" value="以太网物理接口信号丢失告警" onclick="changeFaultFirstDealDesc(this)" style="vertical-align: middle;">以太网物理接口信号丢失告警
				<input type="checkbox" id="_transmission3" name="_transmission" value="网元脱管,无法查询相关信息" onclick="changeFaultFirstDealDesc(this)" style="vertical-align: middle;">网元脱管,无法查询相关信息
				<input type="checkbox" id="_transmission4" name="_transmission" value="光路告警" onclick="changeFaultFirstDealDesc(this)" style="vertical-align: middle;">光路告警
				<input type="checkbox" id="_transmission5" name="_transmission" value="正常" onclick="changeFaultFirstDealDesc(this)" style="vertical-align: middle;">正常
				<br><input type="checkbox" id="_transmission6" name="_transmission" value="室分站点无相关信息,请实地核实故障原因" onclick="changeFaultFirstDealDesc(this)" style="vertical-align: middle;">室分站点无相关信息,请实地核实故障原因
				<input type="checkbox" id="_transmission7" name="_transmission" value="4G站点无对应网元信息,请实地核实故障原因" onclick="changeFaultFirstDealDesc(this)" style="vertical-align: middle;">4G站点无对应网元信息,请实地核实故障原因
				
				<br><br>初步判断选项：<br>
				<input type="checkbox" id="_judge1" name="_judge" value="停电导致退服" onclick="changeFaultFirstDealDesc(this)" style="vertical-align: middle;">停电导致退服
				<input type="checkbox" id="_judge2" name="_judge" value="光路中断导致退服" onclick="changeFaultFirstDealDesc(this)" style="vertical-align: middle;">光路中断导致退服
				<input type="checkbox" id="_judge3" name="_judge" value="传输设备故障导致退服" onclick="changeFaultFirstDealDesc(this)" style="vertical-align: middle;">传输设备故障导致退服
				<input type="checkbox" id="_judge4" name="_judge" value="无线设备故障导致退服" onclick="changeFaultFirstDealDesc(this)" style="vertical-align: middle;">无线设备故障导致退服
				<input type="checkbox" id="_judge5" name="_judge" value="请核实告警原因并及时处理。" onclick="changeFaultFirstDealDesc(this)" style="vertical-align: middle;">请核实告警原因并及时处理。
				<input type="checkbox" id="_judge6" name="_judge" value="网元对应有误,请匹配正确班组。" onclick="changeFaultFirstDealDesc(this)" style="vertical-align: middle;">网元对应有误,请匹配正确班组。
			</td>
		</tr>
<script type="text/javascript">
        ...
        <%if(operateType.equals("46") || operateType.equals("11") ){ %>
	       ...
	       <tr>
				  ...
				  <td class="content" id="linkFaultReasonSort1">
				         ...
				         id="${sheetPageName}linkFaultReasonSort" initDicId="1010317"  sub="${sheetPageName}linkFaultReasonSubsection"
				  ...
				  <td class="content" id="linkFaultReasonSubsection1">
				      <eoms:comboBox name="${sheetPageName}linkFaultReasonSubsection" 
				         id="${sheetPageName}linkFaultReasonSubsection"   initDicId="${sheetLink.linkFaultReasonSort}" sub="${sheetPageName}linkFaultReasonSubsectionTwo" 
				...
				<tr>
					...
					<td colspan="3" id="linkFaultReasonSubsectionTwo1">
						<eoms:comboBox name="${sheetPageName}linkFaultReasonSubsectionTwo" 
					         id="${sheetPageName}linkFaultReasonSubsectionTwo"   initDicId="${sheetLink.linkFaultReasonSubsection}"
	       ...
	       <%}else if ("false".equals(alarmFlag)){%>
				<tr>
				  ...
				  <td class="content" id="linkFaultReasonSubsection1">
				      <eoms:comboBox name="${sheetPageName}linkFaultReasonSubsection" 
				         id="${sheetPageName}linkFaultReasonSubsection"   initDicId="${sheetLink.linkFaultReasonSort}" sub="${sheetPageName}linkFaultReasonSubsectionTwo" 
				         defaultValue="${sheetLink.linkFaultReasonSubsection}"  alt="allowBlank:false,vtext:'归因二级未填写'"/>
				  </td>
				  <td class="column-content" id="linkFaultReasonSubsection2" style="display: none"></td>
				</tr>
				<tr>
					...
					<td colspan="3" id="linkFaultReasonSubsectionTwo1">
						<eoms:comboBox name="${sheetPageName}linkFaultReasonSubsectionTwo" 
					         id="${sheetPageName}linkFaultReasonSubsectionTwo"   initDicId="${sheetLink.linkFaultReasonSubsection}"
					         defaultValue="${sheetLink.linkFaultReasonSubsectionTwo}"  alt="allowBlank:false,vtext:'归因三级未填写'"/>
				    </td>
				    <td class="column-content" id="linkFaultReasonSubsectionTwo2" style="display: none"></td>
				</tr>
...
<%}%>
				...
				<tr>
                   ...
                   value="<%=currentDate %>" id="${sheetPageName}faultdealTime"  alt="vtype:'lessThen',link:'${sheetPageName}linkFaultAvoidTime',vtext:'故障消除时间不能早于故障处理时间',allowBlank:false"/> 
					 </td>
					  <td class="label">故障处理人*</td>
					 <td>
					<input type="text" class="text" name="${sheetPageName}faultTreatment" 
                     id="${sheetPageName}faultTreatment" value="<%=userName %>" alt="allowBlank:false"/>
					 </td>	
	      </tr>
	  ...
	  <%if("101010417".equals(mainNetSortOne)){%>
	      ...
	      <tr>
	       <td class="label">故障原因说明*</td>
					 <td colspan="3">
					  <textarea name="${sheetPageName}faultdealdesc" id="${sheetPageName}faultdealdesc" class="textarea max" 
					 alt="allowBlank:true,width:500,maxLength:1000,vtext:'最多输入500汉字'" alt="width:'500px'">${sheetLink.faultdealdesc}</textarea>	
					 </td>
      ...
      <%if("WL-001-00-800003".equals(mainAlarmId)){%>
				<tr>
				  <td class="label">原因类别选择*</td>
				    <td colspan="3">
	      <select id="select3" name="select3" onchange="choosemodel(this.value)" alt="allowBlank:false,vtext:'原因类别未填写'">
...
<select id="selectStep" name="selectStep" onchange="isifdeal(this.value)" alt="allowBlank:false">
					...
					%>
						...
						<input type="hidden" name="faultReasonSubsection" id="faultReasonSubsection" value="<%=faultReasonSubsection%>"/>
						<input type="hidden" name="faultReasonSubsectionTwo" id="faultReasonSubsectionTwo" value="<%=faultReasonSubsectionTwo%>"/>
         ...
         <%}%>        
				  ...
				  <td colspan="3" >
					<textarea name="${sheetPageName}linkDealdesc" id="${sheetPageName}linkDealdesc" class="textarea max"  alt="allowBlank:true,width:500,maxLength:1000,vtext:'最多输入500汉字'" alt="width:'500px'">${sheetLink.linkDealdesc}</textarea>
		       ...
		       <td class="label">
				...
				<td colspan="3">			
			        <textarea name="${sheetPageName}remark" class="textarea max" id="${sheetPageName}remark" >${sheetLink.remark}</textarea>
			  </td>
			</tr> 
	         <%if((taskName.equals("FirstExcuteHumTask") || taskName.equals("SecondExcuteHumTask") ||
			...
			<tr>
		     ...
		     <%} %>
		  	...
		  	<input type="hidden" name="packflag" id="packflag" value="<%=packflag %>" />
				    ...
				    <input type="hidden" name="mainAlarmSolveDate2" id="mainAlarmSolveDate2" value="${sheetMain.mainAlarmSolveDate}" />	
				    <c:choose>
					 ...
					 <input type="text" class="text" name="${sheetPageName}linkFaultAvoidTime" readonly="readonly" 
					 	id="${sheetPageName}linkFaultAvoidTime"  value="${eoms:date2String(sheetLink.linkFaultAvoidTime)}"  alt="vtype:'moreThen',link:'${sheetPageName}mainFaultGenerantTime',vtext:'故障消除时间晚于故障发生时间',allowBlank:false"/> 
					 <input type="button" class ="submit" value ="获取时间" onclick="getlinkFaultAvoidTime()" />
					  </c:when>
            		<c:otherwise>
				    <input type="text" class="text" name="${sheetPageName}linkFaultAvoidTime" readonly="readonly" 
						id="${sheetPageName}linkFaultAvoidTime"  
						onclick="popUpCalendar(this, this, null, null, null, true, -1)"  value="<%=newdate %>" alt="vtype:'moreThen',link:'${sheetPageName}mainFaultGenerantTime',vtext:'故障消除时间晚于故障发生时间',allowBlank:false"/> 
					</c:otherwise>
           			</c:choose> 
						<input type="hidden" name="${sheetPageName}mainFaultGenerantTime" id="${sheetPageName}mainFaultGenerantTime" value="${sheetMain.mainFaultGenerantTime}" />
				  		...
				  		<input type="hidden" id="${sheetPageName}mainAlarmSolveDateType" name="${sheetPageName}mainAlarmSolveDateType"  value="101030801">
				  		</div>
						<input type="hidden" id="mainAlarmSolveDate1" name="mainAlarmSolveDate1"  value="${sheetMain.mainAlarmSolveDate }">
					</td>
				  ...
				  <td id="ifrequired" colspan="3">
				    <input type="text" class="text" name="${sheetPageName}linkOperRenewTime" readonly="readonly" 
						...
						onclick="popUpCalendar(this, this,null,null,null,true,-1)" value="${eoms:date2String(sheetLink.linkOperRenewTime)}" alt="vtype:'moreThen',link:'${sheetPageName}faultdealTime',vtext:'故障处理时间晚于告警恢复时间', allowBlank:true"/> 
				  </td>	
				</tr>
...
<%} %>
		...
		<!-- 跨地市驳回 -->	
			...
			<tr>
				  ...
				  <td colspan="3">
				  	   <eoms:comboBox name="linkIsPass"
				  	      id="linkIsPass" initDicId="1010112" 
				  	      defaultValue="${sheetLink.linkIsPass}" alt="allowBlank:false" onchange="changeDiv(this)"/>	
				  </td>  
			</tr>
			...
			<tbody id="changeee" style="display:none">
				<tr>
	             	...
	             	<td colspan="3">
	    				<textarea class="textarea max" name="linkT1NoRes" id="linkT1NoRes" 
	    				alt="allowBlank:false,width:500,maxLength:1000,vtext:'最多输入500汉字'" alt="width:'500px'">${sheetLink.linkT1NoRes}</textarea>
					</td>		
		   		</tr>
			</tbody>
		...
		<%if(!operateType.equals("19")&&!operateType.equals("4")&&!operateType.equals("61") && !operateType.equals("8") && !operateType.equals("102")){%>	
	...
	<fieldset id="link4">
		...
		<c:choose>
			<c:when test="${centerMonitor=='true'}">
				 ...
				 <!-- start2 -->
				 <c:choose>
				 	<c:when test="${subroleidjkgd == '' || empty subroleidjkgd }">
				 		<!-- start1 -->
				 		<c:choose>
							<c:when test="${firstsubroleid=='' || empty firstsubroleid}">
			  					<c:if test="${(ccsubroleid=='' || empty ccsubroleid) && (tietasubroleid ==''|| empty tietasubroleid)}">
									<eoms:chooser id="commonfaultSendRole" type="role" roleId="8005106" flowId="51" config="{returnJSON:true,showLeader:true}"
				 	...
				 	<c:otherwise>
				 			<eoms:chooser id="commonfaultSendRole" type="role" roleId="8005106" flowId="51" config="{returnJSON:true,showLeader:true}"
			           			category="[{id:'${sheetPageName}dealPerformer',text:'代维',vtext:'请选择派发对象'},{id:'${sheetPageName}copyPerformer',childType:'user,subrole',limit:'none',text:'抄送'}]" 
			             		data="[{id:'${subroleidjkgd}',nodeType:'subrole',categoryId:'dealPerformer'}]" />	
				 	</c:otherwise>
				 </c:choose>
				 <!-- end2 -->
			</c:when>
  		...
  		<c:when test="${centerMonitor=='true'}">  	
			...
			<div id="test">
					<div class="viewer-list" id="test-chooser-show">
						...
						<input type="hidden" name="dealPerformerLeader" id="ext-gen187" value="8aa0813b1c6f2386011c6f39c8350027">
				</div>
				</fieldset>		
			</c:when>
	</c:choose>	
	<c:if test="${(citySubrole == '0' && sheetMain.mainNetSortOne == '101010401') || sheetMain.mainNetSortOne != '101010401'}">
		<!-- 需要只能选择该地市及该地市一下的班组 -->
		<fieldset>
 			<legend>
		 		<span id="roleName">
    		...
    		<html:button styleClass="btn" property="method.save" styleId="method.save" onclick="seleBanz()">
	        		请选择班组
	    	</html:button>
			<input name="linkCiytSubrole" id="dealPerformer1" value="" type="hidden"/>
			<span id="subRoleName"></span>
			<input name="mainIsOtherFlag" id="mainIsOtherFlag" value="" type="hidden" alt="allowBlank:false,vtext:'未匹配到T2对象'" />
			
			<input name="linkSendRes" id="linkSendRes" value="" type="hidden"/>
			<input name="linkSendOtherName" id="linkSendOtherName" value="" type="hidden"/>
			<input name="linkSendOtherTel" id="linkSendOtherTel" value="" type="hidden"/>
			
			<input name="mainOtherSubrole" id="mainOtherSubrole" value="" type="hidden"/>
			<input name="mainThisSubrole" id="mainThisSubrole" value="" type="hidden"/>
			<input name="mainIsOther" id="mainIsOther" value="" type="hidden"/>
				...
				<fieldset >
				 <legend>
						...
						<span id="roleName"></span>		 
							...
							<eoms:chooser id="test"  type="role" roleId="8005106" flowId="51" ifSpecial="${preDeptId}" config="{returnJSON:true,showLeader:true}"
