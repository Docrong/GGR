...
<div id="sheetform">
    <html:form action="/itsoftchange.do?method=performCreateSubTask" styleId="theform">
      	...
      	<tr>        
	       <td class="label">
			...
			<td colspan="3">			
		        ...
		        alt="allowBlank:false,width:500,maxLength:255,vtext:'请最多输入125个字'">${sheetLink.remark}</textarea>
