        ...
        <logic:iterate id="baselink" name="HISTORY" type="com.boco.eoms.sheet.plannconfirm.model.PlannConfirmLink">
            ...
            <div class="history-item">&nbsp;
                ...
                <div class="history-item-title">
                    ...
                    <eoms:dict key="dict-sheet-plannconfirm" dictId="activeTemplateId"
                               itemId="${baselink.activeTemplateId}" beanId="id2descriptionXML"/>
                    <bean:message bundle="plannconfirm" key="plannconfirm.operateType"/>:
                    <eoms:dict key="dict-sheet-plannconfirm" dictId="mainOperateType" itemId="${baselink.operateType}"
                    ...
                    <table class="formTable" width="100%" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td class="content">
                                ...
                                <pre><eoms:id2nameDB id="${baselink.validationResult}"
                        ...
                        <tr>
                            ...
                            <td class="content">
                                ...
                                <pre><eoms:id2nameDB id="${baselink.groupDiscussion}"
                                                     beanId="ItawSystemDictTypeDao"/></pre>
                        ...
                        <tr>
                            ...
                            <td class="content">
                                ...
                                <pre><eoms:id2nameDB id="${baselink.supplementScheme}"
                                                     beanId="ItawSystemDictTypeDao"/></pre>
