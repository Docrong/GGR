...
<div id="sheetform">
    <html:form action="/algorithm.do?method=performBatchDeal" styleId="theform">
            ...
            <div id="sheetinfo">
                <logic:present name="sheetMain" scope="request">
                    ...
                    <table class="formTable">
                        ...
                        <tr>
                            <td class="label"><bean:message bundle="algorithm" key="algorithm.mainNetSort1"/></td>
                            <td class="content">
                                <eoms:id2nameDB id="${sheetMain.mainNetSort1}" beanId="ItawSystemDictTypeDao"/>
                            </td>
                            <td class="label"><bean:message bundle="algorithm" key="algorithm.mainNetSort2"/></td>
                            <td class="content">
                        ...
                        <tr>
                            <td class="label"><bean:message bundle="algorithm" key="algorithm.mainNetSort3"/></td>
                            <td class="content">
                                <eoms:id2nameDB id="${sheetMain.mainNetSort3}" beanId="ItawSystemDictTypeDao"/>
                            </td>
                            <td class="label"><bean:message bundle="algorithm" key="algorithm.mainTaskType"/></td>
                            <td class="content">
                        ...
                        <tr>
                            <td class="label"><bean:message bundle="algorithm"
                                                            key="algorithm.mainTaskDescription"/></td>
        ...
        <div id="sheetinfo">
            <table class="formTable">
                ...
                <tr>
                    ...
                    <td class="content">
                        <select id="dealSelector" onchange="checkValue(this)" alt="allowBlank:false,vtext:'请选择处理操作'">
                            <option value=""></option>
                            <option value="Receive"><bean:message bundle="algorithm"
                                                                  key="algorithm.dealrejectpass"/></option>
                            <option value="EvaluationTask"><bean:message bundle="algorithm"
                                                                         key="algorithm.nopassback"/></option>
                        </select>
                    </td>
                    <td class="label"></td>
                    <td class="content">
                        ...
                        <input type="hidden" name="beanId" value="iAlgorithmMainManager"/>
                ...
                <tr>
                    <td class="label"><bean:message bundle="algorithm" key="algorithm.advice"/>*</td>
                    <td colspan="3">
