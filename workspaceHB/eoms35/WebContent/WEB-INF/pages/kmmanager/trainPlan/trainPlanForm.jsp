    ...
    <fmt:bundle basename="com/boco/eoms/km/config/applicationResource-kmmanager">
        ...
        <table class="formTable">
            ...
            <tr>
                ...
                <td class="content" colspan="3">
                    <html:text property="trainName" styleId="trainName"
                               styleClass="text max"
                               alt="allowBlank:false,vtext:''trainPlans,maxLength:32"
                               value="${trainPlanForm.trainName}"/>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="content">
                    <html:text property="trainTime" styleId="trainTime"
                               styleClass="text"
                               alt="allowBlank:false,vtext:'',vtype:'number',maxLength:10"
                               value="${trainPlanForm.trainTime}"/>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="content">
                    <input type="text" id="specialityName" name="specialityName" class="text"
                           value='<eoms:id2nameDB id="${trainPlanForm.trainSpeciality}" beanId="trainSpecialtyDao" />'
                           alt="allowBlank:false'" readonly="true"/>
                    <input type="hidden" id=trainSpeciality name="trainSpeciality"
                           value="${trainPlanForm.trainSpeciality}"/>
                </td>
                ...
                <td class="content">
                    <input type="text" id="trainRequireNoName" class="text" onclick="opentest()" name="trainRequireNo"
                           value="${trainPlanForm.trainRequireNo}" readonly="true"/>
                </td>
            ...
            <tr>
                ...
                <td class="content" colspan="3">
                    <eoms:attachment name="trainPlanForm" property="fileName" scope="request" idField="fileName"
                                     appCode="kmmanager"/>
                </td>
            </tr>
        </table>
