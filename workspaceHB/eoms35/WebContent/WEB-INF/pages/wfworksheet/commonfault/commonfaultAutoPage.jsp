    ...
    <table class="formTable">
        ...
        <logic:equal name="ruleType" value="autoHold">
            <tr>
                ...
                <td>
                    <textarea class="textarea max" name="commonFaultDesc"
                              id="commonFaultDesc">${commonfaultAuto.commonFaultDesc}</textarea>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <eoms:comboBox name="equipmentName" id="equipmentName" initDicId="1010103"
                                   defaultValue="${commonfaultAuto.equipmentName}"/>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="text" name="alarmType" id="alarmType"
                           value="${commonfaultAuto.alarmType}"/>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <eoms:comboBox name="netSortTwo" id="netSortTwo"
                                   sub="netSortThree" initDicId="${commonfaultAuto.netSortOne}"
                                   defaultValue="${commonfaultAuto.netSortTwo}"/>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <eoms:comboBox name="netSortThree" id="netSortThree"
                                   initDicId="${commonfaultAuto.netSortTwo}"
                                   defaultValue="${commonfaultAuto.netSortThree}"/>
                </td>
            </tr>
            <tr>
                <td class="label">告警标题</td>
                <td>
                    <textarea class="textarea max" name="alarmTitle"
                              id="alarmTitle">${commonfaultAuto.alarmTitle}</textarea>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <eoms:comboBox name="linkFaultReasonSubsection" id="linkFaultReasonSubsection"
                                   initDicId="${commonfaultAuto.linkFaultReasonSort}"
                                   sub="linkFaultReasonSubsectionTwo"
                                   defaultValue="${commonfaultAuto.linkFaultReasonSubsection}"/>
                </td>
            </tr>
            <tr>
                <td class="label">故障原因分类</td>
                <td>
                    <eoms:comboBox name="linkFaultReasonSubsectionTwo" id="linkFaultReasonSubsectionTwo"
                                   initDicId="${commonfaultAuto.linkFaultReasonSubsection}"
