...
<html:form action="/kmAskQuestions.do?method=searchX" styleId="kmAskQuestionForm1" method="post">
    <table align="center">
        <tr>
            ...
            <td>
                <input type="text" style="WIDTH: 250px" id="name" name="name" class="text" maxlength="50"
    ...
    <fmt:bundle basename="com/boco/eoms/km/config/applicationResource-kmmanager">
        ...
        <display:table name="kmAskQuestionList" cellspacing="0" cellpadding="0"
            ...
            <display:column property="name" sortable="true"
                            ...
                            href="${app}/kmmanager/kmAskQuestions.do?method=edit" paramId="id" paramProperty="id"/>
            ...
            <display:column property="answerCount" sortable="true"
                            headerClass="sortable" titleKey="kmAskQuestion.answerCount" paramId="id"
                            paramProperty="id"/>
        ...
        <fmt:bundle basename="com/boco/eoms/km/config/applicationResource-kmmanager">
			...
			<textarea name="question" id="question"
                ...
                <tr>
                    ...
                    <td class="content">
                        <input type="text" id="specialityName" name="specialityName" class="text max"
