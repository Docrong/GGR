...
public class TawwpMonthMgrImpl implements ITawwpMonthMgr {
    ...
    /**
     * @param tawwpMonthCheckDao the tawwpMonthCheckDao to set
     */
     ...
     * @param _monthFlag   String 计划所属月度
     ...
     * @param _netIdList   String 网元编号字符串(以“,”分隔)
     ...
     *
     * @param _tawwpYearPlan  年度作业计划对象
     * @param _tawwpMonthPlan 月度作业计划对象
     ...
     * 根据年、月份获得该月度作业计划执行内容应执行的日期表示字符串(0,1形式)
     *
     * @param _yearFlag  String 执行年份
     * @param _monthFlag String 执行月份
     * @param _cycle     String 执行周期
     ...
     * 判断指定执行内容是否应该在指定月度执行
     *
     * @param _monthOfPlan    String 月度作业计划月份
     * @param _monthOfExecute String 年度作业计划执行内容执行月份序数(周期大于月)
     * @param _cycle          String 执行内容周期
     ...
     *
     * @param _checkDeptId String 审批人所在部门
...
//				Collections.sort(monthCheckVOList);
     ...
     * @param _tawwpYearExecute TawwpYearExecute 年度作业计划执行内容对象
    ...
    /**
     * @param tawwpMonthExecuteDao the tawwpMonthExecuteDao to set
     */
     ...
     * 业务逻辑:月度作业计划审批(通过)(AUDITING-MONTHLY-PLAN-002)
     *
     * @param _monthCheckIdStr  String 审批信息编号字符串
     * @param _content          String 审批信息
     * @param _currentCheckUser String 审批人
     * @throws Exception 异常
     */
