...
<form method="post" id="theform" action="bureaudataCityzone.do?method=edit">
    <table class="formTable">
        ...
        <tr>
            ...
            <td class="content">
                <input type="text" name="cityname" id=cityname ${type == 'open' ? 'disabled="disabled"': ''}
                       value="${TawBureaudataCityzone.cityname}"/>
            </td>
        </tr>
        <!-- T1受理对象 -->
        <tr>
            ...
            <td class="content">
                <input type="text" name="zonenum" id=zonenum ${type == 'open' ? 'disabled="disabled"': ''}
                       value="${TawBureaudataCityzone.zonenum}"/>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <input type="text" name="userid" id=userid ${type == 'open' ? 'disabled="disabled"': ''}
                       value="${TawBureaudataCityzone.userid}"/>
            </td>
        </tr>
        <logic:notEqual name="type" value="open">
            <tr>
