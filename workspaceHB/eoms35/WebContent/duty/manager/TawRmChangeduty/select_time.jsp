...
<td>
<eoms:SelectDate name="time_from" formName="tawRmChangedutyForm" flag = "1" value = "<%=str_start%>"/>
</td>
</tr>
...
<td>
<eoms:SelectDate name="time_to" formName="tawRmChangedutyForm" flag = "1" value = "<%=str_start%>"/>
</td>
</tr>
</table>
</td>
