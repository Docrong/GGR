...
<div id="sheetform">
    <html:form action="../commonfault/commonfaultpack.do?method=performDeal" styleId="theform">
        ...
        <div class="form-btns" id="btns">
            ada<input type="submit" class="submit"
                      onclick="v.passing=true;this.form.action='${app}/sheet/commonfault/commonfaultpack.do?method=performDeal'"
                      value="<bean:message bundle='sheet' key='button.save'/>"/>
            <input type="submit" class="submit"
                   onclick="v.passing=true;this.form.action='${app}/sheet/commonfault/commonfaultpack.do?method=showListsendundo'"
