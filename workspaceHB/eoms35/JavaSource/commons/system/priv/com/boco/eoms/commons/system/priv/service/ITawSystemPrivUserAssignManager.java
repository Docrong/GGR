...
public interface ITawSystemPrivUserAssignManager extends Manager {
     ...
     *
     * @param id the tawSystemPrivUserAssign's id
     ...
     *
     * @param tawSystemPrivUserAssign the object to be saved
     */
     ...
     * 对某组织分配菜单方案
     *
     * @param TawSystemPrivAssign 菜单方案赋权相关信息
     * @throws AuthorizationException 赋权出错抛出异常
     */
     ...
     *
     * @param menuId 菜单方案
     * @param orgId  组织id，人员，部门，角色
     * @param type   角色类型 人员，部门，角色
     * @return
     */
