...
/**
 * @hibernate.class table="TAW_WP_MODELGROUP"
 */
...
public class TawwpModelGroup
    ...
    /**
     * @hibernate.many-to-one column="PARENT_MODEL_GROUP_ID"
     * cascade="none"
     * not-null="false"
     */
     ...
     * @hibernate.collection-key column="PARENT_MODEL_GROUP_ID"
     ...
     * lazy="true"
     * cascade="all-delete-orphan"
     * @hibernate.collection-key column="MODEL_GROUP_ID"
