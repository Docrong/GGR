...
<fmt:bundle basename="com/boco/eoms/km/config/applicationResource-kmmanager">
    ...
    <display:table name="trainRecordList" cellspacing="0" cellpadding="0"
        ...
        <display:column property="trainCount" sortable="true"
                        headerClass="sortable" titleKey="trainSpecialityStatistic.trainCount" paramId="id"
                        paramProperty="id"/>

        <display:column property="timeCount" sortable="true"
                        headerClass="sortable" titleKey="trainSpecialityStatistic.timeCount" paramId="id"
                        paramProperty="id"/>
