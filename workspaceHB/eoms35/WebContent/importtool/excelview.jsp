    ...
    <table border="0" width="95%" cellspacing="1" bgcolor="#709ED5"
        ...
        <tr>
            <td width="48%" height="62" align="center">
                <table border="0" width="95%" cellspacing="1" bgcolor="#709ED5"
                    ...
                    <tr>
                        <td height="25">
                            <div align="center"><font size="4"><b> Excel �������ݲ�ѯ </b></font></div>
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            <td width="48%" align="center">
                <table border=4 cellpadding=0 cellspacing=40 width="80%" bgcolor="#709ED5"
                       style="border-right-style: solid; border-right-color: #d3d3d3; border-bottom-style: solid; border-bottom-color: #d3d3d3">
                    <tbody>
                    <tr>
                        <td>
                            <table cellpadding=2 cellspacing=6 width="100%" border=1 bgcolor="#709ED5"
                                   style="border-right-style: solid; border-right-color: #d3d3d3; border-bottom-style: solid; border-bottom-color: #d3d3d3">
                                <tbody>
                                <tr>
                                    <td height=35 width="34%" bgcolor="#ffe2a6">
                                        <div align=right>EXCEL �����ƣ�</div>
                                    </td>
