    ...
    <table class="formTable">
        <tr>
            ...
            <td width="100%" colspan="3">
                ...
                <input type="text" name="creatTimeStartDate"
                ...
                <input type="text" name="creatTimeEndDate" id="creatTimeEndDate"
        ...
        <tr>
            ...
            <td width="100%" colspan="3">
                ...
                <input type="hidden" id="completeLimitStartDateExpression" name="completeLimitStartDateExpression"
                       value=""/>
                <input type="text" name="completeLimitStartDate"
                       onclick="popUpCalendar(this, this, null, null, null, true, -1)" readonly="true" class="text"/>
                ...
                <input type="text" name="completeLimitEndDate" id="completeLimitEndDate"
                       onclick="popUpCalendar(this, this,null,null,null,true,-1)" alt="" readonly="true" class="text"/>
            </td>
        </tr>
        <tr>
            ...
            <td width="100%" colspan="3">
                ...
                <input type="text" name="changeTimeStartDate"
                       onclick="popUpCalendar(this, this, null, null, null, true, -1)" readonly="true" class="text"/>
                ...
                <input type="text" name="changeTimeEndDate" id="changeTimeEndDate"
                       onclick="popUpCalendar(this, this,null,null,null,true,-1)" alt="" readonly="true" class="text"/>
            </td>
        </tr>
        <tr>
            ...
            <td width="100%" colspan="3">
                ...
                <input type="text" name="endTimeStartDate"
                       onclick="popUpCalendar(this, this, null, null, null, true, -1)" readonly="true" class="text"/>
                ...
                <input type="text" name="endTimeEndDate" id="endTimeEndDate"
                       onclick="popUpCalendar(this, this,null,null,null,true,-1)" alt="" readonly="true" class="text"/>
            </td>
        </tr>
        <tr>
            ...
            <td width="100%" colspan="3">
                ...
                <input type="text" name="cancelTimeStartDate"
                       onclick="popUpCalendar(this, this, null, null, null, true, -1)" readonly="true" class="text"/>
                ...
                <input type="text" name="cancelTimeEndDate" id="cancelTimeEndDate"
                       onclick="popUpCalendar(this, this,null,null,null,true,-1)" alt="" readonly="true" class="text"/>
            </td>
        </tr>
    </table>
    ...
    <table class="formTable">
        ...
        <tr>
            ...
            <td class="content">
                ...
                <eoms:comboBox name="orderBuisnessTypeChoiceExpression" id="orderBuisnessTypeChoiceExpression"
                               initDicId="1012301"/>
            </td>
            <td class="label">紧急程度:</td>
            <td class="content">
                <input type="hidden" name="ordersheet.urgentDegree" id="urgentDegree" class="text"/>
                <eoms:comboBox name="urgentDegreeChoiceExpression" id="urgentDegreeChoiceExpression"
                               initDicId="1010102"/>
            </td>
        </tr>
    </table>
