...
<%
request.setAttribute("roleId","6000"); 
long localTimes=com.boco.eoms.base.util.StaticMethod.getLocalTime().getTime();
String orderId = UUIDHexGenerator.getInstance().getID();
%>
<%@ include file="/WEB-INF/pages/wfworksheet/businessimplementsms/baseinputmainhtmlnew.jsp"%>
	<input type="hidden" name="${sheetPageName}processTemplateName" value="BusinessImplementSmsProcess" />
	<input type="hidden" name="${sheetPageName}sheetTemplateName" value="BusinessImplementSmsProcess" />
...
<table class="formTable">
	           ...
	           <td><eoms:comboBox   name="${sheetPageName}mainArgument" id="${sheetPageName}mainArgument"  initDicId="1012108" styleClass="select-class" alt="allowBlank:false" defaultValue="${sheetMain.mainArgument}" />
	           </td>
	        </tr>	
	        <tr>
		     <td class="label">要求完成时间</td>
		     <td class="content" colspan=3>
		      <input type="text" class="text" name="${sheetPageName}mainCompleteLimitTime" readonly="readonly" 
					id="${sheetPageName}mainCompleteLimitTime" value="${eoms:date2String(sheetMain.mainCompleteLimitTime)}" 
					onclick="popUpCalendar(this, this)" alt="allowBlank:false"/> 	
		     </td>
...
<tr></tr>		          		         			         	         		         		                   		          		             
	...
	<fieldset id="link1">
	 <legend>
			 ...
			 <span id="roleName">:申请审核人：
			 </span>
	      </legend>
	        <div class="x-form-item" >
			<eoms:chooser id="test1"  type="role" roleId="6001" flowId="333" config="{returnJSON:true,showLeader:true}"
...
refreshFrame();
	...
	function refreshFrame(){
		...
		if(obj.style.display=="none")
	 	...
	 	obj.src = "${app}/businessupport/order/ordersheets.do?method=getSpecialLinesByType&orderId=<%=orderId%>&specialtyType="+mainSpecifyType+"&sheetType=businessImplementsms&taskName=${taskName}&taskStatus=${taskStatus}"; 
