                        ...
                        <tr align="center" valign="middle">
                            ...
                            <td width="45%" valign="top" class="tr_show">
                                <table cellpadding="1" cellspacing="1" border="0" width="800" class="listTable">
                                    ...
                                    <tr class="tr_show">
                                        <td>
                                            <input type="checkbox" name="radio_to"
                                                   value="<%="to,"+String.valueOf(getWorkserial_to.elementAt(i))+","+String.valueOf(getDutyman_to.elementAt(i))+","+String.valueOf(getStarttime_to.elementAt(i))%>"
                                                   onclick="javascript:add_to(this)" ;>
                                        </td>
                                        <td>
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" width="700" class="listTable">
                        ...
                        <tr>
                            <td height="32" align="left">
                                <input type="button" value='<bean:message key="TawRmChangeduty.apply"/>'
                                       onclick="return checkform();" class="button">
                            </td>
                        </tr>
                        <%} else {%>
