        ...
        <logic:iterate id="baselink" name="HISTORY" type="com.boco.eoms.sheet.mofficedata.model.MofficeDataLink">
            ...
            <div class="history-item">&nbsp;
                ...
                <div class="history-item-title">
                    ...
                    <eoms:dict key="dict-sheet-mofficedata" dictId="mainOperateType" itemId="${baselink.operateType}"
                    ...
                    <table class="formTable" width="100%" cellpadding="0" cellspacing="0">
                        ...
                        <tr class="history-item-title">
                            ...
                            <td colspan="3">
                                ...
                                <pre><eoms:id2nameDB id="${baselink.linkIsNeedTest}"
                        ...
                        <tr>
                            ...
                            <td class="content">
                                <pre><eoms:id2nameDB id="${baselink.linkStyle2}"
                                                     beanId="IMofficeDataBuisTypeDAO"/></pre>
                            </td>
                        </tr>
                        <%
