      ...
      <div class="history-item"><!-- add space to hack ie-->&nbsp;
       <div class="history-item-title">
         ...
         <bean:write name="baselink" property="operateTime" formatKey="date.formatDateTimeAll" bundle="sheet" scope="page"/>&nbsp; 
  	    ...
  	    <eoms:dict key="dict-sheet-securitydeal" dictId="activeTemplateId" itemId="${baselink.activeTemplateId}" beanId="id2descriptionXML" />
  	     <bean:message bundle="securitydeal" key="securitydeal.operateType"/>:
  	     <eoms:dict key="dict-sheet-securitydeal" dictId="mainOperateType" itemId="${baselink.operateType}" beanId="id2descriptionXML" />
  		 ...
  		 <table class="history-item-table" width="100%" cellpadding="0" cellspacing="0">
	           ...
	           <tr>
		            <td  class="column-title">
    				  ...
    				  <pre><bean:write name="baselink" property="linkSecurityInproveAdvice" scope="page"/></pre>
                    </td>
		       </tr>
		       <tr>
		            <td  class="column-title">
