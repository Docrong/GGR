...
<c:if test="${findForward != null && findForward == 'list'}">
    <jsp:include page="/WEB-INF/pages/wfworksheet/businessimplement/listsendUndoJS.jsp"/>
</c:if>
<%} %>
...
<display:table name="taskList" cellspacing="0" cellpadding="0"
               ...
               export="true" requestURI="businessimplement.do"
               sort="list" size="total" partialList="true"
               decorator="com.boco.eoms.sheet.businessimplement.webapp.action.ProcessListCommonDisplaytagDecoratorHelper">
