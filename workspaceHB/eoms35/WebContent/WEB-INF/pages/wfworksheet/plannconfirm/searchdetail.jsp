...
<display:table name="taskList" cellspacing="0" cellpadding="0"
    ...
    <display:column sortable="true" headerClass="sortable" title="操作人部门" paramId="sendDeptId"
                    paramProperty="sendDeptId">
    ...
    <display:column sortable="true" headerClass="sortable" title="网络分类二级类别" paramId="networkTypeTwo"
                    paramProperty="networkTypeTwo">
    ...
    <display:column sortable="true" headerClass="sortable" title="经纬度符合要求" paramId="requirement"
                    paramProperty="requirement">
        <eoms:id2nameDB id="${taskList.requirement}" beanId="ItawSystemDictTypeDao"/>
    </display:column>

    <display:column sortable="true" headerClass="sortable" title="挂高符合要求" paramId="highRequirement"
                    paramProperty="highRequirement">
        <eoms:id2nameDB id="${taskList.highRequirement}" beanId="ItawSystemDictTypeDao"/>
    </display:column>

    <display:column sortable="true" headerClass="sortable" title="存在阻挡" paramId="existenceBarrier"
                    paramProperty="existenceBarrier">
    ...
    <display:column sortable="true" headerClass="sortable" title="确认结果" paramId="validationResult"
                    paramProperty="validationResult">
    ...
    <display:column sortable="true" headerClass="sortable" title="协调组讨论" paramId="groupDiscussion"
                    paramProperty="groupDiscussion">
