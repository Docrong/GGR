...
<tr>
  ...
  <c:if test="${empty taskName}">
      <input type="text" name="${sheetPageName}title" class="text max" id="${sheetPageName}title" 
		value="${commonfaultMain.title}${commontaskMain.title}${complaintMain.title}${sheetMain.title}" alt="allowBlank:false,vtext:'<bean:message bundle="sheet" key="mainForm.titleCheck"/>'"/>
  </c:if>
  </td>
</tr>
