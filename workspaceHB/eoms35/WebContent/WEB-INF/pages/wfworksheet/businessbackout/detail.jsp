...
<logic:equal value="101100101" name="sheetMain" property="btype1">
		          ...
		          <tr>
		            ...
		            <td  class="content" colspan="3"><pre><bean:write name="sheetMain" property="backoutCause"/></pre></textarea>
		            </td>
		          </tr>
</logic:equal>
...
<logic:equal value="101100103" name="sheetMain" property="btype1">
		   		<tr>
		   		 <td class="label"><bean:message bundle="businessbackout" key="businessbackout.urgentDegree"/></td>
		            <td colspan='3'><eoms:id2nameDB id="${sheetMain.urgentDegree}" beanId="ItawSystemDictTypeDao"/></td>
		   		</tr>
		   		<tr>
		            <td  class="label"><bean:message bundle="businessbackout" key="businessbackout.enterpriseCode"/></td>
		            <td><bean:write name="sheetMain" property="enterpriseCode"/></td>
	...
	<div class='sheet-deal-header'>
		...
		<%if(taskName.equals("TaskCreateAuditHumTask")){ %>	
			...
			<%if(taskStatus.equals(Constants.TASK_STATUS_READY)){%>
			 ...
			 <option value="${urlShowNewAuditPassPage}"><bean:message bundle="businessbackout" key="businessbackout.taskpass"/> </option>
			 <option value="${urlShowNewAuditUnpassPage}"><bean:message bundle="businessbackout" key="businessbackout.tasknopass"/></option>
           <%} %>
           </select>
		<%}else if(taskName.equals("TaskCompleteAuditHumTask")){%>	
			...
			<%if(taskStatus.equals(Constants.TASK_STATUS_READY)){%>
			    ...
			    <option value="${urlShowRejectBackPage}"><bean:message bundle="sheet" key="common.rejectBack"/></option>
			 <%}else if(taskStatus.equals(Constants.TASK_STATUS_CLAIMED)){ %>
			  <option value="${urlShowTaskCompleteAuditYes}"><bean:message bundle="businessbackout" key="businessbackout.TaskCompleteAuditYes"/></option>
			  <option value="${urlShowTaskCompleteAuditNo}"><bean:message bundle="businessbackout" key="businessbackout.TaskCompleteAuditNo"/></option>
			<%} %>
			</select>			
		<%}else if(taskName.equals("ExcuteHumTask")){%>	
			...
			<%if(taskStatus.equals(Constants.TASK_STATUS_READY)){%>
			 ...
			 <option value="${urlShowDispatchDealPage}"><bean:message bundle="sheet" key="common.dispatchType"/></option>
			  <option value="${urlShowCompleteDealPage}"><bean:message bundle="businessbackout" key="businessbackout.dealwcnosp"/></option>
			  <option value="${urlShowPassDealPage}"><bean:message bundle="businessbackout" key="businessbackout.totaskcompsq"/></option>
		...
		<%}else if(taskName.equals("AffirmHumTask")){%>	
			<select id="dealSelector">
			  <option value="${urlShowExamineNODealPage}"><bean:message bundle="businessbackout" key="businessbackout.dealrejectpass"/></option>
			  <option value="${urlShowExamineDealPage}"><bean:message bundle="businessbackout" key="businessbackout.nopassback"/></option>
			</select>
		<%}else if(taskName.equals("DraftHumTask")){%>	
			<select id="dealSelector">
			  <option value="${urlShowCompleteDraftPage}"><bean:message bundle="businessbackout" key="operateType.send"/></option>
			</select>
		<%}else if(taskName.equals("HoldHumTask")){ %>
			<select id="dealSelector">
			  <option value="${urlShowHoldDealPage}"><bean:message bundle="businessbackout" key="operateType.hold"/></option>
			</select>	
