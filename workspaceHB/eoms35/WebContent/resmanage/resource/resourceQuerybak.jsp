...
<table width='100%' bgcolor=#dddddd>
    <tr>
        <td align=center><font color=#000000 size=2><b>Àà±ðÁÐ±í</b></font></td>
    </tr>
    <tr>
        <td>
            <table width='100%' bgcolor=#eeeeee>
                ...
                <form name=resclass method=post action='typeSelect.jsp'>
                    <tr>
                        <td align=center>ÇëÑ¡ÔñÀàÐÍ£º</td>
                        <td align=center><select name=class onchange='ShowSelect(this.value)'>
                            <%
