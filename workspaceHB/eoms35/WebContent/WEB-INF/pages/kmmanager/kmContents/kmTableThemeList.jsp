...
<fmt:bundle basename="com/boco/eoms/km/config/applicationResource-kmmanager">>
    ...
    <display:table name="kmTableThemeList" cellspacing="0" cellpadding="0"
        ...
        <display:column property="id" sortable="true"
                        headerClass="sortable" titleKey="kmTableTheme.id"
                        href="${app}/kmTableTheme/kmTableThemes.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="createUser" sortable="true"
                        headerClass="sortable" titleKey="kmTableTheme.createUser"
                        href="${app}/kmTableTheme/kmTableThemes.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="createDept" sortable="true"
                        headerClass="sortable" titleKey="kmTableTheme.createDept"
                        href="${app}/kmTableTheme/kmTableThemes.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="createTime" sortable="true"
                        headerClass="sortable" titleKey="kmTableTheme.createTime"
                        href="${app}/kmTableTheme/kmTableThemes.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="themeName" sortable="true"
                        headerClass="sortable" titleKey="kmTableTheme.themeName"
                        href="${app}/kmTableTheme/kmTableThemes.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="parentId" sortable="true"
                        headerClass="sortable" titleKey="kmTableTheme.parentId"
                        href="${app}/kmTableTheme/kmTableThemes.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="isLeaf" sortable="true"
                        headerClass="sortable" titleKey="kmTableTheme.isLeaf"
                        href="${app}/kmTableTheme/kmTableThemes.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="isOpen" sortable="true"
                        headerClass="sortable" titleKey="kmTableTheme.isOpen"
                        href="${app}/kmTableTheme/kmTableThemes.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="isDeleted" sortable="true"
                        headerClass="sortable" titleKey="kmTableTheme.isDeleted"
                        href="${app}/kmTableTheme/kmTableThemes.do?method=edit" paramId="id" paramProperty="id"/>
