...
<%@ page
        import="com.boco.eoms.common.util.*,com.boco.eoms.common.controller.*, com.boco.eoms.common.dao.*,com.boco.eoms.jbzl.model.*,com.boco.eoms.jbzl.dao.*" %>
<html>
<head>
    <title>测试卡借出纪录查询页面</title>
...
<body>
<html:form method="post" action="/TawTestcardManager/searchdo" onsubmit="true">
    ...
    <table cellSpacing="0" borderColorDark="#ffffff" cellPadding="1" width="70%" borderColorLight="#808080" border="1"
           align="center">
        <tr>
            ...
            <td noWrap class="clsfth">&nbsp;&nbsp;借出分公司</td>
            <td width="380">
        ...
        <tr>
            <td nowrap="nowrap" class="clsfth">&nbsp;&nbsp;借用部门</td>
            <td width="380">
                <html:text styleClass="clstext" property="lenddept" size="20"/>
            </td>
            <td noWrap class="clsfth">&nbsp;&nbsp;借用人</td>
            <td width="380">
        ...
        <tr>
            ...
            <td width="380">
                <html:text property="leantime" styleClass="clstext" onfocus="setday(this)" readonly="true"/>
            </td>
            <td noWrap class="clsfth">
                &nbsp;&nbsp;借出时间到
            </td>
            <td width="380">
                <html:text property="belongtime" styleClass="clstext" onfocus="setday(this)" readonly="true"/>
            </td>
        </tr>
        <tr>
            <td colspan=4>
