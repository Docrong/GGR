...
<table class="formTable">
    ...
    <tr>
        ...
        <td>
            <input type="text" class="text" name="${sheetPageName}delayCase" id="${sheetPageName}delayCase"
                   value="${sheetLink.delayCase}" alt="allowBlank:false"/>
        </td>
        <td class="label">延期解决时间</td>
        <td>
            <input class="text" onclick="popUpCalendar(this, this)" type="text"
                   name="${sheetPageName}delayTime" readonly="readonly"
                   value="${eoms:date2String(sheetLink.delayTime)}" id="${sheetPageName}delayTime"
    ...
    <tr>
        ...
        <td>
            <input class="text" onclick="popUpCalendar(this, this)" type="text"
                   ...
                   value="${eoms:date2String(sheetLink.applyTime)}" id="${sheetPageName}applyTime"
                   alt="allowBlank:false"/>
        </td>
        ...
        <td>
            <input class="text" onclick="popUpCalendar(this, this)" type="text"
                   ...
                   value="${eoms:date2String(sheetLink.approveTime)}" id="${sheetPageName}approveTime"
                   alt="allowBlank:false"/>
        </td>
    </tr>
    <tr>
        ...
        <td>
            <input type="text" class="text" name="${sheetPageName}solveCond" id="${sheetPageName}solveCond"
                   value="${sheetLink.solveCond}" alt="allowBlank:false"/>
        </td>
        <td class="label">解决手段</td>
        <td>
            <input type="text" class="text" name="${sheetPageName}solveTool" id="${sheetPageName}solveTool"
                   value="${sheetLink.solveTool}" alt="allowBlank:false"/>
        </td>
    </tr>
    <tr>
        <td class="label">项目名称</td>
        <td>
            <input type="text" class="text" name="${sheetPageName}projectName" id="${sheetPageName}projectName"
                   value="${sheetLink.projectName}" alt="allowBlank:false"/>
        </td>
        <td class="label">审核结果</td>
        <td>
            <eoms:comboBox name="${sheetPageName}approveResult" id="${sheetPageName}approveResult" initDicId="1011702"
                           defaultValue="${sheetLink.approveResult}" alt="allowBlank:false"/>
        </td>
    </tr>
    <tr>
        <td class="label">
