...
<table class="formTable">
	 ...
	 <c:if test="${sheetMain.status==1}">
      <tr>
		    ...
		    <td colspan ='3'><bean:write name="sheetMain" property="endTime" formatKey="date.formatDateTimeAll" bundle="sheet" scope="request"/>
		    </td>
    </tr> 
     <tr>
       <td class="label"><bean:message bundle="sheet" key="mainForm.holdStatisfied"/></td>
	   <td colspan='3'><eoms:id2nameDB id="${sheetMain.holdStatisfied}" beanId="ItawSystemDictTypeDao"/></td>
     </tr>    
     <tr>		
        <td class="label"> <bean:message bundle="sheet" key="mainForm.endResult"/></td>
		    <td colspan='3'><pre><bean:write name="sheetMain" property="endResult" scope="request"/></pre></td>
     </tr>   
  </c:if>
