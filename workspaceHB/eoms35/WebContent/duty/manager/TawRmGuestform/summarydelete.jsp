...
<table border="0" width="95%" cellspacing="1" cellpadding="1" class="table_show" align=center>
    ...
    <logic:iterate id="tawRmGuestform" name="TAWRMGUESTFORMS" type="com.boco.eoms.duty.model.TawRmGuestform">
        ...
        <tr class="tr_show">
            ...
            <td align="center"><html:link href="viewdelete.do" paramId="id" paramName="tawRmGuestform"
                                          paramProperty="id"><img
                    src="<%=request.getContextPath()%>/images/bottom/an_sc.gif" border="0"></html:link>&nbsp;
            </td>
        </tr>
    </logic:iterate>
</table>
