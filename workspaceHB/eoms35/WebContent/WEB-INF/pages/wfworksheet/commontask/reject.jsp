...
function showPage(){
     var pars = '';
     var url = '';    
      url = '${app}/sheet/commontask/commontask.do?method=showInputRejectPage&piid=${sheetMain.piid}&taskId=${taskId}&taskName=${taskName}';
     if (url!=''){
...
<div id="sheetform">
<html:form action="/commontask.do?method=performDeal" styleId="theform">
