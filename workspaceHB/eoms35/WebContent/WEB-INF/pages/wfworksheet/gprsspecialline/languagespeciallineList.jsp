...
<html:form action="LanguageSpecialLines.do?method=xsearch" method="post" styleId="LanguageSpecialLineForm">
    ...
    <display:table name="LanguageSpecialLineList" cellspacing="0" cellpadding="0"
                   ...
                   export="true" requestURI="/businessupport/order/LanguageSpecialLines.do?method=showDetail"
                   sort="list">
    ...
    <tr class="buttonBar bottom">
        <input type="button" styleClass="button"
               onclick="location.href='<c:url
                       value="/businessupport/product/LanguageSpecialLines.do?method=xedit&type=add&ifReference=${ifReference}"/>'"
               value="添加"/>
        <logic:present name="back" scope="request">
            <input type="button" styleClass="button"
                   onclick="location.href='<c:url
                           value="/businessupport/product/LanguageSpecialLines.do?method=xquery&ifReference=${ifReference}"/>'"
                   value="返回"/>
        </logic:present>
    </tr>
</html:form>
