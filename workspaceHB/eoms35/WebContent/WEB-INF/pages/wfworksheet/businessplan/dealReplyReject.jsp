...
<div id="sheetform">
<html:form action="/businessplan.do?method=performDealReplyReject" styleId="theform">
 <%@ include file="/common/taglibs.jsp"%>
<%
 ...
 %>
    ...
    <input type="hidden" name="${sheetPageName}taskNamespace" value="http://BusinessPlanProcess"/>  
<%@ include file="/WEB-INF/pages/wfworksheet/businessplan/baseinputlinkhtmlnew.jsp"%>
     ...
     <tr>
      ...
      <logic:iterate id="toTask" name="acceptList" type="com.boco.eoms.sheet.businessplan.model.BusinessPlanTask">  
        <tr>
          <td>
