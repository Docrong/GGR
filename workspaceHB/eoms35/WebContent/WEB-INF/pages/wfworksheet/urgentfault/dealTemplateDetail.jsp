    ...
    <table class="listTable">
       ...
       <%if(taskName.equals("MiddleReportAffirmHumTask") || 
		...
		<%if(operateType.equals("913") || operateType.equals("923") || operateType.equals("933")){ %>
			...
			<tr>
			  ...
			  <td>
			  	<input type="text" class="text" name="${sheetPageName}linkGreatFaultId" id="${sheetPageName}linkGreatFaultId" value="${sheetLink.linkGreatFaultId}" alt="allowBlank:true" />
			  </td>			  
			</tr>		
			...
			<tr>
			  ...
			  <td colspan="3">
			  	<eoms:comboBox name="${sheetPageName}linkIfAffirm" id="${sheetPageName}linkIfAffirm" initDicId="1011608" defaultValue="${sheetLink.linkIfAffirm}"/>
			  </td>		  
			</tr>	
			...
			<%if(taskName.equals("SolveFaultAffirmHumTask")) {%>
				<tr>
				  ...
				  <td colspan="3">
			  		<textarea name="linkFaultAvoidReport" id="linkFaultAvoidReport" class="textarea max">${sheetLink.linkFaultAvoidReport}</textarea>			   
				  </td>
				</tr>	
			<%}else{ %>
				<tr>
				  ...
				  <td colspan="3">
			  		<textarea name="linkFaultReportDesc" id="linkFaultReportDesc" class="textarea max">${sheetLink.linkFaultReportDesc}</textarea>			   
				  </td>
				</tr>			
			<%} %>
     ...
     <%if(taskName.equals("SolveFaultHumTask")) {%>
		...
		<tr>
		  ...
		  <td>
		  	<input type="text" class="text" name="${sheetPageName}linkFaultGenerantPlace" id="${sheetPageName}linkFaultGenerantPlace" value="${sheetLink.linkFaultGenerantPlace}" alt="allowBlank:true"/>
		  </td>			  
		</tr>
		...
		<tr>
		  ...
		  <td colspan="3">
	  		<textarea name="linkAffectOperationDesc" id="linkAffectOperationDesc" class="textarea max">${sheetLink.linkAffectOperationDesc}</textarea>			   
		  </td>
		</tr>
