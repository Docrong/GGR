...
<input type="hidden" name="${sheetPageName}processTemplateName" value="ResourceConfirmMainFlowProcess"/>
...
<table class="formTable">
    ...
    <tr>
        <td class="label"><bean:message bundle="resourceconfirm" key="resourceconfirm.mainRemark"/>*</td>
        <td colspan="3" class="content">
    ...
    <tr>
        ...
        <td colspan="3">
            ...
            <eoms:attachment name="sheetMain" property="sheetAccessories"
                             scope="request" idField="${sheetPageName}sheetAccessories" appCode="resourceconfirm"/>
        </td>
    </tr>
</table>
