    ...
    <form method="post" action="../part/serialnoend.do" name="frm" onsubmit="return checkdata()">
        ...
        <table border="0" width="80%" cellspacing="1" cellpadding="1" class="table_show" align=center>
            ...
            <tr class="tr_show">
                ...
                <td width="70%" height="25" colspan="2">
                    <input type="text" size="35" value="<%=StaticMethod.nullObject2String(part.getSerialno())%>"
                           maxlength="50" name="serialno">
                    <a href="../../sparepart/charge/updateterm.do"
                       class="clsbtn2">&nbsp;&nbsp;&nbsp;&nbsp${eoms:a2u('查询')}
                    </a>
                </td>
            </tr>
        </table>
