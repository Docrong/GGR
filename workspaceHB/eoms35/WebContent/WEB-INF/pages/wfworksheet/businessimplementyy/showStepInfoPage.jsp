...
<div id="history" class="panel">
    ...
    <logic:present name="HISTORY" scope="request">
        <logic:iterate id="baselink" name="HISTORY"
                       type="com.boco.eoms.sheet.businessimplementyy.model.BusinessImplementYYLink">
            <%
                jNum += 1;
            ...
            <div class="history-item"><!-- add space to hack ie-->&nbsp;
                <div class="history-item-title">
                    ...
                    <eoms:dict key="dict-sheet-businessimplementyy" dictId="activeTemplateId"
                    ...
                    <eoms:dict key="dict-sheet-businessimplementyy" dictId="mainOperateType"
                ...
                <div class="history-item-content hide">
  			      ...
  			      <%} %> -->
                        ...
                        <tr>
                            <td class="column-title">
                                <bean:message bundle="businessimplementyy" key="businessimplementyy.linkAuditResult"/>
                            </td>
                        ...
                        <tr>
                            <td class="column-title">
                                <bean:message bundle="businessimplementyy" key="businessimplementyy.linkAuditIdea"/>
                            </td>
                            <td class="column-content" colspan="3">
                        ...
                        <tr>
                            <td class="label"><bean:message bundle="businessimplementyy"
                                                            key="businessimplementyy.linkTaskComplete"/></td>
                            <td class="column-content" colspan="3">
                        ...
                        <tr>
                            <td class="column-title">
                                <bean:message bundle="businessimplementyy" key="businessimplementyy.advice"/>
                            </td>
                            <td class="column-content" colspan=3>
                                <pre><bean:write name="baselink" property="linkTaskComplete" scope="page"/></pre>
                            </td>
