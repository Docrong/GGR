...
<%
 ...
 %>
	...
	<input type="hidden" name="mainClassName" value="com.boco.eoms.sheet.daiweiindexreduction.model.DaiWeiIndexReductionMain"/>	
	<input type="hidden" name="linkClassName" value="com.boco.eoms.sheet.daiweiindexreduction.model.DaiWeiIndexReductionLink"/>
...
<%@ include file="/WEB-INF/pages/wfworksheet/daiweiindexreduction/baseinputlinkhtmlnew.jsp"%>
     ...
     <tr>
      ...
      <logic:iterate id="toTask" name="acceptList" type="com.boco.eoms.sheet.daiweiindexreduction.model.DaiWeiIndexReductionTask">  
        <tr>
          <td>
