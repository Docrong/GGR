     ...
     { 
      ...
      http_request.onreadystatechange = function (){
          ...
          if (http_request.status == 200)  
           {  
             document.getElementById(id).innerHTML="<img src='010.gif'/>"; 
           }  
           else  
           {  
            
             document.getElementById(id).innerHTML="<img src='iconWarning.gif'/>"; 
           }  
...
<div id="tabs">
	...
	<div id="form" class="tab-content">
		...
		<table cellspacing="0" cellpadding="1" width="100%" border="0"
			...
			<tr class="tr_show">
			<td class="clsfth">
					<bean:message key='interfaceMonitoring.Test' />
				...
				<td class="clsfth">
					<bean:message key='interfaceMonitoring.State' />	
			...
			<logic:iterate id="InterfaceMonitoringList"
				...
				<tr class="tr_show">
				<td class="clsfth">
                  		<input type="radio" name="radio"  onclick="getr('${InterfaceMonitoringList.interfaceUrl}',<%=i%>)">
					</td>
					<td class="clsfth">
	...
	<div id="info">
		<table border="0" width="95%" cellspacing="1">
			...
			<logic:iterate id="LongitudinalList"
				...
				<tr class="tr_show">
				<td class="clsfth">
                  		<input type="radio" name="radio" value="${InterfaceMonitoringList.id}">
					</td>
					<td class="clsfth">
