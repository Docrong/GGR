...
<div id="tabs">
    <div id="form" class="tab-content">
        ...
        <table border="0" width="95%" cellspacing="1" cellpadding="1" class="table logList" align=center id="stable">
            ...
            <logic:iterate id="tawConMem" name="ALLMEMS" type="com.boco.eoms.commons.voiceMessage.model.TawConMem">
                <tr class="tr_show">
                    ...
                    <td width="25%" height="25"><img src="<%=request.getContextPath()%>/images/asc.gif" border="0"
                                                     onclick="addRow(this, 'stable', 'dtable')"></td>
        ...
        <html:form action="/TawHieApply/addmems" method="post"
            ...
            <table border="0" width="95%" cellspacing="1" cellpadding="1" class="table logList" align=center
                   id="dtable">
                <tr class="td_label">
