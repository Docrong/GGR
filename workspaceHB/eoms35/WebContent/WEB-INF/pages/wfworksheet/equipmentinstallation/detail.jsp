...
<%@page import="com.boco.eoms.sheet.equipmentinstallation.model.EquipmentInstallationTask" %>
...
<%
    ...
    EquipmentInstallationTask task = new EquipmentInstallationTask();
    String operaterType = "";
    String ifsub = "";
    String ifwaitfor = "";
    if (request.getAttribute("task") != null) {
        task = (EquipmentInstallationTask) request.getAttribute("task");
...
<script type="text/javascript">
    Ext.onReady(function () {
        var tabConfig = {
            items: [{
                ...
                url: 'equipmentinstallation.do?method=showSheetDealList&sheetKey=${sheetMain.id}&taskName=${taskName}&ifWaitForSubTask=${task.ifWaitForSubTask}'
            }, {
                text: '<bean:message bundle="sheet" key="sheet.flowchar"/>',
                url: 'equipmentinstallation.do?method=showWorkFlow&linkServiceName=iEquipmentInstallationLinkManager&dictSheetName=dict-sheet-equipmentinstallation&description=mainOperateType&sheetKey=${sheetMain.id}',
                isIframe: true
            }
                , {
                    text: '<bean:message bundle="sheet" key="sheet.filesView"/>',
                    url: 'equipmentinstallation.do?method=showSheetAccessoriesList&id=${sheetMain.id}',
                    isIframe: true
                }, {
        ...
        var url2 = "equipmentinstallation.do?method=newShowCCPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}&operateType=-10&taskStatus=${taskStatus}";
        eoms.util.appendPage("sheet-deal-content", url2);
        <%}%>
        <%if(taskName.equals("reply")){ %>
        var url2 = "equipmentinstallation.do?method=showRemarkPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}";
        eoms.util.appendPage("sheet-deal-content", url2);
        <%}%>
    ...
    function forceOperation(obj) {
        ...
        if (obj == 1) {
            ...
            var url2 = "equipmentinstallation.do?method=showForceHoldPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}&operateType=forceHold";
            eoms.util.appendPage("sheet-deal-content", url2);
        } else if (obj == 2) {

            var url2 = "equipmentinstallation.do?method=showForceHoldPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}&operateType=nullity";
            eoms.util.appendPage("sheet-deal-content", url2);
        } else {

            var url2 = "equipmentinstallation.do?method=showForceHoldPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}&operateType=forceNullity";
            eoms.util.appendPage("sheet-deal-content", url2);
        }
    }
    ...
    function eventOperation(obj) {
        if (obj == 1) {
            var url2 = "equipmentinstallation.do?method=showPhaseAdvicePage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&taskName=advice&operateFlag=driveForward&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}";
...
<div id="sheet-detail-page">
    ...
    <div id="sheetinfo">
        <logic:present name="sheetMain" scope="request">
            <%@ include file="/WEB-INF/pages/wfworksheet/equipmentinstallation/basedetailnew.jsp" %>
            <br/>
            <table id="sheet" class="formTable">
                ...
                <tr>
                    <td class="label">
                        <!-- 投诉工单号 -->
                        <bean:message bundle="equipmentinstallation"
                                      key="equipmentInstallationMain.mainComplaintSheetId"/>
                    </td>
                    <td>
                ...
                <tr>
                    <td class="label">
                        <!-- 投诉原因 -->
                        <bean:message bundle="equipmentinstallation"
                                      key="equipmentInstallationMain.mainComplaintReasons"/>
                    </td>
                    <td colspan="3">
                ...
                <tr>
                    <td class="label">
                        <!-- 典型场景 -->
                        <bean:message bundle="equipmentinstallation"
                                      key="equipmentInstallationMain.mainTypicalScenario"/>
                    </td>
                    <td>
                ...
                <tr>
                    <td class="label">
                        <!-- 设备是否收取服务费 -->
                        <bean:message bundle="equipmentinstallation"
                                      key="equipmentInstallationMain.mainIsEquipmentFee"/>
                    </td>
                    <td colspan="3">
                    ...
                    <tr>
                        ...
                        <td colspan='3'>
                            <eoms:attachment name="sheetMain" property="mainSignPhoto"
                                             scope="request" idField="mainSignPhoto" appCode="equipmentinstallation"
                                             viewFlag="Y"/>
                        </td>
                    </tr>
                </c:if>
	  ...
	  <tr>
		    ...
		    <eoms:attachment name="sheetMain" property="sheetAccessories" 
		            scope="request" idField="sheetAccessories" appCode="equipmentinstallation" 
		             viewFlag="Y"/> 
		    </td>
	  </tr>
	   -->
...
<!-- 下面是流程中的步骤URL -->
<!-- Audit -->
<c:url var="urlShowAudit101Page" value="equipmentinstallation.do">
...
<!-- 施工安装 -->
<c:url var="urlShowInstall102Page" value="equipmentinstallation.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 归档 -->
<c:url var="urlShowHoldTask18Page" value="equipmentinstallation.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 下面是公共的URL -->
<!-- 退回 -->
<c:url var="urlShowRejectDealPage" value="equipmentinstallation.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<c:url var="urlShowTransferkPage" value="equipmentinstallation.do">
...
<c:url var="urlShowPhaseReplyPage" value="equipmentinstallation.do">
...
<!--任务分派-->
<c:url var="urlShowInputSplit" value="equipmentinstallation.do">
    <c:param name="method" value="showInputSplit"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
    <c:param name="taskName" value="${taskName}"/>
    <c:param name="subtaskName" value="EquipmentInstallationSubTask"/>
    <c:param name="operateRoleId" value="${operateRoleId}"/>
    <c:param name="TKID" value="${TKID}"/>
...
<!-- 处理回复通过 -->
<c:url var="urlShowDealReplyAcceptPage" value="equipmentinstallation.do">
...
<!-- 处理回复不通过 -->
<c:url var="urlShowDealReplyRejectPage" value="equipmentinstallation.do">
...
<!-- 驳回上一级 -->
<c:url var="urlShowRejectBackPage" value="equipmentinstallation.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 确认受理 -->
<c:url var="urlShowAcceptDealPage" value="equipmentinstallation.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 被驳回 -->
<c:url var="urlBackDealPage" value="equipmentinstallation.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 草稿 -->
<c:url var="urlShowDraftPage" value="equipmentinstallation.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 分派回复 -->
<c:url var="urlShowDispatchPage" value="equipmentinstallation.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 会审 -->
<c:url var="urlShowInputSplitAudit" value="equipmentinstallation.do">
    <c:param name="method" value="showInputSplit"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 会审回复 -->
<c:url var="urlShowDispatchAuditPage" value="equipmentinstallation.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 转审 -->
<c:url var="urlShowTransferAuditPage" value="equipmentinstallation.do">
    <c:param name="method" value="showTransferWorkItemPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<script type="text/javascript">
    Ext.onReady(function () {
        ...
        if (dealTemplateId != null && dealTemplateId != "") {
            url = "equipmentinstallation.do?method=referenceTemplate&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&taskName=${taskName}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&operateType=${operateType}&taskStatus=${taskStatus}&dealTemplateId=" + dealTemplateId
        }
            ...
            <tr>
                <td width="50%">
                    ...
                    <select id="dealSelector">
                        ...
                        <!-- 流程步骤，移交，阶段回复，分派 -->
                        <option value="${urlShowAudit101Page}"><bean:message bundle="equipmentinstallation"
                        ...
                        <!-- 不需要等待回复 -->
                        <% if (ifwaitfor.equals("false")) {%>
                        <option value="${urlShowDispatchPage}"><bean:message bundle="equipmentinstallation"
                    ...
                    <select id="dealSelector">
                        ...
                        <% if (ifwaitfor.equals("false")) {%>
                        <!-- 流程步骤，移交，阶段回复，分派 -->
                        <option value="${urlShowInstall102Page}"><bean:message bundle="equipmentinstallation"
                                                                               key="operateType.Install102"/></option>
                    ...
                    <select id="dealSelector">
                        ...
                        <% if (ifwaitfor.equals("false")) {%>
                        <!-- 流程步骤，移交，阶段回复，分派 -->
                        <option value="${urlShowHoldTask18Page}"><bean:message bundle="equipmentinstallation"
                    ...
                    <select id="dealSelector">
                        <option value="${urlShowDraftPage}"><bean:message bundle="equipmentinstallation"
