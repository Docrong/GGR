    ...
    <html:form action="/TawInformation/save">
        ...
        <table border="0" width="90%" cellspacing="1" cellpadding="1" class="table_show" align=center>
            <tr class="tr_show">
                ...
                <td width="75%">
                    <html:text property="code" size="50" maxlength="80" styleClass="clstext"/><font
                        color="red">**</font>
                </td>
            </tr>
            <tr class="tr_show">
                ...
                <td width="75%">
                    <html:text property="name" size="20" maxlength="50" styleClass="clstext"/><font
                        color="red">**</font>
                </td>
            </tr>
            ...
            <tr class="tr_show">
                ...
                <td width="75%"><%=publicDeptName%> <%=publicerName%>
                </td>
            </tr>
            ...
            <tr class="tr_show">
                ...
                <td width="75%" align="left"><html:textarea property="content" rows="12" cols="80"
            ...
            <tr class="tr_show">
                ...
                <td align="right" colspan="2">
                    <input type="button" Class="clsbtn2" value="<bean:message key="label.save"/>"
        ...
        <table align="center" width="90%" cellspacing="1" border="0" cellpadding="1">
            <eoms:attachment name="tawInformationForm" property="attachName" scope="request" idField="attachName"
                             appCode="kbs"/>
        </table>
    </html:form>
