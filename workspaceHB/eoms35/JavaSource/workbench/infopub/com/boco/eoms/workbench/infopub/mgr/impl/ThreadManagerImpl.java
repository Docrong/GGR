...
public class ThreadManagerImpl extends BaseManager implements IThreadManager {
    ...
    /**
     * @param threadHistoryManager the threadHistoryManager to set
     */
    ...
    /**
     * @param threadAuditHistoryManager the threadAuditHistoryManager to set
     */
    ...
    /**
     * @param threadPermimissionOrgManager the threadPermimissionOrgManager to set
     */
