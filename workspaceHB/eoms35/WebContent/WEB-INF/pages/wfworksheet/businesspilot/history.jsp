        ...
        <logic:iterate id="baselink" name="HISTORY" type="com.boco.eoms.sheet.businesspilot.model.BusinessPilotLink">
            ...
            <div class="history-item"><!-- add space to hack ie-->&nbsp;
                <div class="history-item-title">
                    ...
                    <eoms:dict key="dict-sheet-businesspilot" dictId="activeTemplateId"
                               itemId="${baselink.activeTemplateId}" beanId="id2descriptionXML"/>
                    <bean:message bundle="businesspilot" key="businesspilot.operateType"/>:
                    <eoms:dict key="dict-sheet-businesspilot" dictId="mainOperateType" itemId="${baselink.operateType}"
                ...
                <div class="history-item-content hide">
  		       ...
  		       -->
                        ...
                        <tr>
                            ...
                            <td class="column-content">
                                <eoms:dict key="dict-sheet-businesspilot" dictId="mainOperateType"
                        ...
                        <c:if test="${empty baselink.linkTestResult}">
                            <c:if test="${baselink.operateType!=11 }">
                                <tr>
                                    ...
                                    <td class="column-title">
                                        <pre><bean:message bundle="businesspilot"
                                                           key="businesspilot.linkOperEndTime"/></pre>
                                    </td>
                                    <td class="column-content">
                        ...
                        <tr>
                            ...
                            <td class="content" colspan=3>
                                <eoms:attachment name="baselink" property="linkSummarizeAcc"
                                                 scope="page" idField="linkSummarizeAcc" appCode="businesspilot"
                                                 viewFlag="Y"/>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="column-content" colspan=3>
                                <bean:write name="baselink" property="linkSDEndTime" format="yyyy-MM-dd HH:mm:ss"
                                            scope="page"/>
                            </td>
                        </tr>
