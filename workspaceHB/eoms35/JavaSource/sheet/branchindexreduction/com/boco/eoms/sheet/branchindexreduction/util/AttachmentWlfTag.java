 ...
 *
 * @author 秦敏  修改 自定义标签上传解析 by mwd 20170508
 * @version 1.0
 */
public class AttachmentWlfTag extends BodyTagSupport {
        ...
        try {
            ...
            if (!viewFlag.equals("Y")) {
                html = "<iframe id=\"UIFrame1-" + idField +
                        ...
                        + "scrolling=\"auto\" src=\"" + path + "/accessories/branchindexreductionfiles/uploadWlf.jsp?appId=" + appCode + "&sheetFlag=" + sheetFlag
