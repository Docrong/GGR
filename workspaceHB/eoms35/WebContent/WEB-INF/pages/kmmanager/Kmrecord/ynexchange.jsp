...
<html:form method="post" action="/TawRmRecord/submit">
    ...
    <TABLE cellSpacing="0" cellPadding="0" width="600" borderColorLight="#709FD5" borderColorDark="#ffffff"
        ...
        <TR>
            ...
            <TD><input name="ReceiverPwd" id="ReceiverPwd" type="password" style="WIDTH: 153px; HEIGHT: 24px"
                       maxlength="25"/></TD>
        </TR>
        <%} else {%>
        <TR>
        ...
        <TR>
            ...
            <TD colSpan="3">
                ...
                <input name="receiver" id="receiver" type="text" style="BACKGROUND-COLOR: lightgrey" readOnly=""
                       size="58" value="<bean:write name="tawRmRecordForm" property="receiver" scope="request"/>"/>
            </TD>
        </TR>
