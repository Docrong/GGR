...
<c:set var="buttons">
    <input type="button" style="margin-right: 5px"
        onclick="location.href='<c:url value="/sheet/autodistribute/autodistribute.do?method=showInputPage&type=add"/>'"
...
<display:table name="autoList" cellspacing="0" cellpadding="0"
    ...
    export="true" requestURI="" sort="list" decorator="com.boco.eoms.sheet.autodistribute.webapp.action.AutoDistributeListDisplaytagDecoratorHelper">
