        ...
        <table border="0" width="75%" cellspacing="1" class="table_show" align="center">
            <tr class="tr_show">
                <td colspan="4" class="table_title" align="center">
                        ${eoms:a2u(所属专业：)}
                    <bean:write name="tawClassMsgForm" property="department" scope="request"/>
                        ${eoms:a2u(网元类型：)}
                    <bean:write name="tawClassMsgForm" property="necode" scope="request"/>
                </td>
            </tr>
            <tr class="tr_show">
            ...
            <logic:iterate id="classMsg" name="classMsg" type="com.boco.eoms.sparepart.model.TawClassMsg">
                <tr class="tr_show">
                    ...
                    <td align="center"><a
                            href="../storage/editclass.do?id=<bean:write name="classMsg" property="id" scope="page"/>"><img
                            src="<%=request.getContextPath()%>/images/bottom/an_bj.gif" border="0"></a></td>
                    <td align="center"><img src="<%=request.getContextPath()%>/images/bottom/an_sc.gif" border="0"
                                            Onclick="onPublic(<bean:write name='classMsg' property='id'
                                                                          scope='page'/>);"></td>
                </tr>
            </logic:iterate>
        ...
        <tr>
            <td width="100%" height="32" align="right">
                ...
                <bean:message key="label.add"/> name=button
                       Onclick="window.location.href ='../storage/addclass.do?id=<bean:write name='tawClassMsgForm'
                                                                                             property='id'
                                                                                             scope='request'/>&deleted=4'">
                &nbsp;&nbsp;
            </td>
        </tr>
    </table>
