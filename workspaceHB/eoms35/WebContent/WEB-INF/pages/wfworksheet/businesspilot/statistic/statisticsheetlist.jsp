...
<bean:define id="url" value="businessdesign.do"/>
<fmt:bundle basename="config/ApplicationResources-sheet">
    <display:table name="mainList" cellspacing="0" cellpadding="0"
                   ...
                   export="true" requestURI="pvm.do"
                   sort="list" size="total" partialList="true"
                   decorator="com.boco.eoms.sheet.statistic.base.util.KpiMainListDisplaytagDecoratorHelper">
