...
<table class="formTable"> 
	  ...
	  <tr>
			...
			<td>
				<input type="text"  class="text" name="linkSendOtherName" id="linkSendOtherName"  value="${linkSendOtherName}"/>
			</td>
 			<td class="label">
				已联系待转派单位班组维护人员电话*
			</td>
...
<fieldset>
    ...
    <div class="x-form-item" >
			<eoms:chooser id="sendObject"  type="role" roleId="8005106" flowId="51" config="{returnJSON:true,showLeader:true}"
