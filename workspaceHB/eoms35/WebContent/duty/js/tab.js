...
function tabToggle(tabID){
	...
	if ((lastTab != tabID) && (lastTab != null)){
		...
		lastTab.style.top = "30";
		lastTab.style.backgroundImage='url(/css/UI_graytab.gif)';
	...
	if (tabID.style.zIndex == "3")
		{
	  	...
	  	tabID.style.top = "27";
		tabID.style.backgroundImage='url(/css/UI_bluetab.gif)';
		tabID.style.fontWeight='bold';
		tabID.style.paddingTop='4px';
		}
	else 
		{
		tabID.style.zIndex = "30"; 
		tabID.style.top = "27";
		tabID.style.backgroundImage='url(/css/UI_bluetab.gif)';
		tabID.style.fontWeight='bold';
		tabID.style.paddingTop='4px';
...
function panelExp()
{
	if(panState=='0')
	{
	Layer1.style.width='670';
	panState=1;
	}
	else
	{
	Layer1.style.width='400';
	panState=0;
	}
}
