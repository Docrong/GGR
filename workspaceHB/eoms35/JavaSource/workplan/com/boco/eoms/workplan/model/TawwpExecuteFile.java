...
/**
 * @hibernate.class table="TAW_WP_EXECUTEFILE"
 */
...
public class TawwpExecuteFile
    ...
    /**
     * @hibernate.property column="FILECODENAME"
     * length="50"
     * not-null="true"
     * update="false"
     */
    ...
    /**
     * @hibernate.many-to-one column="EXECUTE_CONTENT_ID"
     * cascade="none"
     * not-null="true"
     */
    ...
    /**
     * @hibernate.many-to-one column="EXECUTE_CONTENT_USER_ID"
     * cascade="none"
     * not-null="true"
     */
