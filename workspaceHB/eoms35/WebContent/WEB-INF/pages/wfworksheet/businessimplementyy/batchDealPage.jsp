...
<div id="sheetform">
<html:form action="/businessimplementyy.do?method=performBatchDeal" styleId="theform">
  ...
  <div id="sheetinfo">
	...
	<table class="formTable"> 
	  <caption></caption>
	               ...
	               <tr>
		           		<td class="label"><bean:message bundle="businessimplementyy" key="businessimplementyy.mainNetSort1"/></td>
		            	<td class="content">  
		            		<eoms:id2nameDB id="${sheetMain.mainNetSort1}" beanId="ItawSystemDictTypeDao"/>
			        	</td>	   
		            	<td class="label"><bean:message bundle="businessimplementyy" key="businessimplementyy.mainNetSort2"/></td>
		                <td class="content">  
	                ...
	                <tr>
		                <td class="label"><bean:message bundle="businessimplementyy" key="businessimplementyy.mainNetSort3"/></td>
		                <td class="content">  
		                	<eoms:id2nameDB id="${sheetMain.mainNetSort3}" beanId="ItawSystemDictTypeDao"/>
			        	</td>	 
		                <td  class="label"><bean:message bundle="businessimplementyy" key="businessimplementyy.mainTaskType"/></td>
		                <td class="content">  
			      ...
			      <tr>
		            <td class="label"><bean:message bundle="businessimplementyy" key="businessimplementyy.mainTaskDescription"/></td>
				...
				<tr>
				    ...
				    <eoms:attachment name="sheetMain" property="sheetAccessories" 
				            scope="request" idField="sheetAccessories" appCode="businessimplementyy" 
				             viewFlag="Y"/> 
				    </td>
				</tr>
	</table>
	               ...
	               <tr>
		            	...
		            	<td class="content">  
		            		<select id="dealSelector" onchange="checkValue(this)" alt="allowBlank:false,vtext:'请选择处理操作'">
		            			 <option value=""></option>
		            			 <option value="Receive"><bean:message bundle="businessimplementyy" key="businessimplementyy.dealrejectpass"/></option>
			 					 <option value="ExcuteHumTask"><bean:message bundle="businessimplementyy" key="businessimplementyy.nopassback"/></option>
			 				</select> 
			        	</td>	   
		            	<td class="label"></td>
		                <td class="content">
		                	 ...
		                	 <input type="hidden" name="beanId" value="iBusinessImplementYYMainManager"/> 
					         <input type="hidden" name="mainClassName" value="com.boco.eoms.sheet.businessimplementyy.model.BusinessImplementYYMain"/>	
					         <input type="hidden" name="linkClassName" value="com.boco.eoms.sheet.businessimplementyy.model.BusinessImplementYYLink"/>
					         <input type="hidden" name="methodBeanId"  id="methodBeanId" value="${methodBeanId}"/>
					         <input type="hidden" name="piid" value="${piid}"/>  
			        	</td>			        	             
		           </tr>
	               <tr>
			            <td  class="label"><bean:message bundle="businessimplementyy" key="businessimplementyy.advice"/>*</td>
			              <td colspan="3"> 	
