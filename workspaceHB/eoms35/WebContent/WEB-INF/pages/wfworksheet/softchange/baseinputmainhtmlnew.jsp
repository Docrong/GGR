...
<table class="formTable">
    ...
    <c:if test="${status==1}">
        ...
        <tr>
            ...
            <td colspan="3">
                <eoms:comboBox name="${sheetPageName}holdStatisfied" defaultValue="${sheetMain.holdStatisfied}"
                               id="${sheetPageName}holdStatisfied" initDicId="10303" styleClass="select"/>
            </td>
        </tr>
