...
<table id="sheet" class="formTable" >
		...
		<tr><td class="label">
			...
			<td>
				<input type="text"  class="text" name="mainProductInstance" id="mainProductInstance"  alt="allowBlank:true,maxLength:1000,vtext:'请填入 产品实例标识 信息，最多输入 1000 字符'" value="${sheetMain.mainProductInstance}"/>
			</td>
 			<td class="label">
				<!-- 客户名称 -->
			...
			<td>
				<input type="text"  class="text" name="mainCustomerName" id="mainCustomerName"  alt="allowBlank:true,maxLength:1000,vtext:'请填入 客户名称 信息，最多输入 1000 字符'" value="${sheetMain.mainCustomerName}"/>
			</td>
		</tr>
		...
		<tr><td class="label">
			...
			<td>
				<input type="text"  class="text" name="mainBusinessType" id="mainBusinessType"  alt="allowBlank:true,maxLength:1000,vtext:'请填入 业务类型 信息，最多输入 1000 字符'" value="${sheetMain.mainBusinessType}"/>
			</td>
 			<td class="label">
				<!-- 电路代号 -->
		...
		<tr><td class="label">
			...
			<td>
				<input type="text"  class="text" name="mainFailCity" id="mainFailCity"  alt="allowBlank:true,maxLength:1000,vtext:'请填入 电路核查失败所属地市 信息，最多输入 1000 字符'" value="${sheetMain.mainFailCity}"/>
			</td>
 			<td class="label">
				<!-- 电路核查状态 -->
			...
			<td>
				<input type="text"  class="text" name="mainCheckState" id="mainCheckState"  alt="allowBlank:true,maxLength:1000,vtext:'请填入 电路核查状态 信息，最多输入 1000 字符'" value="${sheetMain.mainCheckState}"/>
			</td>
		</tr>
</table>
...
<table id="sheet" class="formTable">
	    ...
	    <tr>
		    ...
		    <eoms:attachment name="sheetMain" property="sheetAccessories" 
		            scope="request" idField="sheetAccessories" appCode="focusresourceerrata" alt="allowBlank:true"/> 				
		    </td>
	   </tr>			  
</table>
