...
import com.ggr.hoo.entity.TheUser;
...
public class TheAxis1Test {
    ...
    public void testgetTheUser() throws ServiceException, RemoteException {
        ...
        //这里是将对象序列化和反序列化的配置
        call.registerTypeMapping(com.ggr.hoo.entity.TheUser.class, qn, BeanSerializerFactory.class, BeanDeserializerFactory.class);
