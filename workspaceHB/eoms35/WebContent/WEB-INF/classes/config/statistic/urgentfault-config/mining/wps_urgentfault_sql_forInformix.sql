...
--bussines main
    , MAINSENDCONTENTTYPE, MAINIFGREATFAULT, MAINGREATFAULTID, MAINFAULTSHEETID, MAINFAULTGENERANTTIME,
                          ...
                          MAINAFFECTOPERATIONLEVEL, MAINAFFECTOPERATIONSORT, MAINTRIGGERUSERCOMPLAINT, MAINIFREPORT,
                          MAINIFACHIEVEPROJECTSTARTUP, MAINURGENTLEVE, MAINFAULTSPECIALITY, MAINEQUIPINTEGRATOR,
                          MAINFAULTAVOIDTIME, MAINAFFECTTIMELENGTH, MAINNETSORTONE, MAINNETSORTTWO, MAINNETSORTTHREE,
                          MAINFAULTSUBREASON, MAINFAULTLOCATION, MAINREPORTLIMIT, SENDYEAR, SENDMONTH, SENDDAY,
                          MAINIFRECORD
--bussines link
    , LINKIFGREATFAULT, LINKFAULTGENERANTPLACE, LINKFAULTAVOIDTIME, LINKAFFECTTIMELENGTH, LINKGREATFAULTID,
                          LINKIFAFFIRM, LINKFAULTREASON, LINKFAULTSUBREASON, OPERATEYEAR, OPERATEMONTH, OPERATEDAY
    ) as
    (
--已处理
        select
...
values (53, '2007-07-07 00:00:00', '紧急故障工单基础表采集的上一次操作的时间');
