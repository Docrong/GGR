...
<%@ page
        import="java.util.*,java.text.SimpleDateFormat,java.lang.*, org.apache.struts.util.*,java.io.*,java.sql.*,javax.sql.*,com.boco.eoms.base.util.*" %>
<%
        ...
        <table border="0" width="70%" cellspacing="1" class="formTable">
            ...
            <tr bgcolor="#FFFFFF">
                ...
                <td nowrap align="center" colspan="3">
                    ...
                    <input type="text" name="returntime" size="30" value="<%=date%>"
