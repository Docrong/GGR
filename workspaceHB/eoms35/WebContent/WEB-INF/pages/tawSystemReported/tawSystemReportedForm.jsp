...
<html:html>
    ...
    <script type="text/javascript">
        ...
        Ext.onReady(function () {
            ...
            reportedTree = new xbox({
                ...
                treeRootId: '-1',
                treeRootText: '${eoms:a2u('选择上报用户')}',
                treeChkMode: '',
                treeChkType: 'user',
                showChkFldId: 'reportedOrgView',
                saveChkFldId: 'reportedOrg',
                viewer: reportedOrgViewer,
                returnJSON: true
            });
        });
    ...
    <center>
        ...
        <html:form action="/tawSystemReported.do?method=save" method="post" styleId="tawSystemReportedForm"
                   styleClass="required-validate">
            <table border="0" width="500" cellspacing="1" cellpadding="1" class="formTable" align=center>
                ...
                <tr class="tr_show">
                    ...
                    <td>
                        <eoms:dict key="dict-reported" dictId="modelId" beanId="selectXML" isQuery="false"
                                   selectId="modelId" alt="allowBlank:false"
                                   defaultId="${tawSystemReportedForm.modelId}"/>
                    </td>
                </tr>
                <tr class="tr_show">
                    <td class="label">
                    ...
                    <td>
                        <eoms:dict key="dict-reported" dictId="functionId" beanId="selectXML" isQuery="false"
                                   selectId="functionId" alt="allowBlank:false"
                                   defaultId="${tawSystemReportedForm.functionId}"/>
                    </td>
                </tr>
                ...
                <tr class="tr_show">
                    ...
                    <td>
                        ...
                        <input type="button" id="clkReported" name="clkReported"
                               value="<bean:message key='tawSystemReported.reportedSelectUser'/>"/>
