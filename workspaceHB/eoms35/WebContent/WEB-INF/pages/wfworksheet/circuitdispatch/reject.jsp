...
function showPage(){
     var pars = '';
     var url = '';    
      url = '${app}/sheet/circuitdispatch/circuitdispatch.do?method=showInputRejectPage&piid=${sheetMain.piid}&taskId=${taskId}&taskName=${taskName}';
     if (url!=''){
...
<div id="sheetform">
<html:form action="/circuitdispatch.do?method=performDeal" styleId="theform">
