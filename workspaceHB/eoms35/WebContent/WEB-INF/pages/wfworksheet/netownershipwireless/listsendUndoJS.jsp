...
<div id="listQueryObject" style="display:none;border:1px solid #98c0f4;border-top:0;padding:5px;background-color:#eff6ff;width:100%">
<jsp:include page="/WEB-INF/pages/wfworksheet/netownershipwireless/querybody.jsp"/>
</div>
