...
<html:form action="saveSheetLimit.do" method="post" styleId="sheetLimitForm">
    <ul>
        ...
        <li>
            ...
            <eoms:comboBox name="specialty2" id="${sheetLimitForm.specialty2}"
                           defaultValue="${sheetLimitForm.specialty2}" initDicId="1010304"
                           size="1" alt="allowBlank:false" styleClass="select-class"
                           onchange="getDealLimit(this.value);"/>
        </li>
        <li>
            ...
            <input type="button" title="${eoms:a2u('如果级别没有配置处理时长，可以点击此处获取！')}" value="${eoms:a2u('获取处理时长')}"
                   onclick="location.href='<c:url value="/sheet/sheetLimit/sheetLimit.do?method=editDealLimit"/>'">

        </li>
        <li>
            <eoms:label styleClass="desc" bundle="sheetLimit" key="sheetLimit.specialty1"/>
            <html:errors property="specialty1"/>
            <eoms:comboBox name="specialty1" id="specialty1" defaultValue="${sheetLimitForm.specialty1}"
                           initDicId="1010104" sub="specialty3"
                           size="1" alt="allowBlank:false" styleClass="select-class"/>
        </li>
        ...
        <li>
            ...
            <eoms:comboBox name="specialty3" id="specialty3" defaultValue="${sheetLimitForm.specialty3}"
                           initDicId="${sheetLimitForm.specialty1}" sub="specialty4"
        ...
        <li>
            ...
            <eoms:comboBox name="specialty4" id="specialty4" defaultValue="${sheetLimitForm.specialty4}"
                           initDicId="${sheetLimitForm.specialty3}" sub="specialty5"
                           size="1" styleClass="select-class"/>
        </li>
        <li>
            <eoms:label styleClass="desc" bundle="sheetLimit" key="sheetLimit.specialty4"/>
            <html:errors property="specialty5"/>
            <eoms:comboBox name="specialty5" id="specialty5" defaultValue="${sheetLimitForm.specialty5}"
                           initDicId="${sheetLimitForm.specialty4}"
                           size="1" styleClass="select-class"/>
        </li>
