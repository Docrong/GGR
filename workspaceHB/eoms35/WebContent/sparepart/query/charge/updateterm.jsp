    ...
    <SCRIPT LANGUAGE=JavaScript>
        ...
        function setup() {
            ...
            for (i = 0; i < t.length - 1; i++)
                document.getElementById(t[i]).onchange = new Function("change(dsyStorageTree," + (i + 1) + ",t,opt1)");
            change(dsyStorageTree, 0, t, opt1);
        }
    </SCRIPT>
...
<div align="center">
    ...
    <form action="../charge/updateview.do" method="post" name="frm" onsubmit="checkdata()">
        <table border="0" width="75%" cellspacing="1" cellpadding="1" class="table_show" align=center>
            ...
            <tr class="tr_show">
                <td class="clsfth" width="30%" height="25">
                    <p style="margin-top: 0; margin-bottom: 0"><bean:message
                            key="sparepart.objecttype"/>${eoms:a2u('：')}</p>
                </td>
                <td width="70%" height="25" colspan="2">
                ...
                <td width="70%" height="25" colspan="2">
                    <select name="state" size="1" style="width: 4.4cm;">
                        ...
                        <logic:iterate id="state" name="state" type="com.boco.eoms.sparepart.model.TawClassMsg">
                            <option value="<bean:write name="state" property="id" scope="page"/>"><bean:write
                                    name="state" property="cname" scope="page"/></option>
                        </logic:iterate>
                    </select>
                </td>
            </tr>
