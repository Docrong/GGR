...
<%@ include file="/WEB-INF/pages/wfworksheet/equipmentunsubscribe/baseinputlinkhtmlnew.jsp"%>
 ...
 <%}%>
			...
			<td>
				<input type="text"  class="text" name="linkEquipmentNum" id="linkEquipmentNum"  alt="allowBlank:true,maxLength:1000,vtext:'请填入 设备编号 信息，最多输入 1000 字符'" value="${sheetLink.linkEquipmentNum}"/>
			</td>
		</tr>
 		...
 		<tr>
			...
			<td colspan="3">
				<eoms:attachment name="sheetLink" property="linkScenePhoto" 
              				scope="request" idField="linkScenePhoto" appCode="equipmentunsubscribe" alt="allowBlank:false"/>
			</td>
		</tr>
 		...
 		<tr>		
			...
			<td colspan="3">
				<eoms:attachment name="sheetLink" property="linkPutPhoto" 
              				scope="request" idField="linkPutPhoto" appCode="equipmentunsubscribe" alt="allowBlank:false"/>
			</td>
		</tr>
		...
		<tr>
			...
			<td colspan="3">
				<eoms:attachment name="sheetLink" property="linkReturnPhoto" 
              				scope="request" idField="linkReturnPhoto" appCode="equipmentunsubscribe" alt="allowBlank:false"/>
			</td>
 		</tr>
 		</c:if>
 <%}%>
