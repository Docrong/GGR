...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" bgcolor="#ffffff"
      onload="location.replace('fileload.jsp?fileName=<%=fileName%>&specialtySel=<%=specialtySel%>&manufacturerSel=<%=manufacturerSel%>&equipIdSel=<%=equipIdSel%>&issueType=<%=issueType%>&s_value=<%=s_value%>')">
