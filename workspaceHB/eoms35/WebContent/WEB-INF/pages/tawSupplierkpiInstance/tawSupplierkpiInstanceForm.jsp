    ...
    <table>
        <html:form action="updateTawSupplierkpiInstance" method="post" styleId="tawSupplierkpiInstanceForm">
            ...
            <tr height="50">
                ...
                <td colspan="3">
                    <html:text style="width:100%;height:30;border:1px solid #006699" property="examineContent"
                               styleId="assessRole" styleClass="text medium"/>
                </td>
            </tr>
            <tr height="50">
                <td>
                ...
                <td colspan="3">
                    <html:textarea style="width:100%;height:50;border:1px solid #006699" property="memo" styleId="memo"
