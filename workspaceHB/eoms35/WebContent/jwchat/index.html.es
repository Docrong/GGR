    ...
    <body>
        <table width="100%" height="100%">
            ...
            <form name="login" onSubmit="return loginCheck(this);">
                <tr>
                    <td height="100%" align=center valign=top id='td_form'>
                        ...
                        0 cellpadding=2 id="lTable" align=center width=380>
                        <tr>
                        <td colspan=2
                        >
                        <h3>Conectar
                        <img src="images/available.gif" width=1
                        6 height=16>
                    </h3>
                </td>
            </tr>
            <tr id="tr_server" style="display:none;">
                <th title="Select Jabber server to connect to">
                    <label for='server'>Servidor</label>
                </th>
                <td></td>
            </tr>
            <tr>
                <th class='form_spacer'>
                    <label for='jid'>Nombre</label>
                </th>
                <td class='form_spacer' width="100%">
                    <input type="text" id='jid' name="jid" tabindex=3 class='input_text'>
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
                <td nowrap class="desc">El Nombre de usuario no debe contener:
                    <span id='chars_prohibited'></span>
                </td>
            </tr>
            <tr>
                <th>
                ...
                <td>
                    <input type="password" id='pass' name="pass" tabindex=4 class='input_text'>
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
                <td>
                    <input type=checkbox name=register id=register>
                        <label for="register">Crear esta cuenta</label>
                </td>
            </tr>
            <tr id="showMoreOpts" class="toggleOpts">
                <td>&nbsp;</td>
                <td onClick="return toggleMoreOpts(1);">
                    <img src="images/group_close.gif" title="Mostrar más opciones">Mostrar más opciones
                </td>
            </tr>
            <tr id="showLessOpts" class="toggleOpts" style="display:none;">
                <td>&nbsp;</td>
                <td onClick="return toggleMoreOpts(0);">
                    <img src="images/group_open.gif" title="Mostrar menos opciones">Mostrar menos opciones
                </td>
            </tr>
            <tr class="moreOpts" style="display:none;">
                <th>
                    <label for='res'>Recurso</label>
                </th>
                <td>
                    <input type="text" id="res" name="res" class="input_text">
                </td>
            </tr>
            <tr class="moreOpts" style="display:none;">
                <th>
            ...
            <tr class="moreOpts" style="display: none;">
                ...
                <td class="form_spacer">
                    <input type="text" name="connect_port" id="connect_port" class="input_text" disabled>
                </td>
            </tr>
            <tr class="moreOpts" style="display: none;">
                <th>
                    <label for="connect_host">Connect Host</label>
                </th>
                <td>
                    <input type="text" name="connect_host" id="connect_host" class="input_text" disabled>
                </td>
            </tr>
            <tr class="moreOpts" style="display: none;">
                <td>&nbsp;</td>
                <td>
                    <input type="checkbox" name="connect_secure" id="connect_secure" class="input_text" disabled>
                        <label for="connect_secure" title="Advise connection manager to connect through SSL" disabled>
                            Allow secure conncetions only
                        </label>
                </td>
            </tr>
            ...
            <tr>
                <td>&nbsp;</td>
                <td>
                    <button type="submit" id='login_button' tabindex=5 disabled>Conectar</button>
                </td>
            </tr>
        </table>
    </form>
...
<tr>
    <td id='td_bottom'>
        <a href="http://sourceforge.net/donate/index.php?group_id=92011">
            <img src="http://images.sourceforge.net/images/project-support.jpg" width="88" height="32" border="0"
                 alt="Support This Project" align=right/>
        </a>
