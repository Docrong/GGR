...
<TR bgcolor=#eeeeee align=center>
	<TD align=center colspan=6><font size=2>ÊµÌå±íÖÐÎÄÃû³Æ£º</font><input type=text name=tablename value='±íÃû³Æ'><font color=red>*</font></TD>
	<TD align=center colspan=6><font size=2>ÊµÌå±íÓ¢ÎÄÃû³Æ£º</font><input type=text name=tablecode><font color=red>*</font></TD>
</TR>
<TR bgcolor=#eeeeee align=center>
	...
	<TD><select name='cc_null' disabled><option value=1 selected>²»Îª¿Õ</option></select></TD>
	<TD><select name='cc_dis' disabled><option value=1 selected>ÏÔÊ¾ÁÐ</option><option value=1>²»ÏÔÊ¾ÁÐ</option></TD>
