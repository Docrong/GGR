 ...
 *
 */
public class AttachmentWwTag extends BodyTagSupport {
    ...
    try {
      ...
      if (!viewFlag.equals("Y")) {
        html = "<iframe id=\"UIFrame1-" +idField+
            ...
            + "scrolling=\"auto\" src=\"" + path + "/accessories/branchindexreductionfiles/uploadWw.jsp?appId=" + appCode+"&sheetFlag="+sheetFlag
