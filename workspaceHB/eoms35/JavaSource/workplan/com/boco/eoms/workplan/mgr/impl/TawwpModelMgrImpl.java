...
public class TawwpModelMgrImpl implements ITawwpModelMgr {
     ...
     *
     * @param _name      String 模版名称
     * @param _sysTypeId String 系统类型
     * @param _netTypeId String 网元类别
     ...
     *
     * @param _name        String 作业计划模板执行内容名称
     * @param _modelPlanId String 作业计划模板标识
     * @param _groupId     String 作业计划模板组织信息标识
     * @param _cycle       String 周期
     * @param _formId      String 特殊表格标识
     * @param _format      String 填写格式
     * @param _cruser      String 创建人
     * @throws TawwpException 异常信息
     */
     ...
     *
     * @param _id              String 作业计划模板标识
     * @param _deptIdList      String 接收部门列表
     * @param _yearFlag        String 年度
     * @param _sendDeptId      String 发送部门
     * @param _sendUser        String 发送人
     * @param _content         String 派发信息
     * @param _modelDispatchId String 父派发信息标识
     * @throws TawwpException 异常信息
     */
     ...
     *
     * @param _id          String 作业计划模版派发信息标识
     * @param inceptDeptId String 接收部门
     * @param _inceptUser  String 接收人
     * @throws TawwpException 异常信息
     */
     ...
     *
     * @param _inceptDeptId       String 创建部门
     * @param _inceptUser         String 创建人
     * @param _tawwpModelDispatch TawwpModelDispatch 作业计划模版派发信息
     * @throws TawwpException 异常信息
     */
     ...
     *
     * @param _name               String 作业计划模版组织信息名称
     * @param _parentModelGroupId String 父作业计划模版组织信息标识
     * @param _modelPlanId        String 作业计划模版标识
     * @throws TawwpException 异常信息
     */
...
//					Collections.sort(tawwpModelPlanVO.getModelExecuteList());
     ...
     * 从Excel导入作业计划模板
     *
     * @param _sourceExcel String 上传的Excel
     * @param _sysTypeId   String 系统标识
     * @param _netTypeId   String 网元标识
     * @param _cruser      String 创建人
     */
     ...
     * 创建顶级组织信息
     *
     * @param _tawwpModelGroupManageVO TawwpModelGroupManageVO 组织执行管理类
     * @param _tawwpModelGroup         TawwpModelGroup 组织信息类
     */
     ...
     *
     * @param _tawwpModelGroupManageVO TawwpModelGroupManageVO 组织执行管理类
     * @param _tawwpModelGroupVO       TawwpModelGroupVO 组织信息VO类
     * @param _hashtable               Hashtable 父类Hashtable
     * @param _tawwpModelGroup         TawwpModelGroup 组织信息model类
     */
     ...
     * 进行行数累加处理
     *
     * @param _tawwpModelGroupVO TawwpModelGroupVO 父类的组织信息
     */
    ...
    /**
     * @param tawwpAddonsTableDao the tawwpAddonsTableDao to set
     */
    ...
    /**
     * @param tawwpModelDispatchDao the tawwpModelDispatchDao to set
     */
    ...
    /**
     * @param tawwpModelExecuteDao the tawwpModelExecuteDao to set
     */
    ...
    /**
     * @param tawwpModelGroupDao the tawwpModelGroupDao to set
     */
    ...
    /**
     * @param tawwpModelPlanDao the tawwpModelPlanDao to set
     */
    ...
    /**
     * @param tawwpYearExecuteDao the tawwpYearExecuteDao to set
     */
    ...
    /**
     * @param tawwpYearPlanDao the tawwpYearPlanDao to set
     */
