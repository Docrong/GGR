            ...
            <form id="threadForm" method="post" action="/eoms/workbench/infopub/thread.do?method=save">
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <input type="text" name="title" value="fddsa" id="title" class="text medium"
                    ...
                    <li>
                        ...
                        <select onchange="javascript:null" name="threadTypeId" id="threadTypeId" alt="allowBlank:false">
                            <option value="">��ѡ��</option>
                            <option id="1" value="1" selected="selected">��Ҫ��</option>
                            <option id="2" value="2">��Ҫ����</option>
                            <option id="3" value="3">�����Ҫ</option>
                            <option id="4" value="4">����Ҫ����</option>
                        </select>
                    </li>
                    ...
                    <li>
                        ...
                        <input type="button" id="clkOrg" name="clkOrg"
                               onclick="javascript:deptThree.show(this,'showOrg','org')" value="ѡ�񷢲���Χ"/>
                        <br/><br/>
