...
<html:html>
    <head>
        <title><bean:message key="label.edit"/><bean:write name="tawInfInfoForm" property="infSortName"
                                                           scope="request"/></title>
        <html:base/>
        ...
        <table border="0" width="100%" cellspacing="0" align="center">
            <tr>
                <td width="100%" align="center" class="table_title">
                    <b>
                        <bean:message key="label.edit"/>&nbsp;<bean:write name="tawInfInfoForm" property="infSortName"
                                                                          scope="request"/>
                    </b>
                </td>
            </tr>
...
<IFRAME ID=IFrame1 FRAMEBORDER=0 width="100%" SCROLLING=NO
        SRC="<%=request.getContextPath()%>/infmanage/TawInfAppu/file.do?attValue=<%=attValue.trim()%>&attText=<%=attText.trim()%>&imgValue=<%=imgValue.trim()%>&imgText=<%=imgText.trim()%>"></IFRAME>
