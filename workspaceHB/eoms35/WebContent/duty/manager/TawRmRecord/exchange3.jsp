...
<html:form method="post" action="/TawRmRecord/submit3">
    ...
    <TABLE cellSpacing="1" cellPadding="1" width="290" align="center" border="0" class="formTable">
        ...
        <TR class="tr_show">
            ...
            <TD>
                ...
                %>
                <input name='hander_<%=vecDutyManId.get(i).toString()%>' type="password"
                       style="WIDTH: 120px; HEIGHT: 24px" maxlength="25"/>&nbsp;&nbsp;
                <%}%>
            </TD>
        </TR>
        <TR>
        ...
        <TR class="tr_show">
            ...
            <TD>
                ...
                %>
                <input name='receiver_<%=vecReceiverId.get(i).toString()%>' type="password"
                       style="WIDTH: 120px; HEIGHT: 24px" maxlength="25"/>&nbsp;&nbsp;
                <%}%>
            </TD>
        </TR>
