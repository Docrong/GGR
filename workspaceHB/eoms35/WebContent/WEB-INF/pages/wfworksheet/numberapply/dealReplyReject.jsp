...
<div id="sheetform">
    <html:form action="/numberapply.do?method=performDealReplyReject" styleId="theform">
        <%
        ...
        <input type="hidden" name="subtaskName" value="numberapplySubTask"/>
        ...
        <input type="hidden" name="processTemplateName" id="processTemplateName" value="NumberApplyMainProcess"/>
        ...
        <input type="hidden" name="taskNamespace" value="http://NumberApplyProcess"/>
