...
<input type="hidden" name="mainClassName"
       value="com.boco.eoms.sheet.equipmentinstallation.model.EquipmentInstallationMain"/>
<input type="hidden" name="linkClassName"
       value="com.boco.eoms.sheet.equipmentinstallation.model.EquipmentInstallationLink"/>
<br>
...
<table id="sheet" class="formTable">
    ...
    <tr>
        ...
        <td colspan="3">
            <input type="text" class="text max" name="mainAddress" id="mainAddress"
                   alt="allowBlank:false,maxLength:1000,vtext:'请填入 详细地址信息 信息，最多输入 1000 字符'"
