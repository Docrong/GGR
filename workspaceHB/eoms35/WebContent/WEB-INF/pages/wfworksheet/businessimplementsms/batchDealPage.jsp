    ...
    <html:form action="/businessimplementsms.do?method=performBatchDeal" styleId="theform">
                    ...
                    <table class="formTable">
                        ...
                        <tr>
                            <td class="label"><bean:message bundle="businessimplementsms"
                                                            key="businessimplementsms.mainNetSort1"/></td>
                            <td class="content">
                                <eoms:id2nameDB id="${sheetMain.mainNetSort1}" beanId="ItawSystemDictTypeDao"/>
                            </td>
                            <td class="label"><bean:message bundle="businessimplementsms"
                                                            key="businessimplementsms.mainNetSort2"/></td>
                            <td class="content">
                        ...
                        <tr>
                            <td class="label"><bean:message bundle="businessimplementsms"
                                                            key="businessimplementsms.mainNetSort3"/></td>
                            <td class="content">
                                <eoms:id2nameDB id="${sheetMain.mainNetSort3}" beanId="ItawSystemDictTypeDao"/>
                            </td>
                            <td class="label"><bean:message bundle="businessimplementsms"
                                                            key="businessimplementsms.mainTaskType"/></td>
                            <td class="content">
                        ...
                        <tr>
                            <td class="label"><bean:message bundle="businessimplementsms"
                                                            key="businessimplementsms.mainTaskDescription"/></td>
        ...
        <div id="sheetinfo">
            <table class="formTable">
                ...
                <tr>
                    ...
                    <td class="content">
                        <select id="dealSelector" onchange="checkValue(this)" alt="allowBlank:false,vtext:'请选择处理操作'">
                            <option value=""></option>
                            <option value="Receive"><bean:message bundle="businessimplementsms"
                                                                  key="businessimplementsms.dealrejectpass"/></option>
                            <option value="ExcuteHumTask"><bean:message bundle="businessimplementsms"
                                                                        key="businessimplementsms.nopassback"/></option>
                        </select>
                    </td>
                    <td class="label"></td>
                    <td class="content">
                ...
                <tr>
                    <td class="label"><bean:message bundle="businessimplementsms" key="businessimplementsms.advice"/>*
                    </td>
                    <td colspan="3">
