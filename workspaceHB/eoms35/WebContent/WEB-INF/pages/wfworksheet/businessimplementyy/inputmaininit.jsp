  ...
  <td colspan="3">
    ...
    <c:if test="${status==-1}">
        ...
        <tr>
            ...
            <td colspan="3">
                <textarea class="textarea" name="${sheetPageName}endResult" id="${sheetPageName}endResult"
...
<input type="hidden" name="${sheetPageName}processTemplateName" value="BusinessImplementYYMainFlowProcess"/>
...
<table class="formTable">
    ...
    <tr>
        ...
        <td class="content">
            <eoms:comboBox name="${sheetPageName}mainTaskType" id="${sheetPageName}mainTaskType"
                           initDicId="1010102" alt="allowBlank:false" defaultValue="${sheetMain.mainTaskType}"
                           styleClass="select-class"/>
        </td>
    </tr>

    <tr>
        <td class="label"><bean:message bundle="businessimplementyy" key="businessimplementyy.mainTaskDescription"/>*
        </td>
    ...
    <tr>
        <td class="label"><bean:message bundle="businessimplementyy" key="businessimplementyy.mainRemark"/>*</td>
        <td colspan="3" class="content">
    ...
    <tr>
        ...
        <td colspan="3">
            ...
            <eoms:attachment name="sheetMain" property="sheetAccessories"
                             scope="request" idField="${sheetPageName}sheetAccessories" appCode="businessimplementyy"/>
        </td>
    </tr>
</table>
