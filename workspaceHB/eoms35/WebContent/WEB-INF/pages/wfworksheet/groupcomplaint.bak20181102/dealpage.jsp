  ...
  <c:choose> 
    ...
    <c:when test="${operateType=='61'}">    
		<div class="form-btns" id="btns">
		  <input type="submit" class="submit" onclick="v.passing=true;this.form.action='${app}/sheet/groupcomplaint/groupcomplaint.do?method=performClaimTask'" 
    ...
    <c:when test="${taskName=='DraftHumTask'}">    
		<div class="form-btns" id="btns">
		    ...
		    <input type="submit" class="submit" onclick="v.passing=true;this.form.action='${app}/sheet/groupcomplaint/groupcomplaint.do?method=showDraftList'" value="<bean:message bundle='sheet' key='button.back'/>" />
		</div>	 
   	</c:when>
