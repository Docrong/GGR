    ...
    <table class="listTable" id="listTable">
        ...
        <tr>
            ...
            <td width="20%">
                ...
                %>
                <a href="do_download.jsp?id=<%=tempArray[2]%>"><%=tempArray[0]%>
                </a><br>
                <%--
            ...
            <td width="20%">
                ...
                %>
                <a href="javascript:onAddons('../tawwpaddons/addonsread.do?action=read&executeId=<%=tawwpExecuteContentUserVO.getId() %>&reaction=/tawwpexecute/redirection.jsp');"><%=tawwpExecuteContentUserVO.getFormName()%>
                </a>
