...
<fmt:bundle basename="config/applicationResource-kmexamtesttype">
    ...
    <display:table name="kmExamTestTypeList" cellspacing="0" cellpadding="0"
        ...
        <display:column property="testTypeId" sortable="true"
                        headerClass="sortable" titleKey="kmExamTestType.testTypeId"
                        href="${app}/kmExamTestType/kmExamTestTypes.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="testID" sortable="true"
                        headerClass="sortable" titleKey="kmExamTestType.testID"
                        href="${app}/kmExamTestType/kmExamTestTypes.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="type" sortable="true"
                        headerClass="sortable" titleKey="kmExamTestType.type"
                        href="${app}/kmExamTestType/kmExamTestTypes.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="description" sortable="true"
                        headerClass="sortable" titleKey="kmExamTestType.description"
                        href="${app}/kmExamTestType/kmExamTestTypes.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="quantity" sortable="true"
                        headerClass="sortable" titleKey="kmExamTestType.quantity"
                        href="${app}/kmExamTestType/kmExamTestTypes.do?method=edit" paramId="id" paramProperty="id"/>

        <display:column property="score" sortable="true"
                        headerClass="sortable" titleKey="kmExamTestType.score"
                        href="${app}/kmExamTestType/kmExamTestTypes.do?method=edit" paramId="id" paramProperty="id"/>
