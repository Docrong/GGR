    ...
    <div id="content" class="clearfix">
        <div id="main">
            <div class="login-wrap">
                ...
                <form method="post" id="loginForm" action="<c:url value="/j_security_check"/>" class="fm-v clearfix"
                      onsubmit="saveUsername(this);">
                    </c:when>
                    <c:when test="${loginType==eomsStr}">

                    <form method="post" id="loginForm" action="<c:url value='/index.do?method=saveSession'/>"
                          class="fm-v clearfix" onsubmit="saveUsername(this);">
                        ...
                        <ul>
                            ...
                            <li>
                                <input type="text" class="required text" name="j_username" id="j_username"
                                       tabindex="1"/>
                            </li>

                            <li>
                                <input type="password" class="required text" name="j_password" id="j_password"
                                       tabindex="2"/>
                            </li>
                            <c:choose>
                                <c:when test="${loginType==acegiStr}">
                        ...
                        <div class="input-btn"><input type="submit" class="btn" name="login"
                                                      title="<fmt:message key='button.login'/>" value=" " tabindex="3"/>
                        </div>
                    </form>
            </div>
            <div class="clear"></div>
