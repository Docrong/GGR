            ...
            <table class="formTable">
                ...
                <tr>
                    ...
                    <td class="content"><bean:write name="sheetMain"
                                                    property="mainAlarmId" scope="request"/><INPUT id="btn"
                                                                                                   type="button"
                                                                                                   value="sop"
                                                                                                   onclick="go('002-016-00-009047')">
                    </td>
                    <td class="label"><bean:message bundle="commonfault"
                ...
                <tr>
                    ...
                    <td class="content" colspan='3'><pre><bean:write
                            name="sheetMain" property="mainAlarmDesc" scope="request"/></pre>
                    </td>
                </tr>
                <tr>
                    <td class="label"><bean:message bundle="commonfault"
            ...
            <c:if test="${alarmMethod==''}">
                <c:if test="${sheetMain.mainAlarmState=='1'}">
                    ...
                    <table class="formTable">
                        ...
                        <td class="label"><bean:message bundle="commonfault"
                                                        key="commonfault.linkIfFinallySolveProject"/>*
                        </td>
    ...
    <div class="sheet-deal">
        <div class='sheet-deal-header'>
            ...
            <table id="sheet" class="formTable">
                ...
                <tr>
                    <td class="label"><bean:message bundle="commonfault"
                                                    key="commonfault.linkIfExcuteNetChange"/>*
                    </td>
                    <td><eoms:comboBox
                ...
                <tr>
                    ...
                    <td colspan="3"><textarea class="textarea max"
                                              ...
                                              id="${sheetPageName}replyDealStep"
                                              alt="width:500,allowBlank:true">${sheetMain.replyDealStep}</textarea>
                    </td>
                </tr>
            </table>
