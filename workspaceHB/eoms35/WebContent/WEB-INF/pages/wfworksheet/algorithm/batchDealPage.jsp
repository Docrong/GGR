	               ...
	               <tr>
		            	...
		            	<td class="content">  
		            		<select id="dealSelector" onchange="checkValue(this)" alt="allowBlank:false,vtext:'请选择处理操作'">
		            			 <option value=""></option>
		            			 <option value="Receive"><bean:message bundle="algorithm" key="algorithm.dealrejectpass"/></option>
			 					 <option value="EvaluationTask"><bean:message bundle="algorithm" key="algorithm.nopassback"/></option>
			 				</select> 
			        	</td>	   
		            	<td class="label"></td>
		                <td class="content">
					         ...
					         <input type="hidden" name="mainClassName" value="com.boco.eoms.sheet.algorithm.model.AlgorithmMain"/>	
					         <input type="hidden" name="linkClassName" value="com.boco.eoms.sheet.algorithm.model.AlgorithmLink"/>
