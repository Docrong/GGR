...
<div id="sheetform">
<html:form action="/emergencydrill.do?method=performDealReplyReject" styleId="theform">
 <%@ include file="/common/taglibs.jsp"%>
<%
 ...
 %>
    ...
    <input type="hidden" name="${sheetPageName}subtaskName" value="EmergencyDrillSubTask"/> 
    ...
    <input type="hidden" name="${sheetPageName}taskNamespace" value="http://EmergencyDrillProcess"/>  
<%@ include file="/WEB-INF/pages/wfworksheet/emergencydrill/baseinputlinkhtmlnew.jsp"%>
     ...
     <tr>
      ...
      <logic:iterate id="toTask" name="acceptList" type="com.boco.eoms.sheet.emergencydrill.model.EmergencyDrillTask">  
        <tr>
          <td>
	       ...
	       <td class="label">
			...
			<td colspan="3"> 
		           <textarea name="${sheetPageName}remark" class="textarea max" id="${sheetPageName}remark" 
		              alt="allowBlank:true,maxLength:255,width:500,vtext:'请填入信息，最多输入1000字'" >${sheetlink.remark}</textarea>
		  </td>
		</tr>
		</table>
