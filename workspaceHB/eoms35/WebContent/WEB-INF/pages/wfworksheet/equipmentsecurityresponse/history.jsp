...
<div id="history" class="panel">
    ...
    <logic:present name="HISTORY" scope="request">
        ...
        <logic:iterate id="baselink" name="HISTORY"
                       type="com.boco.eoms.sheet.equipmentsecurityresponse.model.EquipmentSecurityResponseLink">
            <%
                jNum += 1;
            ...
            <div class="history-item">&nbsp;
                ...
                <div class="history-item-title">
                    ...
                    <eoms:dict key="dict-sheet-equipmentsecurityresponse" dictId="activeTemplateId"
                               itemId="${baselink.activeTemplateId}" beanId="id2descriptionXML"/>
                    <bean:message bundle="equipmentsecurityresponse" key="equipmentsecurityresponse.operateType"/>:
                    <eoms:dict key="dict-sheet-equipmentsecurityresponse" dictId="mainOperateType"
                    ...
                    <table class="formTable" width="100%" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td class="label">
                                ...
                                <bean:message bundle="equipmentsecurityresponse"
                                              key="equipmentSecurityResponseLink.linkAuditResult"/>
                            </td>
                            <td class="content">
                            ...
                            <td class="label">
                                <!-- 审核意见 -->
                                <bean:message bundle="equipmentsecurityresponse"
                                              key="equipmentSecurityResponseLink.linkAuditOpinion"/>
                            </td>
                            <td class="content">
                        ...
                        <tr>
                            ...
                            <td class="label">
                                <!-- 挂起状态 -->
                                <bean:message bundle="equipmentsecurityresponse"
                                              key="equipmentSecurityResponseLink.linkUpStuts"/>
                            </td>
                            <td class="content">
                            ...
                            <td class="label">
                                <!-- 挂起原因 -->
                                <bean:message bundle="equipmentsecurityresponse"
                                              key="equipmentSecurityResponseLink.linkUpReason"/>
                            </td>
                            <td class="content">
                        ...
                        <tr>
                            ...
                            <td class="label">
                                <!-- 操作描述 -->
                                <bean:message bundle="equipmentsecurityresponse"
                                              key="equipmentSecurityResponseLink.linkOperation"/>
                            </td>
                            <td class="content">
                        ...
                        <tr>
                            ...
                            <td class="label">
                                <!-- 解除说明 -->
                                <bean:message bundle="equipmentsecurityresponse"
                                              key="equipmentSecurityResponseLink.linkRelieveState"/>
                            </td>
                            <td class="content">
                        ...
                        <tr>
                            ...
                            <td class="label">
                                <!-- 最长处理时间 -->
                                <bean:message bundle="equipmentsecurityresponse"
                                              key="equipmentSecurityResponseLink.mainDealTime"/>
                            </td>
                            <td class="content">
                        ...
                        <tr>
                            ...
                            <td class="label">
                                <!-- 预留字段1 -->
                                <bean:message bundle="equipmentsecurityresponse"
                                              key="equipmentSecurityResponseLink.linkExtend1"/>
                            </td>
                            <td class="content">
                            ...
                            <td class="label">
                                <!-- 预留字段1 -->
                                <bean:message bundle="equipmentsecurityresponse"
                                              key="equipmentSecurityResponseLink.linkExtend2"/>
                            </td>
                            <td class="content">
                        ...
                        <tr>
                            ...
                            <td class="label">
                                <!-- 预留字段1 -->
                                <bean:message bundle="equipmentsecurityresponse"
                                              key="equipmentSecurityResponseLink.linkExtend3"/>
                            </td>
                            <td class="content">
                            ...
                            <td class="label">
                                <!-- 预留字段1 -->
                                <bean:message bundle="equipmentsecurityresponse"
                                              key="equipmentSecurityResponseLink.linkExtend4"/>
                            </td>
                            <td class="content">
                        ...
                        <tr>
                            ...
                            <td class="label">
                                <!-- 预留字段1 -->
                                <bean:message bundle="equipmentsecurityresponse"
                                              key="equipmentSecurityResponseLink.linkExtend5"/>
                            </td>
                            <td class="content">
                        ...
                        <tr>
                            ...
                            <td class="label">
                                <!-- 回复对象 -->
                                <bean:message bundle="equipmentsecurityresponse"
                                              key="equipmentSecurityResponseLink.linkReplyObj"/>
                            </td>
                            <td class="content">
                            ...
                            <td class="label">
                                <!-- 回复说明 -->
                                <bean:message bundle="equipmentsecurityresponse"
                                              key="equipmentSecurityResponseLink.linkReplyExp"/>
                            </td>
                            <td class="content">
                        ...
                        <tr>
                            ...
                            <td class="label">
                                <!-- 采取措施的时间点 -->
                                <bean:message bundle="equipmentsecurityresponse"
                                              key="equipmentSecurityResponseLink.linkMeasuresTime"/>
                            </td>
                            <td class="content">

                                    ${eoms:date2String(baselink.linkMeasuresTime)}


                            <td class="label">
                                <!-- 故障消除时间 -->
                                <bean:message bundle="equipmentsecurityresponse"
                                              key="equipmentSecurityResponseLink.linkRemoveTime"/>
                            </td>
                            <td class="content">

                                    ${eoms:date2String(baselink.linkRemoveTime)}
                        ...
                        <tr>
                            ...
                            <td class="label">
                                <!-- 故障原因 -->
                                <bean:message bundle="equipmentsecurityresponse"
                                              key="equipmentSecurityResponseLink.linkFaultCause"/>
                            </td>
                            <td class="content">

                                <pre>${baselink.linkFaultCause}</pre>
                            </td>
                            ...
                            <td class="label">
                                <!-- 处理措施 -->
                                <bean:message bundle="equipmentsecurityresponse"
                                              key="equipmentSecurityResponseLink.linkDealMeasures"/>
                            </td>
                            <td class="content">

                                <pre>${baselink.linkDealMeasures}</pre>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="label">
                                <!-- 是否为最终解决方案 -->
                                <bean:message bundle="equipmentsecurityresponse"
                                              key="equipmentSecurityResponseLink.linkIfSolution"/>
                            </td>
                            <td class="content">

                                <pre>${baselink.linkIfSolution}</pre>
                            </td>
                            ...
                            <td class="label">
                                <!-- 备注 -->
                                <bean:message bundle="equipmentsecurityresponse"
                                              key="equipmentSecurityResponseLink.linkRemark"/>
                            </td>
                            <td class="content">
                        ...
                        <tr>
                            ...
                            <td class="label">
                                <!-- 质检结果 -->
                                <bean:message bundle="equipmentsecurityresponse"
                                              key="equipmentSecurityResponseLink.linkQualityResult"/>
                            </td>
                            <td class="content">
                            ...
                            <td class="label">
                                <!-- 质检概述 -->
                                <bean:message bundle="equipmentsecurityresponse"
                                              key="equipmentSecurityResponseLink.linkQualityView"/>
                            </td>
                            <td class="content">
...
<script type="text/javascript">
    ...
    function copy(id) {
        ...
        if (ifCheck.checked == true) {
            Ext.Ajax.request({
                method: "get",
                url: "equipmentsecurityresponse.do?method=getJsonLink&id=" + id + "&beanName=EquipmentSecurityResponse",
                success: function (x) {
