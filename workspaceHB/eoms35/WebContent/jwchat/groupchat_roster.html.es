...
<html>
    <head>
        ...
        <script>
            ...
            var optidx = 1;
            list_selector.options[optidx++] = new Option("Voz","role=participant&http://jabber.org/protocol/muc#admin&"+msgEscape("Lista de Voz"));
            if (affiliation == 'admin' || affiliation == 'owner') {
            list_selector.options[optidx++] = new Option("Bloqueados","affiliation=outcast&http://jabber.org/protocol/muc#admin&"+msgEscape("Lista de bloqueados"));
            list_selector.options[optidx++] = new Option("Miembros","affiliation=member&http://jabber.org/protocol/muc#admin&"+msgEscape("Lista de Miembros"));
            list_selector.options[optidx++] = new Option("Moderadores","role=moderator&http://jabber.org/protocol/muc#admin&"+msgEscape("Lista de Moderadores"));
        }
            // add even more
            if (affiliation == 'owner'){
            list_selector.options[optidx++] = new Option("Administradores","affiliation=admin&http://jabber.org/protocol/muc#owner&"+msgEscape("Administrar Lista"));
            list_selector.options[optidx++] = new Option("Propietarios","affiliation=owner&http://jabber.org/protocol/muc#owner&"+msgEscape("Propietario de la Lista"));
        }
            // show list
    ...
    <body style="margin:8px;">
        <table width="100%" height="100%" style="margin: 0px; padding: 0px; border: 0;">
            <tr>
                <td height="100%" width="100%">
                    <iframe src="groupchat_iroster.html" id="groupchatIRoster" name="groupchatIRoster" scrolling="auto"
        ...
        <tr id="list_editor" style="display:none;">
            <td width="100%">
                <div style="font-size: 0.8em;">Modificar Lista</div>
