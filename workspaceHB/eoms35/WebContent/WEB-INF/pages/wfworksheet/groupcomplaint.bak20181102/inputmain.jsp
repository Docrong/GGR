...
<table id="sheet" class="formTable">
    <c:if test="${status!=1}">
        ...
        <tr>
            ...
            <td colspan="3">
                <eoms:comboBox name="${sheetPageName}bservType" id="${sheetPageName}bservType" initDicId="1011002"
        ...
        <tr>
            ...
            <td>
                <input type="text" class="text" name="${sheetPageName}customNo" id="${sheetPageName}customNo"
                       value="${sheetMain.customNo}" alt="allowBlank:true,maxLength:25,vtext:'集团编号，最多输入25字符'"/>
            </td>
            ...
            <td>
                <input type="text" class="text" name="${sheetPageName}customName" id="${sheetPageName}customName"
                       value="${sheetMain.customName}" alt="allowBlank:true,maxLength:64,vtext:'集团名称，最多输入64字符'"/>
        ...
        <tr>
            ...
            <td>
                <eoms:comboBox name="${sheetPageName}bservType" id="${sheetPageName}customLevel" initDicId="1011047"
                               defaultValue="${sheetMain.customLevel}" alt="allowBlank:ture"/>
            </td>
            <td class="label"><bean:message bundle="group" key="groupcomplaint.provinceName"/></td>
            <td>
                <input type="text" class="text" name="${sheetPageName}provinceName" id="${sheetPageName}provinceName"
                       value="${sheetMain.provinceName}" alt="allowBlank:true,maxLength:64,vtext:'所属省份，最多输入64字符'"/>
        ...
        <tr>
            ...
            <td>
                <input type="text" class="text" name="${sheetPageName}cityName" id="${sheetPageName}cityName"
                       value="${sheetMain.cityName}" alt="allowBlank:true,maxLength:64,vtext:'所属地市，最多输入64字符'"/>
            </td>
            <td class="label"><bean:message bundle="group" key="groupcomplaint.countyName"/></td>
            <td>
                <input type="text" class="text" name="${sheetPageName}countyName" id="${sheetPageName}countyName"
                       value="${sheetMain.countyName}" alt="allowBlank:true,maxLength:64,vtext:'所属区县，最多输入64字符'"/>
        ...
        <tr>
            ...
            <td>
                <input type="text" class="text" name="${sheetPageName}bdeptContact" id="${sheetPageName}bdeptContact"
                       value="${sheetMain.bdeptContact}" alt="allowBlank:true,maxLength:25,vtext:'集客部联系人，最多输入25字符'"/>
            </td>
            ...
            <td>
                <input type="text" class="text" name="${sheetPageName}bdeptContactPhone"
                       ...
                       alt="allowBlank:true,maxLength:50,vtext:'集客部联系人联系电话，最多输入50字符'"/>
        ...
        <tr>
            ...
            <td>
                <input type="text" class="text" name="${sheetPageName}cmanagerPhone" id="${sheetPageName}cmanagerPhone"
                       value="${sheetMain.cmanagerPhone}" alt="allowBlank:true,maxLength:25,vtext:'客户经理，最多输入25字符'"/>
            </td>
            ...
            <td>
                <input type="text" class="text" name="${sheetPageName}cmanagerContactPhone"
                       ...
                       alt="allowBlank:true,maxLength:50,vtext:'客户经理联系电话，最多输入50字符'"/>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <input type="text" class="text" name="${sheetPageName}customContact" id="${sheetPageName}customContact"
                       value="${sheetMain.customContact}" alt="allowBlank:true,maxLength:25,vtext:'集团客户联系人，最多输入25字符'"/>
            </td>
            ...
            <td>
                <input type="text" class="text" name="${sheetPageName}customContactPhone"
                       ...
                       alt="allowBlank:true,maxLength:50,vtext:'集团客户联系电话，最多输入50字符'"/>
            </td>
        </tr>
        <tr>
            ...
            <td colspan="3">
                <input type="text" class="text" name="${sheetPageName}productName" id="${sheetPageName}productName"
                       value="${sheetMain.productName}" alt="allowBlank:true,maxLength:254,vtext:'产品名称，最多输入254字符'"/>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <input type="text" class="text" name="${sheetPageName}customAttribution"
                       id="${sheetPageName}customAttribution" value="${sheetMain.customAttribution}"
                       alt="allowBlank:true,maxLength:64,vtext:'用户归属地，最多输入64字符'"/>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <input type="text" class="text" name="${sheetPageName}complaintNum" id="${sheetPageName}complaintNum"
                       value="${sheetMain.complaintNum}" alt="allowBlank:true,maxLength:50,vtext:'故障号码，最多输入50字符'"/>
            </td>
            ...
            <td>
                <input type="text" class="text" name="${sheetPageName}complaintLoca" id="${sheetPageName}complaintLoca"
                       value="${sheetMain.complaintLoca}" alt="allowBlank:true,maxLength:20,vtext:'故障地点，最多输入20字符'"/>
            </td>
        </tr>
        </tr>
        <tr>
            ...
            <td colspan="3">
                <input type="text" class="text" name="${sheetPageName}termType" id="${sheetPageName}termType"
                       value="${sheetMain.termType}" alt="allowBlank:true,maxLength:254,vtext:'终端描述，最多输入254字符'"/>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td colspan="3">
                <textarea name="preDealResult" id="preDealResult" class="textarea max"
                          alt="allowBlank:true,maxLength:1000,vtext:'预处理情况，最多输入500汉字'">${sheetMain.preDealResult}</textarea>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <input type="text" class="text" name="${sheetPageName}enterpriseCode"
                       ...
                       alt="allowBlank:true,maxLength:64,vtext:'企业代码，最多输入64字符'"/>
            ...
            <td>
                <input type="text" class="text" name="${sheetPageName}serverCode" id="${sheetPageName}serverCode"
                       value="${sheetMain.serverCode}" alt="allowBlank:true,maxLength:64,vtext:'服务代码，最多输入64字符'"/>
        ...
        <tr>
            ...
            <td>
                <input type="text" class="text" name="${sheetPageName}apnName" id="${sheetPageName}apnName"
                       value="${sheetMain.apnName}" alt="allowBlank:true,maxLength:64,vtext:'APN名称，最多输入64字符'"/>
            ...
            <td>
                <input type="text" class="text" name="${sheetPageName}circuitCode" id="${sheetPageName}circuitCode"
                       value="${sheetMain.circuitCode}" alt="allowBlank:true,maxLength:32,vtext:'传输专线电路代号，最多输入32字符'"/>
