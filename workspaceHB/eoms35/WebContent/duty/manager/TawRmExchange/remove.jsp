...
<td><html:form method="POST" action="/TawRmExchange/trash">
        <input type="hidden" name="roomId" value="<bean:write name="tawRmExchangeForm" property="roomId" scope="request"/>">
        <input type="hidden" name="id" value="<bean:write name="tawRmExchangeForm" property="id" scope="request"/>">
