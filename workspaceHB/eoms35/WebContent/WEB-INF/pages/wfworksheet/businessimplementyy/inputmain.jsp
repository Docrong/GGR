        ...
        <tr>
            ...
            <td class="content">
                <input type="text" class="text" name="${sheetPageName}businesBelongCity"
                       id="${sheetPageName}businesBelongCity" alt="allowBlank:false"/>
            </td>
        </tr>
        <!-- old end-->
        <tr>
            ...
            <td class="content">
                <input type="text" class="text" name="${sheetPageName}customManagerMail"
                       id="${sheetPageName}customManagerMail" alt="allowBlank:false"/>
            </td>
...
<fieldset id="link2">
    ...
    <table class="formTable">
        ...
        <tr>
            ...
            <td class="content">
                <input type="text" class="text" name="${sheetPageName}productSN" id="${sheetPageName}productSN"
                       alt="allowBlank:true"/>
            </td>
