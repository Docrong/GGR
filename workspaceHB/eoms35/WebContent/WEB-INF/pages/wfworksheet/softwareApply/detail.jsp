...
<%@page
        import="com.boco.eoms.sheet.softwareApply.model.SoftwareApplyTask" %>
<%@page
...
<%
    ...
    SoftwareApplyTask task = new SoftwareApplyTask();
    String operaterType = "";
    String ifsub = "";
    String ifwaitfor = "";
    if (request.getAttribute("task") != null) {
        task = (SoftwareApplyTask) request.getAttribute("task");
...
<script type="text/javascript">
    Ext.onReady(function () {
        var tabConfig = {
            items: [{
                ...
                url: 'softwareApply.do?method=showSheetDealList&orderByDetp=true&sheetKey=${sheetMain.id}&taskName=${taskName}&ifWaitForSubTask=${task.ifWaitForSubTask}'
            }, {
                text: '<bean:message bundle="sheet" key="sheet.flowchar"/>',
                url: 'softwareApply.do?method=showWorkFlow&linkServiceName=iSoftwareApplyLinkManager&dictSheetName=dict-sheet-softwareApply&description=mainOperateType&sheetKey=${sheetMain.id}',
                isIframe: true
            }, {
                text: '<bean:message bundle="sheet" key="sheet.filesView"/>',
                url: 'softwareApply.do?method=showSheetAccessoriesList&id=${sheetMain.id}',
                isIframe: true
            }, {
        ...
        var url2 = "softwareApply.do?method=newShowCCPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}&operateType=-10&taskStatus=${taskStatus}";
        eoms.util.appendPage("sheet-deal-content", url2);
        <%}%>
        <%if(taskName.equals("reply")){ %>
        var url2 = "softwareApply.do?method=showRemarkPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}";
        eoms.util.appendPage("sheet-deal-content", url2);
        <%}%>
    ...
    function forceOperation(obj) {
        ...
        if (obj == 1) {
            ...
            var url2 = "softwareApply.do?method=showForceHoldPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}&operateType=forceHold";
            eoms.util.appendPage("sheet-deal-content", url2);

        } else if (obj == 2) {

            var url2 = "softwareApply.do?method=showForceHoldPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}&operateType=nullity";
            eoms.util.appendPage("sheet-deal-content", url2);
        } else {

            var url2 = "softwareApply.do?method=showForceHoldPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}&operateType=forceNullity";
            eoms.util.appendPage("sheet-deal-content", url2);
        }
    }
    ...
    function eventOperation(obj) {
        if (obj == 1) {
            var url2 = "softwareApply.do?method=showPhaseAdvicePage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&taskName=advice&operateFlag=driveForward&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}";
...
<div id="sheet-detail-page"><!-- Sheet Detail Tab Start -->
    <div id="sheetinfo"><logic:present name="sheetMain"
                                       scope="request">
        <%@ include
                file="/WEB-INF/pages/wfworksheet/softwareApply/basedetailnew.jsp" %>
        <br/>
        <table class="formTable">
            <caption></caption>
            <tr>
                <td class="label"><bean:message bundle="sheet"
                                                key="mainForm.acceptLimit"/></td>
                <td class="content">
                        ${eoms:date2String(sheetMain.sheetAcceptLimit)}</td>
                <td class="label"><bean:message bundle="sheet"
                                                key="mainForm.completeLimit"/></td>
                <td class="content">
                        ${eoms:date2String(sheetMain.sheetCompleteLimit)}</td>
            </tr>
            <tr>
                <td class="label"><bean:message bundle="softwareApply"
                                                key="softwareApply.mainmanufacturer"/></td>
                <td class="content"><eoms:id2nameDB
                        id="${sheetMain.mainmanufacturer}" beanId="ItawSystemDictTypeDao"/>
                </td>
                <td class="label"><bean:message bundle="softwareApply"
                                                key="softwareApply.mainnetsystem"/></td>
                <td class="content"><eoms:id2nameDB
                        id="${sheetMain.mainnetsystem}" beanId="ItawSystemDictTypeDao"/></td>
            </tr>
            <tr>
                <td class="label"><bean:message bundle="softwareApply"
                                                key="softwareApply.mainsoftwaretype"/></td>
                <td class="content"><eoms:id2nameDB
                        id="${sheetMain.mainsoftwaretype}" beanId="ItawSystemDictTypeDao"/>
                </td>
                <td class="label"><bean:message bundle="softwareApply"
                                                key="softwareApply.mainisnetwork"/></td>
                <td class="content"><eoms:id2nameDB
                        id="${sheetMain.mainisnetwork}" beanId="ItawSystemDictTypeDao"/></td>
            </tr>
            <c:if test="${sheetMain.mainsoftwaretype==101150301 }">
                <tr>
                    <td class="label"><bean:message bundle="softwareApply"
                                                    key="softwareApply.mainoldedition"/></td>
                    <td class="content"><bean:write name="sheetMain"
                                                    property="mainoldedition" scope="request"/></td>
                    <td class="label"><bean:message bundle="softwareApply"
                                                    key="softwareApply.mainNewedition"/></td>
                    <td class="content"><bean:write name="sheetMain"
                                                    property="mainNewedition" scope="request"/></td>
                </tr>
            </c:if>
            <c:if test="${sheetMain.mainsoftwaretype==101150302 }">
                <tr>
                    <td class="label"><bean:message bundle="softwareApply"
                                                    key="softwareApply.mainmendedition"/></td>
                    <td class="content"><bean:write name="sheetMain"
                                                    property="mainmendedition" scope="request"/></td>
                    <td class="label"><bean:message bundle="softwareApply"
                                                    key="softwareApply.mainnewmend"/></td>
                    <td class="content"><bean:write name="sheetMain"
                                                    property="mainnewmend" scope="request"/></td>
                </tr>
            </c:if>
            <tr>
                <td class="label"><bean:message bundle="softwareApply"
                ...
                <td class="content"><bean:write name="sheetMain"
                                                property="maintesttime" scope="request"/></td>
                <td class="label"><bean:message bundle="softwareApply"
                                                key="softwareApply.maintestadd"/></td>
                <td class="content"><bean:write name="sheetMain"
                                                property="maintestadd" scope="request"/></td>
            </tr>
            <tr>
                <td class="label"><bean:message bundle="softwareApply"
                                                key="softwareApply.mainstartconfertime"/></td>
                <td class="content"><bean:write name="sheetMain"
                                                property="mainstartconfertime" scope="request"/></td>
                <td class="label"><bean:message bundle="softwareApply"
                                                key="softwareApply.mainendconfertime"/></td>
                <td class="content"><bean:write name="sheetMain"
                                                property="mainendconfertime" scope="request"/></td>
            </tr>
            <tr>
                <td class="label"><bean:message bundle="softwareApply"
                                                key="softwareApply.mainistest"/></td>
                <td class="content"><eoms:id2nameDB id="${sheetMain.mainistest}"
                                                    beanId="ItawSystemDictTypeDao"/></td>
                <td class="label"><bean:message bundle="softwareApply"
                                                key="softwareApply.maininstancy"/></td>
                <td class="content"><eoms:id2nameDB
                        id="${sheetMain.maininstancy}" beanId="ItawSystemDictTypeDao"/></td>
            </tr>
            <tr>
                <td class="label"><bean:message bundle="softwareApply"
                                                key="softwareApply.mainisimbark"/></td>
                <td class="content"><eoms:id2nameDB
                        id="${sheetMain.mainisimbark}" beanId="ItawSystemDictTypeDao"/></td>
                <c:if test="${sheetMain.mainisimbark==1030101 }">
                    <td class="label"><bean:message bundle="softwareApply"
                                                    key="softwareApply.mainintendingtime"/></td>
                    <td class="content"><bean:write name="sheetMain"
                                                    property="mainintendingtime" scope="request"/></td>
                </c:if>
            </tr>
            ...
            <tr>
                ...
                <td class="content"><eoms:id2nameDB
                        id="${sheetMain.mainishardware}" beanId="ItawSystemDictTypeDao"/></td>
                <td class="label"><bean:message bundle="softwareApply"
                                                key="softwareApply.mainissecurity"/></td>
                <td class="content"><eoms:id2nameDB
                        id="${sheetMain.mainissecurity}" beanId="ItawSystemDictTypeDao"/></td>
            </tr>
            <tr>
                <td class="label"><bean:message bundle="softwareApply"
                                                key="softwareApply.mainisnetchange"/></td>
                <td class="content"><eoms:id2nameDB
                        id="${sheetMain.mainisnetchange}" beanId="ItawSystemDictTypeDao"/>
                </td>
                <td class="label"><bean:message bundle="softwareApply"
                                                key="softwareApply.mainnetcriterion"/></td>
                <td class="content"><eoms:id2nameDB
                        id="${sheetMain.mainnetcriterion}" beanId="ItawSystemDictTypeDao"/>
                </td>
            </tr>
            <tr>
                <td class="label"><bean:message bundle="softwareApply"
                                                key="softwareApply.mainsystemtext"/></td>
                <td colspan="3"><bean:write name="sheetMain"
                                            property="mainsystemtext" scope="request"/></td>
            </tr>
            <tr>
                <td class="label"><bean:message bundle="softwareApply"
                                                key="softwareApply.maincompatibility"/></td>
                <td colspan="3"><bean:write name="sheetMain"
                                            property="maincompatibility" scope="request"/></td>
            </tr>
            <tr>
                <td class="label"><bean:message bundle="softwareApply"
                                                key="softwareApply.maintext"/></td>
                <td colspan="3"><bean:write name="sheetMain" property="maintext"
                                            scope="request"/></td>
            </tr>
            <tr>
                <td class="label"><bean:message bundle="softwareApply"
                ...
                <td colspan="3"><bean:write name="sheetMain"
                                            property="mainsoftwarechargeinfo" scope="request"/></td>
            </tr>
            <tr>
                <td class="label"><bean:message bundle="softwareApply"
                                                key="softwareApply.maintestuser"/></td>
                <td colspan="3"><bean:write name="sheetMain"
                                            property="maintestuser" scope="request"/></td>
            </tr>
            <tr>
                <td class="label"><bean:message bundle="softwareApply"
                                                key="softwareApply.mainaccessoriesinfo"/></td>
                <td colspan="3"><bean:write name="sheetMain"
                                            property="mainaccessoriesinfo" scope="request"/></td>
            </tr>
            <tr>
                <td class="label"><bean:message bundle="sheet"
                ...
                <td colspan='3'><eoms:attachment name="sheetMain"
                                                 ...
                                                 idField="sheetAccessories" appCode="commontask" viewFlag="Y"/></td>
            </tr>
        </table>
    </logic:present></div>
...
<c:url var="urlShowAssessorDealPage" value="softwareApply.do">
...
<c:url var="urlShowValidateTaskDealPage" value="softwareApply.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<c:url var="urlShowBatchTaskDealPage" value="softwareApply.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 草稿派发 -->
<c:url var="urlShowDraftDeal" value="softwareApply.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 重新派发 -->
<c:url var="urlShowBackDeal" value="softwareApply.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 归档 -->
<c:url var="urlShowHoldDealPage" value="softwareApply.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 退回 -->
<c:url var="urlShowRejectBackDealPage" value="softwareApply.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 转派 -->
<c:url var="urlShowTransferkPage" value="softwareApply.do">
...
<!-- 转审 -->
<c:url var="urlShowTransferAuditPage" value="softwareApply.do">
    <c:param name="method" value="showTransferWorkItemPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 阶段回复 -->
<c:url var="urlShowPhaseReplyPage" value="softwareApply.do">
...
<!-- 驳回 -->
<c:url var="urlShowRejectBackPage" value="softwareApply.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 确认受理 -->
<c:url var="urlShowAcceptDealPage" value="softwareApply.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 分派 -->
<c:url var="urlShowInputSplit" value="softwareApply.do">
...
<!-- 会审 -->
<c:url var="urlShowInputSplitAudit" value="softwareApply.do">
    <c:param name="method" value="showInputSplit"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 分派回复 -->
<c:url var="urlShowDispatchPage" value="softwareApply.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
    <c:param name="taskName" value="${taskName}"/>
    <c:param name="subtaskName" value="SoftwareApplySubTask"/>
    <c:param name="operateRoleId" value="${operateRoleId}"/>
    <c:param name="TKID" value="${TKID}"/>
    <c:param name="taskStatus" value="${taskStatus}"/>
    <c:param name="preLinkId" value="${preLinkId}"/>
...
<!-- 会审回复 -->
<c:url var="urlShowDispatchAuditPage" value="softwareApply.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 处理回复通过 -->
<c:url var="urlShowDealReplyAcceptPage" value="softwareApply.do">
...
<!-- 处理回复不通过 -->
<c:url var="urlShowDealReplyRejectPage" value="softwareApply.do">
            ...
            <tr>
                ...
                %> <select id="dealSelector">
                    ...
                    <%
                        if (ifwaitfor.equals("false")) {
                    %>
                    <option value="${urlShowValidateTaskDealPage}">提交验证</option>
                ...
                %> <select id="dealSelector">
                    ...
                    <%
                        if (ifwaitfor.equals("false")) {
                    %>
                    <option value="${urlShowBatchTaskDealPage}">提交批复</option>
                    <!--			    <option value="${urlShowRejectBackPage}"><bean:message bundle="sheet" key="common.rejectBack"/></option>	   -->
                    <!--	  		    <option value="${urlShowPhaseReplyPage}"><bean:message bundle="sheet" key="event.reply"/></option>-->
                    <!--			     <option value="${urlShowTransferkPage}"><bean:message bundle="sheet" key="common.transfer"/></option>-->
                ...
                %> <select id="dealSelector">
                    <option value="${urlShowDraftDeal}"><bean:message
                            bundle="softwareApply" key="operateType.draft"/></option>
                </select> <%
                } else if (taskName.equals("RejectTask")) {
                %> <select id="dealSelector">
                    <option value="${urlShowBackDeal}"><bean:message
                            bundle="sheet" key="common.reSend"/></option>
                </select> <%
                } else if (taskName.equals("HoldTask")) {
                %> <select id="dealSelector">
                    <option value="${urlShowHoldDealPage}"><bean:message
                            bundle="softwareApply" key="operateType.hold"/></option>
                </select> <%
                    }
                %>
                </td>
...
<script type="text/javascript">
    Ext.onReady(function () {
        ...
        if (dealTemplateId != null && dealTemplateId != "") {
            url = "softwareApply.do?method=referenceTemplate&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&taskName=${taskName}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&operateType=${operateType}&taskStatus=${taskStatus}&dealTemplateId=" + dealTemplateId
        }
...
<c:if test="${sheetMain.status==0}">
    ...
    <%
    } else if (taskStatus.equals("5") && !taskName.equals("cc")
