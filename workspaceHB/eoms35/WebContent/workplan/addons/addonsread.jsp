    ...
    <table class="table_show">
        ...
        <tr>
            <td colspan="10">
                ...
                <input type="button" value="<bean:message key="addonsread.title.btnClose" />" name="B2"
                       Onclick="Close();" class="button">
                <%} else {%>
                <input type="button" value="<bean:message key="addonsread.title.btnBack" />" name="B2"
