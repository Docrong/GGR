...
<script type="text/javascript">
    ...
    function dispre(input) {
        ...
        } else if (input != null && input == '101250102') {
            v2.enableArea('edit');
            v2.disableArea('new', true);
            v2.disableArea('del', true);
        } else if (input != null && input == '101250103') {
            v2.enableArea('del');
            v2.disableArea('new', true);
            v2.disableArea('edit', true);
        } else {
...
<table class="formTable">
    ...
    <tr>
        ...
        <td>
            <eoms:comboBox name="${sheetPageName}spareOne" id="${sheetPageName}spareOne"
                           defaultValue="${sheetMain.spareOne}"
        ...
        <td colspan="4">
            <table class="formTable">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="text" name="abbreviation" id="abbreviation"
                               alt="allowBlank:false,maxLength:28,vtext:'请填入 EC/SI简称 信息，最多输入 14 字符'"
                               value="${sheetMain.abbreviation}"/></br>
                    ...
                    <td>
                        <input type="text" class="text" name="enterpriseCode" id="enterpriseCode"
                               alt="vtype:'number',allowBlank:false,maxLength:64,vtext:'请填入 企业代码 信息，最多输入 64 数字'"
                               value="${sheetMain.enterpriseCode}"/></br>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="text" name="serviceCode" id="serviceCode"
                               alt="vtype:'number',allowBlank:false,maxLength:64,vtext:'请填入 EC/SI服务代码 信息，最多输入 64 数字'"
                               value="${sheetMain.serviceCode}"/></br>
                        <span style="color:red">数字格式，不得有空格或回车</span>
                    </td>
                    <td class="label">
                        <!-- 客户服务器IP -->
                    ...
                    <td>
                        <input type="text" class="text" name="cilentServerIpAddr" id="cilentServerIpAddr"
                               alt="allowBlank:false,maxLength:16,vtext:'请填入 客户服务器IP 信息，最多输入 16 字符'"
                               value="${sheetMain.cilentServerIpAddr}"/></br>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="text" name="proportion"
                               alt="allowBlank:false,maxLength:255,vtext:'请填入 是否为多IP 信息，最多输入 255 字符'"/></br>
                        <span style="color:red">不得带空格、回车或汉字描述</span>
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="text" name="userValue" id="userValue"
                               alt="allowBlank:false,maxLength:40,vtext:'请填入 登录网关用户名 信息，最多输入 40 字符'"
                               value="${sheetMain.userValue}"/></br>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="text" name="passwordValue" id="passwordValue"
                               alt="allowBlank:false,maxLength:40,vtext:'请填入 登录网关密码 信息，最多输入 40 字符'"
                               value="${sheetMain.passwordValue}"/></br>
                    ...
                    <td>
                        <input type="text" class="text" name="maxConnections" id="maxConnections"
                               alt="vtype:'number',allowBlank:false,maxLength:10,vtext:'请填入 最大连接数 信息，最多输入 10 数字'"
                               value="${sheetMain.maxConnections}"/></br>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="text" name="maxInBytes" id="maxInBytes"
                               alt="vtype:'number',allowBlank:false,maxLength:10,vtext:'请填入 最大下发流量 信息，最多输入 10 数字'"
                               value="${sheetMain.maxInBytes}"/></br>
                        <span style="color:red">数字格式，不得有空格或回车</span>
                    </td>
                    <td class="label">
                        <!-- 最大上行流量 -->
                    ...
                    <td>
                        <input type="text" class="text" name="maxOutBytes" id="maxOutBytes"
                               alt="vtype:'number',allowBlank:false,maxLength:10,vtext:'请填入 最大上行流量 信息，最多输入 10 数字'"
                               value="${sheetMain.maxOutBytes}"/></br>
                        <span style="color:red">数字格式，不得有空格或回车</span>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="text" name="seviceContact" id="seviceContact"
                               alt="allowBlank:false,maxLength:32,vtext:'请填入 业务联系人 信息，最多输入 32 字符'"
                               value="${sheetMain.seviceContact}"/>
                    </td>
                    <td class="label">
                        <!-- 业务联系电话 -->
                    ...
                    <td>
                        <input type="text" class="text" name="sevicePhone" id="sevicePhone"
                               alt="allowBlank:false,maxLength:32,vtext:'请填入 业务联系电话 信息，最多输入 32 字符'"
                               value="${sheetMain.sevicePhone}"/>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="text" name="customerContact" id="customerContact"
                               alt="allowBlank:false,maxLength:32,vtext:'请填入 客户联系人 信息，最多输入 32 字符'"
                               value="${sheetMain.customerContact}"/>
                    </td>
                    <td class="label">
                        <!-- 客户联系电话 -->
                    ...
                    <td>
                        <input type="text" class="text" name="customerPhone" id="customerPhone"
                               alt="allowBlank:false,maxLength:32,vtext:'请填入 客户联系电话 信息，最多输入 32 字符'"
                               value="${sheetMain.customerPhone}"/>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="text" name="hardwareModel" id="hardwareModel"
                               alt="allowBlank:false,maxLength:32,vtext:'请填入 硬件型号 信息，最多输入 32 字符'"
                               value="${sheetMain.hardwareModel}"/>
                    </td>
                    <td class="label">
                        <!-- 软件版本 -->
                    ...
                    <td>
                        <input type="text" class="text" name="softVersion" id="softVersion"
                               alt="allowBlank:false,maxLength:32,vtext:'请填入 软件版本 信息，最多输入 32 字符'"
                               value="${sheetMain.softVersion}"/>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="text" name="integrator" id="integrator"
                               alt="allowBlank:false,maxLength:128,vtext:'请填入 集成商 信息，最多输入 128 字符'"
                               value="${sheetMain.integrator}"/>
                    </td>
                    <td class="label">
                        <!-- 是否为加急流程 -->
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="text" name="groupNumber" id="groupNumber"
                               alt="maxLength:64,vtext:'请填入 集团批复工单号 信息，最多输入 64 字符'" value="${sheetMain.groupNumber}"/>
                    </td>
                    <td class="label">
                        <!-- MASID -->
                    ...
                    <td>
                        <input type="text" class="text" name="masId" id="masId"
                               alt="allowBlank:false,maxLength:64,vtext:'请填入 MASID 信息，最多输入 64 字符'"
                               value="${sheetMain.masId}"/>
                    </td>
                </tr>
        ...
        <td colspan="4">
            <table class="formTable">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="text" name="abbreviation" id="abbreviation"
                               alt="maxLength:28,vtext:'请填入 EC/SI简称 信息，最多输入 14 字符'"
                               value="${sheetMain.abbreviation}"/></br>
                        <span style="color:red">总长不超过14个汉字，不得有空格或回车</span>
                    </td>
                    <td class="label">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="text" name="userValue" id="userValue"
                               alt="vtype:'number',allowBlank:false,maxLength:40,vtext:'请填入 登录网关用户名 信息，最多输入 40 数字'"
                               value="${sheetMain.userValue}"/></br>
                        <span style="color:red">数字格式，不得有空格或回车，必须与企业代码相同</span>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="text" name="passwordValue" id="passwordValue"
                               alt="maxLength:40,vtext:'请填入 登录网关密码 信息，最多输入 40 字符'"
                               value="${sheetMain.passwordValue}"/></br>
                        <span style="color:red">长度6-10位，不得有空格或回车，必须包含大写、小写和数字，不可包含特殊字符</span>
                    </td>
                    <td class="label">
                    ...
                    <td>
                        <input type="text" class="text" name="maxConnections" id="maxConnections"
                               alt="vtype:'number',maxLength:10,vtext:'请填入 最大连接数 信息，最多输入 10 数字'"
                               value="${sheetMain.maxConnections}"/></br>
                        <span style="color:red">数字格式，不得有空格或回车，不得大于15</span>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="text" name="maxInBytes" id="maxInBytes"
                               alt="vtype:'number',maxLength:10,vtext:'请填入 最大下发流量 信息，最多输入 10 数字'"
                               value="${sheetMain.maxInBytes}"/></br>
                        <span style="color:red">数字格式，不得有空格或回车</span>
                    </td>
                    <td class="label">
                    ...
                    <td>
                        <input type="text" class="text" name="maxOutBytes" id="maxOutBytes"
                               alt="vtype:'number',maxLength:10,vtext:'请填入 最大上行流量 信息，最多输入 10 数字'"
                               value="${sheetMain.maxOutBytes}"/></br>
                        <span style="color:red">数字格式，不得有空格或回车</span>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="text" name="isUrgentValue" id="isUrgentValue" readonly="readonly"
                               value="否"/>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="text" name="abbreviationNew" id="abbreviationNew"
                               alt="maxLength:28,vtext:'请填入 EC/SI简称(新) 信息，最多输入 14 字符'"
                               value="${sheetMain.abbreviationNew}"/></br>
                        <span style="color:red">总长不超过14个汉字，不得有空格或回车</span>
                    </td>
                    <td class="label">
                        <!-- EC/SI使用协议(新) -->
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="text" name="cilentServerIpAddrNew" id="cilentServerIpAddrNew"
                               alt="maxLength:16,vtext:'请填入 客户服务器IP(新) 信息，最多输入 16 字符'"
                               value="${sheetMain.cilentServerIpAddrNew}"/></br>
                        <span style="color:red">不得带空格、回车或汉字描述</span>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="text" name="proportionNew"
                               alt="maxLength:255,vtext:'请填入 是否为多IP 信息，最多输入 255 字符'"/></br>
                        <span style="color:red">不得带空格、回车或汉字描述</span>
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="text" name="passwordNew" id="passwordNew"
                               alt="maxLength:40,vtext:'请填入 登录网关密码(新) 信息，最多输入 40 字符'"
                               value="${sheetMain.passwordNew}"/></br>
                        <span style="color:red">长度6-10位，不得有空格或回车，必须包含大写、小写和数字，不可包含特殊字符</span>
                    </td>
                    <td class="label">
                        <!-- 最大连接数(新) -->
                    ...
                    <td>
                        <input type="text" class="text" name="maxConnectionsNew" id="maxConnectionsNew"
                               alt="vtype:'number',maxLength:10,vtext:'请填入 最大连接数(新) 信息，最多输入 10 数字'"
                               value="${sheetMain.maxConnectionsNew}"/></br>
                        <span style="color:red">数字格式，不得有空格或回车，不得大于15</span>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="text" name="maxInBytesNew" id="maxInBytesNew"
                               alt="vtype:'number',maxLength:10,vtext:'请填入 最大下发流量(新) 信息，最多输入 10 数字'"
                               value="${sheetMain.maxInBytesNew}"/></br>
                        <span style="color:red">数字格式，不得有空格或回车</span>
                    </td>
                    <td class="label">
                        <!-- 最大上行流量(新) -->
                    ...
                    <td>
                        <input type="text" class="text" name="maxOutBytesNew" id="maxOutBytesNew"
                               alt="vtype:'number',maxLength:10,vtext:'请填入 最大上行流量(新) 信息，最多输入 10 数字'"
                               value="${sheetMain.maxOutBytesNew}"/></br>
                        <span style="color:red">数字格式，不得有空格或回车</span>
                    </td>
                </tr>
