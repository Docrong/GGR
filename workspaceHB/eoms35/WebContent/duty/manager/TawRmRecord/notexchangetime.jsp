                    ...
                    <tr>
                        <td align="center">
                            ...
                            %>
                                ...
                                <bean:message key="TawRmRecord.notexchangtime2"/><%=strEndTimeDefined%><bean:message
                                        key="TawRmRecord.notexchangtime3"/><%=maxerrortime%><bean:message
                                        key="TawRmRecord.notexchangtime4"/></strong></font>
                        </td>
                    </tr>
                </table>
            </td>
