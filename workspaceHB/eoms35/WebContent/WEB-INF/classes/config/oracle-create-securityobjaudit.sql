...
alter table SECURITYOBJAUDIT_MAIN add constraint SECURITYOBJAUDIT_MAIN_PK primary key (id)  using index;
...
alter table SECURITYOBJAUDIT_TASK add constraint SECURITYOBJAUDIT_TASK_PK primary key (id)  using index;
...
values ('xls,txt,doc,jpg,gif', 'securityobjaudit', '安全对象问题审批工单流程', 1024, '/sheet/securityobjaudit', 31, '40287d8c5ba332e8015ba332e89e0000');

--插入角色
insert into taw_system_role(role_id,deleted,parent_id,role_name,roletype_id,workflow_flag,leaf) values('4301','0','0','建单人','1','43','1');
insert into taw_system_role(role_id,deleted,parent_id,role_name,roletype_id,workflow_flag,leaf) values('4302','0','0','审批人','1','43','1');
insert into taw_system_role(role_id,deleted,parent_id,role_name,roletype_id,workflow_flag,leaf) values('4303','0','0','处理人','1','43','1');
insert into taw_system_role(role_id,deleted,parent_id,role_name,roletype_id,workflow_flag,leaf) values('4304','0','0','质检员','1','43','1');

--插入菜单
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d8c5ba332e8015ba332e89e0001', '4501', '1', '新增工单', '45', null, '/sheet/securityobjaudit/securityobjaudit.do?method=showNewSheetPage', '0', '0', 1);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d8c5ba332e8015ba332e89e0002', '4503', '0', '待处理工单', '45', null, null, '0', '0', 3);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d8c5ba332e8015ba332e89e0003', '450301', '1', '待办工单', '4503', null, '/sheet/securityobjaudit/securityobjaudit.do?method=showListsendundo', '0', '0', 1);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d8c5ba332e8015ba332e89e0004', '4507', '1', '工单查询', '45', null, '/sheet/securityobjaudit/securityobjaudit.do?method=showQueryPage', '0', '0', 7);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d8c5ba332e8015ba332e89e0005', '4508', '1', '工单处理模板', '45', null, '/sheet/securityobjaudit/securityobjaudit.do?method=getDealTemplatesByUserId&&type=templateManage', '0', '0', 8);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d8c5ba332e8015ba332e89e0006', '4509', '1', '工单模板管理', '45', null, '/sheet/securityobjaudit/securityobjaudit.do?method=getTemplatesByUserId&&type=templateManage', '0', '0', 9);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d8c5ba332e8015ba332e89e0007', '4510', '1', '管理者工单', '45', null, '/sheet/securityobjaudit/securityobjaudit.do?method=showListForAdmin', '0', '0', 10);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d8c5ba332e8015ba332e89e0008', '45', '0', '安全对象问题审批工单流程', '10', null, '/sheet/securityobjaudit/securityobjaudit.do?method=showDrawing', '0', '0', 20);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d8c5ba332e8015ba332e89e0009', '4502', '1', '草稿列表', '45', null, '/sheet/securityobjaudit/securityobjaudit.do?method=showDraftList', '0', '0', 2);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d8c5ba332e8015ba332e89e000a', '4504', '0', '已处理工单', '45', null, null, '0', '0', 4);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d8c5ba332e8015ba332e89e000b','450402','1','建立工单','4504', null, '/sheet/securityobjaudit/securityobjaudit.do?method=showOwnStarterList','0','0',2);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d8c5ba332e8015ba332e89e000c', '450401', '1', '处理工单', '4504', null, '/sheet/securityobjaudit/securityobjaudit.do?method=showListsenddone', '0', '0', 1);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d8c5ba332e8015ba332e89e000d', '4505', '1', '已归档工单', '45', null, '/sheet/securityobjaudit/securityobjaudit.do?method=showHoldedList', '0', '0', 5);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d8c5ba332e8015ba332e89e000e', '4506', '1', '已作废工单', '45', null, '/sheet/securityobjaudit/securityobjaudit.do?method=showCancelList', '0', '0', 6);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d8c5ba332e8015ba332e89e000f', '4511', '1', '超时时间设置', '45', null, '/sheet/overtimetip/overtimetip.do?flowName=SecurityObjAudit', '0', '0', 11);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('40287d8c5ba332e8015ba332e89e0010', '4512', '1', '工单处理时限配置', '45', null, '/sheet/newSheetLimit/sheetLimit.do?method=getLevelLimitList&&flowName=SecurityObjAudit', '0', '0', 30);