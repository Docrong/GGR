package com.boco.eoms.sheet.businessdredge.model;

public class BusinessDredge {
    ...
    private String internetIPAdd;

    private String connectRouterIPAdd;
    ...
    public String getConnectRouterIPAdd() {
        return connectRouterIPAdd;
    }

    public void setConnectRouterIPAdd(String connectRouterIPAdd) {
        this.connectRouterIPAdd = connectRouterIPAdd;
    }
    ...
    public String getInternetIPAdd() {
        return internetIPAdd;
    }

    public void setInternetIPAdd(String internetIPAdd) {
        this.internetIPAdd = internetIPAdd;
    }
