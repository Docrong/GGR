...
<table class="formTable">
    ...
    <c:if test="${status!=1}">
        ...
        <tr>
            ...
            <td>
                <eoms:comboBox name="${sheetPageName}netType1" id="${sheetPageName}netType1"
                               sub="${sheetPageName}netType2" initDicId="1010104" defaultValue="${sheetMain.netType1}"
            ...
            <td>
                <eoms:comboBox name="${sheetPageName}netType2" id="${sheetPageName}netType2"
                               sub="${sheetPageName}netType3" initDicId="${sheetMain.netType1}"
                               defaultValue="${sheetMain.netType2}" alt="allowBlank:false"
        ...
        <tr>
            ...
            <td>
                <eoms:comboBox name="${sheetPageName}netType3" id="${sheetPageName}netType3"
                               initDicId="${sheetMain.netType2}" defaultValue="${sheetMain.netType3}"
                               alt="allowBlank:false" onchange="selectLimit(this.value);"/>
            </td>
            <td class="label"></td>
            <td></td>
        ...
        <tr>
            ...
            <td>
                <input type="text" class="text" onclick="popUpCalendar(this, this)" name="${sheetPageName}becomeTime"
                       alt="allowBlank:false" readonly="readonly" id="${sheetPageName}becomeTime"
                       value="${eoms:date2String(sheetMain.becomeTime)}" alt="timer:true"/>
            </td>
            <td class="label"><bean:message bundle="accountpopedomapply" key="accountpopedomapply.abateTime"/>*</td>
            <td>
                <input type="text" class="text" onclick="popUpCalendar(this, this)" name="${sheetPageName}abateTime"
                       alt="allowBlank:false" readonly="readonly" id="${sheetPageName}abateTime"
                       value="${eoms:date2String(sheetMain.abateTime)}" alt="timer:true"/>
            </td>
        </tr>
        <tr>
            <td class="label"><bean:message bundle="accountpopedomapply" key="accountpopedomapply.system"/>*</td>
            <td colspan="3">
                <input type="text" class="text" name="${sheetPageName}system" id="${sheetPageName}system"
                       alt="allowBlank:false" value="${sheetMain.system}"/>
            </td>
        </tr>
        <tr>
            <td class="label"><bean:message bundle="accountpopedomapply" key="accountpopedomapply.applyExplain"/>*</td>
            <td colspan="3">
                <textarea class="textarea max" name="${sheetPageName}applyExplain" id="${sheetPageName}applyExplain"
                          alt="width:500,allowBlank:false">${sheetMain.applyExplain}</textarea>
            </td>
        </tr>
        <tr>
            <td class="label">
            ...
            <td colspan="3">
                <eoms:attachment name="sheetMain" property="sheetAccessories"
                                 ...
                                 appCode="accountpopedomapply" alt="allowBlank:true"/>
            </td>
        </tr>
    </c:if>
</table>
...
<c:if test="${status!=1}">
    <fieldset>
        <legend>
            ...
            <span id="roleName">:<bean:message bundle="accountpopedomapply"
                                               key="accountpopedomapply.role.safetyPerformer"/>
	     	 </span>
        </legend>
