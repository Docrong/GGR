...
<div id="sheetform">
<html:form action="/businessimplementsms.do?method=performDealReplyReject" styleId="theform">
 <%@ include file="/common/taglibs.jsp"%>
<%
 ...
 %>
    ...
    <input type="hidden" name="${sheetPageName}linkClassName" value="com.boco.eoms.sheet.businessimplementsms.model.BusinessImplementSmsLink"/> <!--link表Model对象类名--> 
 	<input type="hidden" name="${sheetPageName}processTemplateName" id="${sheetPageName}processTemplateName" value="BusinessImplementSmsProcess" />
    <input type="hidden" name="${sheetPageName}subtaskName" value="${subtaskName}"/> 
    <input type="hidden" name="${sheetPageName}taskNamespace" value="http://BusinessImplementSmsProcess"/> 
...
<%@ include file="/WEB-INF/pages/wfworksheet/businessimplementsms/baseinputlinkhtmlnew.jsp"%>
     ...
     <tr>
      ...
      <logic:iterate id="toTask" name="acceptList" type="com.boco.eoms.sheet.businessimplementsms.model.BusinessImplementSmsTask">  
        <tr>
          <td>
