...
public class TawwpModelExecuteDaoHibernate extends BaseDaoHibernate implements
     ...
     * 保存作业计划执行内容模板
     *
     * @param _tawwpModelExecute TawwpModelExecute 作业计划模板执行内容类 @ 操作异常
     */
     ...
     * 删除作业计划执行内容模板
     *
     * @param _tawwpModelExecut TawwpModelExecute 作业计划模板执行内容类 @ 操作异常
     */
     ...
     * 查询作业计划执行内容模板
     *
     * @param id String 作业计划模板执行内容标识 @ 操作异常
