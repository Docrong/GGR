    ...
    <script type="text/javascript" defer="defer">
        var config = {
            ...
            ctxMenu: [
                {
                    id: 'newnode',
                    text: '<fmt:message key="kmScoreTree.tree.add"/>',
                    cls: 'new-mi',
                    url: '${app}/kmmanager/kmScoreTrees.do?method=add&nodeId='
                },
                {
                    id: 'edtnode',
                    text: '<fmt:message key="kmScoreTree.tree.edit"/>',
                    cls: 'edit-mi',
                    url: '${app}/kmmanager/kmScoreTrees.do?method=edit&nodeId='
                },
                {
                    id: 'delnode',
                    isDelete: true,
                    text: '<fmt:message key="kmScoreTree.tree.delete"/>',
                    cls: 'remove-mi',
                    url: '${app}/kmmanager/kmScoreTrees.do?method=remove&nodeId='
                }
            ],//end of ctxMenu
            /************************
