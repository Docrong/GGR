...
<table border="0" width="80%" cellspacing="1" cellpadding="1" class="table_show" align=center>
   ...
   <tr class="tr_show">
    ...
    <tr class="tr_show">
                  ...
                  <td width="70%" height="25" colspan="2">
                    <input type="text" value="<%=StaticMethod.null2String(sparepartForm.getProductcode())%>" name="productcode"size="35"  maxlength="40">
                     <font color="#FF0000">**</font>
                  </td>
    </tr>
    <tr class="tr_show">
   ...
   <tr class="tr_show" style="display:none">
    ...
    <tr class="tr_show">
                  ...
                  <td width="70%" height="25" colspan="2">
                    <input type="text" size="35" value="<%=StaticMethod.null2String(sparepartForm.getProposer())%>" name="proposer" >
                  </td>
    </tr>	  
</table>
<table border="0" width="80%" cellspacing="0">
