...
<script type="text/javascript">
    ...
    Ext.onReady(function () {
        ...
        readTree = new xbox({
            ...
            treeRootId: '-1',
            treeRootText: '<bean:message key='threadForm.tree.rotationRead'/>',
            treeChkMode: '',
            treeChkType: 'user,dept,role,subrole',
            showChkFldId: 'showRead',
            saveChkFldId: 'reader',
            viewer: readViewer,
            returnJSON: true
        });
...
<html:form action="/thread.do?method=rotationRead" method="post" styleId="threadForm">
    <table class="formTable middle">
        ...
        <tr>
            ...
            <td class="content">
                <eoms:dict key="dict-workbench-infopub" dictId="threadType" itemId="${threadForm.threadTypeId }"
                           beanId="id2nameXML"/>
            </td>
        </tr>
        <tr>
            ...
            <td class="content">
                <eoms:dict key="dict-workbench-infopub" dictId="reply" itemId="${threadForm.reply }"
                           beanId="id2nameXML"/>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="content">
                ...
                <input type="button" id="clkRead" name="clkRead"
                       value="<bean:message key='threadForm.tree.rotationRead'/>" display="none"/>
        ...
        <tr>
            ...
            <td class="content">
                <eoms:dict key="dict-workbench-infopub" dictId="replyresult" selectId="replyresult" beanId="selectXML"
                           alt="allowBlank:false" defaultId="${threadForm.replyresult}"/>
            </td>
        </tr>
        <%}%>
        <%if (status.equals("4") || status.equals("6") || status.equals("1")) {%>
        <tr>
            ...
            <td class="content">
                ...
                <p/>
                <input type="button" value="<bean:message key="threadHistoryList.savenote" />"
                       onclick="javascript:onSubmit(1);" class="button"/>
                <input type="button" value="<bean:message key='threadForm.button.rotationRead'/>"
                    ...
                    <c:when test="${threadForm.createrId==sessionform.userid}">
                        <input type="button" value="<fmt:message key='button.edit'/>"
                               onclick="javascript:window.location='<html:rewrite
                                       page='/thread.do?method=edit&id=${threadForm.id}'/>'" class="button"/>
                    </c:when>
                    <c:otherwise>
    ...
    <div id="info-page">
        <div id="count-info" class="tabContent">
            ...
            <display:table name="threadHistoryCountList" cellspacing="0" cellpadding="0" id="threadHistoryCountList"
                           pagesize="${pageSizeCount}" class="table threadHistoryCountList" export="false"
                ...
                <display:column property="userId" sortable="false" headerClass="sortable"
                                titleKey="infopub.threadForm.user"/>

                <display:column property="count" sortable="false" headerClass="sortable"
        ...
        <div id="comments-info" class="tabContent">
            ...
            <display:table name="threadHistoryCommentsList" cellspacing="0" cellpadding="0"
                           id="threadHistoryCommentsList" pagesize="${pageSizeComments }"
                ...
                <display:column property="readTime" sortable="false" headerClass="sortable"
                                titleKey="infopub.threadForm.readTime" format="{0,date,yyyy-MM-dd HH:mm:ss}"/>

                <display:column property="comments" sortable="false" headerClass="sortable"
                                titleKey="infopub.threadForm.comments"/>

                <display:column property="replyresult" sortable="false" headerClass="sortable"
                                titleKey="infopub.threadForm.replyresult"/>
                <display:setProperty name="paging.banner.item_name" value="threadHistory"/>
                <display:setProperty name="paging.banner.items_name" value="threadHistorys"/>
            </display:table>
        </div>
