...
<html>
        ...
        <meta http-equiv="content-type" content="text/html; charset=utf-8">
            ...
            <script language="JavaScript1.2">
                ...
                function init() {
                  ...
                  user = srcW.roster.getUserByJID(group);
                  if(!user) {
                    user = srcW.roster.addUser(new RosterUser(group,'',["Salas de charla"],group.substring(0,group.indexOf('@'))));
    ...
    <frameset cols="75%,*" frameborder=2 framespacing=
    2 border=2 bordercolor= black>
    <frameset rows="40,*,90" frameborder=2 framespacing=
    2 border=2 bordercolor= black>
