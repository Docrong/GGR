    ...
    <div id="info-page">
        <div id="file-info" class="tabContent">
            <table class="formTable">
                ...
                <tr>
                    ...
                    <td class="content">
                        <eoms:dict key="dict-kmmanager" dictId="contentStatus" itemId="${kmFileForm.state}"
                                   beanId="id2nameXML"/>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="content">
                        <eoms:dict key="dict-kmmanager" dictId="fileGrade" itemId="${kmFileForm.fileGrade}"
                                   beanId="id2nameXML"/>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="content">
                        ...
                        %>
                        <a href="${app}/kmmanager/files.do?method=download&id=${kmFileForm.id}&nodeId=${kmFileForm.nodeId}"
                           style="text-decoration:none">${kmFileForm.fileName}</a>
                        <%
                        } else {
                        %>
                            ${kmFileForm.fileName}
        ...
        <div id="audit-info" class="tabContent">
            <table class="formTable">
                ...
                %>
                <tr>
                    <td><%=kmAuditerStep.getCreateTime() %>
                    </td>
                    ...
                    %>
                    <td><eoms:dict key="dict-kmmanager" dictId="auditResult"
                                   itemId="<%=kmAuditerStep.getAuditResult() %>" beanId="id2nameXML"/></td>
                    <%
                        }
