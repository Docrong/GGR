...
public interface IParseXmlManager {
     ...
     *
     * @param cls      ��
     * @param key      xml mapping�����ļ���keyֵ
     * @param filePath xml�����ļ�·��,���ļ���
     * @return ���ؽ���Ķ���
     ...
     *
     * @param obj      OR����
     * @param filePath Ҫ����ĵ�ַ
     * @param key      xml mapping�����ļ���keyֵ
     * @throws ParseXMLException �������׳��쳣
     */
     ...
     * @param key       xml mapping�����ļ���keyֵ
     * @param filePath  xml�����ļ�·��,���ļ���
     * @param isMapPath ��ʶkey��mapping�����ļ���keyֵ����mapping�ļ���·����true����������ļ�keyֵ
     * @return ���ؽ���Ķ���
     * @throws ParseXMLException
     */
     ...
     *
     * @param cls ��
     * @param key applicationContext-fileconfig.xml��key
     * @return ���ؽ���Ķ���
     * @throws ParseXMLException
     */
