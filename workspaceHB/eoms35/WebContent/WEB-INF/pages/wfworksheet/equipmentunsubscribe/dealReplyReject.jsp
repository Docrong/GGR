...
<div id="sheetform">
    <html:form action="/equipmentunsubscribe.do?method=performDealReplyReject" styleId="theform">
        <%
        ...
        <input type="hidden" name="subtaskName" value="EquipmentUnsubscribeSubTask"/>
        ...
        <input type="hidden" name="taskNamespace" value="http://EquipmentUnsubscribe"/>
