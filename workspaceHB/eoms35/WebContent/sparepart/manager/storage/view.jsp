        ...
        <table border="0" width="75%" cellspacing="1" cellpadding="1" class="table_show" align="center">
            ...
            <logic:iterate id="storage" name="storage" type="com.boco.eoms.sparepart.model.TawStorage">
                <tr class="tr_show">
                    ...
                    <td align="center"><a
                            href="../storage/edit.do?id=<bean:write name="storage" property="id" scope="page"/>"><img
                            src="<%=request.getContextPath()%>/images/icons/edit.gif" border="0"></a></td>
                    <td align="center"><img src="<%=request.getContextPath()%>/images/icons/delete.gif" border="0"
                                            Onclick="onPublic(<bean:write name='storage' property='id'
                                                                          scope='page'/>);"></td>
                </tr>
            </logic:iterate>
            <tr class="tr_show">
                <form action="../storage/create.do" method="post" name="tawStorageForm">
                    <td height="32" align="right" colspan="5">
                        <input align="right" type="submit" value="<bean:message key="label.add"/>" name="submit"
                               class="clsbtn2">
                        &nbsp;&nbsp;
                    </td>
                </form>
