    ...
    init: function () {
        ...
        simple.add(
            new Ext.form.TextField({
                fieldLabel: 'USER ID', id: 'userid', name: 'userid', value: 'admin22', width: 175, allowBlank: false
            }),

            new Ext.form.TextField({
                fieldLabel: 'MODEL ID', id: 'modelid', name: 'modelid', value: '11', width: 175, allowBlank: false
            })
        );
        ...
        editer.add(
            new Ext.form.TextField({
                fieldLabel: 'USER ID', id: 'user', name: 'userid', width: 175, allowBlank: false
            }),

            new Ext.form.TextField({
                fieldLabel: 'MODEL ID', id: 'model', name: 'modelid', width: 175, allowBlank: false
            }),

            new Ext.form.TextField({
                fieldLabel: 'MODEL NAME', id: 'modelname', name: 'modelname', width: 175, allowBlank: false
            }),
            new Ext.form.TextField({
                fieldLabel: 'VIEW MODEL',
                id: 'viewmodel',
                name: 'viewmodel',
                value: 'ajax',
                width: 175,
