            ...
            <table border="0" cellspacing="1" cellpadding="1" class="table_show" align=center width="95%">
                ...
                <logic:iterate id="VO" name="LIST" type="com.boco.eoms.datum.vo.impl.TawBsc1860VO">
                    <tr class="tr_show">
                        ...
                        <td align="center"><html:link page="/TawBsc1860/view.do" name="map" scope="page"><img
                                src="<%=request.getContextPath()%>/images/bottom/an_xs.gif" border="0"
                                alt="<bean:message key="label.view"/>"></html:link></td>
                        <td align="center"><html:link page="/TawBsc1860/edit.do" name="map" scope="page"><img
                                src="<%=request.getContextPath()%>/images/bottom/an_bj.gif" border="0"
                                alt="<bean:message key="label.edit"/>"></html:link></td>
                        <td align="center"><html:link page="/TawBsc1860/remove.do" name="map" scope="page"><img
