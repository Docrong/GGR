...
<form name="reportform" method="POST" action="../tawwpexecute/reportsave.do" onsubmit="onSubmit();">
    ...
    <table class="formTable">
        ...
        <tr>
            ...
            <td width="300">
                <input type="radio" name="type" value="week" onclick="javascript:show();"><bean:message
                    key="reportadd.title.radWeekRept"/>
                <input type="radio" name="type" value="month" onclick="javascript:hidden();"
                       checked="checked"><bean:message key="reportadd.title.radMonthRept"/>
            </td>
        </tr>
        <tr id="dateselect" style="DISPLAY: none">
            <td width="100" class="label">
                ...
                --%></td>
            <td nowarp>
                <%=yearFlag%><bean:message key="reportadd.title.labYear"/><%=monthFlag%><bean:message
                    key="reportadd.title.labMonth"/>
    ...
    <input type="button" value="<bean:message key="reportadd.title.btnBack" />" name="B2" Onclick="GoBack();"
           class="button">
