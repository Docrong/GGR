...
<form name=del>
    <table id=table1 cellSpacing=0 cellPadding=0 border=1 width="760" bordercolordark="#FFFFFF"
        ...
        <tr>
            <td width="20%">
                <div align="left" nowrap>
                    <a target="_blank"
                       href="<%=request.getContextPath()%>/htmlservlet?action=insert&sheet_id=<%=sheet_id%>"><%=sh_cname%><fmt:message
                            key="autosheet.preview"/></a>
                </div>
            </td>
            <td width="15%">
            ...
            <td width="15%">
                <div align="center"><a
                        href="<%=request.getContextPath()%>/autosheet/editname.jsp?sheet_id=<%out.print(sheet_id);%>&type=name"><fmt:message
                        key="autosheet.bjjbsx"/></a></div>
            </td>
            <td width="15%">
                <div align="center"><a
                        href="<%=request.getContextPath()%>/autosheet/editattr.jsp?sheet_id=<%out.print(sheet_id);%>&type=attr"><fmt:message
                        key="autosheet.bjsrkmc"/></a></div>
            </td>
            <td width="10%">
                <div align="center"><a
                        href="<%=request.getContextPath()%>/autosheet/editvalue.jsp?sheet_id=<%out.print(sheet_id);%>&type=value"><fmt:message
                        key="autosheet.bjsrk"/></a></div>
            </td>
            <td width="10%">
                <div align="center"><a
                        href="<%=request.getContextPath()%>/laststepservlet?sheetID=<%=sheet_id%>&flag=delete"
                        onClick="javascript: return confirm('<fmt:message key="autosheet.confirmdel"/>');"><fmt:message
                        key="autosheet.del"/></a></div>
            </td>
            <td width="10%">
                <div align="center"><a
                        href="<%=request.getContextPath()%>/laststepservlet?sheetID=<%=sheet_id%>&flag=renew"
                        onClick="javascript: return confirm('<fmt:message
                                key="autosheet.confirmrebuild"/>');"><fmt:message key="autosheet.rebuild"/></a></div>
            </td>
...
<p align=center><a href=" <%= request.getContextPath()%>/autosheet/sheetname.jsp"><fmt:message
        key="autosheet.back"/></a></p>
<%
