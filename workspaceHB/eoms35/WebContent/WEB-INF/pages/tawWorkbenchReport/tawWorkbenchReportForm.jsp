...
<html:form action="tawWorkbenchReports" method="post" styleId="tawWorkbenchReportForm">
    <ul>
        ...
        <li>
            ...
            <html:text property="reportPersonName" styleId="reportPersonName" readonly="true" value="<%=username %>"
        ...
        <li>
            ...
            <c:if test="${butian==null||butian!='y'}">
                <html:text property="reportTime" styleId="reportTime" readonly="true" value="<%=date_now %>"
                           styleClass="text medium"/>
            </c:if>
            <c:if test="${butian!=null&&butian=='y'}">
                <html:text property="reportTime" styleId="reportTime" readonly="true" value="<%=date_now %>"
        ...
        <li class="buttonBar bottom">
            ...
            <html:button styleClass="button" property="save" styleId="save&submit"
                         onclick="bCancel=false;document.getElementById('auditStatus').value=1;checkAuditer()">
 ...
 -->
            ...
            <input type="button" style="margin-right: 5px" class="button"
                   onclick="location.href='<c:url
                           value="/workbench/report/tawWorkbenchReports.do?method=list&flag=${flag }"/>'"
