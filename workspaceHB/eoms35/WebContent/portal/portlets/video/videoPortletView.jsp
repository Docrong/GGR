    ...
    <table width='100%' border='0' cellpadding='0' cellspacing='0'>
        <tr>
            <td class='portlet-table-td-center' width='100%'>
                <a href="javascript:void(0);" onclick="javascript:previousVideo('<%= responseId %>');"><img
                        src='portal/light/images/previous.gif' style='border: 0px'/></a>
                <a href="javascript:void(0);" onclick="javascript:nextVideo('<%= responseId %>');"><img
                        src='portal/light/images/next.gif' style='border: 0px'/></a>
            </td>
        </tr>
        ...
        <tr>
            <td class='portlet-table-td-center' width='100%'>
                <OBJECT classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"
                    ...
                    <EMBED src='<c:out value="${requestScope.currentLink}"/>' quality='high' bgcolor='#FFFFFF'
