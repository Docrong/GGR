...
<table bgcolor="#666666" cellpadding="1" cellspacing="0" border="0" width="500">
    ...
    <tr>
        <td>
            <table cellpadding="0" cellspacing="0" border="0" width="500">
                <tr>
                    <td bgcolor="#d6e0ed">&nbsp;<bean:message key="label.remove"/>&nbsp;<bean:message
                            key="TawRmSysteminfo.tablename"/>
                    </td>
                </tr>
                <tr bgcolor="#FFFFFF">
                    <td width="5%"></td>
                            ...
                            <logic:present name="tawRmSysteminfoForm" scope="request">
                                ...
                                <tr>
                                    ...
                                    <td width="19%"><font color="#022077" size="1"
                                            ...
                                            key="TawRmSysteminfo.roomId"/></b></font></td>
                                ...
                                <tr>
                                    ...
                                    <td width="19%"><font color="#022077" size="1"
                                                          face="Verdana, Arial, Helvetica, sans-serif"><b><bean:message
                                            key="TawRmSysteminfo.deptId"/></b></font></td>
                                    <td width="76%"><font size="2" face="Tahoma">
                            ...
                            <tr align="right" valign="middle">
                                <td><html:form method="POST" action="/TawRmSysteminfo/trash">
                                    <input type="hidden" name="roomId"
                                           value="<bean:write name="tawRmSysteminfoForm" property="roomId" scope="request"/>">
