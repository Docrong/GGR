  ...
  <div id="sheetinfo">
	...
	<table class="formTable"> 
	  ...
	  <tr>
		...
		<td class="content" colspan="3"><eoms:id2nameDB id="${sheetMain.netType3}" beanId="ItawSystemDictTypeDao"/></td>
	  </tr>
	  <tr>
        <td class="label"><bean:message bundle="accountpopedomapply" key="accountpopedomapply.becomeTime"/></td>
		<td class="content"> <bean:write name="sheetMain" property="becomeTime" formatKey="date.formatDateTimeAll" bundle="sheet" scope="request"/></td>
		<td class="label"><bean:message bundle="accountpopedomapply" key="accountpopedomapply.abateTime"/></td>
		<td class="content"> <bean:write name="sheetMain" property="abateTime" formatKey="date.formatDateTimeAll" bundle="sheet" scope="request"/></td>
	  </tr>
	  <tr>
		<td class="label"><bean:message bundle="accountpopedomapply" key="accountpopedomapply.system"/></td>
		<td class="content" colspan='3'><bean:write name="sheetMain" property="system" bundle="sheet" scope="request"/></td>
	  </tr> 
	  <tr>
		<td class="label"><bean:message bundle="accountpopedomapply" key="accountpopedomapply.applyExplain"/></td>
		<td class="content" colspan='3'><bean:write name="sheetMain" property="applyExplain" bundle="sheet" scope="request"/></td>
	  </tr> 
	  <tr>
