    ...
    <table class="form_table">
        ...
        <tr>
            ...
            <td>
                ...
                <option value="password" <%if (tag.getType().equals("password")) out.println("selected");%>>password
                </option>
                </select>
            </td>
        </tr>
        ...
        <tr>
            <th>输入格式要求</th>
            <td><input name="format"
                       value="<%if(tag.getFormat()==null || tag.getFormat().length()==0 || tag.getFormat().trim().equals("null") ){out.println("");}else{out.println(tag.getFormat());} %>">
            </td>
        </tr>
        <tr>
            <th>是否允许为空</th>
            <td>
                <select name="emptyok"/>
                <option value="true" <%if ((tag.getEmptyok() + "").equals("true")) out.println("selected");%>>可以
                </option>
                <option value="false" <%if ((tag.getEmptyok() + "").equals("false")) out.println("selected");%>>不可以
                </option>
                </select>
            </td>
        </tr>
        ...
        <tr>
            <th>输入最大字符数</th>
            <td><input name="maxlength" value="<%=(Integer.parseInt(tag.getMaxlength())==0)?"":tag.getMaxlength()%>">
            </td>
        </tr>
    </table>
    <table width="100%">
