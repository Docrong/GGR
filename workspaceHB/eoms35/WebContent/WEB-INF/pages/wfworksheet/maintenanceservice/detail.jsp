            ...
            <tr>
                <td width="50%">
                    ...
                    <select id="dealSelector">
                        ...
                        <!-- 流程步骤，移交，阶段回复，分派 -->
                        <option value="${urlShowConfirmation102Page}"><bean:message bundle="maintenanceservice"
                                                                                    key="operateType.Confirmation102"/></option>
                        <option value="${urlShowConfirmation106Page}"><bean:message bundle="maintenanceservice"
                                                                                    key="operateType.Confirmation106"/></option>
                        ...
                        <!-- 不需要等待回复 -->
                        <% if (ifwaitfor.equals("false")) {%>
                        <option value="${urlShowDispatchPage}"><bean:message bundle="maintenanceservice"
                    ...
                    <select id="dealSelector">
                        ...
                        <% if (ifwaitfor.equals("false")) {%>
                        <!-- 流程步骤，移交，阶段回复，分派 -->
                        <option value="${urlShowFill103Page}"><bean:message bundle="maintenanceservice"
                                                                            key="operateType.Fill103"/></option>
                        <option value="${urlShowFill4Page}"><bean:message bundle="maintenanceservice"
                                                                          key="operateType.Fill4"/></option>
                    ...
                    <select id="dealSelector">
                        ...
                        <% if (ifwaitfor.equals("false")) {%>
                        <!-- 流程步骤，移交，阶段回复，分派 -->
                        <option value="${urlShowExamine104Page}"><bean:message bundle="maintenanceservice"
                                                                               key="operateType.Examine104"/></option>
                        <option value="${urlShowExamine4Page}"><bean:message bundle="maintenanceservice"
                                                                             key="operateType.Examine4"/></option>
                        <option value="${urlShowExamine106Page}"><bean:message bundle="maintenanceservice"
                                                                               key="operateType.Examine106"/></option>
                    ...
                    <select id="dealSelector">
                        ...
                        <% if (ifwaitfor.equals("false")) {%>
                        <!-- 流程步骤，移交，阶段回复，分派 -->
                        <option value="${urlShowApproval105Page}"><bean:message bundle="maintenanceservice"
                                                                                key="operateType.Approval105"/></option>
                        <option value="${urlShowApproval4Page}"><bean:message bundle="maintenanceservice"
                                                                              key="operateType.Approval4"/></option>
                    ...
                    <select id="dealSelector">
                        ...
                        <% if (ifwaitfor.equals("false")) {%>
                        <!-- 流程步骤，移交，阶段回复，分派 -->
                        <option value="${urlShowHoldTask18Page}"><bean:message bundle="maintenanceservice"
                    ...
                    <select id="dealSelector">
                        <option value="${urlShowDraftPage}"><bean:message bundle="maintenanceservice"
