...
alter table PLANNADJUST_MAIN add constraint PLANNADJUST_MAIN_PK primary key (id)  using index; 
...
alter table PLANNADJUST_TASK add constraint PLANNADJUST_TASK_PK primary key (id)  using index; 
...
values ('xls,txt,doc,jpg,gif', 'plannadjust', '规划站址调整申请流程流程', 1024, '/sheet/plannadjust', 105, '402882f13f21c8b8013f21c8b8620000');

--插入角色
insert into taw_system_role(role_id,deleted,parent_id,role_name,roletype_id,workflow_flag,leaf) values('1970','0','0','建单人','1','618','1');
insert into taw_system_role(role_id,deleted,parent_id,role_name,roletype_id,workflow_flag,leaf) values('1971','0','0','规划站址调整管理员','1','618','1');
insert into taw_system_role(role_id,deleted,parent_id,role_name,roletype_id,workflow_flag,leaf) values('1972','0','0','规划站址调整审核人','1','618','1');

--插入菜单
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402882f13f21c8b8013f21c8b8620001', '9701', '1', '新增工单', '97', null, '/sheet/plannadjust/plannadjust.do?method=showNewSheetPage', '0', '0', 1);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402882f13f21c8b8013f21c8b8620002', '9703', '0', '待处理工单', '97', null, null, '0', '0', 3);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402882f13f21c8b8013f21c8b8620003', '970301', '1', '待办工单', '9703', null, '/sheet/plannadjust/plannadjust.do?method=showListsendundo', '0', '0', 1);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402882f13f21c8b8013f21c8b8620004', '9707', '1', '工单查询', '97', null, '/sheet/plannadjust/plannadjust.do?method=showQueryPage', '0', '0', 7);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402882f13f21c8b8013f21c8b8620005', '9708', '1', '工单处理模板', '97', null, '/sheet/plannadjust/plannadjust.do?method=getDealTemplatesByUserId&type=templateManage', '0', '0', 8);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402882f13f21c8b8013f21c8b8620006', '9709', '1', '工单模板管理', '97', null, '/sheet/plannadjust/plannadjust.do?method=getTemplatesByUserId&type=templateManage', '0', '0', 9);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402882f13f21c8b8013f21c8b8620007', '9710', '1', '管理者工单', '97', null, '/sheet/plannadjust/plannadjust.do?method=showListForAdmin', '0', '0', 10);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402882f13f21c8b8013f21c8b8620008', '97', '0', '规划站址调整申请流程流程', '10', null, '/sheet/plannadjust/plannadjust.do?method=showDrawing', '0', '0', 20);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402882f13f21c8b8013f21c8b8620009', '9702', '1', '草稿列表', '97', null, '/sheet/plannadjust/plannadjust.do?method=showDraftList', '0', '0', 2);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402882f13f21c8b8013f21c8b862000a', '9704', '0', '已处理工单', '97', null, null, '0', '0', 4);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402882f13f21c8b8013f21c8b862000b','970402','1','建立工单','9704', null, '/sheet/plannadjust/plannadjust.do?method=showOwnStarterList','0','0',2);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402882f13f21c8b8013f21c8b862000c', '970401', '1', '处理工单', '9704', null, '/sheet/plannadjust/plannadjust.do?method=showListsenddone', '0', '0', 1);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402882f13f21c8b8013f21c8b862000d', '9705', '1', '已归档工单', '97', null, '/sheet/plannadjust/plannadjust.do?method=showHoldedList', '0', '0', 5);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402882f13f21c8b8013f21c8b862000e', '9706', '1', '已作废工单', '97', null, '/sheet/plannadjust/plannadjust.do?method=showCancelList', '0', '0', 6);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402882f13f21c8b8013f21c8b862000f', '9711', '1', '超时时间设置', '97', null, '/sheet/overtimetip/overtimetip.do?flowName=PlannAdjust', '0', '0', 11);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('402882f13f21c8b8013f21c8b8620010', '9712', '1', '工单处理时限配置', '97', null, '/sheet/newSheetLimit/sheetLimit.do?method=getLevelLimitList&flowName=PlannAdjust', '0', '0', 30);