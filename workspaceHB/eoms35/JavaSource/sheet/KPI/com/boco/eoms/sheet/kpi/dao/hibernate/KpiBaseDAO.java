package com.boco.eoms.sheet.kpi.dao.hibernate;
...
public class KpiBaseDAO extends BaseSheetDaoHibernate implements IKpiBaseDAO {
                ...
                try {
                    ...
                    while (rs.next()) {
                        ...
                        for (int i = 1; i <= column; i++) {
                            ...
                            System.out.println("---rsname--" + rsmd.getColumnName(i));
                        }
                        list.add(map);
                    }
...
//						rs.absolute(1);
                    ...
                    while (rs.next()) {
                        ...
                        for (int i = 1; i <= size; i++) {
                            ...
                            System.out.println("--rsname--" + column);
    ...
    public List getXMLList(String xmlName) throws HibernateException {
        ...
        URL resourceUrl = KpiBaseDAO.class.getClassLoader().getResource(
                "com/boco/eoms/sheet/kpi/xmlFile/" + xmlName + ".xml");
