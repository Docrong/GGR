...
<input type="button" value="dlg"
       onclick="window.showModalDialog('test/test.jsp',document.getElementById('container'),'scroll=0;resizable=0;dialogWidth=300px;dialogHeight=350px');"/>
