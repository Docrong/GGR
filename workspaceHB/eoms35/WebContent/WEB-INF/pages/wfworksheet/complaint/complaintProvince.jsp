...
<table class="formTable">
    ...
    <tr>
        ...
        <td class="content"
            colspan="3"><%=id2NameService.id2Name(basemain.getComplaintType7(), "ItawSystemDictTypeDao")%>
        </td>
    </tr>
    <tr>
        ...
        <div class="history-item">&nbsp;
            <div class="history-item-title">
                ...
                <%=service
                    ...
                    itemId2name
                    (
                    "dict-sheet-complaint#mainOperateType"
                    ,
                    baselink
                    .
                    getOperateType
                        ...
                        <tr>
                            ...
                            <td class="column-content" colspan=3>
                                <%
                                    ...
                                    mgr
                                    .
                                    getTawCommonsAccessoriesByName
                                    (
                                    file
                                    )
                                    ;
