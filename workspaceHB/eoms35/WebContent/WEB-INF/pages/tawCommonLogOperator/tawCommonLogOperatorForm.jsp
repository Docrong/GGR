...
<html:form action="saveTawCommonLogOperator" method="post" styleId="tawCommonLogOperatorForm"
    ...
    <ul>
        ...
        <li>
            ...
            <html:text property="beginnotetime" styleId="beginnotetime" styleClass="text medium required"
                       readonly="true"/>
        ...
        <li class="buttonBar bottom">
            ...
            <html:submit styleClass="button" property="method.delete"
                         onclick="bCancel=true; return confirmDelete('TawCommonLogOperator')">
