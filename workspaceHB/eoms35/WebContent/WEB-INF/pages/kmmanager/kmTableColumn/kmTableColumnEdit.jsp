...
<table class="formTable">
	...
	<tr>	
		...
		<td class="content">
			<input type="text"   id="colDictName" name="colDictName" class="text" readonly="readonly" value='<eoms:id2nameDB id="${kmTableColumnForm.colDictId}" beanId="ItawSystemDictTypeDao" />' alt="allowBlank:false'"/>
