...
<table width="50%" cellpadding="0" cellspacing="0" class="table">
    ...
    <tr>
        ...
        <td>
            <a href="../supervisetask/supervisetask.do?method=supervisetaskBoardDetail2&status=0&userid=${userid }">${count1 }</a>
        </td>
    </tr>
    <tr>
        <td class="label">已进入本级督办序列</td>
        <td>
            <a href="../supervisetask/supervisetask.do?method=supervisetaskBoardDetail2&status=1&userid=${userid }">${count2 }</a>
        </td>
    </tr>
    <tr>
        <td class="label">已进入上级督办序列</td>
        <td>
            <a href="../supervisetask/supervisetask.do?method=supervisetaskBoardDetail2&status=2&userid=${userid }">${count3 }</a>
        </td>
    </tr>
    </tbody>
</table>
