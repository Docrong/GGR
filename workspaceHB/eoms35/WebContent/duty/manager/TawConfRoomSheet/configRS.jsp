...
<html:form method="post" action="/TawConfRoomSheet/configRSDone">
    <br>
    <br>
    <br>
    <table border="0" width="80%" cellspacing="1" cellpadding="1" class="table_show" align=center>
        <tr class="tr_show">
            ...
            <td width="70%">
                    <%--
                      ...
                      --%>
                <select name="roomId" style="width:220">
                    <%
                        for (int i = 0; i < SelectRoom.size(); i++) {
                    %>
                    <option value='<%=SelectRoom.get(i).toString()%>'><%=SelectRoomName.get(i).toString()%>
                    </option>
                    <%}%>
                </select>
                　
        ...
        <tr class="tr_show">
            ...
            <td width="70%">
                <html:select property="sheetId" style="width:220" onchange="toDisplay2();">
    ...
    <table border="0" width="80%" cellspacing="1" cellpadding="1" align="center">
        <TR>
            <TD align="right" height="32">
                <input type="button" value="保存配置" class="clsbtn2" onclick="checkdata();">
            </TD>
        </TR>
    </TABLE>
...
<script language="javascript">
    function toDisplay() {
        var selectedSheetId = window.document.all.sheetId.options[document.all.sheetId.selectedIndex].value;
    ...
    function checkdata() {
        if (tawConfRoomSheetForm.roomId.value == "" || tawConfRoomSheetForm.sheetId.value == "") {
            alert("机房或表单为空!");
            return;
        }
        tawConfRoomSheetForm.submit();
    }
</script>
