...
<input type="hidden" name="linkBeanId" id="linkBeanId" value="iNumberApplyLinkManager"/>
<input type="hidden" name="operateTime" id="operateTime" value="${eoms:date2String(sheetMain.sendTime)}"/>
