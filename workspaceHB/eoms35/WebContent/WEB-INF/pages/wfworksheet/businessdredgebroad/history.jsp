...
<logic:present name="HISTORY" scope="request">
      <logic:iterate id="baselink" name="HISTORY" type="com.boco.eoms.sheet.businessdredgebroad.model.BusinessDredgebroadLink">  
       <%         
        jNum += 1;       
    ...
    <div class="history-item"><!-- add space to hack ie-->&nbsp;
   	 <div class="history-item-title">
         ...
         <bean:message bundle="sheet" key="task.operateName"/>:
  	     <eoms:dict key="dict-sheet-businessdredgebroad" dictId="activeTemplateId" itemId="${baselink.activeTemplateId}" beanId="id2descriptionXML" />
  	     <bean:message bundle="businessdredgebroad" key="businessdredgebroad.operateType"/>:
  	     <eoms:dict key="dict-sheet-businessdredgebroad" dictId="mainOperateType" itemId="${baselink.operateType}" beanId="id2descriptionXML" />
...
<!-- add by qinbo begin -->
			...
			<td>
				<bean:write name="baselink" property="loginUserName" format="yyyy-MM-dd HH:mm:ss" scope="page"/>
			</td>
		...
		<tr>
			...
			<td>
				<bean:write name="baselink" property="expectFinishdays" format="yyyy-MM-dd HH:mm:ss" scope="page"/> 
			</td>
		</tr>
		<tr>
