        ...
        ctxMenu: [
            {
                ...
                text: '${eoms:a2u('新增')}',
                cls: 'new-mi',
                url: '${app}/testcard/tawRmTestcards.do?method=edit&folderPath='
            },
            {
                id: 'TestCardQuery',
                text: '${eoms:a2u('查询')}',
                cls: 'list-mi',
                url: '${app}/testcard/tawRmTestcards.do?method=testCardSearch&folderPath='
            },
            {
                id: 'OutAdd',
                text: '${eoms:a2u('测试卡出库')}',
                cls: 'new-mi',
                url: '${app}/testcard/tawRmInoutRecords.do?method=outEdit&folderPath='
            },
            {
                id: 'InAdd',
                text: '${eoms:a2u('测试卡入库')}',
                cls: 'new-mi',
                url: '${app}/testcard/tawRmInoutRecords.do?method=inEdit&folderPath='
            },
            {
                id: 'InOutQuery',
                text: '${eoms:a2u('出入库查询')}',
                cls: 'list-mi',
                url: '${app}/testcard/tawRmInoutRecords.do?method=toSearch&folderPath='
            },
            {
                id: 'RenewAdd',
                text: '${eoms:a2u('测试卡续借')}',
                cls: 'new-mi',
                url: '${app}/testcard/tawRmRenewals.do?method=renewEdit&folderPath='
            },
            {
                id: 'RenewSearch',
                text: '${eoms:a2u('测试卡续借记录查询')}',
                cls: 'list-mi',
                url: '${app}/testcard/tawRmRenewals.do?method=toSearch&folderPath='
            },
            {
                id: 'StatTestCard',
                text: '${eoms:a2u('统计测试卡信息')}',
                cls: 'list-mi',
                url: '${app}/testcard/tawRmTestcards.do?method=toStatTestCard&folderPath='
            },
            {
                id: 'StatInoutRecord',
                text: '${eoms:a2u('统计借用记录')}',
                cls: 'list-mi',
                url: '${app}/testcard/tawRmInoutRecords.do?method=toStatInoutRecord&folderPath='
            }
