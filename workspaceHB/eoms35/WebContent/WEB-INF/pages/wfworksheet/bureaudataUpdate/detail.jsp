				...
				<td class="label" style="text-align:center">HLR编号</td>
	          		...
	          		%>
	          			 <tr>
							...
							<td align="center"><%=bas.getPrehlrName()%></td>
							<td align="center"><%=bas.getPrehlrSignalId()%></td>
							<td align="center"><%=bas.getPrehlrId()%></td>
...
<!--				<option value="${urlShowInputSplit}"><bean:message bundle="sheet" key="common.split"/></option>		  -->
		...
		<%}else if(taskName.equals("DraftTask")){%>	
			<select id="dealSelector">
			  <option value="${urlShowDraftDeal}"><bean:message bundle="bureaudataUpdate" key="operateType.draft"/></option>
			</select>
		...
		<%}else if(taskName.equals("HoldTask")){ %>
			<select id="dealSelector">
			  <option value="${urlShowHoldDealPage}"><bean:message bundle="bureaudataUpdate" key="operateType.hold"/></option>
			</select>		
		<%} %>
		</td>
		</tr>
