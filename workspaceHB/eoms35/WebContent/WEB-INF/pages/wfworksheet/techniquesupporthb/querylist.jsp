...
<logic:notPresent name="recordTotal">
    ...
    <display:table name="taskList" cellspacing="0" cellpadding="0"
        ...
        <display:column sortable="true" sortName="main.mainSheetType"
                        headerClass="sortable" title="${eoms:a2u('工单类型')}">
            <eoms:id2nameDB id="${taskList.mainSheetType}" beanId="ItawSystemDictTypeDao"/>
        </display:column>

        <display:column sortable="true" sortName="main.mainProfessional"
                        headerClass="sortable" title="${eoms:a2u('子专业')}">
            <eoms:id2nameDB id="${taskList.mainProfessional}" beanId="ItawSystemDictTypeDao"/>
        </display:column>

        <display:column sortable="true" sortName="main.mainManufacturer"
                        headerClass="sortable" title="${eoms:a2u('厂商')}">
            <eoms:id2nameDB id="${taskList.mainManufacturer}" beanId="ItawSystemDictTypeDao"/>
        </display:column>
