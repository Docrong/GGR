    ...
    <body style="margin:8px">
        <form>
            <fieldset>
                ...
                <table>
                    <tr>
                        ...
                        <td width="100%">
                            <input type=text id="FN" class="vcardBoxEditable">
                        </td>
                    </tr>
                    <tr>
                        <th nowrap>Apellidos:</th>
                        <td width="100%">
                            <input type=text id="N.FAMILY" class="vcardBoxEditable">
                        </td>
                    </tr>
                    <tr>
                        <th nowrap>Nombre:</th>
                        <td width="100%">
                            <input type=text id="N.GIVEN" class="vcardBoxEditable">
                        </td>
                    </tr>
                    <tr>
                        <th nowrap>Apodo:</th>
                        <td width="100%">
                            <input type=text id="NICKNAME" class="vcardBoxEditable">
                        </td>
                    </tr>
                </table>
            </fieldset>
            ...
            <fieldset>
                ...
                <table>
                    <tr>
                        <th nowrap>Correo-e:</th>
                        <td width="100%">
                            <input type=text id="EMAIL" class="vcardBoxEditable">
                        </td>
                    </tr>
                    <tr>
                        <th nowrap>Página web:</th>
                        <td width="100%">
                            <input type=text id="URL" class="vcardBoxEditable">
                        </td>
                    </tr>
                </table>
            </fieldset>
            ...
            <fieldset>
                ...
                <table>
                    <tr>
                        ...
                        <td width="100%">
                            <input type=text id="ADR.STREET" class="vcardBoxEditable">
                        </td>
                    </tr>
                    <tr>
                        <th nowrap>Direcci&oacute;n 2:</th>
                        <td width="100%">
                            <input type=text id="ADR.EXTADD" class="vcardBoxEditable">
                        </td>
                    </tr>
                    <tr>
                        <th nowrap>Ciudad:</th>
                        <td width="100%">
                            <input type=text id="ADR.LOCALITY" class="vcardBoxEditable">
                        </td>
                    </tr>
                    <tr>
                        <th nowrap>Estado:</th>
                        <td width="100%">
                            <input type=text id="ADR.REGION" class="vcardBoxEditable">
                        </td>
                    </tr>
                    <tr>
                        <th nowrap>C&oacute;digo Postal:</th>
                        <td width="100%">
                            <input type=text id="ADR.PCODE" class="vcardBoxEditable">
                        </td>
                    </tr>
                    <tr>
                        <th nowrap>Pa&iacute;s:</th>
                        <td width="100%">
                            <input type=text id="ADR.CTRY" class="vcardBoxEditable">
                        </td>
                    </tr>
                </table>
            </fieldset>
            ...
            <fieldset>
                ...
                <table>
                    <tr>
                        <th nowrap>Nombre:</th>
                        <td width="100%">
                            <input type=text id="ORG.ORGNAME" class="vcardBoxEditable">
                        </td>
                    </tr>
                    <tr>
                        <th nowrap>Unidad:</th>
                        <td width="100%">
                            <input type=text id="ORG.ORGUNIT" class="vcardBoxEditable">
                        </td>
                    </tr>
                    <tr>
                        <th nowrap>T&iacute;tulo:</th>
                        <td width="100%">
                            <input type=text id="TITLE" class="vcardBoxEditable">
                        </td>
                    </tr>
                    <tr>
                        <th nowrap>Rol:</th>
                        <td width="100%">
                            <input type=text id="ROLE" class="vcardBoxEditable">
                        </td>
                    </tr>
                </table>
            </fieldset>
            ...
            <fieldset>
                ...
                <table width="100%">
                    <tr>
                        ...
                        <td width="100%">
                            <input type=text id="BDAY" class="vcardBoxEditable">
                        </td>
                    </tr>
                    <tr>
                        <td colspan=2
                ...
                <tr>
                    <td colspan=2 width="100%">
                        <textarea id="DESC" class="vcardBoxEditable" style="width:100%;" rows=4 wrap=
                                  virtual></textarea>
                    </td>
                </tr>
            </table>
        ...
        <div id="savebox">
            <hr noshade size="1" size="100%">
                <div align="right">
                    ...
                    &nbsp;
                    <button onClick="return sendSub();">Guardar</button>
                </div>
        </div>
    </form>
</body>
