...
function showPage(){
     var pars = '';
     var url = '';    
      url = '${app}/sheet/bureaudataSave/bureaudataSave.do?method=showInputRejectPage&piid=${sheetMain.piid}&taskId=${taskId}&taskName=${taskName}';
     if (url!=''){
...
<div id="sheetform">
<html:form action="/bureaudataSave.do?method=performDeal" styleId="theform">
