            ...
            <table border="0" width="100%" cellspacing="1" cellpadding="1" class="table_show" align=center>
                <tr class="tr_show">
                    ...
                    <td width="10%">
                        ...
                        <a href="trash.do?boardId=<bean:write name="tawInformation" property="boardId" scope="page"/>&id=<bean:write name="tawInformation" property="id" scope="page"/>"
                ...
                <tr class="tr_show">
                    ...
                    <td colspan="4"><bean:write name="tawInformation" property="publicDeptName"
                                                scope="page"/><bean:write name="tawInformation" property="publicerName"
                                                                          scope="page"/></td>
                </tr>
                ...
                <tr class="tr_show">
                    ...
                    <td colspan="4">
                        <eoms:attachment name="tawInformation" property="attachName" scope="page" idField="attachName"
