                ...
                <table>
                    <tr>
                        <td><input name="Button" type="button" value="返回" class="btn_03"
                                   onclick="javascript:{var url='${app}/wap/dutyroom.do?method=roomselect';location.href=url}"/>
                        </td>
                        <td><input name="Button" type="button" value="前一天" class="btn_03"
                                   onclick="javascript:{var url='${app}/wap/dutyuser.do?method=dutyUser&id=<%=roomId%>&day=-1&dutyDate=<%=dutyDate%>';location.href=url}"/>
                        </td>
                        <td><input name="Button" type="button" value="当天" class="btn_03"
                                   onclick="javascript:{var url='${app}/wap/dutyuser.do?method=dutyUser&id=<%=roomId%>';location.href=url}"/>
                        </td>
        ...
        <table width="100%" border="1" cellspacing="0" cellpadding="0" class="sub_table_bg">
            ...
            <tr>
                <td colSpan="2" class="tt_head_bg">&nbsp&nbsp&nbsp姓名:
                    &nbsp&nbsp&nbsp <a
                            href="wtai://wp/ap;<%= StaticMethod.null2String(tawSystemUser.getMobile())%>;<%=StaticMethod.null2String(tawSystemUser.getUsername())%>">
