...
<div align=center>
    <font color=red><bean:message key="failure.title.warn"/>
        <input class="button" type="button" name="back" value="<bean:message key="failure.title.back" />"
               onclick=javascript:history.back();><bean:message key="failure.title.reset"/></font>
</div>
