...
<script type="text/javascript">
    var config = {
        ...
        onClick: {
            url: "<html:rewrite page='/forums.do?method=edit&id=${ForumsForm.id}'/>",
            text: "${eoms:a2u('修改专题')}"
        },
        ctxMenu: [
            {
                ...
                rootCanShow: true,
                cls: 'new-mi',
                url: '<html:rewrite page='/forums.do?method=initAdd&id='/>'
            },
            {
                id: 'EditForum',
                text: '${eoms:a2u('修改专题')}',
                cls: 'edit-mi',
                url: '<html:rewrite page='/forums.do?method=edit&id='/>'
            },
            {
                id: 'MoveForum',
                text: '${eoms:a2u('移动到...')}',
                cls: 'edit-mi',
                url: '<html:rewrite page='/forums.do?method=list&id='/>'
            },
            {
                id: 'DelForum',
                isDelete: true,
                text: '${eoms:a2u('删除')}',
                cls: 'remove-mi',
                url: '<html:rewrite page='/forums.do?method=delete&id='/>'
            }
        ],//end of ctxMenu
        /************************
