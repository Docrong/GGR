...
<div id="sheetform">
    <html:form action="/plannconfirm.do?method=performTransferWorkItem" styleId="theform">
        ...
        <input type="hidden" name="mainClassName" id="mainClassName"
               value="com.boco.eoms.sheet.plannconfirm.model.PlannConfirmMain"/>
        <input type="hidden" name="linkClassName" id="linkClassName"
               value="com.boco.eoms.sheet.plannconfirm.model.PlannConfirmLink"/>
        ...
        <div class="form-btns">
            ...
            <input type="submit" class="submit"
                   onclick="v.passing=true;this.form.action='${app}/sheet/plannconfirm/plannconfirm.do?method=performSaveInfo'"
