...
<table width="95%" cellspacing="1" class="listTable">
    ...
    <logic:iterate id="tawTestcard" name="tawTestcard" type="com.boco.eoms.testcard.model.TawTestcard">
        ...
        <tr bgcolor="#FFFFFF">
            ...
            <td nowrap align="center"><html:link href="../TawTestcard/view.do" paramId="iccid" paramName="tawTestcard"
                                                 paramProperty="iccid">   ${eoms:a2u("查看")}</html:link></td>
            <td nowrap align="center" height="30"><html:link href="../TawTestcardManager/toscrap.do" paramId="iccid"
                                                             paramName="tawTestcard"
                                                             paramProperty="iccid">${eoms:a2u("报废")}</html:link></td>
        </tr>
    </logic:iterate>
