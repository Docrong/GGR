...
<logic:present name="HISTORY" scope="request">  
      <logic:iterate id="baselink" name="HISTORY" type="com.boco.eoms.sheet.resourceconfirm.model.ResourceConfirmLink">  
       <%         
        jNum += 1;       
     ...
     <div class="history-item"><!-- add space to hack ie-->&nbsp;
       <div class="history-item-title">
		 ...
		 <bean:write name="baselink" property="operateTime" formatKey="date.formatDateTimeAll" bundle="sheet" scope="page"/>&nbsp; 
  	     ...
  	     <eoms:dict key="dict-sheet-resourceconfirm" dictId="activeTemplateId" itemId="${baselink.activeTemplateId}" beanId="id2descriptionXML" />
  	     <bean:message bundle="resourceconfirm" key="resourceconfirm.operateType"/>:
  	     <eoms:dict key="dict-sheet-resourceconfirm" dictId="mainOperateType" itemId="${baselink.operateType}" beanId="id2descriptionXML" />
			 ...
			 <%if(baselink.getOperateType()!=null && (baselink.getOperateType().intValue() == 200||baselink.getOperateType().intValue() == 11)){%> 		            
			      ...
			      <tr>
		            <td  class="label"><bean:message bundle="resourceconfirm" key="resourceconfirm.linkSendSheetDesc"/></td>
		              <td colspan="3"><pre><bean:write name="baselink" property="linkSendSheetDesc" scope="page"/></pre></td>
		          </tr>				      
			 <%} }%>
			 ...
			 <%if(baselink.getOperateType()!=null && (baselink.getOperateType().intValue() == 207||baselink.getOperateType().intValue() == 11)){%> 		            
			      <tr>
		            <td  class="label"><bean:message bundle="resourceconfirm" key="resourceconfirm.linkRemark"/></td>
		              <td colspan="3"><pre><bean:write name="baselink" property="linkRemark" scope="page"/></pre></td>
		          </tr>				      
			 <%} }%>
...
<c:if test="${sheetMain.mainspecialtyType==101220101}">
			 	   <tr>
		                ...
		                <td class="column-content" colspan="3">  
		                <eoms:id2nameDB id="${baselink.linkCapabilityAffirm}" beanId="ItawSystemDictTypeDao"/>
			        </td>	 			                       	                
		           </tr>
			      <tr>
		            <td  class="label"><bean:message bundle="resourceconfirm" key="resourceconfirm.linkRemark"/></td>
...
<c:if test="${sheetMain.mainspecialtyType==101220102}">
			      <tr>
		            <td  class="label"><bean:message bundle="resourceconfirm" key="resourceconfirm.linkANetContact"/></td>
		              <td class="column-content"><pre><bean:write name="baselink" property="linkANetContact" scope="page"/></pre></td>
		            <td  class="label"><bean:message bundle="resourceconfirm" key="resourceconfirm.linkANetContactTel"/></td>
		              <td class="column-content"><pre><bean:write name="baselink" property="linkANetContactTel" scope="page"/></pre></td>		              
		          </tr>
			      <tr>
		            <td  class="label"><bean:message bundle="resourceconfirm" key="resourceconfirm.linkALongitude"/></td>
		              <td class="column-content"><pre><bean:write name="baselink" property="linkALongitude" scope="page"/></pre></td>
		            <td  class="label"><bean:message bundle="resourceconfirm" key="resourceconfirm.linkALatitude"/></td>
		              <td class="column-content"><pre><bean:write name="baselink" property="linkALatitude" scope="page"/></pre></td>		              
		          </tr>
			      <tr>
		            <td  class="label"><bean:message bundle="resourceconfirm" key="resourceconfirm.linkBusinessBandwidth"/></td>
		              <td class="column-content"><pre><bean:write name="baselink" property="linkBusinessBandwidth" scope="page"/></pre></td>
		            <td  class="label"><bean:message bundle="resourceconfirm" key="resourceconfirm.linkBusinessNumber"/></td>
		              <td class="column-content"><pre><bean:write name="baselink" property="linkBusinessNumber" scope="page"/></pre></td>		              
		          </tr>		          
			      <tr>
		            <td  class="label"><bean:message bundle="resourceconfirm" key="resourceconfirm.linkConnectType"/></td>
		              <td class="column-content"><pre><bean:write name="baselink" property="linkConnectType" scope="page"/></pre></td>
		            <td  class="label"><bean:message bundle="resourceconfirm" key="resourceconfirm.linkTunnel"/></td>
		              <td class="column-content"><pre><bean:write name="baselink" property="linkTunnel" scope="page"/></pre></td>		              
		          </tr>			          
			      <tr>
		            <td  class="label"><bean:message bundle="resourceconfirm" key="resourceconfirm.linkGroupUserIP"/></td>
		              <td class="column-content"><pre><bean:write name="baselink" property="linkGroupUserIP" scope="page"/></pre></td>
		            <td  class="label"><bean:message bundle="resourceconfirm" key="resourceconfirm.linkRadiusAddress"/></td>
		              <td class="column-content"><pre><bean:write name="baselink" property="linkRadiusAddress" scope="page"/></pre></td>		              
		          </tr>			          
			      <tr>
		            <td  class="label"><bean:message bundle="resourceconfirm" key="resourceconfirm.linkGroupUserIPReq"/></td>
		              <td class="column-content" colspan="3"><pre><bean:write name="baselink" property="linkGroupUserIPReq" scope="page"/></pre></td>		              
		          </tr>
		          <tr>			          
		            <td  class="label"><bean:message bundle="resourceconfirm" key="resourceconfirm.linkAPNName"/></td>
		              <td class="column-content"><pre><bean:write name="baselink" property="linkAPNName" scope="page"/></pre></td>
		            <td  class="label"><bean:message bundle="resourceconfirm" key="resourceconfirm.linkIPDistribution"/></td>
		              <td class="column-content"><pre><bean:write name="baselink" property="linkIPDistribution" scope="page"/></pre></td>		              
		          </tr>			          
			      <tr>
		            <td  class="label"><bean:message bundle="resourceconfirm" key="resourceconfirm.linkRemark"/></td>
		              <td colspan="3"><pre><bean:write name="baselink" property="linkRemark" scope="page"/></pre></td>
...
<c:if test="${sheetMain.mainspecialtyType==101220101}">
		          ...
		          <tr>			          
		            <td  class="label"><bean:message bundle="resourceconfirm" key="resourceconfirm.linkAccessPointName"/></td>
		              <td class="column-content"><pre><bean:write name="baselink" property="linkAccessPointName" scope="page"/></pre></td>
		            <td  class="label"><bean:message bundle="resourceconfirm" key="resourceconfirm.linkAccessPDistance"/></td>
		              <td class="column-content"><pre><bean:write name="baselink" property="linkAccessPDistance" scope="page"/></pre></td>		              
		          </tr>		           		           		           
			      <tr>
		            <td  class="label"><bean:message bundle="resourceconfirm" key="resourceconfirm.linkRemark"/></td>
		              <td colspan="3"><pre><bean:write name="baselink" property="linkRemark" scope="page"/></pre></td>
...
<c:if test="${sheetMain.mainspecialtyType==101220102}">
			      <tr>
		            <td  class="label"><bean:message bundle="resourceconfirm" key="resourceconfirm.linkGPRSCoreAddress"/></td>
		              <td class="column-content" colspan="3"><pre><bean:write name="baselink" property="linkGPRSCoreAddress" scope="page"/></pre></td>
                  </tr>
			      <tr>
		            <td  class="label"><bean:message bundle="resourceconfirm" key="resourceconfirm.linkGPRSCoreContact"/></td>
		              <td class="column-content"><pre><bean:write name="baselink" property="linkGPRSCoreContact" scope="page"/></pre></td>
		            <td  class="label"><bean:message bundle="resourceconfirm" key="resourceconfirm.linkGPRSCoreContactTel"/></td>
		              <td class="column-content"><pre><bean:write name="baselink" property="linkGPRSCoreContactTel" scope="page"/></pre></td>		              
		          </tr>   
			      <tr>
		            <td  class="label"><bean:message bundle="resourceconfirm" key="resourceconfirm.linkGPRSCoreLongitude"/></td>
		              <td class="column-content"><pre><bean:write name="baselink" property="linkGPRSCoreLongitude" scope="page"/></pre></td>
		            <td  class="label"><bean:message bundle="resourceconfirm" key="resourceconfirm.linkGPRSCoreLatitude"/></td>
		              <td class="column-content"><pre><bean:write name="baselink" property="linkGPRSCoreLatitude" scope="page"/></pre></td>		              
		          </tr>       
			      <tr>
		            <td  class="label"><bean:message bundle="resourceconfirm" key="resourceconfirm.linkRemark"/></td>
		              <td colspan="3"><pre><bean:write name="baselink" property="linkRemark" scope="page"/></pre></td>
...
<c:if test="${sheetMain.mainspecialtyType==101220101}">
			 	   <tr>
		             ...
		             <td  class="label"><bean:message bundle="resourceconfirm" key="resourceconfirm.linkDealDescription"/></td>
		                <td class="column-content">  
		                <eoms:id2nameDB id="${baselink.linkDealDescription}" beanId="ItawSystemDictTypeDao"/>
			        </td>			                        	                
		           </tr>
			 	   <tr>
		            <td  class="label"><bean:message bundle="resourceconfirm" key="resourceconfirm.linkPreInvestment"/></td>
		              <td class="column-content"><pre><bean:write name="baselink" property="linkPreInvestment" scope="page"/></pre></td>		           	
		             <td  class="label"><bean:message bundle="resourceconfirm" key="resourceconfirm.linkPreCompleteDays"/></td>
		                <td class="column-content">  
		                <eoms:id2nameDB id="${baselink.linkPreCompleteDays}" beanId="ItawSystemDictTypeDao"/>
			        </td>			                        	                
		           </tr>
			 	   <tr>
		             <td  class="label"><bean:message bundle="resourceconfirm" key="resourceconfirm.linkIfOpenCondition"/></td>
		                <td class="column-content">  
		                <eoms:id2nameDB id="${baselink.linkIfOpenCondition}" beanId="ItawSystemDictTypeDao"/>
			        </td>	
			      ...
			      <tr>
		            <td  class="label"><bean:message bundle="resourceconfirm" key="resourceconfirm.linkDeviceName"/></td>
		              <td class="column-content"><pre><bean:write name="baselink" property="linkDeviceName" scope="page"/></pre></td>
		            <td  class="label"><bean:message bundle="resourceconfirm" key="resourceconfirm.linkDevicePort"/></td>
		              <td class="column-content"><pre><bean:write name="baselink" property="linkDevicePort" scope="page"/></pre></td>		              
		          </tr>
			      <tr>
		            <td  class="label"><bean:message bundle="resourceconfirm" key="resourceconfirm.linkIPAddressOne"/></td>
		              <td class="column-content"><pre><bean:write name="baselink" property="linkIPAddressOne" scope="page"/></pre></td>
		            <td  class="label"><bean:message bundle="resourceconfirm" key="resourceconfirm.linkIPAddressTwo"/></td>
		              <td class="column-content"><pre><bean:write name="baselink" property="linkIPAddressTwo" scope="page"/></pre></td>		              
		          </tr>	
			      <tr>
		            <td  class="label"><bean:message bundle="resourceconfirm" key="resourceconfirm.linkMask"/></td>
		              <td class="column-content"><pre><bean:write name="baselink" property="linkMask" scope="page"/></pre></td>
		            <td  class="label"><bean:message bundle="resourceconfirm" key="resourceconfirm.linkGateway"/></td>
		              <td class="column-content"><pre><bean:write name="baselink" property="linkGateway" scope="page"/></pre></td>		              
		          </tr>	         		         		                           
</c:if> 	
<c:if test="${sheetMain.mainspecialtyType==101220102}">
			 	   <tr>
		             <td  class="label"><bean:message bundle="resourceconfirm" key="resourceconfirm.linkDealDescriptionA"/></td>
		                <td class="column-content">  
		                <eoms:id2nameDB id="${baselink.linkDealDescriptionA}" beanId="ItawSystemDictTypeDao"/>
			        </td>	
		             <td  class="label"><bean:message bundle="resourceconfirm" key="resourceconfirm.linkPreCompleteDaysA"/></td>
		                <td class="column-content">  
		                <eoms:id2nameDB id="${baselink.linkPreCompleteDaysA}" beanId="ItawSystemDictTypeDao"/>
			        </td>			                        	                
		           </tr>
			 	   <tr>
		             <td  class="label"><bean:message bundle="resourceconfirm" key="resourceconfirm.linkIfOpenConditionA"/></td>
		                <td class="column-content" colspan="3">  
		                <eoms:id2nameDB id="${baselink.linkIfOpenConditionA}" beanId="ItawSystemDictTypeDao"/>
			        </td>				                        	                
		           </tr>    		         		                           
</c:if> 
	                <tr>
			 ...
			 <%if(baselink.getOperateType()!=null && (baselink.getOperateType().intValue() == 206||baselink.getOperateType().intValue() == 11)){%> 		            
			      <tr>
		            <td  class="label"><bean:message bundle="resourceconfirm" key="resourceconfirm.linkDealDesc"/></td>
		              <td colspan="3"><pre><bean:write name="baselink" property="linkDealDesc" scope="page"/></pre></td>
		          </tr>			          
			 <%} }%>	 		 				 			 		 
