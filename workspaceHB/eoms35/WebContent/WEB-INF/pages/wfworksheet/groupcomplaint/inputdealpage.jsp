...
<table class="formTable">
    ...
    <tr>
        ...
        <td colspan="3">
			        <textarea name="${sheetPageName}linkTransmitReason" class="textarea max"
                              id="${sheetPageName}linkTransmitReason"
                              alt="allowBlank:false,width:500,maxLength:1000,vtext:'最多输入500汉字'"
                              alt="width:'500px'">${sheetLink.linkTransmitReason}</textarea>
        </td>
    </tr>
    <%} %>
    ...
    <tr>
        ...
        <td colspan="3">
			        <textarea name="${sheetPageName}transferReason" class="textarea max"
                              ...
                              alt="allowBlank:false,width:500,maxLength:200,vtext:'最多输入100汉字'"
    ...
    <input type="hidden" name="${sheetPageName}phaseId" id="${sheetPageName}phaseId"
           value="ShiftScopeCheckRuleTaskNew"/>
    ...
    <td>
        <eoms:comboBox name="${sheetPageName}compProp" id="${sheetPageName}compProp" initDicId="1011006"
                       defaultValue="${sheetLink.compProp}" alt="allowBlank:false"/>
    </td>
    <td class="label"><bean:message bundle="group" key="groupcomplaint.isReplied"/></td>
    <td>
        <eoms:comboBox name="${sheetPageName}isReplied" id="${sheetPageName}isReplied" initDicId="1011050"
                       defaultValue="${sheetLink.isReplied}" alt="allowBlank:ture"/>
    </td>
    </tr>
    <td class="label"><bean:message bundle="group" key="groupcomplaint.isCorrect"/>*</td>
    <td>
        <eoms:comboBox name="${sheetPageName}isCorrect" id="${sheetPageName}isCorrect" initDicId="1011050"
                       defaultValue="${sheetLink.isCorrect}" alt="allowBlank:false"/>
    </td>
    <td class="label"><bean:message bundle="group" key="groupcomplaint.affectedAreas"/>*</td>
    <td>
        <eoms:comboBox name="${sheetPageName}affectedAreas" id="${sheetPageName}affectedAreas" initDicId="1011003"
                       defaultValue="${sheetLink.affectedAreas}" alt="allowBlank:false"/>
    </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <eoms:comboBox name="${sheetPageName}dealResult" id="${sheetPageName}dealResult" initDicId="1011007"
                           defaultValue="${sheetLink.dealResult}" alt="allowBlank:false"/>
        </td>
    </tr>
    <tr>
        <td class="label"><bean:message bundle="group" key="groupcomplaint.issueEliminatReason"/>*</td>
        <td>
            <input type="text" class="text" name="${sheetPageName}issueEliminatReason"
                   id="${sheetPageName}issueEliminatReason"
    ...
    <tr>
        ...
        <td colspan="3">
            <select name="linkIfElectricCode" id="linkIfElectricCode" onchange="ifElectricCode(this.value);"
                    alt="allowBlank:false,vtext:'请选择是否存在产品实例标识！'">
    ...
    <tr>
        ...
        <td colspan="3">
            <textarea name="electricCode" id="electricCode" class="textarea max"
                      alt="allowBlank:false,maxLength:1000,vtext:'最多输入50汉字'">${sheetLink.electricCode}</textarea>
        </td>
    </tr>
    </tbody>
    ...
    <tr>
        ...
        <td colspan="3">
            <textarea name="linkNoReason" id="linkNoReason" class="textarea max"
                      alt="allowBlank:false,maxLength:1000,vtext:'最多输入300汉字'">${sheetLink.electricCode}</textarea>
        </td>
    </tr>
    </tbody>
    ...
    <tr>
        ...
        <td colspan="3">
            <textarea name="dealDesc" id="dealDesc" class="textarea max"
                      alt="allowBlank:false,maxLength:2000,vtext:'最多输入1000汉字'">${sheetLink.dealDesc}</textarea>
        </td>
    </tr>
    ...
    <input type="hidden" name="${sheetPageName}mainIfCheck" id="${sheetPageName}mainIfCheck" value="1"/>
    <input type="hidden" name="${sheetPageName}mainQcRejectTimes" id="${sheetPageName}mainQcRejectTimes"
           value="${sheetMain.mainQcRejectTimes+1}"/>
    ...
    <tr>
        ...
        <td colspan="3">
		           <textarea name="${sheetPageName}linkExamineContent" class="textarea max"
                             id="${sheetPageName}linkExamineContent"
                             alt="allowBlank:false,width:500,maxLength:1000,vtext:'最多输入250汉字'"
                             alt="width:'500px'">${sheetLink.linkExamineContent}</textarea>
        </td>
    </tr>
...
<fieldset id="link4">
    ...
    <eoms:chooser id="commonfaultSendRole" type="role" roleId="307" flowId="057"
...
<fieldset id="link4">
    ...
    <eoms:chooser id="commonfaultSendRole" type="role" roleId="306" flowId="057"
                  config="{returnJSON:true,showLeader:true}"
...
<fieldset id="link4">
    ...
    <eoms:chooser id="commonfaultSendRole" type="role" roleId="309" flowId="057"
                  config="{returnJSON:true,showLeader:true}"
