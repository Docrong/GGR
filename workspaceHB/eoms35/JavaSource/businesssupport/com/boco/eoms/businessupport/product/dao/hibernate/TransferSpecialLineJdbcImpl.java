...
public class TransferSpecialLineJdbcImpl extends BaseDaoJdbc implements ITransferSpecialLineJdbc {

	public String getMaxCode() {
		String sql = " select max(code) as code from TransferSpecialLine";
