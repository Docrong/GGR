      ...
      <%     
        ...
        <table border="0"  cellspacing="1" cellpadding="1" class="listTable" align=center width="90%">
          ...
          <tr class="tr_show">
            ...
            <td width="20%">
              <textarea name="content<%=strArray[0]%>_<%=stubformindex %>_<%=stubFlag %>"  rows=3 cols="45" value=""><%=tawwpExecuteContentVO.getContent()%></textarea>
            </td>
            <td width="6%" align=center>
              <textarea name="remark<%=strArray[0]%>_<%=stubformindex %>_<%=stubFlag %>"  rows=3 cols="45" value=""><%=tawwpExecuteContentVO.getRemark()%></textarea>
            </td>
            <td width="10%" class="clsthd2" align="left">
        ...
        %>
          <tr class="tr_show">
            ...
            <td width="20%">
              <textarea name="content<%=strArray[k]%>_<%=stubformindex %>_<%=stubFlag %>"  rows=3 cols="45" value=""><%=tawwpExecuteContentVO.getContent()%></textarea>
            </td>
            <td width="6%" align=center>
              <textarea name="remark<%=strArray[k]%>_<%=stubformindex %>_<%=stubFlag %>"  rows=3 cols="45" value=""><%=tawwpExecuteContentVO.getRemark() %></textarea>
            </td>
            <td width="10%" class="clsthd2" align="left">
