    ...
    <fmt:bundle basename="com/boco/eoms/km/config/applicationResource-kmmanager"><br>
        ...
        <table class="formTable">
            ...
            <tr>
                ...
                <td class="content">
                    <html:text property="phone" styleId="phone" styleClass="text medium"
                               alt="allowBlank:false,vtext:'请输入联系电话...'" value="${kmExpertBasicForm.phone}"/>
                </td>
                <td class="label">
            ...
            <tr>
                ...
                <td class="content">
                    <eoms:comboBox name="education" id="education"
            ...
            <tr>
                ...
                <td class="content">
                    <eoms:comboBox name="expertClass" id="expertClass"
                                   initDicId='<%=KmExpertProps.getDictRootId("RootExpertClass")%>'
                ...
                <td class="content">
                    <eoms:comboBox name="expertLevel" id="expertLevel"
                                   initDicId='<%=KmExpertProps.getDictRootId("RootExpertLevel")%>'
            ...
            <tr>
                ...
                <td colspan="3" class="content">
                    <textarea name="intro" cols="50" id="intro" class="textarea max"
                              alt="allowBlank:false,vtext:'请输入专家特长...'">${kmExpertBasicForm.intro}</textarea>
                </td>
            </tr>
        </table>
