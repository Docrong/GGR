...
<table class="formTable">
    ...
    <tr>
        ...
        <td width="310">
            <textarea name="content" class="textarea max"
                      readonly="readonly"><%=tawwpExecuteContentVO.getContent()%></textarea>
        </td>
    </tr>
    <tr>
        <td width="100" class="label">
        ...
        <td width="310">
            <textarea name="remark" class="textarea max"
                      readonly="readonly"><%=tawwpExecuteContentVO.getRemark()%></textarea>
        </td>
    </tr>
    <tr>
        <td width="100" class="label">
        ...
        <td width="310">
            ...
            %>
            <a href="javascript:onAddons('../tawwpaddons/addonsread.do?action=read&window=new&executeId=<%=tawwpExecuteContentVO.getId() %>&reaction=../tawwpexecute/redirection.jsp');"><%=tawwpExecuteContentVO.getFormName()%>
            </a>
            <%
                }
            %>
    ...
    <form name="executeCheckForm" action="../tawwpexecute/checkAdd.do" method="post">
        ...
        <tr>
            ...
            <td width="310">
                <textarea name="checkContent"
                          class="textarea max"><%=StaticMethod.null2String(tawwpExecuteCheck.getCheckContent(), "")%></textarea>
...
<br/>
<input type="button" value="<bean:message key="viewmonthcontent.title.btnBack" />"
