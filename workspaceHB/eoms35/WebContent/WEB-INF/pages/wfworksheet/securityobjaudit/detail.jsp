            ...
            <tr>
                <td width="50%">
                    ...
                    <select id="dealSelector">
                        ...
                        <!-- 流程步骤，移交，阶段回复，分派 -->
                        <option value="${urlShowAudit102Page}"><bean:message bundle="securityobjaudit"
                        ...
                        <!-- 不需要等待回复 -->
                        <% if (ifwaitfor.equals("false")) {%>
                        <option value="${urlShowDispatchPage}"><bean:message bundle="securityobjaudit"
                    ...
                    <select id="dealSelector">
                        ...
                        <% if (ifwaitfor.equals("false")) {%>
                        <!-- 流程步骤，移交，阶段回复，分派 -->
                        <option value="${urlShowAuditReply104Page}"><bean:message bundle="securityobjaudit"
                    ...
                    <select id="dealSelector">
                        ...
                        <% if (ifwaitfor.equals("false")) {%>
                        <!-- 流程步骤，移交，阶段回复，分派 -->
                        <option value="${urlShowQualityInspection105Page}"><bean:message bundle="securityobjaudit"
                                                                                         key="operateType.QualityInspection105"/></option>
                        <option value="${urlShowQualityInspection106Page}"><bean:message bundle="securityobjaudit"
                    ...
                    <select id="dealSelector">
                        ...
                        <% if (ifwaitfor.equals("false")) {%>
                        <!-- 流程步骤，移交，阶段回复，分派 -->
                        <option value="${urlShowHoldTask18Page}"><bean:message bundle="securityobjaudit"
                                                                               key="operateType.HoldTask18"/></option>
                        <option value="${urlShowHoldTask107Page}"><bean:message bundle="securityobjaudit"
                    ...
                    <select id="dealSelector">
                        <option value="${urlShowDraftPage}"><bean:message bundle="securityobjaudit"
