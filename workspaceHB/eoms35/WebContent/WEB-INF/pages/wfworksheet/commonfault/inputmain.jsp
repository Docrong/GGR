...
<input type="hidden" name="sendType" value=""/>
	...
	<table id="sheetAlarm" class="formTable">	
		<c:if test="${status!=1}">
			...
			<tr>
			  ...
			  <td class="content">
			  	<input type="text" class="text" name="${sheetPageName}mainAlarmId" id="${sheetPageName}mainAlarmId" value="${sheetMain.mainAlarmId}" alt="allowBlank:true"/>
			  </td>
			  <td class="label"><bean:message bundle="commonfault" key="commonfault.mainAlarmNum"/></td>
			  <td class="content">
			  	<input type="text" class="text" name="${sheetPageName}mainAlarmNum" id="${sheetPageName}mainAlarmNum" value="${sheetMain.mainAlarmNum}" alt="allowBlank:true"/>
			  </td>
			</tr>		
			...
			<tr>
			  ...
			  <td>
			    <input type="text" class="text" name="${sheetPageName}mainAlarmLevel" id="${sheetPageName}mainAlarmLevel" value="${sheetMain.mainAlarmLevel}" alt="allowBlank:true"/>		   
			  </td>
			  <td class="label"><bean:message bundle="commonfault" key="commonfault.mainAlarmSource"/></td>
			  <td>
			  	<input type="text" class="text" name="${sheetPageName}mainAlarmSource" id="${sheetPageName}mainAlarmSource" value="${sheetMain.mainAlarmSource}" alt="allowBlank:true"/>
			  </td>
			</tr>
			...
			<tr>
			  ...
			  <td>
			  	<input type="text" class="text" name="${sheetPageName}mainAlarmLogicSort" id="${sheetPageName}mainAlarmLogicSort" value="${sheetMain.mainAlarmLogicSort}" alt="allowBlank:true"/>
			  </td>
			  <td class="label"><bean:message bundle="commonfault" key="commonfault.mainAlarmLogicSortSub"/></td>
			  <td>
			  	<input type="text" class="text" name="${sheetPageName}mainAlarmLogicSortSub" id="${sheetPageName}mainAlarmLogicSortSub" value="${sheetMain.mainAlarmLogicSortSub}" alt="allowBlank:true"/>
			  </td>
			</tr>
		...
		<c:if test="${status!=1}">
		   <tr>
            ...
            <tr>
			  ...
			  <td>
			  	<eoms:comboBox name="${sheetPageName}mainFaultResponseLevel" id="${sheetPageName}mainFaultResponseLevel" initDicId="1010304" defaultValue="${sheetMain.mainFaultResponseLevel}" alt="allowBlank:false" onchange="selectLimit(this.value);"/>
			  </td>		  
			</tr>
			<tr>
			...
			<tr>
			  ...
			  <td>
			    <input type="text" class="text" name="${sheetPageName}mainCompleteLimitT1" readonly="readonly" 
					...
					onclick="popUpCalendar(this, this)" alt="vtype:'lessThen',link:'${sheetPageName}sheetCompleteLimit',vtext:'T1处理时限不能晚于处理时限',allowBlank:false"/> 			  
			  </td>				
			  ...
			  <td>
			    <input type="text" class="text" name="${sheetPageName}mainCompleteLimitT2" readonly="readonly" 
					...
					onclick="popUpCalendar(this, this)" alt="vtype:'lessThen',link:'${sheetPageName}sheetCompleteLimit',vtext:'T2处理时限不能晚于处理时限',allowBlank:false"/>  
			  </td>		  
			</tr>
			<tr>
			  ...
			  <td colspan="3">
			    <input type="text" class="text" name="${sheetPageName}mainCompleteLimitT3" readonly="readonly" 
					id="${sheetPageName}mainCompleteLimitT3" value="${eoms:date2String(sheetMain.mainCompleteLimitT3)}" 
					onclick="popUpCalendar(this, this)" alt="vtype:'lessThen',link:'${sheetPageName}sheetCompleteLimit',vtext:'T3处理时限不能晚于处理时限',allowBlank:false"/> 			  
			  </td>	
	        ...
	        <tr>
	          ...
	          <c:if test="${!empty sheetMain.mainSendMode}">
			  <td>
			   <eoms:comboBox name="${sheetPageName}mainSendMode" id="${sheetPageName}mainSendMode" initDicId="1010305" defaultValue="${sheetMain.mainSendMode}"/>				
			  </td>
			  </c:if>
			  <td class="label"><bean:message bundle="commonfault" key="commonfault.mainNetName"/></td>
			  <td>
			  	<input type="text" class="text" name="${sheetPageName}mainNetName" id="${sheetPageName}mainNetName" value="${sheetMain.mainNetName}" alt="allowBlank:true"/>
			  </td>	    
			</tr>
			<tr>			
			   <td class="label"><bean:message bundle="commonfault" key="commonfault.mainEquipmentFactory"/>*</td>
			  <td>
			  	<eoms:comboBox name="${sheetPageName}mainEquipmentFactory" id="${sheetPageName}mainEquipmentFactory" initDicId="1010103" defaultValue="${sheetMain.mainEquipmentFactory}" alt="allowBlank:false"/>
			  </td>
			  <td class="label"><bean:message bundle="commonfault" key="commonfault.mainEquipmentModel"/></td>
			  <td>
			  	<input type="text" class="text" name="${sheetPageName}mainEquipmentModel" id="${sheetPageName}mainEquipmentModel" value="${sheetMain.mainEquipmentModel}" alt="allowBlank:true"/>
			  </td>
			...
			<tr>
			  ...
			  <td>
			  	<input type="text" class="text" name="${sheetPageName}mainFaultGenerantTime" readonly="readonly" 
					id="${sheetPageName}mainFaultGenerantTime" value="${eoms:date2String(sheetMain.mainFaultGenerantTime)}" 
			  ...
			  <td >
 					<eoms:comboBox name="${sheetPageName}mainFaultDiscoverableMode" id="${sheetPageName}mainFaultDiscoverableMode" initDicId="1010301" defaultValue="${sheetMain.mainFaultDiscoverableMode}" alt="allowBlank:false"/>
			  </td>	  			  
			</tr>
			...
			<tr>
			  ...
			  <td class="label"><bean:message bundle="commonfault" key="commonfault.mainFaultGenerantCity"/>*</td>              
               ...
               <input type="text" class="text"  readonly="readonly" name="${sheetPageName}showDept" id="${sheetPageName}showDept" alt="allowBlank:false,vtext:'请选择地域名称'" value="<eoms:id2nameDB id='${sheetMain.toDeptId}' beanId='tawSystemAreaDao'/>"/>
			...
			<tr>
			  ...
			  <td>
			  	<input type="text" class="text" name="${sheetPageName}mainApplySheetId" id="${sheetPageName}mainApplySheetId" value="${sheetMain.mainApplySheetId}" />
			  </td>
			  <td class="label">故障发现时间</td>
			  <td>
			  	<input type="text" class="text" name="${sheetPageName}mainDetectFaultTime" readonly="readonly" 
					id="${sheetPageName}mainDetectFaultTime" value="${eoms:date2String(sheetMain.mainDetectFaultTime)}" 
			...
			<tr>
			  ...
			  <td>
			  	<input type="text" class="text" name="${sheetPageName}mainSendSystem" id="${sheetPageName}mainSendSystem" value="${sheetMain.mainSendSystem}" />
			  </td>	 
			</tr>					
		  ...
		  <table id="sheet" class="formTable">
			...
			<tr>
			 ...
			 <td class="label"><bean:message bundle="commonfault" key="commonfault.mainIfAffectOperation"/>*</td>
			  <td >
			  	<eoms:comboBox name="${sheetPageName}mainIfAffectOperation" id="${sheetPageName}mainIfAffectOperation" initDicId="10301" defaultValue="${sheetMain.mainIfAffectOperation}" alt="allowBlank:false"/>
			  </td>

			  <td class="label">特殊工单说明*</td>
			  <td >
			  	<eoms:comboBox name="${sheetPageName}mainPretreatment" id="${sheetPageName}mainPretreatment" initDicId="10301" defaultValue="${sheetMain.mainPretreatment}" alt="allowBlank:false" onchange="ifDoT1Deal(this.value)"/>
			...
			<tr id="t1tr1">
			  ...
			  <td >
			  	<eoms:comboBox name="${sheetPageName}linkIfMutualCommunication" id="${sheetPageName}linkIfMutualCommunication" initDicId="10301" defaultValue="${sheetMain.linkIfMutualCommunication}"/>
			  </td>
			  <td class="label"><bean:message bundle="commonfault" key="commonfault.mainIfSafe"/></td>
			  <td >
			  	<eoms:comboBox name="${sheetPageName}linkIfSafe" id="${sheetPageName}linkIfSafe" initDicId="10301" defaultValue="${sheetMain.linkIfSafe}"/>
			  </td>			  
			</tr>
	        <tr id="t1tr2">
			  <td class="label"><bean:message bundle="commonfault" key="commonfault.linkIfGreatFault"/></td>
			  <td  coslpan="3">
			  	<eoms:comboBox name="${sheetPageName}linkIfGreatFault" id="${sheetPageName}linkIfGreatFault" initDicId="10301" defaultValue="${sheetMain.linkIfGreatFault}"/>
			  </td>
			...
			<tr id="t1tr3">
			  ...
			  <td colspan="3">
				 <textarea name="${sheetPageName}linkFaultFirstDealDesc" id="${sheetPageName}linkFaultFirstDealDesc" 
				    class="textarea max" alt="allowBlank:false,width:500,maxLength:1000,vtext:'最多输入500汉字'" >${sheetMain.linkFaultFirstDealDesc}</textarea>	  
			  </td>
			</tr>		
	...
	<br/>
<table id="faultPack" class="formTable">
	<%if(!"DraftHumTask".equals(taskName)) {%>
	<tr>
		<td class="label" colspan="4"><iframe id="alarmList" height="480"
			width="100%" height="100%"
			src="../commonfault/commonfaultpack.do?method=showOwnStarterList&mainId=${sheetMain.id}&alarmMethod=new"></iframe>
		</td>
...
<script type="text/javascript">
 ...
 {  
   ...
   { //打包工单
   $('sheetAlarm').hide();    
     v1.disableArea('sheetAlarm');   
     v1.enableArea('faultPack',true); 
   } else if(obj==1030102){ 
      v1.enableArea('sheetAlarm');   
      v1.disableArea('faultPack',true);
  }
  }
   var faultPack='${sheetMain.mainIsPack}'; 
   if(faultPack==1030102){
    //普通故障工单  
    v1.disableArea('faultPack',true); 
    }
   else if(faultPack==1030101)
   { //打包工单 
     v1.disableArea('sheetAlarm',true);  
   }else
   { 
     v1.disableArea('faultPack',true); 
   }
