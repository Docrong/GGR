    ...
    <script type="text/javascript">
        var config = {
            ...
            ctxMenu: [
                {
                    id: 'newnode',
                    text: '<fmt:message key="kmTableTheme.tree.add"/>',
                    cls: 'new-mi',
                    url: '${app}/kmmanager/kmTableThemes.do?method=add&nodeId='
                },
                {
                    id: 'edtnode',
                    text: '<fmt:message key="kmTableTheme.tree.edit"/>',
                    cls: 'edit-mi',
                    url: '${app}/kmmanager/kmTableThemes.do?method=edit&nodeId='
                },
                {
                    id: 'delnode',
                    isDelete: true,
                    text: '<fmt:message key="kmTableTheme.tree.delete"/>',
                    cls: 'remove-mi',
                    url: '${app}/kmmanager/kmTableThemes.do?method=remove&nodeId='
                },
                {
                    id: 'audnode',
                    text: '配置审核人',
                    cls: 'edit-mi',
                    url: '${app}/kmmanager/kmTableThemes.do?method=audit&nodeId='
                },
                {
                    id: 'operate',
                    text: '配置权限',
                    cls: 'edit-mi',
                    url: '${app}/kmmanager/kmOperates.do?method=userTree&nodeType=content&node='
                }
            ],//end of ctxMenu
            /************************
