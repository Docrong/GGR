...
<html:form action="/bureaudataUpdate.do?method=newPerformAdd" styleId="theform">
    ...
    <logic:notPresent name="templateManage">
        ...
        <html:submit styleClass="btn" property="method.saveDraft" onclick="v.passing=true;return changeType2()"
        ...
        <html:button styleClass="btn" property="method.save" styleId="method.save"
                     onclick="window.open('./bureaudataUpdate.do?method=getTemplatesByUserId',null,'left=300,top=150,height=400,width=500,scrollbars=yes,resizable=yes')">
