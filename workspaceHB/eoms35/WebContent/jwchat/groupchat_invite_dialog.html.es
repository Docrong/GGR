    ...
    <head>
        ...
        <meta http-equiv="content-type" content="text/html; charset=utf-8">
          ...
          function init() {
              ...
              document.title = "Invitar Usuarios a "+opener.parent.jid;
          }
    ...
    <body style="margin: 8px;">
        <table width="100%" height="100%">
            <form name="invite_form">
                <tr>
                    <td valign=top nowrap>Seleccionar Usuario(s):</td>
                    <td align=left width="100%">
                        <select name="users_selector" id="users_selector" size=3 multiple style="width:100%;"></select>
                    </td>
                </tr>
                <tr>
                    <td colspan=2
            ...
            <tr>
                ...
                >
                <textarea name="reason" style="width:100%;height:100%">
            </textarea>
        </td>
    </tr>
    <tr>
...
<tr>
    ...
    >
    <button type=submit onClick="return doSub();">Invitar
</button>
</td>
</tr>
<
