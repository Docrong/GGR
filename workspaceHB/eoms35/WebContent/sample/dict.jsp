...
<jsp:directive.page import="com.boco.eoms.sequence.test.Helper"/>
...
<eoms:dict key="sample-relation" relationId="majorrelation" selectId="A1" beanId="selectXML" subid="A2"
           onchange="aa();"/>
