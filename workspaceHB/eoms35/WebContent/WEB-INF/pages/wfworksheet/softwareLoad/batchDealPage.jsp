  ...
  <div id="sheetinfo">
	...
	<table class="formTable"> 
	  <caption></caption>
			      ...
			      <tr>
		            <td class="label"><bean:message bundle="softwareLoad" key="softwareLoad.mainTaskDescription"/></td>
	               ...
	               <tr>
		            	...
		            	<td class="content">  
		            		<select id="dealSelector" onchange="checkValue(this)" alt="allowBlank:false,vtext:'请选择处理操作'">
		            			 <option value=""></option>
		            			 <option value="Receive"><bean:message bundle="softwareLoad" key="softwareLoad.dealrejectpass"/></option>
			 					 <option value="ExcuteHumTask"><bean:message bundle="softwareLoad" key="softwareLoad.nopassback"/></option>
			 				</select> 
			        	</td>	   
		            	<td class="label"></td>
		                <td class="content">
					         ...
					         <input type="hidden" name="mainClassName" value="com.boco.eoms.sheet.softwareLoad.model.SoftwareLoadMain"/>	
					         <input type="hidden" name="linkClassName" value="com.boco.eoms.sheet.softwareLoad.model.SoftwareLoadLink"/>
