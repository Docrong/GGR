        ...
        <td colspan="3">
            ...
            <c:if test="${!empty taskName}">
                ...
                <c:if test="${empty sheetMain.title}">
                    <input type="text" name="${sheetPageName}title" class="text max" id="${sheetPageName}title"
                           ...
                           alt="allowBlank:false,vtext:'<bean:message bundle="sheet" key="mainForm.titleCheck"/>'"/>${title}
                </c:if>
            </c:if>


            <c:if test="${!empty sheetMain.title}">
                <bean:write name="sheetMain" property="title" scope="request"/> ${title}
            </c:if>
            ...
            <c:if test="${empty taskName}">
                <c:if test="${!empty title}">
                    ${title}
                    <input type="hidden" name="${sheetPageName}title" class="text max" id="${sheetPageName}title"
                           value="${title}"/>
                </c:if>
