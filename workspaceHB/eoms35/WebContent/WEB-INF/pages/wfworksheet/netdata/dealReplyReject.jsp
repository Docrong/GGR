...
<div id="sheetform">
<html:form action="/netdata.do?method=performDealReplyReject" styleId="theform">
 <%@ include file="/common/taglibs.jsp"%>
<%
 ...
 %>
    ...
    <input type="hidden" name="${sheetPageName}subtaskName" value="netDataSubTask1"/> 
    ...
    <input type="hidden" name="${sheetPageName}taskNamespace" value="http://NetDataProcess"/>  
<%@ include file="/WEB-INF/pages/wfworksheet/netdata/baseinputlinkhtmlnew.jsp"%>
     ...
     <tr>
      ...
      <logic:iterate id="toTask" name="acceptList" type="com.boco.eoms.sheet.netdata.model.NetDataTask">  
        <tr>
          <td>
