...
if(colNum != 0)
{
	...
	for(int Col = 1; Col < SysVect.size(); Col ++)
	{
		...
		out.println("<td align=center><b><font size=2 color=#000000 face='Verdana, Arial, Helvetica, sans-serif'>"+StaticMethod.dbNull2String(SysColIndex.getCc_name())+"</font></b></td>");
	}
	%>
	</tr>
	<%
	...
	if(rs.getRowCount() >= 1)
	{
		for(int i = 1; i <= rs.getCurrentPageRowNum(); i++)
		{
			...
			out.println("<tr bgcolor="+((i%2 == 0)?"#eaeaea":"#eeeeee")+"><td></td>");
			int temp = 0;
			int tempFlag = 0;
