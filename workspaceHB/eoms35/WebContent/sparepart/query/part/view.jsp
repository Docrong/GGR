...
<center>
    ...
    <table border="0" width="95%" cellspacing="0">
        <tr>
            <td width="106%" class="table_title" align="center">${eoms:a2u('备件查询结果显示')}<bean:message
                    key="label.list"/></td>
        </tr>
    </table>
    <table border="0" width="95%" cellspacing="1" cellpadding="1" class="table_show" align=center>
        ...
        <logic:iterate id="sparepart" name="sparepart" type="com.boco.eoms.sparepart.model.TawPart">
            ...
            <a href="../part/amplyview.do?id=<bean:write name="sparepart" property="id" scope="page"/>">
                <tr <%if(stateId.intValue()==12){%>class="tr_show_fg_red" <%}else{%>class="tr_show"<%}%> align="center"
                    style="cursor:hand" onmousemove="this.style.backgroundColor='#87CEEB'"
