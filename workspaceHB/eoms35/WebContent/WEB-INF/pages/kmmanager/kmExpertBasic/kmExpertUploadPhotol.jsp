...
<div>
    ...
    <!-- 界面右半部分 -->
    <form name="kmExpertPhotoForm" id="kmExpertPhotoForm" method="post"
          action="${app}/kmmanager/kmExpertPhoto.do?method=uploadPhotoDo" enctype="multipart/form-data"
          styleId="kmExpertPhotoForm">
        <div class="right">
            <!--Step 1-->
            <div id="Step1Container">
                ...
                <div id="uploadcontainer">
                    ...
                    <div class="uploaddiv">
                        <html:hidden property="userId" value="${kmExpertPhotoForm.userId}"/>
                        <input type="file" name="file" id="file" title="选择照片"/>
                    </div>
                    <div class="uploaddiv">
