...
<div id="sheetform">
    <html:form action="/complaint.do?method=performCreateSubTask" styleId="theform">
      ...
      <table class="formTable">
         ...
         <input type="hidden" name="${sheetPageName}taskNamespace" value="http://ComplaintProcess"/>       
	    ...
	    <tr>	
          ...
          <td colspan="3">
		    <eoms:attachment idList="" idField="${sheetPageName}nodeAccessories" appCode="complaint"/>
		  </td>	
	   </tr>  
     </table>
