...
alter table GROUPCHECK_MAIN add constraint GROUPCHECK_MAIN_PK primary key (id)  using index;
...
alter table GROUPCHECK_TASK add constraint GROUPCHECK_TASK_PK primary key (id)  using index;
...
values ('xls,txt,doc,jpg,gif', 'groupcheck', '集客投诉核查工单流程', 1024, '/sheet/groupcheck', 78, '297e58995f9a7853015f9a7854000000');

--插入角色
insert into taw_system_role(role_id,deleted,parent_id,role_name,roletype_id,workflow_flag,leaf) values('9701','0','0','建单人','1','97','1');
insert into taw_system_role(role_id,deleted,parent_id,role_name,roletype_id,workflow_flag,leaf) values('9702','0','0','地市核查组','1','97','1');

--插入菜单
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('297e58995f9a7853015f9a7854000001', '14001', '1', '新增工单', '140', null, '/sheet/groupcheck/groupcheck.do?method=showNewSheetPage', '0', '0', 1);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('297e58995f9a7853015f9a7854000002', '14003', '0', '待处理工单', '140', null, null, '0', '0', 3);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('297e58995f9a7853015f9a7854000003', '1400301', '1', '待办工单', '14003', null, '/sheet/groupcheck/groupcheck.do?method=showListsendundo', '0', '0', 1);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('297e58995f9a7853015f9a7854000004', '14007', '1', '工单查询', '140', null, '/sheet/groupcheck/groupcheck.do?method=showQueryPage', '0', '0', 7);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('297e58995f9a7853015f9a7854000005', '14008', '1', '工单处理模板', '140', null, '/sheet/groupcheck/groupcheck.do?method=getDealTemplatesByUserId&&type=templateManage', '0', '0', 8);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('297e58995f9a7853015f9a7854000006', '14009', '1', '工单模板管理', '140', null, '/sheet/groupcheck/groupcheck.do?method=getTemplatesByUserId&&type=templateManage', '0', '0', 9);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('297e58995f9a7853015f9a7854000007', '14010', '1', '管理者工单', '140', null, '/sheet/groupcheck/groupcheck.do?method=showListForAdmin', '0', '0', 10);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('297e58995f9a7853015f9a7854000008', '140', '0', '集客投诉核查工单流程', '10', null, '/sheet/groupcheck/groupcheck.do?method=showDrawing', '0', '0', 20);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('297e58995f9a7853015f9a7854000009', '14002', '1', '草稿列表', '140', null, '/sheet/groupcheck/groupcheck.do?method=showDraftList', '0', '0', 2);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('297e58995f9a7853015f9a785400000a', '14004', '0', '已处理工单', '140', null, null, '0', '0', 4);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('297e58995f9a7853015f9a785400000b','1400402','1','建立工单','14004', null, '/sheet/groupcheck/groupcheck.do?method=showOwnStarterList','0','0',2);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('297e58995f9a7853015f9a785400000c', '1400401', '1', '处理工单', '14004', null, '/sheet/groupcheck/groupcheck.do?method=showListsenddone', '0', '0', 1);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('297e58995f9a7853015f9a785400000d', '14005', '1', '已归档工单', '140', null, '/sheet/groupcheck/groupcheck.do?method=showHoldedList', '0', '0', 5);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('297e58995f9a7853015f9a785400000e', '14006', '1', '已作废工单', '140', null, '/sheet/groupcheck/groupcheck.do?method=showCancelList', '0', '0', 6);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('297e58995f9a7853015f9a785400000f', '14011', '1', '超时时间设置', '140', null, '/sheet/overtimetip/overtimetip.do?flowName=GroupCheck', '0', '0', 11);
insert into TAW_SYSTEM_PRIV_OPERATION (ID, CODE, ISAPP, NAME, PARENTCODE, REMARK, URL, DELETED, HIDED, ORDERBY)
values ('297e58995f9a7853015f9a7854000010', '14012', '1', '工单处理时限配置', '140', null, '/sheet/newSheetLimit/sheetLimit.do?method=getLevelLimitList&&flowName=GroupCheck', '0', '0', 30);