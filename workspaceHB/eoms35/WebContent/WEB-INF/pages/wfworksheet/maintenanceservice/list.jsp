...
<c:if test="${findForward != null && findForward == 'list'}">
    <jsp:include page="/WEB-INF/pages/wfworksheet/maintenanceservice/listsendUndoJS.jsp"/>
</c:if>
<%} %>
...
<display:table name="taskList" cellspacing="0" cellpadding="0"
               ...
               export="true" requestURI="maintenanceservice.do"
               sort="list" size="total" partialList="true"
               decorator="com.boco.eoms.sheet.maintenanceservice.webapp.action.ProcessListMaintenanceServiceDisplaytagDecoratorHelper">
        ...
        <display:footer>
            <tr>
                <td colspan="15">
                    ...
                    <input type="button" value="批量审批" onclick="loadBatchPage(this)" class="btn" operateType="105">
