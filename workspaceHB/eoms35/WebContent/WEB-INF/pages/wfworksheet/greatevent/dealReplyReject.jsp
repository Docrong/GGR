...
<div id="sheetform">
    <html:form action="/greatevent.do?method=performDealReplyReject" styleId="theform">
        ...
        <input type="hidden" name="${sheetPageName}mainClassName"
               value="com.boco.eoms.sheet.greatevent.model.GreatEventMain"/>
        <input type="hidden" name="${sheetPageName}linkClassName"
               value="com.boco.eoms.sheet.greatevent.model.GreatEventLink"/>
            ...
            <tr>
                ...
                <td colspan="3">
		           <textarea name="${sheetPageName}remark" class="textarea max" id="${sheetPageName}remark"
                             alt="allowBlank:true,maxLength:255,vtext:'请填入信息，最多输入125字'"
