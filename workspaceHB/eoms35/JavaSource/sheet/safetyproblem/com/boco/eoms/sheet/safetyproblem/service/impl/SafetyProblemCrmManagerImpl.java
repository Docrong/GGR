...
public class SafetyProblemCrmManagerImpl extends InterfaceServiceManageAbstract implements IInterfaceServiceManage {
        ...
        try {
            ...
            if (type.equals(InterfaceConstants.WORKSHEET_NEW) || type.equals(InterfaceConstants.WORKSHEET_RENEW)) {
                ...
                if (type.equals(InterfaceConstants.WORKSHEET_NEW)) {
                    ...
                    String subRoleId = "";
                    TawSystemSubRole subRole = sm.getMatchRoles("SafetyProblemMainFlowProcess", toDeptId, bigRole, map);
