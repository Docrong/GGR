...
<fmt:bundle basename="com/boco/eoms/km/config/applicationResource-kmmanager">
    ...
    <display:table name="trainInformationList" cellspacing="0" cellpadding="0"
        ...
        <display:column property="trainName" sortable="true"
                        headerClass="sortable" titleKey="trainInformation.trainName"
                        href="${app}/trainInformation/trainInformations.do?method=edit" paramId="id"
                        paramProperty="id"/>

        <display:column property="trainGrade" sortable="true"
                        headerClass="sortable" titleKey="trainInformation.trainGrade"
                        href="${app}/trainInformation/trainInformations.do?method=edit" paramId="id"
                        paramProperty="id"/>

        <display:column property="trainAddress" sortable="true"
                        headerClass="sortable" titleKey="trainInformation.trainAddress"
                        href="${app}/trainInformation/trainInformations.do?method=edit" paramId="id"
                        paramProperty="id"/>

        <display:column property="trainTime" sortable="true" format="{0,date,yyyy-MM-dd HH:mm:ss}"
                        headerClass="sortable" titleKey="trainInformation.trainTime"
                        href="${app}/trainInformation/trainInformations.do?method=edit" paramId="id"
                        paramProperty="id"/>

        <display:column property="trainBeginTime" sortable="true" format="{0,date,yyyy-MM-dd HH:mm:ss}"
                        headerClass="sortable" titleKey="trainInformation.trainBeginTime"
                        href="${app}/trainInformation/trainInformations.do?method=edit" paramId="id"
                        paramProperty="id"/>

        <display:column property="trainEndTime" sortable="true" format="{0,date,yyyy-MM-dd HH:mm:ss}"
                        headerClass="sortable" titleKey="trainInformation.trainEndTime"
                        href="${app}/trainInformation/trainInformations.do?method=edit" paramId="id"
                        paramProperty="id"/>

        <display:column property="trainDept" sortable="true"
                        headerClass="sortable" titleKey="trainInformation.trainDept"
                        href="${app}/trainInformation/trainInformations.do?method=edit" paramId="id"
                        paramProperty="id"/>

        <display:column property="trainDocument" sortable="true"
                        headerClass="sortable" titleKey="trainInformation.trainDocument"
                        href="${app}/trainInformation/trainInformations.do?method=edit" paramId="id"
                        paramProperty="id"/>

        <display:column property="trainVender" sortable="true"
                        headerClass="sortable" titleKey="trainInformation.trainVender"
                        href="${app}/trainInformation/trainInformations.do?method=edit" paramId="id"
                        paramProperty="id"/>

        <display:column property="trainSpeciality" sortable="true"
                        headerClass="sortable" titleKey="trainInformation.trainSpeciality"
                        href="${app}/trainInformation/trainInformations.do?method=edit" paramId="id"
                        paramProperty="id"/>

        <display:column property="trainType" sortable="true"
                        headerClass="sortable" titleKey="trainInformation.trainType"
                        href="${app}/trainInformation/trainInformations.do?method=edit" paramId="id"
                        paramProperty="id"/>
