...
<div id="sheetform">
    <html:form action="/industrysms.do?method=performDealReplyReject" styleId="theform">
        <%
        ...
        <input type="hidden" name="subtaskName" value="IndustrySmsSubTask"/>
        ...
        <input type="hidden" name="taskNamespace" value="http://IndustrySms"/>
