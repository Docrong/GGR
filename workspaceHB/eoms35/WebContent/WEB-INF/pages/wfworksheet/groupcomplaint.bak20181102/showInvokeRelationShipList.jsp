...
<div id="showInvokeRelationShipList" class="panel"> 
     <div class="history-item" width="100%" ><!-- add space to hack ie-->&nbsp;
  	...
  	<logic:present name="showInvokeRelationShipList">
  	 <logic:iterate id="showInvokeRelationShip" name="showInvokeRelationShipList" type="com.boco.eoms.sheet.groupcomplaint.model.GroupComplaintMain" scope="request">
  				<tr>
  				 <td nowrap="nowrap">
  				      <a href="${app}/sheet/groupcomplaint/groupcomplaint.do?method=showDetailPage&sheetKey=${showInvokeRelationShip.id}" target="_blank">${showInvokeRelationShip.sheetId}</a>
                  </td>     
  				  <td nowrap="nowrap">
				      ${proccessName}
  				  </td>
  				  ...
  				  <td nowrap="nowrap">
                  		<eoms:dict key="dict-sheet-commonfault" dictId="activeTemplateId" itemId="${activeTemplateId}" beanId="id2descriptionXML" /> 
                  </td> 
  				  <td nowrap="nowrap">
