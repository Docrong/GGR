...
<fmt:bundle basename="com/boco/eoms/duty/config/ApplicationResources-duty">
    ...
    <html:form method="post" action="/TawRmRecord/ynexchange">
        ...
        <TABLE cellSpacing="1" cellPadding="1" width="600" align="center"
            ...
            <TR class="tr_show">
                <TD noWrap rowSpan="4" align="center" class="label">&nbsp;<bean:message
            ...
            <TR class="tr_show">
                ...
                <TD colSpan="3">
                    <TEXTAREA name=netfault rows=6 style="width:95%;BACKGROUND-COLOR: lightgrey"
            ...
            <TR class="tr_show">
                ...
                <TD colSpan="3">
                    <TEXTAREA name=importantaffair rows=6 style="width:95%;BACKGROUND-COLOR: lightgrey"
                              readonly="readonly"><bean:write name="tawRmRecordForm"
                                                              property="importantaffair"/></TEXTAREA>
                </TD>
            </TR>
            <TR class="tr_show">
                <TD align="left" class="label">${eoms:a2u('需要省公司协调事项')}</TD>
                <TD colSpan="3">
                    <TEXTAREA name=harmony rows=6 style="width:95%;BACKGROUND-COLOR: lightgrey"
            ...
            <TR class="tr_show">
                ...
                <TD colSpan="3">
                    <TEXTAREA name=otheraffair rows=6 style="height:150;width:95%;BACKGROUND-COLOR: lightgrey"
            ...
            <TR class="tr_show">
                ...
                <TD colSpan=6>
                    <TEXTAREA id=notes name=notes rows=4 cols=80 type="_moz"><bean:write name="tawRmRecordForm"
                                                                                         property="notes"
            ...
            <TR>
                ...
                <TD align=right height="32" colSpan=7>
                    <input type="button" name="button" class="clsbtn2"
                           value=
                               <bean:message key="label.save"/> Onclick="save_merge();">
                </TD>
                <%
                } else {
                %>
    ...
    <display:table name="TawRmDutyEventList" cellspacing="0" cellpadding="0"
    	...
    	<span onclick="showSubList2('<bean:write name="TawRmDutyEventList"
                                                 property="id"/>', this, 'TawRmDutyEventList');">
