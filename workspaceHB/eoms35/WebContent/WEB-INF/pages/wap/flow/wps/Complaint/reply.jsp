                ...
                <div class="div_all">
                    <table width="100%" border="0" cellpadding="1" cellspacing="1" class="add_table_bg"
                        ...
                        <tr class="fb_xx_head_tr">
                            ...
                            <td class="fb_add_content">
                                <input type="text" name="linkFaultStartTime"
                        ...
                        <tr class="fb_xx_head_tr">
                            ...
                            <td class="fb_add_content">
                                <input type="text" name="linkFaultEndTime"
                                       value="<%=StaticMethod.getCurrentDateTime() %>"/>
                            </td>
                        </tr>
                        ...
                        <tr class="fb_xx_head_tr">
                            ...
                            <td class="fb_add_content">
                                <input type="text" name="issueEliminatTime"
                                       value="<%=StaticMethod.getCurrentDateTime() %>"/>
                            </td>
                        </tr>
                        ...
                        <tr class="fb_xx_head_tr">
                            ...
                            <td class="fb_add_content" style="word-wrap:break-word;word-break:break-all"><textarea
                                    name="dealDesc"></textarea></td>
                        </tr>
