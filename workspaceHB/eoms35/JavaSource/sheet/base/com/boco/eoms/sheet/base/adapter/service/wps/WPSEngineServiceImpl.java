...
public class WPSEngineServiceImpl implements IWorkflowEngineService {
	...
	/**
	 * @param processCacheMap
	 *            The processCacheMap to set.
	 */
	 ...
	 *             thrown by the method if any exception happened
	 */
	 ...
	 * 
	 * @param size
	 *            the number of process templates returned
	 ...
	 * 
	 * @param processTemplateName
	 *            the specified process template name
	 ...
	 *            the process template name
	 * @param size
	 *            the size of process instances returned
	 ...
	 * 
	 * @param size
	 *            the number of process instances returned
	 ...
	 *            the name of parent process instance
	 ...
	 *            the name of parent process instance
	 * @param size
	 *            number of process instances returned
	 * @return the subProcess instances
	 * @throws Exception
	 *             thrown by the method is any exception happened
	 */
	 ...
	 * 
	 * @param processId
	 *            the processId which can uniquely identify the process instance
	 ...
	 * @param operationName
	 *            the specified operationName
	 * @param parameters
	 *            the HashMap representation of the input BO of the process
...
//		}
	 ...
	 *            the specified process template name
	 * @param operationName
	 *            the operation name corresponding to start activity of the
	 *            process
	 * @param parameters
	 *            the HashMap representation of the input BO of the process
	 * @param properties
	 *            the HashMap representation of specified custom properties.
	 ...
	 * 
	 * @param processId
	 *            the process ID which can uniquely identify the process
	 *            instance
	 ...
	 * 
	 * @param processId
	 *            the process ID which uniquely represent the process instance
	 ...
	 *            instance
	 * @param properties
	 *            the HashMap representation of the custom properties
	 * @throws InvalidParameterException
	 * @throws UnauthorizedException
	 * @throws Exception
	 */
	 ...
	 * 
	 * @param activityId
	 *            the activity ID which can uniquely identify the activity
	 *            instance
	 * @param assignReason
	 ...
	 * 
	 * @param processId
	 *            the process ID which can uniquely represent the process
	 *            instance
	 * @param assignReason
	 *            the assignment reason
	 * @param userName
	 ...
	 * 
	 * @param activityId
	 *            the activity ID which can uniquely represent the activity
	 * @param assignReason
	 *            the assignment reason
	 * @param userName
	 *            the user name
	 ...
	 *            the variable name
	 * @param parameters
	 *            representation of the variable value;If variable is
	 ...
	 * 
	 * @param processId
	 *            the processId which identify the process instance
	 * @throws InvalidParameterException
	 * @throws UnauthorizedException
	 * @throws Exception
	 */
	 ...
	 * 
	 * @param startIndex
	 *            from which index that a task is returned
	 * @param length
	 *            the number of tasks to be returned
	 * @param filter
	 *            the filter condition
	 ...
	 *            instance
	 * @param parameters
	 *            the HashMap representation of the output BO
	 * @throws InvalidParameterException
	 * @throws UnauthorizedException
	 * @throws Exception
	 */
	 ...
	 * @param taskId
	 *            任务ID
	 * @param fromOwnerUserId
	 *            任务移交者用户ID
	 * @param fromOwnerRoleId
	 *            任务移交者角色ID
	 * @param toOwnerRoleId
	 *            任务被移交者角色ID
	 * @param toOwnerUserId
