...
<fmt:bundle basename="config/ApplicationResources-statistic-task">
    <display:table name="estList" cellspacing="0" cellpadding="0"
        ...
        <display:column property="sheetid" sortable="true"
                        headerClass="sortable" titleKey="list.sheetid"
                        href="${scheme}://${serverName}:${serverPort}/tasksheet.pr.prShowQueryInfo.do?detail/isDetail=1"
                        paramId="sheetid" paramProperty="sheetid"/>
