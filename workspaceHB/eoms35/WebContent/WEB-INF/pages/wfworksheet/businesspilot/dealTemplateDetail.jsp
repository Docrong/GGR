      ...
      <%if(operateType.equals("1")){ %>
			...
			<input type="hidden" name="${sheetPageName}phaseId" id="${sheetPageName}phaseId" value="" />
		       <tr>
 			   ...
 			   <tr>
  				  ...
  				  <td class="content" colspan=3>
  				  	<eoms:comboBox name="${sheetPageName}linkTestResult" id="${sheetPageName}linkTestResult" initDicId="10301" onchange="ifTestPass(this.value);" defaultValue="${sheetLink.linkTestResult}"/>
                  </td>	
               </tr>
               <tr>                 
  				  <td class="label">
  				   ...
  				   <td class="content" colspan=3>
  				   	<eoms:comboBox name="${sheetPageName}linkNetType" id="${sheetPageName}linkNetType" initDicId="10301" defaultValue="${sheetLink.linkNetType}"/>
                  </td>	                  
	  		  </tr>	
               ...
               <tr>
  				  ...
  				  <td class="content" colspan=3>
  				   	<textarea name="linkBusDesc" id="linkBusDesc" class="textarea max" alt="allowBlank:false">${sheetLink.linkBusDesc}</textarea>	  
                  </td>
	  		  </tr>	
		  		 <tr>  				
  				  <td class="label">
		...
		<%if(operateType.equals("5")){ %>
			...
			<input type="hidden" name="${sheetPageName}phaseId" id="${sheetPageName}phaseId" value="prepare" />
                ...
                <tr>
				  ...
				  <td colspan=3>
				     <textarea name="linkIlluminate" id="linkIlluminate" class="textarea max" alt="allowBlank:false">${sheetLink.linkIlluminate}</textarea>	  
                </td>
  		       </tr>	
		     ...
		     <%if(operateType.equals("66")){ %>
			   ...
			   <input type="hidden" name="${sheetPageName}phaseId" id="${sheetPageName}phaseId" value="run" />
               	...
               	<tr>
	  				  ...
	  				  <td colspan=3>
	  				   	<eoms:comboBox name="${sheetPageName}linkDeviceVerify" id="${sheetPageName}linkDeviceVerify" initDicId="1011608" defaultValue="${sheetLink.linkDeviceVerify}"/>
		  ...
		  <%if(operateType.equals("46")){ %>
			...
			<input type="hidden" name="${sheetPageName}phaseId" id="${sheetPageName}phaseId" value="check" />
		          ...
		          <tr>
 	                   ...
 	                   id="linkRunFeedBack" class="textarea max" alt="allowBlank:false">${sheetLink.linkRunFeedBack}</textarea>
	                  </td>
		  		 </tr>	
		  		  <tr>  				
	  				   <td class="label">
		  ...
		  <%if(operateType.equals("64")){ %>
			...
			<input type="hidden" name="${sheetPageName}phaseId" id="${sheetPageName}phaseId" value="report" />
		        ...
		        <tr>
	  				  ...
	  				  <td colspan=3>
	  				   	<eoms:comboBox name="${sheetPageName}linkIsUpdate" id="${sheetPageName}linkIsUpdate" initDicId="1011608" defaultValue="${sheetLink.linkIsUpdate}"/>
                     </td>
		  		</tr>	
                ...
                <tr>
	  				  ...
	  				  <td colspan=3>
		  				   <textarea name="linkUpdateAdvice" id="linkUpdateAdvice" class="textarea max" alt="allowBlank:false">${sheetLink.linkUpdateAdvice}</textarea>
		              </td>
		  		</tr>	
		  ...
		  <%if(operateType.equals("7")){ %>
			...
			<input type="hidden" name="${sheetPageName}phaseId" id="${sheetPageName}phaseId" value="note" />
		          ...
		          <tr>
	  				  ...
	  				  <td colspan=3>
	  				   	<eoms:comboBox name="${sheetPageName}linkIsSuccess" id="${sheetPageName}linkIsSuccess" initDicId="1011608" defaultValue="${sheetLink.linkIsSuccess}"/>
	                  </td>
		  		 </tr>	
		  		 <tr>  				
  				  <td class="label">
			  ...
			  <tr>
			    ...
			    <td colspan="3">
			      <eoms:comboBox name="${sheetPageName}linkIsFinish" 
			        id="${sheetPageName}linkIsFinish" defaultValue="${sheetMain.holdStatisfied}" initDicId="10301" onchange="isFinish(this.value);" styleClass="select" alt="allowBlank:false"/>
			    </td>
			  </tr>
			 ...
			 <tr id="isChange" style="display:none">
			    ...
			    <td colspan="3">
			      <eoms:comboBox name="${sheetPageName}linkIsChange" 
			        id="${sheetPageName}linkIsChange" defaultValue="${sheetMain.holdStatisfied}" initDicId="10301" styleClass="select" alt="allowBlank:false"/>
			    </td>
			  </tr>
		  	<%} %>
		<%} %>	
