...
public class SmartUpload
{
        ...
        throws SmartUploadException, IOException, ServletException
    {
        ...
        try {
          ...
          System.out.println("error in io "+ex.toString());
        }catch(IllegalStateException ex){
          System.out.println("error in others "+ex.toString());
        }
    ...
    protected String getPhysicalPath(String filePathName, int option)
        throws IOException
    {
      return getPhysicalPath( filePathName,  option, false);
    }
    protected String getPhysicalPath(String filePathName, int option, boolean IsCreateFolder)
        throws IOException
    {
