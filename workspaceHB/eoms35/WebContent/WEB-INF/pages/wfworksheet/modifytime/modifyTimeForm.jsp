    ...
    <table class="listTable">
        ...
        <tr>
            ...
            <td class="content">
                ...
                <html:text property="functionary" styleId="functionary" styleClass="text medium"
        ...
        <tr>
            ...
            <td>
                <eoms:comboBox name="specialtyOne" id="specialtyOne"
                               sub="specialtyTwo" initDicId="1010104" defaultValue="${modifyTimeForm.specialtyOne}"
        ...
        <tr>
            ...
            <td>
                <eoms:comboBox name="specialtyTwo" id="specialtyTwo"
                               sub="specialtyThree" initDicId="${modifyTimeForm.specialtyOne}"
                               defaultValue="${modifyTimeForm.specialtyTwo}" alt="allowBlank:false"
                               onchange="selectLimit(this.value);"/>
            </td>

            <td class="label"><bean:message bundle="modifytimeForm" key="modifytimeForm.specialtyThree"/>*</td>
            <td>
                <eoms:comboBox name="specialtyThree" id="specialtyThree" initDicId="${modifyTimeForm.specialtyTwo}"
                               defaultValue="${modifyTimeForm.specialtyThree}" alt="allowBlank:false"
                               onchange="selectLimit(this.value);"/>
            </td>
