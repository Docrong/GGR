        ...
        <div align="center">
            <center>
                ...
                <table border="0" width="95%" cellspacing="1" cellpadding="1" class="table_show" align=center>
                    ...
                    <logic:iterate id="tawConfRoomSheet" name="TAWCONFROOMSHEETLIST"
                                   type="com.boco.eoms.duty.model.TawConfRoomSheet">
                        <tr class="tr_show">
                            <td align="left"><bean:write name="tawConfRoomSheet" property="roomName" scope="page"/></td>
                            <td align="left"><bean:write name="tawConfRoomSheet" property="sheetName"
                                                         scope="page"/></td>
                                <%--
                 ...
                 -->
                            <td>
                                <html:link page="/TawConfRoomSheet/del.do" name="map" scope="page">
                                    <img src="<%=request.getContextPath()%>/images/bottom/an_sc.gif"
                                         border="0"></html:link>
                            </td>
                        </tr>
                    </logic:iterate>
