...
<html:form action="/TawInformation/savemail">
    ...
    <table bgcolor="#709fd5" align="center" width="90%" cellspacing="1" border="0" cellpadding="1" class="clsbkgd">
        ...
        <tr>
            ...
            <td width="75%" bgcolor="#e5edf8" class="clsfth"><%=deptName%>
            </td>
        </tr>
        <tr>
            <td width="15%" bgcolor="#e5edf8" class="clsthd"><bean:message key="TawInformation.author"/></td>
            <td width="85%" bgcolor="#e5edf8" class="clsfth"><%=userName%> &nbsp;&nbsp;<input type="checkbox"
                                                                                              name="smsflag" value="1">
                发送短信
            </td>
        </tr>
        ...
        <tr>
            ...
            <td width="85%" bgcolor="#e5edf8" class="clsfth">
                <textarea name="username" cols="75"></textarea> <a href="javascript:onSelUser();">请选择接收人员</a>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td width="85%" bgcolor="#e5edf8" align="left"><html:textarea property="body" rows="15" cols="75"
...
-->
                <eoms:Validate userID="<%=userId%>" operID='<%=operID1%>' domain="<%=boardId%>"
                               domainType="<%=domainType%>">
                    <!--
                    <input type="button" Class="clsbtn2" value="<bean:message
                        key="label.save"/>" onclick="return onSave(0);">
                    -->
...
<IFRAME ID=IFrame1 FRAMEBORDER=0 width="100%" SCROLLING=NO
        SRC="file.do?attValue=<%=attValue.trim()%>&attText=<%=attText.trim()%>&imgValue=<%=imgValue.trim()%>&imgText=<%=imgText.trim()%>"></IFRAME>
