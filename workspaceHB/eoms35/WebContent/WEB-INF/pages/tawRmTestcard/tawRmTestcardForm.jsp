        ...
        <table class="formTable">
            <tr>
                ...
                <td width="500" colspan="2">
                    <eoms:label styleClass="desc" key="tawRmTestcardForm.intelCard"/><html:radio property="cardType"
                                                                                                 value="0"
                                                                                                 onclick="changeType2(this.value);"/>
                    <eoms:label styleClass="desc" key="tawRmTestcardForm.localCard"/><html:radio property="cardType"
                                                                                                 value="1"
                                                                                                 onclick="changeType2(this.value);"/>
                </td>
            </tr>
            <tr id="intelFrom">
                ...
                <td width="500" colspan="2">
                    ...
                    <eoms:country name="fromCountry" prompt="${eoms:a2u('请选择')}"
                                  default="${tawRmTestcardForm.fromCountry}"/>
            ...
            <tr id="intelTo">
                ...
                <td width="500" colspan="2">
                    <eoms:label styleClass="desc" key="tawRmTestcardForm.country"/>:
                    <eoms:country name="toCountry" prompt="${eoms:a2u('请选择')}"
                                  default="${tawRmTestcardForm.toCountry}"/>
                    <eoms:label styleClass="desc" key="tawRmTestcardForm.operator"/>:
                    <eoms:dict key="dict-plancontent" dictId="operator" beanId="selectXML"
            ...
            <tr>
                ...
                <td width="500" colspan="2">
                    <html:text property="iccid" styleId="iccid" styleClass="text medium" maxlength="25"
