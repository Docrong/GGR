...
%>
    ...
    <br>
    <input type="button" class="button" onclick="javascript:submitForm('<%=DutyConstacts.DUTY_AUDIT_PASS%>');"
           value="<bean:message key="tawRmReplaceForm.pass" />"/>
    <input type="button" class="button" onclick="javascript:submitForm('<%=DutyConstacts.DUTY_AUDIT_NO_PASS%>');"
           value="<bean:message key="tawRmReplaceForm.false" />"/>
</html:form>
