...
<div id="sheetform">
    <html:form action="/commontask.do?method=performFroceHold" styleId="theform">
        ...
        <table class="formTable">
            ...
            <input type="hidden" name="${sheetPageName}processTemplateName" value="CommonTaskMainFlowProcess"/>
            ...
            <tr>
                ...
                <td colspan="3">
                    ...
                    <textarea class="textarea max" name="${sheetPageName}remark" id="${sheetPageName}remark"
                              alt="allowBlank:false,maxLength:2000,vtext:'${vtext}'"></textarea>
                </td>
            </tr>
        </table>
        <div class="form-btns">
