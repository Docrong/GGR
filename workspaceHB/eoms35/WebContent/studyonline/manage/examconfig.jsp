        ...
        <table cellpadding="1" cellspacing="1" width="95%" border="0" class="table_show">
            ...
            <tr class="tr_show">
                ...
                <td>
                    ...
                    <html:select size="5" property="studySel" style="width:400" value="0" ondblclick="deleteSel()"
                                 title="已选类别">
                    </html:select>
                </td>
            </tr>
    ...
    <td>
      <html:text property="proportion" style="width:200" value="初级:中级:高级:专家" title="难易度比例"/>
            ...
            <tr class="tr_show">
                ...
                <td>
                    <html:text property="starttime" style="width:200" onfocus="setday(this)" readonly="true"
                               title="开始时间"/>
                </td>
            </tr>
            <tr class="tr_show">
                ...
                <td>
                    <html:text property="endtime" style="width:200" onfocus="setday(this)" readonly="true"
                               title="结束时间"/>
                </td>
            </tr>
            <tr class="tr_show">
                <td class="td_label" rowspan="2">
                    ...
                    <p>
                        <html:select size="9" property="userLabel" value="0" style="width:200"
                                     ondblclick="doUserSelect()">
                        </html:select>
                    </p>
                </td>
                <td>
                    <p>已选人员:<font color="red">*</font></p>
                    <html:select size="8" property="testerSel" style="width:400" value="0" ondblclick="deleteUserSel()"
                                 title="已选人员">
                    </html:select>
                </td>
            </tr>
