...
//			Map map = (Map) trainFeedbackMgr.getTrainFeedbacks(pageIndex, pageSize, "");
//			List list = (List) map.get("result");
//			TrainFeedback trainFeedback = new TrainFeedback();
//			
//			//创建ATOM源
...
//				trainFeedback = (TrainFeedback) list.get(i);
//				
...
//						+ "/trainFeedback/trainFeedbacks.do?method=edit&id="
//						+ trainFeedback.getId() + "' target='_blank'>"
