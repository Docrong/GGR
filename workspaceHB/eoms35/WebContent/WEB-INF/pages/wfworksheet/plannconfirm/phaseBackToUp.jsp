...
<div id="sheetform">
    <html:form action="/plannconfirm.do?method=newPerformNonFlow" styleId="theform">
        ...
        <input type="hidden" name="mainClassName"
               value="com.boco.eoms.sheet.plannconfirm.model.PlannConfirmMain"/> <!--main\u8868Model\u5bf9\u8c61\u7c7b\u540d-->
        <input type="hidden" name="linkClassName"
               value="com.boco.eoms.sheet.plannconfirm.model.PlannConfirmLink"/> <!--link\u8868Model\u5bf9\u8c61\u7c7b\u540d-->
                    ...
                    <table class="listTable">
                        <logic:present name="toOperaterList" scope="request">
                            ...
                            <logic:iterate id="toTask" name="toOperaterList"
                                           type="com.boco.eoms.sheet.plannconfirm.model.PlannConfirmTask">
                                <tr>
                                    <td>
