...
<table class="formTable">
    ...
    <tr>
        ...
        <td>
            <input type="text" class="text" name="reasonRejection" id="reasonRejection"
                   alt="maxLength:2000,vtext:'请填入 驳回理由 信息，最多输入 2000 字符'" value="${sheetLink.reasonRejection}"/>
        </td>
    </tr>
...
<fieldset>
    ...
    <div class="x-form-item">
        ...
        <eoms:chooser id="ConfirmTask0" type="role" roleId="1972" flowId="618"
