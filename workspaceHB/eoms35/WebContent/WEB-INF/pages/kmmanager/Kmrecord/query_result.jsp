...
<form name="tawRmCycleTableForm">
    ...
    <table class="listTable" id="list-table">
        ...
        %>
        <tr>
            <td align="center"><%=String.valueOf(map.get("starttime_defined")).substring(0, 10)%>
            </td>
            <td align="center" nowrap><%
                out.print(String.valueOf(map.get("starttime_defined")) + "至" + String.valueOf(map.get("endtime_defined"))); %></td>
            <td align="center"><%=map.get("workserial") %>
            </td>
            <td align="center"><%=map.get("receiver")%>
            </td>
        </tr>
        <%
                }
