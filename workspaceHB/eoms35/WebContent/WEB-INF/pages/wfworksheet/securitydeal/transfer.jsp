...
<html:form action="/securitydeal.do?method=performTransferWorkItem" styleId="theform">
    ...
    <br/>
           <input type="hidden" name="${sheetPageName}beanId"   id="${sheetPageName}beanId"  value="iSecurityDealMainManager"/>
           <input type="hidden" name="${sheetPageName}mainClassName" id="${sheetPageName}mainClassName"  value="com.boco.eoms.sheet.securitydeal.model.SecurityDealMain"/>	
           <input type="hidden" name="${sheetPageName}linkClassName" id="${sheetPageName}linkClassName" value="com.boco.eoms.sheet.securitydeal.model.SecurityDealLink"/> 
       ...
       <table class="formTable">
        ...
        <tr>
           <td class="label">
             ...
             <td colspan="3">
    				<textarea class="textarea max" name="${sheetPageName}transferReason" id="${sheetPageName}transferReason" alt="allowBlank:false,maxLength:500,width:500,vtext:'请填入信息，最多输入250字'" alt="width:'500px'">${sheetLink.transferReason}</textarea>
			</td>		
	   </tr>
	   </table> 
    <fieldset>
