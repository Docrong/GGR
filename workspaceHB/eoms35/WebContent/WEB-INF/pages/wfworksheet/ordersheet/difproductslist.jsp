...
<fieldset>
    ...
    <logic:present name="gprsspeciallineList" scope="request">
        <table class="listTable" width="100%" cellpadding="0" cellspacing="0">
            ...
            <logic:iterate id="gprsspecialline" name="gprsspeciallineList"
                           type="com.boco.eoms.businessupport.product.model.GprsSpecialLine">
                <tr>
                    <td class="content">
                        <a href="${app}/businessupport/product/gprsspeciallines.do?method=showDetail&id=${gprsspecialline.id}"
                    ...
                    <td class="content"><bean:write name="gprsspecialline" property="contactUserGPRS"
                                                    scope="page"/></td>
                    <td class="content"><bean:write name="gprsspecialline" property="contactPhoneGPRS"
                                                    scope="page"/></td>
                    ...
                    <td class="content"><bean:write name="gprsspecialline" property="businessBandwidth"
                                                    scope="page"/></td>
...
<fieldset>
    ...
    <logic:present name="ipspeciallineList" scope="request">
        <table class="listTable" width="100%" cellpadding="0" cellspacing="0">
            ...
            <logic:iterate id="ipspecialline" name="ipspeciallineList"
                           type="com.boco.eoms.businessupport.product.model.IPSpecialLine">
                <tr>
                    <td class="content">
                        <a href="${app}/businessupport/product/ipspeciallines.do?method=showDetail&id=${ipspecialline.id}"
                           target="_blank">详细信息</a>
                    </td>
                    <td class="content"><bean:write name="ipspecialline" property="businessBandwidth"
                                                    scope="page"/></td>
                    ...
                    <td class="content"><bean:write name="ipspecialline" property="RCAPDetailAddress"
                                                    scope="page"/></td>
                    ...
                    <td class="content"><bean:write name="ipspecialline" property="portANetDeptPhone"
                                                    scope="page"/></td>
                </tr>
            </logic:iterate>
        </table>
...
<fieldset>
    ...
    <logic:present name="transferspeciallineList" scope="request">
        <table class="listTable" width="100%" cellpadding="0" cellspacing="0">
            ...
            <logic:iterate id="transferspecialline" name="transferspeciallineList"
                           type="com.boco.eoms.businessupport.product.model.TransferSpecialLine">
                <tr>
                    <td class="content">
                        <a href="${app}/businessupport/product/transferspeciallines.do?method=showDetail&id=${transferspecialline.id}"
                           target="_blank">详细信息</a>
                    </td>
                    ...
                    <td class="content"><bean:write name="transferspecialline" property="portAInterfaceType"
                                                    scope="page"/></td>
                    <td class="content"><bean:write name="transferspecialline" property="portADetailAdd"
                                                    scope="page"/></td>
                    <td class="content"><bean:write name="transferspecialline" property="portABDeviceName"
                                                    scope="page"/></td>
                    <td class="content"><bean:write name="transferspecialline" property="portABDevicePort"
                                                    scope="page"/></td>
                    <td class="content"><bean:write name="transferspecialline" property="portAContactPhone"
                                                    scope="page"/></td>
                    <td class="content"><bean:write name="transferspecialline" property="portZ" scope="page"/></td>
                    <td class="content"><bean:write name="transferspecialline" property="portZInterfaceType"
                                                    scope="page"/></td>
                    <td class="content"><bean:write name="transferspecialline" property="portZDetailAdd"
                                                    scope="page"/></td>
                    <td class="content"><bean:write name="transferspecialline" property="portZBDeviceName"
                                                    scope="page"/></td>
                    <td class="content"><bean:write name="transferspecialline" property="portZBDevicePort"
                                                    scope="page"/></td>
                    <td class="content"><bean:write name="transferspecialline" property="portZContactPhone"
                                                    scope="page"/></td>
                </tr>
            </logic:iterate>
        </table>
