...
<fmt:bundle basename="com/boco/eoms/km/config/applicationResource-kmmanager">
    ...
    <tr align='center'>
        <td>
            ...
            姓名(可选)：<input type="text" id="trainUserName" name="trainUserName" class="text" readonly="readonly"
                          value='<eoms:id2nameDB id="${trainUser}" beanId="tawSystemUserDao" />'/>
    ...
    <display:table name="trainRecordList" cellspacing="0" cellpadding="0"
        ...
        <display:column property="trainCount" sortable="true"
                        headerClass="sortable" titleKey="trainPersonalStatistic.trainCount" paramId="id"
                        paramProperty="id"/>

        <display:column property="timeCount" sortable="true"
                        headerClass="sortable" titleKey="trainPersonalStatistic.timeCount" paramId="id"
                        paramProperty="id"/>
