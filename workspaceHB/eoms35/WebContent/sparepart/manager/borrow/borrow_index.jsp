...
<head>
    ...
    <SCRIPT LANGUAGE=JavaScript>
        var s = ["s1", "s2", "s3", "s4"];
        var opt0 = ['${eoms:a2u("备件所属专业")}', '${eoms:a2u("小专业")}', '${eoms:a2u("网元类型")}', '${eoms:a2u("备件类型")}'];
        var dsy = new Dsy();
        <%=str%>
...
<div align="center">
    <br>
    <form method="post" action="../borrow/add.do" name="frm" onsubmit="return checkdata()">
        <table class="listTable" border="0" width="80%" cellspacing="0">
            <tr>
        ...
        <table class="listTable" border="0" width="80%" cellspacing="1" cellpadding="1" align=center>
        ...
        <table class="listTable" border="0" width="80%" cellspacing="1" cellpadding="1" class="table_show" align=center>
            <tr class="tr_show">
            ...
            <tr class="tr_show">
                ...
                <td width="70%" height="25" colspan="2">
                    <input type="text" size="35" value="" maxlength="50" name="ename">
                </td>
            </tr>
            <tr class="tr_show">
                <td class="clsfth" width="30%" height="25">
            ...
            <tr class="tr_show">
                ...
                <td width="70%" height="25" colspan="2">
                    <input type="text" name="productcode" size="35" maxlength="255">
            ...
            <tr class="tr_show">
                ...
                <td width="70%" height="25" colspan="2">
                    <input value="<bean:write name="userId" scope="request"/>" type="text" name="operator" size="35"
                           maxlength="255">
                </td>
            </tr>
            <tr class="tr_show">
            ...
            <tr class="tr_show">
                ...
                <td width="70%" height="25" colspan="2">
                    <input type="text" size="35" value="" maxlength="50" name="note">
                </td>
            </tr>
        </table>
