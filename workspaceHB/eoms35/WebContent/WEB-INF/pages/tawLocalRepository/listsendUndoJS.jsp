...
<div id="listQueryObject"
     style="display:;border:1px solid #98c0f4;border-top:0;padding:5px;background-color:#eff6ff;width:98%">
    <script type="text/javascript">
    ...
    <html:form action="/tawLocalRepositorys.do?method=softquery" styleId="tawLocalRepositoryForm" method="post"
               target="netname">
