...
<FORM name="form1" method="post">
    <STYLE type="text/css">
        .mainview {
            Z-INDEX: 1;
            BACKGROUND: url(/images/viewbg.jpg) fixed no-repeat right bottom;
            LEFT: 4px;
            OVERFLOW: auto;;
                ...
                <TABLE class=p9 cellSpacing=0 cellPadding=0 width="100%"
                    ...
                    <TR>
                        ...
                        <TD vAlign=center noWrap><IMG height=0 width=200><BR>&nbsp; <A
                                ...
                                src="../images/reply.gif" align=absMiddle border=0>退出</A> 　　
                        </TD>
                        <TD align=right width=158><IMG height=33
                                                       src="../images/main-top_03.gif" width=158></TD>
                    </TR>
                    </TBODY>
                </TABLE>
            </TD>
                ...
                <DIV id=Layer1>
                    <TABLE height="100%" cellSpacing=0 width="101%" align=center border=1>
                        ...
                        <TR>
                            ...
                            <TD width="85%">
                                <IFRAME id=TaskReport src="about:blank" frameBorder=0 width="100%" scrolling=yes
                                        height="100%"></IFRAME>
                            </TD>
                        </TR>
                        </TBODY>
