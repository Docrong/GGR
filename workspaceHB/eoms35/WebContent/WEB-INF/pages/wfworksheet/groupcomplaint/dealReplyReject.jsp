...
<div id="sheetform">
<html:form action="/groupcomplaint.do?method=performDealReplyReject" styleId="theform">
 <%@ include file="/common/taglibs.jsp"%>
<%
...
<%@ include file="/WEB-INF/pages/wfworksheet/groupcomplaint/baseinputlinkhtmlnew.jsp"%>
     ...
     <tr>
      ...
      <logic:iterate id="toTask" name="acceptList" type="com.boco.eoms.sheet.groupcomplaint.task.impl.GroupComplaintTask">  
        <tr>
          <td>
