...
<div id="sheetform">
    <html:form action="/resourceaffirm.do?method=performProcessEvent" styleId="theform">
        <%@ include file="/common/taglibs.jsp" %>
        <%
        ...
        <input type="hidden" name="${sheetPageName}processTemplateName" id="${sheetPageName}processTemplateName"
               value="ResourceAffirmMainFlowProcess"/>
        ...
        <%@ include file="/WEB-INF/pages/wfworksheet/resourceaffirm/baseinputlinkhtml.jsp" %>
        <table class="listTable">
            <logic:present name="toOperaterList" scope="request">
                <logic:iterate id="toTask" name="toOperaterList"
                               type="com.boco.eoms.sheet.resourceaffirm.task.impl.ResourceAffirmTaskImpl">
                    <tr>
                        <td>
