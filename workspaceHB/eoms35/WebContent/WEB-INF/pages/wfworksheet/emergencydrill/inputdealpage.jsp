...
<table class="formTable">
    ...
    <tr>
        ...
        <td colspan="3">
            <textarea class="textarea max" name="${sheetPageName}linkEmergencyDrillNote"
                      id="${sheetPageName}linkEmergencyDrillNote"
                      alt="width:500,allowBlank:false,maxLength:255,vtext:'请填入应急演练方案说明，最多输入125字'">${sheetLink.linkEmergencyDrillNote}</textarea>
        </td>
    </tr>
    <tr>
        <td class="label">
    ...
    <tr>
        ...
        <td colspan="3">
            <eoms:comboBox name="${sheetPageName}linkAuditOpinion" id="${sheetPageName}linkAuditOpinion"
                           ...
                           onchange="ifAuditPass(this.value);" defaultValue="${sheetLink.linkAuditOpinion}"/>
        </td>
    ...
    <tr>
        ...
        <td colspan="3">
            <textarea class="textarea max" name="${sheetPageName}linkImplementResult"
                      id="${sheetPageName}linkImplementResult"
                      alt="width:500,allowBlank:false,maxLength:255,vtext:'请填入实施演练结果，最多输入125字'">${sheetLink.linkImplementResult}</textarea>
        </td>
    </tr>
    <tr>
        <td class="label">
    ...
    <tr>
        ...
        <td colspan="3">
            <textarea class="textarea max" name="${sheetPageName}linkImplementSummary"
                      id="${sheetPageName}linkImplementSummary"
                      alt="width:500,allowBlank:false,maxLength:255,vtext:'请填入实施演练结果，最多输入125字'">${sheetLink.linkImplementSummary}</textarea>
        </td>
    </tr>
    <tr>
        <td class="label">
    ...
    <tr>
        ...
        <td colspan="3">
            <eoms:comboBox name="${sheetPageName}linkAuditOpinion" id="${sheetPageName}linkAuditOpinion"
                           initDicId="1011601" alt="allowBlank:false" styleClass="select-class"
                           onchange="ifAuditPass3(this.value);" defaultValue="${sheetLink.linkAuditOpinion}"/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td colspan="3">
            <eoms:comboBox name="${sheetPageName}linkIsAmendmentDrill" id="${sheetPageName}linkIsAmendmentDrill"
                           ...
                           onchange="ifAuditPass4(this.value);" defaultValue="${sheetLink.linkIsAmendmentDrill}"/>
        </td>
    ...
    <tr>
        ...
        <td colspan="3">
            <textarea class="textarea max" name="${sheetPageName}linkAmendmentDrillNote"
                      id="${sheetPageName}linkAmendmentDrillNote"
                      alt="width:500,allowBlank:false,maxLength:255,vtext:'请填入修订预案说明，最多输入125字'">${sheetLink.linkAmendmentDrillNote}</textarea>
        </td>
    </tr>
    <tr>
        <td class="label">
    ...
    <tr>
        ...
        <td colspan='3'>
            <eoms:attachment name="sheetLink" property="linkEmergencyPreparedness" idList=""
                             scope="request" idField="${sheetPageName}linkEmergencyPreparedness"
