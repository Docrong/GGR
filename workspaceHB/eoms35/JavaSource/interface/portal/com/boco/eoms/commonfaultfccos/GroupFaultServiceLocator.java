...
public class GroupFaultServiceLocator extends org.apache.axis.client.Service implements com.boco.eoms.commonfaultfccos.GroupFaultService {
...
//    private java.lang.String GroupFault_address = "http://10.25.88.18:8010/usi-fccos-ws/services/GroupFault";
    ...
    private java.lang.String GroupFault_address = XmlManage.getFile("/config/commonfault-util.xml").getProperty("GroupFault_address");
    ...
    public com.boco.eoms.commonfaultfccos.GroupFault_PortType getGroupFault(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.boco.eoms.commonfaultfccos.GroupFaultSoapBindingStub _stub = new com.boco.eoms.commonfaultfccos.GroupFaultSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.boco.eoms.commonfaultfccos.GroupFault_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.boco.eoms.commonfaultfccos.GroupFaultSoapBindingStub _stub = new com.boco.eoms.commonfaultfccos.GroupFaultSoapBindingStub(new java.net.URL(GroupFault_address), this);
                _stub.setPortName(getGroupFaultWSDDServiceName());
                return _stub;
            }
        }
