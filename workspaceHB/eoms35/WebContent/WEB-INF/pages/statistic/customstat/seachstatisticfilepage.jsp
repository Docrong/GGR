        ...
        <tr>
            ...
            <td>
                ...
                <input type="text" name="beginTime" id="beginTime"
                       alt="allowBlank:true,vtype:'lessThen',link:'endTime',vtext:'<bean:message key="custom.beginTime1"/>´'"
                ...
                <input type="text" name="endTime" id="endTime"
                       alt="allowBlank:true,vtype:'moreThen',link:'beginTime',vtext:'<bean:message key="custom.beginTime2"/>'"
                       readonly="readonly" onclick="popUpCalendar(this, this,null,null,null,true,-1);" class="text"/>
            </td>
        </tr>
