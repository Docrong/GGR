    ...
    <ul>
        ...
        <table class="formTable">
            ...
            <tr>
                ...
                <td width="500" colspan="2">
                    <eoms:dict key="dict-plancontent" dictId="orderType"
                               itemId="<%=tawRmWorkorderRecord.getOrderType() %>" beanId="id2nameXML"/>
                </td>
            </tr>
            <tr>
                <td width="100" class="label">
                ...
                <td width="500" colspan="2">
                    <eoms:dict key="dict-plancontent" dictId="orderState"
                               itemId="<%=tawRmWorkorderRecord.getOrderState() %>" beanId="id2nameXML"/>
                </td>
            </tr>
        </table>
