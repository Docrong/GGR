...
<script type="text/javascript">
    Ext.onReady(function () {
        ...
        new xbox({
            btnId: 'auditmanName',
            dlgId: 'dlg-audit',
            dlgTitle: '${eoms:a2u('请选择人员')}',
            treeDataUrl: userTreeAction,
            treeRootId: '-1',
            treeRootText: '${eoms:a2u('所有人员')}',
            treeChkMode: 'single',
            treeChkType: 'user',
            showChkFldId: 'auditmanName',
            saveChkFldId: 'auditman'
        });
        new xbox({
            btnId: 'producerName',
            dlgId: 'dlg-audit',
            ...
            treeChkMode: 'single',
            treeChkType: 'user',
            showChkFldId: 'producerName',
            saveChkFldId: 'producer'
        });
    })
    Ext.onReady(function () {
    ...
    <ul>
        ...
        <li>
            ...
            <eoms:comboBox name="bigNet" id="bigNet" initDicId="10601" sub="net"
                           styleClass="select-class" defaultValue="${tawBureauDataForm.bigNet}"
                           alt="allowBlank:false,vtext:'${eoms:a2u('请选择大网元')}'"/>
        </li>
        <li>
        ...
        <li>
            ...
            <eoms:comboBox name="factory" id="factory" initDicId="10601"
                           ...
                           defaultValue="${tawBureauDataForm.factory}"
                           alt="allowBlank:false,vtext:'${eoms:a2u('请选厂商')}'"/>
        </li>
        <li>
        ...
        <li>
            ...
            <eoms:comboBox name="type" id="type" initDicId="10601"
                           styleClass="select-class" defaultValue="${tawBureauDataForm.type}"
                           alt="allowBlank:false,vtext:'${eoms:a2u('请选择项类型')}'"/>
                <%--
        ...
        <li>
            ...
            <html:textarea property="content" styleId="content"
                           ...
                           alt="allowBlank:false,vtext:'${eoms:a2u('请选择执行情况')}'"/>
        </li>
        ...
        <li>
            ...
            <html:text property="title" styleId="title" styleClass="text medium"
                       alt="allowBlank:false,vtext:'${eoms:a2u('请选择项标题')}'"/>
        </li>
        <li>
