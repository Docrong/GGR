       ...
       <div class="history-item-content">
  		 <table class="listTable" width="100%" cellpadding="0" cellspacing="0">
  	           ...
  	           <logic:present name="showInvokeRelationShipList">
  	            <logic:iterate id="showInvokeRelationShip" name="showInvokeRelationShipList" type="com.boco.eoms.sheet.urgentfault.model.CircuitDispatchMain" scope="request">
  				 <tr>
  				  <td nowrap="nowrap">
  				      <a href="${app}/sheet/circuitdispatch/circuitdispatch.do?method=showDetailPage&sheetKey=${showInvokeRelationShip.id}" target="_blank">${showInvokeRelationShip.sheetId}</a>
                  </td>     
  				  <td nowrap="nowrap">
				      ${proccessName}
  				  </td>
  				  ...
  				  <td nowrap="nowrap">
                  		<eoms:dict key="dict-sheet-circuitdispatch" dictId="activeTemplateId" itemId="${activeTemplateId}" beanId="id2descriptionXML" /> 
                  </td> 
  				  <td nowrap="nowrap">
  				     ${showInvokeRelationShip.title}
  				  </td>
                  <td nowrap="nowrap">
                  		<eoms:dict key="dict-sheet-common" dictId="sheetStatus" itemId="${showInvokeRelationShip.status}" beanId="id2descriptionXML" /> 
                  </td>                
  				</tr>
	  </logic:iterate>	
	 </logic:present> 
