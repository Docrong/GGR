...
<%
 ...
 %>
    ...
    <input type="hidden" name="${sheetPageName}mainClassName" value="com.boco.eoms.sheet.businesspilot.model.CommonFaultMain"/>	<!--main表Model对象类名-->	
    <input type="hidden" name="${sheetPageName}linkClassName" value="com.boco.eoms.sheet.businesspilot.model.CommonFaultLink"/> <!--link表Model对象类名--> 
...
<%@ include file="/WEB-INF/pages/wfworksheet/businesspilot/baseinputlinkhtmlnew.jsp"%>
     <table  class="formTable">
      ...
      <logic:iterate id="toTask" name="toOperaterList" type="com.boco.eoms.sheet.businesspilot.task.impl.CommonFaultTask">  
        <tr>
          <td>
