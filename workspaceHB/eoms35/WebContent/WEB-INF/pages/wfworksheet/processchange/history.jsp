...
<logic:present name="HISTORY" scope="request">  
      <logic:iterate id="baselink" name="HISTORY" type="com.boco.eoms.sheet.processchange.model.ProcessChangeLink">  
       <%         
        jNum += 1;       
     ...
     <div class="history-item"><!-- add space to hack ie-->&nbsp;
       <div class="history-item-title">
		 ...
		 <bean:write name="baselink" property="operateTime" formatKey="date.formatDateTimeAll" bundle="sheet" scope="page"/>&nbsp; 
  	     ...
  	     <eoms:dict key="dict-sheet-processchange" dictId="activeTemplateId" itemId="${baselink.activeTemplateId}" beanId="id2descriptionXML" />
  	     <bean:message bundle="processchange" key="processchange.operateType"/>:
  	     <eoms:dict key="dict-sheet-processchange" dictId="mainOperateType" itemId="${baselink.operateType}" beanId="id2descriptionXML" />
       ...
       <div class="history-item-content hide">
		 ...
		 <%if((baselink.getActiveTemplateId()!=null && baselink.getActiveTemplateId().equals("EvaluateTask"))){%> 		 
			 <%if((baselink.getOperateType()!=null && (baselink.getOperateType().intValue() == 91|| baselink.getOperateType().intValue() == 11))){%> 
		      <tr>
		        ...
		        <td class="column-content"><eoms:id2nameDB id="${baselink.linkProcessType}" beanId="ItawSystemDictTypeDao"/></td>	
		        <td  class="label"><bean:message bundle="processchange" key="processchange.linkProcess"/></td>
		        <td class="column-content"><eoms:id2nameDB id="${baselink.linkProcess}" beanId="ItawSystemDictTypeDao"/></td>			      
		      </tr>
		      <tr>
		  		<td class="column-title"><bean:message bundle="processchange" key="processchange.linkFrameDesc"/></td>
		  		<td class="column-content" colspan=3><pre><bean:write name="baselink" property="linkFrameDesc" scope="page"/></pre></td>
		  	  </tr>
              <tr>
			    <td class="label"><bean:message bundle="processchange" key="processchange.linkSchemeFrame"/></td>
   				<td  colspan='3'>
   				 <eoms:attachment  name="baselink" property="linkSchemeFrame" scope="page"
   				 idField="${sheetPageName}linkSchemeFrame" appCode="processchange" 
   				 viewFlag="Y"/>
                </td>
              </tr>		 
			 <%}}%>	
		 <%if((baselink.getActiveTemplateId()!=null && baselink.getActiveTemplateId().equals("MakeTask"))){%> 		 
			 <%if((baselink.getOperateType()!=null && (baselink.getOperateType().intValue() == 92|| baselink.getOperateType().intValue() == 11))){%> 
		      <tr>
		  		<td class="column-title"><bean:message bundle="processchange" key="processchange.linkSchemeDesc"/></td>
		  		<td class="column-content" colspan=3><pre><bean:write name="baselink" property="linkSchemeDesc" scope="page"/></pre></td>
		  	  </tr>
              <tr>
			    <td class="label"><bean:message bundle="processchange" key="processchange.linkChangeScheme"/></td>
   				<td  colspan='3'>
   				 <eoms:attachment  name="baselink" property="linkChangeScheme" scope="page"
   				 idField="${sheetPageName}linkChangeScheme" appCode="processchange" 
   				 viewFlag="Y"/>
                </td>
              </tr>		
              <tr>
			    <td class="label"><bean:message bundle="processchange" key="processchange.linkITChangeScheme"/></td>
   				<td  colspan='3'>
   				 <eoms:attachment  name="baselink" property="linkITChangeScheme" scope="page"
   				 idField="${sheetPageName}linkITChangeScheme" appCode="processchange" 
   				 viewFlag="Y"/>
                </td>
              </tr>	               
			 <%}}%>	
			 <%if(baselink.getActiveTemplateId()!=null && baselink.getActiveTemplateId().equals("AuditTask")){%> 	
			 <%if(baselink.getOperateType()!=null &&  (baselink.getOperateType().intValue() == 931
			                                          ||baselink.getOperateType().intValue() == 932
			                                          ||baselink.getOperateType().intValue() == 933
			                                          ||baselink.getOperateType().intValue() == 55)){%> 
		      <tr>
		      	<td  class="label"><bean:message bundle="processchange" key="processchange.linkAuditResult"/></td>
		        <td class="column-content" colspan="3"><eoms:id2nameDB id="${baselink.linkAuditResult}" beanId="ItawSystemDictTypeDao"/></td>	
		      </tr>  
		      <tr>
		  		<td class="column-title"><bean:message bundle="processchange" key="processchange.linkAuditDesc"/></td>
		  		<td class="column-content" colspan=3><pre><bean:write name="baselink" property="linkAuditDesc" scope="page"/></pre></td>
		  	  </tr>
			 <%}}%>	
			 
		 <%if((baselink.getActiveTemplateId()!=null && baselink.getActiveTemplateId().equals("ReleaseTask"))){%> 		 
			 <%if((baselink.getOperateType()!=null && (baselink.getOperateType().intValue() == 94|| baselink.getOperateType().intValue() == 941|| baselink.getOperateType().intValue() == 11))){%> 
		      <%if(baselink.getOperateType().intValue() != 11) {%>
		      <tr>
		  		<td class="column-title"><bean:message bundle="processchange" key="processchange.linkIfInvoke"/></td>
		  		<td class="column-content" colspan=3><eoms:id2nameDB id="${baselink.linkIfInvoke}" beanId="ItawSystemDictTypeDao"/></pre></td>
		  	  </tr>	
		  	  <%} %>
		      <tr>
		  		<td class="column-title"><bean:message bundle="processchange" key="processchange.linkReleaseDesc"/></td>
		  		<td class="column-content" colspan=3><pre><bean:write name="baselink" property="linkReleaseDesc" scope="page"/></pre></td>
		  	  </tr>		  	                
			 <%}}%>	
		 ...
		 <%if((baselink.getActiveTemplateId()!=null && baselink.getActiveTemplateId().equals("OperateTask"))){%> 		 
			 <%if((baselink.getOperateType()!=null && (baselink.getOperateType().intValue() == 95|| baselink.getOperateType().intValue() == 11))){%> 
		      <tr>
		        ...
		        <td class="column-content" colspan="3"><eoms:id2nameDB id="${baselink.linkOptimizeImpact}" beanId="ItawSystemDictTypeDao"/></td>	
              </tr>
		      <tr>
		  		<td class="column-title"><bean:message bundle="processchange" key="processchange.linkEvaluateDesc"/></td>
		  		<td class="column-content" colspan=3><pre><bean:write name="baselink" property="linkEvaluateDesc" scope="page"/></pre></td>
		  	  </tr>
              <tr>
			    <td class="label"><bean:message bundle="processchange" key="processchange.linkEvaluateAttach"/></td>
   				<td  colspan='3'>
   				 <eoms:attachment  name="baselink" property="linkEvaluateAttach" scope="page"
   				 idField="${sheetPageName}linkEvaluateAttach" appCode="processchange" 
   				 viewFlag="Y"/>
                </td>
              </tr>		 
			 <%}}%>				 

       <%if(baselink.getActiveTemplateId()!=null && (baselink.getActiveTemplateId().equals("cc")||baselink.getActiveTemplateId().equals("advice")||baselink.getOperateType().intValue() == 4||baselink.getOperateType().intValue() == 9)){%> 
...
<script type="text/javascript">
 ...
 function copy(id){
    ...
    Ext.Ajax.request({
		method:"get",
		url: "processchange.do?method=getJsonLink&id="+id+"&beanName=ProcessChange",
		success: function(x){
