<%@ page
        import="com.boco.eoms.commons.system.session.form.TawSystemSessionForm,java.util.*,com.boco.eoms.common.controller.*" %>
        ...
        <table border="0" width="95%" cellspacing="1" cellpadding="1" class="table_show" align=center>
            <tr class="tr_show">
                ...
                <td>
                    ...
                    <input name="inputdate" type="text" style="WIDTH: 115px; HEIGHT: 22px; BACKGROUND-COLOR: lightgrey"
                           readOnly="" size="15" value="<eoms:TextDate />"/>
