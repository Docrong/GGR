...
<%}%>
 ...
 <tr height=19 style='height:14.25pt'>
  <td height=19 class=xl26 width=43 style='height:14.25pt;width:32pt'>省份</td>
  <td class=xl26 width=50 style='border-left:none;width:38pt'>城市</td>
  <td class=xl26 width=71 style='border-left:none;width:53pt'>城市区号</td>
<%Set set = headMap.keySet();
Iterator iter = set.iterator();
while(iter.hasNext()){%>
  <td class=xl27 width=89 style='border-left:none;width:67pt'><%=iter.next()%></td>
<%}%>
  <td class=xl28 width=121 style='width:91pt'>归属HLR名称</td>
  <td class=xl28 width=126 style='border-left:none;width:95pt'>归属HLR信令点</td>
  <td class=xl29 width=40 style='border-left:none;width:30pt'>备注</td>
 </tr>
<%for(int i=0;i<size;i++){
  TawBureaudataSHlrForExcel po = (TawBureaudataSHlrForExcel)hlrList.get(i);
  String[] segArr = po.getSegArr();%>
 <tr height=19 style='height:14.25pt'>
  <td height=19 class=xl30 style='height:14.25pt;border-top:none'>湖北</td>
