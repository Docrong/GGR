...
<div id="showInvokeRelationShipList" class="panel"> 
     <div class="history-item" width="100%" ><!-- add space to hack ie-->&nbsp;
  	...
  	<logic:present name="showInvokeRelationShipList">
  	 <logic:iterate id="showInvokeRelationShip" name="showInvokeRelationShipList" type="com.boco.eoms.sheet.urgentfault.model.UrgentFaultMain" scope="request">
  				<tr>
  				 <td nowrap="nowrap">
  				      <a href="${app}/sheet/urgentfault/urgentfault.do?method=showDetailPage&sheetKey=${showInvokeRelationShip.id}" target="_blank">${showInvokeRelationShip.sheetId}</a>
                  </td>     
  				  <td nowrap="nowrap">
				      ${proccessName}
  				  </td>
