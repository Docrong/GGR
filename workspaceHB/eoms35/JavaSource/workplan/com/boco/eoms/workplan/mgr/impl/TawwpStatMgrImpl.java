...
public class TawwpStatMgrImpl implements ITawwpStatMgr {
     ...
     * @param _yearFlag    String 年度
     * @param _monthFlag   String 月度
     * @param _refreshFlag boolean 刷新标志 true：重新生成 false：直接调用
     ...
     * @param _yearFlag  String 年度
     * @param _monthFlag String 月度
     * @param _deptId    String 部门信息（内部编号）
     * @return Hashtable 统计数据hash
     * @throws TawwpException 异常信息
     */
     ...
     * @param _monthFlag   String 月度
     * @param _deptId      String 部门信息（内部编号）
     * @param _refreshFlag boolean 刷新标志
     * @return String 生成统计页面路径
     * @throws TawwpException 异常信息
     */
     ...
     *
     * @param _hashtable Hashtable 统计数据Hash
     * @param _list      List 统计数据里列表
     * @param _state     int 状态（state －1：全部 0：未完成，1：已完成 2：超时）
     * @throws TawwpException 异常信息
     */
