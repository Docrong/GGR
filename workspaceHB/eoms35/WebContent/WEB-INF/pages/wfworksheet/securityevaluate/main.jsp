...
<%@ page import="com.boco.eoms.commons.system.role.service.ITawSystemSubRoleManager,
                 com.boco.eoms.commons.system.session.form.TawSystemSessionForm,
                 java.util.List,
...
<html:form action="/securityevaluate.do?method=newPerformAdd" styleId="theform">
    ...
    <logic:notPresent name="templateManage">
        ...
        <html:button styleClass="btn" property="method.save" styleId="method.save"
                     onclick="window.open('./securityevaluate.do?method=getTemplatesByUserId',null,'left=300,top=150,height=400,width=500,scrollbars=yes')">
