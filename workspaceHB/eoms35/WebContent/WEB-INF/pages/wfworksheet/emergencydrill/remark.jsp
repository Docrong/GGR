...
<div id="sheetform">
    <html:form action="/emergencydrill.do?method=newPerformNonFlow" styleId="theform">
        ...
        <input type="hidden" name="${sheetPageName}mainClassName"
               value="com.boco.eoms.sheet.emergencydrill.model.EmergencyDrillMain"/> <!--mainè¡¨Modelå¯¹è±¡ç±»å-->
        <input type="hidden" name="${sheetPageName}linkClassName"
               value="com.boco.eoms.sheet.emergencydrill.model.EmergencyDrillLink"/> <!--linkè¡¨Modelå¯¹è±¡ç±»å-->
