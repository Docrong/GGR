...
<input type="hidden" id="${sheetPageName}mainNetTypeOne" name="${sheetPageName}mainNetTypeOne"
       value="${sheetMain.mainNetTypeOne}"/>
<input type="hidden" id="${sheetPageName}mainNetTypeTwo" name="${sheetPageName}mainNetTypeTwo"
       value="${sheetMain.mainNetTypeTwo}"/>
<input type="hidden" id="${sheetPageName}mainNetTypeThree" name="${sheetPageName}mainNetTypeThree"
       value="${sheetMain.mainNetTypeThree}"/>
<input type="hidden" id="${sheetPageName}mainFactory" name="${sheetPageName}mainFactory"
...
<table class="formTable">
    ...
    <tr>
        ...
        <td><input type="text" class="text" name="${sheetPageName}linkDesignKey" id="${sheetPageName}linkDesignKey"
                   value="${sheetLink.linkDesignKey}" alt="allowBlank:false,maxLength:32,vtext:'请填入备注信息，最多输入32字符'"/>
        </td>
    </tr>
    <tr>
        <!-- 方案资源号 -->
        ...
        <td colspan="3">
            <input type="text" class="text" name="${sheetPageName}mainDesignId" value="${sheetMain.mainDesignId}"
                   alt="allowBlank:true,maxLength:255,vtext:'最多输入255字符'"/>
        </td>
    </tr>
    <tr>
        <!-- 技术方案说明 -->
        ...
        <td colspan="3">
            <textarea class="textarea max" name="${sheetPageName}linkDesignComment"
                      ...
                      alt="allowBlank:true,maxLength:4000,vtext:'请填入备注信息，最多输入4000字符'">${sheetLink.linkDesignComment}</textarea>
        </td>
    </tr>
    <tr>
        <!-- 变更涉及省份 -->
        ...
        <td colspan="3">
            ...
            涉及省份:<textarea class="textarea max" readonly="true" name="linkInvolvedProvince" style="height:50px"
                           ...
                           alt="allowBlank:false,maxLength:4000,vtext:'请填入备注信息，最多输入4000字符'">${sheetLink.linkInvolvedProvince }</textarea><br/>
            涉及地市:<textarea class="textarea max" readonly="true" name="linkInvolvedCity" style="height:50px"
                           id="${sheetPageName}linkInvolvedCity"
                           alt="allowBlank:true,maxLength:4000,vtext:'请填入备注信息，最多输入4000字符'">${sheetLink.linkInvolvedCity}</textarea>
    ...
    <tr>
        ...
        <td colspan="3">
            <textarea class="textarea max" name="${sheetPageName}linkRiskEstimate" id="${sheetPageName}linkRiskEstimate"
                      alt="allowBlank:false,maxLength:4000,vtext:'请填入备注信息，最多输入4000字符'">${sheetLink.linkRiskEstimate}</textarea>
        </td>
    </tr>
    <tr>
        <!-- 影响业务分析 -->
        ...
        <td colspan="3">
            <textarea class="textarea max" name="${sheetPageName}linkEffectAnalyse"
                      ...
                      alt="allowBlank:false,maxLength:4000,vtext:'请填入备注信息，最多输入4000字符'">${sheetLink.linkEffectAnalyse}</textarea>
        </td>
    </tr>
    <tr>
        <td class="label">
    ...
    <tr>
        ...
        <td colspan="3">
            <eoms:comboBox name="${sheetPageName}linkPermitResult" id="${sheetPageName}linkPermitResult"
                           ...
                           defaultValue="${sheetLink.linkPermitResult}" onchange="ifAuditPass(this.value,'AuditTask')"/>
        </td>
    </tr>
    <tr>
        <td class="label"><bean:message bundle="netdata" key="netdata.linkCheckComment"/>*</td>
        <td colspan="3">
            <textarea class="textarea max" name="${sheetPageName}linkCheckComment" id="${sheetPageName}linkCheckComment"
                      alt="allowBlank:false,maxLength:4000,vtext:'请填入备注信息，最多输入4000字符'">${sheetLink.linkCheckComment}</textarea>
        </td>
    </tr>
    <tr>
        ...
        <td colspan="3">
            <eoms:comboBox name="${sheetPageName}linkIfStartOperationTest" id="${sheetPageName}linkIfStartOperationTest"
                           ...
                           defaultValue="${sheetLink.linkIfStartOperationTest}" onchange="ifStart(this.value);"/>
        </td>
    </tr>
        ...
        <td colspan="3">
            ...
            <script type="text/javascript">
                ...
                deptetree = new xbox({
                    ...
                    btnId: '${sheetPageName}showSubRole',
                    dlgId: 'dlg3',

                    treeDataUrl: roleTreeAction,
                    treeRootId: '-1',
                    treeRootText: '网络配置员(业务测试)',
                    treeChkMode: '',
                    treeChkType: 'subrole',
                    showChkFldId: '${sheetPageName}showSubRole',
                    saveChkFldId: '${sheetPageName}linkTestPerson',
                    viewer: subroleViewer
                });
            </script>
            <textarea class="textarea max" readonly="true" name="${sheetPageName}showSubRole" style="height:50px"
                      id="${sheetPageName}showSubRole" alt="allowBlank:true,maxLength:500,vtext:'请填入测试方名称，最多输入500字符'">
            ...
            <input type="hidden" name="${sheetPageName}linkTestPerson" id="${sheetPageName}linkTestPerson"
                   value="${sheetLink.linkTestPerson}"/>
    ...
    <tr>
        ...
        <td colspan="3">
            <eoms:comboBox name="${sheetPageName}linkPermitResult" id="${sheetPageName}linkPermitResult"
                           ...
                           onchange="ifAuditPass(this.value,'PermitTask')"/>
        </td>
    </tr>
    <tr>
        ...
        <td colspan="3">
            <textarea class="textarea max" name="${sheetPageName}linkPermitIdea" id="${sheetPageName}linkPermitIdea"
                      alt="allowBlank:false,maxLength:4000,vtext:'请填入审批意见，最多输入4000字符'">${sheetLink.linkPermitIdea}</textarea>
        </td>
    </tr>
    <!-- 排程 -->
    ...
    <tr>
        ...
        <td><input type="text" class="text" name="${sheetPageName}linkManager" id="${sheetPageName}linkManager"
                   value="${sheetLink.linkManager}" alt="allowBlank:false,maxLength:32,vtext:'请填入备注信息，最多输入32字符'"/></td>
        ...
        <td><input type="text" class="text" name="${sheetPageName}linkContact" id="${sheetPageName}linkContact"
                   value="${sheetLink.linkContact }" alt="allowBlank:false,maxLength:32,vtext:'请填入备注信息，最多输入32字符'"/></td>
    </tr>
    <tr>
        <!-- 排程看板 -->
    ...
    <tr>
        ...
        <td colspan="3">
            <textarea class="textarea max" name="${sheetPageName}linkCellInfo" id="${sheetPageName}linkCellInfo"
                      alt="allowBlank:false,maxLength:500,vtext:'请填入备注信息，最多输入500字符'">${sheetLink.linkCellInfo }</textarea>
        </td>
    </tr>
    <tr>
        ...
        <td colspan="3">
            <eoms:comboBox name="${sheetPageName}linkIsEffectBusiness" id="${sheetPageName}linkIsEffectBusiness"
                           ...
                           defaultValue="${sheetLink.linkIsEffectBusiness}" onchange="ifAffect(this.value)"/>
        </td>
    </tr>
    <tr>
        ...
        <td colspan="3">
            <textarea class="textarea max" name="${sheetPageName}linkEffectCondition"
                      ...
                      alt="allowBlank:true,maxLength:4000,vtext:'请填入备注信息，最多输入4000字符'">${sheetLink.linkEffectCondition}</textarea>
        </td>
    </tr>
    <tr>
        ...
        <td colspan="3">
            <textarea class="textarea max" name="${sheetPageName}linkNetManage" id="${sheetPageName}linkNetManage"
                      alt="allowBlank:true,maxLength:4000,vtext:'请填入备注信息，最多输入4000字符'">${sheetLink.linkNetManage}</textarea>
        </td>
    </tr>
    <tr>
        ...
        <td>
            <eoms:comboBox name="${sheetPageName}linkBusinessDept" id="${sheetPageName}linkBusinessDept"
                           initDicId="1010902" alt="allowBlank:true" styleClass="select-class"
    ...
    <tr>
        ...
        <td>
            <eoms:comboBox name="${sheetPageName}linkCutResult" id="${sheetPageName}linkCutResult"
                           initDicId="1010903" alt="allowBlank:false" styleClass="select-class"
                           defaultValue="${sheetLink.linkCutResult }" onchange="executeResult(this.value);"/>
        </td>
        <!-- 失败原因 -->
    ...
    <tr>
        ...
        <td>
            <eoms:comboBox name="${sheetPageName}linkTestResult" id="${sheetPageName}linkTestResult"
                           initDicId="1010904" alt="allowBlank:false" styleClass="select-class"
    ...
    <tr>
        ...
        <td colspan="3">
            <textarea class="textarea max" name="${sheetPageName}linkTestReport" id="${sheetPageName}linkTestReport"
                      alt="allowBlank:false,maxLength:255,vtext:'请填入备注信息，最多输入255字符'">${sheetLink.linkTestReport }</textarea>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td colspan="3">
            <textarea class="textarea max" name="${sheetPageName}linkCutComment" id="${sheetPageName}linkCutComment"
                      alt="allowBlank:false,maxLength:4000,vtext:'请填入备注信息，最多输入4000字符'">${sheetLink.linkCutComment }</textarea>
        </td>
    </tr>
    <tr>
        ...
        <td colspan="3">
            <textarea class="textarea max" name="${sheetPageName}linkBusinessComment"
                      ...
                      alt="allowBlank:false,maxLength:4000,vtext:'请填入备注信息，最多输入4000字符'">${sheetLink.linkBusinessComment }</textarea>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td colspan="3">
            <textarea class="textarea max" name="${sheetPageName}linkAlertRecord" id="${sheetPageName}linkAlertRecord"
                      alt="allowBlank:false,maxLength:4000,vtext:'请填入备注信息，最多输入4000字符'">${sheetLink.linkAlertRecord}</textarea>
        </td>
    </tr>
    <tr>
        ...
        <td colspan="3">
            <textarea class="textarea max" name="${sheetPageName}linkUnnormalComment"
                      ...
                      alt="allowBlank:false,maxLength:4000,vtext:'请填入备注信息，最多输入4000字符'">${sheetLink.linkUnnormalComment}</textarea>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td colspan="3">
            ...
            <textarea class="textarea max" name="${sheetPageName}linkDataCheck" id="${sheetPageName}linkDataCheck"
                      alt="allowBlank:false,maxLength:255,vtext:'请填入核查结果，最多输入255字符'">${sheetLink.linkDataCheck}</textarea>
        </td>
    </tr>
    <tr>
        <td class="label"><bean:message bundle="netdata" key="netdata.linkCheckExplain"/></td>
        <td colspan="3">
            <textarea class="textarea max" name="${sheetPageName}linkCheckExplain" id="${sheetPageName}linkCheckExplain"
                      alt="allowBlank:true,maxLength:255,vtext:'请填入核查情况说明，最多输入255字符'">${sheetLink.linkCheckExplain}</textarea>
        </td>
    </tr>
    <tr>
        <td class="label">附件</td>
    ...
    <tr>
        ...
        <td colspan="3">
            <textarea class="textarea max" name="${sheetPageName}linkTestReport" id="${sheetPageName}linkTestReport"
                      alt="allowBlank:false,maxLength:255,vtext:'请填入报告信息，最多输入255字符'">${sheetLink.linkTestReport }</textarea>
        </td>
    </tr>
    <tr>
        <td class="label">附件</td>
    ...
    <tr>
        ...
        <td>
            <eoms:comboBox name="${sheetPageName}linkIsNeedProject" id="${sheetPageName}linkIsNeedProject"
                           initDicId="10301" alt="allowBlank:false" styleClass="select-class"
                           defaultValue="${sheetLink.linkIsNeedProject}"/>
        </td>
        <td class="label"><bean:message bundle="netdata" key="netdata.linkIsPlan"/>*</td>
        <td>
            <eoms:comboBox name="${sheetPageName}linkIsPlan" id="${sheetPageName}linkIsPlan"
    ...
    <tr>
        ...
        <td colspan="3">
            <textarea class="textarea max" name="${sheetPageName}linkCutAnalyse" id="${sheetPageName}linkCutAnalyse"
                      alt="allowBlank:true,maxLength:4000,vtext:'请填入备注信息，最多输入4000字符'">${sheetLink.linkCutAnalyse}</textarea>
        </td>
    </tr>
    <tr>
        ...
        <td colspan="3">
            <textarea class="textarea max" name="${sheetPageName}linkWorkUpdateAdvice"
                      ...
                      alt="allowBlank:true,maxLength:4000,vtext:'请填入备注信息，最多输入4000字符'">${sheetLink.linkWorkUpdateAdvice}</textarea>
        </td>
    </tr>
    <tr>
        ...
        <td colspan="3">
            <textarea class="textarea max" name="${sheetPageName}linkSoftVersionUpdate"
                      ...
                      alt="allowBlank:false,maxLength:4000,vtext:'请填入备注信息，最多输入4000字符'">${sheetLink.linkSoftVersionUpdate}</textarea>
        </td>
    </tr>
    <tr>
        ...
        <td colspan="3">
            <textarea class="textarea max" name="${sheetPageName}linkNextPlan" id="${sheetPageName}linkNextPlan"
                      alt="allowBlank:true,maxLength:4000,vtext:'请填入备注信息，最多输入4000字符'">${sheetLink.linkNextPlan}</textarea>
        </td>
    </tr>
    <tr>
        ...
        <td colspan="3">
            <textarea class="textarea max" name="${sheetPageName}linkProjectComment"
                      ...
                      alt="allowBlank:false,maxLength:4000,vtext:'请填入备注信息，最多输入4000字符'">${sheetLink.linkProjectComment}</textarea>
        </td>
    </tr>
    <!-- 归档 -->
    ...
    <tr id="ifDcase">
        ...
        <td colspan="3">
            <textarea name="${sheetPageName}mainCaseKeywords"
                      alt="allowBlank:true,maxLength:100,vtext:'请填入案例关键字，最多输入100字符'"
...
<fieldset id="link4">
    ...
    <div ID="permit1">
        <eoms:chooser id="netSendRole1" type="role" roleId="245" flowId="78"
...
<fieldset id="link5">
    ...
    <div ID="permit2">
        <eoms:chooser id="netSendRole2" type="role" roleId="247" flowId="78"
                      config="{returnJSON:true,showLeader:true,mainPanelTitle:'可选择的子角色'}"
...
<fieldset id="link4">
    ...
    <div ID="permit2">
        <eoms:chooser id="netSendRole" type="role" roleId="246" flowId="78"
                      config="{returnJSON:true,showLeader:true,mainPanelTitle:'可选择的子角色'}"
...
<fieldset id="link4">
    ...
    <eoms:chooser id="netSendRole" type="role" roleId="379" flowId="78"
                  config="{returnJSON:true,showLeader:true,mainPanelTitle:'可选择的子角色'}"
                  category="[{id:'${sheetPageName}dealPerformer',text:'派发',allowBlank:true,vtext:'请选择派发人',limit:1},{id:'${sheetPageName}copyPerformer',text:'抄送',childType:'user,subrole,dept',limit:'none'}]"
                  data="${sendUserAndRoles}"/>
...
<fieldset id="link4">
    ...
    <eoms:chooser id="netSendRole" type="role" roleId="380" flowId="78"
                  config="{returnJSON:true,showLeader:true,mainPanelTitle:'可选择的子角色'}"
                  category="[{id:'${sheetPageName}dealPerformer',text:'派发',allowBlank:true,vtext:'请选择派发人',limit:1},{id:'${sheetPageName}copyPerformer',text:'抄送',childType:'user,subrole,dept',limit:'none'}]"
...
<fieldset id="link4">
    <legend>
        <bean:message bundle="sheet" key="mainForm.toOperateRoleName"/>:<eoms:id2nameDB id="${ProjectCreatePerformer}"
                                                                                        beanId="tawSystemSubRoleDao"/>
    </legend>
    <eoms:chooser id="netSendRole" type="role" roleId="245" flowId="78"
                  config="{returnJSON:true,showLeader:true,mainPanelTitle:'可选择的子角色'}"
                  category="[{id:'${sheetPageName}dealPerformer',text:'派发',allowBlank:true,vtext:'请选择派发人',limit:1},{id:'${sheetPageName}copyPerformer',text:'抄送',childType:'user,subrole,dept',limit:'none'}]"
                  data="${sendUserAndRoles}"/>
</fieldset>
