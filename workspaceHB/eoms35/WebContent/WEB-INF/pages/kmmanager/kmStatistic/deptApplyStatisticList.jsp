...
<script language='javascript'>
    function period() {
        ...
        location.href = '${app}/kmmanager/personalApplyStatistics.do?method=deptSearch&startDate=' + startDate + '&endDate=' + endDate;
    }
</script>
...
<fmt:bundle basename="com/boco/eoms/km/config/applicationResource-kmmanager">
    ...
    <content tag="heading">
        <b><fmt:message key="personalApplyStatistic.list.deptHeading"/></b>
    </content>
    ...
    <display:table name="personalApplyStatisticList" cellspacing="0" cellpadding="0"
        ...
        <display:column property="applyCount" sortable="true"
                        headerClass="sortable" titleKey="personalApplyStatistic.applyCount" paramId="id"
                        paramProperty="id"/>
