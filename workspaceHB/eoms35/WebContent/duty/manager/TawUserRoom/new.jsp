...
<SCRIPT LANGUAGE=javascript>
    ...
    function sent_room_user() {
        ...
        var sel_sprlen = document.form1.sRoomUserTrue.options.length - 1;
        if (<%=request.getAttribute("UserNum")!=null?"true":"false"%> &&
...
<script type="text/javascript">
    ...
    Ext.onReady(function () {
        userTree = new xbox({
            ...
            treeDataUrl: userTreeAction, treeRootId: '-1', treeRootText: '所属部门域', treeChkMode: '', treeChkType: 'dept',
                ...
                <table cellpadding="0" cellspacing="0" border="0" width="100%" class="listTable">
                    <tr>
                        <td width="100%" align="center" class="label">
                            <%=request.getAttribute("ROOMNAME") %> <bean:message
                                key="entry.TawRmSysteminfo.apparatusroom"/><bean:message
                                key="entry.TawUserRoom.btn_new"/>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <%
                                ...
                                <tr class="tr_show">
                                    ...
                                    <td width="50%" align="center">
                                        ...
                                        <p>
                                            ...
                                            <input type="text" name="deptName" size="20" value="" id="deptName"
                                                   readonly="readonly">
                                        ...
                                        <p>
                                            ...
                                            <select size=14 name="sDeptUser" style="width:150" multiple>
                                                ...
                                                <option value="<%out.print(DeptUser.elementAt(i*2));%>"><%
                                                    out.print(DeptUser.elementAt(i * 2 + 1));%></option>
                                                <%
                                                    }
                                                %>
                                    ...
                                    <td width="20%" align="center" valign="top">
                                        ...
                                        <bean:message key="TawUserRoom.btn_add"/> onclick="javascript:add_RoomTrue();")>
                                        <p>
                                        <p>
                                            ...
                                            <tr>
                                                <td align="center" class="label">
                                                    <select size=8 name="sRoomUserTrue" style="width:150">
                                                        ...
                                                        <option value="<%out.print(RoomUserTrue.elementAt(i*2));%>"><%
                                                            out.print(RoomUserTrue.elementAt(i * 2 + 1));%></option>
                                                        <%
                                                            }
                                                        %>
                                                    </select>
                                                ...
                                                <td>
                                                    <table>
                                                        <tr>
                                                            <td><img
                                                                    src="<%=request.getContextPath()%>/duty/images/bottom/up.gif"
                                                                    onclick="fnSwap(0);"></td>
                                                        </tr>
                                                        <tr>
                                                            <td><img
                                                                    src="<%=request.getContextPath()%>/duty/images/bottom/down.gif"
                                                                    onclick="fnSwap(1);"></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                    ...
                                                    <p>
                                                        ...
                                                        <select size=4 name="sRoomUserFalse" style="width:150">
                                                            ...
                                                            <option value="<%out.print(RoomUserFalse.elementAt(i*2));%>"><%
                                                                out.print(RoomUserFalse.elementAt(i * 2 + 1));%></option>
                                                            <%
                                                                }
                                                            %>
                                                        </select>
                            ...
                            <table height="30" cellpadding="0" cellspacing="0" border="0" width="100%">
                                <tr>
                                    <td align="right">
                                        ...
                                        ../TawRmSysteminfo/add.do?roomId=<%=request.getParameter("roomId")%>'">&nbsp;&nbsp;
