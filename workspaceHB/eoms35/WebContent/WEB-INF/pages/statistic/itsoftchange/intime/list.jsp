...
<fmt:bundle basename="config/statistic/commonstat-config/ApplicationResources-statistic-commonstat">
	<display:table name="estList" cellspacing="0" cellpadding="0"
		...
		decorator="com.boco.eoms.commons.statistic.itsoftchange.util.ItsoftchangeListDisplayHelper">
	...
	<display:column property="sheetid" sortable="true"
		headerClass="sortable" titleKey="list.sheetid" href="${app}/sheet/itsoftchange/itsoftchange.do?method=showDetailPage" paramId="sheetKey" paramProperty="mainid"/>
