...
<script type="text/javascript">
    var config = {
        ...
        ctxMenu: [
            {
                id: 'edtnode',
                text: '${eoms:a2u('批量定制评估指标')}',
                cls: 'edit-mi',
                url: '<c:url value="/supplierkpi/editTawSupplierkpiAssessInstance.do?specialType=" />'
            },
            {
                id: 'View',
                text: '${eoms:a2u('已定制供应商')}',
                cls: 'edit-mi',
                url: '<c:url value="/supplierkpi/editTawSupplierkpiAssessInstance.do?method=viewCustomSuppliers&specialType=" />'
            }
        ],//end of ctxMenu
        /************************
