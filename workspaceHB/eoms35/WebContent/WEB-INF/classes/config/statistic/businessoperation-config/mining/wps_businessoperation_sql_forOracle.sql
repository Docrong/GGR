...
from faultsheet_main

select *
from faultsheet_link select *
...
------------------------------VIEW----------------------------------------
select *
from v_businessoperation select distinct *
...
--common main
                                           ...
                                           SENDROLEID, SENDCONTACT, STATUS, HOLDSTATISFIED, ENDTIME, ENDRESULT,
                                           ENDUSERID, ENDDEPTID, ENDROLEID,
...
values (23, to_date('2007-07-07 00:00:00', 'YYYY-MM-DD HH24:MI:SS'), '新业务正式实施工单基础表采集的上一次操作的时间');
...
from businessoperation_link link

SELECT count(distinct mainid)
FROM businessoperation_link
...
from businessoperation_link delete from est_businessoperation
select *
from est_businessoperation drop table est_businessoperation
--中间表
