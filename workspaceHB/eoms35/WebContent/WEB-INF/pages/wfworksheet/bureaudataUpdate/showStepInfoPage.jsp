...
<div id="history" class="panel">
    ...
    <logic:present name="HISTORY" scope="request">
        <logic:iterate id="baselink" name="HISTORY"
                       type="com.boco.eoms.sheet.bureaudataUpdate.model.BureaudataUpdateLink">
            <%
                jNum += 1;
            ...
            <div class="history-item"><!-- add space to hack ie-->&nbsp;
                <div class="history-item-title">
                    ...
                    <eoms:dict key="dict-sheet-bureaudataUpdate" dictId="activeTemplateId"
                    ...
                    <eoms:dict key="dict-sheet-bureaudataUpdate" dictId="mainOperateType"
                ...
                <div class="history-item-content hide">
  			      ...
  			      <%} %> -->
                        ...
                        <tr>
                            <td class="column-title">
                                <bean:message bundle="bureaudataUpdate" key="bureaudataUpdate.linkAuditResult"/>
                            </td>
                        ...
                        <tr>
                            <td class="column-title">
                                <bean:message bundle="bureaudataUpdate" key="bureaudataUpdate.linkAuditIdea"/>
                            </td>
                            <td class="column-content" colspan="3">
                        ...
                        <tr>
                            <td class="label"><bean:message bundle="bureaudataUpdate"
                                                            key="bureaudataUpdate.linkTaskComplete"/></td>
                            <td class="column-content" colspan="3">
                        ...
                        <tr>
                            <td class="column-title">
                                <bean:message bundle="bureaudataUpdate" key="bureaudataUpdate.fenpairesion"/>
                            </td>
                            <td class="column-content" colspan="3">
                                <pre><bean:write name="baselink" property="linkTaskComplete" scope="page"/></pre>
                            </td>
                        ...
                        <tr>
                            <td class="column-title">
                                <bean:message bundle="bureaudataUpdate" key="bureaudataUpdate.yijiaoresion"/>
                            </td>
                            <td class="column-content" colspan="3">
                                <pre><bean:write name="baselink" property="linkTaskComplete" scope="page"/></pre>
                            </td>
                        ...
                        <tr>
                            <td class="column-title">
                                <bean:message bundle="bureaudataUpdate" key="bureaudataUpdate.advice"/>
                            </td>
                            <td class="column-content" colspan=3>
                                <pre><bean:write name="baselink" property="linkTaskComplete" scope="page"/></pre>
                            </td>
