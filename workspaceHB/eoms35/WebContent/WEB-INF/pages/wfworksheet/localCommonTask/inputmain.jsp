     ...
     <table class="formTable">
          <tr>
	                ...
	                <tr>
            	      ...
            	      initDicId="${sheetMain.mainNetSort2}"  alt="allowBlank:false" defaultValue="${sheetMain.mainNetSort3}" styleClass="select-class"/>
		               ...
		               <td  class="label"><bean:message bundle="localCommonTask" key="localCommonTask.mainTaskType"/>*</td>
		                <td class="content">  
				        <eoms:comboBox name="${sheetPageName}mainTaskType" id="${sheetPageName}mainTaskType" onchange="onmainTaskType(this.value);" initDicId="1010108"  alt="allowBlank:false" defaultValue="${sheetMain.mainTaskType}" styleClass="select-class"/>
			        </td>	                
		            </tr>
					...
					<tr>
		              ...
		              <td > 	
			            <eoms:comboBox name="${sheetPageName}sheettype" id="${sheetPageName}sheettype" initDicId="1010109"  alt="allowBlank:false" defaultValue="${sheetMain.sheettype}" styleClass="select-class" />
                      </td>
		          ...
		          <tr>
                    ...
                    <td><input type="text" name="${sheetPageName}netName"   id="${sheetPageName}netName" value="${sheetMain.netName}" /></td>
                    <td  class="label">告警描述*</td>
                    <td>
                    	<input type="text" name="${sheetPageName}netText"  id="${sheetPageName}netText" value="${sheetMain.netText}" alt="allowBlank:false,vtext:'告警描述'"/>
