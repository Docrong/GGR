...
<table border="0" width="95%" cellspacing="1" cellpadding="1" class="table_show" align="center">
    ...
    <logic:iterate id="statlist" name="statlist" type="com.boco.eoms.sparepart.model.TawPart">
        <a href="../part/amplyview.do?id=<bean:write name="statlist" property="id" scope="page"/>">
            <%i = i + 1;%>
            <tr class="tr_show" align="center" style="cursor:hand" onmousemove="this.style.backgroundColor='#87CEEB'"
                ...
                <td><bean:write name="statlist" property="repairnum" scope="page"/></td>
            </tr>
        </a>
    </logic:iterate>
</table>
