    ...
    <%if(taskName.equals("ProjectCreateTask") && operateType.equals("110") ) {%>
			      ...
			      <tr>
		            ...
		            <td> 
		             ...
		             <td> <input type="text"  class="text" name="${sheetPageName}linkDesignKey" id="${sheetPageName}linkDesignKey" value="${sheetLink.linkDesignKey}"  alt="allowBlank:false"/></td>
		          </tr>
			      <tr>
	                ...
	                <tr>
		                ...
		                <td colspan="3">  
	            	      <eoms:comboBox name="${sheetPageName}linkPermitResult" id="${sheetPageName}linkPermitResult" 
		            	      			initDicId="1011608"  alt="allowBlank:false" styleClass="select-class" defaultValue="${sheetLink.linkPermitResult}"/>
			        	</td>	                
		            </tr>
			        <tr>
			      ...
			      <tr>
	                ...
	                <tr>
				        ...
				        <eoms:comboBox name="${sheetPageName}linkIsEffectBusiness" id="${sheetPageName}linkIsEffectBusiness" 
            	      	initDicId="1011608"  alt="allowBlank:true" styleClass="select-class" defaultValue="${sheetLink.linkIsEffectBusiness}"/>
			        </td>	                
		            </tr>
			      <tr>
                 ...
                 <tr>
	                ...
	                <td>  
				        <eoms:comboBox name="${sheetPageName}linkBusinessDept" id="${sheetPageName}linkBusinessDept" 
            	      	initDicId="1011608"  alt="allowBlank:true" styleClass="select-class" defaultValue="${sheetLink.linkBusinessDept}"/>
		        	</td>
	                ...
	                <td>  
			        	<eoms:comboBox name="${sheetPageName}linkIsSendToFront" id="${sheetPageName}linkIsSendToFront" 
           	      		initDicId="1011608"  alt="allowBlank:true" styleClass="select-class" defaultValue="${sheetLink.linkIsSendToFront}"/>
		        	</td>	 	                
	             </tr>
	<!-- 方案实施 -->
	<%}else if(taskName.equals("ExecuteTask") && operateType.equals("114")){%>
                   ...
                   <tr>
	                ...
	                <td>  
            	      ...
            	      initDicId="1011608"  alt="allowBlank:false" styleClass="select-class" defaultValue="${sheetLink.linkCutResult }"/>
		        	</td>
	                 ...
	                 <td>  
            	      ...
            	      initDicId="1011608"  alt="allowBlank:false" styleClass="select-class" defaultValue="${sheetLink.linkIsPlan }"/>
            	     </td>	                
	              </tr>
	              <tr>
	                 ...
	                 <td colspan="3">  
				        <eoms:comboBox name="${sheetPageName}linkTestResult" id="${sheetPageName}linkTestResult" 
            	      	initDicId="1011608"  alt="allowBlank:false" styleClass="select-class" defaultValue="${sheetLink.linkTestResult }"/>
		        	 </td>	                
	              </tr>
			      <tr>
			       ...
			       <tr>
		                ...
		                <td colspan="3">  
					        <eoms:comboBox name="${sheetPageName}linkIsUpdateWork" id="${sheetPageName}linkIsUpdateWork" 
	            	      		initDicId="1011608"  alt="allowBlank:false" styleClass="select-class" defaultValue="${sheetLink.linkIsUpdateWork}"/>
			        	</td>	                
		           </tr>
			      <tr>
		...
		<%if(taskName.equals("ProjectCreateTask")){ %>
			...
			<%if(taskName.equals("PermitTask")){ %>
			 <tr>
			 	<td class="label"></td>
			 	<td>
			 		<input type="radio" name="${sheetPageName}phaseId" value="ProjectCreateTask" checked>${eoms:a2u('重新制定方案')}
