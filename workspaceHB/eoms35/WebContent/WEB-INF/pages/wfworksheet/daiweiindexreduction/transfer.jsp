...
<div id="sheetform">
<html:form action="/daiweiindexreduction.do?method=performTransferWorkItem" styleId="theform">
       <%@ include file="/WEB-INF/pages/wfworksheet/daiweiindexreduction/baseinputlinkhtmlnew.jsp"%>
    <br/>
           <input type="hidden" name="beanId"   id="beanId"  value="iDaiWeiIndexReductionMainManager"/>
           <input type="hidden" name="mainClassName" id="mainClassName"  value="com.boco.eoms.sheet.daiweiindexreduction.model.DaiWeiIndexReductionMain"/>		
           <input type="hidden" name="linkClassName" id="linkClassName" value="com.boco.eoms.sheet.daiweiindexreduction.model.DaiWeiIndexReductionLink"/> 
   ...
   <div class="form-btns">
        ...
        <input type="submit" class="submit" onclick="v.passing=true;this.form.action='${app}/sheet/daiweiindexreduction/daiweiindexreduction.do?method=performSaveInfo'" value="<bean:message bundle='sheet' key='button.save'/>" />
