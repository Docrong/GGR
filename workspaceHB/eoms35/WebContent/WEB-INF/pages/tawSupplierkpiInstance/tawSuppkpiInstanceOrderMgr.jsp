        ...
        ctxMenu: [
            {
                ...
                text: '${eoms:a2u('订制报表')}',
                cls: 'new-mi',
                url: '<c:url value="/supplierkpi/TawSuppKpiInstReportOrder.do?dictId=" />'
            },
            {
                id: 'delnode',
                text: '${eoms:a2u('查看已订制报表')}',
                cls: 'new-mi',
                url: '<c:url value="/supplierkpi/TawSuppKpiInstReportOrder.do?method=list&dictId=" />'
            }
        ],
        /************************
