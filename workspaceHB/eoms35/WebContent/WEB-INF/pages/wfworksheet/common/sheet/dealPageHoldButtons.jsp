    ...
    <c:choose>
        <c:when test="${isAdmin == 'true'}">
            <div id="buttonDisplay" style="display:block">
                ...
                <input type="button" value="<bean:message bundle="sheet" key="button.forceHold"/>"
                       onclick="$('buttonDisplay').style.display='none';forceOperation(1);">
                <input type="button" value="<bean:message bundle="sheet" key="button.forceNullity"/>"
        ...
        <c:when test="${(taskStatus == null || taskStatus == '') && (userId == sendUserId)}">
            <div id="advice" style="display:block">
                <input type="button" value="<bean:message bundle="sheet" key="button.nullity"/>"
