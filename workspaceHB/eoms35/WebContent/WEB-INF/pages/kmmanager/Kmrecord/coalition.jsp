...
<html:form method="post" action="/TawRmRecord/save">
    ...
    <TABLE cellSpacing="0" cellPadding="0" width="520" border="0">
        <TR>
            <TD noWrap align="middle" colSpan="3" height="15"><font color="crimson"><span id="LabelInfo"></span></font>
            </TD>
        </TR>
    </TABLE>
    <TABLE cellSpacing="0" borderColorDark="#ffffff" cellPadding="0" width="560" align="center" bgColor="#f3f3f3"
           borderColorLight="#66ccff" border="1">
        ...
        <TR>
            ...
            <TD colSpan="3">
                <input name="hander" id="hander" type="text" style="BACKGROUND-COLOR: lightgrey" readOnly="" size="58"
                       value="<logic:iterate id="tawRmRecord" name="TAWRMRECORDS" type="com.boco.eoms.duty.model.TawRmRecord"> <bean:write name="tawRmRecord" property="hander" scope="page"/> </logic:iterate> "/>
        ...
        <TR>
            ...
            <TD colSpan="3">
                <input name="dutyman" id="dutyman" type="text" style="BACKGROUND-COLOR: lightgrey" readOnly="" size="58"
                       value="<logic:iterate id="tawRmRecord" name="TAWRMRECORD_DUTYMAN" type="com.boco.eoms.duty.model.TawRmRecord"><bean:write name="tawRmRecord" property="dutyman" scope="page"/> </logic:iterate>"/>
        </TR>
        <TR>
            ...
            <TD colSpan="3">
                <input name="receiver" id="receiver" type="text" style="BACKGROUND-COLOR: lightgrey" readOnly=""
                       size="58"
                       value="<logic:iterate id="tawRmRecord" name="TAWRMRECORD_RECEIVER" type="com.boco.eoms.duty.model.TawRmRecord"><bean:write name="tawRmRecord" property="receiver" scope="page"/> </logic:iterate>"/>
            </TD>
        </TR>
        ...
        <TR>
            ...
            <TD>
                <input name="starttime" type="text" style="BACKGROUND-COLOR: lightgrey" readOnly="" size="18"
                       value="<eoms:TextTime />"/>
            </TD>
        ...
        <TR>
            ...
            <TD colSpan="4"><Span id="spanFile"></Span><BR>
                ...
                <input language="javascript"
                       onclick="{if (typeof(Page_ClientValidate) != 'function' ||  Page_ClientValidate()) __doPostBack('btnUpLoad','')} "
                       name="btnUpLoad" id="btnUpLoad" type="button" value="\u00C9\u00CF\u00B4\u00AB"
        ...
        <TR>
            <TD align="middle">\u5DE5\u4F5C\u65E5\u5FD7<BR>
                <BR>
                <input type="button" id="btnGetSub" runat="server" Value="\u5408\u6210\u65E5\u5FD7" style="WIDTH:52px;"
                       size="3"></TD>
            <TD colspan="4" align="left" Nowrap>
                <textarea rows="6" cols="64" id="Dutyrecord" runat="server" NAME="Dutyrecord"></textarea>
                <asp:CustomValidator id="Customvalidator1" runat="server"
                                     ErrorMessage="<BR>\u5DE5\u4F5C\u65E5\u5FD7\u4E0D\u8981\u8D85\u8FC72000\u5B57\uFF01"
                                     Display="Dynamic" ClientValidationFunction="CheckDutyRecord"
                                     ControlToValidate="Dutyrecord"></asp:CustomValidator></TD>
        </TR>
        <TR>
            <TD align="middle">\u5907&nbsp;&nbsp;&nbsp;&nbsp;\u6CE8</TD>
            <TD colspan="4"><textarea rows="4" cols="64" id="Notes" runat="server" NAME="Notes"></textarea>
                <asp:CustomValidator id="Customvalidator2" runat="server"
                                     ErrorMessage="<BR>\u5907\u6CE8\u4E0D\u8981\u8D85\u8FC7120\u5B57\uFF01"
                                     Display="Dynamic" ClientValidationFunction="CheckNotes"
                                     ControlToValidate="Notes"></asp:CustomValidator></TD>
        </TR>
        <TR>
            <TD align="middle" colspan="5"><INPUT id="btnGo" type="button" value="\u4E0B \u4E00 \u6B65" name="btnGo"
                                                  runat="server"></TD>
        </TR>
    </TABLE>
</html:form>
