...
<input type="hidden" id="tmpCompleteLimit" value="" alt="vtype:'moreThen',link:'${sheetPageName}nodeCompleteLimit',vtext:'处理时限不能晚于工单完成时限'"/> 
	<br/>     
	<input type="hidden" name="${sheetPageName}processTemplateName" id="${sheetPageName}processTemplateName" value="NetOptimizeProcess" />
			...
			<input type="hidden" name="${sheetPageName}phaseId" id="${sheetPageName}phaseId" value="ExcuteTask" />
               ...
               <tr>                 
  				  ...
  				  <td class="content max" colspan=3>
  				   <eoms:comboBox name="${sheetPageName}linkIsAccept" id="${sheetPageName}linkIsAccept" alt="allowBlank:false" initDicId="1011801" onchange="AcceptChange(this.value);" />                
                  </td>	                  
	  		  </tr>	
	  		  <tr>
  				  <td class="label">
  				  ...
  				  <td class="content max" colspan=3>
  				   	<textarea name="linkTestResult" id="linkTestResult" class="textarea max" alt="allowBlank:false,maxLength:200,vtext:'请输入分析/测试结果，最大长度为200个汉字'">${sheetLink.linkTestResult}</textarea>	  
                  </td>
	  		  </tr>	
	  		 <tr>  				
  			 <%}%>		
			 ...
			 <%if(taskName.equals("ProjectCreateTask") && (operateType.equals("2")||operateType.equals("11"))){ %>
		    	...
		    	<tr>
					...
					<td class="content max" colspan="3">			
				        <textarea name="${sheetPageName}linkProjectExplain" class="textarea max" id="${sheetPageName}linkProjectExplain" 
		    	...
		    	<tr>
					...
					<td class="content max" colspan="3">			
				        <eoms:attachment name="sheetLink" property="linkProjectAcc" 
			              scope="request" idField="${sheetPageName}linkProjectAcc" alt="allowBlank:false" appCode="netOptimize"/>
				  	</td>
				</tr>  	
		...
		<%if(operateType.equals("56")|| operateType.equals("55")){ %>
			...
			<input type="hidden" name="${sheetPageName}phaseId" id="${sheetPageName}phaseId" value="ExcuteTask" />
               <tr>                 
  				  ...
  				  <td class="content max" colspan=3>
  				   <eoms:comboBox name="${sheetPageName}linkAuditOpinion" id="${sheetPageName}linkAuditOpinion" alt="allowBlank:false" defaultValue="${sheetLink.linkAuditOpinion}" initDicId="1010503" onchange="AuditIfPass(this.value);" />                
                  </td>	                  
	  		  </tr>				
			 ...
			 <tr>
				  <td class="label">
		 		  ...
		 		  <td class="content max"  colspan=3>
				     <textarea name="linkAuditResult" id="linkAuditResult" class="textarea max" alt="allowBlank:false,maxLength:100,vtext:'请输入审批结果，最大长度为100个汉字！'">${sheetLink.linkAuditResult}</textarea>	  
                </td>
  		       </tr>		
	      <%} }%>	
		     ...
		     <%if(operateType.equals("62") || operateType.equals("11")){ %>
			   ...
			   <input type="hidden" name="${sheetPageName}phaseId" id="${sheetPageName}phaseId" value="ResultEvaluateTask" />
               	...
               	<tr>
	  				  ...
	  				  <td class="content">
	  				   	<eoms:comboBox name="${sheetPageName}linkIsSuccess" id="${sheetPageName}linkIsSuccess" initDicId="1011803" defaultValue="${sheetLink.linkIsSuccess}"/>
                      </td>
                       <td class="label">
	  				     <bean:message bundle="netOptimize" key="netOptimize.linkIsStartSheet"/>*
	  				  </td >
	  				  <td class="content">
	  				   	<eoms:comboBox name="${sheetPageName}linkIsStartSheet" id="${sheetPageName}linkIsStartSheet" initDicId="1011802"  onchange="IsDispatchSheet(this.value);" defaultValue="${sheetLink.linkIsStartSheet}" /> 
                      </td>
		  		</tr>	
		  		...
		  		<tr>
	  				  ...
	  				  <td class="content max"  colspan=3>
 	                       ...
 	                       id="linkSummarize" class="textarea max" alt="allowBlank:true,maxLength:200,vtext:'您输入网优实施概述超出最大长度限制，最多支持200个汉字！'" >${sheetLink.linkSummarize}</textarea>
		              </td>
		  		</tr>
	            ...
	            <tr>
	  				  ...
	  				  <td class="content" colspan=3>
			              ...
			              scope="request" idField="${sheetPageName}linkOperationAcc" alt="allowBlank:false" appCode="netOptimize"/>
		  			 </td>
		  		</tr>	
		  ...
		  <%if(operateType.equals("64") || operateType.equals("11")){%>
			...
			<input type="hidden" name="${sheetPageName}phaseId" id="${sheetPageName}phaseId" value="HoldTask" />
		          ...
		          <tr>
 	                   ...
 	                   id="linkAssessResult" class="textarea max" alt="allowBlank:false,maxLength:1000,vtext:'请输入评定结果，最大长度为200个汉字！'">${sheetLink.linkAssessResult}</textarea>
	                  </td>
		  		 </tr>
