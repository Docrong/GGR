...
function showPage(){
     var pars = '';
     var url = '';    
      url = '${app}/sheet/complaintDuban/complaintDuban.do?method=showInputRejectPage&piid=${sheetMain.piid}&taskId=${taskId}&taskName=${taskName}';
     if (url!=''){
...
<div id="sheetform">
<html:form action="/complaintDuban.do?method=performDeal" styleId="theform">
