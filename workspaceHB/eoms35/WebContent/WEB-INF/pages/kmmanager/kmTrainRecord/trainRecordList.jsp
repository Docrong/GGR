...
<html:form action="/trainRecords.do?method=searchX" styleId="trainRecordForm" method="post">
    <table align="center">
        <tr>
            ...
            <td>
                <input type="text" id="trainUserName" name="trainUserName" class="text" readonly="readonly"
                       value='<eoms:id2nameDB id="${trainRecordForm.trainUser}" beanId="tawSystemUserDao" />'/>
