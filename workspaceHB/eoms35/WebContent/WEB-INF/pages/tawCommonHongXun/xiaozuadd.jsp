...
var Tabs = {
    init : function(){
        ...
        tabs.addTab('form', '${eoms:a2u('小组职务添加')}');
...
<html:form action="/TawCommonHongXunAction/xiaozusave" method="post"
...
<table border="0" width="95%" cellspacing="1">
 ...
 <tr class="tr_show">
		...
		<td colspan=3>
	   <html:text property="xiaozu_name" styleId="xiaozu_name" styleClass="text medium"
				alt="allowBlank:false,vtext:'${eoms:a2u('小组职务不能为空')}'" />
	   </td>
 </tr>
...
<table border="0" width="70%" cellspacing="0">
  ...
  <div id="info">
    ${eoms:a2u('请填写防汛小组职务信息，填写完毕后，请点击保存')}
  </div>
</div>
</body>
</html>
