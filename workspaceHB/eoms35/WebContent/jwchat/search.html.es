...
<html>
    <head>
        <title>JWChat - B&uacute;squeda</title>
        <meta http-equiv="content-type" content="text/html; charset=utf-8">
          ...
          function searchUser() {
            ...
            document.getElementById('results_header').innerHTML = "Consultando ...";
            // send query
            var searchstring = '';
          ...
          function getQueryResult(iq) {
            if (!iq || iq.getType() != 'result') {
              document.getElementById('results_header').innerHTML = "Ha ocurrido un error";
              return false;
            }
            ...
            if (iq.getNode().getElementsByTagName('x').length && iq.getNode().getElementsByTagName('x').item(0).getAttribute('xmlns') == 'jabber:x:data') {
              ...
              if (x.getElementsByTagName('title').item(0))
                ...
                document.getElementById('results_header').innerHTML = "Resultados de la b&uacute;squeda para "+iq.getFrom();
          ...
          function getSearchForm(iq) {
            if (!iq || iq.getType() != 'result') {
              document.getElementById('searchfields').innerHTML = "Ocurrió un error\nAbortando...";
            ...
            html += "<hr noshade size=1><div align=right><button onClick='return searchUser();'>"+"Buscar"+"</button></div>";
    ...
    <body style="margin: 8px;">
        <div id="search_form">
            <form name="service_select">
                Restringir b&uacute;squeda a
                <select name="service" onChange="return serviceSelected(this);">
                    <option value=''>- Elige Directorio -</option>
                </select>
            </form>
        ...
        <div id="search_results">
            <table height="100%" width="100%">
                <tr>
                    <td id="results_header">Consultando ...</td>
                </tr>
                <tr>
                    <td height="100%" width="100%">
                        <iframe src="search_iframe.html" id="resultF" name="resultF" scrolling="auto"
                    ...
                    <td align=right>
                        <hr noshade size="1">
                            <button id="info_button"
                                    onClick='return srcW.openUserInfo(resultF.selectedRow.childNodes[0].innerHTML);'>
                                <l>User Info
                                    <l>
                            </button>
                            &nbsp;
                            <button id="add_button"
                                    onClick='return srcW.openSubscription(resultF.selectedRow.childNodes[0].innerHTML);'>
                                <l>Add Contact
                                    <l>
                            </button>
                            &nbsp;
                            <button onClick='return back();'>
                                <l>Back
                                    <l>
                            </button>
                    </td>
