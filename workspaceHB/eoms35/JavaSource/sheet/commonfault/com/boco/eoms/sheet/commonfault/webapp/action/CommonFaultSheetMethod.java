...
public class CommonFaultSheetMethod extends BaseSheet
{
		...
		if (list != null && list.size() > 0)
		{
			for (int i = 0; i < list.size(); i++)
			{
				...
				if (object.getCount() > 0)
					...
					if (object.getAlreadyCount() < object.getCount() && object.getAlreadyCount() > 0)
						list2.add(object);
					else
		...
		throws Exception
	{
		...
		if (taskName.equals("DraftHumTask") || taskName.equals("BackHumTask"))
		{
			HashMap sheetMap = new HashMap();
		...
		if ((taskName.equals("FirstExcuteHumTask") || taskName.equals("SecondExcuteHumTask") || taskName.equals("ThirdExcuteHumTask")) && subTaskFlag.equals(""))
		{
			String sheetKey = StaticMethod.nullObject2String(request.getParameter("mainId"));
			if (sheetKey.equals(""))
				sheetKey = StaticMethod.nullObject2String(request.getAttribute("mainId"));
...
//					CommonFaultMain mainObject = CommonFaultBO.createMain(mainrule);
		...
		if (operateType.equals("46") && taskName.equals("SecondExcuteHumTask"))
		{
...
//			String mainNeId = StaticMethod.nullObject2String(commonFaultMain.getMainNeId());
		...
		throws Exception
	{
		...
		if (operateMap.get("phaseId").equals("SecondExcuteTask"))
		{
			...
			if (activeTemplateId.equals("BackHumTask"))
			{
				link1.setOperateType(new Integer(3));
				link1.setActiveTemplateId(activeTemplateId);
			} else
		...
		throws Exception
	{
		...
		if (personSendMode != null && mainSendMode.equals(personSendMode))
		{
			StringBuffer sb = new StringBuffer();
			StringBuffer sbFn = new StringBuffer();
			if (taskName.equals("") || taskName.equals("DraftHumTask"))
			...
			if ((taskName.equals("FirstExcuteHumTask") || taskName.equals("SecondExcuteHumTask") || taskName.equals("ThirdExcuteHumTask")) && operateType.equals("46"))
			{
