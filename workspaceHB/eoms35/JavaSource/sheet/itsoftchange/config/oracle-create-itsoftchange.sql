...
insert into taw_system_application(APP_ID,app_name,notes,domain_type) values(28,'IT需求开发流程','IT需求开发流程',1)
insert into taw_system_workflow(id,name,flowid,sheetid,remark,mainservicebeanid) values(113,'ITSoftChangeProcess','092','01','IT需求开发流程','iITSoftChangeMainManager')
