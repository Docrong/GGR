...
<%@page import="com.boco.eoms.sheet.mofficedata.model.MofficeDataTask" %>
<%@page
...
<%
    ...
    if (request.getAttribute("task") != null) {
        task = (MofficeDataTask) request.getAttribute("task");
    ...
    System.out.println("=====taskName333======" + taskName);
%>
...
<script type="text/javascript">
    Ext.onReady(function () {
        var tabConfig = {
            items: [{
                ...
                url: 'mofficedata.do?method=showSheetDealList&sheetKey=${sheetMain.id}&taskName=${taskName}&ifWaitForSubTask=${task.ifWaitForSubTask}'
            }, {
                text: '<bean:message bundle="sheet" key="sheet.flowchar"/>',
                url: 'mofficedata.do?method=showWorkFlow&linkServiceName=iMofficeDataLinkManager&dictSheetName=dict-sheet-mofficedata&description=mainOperateType&sheetKey=${sheetMain.id}',
                isIframe: true
            }
                , {
                    text: '<bean:message bundle="sheet" key="sheet.filesView"/>',
                    url: 'mofficedata.do?method=showSheetAccessoriesList&id=${sheetMain.id}',
                    isIframe: true
                }, {
        ...
        var url2 = "mofficedata.do?method=newShowCCPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}&operateType=-10&taskStatus=${taskStatus}";
        eoms.util.appendPage("sheet-deal-content", url2);
        <%}%>
        <%if(taskName.equals("reply")){ %>
        var url2 = "mofficedata.do?method=showRemarkPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}";
        eoms.util.appendPage("sheet-deal-content", url2);
        <%}%>
    ...
    function forceOperation(obj) {
        ...
        if (obj == 1) {
            ...
            var url2 = "mofficedata.do?method=showForceHoldPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}&operateType=forceHold";
            eoms.util.appendPage("sheet-deal-content", url2);
        } else if (obj == 2) {

            var url2 = "mofficedata.do?method=showForceHoldPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}&operateType=nullity";
            eoms.util.appendPage("sheet-deal-content", url2);
        } else {

            var url2 = "mofficedata.do?method=showForceHoldPage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&taskName=${taskName}&correlationKey=${sheetMain.correlationKey}&operateType=forceNullity";
            eoms.util.appendPage("sheet-deal-content", url2);
        }
    }
    ...
    function eventOperation(obj) {
        if (obj == 1) {
            var url2 = "mofficedata.do?method=showPhaseAdvicePage&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&taskName=advice&operateFlag=driveForward&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}";
...
<div id="sheet-detail-page"><!-- Sheet Detail Tab Start -->
    <div id="sheetinfo"><logic:present name="sheetMain"
                                       scope="request">
        <%@ include
                file="/WEB-INF/pages/wfworksheet/mofficedata/basedetailnew.jsp" %>
        <br/>
        <table id="sheet" class="formTable">
            ...
            <tr>
                ...
                <td>
                    <c:if test="${sheetMain.mainSendModeType==0 }">自动模式</c:if>
                    <c:if test="${sheetMain.mainSendModeType==1 }">手动模式</c:if>
                </td>
                <td class="label"><!-- 局数据编号 --> <bean:message
                        bundle="mofficedata" key="mofficeDataMain.mainDataNo"/></td>
                <td>${sheetMain.mainDataNo}</td>
            </tr>

            <tr>
                <td class="label">专业科室</td>
                <td colspan="3">
                    <c:if test="${sheetMain.mainStyle5==0 }">核心网</c:if>
                    <c:if test="${sheetMain.mainStyle5==1 }">互联网</c:if>
                </td>
            </tr>

            <tr>
                <td class="label">网络一级分类</td>
                <td class="content"><eoms:id2nameDB id="${sheetMain.mainNetTypeOne}"
                                                    beanId="ItawSystemDictTypeDao"/></td>
                <td class="label">网络二级分类</td>
                <td class="content"><eoms:id2nameDB id="${sheetMain.mainNetTypeTwo}"
                                                    beanId="ItawSystemDictTypeDao"/></td>
            </tr>
            <tr>
                <td class="label">网络三级分类</td>
                <td class="content"><eoms:id2nameDB id="${sheetMain.mainNetTypeThree}"
                                                    beanId="ItawSystemDictTypeDao"/></td>
            </tr>
            <tr>
                <td class="label">计划开始时间</td>
                <td>
                        ${eoms:date2String(sheetMain.linkPlanStartTime)}
                </td>
                <td class="label">计划结束时间</td>
                <td>
                        ${eoms:date2String(sheetMain.linkPlanEndTime)}
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="3">
                    <pre>${sheetMain.mainDescRemark}</pre>
                </td>
            </tr>
            <tr>
                ...
                <td colspan='3'><eoms:attachment name="sheetMain"
                                                 ...
                                                 idField="sheetAccessories" appCode="mofficedata" viewFlag="Y"/></td>
            </tr>

            <c:choose>
                <c:when test="${taskName=='DataInsTask'}">
                    <tr>
                    ...
                    <tr>
                        <td class="label" colspan="4" width="120">
                            <iframe height="400" width="100%"
                                    src="mofficedata.do?method=showProducers&mainId=${sheetMain.id}&preLink=${task.correlationKey}&taskName=OfficeMadeTask"></iframe>
                        </td>
                    </tr>
                </c:when>
                <c:otherwise>
                    ...
                    <tr>
                        <td class="label" colspan="4" width="120">
                            <iframe height="400" width="100%"
                                    src="mofficedata.do?method=showProducers&mainId=${sheetMain.id}&preLink=${preLinkId}&taskName=${taskName}"></iframe>
                        </td>
                    </tr>
                </c:otherwise>
            </c:choose>
...
<!-- 局数据工单审批通过 -->
<c:url var="urlShowAuditDataTaskPage" value="mofficedata.do">
...
<!-- 局数据工单审批不通过 -->
<c:url var="urlShowAuditDataTaskPage2" value="mofficedata.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 局数据制作 -->
<c:url var="urlShowOfficeMadeTaskPage" value="mofficedata.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 提交核查 -->
<c:url var="urlShowOfficeMadeTaskPage2" value="mofficedata.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 局数据工单质检通过 到地市拨测 -->
<c:url var="urlShowDataCheckTaskPage" value="mofficedata.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 局数据工单质检不通过 -->
<c:url var="urlShowDataCheckTaskPage2" value="mofficedata.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 测试不通过 add by weichao 20170331-->
<c:url var="urlShowDataCheckTaskPage3" value="mofficedata.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 局数据核查 验证通过 alter by weichao 20170331-->
<c:url var="urlShowDataInsTaskPage" value="mofficedata.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 局数据核查 验证不通过 alter by weichao 20170331-->
<c:url var="urlShowDataInsTaskPage2" value="mofficedata.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 地市拨测费用验证确认 验证通过 -->
<c:url var="urlShowConfirmDataTaskPage" value="mofficedata.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 地市拨测费用验证确认 验证不通过-->
<c:url var="urlShowConfirmDataTaskPage2" value="mofficedata.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 退回 -->
<c:url var="urlShowSelectedPage" value="mofficedata.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 工单归档 -->
<c:url var="urlShowHoldTaskPage" value="mofficedata.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 下面是公共的URL -->
<!-- 退回 -->
<c:url var="urlShowRejectDealPage" value="mofficedata.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<c:url var="urlShowTransferkPage" value="mofficedata.do">
...
<c:url var="urlShowPhaseReplyPage" value="mofficedata.do">
...
<!--任务分派-->
<c:url var="urlShowInputSplit" value="mofficedata.do">
    <c:param name="method" value="showInputSplit"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
    <c:param name="taskName" value="${taskName}"/>
    <c:param name="subtaskName" value="MofficeDataSubTask"/>
    <c:param name="operateRoleId" value="${operateRoleId}"/>
    <c:param name="TKID" value="${TKID}"/>
...
<!-- 处理回复通过 -->
<c:url var="urlShowDealReplyAcceptPage" value="mofficedata.do">
...
<!-- 处理回复不通过 -->
<c:url var="urlShowDealReplyRejectPage" value="mofficedata.do">
...
<!-- 驳回上一级 -->
<c:url var="urlShowRejectBackPage" value="mofficedata.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 确认受理 -->
<c:url var="urlShowAcceptDealPage" value="mofficedata.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 被驳回 -->
<c:url var="urlBackDealPage" value="mofficedata.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 草稿 -->
<c:url var="urlShowDraftPage" value="mofficedata.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 分派回复 -->
<c:url var="urlShowDispatchPage" value="mofficedata.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 会审 -->
<c:url var="urlShowInputSplitAudit" value="mofficedata.do">
    <c:param name="method" value="showInputSplit"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 会审回复 -->
<c:url var="urlShowDispatchAuditPage" value="mofficedata.do">
    <c:param name="method" value="showDealPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<!-- 转审 -->
<c:url var="urlShowTransferAuditPage" value="mofficedata.do">
    <c:param name="method" value="showTransferWorkItemPage"/>
    <c:param name="sheetKey" value="${sheetMain.id}"/>
    <c:param name="piid" value="${sheetMain.piid}"/>
    <c:param name="taskId" value="${taskId}"/>
...
<script type="text/javascript">
    Ext.onReady(function () {
        ...
        if (dealTemplateId != null && dealTemplateId != "") {
            url = "mofficedata.do?method=referenceTemplate&sheetKey=${sheetMain.id}&piid=${sheetMain.piid}&taskId=${taskId}&taskName=${taskName}&operateRoleId=${operateRoleId}&TKID=${TKID}&preLinkId=${preLinkId}&operateType=${operateType}&taskStatus=${taskStatus}&dealTemplateId=" + dealTemplateId
        }
...
<div class="sheet-deal">
    <div class='sheet-deal-header'><!-- 下面是各个处理环节的下拉框功能 -->
        <table>
            <tr>
                <td width="50%">
                    <%
				...
				<option value="${urlShowRejectBackPage}"><bean:message bundle="sheet" key="common.rejectBack" /></option> -->
                        ...
                        <!-- 流程步骤，移交，阶段回复，分派 -->
                        <option value="${urlShowAuditDataTaskPage}">审批通过</option>
                        <option value="${urlShowAuditDataTaskPage2}">审批不通过</option>
                        ...
                        <!-- 不需要等待回复 -->
                        <%if (ifwaitfor.equals("false")) {%>
                        <option value="${urlShowDispatchPage}"><bean:message bundle="mofficedata"
				...
				<option value="${urlShowRejectBackPage}"><bean:message bundle="sheet" key="common.rejectBack" /></option> -->
                        ...
                        <c:if test="${sheetMain.mainSendModeType==0 }">
                            <option value="${urlShowOfficeMadeTaskPage}">制作完成</option>
                        </c:if>
                        <c:if test="${sheetMain.mainSendModeType==1 }">
                            <option value="${urlShowOfficeMadeTaskPage2}">提交核查</option>
                        </c:if>
                    ...
                    <select id="dealSelector">
                        ...
                        <c:if test="${sheetMain.mainSendModeType==0 }">
                            <option value="${urlShowDataCheckTaskPage}">质检通过</option>
                            <option value="${urlShowDataCheckTaskPage2}">质检不通过</option>
                        </c:if>
                        <c:if test="${sheetMain.mainSendModeType==1 }">
                            <option value="${urlShowDataCheckTaskPage}">通过</option>
                            <option value="${urlShowDataCheckTaskPage3}">不通过</option>
                        </c:if>
                        <option value="${urlShowTransferkPage}"><bean:message bundle="sheet"
                                                                              key="common.transfer"/></option>
                        <option value="${urlShowPhaseReplyPage}"><bean:message bundle="sheet"
				...
				<option value="${urlShowRejectBackPage}"><bean:message bundle="sheet" key="common.rejectBack" /></option> -->
                        ...
                        <%if (ifwaitfor.equals("false")) {%>
                        <!-- 流程步骤，移交，阶段回复，分派 -->
                        <option value="${urlShowConfirmDataTaskPage}">验证通过</option>
                        <option value="${urlShowConfirmDataTaskPage2}">验证不通过</option>
                        <option value="${urlShowTransferkPage}"><bean:message bundle="sheet"
                                                                              key="common.transfer"/></option>
                        <option value="${urlShowPhaseReplyPage}"><bean:message bundle="sheet"
                                                                               key="event.reply"/></option>
                    ...
                    <% }
                        if (taskName.equals("DataInsTask")) {%>
                    <select id="dealSelector">
                        <%if (taskStatus.equals(Constants.TASK_STATUS_READY)) {%>
                        <!-- 确认受理 -->
                        <option value="${urlShowAcceptDealPage}"><bean:message bundle="sheet"
				...
				<option value="${urlShowRejectBackPage}"><bean:message bundle="sheet" key="common.rejectBack" /></option> -->
                        ...
                        <%if (ifwaitfor.equals("false")) {%>
                        <!-- 流程步骤，移交，阶段回复，分派 -->
                        <option value="${urlShowDataInsTaskPage}">检查通过</option>
                        <option value="${urlShowDataInsTaskPage2}">核查不通过</option>
                        <option value="${urlShowTransferkPage}"><bean:message bundle="sheet"
                                                                              key="common.transfer"/></option>
                        <option value="${urlShowPhaseReplyPage}"><bean:message bundle="sheet"
                                                                               key="event.reply"/></option>
                    ...
                    <select id="dealSelector">
                        <option value="${urlShowHoldTaskPage}"><bean:message bundle="mofficedata"
                    ...
                    <select id="dealSelector">
                        <option value="${urlShowDraftPage}"><bean:message bundle="mofficedata"
