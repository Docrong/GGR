...
<%@ include file="/WEB-INF/pages/wfworksheet/itrequirement/baseinputlinkhtmlnew.jsp"%>
     ...
     <tr>
      ...
      <logic:iterate id="toTask" name="toOperaterList" type="com.boco.eoms.sheet.itrequirement.model.ITRequirementTask">  
        <tr>
          <td>
	       ...
	       <td class="label">
			...
			<td colspan="3"> 
		           <textarea name="${sheetPageName}remark" class="textarea max" id="${sheetPageName}remark" 
		              alt="allowBlank:false,maxLength:255,vtext:'请填入操作描述，最多输入125字'">${sheetlink.remark}</textarea>
		  </td>
		</tr>
		</table>
