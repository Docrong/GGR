...
<html:form action="ordersheets.do?method=xsave" method="post" styleId="detail">
    ...
    <fieldset>
        ...
        <table class="formTable">
            ...
            <tr>
                ...
                <td class="content"><eoms:id2nameDB id="${ordersheetForm.customLevel}"
                                                    beanId="ItawSystemDictTypeDao"/></td>
    ...
    <fieldset>
        ...
        <table class="formTable">
            <tr>
                ...
                <td class="content"><eoms:id2nameDB id="${ordersheetForm.productKind}"
                                                    beanId="ItawSystemDictTypeDao"/></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="content"><eoms:id2nameDB id="${ordersheetForm.isNonLocal}"
                                                    beanId="ItawSystemDictTypeDao"/></td>
    ...
    <fieldset>
        ...
        <iframe id="frame"
                src="${app}/businessupport/order/ordersheets.do?method=getRelationSheetById&id=${ordersheetForm.id}&specialtyType=${ordersheetForm.specialtyType}"
                width="100%" height="300px"></iframe>
    </fieldset>
    <table>
        <tr>
