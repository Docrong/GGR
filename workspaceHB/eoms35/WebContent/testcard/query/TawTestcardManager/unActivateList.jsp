    ...
    <logic:iterate id="tawTestcard" name="tawTestcard" type="com.boco.eoms.testcard.model.TawTestcard">
        ...
        <tr bgcolor="#FFFFFF">
            ...
            <logic:notEmpty name="tawTestcard" property="iccid">
                ...
                <td nowrap align="center"><html:link href="../TawTestcard/view.do" paramId="iccid"
                                                     paramName="tawTestcard"
                                                     paramProperty="iccid"> ${eoms:a2u("查看")}</html:link></td>
                <td nowrap align="center" height="30"><html:link href="../TawTestcardManager/toactivate.do"
                                                                 paramId="iccid" paramName="tawTestcard"
                                                                 paramProperty="iccid"> ${eoms:a2u("激活")}</html:link></td>
            </logic:notEmpty>
            <logic:empty name="tawTestcard" property="iccid">
                <td nowrap align="center"><html:link href="../TawTestcard/view.do" paramId="phoneNumber"
                                                     paramName="tawTestcard"
                                                     paramProperty="phoneNumber"> ${eoms:a2u("查看")}</html:link></td>
                <td nowrap align="center" height="30"><html:link href="../TawTestcardManager/toactivate.do"
                                                                 paramId="phoneNumber" paramName="tawTestcard"
                                                                 paramProperty="phoneNumber"> ${eoms:a2u("激活")}</html:link></td>
            </logic:empty>
