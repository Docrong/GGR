...
<div id="history" class="panel">
    ...
    <logic:present name="HISTORY" scope="request">
        ...
        <logic:iterate id="baselink" name="HISTORY"
                       type="com.boco.eoms.sheet.equipmentinstallation.model.EquipmentInstallationLink">
            <%
                jNum += 1;
            ...
            <div class="history-item">&nbsp;
                ...
                <div class="history-item-title">
                    ...
                    <eoms:dict key="dict-sheet-equipmentinstallation" dictId="activeTemplateId"
                    ...
                    <eoms:dict key="dict-sheet-equipmentinstallation" dictId="mainOperateType"
                    ...
                    <table class="formTable" width="100%" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td class="label">
                                ...
                                <bean:message bundle="equipmentinstallation"
                                              key="equipmentInstallationLink.linkEquipmentType"/>
                            </td>
                            <td class="content">
                            ...
                            <td class="label">
                                <!-- 设备编号 -->
                                <bean:message bundle="equipmentinstallation"
                                              key="equipmentInstallationLink.linkEquipmentNum"/>
                            </td>
                            <td class="content">
                        ...
                        <tr>
                            ...
                            <td class="label">
                                <!-- 安装时间 -->
                                <bean:message bundle="equipmentinstallation"
                                              key="equipmentInstallationLink.linkEquipmentTime"/>
                            </td>
                            <td class="content">

                                <pre><bean:write name="baselink" property="linkEquipmentTime"
                                                 format="yyyy-MM-dd HH:mm:ss" scope="page"/></pre>
                            </td>
                            ...
                            <td class="label">
                                <!-- MINI设备安装合作协议 -->
                                <bean:message bundle="equipmentinstallation"
                                              key="equipmentInstallationLink.linkEquipmentAgree"/>
                            </td>
                            <td class="content">
                        ...
                        <tr>
                            ...
                            <td class="label">
                                <!-- 用户回执单 -->
                                <bean:message bundle="equipmentinstallation"
                                              key="equipmentInstallationLink.linkUserReceipt"/>
                            </td>
                            <td class="content">
                                <%
                            ...
                            <td class="label">
                                <!-- MINI设备运行信息表 -->
                                <bean:message bundle="equipmentinstallation"
                                              key="equipmentInstallationLink.linkInformation"/>
                            </td>
                            <td class="content">
                                <%
                        ...
                        <tr>
                            ...
                            <td class="label">
                                <!-- 现场施工照片 -->
                                <bean:message bundle="equipmentinstallation"
                                              key="equipmentInstallationLink.linkScenePhoto"/>
                            </td>
                            <td class="content">
                                <%
                            ...
                            <td class="label">
                                <!-- 收费照片 -->
                                <bean:message bundle="equipmentinstallation"
                                              key="equipmentInstallationLink.linkChargePhoto"/>
                            </td>
                            <td class="content">
                                <%
