    ...
    <table width="100%">
        ...
        <tr>
            ...
            <td colspan="3">
                ...
                <eoms:comboBox name="mainNetSort1ChoiceExpression" id="mainNetSort1" sub="mainNetSort2"
                               initDicId="1010104"/>
                <input type="hidden" name="main.mainNetSort2"/>
                <eoms:comboBox name="mainNetSort2Expression" id="mainNetSort2" sub="mainNetSort3"/>
