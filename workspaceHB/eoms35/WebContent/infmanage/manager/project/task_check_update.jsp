    ...
    <center>
        ...
        <table border="0" width="95%" cellspacing="0">
            ...
            <tr>
                <td width="106%" class="table_title" align="center">
                    <center><%=project_name%>----审核<%=task_name%>子任务信息</center>
                </td>
            </tr>
        </table>
        <table border="0" width="95%" cellspacing="1" cellpadding="1" class="table_show" align=center>
            ...
            <tr class="tr_show">
                ...
                <%if (rest == 0) {%>
                <td width="70%" height="25">
                    <html:text property="task_scale" size="2" styleClass="clstext"/>%
                </td>
            ...
            <tr class="tr_show">
                ...
                <td width="75%" height="25">
                    <html:textarea property="task_check_content" rows="4" style="width:100%" name="projectForm"
                                   title="问题描述"/>
                </td>
            </tr>
            <tr class="tr_show">
