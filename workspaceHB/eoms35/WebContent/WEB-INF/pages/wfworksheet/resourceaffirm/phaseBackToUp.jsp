...
<%
 ...
 %>
    ...
    <input type="hidden" name="${sheetPageName}linkClassName" value="com.boco.eoms.sheet.resourceaffirm.model.ResourceAffirmLink"/> <!--link\u8868Model\u5bf9\u8c61\u7c7b\u540d--> 
 	<input type="hidden" name="${sheetPageName}processTemplateName" id="${sheetPageName}processTemplateName" value="ResourceAffirmMainFlowProcess" />
...
<%@ include file="/WEB-INF/pages/wfworksheet/resourceaffirm/baseinputlinkhtml.jsp"%>
     ...
     <tr>
      ...
      <logic:iterate id="toTask" name="toOperaterList" type="com.boco.eoms.sheet.resourceaffirm.task.impl.ResourceAffirmTaskImpl">  
        <tr>
          <td>
