...
<div id="sheetform">
    <html:form action="/businessimplementyy.do?method=performTransferWorkItem" styleId="theform">
        ...
        <input type="hidden" name="${sheetPageName}beanId" id="${sheetPageName}beanId"
               value="iBusinessImplementYYMainManager"/>
        ...
        <div class="form-btns">
            ...
            <input type="submit" class="submit"
                   onclick="v.passing=true;this.form.action='${app}/sheet/businessimplementyy/businessimplementyy.do?method=performSaveInfo'"
