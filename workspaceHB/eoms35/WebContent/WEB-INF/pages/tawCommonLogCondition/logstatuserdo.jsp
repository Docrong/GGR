...
<script type="text/javascript">
    var Tabs = {
        init: function () {
            ...
            tabs.addTab('form', '${eoms:a2u('用户登陆统计')}');
    ...
    <div id="form" class="tab-content">
        <table cellpadding="0" class="table logList" cellspacing="0">
            <tr>
                ...
                <td width='30%' align='center' bgcolor='#66CCFF'><p>${eoms:a2u('登录用户')}</p></td>
                <td width="20%" align='center' bgcolor='#66CCFF'><p>${eoms:a2u('用户登录次数')}</p></td>
            ...
            <tr class="sortable">
                ...
                <td width='30%' align='center'><%=obj[0]%>
                </td>
                <td width="20%" align='center'><%=obj[1]%></a></td>
                <td width="20%" align='center'><%=obj[2]%>
                </td>
