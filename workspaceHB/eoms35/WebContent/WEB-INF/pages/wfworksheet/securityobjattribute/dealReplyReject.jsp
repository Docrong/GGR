...
<div id="sheetform">
    <html:form action="/securityobjattribute.do?method=performDealReplyReject" styleId="theform">
        <%
        ...
        <input type="hidden" name="subtaskName" value="SecurityObjAttributeSubTask"/>
        ...
        <input type="hidden" name="taskNamespace" value="http://SecurityObjAttribute"/>
