 ...
 *  
 */
public class ID2DescriptionXMLHelper implements IDictTagStrategyHelper {
    ...
    public int doEndTag(IDictTagHelper dictTag, PageContext pageContext)
        ...
        try {
            //输出description
            out.print(service.itemId2description(Util.constituteDictId(dictTag
