package com.work.ggr.hoo;

import java.io.Serializable;

public class SuperviseTaskRecord implements Serializable {


    /**
     *
     */
    private static final long serialVersionUID = -2022807247831748421L;
    private String id;
    ...
    private String supervisetaskRule;//督办规则 .rule表id
    private String createTime;//本记录新建时间
    private String content;//督办内容
    private String reason;//督办原因
    private String superviseType;//督办方式

    private String createuser;//督办当前处理人
    private String createcontact;//督办当前处理人联系方式

    private String sendtime1;//一级督办发送时间
    private String sendtime2;//二级督办发送时间
    private String sendtime3;//三级督办发送时间
    private String sendtime4;//四级督办发送时间
    private String sendtime5;//督办当前处理人短信发送时间
