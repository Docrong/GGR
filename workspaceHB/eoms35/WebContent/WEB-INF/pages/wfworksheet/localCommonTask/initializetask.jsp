...
<html:form action="/localCommonTask.do?method=newTaskPerformAdd" styleId="theform" target="myname">
<%@ include file="/WEB-INF/pages/wfworksheet/localCommonTask/baseinputlinkhtmlnew.jsp"%>
   ...
   <table class="formTable">
				<tr>
				  <td class="label"><bean:message bundle="localCommonTask" key="localCommonTask.linkUrgency"/>*</td>
				 ...
				 <tr>
	              <td  class="label"><bean:message bundle="localCommonTask" key="localCommonTask.linkReqCompleteTime"/>*</td>				 
				  <td class="content">
	              ...
	              <td  class="label"><bean:message bundle="localCommonTask" key="localCommonTask.linkAcceptDept"/>*</td>
				  <td class="content">
			  ...
			  <tr>
			  	<td class="label"><bean:message bundle="localCommonTask" key="localCommonTask.linkSendSheetDesc"/>*</td>
			    <td colspan="3">
