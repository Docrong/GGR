...
<table>
 <tr>
	...
	<display:column property="sheetid" sortable="true"
			headerClass="sortable" title="工单号" href="${app}/commonfaulthj/commonfaulthjs.do?method=edit" paramId="id" paramProperty="id"/>

	<display:column property="creater" sortable="true"
			headerClass="sortable" title="创建人" href="${app}/commonfaulthj/commonfaulthjs.do?method=edit" paramId="id" paramProperty="id"/>
	...
	<display:column property="sendyear" sortable="true"
			headerClass="sortable" title="派单年份" href="${app}/commonfaulthj/commonfaulthjs.do?method=edit" paramId="id" paramProperty="id"/>

	<display:column property="sendmonth" sortable="true"
			headerClass="sortable" title="派单月份" href="${app}/commonfaulthj/commonfaulthjs.do?method=edit" paramId="id" paramProperty="id"/>

	<display:column property="sendday" sortable="true"
			headerClass="sortable" title="派单日" href="${app}/commonfaulthj/commonfaulthjs.do?method=edit" paramId="id" paramProperty="id"/>
	...
	<display:column property="remark" sortable="true"
			headerClass="sortable" title="核减理由" href="${app}/commonfaulthj/commonfaulthjs.do?method=edit" paramId="id" paramProperty="id"/>
