...
------------------------------VIEW----------------------------------------
select *
from v_netdata select distinct *
from v_netdata
...
--bussines main
    , MAINISSECURITY, MAINISCONNECT, MAINFACTORY, MAINCELLINFO, MAINCHANGESOURCE, MAINPARENTSHEETID, MAINISNEEDDESIGN,
                                 MAINDESIGNID, MAINNETTYPETHREE, MAINNETTYPETWO, MAINNETTYPEONE, MAINREJECTTIMES,
                                 SENDYEAR, SENDMONTH, SENDDAY, MAINIFRECORD, MAINEXECUTEENDDATE
--bussines link
    , LINKCOMPLETELIMITTIME, LINKINVOLVEDPROVINCE, LINKINVOLVEDCITY, LINKDESIGNKEY, LINKISCHECK, LINKPERMITRESULT,
                                 ...
                                 LINKISNEEDPROJECT, OPERATERCONTACT, OPERATEYEAR, OPERATEMONTH, OPERATEDAY,
                                 LINKFAILEDREASON
    ) as
    (
--已处理
...
values (44, to_date('2007-07-07 00:00:00', 'YYYY-MM-DD HH24:MI:SS'), '
