...
from circuitdispatch_main t
where t.mainisrecord=0 is null
select *
from est_circuitdispatch select *
from circuitdispatch_link

select *
from circuitdispatch_task select *
from v_circuitdispatch
--��ӵ�·������ֶ� main
alter table circuitdispatch_main
    add mainExecuteEndDate varchar2(50);
alter table circuitdispatch_main
    add mainisrecord NUMBER(10) default 0;
-- link  ��
alter table circuitdispatch_link
    add linkrejectreason varchar2(500);
--main
...
------------------------------VIEW----------------------------------------
select *
from v_circuitdispatch select distinct *
from v_circuitdispatch
...
values (42, to_date('2007-07-07 00:00:00', 'YYYY-MM-DD HH24:MI:SS'), '��·��ȹ������ɼ�����һ�β����ʱ��');
...
insert into est_last_oper(id, comments)
values (42, '��·��ȹ������ɼ�����һ�β����ʱ��')

insert into est_last_oper
values (42, to_date('2007-7-7 00:00:00', 'YYYY-MM-DD HH24:MI:SS'), '��·��ȹ������ɼ�����һ�β����ʱ��');


SELECT distinct EST_DATA_STATUS
              , OPERATE_BIGROLE_ID
              , SEND_DEPT_LEVEL
              , OPERATE_DEPT_LEVEL
              , MAINID
