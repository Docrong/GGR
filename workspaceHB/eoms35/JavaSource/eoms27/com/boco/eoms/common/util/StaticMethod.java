...
public class StaticMethod {
     ...
     *
     * @param url soap service's address and
     *            port,example:http://localhost:8080/eoms_j2ee/servlet/messagerouter
     * @param msg message body in xml format,it is a string.
     * @return
     */
     ...
     * @param url  soap service's address and
     *             port,example:http://localhost:8080/eoms_j2ee/servlet/messagerouter
     * @param file xml message file's address,it is a physic directory string
     * @return
     */
