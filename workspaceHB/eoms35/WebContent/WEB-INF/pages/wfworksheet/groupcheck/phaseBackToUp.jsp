...
<div id="sheetform">
    <html:form action="/groupcheck.do?method=newPerformNonFlow" styleId="theform">
        ...
        <input type="hidden" name="mainClassName"
               value="com.boco.eoms.sheet.groupcheck.model.GroupCheckMain"/> <!--main\u8868Model\u5bf9\u8c61\u7c7b\u540d-->
        <input type="hidden" name="linkClassName"
               value="com.boco.eoms.sheet.groupcheck.model.GroupCheckLink"/> <!--link\u8868Model\u5bf9\u8c61\u7c7b\u540d-->
                    ...
                    <table class="listTable">
                        <logic:present name="toOperaterList" scope="request">
                            ...
                            <logic:iterate id="toTask" name="toOperaterList"
                                           type="com.boco.eoms.sheet.groupcheck.model.GroupCheckTask">
                                <tr>
                                    <td>
