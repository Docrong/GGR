	...
	<table id="sheet" class="formTable">	
		<c:if test="${status!=1}">
		   ...
		   <tr>
			  ...
			  <td>
			  	<eoms:comboBox name="${sheetPageName}btype1" id="${sheetPageName}btype1" initDicId="1011002" defaultValue="${sheetMain.btype1}" alt="allowBlank:ture"/>
			  	</td>				
				<td class="label"><bean:message bundle="group" key="groupcomplaint.bservType"/></td>
			  <td>
			  	<eoms:comboBox name="${sheetPageName}bservType" id="${sheetPageName}bservType" initDicId="1011001" defaultValue="${sheetMain.bservType}" alt="allowBlank:ture"/>
			  </td>		  
			</tr>
			   <tr>			  
			    <td class="label"><bean:message bundle="group" key="groupcomplaint.bdeptContact"/></td>
			  <td>
			  	<input type="text" class="text" name="${sheetPageName}bdeptContact" id="${sheetPageName}bdeptContact" value="${sheetMain.bdeptContact}" alt="allowBlank:true,maxLength:20,vtext:'${eoms:a2u('业务部门联系人，最多输入20字符')}'"/>
			  </td>			
			  <td class="label"><bean:message bundle="group" key="groupcomplaint.bdeptContactPhone"/></td>
			  <td>
			  <input type="text" class="text" name="${sheetPageName}bdeptContactPhone" id="${sheetPageName}bdeptContactPhone" value="${sheetMain.bdeptContactPhone}" alt="allowBlank:true,maxLength:20,vtext:'${eoms:a2u('业务部门联系人电话，最多输入20字符')}'"/>
			...
			<tr>
			  ...
			  <td colspan="3">
		  		<textarea name="complaintDesc" id="complaintDesc" class="textarea max" alt="allowBlank:true,maxLength:2000,vtext:'${eoms:a2u('投诉内容，最多输入1000汉字')}'">${sheetMain.complaintDesc}</textarea>	
			  </td>			 					  
			</tr>		
		   ...
		   <tr>
			  ...
			  <td>
			    <input type="text" class="text" name="${sheetPageName}customerName" id="${sheetPageName}customerName" value="${sheetMain.customerName}" alt="allowBlank:true,maxLength:20,vtext:'${eoms:a2u('客户姓名，最多输入20字符')}'"/>
			  
			  </td>				
			  <td class="label"><bean:message bundle="group" key="groupcomplaint.customPhone"/></td>
			  <td>
			  <input type="text" class="text" name="${sheetPageName}customPhone" id="${sheetPageName}customPhone" value="${sheetMain.customPhone}" alt="allowBlank:true,maxLength:20,vtext:'${eoms:a2u('客户电话，最多输入20字符')}'"/>
		   ...
		   <tr>
			  ...
			  <td>
			    <input type="text" class="text" name="${sheetPageName}complaintNum" id="${sheetPageName}complaintNum" value="${sheetMain.complaintNum}" alt="allowBlank:true,maxLength:20,vtext:'${eoms:a2u('投诉号码，最多输入20字符')}'"/>
		      </td>				
			  <td class="label"><bean:message bundle="group" key="groupcomplaint.complaintLoca"/></td>
			  <td> 
			      <input type="text" class="text" name="${sheetPageName}complaintLoca" id="${sheetPageName}complaintLoca" value="${sheetMain.complaintLoca}" alt="allowBlank:true,maxLength:20,vtext:'${eoms:a2u('投诉位置，最多输入20字符')}'"/>
			   </td>		  
			</tr>	
		   ...
		   <tr>
			  ...
			  <td>
			  <input type="text" class="text" name="${sheetPageName}enterpriseCode" id="${sheetPageName}enterpriseCode" value="${sheetMain.enterpriseCode}" alt="allowBlank:true,maxLength:20,vtext:'${eoms:a2u('企业代码，最多输入20字符')}'"/>
		      
			  </td>				
			  <td class="label"><bean:message bundle="group" key="groupcomplaint.serverCode"/></td>
			  <td>
			  <input type="text" class="text" name="${sheetPageName}serverCode" id="${sheetPageName}serverCode" value="${sheetMain.serverCode}" alt="allowBlank:true,maxLength:20,vtext:'${eoms:a2u('服务代码，最多输入20字符')}'"/>
			 ...
			 <tr>
			  ...
			  <td>
			   <input type="text" class="text" name="${sheetPageName}apnName" id="${sheetPageName}apnName" value="${sheetMain.apnName}" alt="allowBlank:true,maxLength:20,vtext:'${eoms:a2u('APN名称，最多输入20字符')}'"/>
		      
			  </td>				
			  <td class="label"><bean:message bundle="group" key="groupcomplaint.circuitCode"/></td>
			  <td>
			   <input type="text" class="text" name="${sheetPageName}circuitCode" id="${sheetPageName}circuitCode" value="${sheetMain.circuitCode}" alt="allowBlank:true,maxLength:20,vtext:'${eoms:a2u('传输专线电路代号，最多输入20字符')}'"/>
			...
			<eoms:comboBox name="${sheetPageName}connectType" id="${sheetPageName}connectType" initDicId="1011005" defaultValue="${sheetMain.connectType}" alt="allowBlank:ture"/>
			  ...
			  <td colspan="3">
		  		<textarea name="termType" id="termType" class="textarea max" alt="allowBlank:true,maxLength:2000,vtext:'${eoms:a2u('终端描述，最多输入1000汉字')}'">${sheetMain.termType}</textarea>	
			  </td>			 					  
			</tr>
