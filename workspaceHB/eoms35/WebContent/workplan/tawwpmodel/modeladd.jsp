...
<form name="tawwpmodeladd" method="post" action="../tawwpmodel/modelsave.do" onsubmit='return SubmitCheck()'>
    ...
    <bean:message key="modeladd.title.btnSubmit"/> name="B1" class="submit">
    <input type="button" value=
    <bean:message key="modeladd.title.btnBack"/> onclick="javascript:window.history.back();" class="button">
