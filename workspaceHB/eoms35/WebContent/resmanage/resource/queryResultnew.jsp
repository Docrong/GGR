...
//out.println("SQL is :::   "+strSql);
    ...
    %>
    <td align=center class=ttTable><b><font size=2 color=#000000 face='Verdana, Arial, Helvetica, sans-serif'>²éÑ¯³öµÄÉè±¸ÊýÁ¿Îª<%=rs.getRowCount()%>
    </font></b>
    </td>
    <br><br>
        ...
        <table width=100%>
            <tr>
                ...
                <td height=20 align=right><font size=2 color=#000000
                                                face='Verdana, Arial, Helvetica, sans-serif'>µÚ<%=rs.getCurrentPageIndex()%>
                    Ò³ / ¹²<%=rs.getPageCount()%>Ò³ / ¹²<%=rs.getRowCount()%>Ìõ¼ÇÂ¼ </font></td>
                    <%}%>
