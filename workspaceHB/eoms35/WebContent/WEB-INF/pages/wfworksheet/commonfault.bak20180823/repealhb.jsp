    ...
    <table class="formTable">
        ...
        <tr>
            <td class="label"><bean:message bundle="sheet"
                                            key="linkForm.operateUserName"/>*
            </td>
            <td class="content"><eoms:id2nameDB
                    id="${Userid}" beanId="tawSystemUserDao"/>&nbsp;
            </td>
            <td class="label"><bean:message bundle="sheet"
                                            key="linkForm.operateDeptName"/>*
            </td>
            <td class="content"><eoms:id2nameDB
                    id="${Deptid}" beanId="tawSystemDeptDao"/>&nbsp;
            </td>
        </tr>
        <tr>
            <td class="label"><bean:message bundle="sheet"
                                            key="linkForm.operaterContact"/> *
            </td>
            ...
            <td class="label"><bean:message bundle="sheet"
                                            key="linkForm.operateTime"/>*
            </td>
            <td class="content">${LocalTime}</td>
        </tr>
        <tr>
            <td class="label"><bean:message bundle="sheet"
                                            key="mainForm.cancelReason"/>*
            </td>
