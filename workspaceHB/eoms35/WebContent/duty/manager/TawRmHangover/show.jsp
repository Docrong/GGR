...
<html:form method="post" action="/TawRmHangover/save">
    ...
    <TABLE cellSpacing="1" cellPadding="1" width="450" align="center" border="0">
        <tr>
            <td class="table_title" align="center" colspan="4" width="100%"><bean:message
                    key="TawRmHangover.hangquestion"/></td>
        </tr>
    </table>
    <TABLE cellSpacing="1" cellPadding="1" width="450" align="center" border="0" class="table_show">
        <tr class="tr_show">
            ...
            <td align="center" width="70%">
                <TEXTAREA id=hangQuestion0 name=hangQuestion0 rows=2 cols=45 style="BACKGROUND-COLOR: lightgrey"
                          readOnly=""><bean:write name="tawRmHangoverForm" property="hangQuestion0"
        ...
        <tr class="tr_show">
            ...
            <td align="center">
                <TEXTAREA id=hangQuestion name=hangQuestion rows=2 cols=45><bean:write name="tawRmHangoverForm"
                                                                                       property="hangQuestion"
                                                                                       scope="request"/></TEXTAREA>
            </td>
        </tr>
    </table>
