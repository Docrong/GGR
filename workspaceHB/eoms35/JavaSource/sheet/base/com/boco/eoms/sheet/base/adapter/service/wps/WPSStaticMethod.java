...
public class WPSStaticMethod {
	 ...
	 *            the dataobject
	 * @param map
	 *            the dataobject instance represented by hashmap
	 */
...
//		}
	...
	public static String receiveMessage(String jmsCorrelationId)throws Exception{
		...
		try {
			...
			if ( qconnection != null) {
				try { qconnection.close(); } catch (JMSException e) {}
			}
		}
