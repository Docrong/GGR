...
//				alert(item.text+"ok");
        ...
        function load(divName, divID) {
            ...
            if (targetTR.style.display != "block") {
                ...
                switch (divName) {
                    case "dept" :
                        bufferFrame.document.location = "loadtree_zyjh.jsp?divName=" + divName + "&divID=" + divID + "&user=no&post=no&room=no&selectself=<%=strSelectSelf%>&mydeptid=<%=myDeptId%>&myuserid=<%=myUserId%>";
                        break;

                    case "user" :
                        bufferFrame.document.location = "loadtree_zyjh.jsp?divName=" + divName + "&divID=" + divID + "&post=no&room=no&selectself=<%=strSelectSelf%>&mydeptid=<%=myDeptId%>&myuserid=<%=myUserId%>";
                        break;

                    case "post" :
                        bufferFrame.document.location = "loadtree_zyjh.jsp?divName=" + divName + "&divID=" + divID + "&user=no&room=no&selectself=<%=strSelectSelf%>&mydeptid=<%=myDeptId%>&myuserid=<%=myUserId%>";
                        break;

                    case "room" :
                        bufferFrame.document.location = "loadtree_zyjh.jsp?divName=" + divName + "&divID=" + divID + "&user=no&post=no&selectself=<%=strSelectSelf%>&mydeptid=<%=myDeptId%>&myuserid=<%=myUserId%>";
                        break;
                ...
                <TABLE cellSpacing=0 cellPadding=0 width=100% border=0 align="center">
                    ...
                    <TR>
                        <TD valign="top" width="50%">
                            ...
                            <!-- 人员 开始------------------------>
                            <SPAN class="EOMSListbox" id=userRoot onchange="jscript: fnEOMSListboxOnChange('userRoot');"
...
%>
        <TR class=EOMSListboxItemUnSelected id="usertr_parentid_<%=deptid%>">
		  ...
		  <IMG id="userimg_parentid_<%=deptid%>" name="userimg_parentid_<%=deptid%>" src="images/false.gif"
               onclick="load('user',<%=deptid%>)" style="cursor:hand"></TD>
...
<%}%>
                            ...
                            <!-- 岗位 开始------------------------>
                            <SPAN class="EOMSListbox" id=postRoot onchange="jscript: fnEOMSListboxOnChange('postRoot');"
                                  style="display:none;margin:5px;">
      <TABLE cellSpacing=0 cellPadding=0>
        <TBODY id=rootTbody>
<%
...
%>
        <TR class=EOMSListboxItemUnSelected id="posttr_parentid_<%=deptid%>">
          <TD class=EOMSListboxImage>
		  <IMG id="postimg_parentid_<%=deptid%>" name="postimg_parentid_<%=deptid%>" src="images/false.gif"
               onclick="load('post',<%=deptid%>)" style="cursor:hand"></TD>
          <TD class=EOMSListboxCaption><%=deptname%></TD>
          <TD class=EOMSListboxValue><%=deptid%></TD>
          <TD class=EOMSListboxTag></TD>
		  <TD class=EOMSListboxParent><%=ID%></TD></TR>
...
<%}%>
                            ...
                            <!-- 机房 开始------------------------>
                            <SPAN class="EOMSListbox" id=roomRoot onchange="jscript: fnEOMSListboxOnChange('roomRoot');"
                                  style="display:none;margin:5px;">
      <TABLE cellSpacing=0 cellPadding=0>
        <TBODY id=rootTbody>
<%
...
%>
        <TR class=EOMSListboxItemUnSelected id="roomtr_parentid_<%=deptid%>">
          <TD class=EOMSListboxImage>
		  <IMG id="roomimg_parentid_<%=deptid%>" name="roomimg_parentid_<%=deptid%>" src="images/false.gif"
               onclick="load('room',<%=deptid%>)" style="cursor:hand"></TD>
          <TD class=EOMSListboxCaption><%=deptname%></TD>
          <TD class=EOMSListboxValue><%=deptid%></TD>
          <TD class=EOMSListboxTag></TD>
		  <TD class=EOMSListboxParent><%=ID%></TD></TR>
...
<%}%>
                            ...
                            <!-- 部门 开始------------------------>
                            <SPAN class="EOMSListbox" id=deptRoot onchange="jscript: fnEOMSListboxOnChange('deptRoot');"
                                  style="margin:5px;">
      <TABLE cellSpacing=0 cellPadding=0>
        <TBODY id=rootTbody>
<%
...
%>
        <TR class=EOMSListboxItem id="depttr_parentid_<%=deptid%>">
          <TD class=EOMSListboxImage>
		  <IMG id="deptimg_parentid_<%=deptid%>" name="deptimg_parentid_<%=deptid%>" src="images/false.gif"
               onclick="load('dept',<%=deptid%>)" style="cursor:hand"></TD>
          <TD class=EOMSListboxCaption><%=deptname%></TD>
          <TD class=EOMSListboxValue><%=deptid%></TD>
          <TD class=EOMSListboxTag></TD>
		  <TD class=EOMSListboxParent><%=ID%></TD></TR>
...
<% } %>
	...
	<SPAN>
        ...
        <tr>
            <td bgcolor="#E2F1FC">
                &nbsp;显示岗位:<%
                if (strPostoff.equals("no")) out.print("否");
                else {
                    out.print("是");
                }
            %>&nbsp;|
