...
<table class="formTable">
    ...
    <tr>
        ...
        <td class="content" colspan="3">
            <eoms:comboBox name="linkIfPass" id="linkIfPass" initDicId="1010401" defaultValue="${sheetLink.linkIfPass}"
                           alt="allowBlank:false" onchange="ifAuditPass(this.value);"/>
        </td>
    </tr>
    <tr>
        <td class="label"><bean:message bundle="numberapply" key="numberApplyLink.linkPermitsuggest"/>*</td>
        <td class="content" colspan="3">
            <textarea class="textarea max" name="linkPermitsuggest" id="linkPermitsuggest"
                      alt="allowBlank:false,maxLength:255,vtext:'请填入 审核意见 信息，最多输入 255 字符'">${sheetLink.linkPermitsuggest}</textarea>
        </td>
    </tr>
    <%}%>
    <%
...
<fieldset>
    ...
    <div class="x-form-item">
        <eoms:chooser id="sendRole" type="dept" flowId="93"
                      data="[{id:'huangfen',nodeType:'user',categoryId:'dealPerformer'}]"
