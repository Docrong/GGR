...
<div id="sheetform">
<html:form action="/circuitdispatch.do?method=newPerformNonFlow" styleId="theform">
 ...
 %>
          ...
          <input type="hidden" name="${sheetPageName}mainClassName" value="com.boco.eoms.sheet.circuitdispatch.model.CircuitDispatchMain"/>	<!--mainè¡¨Modelå¯¹è±¡ç±»å-->	
          <input type="hidden" name="${sheetPageName}linkClassName" value="com.boco.eoms.sheet.circuitdispatch.model.CircuitDispatchLink"/> <!--linkè¡¨Modelå¯¹è±¡ç±»å-->
           <input type="hidden" name="${sheetPageName}processTemplateName" value="CircuitDispatchMainProcess" />
  ...
  <div ID="idSpecial"></div>
                <%--   <tr>
	  				  ...
	  				  <td colspan=3>
	  				   	 <bean:write name="sheetLink" property="remark" scope="request"/>
	                  </td>
		  		</tr>	     --%>  
       </table>  
   <div class="form-btns">
