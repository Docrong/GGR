...
<%         
       ...
       %>
			...
			<input type="hidden" name="id" value="${ordersheet.id}"/>
    ...
    <display:column  sortable="true" headerClass="orderType" title="定单类型" url="/businessupport/order/ordersheets.do?method=showDetail&flag=showDetail&ifReference=${ifReference}" paramId="id" paramProperty="id">   
