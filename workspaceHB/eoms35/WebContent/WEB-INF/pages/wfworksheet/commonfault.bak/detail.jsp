...
<div id="sheet-detail-page">
    ...
    <div id="sheetinfo">
        <logic:present name="sheetMain" scope="request">
            ...
            <c:if test="${sheetMain.mainIsPack == '1030102'}">
                <table class="formTable">
                    <caption></caption>
                    <tr>
                        <td class="label"><bean:message bundle="commonfault" key="commonfault.mainAlarmId"/></td>
                        <td class="content"><bean:write name="sheetMain" property="mainAlarmId" scope="request"/>2222
                        </td>
                ...
                <c:if test="${sheetMain.mainIsPack == '1030101'}">
                    <tr>
                        <td class="label" colspan="4" width="120">
                            <iframe height="400"
                                    width="100%"
                                    src="../commonfault/commonfaultpack.do?method=showOwnStarterList&mainId=${sheetMain.id}&alarmMethod=<%=alarmMethod%>&taskName=<%=taskName%>"></iframe>
                        </td>
                    </tr>
                </c:if>
                <tr>
