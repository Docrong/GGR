...
<display:table name="tawSystemSubRoleList" cellspacing="0" cellpadding="0"
               ...
               export="true" requestURI="/role/tawSystemSubRoles.do" sort="external" partialList="true"
               size="resultSize">

    <display:column property="subRoleName" sortable="true" headerClass="sortable" url="/role/editTawSystemSubRole.do"
