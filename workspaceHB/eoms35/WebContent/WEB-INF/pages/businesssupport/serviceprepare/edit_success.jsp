...
<%} else { %>
<script type="text/javascript">
    function intoProductSpecification() {
        var undo = document.location.href;
        undo = undo.substring(0, undo.indexOf("?") + 1) + "method=showProductSpecificationList";
        location.href = undo;
    }

    <% if(faultReturn.equals("")&&succesReturn.equals("")){ %>
    window.setTimeout(intoProductSpecification, 3000);
    <%}%>
</script>
<%} %>
<style type="text/css">
...
<div class="successPage">
    ...
    <div class="content">
        <ul>
            <li><html:link href="#" onclick="intoProductSpecification();">返回产品规格列表</html:link></li>
        </ul>
    </div>
    <%} %>
</div>
