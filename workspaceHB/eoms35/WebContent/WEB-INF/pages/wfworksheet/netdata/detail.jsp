        ...
        <logic:present name="sheetMain" scope="request">
            ...
            <table class="formTable">
                ...
                <tr>
                    ...
                    <td class="content" colspan="3"><eoms:id2nameDB id="${sheetMain.mainNetTypeThree}"
                                                                    beanId="ItawSystemDictTypeDao"/></td>
                </tr>
                <tr>
            ...
            <tr>
                <td width="50%">
                    ...
                    <select id="dealSelector">
                        ...
                        <!-- 流程步骤，移交，阶段回复，分派 -->
                        <option value="${urlShowProjectCreateTaskPage}"><bean:message bundle="netdata"
                        ...
                        <!-- 不需要等待回复 -->
                        <% if (ifwaitfor.equals("false")) {%>
                        <option value="${urlShowDispatchPage}"><bean:message bundle="netdata"
                    ...
                    <select id="dealSelector">
                        ...
                        <% if (ifwaitfor.equals("false")) {%>
                        <!-- 流程步骤，移交，阶段回复，分派 -->
                        <option value="${urlShowAuditTaskPage}"><bean:message bundle="netdata"
                    ...
                    <select id="dealSelector">
                        ...
                        <!-- 不需要等待回复 -->
                        <% if (ifwaitfor.equals("false")) {%>
                        <option value="${urlShowPermitTaskPage}"><bean:message bundle="netdata"
                    ...
                    <select id="dealSelector">
                        ...
                        <!-- 不需要等待回复 -->
                        <% if (ifwaitfor.equals("false")) {%>
                        <option value="${urlShowPlanTaskPage}"><bean:message bundle="netdata"
                    ...
                    <select id="dealSelector">
                        ...
                        <%if (ifsub.equals("") || ifsub.equals("false")) { %>
                        <% if (ifwaitfor.equals("false")) {%>
                        <option value="${urlShowExecuteTaskPage}"><bean:message bundle="netdata"
                    ...
                    <select id="dealSelector">
                        ...
                        <%if (ifsub.equals("") || ifsub.equals("false")) { %>
                        <% if (ifwaitfor.equals("false")) {%>
                        <option value="${urlShowCheckTaskPage}"><bean:message bundle="netdata"
                                                                              key="operateType.checkDataTask"/></option>
                        <option value="${urlShowTransferkPage}"><bean:message bundle="sheet"
                                                                              key="common.transfer"/></option>
                        <option value="${urlShowPhaseReplyPage}"><bean:message bundle="sheet"
                                                                               key="event.reply"/></option>
                    ...
                    <select id="dealSelector">
                        ...
                        <%if (ifsub.equals("") || ifsub.equals("false")) { %>
                        <% if (ifwaitfor.equals("false")) {%>
                        <option value="${urlShowTestTaskPage}"><bean:message bundle="netdata"
                                                                             key="operateType.testOperationTask"/></option>
                        <option value="${urlShowTransferkPage}"><bean:message bundle="sheet"
                                                                              key="common.transfer"/></option>
                        <option value="${urlShowPhaseReplyPage}"><bean:message bundle="sheet"
                                                                               key="event.reply"/></option>
                    ...
                    <select id="dealSelector">
                        ...
                        <%if (ifsub.equals("") || ifsub.equals("false")) { %>
                        <% if (ifwaitfor.equals("false")) {%>
                        <option value="${urlShowValidateTaskPage}"><bean:message bundle="netdata"
                    ...
                    %>
                    <select id="dealSelector">
                        <option value="${urlShowHoldTaskPage}"><bean:message bundle="netdata"
                    ...
                    <select id="dealSelector">
                        <option value="${urlShowDraftPage}"><bean:message bundle="netdata"
