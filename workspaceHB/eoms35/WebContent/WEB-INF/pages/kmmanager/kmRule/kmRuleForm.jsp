    ...
    <fmt:bundle basename="com/boco/eoms/km/config/applicationResource-kmmanager">
        ...
        <table class="formTable">
            ...
            <tr>
                ...
                <td class="content" colspan="3">
                    <table>
                        <tr>
                            ...
                            <td rowspan="2">
                                <table width="100%">
                                    <tr>
                                        <td>
                                            <input type="button" class="btn" styleId="btnb2" value="并且"
                                                   onclick="appendExpr('and','1');"/>
                                            <input type="button" class="btn" styleId="btnb3" value="或者"
                                                   onclick="appendExpr('or','1');"/>
                                            <input type="button" class="btn" styleId="btnb3" value="("
                                                   onclick="appendExpr('(','1');"/>
                                            <input type="button" class="btn" styleId="btnb3" value=")"
                                                   onclick="appendExpr(')','1');"/>
                                            <input type="button" class="btn" styleId="btnb1" value="等于"
                                                   onclick="appendExpr('=','1');"/>
                                            <input type="button" class="btn" styleId="btnb3" value="大于"
                                                   onclick="appendExpr('>','1');"/>
                                            <input type="button" class="btn" styleId="btnb3" value="小于"
                                                   onclick="appendExpr('<','1');"/>
                                            <input type="button" class="btn" styleId="btnb4" value="不等于"
                                                   onclick="appendExpr('!=','1');"/>
                                            <input type="button" class="btn" styleId="btnb5" value="不小于"
                                                   onclick="appendExpr('>=','1');"/>
                                            <input type="button" class="btn" styleId="btnb6" value="不大于"
                                                   onclick="appendExpr('<=','1');"/>
                                            <input type="button" class="btn" styleId="btnb6" value="参数"
                                                   onclick="appendExpr('?','1');"/>
                                            <input type="button" class="btn" styleId="btnb6" value="like"
                                                   onclick="appendExpr('like','1');"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <textarea name="ruleEditArea" id="ruleEditArea" class="textarea max"
                                                      alt="allowBlank:false'" cols="70" rows="24"
                                                      attributesText="id='ruleEditArea'">${kmRuleForm.ruleScript}</textarea>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <input type="button" id="btnsave" value="清除" class="btn"
                                                   onclick='resetEdit()'>
                                            <input type="button" id="btnsave" value="获取参数" class="btn"
                                                   onclick='getPara()'>
                                            <input type="button" id="btnsave" value="测试脚本" class="btn"
                                                   onclick='hidden_submit_param()'>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <tr>
                            <td width="15%">
                                <html:select property="ruleScriptX" styleId="ruleScript" size="11"
                                             onclick="append(this)">
            ...
            <tr>
                ...
                <td class="content" colspan="3">
                    <textarea name="ruleParameter" id="ruleParameter" class="textarea max"
                              alt="allowBlank:false'">${kmRuleForm.ruleParameter}</textarea>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="content" colspan="3">
                    ...
                    <textarea name="remark" id="remark" class="textarea max"
                              alt="allowBlank:false'">${kmRuleForm.remark}</textarea>
                </td>
            </tr>
