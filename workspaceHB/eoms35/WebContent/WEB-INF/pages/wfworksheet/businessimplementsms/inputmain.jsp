        ...
        <tr>
            ...
            <td class="content">
                ...
                <eoms:comboBox name="${sheetPageName}customLevel" id="${sheetPageName}customLevel" initDicId="10405"
                               ...
                               defaultValue="${orderSheet.mainArgument}"/>
            </td>
        </tr>
        <tr>
    ...
    <fieldset>
        <table class="formTable">
            ...
            <tr>
                ...
                <td><eoms:comboBox name="${sheetPageName}mainArgument" id="${sheetPageName}mainArgument"
                                   initDicId="1012108" styleClass="select-class" alt="allowBlank:false"
            ...
            <tr>
                ...
                <td class="content" colspan=3>
                    <input type="text" class="text" name="${sheetPageName}mainCompleteLimitTime" readonly="readonly"
                           id="${sheetPageName}mainCompleteLimitTime"
                           value="${eoms:date2String(sheetMain.mainCompleteLimitTime)}"
                           onclick="popUpCalendar(this, this)" alt="allowBlank:false"/>
                </td>
