    ...
    <div id="content" style="text-align:center;position:relative;z-index:0;">
            ...
            <tr>
                <td align="center">
                    <div style="border:1px #98c0f4 solid;width:90%;height:60px;">
                        ...
                        <div style="float:left;margin:5px auto auto 18px;">阅卷人：<b><eoms:id2nameDB
                                id="${kmExamAttend.readUser}" beanId="tawSystemUserDao"/></b>&nbsp;&nbsp;&nbsp;&nbsp;得分：<font
                                color='red'><b>${kmExamAttend.score}</b></font></div>
                    </div>
                </td>
            </tr>
        </table>
        ...
        <div style="width:90%;text-align:right;margin-top:5px;">
            <c:if test="${kmExamAttend.isPublic==0}">
                <input type="button" class="btn" style="font-size:15px;margin-right:20px;" value="发布该试卷成绩"
