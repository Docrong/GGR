...
<table class="formTable">
    ...
    <tr>
       <td class="label">
        <bean:message bundle="nbproducts" key="nbproducts.nbPName"/>*</td>       
     <td class="content">
     ...
     <td class="content">
        <html:errors property="businessDept"/>
         <eoms:comboBox name="businessDept" id="${nbproductsForm.businessDept}" defaultValue="${nbproductsForm.businessDept}" initDicId="1010504" 
	  	      sub="${sheetPageName}mainNetSort3" size="1" alt="allowBlank:false" styleClass="select-class"/>
      </td>
    </tr>   
    <tr>
     <td class="label">
        <bean:message bundle="nbproducts" key="nbproducts.businessSort"/>*</td>
     <td class="content">
        <html:errors property="businessSort"/>
        <eoms:comboBox name="businessSort" id="businessSort" defaultValue="${nbproductsForm.businessSort}" initDicId="1010515" 
     ...
     <td class="content">
        ...
        <eoms:comboBox name="businessSortTwo" id="businessSortTwo" defaultValue="${nbproductsForm.businessSortTwo}" 
	  	    initDicId="${nbproductsForm.businessSort}"  alt="allowBlank:false" styleClass="select-class"/>
     </td>
   </tr>
   ...
   <tr>
     ...
     <td class="content" colspan="3">
	  		<textarea name="nbPdescription" id="nbPdescription" class="textarea max" alt="allowBlank:false">${nbproductsForm.nbPdescription}</textarea>			   
		  </td>
   </tr>
   <tr>
    <td class="label">
 ...
 <br/>
     ...
     <input type="submit"  styleClass="submit" property="method.xsave"
            onclick="return;location.href='<c:url value="/sheet/nBProducts/nbproductss.do?method=xquery&ifReference=${ifReference}"/>'" value="保存"/>
