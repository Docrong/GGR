...
import com.boco.eoms.km.statics.util.PersonalContributeStatisticConstants;
...
public final class PersonalContributeStatisticAction extends BaseAction {
    ...
    public ActionForward search4Atom(ActionMapping mapping, ActionForm form,
        ...
        try {
			...
			PersonalContributeStatisticMgr personalContributeStatisticMgr = (PersonalContributeStatisticMgr) getBean("personalContributeStatisticMgr");
			Map map = (Map) personalContributeStatisticMgr.getPersonalContributeStatistics(pageIndex, pageSize, "");
			List list = (List) map.get("result");
			PersonalContributeStatistic personalContributeStatistic = new PersonalContributeStatistic();
	...
	for (int i = 0; i < list.size(); i++) {
				personalContributeStatistic = (PersonalContributeStatistic) list.get(i);
				...
				entry.setTitle("<a href='" + request.getScheme() + "://"
						...
						+ "/personalContributeStatistic/personalContributeStatistics.do?method=edit&id="
						+ personalContributeStatistic.getId() + "' target='_blank'>"
