        ...
        <meta http-equiv="content-type" content="text/html; charset=utf-8">
          ...
          function init() {
              ...
              if (typeof(reason) != 'undefined' && reason != 'undefined')
                  ...
                  document.getElementById('reason').innerHTML = "Ninguna";
          
              document.title = "Invitar a "+to;
          }
            ...
            <body style="margin:8px;">
                <table width="100%" height="100%">
                    <tr>
                        <td colspan=2
                        >
                        <h2 id="title">Invitación a Sala de charla
                    </h2>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan=2 width="100%" height="100%">
                    <table width="100%" height="100%">
                        <tr>
                            <td>
                                <input type=radio name="invite" value="join" id="join" checked>
                            </td>
                            <td>
                                <label for="join">Entrar</label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <input type=radio name="invite" value="decline" id="decline">
                            </td>
                            <td>
                                <label for="decline">Declinar</label>
                            </td>
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
