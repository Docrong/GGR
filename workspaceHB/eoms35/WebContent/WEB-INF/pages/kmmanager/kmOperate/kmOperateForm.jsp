    ...
    <fmt:bundle basename="com/boco/eoms/km/config/applicationResource-kmmanager">
        ...
        <table class="formTable">
            ...
            <tr>
                ...
                <td class="content">
                    <eoms:dict key="dict-kmmanager" dictId="operateType" selectId="operateType" beanId="selectXML"
                               alt="allowBlank:false,vtext:'请选择权限...'" defaultId="${kmOperateForm.operateType}"/>
                </td>
            </tr>
