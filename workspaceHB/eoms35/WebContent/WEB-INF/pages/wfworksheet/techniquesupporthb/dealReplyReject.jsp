...
<div id="sheetform">
<html:form action="/techniquesupporthb.do?method=performDealReplyReject" styleId="theform">
 <%@ include file="/common/taglibs.jsp"%>
<%
 ...
 %>
    ...
    <input type="hidden" name="${sheetPageName}mainClassName" value="com.boco.eoms.sheet.techniquesupporthb.model.TechniqueSupportHbMain"/>	<!--main表Model对象类名-->	
    <input type="hidden" name="${sheetPageName}linkClassName" value="com.boco.eoms.sheet.techniquesupporthb.model.TechniqueSupportHbLink"/> <!--link表Model对象类名--> 
 	<input type="hidden" name="${sheetPageName}processTemplateName" id="${sheetPageName}processTemplateName" value="TechniqueSupportHbProcess" />
    <input type="hidden" name="${sheetPageName}subtaskName" value="${subtaskName}"/> 
    <input type="hidden" name="${sheetPageName}taskNamespace" value="http://TechniqueSupportHbProcess"/> 
...
<%@ include file="/WEB-INF/pages/wfworksheet/techniquesupporthb/baseinputlinkhtmlnew.jsp"%>
     ...
     <tr>
      ...
      <logic:iterate id="toTask" name="acceptList" type="com.boco.eoms.sheet.techniquesupporthb.model.TechniqueSupportHbTask">  
        <tr>
          <td>
