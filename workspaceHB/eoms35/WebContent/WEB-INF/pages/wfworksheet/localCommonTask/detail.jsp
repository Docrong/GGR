	...
	<div class='sheet-deal-header'>
		...
		<%if(taskName.equals("TaskCreateAuditHumTask")){ %>	
			<select id="dealSelector"> 
			 ...
			 <option value="${urlShowTransmitDealPage}"><bean:message bundle="localCommonTask" key="localCommonTask.taskpass"/> </option>
			 <option value="${urlShowTransmit2DealPage}"><bean:message bundle="localCommonTask" key="localCommonTask.tasknopass"/></option>
...
<!--			    <option value="${urlShowRejectBackPage}"><bean:message bundle="sheet" key="common.rejectBack"/></option>-->
			 ...
			 <%if(ifsub.equals("") || ifsub.equals("false")){ %>
			  ...
			  <option value="${urlShowPassDealPage}"><bean:message bundle="localCommonTask" key="localCommonTask.totaskcompsq"/></option>
		...
		<%}else if(taskName.equals("TaskCompleteAuditHumTask")){%>	
			...
			<%if(taskStatus.equals(Constants.TASK_STATUS_READY)){%>
			    ...
			    <!--<option value="${urlShowRejectBackPage}"><bean:message bundle="sheet" key="common.rejectBack"/></option>-->
			 <%}else if(taskStatus.equals(Constants.TASK_STATUS_CLAIMED)){ %>
			  <option value="${urlShowTaskCompleteAuditYes}"><bean:message bundle="localCommonTask" key="localCommonTask.TaskCompleteAuditYes"/></option>
			  <option value="${urlShowTaskCompleteAuditNo}"><bean:message bundle="localCommonTask" key="localCommonTask.TaskCompleteAuditNo"/></option>
              <!--<option value="${urlShowPhaseReplyPage}"><bean:message bundle="sheet" key="event.reply"/></option>-->
              <option value="${urlShowExamineDealPage}">${eoms:a2u('延期申请')}</option> 			
			<%} %>
			</select>
		<%}else if(taskName.equals("AffirmHumTask")){%>	
			<select id="dealSelector">
			  ...
			  <option value="${urlShowDealReplyNoPassPage}"><bean:message bundle="localCommonTask" key="localCommonTask.nopassback"/></option>
			  <!--<option value="${urlShowPhaseReplyPage}"><bean:message bundle="sheet" key="event.reply"/></option>-->
			</select>
	...
	<%}else if(taskName.equals("DraftTask")){%>	
			<select id="dealSelector">
			  <option value="${urlShowCompleteDraftPage}"><bean:message bundle="localCommonTask" key="operateType.draft"/></option>
			</select>
		...
		<%}else if(taskName.equals("HoldTask")){ %>
			<select id="dealSelector">
			  <option value="${urlShowHoldDealPage}"><bean:message bundle="localCommonTask" key="operateType.hold"/></option>
			    <option value="${urlShowBackDeal}"><bean:message bundle="sheet" key="common.reSend"/></option>
			</select>		
		<%} %>
		</td>
