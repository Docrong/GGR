...
function showPage(){
     var pars = '';
     var url = '';    
      url = '${app}/sheet/safetyproblem/safetyproblem.do?method=showInputRejectPage&piid=${sheetMain.piid}&taskId=${taskId}&taskName=${taskName}';
     if (url!=''){
...
<div id="sheetform">
<html:form action="/safetyproblem.do?method=performDeal" styleId="theform">
