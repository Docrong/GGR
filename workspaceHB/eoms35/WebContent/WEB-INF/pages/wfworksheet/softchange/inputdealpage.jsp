...
<table class="formTable">
    ...
    <input type="hidden" name="${sheetPageName}mainClassName"
           value="com.boco.eoms.sheet.softchange.model.SoftChangeMain"/>
    <input type="hidden" name="${sheetPageName}linkClassName"
           value="com.boco.eoms.sheet.softchange.model.SoftChangeLink"/>
    ...
    <tr>
        ...
        <td colspan="3" class="content">
            <textarea class="textarea max" name="${sheetPageName}linkDesignComment"
                      ...
                      alt="width:500,allowBlank:true,maxLength:2000,vtext:'请填入技术方案说明，最多输入2000字'">${sheetLink.linkDesignComment}</textarea>
        </td>
    </tr>
    <tr>
        <!-- 变更涉及省份 -->
        ...
        <td colspan="3">
            ...
            涉及省份:<textarea class="textarea max" readonly="true" name="linkInvolvedProvince" style="height:50px"
                           ...
                           alt="allowBlank:false,maxLength:2000,vtext:'请填入备注信息，最多输入2000字符'">${sheetLink.linkInvolvedProvince }</textarea><br/>
            涉及地市:<textarea class="textarea max" readonly="true" name="linkInvolvedCity" style="height:50px"
                           id="${sheetPageName}linkInvolvedCity"
                           alt="allowBlank:true,maxLength:2000,vtext:'请填入备注信息，最多输入2000字符'">${sheetLink.linkInvolvedCity}</textarea>
    ...
    <tr>
        ...
        <td colspan="3" class="content">
            <textarea class="textarea max" name="${sheetPageName}linkRiskEstimate" id="${sheetPageName}linkRiskEstimate"
                      alt="width:500,allowBlank:false,maxLength:2000,vtext:'请填入风险评估，最多输入2000字'">${sheetLink.linkRiskEstimate}</textarea>
        </td>
    </tr>
    <tr>
        ...
        <td colspan="3" class="content">
            <textarea class="textarea max" name="${sheetPageName}linkEffectAnalyse"
                      ...
                      alt="width:500,allowBlank:false,maxLength:2000,vtext:'请填入影响业务分析，最多输入2000字'">${sheetLink.linkEffectAnalyse}</textarea>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td colspan="3">
            <textarea class="textarea max" name="${sheetPageName}linkCheckComment" id="${sheetPageName}linkCheckComment"
                      alt="width:500,allowBlank:false,maxLength:2000,vtext:'请填入审核意见，最多输入2000字'">${sheetLink.linkCheckComment}</textarea>
        </td>
    </tr>
    <%
            }
    ...
    <tr>
        ...
        <td colspan="3">
            <textarea class="textarea max" name="${sheetPageName}linkPermitIdea" id="${sheetPageName}linkPermitIdea"
                      alt="width:500,allowBlank:false,maxLength:2000,vtext:'请填入审批意见，最多输入2000字'">${sheetLink.linkPermitIdea}</textarea>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><input type="text" class="text" name="${sheetPageName}linkManager" id="${sheetPageName}linkManager"
                   value="${sheetLink.linkManager}" alt="allowBlank:false,maxLength:25,vtext:'请填入实施负责人，最多输入25字'"/></td>
        ...
        <td><input type="text" class="text" name="${sheetPageName}linkContact" id="${sheetPageName}linkContact"
                   value="${sheetLink.linkContact}" alt="allowBlank:false,maxLength:25,vtext:'请填入联系方式，最多输入25字'"/></td>
    </tr>
    <tr>
        <td class="label"><bean:message bundle="softchange" key="softchange.linkPlanStartTime"/>*</td>
        <td>
            <input class="text" onclick="popUpCalendar(this, this)" type="text" name="${sheetPageName}linkPlanStartTime"
                   readonly="readonly"
        ...
        <td>
            <input class="text" onclick="popUpCalendar(this, this)" type="text" name="${sheetPageName}linkPlanEndTime"
                   readonly="readonly"
    ...
    <tr>
        ...
        <td colspan="3">
            <textarea class="textarea max" name="${sheetPageName}linkCellInfo" id="${sheetPageName}linkCellInfo"
                      alt="width:500,allowBlank:false,maxLength:2000,vtext:'请填入影响网元范围，最多输入2000字'">${sheetLink.linkCellInfo}</textarea>
        </td>
    </tr>
    <tr>
        ...
        <td colspan="3">
            <eoms:comboBox name="${sheetPageName}linkIsEffectBusiness" id="${sheetPageName}linkIsEffectBusiness"
                           ...
                           styleClass="select-class" onchange="ifAffect(this.value)"/>
        </td>
    </tr>
    <tr>
        ...
        <td colspan="3">
            <textarea class="textarea max" name="${sheetPageName}linkEffectCondition"
                      ...
                      alt="width:500,allowBlank:true,maxLength:2000,vtext:'请填入影响业务范围及时长，最多输入2000字'">${sheetLink.linkEffectCondition}</textarea>
        </td>
    </tr>
    <tr>
        ...
        <td colspan="3">
            <textarea class="textarea max" name="${sheetPageName}linkNetManage" id="${sheetPageName}linkNetManage"
                      alt="width:500,allowBlank:true,maxLength:2000 ,vtext:'请填入影响网管情况，最多输入2000字'">${sheetLink.linkNetManage}</textarea>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>
            <eoms:comboBox name="${sheetPageName}linkFailedReason" id="${sheetPageName}linkFailedReason"
                           initDicId="1010910" alt="allowBlank:false" defaultValue="${sheetLink.linkFailedReason}"
                           styleClass="select-class"/>
        </td>
    </tr>
    <tr>
        ...
        <td colspan="3">
            <textarea class="textarea max" name="${sheetPageName}linkCutComment" id="${sheetPageName}linkCutComment"
                      alt="width:500,allowBlank:false,maxLength:2000 ,vtext:'请填入实施情况说明，请最多输入2000字'">${sheetLink.linkCutComment}</textarea>
        </td>
    </tr>
    <tr>
        ...
        <td colspan="3">
            <textarea class="textarea max" name="${sheetPageName}linkBusinessComment"
                      ...
                      alt="width:500,allowBlank:false,maxLength:2000 ,vtext:'请填入影响业务情况说明，请最多输入2000字'">${sheetLink.linkBusinessComment}</textarea>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td colspan="3">
            <textarea class="textarea max" name="${sheetPageName}linkAlertRecord" id="${sheetPageName}linkAlertRecord"
                      alt="width:500,allowBlank:false,maxLength:2000 ,vtext:'请填入告警情况记录，请最多输入2000字'">${sheetLink.linkAlertRecord}</textarea>
        </td>
    </tr>
    <tr>
        ...
        <td colspan="3">
            <textarea class="textarea max" name="${sheetPageName}linkUnnormalComment"
                      ...
                      alt="width:500,allowBlank:false,maxLength:2000 ,vtext:'请填入统计报告异常说明，请最多输入2000字'">${sheetLink.linkUnnormalComment}</textarea>
        </td>
    </tr>
    <tr>
        <td class="label">
    ...
    <tr>
        ...
        <td colspan="3">
            <textarea class="textarea max" name="${sheetPageName}linkCutAnalyse" id="${sheetPageName}linkCutAnalyse"
                      alt="width:500,allowBlank:true,maxLength:2000 ,vtext:'请填入执行情况分析，最多输入2000字'">${sheetLink.linkCutAnalyse}</textarea>
        </td>
    </tr>
    <tr>
        ...
        <td>
            <eoms:comboBox name="${sheetPageName}linkIsUpdateWork" id="${sheetPageName}linkIsUpdateWork"
                           initDicId="10301" alt="allowBlank:false" defaultValue="${sheetLink.linkIsUpdateWork}"
                           styleClass="select-class"/>
        </td>
    ...
    <tr>
        ...
        <td colspan="3">
            <textarea class="textarea max" name="${sheetPageName}linkWorkUpdateAdvice"
                      ...
                      alt="width:500,allowBlank:true,maxLength:2000 ,vtext:'请填入作业计划更新建议，最多输入2000字'">${sheetLink.linkWorkUpdateAdvice}</textarea>
        </td>
    </tr>
    <tr>
        ...
        <td colspan="3">
            <textarea class="textarea max" name="${sheetPageName}linkSoftVersionUpdate"
                      ...
                      alt="width:500,allowBlank:false,maxLength:2000 ,vtext:'请填入资源库软件版本数据更新，请最多输入2000字'">${sheetLink.linkSoftVersionUpdate}</textarea>
        </td>
    </tr>
    <tr>
        ...
        <td colspan="3">
            <textarea class="textarea max" name="${sheetPageName}linkNextPlan" id="${sheetPageName}linkNextPlan"
                      alt="width:500,allowBlank:true,maxLength:2000 ,vtext:'请填入后续工作安排，最多输入2000字'">${sheetLink.linkNextPlan}</textarea>
        </td>
    </tr>
    <tr>
        ...
        <td colspan="3">
            <textarea class="textarea max" name="${sheetPageName}linkProjectComment"
                      ...
                      alt="width:500,allowBlank:false,maxLength:2000 ,vtext:'请填入交维描述，请最多输入2000字'">${sheetLink.linkProjectComment}</textarea>
        </td>
    </tr>
    <%
            }
    ...
    <tr>
        ...
        <td colspan="3">
            <textarea name="${sheetPageName}endResult" alt="allowBlank:false,maxLength:2000,vtext:'请填入信息，最多输入2000字符'"
    ...
    <tr>
        ...
        <td colspan="3">
            ...
            <textarea name="${sheetPageName}remark" class="textarea max" id="${sheetPageName}remark"
                      alt="allowBlank:false,width:500,maxLength:2000,vtext:'请填入信息，最多输入2000字符'"
...
<fieldset id="link5">
    ...
    <div ID="permit2">
        <eoms:chooser id="sendRole2" type="role" roleId="256" flowId="43"
