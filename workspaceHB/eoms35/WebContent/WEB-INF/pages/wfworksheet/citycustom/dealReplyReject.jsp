...
<div id="sheetform">
    <html:form action="/citycustom.do?method=performDealReplyReject" styleId="theform">
        <%
        ...
        <input type="hidden" name="subtaskName" value="CityCustomSubTask"/>
        ...
        <input type="hidden" name="taskNamespace" value="http://CityCustom"/>
