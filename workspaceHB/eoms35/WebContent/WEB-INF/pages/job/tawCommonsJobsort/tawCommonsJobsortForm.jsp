...
<html:form action="saveTawCommonsJobsort" method="post" styleId="tawCommonsJobsortForm">
    <ul>
        ...
        <li>
            ...
            <html:text property="jobSortName" styleId="jobSortName" alt="allowBlank:false,vtext:''"
                       styleClass="text medium"/><font color="red">${exist }</font>
        </li>
        <li>
            <eoms:label styleClass="desc" key="tawCommonsJobsortForm.jobClassName"/>
            <html:errors property="jobClassName"/>
            <html:text property="jobClassName" styleId="jobClassName" alt="allowBlank:false,vtext:''"
        ...
        <li class="buttonBar bottom">
            ...
            <html:submit styleClass="button" property="method.delete"
                         onclick="bCancel=true; return confirms('TawCommonsJobsort')">
