...
<form name="newFormPage" method="POST" id="newFormPage" action="numberapply.do?method=performSignalSave">
    <table class="formTable">
        ...
        <tr>
            ...
            <td class="content">
                <input type="text" class="text" name="netName" id="netName" value="${numberApplyHlrid.netName }"
                       alt="allowBlank:false,vtext:'请填写网元名称'"/>
            </td>
            <td class="label">网元代号*</td>
            <td class="content">
                <input type="text" class="text" name="netId" id="netId" value="${numberApplyHlrid.netId }"
                       alt="allowBlank:false,vtext:'请填写网元代号'"/>
            </td>
        </tr>
        <tr>
            <td class="label">网元属性*</td>
            <td class="content">
                <input type="text" class="text" name="netProp" id="netProp" value="${numberApplyHlrid.netProp }"
                       alt="allowBlank:false,vtext:'请填写网元属性'"/>
            </td>
            <td class="label">建设地点*</td>
            <td class="content">
                <input type="text" class="text" name="buildAddress" id="buildAddress"
                       value="${numberApplyHlrid.buildAddress }" alt="allowBlank:false,vtext:'请填写建设地点'"/>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="content">
                <input type="text" class="text" name="areaNumber" id="areaNumber"
                       value="${numberApplyHlrid.areaNumber }"/>
            </td>
        ...
        <tr>
            ...
            <td class="content" colspan="3">
                <input type="text" class="text" name="fileNumber" id="fileNumber"
                       value="${numberApplyHlrid.fileNumber }"/>
            </td>
        </tr>
    </table>
    <script type="text/javascript">
