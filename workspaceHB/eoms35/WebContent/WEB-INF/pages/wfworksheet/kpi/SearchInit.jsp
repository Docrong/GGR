...
<%if (fileName.equals("SQL_complaintDuban")) { %>
	<tr>
		<td class="label"><bean:message bundle="sheet" key="query.completeLimit" /><font  color="red">*该条件只对投诉督办工单详情导出有效</font></td>
...
<%if (!fileName.equals("SQL_projectwarning")) { %>
	...
	<tr>
		...
		<td width="100%"><input type="hidden"
			...
			class="text" readonly="readonly" name="showArea" id="showArea"
			beanId="tawSystemAreaDao" /> <input type="hidden"
