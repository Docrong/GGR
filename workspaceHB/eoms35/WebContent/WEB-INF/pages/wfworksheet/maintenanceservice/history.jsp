...
<div id="history" class="panel">
    ...
    <logic:present name="HISTORY" scope="request">
        ...
        <logic:iterate id="baselink" name="HISTORY"
                       type="com.boco.eoms.sheet.maintenanceservice.model.MaintenanceServiceLink">
            <%
                jNum += 1;
            ...
            <div class="history-item">&nbsp;
                ...
                <div class="history-item-title">
                    ...
                    <c:choose>
                        ...
                        <c:otherwise>
                            <eoms:dict key="dict-sheet-maintenanceservice" dictId="activeTemplateId"
                    ...
                    <eoms:dict key="dict-sheet-maintenanceservice" dictId="mainOperateType"
                ...
                <div class="history-item-content hide">
                    <table class="formTable" width="100%" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td class="label">
                                <!-- 强制归档原因 -->
                                <bean:message bundle="maintenanceservice"
                                              key="maintenanceServiceLink.linkFilingReason"/>
                            </td>
                            <td class="content">
                        ...
                        <tr>
                            ...
                            <td class="label">
                                <!-- 序号 -->
                                <bean:message bundle="maintenanceservice"
                                              key="maintenanceServiceLink.linkSerialNumber"/>
                            </td>
                            <td class="content">
                        ...
                        <tr>
                            ...
                            <td class="label">
                                <!-- 设备厂家 -->
                                <bean:message bundle="maintenanceservice"
                                              key="maintenanceServiceLink.linkManufacturers"/>
                            </td>
                            <td class="content">
                        ...
                        <tr>
                            ...
                            <td class="label">
                                <!-- 设备型号 -->
                                <bean:message bundle="maintenanceservice"
                                              key="maintenanceServiceLink.linkEquipmentType"/>
                            </td>
                            <td class="content">
                        ...
                        <tr>
                            ...
                            <td class="label">
                                <!-- 设备序列号 -->
                                <bean:message bundle="maintenanceservice"
                                              key="maintenanceServiceLink.linkDeviceNumber"/>
                            </td>
                            <td class="content">
                        ...
                        <tr>
                            ...
                            <td class="label">
                                <!-- 接口类型及数量 -->
                                <bean:message bundle="maintenanceservice"
                                              key="maintenanceServiceLink.linkInterfaceType"/>
                            </td>
                            <td class="content">
                        ...
                        <tr>
                            ...
                            <td class="label">
                                <!-- 系统集成商名称 -->
                                <bean:message bundle="maintenanceservice"
                                              key="maintenanceServiceLink.linkIntegratorName"/>
                            </td>
                            <td class="content">
                            ...
                            <td class="label">
                                <!-- 拟购买的服务级别 -->
                                <bean:message bundle="maintenanceservice"
                                              key="maintenanceServiceLink.linkLevelService"/>
                            </td>
                            <td class="content">
                        ...
                        <tr>
                            ...
                            <td class="label">
                                <!-- 设备物理位置 -->
                                <bean:message bundle="maintenanceservice"
                                              key="maintenanceServiceLink.linkPhysicalLocation"/>
                            </td>
                            <td class="content">
                        ...
                        <tr>
                            ...
                            <td class="label">
                                <!-- 联系方式 -->
                                <bean:message bundle="maintenanceservice"
                                              key="maintenanceServiceLink.linkContactInformation"/>
                            </td>
                            <td class="content">
                        ...
                        <tr>
                            ...
                            <td class="label">
                                <!-- 驳回原因 -->
                                <bean:message bundle="maintenanceservice"
                                              key="maintenanceServiceLink.linkReasonRejection"/>
                            </td>
                            <td class="content">
                        ...
                        <tr>
                            ...
                            <td class="label">
                                <!-- 审批意见 -->
                                <bean:message bundle="maintenanceservice"
                                              key="maintenanceServiceLink.linkApprovalOpinion"/>
                            </td>
                            <td class="content">
                        ...
                        <tr>
                            ...
                            <td class="label">
                                <!-- 服务内容是否满意 -->
                                <bean:message bundle="maintenanceservice"
                                              key="maintenanceServiceLink.linkServiceContent"/>
                            </td>
                            <td class="content">
                        ...
                        <tr>
                            ...
                            <td class="label">
                                <!-- 处理是否及时 -->
                                <bean:message bundle="maintenanceservice"
                                              key="maintenanceServiceLink.linkTimelyProcessing"/>
                            </td>
                            <td class="content">
                        ...
                        <tr>
                            ...
                            <td class="label">
                                <!-- 维护开始时间 -->
                                <bean:message bundle="maintenanceservice"
                                              key="maintenanceServiceLink.linkMaintenanceStartTime"/>
                            </td>
                            <td class="content">
                        ...
                        <tr>
                            ...
                            <td class="label">
                                <!-- 维护结束时间 -->
                                <bean:message bundle="maintenanceservice"
                                              key="maintenanceServiceLink.linkMaintenanceEndTime"/>
                            </td>
                            <td class="content">
