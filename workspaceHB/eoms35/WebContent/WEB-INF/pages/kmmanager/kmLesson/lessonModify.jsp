...
<fmt:bundle basename="com/boco/eoms/km/config/applicationResource-kmmanager">
    <form enctype="multipart/form-data" name="CreatlessonForm" action="${app}/kmmanager/creatlessons.do?method=edited"
          styleId="creatlessonForm" method="post">
        <!-- 详细信息 -->
        ...
        <table class="formTable">
            ...
            <tr>
                ...
                <td class="content">
                    <input type="text" id="theme" name="theme" class="text medium" maxlength="30"
                           value="${detailList.theme}"/>
		...
		<textarea name="subjectContents" id="subjectContents"
            ...
            <tr>
                ...
                <td class="content">
                    ...
                    <eoms:attachment name="detailList" property="attachment" scope="request" idField="attachment"
                                     appCode="kmmanager" viewFlag="Y"/>
                    </br><fmt:message key="creatlesson.attention"/>
                    <eoms:attachment name="Creatlesson" property="${detailList.attachment}" scope="request"
                                     idField="attachment" appCode="kmmanager" startsWith="0"/>
                </td>
            </tr>
