...
<display:table name="taskList" cellspacing="0" cellpadding="0"
               ...
               decorator="com.boco.eoms.sheet.numberapply.webapp.action.HLRListDisplaytagDecoratorHelper">
    ...
    <display:column sortable="true" headerClass="sortable" title="HLR ID">
        <c:if test="${empty taskList.hlrId}">
            等待管理员分配
        </c:if>
        <c:if test="${!empty taskList.hlrId}">
            ${taskList.hlrId}
