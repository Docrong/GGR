...
<table width='100%'>
    <tr>
        <td align=center width='100%' colspan=2 class="table_title">查询条件选择</td>
    </tr>
</table>
        ...
        <table width='100%'>
            <tr>
                ...
                <!-- <td width='50%' align=right colspan=2><input type=button name=go value='增加查询条件' onclick='javascript:addInput()'></td>
                 -->
                <td width='100%' align=right height="32"><input type=submit name=go value='查询'
                                                                onclick='javascript:goSearch()' class="clsbtn2"></td>
            </tr>
        </table>
    </form>
