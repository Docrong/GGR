...
<logic:present name="HISTORY" scope="request">  
      ...
      <logic:iterate id="baselink" name="HISTORY" type="com.boco.eoms.sheet.industrysms.model.IndustrySmsLink" >     
       <%         
        jNum += 1;       
      ...
      <div class="history-item">&nbsp;   
	      ...
	      <div class="history-item-title">
			 ...
			 <bean:write name="baselink" property="operateTime" formatKey="date.formatDateTimeAll" bundle="sheet" scope="page"/>&nbsp; 
	  	     ...
	  	     <eoms:dict key="dict-sheet-industrysms" dictId="activeTemplateId" itemId="${baselink.activeTemplateId}" beanId="id2descriptionXML" />
	  	     <bean:message bundle="industrysms" key="industrysms.operateType"/>:
	  	     <eoms:dict key="dict-sheet-industrysms" dictId="mainOperateType" itemId="${baselink.operateType}" beanId="id2descriptionXML" />
	  	     <c:if test="${baselink.operateType == '103'}">
	  	     	数据制作结果:${baselink.dataResult}
	  	     </c:if>
	 ...
	 <!-- 流程中的历史页面 -->
		  		...
		  		<%if(baselink.getActiveTemplateId()!=null && baselink.getActiveTemplateId().equals("AuditHumTask")) {%>
		  				...
		  				<%if(baselink.getOperateType() != null && (baselink.getOperateType().intValue() == 102 || baselink.getOperateType().intValue() == 11)){ %>
							...
							<td class="content">
								...
								<pre>${baselink.approveResult}</pre>
	 						</td>
							...
							<td class="content">
								...
								<pre>${baselink.approveOpinion}</pre>
	 						</td>
		  		...
		  		<%if(baselink.getActiveTemplateId()!=null && baselink.getActiveTemplateId().equals("DataHumTask")) {%>
...
<script type="text/javascript">
 ...
 function copy(id){
    ...
    Ext.Ajax.request({
		method:"get",
		url: "industrysms.do?method=getJsonLink&id="+id+"&beanName=IndustrySms",
		success: function(x){
