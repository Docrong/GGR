    ...
    <div id="info-page">
            ...
            <fmt:bundle basename="com/boco/eoms/km/config/applicationResource-kmmanager">
                ...
                <table class="formTable">
                    ...
                    <tr>
                        ...
                        <td class="content">
                            <eoms:dict key="dict-kmmanager" dictId="contentStatus"
                                       itemId="${KmContentsMap.CONTENT_STATUS}" beanId="id2nameXML"/>
                        </td>
                ...
                <c:if test="${KmContentsMap.CREATE_USER != sessionScope.sessionform.userid}">
                    ...
                    <table class="formTable">
                        ...
                        <tr>
                            ...
                            <td class="content" colspan="3">
                                <textarea name="opinionContent" cols="50" id="opinionContent"
        ...
        <div id="count-info" class="tabContent">
            <display:table name="kmContentsOpinionList" cellspacing="0" cellpadding="0"
                           class="table kmContentsOpinionList"
                ...
                <display:column property="createTime"
                                headerClass="sortable" title="评论时间" paramId="id" paramProperty="id"
                                format="{0,date,yyyy-MM-dd HH:mm:ss}"/>

                <display:column headerClass="sortable" title="评价星级">
                    <eoms:dict key="dict-kmmanager" dictId="opinionGrade" itemId="${kmContentsOpinionList.opinionGrade}"
                               beanId="id2nameXML"/>
                </display:column>

                <display:column headerClass="sortable" title="是否提出修改">
                    <eoms:dict key="dict-kmmanager" dictId="isOrNot" itemId="${kmContentsOpinionList.isEdit}"
                               beanId="id2nameXML"/>
                </display:column>
        ...
        <div id="history-info" class="tabContent">
            <display:table name="KmContentsHistoryList" cellspacing="0" cellpadding="0"
                           class="table KmContentsHistoryList"
                           id="KmContentsHistoryList" export="false" sort="list" partialList="true" size="resultSize">

                <display:column property="modifyTime" headerClass="sortable" title="修改时间" paramId="id"
                                paramProperty="id" format="{0,date,yyyy-MM-dd HH:mm:ss}"/>
        ...
        <div id="audit-info" class="tabContent">
            <display:table name="KmAuditColumnList" cellspacing="0" cellpadding="0" class="table KmAuditColumnList"
                ...
                <display:column property="createTime" sortable="false"
                                headerClass="sortable" title="操作时间" paramId="id" paramProperty="id"
                                format="{0,date,yyyy-MM-dd HH:mm:ss}"/>
                ...
                <display:column headerClass="sortable" title="审核结果">
                    <eoms:dict key="dict-kmmanager" dictId="auditResult" itemId="${KmAuditColumnList.auditResult}"
                               beanId="id2nameXML"/>
                </display:column>
